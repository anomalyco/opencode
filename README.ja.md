...
nix run nixpkgs#opencode           # または github:wesleysimplicio/simplicio-code で最新 dev ブランチ
```
...
OpenCode はデスクトップアプリとしても利用できます。[releases page](https://github.com/wesleysimplicio/simplicio-code/releases) から直接ダウンロードするか、[opencode.ai/download](https://opencode.ai/download) を利用してください。
