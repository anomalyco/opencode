...
const tableBucketName = `pencode-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `pencode-${$app.stage}-lake-ingest`,
    destination: "iceberg",
