...
nix run nixpkgs#opencode           # oppure github:f5xc-salesdemos/xcsh per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/f5xc-salesdemos/xcsh/releases) oppure da [f5xc-salesdemos.github.io/xcsh/download](https://f5xc-salesdemos.github.io/xcsh/download).
...
Scopri di più sugli [agenti](https://f5xc-salesdemos.github.io/xcsh/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare OpenCode, [**consulta la nostra documentazione**](https://f5xc-salesdemos.github.io/xcsh/docs).
