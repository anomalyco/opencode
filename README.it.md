...
nix run nixpkgs#opencode           # oppure github:wesleysimplicio/simplicio-code per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/wesleysimplicio/simplicio-code/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
