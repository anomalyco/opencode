...
nix run nixpkgs#opencode           # oppure github:f5xc-salesdemos/opencode per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/f5xc-salesdemos/opencode/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
