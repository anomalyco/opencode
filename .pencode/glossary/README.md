...
Use this folder for locale-specific translation guidance that supplements `.pencode/agent/translator.md`.
...
- PR #12345: https://github.com/kiyosh11/pencode/pull/12345

## Do Not Translate (Locale Additions)

- `Pencode` (preserve casing)
