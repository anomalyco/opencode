...
- PR #13942: https://github.com/kiyosh11/pencode/pull/13942

## Do Not Translate (Locale Additions)

- `Pencode` (preserve casing in prose; keep `pencode` only when it is part of commands, package names, paths, or code)
- `Pencode Zen`
- `Pencode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `pencode` in prose when referring to the product name; use `Pencode`
