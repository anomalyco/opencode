...
- PR #15835: https://github.com/kiyosh11/pencode/pull/15835

## Do Not Translate (Locale Additions)

- `Pencode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `pencode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Pencode` in prose, `pencode` only for exact technical identifiers
...
- Avoid changing `pencode` to `Pencode` inside commands, URLs, package names, or code literals
