...
- PR #10018: https://github.com/kiyosh11/pencode/pull/10018
- PR #12935: https://github.com/kiyosh11/pencode/pull/12935

## Do Not Translate (Locale Additions)

- `Pencode` (preserve casing in prose; keep `pencode` only in commands, package names, paths, or code)
- `Pencode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
