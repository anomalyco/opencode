...
Desktop application and browser-based app issues, including `pencode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core pencode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Pencode Zen, Pencode Go, and billing issues.
