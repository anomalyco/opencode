...
nix run nixpkgs#opencode           # lub github:wesleysimplicio/simplicio-code dla najnowszej gałęzi dev
```
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/wesleysimplicio/simplicio-code/releases) lub z [opencode.ai/download](https://opencode.ai/download).
