...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/f5xc-salesdemos/xcsh/releases) lub z [opencode.ai/download](https://opencode.ai/download).
