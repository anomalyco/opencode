...
nix run nixpkgs#opencode           # ou github:f5xc-salesdemos/opencode pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/f5xc-salesdemos/opencode/releases) ou [opencode.ai/download](https://opencode.ai/download).
