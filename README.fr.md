...
<p align="center">
  <a href="https://opencode.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo SimplicioCode">
    </picture>
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/wesleysimplicio/simplicio-code/actions/workflows/publish.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/wesleysimplicio/simplicio-code/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
nix run nixpkgs#opencode           # ou github:wesleysimplicio/simplicio-code pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/wesleysimplicio/simplicio-code/releases) ou [opencode.ai/download](https://opencode.ai/download).
