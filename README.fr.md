<p align="center">
  <a href="https://jaminsmoke.github.io/Jarvis">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo Jarvis">
    </picture>
  </a>
</p>
...
Jarvis inclut deux agents intégrés que vous pouvez basculer avec la touche `Tab`.
...
En savoir plus sur les [agents](https://jaminsmoke.github.io/Jarvis/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'Jarvis, [**consultez notre documentation**](https://jaminsmoke.github.io/Jarvis/docs).

### Contribuer

Si vous souhaitez contribuer à Jarvis, lisez nos [docs de contribution](./CONTRIBUTING.md) avant de soumettre une pull request.

### Construire avec Jarvis

Si vous travaillez sur un projet lié à Jarvis et que vous utilisez "opencode" dans le nom du projet (par exemple, "opencode-dashboard" ou "opencode-mobile"), ajoutez une note dans votre README pour préciser qu'il n'est pas construit par l'équipe Jarvis et qu'il n'est pas affilié à nous.
