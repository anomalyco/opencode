...
**P3: 核心代码影响分析** — 技术可行性、架构影响、代码范围、预估文件数

**P5: 架构/数据模型/接口契约设计** — 技术设计文档（核心部分）

**P6: 编码实现** — Effect 服务 / Drizzle schema / ServiceTag / Import / 包名 / 自动化批量替换脚本
...
- `skill:llm` — provider 集成、streaming、token 管理
- `skill:cli` — PTY 管理、终端兼容性
