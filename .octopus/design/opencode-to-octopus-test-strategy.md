...
| L0: 全仓 env 残留 | `rg 'OPENCODE_' packages/core/` | 零结果 (排除 OTEL_* / @openauthjs/*) |
...
const issueGates = {
  ...
  2: [
    { name: "old dir gone", cmd: "test ! -d packages/opencode", expectExit: 0 },
  ],
  // ... 详见 2.2 门矩阵
  9: [
    { name: "i18n keys", cmd: "rg 'opencode_version|opencode_name' packages/web/src/i18n/", expectEmpty: true },
  ],
}
```
