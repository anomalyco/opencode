...
Desktop application and browser-based app issues, including `argus web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core argus server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Argus Zen, Argus Go, and billing issues.
