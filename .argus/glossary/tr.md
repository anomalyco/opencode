...
- PR #15835: https://github.com/argus-team/argus/pull/15835

## Do Not Translate (Locale Additions)

- `Argus` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `argus` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Argus` in prose, `argus` only for exact technical identifiers
...
- Avoid changing `argus` to `Argus` inside commands, URLs, package names, or code literals
