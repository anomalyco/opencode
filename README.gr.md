...
Το OpenCode περιλαμβάνει τρεις ενσωματωμένους πράκτορες μεταξύ των οποίων μπορείτε να εναλλάσσεστε με το πλήκτρο `Tab`.

- **build** - Προεπιλεγμένος πράκτορας με πλήρη πρόσβαση για εργασία πάνω σε κώδικα
- **ask** - Πράκτορας μόνο ανάγνωσης για ερωτήσεις, κατανόηση κώδικα, και καταιγισμό ιδεών/αξιολόγηση ιδεών
  - Δεν μπορεί να τροποποιήσει αρχεία
  - Ιδανικός για εξερεύνηση άγνωστων αρχείων πηγαίου κώδικα και κατανόηση λειτουργίας
- **plan** - Πράκτορας μόνο ανάγνωσης για δημιουργία σχεδίων υλοποίησης
  - Αρνείται την επεξεργασία αρχείων από προεπιλογή
  - Ζητά άδεια πριν εκτελέσει εντολές bash
  - Δημιουργεί λεπτομερή σχέδια υλοποίησης που θα εκτελέσει ο πράκτορας Build
