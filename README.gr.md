...
nix run nixpkgs#opencode           # ή github:f5xc-salesdemos/opencode με βάση την πιο πρόσφατη αλλαγή από το dev branch
```
...
Το OpenCode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/f5xc-salesdemos/opencode/releases) ή το [opencode.ai/download](https://opencode.ai/download).
