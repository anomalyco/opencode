...
Το OpenCode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/f5xc-salesdemos/xcsh/releases) ή το [opencode.ai/download](https://opencode.ai/download).
