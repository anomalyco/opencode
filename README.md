...
nix run nixpkgs#opencode           # or github:wesleysimplicio/simplicio-code for latest dev branch
```
...
OpenCode is also available as a desktop application. Download directly from the [releases page](https://github.com/wesleysimplicio/simplicio-code/releases) or [opencode.ai/download](https://opencode.ai/download).
