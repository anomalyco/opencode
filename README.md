...
<p align="center">The first open-source AI coding agent with secure inference.</p>
<p align="center">
...
To enable it, simply provide a **policy file** (the expected TEE measurement and configuration, generated by the _provider_) in your provider configuration:

```json
{
  "options": {
    "sdk": "@ai-sdk/anthropic",
    "policyFile": "./cvm_policy.json"
  }
}
...
Create `.opencode/opencode.jsonc` at the root of your project:
...
```jsonc
{
  ...
  "provider": {
    "opencode": { "options": {} },
    "concrete-security": {
      "npm": "file:///absolute/path/to/ratls/examples/ai-provider/dist/index.js",
