        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g opendeepseek-ai")}>
                <code>
                  npm i -g <strong>opendeepseek-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g opendeepseek-ai")}>
                <code>
                  bun add -g <strong>opendeepseek-ai</strong>
                </code>
                <CopyStatus />
              </button>
