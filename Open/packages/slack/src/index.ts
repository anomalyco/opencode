...
import { createOpenDeepSeek, type ToolPart } from "@opendeepseek/sdk"
...
console.log("✅ Open DeepSeek server ready")
...
app.message(async ({ message, say }) => {
  ...
  console.log("📤 Open DeepSeek response:", JSON.stringify(result, null, 2))
