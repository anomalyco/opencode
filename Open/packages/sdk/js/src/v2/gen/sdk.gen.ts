...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new OpenDeepSeekClient()" to fix this error.`)
    }
    return instance
  }
...
export class OpenDeepSeekClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<OpenDeepSeekClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    OpenDeepSeekClient.__registry.set(this, args?.key)
  }
