...
Configure agents in your `opendeepseek.json` config file:
...
- Per-project: `.opendeepseek/agent/`
...
```json title="opendeepseek.json" {3-6,9-12}
{
  "$schema": "https://opencode.ai/config.json",
  "tools": {
    "write": true,
...
```json title="opendeepseek.json" {3-5,8-10}
{
  "$schema": "https://opencode.ai/config.json",
  "permission": {
    "edit": "deny"
...
```json title="opendeepseek.json" {7}
{
  "$schema": "https://opencode.ai/config.json",
  "agent": {
    "build": {
...
```json title="opendeepseek.json" {8}
{
  "$schema": "https://opencode.ai/config.json",
  "agent": {
    "build": {
...
```json title="opendeepseek.json" {6,7}
{
  "agent": {
    "deep-thinker": {
