...
nix run nixpkgs#opencode           # hoặc github:f5xc-salesdemos/opencode cho nhánh dev mới nhất
```
...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/f5xc-salesdemos/opencode/releases) hoặc [opencode.ai/download](https://opencode.ai/download).
