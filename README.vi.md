...
nix run nixpkgs#opencode           # hoặc github:wesleysimplicio/simplicio-code cho nhánh dev mới nhất
```
...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/wesleysimplicio/simplicio-code/releases) hoặc [opencode.ai/download](https://opencode.ai/download).
