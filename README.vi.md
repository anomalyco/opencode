...
nix run nixpkgs#opencode           # hoặc github:f5xc-salesdemos/xcsh cho nhánh dev mới nhất
```
...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/f5xc-salesdemos/xcsh/releases) hoặc [f5xc-salesdemos.github.io/xcsh/download](https://f5xc-salesdemos.github.io/xcsh/download).
...
Tìm hiểu thêm về [agents](https://f5xc-salesdemos.github.io/xcsh/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình OpenCode, [**hãy truy cập tài liệu của chúng tôi**](https://f5xc-salesdemos.github.io/xcsh/docs).
