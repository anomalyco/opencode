...
- PR #15835: https://github.com/f5xc-salesdemos/xcsh/pull/15835

## Do Not Translate (Locale Additions)

- `xcsh` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `xcsh` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `xcsh` in prose, `xcsh` only for exact technical identifiers
...
- Avoid changing `xcsh` to `xcsh` inside commands, URLs, package names, or code literals
