...
Use this folder for locale-specific translation guidance that supplements `.xcsh/agent/translator.md`.
...
- PR #12345: https://github.com/f5xc-salesdemos/xcsh/pull/12345

## Do Not Translate (Locale Additions)

- `xcsh` (preserve casing)
