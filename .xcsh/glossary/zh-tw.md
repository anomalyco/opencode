...
- PR #13942: https://github.com/f5xc-salesdemos/xcsh/pull/13942

## Do Not Translate (Locale Additions)

- `xcsh` (preserve casing in prose; keep `xcsh` only when it is part of commands, package names, paths, or code)
- `xcsh Zen`
- `xcsh CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `xcsh` in prose when referring to the product name; use `xcsh`
