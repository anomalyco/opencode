...
nix run nixpkgs#opencode           # ili github:f5xc-salesdemos/opencode za najnoviji dev branch
```
...
OpenCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/f5xc-salesdemos/opencode/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
