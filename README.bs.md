...
nix run nixpkgs#opencode           # ili github:wesleysimplicio/simplicio-code za najnoviji dev branch
```
...
OpenCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/wesleysimplicio/simplicio-code/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
