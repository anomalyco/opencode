...
# Package manageri
npm i -g cyberstrike-ai@latest        # ili bun/pnpm/yarn
...
CyberStrike je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/CyberStrikeus/cyberstrike/releases) ili sa [cyberstrike.io/download](https://cyberstrike.io/download).
...
Saznaj više o [agentima](https://cyberstrike.io/docs/agents).

### Dokumentacija

Za više informacija o konfiguraciji CyberStrike-a, [**pogledaj dokumentaciju**](https://cyberstrike.io/docs).
