...
nix run nixpkgs#opencode           # oder github:wesleysimplicio/simplicio-code für den neuesten dev-Branch
```
...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/wesleysimplicio/simplicio-code/releases) oder [opencode.ai/download](https://opencode.ai/download) herunter.
