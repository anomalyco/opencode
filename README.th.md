...
OpenCode รวมเอเจนต์ในตัวสามตัวที่คุณสามารถสลับได้ด้วยปุ่ม `Tab`

- **build** - เอเจนต์เริ่มต้น มีสิทธิ์เข้าถึงแบบเต็มสำหรับงานพัฒนา
- **ask** - เอเจนต์อ่านอย่างเดียวสำหรับถามคำถาม เข้าใจโค้ด และ brainstorming/ประเมินไอเดีย
  - ไม่สามารถแก้ไขไฟล์ได้
  - เหมาะสำหรับสำรวจโค้ดเบสที่ไม่คุ้นเคยและเข้าใจการทำงาน
- **plan** - เอเจนต์อ่านอย่างเดียวสำหรับการสร้างแผนการดำเนินการ
  - ปฏิเสธการแก้ไขไฟล์โดยค่าเริ่มต้น
  - ขอสิทธิ์ก่อนเรียกใช้คำสั่ง bash
  - สร้างแผนการดำเนินการอย่างละเอียดที่เอเจนต์ Build จะดำเนินการ
