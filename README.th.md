...
OpenCode มีให้ใช้งานเป็นแอปพลิเคชันเดสก์ท็อป ดาวน์โหลดโดยตรงจาก [หน้ารุ่น](https://github.com/f5xc-salesdemos/xcsh/releases) หรือ [opencode.ai/download](https://opencode.ai/download)
