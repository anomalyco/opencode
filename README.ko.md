...
OpenCode는 데스크톱 앱으로도 제공됩니다. [릴리스 페이지](https://github.com/anomalyco/opencode/releases)에서 다운로드하거나 [opencode.ai/download](https://opencode.ai/download)를 이용하세요.
...
- **plan** - 분석 및 코드 탐색을 위한 읽기 전용 에이전트
  - 기본적으로 파일 편집을 거부합니다.
  - bash 명령 실행 전에 권한을 요청합니다.
  - 익숙하지 않은 코드베이스를 탐색하거나 변경을 계획할 때 적합합니다.

또한 복잡한 검색과 다단계 작업을 위한 **general** 서브 에이전트가 있습니다.
메시지에서 `@general`로 호출할 수 있습니다.

[에이전트](https://opencode.ai/docs/agents)에 대한 자세한 내용은 문서를 참고하세요.
...
OpenCode에 기여하고 싶다면, Pull Request를 제출하기 전에 [기여 문서](./CONTRIBUTING.md)를 읽어주세요.
