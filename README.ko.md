...
# 패키지 매니저
npm i -g cyberstrike-ai@latest        # bun/pnpm/yarn 도 가능
...
CyberStrike 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/CyberStrikeus/cyberstrike/releases) 에서 직접 다운로드하거나 [cyberstrike.io/download](https://cyberstrike.io/download) 를 이용하세요.
