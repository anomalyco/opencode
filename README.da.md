...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/wesleysimplicio/simplicio-code/releases) eller [opencode.ai/download](https://opencode.ai/download).
