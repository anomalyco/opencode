...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/f5xc-salesdemos/xcsh/releases) eller [opencode.ai/download](https://opencode.ai/download).
