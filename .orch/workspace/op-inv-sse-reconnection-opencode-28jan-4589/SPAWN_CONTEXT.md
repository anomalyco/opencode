TASK: SSE reconnection in OpenCode client to survive server restarts - see orch-go issue orch-go-20979 for full context
...
**Query:** "sse reconnection opencode"
...
2. **SET UP investigation file:** Run `kb create investigation sse-reconnection-opencode-client-survive` to create from template
   - This creates: `.kb/investigations/simple/YYYY-MM-DD-sse-reconnection-opencode-client-survive.md`
...
6. **CREATE SYNTHESIS.md:** Before completing, create `SYNTHESIS.md` in your workspace: /Users/dylanconlin/Documents/personal/opencode/.orch/workspace/op-inv-sse-reconnection-opencode-28jan-4589/SYNTHESIS.md
