...
OpenCode містить три вбудовані агенти, між якими можна перемикатися клавішею `Tab`.

- **build** - Агент за замовчуванням із повним доступом для завдань розробки
- **ask** - Агент лише для читання для запитань, розуміння коду, і мозкового штурму/оцінки ідей
  - Не може редагувати файли
  - Ідеально підходить для дослідження незнайомих кодових баз та розуміння принципів роботи
- **plan** - Агент лише для читання для створення планів реалізації
  - За замовчуванням забороняє редагування файлів
  - Запитує дозвіл перед запуском bash-команд
  - Створює детальні плани реалізації, які виконає агент Build
