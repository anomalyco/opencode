...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/f5xc-salesdemos/xcsh/releases) або [opencode.ai/download](https://opencode.ai/download).
