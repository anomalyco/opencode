...
nix run nixpkgs#opencode           # або github:wesleysimplicio/simplicio-code для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/wesleysimplicio/simplicio-code/releases) або [opencode.ai/download](https://opencode.ai/download).
