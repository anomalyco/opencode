...
nix run nixpkgs#opencode           # або github:f5xc-salesdemos/xcsh для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/f5xc-salesdemos/xcsh/releases) або [f5xc-salesdemos.github.io/xcsh/download](https://f5xc-salesdemos.github.io/xcsh/download).
...
Дізнайтеся більше про [agents](https://f5xc-salesdemos.github.io/xcsh/docs/agents).

### Документація

Щоб дізнатися більше про налаштування OpenCode, [**перейдіть до нашої документації**](https://f5xc-salesdemos.github.io/xcsh/docs).
