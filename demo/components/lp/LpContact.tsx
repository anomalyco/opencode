...
// SecureCode.dc.html の Apply セクション。濃紺グラデの1枚に、問い合わせフォーム
// （白カード）と軽量ウェイトリスト（id=waitlist）を内包する。
//
    ...
    >
      <div className="mx-auto max-w-[760px] px-5 py-20 md:px-8 md:py-24">
        <div className="text-center">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-[#67d4f3]" style={{ fontFamily: HANKEN }}>
            Contact
          </div>
          <h2 className="mt-4 text-balance text-[1.9rem] font-bold leading-[1.32] tracking-tight md:text-4xl">
            導入相談・お見積り・資料請求
          </h2>
          <p className="mt-5 text-[15px] leading-[1.9] text-[#9fb0c3] md:text-base">
            自社での適用可否やご不明点など、担当よりご案内します。お気軽にご相談ください。
          </p>
        </div>

        {status === "success" ? (
          <div className="mt-9 rounded-2xl border border-emerald-400/35 bg-emerald-400/10 p-8 text-center">
          ...
          <form
            noValidate
            onSubmit={onSubmit}
            className="mt-9 rounded-2xl bg-white p-6 text-slate-900 shadow-[0_24px_60px_rgba(13,40,80,.35)] md:p-8"
          >
        ...
        {/* 軽量ウェイトリスト */}
        <div id="waitlist" className="mt-10 scroll-mt-20 border-t border-white/15 pt-8 text-center">
          <p className="text-[14.5px] leading-relaxed text-[#bcd0e8]">
            メールアドレスを登録するだけ。順次、優先的に β 版アクセスのご案内をお送りします。
          </p>
          <div className="mx-auto mt-4 max-w-[520px]">
            <LpEmailForm
              align="center"
              cta="登録"
              successText="✓ ウェイトリストに登録しました。準備が整い次第ご案内をお送りします。"
            />
          </div>
        </div>
      </div>
