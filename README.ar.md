...
يتوفر OpenCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/f5xc-salesdemos/xcsh/releases) او من [opencode.ai/download](https://opencode.ai/download).
