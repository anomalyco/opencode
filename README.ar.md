...
يتضمن OpenCode ثلاثة وكلاء (Agents) مدمجين يمكنك التبديل بينهم باستخدام زر `Tab`.

- **build** - الافتراضي، وكيل بصلاحيات كاملة لاعمال التطوير
- **ask** - وكيل للقراءة فقط لطرح الاسئلة وفهم الكود وتبادل الافكار وتقييمها
  - لا يمكنه تعديل الملفات
  - مثالي لاستكشاف قواعد كود غير مألوفة وفهم كيفية عملها
- **plan** - وكيل للقراءة فقط لانشاء خطط التنفيذ
  - يرفض تعديل الملفات افتراضيا
  - يطلب الاذن قبل تشغيل اوامر bash
  - ينشئ خطط تنفيذ مفصلة سينفذها وكيل Build
