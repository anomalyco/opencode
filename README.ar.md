...
nix run nixpkgs#opencode           # او github:f5xc-salesdemos/opencode لاحدث فرع dev
```
...
يتوفر OpenCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/f5xc-salesdemos/opencode/releases) او من [opencode.ai/download](https://opencode.ai/download).
