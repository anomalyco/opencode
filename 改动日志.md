...
| [macos-pack-installer](docs/features/macos-pack-installer/3-changelog.md) | 待回填 | macOS 一键打 .app/.dmg 脚本(pack-installer.sh + bump-installer-version.sh)+ apply-icons.sh 现场生成的 icon.icns 加 .gitignore + 4 个 sh 加 +x 权限 | Tiny,只 changelog,2 新 sh ≈ 209 行 + 1 .gitignore + 4 mode change |
