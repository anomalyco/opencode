...
| [claude-code-loop-fix](docs/features/claude-code-loop-fix/3-changelog.md) | (本次 commit) | claude-code plugin 选 Claude 模型时 step loop 不 break、UI 卡死 — 兜底块用 step-finish part 替代 finish 顶层字段(R4 override,case 1) | spec/plan/changelog 三文档 + 顺手修 apply-icons.ps1 中文注释碰 PowerShell 5.1 ANSI 解析 |
