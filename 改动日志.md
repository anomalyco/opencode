...
| [macos-打包](docs/features/macos-打包/3-changelog.md) | (待 Phase 1 commit + Phase 2 实战回填) | DeskFox Mac .app + .dmg 打包 scaffolding(arm64,不签名,sidecar 复用上游 predev.ts) | spec/plan/changelog 三文档,Phase 2 待 user Mac 上跑 |
