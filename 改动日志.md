...
| [installer-打包](docs/features/installer-打包/3-changelog.md) | (待回填) | DeskFox 打成 Windows installer(Inno Setup,不签名) + 顺手修 icon pipeline 让 exe 嵌入多分辨率狐狸 | spec/plan/changelog 三文档 |
