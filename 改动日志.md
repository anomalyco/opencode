...
| [installer-versioning](docs/features/installer-versioning/3-changelog.md) | (待回填) | installer 版本号规则 YYYY.M.D.N + bump 脚本 + pack-installer 一键 + docs/installer-versions.md 版本日志(首发 2026.4.29.1,旧 1.14.21 命名规则停用)| spec/plan/changelog 三文档 + 4 fork-only 文件 |
