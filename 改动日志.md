...
| [icon-pipeline-deep-fix](docs/features/icon-pipeline-deep-fix/3-changelog.md) | `5704142fe` / `bc0b549b7` | Tauri winres 真读 icons/dev/icon.ico 无视 prod.json — apply-icons 同步覆盖 + 新设计资源全量更新 | Tiny,只 changelog |
