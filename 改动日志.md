...
| [macos-右键选区-修复](docs/features/macos-右键选区-修复/3-changelog.md) | `<待回填>` | macOS WKWebView 文字上右键选区丢失 — 选区历史栈挑最长 + overlay div 替代 stale 的 CSS Custom Highlight + 关闭菜单时统一清原生/Pierre 选区 | spec/plan/changelog 三文档,1 fork-only 文件 |
