...
| [bump-script-encoding-fix](docs/features/bump-script-encoding-fix/3-changelog.md) | 待回填 | bump-installer-version.ps1 加 UTF-8 BOM(3 字节)修中文 placeholder 乱码 — PS 5.1 无 BOM 时按 GBK 读源,中文字面量被双重编码 | Tiny,只 changelog |
