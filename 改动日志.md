...
| [bundle-id-debrand](docs/features/bundle-id-debrand/3-changelog.md) | 待回填 | 完整品牌切割 — Bundle ID 三档全去 `opencode` 字眼,改 `ai.deskfox.app` 系列(prod/.beta/.dev),reverse-DNS 与域名所有权 `deskfox.ai` 对齐,与 sst/opencode 上游 0 命名空间共享 | Tiny,只 changelog,3 配置 +3 行 |
