...
| [prod-bundle-id-fix](docs/features/prod-bundle-id-fix/3-changelog.md) | 待回填 | macOS prod / beta Bundle ID 独立 override(prod 去掉 `.dev` 后缀)— 修应用程序网格 / Launchpad / Spotlight 搜不到 prod 包的问题;三档 Bundle ID 独立可共存 | Tiny,只 changelog,2 配置 +2 行 |
