...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/wesleysimplicio/simplicio-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for wesleysimplicio/simplicio-code...\n")
