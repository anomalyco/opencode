...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/octopus/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/octopus...\n")
...
console.log("Fetching npm all-time downloads for octopus-ai...\n")
const npmDownloads = await fetchNpmDownloads("octopus-ai")
