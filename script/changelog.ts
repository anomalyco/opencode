...
Generates UPCOMING_CHANGELOG.md by running the pencode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for pencode run (default: low)
      --quiet            Suppress pencode command output unless it fails
