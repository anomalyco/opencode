...
nix run nixpkgs#opencode           # o github:f5xc-salesdemos/xcsh para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/f5xc-salesdemos/xcsh/releases) o desde [f5xc-salesdemos.github.io/xcsh/download](https://f5xc-salesdemos.github.io/xcsh/download).
...
Más información sobre [agents](https://f5xc-salesdemos.github.io/xcsh/docs/agents).

### Documentación

Para más información sobre cómo configurar OpenCode, [**ve a nuestra documentación**](https://f5xc-salesdemos.github.io/xcsh/docs).
