...
) -> EffectHttpApiErrorBadRequest | InvalidRequestError | list[str] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EffectHttpApiErrorBadRequest | InvalidRequestError | list[str]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EffectHttpApiErrorBadRequest | InvalidRequestError | list[str]
    """
