...
) -> EffectHttpApiErrorBadRequest | InvalidRequestError | list[SyncHistoryListResponse200Item] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EffectHttpApiErrorBadRequest | InvalidRequestError | list[SyncHistoryListResponse200Item]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EffectHttpApiErrorBadRequest | InvalidRequestError | list[SyncHistoryListResponse200Item]
    """
