...
from ...models.v2_session_prompt_body import V2SessionPromptBody
...
def _get_kwargs(
    session_id: str,
    *,
    body: V2SessionPromptBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/session/{session_id}/prompt".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        directory (str | Unset):
        workspace (str | Unset):
        body (V2SessionPromptBody | Unset):
    ...
    Returns:
        Response[InvalidRequestError | ServiceUnavailableError | SessionMessageAgentSwitched | SessionMessageAssistant | SessionMessageCompaction | SessionMessageModelSwitched | SessionMessageShell | SessionMessageSynthetic | SessionMessageUser | SessionNotFoundError | UnauthorizedError]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InvalidRequestError | ServiceUnavailableError | SessionMessageAgentSwitched | SessionMessageAssistant | SessionMessageCompaction | SessionMessageModelSwitched | SessionMessageShell | SessionMessageSynthetic | SessionMessageUser | SessionNotFoundError | UnauthorizedError
    """
