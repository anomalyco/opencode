...
) -> EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | SessionMessageResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | SessionMessageResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | SessionMessageResponse200
    """
