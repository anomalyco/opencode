...
) -> EffectHttpApiErrorBadRequest | InvalidRequestError | SessionStatusResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EffectHttpApiErrorBadRequest | InvalidRequestError | SessionStatusResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EffectHttpApiErrorBadRequest | InvalidRequestError | SessionStatusResponse200
    """
