...
) -> EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | list[Session] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | list[Session]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | list[Session]
    """
