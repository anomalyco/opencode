...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | SessionBusyError | SessionShellResponse200
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | SessionBusyError | SessionShellResponse200]
    """
