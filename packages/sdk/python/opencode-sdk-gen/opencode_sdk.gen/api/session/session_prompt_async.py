...
) -> Any | EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | EffectHttpApiErrorBadRequest | InvalidRequestError | NotFoundError
    """
