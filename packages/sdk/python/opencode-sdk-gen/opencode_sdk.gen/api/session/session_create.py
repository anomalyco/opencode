...
) -> EffectHttpApiErrorBadRequest | InvalidRequestError | Session | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EffectHttpApiErrorBadRequest | InvalidRequestError | Session]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EffectHttpApiErrorBadRequest | InvalidRequestError | Session
    """
