...
) -> EffectHttpApiErrorBadRequest | InvalidRequestError | Pty | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EffectHttpApiErrorBadRequest | InvalidRequestError | Pty]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EffectHttpApiErrorBadRequest | InvalidRequestError | Pty
    """
