...
if TYPE_CHECKING:
    from ..models.sync_event_session_next_tool_progress_data_structured import (
...
T = TypeVar("T", bound="SyncEventSessionNextToolProgressData")


@_attrs_define
class SyncEventSessionNextToolProgressData:
    """
    Attributes:
        timestamp (float):
        session_id (str):
        call_id (str):
        structured (SyncEventSessionNextToolProgressDataStructured):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        structured = SyncEventSessionNextToolProgressDataStructured.from_dict(d.pop("structured"))
        ...
        sync_event_session_next_tool_progress_data = cls(
            timestamp=timestamp,
        ...
        return sync_event_session_next_tool_progress_data
