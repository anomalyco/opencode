...
from ..models.mcp_status_needs_client_registration_status import MCPStatusNeedsClientRegistrationStatus
...
class MCPStatusNeedsClientRegistration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = MCPStatusNeedsClientRegistrationStatus(d.pop("status"))
