...
class Config:
    ...
    Attributes:
        ...
        shell (str | Unset): Default shell to use for terminal and bash tool
        ...
        tool_output (ConfigToolOutput | Unset): Thresholds for truncating tool output. When output exceeds either limit,
            the full text is written to the truncation directory and a preview is returned.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_autoupdate(data: object) -> bool | Literal["notify"] | Unset:
            ...
            if autoupdate_type_1 != "notify":
                raise ValueError(f"autoupdate_type_1 must match const 'notify', got '{autoupdate_type_1}'")
