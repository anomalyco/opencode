...
class ConfigMcp:
    ...
    additional_properties: dict[str, ConfigMcpAdditionalPropertyType1 | McpLocalConfig | McpRemoteConfig] = (
    ...
    def __getitem__(self, key: str) -> ConfigMcpAdditionalPropertyType1 | McpLocalConfig | McpRemoteConfig:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: ConfigMcpAdditionalPropertyType1 | McpLocalConfig | McpRemoteConfig) -> None:
