...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = McpUnsupportedOAuthError.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[MCPStatusConnected | MCPStatusDisabled | MCPStatusFailed | MCPStatusNeedsAuth | MCPStatusNeedsClientRegistration | McpUnsupportedOAuthError | NotFoundError]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        MCPStatusConnected | MCPStatusDisabled | MCPStatusFailed | MCPStatusNeedsAuth | MCPStatusNeedsClientRegistration | McpUnsupportedOAuthError | NotFoundError
    """
