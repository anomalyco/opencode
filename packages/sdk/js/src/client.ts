 ...
 *
 * 导出内容：
 * - createOpencodeClient：创建 OpenCode 客户端的函数
 * - OpencodeClient：OpenCode 客户端类
 ...
 * 创建 OpenCode 客户端
 *
 * 创建一个配置好的 OpenCode 客户端实例，用于与 OpenCode 服务器通信。
 *
 * @param config - 客户端配置选项
 * @returns OpenCode 客户端实例
 *
 * 配置处理：
