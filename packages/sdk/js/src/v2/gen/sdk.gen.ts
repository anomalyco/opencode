...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new ArgusClient()" to fix this error.`)
    }
    return instance
  }
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Argus server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Argus state.
   */
...
export class Global extends HeyApiClient {
   ...
   * Upgrade argus
   *
   * Upgrade argus to the specified version.
   */
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Argus process. Idle interruption is a no-op.
   */
...
export class ArgusClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<ArgusClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    ArgusClient.__registry.set(this, args?.key)
  }
