 ...
 * - createOpencodeTui：创建 OpenCode TUI 会话
 ...
 * 创建 OpenCode 服务器
 *
 * 启动一个 OpenCode 服务器进程，等待其启动完成，并返回服务器信息。
 *
...
/**
 * 创建 OpenCode TUI（终端用户界面）会话
 *
 * 启动 OpenCode 的交互式终端界面，用于直接在终端中使用 OpenCode。
 *
