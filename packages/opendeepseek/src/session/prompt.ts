...
import PROMPT_PLAN from "../session/prompt/plan.txt.mjs"
import BUILD_SWITCH from "../session/prompt/build-switch.txt.mjs"
import MAX_STEPS from "../session/prompt/max-steps.txt.mjs"
...
export namespace SessionPrompt {
  ...
  export const OUTPUT_TOKEN_MAX = Flag.OPENDEEPSEEK_EXPERIMENTAL_OUTPUT_TOKEN_MAX || 32_000
