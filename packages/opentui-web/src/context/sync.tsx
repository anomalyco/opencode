    ...
    sdk.event.listen((e) => {
      ...
      switch (event.type) {
        ...
        case "permission.updated": {
          // Cast permission.updated properties to Permission type
          const perm = event.properties as any
          if (perm.sessionID) {
            const permissions = store.permission[perm.sessionID] || []
            const sorted = [...permissions, perm].sort((a, b) => a.time.created - b.time.created)
            setStore("permission", perm.sessionID, sorted)
          }
          break
        }
