...
instance FromJSON ModelCost where
  parseJSON = withObject "ModelCost" $ \v -> ModelCost
    <$> v .: "input"
    <*> v .: "output"
    <*> v .:? "cacheRead"
    <*> v .:? "cacheWrite"
...
instance FromJSON Model where
  parseJSON = withObject "Model" $ \v -> Model
    <$> v .: "id"
    <*> v .: "name"
    <*> v .: "providerID"
    <*> v .:? "contextLength"
...
instance FromJSON AuthMethod where
  parseJSON = withObject "AuthMethod" $ \v -> AuthMethod
    <$> v .: "type"
    <*> v .:? "envVars" .!= []
    <*> v .:? "url"
...
instance FromJSON Provider where
  parseJSON = withObject "Provider" $ \v -> Provider
    <$> v .: "id"
    <*> v .: "name"
    <*> v .:? "icon"
    <*> v .:? "models" .!= Map.empty
