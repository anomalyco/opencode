...
instance FromJSON KeybindsConfig where
  parseJSON = withObject "KeybindsConfig" $ \v -> KeybindsConfig
    <$> v .:? "submit"
    <*> v .:? "cancel"
...
instance FromJSON ServerConfig where
  parseJSON = withObject "ServerConfig" $ \v -> ServerConfig
    <$> v .:? "hostname"
    <*> v .:? "port"
...
instance FromJSON LayoutConfig where
  parseJSON = withObject "LayoutConfig" $ \v -> LayoutConfig
    <$> v .:? "terminalRatio"
    <*> v .:? "sidebarVisible"
...
instance FromJSON ProviderConfig where
  parseJSON = withObject "ProviderConfig" $ \v -> ProviderConfig
    <$> v .:? "disabled"
    <*> v .:? "options"
