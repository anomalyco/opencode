import { OpenCode } from "@leak-code/client/effect"
...
import { createEmbeddedRoutes } from "@leak-code/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@leak-code/sdk-next/OpenCode") {}
