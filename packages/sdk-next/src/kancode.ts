import { KanCode } from "@kancode/client/effect"
...
import { createEmbeddedRoutes } from "@kancode/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("KanCode.create")(function* () {
...
export class Service extends Context.Service<Service, Interface>()("@kancode/sdk-next/KanCode") {}
