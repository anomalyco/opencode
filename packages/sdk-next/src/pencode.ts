import { Pencode } from "@pencode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@pencode-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Pencode.create")(function* () {
  ...
  const client = yield* Pencode.make({ baseUrl: "http://pencode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@pencode-ai/sdk-next/Pencode") {}
