...
import { EventManifest } from "@argus-ai/schema/event-manifest"
...
export const ArgusEvent = event.schema
export type ArgusEvent = typeof ArgusEvent.Type
export type ArgusEventEncoded = typeof ArgusEvent.Encoded
