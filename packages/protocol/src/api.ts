...
import { makeAutomationGroup } from "./groups/automation"
import { TeamJulesGroup } from "./groups/teamjules"
...
>(
  ...
  HttpApi.make("server")
    ...
    .add(makeAutomationGroup(locationMiddleware))
    .add(TeamJulesGroup.middleware(locationMiddleware))
    .annotateMerge(
      OpenApi.annotations({
