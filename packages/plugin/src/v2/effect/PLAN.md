...
- Effect plugins import `@pencode-ai/plugin/v2/effect`, not `@pencode-ai/core`.
- Public domain values use generated `@pencode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@pencode-ai/plugin/v2/effect`.
