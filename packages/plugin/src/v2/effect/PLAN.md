...
- Effect plugins import `@kancode/plugin/v2/effect`, not `@kancode/core`.
- Public domain values use generated `@kancode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@kancode/plugin/v2/effect`.
