      ...
      Effect.gen(function* () {
        ...
        const context2: Context = {
          ...
          vcs: {
            ...
            setBase: adaptApiMethod(VcsEndpoints["vcs.setBase"], host.vcs.setBase),
