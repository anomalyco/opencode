...
import { ProjectDirectoryTable, ProjectTable } from "@kancode/core/project/sql"
import { ProjectDirectories } from "@kancode/core/project/directories"
...
import { which } from "@kancode/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/Project") {}
