...
import { MAX_STEPS_PROMPT } from "@kancode/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/SessionPrompt") {}
