...
import { SessionStatusEvent } from "@kancode/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/SessionStatus") {}
