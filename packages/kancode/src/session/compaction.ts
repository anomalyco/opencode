...
import { buildPrompt } from "@kancode/core/session/compaction"
import { SessionCompactionEvent } from "@kancode/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/SessionCompaction") {}
