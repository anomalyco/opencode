...
import { llmClient } from "@kancode/core/effect/app-node-platform"
...
import type { LLMEvent } from "@kancode/llm"
import { LLMClient } from "@kancode/llm/route"
import type { LLMClientService } from "@kancode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @kancode/llm. It
