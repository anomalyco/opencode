...
import type { ProviderMetadata, Usage } from "@kancode/llm"
...
import { locationServiceMapLayer } from "@kancode/core/location-services"
...
import { PartTable, SessionTable } from "@kancode/core/session/sql"
...
import { NonNegativeInt, optional } from "@kancode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".kancode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@kancode/Session") {}
