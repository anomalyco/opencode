import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@kancode/llm"
...
// Move this extraction into @kancode/llm when Copilot is handled by the native runtime.
