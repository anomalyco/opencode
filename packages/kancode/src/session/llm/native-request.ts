import type { JsonSchema, LLMRequest, ProviderMetadata } from "@kancode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@kancode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @kancode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
