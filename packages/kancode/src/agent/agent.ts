...
import { AbsolutePath, type DeepMutable } from "@kancode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".kancode", "plans", "*.md")]: "allow",
