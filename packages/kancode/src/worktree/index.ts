...
import { path } from "@kancode/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@kancode/core/project"
...
import { WorktreeEvent } from "@kancode/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/Worktree") {}
