...
import { createOpencodeClient } from "@kancode/sdk"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/Plugin") {}
...
// Cruise Control is loaded lazily below to avoid a Provider ↔ Plugin cycle.
