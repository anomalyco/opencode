...
import type { Event, GlobalEvent, OpencodeClient } from "@kancode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@kancode/RunStreamTransport") {}
