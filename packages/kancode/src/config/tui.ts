...
import { isRecord } from "@kancode/tui/util/record"
...
import { TuiKeybind } from "@kancode/tui/config/keybind"
...
import { TuiConfig } from "@kancode/tui/config"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/TuiConfig") {}
...
const loadState = Effect.fn("TuiConfig.loadState")(function* (ctx: { directory: string }) {
  ...
  // 2. Explicit OPENCODE_TUI_CONFIG / KANCODE_TUI_CONFIG override, if set.
