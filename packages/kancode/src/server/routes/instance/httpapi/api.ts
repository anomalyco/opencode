...
import { makeApi } from "@kancode/protocol/api"
import { LocationMiddleware } from "@kancode/server/location"
import { SessionLocationMiddleware } from "@kancode/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("kancode-root")
...
export const InstanceHttpApi = HttpApi.make("kancode-instance")
...
export const KanCodeHttpApi = HttpApi.make("kancode")
