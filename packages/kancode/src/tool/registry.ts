...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@kancode/plugin"
...
import { Glob } from "@kancode/core/util/glob"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/ToolRegistry") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          todo: Tool.init(todo),
          sessionRename: Tool.init(sessionRename),
