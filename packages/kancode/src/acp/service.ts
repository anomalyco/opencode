...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@kancode/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/ACP/Service") {}
