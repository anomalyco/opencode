...
import type { AssistantMessage as KanCodeAssistantMessage, Message } from "@kancode/sdk/v2"
...
export type AssistantTokenCost = Pick<KanCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<KanCodeAssistantMessage, "role"> &
  Partial<Pick<KanCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@kancode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@kancode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@kancode/ACPUsage") {}
