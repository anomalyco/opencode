...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@kancode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@kancode/ACPDirectory") {}
