...
import { ConfigMCPV1 } from "@kancode/core/v1/config/mcp"
...
import { McpEvent } from "@kancode/schema/mcp-event"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/MCP") {}
