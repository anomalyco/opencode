...
import { ModelsDev } from "@kancode/core/models-dev"
...
import { LLMEvent, LLMResponse } from "@kancode/llm"
import { RequestExecutor } from "@kancode/llm/route"
...
const writeConfig = (directory: string, scenario: RecordedScenario, model: ModelsDev.Provider["models"][string]) =>
  Effect.promise(() =>
    Bun.write(
      ...
      JSON.stringify({ $schema: "https://raw.githubusercontent.com/puetsua/kancode/main/schemas/kancode.schema.json", ...scenario.config(model) }),
    ),
  )
