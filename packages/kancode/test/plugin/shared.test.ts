...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@kancode/acme")).toEqual({
      pkg: "@kancode/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@kancode/acme@1.0.0")).toEqual({
      pkg: "@kancode/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@kancode/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@kancode/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@kancode/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@kancode/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
