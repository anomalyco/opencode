...
Practical reference for the current tool-migration state in `packages/kancode`.
...
Tool tests should use the existing Effect helpers in `packages/kancode/test/lib/effect.ts`:
