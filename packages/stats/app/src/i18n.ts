...
const en = {
  "app.title": "AI Model Usage Rankings | Pencode Data",
  "app.description":
    "Explore Pencode usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Pencode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Pencode on GitHub",
  "header.github": "GitHub",
  "header.tryPencode": "Try Pencode",
  ...
  "home.topModelsDescription": "Usage of models across Pencode.",
  ...
  "home.uniqueUsersDescription": "Daily unique Pencode users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Pencode Data",
  "lab.description":
    "Compare {{lab}} models used in Pencode, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Pencode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Pencode",
  ...
  "lab.shareOfUsage": "{{share}} of recent Pencode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Pencode Data",
  "model.description":
    "View {{model}} Pencode usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Pencode usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Pencode usage",
  "model.ranked": "Ranked #{{rank}} across last week's Pencode usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Pencode usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Pencode usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Pencode model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Pencode geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Pencode token volume.",
