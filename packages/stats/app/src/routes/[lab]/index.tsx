...
import {
  ...
  type StatsLabData,
} from "@pencode-ai/stats-core/domain/home"
...
export default function StatsLab() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="Pencode" />
  ...
  return (
    ...
    >
      <div data-slot="lab-model-tooltip-summary">
        ...
        <p>{props.state.model.description ?? "Recent Pencode usage, share, context, and output limits."}</p>
      </div>
      <div data-slot="tooltip-divider" />
