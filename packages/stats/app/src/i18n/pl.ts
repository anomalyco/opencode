export const dict = {
  "app.title": "Rankingi użycia modeli AI | Pencode Data",
  "app.description":
    "Przeglądaj użycie Pencode w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Pencode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Pencode na GitHub",
  "header.github": "GitHub",
  "header.tryPencode": "Wypróbuj Pencode",
  ...
  "footer.homeAria": "Strona główna Pencode",
  ...
  "home.topModelsDescription": "Użycie modeli w Pencode.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Pencode według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Pencode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Pencode, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Pencode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Pencode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Pencode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Pencode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Pencode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Pencode, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Pencode pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Pencode z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Pencode z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Pencode w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Pencode, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Pencode.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Pencode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Pencode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Pencode.",
  ...
  "model.geoDescription": "Tokeny modelu Pencode użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Pencode nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Pencode.",
