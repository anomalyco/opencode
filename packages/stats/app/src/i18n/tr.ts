export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Pencode Data",
  "app.description":
    "Pencode kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Pencode Data logosu",
  ...
  "header.githubAria": "GitHub'da Pencode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryPencode": "Pencode'u dene",
  ...
  "footer.homeAria": "Pencode ana sayfası",
  ...
  "home.topModelsDescription": "Pencode genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Pencode kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Pencode Data",
  "lab.description":
    "Pencode'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Pencode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Pencode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Pencode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Pencode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Pencode Data",
  "model.description":
    "{{model}} için Pencode kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Pencode kullanımı görünür.",
  "model.unranked": "Geçen haftaki Pencode kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Pencode kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Pencode kullanımı yok.",
  ...
  "model.overviewDescription": "Son Pencode tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Pencode kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Pencode token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Pencode kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Pencode oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Pencode model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Pencode coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Pencode token hacmine göre yakındaki modeller.",
