export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Pencode Data",
  "app.description":
    "Esplora l'utilizzo di Pencode nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Pencode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Pencode su GitHub",
  "header.github": "GitHub",
  "header.tryPencode": "Prova Pencode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Pencode.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Pencode per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Pencode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Pencode, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Pencode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Pencode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Pencode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Pencode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Pencode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Pencode, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Pencode appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Pencode della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Pencode della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Pencode nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Pencode, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Pencode.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Pencode nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Pencode nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Pencode.",
  ...
  "model.geoDescription": "Token del modello Pencode usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Pencode corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Pencode.",
