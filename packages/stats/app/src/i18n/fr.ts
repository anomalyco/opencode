export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | Pencode Data",
  "app.description":
    "Explorez l'utilisation d'Pencode par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel Pencode Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à Pencode sur GitHub",
  "header.github": "GitHub",
  "header.tryPencode": "Essayer Pencode",
  ...
  "footer.homeAria": "Accueil Pencode",
  ...
  "modal.title": "Newsletter Pencode",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans Pencode.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'Pencode par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | Pencode Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans Pencode, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'Pencode.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans Pencode",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'Pencode",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens Pencode sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | Pencode Data",
  "model.description":
    "Consultez les données d'utilisation Pencode de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation Pencode apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation Pencode de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation Pencode de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation Pencode dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens Pencode récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation Pencode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens Pencode sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'Pencode sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions Pencode.",
  ...
  "model.geoDescription": "Tokens du modèle Pencode utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique Pencode ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens Pencode.",
