export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Pencode Data",
  "app.description":
    "Explore o uso do Pencode em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Pencode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Pencode no GitHub",
  "header.github": "GitHub",
  "header.tryPencode": "Experimente o Pencode",
  ...
  "footer.homeAria": "Início do Pencode",
  ...
  "modal.title": "Newsletter do Pencode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Pencode.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Pencode por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Pencode Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Pencode, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Pencode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Pencode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Pencode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Pencode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Pencode Data",
  "model.description":
    "Veja dados de uso de {{model}} no Pencode, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Pencode aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Pencode da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Pencode da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Pencode na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Pencode, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Pencode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Pencode na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Pencode na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Pencode.",
  ...
  "model.geoDescription": "Tokens do modelo Pencode usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Pencode correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Pencode.",
