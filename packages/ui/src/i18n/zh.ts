...
export const dict = {
  ...
  "ui.sessionTurn.retry.attemptLabel": "第 {{attempt}} 次尝试",
  "ui.sessionTurn.retry.attemptRetrying": "第 {{attempt}} 次尝试 - {{line}}",
  "ui.messagePart.compaction.started": "已开始压缩会话",
  "ui.messagePart.compaction.running": "正在压缩",
  "ui.messagePart.compaction.failed": "压缩会话失败",
  "ui.messagePart.compaction.cancelled": "压缩会话已取消",
  "ui.messagePart.compaction.interrupted": "压缩会话已中断",
  "ui.messagePart.providerCompaction": "会话已由提供商压缩",
  "ui.messagePart.compaction.usage": "输入 {{input}} · 输出 {{output}}",
  "ui.messagePart.context.updates": "更新",
  "ui.messagePart.context.notice.one": "{{count}} 条通知",
  "ui.messagePart.context.notice.other": "{{count}} 条通知",
  "ui.messagePart.context.thought.one": "思考",
  "ui.messagePart.context.thought.other": "思考",
  "ui.messagePart.context.match.one": "（{{count}} 处匹配）",
  "ui.messagePart.context.match.other": "（{{count}} 处匹配）",
  "ui.messagePart.tools.used.one": "使用了 {{count}} 个{{tools}}",
  "ui.messagePart.tools.used.other": "使用了 {{count}} 个{{tools}}",
  "ui.promptInput.dropFiles.image": "拖入图片或文件即可添加",
  "ui.promptInput.dropFiles.pdf": "拖入 PDF 或文件即可添加",
  "ui.promptInput.dropFiles.imagePdf": "拖入图片、PDF 或文件即可添加",
  "ui.promptInput.cancelUpload": "取消上传",
  "ui.promptInput.uploading": "{{percent}}%",
  "ui.promptInput.placeholder.followUp": "添加后续消息，{{slash}} 查看命令，{{at}} 添加上下文…",
  "ui.promptInput.exitShell": "退出",
  "ui.promptInput.steer": "引导",
  "ui.promptInput.queue": "排队",
  "ui.promptInput.steerHint": "发送但不中断当前回合",
  "ui.tool.loadedFile": "已加载 {{path}}",
  "ui.tool.loadedSkill": "已加载 {{name}} 技能",
  "ui.tool.loadedSkills.one": "已加载 {{name}} 技能",
  "ui.tool.loadedSkills.other": "已加载 {{name}} 技能",
  "ui.tool.browser": "浏览器",
  "ui.tool.shell.writingCommand": "正在写入命令…",
  "ui.tool.shell.exit": "命令退出，代码 {{code}}",
  "ui.tool.shell.timeout": "命令超时",
  "ui.tool.shell.cancelled": "命令已取消",
  "ui.tool.execute": "执行",
  "ui.tool.agent.delegating": "正在委派智能体…",
  "ui.common.moreCount.one": "另外 {{count}} 项",
  "ui.common.moreCount.other": "另外 {{count}} 项",
  "ui.message.thought": "思考",
  "ui.sessionTimeline.notice.model": "模型",
  "ui.sessionTimeline.notice.modelSwitched": "已切换到 {{model}}",
  "ui.sessionTimeline.notice.agentChanged": "智能体已更改",
  "ui.sessionTimeline.notice.movedTo": "已移动到",
