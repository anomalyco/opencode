...
export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "添加后续消息，输入 {{slash}} 使用命令，输入 {{at}} 添加上下文...",
  "ui.promptInput.steer": "引导",
  "ui.promptInput.queue": "加入队列",
  "ui.promptInput.steerHint": "发送但不中断",
  "ui.tool.loadedSkills.one": "已加载技能 {{name}}",
  "ui.tool.loadedSkills.other": "已加载技能 {{name}}",
  "ui.tool.shell.exit": "命令已退出，退出代码为 {{code}}",
  ...
  "ui.sessionTurn.retry.attemptRetrying": "尝试 {{attempt}} - {{line}}",
  "ui.messagePart.context.details": "细节",
  "ui.messagePart.context.notice.one": "{{count}} 通知",
  ...
  "ui.promptInput.dropFiles.image": "拖放要添加的图像或文件",
  "ui.promptInput.dropFiles.pdf": "拖放要添加的 PDF 或文件",
  "ui.promptInput.dropFiles.imagePdf": "拖放要添加的图像、PDF 或文件",
  "ui.promptInput.exitShell": "出口",
  "ui.sessionTimeline.notice.agentChanged": "代理变更",

  "ui.sessionTurn.retry.attemptWaiting.one": "尝试 {{attempt}} - 在 {{count}} 秒内重试",
  "ui.sessionTurn.retry.attemptWaiting.other": "尝试 {{attempt}} - 在 {{count}} 秒内重试",
  "ui.sessionTurn.retry.attemptRetryingNow": "尝试 {{attempt}} - 重试",
  "ui.messagePart.compaction.started": "会话压缩已开始",
  "ui.messagePart.compaction.running": "正在压缩",
  "ui.messagePart.compaction.failed": "会话压缩失败",
  "ui.messagePart.compaction.cancelled": "会话压缩已取消",
  "ui.messagePart.compaction.interrupted": "会话压缩被中断",
  "ui.messagePart.providerCompaction": "会话由提供者压缩",
  "ui.messagePart.compaction.usage": "{{input}} 输入 · {{output}} 输出",
