export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.followUp": "Dodaj naknadnu poruku, {{slash}} za naredbe, {{at}} za kontekst...",
  "ui.promptInput.steer": "Usmjeri",
  "ui.promptInput.queue": "Stavi u red čekanja",
  "ui.promptInput.steerHint": "Pošalji bez prekidanja",
  "ui.tool.loadedSkills.one": "Učitana vještina {{name}}",
  "ui.tool.loadedSkills.few": "Učitane vještine {{name}}",
  "ui.tool.loadedSkills.other": "Učitano vještina {{name}}",
  "ui.tool.shell.exit": "Naredba je završila s kodom {{code}}",
  "ui.tool.shell.timeout": "Isteklo je vrijeme za izvršavanje naredbe",
  "ui.tool.shell.cancelled": "Naredba je otkazana",
  ...
  "ui.messagePart.context.thought.other": "Misli",
  "ui.promptInput.dropFiles.image": "Ispustite slike ili datoteke za dodavanje",
  "ui.promptInput.dropFiles.pdf": "Ispustite PDF-ove ili datoteke za dodavanje",
  "ui.promptInput.dropFiles.imagePdf": "Ispustite slike, PDF-ove ili datoteke za dodavanje",
  "ui.promptInput.exitShell": "Izlaz",
  "ui.sessionTimeline.notice.agentChanged": "Promijenjen agent",
  "ui.messagePart.context.notice.few": "{{count}} obavijesti",
  "ui.messagePart.context.thought.few": "Misli",
  "ui.sessionTurn.retry.attemptRetryingNow": "Pokušaj {{attempt}} – ponovni pokušaj",
  "ui.sessionTurn.retry.attemptWaiting.one": "Pokušaj {{attempt}} – ponovni pokušaj za {{count}} sekundu",
  "ui.sessionTurn.retry.attemptWaiting.few": "Pokušaj {{attempt}} – ponovni pokušaj za {{count}} sekunde",
  "ui.sessionTurn.retry.attemptWaiting.other": "Pokušaj {{attempt}} – ponovni pokušaj za {{count}} sekundi",
  "ui.messagePart.compaction.started": "Sažimanje sesije je započelo",
  "ui.messagePart.compaction.running": "Sažimanje",
  "ui.messagePart.compaction.failed": "Sažimanje sesije nije uspjelo",
  "ui.messagePart.compaction.cancelled": "Sažimanje sesije je otkazano",
  "ui.messagePart.compaction.interrupted": "Sažimanje sesije je prekinuto",
  "ui.messagePart.providerCompaction": "Pružatelj je sažeo sesiju",
  "ui.messagePart.compaction.usage": "{{input}} ulaz · {{output}} izlaz",
  "ui.messagePart.tools.used.one": "Korišten je {{count}} alat: {{tools}}",
  "ui.messagePart.tools.used.few": "Korištena su {{count}} alata: {{tools}}",
  "ui.messagePart.tools.used.other": "Korišteno je {{count}} alata: {{tools}}",
  "ui.tool.browser": "Preglednik",
