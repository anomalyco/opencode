export const dict: Record<string, string> = {
  ...
  "ui.messagePart.tools.used": "Korišteni alati: {{tools}}",
  ...
  "ui.messagePart.context.thought.one": "{{count}} misao",
  "ui.messagePart.context.thought.other": "{{count}} misli",
  ...
  "ui.messagePart.context.thought.few": "{{count}} misli",
