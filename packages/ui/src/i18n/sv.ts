export const dict: Record<string, string> = {
  ...
  "ui.messagePart.compaction.running": "Komprimerar",
  "ui.messagePart.compaction.failed": "Sessionskomprimering misslyckades",
  "ui.messagePart.compaction.cancelled": "Sessionskomprimering avbröts",
  "ui.messagePart.compaction.interrupted": "Sessionskomprimering avbröts",
  "ui.messagePart.providerCompaction": "Session komprimerad av leverantör",
  "ui.messagePart.compaction.usage": "{{input}} in · {{output}} ut",
  "ui.messagePart.tools.used.one": "Använde {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Använde {{count}} {{tools}}",
  "ui.tool.browser": "Webbläsare",
  "ui.messagePart.context.thought.one": "Tanke",
  "ui.messagePart.context.thought.other": "Tankar",
  "ui.sessionTurn.retry.attemptWaiting.one": "Försök {{attempt}} upprepas om {{count}} sekund",
  "ui.sessionTurn.retry.attemptWaiting.other": "Försök {{attempt}} upprepas om {{count}} sekunder",
  ...
  "ui.promptInput.dropFiles.pdf": "Släpp PDF-filer eller andra filer för att lägga till dem",
  "ui.promptInput.dropFiles.imagePdf": "Släpp bilder, PDF-filer eller andra filer för att lägga till dem",
  "ui.promptInput.exitShell": "Avsluta",
  "ui.sessionTimeline.notice.agentChanged": "Agent ändrad",
  "ui.promptInput.placeholder.followUp": "Lägg till uppföljning, {{slash}} för kommandon, {{at}} för kontext…",
  "ui.promptInput.steer": "Styr",
  "ui.promptInput.queue": "Kö",
  "ui.promptInput.steerHint": "Skicka utan att avbryta",
  "ui.tool.loadedSkills.one": "Läste in färdigheten {{name}}",
  "ui.tool.loadedSkills.other": "Läste in färdigheterna {{name}}",
  "ui.tool.shell.exit": "Kommandot avslutades med kod {{code}}",
  "ui.tool.shell.timeout": "Tidsgränsen för kommandot överskreds",
  "ui.tool.shell.cancelled": "Kommandot avbröts",
  "ui.message.thought": "Tanke",
  "ui.sessionTimeline.notice.modelSwitched": "Bytte till {{model}}",
