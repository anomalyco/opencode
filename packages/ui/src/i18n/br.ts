export const dict = {
  "ui.common.fileCount.one": "{{count}} arquivo",
  "ui.common.fileCount.other": "{{count}} arquivos",
  "ui.common.fileCount.many": "{{count}} arquivos",
  "ui.messagePart.compaction.started": "Compactação da sessão iniciada",
  "ui.messagePart.compaction.running": "Compactação",
  "ui.messagePart.compaction.failed": "Falha na compactação da sessão",
  "ui.messagePart.compaction.cancelled": "Compactação de sessão cancelada",
  "ui.messagePart.compaction.interrupted": "Compactação da sessão interrompida",
  "ui.messagePart.providerCompaction": "Sessão compactada pelo provedor",
  "ui.messagePart.compaction.usage": "Entrada {{input}} · Saída {{output}}",
  "ui.messagePart.tools.used.one": "Usou {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Usou {{count}} {{tools}}",
  "ui.tool.browser": "Navegador",
  "ui.messagePart.context.thought.one": "Pensamento",
  "ui.messagePart.context.thought.other": "Pensamentos",
  "ui.messagePart.context.thought.many": "Pensamentos",
  "ui.messagePart.tools.used.many": "Usou {{count}} {{tools}}",
  "ui.sessionTurn.retry.attemptWaiting.one": "A tentativa {{attempt}} será repetida em {{count}} segundo",
  "ui.sessionTurn.retry.attemptWaiting.many": "A tentativa {{attempt}} será repetida em {{count}} segundos",
  "ui.sessionTurn.retry.attemptWaiting.other": "A tentativa {{attempt}} será repetida em {{count}} segundos",
  "ui.sessionTurn.retry.attemptRetryingNow": "Tentativa {{attempt}} — tentando novamente",
  "ui.sessionTurn.retry.attemptLabel": "Tentativa {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "Tentativa {{attempt}} - {{line}}",
  "ui.messagePart.context.details": "Detalhes",
  "ui.messagePart.context.notice.one": "{{count}} aviso",
  "ui.messagePart.context.notice.other": "{{count}} avisos",
  "ui.promptInput.dropFiles.image": "Solte imagens ou arquivos para adicionar",
  "ui.promptInput.dropFiles.pdf": "Solte PDFs ou arquivos para adicionar",
  "ui.promptInput.dropFiles.imagePdf": "Solte imagens, PDFs ou arquivos para adicionar",
  "ui.promptInput.exitShell": "Sair",
  "ui.sessionTimeline.notice.agentChanged": "Agente alterado",
  "ui.messagePart.context.notice.many": "{{count}} avisos",
  "ui.promptInput.placeholder.followUp":
    "Adicione uma mensagem de acompanhamento, {{slash}} para comandos, {{at}} para contexto…",
  "ui.promptInput.steer": "Orientar",
  "ui.promptInput.queue": "Fila",
  "ui.promptInput.steerHint": "Enviar sem interromper",
  "ui.tool.loadedSkills.one": "Skill {{name}} carregada",
  "ui.tool.loadedSkills.many": "Skills {{name}} carregadas",
  "ui.tool.loadedSkills.other": "Skills {{name}} carregadas",
  "ui.tool.shell.exit": "Comando encerrado com o código {{code}}",
  "ui.tool.shell.timeout": "O tempo limite do comando foi excedido",
  "ui.tool.shell.cancelled": "Comando cancelado",
  "ui.message.thought": "Raciocínio",
  "ui.sessionTimeline.notice.modelSwitched": "Modelo alterado para {{model}}",
