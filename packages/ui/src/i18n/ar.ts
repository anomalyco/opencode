export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "أضف متابعة، \u2068{{slash}}\u2069 للأوامر، و\u2068{{at}}\u2069 للسياق...",
  "ui.promptInput.steer": "توجيه",
  "ui.promptInput.queue": "وضع في قائمة الانتظار",
  "ui.promptInput.steerHint": "إرسال دون مقاطعة",
  "ui.tool.loadedSkills.zero": "لم يتم تحميل أي مهارات من \u2068{{name}}\u2069",
  "ui.tool.loadedSkills.one": "تم تحميل المهارة \u2068{{name}}\u2069",
  "ui.tool.loadedSkills.two": "تم تحميل مهارتَي \u2068{{name}}\u2069",
  "ui.tool.loadedSkills.few": "تم تحميل مهارات \u2068{{name}}\u2069",
  "ui.tool.loadedSkills.many": "تم تحميل مهارات \u2068{{name}}\u2069",
  "ui.tool.loadedSkills.other": "تم تحميل مهارات \u2068{{name}}\u2069",
  "ui.tool.shell.exit": "خرج الأمر بالرمز {{code}}",
  "ui.tool.shell.timeout": "انتهت مهلة الأمر",
  "ui.tool.shell.cancelled": "أُلغي الأمر",
  "ui.message.thought": "فكرة",
  "ui.sessionTimeline.notice.modelSwitched": "تم التبديل إلى \u2068{{model}}\u2069",
  "ui.common.file.zero": "ملفات",
  "ui.common.file.two": "ملفان",
  "ui.common.file.few": "ملفات",
  "ui.common.file.many": "ملفًا",
  "ui.common.fileCount.zero": "\u2068{{count}}\u2069 ملف",
  "ui.common.fileCount.one": "\u2068{{count}}\u2069 ملف",
  "ui.common.fileCount.two": "\u2068{{count}}\u2069 ملفان",
  ...
  "ui.messagePart.context.notice.few": "{{count}} إشعارات",
  "ui.messagePart.context.notice.many": "{{count}} إشعارًا",
  "ui.messagePart.context.notice.other": "{{count}} إشعار",
  "ui.messagePart.context.thought.zero": "أفكار",
  "ui.messagePart.context.thought.one": "فكرة",
  "ui.messagePart.context.thought.two": "فكرتان",
  "ui.messagePart.context.thought.few": "أفكار",
  "ui.messagePart.context.thought.many": "فكرة",
  "ui.messagePart.context.thought.other": "فكرة",
  "ui.promptInput.dropFiles.image": "أفلت الصور أو الملفات لإضافتها",
  "ui.promptInput.dropFiles.pdf": "أفلت ملفات \u2068PDF\u2069 أو الملفات لإضافتها",
  "ui.promptInput.dropFiles.imagePdf": "أفلت الصور أو ملفات \u2068PDF\u2069 أو الملفات لإضافتها",
  "ui.promptInput.exitShell": "خروج",
  "ui.sessionTimeline.notice.agentChanged": "تم تغيير الوكيل",
  "ui.sessionTurn.retry.attemptWaiting.zero": "المحاولة {{attempt}} - إعادة المحاولة بعد {{count}} ث",
  "ui.sessionTurn.retry.attemptWaiting.one": "المحاولة {{attempt}} - إعادة المحاولة بعد {{count}} ث",
  "ui.sessionTurn.retry.attemptWaiting.two": "المحاولة {{attempt}} - إعادة المحاولة بعد {{count}} ث",
  "ui.sessionTurn.retry.attemptWaiting.few": "المحاولة {{attempt}} - إعادة المحاولة بعد {{count}} ث",
  "ui.sessionTurn.retry.attemptWaiting.many": "المحاولة {{attempt}} - إعادة المحاولة بعد {{count}} ث",
  "ui.sessionTurn.retry.attemptWaiting.other": "المحاولة {{attempt}} - إعادة المحاولة بعد {{count}} ث",
  "ui.sessionTurn.retry.attemptRetryingNow": "المحاولة {{attempt}} - جارٍ إعادة المحاولة",
  "ui.messagePart.compaction.started": "بدأ ضغط الجلسة",
  "ui.messagePart.compaction.running": "جارٍ الضغط",
  "ui.messagePart.compaction.failed": "فشل ضغط الجلسة",
  "ui.messagePart.compaction.cancelled": "أُلغي ضغط الجلسة",
  "ui.messagePart.compaction.interrupted": "قوطع ضغط الجلسة",
  "ui.messagePart.providerCompaction": "ضغط موفر الخدمة الجلسة",
  "ui.messagePart.compaction.usage": "{{input}} إدخال · {{output}} إخراج",
  "ui.messagePart.tools.used.one": "استُخدمت {{count}} أداة: \u2068{{tools}}\u2069",
  "ui.messagePart.tools.used.other": "استُخدمت {{count}} أداة: \u2068{{tools}}\u2069",
  "ui.tool.browser": "المتصفح",
  "ui.messagePart.tools.used.zero": "لم تُستخدم أي أداة من أصل \u2068{{count}}\u2069: \u2068{{tools}}\u2069",
