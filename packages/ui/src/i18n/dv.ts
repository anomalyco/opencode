export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.diffs.changed.many": "{{count}} ބަދަލުކޮށްފައިވާ ފައިލްތައް",
