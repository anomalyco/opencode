export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "הוסף הודעת המשך, \u2068{{slash}}\u2069 לפקודות, \u2068{{at}}\u2069 להקשר...",
  "ui.promptInput.steer": "הכוונה",
  "ui.promptInput.queue": "הוספה לתור",
  "ui.promptInput.steerHint": "שלח בלי להפריע",
  "ui.tool.loadedSkills.one": "המיומנות \u2068{{name}}\u2069 נטענה",
  "ui.tool.loadedSkills.two": "המיומנויות \u2068{{name}}\u2069 נטענו",
  "ui.tool.loadedSkills.other": "המיומנויות \u2068{{name}}\u2069 נטענו",
  "ui.tool.shell.exit": "הפקודה הסתיימה עם קוד {{code}}",
  "ui.tool.shell.timeout": "תם הזמן שהוקצב לפקודה",
  "ui.tool.shell.cancelled": "הפקודה בוטלה",
  "ui.message.thought": "מחשבה",
  "ui.sessionTimeline.notice.modelSwitched": "המודל הוחלף ל-\u2068{{model}}\u2069",
  "ui.common.file.two": "קבצים",
  "ui.common.fileCount.one": "\u2068{{count}}\u2069 קובץ",
  "ui.common.fileCount.two": "\u2068{{count}}\u2069 קבצים",
  "ui.common.fileCount.other": "\u2068{{count}}\u2069 קבצים",
  ...
  "ui.messagePart.context.thought.one": "מחשבה",
  "ui.messagePart.context.thought.two": "מחשבות",
  "ui.messagePart.context.thought.other": "מחשבות",
  "ui.promptInput.dropFiles.image": "שחרר תמונות או קבצים להוספה",
  "ui.promptInput.dropFiles.pdf": "שחרר קובצי \u2068PDF\u2069 או קבצים להוספה",
  "ui.promptInput.dropFiles.imagePdf": "שחרר תמונות, קובצי \u2068PDF\u2069 או קבצים להוספה",
  "ui.promptInput.exitShell": "יציאה",
  "ui.sessionTimeline.notice.agentChanged": "הסוכן השתנה",
  "ui.sessionTurn.retry.attemptWaiting.one": "ניסיון {{attempt}} - ניסיון חוזר בעוד {{count}} שנייה",
  "ui.sessionTurn.retry.attemptWaiting.two": "ניסיון {{attempt}} - ניסיון חוזר בעוד {{count}} שניות",
  "ui.sessionTurn.retry.attemptWaiting.other": "ניסיון {{attempt}} - ניסיון חוזר בעוד {{count}} שניות",
  "ui.sessionTurn.retry.attemptRetryingNow": "ניסיון {{attempt}} - מנסה שוב",
  "ui.messagePart.compaction.started": "דחיסת ההפעלה החלה",
  "ui.messagePart.compaction.running": "דוחס",
  "ui.messagePart.compaction.failed": "דחיסת ההפעלה נכשלה",
  "ui.messagePart.compaction.cancelled": "דחיסת ההפעלה בוטלה",
  "ui.messagePart.compaction.interrupted": "דחיסת ההפעלה נקטעה",
  "ui.messagePart.providerCompaction": "ההפעלה נדחסה על ידי הספק",
  "ui.messagePart.compaction.usage": "{{input}} קלט · {{output}} פלט",
  "ui.messagePart.tools.used.one": "נעשה שימוש ב-{{count}} כלי: \u2068{{tools}}\u2069",
