export const dict = {
  ...
  "ui.messagePart.tools.used": "Использованы инструменты: {{tools}}",
  ...
  "ui.messagePart.context.thought.one": "{{count}} мысль",
  "ui.messagePart.context.thought.other": "{{count}} мысли",
  ...
  "ui.messagePart.context.thought.few": "{{count}} мысли",
  "ui.messagePart.context.thought.many": "{{count}} мыслей",
