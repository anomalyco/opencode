export const dict = {
  ...
  "ui.messagePart.context.details": "Détails",
  "ui.messagePart.context.notice.one": "{{count}} avis",
  "ui.messagePart.context.notice.other": "{{count}} avis",
  "ui.messagePart.context.thought.one": "{{count}} pensée",
  "ui.messagePart.context.thought.other": "{{count}} pensées",
  ...
  "ui.messagePart.context.thought.many": "{{count}} pensées",
