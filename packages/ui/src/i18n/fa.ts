export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.diffs.changed.one": "{{count}} فایل تغییریافته",
  "ui.sessionTurn.diffs.changed.other": "{{count}} فایل تغییریافته",
  ...
  "ui.messagePart.context.read.one": "{{count}} بار خواندن",
  "ui.messagePart.context.read.other": "{{count}} بار خواندن",
  "ui.messagePart.context.search.one": "{{count}} جستجو",
  "ui.messagePart.context.search.other": "{{count}} جستجو",
  "ui.messagePart.context.list.one": "{{count}} فهرست‌گیری",
  "ui.messagePart.context.list.other": "{{count}} فهرست‌گیری",
