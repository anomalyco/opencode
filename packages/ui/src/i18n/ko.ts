export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "후속 메시지 추가, {{slash}} 명령어, {{at}} 컨텍스트...",
  "ui.promptInput.steer": "방향 지시",
  "ui.promptInput.queue": "대기열에 추가",
  "ui.promptInput.steerHint": "중단하지 않고 보내기",
  "ui.tool.loadedSkills.one": "{{name}} 스킬 불러옴",
  "ui.tool.loadedSkills.other": "{{name}} 스킬 불러옴",
  "ui.tool.shell.exit": "명령어가 코드 {{code}}(으)로 종료됨",
  "ui.tool.shell.timeout": "명령어 시간 초과",
  "ui.tool.shell.cancelled": "명령어 취소됨",
  "ui.message.thought": "생각",
  "ui.sessionTimeline.notice.modelSwitched": "{{model}}(으)로 전환됨",
  "ui.sessionTurn.retry.attemptLabel": "시도 {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "{{attempt}} 시도 - {{line}}",
  "ui.messagePart.context.details": "세부",
  "ui.messagePart.context.notice.one": "{{count}} 통지",
  "ui.messagePart.context.notice.other": "{{count}}개의 통지",
  "ui.messagePart.context.thought.one": "생각",
  "ui.messagePart.context.thought.other": "생각",
  "ui.promptInput.dropFiles.image": "추가할 이미지나 파일을 드롭하세요.",
  "ui.promptInput.dropFiles.pdf": "추가할 PDF 또는 파일을 드롭하세요.",
  "ui.promptInput.dropFiles.imagePdf": "추가할 이미지, PDF 또는 파일을 드롭하세요.",
  "ui.promptInput.exitShell": "출구",
  "ui.sessionTimeline.notice.agentChanged": "에이전트가 변경됨",

  "ui.sessionTurn.retry.attemptWaiting.one": "{{attempt}}번 시도 - {{count}}초 후에 재시도 중",
  "ui.sessionTurn.retry.attemptWaiting.other": "{{attempt}}번 시도 - {{count}}초 후에 재시도 중",
  "ui.sessionTurn.retry.attemptRetryingNow": "{{attempt}} 시도 - 재시도 중",
  "ui.messagePart.compaction.started": "세션 압축 시작됨",
  "ui.messagePart.compaction.running": "압축 중",
  "ui.messagePart.compaction.failed": "세션 압축 실패",
  "ui.messagePart.compaction.cancelled": "세션 압축 취소됨",
  "ui.messagePart.compaction.interrupted": "세션 압축 중단됨",
  "ui.messagePart.providerCompaction": "공급자가 세션을 압축함",
  "ui.messagePart.compaction.usage": "입력 {{input}} · 출력 {{output}}",
  "ui.messagePart.tools.used.one": "{{count}} {{tools}} 사용됨",
  "ui.messagePart.tools.used.other": "{{count}} {{tools}} 사용됨",
