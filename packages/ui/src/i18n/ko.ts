export const dict = {
  ...
  "ui.sessionTurn.error.addCredits": "문서 보기",

  "dialog.usageExceeded.freeTier.title": "무료 한도에 도달했습니다",
  "dialog.usageExceeded.freeTier.description":
    "공급자 무료 사용량 한도에 도달했습니다. 모델이나 공급자를 바꾸거나 API 요금제를 확인하세요.",
  "dialog.usageExceeded.freeTier.actionLabel": "문서",
  "dialog.usageExceeded.accountRateLimit.title": "사용량 한도에 도달했습니다",
  "dialog.usageExceeded.accountRateLimit.description":
    "사용량 한도에 도달했습니다. 모델이나 공급자를 바꾸거나 한도가 재설정될 때까지 기다리세요.",
  "dialog.usageExceeded.accountRateLimit.actionLabel": "문서 열기",
