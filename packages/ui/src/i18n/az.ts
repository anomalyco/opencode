export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.followUp": "Davam mesajı əlavə edin, əmrlər üçün {{slash}}, kontekst üçün {{at}}...",
  "ui.promptInput.steer": "İstiqamətləndir",
  "ui.promptInput.queue": "Növbə",
  "ui.promptInput.steerHint": "Dayandırmadan göndər",
  "ui.tool.loadedSkills.one": "{{name}} bacarığı yükləndi",
  "ui.tool.loadedSkills.other": "{{name}} bacarıqları yükləndi",
  "ui.tool.shell.exit": "Əmr {{code}} kodu ilə başa çatdı",
  "ui.tool.shell.timeout": "Əmrin vaxtı bitdi",
  "ui.tool.shell.cancelled": "Əmr ləğv edildi",
  "ui.message.thought": "Düşüncə",
  "ui.sessionTimeline.notice.modelSwitched": "{{model}} modelinə keçildi",
  "ui.sessionTurn.retry.attemptLabel": "Cəhd {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "Cəhd {{attempt}} - {{line}}",
  "ui.messagePart.context.details": "Təfərrüatlar",
  "ui.messagePart.context.notice.one": "{{count}} bildiriş",
  "ui.messagePart.context.notice.other": "{{count}} bildiriş",
  "ui.messagePart.context.thought.one": "fikir",
  "ui.messagePart.context.thought.other": "fikir",
  "ui.promptInput.dropFiles.image": "Şəkillər və ya fayllar əlavə etmək üçün buraya atın",
  "ui.promptInput.dropFiles.pdf": "PDF-lər və ya fayllar əlavə etmək üçün buraya atın",
  "ui.promptInput.dropFiles.imagePdf": "Şəkillər, PDF-lər və ya fayllar əlavə etmək üçün buraya atın",
  "ui.promptInput.exitShell": "Çıx",
  "ui.sessionTimeline.notice.agentChanged": "Agent dəyişdirildi",
  "ui.sessionTurn.retry.attemptWaiting.one": "Cəhd {{attempt}} - {{count}} saniyə sonra yenidən cəhd edilir",
  "ui.sessionTurn.retry.attemptWaiting.other": "Cəhd {{attempt}} - {{count}} saniyə sonra yenidən cəhd edilir",
  "ui.sessionTurn.retry.attemptRetryingNow": "Cəhd {{attempt}} - yenidən cəhd edilir",
  "ui.messagePart.compaction.started": "Sessiya sıxışdırılması başladı",
  "ui.messagePart.compaction.running": "Sıxışdırılır",
  "ui.messagePart.compaction.failed": "Sessiya sıxışdırılması uğursuz oldu",
  "ui.messagePart.compaction.cancelled": "Sessiya sıxışdırılması ləğv edildi",
  "ui.messagePart.compaction.interrupted": "Sessiya sıxışdırılması dayandırıldı",
  "ui.messagePart.providerCompaction": "Sessiya təminatçı tərəfindən sıxışdırıldı",
  "ui.messagePart.compaction.usage": "{{input}} daxil · {{output}} çıxış",
  "ui.messagePart.tools.used.one": "{{count}} {{tools}} istifadə edildi",
  "ui.messagePart.tools.used.other": "{{count}} {{tools}} istifadə edildi",
  "ui.tool.browser": "Brauzer",
  "ui.common.fileCount.one": "{{count}} fayl",
  "ui.common.fileCount.other": "{{count}} fayl",
}
