export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.normal": "Har qanday narsani so'rang, buyruqlar uchun {{slash}}, kontekst uchun {{at}}…",
  ...
  "ui.messagePart.context.thought.other": "ta fikr",
  "ui.promptInput.dropFiles.image": "Rasm yoki fayllarni qo‘shish uchun tashlang",
  "ui.promptInput.dropFiles.pdf": "PDF yoki fayllarni qo‘shish uchun tashlang",
  "ui.promptInput.dropFiles.imagePdf": "Rasm, PDF yoki fayllarni qo‘shish uchun tashlang",
  "ui.promptInput.exitShell": "Chiqish",
  "ui.sessionTimeline.notice.agentChanged": "Agent o‘zgardi",
  "ui.sessionTurn.retry.attemptWaiting.one": "Urinish {{attempt}} - {{count}} soniyadan keyin qayta uriniladi",
  "ui.sessionTurn.retry.attemptWaiting.other": "Urinish {{attempt}} - {{count}} soniyadan keyin qayta uriniladi",
  "ui.sessionTurn.retry.attemptRetryingNow": "Urinish {{attempt}} - qayta urinilmoqda",
  "ui.messagePart.compaction.started": "Seansni siqish boshlandi",
  "ui.messagePart.compaction.running": "Siqilish",
  "ui.messagePart.compaction.failed": "Seansni siqish amalga oshmadi",
  "ui.messagePart.compaction.cancelled": "Seansni siqish bekor qilindi",
  "ui.messagePart.compaction.interrupted": "Seansni siqish uzildi",
  "ui.messagePart.providerCompaction": "Seans provayder tomonidan ixchamlashtirilgan",
  "ui.messagePart.compaction.usage": "{{input}} ichida · {{output}} chiqdi",
  "ui.messagePart.tools.used.one": "Ishlatilgan {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Ishlatilgan {{count}} {{tools}}",
