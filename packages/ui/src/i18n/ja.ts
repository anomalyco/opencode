export const dict = {
  ...
  "ui.messagePart.tools.used": "{{tools}}を使用しました",
  ...
  "ui.messagePart.context.details": "詳細",
  "ui.messagePart.context.notice.one": "{{count}} 通知",
  "ui.messagePart.context.notice.other": "{{count}} 件の通知",
  "ui.messagePart.context.thought.one": "{{count}} 個の考え",
  "ui.messagePart.context.thought.other": "{{count}} 件の感想",
