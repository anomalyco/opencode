...
export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "Takip iletisi ekleyin; komutlar için {{slash}}, bağlam için {{at}}...",
  "ui.promptInput.steer": "Yönlendir",
  "ui.promptInput.queue": "Sıraya al",
  "ui.promptInput.steerHint": "Kesintiye uğratmadan gönder",
  "ui.tool.loadedSkills.one": "{{name}} becerisi yüklendi",
  "ui.tool.loadedSkills.other": "{{name}} becerileri yüklendi",
  "ui.tool.shell.exit": "Komut {{code}} koduyla sonlandı",
  "ui.tool.shell.timeout": "Komut zaman aşımına uğradı",
  "ui.tool.shell.cancelled": "Komut iptal edildi",
  "ui.message.thought": "Düşünce",
  ...
  "ui.messagePart.context.thought.other": "Düşünceler",
  "ui.promptInput.dropFiles.image": "Eklenecek resimleri veya dosyaları bırakın",
  "ui.promptInput.dropFiles.pdf": "Eklenecek PDF'leri veya dosyaları bırakın",
  "ui.promptInput.dropFiles.imagePdf": "Eklenecek görselleri, PDF'leri veya dosyaları bırakın",
  "ui.promptInput.exitShell": "Çıkış",
  "ui.sessionTimeline.notice.agentChanged": "Temsilci değişti",
  "ui.sessionTurn.retry.attemptRetryingNow": "{{attempt}} denemesi - yeniden deneniyor",
  "ui.sessionTurn.retry.attemptWaiting.one": "Deneme {{attempt}} - {{count}} sn sonra yeniden deneniyor",
  "ui.sessionTurn.retry.attemptWaiting.other": "Deneme {{attempt}} - {{count}} sn sonra yeniden deneniyor",
  "ui.messagePart.compaction.started": "Oturum sıkıştırma başladı",
  "ui.messagePart.compaction.running": "Sıkıştırma",
  "ui.messagePart.compaction.failed": "Oturum sıkıştırma başarısız oldu",
  "ui.messagePart.compaction.cancelled": "Oturum sıkıştırma iptal edildi",
  "ui.messagePart.compaction.interrupted": "Oturum sıkıştırması kesintiye uğradı",
  "ui.messagePart.providerCompaction": "Oturum sağlayıcı tarafından sıkıştırıldı",
  "ui.messagePart.compaction.usage": "{{input}} giriş · {{output}} çıkış",
  "ui.messagePart.tools.used.one": "İkinci el {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "İkinci el {{count}} {{tools}}",
