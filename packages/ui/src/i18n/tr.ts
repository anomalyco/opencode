...
export const dict = {
  ...
  "ui.messagePart.tools.used": "Kullanılan araçlar: {{tools}}",
  ...
  "ui.messagePart.context.thought.one": "{{count}} Düşünce",
  "ui.messagePart.context.thought.other": "{{count}} Düşünceler",
