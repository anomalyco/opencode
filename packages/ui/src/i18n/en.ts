export const dict: Record<string, string> = {
  ...
  "ui.promptInput.voice.start": "Hold to speak",
  "ui.promptInput.voice.recording": "Release to send",
  "ui.promptInput.voice.processing": "Processing voice input...",
  ...
  "settings.general.row.voiceModel.title": "Transcription model",
  "settings.general.row.voiceModel.description": "Model used to convert recorded audio to text.",
  "settings.general.row.voiceLanguage.title": "Spoken language",
  "settings.general.row.voiceLanguage.description": "Language used by the transcription model.",
  "settings.general.row.voiceLanguage.auto": "Automatic",
  "settings.general.row.voiceLanguage.russian": "Russian",
  "settings.general.row.voiceLanguage.english": "English",
