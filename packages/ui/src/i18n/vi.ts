export const dict: Record<string, string> = {
  ...
  "ui.messagePart.context.read.one": "{{count}} lượt đọc",
  ...
  "ui.promptInput.placeholder.followUp": "Thêm nội dung tiếp theo, {{slash}} để dùng lệnh, {{at}} để thêm ngữ cảnh...",
  "ui.promptInput.steer": "Điều hướng",
  "ui.promptInput.queue": "Xếp hàng",
  "ui.promptInput.steerHint": "Gửi mà không gián đoạn",
  "ui.tool.loadedSkills.one": "Đã tải kỹ năng {{name}}",
  "ui.tool.loadedSkills.other": "Đã tải kỹ năng {{name}}",
  "ui.tool.shell.exit": "Lệnh đã thoát với mã {{code}}",
  "ui.tool.shell.timeout": "Lệnh đã hết thời gian chờ",
  "ui.tool.shell.cancelled": "Lệnh đã bị hủy",
  "ui.message.thought": "Suy nghĩ",
  "ui.sessionTimeline.notice.modelSwitched": "Đã chuyển sang {{model}}",
  "ui.sessionTurn.retry.attemptLabel": "Lần thử {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "Lần thử {{attempt}} - {{line}}",
  "ui.messagePart.context.details": "Chi tiết",
  "ui.messagePart.context.notice.one": "{{count}} Thông báo",
  "ui.messagePart.context.notice.other": "{{count}} Thông báo",
  "ui.messagePart.context.thought.one": "Suy nghĩ",
  "ui.messagePart.context.thought.other": "Suy nghĩ",
  "ui.promptInput.dropFiles.image": "Thả hình ảnh hoặc tập tin để thêm",
  "ui.promptInput.dropFiles.pdf": "Thả tệp PDF hoặc tệp để thêm",
  "ui.promptInput.dropFiles.imagePdf": "Thả hình ảnh, tệp PDF hoặc tệp để thêm",
  "ui.promptInput.exitShell": "Thoát",
  "ui.sessionTimeline.notice.agentChanged": "Đã đổi tác tử",

  "ui.sessionTurn.retry.attemptWaiting.one": "Hãy thử {{attempt}} - thử lại sau {{count}} giây",
  "ui.sessionTurn.retry.attemptWaiting.other": "Hãy thử {{attempt}} - thử lại sau {{count}} giây",
  "ui.sessionTurn.retry.attemptRetryingNow": "Cố gắng {{attempt}} - đang thử lại",
  "ui.messagePart.compaction.started": "Đã bắt đầu nén phiên",
  "ui.messagePart.compaction.running": "Đang nén",
  "ui.messagePart.compaction.failed": "Nén phiên thất bại",
  "ui.messagePart.compaction.cancelled": "Nén phiên đã bị hủy",
  "ui.messagePart.compaction.interrupted": "Nén phiên bị gián đoạn",
  "ui.messagePart.providerCompaction": "Phiên được nén bởi nhà cung cấp",
  "ui.messagePart.compaction.usage": "{{input}} vào · {{output}} ra",
  "ui.messagePart.tools.used.one": "Đã sử dụng {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Đã sử dụng {{count}} {{tools}}",
