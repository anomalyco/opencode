export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.followUp": "Tambah susulan, {{slash}} untuk arahan, {{at}} untuk konteks...",
  "ui.promptInput.steer": "Halakan",
  "ui.promptInput.queue": "Baris gilir",
  "ui.promptInput.steerHint": "Hantar tanpa mengganggu",
  "ui.tool.loadedSkills.one": "Memuatkan kemahiran {{name}}",
  "ui.tool.loadedSkills.other": "Memuatkan kemahiran {{name}}",
  "ui.tool.shell.exit": "Arahan tamat dengan kod {{code}}",
  "ui.tool.shell.timeout": "Arahan tamat masa",
  "ui.tool.shell.cancelled": "Arahan dibatalkan",
  "ui.message.thought": "Pemikiran",
  "ui.sessionTimeline.notice.modelSwitched": "Bertukar kepada {{model}}",
  "ui.sessionTurn.retry.attemptLabel": "Percubaan {{attempt}}",
  "ui.sessionTurn.retry.attemptRetrying": "Percubaan {{attempt}} - {{line}}",
  "ui.messagePart.context.details": "Butiran",
  "ui.messagePart.context.notice.one": "{{count}} Notis",
  "ui.messagePart.context.notice.other": "{{count}} Notis",
  "ui.messagePart.context.thought.one": "Pemikiran",
  "ui.messagePart.context.thought.other": "Pemikiran",
  "ui.promptInput.dropFiles.image": "Lepaskan imej atau fail untuk ditambahkan",
  "ui.promptInput.dropFiles.pdf": "Lepaskan PDF atau fail untuk ditambahkan",
  "ui.promptInput.dropFiles.imagePdf": "Lepaskan imej, PDF atau fail untuk ditambahkan",
  "ui.promptInput.exitShell": "Keluar",
  "ui.sessionTimeline.notice.agentChanged": "Ejen bertukar",

  "ui.sessionTurn.retry.attemptWaiting.one": "Percubaan {{attempt}} - mencuba semula dalam {{count}}s",
  "ui.sessionTurn.retry.attemptWaiting.other": "Percubaan {{attempt}} - mencuba semula dalam {{count}}s",
  "ui.sessionTurn.retry.attemptRetryingNow": "Percubaan {{attempt}} - mencuba semula",
  "ui.messagePart.compaction.started": "Pemadatan sesi dimulakan",
  "ui.messagePart.compaction.running": "Memadatkan",
  "ui.messagePart.compaction.failed": "Pemadatan sesi gagal",
  "ui.messagePart.compaction.cancelled": "Pemadatan sesi dibatalkan",
  "ui.messagePart.compaction.interrupted": "Pemadatan sesi terganggu",
  "ui.messagePart.providerCompaction": "Sesi dipadatkan oleh penyedia",
  "ui.messagePart.compaction.usage": "{{input}} masuk · {{output}} keluar",
  "ui.messagePart.tools.used.one": "Menggunakan {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Menggunakan {{count}} {{tools}}",
