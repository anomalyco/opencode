export const dict: Record<string, string> = {
  ...
  "ui.messagePart.tools.used": "Használt eszközök: {{tools}}",
  ...
  "ui.messagePart.context.thought.one": "{{count}} Gondolat",
  "ui.messagePart.context.thought.other": "{{count}} Gondolatok",
