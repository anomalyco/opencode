export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.followUp": "Követő üzenet hozzáadása, {{slash}} a parancsokhoz, {{at}} a kontextushoz...",
  "ui.promptInput.steer": "Irányítás",
  "ui.promptInput.queue": "Sorba állítás",
  "ui.promptInput.steerHint": "Küldés megszakítás nélkül",
  "ui.tool.loadedSkills.one": "A(z) {{name}} készség betöltve",
  "ui.tool.loadedSkills.other": "A(z) {{name}} készségek betöltve",
  "ui.tool.shell.exit": "A parancs {{code}} kóddal lépett ki",
  "ui.tool.shell.timeout": "A parancs túllépte az időkorlátot",
  "ui.tool.shell.cancelled": "A parancs megszakítva",
  "ui.message.thought": "Gondolat",
  ...
  "ui.messagePart.context.thought.other": "Gondolatok",
  "ui.promptInput.dropFiles.image": "Húzza le a hozzáadandó képeket vagy fájlokat",
  "ui.promptInput.dropFiles.pdf": "Dobja el a hozzáadandó PDF-eket vagy fájlokat",
  "ui.promptInput.dropFiles.imagePdf": "Húzza le a hozzáadandó képeket, PDF-eket vagy fájlokat",
  "ui.promptInput.exitShell": "Kilépés",
  "ui.sessionTimeline.notice.agentChanged": "Az ügynök megváltozott",
  "ui.sessionTurn.retry.attemptRetryingNow": "{{attempt}} – újrapróbálkozás",
  "ui.sessionTurn.retry.attemptWaiting.one": "{{attempt}}. kísérlet – újrapróbálkozás {{count}} mp múlva",
  "ui.sessionTurn.retry.attemptWaiting.other": "{{attempt}}. kísérlet – újrapróbálkozás {{count}} mp múlva",
  "ui.messagePart.compaction.started": "A munkamenet tömörítés megkezdődött",
  "ui.messagePart.compaction.running": "Tömörítés",
  "ui.messagePart.compaction.failed": "A munkamenet tömörítése nem sikerült",
  "ui.messagePart.compaction.cancelled": "Munkamenet tömörítés megszakítva",
  "ui.messagePart.compaction.interrupted": "A munkamenet tömörítése megszakadt",
  "ui.messagePart.providerCompaction": "A munkamenetet tömörítette a szolgáltató",
  "ui.messagePart.compaction.usage": "{{input}} be · {{output}} ki",
  "ui.messagePart.tools.used.one": "Használt {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Használt {{count}} {{tools}}",
