...
export const dict = {
  ...
  "ui.promptInput.placeholder.followUp": "新增後續訊息，輸入 {{slash}} 使用命令，輸入 {{at}} 加入上下文...",
  "ui.promptInput.steer": "引導",
  "ui.promptInput.queue": "排入佇列",
  "ui.promptInput.steerHint": "傳送但不中斷",
  "ui.tool.loadedSkills.one": "已載入技能 {{name}}",
  "ui.tool.loadedSkills.other": "已載入技能 {{name}}",
  "ui.tool.shell.exit": "命令已結束，結束代碼為 {{code}}",
  "ui.tool.shell.timeout": "命令逾時",
  "ui.tool.shell.cancelled": "命令已取消",
  "ui.message.thought": "思考",
  "ui.sessionTimeline.notice.modelSwitched": "已切換至 {{model}}",
  "ui.sessionTurn.retry.attemptLabel": "第 {{attempt}} 次嘗試",
  "ui.sessionTurn.retry.attemptRetrying": "試 {{attempt}} - {{line}}",
  "ui.messagePart.context.details": "細節",
  "ui.messagePart.context.notice.one": "{{count}} 通知",
  "ui.messagePart.context.notice.other": "{{count}} 條通知",
  "ui.messagePart.context.thought.one": "思考",
  "ui.messagePart.context.thought.other": "思考",
  "ui.promptInput.dropFiles.image": "拖放要新增的圖像或文件",
  "ui.promptInput.dropFiles.pdf": "拖放要新增的 PDF 或文件",
  "ui.promptInput.dropFiles.imagePdf": "拖放要新增的圖像、PDF 或文件",
  "ui.promptInput.exitShell": "出口",
  "ui.sessionTimeline.notice.agentChanged": "代理變更",

  "ui.sessionTurn.retry.attemptWaiting.one": "嘗試 {{attempt}} - 在 {{count}} 秒內重試",
  "ui.sessionTurn.retry.attemptWaiting.other": "嘗試 {{attempt}} - 在 {{count}} 秒內重試",
  "ui.sessionTurn.retry.attemptRetryingNow": "試 {{attempt}} - 重試",
  "ui.messagePart.compaction.started": "工作階段壓縮已開始",
  "ui.messagePart.compaction.running": "正在壓縮",
  "ui.messagePart.compaction.failed": "工作階段壓縮失敗",
  "ui.messagePart.compaction.cancelled": "工作階段壓縮已取消",
  "ui.messagePart.compaction.interrupted": "工作階段壓縮中斷",
  "ui.messagePart.providerCompaction": "工作階段已由提供者壓縮",
  "ui.messagePart.compaction.usage": "{{input}} 輸入 · {{output}} 輸出",
  "ui.messagePart.tools.used.one": "使用了 {{count}} 個 {{tools}}",
  "ui.messagePart.tools.used.other": "使用了 {{count}} 個 {{tools}}",
  "ui.tool.browser": "瀏覽器",
