...
export const dict = {
  ...
  "ui.sessionReview.diffStyle.split": "分割",
  ...
  "ui.sessionReview.largeDiff.title": "差異過大，無法呈現",
  "ui.sessionReview.largeDiff.meta": "限制：{{limit}} 行變更。目前：{{current}} 行變更。",
  "ui.sessionReview.largeDiff.renderAnyway": "仍然呈現",
  ...
  "ui.sessionReviewV2.unifiedDiff": "統一差異",
  "ui.sessionReviewV2.splitDiff": "分割差異",
  ...
  "ui.sessionTurn.status.runningCommands": "正在執行指令",
  ...
  "ui.messagePart.context.list.one": "{{count}} 個列表",
  "ui.messagePart.context.list.other": "{{count}} 個列表",
  ...
  "ui.messagePart.review.title": "檢視你的答案",
