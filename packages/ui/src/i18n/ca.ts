export const dict: Record<string, string> = {
  ...
  "ui.promptInput.placeholder.followUp": "Afegiu un seguiment, {{slash}} per a ordres, {{at}} per al context...",
  "ui.promptInput.steer": "Redirigeix",
  ...
  "ui.tool.loadedSkills.many": "S'han carregat les habilitats {{name}}",
  "ui.tool.loadedSkills.other": "S'han carregat les habilitats {{name}}",
  "ui.tool.shell.exit": "L'ordre ha acabat amb el codi {{code}}",
  "ui.tool.shell.timeout": "S'ha esgotat el temps d'espera de l'ordre",
  "ui.tool.shell.cancelled": "S'ha cancel·lat l'ordre",
  "ui.message.thought": "Pensament",
  "ui.sessionTimeline.notice.modelSwitched": "S'ha canviat al model {{model}}",
  "ui.common.file.many": "fitxers",
  ...
  "ui.promptInput.dropFiles.image": "Deixa anar imatges o fitxers per afegir",
  "ui.promptInput.dropFiles.pdf": "Deixa anar PDF o fitxers per afegir",
  "ui.promptInput.dropFiles.imagePdf": "Deixa anar imatges, PDF o fitxers per afegir",
  "ui.promptInput.exitShell": "Sortida",
  "ui.sessionTimeline.notice.agentChanged": "L'agent ha canviat",
  "ui.messagePart.context.notice.many": "{{count}} avisos",
  "ui.messagePart.context.thought.many": "pensaments",
  "ui.sessionTurn.retry.attemptRetryingNow": "Intent {{attempt}}: torna a intentar-ho",
  "ui.sessionTurn.retry.attemptWaiting.one": "Intent {{attempt}}: es tornarà a provar d’aquí a {{count}} s",
  "ui.sessionTurn.retry.attemptWaiting.many": "Intent {{attempt}}: es tornarà a provar d’aquí a {{count}} s",
  "ui.sessionTurn.retry.attemptWaiting.other": "Intent {{attempt}}: es tornarà a provar d’aquí a {{count}} s",
  "ui.messagePart.compaction.started": "La compactació de la sessió ha començat",
  "ui.messagePart.compaction.running": "Compactació",
  "ui.messagePart.compaction.failed": "La compactació de la sessió ha fallat",
  "ui.messagePart.compaction.cancelled": "La compactació de la sessió s'ha cancel·lat",
  "ui.messagePart.compaction.interrupted": "Compactació de la sessió interrompuda",
  "ui.messagePart.providerCompaction": "Sessió compactada pel proveïdor",
  "ui.messagePart.compaction.usage": "{{input}} entra · {{output}} fora",
  "ui.messagePart.tools.used.one": "Usat {{count}} {{tools}}",
  "ui.messagePart.tools.used.other": "Usat {{count}} {{tools}}",
  "ui.tool.browser": "Navegador",
  "ui.messagePart.tools.used.many": "Usat {{count}} {{tools}}",
