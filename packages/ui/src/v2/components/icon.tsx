...
const icons = {
  ...
  task: {
    viewBox: "0 0 20 20",
    body: `<path d="M9.99992 4.0835V17.9168M7.08325 5.75016H2.08325V16.2502H7.08325M12.9166 16.2502H17.9166V5.75016H12.9166" stroke="currentColor" stroke-linecap="square"/>`,
  },
  status: {
    viewBox: "0 0 20 20",
