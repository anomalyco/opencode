...
const icons = {
  ...
  puzzle: {
    viewBox: "0 0 16 16",
    body: `<path d="M2.5 2.5H7V7H2.5V2.5ZM9 2.5H13.5V7H9V2.5ZM2.5 9H7V13.5H2.5V9ZM9 9H13.5V13.5H9V9Z" stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"/>`,
  },
  nodes: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 2.5C8.66 2.5 9.2 3.04 9.2 3.7C9.2 4.36 8.66 4.9 8 4.9C7.34 4.9 6.8 4.36 6.8 3.7C6.8 3.04 7.34 2.5 8 2.5ZM2 13.5C2.66 13.5 3.2 12.96 3.2 12.3C3.2 11.64 2.66 11.1 2 11.1C1.34 11.1 0.8 11.64 0.8 12.3C0.8 12.96 1.34 13.5 2 13.5ZM14 13.5C14.66 13.5 15.2 12.96 15.2 12.3C15.2 11.64 14.66 11.1 14 11.1C13.34 11.1 12.8 11.64 12.8 12.3C12.8 12.96 13.34 13.5 14 13.5ZM6.8 3.8L3 11.2M9.2 3.8L13 11.2" stroke="currentColor" stroke-linecap="square"/>`,
  },
}
