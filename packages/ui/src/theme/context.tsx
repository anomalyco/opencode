...
const STORAGE_KEYS = {
  THEME_ID: "cyberstrike-theme-id",
  COLOR_SCHEME: "cyberstrike-color-scheme",
  THEME_CSS_LIGHT: "cyberstrike-theme-css-light",
  THEME_CSS_DARK: "cyberstrike-theme-css-dark",
} as const
