...
const light: Record<string, V2ColorValue> = {
  ...
  "v2-background-bg-layer-01": ref("v2-grey-200"),
  "v2-background-bg-layer-02": ref("v2-grey-300"),
  "v2-background-bg-layer-03": ref("v2-grey-400"),
...
const dark: Record<string, V2ColorValue> = {
  ...
  "v2-background-bg-layer-01": ref("v2-grey-900"),
  "v2-background-bg-layer-02": ref("v2-grey-800"),
  "v2-background-bg-layer-03": ref("v2-grey-700"),
