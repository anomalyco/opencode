...
const light: Record<string, V2ColorValue> = {
  ...
  "v2-background-bg-accent": ref("v2-orange-800"),
  "v2-text-text-inverse": ref("v2-grey-100"),
  "v2-text-text-contrast": ref("v2-grey-100"),
  "v2-text-text-accent": ref("v2-orange-800"),
  "v2-text-text-accent-hover": ref("v2-orange-900"),
  "v2-text-text-code-accent": ref("v2-orange-1000"),
  ...
  "v2-border-border-focus": ref("v2-orange-700"),
...
const dark: Record<string, V2ColorValue> = {
  ...
  "v2-text-text-contrast": ref("v2-grey-100"),
  "v2-text-text-accent": ref("v2-orange-400"),
  "v2-text-text-accent-hover": ref("v2-orange-300"),
  "v2-text-text-code-accent": ref("v2-orange-400"),
  ...
  "v2-border-border-focus": ref("v2-orange-500"),
