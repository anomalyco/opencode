...
export function SessionTurn(
  ...
  const permissions = createMemo(() => list((data.store as any).permission?.[props.sessionID], emptyPermissions))
  const nextPermission = createMemo(() => permissions()[0])

  const questions = createMemo(() => list((data.store as any).question?.[props.sessionID], emptyQuestions))
