...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/f5xc-salesdemos/xcsh/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("xcsh-version", Installation.VERSION)
