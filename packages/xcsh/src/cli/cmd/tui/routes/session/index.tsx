...
export function Session() {
  ...
  // FORK: default sidebar to hidden; upstream defaults to "auto" (shows on wide terminals)
  // Re-apply this change after upstream syncs — tracked in GitHub issues
  ...
  const [footerVisible] = kv.signal("footer_visible", true)
  ...
  command.register(() => [
    ...
    },
    {
      ...
      keybind: "display_assistant_metadata",
      category: "Session",
      slash: {
        name: "metadata",
        aliases: ["toggle-metadata"],
      },
      onSelect: (dialog) => {
  ...
  return (
    <Show when={props.part.text.trim()}>
      <box id={"text-" + props.part.id} paddingLeft={3} marginTop={1} flexShrink={0}>
        <Switch>
          <Match when={Flag.XCSH_EXPERIMENTAL_MARKDOWN}>
            <markdown
              syntaxStyle={syntax()}
              streaming={true}
