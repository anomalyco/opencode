  ...
  spinner: z
    .object({
      ...
      hold_start: z
        ...
        .max(200)
        .optional()
        .describe("Frames to hold at the left/start position (default: 60)"),
      hold_end: z
        .number()
        .min(0)
        .max(200)
        .optional()
        .describe("Frames to hold at the right/end position (default: 20)"),
      ...
      inactive_factor: z
        ...
        .max(1)
        .optional()
        .describe("Alpha for inactive dots, 0=invisible 1=full (default: 0.5)"),
      min_alpha: z
        .number()
        .min(0)
        .max(1)
        .optional()
        .describe("Minimum alpha during fade, higher=more visible pulse (default: 0.4)"),
    })
    .optional()
