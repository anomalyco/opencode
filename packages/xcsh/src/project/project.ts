...
export namespace Project {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@xcsh/Project") {}
  ...
  > = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const fakeVcs = Info.shape.vcs.parse(Flag.XCSH_FAKE_VCS)
      ...
      const fromDirectory = Effect.fn("Project.fromDirectory")(function* (directory: string) {
        ...
        if (Flag.XCSH_EXPERIMENTAL_ICON_DISCOVERY)
