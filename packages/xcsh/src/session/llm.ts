...
export namespace LLM {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@xcsh/LLM") {}
  ...
  export async function stream(input: StreamRequest) {
    ...
    // from the workflow service are executed via xcsh's tool system
      ...
      headers: {
        ...(input.model.providerID.startsWith("opencode")
          ? {
              ...
              "x-opencode-client": Flag.XCSH_CLIENT,
            }
          : {
