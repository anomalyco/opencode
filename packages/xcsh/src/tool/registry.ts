...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@f5xc-salesdemos/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@xcsh/ToolRegistry") {}
    ...
    Effect.gen(function* () {
      ...
      const all = Effect.fn("ToolRegistry.all")(function* (custom: Tool.Info[]) {
        ...
        return [
          ...
          SkillTool,
          ApplyPatchTool,
          ...(Flag.XCSH_EXPERIMENTAL_LSP_TOOL ? [LspTool] : []),
          ...(cfg.experimental?.batch_tool === true ? [BatchTool] : []),
          ...(Flag.XCSH_EXPERIMENTAL_PLAN_MODE && Flag.XCSH_CLIENT === "cli" ? [PlanExitTool] : []),
          ...custom,
        ]
      })
