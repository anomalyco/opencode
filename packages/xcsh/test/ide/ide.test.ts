...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders XCSH_CALLER", () => {
    process.env["XCSH_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode XCSH_CALLER", () => {
    process.env["XCSH_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown XCSH_CALLER", () => {
    process.env["XCSH_CALLER"] = "unknown"
