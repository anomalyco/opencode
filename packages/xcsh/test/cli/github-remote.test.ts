...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/xcsh.git")).toEqual({ owner: "sst", repo: "xcsh" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/xcsh")).toEqual({ owner: "sst", repo: "xcsh" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/xcsh.git")).toEqual({ owner: "sst", repo: "xcsh" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/xcsh")).toEqual({ owner: "sst", repo: "xcsh" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/xcsh.git")).toEqual({ owner: "sst", repo: "xcsh" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/xcsh")).toEqual({ owner: "sst", repo: "xcsh" })
})
