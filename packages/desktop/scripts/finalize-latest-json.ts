...
const releaseId = process.env.LEAKCODE_RELEASE
if (!releaseId) throw new Error("LEAKCODE_RELEASE is required")

const version = process.env.LEAKCODE_VERSION
if (!version) throw new Error("LEAKCODE_VERSION is required")
