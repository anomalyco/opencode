...
const targets = [
  { key: "linux-x86_64-deb", asset: "athena-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "athena-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "athena-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "athena-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "athena-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "athena-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "athena-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "athena-desktop-darwin-aarch64.app.tar.gz",
  },
]
