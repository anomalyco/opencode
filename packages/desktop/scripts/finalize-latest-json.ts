...
const releaseId = process.env.IMECODE_RELEASE
if (!releaseId) throw new Error("IMECODE_RELEASE is required")

const version = process.env.IMECODE_VERSION
if (!version) throw new Error("IMECODE_VERSION is required")
