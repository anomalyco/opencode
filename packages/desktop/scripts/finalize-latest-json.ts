...
const releaseId = process.env.OCTOPUS_RELEASE
if (!releaseId) throw new Error("OCTOPUS_RELEASE is required")

const version = process.env.OCTOPUS_VERSION
if (!version) throw new Error("OCTOPUS_VERSION is required")
