...
const releaseId = process.env.PENCODE_RELEASE
if (!releaseId) throw new Error("PENCODE_RELEASE is required")

const version = process.env.PENCODE_VERSION
if (!version) throw new Error("PENCODE_VERSION is required")
...
const macxTarGz = "pencode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "pencode-desktop-mac-arm64.app.tar.gz"
