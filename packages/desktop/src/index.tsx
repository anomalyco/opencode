...
import { Fonts, MarkedProvider } from "@chalicecode-ai/ui"
...
const host = import.meta.env.VITE_CHALICECODE_SERVER_HOST ?? "127.0.0.1"
const port = import.meta.env.VITE_CHALICECODE_SERVER_PORT ?? "4096"
