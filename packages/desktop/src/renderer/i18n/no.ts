export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Cedric",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Cedric er lastet ned. Vil du installere den og starte på nytt?",
