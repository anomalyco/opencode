export const dict = {
  ...
  "desktop.updater.none.message": "Pencode'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Pencode'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'pencode' komutunu kullanmak için terminalinizi yeniden başlatın.",
