export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Cedric",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Cedric. ¿Quieres instalarla y reiniciar?",
