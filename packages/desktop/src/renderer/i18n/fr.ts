export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Cedric",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Cedric a été téléchargée. Voulez-vous l'installer et redémarrer ?",
