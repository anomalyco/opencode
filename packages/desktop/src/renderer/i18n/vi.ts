export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của Jarvis",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của Jarvis đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
