export const dict = {
  ...
  "desktop.updater.none.message": "Pencode-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Pencode-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'pencode' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
