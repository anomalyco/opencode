export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Jarvisn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Jarvisn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Jarvisn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'jarvis'-komentoa.",
