export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Cedric",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Cedric er blevet downloadet. Vil du installere den og genstarte?",
