export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Pencode-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Pencode-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «pencode» հրամանն օգտագործելու համար:",
