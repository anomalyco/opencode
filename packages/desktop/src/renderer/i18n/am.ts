export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የPencode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከPencode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
