export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Pencode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Pencode is gedownload. Wil je deze installeren en Pencode opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'pencode' te gebruiken.",
