export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Jarvis",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Jarvis is gedownload. Wil je deze installeren en Jarvis opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'jarvis' te gebruiken.",
