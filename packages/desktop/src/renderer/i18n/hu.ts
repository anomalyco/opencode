export const dict = {
  ...
  "desktop.updater.none.message": "Már az OpenCode legújabb verzióját használod",
  ...
  "desktop.updater.downloaded.prompt":
    "Az OpenCode {{version}} verziója letöltődött. Telepíted és újraindítod az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsd újra a terminált az 'opencode' parancs használatához.",
  "desktop.cli.failed.title": "A telepítés sikertelen",
  "desktop.cli.failed.message": "A CLI telepítése sikertelen: {{error}}",

  "desktop.error.dev.rootNotFound":
    "A gyökérelem nem található. Elfelejtetted hozzáadni az index.html fájlhoz, vagy elírtad az id attribútumot?",
}
