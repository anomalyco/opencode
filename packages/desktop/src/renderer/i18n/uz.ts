export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Pencode ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Pencodening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'pencode' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
