export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Cedric",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Cedric wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
