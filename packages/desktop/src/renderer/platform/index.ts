...
export function createDesktopPlatform(
  ...
  return {
    ...
    getKeepAwakeEnabled: () => api.getKeepAwakeEnabled(),
    setKeepAwakeEnabled: (enabled) => api.setKeepAwakeEnabled(enabled),
    setKeepAwakeActive: (active) => api.setKeepAwakeActive(active),
