export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Athena er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Athena Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Athena CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
