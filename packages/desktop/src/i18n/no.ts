export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenSec",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenSec er lastet ned. Vil du installere den og starte på nytt?",
