export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Athena. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Athena",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Athena. Intenta reinstalar la aplicación de escritorio.",
