...
import { dict as appSq } from "../../../app/src/i18n/sq"
...
function detectLocale(): Locale {
  ...
  for (const language of languages) {
    ...
    if (language.toLowerCase().startsWith("sq")) return "sq"
  }
...
function build(locale: Locale): Dictionary {
  ...
  if (locale === "sq") return { ...base, ...i18n.flatten(appSq), ...i18n.flatten(desktopSq) }
