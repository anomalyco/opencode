export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Athena a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'athena'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'Athena",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Athena est manquant. Essayez de réinstaller l'application de bureau.",
