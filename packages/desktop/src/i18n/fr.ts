export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenSec",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenSec a été téléchargée. Voulez-vous l'installer et redémarrer ?",
