export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Athena er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'athena'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "Athena CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
