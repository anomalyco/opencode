export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Athena を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Athena のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'athena' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "Athena ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Athena CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
