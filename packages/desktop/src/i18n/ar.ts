export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Athena",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Athena، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Athena",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Athena CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
