export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Athena foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Athena",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Athena está ausente. Tente reinstalar o aplicativo de desktop.",
