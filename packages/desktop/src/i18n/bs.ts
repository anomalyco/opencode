export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Athena-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Athena-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'athena'.",
  ...
  "desktop.menu.help.documentation": "Athena Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Athena CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
