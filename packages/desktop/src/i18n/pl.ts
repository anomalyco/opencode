export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Athena. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'athena'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Athena",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Athena CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
