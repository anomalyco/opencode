export const dict = {
  ...
  "desktop.menu.help.documentation": "Athena Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Athena has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'athena' command.",
  ...
  "desktop.cli.error.sidecarMissing": "Athena CLI binary is missing. Try reinstalling the desktop app.",
