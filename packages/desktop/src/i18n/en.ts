export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of CyberStrike",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of CyberStrike has been downloaded, would you like to install it and relaunch?",
