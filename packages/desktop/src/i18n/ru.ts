export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Athena",
  ...
  "desktop.updater.downloaded.prompt": "Версия Athena {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'athena'.",
  ...
  "desktop.menu.help.documentation": "Документация Athena",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Athena CLI. Попробуйте переустановить настольное приложение.",
