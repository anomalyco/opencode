export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Athena",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Athena wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'athena' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "Athena-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Athena CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
