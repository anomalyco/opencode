...
import { FileSystem, Integration, Permission, Project, Reference, Session } from "../src"
...
describe("public event manifest", () => {
  ...
  test("uses canonical definitions for current public events", () => {
    ...
    expect(EventManifest.Definitions).toEqual(
      expect.arrayContaining([SessionV1.Event.PartDelta, SessionV1.Event.Diff, SessionV1.Event.Error]),
    )
