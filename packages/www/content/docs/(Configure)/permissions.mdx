...
configured reference directories. These exceptions apply to every agent but do
not grant general external-directory access. Later global and agent-specific
