...
<Callout type="tip">
  If supported V1 functionality does not work in V2, follow the issue-reporting guidance in [Troubleshooting](/troubleshooting)
  and file a compatibility issue.
</Callout>
