...
3. In OpenCode, run `/connect`, select **Azure**, choose **Microsoft Entra ID (Azure CLI)**, and enter the resource name.
   If `AZURE_RESOURCE_NAME` is already set, OpenCode uses it without prompting.
