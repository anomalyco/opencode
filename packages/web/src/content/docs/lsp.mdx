---
title: LSP Servers
description: OpenSec integrates with your LSP servers.
---

OpenSec integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

OpenSec comes with several built-in LSP servers for popular languages:
