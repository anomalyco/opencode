...
| **Docker Agent**        | [Issue #4164](https://github.com/docker/docker-agent/issues/4164) has a proposed fix in [PR #4190](https://github.com/docker/docker-agent/pull/4190), which has not yet merged.                                                                        |
