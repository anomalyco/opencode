...
- **5-hour limit** — 20% of your usage quota
- **Weekly limit** — 50% of your usage quota
- **Monthly limit** — 100% of your usage quota

These limits are percentages of a shared usage quota across all models.

### Usage by model

Included monthly usage varies by model and is valued at official API prices. Token prices are per 1M tokens.

| Model                                   | Input  | Output | Cached Read | Cached Write | Monthly usage |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | ------------- |
...
Your request count depends on the model's monthly usage and API prices. The estimates below use typical Go usage patterns.
