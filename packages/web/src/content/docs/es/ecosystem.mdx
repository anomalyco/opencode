...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Rastrea el uso del proveedor en OpenCode con un diálogo TUI nativo mediante el sencillo comando `/usage` |
