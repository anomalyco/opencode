...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Plugin de OAuth de Google Antigravity con recuperación dinámica de modelos, seguimiento de cuotas y persistencia de estado de turnos |
