...
| [opencode-kilo-gateway](https://github.com/RespectMathias/opencode-kilo-gateway)                   | Añade inicio de sesión por dispositivo con OAuth para Kilo Gateway en OpenCode.                                             |
