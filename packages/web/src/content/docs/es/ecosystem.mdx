...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Complemento Google Antigravity OAuth, compatible con la Búsqueda de Google y manejo más sólido de API                       |
