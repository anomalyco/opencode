...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Suite multi-agente ligera con 7 agentes especializados (Orchestrator, Explorer, Oracle, etc.) |
