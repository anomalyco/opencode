...
La opción `mode` ahora está en desuso. [Más información](./agents).
:::
...
Consulte también: [Formateadores](./formatters) para obtener información sobre la configuración de formato de código.
