...
- `.leak-code/plugins/` - Complementos a nivel de proyecto
- `~/.config/leak-code/plugins/` - Complementos globales
...
1. Configuración global (`~/.config/leak-code/leak-code.json`)
2. Configuración del proyecto (`leak-code.json`)
3. Directorio global de complementos (`~/.config/leak-code/plugins/`)
4. Directorio de complementos del proyecto (`.leak-code/plugins/`)
