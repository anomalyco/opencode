---
title: Compartir
description: Comparte tus conversaciones Octopus.
---

La función para compartir de Octopus te permite crear enlaces públicos a tus conversaciones de Octopus, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Octopus:
...
Octopus admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Octopus usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `octopus.json` en su proyecto y regístrelo en Git.
