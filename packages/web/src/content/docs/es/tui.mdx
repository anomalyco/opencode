---
title: TUI
description: Usando la interfaz de usuario del terminal xcsh.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

xcsh proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar xcsh se inicia TUI para el directorio actual.
...
Cuando utilice xcsh TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a xcsh. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `xcsh.json`, que configura el comportamiento del servidor/tiempo de ejecución.
