...
Esto es independiente de `leak-code.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `LEAKCODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
