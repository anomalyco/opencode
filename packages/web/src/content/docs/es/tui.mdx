---
title: TUI
description: Usando la interfaz de usuario del terminal Octopus.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Octopus proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Octopus se inicia TUI para el directorio actual.
...
Cuando utilice Octopus TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Octopus. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Octopus. _Alias_: `/quit`, `/q`
...
Esto es independiente de `octopus.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `OCTOPUS_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
