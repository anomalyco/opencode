...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Debe tener entre 1 y 64 caracteres.                                                               |
| `description` | `string` | yes      | Debe tener entre 1 y 1024 caracteres. Se muestra al agente para que pueda decidir cuándo cargar la habilidad. |

Todos los demás campos de frontmatter se ignoran de forma segura.

:::tip
Mantenga la descripción lo suficientemente específica para que el agente elija correctamente.
:::
