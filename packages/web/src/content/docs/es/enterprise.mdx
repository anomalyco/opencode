...
OpenCode es de código abierto y no almacena ningún código ni datos de contexto, por lo que sus desarrolladores pueden simplemente [comenzar](./) y realizar una prueba.
...
[Más información sobre cómo compartir](./share).
