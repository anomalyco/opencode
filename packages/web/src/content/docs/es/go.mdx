...
- Qwen3.8 Flash — patrón de petición estimado: 600 tokens de entrada, 58,000 tokens leídos de caché y 200 tokens de salida por petición; excluye escrituras en caché
