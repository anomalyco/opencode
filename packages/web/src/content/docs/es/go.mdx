...
| **Docker Agent**        | El [issue #4164](https://github.com/docker/docker-agent/issues/4164) tiene una corrección propuesta en el [PR #4190](https://github.com/docker/docker-agent/pull/4190), que aún no se ha fusionado.                                                                   |
