...
- **Límite de 5 horas** — 20 % de tu cuota de uso
- **Límite semanal** — 50 % de tu cuota de uso
- **Límite mensual** — 100 % de tu cuota de uso

Estos límites son porcentajes de una cuota de uso compartida entre todos los modelos.

### Uso por modelo

El uso mensual incluido varía según el modelo y se valora según sus precios oficiales de API. Los precios de tokens se indican por 1M tokens.

| Modelo                                  | Entrada | Salida | Lectura en caché | Escritura en caché | Uso mensual |
| --------------------------------------- | ------- | ------ | ---------------- | ------------------ | ---- |
...
La cantidad de peticiones depende del uso mensual del modelo y de sus precios de API. Las estimaciones siguientes se basan en los patrones típicos de uso de Go.
