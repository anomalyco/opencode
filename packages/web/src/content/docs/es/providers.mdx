...
probado y verificado para funcionar bien con OpenCode. [Más información](./zen).
...
OpenCode Zen es una lista de modelos probados y verificados proporcionada por el equipo OpenCode. [Más información](./zen).
...
- **apiKey**: se configura usando la sintaxis de la variable `env`, [más información](./config#env-vars).
