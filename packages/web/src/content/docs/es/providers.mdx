...
4. **Habilita los modelos en tu espacio de trabajo.** Ve a Zen y asegúrate de que los modelos de Go (GLM-5, Kimi K2.5, MiniMax M2.5) estén habilitados.

5. Ejecuta `/models` en la TUI para ver la lista de modelos disponibles a través de Go.
