...
Crear `.octopus/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Octopus o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Octopus [config](/docs/config):
