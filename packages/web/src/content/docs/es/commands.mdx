...
Crear `.cyberstrike/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CyberStrike o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CyberStrike [config](/docs/config):
...
- Por proyecto: `.cyberstrike/commands/`
...
cyberstrike incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
