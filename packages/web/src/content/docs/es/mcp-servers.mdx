...
Los valores de configuración local anulan los valores predeterminados remotos. Consulte [precedencia de configuración](./config#precedence-order) para obtener más detalles.
...
2. En su [configuración del agente](./agents#tools), habilite el servidor MCP como herramienta.
...
Alternativamente, puede agregar algo como esto a su [AGENTS.md](./rules/).
