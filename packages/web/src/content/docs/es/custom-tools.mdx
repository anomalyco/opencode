...
description: Cree herramientas que LLM pueda llamar en cyberstrike.
---

Las herramientas personalizadas son funciones que usted crea y que el LLM puede llamar durante las conversaciones. Trabajan junto con las [herramientas integradas](/docs/tools) de cyberstrike como `read`, `write` y `bash`.
...
- Localmente colocándolos en el directorio `.cyberstrike/tools/` de tu proyecto.
- O de forma global, colocándolos en `~/.config/cyberstrike/tools/`.
