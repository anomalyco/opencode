...
El [ID del modelo](./config/#models) en su configuración OpenCode
...
Es posible que notes _Claude Haiku 3.5_ en tu historial de uso. Este es un [modelo de bajo costo](./config/#models) que se utiliza para generar los títulos de tus sesiones.
