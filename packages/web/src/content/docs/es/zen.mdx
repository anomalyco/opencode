---
title: Zen
description: Lista seleccionada de modelos proporcionada por Octopus.
---
...
Octopus Zen es una lista de modelos probados y verificados proporcionada por el equipo de Octopus.

:::note
Octopus Zen está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en Octopus. Inicias sesión en Octopus Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Octopus.
:::
...
Octopus Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Octopus Zen funciona como cualquier otro proveedor en Octopus.

1. Inicias sesión en **<a href={console}>Octopus Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Octopus Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Octopus
...
- MiniMax M2.5 Free está disponible en Octopus por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ring 2.6 1T Free está disponible en Octopus por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en Octopus por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Octopus por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Octopus.
