...
Si tiene un rendimiento lento, problemas de acceso a archivos o problemas de terminal en Windows, intente usar [WSL (Windows Subsistema para Linux)](./windows-wsl). WSL proporciona un entorno Linux que funciona de manera más fluida con las funciones de OpenCode.
...
1. Primero, verifique que su proveedor esté configurado correctamente siguiendo la [guía de proveedores](./providers)
