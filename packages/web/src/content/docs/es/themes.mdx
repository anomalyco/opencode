...
2. **Directorio de configuración de usuario**: definido en `~/.config/leak-code/themes/*.json` o `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.leak-code/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.leak-code/themes/*.json`
