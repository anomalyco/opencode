...
3. **Configuración personalizada** (`IMECODE_CONFIG` env var): anulaciones personalizadas
...
6. **Configuración en línea** (`IMECODE_CONFIG_CONTENT` env var): anulaciones del tiempo de ejecución
...
Especifique una ruta de archivo de configuración personalizada utilizando la variable de entorno `IMECODE_CONFIG`.
...
Especifique un directorio de configuración personalizado usando `IMECODE_CONFIG_DIR`
