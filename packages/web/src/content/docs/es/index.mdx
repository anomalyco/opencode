...
[**OpenCode**](/) es un agente de codigo de IA de código abierto. Está disponible como interfaz de terminal, aplicación de escritorio o extensión para IDE.
...
También puede instalarlo con alguno de los siguientes métodos:
...
También puede descargar el binario desde [Versiones](https://github.com/anomalyco/opencode/releases).
...
1. Ejecute el comando `/connect` en la TUI, seleccione opencode y vaya a [opencode.ai/auth](https://opencode.ai/auth).
...
:::tip
Use la tecla @ para realizar una búsqueda aproximada de archivos dentro del proyecto.
:::
...
Para personalizarlo, le recomendamos [elegir un tema](/docs/themes), [personalizar las combinaciones de teclas](/docs/keybinds), [configurar formateadores de código](/docs/formatters), [crear comandos personalizados](/docs/commands) o explorar la [configuración OpenCode](/docs/config).
