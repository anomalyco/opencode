...
Para obtener la mejor experiencia en Windows, recomendamos utilizar [Subsistema Windows para Linux (WSL)](./windows-wsl). Proporciona un mejor rendimiento y compatibilidad total con las funciones de OpenCode.
:::
...
Si es nuevo en el uso de proveedores LLM, le recomendamos usar [OpenCode Zen](./zen).
...
Alternativamente, puede seleccionar uno de los otros proveedores. [Más información](./providers#directory).
...
Para personalizarlo, recomendamos [elegir un tema](./themes), [personalizar las combinaciones de teclas](./keybinds), [configurar formateadores de código](./formatters), [crear comandos personalizados](./commands) o jugar con la [configuración OpenCode](./config).
