...
Create `.octopus/commands/test.md`:
...
You can add custom commands through the Octopus config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Octopus [config](/docs/config):
