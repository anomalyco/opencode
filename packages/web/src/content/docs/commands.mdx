...
Create `.chalicecode/command/test.md`:

```md title=".chalicecode/command/test.md"
---
...
You can add custom commands through the ChaliceCode config or by creating markdown files in the `command/` directory.

---

### JSON

Use the `command` option in your ChaliceCode [config](/docs/config):
...
- Global: `~/.config/chalice-code/command/`
- Per-project: `.chalicecode/command/`

```markdown title="~/.config/chalice-code/command/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".chalicecode/command/component.md"
---
...
```md title=".chalicecode/command/create-file.md"
---
...
```md title=".chalicecode/command/analyze-coverage.md"
---
...
```md title=".chalicecode/command/review-changes.md"
---
...
```md title=".chalicecode/command/review-component.md"
---
