...
You can add custom commands through the OpenSec config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenSec [config](/docs/config):
