...
- `.leak-code/plugins/` - 專案級外掛
- `~/.config/leak-code/plugins/` - 全域外掛
...
1. 全域設定 (`~/.config/leak-code/leak-code.json`)
2. 專案設定 (`leak-code.json`)
3. 全域外掛目錄 (`~/.config/leak-code/plugins/`)
4. 專案外掛目錄 (`.leak-code/plugins/`)
