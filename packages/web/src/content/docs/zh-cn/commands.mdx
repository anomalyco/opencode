...
你可以通过 Octopus 配置或在 `commands/` 目录中创建 markdown 文件来添加自定义命令。

---

### JSON

在 Octopus [配置](/docs/config)中使用 `command` 选项：
...
- 全局：`~/.config/octopus/commands/`
- 项目级：`.octopus/commands/`
