...
默认情况下，OpenCode 使用我们自己的 `___W1___` 主题。
...
| ---------------------- | ---------------------------------------------------------------------------- |
| `system` |适应您所处的背景颜色|
| `tokyonight` | 基于 [Tokyonight](___T1___) 主题 |
| `everforest` | 基于 [Everforest](___T1___) 主题 |
| `ayu` | 基于 [Ayu](___T1___) 黑暗主题 |
| `catppuccin` | 基于 [Catppuccin](___T1___) 主题 |
| `catppuccin-macchiato` | 基于 [Catppuccin](___T1___) 主题 |
| `gruvbox` | 基于 [Gruvbox](___T1___) 主题 |
| `kanagawa` | 基于 [神奈川](___T1___) 主题 |
| `nord` | 基于 [Nord](___T1___) 主题 |
| `matrix` | 骇客风格黑底绿主题|
| `one-dark` | 基于 [Atom One](___T1___) 黑暗主题 |
...
您可以通过使用 `/theme` 命令调出主题选择来选择主题。或者您可以在 [config](./config) 中指定它。
...
2. **用户配置目录** - 在 `~/.config/___W0___/themes/*.json` 或 `$XDG_CONFIG_HOME/___W0___/themes/*.json` 中定义
3. **專案根目錄** - 在 `<project-root>/.___W0___/themes/*.json` 中定義
4. **当前工作目录** - 在 `./.___W0___/themes/*.json` 中定义
