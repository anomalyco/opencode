---
title: SDK
description: cyberstrike 服务器的类型不同于安全 JS 客户端。
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

cyberstrike JS/TS SDK 提供类型其他安全的客户端用于与服务器交互。
使用它以程序设计方式构建集成和控制cyberstrike。
...
如果您已经有 cyberstrike 的正在执行示例项，则可以创建一个客户端示例项来连线到它：
