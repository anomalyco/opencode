...
- 專案配置：`.___W0___/skills/<name>/SKILL.md`
- 全域性配置：`~/.config/___W0___/skills/<name>/SKILL.md`
...
它会加载 `.___W0___/` 中任何匹配的 `skills/*/SKILL.md` 以及一路上任何匹配的 `.claude/skills/*/SKILL.md` 或 `.agents/skills/*/SKILL.md`。

全域性定义也从 `~/.config/___W0___/skills/*/SKILL.md`、`~/.claude/skills/*/SKILL.md` 和 `~/.agents/skills/*/SKILL.md` 加载。
...
像这样建立`.___W0___/skills/git-release/SKILL.md`：
...
使用 `___W0___.json` 中基于模式的许可权限控制客服人员可以访问哪些技能：
