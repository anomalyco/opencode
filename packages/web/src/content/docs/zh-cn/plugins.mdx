...
- `.leak-code/plugins/` - 项目级插件
- `~/.config/leak-code/plugins/` - 全局插件
...
1. 全局配置 (`~/.config/leak-code/leak-code.json`)
2. 项目配置 (`leak-code.json`)
3. 全局插件目录 (`~/.config/leak-code/plugins/`)
4. 项目插件目录 (`.leak-code/plugins/`)
