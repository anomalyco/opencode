...
ACP 是一个开放协议，用于标准化代码编辑器与 AI 编码智能体之间的通信。
...
打开方式：在 AI Chat 智能体选择器中选择新的 'OpenCode' 智能体。
...
要在 [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) 中将 OpenCode 用作 ACP 智能体，请将以下内容添加到你的 Neovim 配置中：
