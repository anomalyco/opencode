---
title: 分享
description: 分享您的 cyberstrike 对话。
---

cyberstrike 的共享功能允许您建立指向 cyberstrike 对话的公共链接，以便您可以与蓝牙进行战斗或从其他人那里获得帮助。
...
cyberstrike 支持三种控制对话共享方式的共享模式：

---

### 手动（默认）

在默认情况下，cyberstrike 使用手动共享模式。会话不会自动共享，但您可以使用 `/share` 命令手动共享它们：
...
为了在您的团队中针对特定项目强制执行此操作，请将其添加到您项目的 `cyberstrike.json` 文件中，并将其提交到Git。
...
[了解更多关于在您的组织中使用cyberstrike的](/docs/enterprise)。
