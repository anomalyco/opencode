---
title: Paylasim
description: cyberstrike konusmalarini genel baglantilarla paylasin.
---

cyberstrike'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda cyberstrike:
...
cyberstrike, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak cyberstrike manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `cyberstrike.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda cyberstrike kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
