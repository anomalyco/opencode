---
title: Paylasim
description: xcsh konusmalarini genel baglantilarla paylasin.
---

xcsh'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda xcsh:
...
xcsh, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak xcsh manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `xcsh.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda xcsh kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
