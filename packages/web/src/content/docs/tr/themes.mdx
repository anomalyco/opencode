...
2. **Kullanıcı yapılandırma dizini** - `~/.config/octopus/themes/*.json` veya `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Proje kök dizini** - `<project-root>/.octopus/themes/*.json`
4. **Geçerli çalışma dizini** - `./.octopus/themes/*.json`
