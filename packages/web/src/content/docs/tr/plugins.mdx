...
- `.leak-code/plugins/` - Proje düzeyinde eklentiler
- `~/.config/leak-code/plugins/` - Genel eklentiler
...
1. Global config (`~/.config/leak-code/leak-code.json`)
2. Project config (`leak-code.json`)
3. Global eklenti dizini (`~/.config/leak-code/plugins/`)
4. Proje eklenti dizini (`.leak-code/plugins/`)
