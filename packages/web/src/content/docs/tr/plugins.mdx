...
Örnekler için topluluk tarafından oluşturulan [plugins](./ecosystem#plugins)'a göz atın.
...
[ecosystem](./ecosystem#plugins)'daki mevcut eklentilere göz atın.
...
**Yerel eklentiler** doğrudan eklenti dizininden yüklenir. Harici paketleri kullanmak için, sisteminizin dizininde bir `package.json` oluşturmanız (bkz. [Dependencies](#dependencies)) veya eklentiyi npm ve [add it to your config](./config#plugins)'de yayınlamanız gerekir.
