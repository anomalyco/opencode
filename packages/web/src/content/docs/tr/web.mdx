...
:::tip[Windows Users]
En iyi deneyim için PowerShell yerine `opencode web`'yi [WSL](./windows-wsl)'den çalıştırın. Bu, uygun dosya sistemi erişimini ve terminal entegrasyonunu sağlar.
:::
...
Web sunucusunu komut satırı bayraklarıyla veya [config dosyanızda](./config) yapılandırabilirsiniz.
