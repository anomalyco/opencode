...
| [my-opencode-deepseek-config](https://github.com/znlgis/my-opencode-deepseek-config)       | OpenCode × DeepSeek V4 optimal config with multi-agent orchestration, model-aware routing, and 15+ skills |
