...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Dinamik model alma, kota takibi ve tur durumu kalıcılığı özelliklerine sahip Google Antigravity OAuth eklentisi |
