...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin)                         | Apify Store'daki binlerce güvenilir scraper, crawler ve otomasyon ile herhangi bir web sitesinden veri çıkarın. |
