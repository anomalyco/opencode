...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | OpenCode içinde sağlayıcı kullanımını, basit `/usage` komutuyla yerel bir TUI iletişim kutusunda izleyin |
