...
:::caution
`--hostname 0.0.0.0` kullaniyorsaniz sunucuyu guvene almak icin `OCTOPUS_SERVER_PASSWORD` ayarlayin.
...
- opencode konfigurasyonunuz ve oturumlariniz WSL ortaminda `~/.local/share/octopus/` konumunda saklanir
