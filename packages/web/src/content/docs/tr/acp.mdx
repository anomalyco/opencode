...
OpenCode, JetBrains IDE'lerinde ACP Registry üzerinden kullanılabilir.

Kullanmak için JetBrains AI Assistant eklentisini yükleyin veya güncelleyin, AI Chat'i açın ve sohbet modu seçicisinden **Install From ACP Registry** seçeneğini seçin. Ayrıca **Settings | Tools | AI Assistant | Agents** bölümüne gidebilirsiniz. **OpenCode** arayın, yükleyin, ayarları uygulayın ve ardından AI Chat ajan seçicisinden **OpenCode**'u seçin.

Kayıt girdisi: `opencode`

Daha fazla ayrıntı için [JetBrains ACP belgelerine](https://www.jetbrains.com/help/ai-assistant/acp.html) ve [ACP Registry belgelerine](https://agentclientprotocol.com/get-started/registry) bakın.
