...
opencode'u ACP aracılığıyla kullanmak için düzenleyicinizi `leak-code acp` komutunu çalıştıracak şekilde yapılandırın.
...
Ortam değişkenlerini (`LEAKCODE_API_KEY` gibi) iletmeniz gerekiyorsa, tüm ayrıntılar için CodeCompanion.nvim belgelerindeki [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key)'ye bakın.
