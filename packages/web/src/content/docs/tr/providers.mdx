...
OpenCode ile iyi çalıştığı test edildi ve doğrulandı. [Learn more](./zen).
...
abonelik](https://github.com/features/copilot/plans) kullanmak için.
...
OpenCode Zen, OpenCode ekibi tarafından sağlanan test edilmiş ve doğrulanmış modellerin bir listesidir. [Learn more](./zen).
...
- **apiKey**: `env` değişken söz dizimini kullanarak ayarlayın, [learn more](./config#env-vars).
