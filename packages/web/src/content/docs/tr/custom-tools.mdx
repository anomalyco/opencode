---
title: Özel Araçlar
description: LLM'un cyberstrike'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. cyberstrike'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.cyberstrike/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/cyberstrike/tools/` içine yerleştirerek.
