---
title: Özel Araçlar
description: LLM'un pencode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. pencode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.pencode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/pencode/tools/` içine yerleştirerek.
