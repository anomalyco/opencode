---
title: Özel Araçlar
description: LLM'un xcsh'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. xcsh'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.xcsh/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/xcsh/tools/` içine yerleştirerek.
