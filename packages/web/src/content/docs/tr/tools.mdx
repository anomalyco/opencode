...
Araclar, LLM'in kod tabaninizda eylem gerceklestirmesini saglar. OpenCode yerlesik bir arac setiyle gelir, ancak bunu [ozel araclarla](./custom-tools) veya [MCP sunuculariyla](./mcp-servers) genisletebilirsiniz.

Varsayilan olarak tum araclar **etkindir** ve calismak icin izin istemez. Arac davranisini [izinler](./permissions) uzerinden kontrol edebilirsiniz.
...
Izin yapilandirmasi icin [daha fazla bilgi alin](./permissions).
...
Projeniz icin kullanilabilir LSP sunucularini ayarlamak icin [LSP Servers](./lsp) sayfasina bakin.
...
Bir [skill](./skills) (`SKILL.md` dosyasi) yukler ve icerigini konusmaya dondurur.
...
:::note
Bu arac alt ajanlar icin varsayilan olarak devre disidir, ama manuel etkinlestirebilirsiniz. [Daha fazla bilgi](./agents/#permissions)
:::
...
Ozel arac olusturma icin [daha fazla bilgi alin](./custom-tools).
...
MCP sunucularini yapilandirma icin [daha fazla bilgi alin](./mcp-servers).
