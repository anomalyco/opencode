...
description: xcsh, LSP sunucularınızla bütünleşir.
---

xcsh, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

xcsh, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP sunucularını, xcsh yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
