...
description: Octopus, LSP sunucularınızla bütünleşir.
---

Octopus, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

Octopus, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`OCTOPUS_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
