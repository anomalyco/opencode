...
| **Docker Agent**        | [Issue #4164](https://github.com/docker/docker-agent/issues/4164) için [PR #4190](https://github.com/docker/docker-agent/pull/4190) içinde bir düzeltme önerilmiştir ancak henüz birleştirilmemiştir.                                                                          |
