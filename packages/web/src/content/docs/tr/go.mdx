...
- **5 saatlik limit** — %20 oranında kullanım kotası
- **Haftalık limit** — %50 oranında kullanım kotası
- **Aylık limit** — %100 oranında kullanım kotası

Bu limitler, tüm modellerin paylaştığı kullanım kotasının yüzdeleridir.

### Modele göre kullanım

Sunulan aylık kullanım modele göre değişir ve resmi API fiyatları üzerinden hesaplanır. Token fiyatları 1M token başına verilmiştir.

| Model                                   | Input  | Output | Cached Read | Cached Write | Aylık kullanım |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | -------- |
...
İstek sayısı, modelin aylık kullanımına ve API fiyatlarına bağlıdır. Aşağıdaki tahminler tipik Go kullanım modellerine dayanır.
