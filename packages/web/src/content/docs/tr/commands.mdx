...
`.cyberstrike/commands/test.md` oluştur:
...
cyberstrike işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

cyberstrike [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/cyberstrike/commands/`
- Proje başına: `.cyberstrike/commands/`
...
cyberstrike, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
