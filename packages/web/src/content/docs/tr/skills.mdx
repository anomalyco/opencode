...
- Proje konfigurasyonu: `.octopus/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/octopus/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.octopus/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/octopus/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.octopus/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`octopus.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`octopus.json` icinde):
