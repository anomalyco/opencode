...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | 1-64 karakter uzunluğunda olmalıdır.                                                              |
| `description` | `string` | yes      | 1-1024 karakter uzunluğunda olmalıdır. Ajanın beceriyi ne zaman yükleyeceğine karar verebilmesi için gösterilir. |

Diğer tüm frontmatter alanları güvenle yok sayılır.

:::tip
Ajanın doğru seçim yapması için açıklamayı yeterince spesifik tutun.
:::
