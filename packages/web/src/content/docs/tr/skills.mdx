...
- Proje konfigurasyonu: `.leak-code/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/leak-code/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.leak-code/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/leak-code/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.leak-code/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`leak-code.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`leak-code.json` icinde):
