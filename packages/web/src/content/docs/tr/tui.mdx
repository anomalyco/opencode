...
Komutlarin cogu, lider tusu `ctrl+x` olan bir kisayola da sahiptir. [Daha fazla bilgi](./keybinds).
...
`AGENTS.md` dosyasini olusturur veya gunceller. [Daha fazla bilgi](./rules).
...
Mevcut oturumu paylasir. [Daha fazla bilgi](./share).
...
Mevcut oturumun paylasimini kaldirir. [Daha fazla bilgi](./share#paylasimi-kaldirma).
