---
title: TUI
description: cyberstrike terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

cyberstrike, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

cyberstrike'u calistirdiginizda mevcut dizin icin TUI baslar.
...
cyberstrike TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
cyberstrike'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
cyberstrike'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini cyberstrike config dosyanizdan ozellestirebilirsiniz.
