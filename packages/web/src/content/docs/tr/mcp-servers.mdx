...
Yerel yapılandırma değerleriniz uzak varsayılanları geçersiz kılar. Daha fazla ayrıntı için [config precedence](./config#precedence-order)'a bakın.
...
2. [agent config](./agents#tools)'nizde, MCP sunucusunu bir araç olarak etkinleştirin.
...
Alternatif olarak [AGENTS.md](./rules/)'a buna benzer bir şey ekleyebilirsiniz.
