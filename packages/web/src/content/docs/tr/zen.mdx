...
OpenCode config'inizdeki [model id](./config/#models), `opencode/<model-id>` formatini kullanir.
...
Kullanim gecmisinizde _Claude Haiku 3.5_ gorebilirsiniz. Bu, oturum basliklarini olusturmak icin kullanilan [dusuk maliyetli bir modeldir](./config/#models).
