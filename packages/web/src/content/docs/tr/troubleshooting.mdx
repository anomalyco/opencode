...
Windows'ta yavaslik, dosya erisim sorunlari veya terminal problemleri yasiyorsaniz [WSL (Windows Subsystem for Linux)](./windows-wsl) kullanmayi deneyin. WSL, OpenCode ozellikleriyle daha sorunsuz calisan bir Linux ortami saglar.
...
1. Once [providers rehberini](./providers) izleyerek provider kurulumunun dogru oldugunu dogrulayin
