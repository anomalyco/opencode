...
Agent'ları `leak-code.json` yapılandırma dosyanızda yapılandırın:
...
:::tip
Mevcut modellerin listesini görmek için `leak-code models` komutunu çalıştırın.
:::
