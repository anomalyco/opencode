...
OpenCode açık kaynaktır ve herhangi bir kodunuzu veya içerik verilerinizi saklamaz; böylece geliştiricileriniz [get started](./) yapıp bir deneme gerçekleştirebilir.
