...
description: xcsh dile özgü biçimlendiriciler kullanır.
---

xcsh, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

xcsh, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, xcsh bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

xcsh bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri xcsh yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
