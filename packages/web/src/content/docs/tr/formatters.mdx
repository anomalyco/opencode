...
description: cyberstrike dile özgü biçimlendiriciler kullanır.
---

cyberstrike, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

cyberstrike, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, cyberstrike bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

cyberstrike bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri cyberstrike yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
