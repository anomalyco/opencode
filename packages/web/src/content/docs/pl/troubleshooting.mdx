...
Jeśli w swoim środowisku masz ustawiony `IMECODE_PORT`, aplikacja komputerowa spróbuje użyć tego portu dla serwera lokalnego.

- usuń `IMECODE_PORT` (lub wybierz wolny port) i uruchom ponownie.
