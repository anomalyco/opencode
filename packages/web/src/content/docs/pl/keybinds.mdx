...
cyberstrike zawiera listę skrótów klawiszowych, które można zastosować poprzez cyberstrike.
...
cyberstrike używa klucza `leader` dla głównych skrótów klawiszowych. Rozwiązanie problemu konfliktów w terminalu.
...
Pole sprawdzania aplikacji komputerowej cyberstrike obsługuje popularne skróty w stylu Readline/Emacs do edycji tekstu. Są one dostępne i obecnie nie można ich skonfigurować za pomocą `cyberstrike.json`.
