...
Opcja `mode` jest obecnie przestarzała. [Dowiedz się więcej](./agents).
:::
...
Zobacz także: [Formaterzy](./formatters), aby uzyskać informacje na temat konfiguracji formatowania kodu.
