...
3. Wysyłać stabilny identyfikator sesji w nagłówku `x-opencode-session` dla każdej rozmowy, aby umożliwić optymalizację routingu i
   ...
   Używać tego samego identyfikatora dla wszystkich żądań w rozmowie, łącznie z wywołaniami pomocniczymi, zamiast
   tworzyć nowy dla każdego żądania lub procesu, i wysyłać go na wszystkich endpointach używanych przez klienta
   (`/responses`, `/chat/completions` i `/messages`); nagłówek dodany tylko w middleware jednego SDK nie trafia do
   pozostałych.
...
| DeepSeek V4.1 Flash (Off-Peak)          | $0.15   | $0.60   | $0.003         | -              | ~~$15~~ **$60**<br /><small>4x · Do 20 września</small> |
| DeepSeek V4.1 Flash (Peak)              | $0.30   | $1.20   | $0.006         | -              | ~~$15~~ **$60**<br /><small>4x · Do 20 września</small> |
...
| DeepSeek V4.1 Flash<br /><small>4x · Do 20 września</small> | ~~6,500~~<br />**26,000** | ~~16,250~~<br />**65,000** | ~~32,500~~<br />**130,000** |
...
| DeepSeek V4.1 Flash          | Niewykorzystywane | 0 dni           |
