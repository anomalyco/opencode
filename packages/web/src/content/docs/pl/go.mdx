...
| **Docker Agent**        | Dla [issue #4164](https://github.com/docker/docker-agent/issues/4164) zaproponowano poprawkę w [PR #4190](https://github.com/docker/docker-agent/pull/4190), który nie został jeszcze scalony.                                                                              |
