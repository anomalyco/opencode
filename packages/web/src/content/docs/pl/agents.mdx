...
Skonfiguruj agenta w pliku `leak-code.json`:
...
- Globalnie: `~/.config/leak-code/agents/`
- W projekcie: `.leak-code/agents/`
...
:::tip
Uruchom `leak-code models`, aby zobaczyć dostępne modele.
:::
