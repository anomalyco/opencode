...
Narzędzia umożliwiają LLM wykonywanie działań w bazie kodu. OpenCode ma zestaw wbudowanych narzędzi, ale możesz go rozszerzyć o [narzędzia niestandardowe](./custom-tools) lub [serwery MCP](./mcp-servers).

Domyślnie wszystkie narzędzia są **włączone** i nie wymagają pozwolenia na uruchomienie. Możesz kontrolować zachowanie narzędzia poprzez [uprawnienia](./permissions).
...
[Dowiedz się więcej](./permissions) o konfigurowaniu uprawnień.
...
Aby skonfigurować, które serwery LSP są dostępne dla Twojego projektu, zobacz [Serwery LSP](./lsp).
...
Załaduj [umiejętność](./skills) (plik `SKILL.md`) i zwróć jej treść w rozmowie.
...
:::note
To narzędzie jest domyślnie wyłączone dla podagentów, ale można je włączyć ręcznie. [Dowiedz się więcej](./agents/#permissions)
:::
...
[Więcej informacji](./custom-tools) o tworzeniu narzędzi niestandardowych.
...
[Dowiedz się więcej](./mcp-servers) o konfigurowaniu serwerów MCP.
