...
Utwórz `.octopus/commands/test.md`:
...
Możesz zdefiniować polecenia w `octopus.json` lub w plikach w katalogu `commands/`.
...
- Globalnie: `~/.config/octopus/commands/`
- Na projekt: `.octopus/commands/`
