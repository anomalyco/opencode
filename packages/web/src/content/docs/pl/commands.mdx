...
Utwórz `.pencode/commands/test.md`:
...
Możesz zdefiniować polecenia w `pencode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji pencode:
...
- Globalnie: `~/.config/pencode/commands/`
- Na projekt: `.pencode/commands/`
...
pencode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
