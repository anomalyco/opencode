...
Możesz zdefiniować polecenia w `xcsh.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji xcsh:
...
- Globalnie: `~/.config/xcsh/commands/`
- Na projekt: `.xcsh/commands/`
...
xcsh zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
