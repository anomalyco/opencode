...
Utwórz `.leak-code/commands/test.md`:
...
Możesz zdefiniować polecenia w `leak-code.json` lub w plikach w katalogu `commands/`.
...
- Globalnie: `~/.config/leak-code/commands/`
- Na projekt: `.leak-code/commands/`
