...
Utwórz `.cyberstrike/commands/test.md`:
...
Możesz zdefiniować polecenia w `cyberstrike.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji cyberstrike:
...
- Globalnie: `~/.config/cyberstrike/commands/`
- Na projekt: `.cyberstrike/commands/`
...
cyberstrike zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
