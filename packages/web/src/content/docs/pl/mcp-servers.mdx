...
Lokalne wartości konfiguracyjne za występujące zdalne wartości. Aby uzyskać więcej informacji, zobacz [pierwszeństwo konfiguracji](./config#precedence-order).
...
2. W [konfiguracji agenta](./agents#tools) włącz serwer MCP jako narzędzie.
...
Alternatywnie możesz zadać coś takiego do pliku [AGENTS.md](./rules/).
