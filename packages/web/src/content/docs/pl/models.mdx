...
Dowiedz się więcej o [dostawcach](./providers).
...
Tutaj pełny identyfikator do `provider_id/model_id`. Na przykład, użycie [OpenCode Zen](./zen), przestrzeganie `opencode/gpt-5.1-codex` dla Kodeksu GPT 5.1.
...
Można także skorzystać z opcji dla dowolnych agentów, których używa się. Konfiguracja agenta jest dostępna jako opcja globalna. [Dowiedz się więcej](./agents/#additional).
...
Naciśnij klawisza `variant_cycle`, aby szybko przełączać się między wariantami. [Dowiedz się więcej](./keybinds).
