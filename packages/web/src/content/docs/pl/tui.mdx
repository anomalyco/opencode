---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala xcsh.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

xcsh zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie xcsh uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI xcsh, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do xcsh. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `xcsh.json`, który konfiguruje zachowanie serwera/runtime.
