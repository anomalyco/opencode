...
Jest to oddzielny plik od `leak-code.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `LEAKCODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
