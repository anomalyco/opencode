...
Większość poleceń ma również skrót klawiszowy wykorzystujący `ctrl+x` jako klucz wiodący, gdzie `ctrl+x` jest domyślnym klawiszem wiodącym. [Dowiedz się więcej](./keybinds).
...
Utwórz lub zaktualizuj plik `AGENTS.md`. [Dowiedz się więcej](./rules).
...
Udostępnij bieżącą sesję. [Dowiedz się więcej](./share).
...
Anuluj udostępnianie bieżącej sesji. [Dowiedz się więcej](./share#un-sharing).
