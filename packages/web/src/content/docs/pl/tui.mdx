---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala pencode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

pencode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie pencode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI pencode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do pencode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij pencode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `pencode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Pencode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `pencode.default`.
