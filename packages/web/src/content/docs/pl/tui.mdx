...
Jest to oddzielny plik od `octopus.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `OCTOPUS_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
