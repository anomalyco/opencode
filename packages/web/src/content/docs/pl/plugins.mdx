...
- `.octopus/plugins/` - Wtyczki na poziomie projektu
- `~/.config/octopus/plugins/` - Wtyczki globalne
...
1. Konfiguracja globalna (`~/.config/octopus/octopus.json`)
2. Konfiguracja projektu (`octopus.json`)
3. Globalny katalog wtyczek (`~/.config/octopus/plugins/`)
4. Katalog wtyczek projektu (`.octopus/plugins/`)
