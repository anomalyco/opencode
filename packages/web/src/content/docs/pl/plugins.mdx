...
- `.leak-code/plugins/` - Wtyczki na poziomie projektu
- `~/.config/leak-code/plugins/` - Wtyczki globalne
...
1. Konfiguracja globalna (`~/.config/leak-code/leak-code.json`)
2. Konfiguracja projektu (`leak-code.json`)
3. Globalny katalog wtyczek (`~/.config/leak-code/plugins/`)
4. Katalog wtyczek projektu (`.leak-code/plugins/`)
