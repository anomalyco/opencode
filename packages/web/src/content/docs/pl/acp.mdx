...
OpenCode jest dostępny w IDE JetBrains przez ACP Registry.

Aby go używać, zainstaluj lub zaktualizuj wtyczkę JetBrains AI Assistant, otwórz AI Chat i wybierz **Install From ACP Registry** z selektora trybu czatu. Możesz też przejść do **Settings | Tools | AI Assistant | Agents**. Wyszukaj **OpenCode**, zainstaluj go, zastosuj ustawienia, a potem wybierz **OpenCode** z selektora agentów AI Chat.

Pozycja w rejestrze: `opencode`

Więcej informacji znajdziesz w [dokumentacji ACP JetBrains](https://www.jetbrains.com/help/ai-assistant/acp.html) oraz [dokumentacji ACP Registry](https://agentclientprotocol.com/get-started/registry).
