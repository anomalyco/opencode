---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez cyberstrike.
---
...
CyberStrike Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół cyberstrike.

:::note
CyberStrike Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca cyberstrike. Logujesz się do CyberStrike Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z cyberstrike.
:::
...
CyberStrike Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

CyberStrike Zen działa jak każdy inny dostawca cyberstrike.

1. Logujesz się do **<a href={console}>CyberStrike Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz CyberStrike Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji cyberstrike
używa formatu `cyberstrike/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `cyberstrike/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie cyberstrike przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na cyberstrike przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie cyberstrike przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w cyberstrike przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy CyberStrike Zen, aby:
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z cyberstrike dowolnego innego dostawcy.
