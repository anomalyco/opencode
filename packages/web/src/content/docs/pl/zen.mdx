---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Pencode.
---
...
Pencode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Pencode.

Zen działa jak każdy inny dostawca w Pencode. Logujesz się do Pencode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Pencode.
:::
...
Pencode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Pencode Zen działa jak każdy inny dostawca w Pencode.

1. Logujesz się do **<a href={console}>Pencode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Pencode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Pencode używa formatu
`pencode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`pencode/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Pencode używa tych modeli do generowania tytułów sesji.
...
- MiMo-V2.5 Free jest dostępny w Pencode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Free jest dostępny w Pencode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Pencode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w Pencode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Pencode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ox Alpha Free to stealth model, który jest darmowy w Pencode przez ograniczony czas. Dostawca stosuje zasadę zerowego przechowywania i nie używa twoich danych do trenowania modeli.
- Muse Spark 1.2 Contributor Free jest dostępny w Pencode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Pencode także dowolnego innego dostawcy.
