...
[Identyfikator modelu](./config/#models) w konfiguracji OpenCode
...
Możesz zauważyć _Claude Haiku 3.5_ w swojej historii użytkowania. To jest [model niskokosztowy](./config/#models), który służy do generowania tytułów sesji.
