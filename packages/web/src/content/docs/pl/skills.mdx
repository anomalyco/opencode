...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Powinno mieć od 1 do 64 znaków.                                                                   |
| `description` | `string` | yes      | Powinno mieć od 1 do 1024 znaków. Wyświetlane agentowi, aby mógł zdecydować, kiedy załadować umiejętność. |

Wszystkie pozostałe pola frontmatter są bezpiecznie ignorowane.

:::tip
Zadbaj o to, aby opis był wystarczająco konkretny, by agent mógł dokonać prawidłowego wyboru.
:::
