...
:::caution
Przy uzyciu `--hostname 0.0.0.0` ustaw `OCTOPUS_SERVER_PASSWORD`, aby zabezpieczyc serwer.
...
- Konfiguracja opencode i sesje sa przechowywane w srodowisku WSL pod `~/.local/share/octopus/`
