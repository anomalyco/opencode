---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące cyberstrike.
---

Funkcja udostępniania cyberstrike umożliwia tworzenie publicznych linków do konwersacji cyberstrike, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, cyberstrike:
...
cyberstrike obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie cyberstrike korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `cyberstrike.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu cyberstrike w Twojej organizacji.
