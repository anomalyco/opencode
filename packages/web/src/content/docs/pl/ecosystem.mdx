...
| [opencode-tokenstats](https://github.com/anna-jay-antarctica/tokenstats)                           | Wyświetla liczbę tokenów wejściowych i wyjściowych oraz trafienia w cache w bieżącej sesji                             |
