...
| [opencode-plan-manager](https://github.com/yurihbm/opencode-plan-manager)                                 | Planowanie implementacji rozwiązań AI-Native dla nowoczesnych przepływów pracy agentów                                |
