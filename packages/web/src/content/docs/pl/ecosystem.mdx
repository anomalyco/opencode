...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Wtyczka Google Antigravity OAuth z dynamicznym pobieraniem modeli, śledzeniem limitów i utrwalaniem stanu tur |
