...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Wtyczka Google Antigravity OAuth ze wsparciem dla wyszukiwarki Google i bardziej niezawodną obsługą API               |
