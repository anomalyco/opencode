...
:::tip[Windows Users]
Aby uzyskać najlepsze wyniki, uruchom `opencode web` z [WSL](./windows-wsl) zamiast programu PowerShell. Zapewnia to prawidłowy dostęp do systemu plików i integrację terminala.
:::
