...
przetestowane i zweryfikowane, aby dobrze współpracować z OpenCode. [Dowiedz się więcej](./zen).
...
subskrypcja](https://github.com/features/copilot/plans), z której chcesz skorzystać.
...
OpenCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół OpenCode. [Dowiedz się więcej](./zen).
...
- **apiKey**: Ustaw przy użyciu składni zmiennej `env`, [dowiedz się więcej](./config#env-vars).
