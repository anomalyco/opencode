...
If you have `IMECODE_PORT` set in your environment, the desktop app will try to use that port for the local server.

- Unset `IMECODE_PORT` (or pick a free port) and restart.
