...
The desktop sidebar uses colored dots to show what needs your attention.

- Yellow dot: a permission request or another action needs your attention
- Red dot: an unseen error exists in a session or project
- Blue dot: unseen activity is available, or a response is ready

Opening a session marks it as viewed and clears its indicator. You can clear project-level notifications from the project's context menu.
