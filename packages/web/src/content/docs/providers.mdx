...
1. Head over to the [Nebius AI Studio console](https://studio.nebius.com/), create an account, and click **Add Key**.

2. Run `opencode auth login` and select **Nebius AI Studio**.
...
3. Enter your Nebius AI Studio API key.
