...
> **Note**: Specifications sourced from official model providers (Z.AI, Moonshot AI, Alibaba Qwen, Meta, Mistral AI, Nous Research). Context limits and capabilities reflect base models. Actual pricing on Morpheus AI may vary.
