...
[IO.NET](https://io.net/intelligence) provides access to powerful open-source LLMs running on io.net's decentralized GPU network. The API is fully OpenAI-compatible.
...
6. Run the `/models` command to select a model like _Llama 3.3 70B Instruct_, _Qwen 3 Coder 480B_, or _DeepSeek R1_.

##### Available Models

IO.NET offers 17 models including:

- **Llama 3.3 70B Instruct** - General purpose (128K context)
- **Qwen 3 Coder 480B** - Optimized for coding (106K context)
- **DeepSeek R1** - Advanced reasoning (128K context)
- **Llama 4 Maverick** - 430K context with vision support
- **Mistral Large 2411** - Flagship model with vision
- **Kimi K2 Thinking** - Reasoning with prompt caching

:::tip
IO.NET models run on io.net's decentralized GPU network, offering competitive pricing and high availability.
:::
