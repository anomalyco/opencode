...
4. **Enable the models in your workspace.** Go to Zen and ensure the Go models (GLM-5, Kimi K2.5, MiniMax M2.5) are enabled.

5. Run `/models` in the TUI to see the list of models available through Go.
