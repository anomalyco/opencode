...
4. Run the `/models` command to select a model like _GLM 4.7_, _Kimi K2.5_, or _Qwen3 Coder 480B_.
...
> **Note**: Pricing is per 1 million tokens in USD. Specifications sourced from official model providers (Z.AI, Moonshot AI, Alibaba Qwen, Meta, Mistral AI, Nous Research, Venice AI). Context limits and capabilities reflect base models.
