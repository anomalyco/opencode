...
##### GitLab Duo Agent Platform (DAP) Workflow Models {#gitlab-dap}
...
To enable DAP workflow models, ensure the following feature flags are set in your
`opencode.json`:
...
:::note
Your GitLab administrator must enable the Duo Agent Platform for your user,
group, or instance. See
[GitLab Duo setup](https://docs.gitlab.com/user/gitlab_duo/turn_on_off/) for
details.
:::
