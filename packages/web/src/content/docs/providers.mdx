...
1. Head over to the [Corvex Token Factory dashboard](https://tokenfactory.corvex.cloud/), create an account, and create an API key.

2. Run the `/connect` command and search for **Corvex**.

   ```txt
   /connect
   ```

3. Enter your Corvex API key.
...
4. Run the `/models` command to select a model like _GLM 5.2 FP8_.
