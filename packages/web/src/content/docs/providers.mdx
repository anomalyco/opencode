...
[Maritaca AI](https://www.maritaca.ai) is a Brazilian AI company that develops the Sabiá family of language models,
specialized in Portuguese and Brazilian contexts.

1. Head over to the [Maritaca AI platform](https://plataforma.maritaca.ai), create an account, and generate an API key.

2. Run the `/connect` command and search for **Maritaca AI**.

   ```txt
   /connect
   ```

3. Enter your Maritaca AI API key.
...
4. Run the `/models` command to select a model like _Sabiá 4_.
...
To use Snowflake Cortex AI with OpenCode:

1. Head over to your [Snowflake account](https://app.snowflake.com), navigate to the **Cortex AI** section, and create an API key from the **API Integration** settings.

2. Run the `/connect` command and search for **Snowflake Cortex AI**.

   ```txt
   /connect
   ```

3. Enter your Snowflake API key.
...
1. Head over to the [Together AI console](https://api.together.xyz/settings/api-keys), create an account, and click **Create API Key**.
...
1. Head over to the [Venice AI console](https://venice.ai/api-keys), create an account, and generate an API key.
...
To use Vercel AI Gateway with OpenCode:

1. Head over to the [Vercel dashboard](https://vercel.com), navigate to **Storage** > **AI Gateway**, and create a new gateway. Copy your **Gateway ID** and **API key**. You'll also need to note your **Team ID**.
...
5. Enter your **Team ID** when prompted.
...
4. Run the `/models` command to select a model like _Grok 4_.
...
1. Head over to [Z.AI](https://z.ai), create an account, and generate an API key.
...
4. Run the `/models` command to select a model like _GLM-5.1_.
...
[ZenMux](https://zenmux.com) is an AI gateway that lets you access models from OpenAI, Anthropic, Google, and many more through a single unified API.

1. Head over to [ZenMux](https://zenmux.com), create an account, and generate an API key from your dashboard.
