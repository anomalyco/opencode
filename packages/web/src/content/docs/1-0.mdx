...
description: What's new in ChaliceCode 1.0.
---

ChaliceCode 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same chalice server.
...
version. However some older versions of ChaliceCode always grab latest.

To upgrade manually, run

```bash
$ chalice upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ chalice upgrade 0.15.31
```
