...
description: What's new in CrazyCode 1.0.
---

CrazyCode 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same crazycode server.
...
version. However some older versions of CrazyCode always grab latest.

To upgrade manually, run

```bash
$ crazycode upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ crazycode upgrade 0.15.31
```
