...
Hvis du opplever treg ytelse, problemer med filtilgang eller terminalproblemer på Windows, kan du prøve å bruke [WSL (Windows Subsystem for Linux)](./windows-wsl). WSL gir et Linux-miljø som fungerer mer sømløst med funksjonene til OpenCode.
...
1. Kontroller først at leverandøren din er riktig konfigurert ved å følge [leverandørveiledningen](./providers)
