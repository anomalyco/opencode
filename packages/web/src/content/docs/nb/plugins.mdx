...
For eksempler, sjekk ut [plugins](./ecosystem#plugins) opprettet av fellesskapet.
...
Bla gjennom tilgjengelige plugins i [økosystemet](./ecosystem#plugins).
...
**Lokale plugins** lastes direkte fra plugin-katalogen. For å bruke eksterne pakker, må du opprette en `package.json` i konfigurasjonskatalogen din (se [Dependencies](#dependencies)), eller publisere plugin-en til npm og [legg den til i konfigurasjonen din](./config#plugins).
