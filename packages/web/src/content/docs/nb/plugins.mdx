...
- `.leak-code/plugins/` - Programtillegg på prosjektnivå
...
1. Global konfigurasjon (`~/.config/leak-code/leak-code.json`)
2. Prosjektkonfigurasjon (`leak-code.json`)
3. Global plugin-katalog (`~/.config/leak-code/plugins/`)
4. Prosjektpluginkatalog (`.leak-code/plugins/`)
