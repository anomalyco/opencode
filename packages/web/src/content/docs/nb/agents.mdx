...
Konfigurer agenter i konfigurasjonsfilen `leak-code.json`:
...
- Globalt: `~/.config/leak-code/agents/`
- Per prosjekt: `.leak-code/agents/`
...
:::tip
Kjør `leak-code models` for å se en liste over tilgjengelige modeller.
:::
