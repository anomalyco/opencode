...
- **5-timers grense** — 20 % av brukskvoten din
- **Ukentlig grense** — 50 % av brukskvoten din
- **Månedlig grense** — 100 % av brukskvoten din

Disse grensene er prosenter av en felles brukskvote på tvers av alle modeller.

### Bruk per modell

Den inkluderte månedlige bruken varierer etter modell og beregnes til de offisielle API-prisene. Tokenpriser er oppgitt per 1M tokens.

| Model                                   | Input  | Output | Cached Read | Cached Write | Månedlig bruk |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | ---- |
...
Antallet forespørsler avhenger av modellens månedlige bruk og API-priser. Estimatene nedenfor er basert på typiske bruksmønstre for Go.
