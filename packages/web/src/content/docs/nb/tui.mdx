---
title: TUI
description: Bruke cyberstrike-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

cyberstrike gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre cyberstrike starter TUI for gjeldende katalog.
...
Når du bruker cyberstrike TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til cyberstrike. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt cyberstrike. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom cyberstrike-konfigurasjonsfilen.
