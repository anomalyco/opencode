---
title: TUI
description: Bruke xcsh-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

xcsh gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre xcsh starter TUI for gjeldende katalog.
...
Når du bruker xcsh TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til xcsh. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Dette er atskilt fra `xcsh.json`, som konfigurerer server-/kjøretidsoppførsel.
