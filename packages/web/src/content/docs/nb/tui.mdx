...
Dette er atskilt fra `leak-code.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `LEAKCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
