---
title: TUI
description: Bruke pencode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Pencode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Pencode starter TUI for gjeldende katalog.
...
Når du bruker Pencode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Pencode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Pencode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `pencode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Pencode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `pencode.default`.
