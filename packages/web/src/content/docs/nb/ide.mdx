---
title: IDE
description: Octopus-utvidelsen for VS Code, Cursor og andre IDE-er
---

Octopus integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `opencode` i terminalen for å komme i gang.

---

## Bruk

- **Hurtigstart**: Bruk `Cmd+Esc` (Mac) eller `Ctrl+Esc` (Windows/Linux) for å åpne Octopus i en delt terminalvisning, eller fokuser en eksisterende terminaløkt hvis en allerede kjører.
- **Ny økt**: Bruk `Cmd+Shift+Esc` (Mac) eller `Ctrl+Shift+Esc` (Windows/Linux) for å starte en ny Octopus-terminaløkt, selv om en allerede er åpen. Du kan også klikke på Octopus-knappen i UI.
- **Kontekstbevissthet**: Del automatisk ditt nåværende valg eller fane med Octopus.
...
For å installere Octopus på VS Code og populære varianter som Cursor, Windsurf, VSCodium:
...
Søk etter **Octopus** i Extension Marketplace og klikk på **Install**.
