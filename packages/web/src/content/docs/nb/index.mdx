...
For den beste opplevelsen på Windows anbefaler vi å bruke [Windows Subsystem for Linux (WSL)](./windows-wsl). Det gir bedre ytelse og full kompatibilitet med OpenCodes funksjoner.
:::
...
Hvis du er ny til å bruke LLM-leverandører, anbefaler vi å bruke [OpenCode Zen](./zen).
...
Alternativt kan du velge en av de andre leverandørene. [Finn ut mer](./providers#directory).
...
For å gjøre det til ditt eget anbefaler vi å [velge et tema](./themes), [tilpasse nøkkelbindingene](./keybinds), [konfigurere kodeformatere](./formatters), [opprette egendefinerte kommandoer](./commands) eller leke med [OpenCode-konfigurasjonen](./config).
