...
[modell-id](./config/#models) i OpenCode-konfigurasjonen
...
Du legger kanskje merke til _Claude Haiku 3.5_ i brukshistorikken din. Dette er en [lavprismodell](./config/#models) som brukes til å generere titlene på øktene dine.
