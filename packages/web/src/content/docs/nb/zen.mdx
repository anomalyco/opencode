---
title: Zen
description: Utvalgt liste over modeller levert av Octopus.
---
...
Octopus Zen er en liste over testede og verifiserte modeller levert av Octopus-teamet.

:::note
Octopus Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i Octopus. Du logger inn på Octopus Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Octopus.
:::
...
Octopus Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Octopus Zen fungerer som enhver annen leverandør i Octopus.

1. Du logger inn på **<a href={console}>Octopus Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Octopus Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Octopus-konfigurasjonen din
...
- MiniMax M2.5 Free er tilgjengelig på Octopus i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ring 2.6 1T Free er tilgjengelig på Octopus i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på Octopus i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Octopus i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet Octopus Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Octopus også.
