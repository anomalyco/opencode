...
3. **Egendefinert konfigurasjon** (`IMECODE_CONFIG` env var) - egendefinerte overstyringer
...
6. **Inline config** (`IMECODE_CONFIG_CONTENT` env var) - kjøretidsoverstyringer
...
Spesifiser en tilpasset konfigurasjonsfilbane ved å bruke miljøvariabelen `IMECODE_CONFIG`.
...
Spesifiser en tilpasset konfigurasjonskatalog ved å bruke `IMECODE_CONFIG_DIR`
