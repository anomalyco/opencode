...
5. **`.opencode`-konfigurasjon** (`.opencode/opencode.json` i prosjekt) - samme som prosjektkonfigurasjon, men separat
6. **`.opencode` kataloger** - agenter, kommandoer, plugins
7. **Inline config** (`OPENCODE_CONFIG_CONTENT` env var) - kjøretidsoverstyringer
