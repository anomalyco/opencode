...
For den beste opplevelsen, kjør `opencode web` fra [WSL](./windows-wsl) i stedet for PowerShell. Dette sikrer riktig filsystemtilgang og terminalintegrasjon.
:::
...
Du kan konfigurere webserveren ved å bruke kommandolinjeflagg eller i [config file](./config).
