---
title: LSP-servere
description: xcsh integreres med LSP-serverne dine.
---

xcsh integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

xcsh kommer med flere innebygde LSP-servere for populære språk:
...
Når xcsh åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i xcsh-konfigurasjonen.
