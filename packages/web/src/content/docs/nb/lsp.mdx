---
title: LSP-servere
description: pencode integreres med LSP-serverne dine.
---

Pencode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Pencode kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `PENCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og pencode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Pencode-konfigurasjonen.
