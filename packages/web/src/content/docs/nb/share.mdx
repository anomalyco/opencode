...
For å eksplisitt angi manuell modus i [konfigurasjonsfilen](./config):
...
Du kan aktivere automatisk deling for alle nye samtaler ved å sette alternativet `share` til `"auto"` i [konfigurasjonsfilen](./config):
...
Du kan deaktivere deling helt ved å sette alternativet `share` til `"disabled"` i [konfigurasjonsfilen](./config):
...
[Finn ut mer](./enterprise) om bruk av opencode i organisasjonen din.
