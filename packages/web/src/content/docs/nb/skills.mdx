...
| `description` | `string` | yes      | Skal være 1-1024 tegn langt. Vises til agenten slik at den kan bestemme når ferdigheten skal lastes. |

Alle andre frontmatter-felt ignoreres trygt.

:::tip
Hold beskrivelsen spesifikk nok til at agenten kan velge riktig.
:::
