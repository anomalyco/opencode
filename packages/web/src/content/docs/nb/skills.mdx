...
Agentferdigheter lar Pencode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går pencode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
pencode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `pencode.json`:
