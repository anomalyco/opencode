...
| ------------------------------------- | ------ | --------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT                ` | streng  | Innebygde JSON-autentiseringslegitimasjoner |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS     ` | boolsk  | Deaktiver innlasting av ferdigheter fra npm-pakker |
...
| `OPENCODE_DISABLE_MOUSE               ` | boolsk  | Deaktiver musfangst i TUI |
| `OPENCODE_DISABLE_PRUNE               ` | boolsk  | Deaktiver beskjæring av gamle data |
| `OPENCODE_DISABLE_PROJECT_CONFIG      ` | boolsk  | Deaktiver innlasting av prosjektnivåkonfigurasjon |
...
| `OPENCODE_MODELS_PATH                 ` | streng  | Egendefinert bane for JSON-hurtigbufferfil for modeller |
...
| `EXA_API_KEY                          ` | streng  | API-nøkkel for Exa-nettsøk (krever `OPENCODE_ENABLE_EXA`) |
| `OTEL_EXPORTER_OTLP_ENDPOINT          ` | streng  | OpenTelemetry OTLP-eksporterendepunkt |
| `OTEL_EXPORTER_OTLP_HEADERS           ` | streng  | OpenTelemetry OTLP-eksporterheadere |
| `OTEL_RESOURCE_ATTRIBUTES             ` | streng  | OpenTelemetry-ressursattributter (nøkkel=verdi-par) |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI                  ` | boolsk  | Aktiver Effect HttpApi-bro |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES               ` | boolsk  | Aktiver eksperimentelle arbeidsområder |
