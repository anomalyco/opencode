...
OpenCode er tilgjengelig i JetBrains IDE-er via ACP Registry.

For å bruke det, installer eller oppdater JetBrains AI Assistant-pluginen, åpne AI Chat og velg **Install From ACP Registry** fra velgeren for chatmodus. Du kan også gå til **Settings | Tools | AI Assistant | Agents**. Søk etter **OpenCode**, installer det, bruk innstillingene, og velg deretter **OpenCode** fra agentvelgeren i AI Chat.

Registeroppføring: `opencode`

Se [JetBrains ACP-dokumentasjonen](https://www.jetbrains.com/help/ai-assistant/acp.html) og [ACP Registry-dokumentasjonen](https://agentclientprotocol.com/get-started/registry) for flere detaljer.
