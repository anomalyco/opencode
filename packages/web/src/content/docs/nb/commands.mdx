...
Opprett `.cyberstrike/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CyberStrike-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CyberStrike [config](/docs/config):
...
- Per prosjekt: `.cyberstrike/commands/`
...
CyberStrike inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
