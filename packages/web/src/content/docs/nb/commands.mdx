...
Opprett `.pencode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Pencode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Pencode [config](/docs/config):
...
Pencode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
