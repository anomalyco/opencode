...
Dine lokale konfigurasjonsverdier overstyrer de eksterne standardinnstillingene. Se [config precedence](./config#precedence-order) for flere detaljer.
...
2. Aktiver MCP-serveren som et verktøy i [agent config](./agents#tools).
...
Alternativt kan du legge til noe slikt til din [AGENTS.md](./rules/).
