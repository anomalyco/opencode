...
Verktøy lar LLM utføre handlinger i kodebasen din. OpenCode kommer med et sett med innebygde verktøy, men du kan utvide det med [egendefinerte verktøy](./custom-tools) eller [MCP servere](./mcp-servers).

Som standard er alle verktøy **aktivert** og trenger ikke tillatelse for å kjøre. Du kan kontrollere verktøyets oppførsel gjennom [tillatelser](./permissions).
...
[Finn ut mer](./permissions) om konfigurering av tillatelser.
...
For å konfigurere hvilke LSP-servere som er tilgjengelige for prosjektet ditt, se [LSP-servere](./lsp).
...
Last inn en [ferdighet](./skills) (en `SKILL.md` fil) og returner innholdet i samtalen.
...
:::note
Dette verktøyet er deaktivert for subagenter som standard, men du kan aktivere det manuelt. [Finn ut mer](./agents/#permissions)
:::
...
[Finn ut mer](./custom-tools) om å lage tilpassede verktøy.
...
[Les mer](./mcp-servers) om konfigurering av MCP-servere.
