...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Spor leverandørbruk i OpenCode med en innebygd TUI-dialog via den enkle `/usage`-kommandoen     |
