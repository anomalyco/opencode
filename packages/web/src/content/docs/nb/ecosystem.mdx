...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Google Antigravity OAuth-plugin, med støtte for Google Søk og mer robust API-håndtering                       |
