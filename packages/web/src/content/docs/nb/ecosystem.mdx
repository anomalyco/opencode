...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Google Antigravity OAuth-plugin med dynamisk modellhenting, kvotesporing og turn-state-persistens             |
