...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Lettvekts multi-agent suite med 7 spesialiserte agenter (Orchestrator, Explorer, Oracle, etc.) |
