...
Agent skills let OpenSec discover reusable instructions from your repo or home directory.
...
OpenSec searches these locations:
...
For project-local paths, OpenSec walks up from your current working directory until it reaches the git worktree.
...
OpenSec lists available skills in the `skill` tool description.
