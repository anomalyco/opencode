...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Should be 1-64 characters long.                                                                   |
| `description` | `string` | yes      | Should be 1-1024 characters long. Displayed to the agent so it can decide when to load the skill. |

All other frontmatter fields are safely ignored.

:::tip
Keep the description specific enough for the agent to choose correctly.
:::
