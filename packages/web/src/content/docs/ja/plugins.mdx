...
- `.leak-code/plugins/` - プロジェクトレベルのプラグイン
- `~/.config/leak-code/plugins/` - グローバルプラグイン
...
1. グローバル設定 (`~/.config/leak-code/leak-code.json`)
2. プロジェクト設定 (`leak-code.json`)
3. グローバルプラグインディレクトリ (`~/.config/leak-code/plugins/`)
4. プロジェクトプラグインディレクトリ (`.leak-code/plugins/`)
