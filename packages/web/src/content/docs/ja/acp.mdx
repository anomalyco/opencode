...
OpenCode は ACP Registry を通じて JetBrains IDE で利用できます。

利用するには、JetBrains AI Assistant プラグインをインストールまたは更新し、AI Chat を開いて、チャットモードセレクタから **Install From ACP Registry** を選択します。**Settings | Tools | AI Assistant | Agents** に移動してもかまいません。**OpenCode** を検索してインストールし、設定を適用したら、AI Chat のエージェントセレクタから **OpenCode** を選択します。

レジストリエントリ: `opencode`

詳細は [JetBrains ACP ドキュメント](https://www.jetbrains.com/help/ai-assistant/acp.html) と [ACP Registry ドキュメント](https://agentclientprotocol.com/get-started/registry) を参照してください。
