...
| [opencode-localmemory](https://github.com/DevairRestani/memmoryit)                                | Persistent local memory for OpenCode — Markdown files with frontmatter, fully offline, zero cost |
