...
| [opencode-free-models](https://github.com/murcanlat/opencode-free-models)                          | Discover free models, route prompts to the best one, and fall back on quota/rate limits            |
