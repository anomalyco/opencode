...
| [opencode-stay-awake](https://github.com/AuroraAeon/opencode-stay-awake)                           | Keeps the computer awake while a session is generating (macOS caffeinate, Linux systemd-inhibit)   |
