...
| [SCVD General Store](https://github.com/seancrecord/scvd-general-store-repo) | Skills and MCP tools for checking x402 endpoints before payment and signed receipts afterward |
