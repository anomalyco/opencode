...
| [@rehydra/opencode](https://github.com/rehydra-ai/rehydra-sdk)                                     | Anonymize secrets and PII before they reach the LLM; transparently restore them for local tools   |
