...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for permission, completion, and error events                |
...
| [opencode-figranium](https://github.com/figranium/figranium-mcp/tree/main/integrations/opencode)   | Browser automation with Figranium via its MCP server, agent, and reusable automation workflows     |
