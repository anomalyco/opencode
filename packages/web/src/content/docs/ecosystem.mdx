...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)                           | Google Antigravity OAuth plugin with dynamic model retrieval, quota tracking, and turn-state persistence |
