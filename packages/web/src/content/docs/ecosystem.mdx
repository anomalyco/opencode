...
| [opencode-morph-plugin](https://github.com/morphllm/opencode-morph-plugin)                         | Fast Apply editing, WarpGrep fast agentic search, and proactive context compaction via Morph SDK  |
