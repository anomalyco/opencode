...
| [opencode-senses](https://github.com/itsmeadarsh2008/opencode-senses)                              | The vision plugin for OpenCode that truly understands images. Inspect, read, and reason about any screenshot or picture with deeper understanding than any other plugin — fully local, private, and free. |
