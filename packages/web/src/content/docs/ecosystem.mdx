...
| [Orkas](https://github.com/Orkas-AI/Orkas) | Open-source, local-first desktop AI workspace whose Commander coordinates specialist agents and local OpenCode sessions through one chat. |
