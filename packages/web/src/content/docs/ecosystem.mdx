...
| [opencode-keenable](https://github.com/keenableai/keenable-integrations/tree/main/opencode/plugin) | Web search and page fetch with no API key and no CLI to install                                    |
