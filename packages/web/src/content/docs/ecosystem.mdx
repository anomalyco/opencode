...
| [opencode-session-navigation](https://github.com/samiralibabic/opencode-session-navigation)         | Vim-like navigation mode for the OpenCode TUI session view                                        |
| [opencode-rexd-target](https://github.com/samiralibabic/opencode-rexd-target)                      | Route OpenCode tool calls to REXD remote execution targets over SSH                               |
