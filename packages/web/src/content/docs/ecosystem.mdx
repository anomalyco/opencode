...
| [opencode-bmad-workflow](https://github.com/Alex-stack-cell/opencode-bmad-workflow)                | BMAD methodology plugin — automates epic, story, sprint and code review workflows via specialized agents with preview/save pattern                                    
---
