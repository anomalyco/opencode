...
| Name                                                                                                      | Description                                                                                       |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-plugin-tmux](https://github.com/AnganSamadder/opencode-tmux)                                    | Smart tmux integration: auto-spawns subagent panes, streams real-time execution with smart layouts |
