...
| [opencode-md-table-formatter](https://github.com/iMythms/opencode-md-table-formatter)                     | Markdown table formatter plugin for OpenCode with concealment mode support.                       |
