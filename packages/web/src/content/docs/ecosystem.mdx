...
| [opencode-chrome-annotation](https://github.com/eagleeyejack/opencode-chrome-annotation)           | Annotate pages in Chrome and queue element screenshots and instructions to send into OpenCode      |
