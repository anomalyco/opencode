...
| [opencode-stay-awake](https://github.com/AuroraAeon/opencode-stay-awake)                           | Keep the computer awake while any session is generating, and asleep again the moment work finishes |
