...
| [opencode-chrome-annotation](https://github.com/jodusnodus/opencode-chrome-annotation)             | Annotate pages in Chrome and send screenshots, element metadata, and instructions into OpenCode    |
