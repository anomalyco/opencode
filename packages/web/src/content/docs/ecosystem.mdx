...
| [opencode-plan-cards-plugin](https://github.com/SAKURA1175/opencode-plan-cards-plugin)                    | Improves plan-mode card interactions with adaptive, stateful clarification for fewer unnecessary follow-up questions |
