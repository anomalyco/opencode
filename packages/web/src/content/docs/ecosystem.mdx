...
| [@parallel-web/opencode-plugin][parallel-plugin]                                                   | Web search and content extraction using Parallel's authenticated Search and Extract APIs           |

[parallel-plugin]: https://github.com/parallel-web/parallel-npm-packages/tree/main/packages/opencode-plugin
