...
| [@rehydra/opencode](https://docs.rehydra.ai/guides/opencode-plugin)                                | Anonymize secrets and PII before LLM calls, then restore values before local tool execution       |
