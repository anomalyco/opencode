...
| [opencode-supabase](https://github.com/supabase-community/opencode-supabase)                       | Supabase plugin for OpenCode: account login, Management API tools, bundled Supabase agent skills, and guided Supabase MCP setup. |
