...
| [opencode-localmemory](https://github.com/DevairRestani/opencode-localmemory)                      | Persistent local memory for OpenCode — Markdown files with frontmatter, fully offline, zero cost |
