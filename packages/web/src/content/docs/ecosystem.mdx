...
| [opencode-smart-session-picker](https://github.com/Techie5879/opencode-smart-session-picker)       | Better search via fzf and hybrid (vector + BM25) through opencode sessions                        |
