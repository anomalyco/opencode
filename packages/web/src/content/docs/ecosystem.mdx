...
| [forLoop-planner-plugin](https://github.com/forloop-cc/forloop-opencode-plugin-planner             | Autopilot development. Plan with ForLoop agent. Build, Test, Deploy on cloud in one go.            |
...
| [forloop-agents](https://github.com/forloop-cc/forloop-agents-skills) | Specialized ForLoop agent that deeply integrated ForLoop platform which provides an autopilot development. |
