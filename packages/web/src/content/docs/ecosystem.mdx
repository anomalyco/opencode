...
| [opencode-skills-tui](https://github.com/aihaipeng/opencode-skills-tui)                            | Skills sidebar panel with loaded-state tracking and right-click SKILL.md preview                   |
| [opencode-dir-tree-tui](https://github.com/aihaipeng/opencode-dir-tree-tui)                        | VS Code-style file tree in the sidebar with git status coloring and click-to-open                  |
