...
| [opencode-mlflow-plugin](https://github.com/MunhozThiago/opencode-mlflow-plugin)                  | Track OpenCode session metrics and tool execution timings in a local MLflow server                |
