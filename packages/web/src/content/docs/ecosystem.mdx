...
| [opencode-brightdata](https://github.com/brightdata/opencode-brightdata)                           | Scrape, search & extract structured data from 40+ platforms (Amazon, LinkedIn, Instagram, YouTube) - 5K free requests/month |                     |
