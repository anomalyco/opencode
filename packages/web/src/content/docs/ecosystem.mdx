...
| [opencode-dashscope-imagegen](https://github.com/WhiteBite/opencode-dashscope-imagegen)            | Text-to-image generation via Alibaba DashScope models (qwen-image, wan2.7-image)                   |
