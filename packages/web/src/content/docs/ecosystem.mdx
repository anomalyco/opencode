...
| [opencode-tts](https://github.com/StefanoChiodino/opencode-tts)                                    | Speak assistant responses aloud, in full or as a summary, using a local text-to-speech engine   |
