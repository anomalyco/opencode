...
| [opencode-mempalace-persistence](https://github.com/geco/opencode-mempalace-persistence)          | Auto-save conversations to MemPalace (local vector memory): per-prompt recall, AI checkpoints, pre-compact rescue |
