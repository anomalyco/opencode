...
| [opencode-event-push](https://github.com/dragonwize/opencode-event-push)                           | Forward a configurable set of events to one or more URLs via HTTP POST, webhook style.            |
