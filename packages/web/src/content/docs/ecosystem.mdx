...
| [opencode-session-search](https://github.com/arthurtyukayev/opencode-session-search)                      | Exposes the Opencode sessions database as a tool for use within new sesisons                      |
---
