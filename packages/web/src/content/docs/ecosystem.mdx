...
| [opencode-short-term-memory](https://github.com/andrejtonev/opencode-short-term-memory)            | Automatically summarizes conversations into structured memory and injects them back into context |
