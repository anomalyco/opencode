...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [AgentField](https://github.com/Agent-Field/agentfield)                                    | Control plane for orchestrating AI agent swarms as microservices — best-in-class DX with SDKs for Python, Go, and TypeScript |
...
| Name                                                              | Description                                                  |
| ----------------------------------------------------------------- | ------------------------------------------------------------ |
| [SWE-AF](https://github.com/Agent-Field/SWE-AF)                   | Autonomous software engineering agent team — orchestrates a 400+ agent swarm across planning, coding, testing, and review from a single API call |
| [SEC-AF](https://github.com/Agent-Field/sec-af)                   | Multi-agent security auditor — orchestrates a 250+ agent swarm to find vulnerabilities and prove exploitability, outputs SARIF for CI |
