...
| [opencode-mini-session](https://github.com/karamanliev/opencode-mini-session)                      | Floating non-blocking temporary mini sessions dialog for aside/btw style questions                 |
