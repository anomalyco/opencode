...
| [opencode-agent-memory](https://github.com/Ghilteras/opencode-agent-memory)                        | Persistent, self-editable memory blocks and an optional journal with local semantic search         |
