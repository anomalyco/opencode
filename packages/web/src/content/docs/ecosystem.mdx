...
| [opencode-agent-memory](https://github.com/joshuadavidthomas/opencode-agent-memory)                       | Persistent self-modifying memory blocks that survive across sessions, inspired by [Letta](https://letta.com/) |
