...
| [BytesBrains Cruise](https://github.com/bytesbrains/cruise-opencode)                               | Route OpenCode through Cruise with live model discovery, budgets, spend visibility, and MCP tools  |
