...
| [opencode-session-tracker](https://github.com/ykocaman/opencode-session-tracker)                   | Real-time TUI sidebar & Telegram companion for OpenCode. Track active sessions, nested subagents, dynamic statuses, and authorize commands from your phone. |
