...
| [opencode-launcher](https://github.com/krisvandebroek/opencode-launcher)                           | Lightning-fast TUI launcher for OpenCode. Pick a project + model, or resume a previous session. |
