...
| [opencode-mission-control](https://github.com/nigel-dev/opencode-mission-control)                         | Parallel agents in tmux-isolated worktrees with DAG plans, merge train, and PR creation           |
