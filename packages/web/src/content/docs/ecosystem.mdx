...
| [opencode-annotate](https://github.com/eagleeyejack/opencode-chrome-annotation)                    | Annotate live running UI from Chrome: click an element, send screenshot, selector, instruction     |
