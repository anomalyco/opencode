...
| [@upstash/context7-opencode](https://www.npmjs.com/package/@upstash/context7-opencode)             | Add current library documentation through the Context7 MCP server and skill                        |
