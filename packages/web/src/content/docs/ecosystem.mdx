...
| [opencode-repo-map](https://github.com/atuljaiswal1246/opencode-repo-map)                          | Symbol map of the repository, so an agent stops re-reading files it already understands            |
