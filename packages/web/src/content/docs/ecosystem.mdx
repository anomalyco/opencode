...
| [opencode-claude-memory](https://github.com/kuitos/opencode-claude-memory)                         | Share Claude Code-compatible persistent Markdown memory between OpenCode and Claude Code          |
