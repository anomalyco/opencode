...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Track provider usage inside OpenCode with a native TUI dialog through a simple `/usage` command  |
