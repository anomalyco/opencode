...
| [superpowers-controller](https://github.com/goodjin/superpowers-controller)                             | Stateful Superpowers workflow controller for design, planning, execution, verification, and review |
