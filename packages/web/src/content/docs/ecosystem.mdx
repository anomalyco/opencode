...
| [opencode-session-tools](https://github.com/kernel-oops/opencode-session-tools)                    | OpenCode v2: session metadata, history recall, and Claude Code-style cross-session messaging       |
