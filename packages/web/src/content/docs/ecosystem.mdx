...
| [opencode-chrome-annotation](https://github.com/eagleeyejack/opencode-chrome-annotation-extension) | Annotate any webpage in Chrome: click an element, send its screenshot, selector, and instruction into a session |
