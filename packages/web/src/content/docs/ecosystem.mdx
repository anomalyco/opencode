...
| [opencode-sop-engine](https://github.com/wyf111/opencode-sop-engine)                               | SOP/state-machine enforcement plugin with evidence-gated stage transitions and context pruning     |
