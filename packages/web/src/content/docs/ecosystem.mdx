...
| [opencode-langsmith-tracing](https://github.com/Dramalf/opencode-langsmith-tracing)                | Trace and observe your OpenCode sessions, LLM calls, and tools with LangSmith                     |
