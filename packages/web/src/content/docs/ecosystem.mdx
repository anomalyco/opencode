...
| [opencode-plain-english](https://github.com/rubenxyz/opencode-plain-english)                       | Make the assistant reply in plain English: everyday words, no jargon, no code in explanations      |
