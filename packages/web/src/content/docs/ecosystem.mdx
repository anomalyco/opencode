...
| [opencode-goal-plugin](https://github.com/william-ricchiuti/OpenCode-goal-plugin)                  | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
