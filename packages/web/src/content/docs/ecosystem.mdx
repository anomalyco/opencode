...
| [opencode-enhance-plan](https://github.com/spartawhy117/opencode-enhance-plan) | Enhanced planning workflow — persistent plan artifacts, explicit review gates, structured todo state, and multi-feature switching |
