...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Lightweight multi-agent suite with 7 specialized agents (Orchestrator, Explorer, Oracle, etc.) |
