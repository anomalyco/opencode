...
| [opencode-agent-factory-plugin](https://github.com/MunhozThiago/opencode-agent-factory-plugin)    | Dynamic multi-agent orchestration with runtime agent generation and consensus protocols            |
