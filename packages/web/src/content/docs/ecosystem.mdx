...
| [opencode-dynamic-workflows](https://github.com/vogtsw/opencode-dynamic-workflows)                 | Multi-agent workflows via a safe JSON DSL with parallel/sequential phases, synthesis, and resume   |
