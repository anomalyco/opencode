...
| Name                                                                                                      | Description                                                                                       |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [@angansamadder/opencode-tmux](https://github.com/AnganSamadder/opencode-tmux)                            | Smart tmux integration: auto-spawns subagent panes, streams real-time execution with smart layouts |
| [opencode-plugin-auto-update](https://github.com/AnganSamadder/opencode-plugin-auto-update)               | Background plugin updates with safe locking, throttling, and circular update history              |
