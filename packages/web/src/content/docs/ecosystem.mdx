...
| [opencode-reflection](https://github.com/dzianisv/opencode-plugins)                                | Judge layer that re-prompts the agent when it stops prematurely — enforces tests, CI, and PR gates |
