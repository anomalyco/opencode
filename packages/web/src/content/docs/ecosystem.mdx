...
| [@artem-kuprin/opencode-toolcost](https://github.com/ArtemKx1/opencode-toolcost)                  | Real-time per-tool token & cost breakdown in the TUI sidebar — see exactly which tools cost you most |
