...
| [opencode-langsmith-tracing](https://github.com/Dramalf/opencode-langsmith-tracing)               | Stream OpenCode sessions into LangSmith as nested traces for debugging and evaluation            |
| [opencode-contexty](https://github.com/ttalkkak-lab/opencode-contexty)                           | Context window visualization, architecture supervision, and log summarization                  |
