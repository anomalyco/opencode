...
| [opencode-shell-magazine](https://github.com/aiev/opencode-shell-magazine)                         | Real-time shell command monitor for the TUI: status, output, history and actions                   |
| [opencode-todolist](https://github.com/aiev/opencode-todolist)                                     | Restores todowrite/todoread with a sidebar todo strip and context summaries                        |
| [opencode-cut](https://github.com/aiev/opencode-cut)                                               | Clipboard-aware Ctrl+X cut for prompt and dialog inputs                                            |
| [opencode-deepseek-peak](https://github.com/aiev/opencode-deepseek-peak)                           | DeepSeek peak/off-peak pricing with Chinese holidays, header truth and next-change times           |
