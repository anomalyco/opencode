...
| [@thiagos1lva/opencode-token-usage-chart](https://github.com/thiagos1lva/opencode-token-usage-chart) | Token usage chart for the OpenCode TUI by hour/day/week/month                                     |
