...
| [Claudexor](https://github.com/razzant/claudexor)                                          | Local-first control plane for running OpenCode alongside Claude Code, Codex, and Cursor with quota-aware Claude/Codex account rotation, shared thread context, and cross-harness review |
