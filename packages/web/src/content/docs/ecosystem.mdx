...
| [opencode-commandcode-usage](https://github.com/Jovan1666/commandcode-usage)                       | Command Code plan usage in the sidebar: 5-hour and weekly windows with reset times                 |
