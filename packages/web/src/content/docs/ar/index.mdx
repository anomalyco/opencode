...
لأفضل تجربة على Windows، نوصي باستخدام [Windows Subsystem for Linux (WSL)](./windows-wsl). يوفر أداء أفضل وتوافقا كاملا مع ميزات OpenCode.
:::
...
إذا كنت جديدا على استخدام مزوّدي LLM، فنوصي باستخدام [OpenCode Zen](./zen).
...
بدلا من ذلك يمكنك اختيار أحد المزوّدين الآخرين. [اعرف المزيد](./providers#directory).
...
يمكن [مشاركة المحادثات](./share) التي تجريها مع OpenCode مع فريقك.
...
لتجعله مناسبا لك، نوصي بـ [اختيار سمة](./themes)، و[تخصيص اختصارات لوحة المفاتيح](./keybinds)، و[إعداد منسقات الشيفرة](./formatters)، و[إنشاء أوامر مخصصة](./commands)، أو التجربة مع [إعدادات OpenCode](./config).
