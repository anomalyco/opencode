...
يبدأ سطر أوامر OpenCode افتراضيا واجهة [TUI](./tui) عند تشغيله بدون أي معاملات.
...
يقوم ذلك بإعداد سير عمل GitHub Actions اللازم ويرشدك خلال عملية التهيئة. [اعرف المزيد](./github).
...
هذا مفيد لتحديد اسم النموذج الدقيق الذي ستستخدمه في [تهيئتك](./config/).
...
بدء خادم OpenCode بدون واجهة للوصول عبر API. راجع [توثيق الخادم](./server) لواجهة HTTP الكاملة.
