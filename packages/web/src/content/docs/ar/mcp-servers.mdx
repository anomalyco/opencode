...
تتغلب قيم إعداداتك المحلية على القيم الافتراضية البعيدة. راجع [أولوية الإعدادات](./config#precedence-order) لمزيد من التفاصيل.
...
2. في [إعدادات الوكيل](./agents#tools)، فعّل خادم MCP كأداة.
...
بدلا من ذلك، يمكنك إضافة شيء مثل هذا إلى [AGENTS.md](./rules/).
