...
يوجد نوعان من الوكلاء في CyberStrike: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي CyberStrike مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي CyberStrike مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي CyberStrike مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `cyberstrike.json`:
...
- عام: `~/.config/cyberstrike/agents/`
- لكل مشروع: `.cyberstrike/agents/`
...
إذا لم يتم تحديد temperature، يستخدم CyberStrike القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات CyberStrike العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات CyberStrike الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [CyberStrike Zen](/docs/zen)، فستستخدم `cyberstrike/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `cyberstrike models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/CyberStrikeus/cyberstrike).
:::
