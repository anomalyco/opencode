...
:::tip
إذا لم تحدد نموذجا، يستخدم الوكلاء الأساسيون [النموذج المُهيأ عالميا](./config#models)، بينما يستخدم الوكلاء الفرعيون نموذج الوكيل الأساسي الذي استدعاهم.
:::
...
يستخدم معرّف النموذج في إعدادات OpenCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenCode Zen](./zen)، فستستخدم `opencode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
[اعرف المزيد عن الأذونات](./permissions).
