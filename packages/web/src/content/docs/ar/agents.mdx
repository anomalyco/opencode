...
يوجد نوعان من الوكلاء في xcsh: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي xcsh مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي xcsh مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي xcsh مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `xcsh.json`:
...
- عام: `~/.config/xcsh/agents/`
- لكل مشروع: `.xcsh/agents/`
...
إذا لم يتم تحديد temperature، يستخدم xcsh القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات xcsh العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات xcsh الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [xcsh Zen](/docs/zen)، فستستخدم `xcsh/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `xcsh models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/f5xc-salesdemos/xcsh).
:::
