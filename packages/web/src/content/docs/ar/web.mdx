...
:::tip[مستخدمو Windows]
لأفضل تجربة، شغّل `opencode web` من [WSL](./windows-wsl) بدلا من PowerShell. يضمن ذلك وصولا صحيحا إلى نظام الملفات وتكاملا أفضل مع الطرفية.
:::
...
يمكنك ضبط خادم الويب باستخدام خيارات سطر الأوامر أو عبر [ملف الإعدادات](./config).
