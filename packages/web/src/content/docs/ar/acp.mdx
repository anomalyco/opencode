---
title: دعم ACP
description: استخدم xcsh في أي محرر متوافق مع ACP.
---

يدعم xcsh بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام xcsh عبر ACP، اضبط محررك ليشغّل الأمر `xcsh acp`.

يشغّل هذا الأمر xcsh كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'xcsh' من محدد الوكلاء في AI Chat.
...
لاستخدام xcsh كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام xcsh كوكيل ACP للدردشة.
...
يعمل xcsh عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات xcsh
