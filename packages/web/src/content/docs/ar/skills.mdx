...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | يجب أن يكون طوله 1-64 حرفاً.                                                                     |
| `description` | `string` | yes      | يجب أن يكون طوله 1-1024 حرفاً. يُعرض على الوكيل ليتمكن من تحديد وقت تحميل المهارة.              |

يتم تجاهل جميع حقول `frontmatter` الأخرى بأمان.

:::tip
اجعل الوصف محدداً بما يكفي كي يختار الوكيل بشكل صحيح.
:::
