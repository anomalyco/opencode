...
5. **إعدادات `.opencode`** (`.opencode/opencode.json` داخل المشروع) - نفس إعدادات المشروع ولكن بشكل منفصل
6. **أدلة `.opencode`** - الوكلاء، الأوامر، الإضافات
7. **إعدادات ضمنية** (`OPENCODE_CONFIG_CONTENT` env var) - تجاوزات وقت التشغيل
