...
- **حد 5 ساعات** — 20% من حصة الاستخدام الخاصة بك
- **الحد الأسبوعي** — 50% من حصة الاستخدام الخاصة بك
- **الحد الشهري** — 100% من حصة الاستخدام الخاصة بك

هذه الحدود هي نِسَب مئوية من حصة استخدام مشتركة بين جميع النماذج.

### الاستخدام حسب النموذج

يختلف الاستخدام الشهري المتضمن حسب النموذج، وتُحسب قيمته وفق أسعار API الرسمية. أسعار tokens مُدرجة لكل 1M tokens.

| النموذج                                 | الإدخال | الإخراج | القراءة المخزنة | الكتابة المخزنة | الاستخدام الشهري |
| --------------------------------------- | ------- | ------- | --------------- | --------------- | --------- |
...
يعتمد عدد الطلبات على الاستخدام الشهري للنموذج وأسعار API الخاصة به. تستند التقديرات أدناه إلى أنماط استخدام Go المعتادة.
