...
| **Docker Agent**        | يتضمن [Issue #4164](https://github.com/docker/docker-agent/issues/4164) إصلاحًا مقترحًا في [PR #4190](https://github.com/docker/docker-agent/pull/4190)، ولم يُدمج بعد.                                                                                     |
