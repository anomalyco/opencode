---
title: خوادم LSP
description: يتكامل CyberStrike مع خوادم LSP لديك.
---

يتكامل CyberStrike مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي CyberStrike مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `CYBERSTRIKE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح cyberstrike ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات cyberstrike.
