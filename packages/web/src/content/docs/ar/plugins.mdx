...
- `.leak-code/plugins/` - إضافات على مستوى المشروع
- `~/.config/leak-code/plugins/` - إضافات عامة
...
1. إعدادات عامة (`~/.config/leak-code/leak-code.json`)
2. إعدادات المشروع (`leak-code.json`)
3. دليل الإضافات العام (`~/.config/leak-code/plugins/`)
4. دليل إضافات المشروع (`.leak-code/plugins/`)
