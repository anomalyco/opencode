...
للاطلاع على أمثلة، راجع [الإضافات](./ecosystem#plugins) التي أنشأها المجتمع.
...
تصفّح الإضافات المتاحة في [النظام البيئي](./ecosystem#plugins).
...
**الإضافات المحلية** تُحمَّل مباشرة من دليل الإضافات. لاستخدام حزم خارجية، يجب إنشاء `package.json` داخل دليل الإعدادات لديك (راجع [الاعتماديات](#dependencies))، أو نشر الإضافة على npm ثم [إضافتها إلى إعداداتك](./config#plugins).
