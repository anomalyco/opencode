...
أنشئ الملف `.octopus/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات Octopus أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ Octopus:
...
- على مستوى النظام: `~/.config/octopus/commands/`
- لكل مشروع: `.octopus/commands/`
