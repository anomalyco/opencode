...
تتيح الأدوات لـ LLM تنفيذ إجراءات داخل قاعدة الشفرة الخاصة بك. يأتي OpenCode مع مجموعة من الأدوات المدمجة، لكن يمكنك توسيعه عبر [أدوات مخصصة](./custom-tools) أو [خوادم MCP](./mcp-servers).

افتراضيا، تكون جميع الأدوات **مفعلة** ولا تحتاج إلى إذن للتشغيل. يمكنك التحكم في سلوك الأدوات عبر [الأذونات](./permissions).
...
[اعرف المزيد](./permissions) حول تهيئة الأذونات.
...
لتهيئة خوادم LSP المتاحة لمشروعك، راجع [خوادم LSP](./lsp).
...
حمّل [مهارة](./skills) (ملف `SKILL.md`) وأعد محتواها ضمن المحادثة.
...
:::note
هذه الأداة معطلة للوكلاء الفرعيين افتراضيا، لكن يمكنك تفعيلها يدويا. [اعرف المزيد](./agents/#permissions)
:::
...
[اعرف المزيد](./custom-tools) حول إنشاء أدوات مخصصة.
...
[اعرف المزيد](./mcp-servers) حول تهيئة خوادم MCP.
