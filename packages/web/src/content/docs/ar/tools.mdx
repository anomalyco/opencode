...
:::note
عند تفعيل البيئة المعزولة على macOS، يعمل bash مع قيود على نظام الملفات ويمكنه طلب إعادة محاولة منفصلة بدون عزل عند الحاجة.
إذا كنت تعلم أن أمرًا ما يجب أن يبدأ خارج البيئة المعزولة، ضع `# opencode:unsandboxed <reason>` في أول سطر غير فارغ من الأمر.
راجع [إعدادات البيئة المعزولة](/docs/config#sandbox) للسلوك المدعوم والقيود.
:::
