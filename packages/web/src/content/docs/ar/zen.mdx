...
يستخدم [معرّف النموذج](./config/#models) في إعدادات OpenCode الصيغة `opencode/<model-id>`.
...
قد تلاحظ _Claude Haiku 3.5_ في سجل الاستخدام. هذا [نموذج منخفض التكلفة](./config/#models) يُستخدم لتوليد عناوين جلساتك.
