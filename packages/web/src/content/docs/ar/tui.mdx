...
تملك معظم الأوامر أيضا اختصارا باستخدام `ctrl+x` كمفتاح قائد، حيث إن `ctrl+x` هو المفتاح القائد الافتراضي. [اعرف المزيد](./keybinds).
...
أنشئ ملف `AGENTS.md` أو حدّثه. [اعرف المزيد](./rules).
...
شارك الجلسة الحالية. [اعرف المزيد](./share).
...
ألغِ مشاركة الجلسة الحالية. [اعرف المزيد](./share#un-sharing).
