---
title: TUI
description: استخدام واجهة المستخدم TUI في Octopus.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Octopus واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Octopus إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Octopus في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Octopus. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Octopus. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Octopus.
...
استخدم `OCTOPUS_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
