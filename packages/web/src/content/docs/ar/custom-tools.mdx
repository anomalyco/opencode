...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في xcsh.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في xcsh مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.xcsh/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/xcsh/tools/`.
