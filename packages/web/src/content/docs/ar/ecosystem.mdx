...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | إضافة Google Antigravity OAuth مع استرداد النماذج ديناميكيًا وتتبع الحصص واستمرار حالة الأدوار                 |
