...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | تتبع استخدام المزوّد داخل OpenCode عبر نافذة TUI أصلية باستخدام أمر `/usage` بسيط               |
