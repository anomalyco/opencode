...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin)                                   | استخراج البيانات من أي موقع ويب باستخدام آلاف أدوات الكشط والزحف والأتمتة الموثوقة من Apify Store.             |
