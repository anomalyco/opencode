...
:::tip[추천: WSL 사용]
Windows에서 최고의 경험을 위해 [Windows Subsystem for Linux (WSL)](./windows-wsl)를 사용하는 것이 좋습니다. OpenCode의 기능으로 더 나은 성능과 전체 호환성을 제공합니다.
:::
...
LLM 공급자를 사용하는 새로운 경우, [OpenCode Zen](./zen)를 사용하는 것이 좋습니다.
...
또는 다른 공급자 중 하나를 선택할 수 있습니다. [더 알아보기](./providers#directory).
...
OpenCode와 나눈 대화는 [팀과 공유](./share)할 수 있습니다.
...
자신의 것을 만들기 위해, 우리는 [themes](./themes), [keybinds](./keybinds), [configuring code formatters](./formatters), [creating custom commands](./commands), 또는 [OpenCode config](./config)와 함께 연주하는 것을 추천합니다.
