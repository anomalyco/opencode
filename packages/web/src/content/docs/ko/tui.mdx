...
대부분의 명령은 `ctrl+x`를 `ctrl+x`가 기본 리더 키입니다. [더 알아보기](./keybinds).
...
`AGENTS.md` 파일을 만들거나 업데이트하십시오. [더 알아보기](./rules).
...
Unshare 현재 세션. [더 알아보기](./share#un-sharing).
