...
- `.leak-code/plugins/` - 프로젝트 레벨 플러그인
- `~/.config/leak-code/plugins/` - 글로벌 플러그인
...
1. 글로벌 구성 (`~/.config/leak-code/leak-code.json`)
2. 프로젝트 구성 (`leak-code.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/leak-code/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.leak-code/plugins/`)
