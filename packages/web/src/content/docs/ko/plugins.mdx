---
title: 플러그인
description: Octopus를 확장하기 위해 자신만의 플러그인을 작성하세요.
---
...
- `.octopus/plugins/` - 프로젝트 레벨 플러그인
- `~/.config/octopus/plugins/` - 글로벌 플러그인
...
1. 글로벌 구성 (`~/.config/octopus/octopus.json`)
2. 프로젝트 구성 (`octopus.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/octopus/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.octopus/plugins/`)
