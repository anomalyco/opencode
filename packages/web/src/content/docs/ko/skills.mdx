...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | 1-64자여야 합니다.                                                                                |
| `description` | `string` | yes      | 1-1024자여야 합니다. 에이전트가 스킬을 로드할 시기를 결정할 수 있도록 표시됩니다.                |

다른 모든 frontmatter 필드는 안전하게 무시됩니다.

:::tip
에이전트가 올바르게 선택할 수 있도록 설명을 충분히 구체적으로 유지하십시오.
:::
