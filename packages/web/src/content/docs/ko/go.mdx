...
| **Docker Agent**        | [Issue #4164](https://github.com/docker/docker-agent/issues/4164)에 [PR #4190](https://github.com/docker/docker-agent/pull/4190)로 수정안이 제안되었지만 아직 병합되지 않았습니다.                                                                                   |
