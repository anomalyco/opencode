...
OpenCode와 잘 작동하도록 테스트 및 검증. [더 알아보기](./zen).
...
OpenCode Zen은 OpenCode 팀에서 제공하는 테스트 및 검증된 모델 목록입니다. [더 알아보기](./zen).
...
- **apiKey**: `env` 변수 구문을 사용하여 설정, [learn more](./config#env-vars).
