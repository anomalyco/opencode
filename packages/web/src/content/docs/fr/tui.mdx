...
Ceci est séparé de `leak-code.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `LEAKCODE_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
