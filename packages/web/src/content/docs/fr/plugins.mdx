...
- `.leak-code/plugins/` - Plugins au niveau du projet
- `~/.config/leak-code/plugins/` - Plugins globaux
...
1. Configuration globale (`~/.config/leak-code/leak-code.json`)
2. Configuration du projet (`leak-code.json`)
3. Répertoire global des plugins (`~/.config/leak-code/plugins/`)
4. Répertoire des plugins du projet (`.leak-code/plugins/`)
