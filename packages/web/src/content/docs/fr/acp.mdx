...
OpenCode est disponible dans les IDE JetBrains via le registre ACP.

Pour l'utiliser, installez ou mettez à jour le plugin JetBrains AI Assistant, ouvrez AI Chat et sélectionnez **Install From ACP Registry** dans le sélecteur de mode de chat. Vous pouvez aussi aller dans **Settings | Tools | AI Assistant | Agents**. Recherchez **OpenCode**, installez-le, appliquez les paramètres, puis choisissez **OpenCode** dans le sélecteur d'agents d'AI Chat.

Entrée du registre : `opencode`

Consultez la [documentation JetBrains ACP](https://www.jetbrains.com/help/ai-assistant/acp.html) et la [documentation du registre ACP](https://agentclientprotocol.com/get-started/registry) pour plus de détails.
