...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Suite multi-agents légère avec 7 agents spécialisés (Orchestrator, Explorer, Oracle, etc.) |
