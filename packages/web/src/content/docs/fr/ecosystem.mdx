...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Suivez l'utilisation du fournisseur dans OpenCode avec une boîte de dialogue TUI native via la simple commande `/usage` |
