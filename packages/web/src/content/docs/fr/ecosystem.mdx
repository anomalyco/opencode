...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Plugin OAuth Google Antigravity, avec prise en charge de la recherche Google et une gestion d'API plus robuste                         |
