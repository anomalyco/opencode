...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Plugin OAuth Google Antigravity avec récupération dynamique des modèles, suivi des quotas et persistance de l'état des tours |
