...
| **Docker Agent**        | L'[issue #4164](https://github.com/docker/docker-agent/issues/4164) dispose d'un correctif proposé dans la [PR #4190](https://github.com/docker/docker-agent/pull/4190), qui n'a pas encore été fusionnée.                                                                               |
