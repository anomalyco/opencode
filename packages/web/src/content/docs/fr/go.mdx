...
OpenCode Go inclut les limites de base suivantes :

- **Limite de 5 heures** — 20 % de votre quota d’utilisation
- **Limite hebdomadaire** — 50 % de votre quota d’utilisation
- **Limite mensuelle** — 100 % de votre quota d’utilisation

Ces limites sont des pourcentages d’un quota d’utilisation partagé entre tous les modèles.

### Utilisation par modèle

L’utilisation mensuelle incluse varie selon le modèle et est évaluée aux tarifs officiels de l’API. Les prix des tokens sont indiqués par million de tokens.

| Modèle                                  | Input  | Output | Cached Read | Cached Write | Utilisation mensuelle |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | ----------- |
...
Le nombre de requêtes dépend de l’utilisation mensuelle du modèle et de ses tarifs API. Les estimations ci-dessous reposent sur une utilisation typique de Go.
...
- Omen Alpha — 300 tokens en entrée, 40 000 en cache, 100 tokens en sortie par requête
...
- **DeepSeek V4 Flash:** L’accord ZDR est renouvelé chaque mois. L’accord actuel est valable jusqu’au 30 septembre 2026.
