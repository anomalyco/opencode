...
- Qwen3.8 Flash — profil de requête estimé : 600 tokens en entrée, 58,000 tokens lus depuis le cache et 200 tokens en sortie par requête ; exclut les écritures en cache
