...
5. **Configuration `.opencode`** (`.opencode/opencode.json` dans le projet) - identique à la configuration du projet mais séparée
6. **Répertoires `.opencode`** - agents, commandes, plugins
7. **Configuration en ligne** (`OPENCODE_CONFIG_CONTENT` env var) - remplacements d'exécution
