...
| ------------- | -------- | -------- | --------------------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Doit comporter entre 1 et 64 caractères.                                                                        |
| `description` | `string` | yes      | Doit comporter entre 1 et 1024 caractères. Affiché à l'agent pour qu'il puisse décider quand charger la compétence. |

Tous les autres champs de frontmatter sont ignorés en toute sécurité.

:::tip
Gardez la description suffisamment précise pour que l'agent puisse choisir correctement.
:::
