...
description: Créez des outils que le LLM peut appeler dans pencode.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de pencode comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.pencode/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/pencode/tools/`.
