...
L’option `mode` est désormais obsolète. [En savoir plus](./agents).
:::
...
Voir également : [Formatters](./formatters) pour plus d'informations sur la configuration du formatage du code.
