---
title: Zen
description: Liste organisée de modèles fournis par Octopus.
---
...
Octopus Zen est une liste de modèles testés et vérifiés fournie par l'équipe Octopus.

:::note
Octopus Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans Octopus. Vous vous connectez à Octopus Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Octopus.
...
Octopus Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

Octopus Zen fonctionne comme n'importe quel autre fournisseur dans Octopus.

1. Vous vous connectez à **<a href={console}>Octopus Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Octopus Zen et collez votre clé API.
...
Le [model id](/docs/config/#models) dans votre configuration Octopus utilise le format `opencode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `opencode/gpt-5.5` dans votre configuration.
...
- MiniMax M2.5 Free est disponible sur Octopus pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Ring 2.6 1T Free est disponible sur Octopus pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur Octopus pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Octopus pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé Octopus Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Octopus également.
