---
title: Zen
description: Curated list of models provided by ChaliceCode.
---
...
ChaliceCode Zen is a list of tested and verified models provided by the ChaliceCode team.

:::note
ChaliceCode Zen is currently in beta.
:::

Zen works like any other provider in ChaliceCode. You login to ChaliceCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with ChaliceCode.
:::
...
ChaliceCode Zen is an AI gateway that gives you access to these models.

---

## How it works

ChaliceCode Zen works like any other provider in ChaliceCode.

1. You sign in to **<a href={console}>ChaliceCode Zen</a>**, add your billing
   details, and copy your API key.
2. You run `opencode auth login`, select chalice, and paste your API key.
...
| ----------------- | ----------------- | --------------------------------------------- | --------------------------- |
| GPT 5.1           | gpt-5.1           | `https://chalice-code.ai/zen/v1/responses`        | `@ai-sdk/openai`            |
| GPT 5.1 Codex     | gpt-5.1-codex     | `https://chalice-code.ai/zen/v1/responses`        | `@ai-sdk/openai`            |
| GPT 5             | gpt-5             | `https://chalice-code.ai/zen/v1/responses`        | `@ai-sdk/openai`            |
| GPT 5 Codex       | gpt-5-codex       | `https://chalice-code.ai/zen/v1/responses`        | `@ai-sdk/openai`            |
| GPT 5 Nano        | gpt-5-nano        | `https://chalice-code.ai/zen/v1/responses`        | `@ai-sdk/openai`            |
| Claude Sonnet 4.5 | claude-sonnet-4-5 | `https://chalice-code.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| Claude Sonnet 4   | claude-sonnet-4   | `https://chalice-code.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5  | claude-haiku-4-5  | `https://chalice-code.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5  | claude-3-5-haiku  | `https://chalice-code.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| Claude Opus 4.1   | claude-opus-4-1   | `https://chalice-code.ai/zen/v1/messages`         | `@ai-sdk/anthropic`         |
| GLM 4.6           | glm-4.6           | `https://chalice-code.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2           | kimi-k2           | `https://chalice-code.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B  | qwen3-coder       | `https://chalice-code.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Grok Code Fast 1  | grok-code         | `https://chalice-code.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Big Pickle        | big-pickle        | `https://chalice-code.ai/zen/v1/chat/completions` | `@ai-sdk/openai-compatible` |

The [model id](/docs/config/#models) in your ChaliceCode config
...
```
https://chalice-code.ai/zen/v1/chat/completions
```
...
```
https://chalice-code.ai/zen/v1/models
```
...
- Grok Code Fast 1 is currently free on ChaliceCode for a limited time. The xAI team is using this time to collect feedback and improve Grok Code.
- Big Pickle is a stealth model that's free on ChaliceCode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with ChaliceCode as well.
