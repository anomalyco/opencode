---
title: Zen
description: Curated list of models provided by Leak Code.
---
...
OpenCode Zen is a list of tested and verified models provided by the Leak Code team.

Zen works like any other provider in Leak Code. You login to OpenCode Zen and get
...
OpenCode Zen works like any other provider in Leak Code.
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. Leak Code uses these models to generate session titles.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Leak Code as well.
