---
title: Zen
description: Curated list of models provided by Octopus.
---
...
Octopus Zen is a list of tested and verified models provided by the Octopus team.

:::note
Octopus Zen is currently in beta.
:::

Zen works like any other provider in Octopus. You login to Octopus Zen and get
...
Octopus Zen is an AI gateway that gives you access to these models.

---

## How it works

Octopus Zen works like any other provider in Octopus.

1. You sign in to **<a href={console}>Octopus Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Octopus Zen, and paste your API key.
...
- MiniMax M2.5 Free is available on Octopus for a limited time. The team is using this time to collect feedback and improve the model.
- Ring 2.6 1T Free is available on Octopus for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on Octopus for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Octopus for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Octopus as well.
