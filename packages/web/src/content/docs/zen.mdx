...
| Trinity Large Preview         | trinity-large         | `https://opencode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Trinity Large Preview             | Free   | Free   | Free        | -            |
...
- Trinity Large Preview is currently free on OpenCode for a limited time. The team is using this time to collect feedback and improve the model.
