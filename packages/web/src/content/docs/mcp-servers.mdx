...
Add the [opencode-history-mcp](https://github.com/crottolo/opencode-history-mcp) server to search your past OpenCode conversations before starting new work on a module or file.
