...
OpenCode is available in JetBrains IDEs through the ACP Registry.

To use it, install or update the JetBrains AI Assistant plugin, open AI Chat, and select **Install From ACP Registry** from the chat mode selector. You can also go to **Settings | Tools | AI Assistant | Agents**. Search for **OpenCode**, install it, apply the settings, and then choose **OpenCode** from the AI Chat agent selector.

Registry entry: `opencode`

See the [JetBrains ACP documentation](https://www.jetbrains.com/help/ai-assistant/acp.html) and the [ACP Registry documentation](https://agentclientprotocol.com/get-started/registry) for more details.
