...
Значения вашей локальной конфигурации переопределяют удаленные значения по умолчанию. Дополнительную информацию см. в [config Priorce](./config#precedence-order)].
...
2. В вашей [конфигурации агента](./agents#tools)] включите сервер MCP в качестве инструмента.
...
Альтернативно вы можете добавить что-то подобное в свой файл [AGENTS.md](./rules/).
