...
Создайте `.leak-code/commands/test.md`:

```md title=".leak-code/commands/test.md"
---
...
```json title="leak-code.jsonc" {4-12}
{
...
- Глобальный: `~/.config/leak-code/commands/`
- Для каждого проекта: `.leak-code/commands/`

```markdown title="~/.config/leak-code/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".leak-code/commands/component.md"
---
...
```md title=".leak-code/commands/create-file.md"
---
...
```md title=".leak-code/commands/analyze-coverage.md"
---
...
```md title=".leak-code/commands/review-changes.md"
---
...
```md title=".leak-code/commands/review-component.md"
---
