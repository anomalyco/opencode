...
OpenCode доступен в JetBrains IDE через ACP Registry.

Чтобы использовать его, установите или обновите плагин JetBrains AI Assistant, откройте AI Chat и выберите **Install From ACP Registry** в селекторе режима чата. Также можно перейти в **Settings | Tools | AI Assistant | Agents**. Найдите **OpenCode**, установите его, примените настройки, а затем выберите **OpenCode** в селекторе агентов AI Chat.

Запись в реестре: `opencode`

Подробнее см. [документацию JetBrains ACP](https://www.jetbrains.com/help/ai-assistant/acp.html) и [документацию ACP Registry](https://agentclientprotocol.com/get-started/registry).
