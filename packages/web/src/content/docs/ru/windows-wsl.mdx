...
:::caution
При использовании `--hostname 0.0.0.0` задайте `IMECODE_SERVER_PASSWORD`, чтобы защитить сервер.

```bash
IMECODE_SERVER_PASSWORD=your-password opencode serve --hostname 0.0.0.0
```
