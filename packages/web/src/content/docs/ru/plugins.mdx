...
- `.octopus/plugins/` – плагины уровня проекта.
- `~/.config/octopus/plugins/` — глобальные плагины
...
1. Глобальная конфигурация (`~/.config/octopus/octopus.json`)
2. Конфигурация проекта (`octopus.json`)
3. Глобальный каталог плагинов (`~/.config/octopus/plugins/`)
4. Каталог плагинов проекта (`.octopus/plugins/`)
