...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Отслеживайте использование провайдера в OpenCode через нативный TUI-диалог с помощью простой команды `/usage` |
