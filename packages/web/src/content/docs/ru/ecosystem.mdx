...
| [opencode-clippy](https://github.com/huangcheng/opencode-clippy)   | Плагин-ассистент Clippy с подсказками, виджетом для рабочего стола и обнаружением бездействия |
