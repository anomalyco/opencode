...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin/tree/main)                         | Извлекайте данные с любого веб-сайта с помощью тысяч проверенных скраперов, краулеров и автоматизаций из Apify Store. |
