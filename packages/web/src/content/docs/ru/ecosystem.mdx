...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin)                                   | Извлекайте данные с любого веб-сайта с помощью тысяч доверенных скраперов, краулеров и автоматизаций из Apify Store. |
