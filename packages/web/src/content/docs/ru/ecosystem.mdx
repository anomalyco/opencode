...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Плагин Google Antigravity OAuth с поддержкой поиска Google и более надежной обработкой API                                                       |
