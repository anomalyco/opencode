...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Плагин OAuth Google Antigravity с динамическим получением моделей, отслеживанием квот и сохранением состояния ходов |
