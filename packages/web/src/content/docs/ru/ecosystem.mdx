...
| [opencode-plan-manager](https://github.com/yurihbm/opencode-plan-manager)                                 | Планирование внедрения ИИ-ориентированных решений для современных агентских рабочих процессов                                                     |
