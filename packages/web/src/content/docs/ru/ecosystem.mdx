...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Легкая мульти-агентная платформа с 7 специализированными агентами (Orchestrator, Explorer, Oracle и др.) |
