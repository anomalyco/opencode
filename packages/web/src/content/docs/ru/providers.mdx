...
протестировано и проверено на хорошую работу с OpenCode. [Подробнее](./zen).
...
OpenCode Zen — это список протестированных и проверенных моделей, предоставленный командой OpenCode. [Подробнее](./zen).
...
- **apiKey**: устанавливается с использованием синтаксиса переменной `env`, [подробнее ](./config#env-vars).
