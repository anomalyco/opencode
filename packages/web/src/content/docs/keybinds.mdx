...
```json title="opencode.json"
{
  ...
  "keybinds": {
    ...
    "automation_list": "<leader>o",
    "automation_create": "shift+n",
    "automation_run": "shift+r",
    "automation_open": "shift+o",
    "automation_history": "shift+h",
    "automation_edit": "shift+e",
    "automation_delete": "shift+d",
    "automation_clear_history": "shift+l",
    "automation_export": "shift+x",
    "automation_export_all": "shift+a",
    "automation_import": "shift+i",
