...
- **`variant_list`** — Open a variant picker. In the default config it is set to `"none"`; add a combo under `keybinds.variant_list` in `tui.json` if you want this action.
