...
ChaliceCode has a list of keybinds that you can customize through the ChaliceCode config.
...
ChaliceCode uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
