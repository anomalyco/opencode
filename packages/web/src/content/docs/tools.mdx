...
When [`ai.useToonEncoding`](/docs/config#toon-encoding) is enabled, search results use the TOON format for improved token efficiency.
...
When [`ai.useToonEncoding`](/docs/config#toon-encoding) is enabled, file lists use the TOON format for improved token efficiency.
...
When [`ai.useToonEncoding`](/docs/config#toon-encoding) is enabled, directory listings use the TOON format for improved token efficiency.
