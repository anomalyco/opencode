...
OpenCode ist in JetBrains-IDEs über das ACP Registry verfügbar.

Um es zu verwenden, installieren oder aktualisieren Sie das JetBrains-AI-Assistant-Plugin, öffnen Sie AI Chat und wählen Sie im Chatmodus-Auswahlmenü **Install From ACP Registry**. Sie können auch zu **Settings | Tools | AI Assistant | Agents** gehen. Suchen Sie nach **OpenCode**, installieren Sie es, übernehmen Sie die Einstellungen und wählen Sie dann **OpenCode** im Agentenauswahlmenü von AI Chat.

Registry-Eintrag: `opencode`

Siehe die [JetBrains-ACP-Dokumentation](https://www.jetbrains.com/help/ai-assistant/acp.html) und die [ACP-Registry-Dokumentation](https://agentclientprotocol.com/get-started/registry) für weitere Details.
