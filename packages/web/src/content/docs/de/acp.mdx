...
description: Verwenden Sie xcsh in jedem ACP-kompatiblen Editor.
---

xcsh unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um xcsh über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `xcsh acp`.

Der Befehl startet xcsh als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „xcsh“ in der AI Chat Agent Selector.
...
Um xcsh als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass xcsh als ACP-Agent für den Chat verwendet wird.
...
xcsh funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer xcsh-Konfiguration konfiguriert sind
