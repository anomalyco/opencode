...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Sollte 1-64 Zeichen lang sein.                                                                    |
| `description` | `string` | yes      | Sollte 1-1024 Zeichen lang sein. Wird dem Agenten angezeigt, damit er entscheiden kann, wann der Skill geladen werden soll. |

Alle anderen Frontmatter-Felder werden sicher ignoriert.

:::tip
Formuliere die Beschreibung so konkret, dass der Agent den Skill eindeutig auswaehlen kann.
:::
