---
title: Zen
description: Kuratierte Modellliste direkt von Octopus.
---
...
Octopus Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Octopus-Team bereitgestellt wird.

:::note
Octopus Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Octopus. Du meldest dich bei Octopus Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Octopus zu nutzen.
...
Octopus Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Octopus Zen funktioniert wie jeder andere Provider in Octopus.

1. Du meldest dich bei **<a href={console}>Octopus Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Octopus Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Octopus-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `opencode/gpt-5.5` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf Octopus verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ring 2.6 1T Free ist für begrenzte Zeit auf Octopus verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf Octopus verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Octopus verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Octopus Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Octopus auch jeden anderen Provider zu verwenden.
