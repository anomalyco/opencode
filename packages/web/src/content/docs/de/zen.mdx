---
title: Zen
description: Kuratierte Modellliste direkt von CyberStrike.
---
...
CyberStrike Zen ist eine vom CyberStrike-Team getestete und verifizierte Modellliste.

:::note
CyberStrike Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in CyberStrike.
Du meldest dich bei CyberStrike Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit CyberStrike funktionieren.
:::
...
CyberStrike Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

CyberStrike Zen funktioniert wie jeder andere Provider in CyberStrike.

1. Melde dich bei **<a href={console}>CyberStrike Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle CyberStrike Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner CyberStrike-Konfiguration hat das Format `cyberstrike/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `cyberstrike/gpt-5.2-codex`.
...
Wir haben CyberStrike Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und CyberStrike weiter mit anderen Providern nutzen kannst
