...
Die [Model-ID](./config/#models) in deiner OpenCode-Konfiguration hat das Format `opencode/<model-id>`.
...
Das ist ein [guenstiges Modell](./config/#models), das fuer Session-Titel verwendet wird.
