---
title: Zen
description: Kuratierte Modellliste direkt von Pencode.
---
...
Pencode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Pencode-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Pencode. Du meldest dich bei Pencode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Pencode zu nutzen.
...
Pencode Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Pencode Zen funktioniert wie jeder andere Provider in Pencode.

1. Du meldest dich bei **<a href={console}>Pencode Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Pencode Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Pencode-Konfiguration verwendet das Format `pencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `pencode/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. Pencode verwendet diese Modelle, um Session-Titel zu generieren.
...
- MiMo-V2.5 Free ist für begrenzte Zeit auf Pencode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Hy3 Free ist für begrenzte Zeit auf Pencode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Pencode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3.5 Lightning Free ist für begrenzte Zeit auf Pencode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Pencode verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ox Alpha Free ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Pencode verfügbar ist. Der Anbieter befolgt eine Zero-Retention-Richtlinie und verwendet deine Daten nicht zum Trainieren von Modellen.
- Muse Spark 1.2 Contributor Free ist für begrenzte Zeit auf Pencode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Pencode Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Pencode auch jeden anderen Provider zu verwenden.
