...
:::tip[Windows Users]
For the best experience, run `opencode web` from [WSL](./windows-wsl) rather than PowerShell. This ensures proper file system access and terminal integration.
:::
...
You can configure the web server using command line flags or in your [config file](./config).
