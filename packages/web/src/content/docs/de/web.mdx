...
:::tip[Windows Users]
Um die beste Erfahrung zu erzielen, führen Sie `opencode web` über [WSL](./windows-wsl) und nicht über PowerShell aus. Dies gewährleistet den ordnungsgemäßen Zugriff auf das Dateisystem und die Terminalintegration.
:::
...
Sie können den Webserver mithilfe von Befehlszeilen-Flags oder in Ihrer [Konfigurationsdatei](./config) konfigurieren.
