...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Verfolgen Sie die Nutzung von Anbietern in OpenCode mit einem nativen TUI-Dialog per einfachem `/usage`-Befehl |
