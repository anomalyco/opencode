...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin)                         | Extrahieren Sie Daten von jeder Website mit Tausenden vertrauenswürdiger Scraper, Crawler und Automatisierungen aus dem Apify Store. |
