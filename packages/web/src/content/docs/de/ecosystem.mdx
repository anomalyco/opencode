...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Google Antigravity OAuth-Plugin mit Unterstützung für die Google-Suche und robustere API-Verarbeitung                         |
