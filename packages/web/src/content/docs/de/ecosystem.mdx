...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Leichtgewichtige Multi-Agent-Suite mit 7 spezialisierten Agenten (Orchestrator, Explorer, Oracle, etc.) |
