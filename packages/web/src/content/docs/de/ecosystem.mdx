...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Google Antigravity OAuth-Plugin mit dynamischem Modellabruf, Quotenverfolgung und Rundenstatus-Persistenz |
