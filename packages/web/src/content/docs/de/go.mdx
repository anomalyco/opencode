...
| **Docker Agent**        | Für [Issue #4164](https://github.com/docker/docker-agent/issues/4164) gibt es einen vorgeschlagenen Fix in [PR #4190](https://github.com/docker/docker-agent/pull/4190), der noch nicht gemergt wurde.                                                                     |
