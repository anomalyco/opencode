...
3. für jede Unterhaltung eine stabile Sitzungs-ID in `x-opencode-session` senden, damit wir das Routing und
   ...
   Dieselbe ID für alle Anfragen einer Unterhaltung wiederverwenden, Hilfsaufrufe eingeschlossen, statt pro Anfrage
   oder pro Prozess eine neue zu erzeugen, und sie an allen vom Client genutzten Endpunkten senden (`/responses`,
   `/chat/completions` und `/messages`); ein Header, der nur in der Middleware eines einzigen SDK gesetzt wird,
   erreicht die anderen nicht.
...
| Model                                   | Input  | Output | Cached Read | Cached Write | Monatliches Limit                                           |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | ----------------------------------------------------------- |
...
| DeepSeek V4.1 Flash (Off-Peak)          | $0.15  | $0.60  | $0.003      | -            | ~~$15~~ **$60**<br /><small>4x · Endet am 27. Sept.</small> |
| DeepSeek V4.1 Flash (Peak)              | $0.30  | $1.20  | $0.006      | -            | ~~$15~~ **$60**<br /><small>4x · Endet am 27. Sept.</small> |
...
| DeepSeek V4.1 Flash<br /><small>4x · Endet am 27. Sept.</small> | ~~6,500~~<br />**26,000** | ~~16,250~~<br />**65,000** | ~~32,500~~<br />**130,000** |
...
| DeepSeek V4.1 Flash          | Nicht verwendet | 0 Tage            |
