...
5. **`.opencode`-Konfiguration** (`.opencode/opencode.json` im Projekt) – wie Projektkonfiguration, aber separat verwaltet
6. **`.opencode` Verzeichnisse** – Agenten, Befehle, Plugins
7. **Inline-Konfiguration** (`OPENCODE_CONFIG_CONTENT` env var) – Laufzeitüberschreibungen
