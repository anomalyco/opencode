...
3. **Benutzerdefinierte Konfiguration** (`IMECODE_CONFIG` env var) – benutzerdefinierte Überschreibungen
...
6. **Inline-Konfiguration** (`IMECODE_CONFIG_CONTENT` env var) – Laufzeitüberschreibungen
...
Geben Sie mithilfe der Umgebungsvariablen `IMECODE_CONFIG` einen benutzerdefinierten Konfigurationsdateipfad an.
...
Geben Sie mit `IMECODE_CONFIG_DIR` ein benutzerdefiniertes Konfigurationsverzeichnis an.
