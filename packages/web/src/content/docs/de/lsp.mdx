---
title: LSP Server
description: xcsh lässt sich in Ihren LSP-Server integrieren.
---

xcsh lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

xcsh verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn xcsh eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer xcsh-Konfiguration anpassen.
