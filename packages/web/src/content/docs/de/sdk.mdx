...
Damit kannst du Integrationen bauen und leak-code programmatisch steuern.
...
`leak-code.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
