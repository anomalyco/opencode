...
Getestet und verifiziert, dass es gut mit OpenCode funktioniert. [Learn more](./zen).
...
OpenCode Zen ist eine Liste getesteter und verifizierter Modelle, die vom OpenCode-Team bereitgestellt werden. [Learn more](./zen).
...
- **apiKey**: Wird mit der Variablensyntax `env`, [learn more](./config#env-vars), festgelegt.
