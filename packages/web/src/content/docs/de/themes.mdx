...
Mit CyberStrike kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet CyberStrike das `cyberstrike`-Theme.
...
CyberStrike liefert mehrere eingebaute Themes mit.
...
- CyberStrike optisch ans Terminal anpassen wollen
...
CyberStrike unterstuetzt ein flexibles JSON-basiertes Theme-System.
