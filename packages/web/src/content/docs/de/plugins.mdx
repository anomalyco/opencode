...
- `.leak-code/plugins/` – Plugins auf Projektebene
- `~/.config/leak-code/plugins/` – Globale Plugins
...
1. Globale Konfiguration (`~/.config/leak-code/leak-code.json`)
2. Projektkonfiguration (`leak-code.json`)
3. Globales Plugin-Verzeichnis (`~/.config/leak-code/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.leak-code/plugins/`)
