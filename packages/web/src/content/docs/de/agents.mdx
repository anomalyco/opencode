...
Konfigurieren Sie Agenten in Ihrer `leak-code.json`-Konfigurationsdatei:
...
:::tip
Führen Sie `leak-code models` aus, um eine Liste der verfügbaren Modelle anzubieten.
:::
