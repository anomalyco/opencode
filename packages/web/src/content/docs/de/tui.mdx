---
title: TUI
description: Arbeite mit Octopus in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Octopus bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Octopus die TUI im aktuellen Verzeichnis.
...
In der Octopus-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Octopus hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Octopus. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `octopus.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `OCTOPUS_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
