...
Dies ist getrennt von `leak-code.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `LEAKCODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
