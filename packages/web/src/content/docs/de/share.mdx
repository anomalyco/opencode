---
title: Teilen
description: Teile CyberStrike-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CyberStrike-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CyberStrike Folgendes:
...
CyberStrike hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CyberStrike den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`cyberstrike.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du cyberstrike in deiner Organisation einsetzt.
