---
title: Teilen
description: Teile xcsh-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu xcsh-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht xcsh Folgendes:
...
xcsh hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt xcsh den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`xcsh.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du xcsh in deiner Organisation einsetzt.
