---
title: Teilen
description: Teile Octopus-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Octopus-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Octopus Folgendes:
...
Octopus hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Octopus den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`octopus.json` fest und committe die Datei.
