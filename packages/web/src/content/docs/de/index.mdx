...
- **Mit Mise**
  ...
  ```bash
  mise use -g github:f5xc-salesdemos/opencode
  ```

- **Verwendung von Docker**

  ```bash
  docker run -it --rm ghcr.io/f5xc-salesdemos/opencode
  ```

Die Unterstützung für die Installation von OpenCode unter Windows mit Bun ist derzeit in Arbeit.

Sie können die Binärdatei auch aus [Releases](https://github.com/f5xc-salesdemos/opencode/releases) abrufen.
