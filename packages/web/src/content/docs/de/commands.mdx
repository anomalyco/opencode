...
Erstellen Sie `.pencode/commands/test.md`:

```md title=".pencode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Pencode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Pencode [config](/docs/config):

```json title="pencode.jsonc" {4-12}
{
...
- Global: `~/.config/pencode/commands/`
- Pro Projekt: `.pencode/commands/`

```markdown title="~/.config/pencode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".pencode/commands/component.md"
---
...
```md title=".pencode/commands/create-file.md"
---
...
```md title=".pencode/commands/analyze-coverage.md"
---
...
```md title=".pencode/commands/review-changes.md"
---
...
```md title=".pencode/commands/review-component.md"
---
...
Pencode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
