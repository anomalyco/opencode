...
Erstellen Sie `.cyberstrike/commands/test.md`:
...
Sie können benutzerdefinierte Befehle über die CyberStrike-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem CyberStrike [config](/docs/config):
...
- Pro Projekt: `.cyberstrike/commands/`
...
CyberStrike enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
