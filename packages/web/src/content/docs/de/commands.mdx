...
Erstellen Sie `.octopus/commands/test.md`:

```md title=".octopus/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Octopus-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Octopus [config](/docs/config):

```json title="octopus.jsonc" {4-12}
{
...
- Global: `~/.config/octopus/commands/`
- Pro Projekt: `.octopus/commands/`

```markdown title="~/.config/octopus/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".octopus/commands/component.md"
---
...
```md title=".octopus/commands/create-file.md"
---
...
```md title=".octopus/commands/analyze-coverage.md"
---
...
```md title=".octopus/commands/review-changes.md"
---
...
```md title=".octopus/commands/review-component.md"
---
...
Octopus enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
