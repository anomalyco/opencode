...
Erstellen Sie `.xcsh/commands/test.md`:

```md title=".xcsh/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die xcsh-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem xcsh [config](/docs/config):

```json title="xcsh.jsonc" {4-12}
{
...
- Global: `~/.config/xcsh/commands/`
- Pro Projekt: `.xcsh/commands/`

```markdown title="~/.config/xcsh/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".xcsh/commands/component.md"
---
...
```md title=".xcsh/commands/create-file.md"
---
...
```md title=".xcsh/commands/analyze-coverage.md"
---
...
```md title=".xcsh/commands/review-changes.md"
---
...
```md title=".xcsh/commands/review-component.md"
---
...
xcsh enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
