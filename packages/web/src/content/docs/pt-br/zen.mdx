...
O [id do modelo](./config/#models) na sua configuração da OpenCode usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `opencode/gpt-5.2-codex` na sua configuração.
...
Você pode notar _Claude Haiku 3.5_ em seu histórico de uso. Este é um [modelo de baixo custo](./config/#models) que é usado para gerar os títulos de suas sessões.
