...
Configure os agentes em seu arquivo de configuração `leak-code.json`:
...
:::tip
Execute `leak-code models` para ver uma lista dos modelos disponíveis.
:::
