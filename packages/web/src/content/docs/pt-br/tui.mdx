...
Isso é separado do `octopus.json`, que configura o comportamento do servidor/runtime.
...
Use `OCTOPUS_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
