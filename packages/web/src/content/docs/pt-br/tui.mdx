...
Isso é separado do `leak-code.json`, que configura o comportamento do servidor/runtime.
...
Use `LEAKCODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
