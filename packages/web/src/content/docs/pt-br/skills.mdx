...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Deve ter de 1 a 64 caracteres.                                                                    |
| `description` | `string` | yes      | Deve ter de 1 a 1024 caracteres. Exibida ao agente para que ele possa decidir quando carregar a habilidade. |

Todos os outros campos de frontmatter são ignorados com segurança.

:::tip
Mantenha a descrição específica o suficiente para que o agente escolha corretamente.
:::
