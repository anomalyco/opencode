...
OpenCode Zen é uma lista de modelos fornecidos pela equipe do OpenCode que foram testados e verificados para funcionar bem com o OpenCode. [Saiba mais](./zen).
...
OpenCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do OpenCode. [Saiba mais](./zen).
...
- **apiKey**: Definido usando a sintaxe de variável `env`, [saiba mais](./config#env-vars).
