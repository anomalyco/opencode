...
1. Um emulador de terminal moderno, como por exemplo:
...
Para uma melhor experiência no Windows, recomendamos usar o [Windows Subsystem for Linux (WSL)](/docs/windows-wsl). Ele oferece melhor desempenho e total compatibilidade com os recursos do opencode.
:::
...
O suporte para instalar o opencode no Windows usando Bun está atualmente em desenvolvimento.
...
Zen conta com uma lista selecionada de modelos que foram testados e verificados pela equipe do opencode.
...
Agora que você configurou um provedor, navegue até um projeto no qual deseja trabalhar.
...
1. **Criar um plano**
   ...
   É importante fornecer ao opencode detalhes suficientes para entender o que você deseja. Ajuda conversar com ele como se você estivesse falando com um desenvolvedor júnior da sua equipe.
...
Certifique-se de fornecer uma boa quantidade de detalhes para que o opencode faça as alterações corretas.
