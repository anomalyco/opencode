...
Use-o para construir integrações e controlar o leak-code programaticamente.
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `leak-code.json`, mas você pode substituir ou adicionar configuração inline:
