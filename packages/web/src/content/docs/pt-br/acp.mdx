...
Para usar opencode via ACP, configure seu editor para executar o comando `leak-code acp`.
...
Se você precisar passar variáveis de ambiente (como `LEAKCODE_API_KEY`), consulte [Configurando Adaptadores: Variáveis de Ambiente](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) na documentação do CodeCompanion.nvim para detalhes completos.
