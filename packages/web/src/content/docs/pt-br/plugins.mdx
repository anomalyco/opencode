...
- `.octopus/plugins/` - Plugins em nível de projeto
- `~/.config/octopus/plugins/` - Plugins globais
...
1. Configuração global (`~/.config/octopus/octopus.json`)
2. Configuração do projeto (`octopus.json`)
3. Diretório de plugins global (`~/.config/octopus/plugins/`)
4. Diretório de plugins do projeto (`.octopus/plugins/`)
