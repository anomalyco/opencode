...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Plugin Google Antigravity OAuth com recuperação dinâmica de modelos, rastreamento de cotas e persistência de estado de turnos |
