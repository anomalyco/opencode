...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Acompanhe o uso do provedor no OpenCode com um diálogo TUI nativo usando o simples comando `/usage` |
