...
| [@thiagos1lva/opencode-token-usage-chart](https://github.com/thiagos1lva/opencode-token-usage-chart) | Gráfico de uso de tokens no OpenCode TUI com escopo por sessão, workspace e global                                            |
