...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Suite multi-agente leve com 7 agentes especializados (Orchestrator, Explorer, Oracle, etc.) |
