...
| [opencode-plan-manager](https://github.com/yurihbm/opencode-plan-manager)                                 | Planejamento de implementação nativa para IA para fluxos de trabalho modernos baseados em agentes                              |
