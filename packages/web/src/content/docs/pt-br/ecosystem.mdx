...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin/tree/main)                         | Extraia dados de qualquer site com milhares de scrapers, crawlers e automações confiáveis da Apify Store. |
