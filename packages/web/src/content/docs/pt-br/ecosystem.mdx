...
| [@thiagos1lva/opencode-token-usage-chart](https://github.com/thiagos1lva/opencode-token-usage-chart) | Gráfico de uso de tokens no TUI do OpenCode por hora/dia/semana/mês                                                            |
