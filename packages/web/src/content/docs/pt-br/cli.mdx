...
| ------------------------------------- | ------- | --------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT                ` | string  | Credenciais de autenticação JSON inline |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS     ` | boolean | Desabilitar carregamento de skills de pacotes npm |
...
| `OPENCODE_DISABLE_MOUSE               ` | boolean | Desabilitar captura do mouse no TUI |
| `OPENCODE_DISABLE_PRUNE               ` | boolean | Desabilitar a poda de dados antigos |
| `OPENCODE_DISABLE_PROJECT_CONFIG      ` | boolean | Desabilitar carregamento de config a nível de projeto |
...
| `OPENCODE_MODELS_PATH                 ` | string  | Caminho personalizado para arquivo cache JSON de modelos |
...
| `OPENCODE_TUI_CONFIG                  ` | string  | Caminho para o arquivo de configuração TUI |
| `EXA_API_KEY                          ` | string  | Chave de API para busca web Exa (requer `OPENCODE_ENABLE_EXA`) |
| `OTEL_EXPORTER_OTLP_ENDPOINT          ` | string  | Endpoint do exportador OpenTelemetry OTLP |
| `OTEL_EXPORTER_OTLP_HEADERS           ` | string  | Headers do exportador OpenTelemetry OTLP |
| `OTEL_RESOURCE_ATTRIBUTES             ` | string  | Atributos de recurso OpenTelemetry (pares chave=valor) |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI                  ` | boolean | Habilitar bridge Effect HttpApi |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES               ` | boolean | Habilitar workspaces experimentais |
