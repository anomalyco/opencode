...
:::tip[Sem abertura automática]
Para iniciar o servidor web sem abrir automaticamente o navegador, use `opencode serve`:

```bash
opencode serve --hostname 0.0.0.0 --port 4096
```

Em seguida, navegue manualmente para `http://localhost:4096` (ou seu endereço de rede). Ao vincular a `0.0.0.0`, defina `OPENCODE_SERVER_PASSWORD` para proteger o acesso.
:::
