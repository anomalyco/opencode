...
3. Enviar um ID de sessão estável em `x-opencode-session` para cada conversa, para que possamos otimizar o roteamento e
   o cache de prompts.
   Reutilizar o mesmo ID em todas as requisições de uma conversa, incluindo chamadas auxiliares, em vez de gerar um
   por requisição ou por processo, e enviá-lo em todos os endpoints que o cliente usa (`/responses`,
   `/chat/completions` e `/messages`); um cabeçalho adicionado apenas no middleware de um único SDK não chega aos
   demais.
...
| Modelo                                  | Entrada | Saída  | Leitura em cache | Escrita em cache | Limite mensal                                           |
| --------------------------------------- | ------- | ------ | ---------------- | ---------------- | ------------------------------------------------------- |
...
| DeepSeek V4.1 Flash (Off-Peak)          | $0.15   | $0.60  | $0.003           | -                | ~~$15~~ **$60**<br /><small>4x · Até 20 de set.</small> |
| DeepSeek V4.1 Flash (Peak)              | $0.30   | $1.20  | $0.006           | -                | ~~$15~~ **$60**<br /><small>4x · Até 20 de set.</small> |
...
| DeepSeek V4.1 Flash<br /><small>4x · Até 20 de set.</small> | ~~6,500~~<br />**26,000** | ~~16,250~~<br />**65,000** | ~~32,500~~<br />**130,000** |
...
| DeepSeek V4.1 Flash          | Não usado              | 0 dias            |
