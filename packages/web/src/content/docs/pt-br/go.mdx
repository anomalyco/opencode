...
- **Limite de 5 horas** — 20% da sua cota de uso
- **Limite semanal** — 50% da sua cota de uso
- **Limite mensal** — 100% da sua cota de uso

Esses limites são porcentagens de uma cota de uso compartilhada entre todos os modelos.

### Uso por modelo

O uso mensal incluído varia conforme o modelo e é calculado pelos preços oficiais da API. Os preços de tokens são indicados por 1M tokens.

| Modelo                                  | Entrada | Saída  | Leitura em cache | Escrita em cache | Uso mensal |
| --------------------------------------- | ------- | ------ | ---------------- | ---------------- | ---- |
...
A quantidade de requisições depende do uso mensal do modelo e dos seus preços de API. As estimativas abaixo se baseiam nos padrões típicos de uso do Go.
