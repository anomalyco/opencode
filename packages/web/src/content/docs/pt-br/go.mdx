...
- Qwen3.8 Flash — padrão estimado por requisição: 600 tokens de entrada, 58.000 tokens de leitura em cache e 200 tokens de saída; não inclui escritas em cache
