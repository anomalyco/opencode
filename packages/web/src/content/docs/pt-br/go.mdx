...
| **Docker Agent**        | A [issue #4164](https://github.com/docker/docker-agent/issues/4164) tem uma correção proposta no [PR #4190](https://github.com/docker/docker-agent/pull/4190), que ainda não foi incorporada.                                                                  |
