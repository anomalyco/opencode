...
- `headerTimeout` - Timeout in milliseconds to wait for response headers (default: 300000). Set to `false` to disable.
- `chunkTimeout` - Timeout in milliseconds between streamed response chunks (default: 300000). Set to `false` to disable.
