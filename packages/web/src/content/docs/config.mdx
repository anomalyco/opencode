...
You can also define commands using text-based files in `~/.config/opencode/commands/` or `.opencode/commands/`, including `.md`, `.txt`, `.prompt`, and extensionless files. [Learn more here](/docs/commands).
