...
The default is `5`. Set it to `2` to restore the previous behavior (the main session spawns subagents, subagents do not), or to `1` to disable the task tool entirely.
