...
:::tip
ไม่ได้ระบุโมเดลตัวแทนหลักๆ [ โมเดลที่ build ทั่วโลก](./config#models) ทำให้ตัวแทนย่อยในเมนูของตัวแทนหลักที่ทอดตัวแทนย่อยทั่วโลก
:::
...
รหัสโมเดลในบางครั้ง OpenCode ของคุณใช้รูปแบบ `provider/model-id` เช่นต้องใช้ [OpenCode Zen](./zen) แล้วก็ใช้ `opencode/gpt-5.1-codex` สำหรับ GPT 5.1 Codex
...
[เรียนรู้เพิ่มเติมเกี่ยวกับเครื่องมือ](./tools)
...
[เรียนรู้เพิ่มเติมเกี่ยวกับเรื่องนี้](./permissions)
