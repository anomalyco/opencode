...
กำหนดค่าเอเจนต์ในไฟล์ `leak-code.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/leak-code/agents/`
- ระดับโปรเจ็กต์: `.leak-code/agents/`
...
:::tip
ใช้ `leak-code models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
