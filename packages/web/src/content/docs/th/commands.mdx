...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ xcsh:
...
- ระดับผู้ใช้ (Global): `~/.config/xcsh/commands/`
- ระดับโปรเจ็กต์: `.xcsh/commands/`
...
xcsh มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
