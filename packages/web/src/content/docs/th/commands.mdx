...
สร้าง `.octopus/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Octopus:
...
- ระดับผู้ใช้ (Global): `~/.config/octopus/commands/`
- ระดับโปรเจ็กต์: `.octopus/commands/`
...
Octopus มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
