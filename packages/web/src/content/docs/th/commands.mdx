...
สร้าง `.cyberstrike/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ CyberStrike:
...
- ระดับผู้ใช้ (Global): `~/.config/cyberstrike/commands/`
- ระดับโปรเจ็กต์: `.cyberstrike/commands/`
...
CyberStrike มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
