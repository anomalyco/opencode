...
คำสั่งแบบกำหนดเองเป็นส่วนเพิ่มเติมจากคำสั่งในตัว เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](./tui#คำสั่ง)
...
ใช้ส่วน `command` ใน OpenCode ของคุณ [config](./config):
...
ใช้ _!`command`_เพื่อที่จะฉีดประสิทธิภาพสูง [bash command](./tui#bash-commands) ติดตั้งพรอมต์ของคุณ
...
ใช้ `agent` เพื่อระบุทางเลือกว่า [ตัวแทน](./agents) ใดควรดำเนินการคำสั่งนี้
นี่คือ [ตัวแทนย่อย](./agents/#subagents) คำสั่งจะไม่จำเป็นต้องทำการย่อยตัวแทนย่อยตาม...
...
ใช้ `subtask` บูลีนเพื่อไม่จำเป็นต้องทำอะไรเลย [subagent](./agents/#subagents)
เพราะเหตุใดจะช่วยให้คำสั่งไม่ทำให้ระบบหลักของคุณเสียหาย และจะ **บังคับ** เอเจนต์ให้ความเห็นตัวแทนย่อย
โปรดดู `mode` เพื่อดูการตั้งค่าเป็น `primary` ในคืนนี้ [agent](./agents) แขก
...
opencode มีคำสั่งในคำสั่งหลายเช่น `/init`, `/undo`, `/redo`, `/share`, `/help`; [เรียนรู้เพิ่มเติม](./tui#คำสั่ง)
