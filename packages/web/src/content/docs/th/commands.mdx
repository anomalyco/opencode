...
สร้าง `.pencode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Pencode:
...
- ระดับผู้ใช้ (Global): `~/.config/pencode/commands/`
- ระดับโปรเจ็กต์: `.pencode/commands/`
...
Pencode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
