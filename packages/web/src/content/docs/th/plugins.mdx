...
- `.leak-code/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/leak-code/plugins/` - ​​ปลั๊กอินทั่วโลก
...
1. การกำหนดค่าส่วนกลาง (`~/.config/leak-code/leak-code.json`)
2. การกำหนดค่าโครงการ (`leak-code.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/leak-code/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.leak-code/plugins/`)
