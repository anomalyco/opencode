...
OpenCode CLI โดยเฉพาะอย่างยิ่งจะเริ่มต้น [TUI](./tui) ไม่ต้องทำงานโดยไม่มีข้อใดใดๆ
...
ไม่ว่าคุณจะเริ่มต้นโฟลว์ GitHub Actions และแนะนำคุณตลอดประวัติศาสตร์ [เรียนรู้เพิ่มเติม](./github)
...
คุณสามารถใช้ชื่อรุ่นได้อย่างแม่นยำใน [ ฟังก์ชั่นของคุณ](./config/)
...
เริ่มต้นเลานจ์ OpenCode ไม่เพียงแต่สำหรับนักท่องเที่ยวเท่านั้น API ภาพถ่าย [เอกสารรับรอง](./server) เพื่อดู HTTP เต็มรูปแบบ
