...
`OPENCODE_CONFIG_DIRS` สามารถระบุไดเร็กทอรีการกำหนดค่าแบบกำหนดเองได้หลายรายการ โดยใช้ตัวคั่นเดียวกับ `PATH` ของระบบ (`:` บน Linux/macOS, `;` บน Windows) ไดเร็กทอรีจะโหลดจากซ้ายไปขวา ดังนั้นรายการที่อยู่ภายหลังจะแทนที่รายการก่อนหน้า หากตั้งค่า `OPENCODE_CONFIG_DIR` ไว้ด้วย ระบบจะต่อท้ายรายการนี้เป็นรายการสุดท้าย และใช้เป็นไดเร็กทอรีแบบกำหนดเองที่มีลำดับความสำคัญสูงสุดและเป็นตำแหน่งเขียนส่วนกลาง
