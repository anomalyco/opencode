...
[เรียนรู้เพิ่มเติมเกี่ยวกับการใช้ TUI ที่นี่](./tui)
...
[เรียนรู้เพิ่มเติมเกี่ยวกับเซิร์ฟเวอร์ที่นี่](./server)
...
[เรียนรู้เพิ่มเติมเกี่ยวกับเครื่องมือที่นี่](./tools)
...
คุณยังสามารถกำหนดค่า [รุ่นท้องถิ่น](./models#local) ได้ [เรียนรู้เพิ่มเติม](./models)
...
:::note
โทเค็นผู้ถือ (`AWS_BEARER_TOKEN_BEDROCK` หรือ `/connect`) มีความสำคัญมากกว่าการตรวจสอบสิทธิ์ตามโปรไฟล์ ดู [ลำดับความสำคัญในการรับรองความถูกต้อง](./providers#การรับรองความถูกต้อง-เหนือกว่า) สำหรับรายละเอียด
:::

[เรียนรู้เพิ่มเติมเกี่ยวกับการกำหนดค่า Amazon Bedrock](./providers#amazon-bedrock)
...
[เรียนรู้เพิ่มเติมที่นี่](./themes)
...
คุณยังสามารถกำหนดตัวแทนโดยใช้ไฟล์มาร์กดาวน์ใน `~/.config/opencode/agents/` หรือ `.opencode/agents/` [เรียนรู้เพิ่มเติมที่นี่](./agents)
...
ตัวแทนเริ่มต้นจะต้องเป็นตัวแทนหลัก (ไม่ใช่ตัวแทนย่อย) ซึ่งอาจเป็นตัวแทนในตัว เช่น `"build"` หรือ `"plan"` หรือ [ตัวแทนที่กำหนดเอง](./agents) ที่คุณกำหนดไว้ หากไม่มีตัวแทนที่ระบุหรือเป็นตัวแทนย่อย OpenCode จะถอยกลับไปที่ `"build"` พร้อมคำเตือน
...
คุณสามารถกำหนดค่าคุณสมบัติ [แบ่งปัน](./share) ได้ผ่านทางตัวเลือก `share`
...
คุณยังสามารถกำหนดคำสั่งโดยใช้ไฟล์มาร์กดาวน์ใน `~/.config/opencode/commands/` หรือ `.opencode/commands/` [เรียนรู้เพิ่มเติมที่นี่](./commands)
...
[เรียนรู้เพิ่มเติมที่นี่](./keybinds)
...
[เรียนรู้เพิ่มเติมเกี่ยวกับฟอร์แมตเตอร์ที่นี่](./formatters)
...
[เรียนรู้เพิ่มเติมเกี่ยวกับการอนุญาตที่นี่](./permissions)
...
[เรียนรู้เพิ่มเติมที่นี่](./mcp-servers)

---

### ปลั๊กอิน

[ปลั๊กอิน](./plugins) ขยาย OpenCode ด้วยเครื่องมือที่กำหนดเอง hooks และการผสานรวม
...
[เรียนรู้เพิ่มเติมที่นี่](./plugins)
