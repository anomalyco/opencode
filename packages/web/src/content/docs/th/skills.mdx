...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | ควรมีความยาว 1-64 อักขระ                                                                          |
| `description` | `string` | yes      | ควรมีความยาว 1-1024 อักขระ แสดงต่อเอเจนต์เพื่อให้ตัดสินใจได้ว่าจะโหลดทักษะเมื่อใด                 |

ฟิลด์ frontmatter อื่นๆ ทั้งหมดจะถูกละเว้นอย่างปลอดภัย

:::tip
ระบุให้เจาะจงเพียงพอให้เอเจนต์เลือกได้อย่างถูกต้อง
:::
