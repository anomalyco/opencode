...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | ติดตามการใช้งานผู้ให้บริการใน OpenCode ผ่านกล่องโต้ตอบ TUI แบบเนทีฟด้วยคำสั่ง `/usage` ที่ใช้งานง่าย |
