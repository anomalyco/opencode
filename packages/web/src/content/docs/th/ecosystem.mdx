...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | ปลั๊กอิน Google Antigravity OAuth พร้อมการดึงโมเดลแบบไดนามิก การติดตามโควต้า และการคงสถานะรอบการสนทนา |
