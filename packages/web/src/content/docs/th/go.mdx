...
OpenCode Go มีขีดจำกัดพื้นฐานดังต่อไปนี้:

- **ขีดจำกัดต่อ 5 ชั่วโมง** — 20% ของโควตาการใช้งานของคุณ
- **ขีดจำกัดรายสัปดาห์** — 50% ของโควตาการใช้งานของคุณ
- **ขีดจำกัดรายเดือน** — 100% ของโควตาการใช้งานของคุณ

ขีดจำกัดเหล่านี้เป็นเปอร์เซ็นต์ของโควตาการใช้งานที่ทุกโมเดลใช้ร่วมกัน

### การใช้งานตามโมเดล

ปริมาณการใช้งานรายเดือนที่รวมอยู่จะแตกต่างกันตามโมเดล โดยคิดมูลค่าตามราคา API อย่างเป็นทางการ ราคา token แสดงต่อ 1M tokens

| Model                                   | Input  | Output | Cached Read | Cached Write | ปริมาณการใช้งานรายเดือน |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | ----- |
...
จำนวน request ขึ้นอยู่กับปริมาณการใช้งานรายเดือนและราคา API ของโมเดล การประมาณการด้านล่างอ้างอิงรูปแบบการใช้งานปกติของ Go
...
- Omen Alpha — 300 input, 40,000 cached, 100 output tokens ต่อ request
...
- **DeepSeek V4 Flash:** ข้อตกลง ZDR จะต่ออายุทุกเดือน ข้อตกลงปัจจุบันมีผลใช้ถึงวันที่ 30 กันยายน 2026
