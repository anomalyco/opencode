...
| **Docker Agent**        | [Issue #4164](https://github.com/docker/docker-agent/issues/4164) มีการเสนอการแก้ไขใน [PR #4190](https://github.com/docker/docker-agent/pull/4190) ซึ่งยังไม่ได้ merge                                                                                      |
