---
title: Share
description: Share your ChaliceCode conversations.
---

ChaliceCode's share feature allows you to create public links to your ChaliceCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, ChaliceCode:
...
ChaliceCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, ChaliceCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using chalice in your organization.
