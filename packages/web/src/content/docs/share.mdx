---
title: Share
description: Share your OpenSec conversations.
---

OpenSec's share feature allows you to create public links to your OpenSec conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OpenSec:
...
OpenSec supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OpenSec uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
