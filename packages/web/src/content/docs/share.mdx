---
title: Share
description: Share your Octopus conversations.
---

Octopus's share feature allows you to create public links to your Octopus conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Octopus:
...
Octopus supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Octopus uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `octopus.json` in your project and check into Git.
