...
:::tip
If you’re using one of the popular GUI Editors (Cursor, VSCodium, Windsurf, Zed, etc.), always include the `--wait` flag. Without it, OpenCode won’t pause while you edit and will read the file too early.
:::