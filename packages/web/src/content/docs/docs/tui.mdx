...
<Tabs>
  <TabItem label="Linux/macOS">
    ...
    # For VS Code and forks (must include --wait)
...
:::tip
If you’re using VS Code or a VS Code–based editor (Cursor, VSCodium, Windsurf, Zed, etc.), always include the `--wait` flag. Without it, OpenCode won’t pause while you edit and will read the file too early.
:::