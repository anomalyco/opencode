...
:::tip[Utenti Windows]
Per la migliore esperienza, esegui `opencode web` da [WSL](./windows-wsl) invece che da PowerShell. Questo garantisce accesso corretto al file system e integrazione col terminale.
:::
...
Puoi configurare il server web con i flag della riga di comando o nel tuo [file di config](./config).
