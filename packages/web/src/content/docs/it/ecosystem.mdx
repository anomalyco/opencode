...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Plugin OAuth Google Antigravity con recupero dinamico dei modelli, monitoraggio delle quote e persistenza dello stato dei turni |
