...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Suite multi-agente leggera con 7 agenti specializzati (Orchestrator, Explorer, Oracle, ecc.) |
