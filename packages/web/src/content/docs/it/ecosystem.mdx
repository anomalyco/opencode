...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Plugin OAuth Google Antigravity, con supporto a Google Search e gestione API più robusta          |
