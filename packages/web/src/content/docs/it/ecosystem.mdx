...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Tieni traccia dell'uso del provider in OpenCode con una finestra di dialogo TUI nativa tramite il semplice comando `/usage` |
