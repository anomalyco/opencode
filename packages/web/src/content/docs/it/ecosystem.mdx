...
| [opencode-plan-manager](https://github.com/yurihbm/opencode-plan-manager)                                 | Pianificazione dell'implementazione AI-nativa per flussi di lavoro agentici moderni               |
