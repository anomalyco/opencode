...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin)                                   | Estrai dati da qualsiasi sito web con migliaia di scraper, crawler e automazioni affidabili da Apify Store. |
