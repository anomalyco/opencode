...
OpenCode Enterprise è pensato per organizzazioni che vogliono assicurarsi che codice e dati non escano mai dalla propria infrastruttura. Questo è possibile grazie a una config centralizzata che si integra con SSO e con il gateway AI interno.
...
<details>
<summary>Che cos'è OpenCode Enterprise?</summary>

OpenCode Enterprise è pensato per organizzazioni che vogliono assicurarsi che codice e dati non escano mai dalla propria infrastruttura. Questo e possibile grazie a una config centralizzata che si integra con SSO e con il gateway AI interno.
