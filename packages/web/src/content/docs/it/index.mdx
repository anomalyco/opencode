...
[**OpenCode**](/) è un agente di programmazione AI open source. È disponibile come interfaccia per terminale, app desktop o estensione per IDE.
...
Il modo piu semplice per installare OpenCode è usare lo script di installazione.
...
- **Con Homebrew su macOS e Linux**
  ...
  > Ti consigliamo di usare il tap di OpenCode per avere le release piu aggiornate. La formula ufficiale `brew install opencode` è mantenuta dal team Homebrew e viene aggiornata meno spesso.
