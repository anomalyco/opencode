...
Il [model id](./config/#models) nella config di OpenCode usa il formato `opencode/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `opencode/gpt-5.2-codex` nella config.
...
Potresti notare _Claude Haiku 3.5_ nella cronologia d'uso. E un [modello a basso costo](./config/#models) usato per generare i titoli delle sessioni.
