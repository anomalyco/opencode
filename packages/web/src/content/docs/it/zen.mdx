---
title: Zen
description: Lista curata di modelli fornita da CyberStrike.
---
...
CyberStrike Zen e una lista di modelli testati e verificati dal team di CyberStrike.

:::note
CyberStrike Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in CyberStrike. Accedi a CyberStrike Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare CyberStrike.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con CyberStrike.
:::
...
CyberStrike Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

CyberStrike Zen funziona come qualunque altro provider in CyberStrike.

1. Accedi a **<a href={console}>CyberStrike Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona CyberStrike Zen e incolla la chiave API.
...
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://cyberstrike.io/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2.5 Free     | kimi-k2.5-free     | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
Il [model id](/docs/config/#models) nella config di CyberStrike usa il formato `cyberstrike/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `cyberstrike/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su CyberStrike per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su CyberStrike per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su CyberStrike per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su CyberStrike per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato CyberStrike Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con CyberStrike.
