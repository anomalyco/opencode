...
Molti comandi hanno anche una scorciatoia da tastiera che usa `ctrl+x` come tasto leader (predefinito). [Scopri di piu](./keybinds).
...
Crea o aggiorna il file `AGENTS.md`. [Scopri di piu](./rules).
...
Condivide la sessione corrente. [Scopri di piu](./share).
...
Annulla la condivisione della sessione corrente. [Scopri di piu](./share#un-sharing).
