...
Questo è separato da `leak-code.json`, che configura il comportamento di server/runtime.
...
Usa `LEAKCODE_TUI_CONFIG` per caricare un path di configurazione TUI personalizzato.
