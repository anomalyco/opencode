...
| **Docker Agent**        | L'[issue #4164](https://github.com/docker/docker-agent/issues/4164) ha una correzione proposta nella [PR #4190](https://github.com/docker/docker-agent/pull/4190), che non è stata ancora unita.                                                                         |
