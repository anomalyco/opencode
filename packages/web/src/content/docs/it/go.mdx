...
- Qwen3.8 Flash — schema di richiesta stimato: 600 token di input, 58.000 token letti dalla cache e 200 token di output per richiesta; esclude le scritture nella cache
