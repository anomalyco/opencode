...
Se hai `IMECODE_PORT` impostato nell'ambiente, l'app desktop provera a usare quella porta per il server locale.

- Rimuovi `IMECODE_PORT` (o scegli una porta libera) e riavvia.
