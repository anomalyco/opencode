...
Puoi aggiungere comandi personalizzati tramite la config di Pencode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Pencode:
...
- Globale: `~/.config/pencode/commands/`
- Per progetto: `.pencode/commands/`
...
pencode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
