...
Crea `.cyberstrike/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di CyberStrike o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di CyberStrike:
...
- Globale: `~/.config/cyberstrike/commands/`
- Per progetto: `.cyberstrike/commands/`
...
cyberstrike include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
