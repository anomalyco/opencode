...
Puoi aggiungere comandi personalizzati tramite la config di xcsh o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di xcsh:
...
- Globale: `~/.config/xcsh/commands/`
- Per progetto: `.xcsh/commands/`
...
xcsh include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
