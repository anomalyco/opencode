...
Puoi aggiungere comandi personalizzati tramite la config di Octopus o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Octopus:
...
- Globale: `~/.config/octopus/commands/`
- Per progetto: `.octopus/commands/`
