...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Deve essere lungo 1-64 caratteri.                                                                 |
| `description` | `string` | yes      | Deve essere lunga 1-1024 caratteri. Mostrata all'agente per decidere quando caricare la skill.    |

Tutti gli altri campi di frontmatter vengono ignorati in modo sicuro.
