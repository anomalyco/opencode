...
5. **Config `.opencode`** (`.opencode/opencode.json` nel progetto) - come la config di progetto ma separata
6. **Directory `.opencode`** - agenti, comandi, plugin
7. **Config inline** (variabile d'ambiente `OPENCODE_CONFIG_CONTENT`) - sovrascritture a runtime
