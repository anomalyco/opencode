...
Configura gli agenti nel file `leak-code.json`:
...
- Globale: `~/.config/leak-code/agents/`
- Per progetto: `.leak-code/agents/`
...
:::tip
Esegui `leak-code models` per vedere la lista dei modelli disponibili.
:::
