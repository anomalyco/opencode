...
I valori della configurazione locale sovrascrivono i default remoti. Vedi [config precedence](./config#precedence-order) per maggiori dettagli.
...
2. Nella tua [config dell'agente](./agents#tools), abilita il server MCP come strumento.
...
In alternativa, puoi aggiungere qualcosa del genere al tuo [AGENTS.md](./rules/).
