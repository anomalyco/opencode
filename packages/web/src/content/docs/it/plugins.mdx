...
- `.leak-code/plugins/` - plugin a livello progetto
- `~/.config/leak-code/plugins/` - plugin globali
...
1. Config globale (`~/.config/leak-code/leak-code.json`)
2. Config di progetto (`leak-code.json`)
3. Directory plugin globale (`~/.config/leak-code/plugins/`)
4. Directory plugin di progetto (`.leak-code/plugins/`)
