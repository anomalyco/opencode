---
title: TUI
description: Using the OpenSec terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenSec provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running OpenSec starts the TUI for the current directory.
...
When using the OpenSec TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to OpenSec. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your OpenSec config file.
