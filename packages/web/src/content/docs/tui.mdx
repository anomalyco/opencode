---
title: TUI
description: Using the CrazyCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CrazyCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running CrazyCode starts the TUI for the current directory.
...
When using the CrazyCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to CrazyCode. Allows you to select from available providers and add their API keys.
...
Exit CrazyCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your CrazyCode config file.
