...
- `session_bar.context` - Show token usage context in the session bar.
- `session_bar.cost` - Show estimated cost in the session bar.
- `sidebar.context` - Show token usage and context percentage in the sidebar.
- `sidebar.cost` - Show estimated cost in the sidebar.
