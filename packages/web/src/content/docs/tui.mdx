---
title: TUI
description: Using the ChaliceCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ChaliceCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running ChaliceCode starts the TUI for the current directory.
...
When using the ChaliceCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Exit ChaliceCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your ChaliceCode config file.
