...
1. **Local files** by traversing up from the current directory (`AGENTS.md`, `CLAUDE.md`) plus `.opencode/AGENTS.md`
2. **Global file** at `~/.config/opencode/AGENTS.md`
3. **Claude Code file** at `~/.claude/CLAUDE.md` (unless disabled)

For local rules, opencode prefers `AGENTS.md` over `CLAUDE.md`, but still loads any `.opencode/AGENTS.md` files it finds. For global rules, `~/.config/opencode/AGENTS.md` takes precedence over `~/.claude/CLAUDE.md`.
