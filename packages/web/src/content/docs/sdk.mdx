---
title: SDK
description: Type-safe JS client for leak-code server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The leak-code JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control leak-code programmatically.
...
Create an instance of leak-code:
...
You can pass a configuration object to customize behavior. The instance still picks up your `leak-code.json`, but you can override or add configuration inline:
...
If you already have a running instance of leak-code, you can create a client instance to connect to it:
...
const textResults = await client.find.text({
  query: { pattern: "function.*leak-code" },
})
