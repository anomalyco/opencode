---
title: LSP-servere
description: xcsh integreres med dine LSP-servere.
---

xcsh integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

xcsh leveres med flere indbyggede LSP-servere til populære sprog:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din xcsh-konfiguration.
