...
Agentferdigheter lar CyberStrike oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går CyberStrike opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
CyberStrike viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `cyberstrike.json`:
