...
- Prosjektkonfigurasjon: `.leak-code/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/leak-code/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.leak-code/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/leak-code/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.leak-code/skills/git-release/SKILL.md` slik:
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `leak-code.json`:
...
**For innebygde agenter** (i `leak-code.json`):
