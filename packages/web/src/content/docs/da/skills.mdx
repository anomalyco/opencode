...
Agentferdigheter lar xcsh oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går xcsh opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
xcsh viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `xcsh.json`:
