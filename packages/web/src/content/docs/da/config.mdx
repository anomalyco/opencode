...
5. **`.opencode` konfiguration** (`.opencode/opencode.json` i projekt) - samme som projektconfig men separat
6. **`.opencode` mapper** - agent, kommandoer, plugins
7. **Inline config** (`OPENCODE_CONFIG_CONTENT` env var) - runtime tilsidesættelser
