---
title: TUI
description: Brug af xcsh-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

xcsh giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre xcsh starter TUI for den nuværende mappe.
...
Når du bruger xcsh TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til xcsh. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `xcsh.json`, som konfigurerer server-/kørselstidsadfærd.
