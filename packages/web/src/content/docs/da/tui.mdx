...
De fleste kommandoer har også tastebinding som bruker `ctrl+x` som ledernøkkel, der `ctrl+x` er standard ledernøkkel. [Finn ut mer](./keybinds).
...
Opprett eller oppdater `AGENTS.md`-fil. [Finn ut mer](./rules).
...
Del gjeldende økt. [Finn ut mer](./share).
...
Opphev deling av gjeldende økt. [Finn ut mer](./share#un-sharing).
