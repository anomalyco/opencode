...
Dette er adskilt fra `leak-code.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `LEAKCODE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
