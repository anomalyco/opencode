---
title: TUI
description: Brug af Pencode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Pencode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Pencode starter TUI for den nuværende mappe.
...
Når du bruger Pencode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Pencode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Pencode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `pencode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Pencode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `pencode.default`.
