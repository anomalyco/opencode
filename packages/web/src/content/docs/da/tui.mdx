---
title: TUI
description: Brug af Octopus-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Octopus giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Octopus starter TUI for den nuværende mappe.
...
Når du bruger Octopus TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Octopus. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Octopus. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `octopus.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `OCTOPUS_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
