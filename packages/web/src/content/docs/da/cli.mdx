...
| ------------------------------------- | ------- | --------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT                ` | string  | Indbyggede JSON-godkendelsesoplysninger |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS     ` | boolean | Deaktiver indlæsning af færdigheder fra npm-pakker |
...
| `OPENCODE_DISABLE_MOUSE               ` | boolean | Deaktiver museopsnapning i TUI |
| `OPENCODE_DISABLE_PRUNE               ` | boolean | Deaktiver beskæring af gamle data |
| `OPENCODE_DISABLE_PROJECT_CONFIG      ` | boolean | Deaktiver indlæsning af projektniveaubaseret konfiguration |
...
| `OPENCODE_MODELS_PATH                 ` | string  | Brugerdefineret sti til JSON-cache-fil til modeller |
...
| `EXA_API_KEY                          ` | string  | API-nøgle til Exa-websøgning (kræver `OPENCODE_ENABLE_EXA`) |
| `OTEL_EXPORTER_OTLP_ENDPOINT          ` | string  | OpenTelemetry OTLP-eksportør-endepunkt |
| `OTEL_EXPORTER_OTLP_HEADERS           ` | string  | OpenTelemetry OTLP-eksportør-headere |
| `OTEL_RESOURCE_ATTRIBUTES             ` | string  | OpenTelemetry-ressourceattributter (nøgle=værdi-par) |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI                  ` | boolean | Aktiver Effect HttpApi-bro |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES               ` | boolean | Aktiver eksperimentelle arbejdsområder |
