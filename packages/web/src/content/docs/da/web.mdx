...
:::tip[Windows Users]
For den bedste oplevelse skal du køre `opencode web` fra [WSL](./windows-wsl) i stedet for PowerShell. Dette sikrer korrekt filsystemadgang og terminalintegration.
:::
...
Du kan konfigurere webserveren ved hjælp af kommandolinjeflag eller i din [config-fil](./config).
