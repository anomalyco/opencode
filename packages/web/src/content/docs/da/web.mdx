...
:::tip[Ingen automatisk åbning]
For at starte webserveren uden automatisk at åbne en browser, brug `opencode serve` i stedet:

```bash
opencode serve --hostname 0.0.0.0 --port 4096
```

Naviger derefter manuelt til `http://localhost:4096` (eller din netværksadresse). Når du binder til `0.0.0.0`, skal du indstille `OPENCODE_SERVER_PASSWORD` for at beskytte adgangen.
:::
