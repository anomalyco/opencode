---
title: Zen
description: Udvalgt liste over modeller leveret af CyberStrike.
---
...
CyberStrike Zen er en liste over testede og verificerede modeller leveret af CyberStrike-teamet.

:::note
CyberStrike Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i CyberStrike. Du logger på CyberStrike Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med CyberStrike.
:::
...
CyberStrike Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

CyberStrike Zen fungerer som alle andre udbydere i CyberStrike.

1. Du logger på **<a href={console}>CyberStrike Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger CyberStrike Zen og indsætter API-nøglen.
...
| Claude Sonnet 4.5   | claude-sonnett-4-5 | `https://cyberstrike.io/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4     | claude-sonnett-4   | `https://cyberstrike.io/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| Claude Opus 4.6     | claude-opus-4-6    | `https://cyberstrike.io/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| MiniMax M2.1        | minimax-m2.1       | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.1 Gratis | minimax-m2.1-free  | `https://cyberstrike.io/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7             | glm-4.7            | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Gratis      | glm-4.7-free       | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6             | glm-4.6            | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5           | kimi-k2.5          | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5 Gratis    | kimi-k2.5-free     | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://cyberstrike.io/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i CyberStrike-konfigurationen
bruger formatet `cyberstrike/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `cyberstrike/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på CyberStrike i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på CyberStrike i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på CyberStrike i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på CyberStrike i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede CyberStrike Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med CyberStrike også.
