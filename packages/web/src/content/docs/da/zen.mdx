---
title: Zen
description: Udvalgt liste over modeller leveret af Octopus.
---
...
Octopus Zen er en liste over testede og verificerede modeller leveret af Octopus-teamet.

:::note
Octopus Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i Octopus. Du logger ind på Octopus Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Octopus.
:::
...
Octopus Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Octopus Zen fungerer som enhver anden udbyder i Octopus.

1. Du logger ind på **<a href={console}>Octopus Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Octopus Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Octopus-konfiguration
...
- MiniMax M2.5 Free er tilgængelig på Octopus i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ring 2.6 1T Free er tilgængelig på Octopus i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på Octopus i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Octopus i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Octopus også.
