...
Der er to typer agenter i CyberStrike; primære agenter og subagenter.
...
CyberStrike leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
CyberStrike leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

CyberStrike leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `cyberstrike.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger CyberStrike modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale CyberStrike-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din CyberStrike-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [CyberStrike Zen](/docs/zen), vil du bruge `cyberstrike/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `cyberstrike models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/CyberStrikeus/cyberstrike).
:::
