...
testet og verifisert for å fungere godt med OpenCode. [Finn ut mer](./zen).
...
OpenCode Zen er en liste over testede og verifiserte modeller levert av OpenCode-teamet. [Finn ut mer](./zen).
...
- **apiKey**: Angi med `env` variabel syntaks, [finn ut mer](./config#env-vars).
