...
Dine lokale konfigurationsværdier tilsidesætter fjernstandarderne. Se [config precedence](./config#precedence-order) for flere detaljer.
...
2. Aktiver MCP-serveren som et værktøj i din [agent config](./agents#tools).
...
Alternativt kan du tilføje noget som dette til din [AGENTS.md](./rules/).
