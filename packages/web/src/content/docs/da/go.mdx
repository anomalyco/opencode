...
OpenCode Go inkluderer følgende basisgrænser:

- **5-timers grænse** — 20 % af din forbrugskvote
- **Ugentlig grænse** — 50 % af din forbrugskvote
- **Månedlig grænse** — 100 % af din forbrugskvote

Disse grænser er procenter af en fælles forbrugskvote på tværs af alle modeller.

### Forbrug pr. model

Det inkluderede månedlige forbrug varierer efter model og beregnes til de officielle API-priser. Tokenpriser er angivet pr. 1M tokens.

| Model                                   | Input  | Output | Cached Read | Cached Write | Månedligt forbrug |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | ------- |
...
Antallet af anmodninger afhænger af modellens månedlige forbrug og API-priser. Estimaterne nedenfor er baseret på typiske Go-forbrugsmønstre.
...
- Omen Alpha — 300 input-, 40.000 cachede, 100 output-tokens pr. anmodning
...
- **DeepSeek V4 Flash:** ZDR-aftalen fornyes månedligt. Den nuværende aftale er gyldig til og med 30. september 2026.
