...
| **Docker Agent**        | [Issue #4164](https://github.com/docker/docker-agent/issues/4164) har en foreslået rettelse i [PR #4190](https://github.com/docker/docker-agent/pull/4190), som endnu ikke er merged.                                                                           |
