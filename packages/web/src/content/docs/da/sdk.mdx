...
Brug den til at bygge integrasjoner og kontrollere leak-code programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `leak-code.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
