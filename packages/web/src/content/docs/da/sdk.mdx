...
Brug den til at bygge integrasjoner og kontrollere cyberstrike programmatisk.
...
Opret en forekomst av cyberstrike:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `cyberstrike.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av cyberstrike, kan du oprete en klientforekomst for at koble til den:
