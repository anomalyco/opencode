...
Opret `.octopus/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Octopus-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Octopus [config](/docs/config):
...
- Globalt: `~/.config/octopus/commands/`
- Pr. projekt: `.octopus/commands/`
