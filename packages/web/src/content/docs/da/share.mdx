---
title: Deling
description: Del dine Octopus-samtaler.
---

Octopuss delingsfunksjon lar deg lage offentlige lenker til dine Octopus-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Octopus:
...
Octopus støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Octopus manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `octopus.json` i prosjektet ditt og tjek inn i Git.
