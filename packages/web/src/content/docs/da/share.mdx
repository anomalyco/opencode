---
title: Deling
description: Del dine xcsh-samtaler.
---

xcshs delingsfunksjon lar deg lage offentlige lenker til dine xcsh-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
xcsh støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger xcsh manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `xcsh.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av xcsh i organisasjonen din.
