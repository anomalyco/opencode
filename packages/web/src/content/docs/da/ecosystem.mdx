...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Google Antigravity OAuth-plugin med dynamisk modelhentning, kvotasporing og turn-state persistens                 |
