...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Letvægtig multi-agent suite med 7 specialiserede agenter (Orchestrator, Explorer, Oracle, etc.) |
