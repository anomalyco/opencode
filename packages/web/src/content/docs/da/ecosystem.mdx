...
| [opencode-apify](https://github.com/apify/apify-opencode-plugin/tree/main)                         | Udtræk data fra enhver hjemmeside med tusindvis af pålidelige scrapere, crawlere og automatiseringer fra Apify Store. |
