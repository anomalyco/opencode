...
For at få den bedste oplevelse på Windows anbefaler vi at bruge [Windows Subsystem for Linux (WSL)](./windows-wsl). Det giver bedre ydeevne og fuld kompatibilitet med OpenCodes funktioner.
:::
...
Hvis du er ny til at bruge LLM-udbydere, anbefaler vi at bruge [OpenCode Zen](./zen).
...
Alternativt kan du vælge en af ​​de andre udbydere. [Learn more](./providers#directory).
...
Her er en [example conversation](https://opencode.ai/s/4XP1fce5) med OpenCode.
...
For at gøre det til dit eget, anbefaler vi [picking a theme](./themes), [customizing the keybinds](./keybinds), [configuring code formatters](./formatters), [creating custom commands](./commands) eller at lege med [OpenCode config](./config).
