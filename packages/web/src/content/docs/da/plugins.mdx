...
- `.leak-code/plugins/` - Plugins på projektniveau
...
1. Global konfiguration (`~/.config/leak-code/leak-code.json`)
2. Projektkonfiguration (`leak-code.json`)
3. Global plugin-mappe (`~/.config/leak-code/plugins/`)
4. Projekt plugin bibliotek (`.leak-code/plugins/`)
