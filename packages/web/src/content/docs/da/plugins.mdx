...
For eksempler, tjek [plugins](./ecosystem#plugins) oprettet af fællesskabet.
...
Gennemse tilgængelige plugins i [ecosystem](./ecosystem#plugins).
...
**Lokale plugins** indlæses direkte fra plugin-biblioteket. For at bruge eksterne pakker skal du oprette en `package.json` i din konfigurationsmappe (se [Dependencies](#dependencies)), eller udgive pluginnet til npm og [add it to your config](./config#plugins).
