...
Set the default [model variant](/docs/models#variants) for an agent with the `variant` option. Variants control reasoning effort and thinking budgets for models that support them.
