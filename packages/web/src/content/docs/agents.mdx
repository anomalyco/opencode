...
- Answering a prompt with `always` applies **instance-wide** for the rest of the OpenCode process — it covers the whole session tree, and also any other sessions in the same instance.
