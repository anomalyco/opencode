...
:::tip
Use the ask or plan agent to analyze code and review suggestions without making any code changes.
:::
...
OpenCode comes with three built-in primary agents, **Build**, **Ask**, and **Plan**. We'll
look at these below.
...
OpenCode comes with three built-in primary agents and two built-in subagents.
...
A read-only agent for exploring and understanding codebases. Cannot modify files. Use this when you want to ask questions about how something works, understand code functionality, explore project architecture, or brainstorm and assess an idea without making any changes.
...
A restricted agent designed for creating implementation plans. Use this when you want to plan out work before switching to the Build agent to execute it. We use a permission system to give you more control and prevent unintended changes.
By default, all of the following are set to `ask`:

- `file edits`: All writes, patches, and edits
- `bash`: All bash commands

This agent is useful when you want the LLM to analyze code, suggest changes, or create detailed implementation plans that you can review before executing with the Build agent.
...
- **Ask agent**: Read-only exploration, answering questions, and brainstorming ideas about the codebase
