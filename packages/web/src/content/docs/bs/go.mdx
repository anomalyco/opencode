...
| **Docker Agent**        | [Issue #4164](https://github.com/docker/docker-agent/issues/4164) ima predloženu ispravku u [PR #4190](https://github.com/docker/docker-agent/pull/4190), koji još nije spojen.                                                                       |
