...
OpenCode Go uključuje sljedeća osnovna ograničenja:

- **Ograničenje od 5 sati** — 20% vaše kvote korištenja
- **Sedmično ograničenje** — 50% vaše kvote korištenja
- **Mjesečno ograničenje** — 100% vaše kvote korištenja

Ova ograničenja su procenti zajedničke kvote korištenja za sve modele.

### Potrošnja po modelu

Uključena mjesečna potrošnja razlikuje se po modelu i obračunava prema zvaničnim API cijenama. Cijene tokena navedene su za 1M tokena.

| Model                                   | Input  | Output | Cached Read | Cached Write | Mjesečna potrošnja |
| --------------------------------------- | ------ | ------ | ----------- | ------------ | --------- |
...
Broj zahtjeva zavisi od mjesečne potrošnje uključene uz model i njegovih API cijena. Procjene u nastavku zasnivaju se na tipičnim obrascima korištenja Go-a.
...
- Omen Alpha — 300 ulaznih, 40.000 keširanih, 100 izlaznih tokena po zahtjevu
...
| Omen Alpha                   | Ne koristi se     | 0 dana               |
...
- **DeepSeek V4 Flash:** ZDR sporazum obnavlja se mjesečno. Trenutni sporazum važi do 30. septembra 2026.
