...
Konfigurirajte agente u svom konfiguracijskom fajlu `leak-code.json`:
...
- Globalno: `~/.config/leak-code/agents/`
- Po projektu: `.leak-code/agents/`
...
:::tip
Pokrenite `leak-code models` da vidite listu dostupnih modela.
:::
