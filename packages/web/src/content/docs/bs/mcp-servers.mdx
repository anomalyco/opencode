...
Vrijednosti vaše lokalne konfiguracije nadjačavaju udaljene zadane postavke. Pogledajte [config precedence](./config#precedence-order) za više detalja.
---
...
2. U vašem [agent config](./agents#tools), omogućite MCP server kao alat.
...
Alternativno, možete dodati nešto poput ovoga na svoj [AGENTS.md](./rules/).
```md title="AGENTS.md"
