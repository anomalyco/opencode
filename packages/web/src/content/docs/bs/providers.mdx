...
testirano i potvrđeno da dobro radi sa OpenCodeom. [Saznajte više](./zen).
...
3. Pokrenite naredbu `/models` da vidite dostupne modele.
...
OpenCode Zen je lista testiranih i verifikovanih modela koju je obezbedio OpenCode tim. [Saznajte više](./zen).
...
- **apiKey**: Postavite pomoću sintakse varijable `env`, [saznajte više](./config#env-vars).
