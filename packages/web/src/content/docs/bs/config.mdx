...
5. **`.opencode` konfiguracija** (`.opencode/opencode.json` u projektu) - isto kao konfiguracija projekta ali odvojeno
6. **`.opencode` direktoriji** - agenti, komande, dodaci
7. **Inline konfiguracija** (`OPENCODE_CONFIG_CONTENT` env var) - runtime preinačenja
