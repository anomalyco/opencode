---
title: ACP podrška
description: Koristite xcsh u bilo kojem uređivaču kompatibilnom sa ACP.
---

xcsh podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili xcsh putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `xcsh acp`.

Naredba pokreće xcsh kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "xcsh" agenta u AI Chat agent selektoru.
...
Da koristite xcsh kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi xcsh kao ACP chat agenta.
...
xcsh radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj xcsh konfiguraciji
