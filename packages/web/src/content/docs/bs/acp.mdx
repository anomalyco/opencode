...
OpenCode je dostupan u JetBrains IDE-ovima putem ACP registra.

Da biste ga koristili, instalirajte ili ažurirajte dodatak JetBrains AI Assistant, otvorite AI Chat i iz padajućeg izbornika za način chata izaberite **Install From ACP Registry**. Također možete otići na **Settings | Tools | AI Assistant | Agents**. Potražite **OpenCode**, instalirajte ga, primijenite postavke, a zatim izaberite **OpenCode** iz birača agenata u AI Chatu.

Stavka registra: `opencode`

Pogledajte [JetBrains ACP dokumentaciju](https://www.jetbrains.com/help/ai-assistant/acp.html) i [ACP Registry dokumentaciju](https://agentclientprotocol.com/get-started/registry) za više detalja.
