---
title: Zen
description: Kurirana lista modela koje nudi Octopus.
---
...
Octopus Zen je lista testiranih i provjerenih modela koje pruža Octopus tim.

:::note
Octopus Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u Octopus. Prijavite se na Octopus Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili Octopus.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Octopus.
:::
...
Octopus Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Octopus Zen radi kao i svaki drugi provajder u Octopus.

1. Prijavite se na **<a href={console}>Octopus Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite Octopus Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj Octopus konfiguraciji koristi format
...
- MiniMax M2.5 Free je dostupan na Octopus ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Ring 2.6 1T Free je dostupan na Octopus ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Super Free je dostupan na Octopus ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na Octopus ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u Octopus.
