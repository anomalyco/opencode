...
[model id](./config/#models) u OpenCode konfiguraciji koristi format `opencode/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `opencode/gpt-5.2-codex`.
...
U historiji koristenja mozete primijetiti _Claude Haiku 3.5_. To je [low cost model](./config/#models) koji se koristi za generisanje naslova sesija.
