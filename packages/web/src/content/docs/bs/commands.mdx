...
Kreiraj `.cyberstrike/commands/test.md`:
...
Možete dodati prilagođene komande kroz CyberStrike konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CyberStrike [config](/docs/config):
...
- Globalno: `~/.config/cyberstrike/commands/`
- Po projektu: `.cyberstrike/commands/`
...
CyberStrike uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
