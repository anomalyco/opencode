...
Možete dodati prilagođene komande kroz xcsh konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom xcsh [config](/docs/config):
...
- Globalno: `~/.config/xcsh/commands/`
- Po projektu: `.xcsh/commands/`
...
xcsh uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
