...
Kreiraj `.octopus/commands/test.md`:
...
Možete dodati prilagođene komande kroz Octopus konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Octopus [config](/docs/config):
...
- Globalno: `~/.config/octopus/commands/`
- Po projektu: `.octopus/commands/`
...
Octopus uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
