...
Kreiraj `.pencode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Pencode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Pencode [config](/docs/config):
...
- Globalno: `~/.config/pencode/commands/`
- Po projektu: `.pencode/commands/`
...
Pencode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
