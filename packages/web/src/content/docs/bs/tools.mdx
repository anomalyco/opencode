...
:::note
Kada je macOS sandboxing omogućen, bash se pokreće sa ograničenjima fajl sistema i može zatražiti odvojeni pokušaj bez sandboxa kada je potrebno.
Ako znate da komanda mora početi izvan sandboxa, stavite `# opencode:unsandboxed <reason>` na prvi neprazni red komande.
Pogledajte [sandbox konfiguraciju](/docs/config#sandbox) za podržano ponašanje i ograničenja.
:::
