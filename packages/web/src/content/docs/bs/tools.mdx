...
Alati omogucavaju LLM-u da izvrsava akcije u vasem kodu. OpenCode dolazi sa skupom ugradenih alata, a mozete ga prosiriti kroz [custom tools](./custom-tools) ili [MCP servers](./mcp-servers).

Po defaultu su svi alati **ukljuceni** i ne traze dozvolu za pokretanje. Ponasanje alata kontrolisete kroz [permissions](./permissions).
...
[Saznajte vise](./permissions) o konfigurisanju dozvola.
...
Za konfiguraciju dostupnih LSP servera u projektu, pogledajte [LSP Servers](./lsp).
...
Ucitajte [skill](./skills) (`SKILL.md` datoteku) i vratite njegov sadrzaj u razgovor.
...
:::note
Ovaj alat je po defaultu iskljucen za subagente, ali ga mozete rucno ukljuciti. [Saznajte vise](./agents/#permissions)
:::
...
[Saznajte vise](./custom-tools) o kreiranju custom tools.
...
[Saznajte vise](./mcp-servers) o konfigurisanju MCP servera.
