...
Za primjere, pogledajte [plugins](./ecosystem#plugins) kreirane od strane zajednice.
---
...
Pregledajte dostupne dodatke u [ecosystem](./ecosystem#plugins).
---
...
**Lokalni dodaci** se učitavaju direktno iz direktorija dodataka. Da biste koristili vanjske pakete, morate kreirati `package.json` unutar svog konfiguracijskog direktorija (pogledajte [Zavisnosti](#dependencies)) ili objaviti dodatak na npm i [dodati ga u svoju konfiguraciju](./config#plugins).
---
