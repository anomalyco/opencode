...
- `.leak-code/plugins/` - Dodaci na nivou projekta
- `~/.config/leak-code/plugins/` - Globalni dodaci
...
1. Globalna konfiguracija (`~/.config/leak-code/leak-code.json`)
2. Konfiguracija projekta (`leak-code.json`)
3. Globalni direktorij dodataka (`~/.config/leak-code/plugins/`)
4. Direktorij dodataka projekta (`.leak-code/plugins/`)
