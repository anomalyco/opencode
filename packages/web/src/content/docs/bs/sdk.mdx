---
title: SDK
description: Type-safe JS klijent za leak-code server.
---
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `leak-code.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
