---
title: SDK
description: Type-safe JS klijent za cyberstrike server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

cyberstrike JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje cyberstrike-om.
...
Kreirajte instancu cyberstrike:
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `cyberstrike.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu cyberstrike instancu, mozete napraviti klijentsku instancu i povezati se na nju:
