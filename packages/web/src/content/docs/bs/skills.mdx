...
| ------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- |
| `name`        | `string` | yes      | Treba imati 1-64 karaktera.                                                                       |
| `description` | `string` | yes      | Treba imati 1-1024 karaktera. Prikazuje se agentu kako bi mogao odlučiti kada da učita skill.     |

Sva ostala frontmatter polja se sigurno ignoriraju.

:::tip
Neka opis bude dovoljno precizan da agent može pravilno odabrati.
:::
