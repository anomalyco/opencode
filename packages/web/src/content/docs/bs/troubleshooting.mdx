...
Ako imate spore performanse, probleme s pristupom datotekama ili probleme s terminalom na Windows-u, pokušajte koristiti [WSL (Windows podsistem za Linux)](./windows-wsl). WSL pruža Linux okruženje koje radi neprimetnije sa OpenCode-ovim karakteristikama.
...
1. Prvo provjerite da li je vaš provajder ispravno postavljen slijedeći [vodič za pružatelje](./providers)
