...
Ako ste postavili `IMECODE_PORT` u svom okruženju, desktop aplikacija će pokušati da koristi taj port za lokalni server.

- Poništite `IMECODE_PORT` (ili odaberite slobodan port) i ponovo pokrenite.
