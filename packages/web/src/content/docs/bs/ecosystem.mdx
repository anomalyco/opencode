...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Google Antigravity OAuth dodatak s dinamičkim preuzimanjem modela, praćenjem kvota i perzistencijom stanja poteza |
