...
| [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim)                         | Lagana multi-agent orkestracija sa 7 specijalizovanih agenata (Orchestrator, Explorer, Oracle, itd.) |
