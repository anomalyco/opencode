...
| [opencode-agy-auth](https://github.com/anthonyhaussman/opencode-agy-auth)   | Google Antigravity OAuth dodatak, s podrškom za Google pretraživanje i robusnijim API rukovanjem              |
