...
| [opencode-usage-tracker](https://github.com/Dylan-Liew/opencode-usage-tracker)                     | Pratite korištenje pružatelja unutar OpenCodea kroz izvorni TUI dijalog pomoću jednostavne `/usage` naredbe |
