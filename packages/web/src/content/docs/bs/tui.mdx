---
title: TUI
description: Korištenje korisničkog interfejsa xcsh terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

xcsh pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje xcsh pokreće TUI za trenutni direktorij.
...
Kada koristite xcsh TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u xcsh. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz xcsh. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `xcsh.json`, koji konfiguriše ponašanje servera/izvršavanja.
