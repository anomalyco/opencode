---
title: TUI
description: Korištenje korisničkog interfejsa Pencode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Pencode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Pencode pokreće TUI za trenutni direktorij.
...
Kada koristite Pencode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Pencode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Pencode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `pencode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Pencode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `pencode.default`.
