...
Većina naredbi također ima vezu pomoću `ctrl+x` kao vodeće tipke, gdje je `ctrl+x` zadani vodeći ključ. [Saznajte više](./keybinds).
...
Kreirajte ili ažurirajte datoteku `AGENTS.md`. [Saznajte više](./rules).
...
Podijelite trenutnu sesiju. [Saznajte više](./share).
...
Poništi dijeljenje trenutne sesije. [Saznajte više](./share#un-sharing).
