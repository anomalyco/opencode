---
title: TUI
description: Korištenje korisničkog interfejsa Octopus terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Octopus pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Octopus pokreće TUI za trenutni direktorij.
...
Kada koristite Octopus TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Octopus. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Octopus. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `octopus.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `OCTOPUS_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
