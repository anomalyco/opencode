---
title: TUI
description: Korištenje korisničkog interfejsa CyberStrike terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CyberStrike pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje CyberStrike pokreće TUI za trenutni direktorij.
...
Kada koristite CyberStrike TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u CyberStrike. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz CyberStrike. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg CyberStrike konfiguracionog fajla.
