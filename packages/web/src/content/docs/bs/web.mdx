...
:::tip[Windows Users]
Za najbolje iskustvo, pokrenite `opencode web` iz [WSL](./windows-wsl) umjesto PowerShell-a. Ovo osigurava pravilan pristup sistemu datoteka i integraciju terminala.
:::
...
Možete konfigurirati web server koristeći oznake komandne linije ili u vašoj [config file](./config).
