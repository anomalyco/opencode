---
title: IDE
description: Ekstenzija Octopus za VS Code, Cursor i druge IDE
---

Octopus se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `opencode` u terminalu da započnete.

---

## Korištenje

- **Brzo pokretanje**: Koristite `Cmd+Esc` (Mac) ili `Ctrl+Esc` (Windows/Linux) da otvorite Octopus u prikazu podijeljenog terminala ili fokusirajte postojeću terminalsku sesiju ako je već pokrenuta.
- **Nova sesija**: Koristite `Cmd+Shift+Esc` (Mac) ili `Ctrl+Shift+Esc` (Windows/Linux) da započnete novu Octopus terminalsku sesiju, čak i ako je ona već otvorena. Takođe možete kliknuti na dugme Octopus u korisničkom sučelju.
- **Svijest o kontekstu**: Automatski dijelite svoj trenutni odabir ili karticu s Octopus.
...
Da biste instalirali Octopus na VS Code i popularne viljuške kao što su Cursor, Windsurf, VSCodium:
...
Potražite **Octopus** na Extension Marketplaceu i kliknite na **Instaliraj**.
