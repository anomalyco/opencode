...
**Local plugins** are loaded directly from the plugin directory. To use external packages, add a `package.json` to your config directory (see [Dependencies](#dependencies)), or publish it to npm and [add it to your config](/docs/config#plugins).
