...
Specify npm packages in your config file. OpenCode automatically installs them at startup.
...
Packages are cached in `~/.cache/opencode/`. Both regular and scoped npm packages are supported.
