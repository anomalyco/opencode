...
Install the official **OpenCode** extension from the Visual Studio Code Marketplace:

👉 https://marketplace.visualstudio.com/items?itemName=sst-dev.opencode

> Make sure the search with `publisher:"SST"` to avoid installing unofficial extensions.

Alternatively, search for **OpenCode** in the Extensions Marketplace inside VS Code and click **Install**.
