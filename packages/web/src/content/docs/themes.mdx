...
With OpenSec you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, OpenSec uses our own `opencode` theme.
...
OpenSec comes with several built-in themes.
...
- Want OpenSec to match their terminal's appearance
...
OpenSec supports a flexible JSON-based theme system that allows users to create and customize themes easily.
