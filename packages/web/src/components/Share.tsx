...
import { IconPencode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "pencode/session/message-v2"
import type { Message } from "pencode/session/message"
import type { Session } from "pencode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.pencode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.pencode_name}>
                    <IconPencode width={16} height={16} />
                  </div>
