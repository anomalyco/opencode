...
import type { MessageV2 } from "crazycode/session/message-v2"
import type { Message } from "crazycode/session/message"
import type { Session } from "crazycode/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="crazycode version" data-slot="item">
                <div data-slot="icon" title="crazycode">
