...
describe("opencode read-only commands (smoke)", () => {
  ...
  // LEAKCODE_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh LEAKCODE_TEST_HOME means
  ...
  // in production it'd be a path under LEAKCODE_TEST_HOME / XDG_DATA_HOME.
