...
cliIt.live(
  "hydrates side-table diffs in raw and sanitized exports",
  ({ opencode }) =>
    Effect.gen(function* () {
  ...
  // Four CLI subprocesses, each a cold start; the 5 s default is too short under load.
  60_000,
)

cliIt.live(
  "exports legacy inline and session summary diffs",
  ({ opencode }) =>
    Effect.gen(function* () {
