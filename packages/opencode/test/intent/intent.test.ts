...
describe("intent", () => {
  test("creates pending intent and resolves on response", async () => {
  ...
  test("rejects on cancel response", async () => {
    await Instance.provide({
      directory: projectRoot,
      fn: async () => {
        const requestPromise = Intent.request({
  ...
  test("form helper returns field values", async () => {
    await Instance.provide({
      directory: projectRoot,
      fn: async () => {
  ...
  test("cancelAll cancels all pending intents for session", async () => {
    await Instance.provide({
      directory: projectRoot,
      fn: async () => {
  ...
  test("toast intent returns immediately (non-blocking)", async () => {
    await Instance.provide({
      directory: projectRoot,
      fn: async () => {
  ...
  test("select helper returns selected value", async () => {
    await Instance.provide({
      directory: projectRoot,
      fn: async () => {
  ...
  test("multiselect helper returns selected values", async () => {
    await Instance.provide({
      directory: projectRoot,
      fn: async () => {
  ...
  test("emits intent.updated event when intent is created", async () => {
    await Instance.provide({
      directory: projectRoot,
      fn: async () => {
        let eventReceived = false
