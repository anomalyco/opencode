...
describe("session.message-v2.toModelMessage", () => {
  ...
  test("excludes aborted assistant messages that only have reasoning and empty text", async () => {
  ...
  test("preserves empty text between reasoning blocks in same-model assistant messages", async () => {
