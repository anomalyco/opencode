...
import { SessionMessageTable } from "@daemon-protocol/core/session/sql"
...
import { SessionExecution } from "@daemon-protocol/core/session/execution"
...
import { Ripgrep } from "@daemon-protocol/core/ripgrep"
...
const writeConfig = Effect.fn("test.writeConfig")(function* (dir: string, config: Partial<ConfigV1.Info>) {
  yield* writeText(
    ...
    JSON.stringify({ $schema: "https://daemonprotocol.com/config.json", ...config }),
  )
})
