...
it.live(
  "disabled skill command throws typed error",
  () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
...
`,
          ...
          yield* skill.disable("blocked-skill")
...
it.live(
  "skill disabled by config throws typed error",
  () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".opencode", "skill", "blocked-by-config", "SKILL.md"),
              `---
