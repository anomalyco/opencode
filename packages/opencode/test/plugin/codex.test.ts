...
describe("plugin.codex", () => {
  ...
  test("uses Codex context limits for OAuth GPT models", async () => {
    ...
    expect(models["gpt-5.6-sol"]?.limit).toEqual({ context: 372_000, input: 244_000, output: 128_000 })
    expect(models["gpt-5.6-terra"]?.limit).toEqual({ context: 372_000, input: 244_000, output: 128_000 })
    expect(models["gpt-5.6-luna"]?.limit).toEqual({ context: 372_000, input: 244_000, output: 128_000 })
