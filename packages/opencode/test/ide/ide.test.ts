...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders IMECODE_CALLER", () => {
    process.env["IMECODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode IMECODE_CALLER", () => {
    process.env["IMECODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown IMECODE_CALLER", () => {
    process.env["IMECODE_CALLER"] = "unknown"
