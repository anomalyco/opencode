...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LEAKCODE_CALLER", () => {
    process.env["LEAKCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LEAKCODE_CALLER", () => {
    process.env["LEAKCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LEAKCODE_CALLER", () => {
    process.env["LEAKCODE_CALLER"] = "unknown"
