...
import { GenericContainer, GenericContainerBuilder, StartedTestContainer, Wait, Network } from "testcontainers"
 ...
 */
export async function withFullStack<T>(
  fn: (ctx: FullStackContext) => Promise<T>,
): Promise<T> {
