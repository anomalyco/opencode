...
if defined CODESURF_BIN_PATH (
    set "resolved=%CODESURF_BIN_PATH%"
    goto :execute
)
...
:not_found
echo It seems that your package manager failed to install the right version of the codesurf CLI for your platform. You can try manually installing the "%name%" package >&2
exit /b 1
