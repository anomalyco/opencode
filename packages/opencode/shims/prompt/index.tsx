/**
 * Lash Shell Mode Prompt Shim
 *
 * This is a fork of the upstream prompt/index.tsx with shell mode features.
 * It includes execution mode switching, tab completion, and visual mode indicators.
 *
 * This file is used as a build-time replacement for the upstream prompt/index.tsx.
 */
...
import { type AutocompleteRef, Autocomplete } from "@tui/component/prompt/autocomplete"
...
// Shell mode integration (Lash-specific)
...
export function Prompt(props: PromptProps) {
  ...
  const [store, setStore] = createStore<{
    ...
    interrupt: number
    placeholder: number
    // Shell mode completion cycling state (Lash-specific)
  ...
  // Shell mode command registration (Lash-specific)
  command.register(() => [
    {
  ...
  async function submit() {
    ...
    // Determine routing based on execution mode (Lash-specific)
  ...
  // Border highlight color based on mode (Lash-specific)
  ...
  // Mode prefix color for the input (Lash-specific)
    ...
    <>
      ...
      <box ref={(r) => (anchor = r)} visible={props.visible !== false}>
        ...
        >
          ...
          >
            <box flexDirection="row" alignItems="flex-start">
              {/* Mode icon prefix (Lash-specific) */}
              ...
              onKeyDown={async (e) => {
                ...
                // Handle Ctrl+Space to toggle execution mode (Lash-specific)
                if (handleModeToggleKey(e, { setMode: executionMode.setMode })) {
                  e.preventDefault()
                  return
                }
                // Handle tab for shell completion in shell/auto mode (Lash-specific)
                ...
                // Reset completion cycle on any other key press (Lash-specific)
        ...
        <box flexDirection="row" justifyContent="space-between">
          {/* Working directory display (Lash-specific) */}
            ...
            <box gap={2} flexDirection="row">
              <Switch>
                <Match when={store.mode === "normal"}>
                  {/* Mode indicator and keyboard hint (Lash-specific) */}
