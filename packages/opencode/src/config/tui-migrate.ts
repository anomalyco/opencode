...
const TUI_SCHEMA_URL = "https://raw.githubusercontent.com/puetsua/kancode/main/schemas/kancode-tui.schema.json"
...
/**
 * Migrates tui-specific keys (theme, keybinds, tui) from kancode/opencode.json
...
async function opencodeFiles(input: { directories: string[]; cwd: string }) {
  ...
  for (const dir of unique(input.directories)) {
    ...
    files.push(
      ...(userScope ? ConfigPaths.userConfigFilesInDirectory(dir) : ConfigPaths.appConfigFilesInDirectory(dir)),
    )
  }
