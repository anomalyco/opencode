...
// Keys injected by macOS/MDM into the managed plist that are not IMECODE config
...
export function managedConfigDir() {
  return process.env.IMECODE_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
