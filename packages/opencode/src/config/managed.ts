...
const MANAGED_PLIST_DOMAIN = "ai.apex.managed"
...
function systemManagedConfigDir(): string {
  switch (process.platform) {
    case "darwin":
      return "/Library/Application Support/apex"
    case "win32":
      return path.join(process.env.ProgramData || "C:\\ProgramData", "apex")
    default:
      return "/etc/apex"
  }
}
...
export function managedConfigDir() {
  return process.env.APEX_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
