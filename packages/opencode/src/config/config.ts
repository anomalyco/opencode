...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      panel_resize_mode: z.string().optional().default("<leader>p").describe("Toggle panel resize mode"),
      panel_resize_reset: z.string().optional().default("<leader>0").describe("Reset panel widths"),
      panel_resize_preset_code: z.string().optional().default("<leader>1").describe("Set code-focus panel widths"),
      panel_resize_preset_review: z.string().optional().default("<leader>2").describe("Set review-focus panel widths"),
      right_sidebar_narrow: z.string().optional().default("<leader>-").describe("Narrow right sidebar width"),
      right_sidebar_widen: z.string().optional().default("<leader>=").describe("Widen right sidebar width"),
      left_sidebar_toggle: z.string().optional().default("<leader>v").describe("Toggle left sidebar"),
      left_sidebar_narrow: z.string().optional().default("<leader>[").describe("Narrow left sidebar width"),
      left_sidebar_widen: z.string().optional().default("<leader>]").describe("Widen left sidebar width"),
