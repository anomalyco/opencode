...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      model_cycle_favorite: z.string().optional().default("ctrl+alt+1").describe("Next favorite model"),
      model_cycle_favorite_reverse: z.string().optional().default("ctrl+alt+2").describe("Previous favorite model"),
