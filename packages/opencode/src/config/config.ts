...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const loadGlobal = Effect.fnUntraced(function* () {
      ...
      result = mergeConfig(result, yield* loadFile(path.join(Global.Path.config, "securecode.json")))
      result = mergeConfig(result, yield* loadFile(path.join(Global.Path.config, "securecode.jsonc")))
