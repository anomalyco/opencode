...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      session_directory: z.string().optional().default("ctrl+g").describe("Open session directory selector"),
      session_directory_refresh: z.string().optional().default("ctrl+r").describe("Refresh session directory list"),
