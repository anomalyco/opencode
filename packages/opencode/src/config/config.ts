...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      diff_viewer_open: z.string().optional().default("<leader>d").describe("Open visual diff viewer"),
      diff_viewer_scroll_up: z.string().optional().default("k").describe("Scroll diff viewer up by one line"),
      diff_viewer_scroll_down: z.string().optional().default("j").describe("Scroll diff viewer down by one line"),
