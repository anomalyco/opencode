...
const KeybindsSchema = Schema.Struct({
  ...
  session_tab_pin: keybind("<leader>p", "Pin or unpin the current session as a tab"),
  session_tab_close: keybind("<leader>w", "Close the current session tab"),
  session_tab_next: keybind("ctrl+down", "Switch to next session tab"),
  session_tab_prev: keybind("ctrl+up", "Switch to previous session tab"),
