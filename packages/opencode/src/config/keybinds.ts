...
const KeybindsSchema = Schema.Struct({
  ...
  input_line_home: keybind("ctrl+a,home", "Move to start of line in input"),
  input_line_end: keybind("ctrl+e,end", "Move to end of line in input"),
  input_select_line_home: keybind("ctrl+shift+a,shift+home", "Select to start of line in input"),
  input_select_line_end: keybind("ctrl+shift+e,shift+end", "Select to end of line in input"),
  ...
  input_buffer_home: keybind("ctrl+home", "Move to start of buffer in input"),
  input_buffer_end: keybind("ctrl+end", "Move to end of buffer in input"),
  input_select_buffer_home: keybind("ctrl+shift+home", "Select to start of buffer in input"),
  input_select_buffer_end: keybind("ctrl+shift+end", "Select to end of buffer in input"),
