export * as ContextPredictor from "./predictor"
...
const scanFiles = (root: string): ReadonlyArray<string> =>
  Glob.scanSync("**/*.{ts,tsx,js,jsx,mjs,mts,cts,svelte,vue}", { cwd: root, absolute: true, dot: true })
