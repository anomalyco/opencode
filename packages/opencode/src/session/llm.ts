...
import type { LLMEvent } from "@cedric/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@cedric/llm/route"
import type { LLMClientService } from "@cedric/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @cedric/llm. It
