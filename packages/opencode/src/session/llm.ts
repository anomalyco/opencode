...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // FORK: plugin-cwd-channel — pre-fetch instance ctx for _opencode namespace below 2026-05-03
      const _instanceCtx = yield* InstanceState.context
      ...
      return streamText({
        ...
        providerOptions: {
          ...
          _opencode: {
            cwd: _instanceCtx.directory,
            project: _instanceCtx.project.id,
          },
        },
        // FORK-END
