...
export function buildSystem(input: Pick<StreamInput, "agent" | "model" | "system" | "user">) {
  return [
    [
...
export function rejoinSystemForCaching(system: string[]) {
