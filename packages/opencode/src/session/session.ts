...
import { Slug } from "@leak-code/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@leak-code/llm"
...
import { locationServiceMapLayer } from "@leak-code/core/location-services"
...
import { PartTable, SessionTable } from "@leak-code/core/session/sql"
...
import { NonNegativeInt, optional } from "@leak-code/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".leak-code", "plans")
