...
import { PermissionV1 } from "@daemon-protocol/core/v1/permission"
...
import { LLM } from "./llm"
import { Shell } from "@daemon-protocol/core/shell"
...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@daemon-protocol/core/session/prompt"
import * as DateTime from "effect/DateTime"
import { eq } from "drizzle-orm"
import { SessionTable } from "@daemon-protocol/core/session/sql"
import { SessionReminders } from "./reminders"
import { SessionTools } from "./tools"
import { LLMEvent } from "@daemon-protocol/llm"
  ...
  Effect.gen(function* () {
    ...
    const shell: (input: ShellInput) => Effect.Effect<SessionV1.WithParts, Session.BusyError> = Effect.fn(
      ...
      return yield* state.startShell(
        input.sessionID,
        lastAssistant(input.sessionID),
        shellImpl(input, ready) as Effect.Effect<SessionV1.WithParts>,
        ready,
      )
    })
