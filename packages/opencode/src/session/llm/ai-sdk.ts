import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@leak-code/llm"
...
// Move this extraction into @leak-code/llm when Copilot is handled by the native runtime.
