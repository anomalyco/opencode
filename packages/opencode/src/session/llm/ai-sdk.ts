import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@cedric/llm"
...
// Move this extraction into @cedric/llm when Copilot is handled by the native runtime.
