import type { JsonSchema, LLMRequest, ProviderMetadata } from "@cedric/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@cedric/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @cedric/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
