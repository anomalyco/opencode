import type { JsonSchema, LLMRequest, ProviderMetadata } from "@leak-code/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@leak-code/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @leak-code/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
