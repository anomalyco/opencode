...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("SessionProcessor.create")(function* (input: Input) {
      ...
      const ensureCurrentTextPersisted = Effect.fn("SessionProcessor.ensureCurrentTextPersisted")(function* () {
        if (!ctx.currentText) return false
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "text-delta":
            ...
            yield* ensureCurrentTextPersisted()
