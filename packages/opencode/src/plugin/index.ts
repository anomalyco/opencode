...
import { SkillModelPlugin } from "./skill-model"
...
export namespace Plugin {
  ...
  const INTERNAL_PLUGINS: PluginInstance[] = [CodexAuthPlugin, CopilotAuthPlugin, GitlabAuthPlugin, PoeAuthPlugin, SkillModelPlugin]
