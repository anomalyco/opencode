  ...
  handler: Effect.fn("Cli.github.run")(function* (args) {
    ...
    yield* Effect.promise(async () => {
      ...
      try {
        ...
        console.log("imecode session", session.id)
      ...
      async function chat(message: string, files: PromptFiles = []) {
        console.log("Sending message to imecode...")
      ...
      function footer(opts?: { image?: boolean }) {
        ...
        const shareUrl = shareId ? `[imecode session](${shareBaseUrl}/s/${shareId})&nbsp;&nbsp;|&nbsp;&nbsp;` : ""
    ...
    issue(number: $number) {
      ...
      function buildPromptDataForIssue(issue: GitHubIssue) {
        ...
        return [
          ...
          "- Git push and PR creation are handled AUTOMATICALLY by the imecode infrastructure after your response",
