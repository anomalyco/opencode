    ...
    await bootstrap(process.cwd(), async () => {
      ...
      function subscribeSessionEvents() {
        const TOOL: Record<string, [string, string]> = {
          ...
          path_edit: ["Path Edit", UI.Style.TEXT_SUCCESS_BOLD],
          edit_batch: ["Edit Batch", UI.Style.TEXT_SUCCESS_BOLD],
          workspace_replace: ["Workspace Replace", UI.Style.TEXT_SUCCESS_BOLD],
          apply_patch: ["Patch", UI.Style.TEXT_SUCCESS_BOLD],
          inspect: ["Inspect", UI.Style.TEXT_HIGHLIGHT_BOLD],
          search: ["Search", UI.Style.TEXT_INFO_BOLD],
          discover_batch: ["Discover", UI.Style.TEXT_INFO_BOLD],
          list: ["List", UI.Style.TEXT_INFO_BOLD],
          write: ["Write", UI.Style.TEXT_SUCCESS_BOLD],
          task_async: ["Async Task", UI.Style.TEXT_WARNING_BOLD],
