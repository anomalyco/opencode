...
const TIPS = [
  ...
  "Press {highlight}Tab{/highlight} to cycle between Build, Plan and Chat agents",
  ...
  "Switch to {highlight}Chat{/highlight} agent for isolated tasks in a temporary directory",
