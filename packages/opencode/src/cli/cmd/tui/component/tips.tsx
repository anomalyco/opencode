...
const TIPS = [
  ...
  "Run {highlight}SecreCode serve{/highlight} for headless API access to SecreCode",
  "Use {highlight}SecreCode run --attach{/highlight} to connect to a running server",
  "Run {highlight}SecreCode upgrade{/highlight} to update to the latest version",
  "Run {highlight}SecreCode auth list{/highlight} to see all configured providers",
  "Run {highlight}SecreCode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}SecreCode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}SecreCode debug config{/highlight} to troubleshoot configuration",
