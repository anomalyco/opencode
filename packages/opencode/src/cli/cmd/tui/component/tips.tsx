...
const TIPS = [
  ...
  "Run {highlight}/connect{/highlight} to change or update your Mammouth AI key",
  ...
  "Create {highlight}mammouth.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/mammouth/mammouth.json{/highlight} for global config",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.mammouth/tool/{/highlight} to define new LLM tools",
  ...
  "Run {highlight}mammouth agent create{/highlight} for guided agent creation",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.mammouth/themes/{/highlight} directory",
  ...
  "Run {highlight}mammouth debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}mammouth run --model mammouth-ai/claude-haiku-4-5{/highlight} to specify a model via CLI",
  "All conversations are stored locally in {highlight}~/.local/share/mammouth/{/highlight}",
  "Your code never leaves your machine except for LLM API calls",
]
