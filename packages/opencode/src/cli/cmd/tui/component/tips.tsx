...
const TIPS = [
  ...
  "OpenSec auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "OpenSec auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "OpenSec uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent OpenSec from reading sensitive files",
  "Use {highlight}opensec run{/highlight} for non-interactive scripting",
  "Use {highlight}opensec --continue{/highlight} to resume the last session",
  "Use {highlight}opensec run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opensec serve{/highlight} for headless API access to OpenSec",
  "Use {highlight}opensec run --attach{/highlight} to connect to a running server",
  "Run {highlight}opensec upgrade{/highlight} to update to the latest version",
  "Run {highlight}opensec auth list{/highlight} to see all configured providers",
  "Run {highlight}opensec agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}opensec github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}opensec debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with OpenSec Zen for curated, tested models",
