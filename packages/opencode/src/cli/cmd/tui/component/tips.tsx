...
const TIPS = [
  ...
  "Create {highlight}mammouth-cli.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/mammouth-cli/mammouth-cli.json{/highlight} for global config",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.mammouth-cli/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Add {highlight}.md{/highlight} files to {highlight}.mammouth-cli/agent/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.mammouth-cli/tool/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.mammouth-cli/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent Mammouth CLI from reading sensitive files",
  "Use {highlight}mammouth-cli run{/highlight} for non-interactive scripting",
  "Use {highlight}mammouth-cli --continue{/highlight} to resume the last session",
  "Use {highlight}mammouth-cli run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}mammouth-cli serve{/highlight} for headless API access to Mammouth CLI",
  "Use {highlight}mammouth-cli run --attach{/highlight} to connect to a running server",
  "Run {highlight}mammouth-cli upgrade{/highlight} to update to the latest version",
  "Run {highlight}mammouth-cli auth list{/highlight} to see all configured providers",
  "Run {highlight}mammouth-cli agent create{/highlight} for guided agent creation",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.mammouth-cli/themes/{/highlight} directory",
  ...
  "Run {highlight}mammouth-cli debug config{/highlight} to troubleshoot configuration",
