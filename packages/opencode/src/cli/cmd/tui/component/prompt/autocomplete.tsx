        ...
        >
          {(option, index) => (
            <box
              ...
              flexDirection="row"
            >
              <text fg={index() === store.selected ? theme.selectedListItemText : theme.text} flexShrink={0}>
                {option.display}
              </text>
              <Show when={option.description}>
                <text fg={index() === store.selected ? theme.selectedListItemText : theme.textMuted} wrapMode="none">
                  {option.description}
                </text>
              </Show>
            </box>
