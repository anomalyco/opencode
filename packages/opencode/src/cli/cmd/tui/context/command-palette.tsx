...
function isVisibleSlashCommand(entry: PaletteCommandEntry) {
  return entry.command.hidden !== true
}
...
export function CommandPaletteProvider(props: ParentProps) {
  ...
  const slashEntries = useKeymapSelector((keymap: OpenTuiKeymap) =>
    keymap
      .getCommandEntries({
        visibility: "reachable",
        namespace: "palette",
