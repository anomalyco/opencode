...
export let DEFAULT_THEMES: Record<string, ThemeJson> = { opencode }
...
async function loadBuiltinThemes() {
  if (Object.keys(DEFAULT_THEMES).length > 1) return
  DEFAULT_THEMES = (await import("./theme-builtins")).BUILTIN_THEMES
  syncThemes()
}
