...
export const Definitions = {
  ...
  workflow_overview: keybind("ctrl+o", "Toggle workflow overview"),
  workflow_tasks: keybind("<leader>k", "Toggle workflow task panel"),
  workflow_verbosity: keybind("ctrl+shift+v", "Cycle workflow verbosity"),
...
export const CommandMap = {
  ...
  workflow_verbosity: "workflow.verbosity",
