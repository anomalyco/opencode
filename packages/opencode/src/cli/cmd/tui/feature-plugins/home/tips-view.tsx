...
const TIPS: Tip[] = [
  ...
  (shortcuts) => `Use ${commandText("/menu", shortcuts.commandList())} to see all available actions and commands`,
  ...
  (shortcuts) =>
    shortcuts.commandList()
      ? `Toggle username display in chat via the command palette (${commandText("/menu", shortcuts.commandList())})`
