...
const TIPS = [
  ...
  "Create {highlight}securecode.json{/highlight} (or {highlight}opencode.json{/highlight}) for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/securecode/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "SecureCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "SecureCode auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "SecureCode uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent SecureCode from reading sensitive files",
  "Use {highlight}securecode run{/highlight} for non-interactive scripting",
  "Use {highlight}securecode --continue{/highlight} to resume the last session",
  "Use {highlight}securecode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}securecode serve{/highlight} for headless API access to securecode",
  "Use {highlight}securecode run --attach{/highlight} to connect to a running server",
  "Run {highlight}securecode upgrade{/highlight} to update to the latest version",
  "Run {highlight}securecode auth list{/highlight} to see all configured providers",
  "Run {highlight}securecode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}securecode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}securecode debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/acompany-develop/securecode{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with SecureCode for curated, tested models",
