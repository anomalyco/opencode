...
const TIPS = [
  ...
  "Press {highlight}Ctrl+P{/highlight} or run {highlight}/menu{/highlight} to see all available actions and commands",
  ...
  "Toggle username display in chat via command palette ({highlight}Ctrl+P{/highlight} or {highlight}/menu{/highlight})",
