...
const TIPS = [
  ...
  "Press {highlight}Ctrl+G{/highlight} or {highlight}Ctrl+Home{/highlight} to jump to the beginning of the conversation",
  "Press {highlight}Ctrl+Alt+G{/highlight} or {highlight}Ctrl+End{/highlight} to jump to the most recent message",
  "Use {highlight}Home{/highlight} and {highlight}End{/highlight} to move within your prompt",
