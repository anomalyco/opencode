...
function printDoctorReport(report: Awaited<ReturnType<typeof generateDoctorReport>>) {
  ...
  console.log(`Latest migration: ${report.compatibility.latestAppliedMigration ?? "none"}`)
  console.log(`Sessions: ${report.sessionCount ?? 0}`)
  console.log(`Messages: ${report.messageCount ?? 0}`)
  console.log("")
  console.log("Supported repairs:")
  report.supportedRepairs.forEach((repair) => console.log(`- ${repair.code}: ${repair.sourceVersions} Target: ${repair.targetInvariant}`))
  console.log("")
...
function printRepairPlan(plan: RepairPlan) {
  ...
  console.log(`Latest migration: ${plan.compatibility.latestAppliedMigration ?? "none"}`)
  console.log("")
  console.log("Supported repairs:")
  plan.supportedRepairs.forEach((repair) => console.log(`- ${repair.code}: ${repair.sourceVersions} Target: ${repair.targetInvariant}`))
  console.log("")
