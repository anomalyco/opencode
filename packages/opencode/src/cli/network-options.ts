...
// Dependency-free network option definitions for the CLI entrypoint. Lives
// here (instead of network.ts) so the default TUI command's synchronous
// builder doesn't evaluate the effect import in network.ts.
const options = {
  port: {
