...
export function serveUIEffect(
  ...
  return Effect.gen(function* () {
    ...
    // Upstream fell back to proxying this server's UI routes to app.opencode.ai when no
    // web UI was compiled in. VeniceCode serves its own UI or nothing at all.
