    ...
    HttpApiGroup.make("provider")
      .add(
        ...
        HttpApiEndpoint.post("reload", `${root}/reload`, {
          query: WorkspaceRoutingQuery,
          success: described(Schema.Boolean, "Providers reloaded"),
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "provider.reload",
            summary: "Reload providers",
            description: "Reload provider auth state, picking up credential changes without restarting.",
          }),
        ),
      )
      .annotateMerge(
