...
import { makeApi } from "@leak-code/protocol/api"
import { LocationMiddleware } from "@leak-code/server/location"
import { SessionLocationMiddleware } from "@leak-code/server/middleware/session-location"
...
export const OpenCodeHttpApi = HttpApi.make("leak-code")
