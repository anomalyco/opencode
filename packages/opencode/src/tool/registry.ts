...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@yunpat/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@yunpat/ToolRegistry") {}
