...
import { AbsolutePath, type DeepMutable } from "@leak-code/core/schema"
import { ProviderV2 } from "@leak-code/core/provider"
import { ModelV2 } from "@leak-code/core/model"
import { LocationServiceMap, locationServiceMapLayer } from "@leak-code/core/location-services"
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".leak-code", "plans", "*.md")]: "allow",
