  ...
  export const layer: Layer.Layer<Service, never, AppFileSystem.Service | ChildProcessSpawner.ChildProcessSpawner> =
    Layer.effect(
      ...
      Effect.gen(function* () {
        ...
        const current = InstanceState.get(instanceState)
        ...
        return Service.of({
          ...
          cleanup: Effect.fn("Snapshot.cleanup")(function* () {
            return yield* (yield* current).cleanup()
          }),
          track: Effect.fn("Snapshot.track")(function* () {
            return yield* (yield* current).track()
          }),
          patch: Effect.fn("Snapshot.patch")(function* (hash: string) {
            return yield* (yield* current).patch(hash)
          }),
          restore: Effect.fn("Snapshot.restore")(function* (snapshot: string) {
            return yield* (yield* current).restore(snapshot)
          }),
          revert: Effect.fn("Snapshot.revert")(function* (patches: Snapshot.Patch[]) {
            return yield* (yield* current).revert(patches)
          }),
          diff: Effect.fn("Snapshot.diff")(function* (hash: string) {
            return yield* (yield* current).diff(hash)
          }),
          diffFull: Effect.fn("Snapshot.diffFull")(function* (from: string, to: string) {
            return yield* (yield* current).diffFull(from, to)
          }),
        })
      }),
    )
...
export const runPromise = makeRunPromise(Snapshot.Service, Snapshot.defaultLayer)
