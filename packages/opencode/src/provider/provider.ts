...
import { Hash } from "@cedric/core/util/hash"
...
import { optionalOmitUndefined } from "@cedric/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@cedric/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
