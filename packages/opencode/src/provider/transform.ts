...
export namespace ProviderTransform {
  ...
  function normalizeMessages(
    ...
    // Filter out messages with empty content - many providers (Anthropic, Bedrock,
    // Moonshot/Kimi, OpenAI-compatible) reject empty assistant messages.
    // Apply unconditionally since no provider accepts truly empty messages.
