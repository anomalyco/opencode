...
// The server fetches a caller-supplied URL. Loopback and LAN hosts stay reachable on purpose for
// local runtimes like Ollama; callers need the same authorization as config writes.
