...
import { EventSequenceTable, EventTable } from "@leak-code/core/event/sql"
...
import { WorkspaceEvent } from "@leak-code/schema/workspace-event"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        LEAKCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        LEAKCODE_WORKSPACE_ID: config.id,
        LEAKCODE_EXPERIMENTAL_WORKSPACES: "true",
