 ...
 *
 * This module provides GitHub integration for opencode. It has been refactored
 * to implement the IVCSProvider interface but is deprecated in favor of the
 * GitLab provider.
 */

// Re-export the provider
export { GitHubProvider, parseGitHubRemote, type GitHubConfig } from "./provider"
...
// Local cmd function to avoid circular dependency
import type { CommandModule } from "yargs"

type WithDoubleDash<T> = T & { "--"?: string[] }

function cmd<T, U>(input: CommandModule<T, WithDoubleDash<U>>) {
  return input
}
...
// ============================================================================
// CLI Commands (preserved for backward compatibility)
// ============================================================================
