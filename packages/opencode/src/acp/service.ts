...
import { buildConfigOptions, DEFAULT_VARIANT_VALUE, parseModelSelection, toV2ConfigOptions } from "./config-option"
...
export function make(input: {
  ...
  const setSessionConfigOption = Effect.fn("ACP.setSessionConfigOption")(function* (
    ...
    if (params.configId === "model") {
      ...
      return {
        configOptions: v2Active ? toV2ConfigOptions(options) : options,
      }
    }
