...
export namespace Flag {
	...
	export const OPENCODE_WORKOS_ENABLED = truthy("OPENCODE_WORKOS_ENABLED");
	export const OPENCODE_ENABLE_QUESTION_TOOL = truthy("OPENCODE_ENABLE_QUESTION_TOOL");
	export const OPENCODE_HOSTED_MODE = truthy("OPENCODE_HOSTED_MODE");
	export const OPENCODE_DISABLE_LOCAL_FILESYSTEM = OPENCODE_HOSTED_MODE || truthy("OPENCODE_DISABLE_LOCAL_FILESYSTEM");
