...
export namespace Flag {
  ...
  // Enables L1/L2 tool+skill cache globally and overrides config.experimental.cache.enabled when true.
  ...
  export const OPENCODE_EXPERIMENTAL_CACHE = truthy("OPENCODE_EXPERIMENTAL_CACHE")
