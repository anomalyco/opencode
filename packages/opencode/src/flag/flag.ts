...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_WORKSPACES_TUI =
    OPENCODE_EXPERIMENTAL || truthy("MAMMOUTH_EXPERIMENTAL_WORKSPACES_TUI")
  ...
  export const OPENCODE_DISABLE_CHANNEL_DB = truthy("MAMMOUTH_DISABLE_CHANNEL_DB")
  export const OPENCODE_SKIP_MIGRATIONS = truthy("MAMMOUTH_SKIP_MIGRATIONS")
