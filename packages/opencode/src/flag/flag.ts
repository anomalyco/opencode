...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_WS_TRANSPORT = truthy("OPENCODE_EXPERIMENTAL_WS_TRANSPORT")
  export const OPENCODE_EXPERIMENTAL_WS_INCREMENTAL =
    OPENCODE_EXPERIMENTAL_WS_TRANSPORT || truthy("OPENCODE_EXPERIMENTAL_WS_INCREMENTAL")
