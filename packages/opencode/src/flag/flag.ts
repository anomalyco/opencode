...
export namespace Flag {
  ...
  export const OPENCODE_MEMORY_MONITOR_RSS_BYTES = number("OPENCODE_MEMORY_MONITOR_RSS_BYTES")
  export const OPENCODE_MEMORY_MONITOR_CONSECUTIVE = number("OPENCODE_MEMORY_MONITOR_CONSECUTIVE")
