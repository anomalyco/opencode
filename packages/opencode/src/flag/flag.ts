...
export namespace Flag {
  ...
  export const OPENCODE_DISABLE_APPLE_CONTAINER = truthy("OPENCODE_DISABLE_APPLE_CONTAINER")
  export const OPENCODE_FORCE_APPLE_CONTAINER = truthy("OPENCODE_FORCE_APPLE_CONTAINER")
  export const OPENCODE_APPLE_CONTAINER_IMAGE = process.env["OPENCODE_APPLE_CONTAINER_IMAGE"]
  export const OPENCODE_APPLE_CONTAINER_BINARY = process.env["OPENCODE_APPLE_CONTAINER_BINARY"]
