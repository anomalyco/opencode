...
export declare namespace BunProc {
    function run(cmd: string[], options?: Process.Options): Promise<Process.Child>;
    ...
    const InstallFailedError: {
        new (data: {
            ...
            cause?: unknown;
            readonly name: "BunInstallFailedError";
            readonly data: {
                pkg: string;
                version: string;
            };
            schema(): z.ZodObject<{
                name: z.ZodLiteral<"BunInstallFailedError">;
                data: z.ZodObject<{
                    pkg: z.ZodString;
                    version: z.ZodString;
                }, z.core.$strip>;
    ...
    function install(pkg: string, version?: string): Promise<string>;
}
