...
export namespace LSPServer {
  ...
  export const Typescript: Info = {
    ...
    async spawn(root) {
      ...
      const proc = Bun.spawn({
        cmd: [BunProc.which(), "x", "typescript-language-server", "--stdio"],
        cwd: root,
        env: {
          ...process.env,
          BUN_BE_BUN: "1",
  ...
  export const ESLint: Info = {
    ...
    async spawn(root) {
      ...
      const proc = Bun.spawn({
        cmd: [BunProc.which(), serverPath, "--stdio"],
        cwd: root,
        env: {
          ...process.env,
          BUN_BE_BUN: "1",
  ...
  export const Ty: Info = {
    ...
    async spawn(root) {
      ...
      const proc = Bun.spawn([binary, "server"], {
        cwd: root,
      })
  ...
  export const Clangd: Info = {
    ...
    async spawn(root) {
      ...
      if (fromPath) {
        return {
          process: Bun.spawn([fromPath, ...args], {
            cwd: root,
          }),
        }
      }
      ...
      for (const entry of entries) {
        ...
        if (await Bun.file(candidate).exists()) {
          return {
            process: Bun.spawn([candidate, ...args], {
              cwd: root,
            }),
          }
        }
  ...
  export const KotlinLS: Info = {
    ...
    async spawn(root) {
      ...
      return {
        process: Bun.spawn([launcherScript, "--stdio"], {
          cwd: root,
        }),
      }
    },
  ...
  export const Prisma: Info = {
    ...
    async spawn(root) {
      ...
      return {
        process: Bun.spawn([prisma, "language-server"], {
          cwd: root,
        }),
      }
    },
  ...
  export const Dart: Info = {
    ...
    async spawn(root) {
      ...
      return {
        process: Bun.spawn([dart, "language-server", "--lsp"], {
          cwd: root,
        }),
      }
    },
  ...
  export const Tinymist: Info = {
    ...
    async spawn(root) {
      ...
      return {
        process: Bun.spawn([bin], { cwd: root }),
      }
    },
  }
