...
import type * as SDK from "@leak-code/sdk/v2"
...
import { SessionShareTable } from "@leak-code/core/share/sql"
...
const disabled = process.env["LEAKCODE_DISABLE_SHARE"] === "true" || process.env["LEAKCODE_DISABLE_SHARE"] === "1"
