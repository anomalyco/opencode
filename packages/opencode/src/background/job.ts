...
import { Cause, Clock, Context, Deferred, Effect, Fiber, Layer, Scope } from "effect"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const finish = Effect.fn("BackgroundJob.finish")(function* (
      ...
      job.info.completed_at = yield* Clock.currentTimeMillis
    ...
    const start: Interface["start"] = Effect.fn("BackgroundJob.start")(function* (input) {
      ...
      const job: Active = {
        info: {
          ...
          title: input.title,
          status: "running",
          started_at: yield* Clock.currentTimeMillis,
