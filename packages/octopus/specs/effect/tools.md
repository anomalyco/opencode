...
Practical reference for the current tool-migration state in `packages/octopus`.
...
Tool tests should use the existing Effect helpers in `packages/octopus/test/lib/effect.ts`:
