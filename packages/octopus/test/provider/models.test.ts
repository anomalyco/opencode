...
// test/preload.ts pins OCTOPUS_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.OCTOPUS_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.OCTOPUS_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.OCTOPUS_MODELS_PATH = undefined
  Flag.OCTOPUS_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.OCTOPUS_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.OCTOPUS_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
