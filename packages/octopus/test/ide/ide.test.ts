...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OCTOPUS_CALLER", () => {
    process.env["OCTOPUS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OCTOPUS_CALLER", () => {
    process.env["OCTOPUS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OCTOPUS_CALLER", () => {
    process.env["OCTOPUS_CALLER"] = "unknown"
