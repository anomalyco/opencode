...
const original = {
  OCTOPUS_DISABLE_EMBEDDED_WEB_UI: Flag.OCTOPUS_DISABLE_EMBEDDED_WEB_UI,
  OCTOPUS_SERVER_PASSWORD: Flag.OCTOPUS_SERVER_PASSWORD,
  OCTOPUS_SERVER_USERNAME: Flag.OCTOPUS_SERVER_USERNAME,
  envPassword: process.env.OCTOPUS_SERVER_PASSWORD,
  envUsername: process.env.OCTOPUS_SERVER_USERNAME,
}

afterEach(() => {
  Flag.OCTOPUS_DISABLE_EMBEDDED_WEB_UI = original.OCTOPUS_DISABLE_EMBEDDED_WEB_UI
  Flag.OCTOPUS_SERVER_PASSWORD = original.OCTOPUS_SERVER_PASSWORD
  Flag.OCTOPUS_SERVER_USERNAME = original.OCTOPUS_SERVER_USERNAME
  restoreEnv("OCTOPUS_SERVER_PASSWORD", original.envPassword)
  restoreEnv("OCTOPUS_SERVER_USERNAME", original.envUsername)
})
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            OCTOPUS_SERVER_PASSWORD: input?.password,
            OCTOPUS_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
