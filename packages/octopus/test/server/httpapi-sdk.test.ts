...
import { createOctopusClient } from "@octopus-ai/sdk/v2"
...
type Sdk = ReturnType<typeof createOctopusClient>
...
function app(serverPath: ServerPath, input?: { password?: string; username?: string }) {
  Flag.OCTOPUS_SERVER_PASSWORD = input?.password
  Flag.OCTOPUS_SERVER_USERNAME = input?.username
