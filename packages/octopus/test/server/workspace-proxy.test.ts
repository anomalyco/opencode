...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips octopus-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-octopus-directory"]).toBeUndefined()
      expect(forwarded["x-octopus-workspace"]).toBeUndefined()
