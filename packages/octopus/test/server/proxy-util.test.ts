...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips octopus-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-octopus-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-octopus-directory")).toBeNull()
      expect(result.get("x-octopus-workspace")).toBeNull()
