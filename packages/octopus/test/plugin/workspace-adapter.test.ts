...
const { Flag } = await import("@octopus-ai/core/flag/flag")
...
const experimental = Flag.OCTOPUS_EXPERIMENTAL_WORKSPACES
...
afterAll(() => {
  ...
  Flag.OCTOPUS_EXPERIMENTAL_WORKSPACES = experimental
})
