...
process.env["OCTOPUS_TEST_HOME"] = testHome

// Set test managed config directory to isolate tests from system managed settings
const testManagedConfigDir = path.join(dir, "managed")
process.env["OCTOPUS_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["OCTOPUS_DISABLE_DEFAULT_PLUGINS"] = "true"
...
delete process.env["OCTOPUS_SERVER_PASSWORD"]
delete process.env["OCTOPUS_SERVER_USERNAME"]

// Use in-memory sqlite
process.env["OCTOPUS_DB"] = ":memory:"

// Now safe to import from src/
const { Log } = await import("@octopus-ai/core/util/log")
