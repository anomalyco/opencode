...
export class Service extends Context.Service<Service, Interface>()("@octopus/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.OCTOPUS_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OCTOPUS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OCTOPUS_WORKSPACE_ID: config.id,
        OCTOPUS_EXPERIMENTAL_WORKSPACES: "true",
