...
const TIPS = [
  ...
  "Octopus auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Octopus auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Octopus uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Octopus from reading sensitive files",
  "Use {highlight}octopus run{/highlight} for non-interactive scripting",
  "Use {highlight}octopus --continue{/highlight} to resume the last session",
  "Use {highlight}octopus run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}octopus serve{/highlight} for headless API access to Octopus",
  "Use {highlight}octopus run --attach{/highlight} to connect to a running server",
  "Run {highlight}octopus upgrade{/highlight} to update to the latest version",
  "Run {highlight}octopus auth list{/highlight} to see all configured providers",
  "Run {highlight}octopus agent create{/highlight} for guided agent creation",
  "Use {highlight}/octopus{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}octopus github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/octopus fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}octopus debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with Octopus Zen for curated, tested models",
