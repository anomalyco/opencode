...
import type { Event, GlobalEvent, OctopusClient } from "@octopus-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@octopus/RunStreamTransport") {}
