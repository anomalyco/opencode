...
import os from "os"
import * as EffectZod from "@octopus-ai/core/effect-zod"
...
export class Service extends Context.Service<Service, Interface>()("@octopus/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      if (!Flag.OCTOPUS_EXPERIMENTAL_PLAN_MODE) {
