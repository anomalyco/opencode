...
import { NonNegativeInt, type DeepMutable, withStatics } from "@octopus-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@octopus/File") {}
