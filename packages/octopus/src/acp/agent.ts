...
import type { AssistantMessage, Event, OctopusClient, SessionMessageResponse, ToolPart } from "@octopus-ai/sdk/v2"
...
export function init({ sdk: _sdk }: { sdk: OctopusClient }) {
  return {
