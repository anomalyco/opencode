...
import { zod, ZodOverride } from "@octopus-ai/core/effect-zod"
...
const filterExperimentalServers = (servers: Record<string, LSPServer.Info>) => {
  if (Flag.OCTOPUS_EXPERIMENTAL_LSP_TY) {
    if (servers["pyright"]) {
      log.info("LSP server pyright is disabled because OCTOPUS_EXPERIMENTAL_LSP_TY is enabled")
...
export class Service extends Context.Service<Service, Interface>()("@octopus/LSP") {}
