...
export const RootHttpApi = HttpApi.make("octopus-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("octopus-instance")
...
export const OpenCodeHttpApi = HttpApi.make("octopus")
