...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@octopus-ai/plugin"
import { Schema } from "effect"
import z from "zod"
import { ZodOverride } from "@octopus-ai/core/effect-zod"
...
export class Service extends Context.Service<Service, Interface>()("@octopus/ToolRegistry") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const questionEnabled =
          ["app", "cli", "desktop"].includes(Flag.OCTOPUS_CLIENT) || Flag.OCTOPUS_ENABLE_QUESTION_TOOL
        ...
        return {
          ...
          builtin: [
            ...
            tool.todo,
            tool.search,
            ...(Flag.OCTOPUS_EXPERIMENTAL_SCOUT ? [tool.code, tool.repo_clone, tool.repo_overview] : []),
            tool.skill,
            tool.patch,
            ...(Flag.OCTOPUS_EXPERIMENTAL_LSP_TOOL ? [tool.lsp] : []),
            ...(Flag.OCTOPUS_EXPERIMENTAL_PLAN_MODE && Flag.OCTOPUS_CLIENT === "cli" ? [tool.plan] : []),
          ],
          task: tool.task,
          read: tool.read,
        }
