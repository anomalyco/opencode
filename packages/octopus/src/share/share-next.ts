import type * as SDK from "@octopus-ai/sdk/v2"
...
const disabled = process.env["OCTOPUS_DISABLE_SHARE"] === "true" || process.env["OCTOPUS_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@octopus/ShareNext") {}
