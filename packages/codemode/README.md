...
```ts
import { CodeMode, Tool } from "@kancode/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@kancode/codemode"
...
```ts
import { toolError } from "@kancode/codemode"
