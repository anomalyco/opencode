...
import { createOpencode, type ToolPart } from "@f5xc-salesdemos/sdk"
...
console.log("🚀 Starting xcsh server...")
const opencode = await createOpencode({
  port: 0,
})
console.log("✅ xcsh server ready")
...
app.message(async ({ message, say }) => {
  ...
  if (!session) {
    console.log("🆕 Creating new xcsh session...")
    ...
    console.log("✅ Created xcsh session:", createResult.data.id)
  ...
  console.log("📝 Sending to xcsh:", message.text)
