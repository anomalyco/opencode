      ...
      async fn() {
        {
          ...
          function printNextSteps() {
            ...
            prompts.outro(
              [
                ...
                "",
                "   Learn more about the GitHub agent - https://forge.dev/docs/github/#usage-examples",
              ].join("\n"),
            )
          }
          ...
          async function installGitHubApp() {
            ...
            async function getInstallation() {
              return await fetch(
                `https://api.forge.dev/get_github_app_installation?owner=${app.owner}&repo=${app.repo}`,
              )
                .then((res) => res.json())
...
export const GithubRunCommand = cmd({
  ...
  async handler(args) {
    await bootstrap(process.cwd(), async () => {
      ...
      const shareBaseUrl = isMock ? "https://dev.forge.dev" : "https://forge.dev"
      ...
      async function exchangeForAppToken(token: string) {
        const response = token.startsWith("github_pat_")
          ? await fetch("https://api.forge.dev/exchange_github_app_token_with_pat", {
              method: "POST",
              headers: {
          ...
          : await fetch("https://api.forge.dev/exchange_github_app_token", {
              method: "POST",
              headers: {
                Authorization: `Bearer ${token}`,
              },
