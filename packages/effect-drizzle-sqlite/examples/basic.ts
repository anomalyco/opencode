...
class Database extends Context.Service<Database, DatabaseShape>()("@kancode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@kancode/example/UserStore") {
