...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CHALICECODE_CALLER", () => {
    process.env["CHALICECODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CHALICECODE_CALLER", () => {
    process.env["CHALICECODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CHALICECODE_CALLER", () => {
    process.env["CHALICECODE_CALLER"] = "unknown"
