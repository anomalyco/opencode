...
import { createOpencodeClient, type OpencodeClient } from "@chalicecode-ai/sdk"
...
export const RunCommand = cmd({
  ...
  handler: async (args) => {
    ...
    if (args.attach) {
      ...
      if (cfgResult.data && (cfgResult.data.share === "auto" || Flag.CHALICECODE_AUTO_SHARE || args.share)) {
