  ...
  return (
    <div class="flex flex-col gap-4">
      <p class="text-14-regular text-text-base">
        A powerful interface for managing AI coding agents — built on top of OpenCode.
      </p>
...
function StepTailscaleSetup(props: {
  ...
  return (
    <div class="flex flex-col gap-4">
      ...
      {/* Start server + verify */}
      <CodeBlock label="Start your OpenCode server" code="opencode server --port 4096" />
  ...
  return (
    <div class="flex flex-col gap-4">
      ...
      <div class="bg-surface-raised-base rounded-lg p-4 flex flex-col gap-2">
        ...
        <p class="text-13-regular text-text-weak">
          Open <strong>Settings &gt; Remote Access</strong> to find a QR code for this site. Scan it on your phone or tablet to open Claxedo instantly — it connects to your local OpenCode server through this gateway.
        </p>
      </div>
...
const FEATURES = [
  ...
  { title: "Built on OpenCode", desc: "Extended with a better, more powerful UI" },
]
