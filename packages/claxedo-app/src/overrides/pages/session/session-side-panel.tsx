/**
 * Override of SessionSidePanel that uses CSS visibility instead of <Show>
 * to avoid expensive unmount/remount of the diff viewer and file tree.
 *
 * Upstream uses <Show when={fileTree.opened() && tab === "changes"}> which
 * switches between two entirely different subtrees (direct review vs tabbed view),
 * destroying and recreating the diff component each time.
 */
