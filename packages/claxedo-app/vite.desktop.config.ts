...
// Backend URL for proxy (defaults to OpenCode server port)
const backendUrl = process.env.VITE_OPENCODE_BACKEND_URL || "http://127.0.0.1:4096"
...
export default defineConfig({
  ...
  server: {
    ...
    // Proxy API routes to the OpenCode backend server
    proxy: {
      ...Object.fromEntries(
        [
          "agent",
