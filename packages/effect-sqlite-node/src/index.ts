...
export const TypeId: TypeId = "~@moks/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@moks/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@moks/effect-sqlite-node/NodeSqliteClient")
