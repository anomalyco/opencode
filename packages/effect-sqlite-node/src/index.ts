...
export const TypeId: TypeId = "~@leak-code/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@leak-code/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@leak-code/effect-sqlite-node/NodeSqliteClient")
