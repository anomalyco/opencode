...
export const TypeId: TypeId = "~@argus-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@argus-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@argus-ai/effect-sqlite-node/NodeSqliteClient")
