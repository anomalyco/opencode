...
export const TypeId: TypeId = "~@pencode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@pencode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@pencode-ai/effect-sqlite-node/NodeSqliteClient")
