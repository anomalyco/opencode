...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@argus-ai/sdk/v2"
...
const CUSTOM_PROVIDER_OPTION_VALUE = "__argus_custom_provider__"
    ...
    const value = await DialogPrompt.show(dialog, "Other", {
      ...
      description: () => (
        <text fg={theme.textMuted}>
          This only stores a credential. Configure the provider in argus.json to use it.
        </text>
      ),
    })
    ...
    <DialogPrompt
        ...
        ({
          argus: (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://argus.ai/zen</span> to get a key
              </text>
            </box>
          ),
          "argus-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://argus.ai/go</span> and enable Argus Go
              </text>
            </box>
          ),
      ...
      onConfirm={async (value) => {
        ...
        if (props.custom && !sync.data.provider_next.all.some((provider) => provider.id === props.providerID)) {
          toast.show({
            variant: "info",
            message: `Saved credential for ${props.providerID}. Configure it in argus.json to use it.`,
          })
          dialog.clear()
          return
        }
