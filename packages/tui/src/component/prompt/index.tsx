...
import type { AssistantMessage, FilePart, UserMessage } from "@pencode-ai/sdk/v2"
...
import { PENCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, usePencodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.PENCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
