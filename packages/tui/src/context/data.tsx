...
import { useEvent, type EventMetadata } from "./event"
      ...
      switch (event.type) {
        ...
        case "session.deleted":
          setStore(
            "session",
            produce((draft) => {
              delete draft.info[event.properties.sessionID]
              delete draft.message[event.properties.sessionID]
              delete draft.permission[event.properties.sessionID]
              delete draft.question[event.properties.sessionID]
            }),
          )
          break
