...
import defaultSoundPath from "@leak-code/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@leak-code/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@leak-code/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@leak-code/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@leak-code/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@leak-code/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "leak-code"
const DEFAULT_PACK_ID = "leak-code.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Leak Code Default",
  builtin: true,
  sounds: {
