...
import defaultSoundPath from "@argus-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@argus-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@argus-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@argus-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@argus-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@argus-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "argus"
const DEFAULT_PACK_ID = "argus.default"
