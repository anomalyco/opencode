...
import defaultSoundPath from "@kancode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@kancode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@kancode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@kancode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@kancode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@kancode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "kancode"
const DEFAULT_PACK_ID = "kancode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "KanCode Default",
  builtin: true,
  sounds: {
