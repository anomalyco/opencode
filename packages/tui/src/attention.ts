...
import defaultSoundPath from "./assets/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "./assets/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "./assets/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "./assets/nope-03.mp3" with { type: "file" }
import doneSoundPath from "./assets/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "./assets/yup-01.mp3" with { type: "file" }
