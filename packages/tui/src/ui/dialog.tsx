...
import { useBindings, useArgusModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useArgusModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.ARGUS_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
