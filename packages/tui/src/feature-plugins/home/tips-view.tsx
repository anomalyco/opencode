import type { TuiPluginApi } from "@argus-ai/plugin/tui"
...
export function Tips(props: { api: TuiPluginApi; connected?: boolean }) {
  ...
  const shortcuts: Shortcuts = {
    ...
    statusView: useCommandShortcut("argus.status"),
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public argus.ai link",
  ...
  "Create {highlight}argus.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.argus/commands/{/highlight} for reusable prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.argus/agents/{/highlight} for specialized AI personas",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.argus/plugins/{/highlight} for event hooks",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/argus-team/argus{/highlight} in a container",
