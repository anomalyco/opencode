...
export const Definitions = {
  ...
  session_tab_next_unread: keybind("pagedown,alt+shift+down", "Switch to next unread tab"),
  session_tab_previous_unread: keybind("pageup,alt+shift+up", "Switch to previous unread tab"),
  ...
  messages_page_up: keybind("ctrl+alt+b", "Scroll messages up by one page"),
  messages_page_down: keybind("ctrl+alt+f", "Scroll messages down by one page"),
