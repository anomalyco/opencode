...
export const Definitions = {
  ...
  session_tab_next_unread: keybind("<leader>]", "Switch to next unread session tab"),
  session_tab_previous_unread: keybind("<leader>[", "Switch to previous unread session tab"),
