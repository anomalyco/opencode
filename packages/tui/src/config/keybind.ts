...
export const Definitions = {
  ...
  messages_search: keybind("ctrl+r", "Search messages"),
  messages_search_next: keybind("none", "Next search match"),
  messages_search_previous: keybind("none", "Previous search match"),
