...
export const Definitions = {
  ...
  messages_search: keybind("<leader>f", "Search messages"),
  messages_search_next: keybind("<leader>]", "Navigate to next search match"),
  messages_search_previous: keybind("<leader>[", "Navigate to previous search match"),
...
export const CommandMap = {
  ...
  messages_search: "session.search",
  messages_search_next: "session.search.next",
  messages_search_previous: "session.search.previous",
