...
export const Definitions = {
  ...
  app_automode_cycle: keybind("<leader>o", "Cycle agent autonomy (manual / skip-ask / continue / auto)"),
  ...
  "dialog.local.toggle": keybind("space", "Toggle local provider selection"),
  "dialog.local.connect": keybind("ctrl+return", "Add selected local providers"),
  ...
  "loop.pause": keybind("ctrl+g", "Pause selected loop"),
  "loop.resume": keybind("ctrl+o", "Resume selected loop"),
  "loop.cancel": keybind("ctrl+x", "Stop selected loop"),
...
export const CommandMap = {
  ...
  app_toggle_automode_permissions: "app.toggle.automode.permissions",
  app_toggle_automode_continue: "app.toggle.automode.continue",
  app_automode_cycle: "app.automode.cycle",
  loop_list: "loop.list",
