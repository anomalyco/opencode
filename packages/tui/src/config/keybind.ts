...
export const Definitions = {
  ...
  session_rail_focus: keybind("<leader>j", "Focus session history rail"),
  session_rail_search: keybind("/", "Search in session history rail"),
  session_rail_unfocus: keybind("escape", "Leave session history rail focus"),
  session_rail_delete: keybind("ctrl+d", "Delete session from the history rail"),
  session_rail_rename: keybind("ctrl+r", "Rename session from the history rail"),
...
export const CommandMap = {
  ...
  session_rail_focus: "session.rail.focus",
  session_rail_search: "session.rail.search",
  session_rail_unfocus: "session.rail.unfocus",
  session_rail_delete: "session.rail.delete",
  session_rail_rename: "session.rail.rename",
