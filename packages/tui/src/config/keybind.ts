...
export const Definitions = {
  ...
  session_root: keybind("none", "Go to root session"),
  session_tree: keybind("none", "Show session tree"),
  ...
  team_overview: keybind("<leader>w", "Open team overview"),
  team_next: keybind("<leader>j", "Select next teammate"),
  team_previous: keybind("<leader>k", "Select previous teammate"),
  team_lead: keybind("l", "Go to team lead"),
  team_delegate_toggle: keybind("<leader>d", "Toggle team delegate mode"),
  team_approve_plan: keybind("a", "Approve teammate plan"),
  team_reject_plan: keybind("r", "Reject teammate plan"),
  team_shutdown: keybind("x", "Request teammate shutdown"),
  team_cleanup: keybind("shift+x", "Clean up team"),
  team_cancel: keybind("c", "Cancel teammate work"),
...
export const CommandMap = {
  ...
  team_lead: "team.lead",
  team_delegate_toggle: "team.delegate.toggle",
  team_approve_plan: "team.approve_plan",
  team_reject_plan: "team.reject_plan",
  team_shutdown: "team.shutdown",
  team_cleanup: "team.cleanup",
