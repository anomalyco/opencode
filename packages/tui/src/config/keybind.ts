...
export const Definitions = {
  ...
  session_split_toggle: keybind("ctrl+alt+s", "Toggle split-screen session view"),
  session_todo_toggle: keybind("alt+t", "Toggle session todo list"),
...
export const CommandMap = {
  ...
  session_todo_toggle: "session.todo.toggle",
