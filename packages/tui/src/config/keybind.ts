...
export const Definitions = {
  ...
  model_dialog_set_default: keybind("none", "Set focused model as default in global config"),
  model_list: keybind("<leader>m", "List available models"),
  model_set_default: keybind("none", "Set current model as default in global config"),
...
export const CommandMap = {
  ...
  model_dialog_set_default: "model.dialog.set_default",
