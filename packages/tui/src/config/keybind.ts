...
export const Definitions = {
  ...
  session_interrupt_send: keybind("ctrl+enter,<leader>i", "Interrupt and send prompt"),
  ...
  session_queued_flush: keybind("ctrl+shift+return,<leader>f", "Send queued prompts now"),
...
export const CommandMap = {
  ...
  session_interrupt_send: "session.interrupt_send",
  ...
  session_queued_flush: "session.queued_flush",
