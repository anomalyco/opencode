...
export const Definitions = {
  ...
  app_toggle_auto_resume: keybind("none", "Toggle auto-resume last session on startup"),
...
export const CommandMap = {
  ...
  app_toggle_auto_resume: "app.toggle.auto_resume",
  ...
  session_title_model: "session.title.model",
  permission_cruise_control_model: "permission.cruise_control.model",
  ...
  model_hide_toggle: "model.dialog.hide",
  model_note_edit: "model.dialog.note",
  model_variant_list: "model.dialog.variant",
