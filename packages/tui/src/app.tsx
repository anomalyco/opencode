...
export const appGlobalBindingCommands = [
  ...
  // Dialogs push the "modal" mode, and the session picker is a dialog, so this
  // has to stay mode-less or the binding is dead exactly where it is used.
    ...
    [
      ...
      },
      {
        ...
        run: async () => {
          ...
          // The picker re-queries on sync.session.query(), so leaving it open
