...
Internal package; depended on as `@simpliciocode/http-recorder` from another
workspace package.
...
```ts
import { HttpRecorder, Redactor } from "@simpliciocode/http-recorder"
