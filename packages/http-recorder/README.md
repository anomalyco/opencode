...
Internal package; depended on as `@octopus-ai/http-recorder` from another
workspace package.
...
```ts
import { HttpRecorder, Redactor } from "@octopus-ai/http-recorder"
