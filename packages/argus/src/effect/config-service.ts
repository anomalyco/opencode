 ...
 *   "@argus/ServerAuthConfig",
 *   {
 *     password: Config.string("ARGUS_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ARGUS_SERVER_USERNAME").pipe(Config.withDefault("argus")),
 *   },
 * ) {}
 *
