...
import { path } from "@argus-ai/core/effect/app-node-platform"
import { Global } from "@argus-ai/core/global"
import { InstanceStore } from "@/project/instance-store"
import { Project } from "@/project/project"
import { Database } from "@argus-ai/core/database/database"
import { eq } from "drizzle-orm"
import { ProjectTable } from "@argus-ai/core/project/sql"
import type { ProjectV2 } from "@argus-ai/core/project"
import { Slug } from "@argus-ai/core/util/slug"
...
import { WorktreeEvent } from "@argus-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@argus/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `argus/${name}`
