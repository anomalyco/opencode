...
>()("@argus/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@argus/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.ARGUS_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.ARGUS_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-argus-directory"] || process.cwd()
}
