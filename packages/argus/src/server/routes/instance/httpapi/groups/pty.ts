import { Pty } from "@argus-ai/core/pty"
import { PtyTicket } from "@argus-ai/core/pty/ticket"
import { PtyID } from "@argus-ai/core/pty/schema"
...
export const PtyApi = HttpApi.make("pty")
      ...
      .add(
        ...
        HttpApiEndpoint.get("list", PtyPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all active pseudo-terminal (PTY) sessions managed by Argus.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "argus experimental HttpApi",
      version: "0.0.1",
