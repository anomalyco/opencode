...
import type * as SDK from "@argus-ai/sdk/v2"
...
import { SessionShareTable } from "@argus-ai/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@argus/ShareNext") {}
