...
import { PermissionV1 } from "@argus-ai/core/v1/permission"
...
import { Usage, type LLMEvent } from "@argus-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@argus/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean argus changed history behind a signed
