import type { JsonSchema, LLMRequest, ProviderMetadata } from "@argus-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@argus-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @argus-ai/llm request objects from argus's session/AI SDK-shaped data.
  return LLM.request({
