...
import { ProjectDirectoryTable, ProjectTable } from "@argus-ai/core/project/sql"
import { ProjectDirectories } from "@argus-ai/core/project/directories"
import { SessionTable } from "@argus-ai/core/session/sql"
import { WorkspaceTable } from "@argus-ai/core/control-plane/workspace.sql"
...
export class Service extends Context.Service<Service, Interface>()("@argus/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ARGUS_FAKE_VCS)
