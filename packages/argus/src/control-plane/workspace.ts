...
import { EventSequenceTable, EventTable } from "@argus-ai/core/event/sql"
...
import { WorkspaceEvent } from "@argus-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@argus/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ARGUS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ARGUS_WORKSPACE_ID: config.id,
        ARGUS_EXPERIMENTAL_WORKSPACES: "true",
