...
export class Service extends Context.Service<Service, Interface>()("@argus/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __ARGUS_PHOTON_WASM_PATH?: string }).__ARGUS_PHOTON_WASM_PATH =
