import type { Hooks, PluginInput } from "@argus-ai/plugin"
import { OAUTH_DUMMY_KEY } from "../auth"
import { InstallationVersion } from "@argus-ai/core/installation/version"
import { OauthCallbackPage } from "@argus-ai/core/oauth/page"
        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            const prepareRequest = () => {
              ...
              headers.set("User-Agent", `argus/${InstallationVersion}`)
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. Argus will capture the OAuth callback and store the bearer token automatically.",
