...
import { ConfigMCPV1 } from "@argus-ai/core/v1/config/mcp"
...
import { CrossSpawnSpawner } from "@argus-ai/core/cross-spawn-spawner"
import { McpCatalog } from "./catalog"
import { McpEvent } from "@argus-ai/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/argus-team/argus/issues/11948
    // sampling: {},
    // https://github.com/argus-team/argus/issues/23066
    // elicitation: {},
    // https://github.com/argus-team/argus/issues/2308
    roots: {},
    // https://github.com/argus-team/argus/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "argus", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@argus/MCP") {}
