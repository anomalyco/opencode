...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@argus/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@argus/ACPDirectory") {}
