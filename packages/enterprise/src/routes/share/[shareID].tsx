import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@leak-code/sdk/v2"
import { SessionTurn } from "@leak-code/session-ui/session-turn"
...
import { MessageNav } from "@leak-code/session-ui/message-nav"
import { FileSSR } from "@leak-code/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@leak-code/session-ui/pierre/worker").then((m) => ({
