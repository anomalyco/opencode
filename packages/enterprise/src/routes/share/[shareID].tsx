import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@octopus-ai/sdk/v2"
import { SessionTurn } from "@octopus-ai/ui/session-turn"
import { SessionReview } from "@octopus-ai/ui/session-review"
import { DataProvider } from "@octopus-ai/ui/context"
import { FileComponentProvider } from "@octopus-ai/ui/context/file"
import { WorkerPoolProvider } from "@octopus-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@octopus-ai/ui/logo"
import { IconButton } from "@octopus-ai/ui/icon-button"
import { ProviderIcon } from "@octopus-ai/ui/provider-icon"
import { iife } from "@octopus-ai/core/util/iife"
...
import { MessageNav } from "@octopus-ai/ui/message-nav"
import { FileSSR } from "@octopus-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@octopus-ai/ui/pierre/worker").then((m) => ({
