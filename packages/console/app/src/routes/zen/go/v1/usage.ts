...
import { and, Database, eq, isNull } from "@pencode-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@pencode-ai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "Pencode Go subscription required.",
        },
      }),
      {
        status: 403,
