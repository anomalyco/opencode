...
import compareVideo from "../../asset/lander/xcsh-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/xcsh-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="xcsh:auth" content={loggedin() ? "true" : "false"} />
