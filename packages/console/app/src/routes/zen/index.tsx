...
import compareVideo from "../../asset/lander/pencode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/pencode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="pencode:auth" content={loggedin() ? "true" : "false"} />
