...
import desktopAppIcon from "../../asset/lander/xcsh-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://f5xc-salesdemos.github.io/xcsh/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>f5xc-salesdemos.github.io/xcsh/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g xcsh-cli")}>
                <code>
                  npm i -g <strong>xcsh-cli</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g xcsh-cli")}>
                <code>
                  bun add -g <strong>xcsh-cli</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/xcsh")}>
                <code>
                  brew install <strong>anomalyco/tap/xcsh</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S xcsh")}>
                <code>
                  paru -S <strong>xcsh</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask xcsh-desktop")}>
                <code>
                  brew install --cask <strong>xcsh-desktop</strong>
                </code>
                <CopyStatus />
              </button>
