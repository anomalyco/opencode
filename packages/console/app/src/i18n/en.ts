export const dict = {
  ...
  "workspace.referral.page.subtitle": "Invite friends to Go and apply earned usage deductions.",
  ...
  "workspace.referral.banner.body": "Earn $5 Go usage deductions when friends subscribe.",
  ...
  "workspace.referral.instructions.apply": "Each side gets {{amount}} to apply to current Go usage.",
