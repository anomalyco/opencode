...
export const dict = {
  ...
  "go.testimonials.dax.title": "екс-CEO, Terminal Products",
  "go.testimonials.dax.quoteAfter": "змінило моє життя, це справді очевидний вибір.",
  "go.testimonials.jay.name": "Jay V",
  "go.testimonials.jay.title": "екс-засновник SEED, PM у Melt, Pop, Dapt, Cadmus та ViewPoint",
  ...
  "go.testimonials.adam.title": "екс-Hero, AWS",
  ...
  "go.testimonials.david.title": "екс-керівник відділу дизайну, Laravel",
  ...
  "go.testimonials.frank.title": "екс-інтерн Nvidia (4 рази)",
  ...
  "workspace.referral.copyLink": "Копіювати посилання",
  "workspace.referral.copied": "Скопійовано",
  "workspace.referral.overview.title": "Запросити друзів",
  "workspace.referral.overview.subtitle": "Заробляйте $5, коли ваш друг підписується. Вони також отримають $5.",
  "workspace.referral.instructions.share": "Поділіться своїм реферальним посиланням",
  "workspace.referral.instructions.subscribe": "Ваш друг приєднується та підписується на Go",
  "workspace.referral.instructions.claim": "Ви обидва отримаєте кредит на використання у розмірі $5 для покриття ваших лімітів використання Go",
  "workspace.referral.rewards.title": "Реферальні винагороди",
  "workspace.referral.rewards.description": "Застосовуйте доступні реферальні кредити для оплати використання Go.",
  "workspace.referral.rewards.subtitle": "Застосовано {{applied}} з {{total}} винагород.",
  "workspace.referral.rewards.empty": "Поки немає реферальних винагород.",
  "workspace.referral.table.reward": "Винагорода",
  "workspace.referral.table.referral": "Опис",
  "workspace.referral.table.date": "Дата",
  "workspace.referral.reward.description.inviter": "Запрошено {{email}}",
  "workspace.referral.reward.description.invitee": "Запрошено користувачем {{email}}",
  "workspace.referral.reward.action.subscribeUnlock": "Підпишіться, щоб розблокувати",
  "workspace.referral.reward.action.view": "Переглянути винагороду",
  "workspace.referral.reward.action.applied": "Винагороду застосовано",
  "workspace.referral.reward.source.pendingInviter": "Очікування їхньої підписки",
  "workspace.referral.reward.source.pendingInvitee": "Підпишіться, щоб розблокувати винагороду",
  "workspace.referral.reward.source.available": "Винагорода готова до застосування",
  "workspace.referral.reward.source.applied": "Винагороду застосовано",
  "workspace.referral.reward.status.applied": "Винагороду застосовано",
  "workspace.referral.reward.status.pendingInviter": "Підпишіться, щоб розблокувати",
  "workspace.referral.reward.status.pendingInvitee": "Підпишіться, щоб розблокувати",
  "workspace.referral.apply.noGo": "Підпишіться, щоб розблокувати",
  "workspace.referral.apply.preview": "Переглянути винагороду",
  "workspace.referral.apply.action": "Застосувати",
  "workspace.referral.apply.confirmTitle": "Застосувати винагороду",
  "workspace.referral.apply.confirmBody": "Застосувати {{amount}}, щоб зменшити поточне використання цього робочого простору.",
  "workspace.referral.apply.confirmAction": "Застосувати",
