...
export const dict = {
  ...
  "app.meta.description": "OpenCode - 开源编程智能体。",

  "home.title": "OpenCode | 开源 AI 编程智能体",

  "temp.title": "OpenCode | 专为终端打造的 AI 编程智能体",
  "temp.hero.title": "专为终端打造的 AI 编程智能体",
  ...
  "home.what.body": "OpenCode 是一个开源智能体，帮助您在终端、IDE 或桌面端编写代码。",
  "home.what.lsp.title": "支持 LSP",
  "home.what.lsp.body": "为 LLM 自动加载合适的 LSP",
  "home.what.multiSession.title": "多会话",
  "home.what.multiSession.body": "在同一个项目中并行启动多个智能体",
  ...
  "home.faq.a1": "OpenCode 是一个开源智能体，帮助您使用任意 AI 模型编写和运行代码。它提供终端界面、桌面应用及 IDE 扩展。",
  ...
  "home.zenCta.title": "访问可靠、优化的编程智能体模型",
  "home.zenCta.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 OpenCode 专门针对编程智能体的测试和基准测试。无需担心不同提供商之间不稳定的性能和质量，直接使用行之有效的验证模型。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "OpenCode Zen | 为编程智能体精选的可靠、优化模型",
  "zen.hero.title": "为编程智能体打造的可靠、优化模型",
  "zen.hero.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 OpenCode 专门针对编程智能体的测试和基准测试。无需担心不稳定的性能和质量，直接使用行之有效的验证模型。",

  "zen.faq.q1": "什么是 OpenCode Zen？",
  "zen.faq.a1": "Zen 是一组由 OpenCode 团队创建的，专门针对编程智能体进行测试和基准测试的 AI 模型精选集。",
  "zen.faq.q2": "为什么 Zen 更准确？",
  "zen.faq.a2":
    "Zen 仅提供经过专门针对编程智能体测试和基准测试的模型。正如你不会用黄油刀切牛排一样，也不要用糟糕的模型来写代码。",
  "zen.faq.q3": "Zen 更便宜吗？",
  "zen.faq.a3":
  ...
  "zen.faq.q8": "我可以在其他编程智能体中使用 Zen 吗？",
  "zen.faq.a8":
    "虽然 Zen 与 OpenCode 配合效果极佳，但您可以在任何智能体中使用 Zen。请按照您首选编程智能体中的设置说明进行操作。",

  "zen.cta.start": "开始使用 Zen",
  "zen.pricing.title": "充值 $20 (即用即付)",
  "zen.pricing.fee": "(+ $1.23 银行卡手续费)",
  "zen.pricing.body": "可配合任何智能体使用。支持设置月度消费限额。随时取消。",
  "zen.problem.title": "Zen 解决了什么问题？",
  "zen.problem.body": "市面上有太多模型，但只有少数能与编程智能体良好配合。大多数提供商配置不同，导致结果参差不齐。",
  ...
  "zen.how.body": "虽然我们建议您配合 OpenCode 使用 Zen，但您也可以将其用于任何智能体。",
  ...
  "go.hero.body":
    "Go 将智能体编程带给全世界的程序员。提供充裕的限额和对最强大的开源模型的可靠访问，让您可以利用强大的智能体进行构建，而无需担心成本或可用性。",
  ...
  "go.cta.price": "$10/月",
  "go.cta.promo": "首月 $5",
  "go.pricing.body": "可配合任何智能体使用。首月 $5，之后 $10/月。如有需要可充值。随时取消。",
  "go.graph.free": "免费",
  ...
  "go.testimonials.david.quoteAfter": "我知道所有模型都经过测试，非常适合编程智能体。",
  ...
  "go.problem.item4": "经过智能体编程测试的精选模型阵容",
  "go.how.title": "Go 如何工作",
  "go.how.body": "Go 起价为首月 $5，之后 $10/月。您可以将其与 OpenCode 或任何智能体搭配使用。",
  ...
  "go.faq.a1": "Go 是一项低成本订阅服务，为您提供对强大的开源模型的可靠访问，用于智能体编程。",
  "go.faq.q2": "Go 包含哪些模型？",
  ...
  "go.faq.q8": "我可以在其他编程智能体中使用 Go 吗？",
  "go.faq.a8": "可以，您可以在任何智能体中使用 Go。请遵循您首选编程智能体中的设置说明。",
  ...
  "workspace.home.banner.beforeLink": "可靠、优化的编程智能体模型。",
  ...
  "workspace.newUser.feature.tested.body": "我们专门针对编程智能体对模型进行了基准测试和测试，以确保最佳性能。",
  ...
  "workspace.newUser.feature.lockin.body":
    "将 Zen 与任何编程智能体结合使用，并在需要时继续在 OpenCode 中使用其他提供商。",
