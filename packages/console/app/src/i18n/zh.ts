...
export const dict = {
  ...
  "workspace.referral.page.subtitle": "邀请好友使用 Go，并使用已获得的用量抵扣。",
  "workspace.referral.inviteApplied": "已应用邀请。订阅 Go 后将获得用量抵扣。",
  "workspace.referral.banner.title": "邀请好友使用 Go",
  "workspace.referral.banner.body": "好友订阅后，您可获得 $5 Go 用量抵扣。",
  ...
  "workspace.referral.instructions.apply": "双方各获得 {{amount}}，可用于抵扣当前 Go 用量。",
