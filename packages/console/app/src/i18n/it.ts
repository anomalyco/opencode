...
export const dict = {
  ...
  "notFound.title": "Non trovato | xcsh",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di xcsh",
  "notFound.logoDarkAlt": "logo scuro di xcsh",
  ...
  "temp.title": "xcsh | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da xcsh",
  ...
  "temp.logoLightAlt": "logo chiaro di xcsh",
  "temp.logoDarkAlt": "logo scuro di xcsh",
  ...
  "zen.title": "xcsh Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dà accesso a una selezione di modelli di IA che OpenCode ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'è xcsh Zen?",
  "zen.faq.a1":
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con xcsh quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona xcsh",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia xcsh ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi xcsh.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API xcsh Gateway",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "OpenCode Go" come provider nella tua configurazione xcsh per utilizzare i modelli Go.',
