...
export const DESKTOP_MENU: DesktopMenu[] = [
  {
    ...
    items: [
      ...
      { type: "item", labelKey: "desktop.menu.checkForUpdates", action: "app.checkForUpdates", enabled: "updater" },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "item", labelKey: "desktop.menu.openProject", command: "project.open", accelerator: { macos: "Cmd+O" } },
      {
        type: "item",
  ...
  },
  {
    ...
    items: [
      ...
      { type: "item", labelKey: "desktop.menu.toggleDevTools", action: "view.toggleDevTools", role: "toggleDevTools" },
      { type: "separator" },
      {
        type: "item",
