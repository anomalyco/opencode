...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://jaminsmoke.github.io/Jarvis/install" },
      { type: "item", labelKey: "desktop.menu.wiki", href: "https://github.com/jaminsmoke/Jarvis/wiki" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://github.com/jaminsmoke/Jarvis/discussions" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/jaminsmoke/Jarvis/issues/new",
      },
      {
        type: "item",
