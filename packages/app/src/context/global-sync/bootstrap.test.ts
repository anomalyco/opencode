...
import type { Config, OpencodeClient, Project } from "@leak-code/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@leak-code/client/promise"
import type { NormalizedProviderListResponse } from "@leak-code/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
