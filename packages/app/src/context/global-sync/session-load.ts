import type { SessionApi } from "@pencode-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { PencodeClient } from "@pencode-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: PencodeClient; directory: string; limit: number }) {
  try {
