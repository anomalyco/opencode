...
import { dict as sq } from "@/i18n/sq"
...
import { dict as uiSq } from "@opencode-ai/ui/i18n/sq"
...
const localeMatchers: Array<{ locale: Locale; match: (language: string) => boolean }> = [
  ...
  { locale: "sq", match: (language) => language.startsWith("sq") },
]
