...
import { resolveAgent, shouldShowAgentSelector } from "./local-agent"
...
export const { use: useLocal, provider: LocalProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    const agentsVisible = createMemo(() => shouldShowAgentSelector(list(), settings.visibility.customAgents()))
