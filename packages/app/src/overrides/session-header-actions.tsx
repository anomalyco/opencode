...
export function SessionHeaderActions() {
  ...
  return (
    <div class="flex items-center gap-2">
        ...
        <Tooltip value="Preview" placement="bottom">
          <Button
        ...
        <SettingsPopup />
        <Tooltip value="Open / create project" placement="bottom">
          <Button
            variant="secondary"
            class="rounded-sm h-[24px] w-[24px] p-0"
            onClick={() =>
