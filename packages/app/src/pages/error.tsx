  ...
  return (
    ...
    >
      <div class="w-2/3 max-w-3xl flex flex-col items-center justify-center gap-8">
        <div
          aria-hidden="true"
          class="text-center font-extrabold tracking-tighter leading-none text-text-weak opacity-15 select-none text-7xl"
        >
          argus
        </div>
        ...
        <div class="flex flex-col items-center gap-2">
          <div class="flex items-center justify-center gap-1">
            ...
            <button
              ...
              onClick={() => platform.openExternal("https://argus.ai/desktop-feedback")}
            >
