...
/**
 * The `/new-session` draft page. Unlike `session.tsx`, this renders the prompt composer
 * for a brand-new session plus the workspace terminal, but no review pane, file tree, or
 * message timeline. Submitting promotes the draft into a real session (see prompt-input/submit).
 */
export default function NewSessionPage() {
  ...
  command.register("new-session", () => [
    ...
    },
    {
      ...
      keybind: "ctrl+`",
      slash: "terminal",
      onSelect: () => route.view().terminal.toggle(),
    },
    {
      id: "terminal.new",
