import type { FilePart, Project, UserMessage, VcsFileDiff } from "@leak-code/sdk/v2"
import { getFilename } from "@leak-code/core/util/path"
...
import type { SessionReviewLineComment } from "@leak-code/session-ui/session-review"
import { ResizeHandle } from "@leak-code/ui/resize-handle"
import { Select } from "@leak-code/ui/select"
import { SelectV2 } from "@leak-code/ui/v2/select-v2"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@leak-code/ui/scroll-view"
import { Tabs } from "@leak-code/ui/tabs"
import { ButtonV2 } from "@leak-code/ui/v2/button-v2"
import { createAutoScroll } from "@leak-code/ui/hooks"
import { previewSelectedLines } from "@leak-code/session-ui/pierre/selection-bridge"
import { Button } from "@leak-code/ui/button"
import { showToast } from "@/utils/toast"
import { base64Encode, checksum } from "@leak-code/core/util/encode"
...
import { SessionReviewEmptyChangesV2 } from "@leak-code/session-ui/v2/session-review-empty-changes-v2"
import { SessionReviewEmptyNoGitV2 } from "@leak-code/session-ui/v2/session-review-empty-no-git-v2"
import { SessionReviewV2SidebarToggle } from "@leak-code/session-ui/v2/session-review-v2"
