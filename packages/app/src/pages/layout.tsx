...
import { base64Encode } from "@pencode-ai/core/util/encode"
...
import { Tooltip } from "@pencode-ai/ui/tooltip"
...
import { Session } from "@pencode-ai/sdk/v2/client"
...
import { Binary } from "@pencode-ai/core/util/binary"
import { retry } from "@pencode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@pencode-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://pencode.ai/desktop-feedback")}
      renderPanel={() =>
