...
import { Session } from "@argus-ai/sdk/v2/client"
...
import { retry } from "@argus-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@argus-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://argus.ai/desktop-feedback")}
      renderPanel={() =>
