...
import { ResizeHandle } from "@athena/ui/resize-handle"
import { Button } from "@athena/ui/button"
import { IconButton } from "@athena/ui/icon-button"
import { Tooltip } from "@athena/ui/tooltip"
import { DropdownMenu } from "@athena/ui/dropdown-menu"
import { Dialog } from "@athena/ui/dialog"
import { getFilename } from "@athena/util/path"
import { Session, type Message } from "@athena/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@athena/ui/toast"
...
import { Binary } from "@athena/util/binary"
import { retry } from "@athena/util/retry"
...
import { useTheme, type ColorScheme } from "@athena/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://athena.ai/desktop-feedback")}
      renderPanel={() =>
