          ...
          <Show
            ...
            fallback={
              <>
                ...
                <div class="w-full min-h-32 md:min-h-40 rounded-md border border-border-weak-base bg-background-base/50 px-0 py-3 text-text-weak whitespace-pre-wrap pointer-events-none">
