    ...
    >
      <div
        classList={{
          ...
          "md:mx-auto": controller.centered() && settings.appearance.contentMaxWidth() > 0,
        }}
        style={
          controller.centered() && settings.appearance.contentMaxWidth() > 0
            ? { "max-width": `${settings.appearance.contentMaxWidth()}px` }
            : controller.centered()
              ? { "max-width": "1000px" }
              : undefined
        }
