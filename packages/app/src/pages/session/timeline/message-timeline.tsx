...
import { Accordion } from "@leak-code/ui/accordion"
import { Button } from "@leak-code/ui/button"
import { Card } from "@leak-code/ui/card"
import {
  ContextToolGroup,
  Message,
  MessageDivider,
  ...
  partDefaultOpen,
  type UserActions,
} from "@leak-code/session-ui/message-part"
import { DiffChanges } from "@leak-code/ui/diff-changes"
import { FileIcon } from "@leak-code/ui/file-icon"
import { Icon } from "@leak-code/ui/icon"
import { IconButton } from "@leak-code/ui/icon-button"
import { Icon as IconV2 } from "@leak-code/ui/v2/icon"
import { IconButtonV2 } from "@leak-code/ui/v2/icon-button-v2"
import { DropdownMenu } from "@leak-code/ui/dropdown-menu"
import { MenuV2 } from "@leak-code/ui/v2/menu-v2"
import { Dialog } from "@leak-code/ui/dialog"
import { DialogFooter, DialogHeader, DialogTitleGroup, DialogV2 } from "@leak-code/ui/v2/dialog-v2"
import { InlineInput } from "@leak-code/ui/inline-input"
import { ButtonV2 } from "@leak-code/ui/v2/button-v2"
import { SessionRetry } from "@leak-code/session-ui/session-retry"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner, ScrollView } from "@leak-code/ui/scroll-view"
import { StickyAccordionHeader } from "@leak-code/ui/sticky-accordion-header"
import { TextField } from "@leak-code/ui/text-field"
import { TextReveal } from "@leak-code/ui/text-reveal"
import { TextShimmer } from "@leak-code/ui/text-shimmer"
import type {
  AssistantMessage,
  ...
  ToolPart,
  UserMessage,
} from "@leak-code/sdk/v2"
import { showToast } from "@/utils/toast"
import { getDirectory, getFilename } from "@leak-code/core/util/path"
import { Popover as KobaltePopover } from "@kobalte/core/popover"
import { normalize } from "@leak-code/session-ui/session-diff"
import { useFileComponent } from "@leak-code/ui/context/file"
