...
// FORK: 9 个纯函数 helper 拆到 file-tabs-helpers.ts 单独 unit 测试 2026-05-07
// 原因:本文件 import 链含 SolidJS / kobalte 在 happydom 下抛 SSR 错。
// 拆出后 file-tabs.tsx 行为不变,仅 import 路径变。
import {
  isMarkdownPath,
  isHtmlPath,
  pathDirname,
