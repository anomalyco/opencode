import type { Message, Session, TextPart, UserMessage } from "@athena/sdk/v2/client"
import { Avatar } from "@athena/ui/avatar"
import { HoverCard } from "@athena/ui/hover-card"
import { Icon } from "@athena/ui/icon"
import { IconButton } from "@athena/ui/icon-button"
import { MessageNav } from "@athena/ui/message-nav"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === OPENCODE_PROJECT_ID ? "https://athena.ai/favicon.svg" : props.project.icon?.override
          }
