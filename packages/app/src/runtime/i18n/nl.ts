export const dict = {
  ...
  "common.color.gray": "grijs",
  "toast.migration.progress.migratingSessions.current": "Sessies migreren: {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Sessies migreren: {{current}}/{{total}}",
  "toast.migration.progress.working": "Gegevens migreren",
  "toast.migration.progress.working.current": "Gegevens migreren: {{current}}",
  "toast.migration.progress.working.progress": "Gegevens migreren: {{current}}/{{total}}",
  "session.browser.unsupported": "Deze desktopapp ondersteunt het browserpaneel niet.",
  "ssh.label": "SSH",
  "ssh.offline":
    "Niet verbonden met {{host}}. Uw concept blijft behouden; Het is mogelijk dat er nog steeds op afstand wordt gewerkt.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "SSH-server toevoegen",
  "ssh.server.menu.label": "SSH-server",
  "ssh.target": "Host- of SSH-opdracht",
  "ssh.connect": "Verbinden",
  "ssh.connectTo": "Maak verbinding met {{host}}",
  "ssh.authenticate": "SSH-authenticatie",
  "ssh.action.authenticate": "Authenticeren",
  "ssh.session.disconnected": "SSH-verbinding inactief",
  "ssh.session.connecting": "Verbinding maken met de SSH-server",
  "ssh.session.reconnectDescription":
    "Maak opnieuw verbinding om deze sessie te bekijken en verder te werken. Uw externe sessie blijft behouden.",
  "ssh.session.reconnect": "Maak opnieuw verbinding",
  "ssh.authenticationRequired": "Authenticatie vereist voor {{host}}",
  "ssh.trust": "Vertrouw en verbind",
  "ssh.continue": "Ga door",
  "ssh.retry": "Opnieuw proberen",
  "ssh.update": "Update en maak opnieuw verbinding",
  "ssh.openProject": "Project openen",
  "ssh.project": "Project openen op {{host}}",
  "ssh.disconnect": "Verbreek de verbinding",
  "ssh.forget": "Vergeet verbinding",
  "ssh.stage.disconnected": "Verbinding verbroken. De externe server blijft actief.",
  "ssh.stage.connecting": "Verbinding maken via SSH…",
  "ssh.stage.checking": "OpenCode controleren…",
  "ssh.stage.downloading": "Server downloaden…",
  "ssh.stage.uploading": "Server uploaden…",
  "ssh.stage.starting": "Verbinding maken met OpenCode…",
  "ssh.stage.ready": "Verbonden",
  "ssh.stage.authentication": "Authenticatie vereist",
  "ssh.stage.incompatible": "Serverupdate vereist",
  "ssh.stage.failed": "Verbinding mislukt",
  "ssh.error.input":
    "Voer een host- of SSH-verbindingsopdracht in. Externe opdrachten en niet-ondersteunde SSH-opties zijn niet toegestaan.",
  "ssh.error.connection": "Kan de SSH-verbinding niet tot stand brengen. Controleer uw netwerk- en SSH-configuratie.",
  "ssh.error.platform":
    "Dit externe platform wordt niet ondersteund. Voor automatische configuratie is momenteel Linux of macOS op x64 of arm64 vereist.",
  "ssh.error.version": "De externe service moet overeenkomen met deze desktopversie voordat verbinding wordt gemaakt.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH verbonden, maar de OpenCode-server is niet gereed geworden.",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing":
    "OpenSSH is niet gevonden. Installeer een OpenSSH-client en zorg ervoor dat ssh beschikbaar is op PATH.",
  "command.browser.open": "Browser openen",
  "command.browser.reload": "Browserpagina opnieuw laden",
  "command.session.summary.toggle": "Samenvatting schakelen",
  "mcp.auth.interactiveForm": "MCP-server {{name}} vereist een interactief authenticatieformulier",
  "server.connect.title": "Maak verbinding met een server",
  "server.connect.description": "Voer uw serveradres en wachtwoord in om aan de slag te gaan.",
  ...
  "server.connect.camera.error":
    "Kon de camera niet openen. Sta cameratoegang toe of voer uw verbindingsgegevens handmatig in.",
  "dialog.server.menu.remove": "Verwijderen",
  "file.error.notFound": "Bestand niet gevonden: {{name}}",
  "home.workspaceTip": "Start de volgende sessie in een nieuwe werkruimte om wijzigingen geïsoleerd te houden",
  "session.tab.browser": "Browser",
  "session.tab.add": "Tabblad toevoegen",
  "session.queue.attachments.one": "Plus {{count}}-hulpstuk",
  "session.queue.attachments.other": "Plus {{count}}-hulpstukken",
  "session.browser.address": "Browseradres",
  "session.browser.replaced": "Browserbediening verplaatst naar een ander bureaubladvenster.",
  "session.browser.suspended": "Browser opgeschort. Interactie met deze sessie om opnieuw verbinding te maken.",
  "session.browser.address.placeholder": "Voer URL in",
  "settings.backToSettings": "Terug naar instellingen",
  "settings.backToProjects": "Terug naar projecten",
  "settings.search.placeholder": "Zoeken",
  "settings.search.results": "Resultaten van instellingen",
  "settings.search.group.pages": "Pagina's",
  "settings.search.group.settings": "Instellingen",
  "settings.search.group.projects": "Projecten",
  ...
  "settings.search.empty": "Geen resultaten voor {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Verfijn uw zoekopdracht om specifiekere resultaten te zien.",
  "settings.server.description": "Beheer de verbinding en voorkeuren van deze server",
  "settings.server.section.connection": "Verbinding",
  "settings.server.preferences.websearch.title": "Zoeken door derden",
  "settings.server.preferences.websearch.description":
    "Selecteer de zoekmachine die agenten gebruiken om op internet te zoeken",
  "settings.projects.search.placeholder": "Zoek projecten",
  "project.settings.name.title": "Projectnaam",
  "project.settings.name.description": "De naam die overal in OpenCode voor dit project wordt weergegeven",
  "project.settings.icon.description": "Aanbevolen: 128×128px. Klik of sleep om een ​​afbeelding te uploaden.",
  "project.settings.color.description":
    "Wordt gebruikt voor het projectpictogram als er geen aangepaste afbeelding is ingesteld",
  "project.settings.worktree.startup.description": "Wordt één keer uitgevoerd na het maken van een nieuwe werkruimte",
  "project.settings.worktree.startup.hint.base": "Gebruik $OPENCODE_WORKTREE_BASE voor de basiswerkruimte.",
  "project.settings.worktree.startup.hint.new": "Gebruik $OPENCODE_WORKTREE_PATH voor de nieuwe werkruimte.",
  "project.settings.extensions.empty.mcps.title": "Nog geen MCPs",
  "project.settings.extensions.empty.mcps.description": "MCPs beschikbaar voor OpenCode wordt hier weergegeven",
  "project.settings.extensions.empty.plugins.title": "Nog geen plug-ins",
  "project.settings.extensions.empty.plugins.description":
    "Plug-ins die beschikbaar zijn voor OpenCode verschijnen hier",
  "project.settings.extensions.empty.skills.title": "Nog geen vaardigheden",
  "project.settings.extensions.empty.skills.description":
    "Vaardigheden die beschikbaar zijn voor OpenCode worden hier weergegeven",
  "project.settings.extensions.lsp.configured": "Geconfigureerde taalservers",
  "project.settings.extensions.lsp.status.enabled": "Ingeschakeld in configuratie",
  "project.settings.extensions.lsp.status.disabled": "Uitgeschakeld in configuratie",
  "project.settings.extensions.lsp.empty.title": "Geen taalservers geconfigureerd",
  "project.settings.extensions.lsp.empty.description":
    "Taalservers die voor dit project zijn geconfigureerd, worden hier weergegeven",
  "project.settings.extensions.lsp.disabled.title": "Taalservers uitgeschakeld",
  "project.settings.extensions.lsp.disabled.description": "LSP is uitgeschakeld in de configuratie van dit project",
  "project.settings.extensions.lsp.loadFailed": "Kan de taalserverconfiguratie niet laden",
  "project.settings.extensions.lsp.retry": "Opnieuw proberen",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Groep",
  "settings.timeline.collapse": "Samenvouwen",
  "settings.timeline.visibility.show": "Toon",
  "settings.timeline.visibility.hide": "Verbergen",
  "settings.timeline.visibility.label": "{{activity}}-zichtbaarheid",
  "settings.timeline.grouped.label": "{{activity}} gegroepeerd",
  "settings.timeline.collapsed.label": "{{activity}} stortte in",
  "settings.general.row.browserPane.title": "Browser",
  "settings.general.row.browserPane.description": "Laat agenten een in-app-ontwikkelingsbrowser openen en beheren.",
  "session.new.workspace.search.empty": "Geen bijpassende werkruimten",
  "settings.workspaces.description": "Bekijk werkruimten en beheer het schijfgebruik",
  "settings.workspaces.empty.description": "Werkbomen die in OpenCode zijn gemaakt, verschijnen hier",
  "settings.workspaces.sessions.filtered.one": "{{count}}-sessie",
  "settings.workspaces.sessions.filtered.other": "{{count}}-sessies",
  "settings.workspaces.deleteAll.confirm.one":
    "Hierdoor wordt de door {{count}} geselecteerde werkruimte permanent verwijderd.",
  "settings.workspaces.deleteAll.confirm.other":
    "Hierdoor worden de door {{count}} geselecteerde werkruimten permanent verwijderd.",
  "settings.workspaces.deleteWithoutSessions": "Verwijder werkruimten zonder sessies",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Hierdoor wordt de {{count}}-werkruimte zonder gekoppelde sessies permanent verwijderd.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Hierdoor worden de {{count}}-werkruimten zonder gekoppelde sessies permanent verwijderd.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Werkbomen met niet-samengevoegde wijzigingen of actieve locaties blijven behouden.",
  "settings.workspaces.delete.button": "Werkbomen verwijderen",
  "workspace.lifecycle.deleting": "Verwijderen…",
  "session.summary.tooltip": "Samenvatting",
  "session.summary.server": "Extensies",
  "session.summary.chooseProject": "Kies een project",
  "session.summary.mcp.onCreation": "Is van toepassing wanneer de werkruimte wordt gemaakt",
  "session.summary.mcp.prepareFailed": "Kan MCP-servers niet voorbereiden",
  "session.summary.mcp.unavailable": "MCP-server {{name}} is niet beschikbaar in deze werkruimte.",
  "session.summary.mcp.signInBeforeSend": "Meld u aan bij {{name}} voordat u de prompt verzendt.",
  "session.summary.mcp.notReady":
    "MCP-server {{name}} is niet gereed. Los de verbinding op voordat u de prompt verzendt.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "MCP-servers geconfigureerd",
  "session.summary.plugins": "Plug-ins",
  "session.summary.plugins.configured": "Geconfigureerde plug-ins",
  "session.summary.skills": "Vaardigheden",
  "session.summary.skills.configured": "Geconfigureerde vaardigheden",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Mislukt",
  "session.summary.retry": "Opnieuw proberen",
  "session.summary.connecting": "Verbinden…",
  "session.summary.needsAuth": "Inloggen vereist",
  "session.summary.configure": "Configuratiebestand",
  "session.summary.copyConfigPath": "Kopieer het configuratiebestandspad",
  "session.summary.configFileMissing": "Geen configuratiebestand gevonden",
  "session.summary.mcp.empty": "Geen MCP-servers geconfigureerd",
  "session.summary.mcp.add": "Voeg servers toe in opencode.json",
  "session.summary.plugins.manage": "Beheer plug-ins in opencode.json",
  "session.summary.plugins.empty": "Geen plug-ins geconfigureerd",
  "session.summary.plugins.add": "Voeg plug-ins toe in opencode.json",
  "session.summary.skills.manage": "Beheer vaardigheden in opencode.json",
  "session.summary.skills.empty": "Geen vaardigheden geconfigureerd",
  "session.summary.skills.add": "Vaardigheden toevoegen in opencode.json",
  "session.summary.lsp.configured": "LSPs geconfigureerd",
  "session.summary.lsp.empty": "Geen LSP-servers geconfigureerd",
  "session.summary.lsp.manage": "Beheer LSP in opencode.json",
  "workspace.delete.location": "Locatie",
  "settings.workspaces.deleteAll.warning":
    "Werkruimten met niet-samengevoegde wijzigingen, gekoppelde sessies of actieve locaties blijven behouden.",
  "provider.connect.error.unsupportedFields": "Dit authenticatieformulier bevat niet-ondersteunde velden",
  "session.review.filesChangedCount.one": "{{count}} bestand gewijzigd",
  "session.review.filesChangedCount.other": "{{count}} bestanden gewijzigd",
  "settings.about.writtenByNames": "Geschreven door {{names}}",
  "settings.about.illustratedByNames": "Geïllustreerd door {{names}}",
  "home.projects.all": "Alle projecten",
  "session.tab.files": "Bestanden",
  "session.files.openTabs": "Geopende bestanden",
  "session.tab.usage": "Gebruik",
  "session.view.select": "Sessieweergave",
  "session.background.moveTasks": "{{tasks}} naar de achtergrond verplaatsen",
  ...
  "session.background.tasksRunning.one": "{{count}} achtergrondtaak wordt uitgevoerd",
  "session.background.tasksRunning.other": "{{count}} achtergrondtaken worden uitgevoerd",
  ...
  "session.websearch.any": "Elke",
  "session.websearch.disable": "Zoeken niet gebruiken",
  "session.websearch.enable": "Inschakelen",
  "session.websearch.loadFailed": "Zoekproviders konden niet worden geladen.",
  "session.websearch.empty": "Geen zoekproviders beschikbaar.",
  "session.websearch.failed": "Je keuze kon niet worden opgeslagen. Probeer het opnieuw.",
  "session.websearch.retry": "Opnieuw proberen",
  "session.new.worktree.draftPlaceholder": "Stel een vervolgbericht op terwijl de worktree wordt voorbereid…",
  "session.search.placeholder": "Zoeken...",
  "session.search.noResults": "Geen overeenkomsten",
  "titlebar.tabs": "Tabbladen",
  "titlebar.channel.local": "Lokaal",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Bèta",
  "titlebar.toggleDebugTools": "Debughulpmiddelen in-/uitschakelen",
  "settings.tab.experimental": "Experimenteel",
  "settings.experimental.description": "Probeer experimentele functies",
  "settings.tab.about": "Over",
  "settings.about.version": "Versie {{version}}",
  "settings.about.devVersion": "ontwikkeling",
  "settings.about.license": "Uitgebracht onder de MIT-licentie",
  "settings.about.writtenBy": "Geschreven door",
  "settings.about.illustratedBy": "Geïllustreerd door",
  "settings.about.and": "en",
  "settings.about.otherContributor.one": "{{count}} andere",
  "settings.about.otherContributor.other": "{{count}} andere",
  "settings.about.firstPublished": "Voor het eerst gepubliceerd in Missouri, VS",
  "settings.about.firstIllustrated": "Voor het eerst geïllustreerd in Londen, Engeland",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, de open-source programmeeragent",
  "settings.about.trademark": "OpenCode is een geregistreerd handelsmerk van Anomaly Innovations, Inc.",
  "settings.about.typeset": "Opgemaakt in Inter en IBM Plex Mono",
  "settings.about.tagline": "AI kan geen geweldige software bouwen zonder jou",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "settings.appearance.row.projectName.title": "Projectnamen tonen",
  "settings.appearance.row.projectName.description":
    "Projectnamen tonen in verticale tabbladen en de mobiele tabbladenlade",
  "project.settings.title": "Project bewerken",
  "settings.timeline.title": "Tijdlijn",
  "settings.timeline.detail": "Tijdlijndetails",
  "settings.timeline.description": "Kies hoeveel activiteit op de tijdlijn verschijnt. Berichten blijven zichtbaar.",
  "settings.timeline.preset.everything": "Alles",
  "settings.timeline.preset.detailed": "Gedetailleerd",
  "settings.timeline.preset.compact": "Compact",
  "settings.timeline.preset.quiet": "Rustig",
  "settings.timeline.preset.text-only": "Alleen tekst",
  ...
  "settings.timeline.description.custom":
    "De geselecteerde plaatsing en details gebruiken voor elke activiteitscategorie.",
  "settings.timeline.custom": "Aangepast",
  "settings.timeline.advanced": "Geavanceerd",
  "settings.timeline.advanced.description": "Plaatsing en details instellen voor elke activiteitscategorie.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Bewerkingen",
  "settings.timeline.category.thinking": "Denkwerk",
  ...
  "desktop.onboarding.defaultProject": "Standaardproject",
  "session.location.unavailable": "Sessielocatie niet beschikbaar",
  "session.location.description": "Kies een andere map om deze sessie voort te zetten.",
  "session.location.choose": "Map kiezen",
  "session.location.worktree": "Worktree kiezen",
  "session.location.worktreesFailed": "Kan worktrees niet laden",
  "session.location.moving": "Sessie wordt verplaatst…",
  "dialog.server.menu.hide": "Verbergen in projectlijst",
  "dialog.server.menu.show": "Weergeven in projectlijst",
  "session.queue.count.one": "{{count}} in wachtrij",
  "session.queue.count.other": "{{count}} in wachtrij",
  "session.queue.steer": "Bijsturen",
  "session.queue.send": "Verzenden",
  "session.queue.steerTooltip": "Verzenden zonder te onderbreken",
  "session.queue.remove": "Verwijderen",
  "session.queue.reorder": "Prompt in wachtrij opnieuw ordenen",
  "session.new.worktree.creating": "Worktree wordt gemaakt",
  "settings.backToApp": "Terug naar app",
  "settings.appearance.section.experimental": "Experimenteel",
  "settings.appearance.row.tabs.title": "Tabbladen",
  "settings.appearance.row.tabs.description": "Kies hoe sessietabbladen worden gerangschikt",
  "settings.appearance.row.tabs.horizontal": "Horizontaal",
  "settings.appearance.row.tabs.vertical": "Verticaal",
  "settings.general.row.followUpBehavior.title": "Gedrag van vervolgberichten",
  "settings.general.row.followUpBehavior.description":
    "Kies of vervolgberichten in de wachtrij komen of de huidige beurt bijsturen. Gebruik {{keybind}} om te wisselen.",
  "settings.general.row.followUpBehavior.queue": "In wachtrij plaatsen",
  "settings.general.row.followUpBehavior.steer": "Bijsturen",
  "settings.general.row.reasoningMode.title": "Redenering van het model",
  "settings.general.row.reasoningMode.description":
    "Kies hoe de redenering van het model in de tijdlijn wordt weergegeven",
  "settings.general.row.reasoningMode.hidden": "Verborgen",
  "settings.general.row.reasoningMode.compact": "Compact",
  "settings.general.row.reasoningMode.full": "Volledig",
  "session.new.workspace.createFrom": "Maken vanuit branch",
  "session.new.workspace.branch.search.placeholder": "Branches zoeken",
  ...
  "command.debugBar.toggle": "Debugbalk in-/uitschakelen",
  "command.session.location.cycle": "Sessielocatie wisselen",
  "dialog.provider.anthropic.note": "Directe toegang tot Claude-modellen via een API-sleutel",
  "provider.connect.title.anthropicProMax": "Inloggen met Anthropic",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Upload annuleren",
  "prompt.toast.uploading.cancelFile": "Upload van {{filename}} annuleren",
  "prompt.toast.uploadFailed.title": "Upload mislukt",
  "session.browser.empty.title": "Voer URL in",
  "session.browser.empty.description": "Of vraag ‘Openen in de appbrowser’",
  "session.browser.failed.title": "URL is niet bereikbaar",
  "session.browser.failed.description": "Controleer de URL en je verbinding en probeer het opnieuw.",
  "debugBar.providerAriaLabel": "Prestatiediagnose van provider",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Tijd vanaf het verzenden van de provideraanvraag tot de eerste modeluitvoer.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Tijd vanaf het verzenden van de provideraanvraag tot de eerste antwoordtekst.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Uitvoertokens per seconde na de eerste modeluitvoer.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Tijd vanaf het verzenden van de provideraanvraag tot het einde van de antwoordstream.",
  "settings.updates.action.download": "OpenCode downloaden",
  "settings.updates.migration.title": "Van Beta naar Stabiel overstappen",
