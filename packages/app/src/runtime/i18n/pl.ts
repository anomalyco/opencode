export const dict = {
  ...
  "session.queue.attachments": "+ załączniki",
  ...
  "settings.timeline.advanced.explainer":
    "Zgrupowana aktywność przechodzi do Użyte. Szczegóły obowiązują po otwarciu grupy.",
  "settings.timeline.activity": "Aktywność",
  ...
  "settings.timeline.placement.title": "Umiejscowienie",
  "settings.timeline.placement.separate": "Oddzielne",
  "settings.timeline.placement.grouped": "Zgrupowane",
  "settings.timeline.placement.hidden": "Ukryty",
  "settings.timeline.expansion.title": "Szczegóły",
  "settings.timeline.expansion.collapsed": "upadł",
  "settings.timeline.expansion.expanded": "Rozszerzony",
