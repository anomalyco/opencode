export const dict = {
  ...
  "session.queue.attachments": "+ συνημμένα",
  ...
  "settings.timeline.advanced.explainer":
    "Η ομαδοποιημένη δραστηριότητα πηγαίνει στο Χρησιμοποιήθηκαν. Οι λεπτομέρειες ισχύουν μετά το άνοιγμα της ομάδας.",
  "settings.timeline.activity": "Δραστηριότητα",
  ...
  "settings.timeline.placement.title": "Τοποθέτηση",
  "settings.timeline.placement.separate": "Ξεχωριστό",
  "settings.timeline.placement.grouped": "Ομαδοποιημένα",
  "settings.timeline.placement.hidden": "Κρυφό",
  "settings.timeline.expansion.title": "Λεπτομέρειες",
  "settings.timeline.expansion.collapsed": "Συμπτυγμένο",
  "settings.timeline.expansion.expanded": "Αναπτυγμένο",
