export const dict = {
  ...
  "settings.appearance.row.projectName.title": "Vis projektnavne",
  "settings.appearance.row.projectName.description": "Vis projektnavne i lodrette faner og mobilens fanepanel",
  ...
  "settings.timeline.advanced.explainer":
    "Grupperet aktivitet placeres under Brugt. Detaljer anvendes, når gruppen åbnes.",
  ...
  "settings.timeline.placement.grouped": "Grupperet",
  ...
  "settings.timeline.expansion.expanded": "Udvidet",
  ...
  "session.queue.attachments": "+ vedhæftede filer",
