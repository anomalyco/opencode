export const dict = {
  ...
  "toast.migration.progress.migratingSessions.current": "Migrazione delle sessioni: {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migrazione delle sessioni: {{current}}/{{total}}",
  "toast.migration.progress.working": "Migrazione dei dati",
  "toast.migration.progress.working.current": "Migrazione dei dati: {{current}}",
  "toast.migration.progress.working.progress": "Migrazione dei dati: {{current}}/{{total}}",
  "session.browser.unsupported": "Questa app desktop non supporta il pannello del browser.",
  "ssh.label": "SSH",
  "ssh.offline":
    "Non collegato a {{host}}. La tua bozza viene conservata; il lavoro a distanza potrebbe essere ancora in corso.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Aggiungi il server SSH",
  "ssh.server.menu.label": "Server SSH",
  "ssh.target": "Comando host o SSH",
  "ssh.connect": "Connettiti",
  "ssh.connectTo": "Connettiti a {{host}}",
  "ssh.authenticate": "Autenticazione SSH",
  "ssh.action.authenticate": "Autenticarsi",
  "ssh.session.disconnected": "Connessione SSH inattiva",
  "ssh.session.connecting": "Connessione al server SSH",
  "ssh.session.reconnectDescription":
    "Riconnettiti per visualizzare questa sessione e continuare a lavorare. La tua sessione remota viene preservata.",
  "ssh.session.reconnect": "Riconnettiti",
  "ssh.authenticationRequired": "Autenticazione richiesta per {{host}}",
  "ssh.trust": "Fidati e connettiti",
  "ssh.continue": "Continua",
  "ssh.retry": "Riprova",
  "ssh.update": "Aggiorna e riconnettiti",
  "ssh.openProject": "Apri progetto",
  "ssh.project": "Apri progetto su {{host}}",
  "ssh.disconnect": "Disconnetti",
  "ssh.forget": "Dimentica la connessione",
  "ssh.stage.disconnected": "Disconnesso. Il server remoto viene lasciato in esecuzione.",
  "ssh.stage.connecting": "Collegamento tramite SSH…",
  "ssh.stage.checking": "Controllo OpenCode…",
  "ssh.stage.downloading": "Download del server…",
  "ssh.stage.uploading": "Caricamento del server...",
  "ssh.stage.starting": "Collegamento a OpenCode…",
  "ssh.stage.ready": "Connesso",
  "ssh.stage.authentication": "Autenticazione richiesta",
  "ssh.stage.incompatible": "È richiesto l'aggiornamento del server",
  "ssh.stage.failed": "Connessione non riuscita",
  "ssh.error.input":
    "Immettere un comando di connessione host o SSH. Non sono consentiti comandi remoti e opzioni SSH non supportate.",
  "ssh.error.connection": "Impossibile stabilire la connessione SSH. Controlla la tua rete e la configurazione SSH.",
  "ssh.error.platform":
    "Questa piattaforma remota non è supportata. La configurazione automatica attualmente richiede Linux o macOS su x64 o arm64.",
  "ssh.error.version": "Il servizio remoto deve corrispondere a questa versione desktop prima della connessione.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH si è connesso, ma il server OpenCode non è pronto.",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing":
    "OpenSSH non è stato trovato. Installa un client OpenSSH e assicurati che ssh sia disponibile su PATH.",
  "command.browser.open": "Apri il browser",
  "command.browser.reload": "Ricarica la pagina del browser",
  "command.session.summary.toggle": "Attiva/disattiva riepilogo",
  "mcp.auth.interactiveForm": "Il server MCP {{name}} richiede un modulo di autenticazione interattivo",
  "server.connect.title": "Connettersi a un server",
  "server.connect.description": "Inserisci l'indirizzo del tuo server e la password per iniziare.",
  ...
  "server.connect.camera.error":
    "Impossibile aprire la fotocamera. Consenti l'accesso alla fotocamera o inserisci manualmente i dettagli della connessione.",
  "dialog.server.menu.remove": "Rimuovi",
  "file.error.notFound": "File non trovato: {{name}}",
  "home.workspaceTip": "Inizia la sessione successiva in una nuova area di lavoro per mantenere isolate le modifiche",
  "session.tab.browser": "Navigatore",
  "session.tab.add": "Aggiungi scheda",
  "session.queue.attachments.one": "Inoltre attacco {{count}}",
  "session.queue.attachments.other": "Inoltre accessori {{count}}",
  "session.browser.address": "Indirizzo del browser",
  "session.browser.replaced": "Il controllo del browser è stato spostato su un'altra finestra del desktop.",
  "session.browser.suspended": "Browser sospeso. Interagisci con questa sessione per riconnetterti.",
  "session.browser.address.placeholder": "Inserisci URL",
  "settings.backToSettings": "Torna alle impostazioni",
  "settings.backToProjects": "Torniamo ai progetti",
  "settings.search.placeholder": "Cerca",
  "settings.search.results": "Risultati delle impostazioni",
  "settings.search.group.pages": "Pagine",
  "settings.search.group.settings": "Impostazioni",
  "settings.search.group.projects": "Progetti",
  ...
  "settings.search.empty": "Nessun risultato per {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Restringi la ricerca per visualizzare risultati più specifici.",
  "settings.server.description": "Gestisci la connessione e le preferenze di questo server",
  "settings.server.section.connection": "Connessione",
  "settings.server.preferences.websearch.title": "Ricerca di terze parti",
  "settings.server.preferences.websearch.description":
    "Seleziona il provider di ricerca utilizzato dagli agenti per effettuare ricerche sul Web",
  "settings.projects.search.placeholder": "Cerca progetti",
  "project.settings.name.title": "Nome del progetto",
  "project.settings.name.description": "Il nome mostrato per questo progetto in tutto OpenCode",
  "project.settings.icon.description": "Consigliato: 128×128px. Fare clic o trascinare per caricare un'immagine.",
  "project.settings.color.description":
    "Utilizzato per l'icona del progetto quando non è impostata alcuna immagine personalizzata",
  "project.settings.worktree.startup.description":
    "Viene eseguito una volta dopo aver creato un nuovo spazio di lavoro",
  "project.settings.worktree.startup.hint.base": "Utilizzare $OPENCODE_WORKTREE_BASE per lo spazio di lavoro di base.",
  "project.settings.worktree.startup.hint.new": "Utilizzare $OPENCODE_WORKTREE_PATH per il nuovo spazio di lavoro.",
  "project.settings.extensions.empty.mcps.title": "Ancora nessun MCPs",
  "project.settings.extensions.empty.mcps.description": "MCPs disponibile per OpenCode verrà visualizzato qui",
  "project.settings.extensions.empty.plugins.title": "Nessun plugin ancora",
  "project.settings.extensions.empty.plugins.description": "I plugin disponibili per OpenCode appariranno qui",
  "project.settings.extensions.empty.skills.title": "Nessuna competenza ancora",
  "project.settings.extensions.empty.skills.description": "Le abilità disponibili per OpenCode appariranno qui",
  "project.settings.extensions.lsp.configured": "Server linguistici configurati",
  "project.settings.extensions.lsp.status.enabled": "Abilitato nella configurazione",
  "project.settings.extensions.lsp.status.disabled": "Disabilitato nella configurazione",
  "project.settings.extensions.lsp.empty.title": "Nessun server di lingua configurato",
  "project.settings.extensions.lsp.empty.description":
    "I server linguistici configurati per questo progetto verranno visualizzati qui",
  "project.settings.extensions.lsp.disabled.title": "Server linguistici disabilitati",
  "project.settings.extensions.lsp.disabled.description": "LSP è disabilitato nella configurazione di questo progetto",
  "project.settings.extensions.lsp.loadFailed": "Impossibile caricare la configurazione del server della lingua",
  "project.settings.extensions.lsp.retry": "Riprova",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Gruppo",
  "settings.timeline.collapse": "Crollo",
  "settings.timeline.visibility.show": "Mostra",
  "settings.timeline.visibility.hide": "Nasconditi",
  ...
  "settings.workspaces.sessions.filtered.one": "Sessione {{count}}",
  "settings.workspaces.sessions.filtered.other": "Sessioni {{count}}",
  "settings.workspaces.deleteAll.confirm.one":
    "Ciò eliminerà permanentemente l'spazio di lavoro selezionato {{count}}.",
  "settings.workspaces.deleteAll.confirm.other":
    "Ciò eliminerà permanentemente gli spazi di lavoro selezionati {{count}}.",
  "settings.workspaces.deleteWithoutSessions": "Elimina spazi di lavoro senza sessioni",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Ciò eliminerà permanentemente l'spazio di lavoro {{count}} senza sessioni collegate.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Ciò eliminerà definitivamente gli spazi di lavoro {{count}} senza sessioni collegate.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Gli spazi di lavoro con modifiche non unite o posizioni attive verranno mantenuti.",
  "settings.workspaces.delete.button": "Elimina spazi di lavoro",
  "workspace.lifecycle.deleting": "Eliminazione…",
  "session.summary.tooltip": "Sommario",
  "session.summary.server": "Estensioni",
  "session.summary.chooseProject": "Scegli un progetto",
  "session.summary.mcp.onCreation": "Si applica quando viene creato l'spazio di lavoro",
  "session.summary.mcp.prepareFailed": "Impossibile preparare i server MCP",
  "session.summary.mcp.unavailable": "Il server MCP {{name}} non è disponibile in questo spazio di lavoro.",
  "session.summary.mcp.signInBeforeSend": "Accedi a {{name}} prima di inviare la richiesta.",
  "session.summary.mcp.notReady":
    "Il server MCP {{name}} non è pronto. Risolvere la connessione prima di inviare il prompt.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Server MCP configurati",
  "session.summary.plugins": "Plugin",
  "session.summary.plugins.configured": "Plugin configurati",
  "session.summary.skills": "Abilità",
  "session.summary.skills.configured": "Competenze configurate",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Fallito",
  "session.summary.retry": "Riprova",
  "session.summary.connecting": "Connessione…",
  "session.summary.needsAuth": "È richiesto l'accesso",
  "session.summary.configure": "File di configurazione",
  "session.summary.copyConfigPath": "Copia il percorso del file di configurazione",
  "session.summary.configFileMissing": "Nessun file di configurazione trovato",
  "session.summary.mcp.empty": "Nessun server MCP configurato",
  "session.summary.mcp.add": "Aggiungi server in opencode.json",
  "session.summary.plugins.manage": "Gestisci i plugin in opencode.json",
  "session.summary.plugins.empty": "Nessun plugin configurato",
  "session.summary.plugins.add": "Aggiungi plugin in opencode.json",
  "session.summary.skills.manage": "Gestisci le abilità in opencode.json",
  "session.summary.skills.empty": "Nessuna competenza configurata",
  "session.summary.skills.add": "Aggiungi abilità in opencode.json",
  "session.summary.lsp.configured": "LSPs configurato",
  "session.summary.lsp.empty": "Nessun server LSP configurato",
  "session.summary.lsp.manage": "Gestisci LSP in opencode.json",
  "workspace.delete.location": "Posizione",
  "session.queue.attachments.many": "Inoltre accessori {{count}}",
  "settings.workspaces.sessions.filtered.many": "Sessioni {{count}}",
  ...
  "settings.workspaces.deleteAll.warning":
    "Gli spazi di lavoro con modifiche non unite, sessioni collegate o posizioni attive verranno mantenuti.",
  "provider.connect.error.unsupportedFields": "Questo modulo di autenticazione contiene campi non supportati",
  "session.review.filesChangedCount.one": "{{count}} file modificato",
  "session.review.filesChangedCount.other": "{{count}} file modificati",
  "session.review.filesChangedCount.many": "{{count}} file modificati",
  "settings.about.writtenByNames": "Scritto da {{names}}",
  "settings.about.illustratedByNames": "Illustrato da {{names}}",
  "home.projects.all": "Tutti i progetti",
  "session.tab.files": "File",
  "session.files.openTabs": "File aperti",
  "session.tab.usage": "Utilizzo",
  "session.view.select": "Vista sessione",
  "session.background.moveTasks": "Sposta {{tasks}} in background",
  "session.background.moveRunning": "Sposta in background",
  "session.background.inBackground": "Esecuzione di {{tasks}} in background",
  "session.background.tasksRunning.one": "{{count}} attività in background in esecuzione",
  "session.background.tasksRunning.other": "{{count}} attività in background in esecuzione",
  ...
  "session.websearch.any": "Qualsiasi",
  "session.websearch.disable": "Non usare la ricerca",
  "session.websearch.enable": "Abilita",
  "session.websearch.loadFailed": "Impossibile caricare i provider di ricerca.",
  "session.websearch.empty": "Nessun provider di ricerca disponibile.",
  "session.websearch.failed": "Impossibile salvare la scelta. Riprova.",
  "session.websearch.retry": "Riprova",
  "session.new.worktree.draftPlaceholder": "Scrivi una bozza di follow-up mentre viene preparato il worktree…",
  "session.search.placeholder": "Trova...",
  "session.search.noResults": "Nessuna corrispondenza",
  "titlebar.tabs": "Schede",
  "titlebar.channel.local": "Locale",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Attiva/disattiva strumenti di debug",
  "settings.tab.experimental": "Sperimentale",
  "settings.experimental.description": "Prova le funzionalità sperimentali",
  "settings.tab.about": "Informazioni",
  "settings.about.version": "Versione {{version}}",
  "settings.about.devVersion": "sviluppo",
  "settings.about.license": "Rilasciato con licenza MIT",
  "settings.about.writtenBy": "Scritto da",
  "settings.about.illustratedBy": "Illustrato da",
  "settings.about.and": "e",
  "settings.about.otherContributor.one": "{{count}} altro",
  "settings.about.otherContributor.other": "{{count}} altri",
  "settings.about.firstPublished": "Pubblicato per la prima volta nel Missouri, USA",
  "settings.about.firstIllustrated": "Illustrato per la prima volta a Londra, Inghilterra",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, l’agente di programmazione open source",
  "settings.about.trademark": "OpenCode è un marchio registrato di Anomaly Innovations, Inc.",
  ...
  "settings.timeline.description":
    "Scegli quante attività mostrare nella sequenza temporale. I messaggi rimangono visibili.",
  "settings.timeline.preset.everything": "Tutto",
  "settings.timeline.preset.detailed": "Dettagliato",
  "settings.timeline.preset.compact": "Compatto",
  "settings.timeline.preset.quiet": "Discreto",
  "settings.timeline.preset.text-only": "Solo testo",
  ...
  "settings.timeline.description.custom":
    "Usa il posizionamento e i dettagli selezionati per ogni categoria di attività.",
  "settings.timeline.custom": "Personalizzato",
  "settings.timeline.advanced": "Avanzate",
  "settings.timeline.advanced.description": "Imposta il posizionamento e i dettagli per ogni categoria di attività.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Modifiche",
  ...
  "session.background.tasksRunning.many": "{{count}} attività in background in esecuzione",
  ...
  "toast.migration.progress.clearingOldEvents": "Eliminazione dei vecchi eventi",
  "toast.migration.progress.migratingSessions": "Migrazione delle sessioni",
  "session.new.workspace.existingLabel": "Worktree",
  "desktop.onboarding.defaultProject": "Progetto predefinito",
  "session.location.unavailable": "Posizione della sessione non disponibile",
  "session.location.description": "Scegli un’altra directory per continuare questa sessione.",
  "session.location.choose": "Scegli directory",
  "session.location.worktree": "Scegli worktree",
  "session.location.worktreesFailed": "Impossibile caricare i worktree",
  "session.location.moving": "Spostamento della sessione…",
  "dialog.server.menu.hide": "Nascondi dall’elenco dei progetti",
  "dialog.server.menu.show": "Mostra nell’elenco dei progetti",
  "session.queue.count.one": "{{count}} in coda",
  "session.queue.count.many": "{{count}} in coda",
  "session.queue.count.other": "{{count}} in coda",
  "session.queue.steer": "Guida",
  "session.queue.send": "Invia",
  "session.queue.steerTooltip": "Invia senza interrompere",
  "session.queue.remove": "Rimuovi",
  "session.queue.reorder": "Riordina il prompt in coda",
  "session.new.worktree.creating": "Creazione del worktree",
  "settings.backToApp": "Torna all’app",
  "settings.appearance.section.experimental": "Sperimentale",
  "settings.appearance.row.tabs.title": "Schede",
  "settings.appearance.row.tabs.description": "Scegli come disporre le schede delle sessioni",
  "settings.appearance.row.tabs.horizontal": "Orizzontale",
  "settings.appearance.row.tabs.vertical": "Verticale",
  "settings.general.row.followUpBehavior.title": "Comportamento dei messaggi successivi",
  "settings.general.row.followUpBehavior.description":
    "Scegli se mettere in coda i messaggi successivi o guidare il turno corrente. Usa {{keybind}} per cambiare.",
  "settings.general.row.followUpBehavior.queue": "Metti in coda",
  "settings.general.row.followUpBehavior.steer": "Guida",
  "settings.general.row.reasoningMode.title": "Ragionamento del modello",
  "settings.general.row.reasoningMode.description":
    "Scegli come visualizzare il ragionamento del modello nella sequenza temporale",
  "settings.general.row.reasoningMode.hidden": "Nascosto",
  "settings.general.row.reasoningMode.compact": "Compatto",
  "settings.general.row.reasoningMode.full": "Completo",
  "session.new.workspace.createFrom": "Crea da un ramo",
  "session.new.workspace.branch.search.placeholder": "Cerca rami",
  ...
  "session.review.change.many": "Modifiche",
  ...
  "provider.connect.title.anthropicProMax": "Accedi con Anthropic",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Annulla caricamento",
  "prompt.toast.uploading.cancelFile": "Annulla il caricamento di {{filename}}",
  "prompt.toast.uploadFailed.title": "Caricamento non riuscito",
  "session.browser.empty.title": "Inserisci URL",
  "session.browser.empty.description": "Oppure chiedi “Apri nel browser dell’app”",
  "session.browser.failed.title": "Impossibile raggiungere l’URL",
  "session.browser.failed.description": "Controlla l’URL e la connessione, quindi riprova.",
  "debugBar.providerAriaLabel": "Diagnostica delle prestazioni del provider",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Tempo dall’invio della richiesta al provider al primo output del modello.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Tempo dall’invio della richiesta al provider al primo testo della risposta.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Token di output al secondo dopo il primo output del modello.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Tempo dall’invio della richiesta al provider alla fine del flusso di risposta.",
  "settings.updates.action.download": "Scarica OpenCode",
  "settings.updates.migration.title": "Passa da Beta a Stabile",
