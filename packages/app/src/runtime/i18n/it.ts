export const dict = {
  ...
  "settings.timeline.advanced.explainer":
    "Le attività raggruppate vengono visualizzate in Utilizzati. I dettagli si applicano dopo l’apertura del gruppo.",
  "settings.timeline.activity": "Attività",
  ...
  "settings.timeline.placement.title": "Posizionamento",
  "settings.timeline.placement.separate": "Separato",
  "settings.timeline.placement.grouped": "Raggruppato",
  "settings.timeline.placement.hidden": "Nascosto",
  "settings.timeline.expansion.title": "Dettagli",
  "settings.timeline.expansion.collapsed": "Compresso",
  "settings.timeline.expansion.expanded": "Espanso",
  ...
  "session.queue.attachments": "+ allegati",
