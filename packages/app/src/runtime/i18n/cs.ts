export const dict = {
  ...
  "settings.general.row.browserPane.title": "Prohlížeč",
  "settings.general.row.browserPane.description": "Povolit agentům otevírat a ovládat vývojový prohlížeč v aplikaci.",
