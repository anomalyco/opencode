export const dict = {
  ...
  "session.queue.attachments": "+ přílohy",
  ...
  "settings.appearance.row.projectName.title": "Zobrazit názvy projektů",
  "settings.appearance.row.projectName.description":
    "Zobrazení názvů projektů na svislých kartách a v zásuvce mobilních karet",
  ...
  "settings.timeline.advanced.explainer":
    "Seskupená aktivita přejde do Použito. Podrobnosti platí po otevření skupiny.",
  ...
  "settings.timeline.placement.title": "Umístění",
  "settings.timeline.placement.separate": "Samostatný",
  "settings.timeline.placement.grouped": "Seskupené",
  "settings.timeline.placement.hidden": "skrytý",
  "settings.timeline.expansion.title": "Podrobnosti",
  "settings.timeline.expansion.collapsed": "Sbaleno",
  "settings.timeline.expansion.expanded": "Rozšířeno",
