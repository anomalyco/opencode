export const dict = {
  ...
  "session.queue.attachments": "+ fitxers adjunts",
  ...
  "settings.timeline.advanced.explainer":
    "L'activitat agrupada entra a Usat. Els detalls s'apliquen després d'obrir el grup.",
  "settings.timeline.activity": "Activitat",
  ...
  "settings.timeline.placement.title": "Col·locació",
  "settings.timeline.placement.separate": "Separat",
  "settings.timeline.placement.grouped": "Agrupats",
  "settings.timeline.placement.hidden": "Amagat",
  "settings.timeline.expansion.title": "Informació",
  "settings.timeline.expansion.collapsed": "Replegat",
  "settings.timeline.expansion.expanded": "Desplegat",
