export const dict = {
  ...
  "session.queue.attachments": "+ 添付ファイル",
  ...
  "settings.appearance.row.projectName.title": "プロジェクト名を表示",
  "settings.appearance.row.projectName.description": "プロジェクト名を垂直タブとモバイルタブドロワーに表示する",
  ...
  "settings.timeline.advanced.explainer":
    "グループ化されたアクティビティが使用済みになります。 詳細はグループを開いた後に適用されます。",
  "settings.timeline.activity": "アクティビティ",
  ...
  "settings.timeline.placement.title": "プレースメント",
  "settings.timeline.placement.separate": "別途",
  "settings.timeline.placement.grouped": "グループ化",
  "settings.timeline.placement.hidden": "非表示",
  "settings.timeline.expansion.title": "詳細",
  "settings.timeline.expansion.collapsed": "折りたたまれました",
  "settings.timeline.expansion.expanded": "展開済み",
