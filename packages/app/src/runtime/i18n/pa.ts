export const dict = {
  ...
  "session.queue.attachments": "+ منسلکہ",
  ...
  "settings.appearance.row.projectName.title": "پروجیکٹ دے ناں وکھاؤ",
  "settings.appearance.row.projectName.description": "کھڑویں ٹیباں تے موبائل ٹیب دراز وچ پروجیکٹ دے ناں وکھاؤ",
  ...
  "settings.timeline.advanced.explainer":
    "گروپ کیتی سرگرمی ’ورتی گئی‘ وچ جاندی اے۔ گروپ کھولݨ توں بعد تفصیل لاگو ہوندی اے۔",
  ...
  "settings.timeline.placement.title": "تھان",
  "settings.timeline.placement.separate": "وکھرا",
  "settings.timeline.placement.grouped": "گروپ کیتا",
  "settings.timeline.placement.hidden": "لُکیا ہویا",
  "settings.timeline.expansion.title": "تفصیل",
  "settings.timeline.expansion.collapsed": "بند",
  "settings.timeline.expansion.expanded": "کھلیا",
