...
export const dict = {
  ...
  "command.session.location.cycle": "依次切换会话位置",
  ...
  "provider.connect.title.anthropicProMax": "登录 Anthropic",
  ...
  "prompt.toast.uploading.cancelFile": "取消上传 {{filename}}",
  ...
  "settings.updates.migration.title": "从 Beta 版迁移到稳定版",
  ...
  "debugBar.providerAriaLabel": "提供商性能诊断",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "从发送提供商请求到模型首次输出所用的时间。",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "从发送提供商请求到首次输出回答文本所用的时间。",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "模型首次输出后每秒生成的输出词元数。",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "从发送提供商请求到其响应流结束所用的时间。",
  "debugBar.na": "不适用",
  ...
  "settings.workspaces.deleteAll.warning": "具有未合并更改、关联会话或活动位置的工作树将被保留。",
  ...
  "session.location.description": "请选择其他目录以继续此会话。",
  "session.location.choose": "选择目录",
  "session.location.worktree": "选择 worktree",
  "session.location.worktreesFailed": "无法加载 worktree",
  "session.location.moving": "正在移动会话…",
  "dialog.server.menu.hide": "从项目列表中隐藏",
  "dialog.server.menu.show": "在项目列表中显示",
  "session.queue.count.one": "{{count}} 个已排队",
  "session.queue.count.other": "{{count}} 个已排队",
  "session.queue.steer": "引导",
  "session.queue.send": "发送",
  "session.queue.steerTooltip": "发送但不中断",
  "session.queue.remove": "移除",
  "session.queue.reorder": "重新排列已排队的提示词",
  "session.new.worktree.creating": "正在创建 worktree",
  ...
  "settings.general.row.reasoningMode.description": "选择模型推理在时间线中的显示方式",
  ...
  "session.new.workspace.createFrom": "创建自",
  "session.new.workspace.branch.search.placeholder": "搜索分支",
  "toast.migration.progress.clearingOldEvents": "正在清除旧事件",
  "toast.migration.progress.migratingSessions": "正在迁移会话",
  "session.new.workspace.existingLabel": "工作树",
  "desktop.onboarding.defaultProject": "默认项目",

  "home.projects.all": "所有项目",
  "session.tab.files": "文件",
  "session.files.openTabs": "打开文件",
  "session.tab.usage": "用法",
  "session.view.select": "课次视图",
  "session.background.moveTasks": "将{{tasks}}移至后台",
  "session.background.moveRunning": "移至背景",
  "session.background.inBackground": "在后台运行{{tasks}}",
  "session.background.tasksRunning.one": "{{count}}个后台任务正在运行",
  "session.background.tasksRunning.other": "{{count}}个后台任务正在运行",
  "session.background.combine": "{{first}}和{{second}}",
  "session.background.shell.one": "{{count}}个shell",
  "session.background.shell.other": "{{count}}个贝壳",
  "session.background.subagent.one": "{{count}}个子代理",
  "session.background.subagent.other": "{{count}}个子代理",
  "session.timeline.working": "工作中",
  "session.review.wrapLines": "换行",
  "session.websearch.title": "第三方网页搜索",
  "session.websearch.description": "选择搜索提供商代理用于搜索网页",
  "session.websearch.provider": "搜索提供商",
  "session.websearch.any": "任何",
  "session.websearch.disable": "不使用搜索",
  "session.websearch.enable": "启用",
  "session.websearch.loadFailed": "无法加载搜索提供程序。",
  "session.websearch.empty": "没有可用的搜索提供程序。",
  "session.websearch.failed": "无法保存您的选择。请重试。",
  "session.websearch.retry": "重试",
  "session.new.worktree.draftPlaceholder": "在准备工作树时起草跟进……",
  "session.search.placeholder": "查找...",
  "session.search.noResults": "无匹配项",
  "titlebar.tabs": "标签页",
  "titlebar.channel.local": "本地",
  "titlebar.channel.dev": "开发",
  "titlebar.channel.beta": "测试版",
  "titlebar.toggleDebugTools": "切换调试工具",
  "settings.tab.experimental": "实验",
  "settings.experimental.description": "尝试实验性功能",
  "settings.tab.about": "关于",
  "settings.about.version": "版本{{version}}",
  "settings.about.devVersion": "发展",
  "settings.about.license": "根据麻省理工学院许可证发布",
  "settings.about.writtenBy": "作者",
  "settings.about.illustratedBy": "图示：",
  "settings.about.and": "和",
  "settings.about.otherContributor.one": "{{count}}其他",
  "settings.about.otherContributor.other": "其他{{count}}人",
  "settings.about.firstPublished": "首次在美国密苏里州发布",
  "settings.about.firstIllustrated": "首次在英国伦敦展出",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode ，开源编码代理",
  "settings.about.trademark": "OpenCode是Anomaly Innovations, Inc.的注册商标。",
  "settings.about.typeset": "Inter和IBM Plex Mono中的排版",
  "settings.about.tagline": "没有您，人工智能无法构建出色的软件",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "settings.appearance.row.projectName.title": "显示项目名称",
  "settings.appearance.row.projectName.description": "在垂直选项卡和移动选项卡抽屉中显示项目名称",
  "project.settings.title": "编辑项目",
  "settings.timeline.title": "时间表",
  "settings.timeline.detail": "时间轴详细信息",
  "settings.timeline.description": "选择时间轴上显示的活动量。消息始终可见。",
  "settings.timeline.preset.everything": "一切",
  "settings.timeline.preset.detailed": "详情",
  "settings.timeline.preset.compact": "紧凑型",
  "settings.timeline.preset.quiet": "安静",
  ...
  "settings.timeline.advanced.description": "设置每个活动类别的位置和详细信息。",
  "settings.timeline.category.shell": "壳牌",
  "settings.timeline.category.edit": "编辑",
  "settings.timeline.category.thinking": "思考",
  "settings.timeline.category.subagents": "子代理",
  "settings.timeline.category.notices": "注意事项",
  "settings.timeline.category.tools": "其他工具",
  "settings.general.row.mobileDiffWrap.description": "在移动设备差异中换行，而不是水平滚动",

  "provider.connect.error.unsupportedFields": "此身份验证表单包含不受支持的字段",
  "session.review.filesChangedCount.one": "{{count}} 个文件已更改",
  "session.review.filesChangedCount.other": "{{count}} 个文件已更改",
  "settings.about.writtenByNames": "作者：{{names}}",
  "settings.about.illustratedByNames": "插图由{{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "未连接到 {{host}}。您的草稿已保存；远程工作可能仍在运行。",
  ...
  "ssh.authenticate": "SSH 验证",
  "ssh.action.authenticate": "验证",
  "ssh.session.disconnected": "SSH 连接不活动",
  "ssh.session.connecting": "正在连接到 SSH 服务器",
  "ssh.session.reconnectDescription": "重新连接以查看此会话并继续工作。您的远程会话已保存。",
  "ssh.session.reconnect": "重新连接",
  "ssh.authenticationRequired": "需要对 {{host}} 进行身份验证",
  "ssh.trust": "信任并连接",
  "ssh.continue": "继续",
  "ssh.retry": "重试",
  "ssh.update": "更新并重新连接",
  ...
  "ssh.disconnect": "断开连接",
  "ssh.forget": "忘记连接",
  "ssh.stage.disconnected": "已断开连接。远程服务器仍在运行。",
  "ssh.stage.connecting": "正在通过 SSH 连接…",
  "ssh.stage.checking": "正在检查 OpenCode…",
  "ssh.stage.downloading": "正在下载服务器…",
  "ssh.stage.uploading": "正在上传服务器…",
  "ssh.stage.starting": "正在连接到 OpenCode…",
  "ssh.stage.ready": "已连接",
  "ssh.stage.authentication": "需要身份验证",
  "ssh.stage.incompatible": "需要更新服务器",
  "ssh.stage.failed": "连接失败",
  "ssh.error.input": "请输入主机或 SSH 连接命令。不允许远程命令和不支持的 SSH 选项。",
  "ssh.error.connection": "无法建立 SSH 连接。请检查您的网络和 SSH 配置。",
  "ssh.error.platform": "此远程平台不受支持。自动设置目前需要在 x64 或 arm64 上运行的 Linux 或 macOS。",
  "ssh.error.version": "在连接之前，远程服务必须与此桌面版本匹配。",
  "ssh.error.install": "无法安装远程服务器。请检查连接性、磁盘空间，并确认已安装 tar。",
  "ssh.error.unpublished": "此桌面版本没有发布远程服务器。对于开发版本，请在主机上安装并启动 V2，然后重试。",
  "ssh.error.service": "SSH 已连接，但 OpenCode 服务器未准备就绪。",
  "ssh.error.host-key": "无法验证主机的身份。在更新 SSH 已知主机之前，请验证其指纹。",
  "ssh.error.ssh-missing": "未找到 OpenSSH。请安装 OpenSSH 客户端，并确保 ssh 可在 PATH 中使用。",
  ...
  "mcp.auth.interactiveForm": "MCP 服务器 {{name}} 需要交互式身份验证表单",
  "server.connect.title": "连接到服务器",
  "server.connect.description": "输入您的服务器地址和密码以开始。",
  ...
  "server.connect.pair.description": "在您的计算机上运行此命令以获取连接详细信息。",
  "server.connect.scan": "扫描二维码",
  "server.connect.scan.description": "将摄像头对准 opencode pair 显示的二维码。",
  "server.connect.scan.invalid": "这不是 OpenCode 配对码。请扫描 opencode pair 显示的二维码。",
  "server.connect.camera": "正在配对摄像头",
  "server.connect.camera.starting": "正在打开摄像头…",
  "server.connect.mixedContent": "无法从 HTTPS 页面连接此 HTTP 服务器。请使用 HTTPS 服务器地址。",
  "server.connect.camera.insecure": "扫描二维码需要通过 HTTPS 打开此页面或在本地主机上打开。",
  "server.connect.camera.unavailable": "此浏览器无法使用摄像头。请手动输入连接详情。",
  "server.connect.camera.error": "无法打开摄像头。请允许摄像头访问或手动输入连接详情。",
  "dialog.server.menu.remove": "移除",
  "file.error.notFound": "未找到文件：{{name}}",
  "toast.migration.progress.migratingSessions.current": "正在迁移会话 {{current}}",
  "toast.migration.progress.migratingSessions.progress": "正在迁移会话 {{current}}/{{total}}",
  "toast.migration.progress.working": "正在迁移数据",
  "toast.migration.progress.working.current": "正在迁移数据 {{current}}",
  "toast.migration.progress.working.progress": "正在迁移数据 {{current}}/{{total}}",
  "home.workspaceTip": "在新工作区中开始下一个会话以保持更改独立",
  "session.tab.browser": "浏览器",
  "session.tab.add": "添加标签页",
  "session.queue.attachments.one": "添加 {{count}} 个附件",
  "session.queue.attachments.other": "添加 {{count}} 个附件",
  "session.browser.address": "浏览器地址",
  "session.browser.replaced": "浏览器控件已移动到另一个桌面窗口。",
  "session.browser.unsupported": "此桌面应用程序不支持浏览器面板。",
  "session.browser.suspended": "浏览器已挂起。请与此会话交互以重新连接。",
  "session.browser.address.placeholder": "输入 URL",
  "session.browser.empty.title": "输入 URL",
  "session.browser.empty.description": "或提示“在应用内浏览器中打开”",
  "session.browser.failed.title": "无法访问 URL",
  "session.browser.failed.description": "请检查 URL 和网络连接，然后重试。",
  "settings.backToSettings": "返回设置",
  "settings.backToProjects": "返回项目",
  "settings.search.placeholder": "搜索",
  "settings.search.results": "设置结果",
  ...
  "settings.search.empty": "未找到 {{query}} 的结果",
  "settings.search.refine": "缩小搜索范围以查看更多具体结果。",
  ...
  "settings.server.preferences.websearch.description": "选择代理用来在网络上搜索的搜索提供商",
  "settings.projects.search.placeholder": "搜索项目",
  "project.settings.name.title": "项目名称",
  "project.settings.name.description": "在 OpenCode 中此项目显示的名称",
  "project.settings.icon.description": "建议：128×128 像素。点击或拖动上传图片。",
  "project.settings.color.description": "当未设置自定义图片时用于项目图标",
  "project.settings.worktree.startup.description": "在创建新工作树后运行一次",
  "project.settings.worktree.startup.hint.base": "使用 $OPENCODE_WORKTREE_BASE 作为基础工作树。",
  "project.settings.worktree.startup.hint.new": "使用 $OPENCODE_WORKTREE_PATH 作为新工作树。",
  "project.settings.extensions.empty.mcps.title": "尚无 MCP",
  "project.settings.extensions.empty.mcps.description": "可用于 OpenCode 的 MCP 将显示在这里",
  "project.settings.extensions.empty.plugins.title": "尚无插件",
  "project.settings.extensions.empty.plugins.description": "可用于 OpenCode 的插件将显示在这里",
  "project.settings.extensions.empty.skills.title": "尚无技能",
  ...
  "project.settings.extensions.lsp.status.enabled": "在配置中启用",
  "project.settings.extensions.lsp.status.disabled": "在配置中禁用",
  "project.settings.extensions.lsp.empty.title": "尚未配置语言服务器",
  ...
  "project.settings.extensions.lsp.disabled.description": "此项目配置中已禁用 LSP",
  ...
  "settings.general.row.browserPane.description": "允许代理打开并控制应用内开发浏览器。",
  "session.new.workspace.search.empty": "没有匹配的工作树",
  "settings.workspaces.description": "查看工作树并管理磁盘使用",
  "settings.workspaces.empty.description": "在 OpenCode 中创建的工作树将显示在此处",
  "settings.workspaces.sessions.filtered.one": "{{count}} 个会话",
  "settings.workspaces.sessions.filtered.other": "{{count}} 个会话",
  "settings.workspaces.deleteAll.confirm.one": "这将永久删除 {{count}} 个选定的工作树。",
  "settings.workspaces.deleteAll.confirm.other": "这将永久删除 {{count}} 个选定的工作树。",
  "settings.workspaces.deleteWithoutSessions": "删除没有会话的工作树",
  ...
  "settings.workspaces.deleteWithoutSessions.warning": "有未合并更改或活跃位置的工作树将被保留。",
  ...
  "session.summary.mcp.onCreation": "在创建工作树时适用",
  "session.summary.mcp.prepareFailed": "无法准备 MCP 服务器",
  "session.summary.mcp.unavailable": "MCP 服务器 {{name}} 在此工作树中不可用。",
  "session.summary.mcp.signInBeforeSend": "在发送提示之前，请先登录 {{name}}。",
  "session.summary.mcp.notReady": "MCP 服务器 {{name}} 尚未准备好。在发送提示前请先解决其连接问题。",
  ...
  "session.summary.lsp.configured": "已配置的 LSP",
  "session.summary.lsp.empty": "未配置 LSP 服务器",
