...
export const dict = {
  ...
  "gitGraph.title": "Git 提交图",
  "gitGraph.refresh": "刷新 Git 提交图",
  "gitGraph.retry": "重试",
  "gitGraph.loading": "正在加载 Git 历史…",
  "gitGraph.loadingMore": "正在加载更多…",
  "gitGraph.loadMore": "加载更多",
  "gitGraph.merge": "合并提交",
  "gitGraph.continues": "已加载提交之外仍有历史",
  "gitGraph.column.graph": "图形",
  "gitGraph.column.description": "说明 / 引用",
  "gitGraph.column.date": "日期",
  "gitGraph.column.author": "作者",
  "gitGraph.column.commit": "提交",
  "gitGraph.graph.ariaLabel": "包含分支与合并连线的提交图",
  "gitGraph.detail.ariaLabel": "所选提交详情",
  "gitGraph.detail.commit": "提交",
  "gitGraph.detail.author": "作者",
  "gitGraph.detail.date": "日期",
  "gitGraph.detail.parents": "父提交",
  "gitGraph.detail.refs": "引用",
  "gitGraph.value.unknown": "未知",
  "gitGraph.value.none": "无",
  "gitGraph.empty.title": "暂无提交",
  "gitGraph.empty.description": "此仓库没有任何可见的提交。",
  "gitGraph.unsupported.title": "Git 提交图不可用",
  "gitGraph.unsupported.description": "此位置未使用支持提交图的版本控制提供程序。",
  "gitGraph.error.initial.title": "无法加载 Git 历史",
  "gitGraph.error.initial.description": "请检查仓库后重试。",
  "gitGraph.error.loadMore": "无法加载更多提交。",
  "gitGraph.error.refresh": "无法刷新 Git 历史。仍显示已有的提交图。",
