...
export const dict = {
  ...
  "settings.timeline.description.compact": '分组"已使用"中的所有活动，详细信息已折叠。',
  ...
  "settings.timeline.advanced.explainer": "分组活动进入已使用状态。 详细信息在打开群组后适用。",
  "settings.timeline.activity": "活动",
  ...
  "settings.timeline.placement.title": "安置",
  "settings.timeline.placement.separate": "分开",
  "settings.timeline.placement.grouped": "已分组",
  "settings.timeline.placement.hidden": "隐藏",
  "settings.timeline.expansion.title": "详情",
  "settings.timeline.expansion.collapsed": "已收起",
  "settings.timeline.expansion.expanded": "已展开",
