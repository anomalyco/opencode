export const dict = {
  ...
  "session.queue.attachments": "+ вкладення",
  ...
  "settings.timeline.advanced.explainer":
    "Згрупована діяльність переходить до Використано. Подробиці після відкриття групи.",
  "settings.timeline.activity": "Діяльність",
  ...
  "settings.timeline.placement.title": "Розміщення",
  "settings.timeline.placement.separate": "Окремо",
  "settings.timeline.placement.grouped": "Згруповано",
  "settings.timeline.placement.hidden": "Приховано",
  "settings.timeline.expansion.title": "Деталі",
  "settings.timeline.expansion.collapsed": "Згорнуто",
  "settings.timeline.expansion.expanded": "Розгорнуто",
