export const dict = {
  ...
  "settings.general.row.browserPane.title": "เบราว์เซอร์",
  "settings.general.row.browserPane.description": "อนุญาตให้ตัวแทนเปิดและควบคุมเบราว์เซอร์สำหรับพัฒนาในแอป",
