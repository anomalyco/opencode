...
export const dict = {
  ...
  "session.queue.attachments": "+ priedai",
  ...
  "settings.appearance.row.projectName.title": "Rodyti projektų pavadinimus",
  "settings.appearance.row.projectName.description":
    "Rodyti projektų pavadinimus vertikaliuose skirtukuose ir skirtukų stalčiuje mobiliesiems",
  ...
  "settings.timeline.advanced.explainer":
    "Sugrupuota veikla patenka į Naudota. Išsami informacija taikoma atidarius grupę.",
  "settings.timeline.activity": "Veikla",
  ...
  "settings.timeline.placement.title": "Įdėjimas",
  "settings.timeline.placement.separate": "Atskirai",
  "settings.timeline.placement.grouped": "Sugrupuota",
  "settings.timeline.placement.hidden": "Paslėpta",
  "settings.timeline.expansion.title": "Detalės",
  "settings.timeline.expansion.collapsed": "Suskleista",
  "settings.timeline.expansion.expanded": "Išskleista",
