...
export const dict = {
  ...
  "settings.general.row.browserPane.title": "Naršyklė",
  "settings.general.row.browserPane.description": "Leiskite agentams atidaryti ir valdyti programos kūrimo naršyklę.",
