...
export const dict = {
  ...
  "prompt.toast.uploading.cancelFile": "Cancel upload of {{filename}}",
  ...
  "toast.migration.progress.migratingSessions.current": "Migrating sessions {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migrating sessions {{current}}/{{total}}",
  "toast.migration.progress.working": "Migrating data",
  "toast.migration.progress.working.current": "Migrating data {{current}}",
  "toast.migration.progress.working.progress": "Migrating data {{current}}/{{total}}",
  ...
  "home.project.missing.description": "The folder for {{name}} no longer exists.",
  ...
  "session.review.filesChangedCount.one": "Files Changed {{count}}",
  "session.review.filesChangedCount.other": "Files Changed {{count}}",
  ...
  "session.browser.unsupported": "This desktop app does not support the browser pane.",
  ...
  "settings.projects.empty.description": "Add a project to get started",
  ...
  "settings.general.row.newTabProject.title": "New tab project",
  "settings.general.row.newTabProject.description": "Choose where new session tabs start",
  "settings.general.row.newTabProject.currentTab": "Current tab's directory",
  "settings.general.row.newTabProject.lastSelected": "Last selected project",
