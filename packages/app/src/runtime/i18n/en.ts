...
export const dict = {
  ...
  "gitGraph.retry": "Retry",
  "gitGraph.loading": "Loading Git history…",
  "gitGraph.loadingMore": "Loading more…",
  "gitGraph.loadMore": "Load more",
  "gitGraph.merge": "Merge commit",
  "gitGraph.continues": "History continues beyond the loaded commits",
  "gitGraph.column.graph": "Graph",
  "gitGraph.column.description": "Description / refs",
  "gitGraph.column.date": "Date",
  "gitGraph.column.author": "Author",
  "gitGraph.column.commit": "Commit",
  "gitGraph.graph.ariaLabel": "Commit graph with branch and merge connections",
  "gitGraph.detail.ariaLabel": "Selected commit details",
  "gitGraph.detail.commit": "Commit",
  "gitGraph.detail.author": "Author",
  "gitGraph.detail.date": "Date",
  "gitGraph.detail.parents": "Parents",
  "gitGraph.detail.refs": "Refs",
  "gitGraph.value.unknown": "Unknown",
  "gitGraph.value.none": "None",
  "gitGraph.empty.title": "No commits yet",
  "gitGraph.empty.description": "This repository does not have any visible commits.",
  "gitGraph.unsupported.title": "Git graph is unavailable",
  "gitGraph.unsupported.description": "This location does not use a version control provider with graph support.",
  "gitGraph.error.initial.title": "Could not load Git history",
  "gitGraph.error.initial.description": "Check the repository and try again.",
  "gitGraph.error.loadMore": "Could not load more commits.",
  "gitGraph.error.refresh": "Could not refresh Git history. The existing graph is still shown.",
