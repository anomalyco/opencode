...
export const dict = {
  ...
  "execution.status.detail.needsInput": "Pending input: {{count}}",
  "execution.status.detail.failed": "Failures: {{count}}",
  "execution.status.detail.blocked": "Blocked: {{count}}",
  "execution.status.detail.verified": "Verified: {{verified}} of {{total}}",
  "execution.status.detail.agents": "Active agents: {{count}}",
