...
export const dict = {
  ...
  "session.background.viewAllAgents": "View all agents",
  ...
  "execution.expand": "Expand execution",
  "execution.expand.short": "Expand",
  "execution.collapse": "Collapse execution",
  "execution.collapse.short": "Collapse",
  "execution.expanded.label": "Expanded execution",
  "execution.expanded.title": "Execution",
  "execution.expanded.pending.one": "{{count}} request needs your input",
  "execution.expanded.pending.other": "{{count}} requests need your input",
  "execution.expanded.returnToRequest": "Return to request",
  ...
  "execution.agent.row.label": "{{title}}, {{state}}",
  "execution.agent.controller": "Controller",
  "execution.agent.state.running": "Running",
  "execution.agent.state.idle": "Idle",
  "execution.agent.state.needs_input": "Needs input",
  "execution.agent.state.error": "Error",
  "execution.agent.state.unknown": "Unknown",
  "execution.agent.role.controller": "Controller",
  "execution.agent.role.implementer": "Implementer",
  "execution.agent.role.spec_reviewer": "Spec reviewer",
  "execution.agent.role.code_reviewer": "Code reviewer",
  "execution.agent.role.debugger": "Debugger",
  "execution.agent.model.unknown": "Model unknown",
  "execution.agent.usage.both.one": "{{cost}} · {{tokens}} token",
  "execution.agent.usage.both.other": "{{cost}} · {{tokens}} tokens",
  "execution.agent.usage.costOnly": "Cost {{cost}}",
  "execution.agent.usage.tokensOnly.one": "{{tokens}} token",
  "execution.agent.usage.tokensOnly.other": "{{tokens}} tokens",
  "execution.agent.expand": "Expand {{title}}",
  "execution.agent.collapse": "Collapse {{title}}",
  "execution.agent.open": "Open {{title}} session",
  "execution.agent.retry": "Retry loading {{title}}",
  "execution.agent.retry.action": "Retry",
  "execution.agent.assignments.current": "Current assignments",
  "execution.agent.assignments.previous": "Previous assignments",
  ...
  "execution.status.needs_input": "Waiting for your input",
  "execution.status.failed": "Execution reports a failure",
  "execution.status.blocked": "Execution blocked",
  "execution.status.verified": "{{verified}} of {{total}} verified",
  "execution.status.activeAgents.one": "{{count}} active agent",
  "execution.status.activeAgents.other": "{{count}} active agents",
  "execution.status.reviewRequest": "Review pending request",
  "execution.status.detail.title": "Execution detail",
  "execution.status.detail.stale": "Connection: offline",
  "execution.status.detail.connected": "Connection: live",
  "execution.status.detail.needsInput.one": "Pending input: {{count}}",
  "execution.status.detail.needsInput.other": "Pending input: {{count}}",
  "execution.status.detail.failed.one": "Failure: {{count}}",
  "execution.status.detail.failed.other": "Failures: {{count}}",
  "execution.status.detail.blocked.one": "Blocked: {{count}}",
  "execution.status.detail.blocked.other": "Blocked: {{count}}",
  "execution.status.detail.verified": "Verified: {{verified}} of {{total}}",
  "execution.status.detail.agents.one": "Active agent: {{count}}",
  "execution.status.detail.agents.other": "Active agents: {{count}}",

  "execution.progress.label": "Task progress",
  "execution.progress.count": "{{verified}}/{{total}}",
  "execution.progress.percent": "{{percent}}%",
  "execution.progress.none": "No reliable progress report for this session.",
  "execution.progress.stale": "Stale snapshot",
  "execution.progress.info": "Progress information",
  "execution.progress.provenance": "Verification is reported by the controller.",
  "execution.progress.provenanceDetail":
    "Verified (reported) means the controller reported every required gate as passed for the current attempt. It is not an independent attestation.",
  "execution.progress.fractionNote":
    "The percentage is a count fraction of included tasks, not elapsed work or time remaining.",
  "execution.progress.source": "Source: controller report",
  "execution.progress.skipped.one": "{{count}} skipped task",
  "execution.progress.skipped.other": "{{count}} skipped tasks",
  "execution.progress.failed.one": "{{count}} failed",
  "execution.progress.failed.other": "{{count}} failed",
  "execution.progress.blocked.one": "{{count}} blocked",
  "execution.progress.blocked.other": "{{count}} blocked",
  "execution.progress.review.one": "{{count}} awaiting review",
  "execution.progress.review.other": "{{count}} awaiting review",
  "execution.runState.active": "Active",
  "execution.runState.completed": "Complete",
  "execution.runState.cancelled": "Cancelled",
  "execution.tasks.label": "Task list",
  "execution.tasks.planRevision": "Plan revision {{revision}}",
  "execution.tasks.noRun": "No execution run is registered for this session yet.",
  "execution.tasks.empty": "No tasks match the current filters.",
  "execution.tasks.search.label": "Search tasks",
  "execution.tasks.search.placeholder": "Search tasks",
  "execution.tasks.filter.state.label": "Filter by state",
  "execution.tasks.filter.state.all": "All states",
  "execution.tasks.filter.phase.label": "Filter by phase",
  "execution.tasks.filter.phase.all": "All phases",
  "execution.tasks.row.label": "{{title}}, {{state}}",
  "execution.tasks.assignmentCount.one": "{{count}} assignment",
  "execution.tasks.assignmentCount.other": "{{count}} assignments",
  "execution.task.state.pending": "Pending",
  "execution.task.state.running": "Running",
  "execution.task.state.blocked": "Blocked",
  "execution.task.state.awaiting_review": "Awaiting review",
  "execution.task.state.verified": "Verified",
  "execution.task.state.failed": "Failed",
  "execution.task.state.skipped": "Skipped",
  "execution.task.details.label": "Task details",
  "execution.task.details.empty": "Select a task to see its dependencies, gates, evidence, and assignments.",
  "execution.task.attempt": "Attempt {{attempt}}",
  "execution.task.phase": "Phase: {{phase}}",
  "execution.task.outcome": "Reported outcome: {{state}}",
  "execution.task.reason.label": "Reason",
  "execution.task.dependencies.label": "Dependencies",
  "execution.task.dependencies.none": "No dependencies",
  "execution.task.dependencies.waiting": "Waiting on dependencies",
  "execution.task.gates.label": "Required verification gates",
  "execution.task.gate.tests": "Tests",
  "execution.task.gate.spec_review": "Spec review",
  "execution.task.gate.code_review": "Code review",
  "execution.task.gate.manual": "Manual",
  "execution.task.gate.outcome.passed": "Passed",
  "execution.task.gate.outcome.failed": "Failed",
  "execution.task.gate.outcome.unrun": "Unrun",
  "execution.task.gate.reported": "Reported",
  "execution.task.verifiedReported": "Verified (reported)",
  "execution.task.finalReview": "Final review",
  "execution.task.finalReview.pending": "Final review is still pending",
  "execution.task.provenance": "Verification is reported by the controller, not independently attested.",
  "execution.task.evidence.label": "Evidence",
  "execution.task.evidence.current": "Current attempt evidence",
  ...
  "execution.task.assignments.current": "Current attempt assignments",
  "execution.task.assignments.history": "Earlier assignments",
  "execution.task.assignments.none": "No assignments reported.",
  "execution.task.assignments.agentCount.one": "{{count}} agent",
  "execution.task.assignments.agentCount.other": "{{count}} agents",
  "execution.task.assignments.reported": "Reported {{time}}",
  "execution.task.assignments.ended": "Ended {{time}}",
  "execution.task.assignments.active": "Active",
  "execution.task.assignments.endedBadge": "Ended",
  "execution.task.assignments.native": "Native: {{state}}",
  "execution.task.assignments.sessionUnavailable": "Session unavailable",

  "execution.activity.list.label": "Reported execution activity",
  "execution.activity.note": "Durable reporting events only; native tool activity stays in the Agents view.",
  "execution.activity.empty": "No reporting events have been recorded for this run yet.",
  "execution.activity.loadMore": "Load more",
  "execution.activity.boundary":
    "History before revision {{revision}} was truncated. This is the retained reporting window, not a complete native audit.",
  "execution.activity.revision": "Revision {{revision}}",
  "execution.activity.reported": "Reported {{time}}",
  "execution.activity.task.link": "View task",
  "execution.activity.task.open": "Open task {{title}}",
  "execution.activity.session.link": "Open session",
  "execution.activity.session.open": "Open session {{session}}",
  "execution.activity.type.run.start": "Run created",
  "execution.activity.type.task.state": "Task state changed",
  "execution.activity.type.assignment.add": "Assignment added",
  "execution.activity.type.assignment.end": "Assignment ended",
  "execution.activity.type.evidence.add": "Evidence added",
  "execution.activity.type.task.verify": "Task verified",
  "execution.activity.type.task.reopen": "Task reopened",
  "execution.activity.type.plan.revise": "Plan revised",
  "execution.activity.type.run.finish": "Run completed",
  "execution.activity.type.run.cancel": "Run cancelled",
  "execution.activity.usage.cost": "Reported cost {{cost}}",
  "execution.activity.usage.tokens.one": "Reported token {{tokens}}",
  "execution.activity.usage.tokens.other": "Reported tokens {{tokens}}",
  "execution.activity.usage.partial": "Partial coverage from the loaded sessions.",
  "execution.activity.usage.unavailable": "Usage is unavailable for the loaded sessions.",
  "execution.activity.usage.source": "Server-reported accounting, not a provider invoice.",
