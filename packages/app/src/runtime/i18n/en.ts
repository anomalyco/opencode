...
export const dict = {
  ...
  "settings.extensions.skills.enabled": "Enabled",
  "settings.extensions.skills.disabled": "Disabled",
  "settings.extensions.skills.toggle": "Enable {{name}}",
  "settings.extensions.skills.updateFailed": "Could not update {{name}}. Please try again.",
