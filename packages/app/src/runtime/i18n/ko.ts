export const dict = {
  ...
  "session.queue.attachments": "+ 첨부 파일",
  ...
  "settings.appearance.row.projectName.title": "프로젝트 이름 표시",
  "settings.appearance.row.projectName.description": "수직 탭과 모바일 탭 서랍에 프로젝트 이름 표시",
  ...
  "settings.timeline.advanced.explainer": "그룹화된 활동은 사용됨으로 들어갑니다. 세부정보는 그룹 개설 후 적용됩니다.",
  "settings.timeline.activity": "활동",
  ...
  "settings.timeline.placement.title": "놓기",
  "settings.timeline.placement.separate": "분리된",
  "settings.timeline.placement.grouped": "그룹화됨",
  "settings.timeline.placement.hidden": "숨겨진",
  "settings.timeline.expansion.title": "세부",
  "settings.timeline.expansion.collapsed": "축소됨",
  "settings.timeline.expansion.expanded": "퍼지는",
