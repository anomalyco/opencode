export const dict = {
  ...
  "settings.timeline.advanced.explainer":
    "La actividad agrupada aparece en Usado. Los detalles se aplican después de abrir el grupo.",
  "settings.timeline.activity": "Actividad",
  ...
  "settings.timeline.placement.title": "Ubicación",
  "settings.timeline.placement.separate": "Separado",
  "settings.timeline.placement.grouped": "Agrupado",
  "settings.timeline.placement.hidden": "Oculto",
  "settings.timeline.expansion.title": "Detalles",
  "settings.timeline.expansion.collapsed": "Contraído",
  "settings.timeline.expansion.expanded": "Expandido",
  ...
  "session.queue.attachments": "+ archivos adjuntos",
