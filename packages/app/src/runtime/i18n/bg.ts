export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Работните дървета с неслети промени, свързани сесии или активни местоположения ще бъдат запазени.",
  ...
  "session.location.worktree": "Изберете работно дърво",
  "session.location.worktreesFailed": "Работните дървета не можаха да се заредят",
  "session.location.moving": "Преместване на сесията…",
  "dialog.server.menu.hide": "Скриване от списъка с проекти",
  "dialog.server.menu.show": "Показване в списъка с проекти",
  "session.queue.count.one": "{{count}} заявка на опашката",
  "session.queue.count.other": "{{count}} заявки на опашката",
  "session.queue.steer": "Насочи",
  "session.queue.send": "Изпрати",
  "session.queue.steerTooltip": "Изпращане без прекъсване",
  "session.queue.remove": "Премахни",
  "session.queue.reorder": "Пренареждане на заявката в опашката",
  "session.new.worktree.creating": "Създаване на работно дърво",
  "settings.backToApp": "Назад към приложението",
  "settings.appearance.section.experimental": "Експериментални",
  "settings.appearance.row.tabs.title": "Раздели",
  "settings.appearance.row.tabs.description": "Изберете как да бъдат подредени разделите на сесиите",
  "settings.appearance.row.tabs.horizontal": "Хоризонтално",
  "settings.appearance.row.tabs.vertical": "Вертикално",
  "settings.general.row.followUpBehavior.title": "Поведение на последващите съобщения",
  "settings.general.row.followUpBehavior.description":
    "Изберете дали последващите съобщения да се поставят на опашка, или да насочват текущия ход. Използвайте {{keybind}} за превключване.",
  "settings.general.row.followUpBehavior.queue": "Поставяне на опашка",
  "settings.general.row.followUpBehavior.steer": "Насочване",
  "settings.general.row.reasoningMode.title": "Разсъждение на модела",
  "settings.general.row.reasoningMode.description":
    "Изберете как да се показва разсъждението на модела във времевата линия",
  "settings.general.row.reasoningMode.hidden": "Скрито",
  "settings.general.row.reasoningMode.compact": "Компактно",
  "settings.general.row.reasoningMode.full": "Пълно",
  "session.new.workspace.createFrom": "Създаване от клон",
  "session.new.workspace.branch.search.placeholder": "Търсене на клонове",
  "desktop.onboarding.defaultProject": "Проект по подразбиране",
  "toast.migration.progress.clearingOldEvents": "Изчистване на стари събития",
  "toast.migration.progress.migratingSessions": "Мигриране на сесии",
  "session.new.workspace.existingLabel": "Работно дърво",
  "home.projects.all": "Всички проекти",
  "session.tab.files": "Файлове",
  "session.files.openTabs": "Отворени файлове",
  "session.tab.usage": "Използване",
  "session.view.select": "Изглед на сесията",
  "session.background.moveTasks": "Преместете {{tasks}} на заден план",
  "session.background.moveRunning": "Преместване на заден план",
  "session.background.inBackground": "Работи {{tasks}} във фонов режим",
  "session.background.tasksRunning.one": "{{count}} фонова задача се изпълнява",
  "session.background.tasksRunning.other": "{{count}} фонови задачи се изпълняват",
  "session.background.combine": "{{first}} и {{second}}",
  "session.background.shell.one": "{{count}} обвивка",
  "session.background.shell.other": "{{count}} обвивки",
  "session.background.subagent.one": "{{count}} подагент",
  "session.background.subagent.other": "{{count}} подагенти",
  "session.timeline.working": "Работи",
  "session.review.wrapLines": "Пренасяне на редовете",
  "session.websearch.title": "Уеб търсене на трети страни",
  "session.websearch.description": "Изберете доставчика на търсене, който агентите използват за търсене в мрежата",
  "session.websearch.provider": "Доставчик на търсене",
  "session.websearch.any": "Всеки",
  "session.websearch.disable": "Не използвайте търсене",
  "session.websearch.enable": "Активиране",
  "session.websearch.loadFailed": "Не можа да зареди доставчиците на търсене.",
  "session.websearch.empty": "Няма налични доставчици на търсене.",
  "session.websearch.failed": "Не можах да запазя вашия избор. Моля, опитайте отново.",
  "session.websearch.retry": "Опитайте отново",
  "session.new.worktree.draftPlaceholder": "Напишете последващо съобщение, докато работното дърво се подготвя…",
  "session.search.placeholder": "Намери...",
  "session.search.noResults": "Няма съвпадения",
  "titlebar.tabs": "Раздели",
  "titlebar.channel.local": "Локално",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Превключване на инструментите за отстраняване на грешки",
  "settings.tab.experimental": "Експериментален",
  "settings.experimental.description": "Опитайте експериментални функции",
  "settings.tab.about": "Относно",
  "settings.about.version": "Версия {{version}}",
  "settings.about.devVersion": "развитие",
  "settings.about.license": "Издаден под MIT License",
  "settings.about.writtenBy": "Написано от",
  "settings.about.illustratedBy": "Илюстрирано от",
  "settings.about.and": "и",
  "settings.about.otherContributor.one": "{{count}} друг",
  "settings.about.otherContributor.other": "{{count}} други",
  "settings.about.firstPublished": "Първо публикувано в Мисури, САЩ",
  "settings.about.firstIllustrated": "Първо илюстрирано в Лондон, Англия",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, агентът за кодиране с отворен код",
  "settings.about.trademark": "OpenCode е регистрирана търговска марка на Anomaly Innovations, Inc.",
  ...
  "settings.timeline.description":
    "Изберете колко активност да се показва във времевата линия. Съобщенията остават видими.",
  "settings.timeline.preset.everything": "Всичко",
  "settings.timeline.preset.detailed": "Подробно",
  "settings.timeline.preset.compact": "Компактен",
  ...
  "settings.timeline.description.custom":
    "Използвайте избраното от вас разположение и подробности за всяка категория дейност.",
  "settings.timeline.custom": "Персонализирано",
  "settings.timeline.advanced": "Разширено",
  "settings.timeline.advanced.description": "Задайте разположение и подробности за всяка категория дейност.",
  "settings.timeline.category.shell": "Черупка",
  "settings.timeline.category.edit": "Редакции",
  "settings.timeline.category.thinking": "Мислене",
  "settings.timeline.category.subagents": "Субагенти",
  "settings.timeline.category.notices": "Бележки",
  "settings.timeline.category.tools": "Други инструменти",
  "settings.general.row.mobileDiffWrap.description":
    "Увийте дълги редове в мобилни разлики, вместо да превъртате хоризонтално",
  "provider.connect.error.unsupportedFields": "Този формуляр за удостоверяване съдържа неподдържани полета",
  "session.review.filesChangedCount.one": "{{count}} файл е променен",
  "session.review.filesChangedCount.other": "{{count}} файла са променени",
  "settings.about.writtenByNames": "Написано от {{names}}",
  "settings.about.illustratedByNames": "Илюстрирано от {{names}}",
  "ssh.label": "SSH",
  "ssh.offline":
    "Няма връзка с {{host}}. Черновата ви е запазена; работата на отдалечения сървър може все още да се изпълнява.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Добавяне на SSH сървър",
  "ssh.server.menu.label": "SSH сървър",
  "ssh.target": "Хост или SSH команда",
  "ssh.connect": "Свързване",
  "ssh.connectTo": "Свързване с {{host}}",
  "ssh.authenticate": "SSH удостоверяване",
  "ssh.action.authenticate": "Удостоверяване",
  "ssh.session.disconnected": "SSH връзката не е активна",
  "ssh.session.connecting": "Свързване с SSH сървъра",
  "ssh.session.reconnectDescription":
    "Свържете се отново, за да видите тази сесия и да продължите работа. Отдалечената ви сесия е запазена.",
  "ssh.session.reconnect": "Повторно свързване",
  "ssh.authenticationRequired": "Изисква се удостоверяване за {{host}}",
  "ssh.trust": "Доверяване и свързване",
  "ssh.continue": "Продължаване",
  "ssh.retry": "Повторен опит",
  "ssh.update": "Актуализиране и повторно свързване",
  "ssh.openProject": "Отваряне на проект",
  "ssh.project": "Отваряне на проект на {{host}}",
  "ssh.disconnect": "Прекъсване на връзката",
  "ssh.forget": "Забравяне на връзката",
  "ssh.stage.disconnected": "Връзката е прекъсната. Отдалеченият сървър продължава да работи.",
  "ssh.stage.connecting": "Свързване чрез SSH…",
  "ssh.stage.checking": "Проверка на OpenCode…",
  "ssh.stage.downloading": "Изтегляне на сървъра…",
  "ssh.stage.uploading": "Качване на сървъра…",
  "ssh.stage.starting": "Свързване с OpenCode…",
  "ssh.stage.ready": "Свързано",
  "ssh.stage.authentication": "Изисква се удостоверяване",
  "ssh.stage.incompatible": "Изисква се актуализация на сървъра",
  "ssh.stage.failed": "Неуспешно свързване",
  "ssh.error.input":
    "Въведете хост или команда за SSH връзка. Не се допускат отдалечени команди и неподдържани SSH опции.",
  "ssh.error.connection": "SSH връзката не можа да бъде установена. Проверете мрежата и SSH конфигурацията си.",
  "ssh.error.platform":
    "Тази отдалечена платформа не се поддържа. Автоматичната настройка в момента изисква Linux или macOS на x64 или arm64.",
  "ssh.error.version":
    "Отдалечената услуга трябва да съответства на тази версия на настолното приложение, преди да се свържете.",
  "ssh.error.install":
    "Отдалеченият сървър не можа да бъде инсталиран. Проверете свързаността, свободното място и дали tar е инсталиран.",
  "ssh.error.unpublished":
    "За тази версия на настолното приложение няма публикуван отдалечен сървър. За развойни компилации инсталирайте и стартирайте V2 на хоста, след което опитайте отново.",
  "ssh.error.service": "SSH връзката е установена, но сървърът на OpenCode не е готов.",
  "ssh.error.host-key":
    "Самоличността на хоста не можа да бъде потвърдена. Проверете отпечатъка му, преди да актуализирате познатите SSH хостове.",
  "ssh.error.ssh-missing": "OpenSSH не е намерен. Инсталирайте OpenSSH клиент и се уверете, че ssh е наличен в PATH.",
  "command.browser.open": "Отваряне на браузъра",
  "command.browser.reload": "Презареждане на страницата в браузъра",
  "command.session.summary.toggle": "Превключване на обобщението",
  "common.color.orange": "оранжево",
  "common.color.yellow": "жълто",
  "common.color.cyan": "циан",
  "common.color.green": "зелено",
  "common.color.red": "червено",
  "common.color.pink": "розово",
  "common.color.blue": "синьо",
  "common.color.purple": "лилаво",
  "common.color.gray": "сиво",
  "mcp.auth.interactiveForm": "MCP сървърът {{name}} изисква интерактивен формуляр за удостоверяване",
  "server.connect.title": "Свързване със сървър",
  "server.connect.description": "Въведете адреса и паролата на сървъра, за да започнете.",
  ...
  "dialog.server.menu.remove": "Премахване",
  "file.error.notFound": "Файлът не е намерен: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Мигриране на сесии {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Мигриране на сесии {{current}}/{{total}}",
  "toast.migration.progress.working": "Мигриране на данни",
  "toast.migration.progress.working.current": "Мигриране на данни {{current}}",
  "toast.migration.progress.working.progress": "Мигриране на данни {{current}}/{{total}}",
  "home.workspaceTip": "Започнете следващата сесия в ново работно пространство, за да запазите промените изолирани",
  "session.tab.browser": "Браузър",
  "session.tab.add": "Добавяне на раздел",
  "session.queue.attachments.one": "Плюс {{count}} прикачен файл",
  "session.queue.attachments.other": "Плюс {{count}} прикачени файла",
  "session.browser.address": "Адрес на браузъра",
  "session.browser.replaced": "Управлението на браузъра е преместено в друг прозорец на настолното приложение.",
  "session.browser.unsupported": "Това настолно приложение не поддържа панела на браузъра.",
  "session.browser.suspended": "Браузърът е спрян временно. Взаимодействайте с тази сесия, за да се свържете отново.",
  "session.browser.address.placeholder": "Въведете URL адрес",
  "settings.backToSettings": "Назад към настройките",
  "settings.backToProjects": "Назад към проектите",
  "settings.search.placeholder": "Търсене",
  "settings.search.results": "Резултати от настройките",
  "settings.search.group.pages": "Страници",
  "settings.search.group.settings": "Настройки",
  "settings.search.group.projects": "Проекти",
  "settings.search.group.servers": "Сървъри",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Няма резултати за {{query}}",
  "settings.search.empty.query": "„{{query}}“",
  "settings.search.refine": "Стеснете търсенето, за да видите по-конкретни резултати.",
  "settings.server.description": "Управление на връзката и предпочитанията на този сървър",
  "settings.server.section.connection": "Връзка",
  "settings.server.preferences.websearch.title": "Търсене чрез трета страна",
  "settings.server.preferences.websearch.description":
    "Изберете доставчика, който агентите използват за търсене в уеб пространството",
  "settings.projects.search.placeholder": "Търсене на проекти",
  "project.settings.name.title": "Име на проекта",
  "project.settings.name.description": "Името, което се показва за този проект в OpenCode",
  "project.settings.icon.description": "Препоръчително: 128×128 px. Щракнете или плъзнете, за да качите изображение.",
  "project.settings.color.description":
    "Използва се за иконата на проекта, когато няма зададено персонализирано изображение",
  "project.settings.worktree.startup.description": "Изпълнява се веднъж след създаването на ново работно дърво",
  "project.settings.worktree.startup.hint.base": "Използвайте $OPENCODE_WORKTREE_BASE за основното работно дърво.",
  "project.settings.worktree.startup.hint.new": "Използвайте $OPENCODE_WORKTREE_PATH за новото работно дърво.",
  "project.settings.extensions.empty.mcps.title": "Все още няма MCP сървъри",
  "project.settings.extensions.empty.mcps.description": "Наличните за OpenCode MCP сървъри ще се показват тук",
  "project.settings.extensions.empty.plugins.title": "Все още няма добавки",
  "project.settings.extensions.empty.plugins.description": "Наличните за OpenCode добавки ще се показват тук",
  "project.settings.extensions.empty.skills.title": "Все още няма умения",
  "project.settings.extensions.empty.skills.description": "Наличните за OpenCode умения ще се показват тук",
  "project.settings.extensions.lsp.configured": "Конфигурирани езикови сървъри",
  "project.settings.extensions.lsp.status.enabled": "Активиран в конфигурацията",
  "project.settings.extensions.lsp.status.disabled": "Деактивиран в конфигурацията",
  "project.settings.extensions.lsp.empty.title": "Няма конфигурирани езикови сървъри",
  "project.settings.extensions.lsp.empty.description":
    "Езиковите сървъри, конфигурирани за този проект, ще се показват тук",
  "project.settings.extensions.lsp.disabled.title": "Езиковите сървъри са деактивирани",
  "project.settings.extensions.lsp.disabled.description": "LSP е деактивиран в конфигурацията на този проект",
  "project.settings.extensions.lsp.loadFailed": "Конфигурацията на езиковите сървъри не можа да бъде заредена",
  "project.settings.extensions.lsp.retry": "Повторен опит",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Групиране",
  "settings.timeline.collapse": "Свиване",
  "settings.timeline.visibility.show": "Показване",
  "settings.timeline.visibility.hide": "Скриване",
  ...
  "settings.workspaces.sessions.filtered.one": "{{count}} сесия",
  "settings.workspaces.sessions.filtered.other": "{{count}} сесии",
  "settings.workspaces.deleteAll.confirm.one": "Това ще изтрие окончателно {{count}} избрано работно дърво.",
  "settings.workspaces.deleteAll.confirm.other": "Това ще изтрие окончателно {{count}} избрани работни дървета.",
  "settings.workspaces.deleteWithoutSessions": "Изтриване на работни дървета без сесии",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Това ще изтрие окончателно {{count}} работно дърво без свързани сесии.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Това ще изтрие окончателно {{count}} работни дървета без свързани сесии.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Работните дървета с неслети промени или активни местоположения ще бъдат запазени.",
  "settings.workspaces.delete.button": "Изтриване на работните дървета",
  "workspace.lifecycle.deleting": "Изтриване…",
  "session.summary.tooltip": "Обобщение",
  "session.summary.server": "Разширения",
  "session.summary.chooseProject": "Изберете проект",
  "session.summary.mcp.onCreation": "Прилага се при създаването на работното дърво",
  "session.summary.mcp.prepareFailed": "MCP сървърите не можаха да бъдат подготвени",
  "session.summary.mcp.unavailable": "MCP сървърът {{name}} не е наличен в това работно дърво.",
  "session.summary.mcp.signInBeforeSend": "Влезте в {{name}}, преди да изпратите подканата.",
  "session.summary.mcp.notReady":
    "MCP сървърът {{name}} не е готов. Отстранете проблема с връзката му, преди да изпратите подканата.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Конфигурирани MCP сървъри",
  "session.summary.plugins": "Добавки",
  "session.summary.plugins.configured": "Конфигурирани добавки",
  "session.summary.skills": "Умения",
  "session.summary.skills.configured": "Конфигурирани умения",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Неуспешно",
  "session.summary.retry": "Повторен опит",
  "session.summary.connecting": "Свързване…",
  "session.summary.needsAuth": "Изисква се влизане",
  "session.summary.configure": "Конфигурационен файл",
  "session.summary.copyConfigPath": "Копиране на пътя до конфигурационния файл",
  "session.summary.configFileMissing": "Не е намерен конфигурационен файл",
  "session.summary.mcp.empty": "Няма конфигурирани MCP сървъри",
  "session.summary.mcp.add": "Добавете сървъри в opencode.json",
  "session.summary.plugins.manage": "Управление на добавките в opencode.json",
  "session.summary.plugins.empty": "Няма конфигурирани добавки",
  "session.summary.plugins.add": "Добавете добавки в opencode.json",
  "session.summary.skills.manage": "Управление на уменията в opencode.json",
  "session.summary.skills.empty": "Няма конфигурирани умения",
  "session.summary.skills.add": "Добавете умения в opencode.json",
  "session.summary.lsp.configured": "Конфигурирани LSP сървъри",
  "session.summary.lsp.empty": "Няма конфигурирани LSP сървъри",
  "session.summary.lsp.manage": "Управление на LSP в opencode.json",
  "workspace.delete.location": "Местоположение",
  "command.debugBar.toggle": "Превключване на лентата за отстраняване на грешки",
  "command.session.location.cycle": "Смяна на местоположението на сесията",
  "dialog.provider.anthropic.note": "Директен достъп до моделите Claude чрез API ключ",
  "provider.connect.title.anthropicProMax": "Вход с Anthropic",
  "prompt.toast.uploading.cancel": "Отказ от качването",
  "prompt.toast.uploading.cancelFile": "Отказ от качването на {{filename}}",
  "prompt.toast.uploadFailed.title": "Качването е неуспешно",
  "session.browser.empty.title": "Въведете URL адрес",
  "session.browser.empty.description": "Или подайте подкана „Отвори в браузъра на приложението“",
  "session.browser.failed.title": "URL адресът не е достъпен",
  "session.browser.failed.description": "Проверете URL адреса и връзката си, след което опитайте отново.",
  "debugBar.providerAriaLabel": "Диагностика на производителността на доставчика",
  "debugBar.ttft.tip": "Време от изпращането на заявката към доставчика до първия изход от модела.",
  "debugBar.ttfa.tip": "Време от изпращането на заявката към доставчика до първия текст на отговора.",
  "debugBar.tps.tip": "Изходни токени в секунда след първия изход от модела.",
  "debugBar.e2e.tip": "Време от изпращането на заявката към доставчика до края на потока с отговора.",
  "settings.updates.action.download": "Изтегляне на OpenCode",
  "settings.updates.migration.title": "Преминаване от Beta към Stable",
