export const dict = {
  ...
  "session.background.shell.other": "{{count}} cangkang",
  ...
  "settings.appearance.row.projectName.title": "Tampilkan nama proyek",
  "settings.appearance.row.projectName.description": "Tampilkan nama proyek di tab vertikal dan laci tab seluler",
  ...
  "settings.timeline.advanced.explainer":
    "Aktivitas yang dikelompokkan masuk ke Digunakan. Detail berlaku setelah pembukaan grup.",
  "settings.timeline.activity": "Aktivitas",
  ...
  "settings.timeline.placement.separate": "Memisahkan",
  "settings.timeline.placement.grouped": "Dikelompokkan",
  "settings.timeline.placement.hidden": "Tersembunyi",
  "settings.timeline.expansion.title": "Detail",
  "settings.timeline.expansion.collapsed": "Runtuh",
  "settings.timeline.expansion.expanded": "Diperluas",
