...
export const dict = {
  ...
  "settings.timeline.advanced.explainer":
    "Gruppert aktivitet vises under Brukt. Detaljer gjelder etter at gruppen er åpnet.",
  "settings.timeline.activity": "Aktivitet",
  ...
  "settings.timeline.placement.title": "Plassering",
  "settings.timeline.placement.separate": "Separat",
  "settings.timeline.placement.grouped": "Gruppert",
  "settings.timeline.placement.hidden": "Skjult",
  "settings.timeline.expansion.title": "Detaljer",
  "settings.timeline.expansion.collapsed": "Skjult",
  "settings.timeline.expansion.expanded": "Utvidet",
  ...
  "session.queue.attachments": "+ vedlegg",
