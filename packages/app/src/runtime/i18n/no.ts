...
export const dict = {
  "common.color.orange": "oransje",
  "common.color.yellow": "gul",
  "common.color.cyan": "cyan",
  "common.color.green": "grønn",
  "common.color.red": "rød",
  "common.color.pink": "rosa",
  "common.color.blue": "blå",
  "common.color.purple": "lilla",
  "common.color.gray": "grå",
  "toast.migration.progress.migratingSessions.current": "Migrerer økter: {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migrerer økter: {{current}}/{{total}}",
  ...
  "session.browser.unsupported": "Denne skrivebordsappen støtter ikke nettleserpanelet.",
  "ssh.label": "SSH",
  "ssh.offline": "Ikke koblet til {{host}}. Utkastet ditt er bevart; eksternt arbeid kan fortsatt kjøres.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Legg til SSH-server",
  "ssh.server.menu.label": "SSH server",
  "ssh.target": "Vert eller SSH kommando",
  "ssh.connect": "Koble til",
  "ssh.connectTo": "Koble til {{host}}",
  "ssh.authenticate": "SSH-autentisering",
  "ssh.action.authenticate": "Autentiser",
  "ssh.session.disconnected": "SSH-tilkobling inaktiv",
  "ssh.session.connecting": "Kobler til SSH server",
  "ssh.session.reconnectDescription":
    "Koble til på nytt for å se denne økten og fortsette å jobbe. Den eksterne økten din er bevart.",
  "ssh.session.reconnect": "Koble til på nytt",
  "ssh.authenticationRequired": "Autentisering kreves for {{host}}",
  "ssh.trust": "Stol på og koble til",
  "ssh.continue": "Fortsett",
  "ssh.retry": "Prøv på nytt",
  "ssh.update": "Oppdater og koble til på nytt",
  "ssh.openProject": "Åpent prosjekt",
  "ssh.project": "Åpent prosjekt på {{host}}",
  "ssh.disconnect": "Koble fra",
  "ssh.forget": "Glem tilkobling",
  "ssh.stage.disconnected": "Koblet fra. Den eksterne serveren kjører igjen.",
  "ssh.stage.connecting": "Kobler over SSH...",
  "ssh.stage.checking": "Sjekker OpenCode …",
  "ssh.stage.downloading": "Laster ned server …",
  "ssh.stage.uploading": "Laster opp serveren …",
  "ssh.stage.starting": "Kobler til OpenCode...",
  "ssh.stage.ready": "Tilkoblet",
  "ssh.stage.authentication": "Autentisering kreves",
  "ssh.stage.incompatible": "Serveroppdatering kreves",
  "ssh.stage.failed": "Tilkobling mislyktes",
  "ssh.error.input":
    "Skriv inn en verts- eller SSH-tilkoblingskommando. Fjernkommandoer og ikke-støttede SSH-alternativer er ikke tillatt.",
  "ssh.error.connection": "Kunne ikke opprette SSH-tilkoblingen. Sjekk nettverket og SSH-konfigurasjonen.",
  "ssh.error.platform":
    "Denne eksterne plattformen støttes ikke. Automatisk oppsett krever for øyeblikket Linux eller macOS på x64 eller arm64.",
  "ssh.error.version": "Den eksterne tjenesten må samsvare med denne skrivebordsversjonen før tilkobling.",
  "ssh.error.install":
    "Kunne ikke installere den eksterne serveren. Sjekk tilkobling, diskplass og at tar er installert.",
  ...
  "ssh.error.service": "SSH koblet til, men OpenCode-serveren ble ikke klar.",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing":
    "OpenSSH ble ikke funnet. Installer en OpenSSH-klient og sørg for at ssh er tilgjengelig på PATH.",
  "command.browser.open": "Åpne nettleseren",
  "command.browser.reload": "Last nettlesersiden på nytt",
  "command.session.summary.toggle": "Slå sammendrag av/på",
  "mcp.auth.interactiveForm": "MCP server {{name}} krever et interaktivt autentiseringsskjema",
  "server.connect.title": "Koble til en server",
  "server.connect.description": "Skriv inn serveradressen og passordet for å komme i gang.",
  ...
  "file.error.notFound": "Filen ble ikke funnet: {{name}}",
  "home.workspaceTip": "Start neste økt i et nytt arbeidsområde for å holde endringer isolert",
  "session.tab.browser": "Nettleser",
  "session.tab.add": "Legg til fane",
  "session.queue.attachments.one": "Pluss {{count}} vedlegg",
  "session.queue.attachments.other": "Pluss {{count}} vedlegg",
  "session.browser.address": "Nettleseradresse",
  "session.browser.replaced": "Nettleserkontrollen flyttet til et annet skrivebordsvindu.",
  "session.browser.suspended": "Nettleseren er suspendert. Samhandle med denne økten for å koble til på nytt.",
  "session.browser.address.placeholder": "Skriv inn URL",
  "settings.backToSettings": "Tilbake til innstillinger",
  "settings.backToProjects": "Tilbake til prosjekter",
  "settings.search.placeholder": "Søk",
  "settings.search.results": "Innstillinger resultater",
  "settings.search.group.pages": "Sider",
  "settings.search.group.settings": "Innstillinger",
  "settings.search.group.projects": "Prosjekter",
  ...
  "settings.search.refine": "Begrens søket for å se mer spesifikke resultater.",
  "settings.server.description": "Administrer denne serverens tilkobling og preferanser",
  "settings.server.section.connection": "Tilkobling",
  "settings.server.preferences.websearch.title": "Tredjepartssøk",
  "settings.server.preferences.websearch.description": "Velg søkeleverandøren agenter bruker til å søke på nettet",
  "settings.projects.search.placeholder": "Søk etter prosjekter",
  "project.settings.name.title": "Prosjektnavn",
  "project.settings.name.description": "Navnet som vises for dette prosjektet gjennom hele OpenCode",
  "project.settings.icon.description": "Anbefalt: 128×128px. Klikk eller dra for å laste opp et bilde.",
  "project.settings.color.description": "Brukes for prosjektikonet når det ikke er angitt noe egendefinert bilde",
  "project.settings.worktree.startup.description": "Kjører én gang etter å ha opprettet et nytt arbeidsområde",
  "project.settings.worktree.startup.hint.base": "Bruk $OPENCODE_WORKTREE_BASE for basisarbeidsområdet.",
  "project.settings.worktree.startup.hint.new": "Bruk $OPENCODE_WORKTREE_PATH for det nye arbeidsområdet.",
  "project.settings.extensions.empty.mcps.title": "Ingen MCPs ennå",
  "project.settings.extensions.empty.mcps.description": "MCPs tilgjengelig for OpenCode vil vises her",
  "project.settings.extensions.empty.plugins.title": "Ingen plugins ennå",
  "project.settings.extensions.empty.plugins.description": "Plugins tilgjengelig for OpenCode vil vises her",
  "project.settings.extensions.empty.skills.title": "Ingen ferdigheter ennå",
  "project.settings.extensions.empty.skills.description": "Ferdigheter tilgjengelig for OpenCode vil vises her",
  "project.settings.extensions.lsp.configured": "Konfigurerte språkservere",
  "project.settings.extensions.lsp.status.enabled": "Aktivert i konfig",
  "project.settings.extensions.lsp.status.disabled": "Deaktivert i konfig",
  "project.settings.extensions.lsp.empty.title": "Ingen språkservere er konfigurert",
  "project.settings.extensions.lsp.empty.description":
    "Språkservere som er konfigurert for dette prosjektet vil vises her",
  "project.settings.extensions.lsp.disabled.title": "Språkservere er deaktivert",
  "project.settings.extensions.lsp.disabled.description": "LSP er deaktivert i dette prosjektets konfigurasjon",
  "project.settings.extensions.lsp.loadFailed": "Kunne ikke laste inn språkserverkonfigurasjonen",
  "project.settings.extensions.lsp.retry": "Prøv på nytt",
  ...
  "settings.timeline.grouped.label": "{{activity}} gruppert",
  "settings.timeline.collapsed.label": "{{activity}} kollapset",
  "settings.general.row.browserPane.title": "Nettleser",
  "settings.general.row.browserPane.description":
    "Tillat agenter å åpne og kontrollere en utviklingsnettleser i appen.",
  "session.new.workspace.search.empty": "Ingen matchende arbeidsområder",
  "settings.workspaces.description": "Se gjennom arbeidsområder og administrer diskbruk",
  "settings.workspaces.empty.description": "Arbeidstre opprettet i OpenCode vil vises her",
  "settings.workspaces.sessions.filtered.one": "{{count}} økt",
  "settings.workspaces.sessions.filtered.other": "{{count}} økter",
  "settings.workspaces.deleteAll.confirm.one": "Dette vil permanent slette {{count}} valgt arbeidsområde.",
  "settings.workspaces.deleteAll.confirm.other": "Dette vil permanent slette {{count}} valgte arbeidsområder.",
  "settings.workspaces.deleteWithoutSessions": "Slett arbeidsområder uten økter",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Dette vil permanent slette {{count}} arbeidsområde uten tilknyttede økter.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Dette vil permanent slette {{count}} arbeidsområder uten tilknyttede økter.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Arbeidstre med usammenslåtte endringer eller aktive lokasjoner vil bli beholdt.",
  "settings.workspaces.delete.button": "Slett arbeidsområder",
  "workspace.lifecycle.deleting": "Sletter …",
  "session.summary.tooltip": "Sammendrag",
  "session.summary.server": "Utvidelser",
  "session.summary.chooseProject": "Velg et prosjekt",
  "session.summary.mcp.onCreation": "Gjelder når arbeidsområdet er opprettet",
  "session.summary.mcp.prepareFailed": "Kunne ikke klargjøre MCP-servere",
  "session.summary.mcp.unavailable": "MCP server {{name}} er ikke tilgjengelig i dette arbeidsområdet.",
  "session.summary.mcp.signInBeforeSend": "Logg på {{name}} før du sender forespørselen.",
  "session.summary.mcp.notReady": "MCP-serveren {{name}} er ikke klar. Løs tilkoblingen før du sender forespørselen.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfigurerte MCP-servere",
  "session.summary.plugins": "Plugins",
  "session.summary.plugins.configured": "Konfigurerte plugins",
  "session.summary.skills": "Ferdigheter",
  "session.summary.skills.configured": "Konfigurerte ferdigheter",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Mislyktes",
  "session.summary.retry": "Prøv på nytt",
  "session.summary.connecting": "Kobler til …",
  "session.summary.needsAuth": "Pålogging kreves",
  "session.summary.configure": "Konfigurasjonsfil",
  "session.summary.copyConfigPath": "Kopier konfigurasjonsfilbanen",
  "session.summary.configFileMissing": "Finner ingen konfigurasjonsfil",
  "session.summary.mcp.empty": "Ingen MCP-servere er konfigurert",
  "session.summary.mcp.add": "Legg til servere i opencode.json",
  "session.summary.plugins.manage": "Administrer plugins i opencode.json",
  "session.summary.plugins.empty": "Ingen plugins er konfigurert",
  "session.summary.plugins.add": "Legg til plugins i opencode.json",
  "session.summary.skills.manage": "Administrer ferdigheter i opencode.json",
  "session.summary.skills.empty": "Ingen ferdigheter konfigurert",
  "session.summary.skills.add": "Legg til ferdigheter i opencode.json",
  "session.summary.lsp.configured": "Konfigurert LSPs",
  "session.summary.lsp.empty": "Ingen LSP-servere er konfigurert",
  "session.summary.lsp.manage": "Administrer LSP i opencode.json",
  "workspace.delete.location": "Beliggenhet",
  "settings.workspaces.deleteAll.warning":
    "Arbeidsområder med usammenslåtte endringer, tilknyttede økter eller aktive plasseringer beholdes.",
  "provider.connect.error.unsupportedFields": "Dette autentiseringsskjemaet inneholder felt som ikke støttes",
  "session.review.filesChangedCount.one": "{{count}} fil endret",
  "session.review.filesChangedCount.other": "{{count}} filer endret",
  "settings.about.writtenByNames": "Skrevet av {{names}}",
  "settings.about.illustratedByNames": "Illustrert av {{names}}",
  "home.projects.all": "Alle prosjekter",
  "session.tab.files": "Filer",
  "session.files.openTabs": "Åpne filer",
  "session.tab.usage": "Bruk",
  ...
  "session.background.tasksRunning.one": "{{count}} bakgrunnsoppgave kjører",
  "session.background.tasksRunning.other": "{{count}} bakgrunnsoppgaver kjører",
  ...
  "session.websearch.disable": "Ikke bruk søk",
  "session.websearch.enable": "Aktiver",
  "session.websearch.loadFailed": "Kunne ikke laste søkeleverandører.",
  "session.websearch.empty": "Ingen søkeleverandører er tilgjengelige.",
  "session.websearch.failed": "Kunne ikke lagre valget ditt. Prøv igjen.",
  "session.websearch.retry": "Prøv igjen",
  "session.new.worktree.draftPlaceholder": "Skriv et utkast til oppfølging mens worktree-et klargjøres…",
  ...
  "titlebar.toggleDebugTools": "Slå feilsøkingsverktøy av/på",
  "settings.tab.experimental": "Eksperimentell",
  "settings.experimental.description": "Prøv eksperimentelle funksjoner",
  "settings.tab.about": "Om",
  "settings.about.version": "Versjon {{version}}",
  "settings.about.devVersion": "utvikling",
  "settings.about.license": "Utgitt under MIT-lisensen",
  "settings.about.writtenBy": "Skrevet av",
  "settings.about.illustratedBy": "Illustrert av",
  "settings.about.and": "og",
  "settings.about.otherContributor.one": "{{count}} annen",
  "settings.about.otherContributor.other": "{{count}} andre",
  "settings.about.firstPublished": "Først utgitt i Missouri, USA",
  "settings.about.firstIllustrated": "Først illustrert i London, England",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, kodeagenten med åpen kildekode",
  "settings.about.trademark": "OpenCode er et registrert varemerke for Anomaly Innovations, Inc.",
  "settings.about.typeset": "Satt med Inter og IBM Plex Mono",
  "settings.about.tagline": "KI kan ikke bygge fantastisk programvare uten deg",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "settings.appearance.row.projectName.title": "Vis prosjektnavn",
  "settings.appearance.row.projectName.description": "Vis prosjektnavn i vertikale faner og mobilens faneskuff",
  "project.settings.title": "Rediger prosjekt",
  "settings.timeline.title": "Tidslinje",
  "settings.timeline.detail": "Tidslinjedetaljer",
  "settings.timeline.description": "Velg hvor mye aktivitet som vises på tidslinjen. Meldinger forblir synlige.",
  "settings.timeline.preset.everything": "Alt",
  "settings.timeline.preset.detailed": "Detaljert",
  "settings.timeline.preset.compact": "Kompakt",
  "settings.timeline.preset.quiet": "Rolig",
  "settings.timeline.preset.text-only": "Bare tekst",
  ...
  "settings.timeline.advanced": "Avansert",
  "settings.timeline.advanced.description": "Angi plassering og detaljer for hver aktivitetskategori.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Redigeringer",
  "settings.timeline.category.thinking": "Tenking",
  ...
  "desktop.onboarding.defaultProject": "Standardprosjekt",
  "session.location.unavailable": "Øktplasseringen er utilgjengelig",
  "session.location.description": "Velg en annen mappe for å fortsette denne økten.",
  "session.location.choose": "Velg mappe",
  "session.location.worktree": "Velg worktree",
  "session.location.worktreesFailed": "Kunne ikke laste inn worktrees",
  "session.location.moving": "Flytter økten…",
  "dialog.server.menu.hide": "Skjul fra prosjektlisten",
  "dialog.server.menu.show": "Vis i prosjektlisten",
  "session.queue.count.one": "{{count}} i kø",
  "session.queue.count.other": "{{count}} i kø",
  "session.queue.steer": "Styr",
  "session.queue.send": "Send",
  "session.queue.steerTooltip": "Send uten å avbryte",
  "session.queue.remove": "Fjern",
  "session.queue.reorder": "Endre rekkefølgen på ledeteksten i køen",
  "session.new.worktree.creating": "Oppretter worktree",
  ...
  "settings.appearance.row.tabs.description": "Velg hvordan øktfanene skal ordnes",
  "settings.appearance.row.tabs.horizontal": "Vannrett",
  "settings.appearance.row.tabs.vertical": "Loddrett",
  "settings.general.row.followUpBehavior.title": "Håndtering av oppfølginger",
  "settings.general.row.followUpBehavior.description":
    "Velg om oppfølginger skal legges i kø eller styre den gjeldende turen. Bruk {{keybind}} for å bytte.",
  "settings.general.row.followUpBehavior.queue": "Legg i kø",
  "settings.general.row.followUpBehavior.steer": "Styr",
  "settings.general.row.reasoningMode.title": "Modellresonnering",
  "settings.general.row.reasoningMode.description": "Velg hvordan modellresonnering vises i tidslinjen",
  ...
  "session.new.workspace.createFrom": "Opprett fra gren",
  "session.new.workspace.branch.search.placeholder": "Søk etter grener",
  ...
  "command.debugBar.toggle": "Vis eller skjul feilsøkingslinjen",
  "command.session.location.cycle": "Bytt øktplassering",
  "dialog.provider.anthropic.note": "Direkte tilgang til Claude-modeller via API-nøkkel",
  "provider.connect.title.anthropicProMax": "Logg på med Anthropic",
  "prompt.toast.uploading.percent": "{{percent}} %",
  "prompt.toast.uploading.cancel": "Avbryt opplasting",
  "prompt.toast.uploading.cancelFile": "Avbryt opplasting av {{filename}}",
  "prompt.toast.uploadFailed.title": "Opplasting mislyktes",
  "session.browser.empty.title": "Skriv inn URL",
  "session.browser.empty.description": "Eller be om «Åpne i appnettleseren»",
  "session.browser.failed.title": "URL-en kan ikke nås",
  "session.browser.failed.description": "Kontroller URL-en og tilkoblingen, og prøv på nytt.",
  "debugBar.providerAriaLabel": "Ytelsesdiagnostikk for leverandør",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Tid fra leverandørforespørselen sendes til den første modellutdataen.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Tid fra leverandørforespørselen sendes til den første svarteksten.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Utdatatokener per sekund etter den første modellutdataen.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Tid fra leverandørforespørselen sendes til svarstrømmen er avsluttet.",
  "settings.updates.action.download": "Last ned OpenCode",
  "settings.updates.migration.title": "Bytt fra Beta til Stabil",
