...
export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Vinnutré með ósameinuðum breytingum, tengdum lotum eða virkum stöðum verður haldið.",
  ...
  "session.location.unavailable": "Staðsetning setunnar er ekki tiltæk",
  "session.location.description": "Veldu aðra möppu til að halda þessari setu áfram.",
  "session.location.choose": "Velja möppu",
  "session.location.worktree": "Velja vinnutré",
  "session.location.worktreesFailed": "Ekki tókst að hlaða vinnutrjám",
  "session.location.moving": "Færi setu…",
  "dialog.server.menu.hide": "Fela á verkefnalista",
  "dialog.server.menu.show": "Sýna á verkefnalista",
  "session.queue.count.one": "{{count}} í biðröð",
  "session.queue.count.other": "{{count}} í biðröð",
  "session.queue.steer": "Stýra",
  "session.queue.send": "Senda",
  "session.queue.steerTooltip": "Senda án þess að rjúfa",
  "session.queue.remove": "Fjarlægja",
  "session.queue.reorder": "Endurraða kvaðningu í biðröð",
  "session.new.worktree.creating": "Bý til vinnutré",
  "settings.backToApp": "Til baka í forritið",
  "settings.appearance.section.experimental": "Tilraunir",
  "settings.appearance.row.tabs.title": "Flipar",
  "settings.appearance.row.tabs.description": "Veldu hvernig setuflipum er raðað",
  "settings.appearance.row.tabs.horizontal": "Lárétt",
  "settings.appearance.row.tabs.vertical": "Lóðrétt",
  "settings.general.row.followUpBehavior.title": "Hegðun eftirfylgnibeiðna",
  "settings.general.row.followUpBehavior.description":
    "Veldu hvort eftirfylgnibeiðnir fari í biðröð eða stýri núverandi umferð. Notaðu {{keybind}} til að skipta.",
  "settings.general.row.followUpBehavior.queue": "Setja í biðröð",
  "settings.general.row.followUpBehavior.steer": "Stýra",
  "settings.general.row.reasoningMode.title": "Röksemdafærsla líkans",
  "settings.general.row.reasoningMode.description": "Veldu hvernig röksemdafærsla líkansins birtist á tímalínunni",
  "settings.general.row.reasoningMode.hidden": "Falin",
  "settings.general.row.reasoningMode.compact": "Þjöppuð",
  "settings.general.row.reasoningMode.full": "Í heild",
  "session.new.workspace.createFrom": "Búa til úr grein",
  "session.new.workspace.branch.search.placeholder": "Leita að greinum",
  "toast.migration.progress.clearingOldEvents": "Hreinsa gamla atburði",
  "toast.migration.progress.migratingSessions": "Flyt setur",
  "session.new.workspace.existingLabel": "Vinnutré",
  "home.projects.all": "Öll verkefni",
  "session.tab.files": "Skrár",
  "session.files.openTabs": "Opna skrár",
  "session.tab.usage": "Notkun",
  "session.view.select": "Fundarsýn",
  "session.background.moveTasks": "Færðu {{tasks}} í bakgrunninn",
  "session.background.moveRunning": "Færa í bakgrunn",
  "session.background.inBackground": "Keyrir {{tasks}} í bakgrunni",
  "session.background.tasksRunning.one": "{{count}} bakgrunnsverkefni í gangi",
  "session.background.tasksRunning.other": "{{count}} bakgrunnsverkefni í gangi",
  ...
  "session.websearch.any": "Hvaða sem er",
  "session.websearch.disable": "Ekki nota leit",
  "session.websearch.enable": "Virkja",
  "session.websearch.loadFailed": "Ekki tókst að hlaða leitarþjónustum.",
  "session.websearch.empty": "Engar leitarveitur tiltækar.",
  "session.websearch.failed": "Ekki tókst að vista val þitt. Vinsamlegast reyndu aftur.",
  "session.websearch.retry": "Reyndu aftur",
  "session.new.worktree.draftPlaceholder": "Gerðu drög að eftirfylgni á meðan vinnutréð er í undirbúningi…",
  "session.search.placeholder": "Finndu…",
  "session.search.noResults": "Engar samsvaranir",
  "titlebar.tabs": "Flipar",
  "titlebar.channel.local": "Staðbundið",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Skiptu um villuleitarverkfæri",
  "settings.tab.experimental": "Tilraunakennt",
  "settings.experimental.description": "Prófaðu tilraunaeiginleika",
  "settings.tab.about": "Um",
  "settings.about.version": "Útgáfa {{version}}",
  "settings.about.devVersion": "þróunarútgáfa",
  "settings.about.license": "Gefið út undir MIT leyfinu",
  "settings.about.writtenBy": "Skrifað af",
  "settings.about.illustratedBy": "Myndskreytt af",
  "settings.about.and": "og",
  "settings.about.otherContributor.one": "{{count}} annað",
  "settings.about.otherContributor.other": "{{count}} aðrir",
  "settings.about.firstPublished": "Fyrst gefin út í Missouri í Bandaríkjunum",
  "settings.about.firstIllustrated": "Fyrst myndskreytt í London á Englandi",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, opinn kóðunaraðili",
  "settings.about.trademark": "OpenCode er skráð vörumerki Anomaly Innovations, Inc.",
  "settings.about.typeset": "Tegund í Inter og IBM Plex Mono",
  "settings.about.tagline": "AI getur ekki smíðað frábæran hugbúnað án þín",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "settings.appearance.row.projectName.title": "Sýndu nöfn verkefna",
  "settings.appearance.row.projectName.description": "Sýndu nöfn verkefna í lóðréttum flipa og farsímaflipaskúffunni",
  "project.settings.title": "Breyta verkefni",
  "settings.timeline.title": "Tímalína",
  "settings.timeline.detail": "Upplýsingar tímalínu",
  "settings.timeline.description": "Veldu hversu mikil virkni birtist á tímalínunni. Skilaboð haldast sýnileg.",
  "settings.timeline.preset.everything": "Allt",
  "settings.timeline.preset.detailed": "Ítarlegt",
  "settings.timeline.preset.compact": "Fyrirferðarlítill",
  "settings.timeline.preset.quiet": "Rólegt",
  "settings.timeline.preset.text-only": "Aðeins texti",
  ...
  "settings.timeline.custom": "Sérsniðin",
  "settings.timeline.advanced": "Ítarlegri",
  "settings.timeline.advanced.description": "Stilltu staðsetningu og upplýsingar fyrir hvern athafnaflokk.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Breytingar",
  ...
  "session.review.filesChangedCount.one": "{{count}} skrá breytt",
  "session.review.filesChangedCount.other": "{{count}} skrám breytt",
  "settings.about.writtenByNames": "Skrifað af {{names}}",
  "settings.about.illustratedByNames": "Myndskreytt af {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Ekki tengdur við {{host}}. Drög þín eru varðveitt; fjarvinna gæti enn verið í gangi.",
  "ssh.placeholder": "ssh notandi@example.com",
  "ssh.add": "Bæta við SSH miðlara",
  "ssh.server.menu.label": "SSH þjónn",
  "ssh.target": "Host eða SSH skipun",
  "ssh.connect": "Tengdu",
  "ssh.connectTo": "Tengstu {{host}}",
  "ssh.authenticate": "SSH auðkenning",
  "ssh.action.authenticate": "Staðfesta",
  "ssh.session.disconnected": "SSH tenging óvirk",
  "ssh.session.connecting": "Tengist SSH miðlara",
  "ssh.session.reconnectDescription":
    "Tengstu aftur til að skoða þessa lotu og halda áfram að vinna. Fjarlotan þín er varðveitt.",
  "ssh.session.reconnect": "Tengdu aftur",
  "ssh.authenticationRequired": "Auðkenning krafist fyrir {{host}}",
  "ssh.trust": "Treystu og tengdu",
  "ssh.continue": "Áfram",
  "ssh.retry": "Reyndu aftur",
  "ssh.update": "Uppfærðu og tengdu aftur",
  "ssh.openProject": "Opið verkefni",
  "ssh.project": "Opið verkefni á {{host}}",
  "ssh.disconnect": "Aftengjast",
  "ssh.forget": "Gleymdu tengingu",
  "ssh.stage.disconnected": "Ótengdur. Ytri netþjónn er eftir í gangi.",
  "ssh.stage.connecting": "Tengist yfir SSH…",
  "ssh.stage.checking": "Athugar OpenCode…",
  "ssh.stage.downloading": "Sækir miðlara…",
  "ssh.stage.uploading": "Hleður upp þjóni...",
  "ssh.stage.starting": "Tengist OpenCode…",
  "ssh.stage.ready": "Tengdur",
  "ssh.stage.authentication": "Auðkenning krafist",
  "ssh.stage.incompatible": "Þörf fyrir uppfærslu á netþjóni",
  "ssh.stage.failed": "Tenging mistókst",
  "ssh.error.input":
    "Sláðu inn hýsil eða SSH tengingarskipun. Fjarskipanir og óstuddir SSH valkostir eru ekki leyfðar.",
  "ssh.error.connection": "Gat ekki komið á SSH tengingunni. Athugaðu netið þitt og SSH stillingar.",
  "ssh.error.platform":
    "Þessi ytri pallur er ekki studdur. Sjálfvirk uppsetning krefst sem stendur Linux eða macOS á x64 eða arm64.",
  "ssh.error.version": "Fjarþjónustan verður að passa við þessa skrifborðsútgáfu áður en hún tengist.",
  "ssh.error.install": "Gat ekki sett upp ytri netþjóninn. Athugaðu tengingar, pláss og að tar sé uppsett.",
  ...
  "ssh.error.service": "SSH tengdur, en OpenCode þjónninn varð ekki tilbúinn.",
  "ssh.error.host-key":
    "Ekki var hægt að staðfesta auðkenni gestgjafans. Staðfestu fingrafar þess áður en þú uppfærir SSH þekkta gestgjafa þína.",
  "ssh.error.ssh-missing": "OpenSSH fannst ekki. Settu upp OpenSSH viðskiptavin og tryggðu að ssh sé tiltækt á PATH.",
  "command.browser.open": "Opnaðu vafra",
  "command.browser.reload": "Endurhlaða vafrasíðu",
  "command.session.summary.toggle": "Skipta yfirliti",
  "mcp.auth.interactiveForm": "MCP þjónn {{name}} krefst gagnvirks auðkenningareyðublaðs",
  "server.connect.title": "Tengstu við netþjón",
  "server.connect.description": "Sláðu inn netþjóninn þinn og lykilorð til að byrja.",
  ...
  "server.connect.camera.error":
    "Gat ekki opnað myndavélina. Leyfðu myndavélaraðgangi eða sláðu inn tengiupplýsingar þínar handvirkt.",
  "dialog.server.menu.remove": "Fjarlægja",
  "file.error.notFound": "Skrá fannst ekki: {{name}}",
  "home.workspaceTip": "Byrjaðu næstu lotu á nýju vinnusvæði til að halda breytingum einangruðum",
  "session.tab.browser": "Vafri",
  "session.tab.add": "Bæta við flipa",
  "session.queue.attachments.one": "Auk {{count}} viðhengi",
  "session.queue.attachments.other": "Auk {{count}} viðhengja",
  "session.browser.address": "Heimilisfang vafra",
  "session.browser.replaced": "Vafrastýring færð í annan skjáborðsglugga.",
  "session.browser.suspended": "Vafra lokað. Vertu í samskiptum við þessa lotu til að tengjast aftur.",
  "session.browser.address.placeholder": "Sláðu inn vefslóð",
  "settings.backToSettings": "Til baka í stillingar",
  "settings.backToProjects": "Til baka í verkefni",
  "settings.search.placeholder": "Leita",
  "settings.search.results": "Niðurstöður stillinga",
  "settings.search.group.pages": "Síður",
  "settings.search.group.settings": "Stillingar",
  "settings.search.group.projects": "Verkefni",
  "settings.search.group.servers": "Netþjónar",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Engar niðurstöður fyrir {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Þrengdu leitina til að sjá nákvæmari niðurstöður.",
  "settings.server.description": "Hafa umsjón með tengingu og kjörstillingum þessa netþjóns",
  "settings.server.section.connection": "Tenging",
  "settings.server.preferences.websearch.title": "Leit þriðja aðila",
  "settings.server.preferences.websearch.description":
    "Veldu leitarþjónustuna sem umboðsmenn nota til að leita á vefnum",
  "settings.projects.search.placeholder": "Leita að verkefnum",
  "project.settings.name.title": "Heiti verkefnis",
  "project.settings.name.description": "Nafnið sem sýnt er fyrir þetta verkefni í gegnum OpenCode",
  "project.settings.icon.description": "Mælt með: 128×128px. Smelltu eða dragðu til að hlaða upp mynd.",
  "project.settings.color.description": "Notað fyrir verkefnistáknið þegar engin sérsniðin mynd er stillt",
  "project.settings.worktree.startup.description": "Keyrir einu sinni eftir að nýtt vinnutré er búið til",
  "project.settings.worktree.startup.hint.base": "Notaðu $OPENCODE_WORKTREE_BASE fyrir grunnvinnutréð.",
  "project.settings.worktree.startup.hint.new": "Notaðu $OPENCODE_WORKTREE_PATH fyrir nýja vinnutréð.",
  "project.settings.extensions.empty.mcps.title": "Enginn MCPs enn",
  "project.settings.extensions.empty.mcps.description": "MCPs í boði fyrir OpenCode mun birtast hér",
  "project.settings.extensions.empty.plugins.title": "Engar viðbætur ennþá",
  "project.settings.extensions.empty.plugins.description": "Viðbætur sem eru í boði fyrir OpenCode munu birtast hér",
  "project.settings.extensions.empty.skills.title": "Engar færni enn",
  "project.settings.extensions.empty.skills.description": "Hæfni í boði fyrir OpenCode mun birtast hér",
  "project.settings.extensions.lsp.configured": "Stilltir tungumálaþjónar",
  "project.settings.extensions.lsp.status.enabled": "Virkt í stillingum",
  "project.settings.extensions.lsp.status.disabled": "Óvirkt í stillingum",
  "project.settings.extensions.lsp.empty.title": "Engir tungumálaþjónar stilltir",
  "project.settings.extensions.lsp.empty.description":
    "Tungumálaþjónar sem eru stilltir fyrir þetta verkefni munu birtast hér",
  "project.settings.extensions.lsp.disabled.title": "Tungumálaþjónar óvirkir",
  "project.settings.extensions.lsp.disabled.description": "LSP er óvirkt í uppsetningu þessa verkefnis",
  "project.settings.extensions.lsp.loadFailed": "Gat ekki hlaðið stillingu tungumálaþjóns",
  "project.settings.extensions.lsp.retry": "Reyndu aftur",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Hópur",
  "settings.timeline.collapse": "Fella saman",
  "settings.timeline.visibility.show": "Sýna",
  "settings.timeline.visibility.hide": "Fela",
  "settings.timeline.visibility.label": "{{activity}} skyggni",
  "settings.timeline.grouped.label": "{{activity}} flokkaður",
  "settings.timeline.collapsed.label": "{{activity}} hrundi",
  "settings.general.row.browserPane.title": "Vafri",
  "settings.general.row.browserPane.description": "Leyfa umboðsmönnum að opna og stjórna þróunarvafra í forriti.",
  "session.new.workspace.search.empty": "Engin samsvarandi vinnutré",
  "settings.workspaces.description": "Skoðaðu vinnutré og stjórnaðu diskanotkun",
  "settings.workspaces.empty.description": "Vinnutré sem búin eru til í OpenCode munu birtast hér",
  "settings.workspaces.sessions.filtered.one": "{{count}} fundur",
  "settings.workspaces.sessions.filtered.other": "{{count}} lotur",
  "settings.workspaces.deleteAll.confirm.one": "Þetta mun eyða {{count}} völdum vinnutré varanlega.",
  "settings.workspaces.deleteAll.confirm.other": "Þetta mun eyða {{count}} völdum vinnutré varanlega.",
  "settings.workspaces.deleteWithoutSessions": "Eyða vinnutré án lota",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Þetta mun eyða {{count}} vinnutré varanlega án tengdra lota.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Þetta mun varanlega eyða {{count}} vinnutré án tengdra lota.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Vinnutré með ósameinuðum breytingum eða virkum staðsetningum verða geymd.",
  "settings.workspaces.delete.button": "Eyða vinnutré",
  "workspace.lifecycle.deleting": "Eyðir…",
  "session.summary.tooltip": "Samantekt",
  "session.summary.server": "Viðbætur",
  "session.summary.chooseProject": "Veldu verkefni",
  "session.summary.mcp.onCreation": "Á við þegar vinnutréð er búið til",
  "session.summary.mcp.prepareFailed": "Gat ekki undirbúið MCP netþjóna",
  "session.summary.mcp.unavailable": "MCP þjónn {{name}} er ekki tiltækur í þessu vinnutré.",
  "session.summary.mcp.signInBeforeSend": "Skráðu þig inn á {{name}} áður en þú sendir kvaðninguna.",
  "session.summary.mcp.notReady":
    "MCP þjónn {{name}} er ekki tilbúinn. Leysaðu tenginguna áður en þú sendir kvaðninguna.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Stilltir MCP netþjónar",
  "session.summary.plugins": "Viðbætur",
  "session.summary.plugins.configured": "Stillt viðbætur",
  "session.summary.skills": "Færni",
  "session.summary.skills.configured": "Stilla færni",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Mistókst",
  "session.summary.retry": "Reyndu aftur",
  "session.summary.connecting": "Tengist…",
  "session.summary.needsAuth": "Innskráning krafist",
  "session.summary.configure": "Stillingarskrá",
  "session.summary.copyConfigPath": "Afritaðu slóð stillingarskráar",
  "session.summary.configFileMissing": "Engin stillingarskrá fannst",
  "session.summary.mcp.empty": "Engir MCP netþjónar stilltir",
  "session.summary.mcp.add": "Bættu við netþjónum í opencode.json",
  "session.summary.plugins.manage": "Stjórna viðbætur í opencode.json",
  "session.summary.plugins.empty": "Engar viðbætur stilltar",
  "session.summary.plugins.add": "Bættu við viðbótum í opencode.json",
  "session.summary.skills.manage": "Stjórna færni í opencode.json",
  "session.summary.skills.empty": "Engin færni stillt",
  "session.summary.skills.add": "Bættu við færni í opencode.json",
  "session.summary.lsp.configured": "Stillt LSPs",
  "session.summary.lsp.empty": "Engir LSP netþjónar stilltir",
  "session.summary.lsp.manage": "Stjórnaðu LSP í opencode.json",
  "workspace.delete.location": "Staðsetning",
  "common.color.orange": "appelsínugult",
  "common.color.yellow": "gulur",
  "common.color.cyan": "blár",
  "common.color.green": "grænn",
  "common.color.red": "rauður",
  "common.color.pink": "bleikur",
  "common.color.blue": "blár",
  "common.color.purple": "fjólublátt",
  "common.color.gray": "grár",
  "toast.migration.progress.migratingSessions.current": "Flytja lotur {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Flytja lotur {{current}}/{{total}}",
  "toast.migration.progress.working": "Flutningur gagna",
  "toast.migration.progress.working.current": "Flutningur gagna {{current}}",
  "toast.migration.progress.working.progress": "Flytja gögn {{current}}/{{total}}",
  "session.browser.unsupported": "Þetta skrifborðsforrit styður ekki vafrarúðuna.",
  "command.debugBar.toggle": "Sýna eða fela villuleitarstiku",
  "command.session.location.cycle": "Skipta um staðsetningu setu",
  "dialog.provider.anthropic.note": "Beinn aðgangur að Claude-líkönum með API-lykli",
  "provider.connect.title.anthropicProMax": "Skrá inn með Anthropic",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Hætta við upphleðslu",
  "prompt.toast.uploading.cancelFile": "Hætta við upphleðslu á {{filename}}",
  "prompt.toast.uploadFailed.title": "Upphleðsla mistókst",
  "session.browser.empty.title": "Sláðu inn vefslóð",
  "session.browser.empty.description": "Eða biddu um „Opna í vafra forritsins“",
  "session.browser.failed.title": "Ekki næst í vefslóðina",
  "session.browser.failed.description": "Athugaðu vefslóðina og tenginguna og reyndu aftur.",
  "debugBar.providerAriaLabel": "Afkastagreining þjónustuveitu",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Tími frá því að beiðni er send til þjónustuveitu þar til fyrsta úttak líkansins berst.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Tími frá því að beiðni er send til þjónustuveitu þar til fyrsti svartextinn berst.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Úttakstókar á sekúndu eftir fyrsta úttak líkansins.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Tími frá því að beiðni er send til þjónustuveitu þar til svarstraumnum lýkur.",
  "settings.updates.action.download": "Sækja OpenCode",
  "settings.updates.migration.title": "Fara úr Beta í Stöðuga útgáfu",
