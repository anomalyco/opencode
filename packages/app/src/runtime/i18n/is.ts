...
export const dict = {
  ...
  "session.queue.attachments": "+ viðhengi",
  ...
  "settings.timeline.advanced.explainer": "Hópuð virkni fer í Notað. Upplýsingar gilda eftir opnun hópsins.",
  "settings.timeline.activity": "Virkni",
  ...
  "settings.timeline.placement.title": "Staðsetning",
  "settings.timeline.placement.separate": "Aðskilið",
  "settings.timeline.placement.grouped": "Hópað",
  "settings.timeline.placement.hidden": "Falinn",
  "settings.timeline.expansion.title": "Upplýsingar",
  "settings.timeline.expansion.collapsed": "Fellt saman",
  "settings.timeline.expansion.expanded": "Útvíkkað",
