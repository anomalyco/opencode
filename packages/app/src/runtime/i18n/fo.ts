export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Arbeiðstrø við ósamanlagdum broytingum, linkaðum setum ella virknum støðum verða hildin.",
  ...
  "session.location.unavailable": "Staðsetingin hjá setuni er ikki tøk",
  "session.location.description": "Vel eina aðra skrá til at halda fram við hesi setuni.",
  "session.location.choose": "Vel skrá",
  "session.location.worktree": "Vel arbeiðstræ",
  "session.location.worktreesFailed": "Arbeiðstrøini kundu ikki lesast inn",
  "session.location.moving": "Flytur setuna…",
  "dialog.server.menu.hide": "Fjal úr verkætlanarlistanum",
  "dialog.server.menu.show": "Vís í verkætlanarlistanum",
  "session.queue.count.one": "{{count}} í bíðirøð",
  "session.queue.count.other": "{{count}} í bíðirøð",
  "session.queue.steer": "Stýr",
  "session.queue.send": "Send",
  "session.queue.steerTooltip": "Send uttan at steðga",
  "session.queue.remove": "Tak burtur",
  "session.queue.reorder": "Broyt raðfylgjuna á boðnum í bíðirøðini",
  "session.new.worktree.creating": "Stovnar arbeiðstræ",
  "settings.backToApp": "Aftur til forritið",
  "settings.appearance.section.experimental": "Royndarvirkni",
  "settings.appearance.row.tabs.title": "Fanar",
  "settings.appearance.row.tabs.description": "Vel, hvussu setufanarnir verða skipaðir",
  "settings.appearance.row.tabs.horizontal": "Vatnrætt",
  "settings.appearance.row.tabs.vertical": "Loddrætt",
  "settings.general.row.followUpBehavior.title": "Atferð hjá framhaldsboðum",
  "settings.general.row.followUpBehavior.description":
    "Vel, um framhaldsboð skulu í bíðirøð ella stýra verandi umfari. Brúka {{keybind}} til at skifta.",
  "settings.general.row.followUpBehavior.queue": "Set í bíðirøð",
  "settings.general.row.followUpBehavior.steer": "Stýr",
  "settings.general.row.reasoningMode.title": "Grundgeving hjá modellinum",
  "settings.general.row.reasoningMode.description":
    "Vel, hvussu grundgevingin hjá modellinum verður víst á tíðarlinjuni",
  "settings.general.row.reasoningMode.hidden": "Fjald",
  "settings.general.row.reasoningMode.compact": "Samantrýst",
  "settings.general.row.reasoningMode.full": "Full",
  "session.new.workspace.createFrom": "Stovna frá grein",
  "session.new.workspace.branch.search.placeholder": "Leita eftir greinum",
  "toast.migration.progress.clearingOldEvents": "Strikar gamlar hendingar",
  "toast.migration.progress.migratingSessions": "Flytur setur",
  "session.new.workspace.existingLabel": "Arbeiðstræ",
  "desktop.onboarding.defaultProject": "Standardverkætlan",
  "home.projects.all": "Allar verkætlanir",
  "session.tab.files": "Fílur",
  "session.files.openTabs": "Opna fílur",
  "session.tab.usage": "Nýtsla",
  "session.view.select": "Setuvísing",
  "session.background.moveTasks": "Flyt {{tasks}} til bakgrundina",
  "session.background.moveRunning": "Flyt til bakgrund",
  "session.background.inBackground": "Koyrir {{tasks}} í bakgrundini",
  "session.background.tasksRunning.one": "{{count}} bakgrundsuppgáva í gongd",
  "session.background.tasksRunning.other": "{{count}} bakgrundsuppgávur í gongd",
  ...
  "session.background.subagent.one": "{{count}} undirumboðsmaður",
  "session.background.subagent.other": "{{count}} undirumboðsmenn",
  ...
  "session.websearch.any": "Ein og hvør",
  "session.websearch.disable": "Brúka ikki leiting",
  "session.websearch.enable": "Virkja",
  "session.websearch.loadFailed": "Kundi ikki heinta leitiveitarar.",
  "session.websearch.empty": "Ongin leitiveitari er tøkur.",
  "session.websearch.failed": "Kundi ikki goyma títt val. Vinarliga royn aftur.",
  "session.websearch.retry": "Royn aftur",
  "session.new.worktree.draftPlaceholder": "Ger eina eftirfylgjandi uppskot, meðan arbeiðstræið verður fyrireikað…",
  "session.search.placeholder": "Finn…",
  "session.search.noResults": "Einki samsvar",
  "titlebar.tabs": "Fanar",
  "titlebar.channel.local": "Lokal",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Skift feilsøkingartól",
  "settings.tab.experimental": "Royndar",
  "settings.experimental.description": "Royn royndarfunktiónir",
  "settings.tab.about": "Um",
  "settings.about.version": "Útgáva {{version}}",
  "settings.about.devVersion": "menningarútgáva",
  "settings.about.license": "Útgivið undir MIT-loyvinum",
  "settings.about.writtenBy": "Skrivað hevur",
  "settings.about.illustratedBy": "Myndprýtt av",
  "settings.about.and": "og",
  "settings.about.otherContributor.one": "{{count}} annað",
  "settings.about.otherContributor.other": "{{count}} onnur",
  "settings.about.firstPublished": "Fyrst útgivið í Missouri í USA",
  "settings.about.firstIllustrated": "Fyrst myndprýdd í London í Onglandi",
  "settings.about.website": "www.opna koda.ai",
  "settings.about.description": "OpenCode, opna keldukoduumboðnum",
  "settings.about.trademark": "OpenCode er eitt skrásett vørumerki hjá Anomaly Innovations, Inc.",
  "settings.about.typeset": "Skriftsett í Inter og IBM Plex Mono",
  "settings.about.tagline": "AI kann ikki byggja góða ritbúnað, uttan teg",
  "settings.about.copyright": "© Anomaly nýskapanir, Inc.",
  "settings.appearance.row.projectName.title": "Vís verkætlanarnøvn",
  "settings.appearance.row.projectName.description":
    "Vís verkætlanarnøvn í loddrættum flikum og fartelefonflipukuffuni",
  "project.settings.title": "Rætta verkætlan",
  "settings.timeline.title": "Tíðarlinja",
  "settings.timeline.detail": "Smálutir á tíðarlinju",
  "settings.timeline.description": "Vel, hvussu nógv virksemi sæst á tíðarlinjuni. Boðini verða sjónlig.",
  "settings.timeline.preset.everything": "Alt",
  "settings.timeline.preset.detailed": "Nærri",
  "settings.timeline.preset.compact": "Kompakt",
  "settings.timeline.preset.quiet": "Kvirt",
  "settings.timeline.preset.text-only": "Einans tekstur",
  ...
  "settings.timeline.custom": "Sersniðgivið",
  "settings.timeline.advanced": "Framkomin",
  "settings.timeline.advanced.description": "Set plasering og smálutir fyri hvønn virksemisflokk.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Rættingar",
  ...
  "session.review.filesChangedCount.one": "{{count}} fílan er broytt",
  "session.review.filesChangedCount.other": "{{count}} fílur broyttar",
  "settings.about.writtenByNames": "Skrivað hevur {{names}}",
  "settings.about.illustratedByNames": "Myndprýtt við {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Ikki tengt at {{host}}. Títt uppskot er varðveitt; fjararbeiði kann enn vera í gongd.",
  "ssh.placeholder": "ssh brúkari@dømi.com",
  "ssh.add": "Legg SSH ambætara til",
  "ssh.server.menu.label": "SSH ambætari",
  "ssh.target": "Vertur ella SSH skipan",
  "ssh.connect": "Samband",
  "ssh.connectTo": "Seta teg í samband við {{host}}",
  "ssh.authenticate": "SSH góðkenning",
  "ssh.action.authenticate": "Staðfesta",
  "ssh.session.disconnected": "SSH sambandið óvirkið",
  "ssh.session.connecting": "Samband við SSH ambætara",
  ...
  "ssh.session.reconnect": "Samband aftur",
  "ssh.authenticationRequired": "Staðfesting krevst fyri {{host}}",
  "ssh.trust": "Lít á og knýta samband",
  "ssh.continue": "Halt fram",
  "ssh.retry": "Royn aftur",
  "ssh.update": "Dagfør og set samband aftur",
  "ssh.openProject": "Opin verkætlan",
  "ssh.project": "Opið verkætlan á {{host}}",
  "ssh.disconnect": "Kopla sambandið frá",
  "ssh.forget": "Gloym samband",
  "ssh.stage.disconnected": "Slitið. Fjartænarin er latin koyra.",
  "ssh.stage.connecting": "Samband yvir SSH...",
  "ssh.stage.checking": "Kanna OpenCode...",
  "ssh.stage.downloading": "Heinta servara...",
  "ssh.stage.uploading": "Uppleggja ambætaran...",
  "ssh.stage.starting": "Samband við OpenCode...",
  "ssh.stage.ready": "Samband",
  "ssh.stage.authentication": "Staðfesting krevst",
  "ssh.stage.incompatible": "Ambætaradagføring krevst",
  "ssh.stage.failed": "Sambandið miseydnaðist",
  "ssh.error.input":
    "Skriva eina verts- ella SSH sambandsskipan. Fjarskipanir og óstuðlaðir SSH møguleikar eru ikki loyvdir.",
  "ssh.error.connection": "Kundi ikki fáa SSH sambandið upp. Kanna títt net og SSH uppseting.",
  "ssh.error.platform":
    "Hesin fjarskiftispallurin er ikki stuðlaður. Sjálvvirkandi uppseting krevur í løtuni Linux ella macOS á x64 ella arm64.",
  "ssh.error.version": "Fjartænastan skal passa til hesa skriviborðsútgávuna áðrenn tú setur samband.",
  "ssh.error.install": "Kundi ikki seta fjar-ambætaran upp. Kanna samband, diskpláss, og at tar er sett upp.",
  ...
  "ssh.error.service": "SSH varð knýtt, men OpenCode ambætarin gjørdist ikki klárur.",
  "ssh.error.host-key":
    "Samleikin hjá vertinum kundi ikki staðfestast. Staðfest fingramerkið áðrenn tú dagførir tínar SSH kendu vertir.",
  "ssh.error.ssh-missing": "OpenSSH varð ikki funnið. Set ein OpenSSH klient upp og tryggja tær at ssh er tøkt á PATH.",
  "command.browser.open": "Opna kaga",
  "command.browser.reload": "Endurlesa kagasíðuna",
  "command.session.summary.toggle": "Skifta samandrátt",
  "mcp.auth.interactiveForm": "MCP ambætarin {{name}} krevur eitt samvirkið sannroyndarblað",
  "server.connect.title": "Set samband við ein ambætara",
  "server.connect.description": "Skriva tína ambætaraadressu og loyniorð fyri at byrja.",
  ...
  "server.connect.camera.error":
    "Kundi ikki lata myndatólið upp. Loyv atgongd til myndatól ella skriva tínar sambandsupplýsingar manuelt.",
  "dialog.server.menu.remove": "Strika",
  "file.error.notFound": "Fíla ikki funnin: {{name}}",
  "home.workspaceTip": "Byrja næstu setu í einum nýggjum arbeiðsøki fyri at halda broytingar einstøkar",
  "session.tab.browser": "Kaga",
  "session.tab.add": "Legg flipa til",
  "session.queue.attachments.one": "Pluss {{count}} viðheft",
  "session.queue.attachments.other": "Umframt {{count}} viðheftir",
  "session.browser.address": "Kagaadressa",
  "session.browser.replaced": "Kagastýring flutt til eitt annað skriviborðsvindeyga.",
  "session.browser.suspended": "Kagari steðgaður. Samskifta við hesa setuna fyri at fáa samband aftur.",
  "session.browser.address.placeholder": "Skriva URL",
  "settings.backToSettings": "Aftur til innstillingar",
  "settings.backToProjects": "Aftur til verkætlanir",
  "settings.search.placeholder": "Leita",
  "settings.search.results": "Innstillingar úrslit",
  "settings.search.group.pages": "Síður",
  "settings.search.group.settings": "Innstillingar",
  "settings.search.group.projects": "Verkætlanir",
  "settings.search.group.servers": "Servarar",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Einki úrslit fyri {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Minka um tína leiting fyri at síggja meira nágreinilig úrslit.",
  "settings.server.description": "Stýr sambandinum og innstillingunum hjá hesum ambætaranum",
  "settings.server.section.connection": "Samband",
  "settings.server.preferences.websearch.title": "Leitan frá triðjaparti",
  "settings.server.preferences.websearch.description": "Vel leitveitaranum, sum umboðini brúka til at leita á netinum",
  "settings.projects.search.placeholder": "Leita verkætlanir",
  "project.settings.name.title": "Verkætlanarnavn",
  "project.settings.name.description": "Navnið víst fyri hesa verkætlan í øllum OpenCode",
  "project.settings.icon.description": "Viðmælt verður: 128×128px. Trýst ella drag fyri at leggja eina mynd upp.",
  "project.settings.color.description": "Brúkt til verkætlanar-ikonið, tá eingin sersniðgivin mynd er sett",
  "project.settings.worktree.startup.description": "Koyrir einaferð eftir at hava stovnað eitt nýtt arbeiðstræ",
  "project.settings.worktree.startup.hint.base": "Brúka $OPENCODE_WORKTREE_BASE til grundarbeiðstræið.",
  "project.settings.worktree.startup.hint.new": "Brúka $OPENCODE_WORKTREE_PATH til nýggja arbeiðstræið.",
  "project.settings.extensions.empty.mcps.title": "Nei MCPs enn",
  "project.settings.extensions.empty.mcps.description": "MCPs tøkt til OpenCode kemur fram her",
  "project.settings.extensions.empty.plugins.title": "Einki tilskot enn",
  "project.settings.extensions.empty.plugins.description": "Plugins, sum eru tøk til OpenCode, koma at síggjast her",
  "project.settings.extensions.empty.skills.title": "Ongin førleiki enn",
  "project.settings.extensions.empty.skills.description": "Førleikar, sum eru tøkir hjá OpenCode, koma fram her",
  "project.settings.extensions.lsp.configured": "Uppsettir málambætarar",
  "project.settings.extensions.lsp.status.enabled": "Virkt í uppseting",
  "project.settings.extensions.lsp.status.disabled": "Sløkt í uppseting",
  "project.settings.extensions.lsp.empty.title": "Eingin mál-ambætari er uppsettur",
  "project.settings.extensions.lsp.empty.description":
    "Máltænarar, sum eru uppsettir til hesa verkætlan, koma at síggjast her",
  "project.settings.extensions.lsp.disabled.title": "Máltænarar sløktir",
  "project.settings.extensions.lsp.disabled.description": "LSP er sløkt í uppsetingini av hesi verkætlan",
  "project.settings.extensions.lsp.loadFailed": "Kundi ikki heinta málambætara uppsetingina",
  "project.settings.extensions.lsp.retry": "Royn aftur",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Bólkur",
  "settings.timeline.collapse": "Kollaps",
  "settings.timeline.visibility.show": "Vís",
  "settings.timeline.visibility.hide": "Goym",
  "settings.timeline.visibility.label": "{{activity}} sjónleiki",
  "settings.timeline.grouped.label": "{{activity}} bólkað",
  "settings.timeline.collapsed.label": "{{activity}} fall saman",
  "settings.general.row.browserPane.title": "Kaga",
  "settings.general.row.browserPane.description": "Loyva umboðum at lata upp og stýra einum menningarkagara í appini.",
  "session.new.workspace.search.empty": "Eingi samsvarandi arbeiðstrø",
  "settings.workspaces.description": "Gjøgnumganga arbeiðstrø og stýr disknýtslu",
  "settings.workspaces.empty.description": "Arbeiðstrø, sum eru stovnað í OpenCode, koma at síggjast her",
  "settings.workspaces.sessions.filtered.one": "{{count}} setan",
  "settings.workspaces.sessions.filtered.other": "{{count}} setur",
  "settings.workspaces.deleteAll.confirm.one": "Hetta fer varandi at strika {{count}} valda arbeiðstræið.",
  "settings.workspaces.deleteAll.confirm.other": "Hetta fer varandi at strika {{count}} vald arbeiðstrø.",
  "settings.workspaces.deleteWithoutSessions": "Strika arbeiðstrø uttan setur",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Hetta fer varandi at strika {{count}} arbeiðstræið uttan leinkjaðar setur.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Hetta fer varandi at strika {{count}} arbeiðstrø uttan leinkjaðar setur.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Arbeiðstrø við ósamanlagdum broytingum ella virknum støðum verða hildin.",
  "settings.workspaces.delete.button": "Strika arbeiðstrø",
  "workspace.lifecycle.deleting": "Strika...",
  "session.summary.tooltip": "Samandráttur",
  "session.summary.server": "Útbyggingar",
  "session.summary.chooseProject": "Vel verkætlan",
  "session.summary.mcp.onCreation": "Er galdandi tá arbeiðstræið er stovnað",
  "session.summary.mcp.prepareFailed": "Kundi ikki fyrireika MCP ambætarar",
  "session.summary.mcp.unavailable": "MCP ambætarin {{name}} er ikki tøkur í hesum arbeiðstrænum.",
  "session.summary.mcp.signInBeforeSend": "Rita inn á {{name}} áðrenn tú sendir boðini.",
  "session.summary.mcp.notReady": "MCP ambætarin {{name}} er ikki klárur. Loys sambandið áðrenn tú sendir boðini.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Uppsettir MCP ambætarar",
  "session.summary.plugins": "Tilskot",
  "session.summary.plugins.configured": "Uppsett tilskot",
  "session.summary.skills": "Førleikar",
  "session.summary.skills.configured": "Uppsettir førleikar",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Mistókst",
  "session.summary.retry": "Royn aftur",
  "session.summary.connecting": "Samband...",
  "session.summary.needsAuth": "Rita inn krevst",
  "session.summary.configure": "Uppsetingarfíla",
  "session.summary.copyConfigPath": "Avrita uppsetingarfíluslóð",
  "session.summary.configFileMissing": "Eingin uppsetingarfíla funnin",
  "session.summary.mcp.empty": "Eingin MCP ambætari er uppsettur",
  "session.summary.mcp.add": "Legg ambætarar til í opencode.json",
  "session.summary.plugins.manage": "Stjóra tilskotum í opencode.json",
  "session.summary.plugins.empty": "Eingi tilskot uppsett",
  "session.summary.plugins.add": "Legg tilskot til í opencode.json",
  "session.summary.skills.manage": "Stjóra førleikum í opencode.json",
  "session.summary.skills.empty": "Eingin førleiki er uppsettur",
  "session.summary.skills.add": "Legg førleikar til í opencode.json",
  "session.summary.lsp.configured": "Uppsett LSPs",
  "session.summary.lsp.empty": "Eingin LSP ambætari er uppsettur",
  "session.summary.lsp.manage": "Stjóra LSP í opnari kotu.json",
  "workspace.delete.location": "Staðseting",
  "common.color.orange": "appelsin",
  "common.color.yellow": "gult",
  "common.color.cyan": "cyan",
  "common.color.green": "grønt",
  "common.color.red": "reytt",
  "common.color.pink": "bleikt",
  "common.color.blue": "blátt",
  "common.color.purple": "lilla",
  "common.color.gray": "grátt",
  "toast.migration.progress.migratingSessions.current": "Flyta setur {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Flyta setur {{current}}/{{total}}",
  "toast.migration.progress.working": "Flyta dátur",
  "toast.migration.progress.working.current": "Flyta dátur {{current}}",
  "toast.migration.progress.working.progress": "Flyta dátur {{current}}/{{total}}",
  "session.browser.unsupported": "Hendan skriviborðsappin stuðlar ikki kagarútinum.",
  "command.debugBar.toggle": "Vís ella fjala kembibjálkan",
  "command.session.location.cycle": "Skift staðseting fyri setuna",
  "dialog.provider.anthropic.note": "Beinleiðis atgongd til Claude-modellar við API-lykli",
  "provider.connect.title.anthropicProMax": "Rita inn við Anthropic",
  "prompt.toast.uploading.percent": "{{percent}} %",
  "prompt.toast.uploading.cancel": "Ógilda uppsending",
  "prompt.toast.uploading.cancelFile": "Ógilda uppsendingina av {{filename}}",
  "prompt.toast.uploadFailed.title": "Uppsending miseydnaðist",
  "session.browser.empty.title": "Skriva URL",
  "session.browser.empty.description": "Ella bið um „Lat upp í kaganum í appini“",
  "session.browser.failed.title": "URL-adressan kann ikki røkkast",
  "session.browser.failed.description": "Kanna URL-adressuna og sambandið og royn aftur.",
  "debugBar.providerAriaLabel": "Avriksgreining hjá veitara",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Tíð frá tí at fyrispurningurin verður sendur veitaranum, til fyrsta úttakið frá modellinum.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Tíð frá tí at fyrispurningurin verður sendur veitaranum, til fyrsti svarteksturin.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Útflutningsmerki um sekundið eftir fyrsta úttakið frá modellinum.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Tíð frá tí at fyrispurningurin verður sendur veitaranum, til svarstreymurin endar.",
  "settings.updates.action.download": "Tak OpenCode niður",
  "settings.updates.migration.title": "Far úr Beta í Støðugt",
