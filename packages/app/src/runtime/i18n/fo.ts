export const dict = {
  ...
  "session.queue.attachments": "+ viðhefti",
  ...
  "settings.timeline.advanced.explainer":
    "Bólkavirksemi fer inn í Brúkt. Smálutir eru galdandi eftir at hava latið bólkin upp.",
  "settings.timeline.activity": "Virksemi",
  ...
  "settings.timeline.placement.title": "Staðseting",
  "settings.timeline.placement.separate": "Skilja",
  "settings.timeline.placement.grouped": "Bólkað",
  "settings.timeline.placement.hidden": "Dult",
  "settings.timeline.expansion.title": "Smálutir",
  "settings.timeline.expansion.collapsed": "Samanlagt",
  "settings.timeline.expansion.expanded": "Víðkað",
