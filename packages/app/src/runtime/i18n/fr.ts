export const dict = {
  ...
  "toast.migration.progress.migratingSessions.current": "Migration des sessions : {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Migration des sessions : {{current}}/{{total}}",
  "toast.migration.progress.working": "Migration des données",
  "toast.migration.progress.working.current": "Migration des données : {{current}}",
  "toast.migration.progress.working.progress": "Migration des données : {{current}}/{{total}}",
  "session.browser.unsupported": "Cette application de bureau ne prend pas en charge le volet du navigateur.",
  "ssh.label": "SSH",
  "ssh.offline":
    "Non connecté au {{host}}. Votre brouillon est conservé ; le travail à distance peut toujours être en cours.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Ajouter le serveur SSH",
  "ssh.server.menu.label": "Serveur SSH",
  "ssh.target": "Commande hôte ou SSH",
  "ssh.connect": "Se connecter",
  "ssh.connectTo": "Connectez-vous à {{host}}",
  "ssh.authenticate": "Authentification SSH",
  "ssh.action.authenticate": "Authentifier",
  "ssh.session.disconnected": "Connexion SSH inactive",
  "ssh.session.connecting": "Connexion au serveur SSH",
  ...
  "ssh.session.reconnect": "Reconnecter",
  "ssh.authenticationRequired": "Authentification requise pour {{host}}",
  "ssh.trust": "Faites confiance et connectez-vous",
  "ssh.continue": "Continuer",
  "ssh.retry": "Réessayer",
  "ssh.update": "Mettre à jour et reconnecter",
  "ssh.openProject": "Projet ouvert",
  "ssh.project": "Projet ouvert sur {{host}}",
  "ssh.disconnect": "Déconnecter",
  "ssh.forget": "Oublier la connexion",
  "ssh.stage.disconnected": "Déconnecté. Le serveur distant continue de fonctionner.",
  "ssh.stage.connecting": "Connexion via SSH…",
  "ssh.stage.checking": "Vérification de OpenCode…",
  "ssh.stage.downloading": "Serveur de téléchargement…",
  "ssh.stage.uploading": "Serveur de téléchargement…",
  "ssh.stage.starting": "Connexion au OpenCode…",
  "ssh.stage.ready": "Connecté",
  "ssh.stage.authentication": "Authentification requise",
  "ssh.stage.incompatible": "Mise à jour du serveur requise",
  "ssh.stage.failed": "La connexion a échoué",
  "ssh.error.input":
  ...
  "ssh.error.connection": "Impossible d'établir la connexion SSH. Vérifiez votre réseau et la configuration du SSH.",
  "ssh.error.platform":
  ...
  "ssh.error.version": "Le service distant doit correspondre à cette version de bureau avant de se connecter.",
  "ssh.error.install":
  ...
  "ssh.error.service": "SSH s'est connecté, mais le serveur OpenCode n'est pas prêt.",
  "ssh.error.host-key":
  ...
  "command.browser.open": "Ouvrir le navigateur",
  "command.browser.reload": "Recharger la page du navigateur",
  "command.session.summary.toggle": "Basculer le résumé",
  "mcp.auth.interactiveForm": "Serveur MCP {{name}} nécessite un formulaire d'authentification interactif",
  "server.connect.title": "Se connecter à un serveur",
  "server.connect.description": "Entrez l'adresse de votre serveur et votre mot de passe pour commencer.",
  "server.connect.button": "Se connecter",
  ...
  "server.connect.camera.error":
    "Impossible d'ouvrir la caméra. Autorisez l’accès à la caméra ou saisissez manuellement vos informations de connexion.",
  "dialog.server.menu.remove": "Supprimer",
  "file.error.notFound": "Fichier introuvable : {{name}}",
  "home.workspaceTip":
    "Démarrez la prochaine session dans un nouvel espace de travail pour garder les modifications isolées",
  "session.tab.browser": "Navigateur",
  "session.tab.add": "Ajouter un onglet",
  "session.queue.attachments.one": "Plus accessoire {{count}}",
  "session.queue.attachments.other": "Plus les accessoires {{count}}",
  "session.browser.address": "Adresse du navigateur",
  "session.browser.replaced": "Le contrôle du navigateur a été déplacé vers une autre fenêtre du bureau.",
  "session.browser.suspended": "Navigateur suspendu. Interagissez avec cette session pour vous reconnecter.",
  "session.browser.address.placeholder": "Entrez URL",
  "settings.backToSettings": "Retour aux paramètres",
  "settings.backToProjects": "Retour aux projets",
  "settings.search.placeholder": "Rechercher",
  "settings.search.results": "Résultats des paramètres",
  "settings.search.group.pages": "Pages",
  "settings.search.group.settings": "Paramètres",
  "settings.search.group.projects": "Projets",
  "settings.search.group.servers": "Serveurs",
  ...
  "settings.search.refine": "Affinez votre recherche pour voir des résultats plus spécifiques.",
  "settings.server.description": "Gérer la connexion et les préférences de ce serveur",
  "settings.server.section.connection": "Connexion",
  "settings.server.preferences.websearch.title": "Recherche tierce",
  "settings.server.preferences.websearch.description":
    "Sélectionnez le moteur de recherche que les agents utilisent pour effectuer des recherches sur le Web.",
  "settings.projects.search.placeholder": "Rechercher des projets",
  "project.settings.name.title": "Nom du projet",
  "project.settings.name.description": "Le nom affiché pour ce projet dans OpenCode",
  "project.settings.icon.description": "Recommandé : 128×128px. Cliquez ou faites glisser pour télécharger une image.",
  "project.settings.color.description":
    "Utilisé pour l'icône du projet lorsqu'aucune image personnalisée n'est définie",
  "project.settings.worktree.startup.description": "S'exécute une fois après la création d'un nouvel espace de travail",
  "project.settings.worktree.startup.hint.base": "Utilisez $OPENCODE_WORKTREE_BASE pour l'espace de travail de base.",
  "project.settings.worktree.startup.hint.new": "Utilisez $OPENCODE_WORKTREE_PATH pour le nouvel espace de travail.",
  "project.settings.extensions.empty.mcps.title": "Pas encore de MCPs",
  "project.settings.extensions.empty.mcps.description": "MCPs disponible pour OpenCode apparaîtra ici",
  "project.settings.extensions.empty.plugins.title": "Pas encore de plugin",
  "project.settings.extensions.empty.plugins.description": "Les plugins disponibles pour OpenCode apparaîtront ici",
  "project.settings.extensions.empty.skills.title": "Aucune compétence pour l'instant",
  "project.settings.extensions.empty.skills.description": "Les compétences disponibles pour OpenCode apparaîtront ici",
  "project.settings.extensions.lsp.configured": "Serveurs de langues configurés",
  "project.settings.extensions.lsp.status.enabled": "Activé dans la configuration",
  "project.settings.extensions.lsp.status.disabled": "Désactivé dans la configuration",
  "project.settings.extensions.lsp.empty.title": "Aucun serveur de langue configuré",
  "project.settings.extensions.lsp.empty.description":
    "Les serveurs de langue configurés pour ce projet apparaîtront ici",
  "project.settings.extensions.lsp.disabled.title": "Serveurs de langue désactivés",
  "project.settings.extensions.lsp.disabled.description": "LSP est désactivé dans la configuration de ce projet",
  "project.settings.extensions.lsp.loadFailed": "Impossible de charger la configuration du serveur de langue",
  "project.settings.extensions.lsp.retry": "Réessayer",
  "settings.timeline.summary": "{{preset}} :",
  "settings.timeline.group": "Groupe",
  "settings.timeline.collapse": "Réduire",
  "settings.timeline.visibility.show": "Afficher",
  "settings.timeline.visibility.hide": "Masquer",
  ...
  "settings.workspaces.sessions.filtered.one": "Séance {{count}}",
  "settings.workspaces.sessions.filtered.other": "Séances {{count}}",
  "settings.workspaces.deleteAll.confirm.one":
    "Cela supprimera définitivement l’espace de travail sélectionné {{count}}.",
  "settings.workspaces.deleteAll.confirm.other":
    "Cela supprimera définitivement les espaces de travail sélectionnés par {{count}}.",
  "settings.workspaces.deleteWithoutSessions": "Supprimer les espaces de travail sans sessions",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Cela supprimera définitivement l'espace de travail {{count}} sans sessions liées.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Cela supprimera définitivement les espaces de travail {{count}} sans sessions liées.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Les espaces de travail avec des modifications non fusionnées ou des emplacements actifs seront conservés.",
  "settings.workspaces.delete.button": "Supprimer les espaces de travail",
  "workspace.lifecycle.deleting": "Suppression…",
  "session.summary.tooltip": "Résumé",
  "session.summary.server": "Rallonges",
  "session.summary.chooseProject": "Choisissez un projet",
  "session.summary.mcp.onCreation": "S'applique lorsque l'espace de travail est créé",
  "session.summary.mcp.prepareFailed": "Impossible de préparer les serveurs MCP",
  "session.summary.mcp.unavailable": "Le serveur MCP {{name}} n'est pas disponible dans cet espace de travail.",
  "session.summary.mcp.signInBeforeSend": "Connectez-vous à {{name}} avant d’envoyer l’invite.",
  "session.summary.mcp.notReady":
    "Le serveur MCP {{name}} n'est pas prêt. Résolvez sa connexion avant d’envoyer l’invite.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Serveurs MCP configurés",
  "session.summary.plugins": "Plugins",
  "session.summary.plugins.configured": "Plugins configurés",
  "session.summary.skills": "Compétences",
  "session.summary.skills.configured": "Compétences configurées",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Échec",
  "session.summary.retry": "Réessayer",
  "session.summary.connecting": "Connexion…",
  "session.summary.needsAuth": "Connexion requise",
  "session.summary.configure": "Fichier de configuration",
  "session.summary.copyConfigPath": "Copier le chemin du fichier de configuration",
  "session.summary.configFileMissing": "Aucun fichier de configuration trouvé",
  "session.summary.mcp.empty": "Aucun serveur MCP configuré",
  "session.summary.mcp.add": "Ajouter des serveurs dans opencode.json",
  "session.summary.plugins.manage": "Gérer les plugins dans opencode.json",
  "session.summary.plugins.empty": "Aucun plugin configuré",
  "session.summary.plugins.add": "Ajouter des plugins dans opencode.json",
  "session.summary.skills.manage": "Gérer les compétences dans opencode.json",
  "session.summary.skills.empty": "Aucune compétence configurée",
  "session.summary.skills.add": "Ajouter des compétences dans opencode.json",
  "session.summary.lsp.configured": "LSPs configuré",
  "session.summary.lsp.empty": "Aucun serveur LSP configuré",
  "session.summary.lsp.manage": "Gérer LSP dans opencode.json",
  "workspace.delete.location": "Emplacement",
  "session.queue.attachments.many": "Plus les accessoires {{count}}",
  "settings.workspaces.sessions.filtered.many": "Séances {{count}}",
  ...
  "settings.workspaces.deleteAll.warning":
    "Les espaces de travail avec des modifications non fusionnées, des sessions liées ou des emplacements actifs seront conservés.",
  "provider.connect.error.unsupportedFields": "Ce formulaire d’authentification contient des champs non pris en charge",
  "session.review.filesChangedCount.one": "{{count}} fichier modifié",
  "session.review.filesChangedCount.other": "{{count}} fichiers modifiés",
  "session.review.filesChangedCount.many": "{{count}} fichiers modifiés",
  "settings.about.writtenByNames": "Écrit par {{names}}",
  "settings.about.illustratedByNames": "Illustré par {{names}}",
  "home.projects.all": "Tous les projets",
  "session.tab.files": "Fichiers",
  "session.files.openTabs": "Fichiers ouverts",
  "session.tab.usage": "Utilisation",
  ...
  "session.background.tasksRunning.one": "{{count}} tâche en arrière-plan en cours",
  "session.background.tasksRunning.other": "{{count}} tâches en arrière-plan en cours",
  ...
  "session.websearch.provider": "Fournisseur de recherche",
  "session.websearch.any": "Tous",
  "session.websearch.disable": "Ne pas utiliser la recherche",
  "session.websearch.enable": "Activer",
  "session.websearch.loadFailed": "Impossible de charger les fournisseurs de recherche.",
  "session.websearch.empty": "Aucun fournisseur de recherche disponible.",
  "session.websearch.failed": "Impossible d’enregistrer votre choix. Veuillez réessayer.",
  "session.websearch.retry": "Réessayer",
  "session.new.worktree.draftPlaceholder": "Rédigez un suivi pendant la préparation de l’arbre de travail…",
  "session.search.placeholder": "Rechercher...",
  "session.search.noResults": "Aucune correspondance",
  "titlebar.tabs": "Onglets",
  "titlebar.channel.local": "Local",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Bêta",
  "titlebar.toggleDebugTools": "Afficher ou masquer les outils de débogage",
  "settings.tab.experimental": "Expérimental",
  "settings.experimental.description": "Essayer les fonctionnalités expérimentales",
  "settings.tab.about": "À propos",
  "settings.about.version": "Version {{version}}",
  "settings.about.devVersion": "développement",
  "settings.about.license": "Publié sous licence MIT",
  "settings.about.writtenBy": "Écrit par",
  "settings.about.illustratedBy": "Illustré par",
  "settings.about.and": "et",
  "settings.about.otherContributor.one": "{{count}} autre",
  "settings.about.otherContributor.other": "{{count}} autres",
  "settings.about.firstPublished": "Publié pour la première fois dans le Missouri, aux États-Unis",
  "settings.about.firstIllustrated": "Illustré pour la première fois à Londres, en Angleterre",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, l’agent de programmation open source",
  "settings.about.trademark": "OpenCode est une marque déposée d’Anomaly Innovations, Inc.",
  ...
  "settings.timeline.description":
    "Choisissez la quantité d’activité affichée dans la chronologie. Les messages restent visibles.",
  "settings.timeline.preset.everything": "Tout",
  "settings.timeline.preset.detailed": "Détaillé",
  "settings.timeline.preset.compact": "Compact",
  "settings.timeline.preset.quiet": "Discret",
  "settings.timeline.preset.text-only": "Texte uniquement",
  ...
  "settings.timeline.description.custom":
    "Utiliser l’emplacement et les détails sélectionnés pour chaque catégorie d’activité.",
  "settings.timeline.custom": "Personnalisé",
  "settings.timeline.advanced": "Avancé",
  "settings.timeline.advanced.description": "Définir l’emplacement et les détails de chaque catégorie d’activité.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Modifications",
  "settings.timeline.category.thinking": "Raisonnement",
  ...
  "session.background.tasksRunning.many": "{{count}} tâches en arrière-plan en cours",
  ...
  "session.new.workspace.existingLabel": "Arbre de travail",
  "desktop.onboarding.defaultProject": "Projet par défaut",
  "session.location.unavailable": "Emplacement de la session indisponible",
  "session.location.description": "Choisissez un autre répertoire pour continuer cette session.",
  "session.location.choose": "Choisir un répertoire",
  "session.location.worktree": "Choisir un arbre de travail",
  "session.location.worktreesFailed": "Impossible de charger les arbres de travail",
  "session.location.moving": "Déplacement de la session…",
  "dialog.server.menu.hide": "Masquer de la liste des projets",
  "dialog.server.menu.show": "Afficher dans la liste des projets",
  "session.queue.count.one": "{{count}} en attente",
  "session.queue.count.many": "{{count}} en attente",
  "session.queue.count.other": "{{count}} en attente",
  "session.queue.steer": "Orienter",
  "session.queue.send": "Envoyer",
  "session.queue.steerTooltip": "Envoyer sans interrompre",
  "session.queue.remove": "Supprimer",
  "session.queue.reorder": "Réorganiser l’invite en attente",
  "session.new.worktree.creating": "Création de l’arbre de travail",
  "settings.backToApp": "Retour à l’application",
  "settings.appearance.section.experimental": "Expérimental",
  "settings.appearance.row.tabs.title": "Onglets",
  "settings.appearance.row.tabs.description": "Choisissez la disposition des onglets de session",
  "settings.appearance.row.tabs.horizontal": "Horizontale",
  "settings.appearance.row.tabs.vertical": "Verticale",
  "settings.general.row.followUpBehavior.title": "Comportement des relances",
  "settings.general.row.followUpBehavior.description":
    "Choisissez de mettre les relances en attente ou d’orienter le tour en cours. Utilisez {{keybind}} pour changer.",
  "settings.general.row.followUpBehavior.queue": "Mettre en attente",
  "settings.general.row.followUpBehavior.steer": "Orienter",
  "settings.general.row.reasoningMode.title": "Raisonnement du modèle",
  "settings.general.row.reasoningMode.description":
    "Choisissez comment afficher le raisonnement du modèle dans la chronologie",
  "settings.general.row.reasoningMode.hidden": "Masqué",
  "settings.general.row.reasoningMode.compact": "Compact",
  "settings.general.row.reasoningMode.full": "Complet",
  "session.new.workspace.createFrom": "Créer à partir d’une branche",
  "session.new.workspace.branch.search.placeholder": "Rechercher des branches",
  ...
  "session.review.change.many": "Modifications",
  ...
  "provider.connect.title.anthropicProMax": "Se connecter avec Anthropic",
  "prompt.toast.uploading.percent": "{{percent}} %",
  "prompt.toast.uploading.cancel": "Annuler le téléversement",
  ...
  "session.browser.empty.title": "Saisissez l’URL",
  "session.browser.empty.description": "Ou demandez « Ouvrir dans le navigateur de l’application »",
  "session.browser.failed.title": "L’URL est inaccessible",
  "session.browser.failed.description": "Vérifiez l’URL et votre connexion, puis réessayez.",
  "debugBar.providerAriaLabel": "Diagnostic des performances du fournisseur",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Temps entre l’envoi de la requête au fournisseur et la première sortie du modèle.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Temps entre l’envoi de la requête au fournisseur et le premier texte de réponse.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Jetons de sortie par seconde après la première sortie du modèle.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Temps entre l’envoi de la requête au fournisseur et la fin du flux de réponse.",
  "settings.updates.action.download": "Télécharger OpenCode",
  "settings.updates.migration.title": "Passer de la version bêta à la version stable",
