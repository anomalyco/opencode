export const dict = {
  ...
  "settings.timeline.advanced.explainer":
    "Les activités regroupées apparaissent dans Utilisé. Les détails s’appliquent après l’ouverture du groupe.",
  "settings.timeline.activity": "Activité",
  ...
  "settings.timeline.placement.title": "Emplacement",
  "settings.timeline.placement.separate": "Séparé",
  "settings.timeline.placement.grouped": "Regroupé",
  "settings.timeline.placement.hidden": "Masqué",
  "settings.timeline.expansion.title": "Détails",
  "settings.timeline.expansion.collapsed": "Réduit",
  "settings.timeline.expansion.expanded": "Développé",
  ...
  "session.queue.attachments": "+ pièces jointes",
