export const dict = {
  ...
  "command.debugBar.toggle": "Togol bar nyahpepijat",
  ...
  "command.session.location.cycle": "Kitar lokasi sesi",
  ...
  "provider.connect.title.anthropicProMax": "Log masuk dengan Anthropic",
  ...
  "prompt.toast.uploading.cancel": "Batalkan muat naik",
  "prompt.toast.uploading.cancelFile": "Batalkan muat naik {{filename}}",
  "prompt.toast.uploadFailed.title": "Muat naik gagal",
  ...
  "debugBar.providerAriaLabel": "Diagnostik prestasi penyedia",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Masa dari penghantaran permintaan penyedia hingga output pertama model.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Masa dari penghantaran permintaan penyedia hingga teks jawapan pertama.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Token output sesaat selepas output pertama model.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Masa dari penghantaran permintaan penyedia hingga strim responsnya tamat.",
  "debugBar.na": "tiada",
  ...
  "settings.updates.action.download": "Muat turun OpenCode",
  "settings.updates.migration.title": "Beralih daripada Beta kepada Stabil",
  ...
  "settings.workspaces.deleteAll.warning":
    "Pepohon kerja yang mempunyai perubahan belum digabungkan, sesi terpaut atau lokasi aktif akan dikekalkan.",
  ...
  "session.location.description": "Pilih direktori lain untuk meneruskan sesi ini.",
  "session.location.choose": "Pilih direktori",
  "session.location.worktree": "Pilih worktree",
  "session.location.worktreesFailed": "Gagal memuatkan worktree",
  "session.location.moving": "Memindahkan sesi…",
  "dialog.server.menu.hide": "Sembunyikan daripada senarai projek",
  "dialog.server.menu.show": "Tunjukkan dalam senarai projek",
  "session.queue.count.one": "{{count}} dalam baris gilir",
  "session.queue.count.other": "{{count}} dalam baris gilir",
  "session.queue.steer": "Halakan",
  "session.queue.send": "Hantar",
  "session.queue.steerTooltip": "Hantar tanpa mengganggu",
  "session.queue.remove": "Buang",
  "session.queue.reorder": "Susun semula gesaan dalam baris gilir",
  "session.new.worktree.creating": "Mencipta worktree",
  ...
  "settings.appearance.row.tabs.horizontal": "Mendatar",
  "settings.appearance.row.tabs.vertical": "Menegak",
  "settings.general.row.followUpBehavior.title": "Tingkah laku susulan",
  "settings.general.row.followUpBehavior.description":
    "Pilih sama ada hendak membaris gilir susulan atau menghalakan giliran semasa. Gunakan {{keybind}} untuk bertukar.",
  "settings.general.row.followUpBehavior.queue": "Baris gilir",
  "settings.general.row.followUpBehavior.steer": "Halakan",
  "settings.general.row.reasoningMode.title": "Penaakulan model",
  "settings.general.row.reasoningMode.description": "Pilih cara penaakulan model dipaparkan dalam garis masa",
  "settings.general.row.reasoningMode.hidden": "Tersembunyi",
  "settings.general.row.reasoningMode.compact": "Padat",
  "settings.general.row.reasoningMode.full": "Penuh",
  "session.new.workspace.createFrom": "Cipta daripada",
  "session.new.workspace.branch.search.placeholder": "Cari cawangan",
  "toast.migration.progress.clearingOldEvents": "Mengosongkan peristiwa lama",
  "toast.migration.progress.migratingSessions": "Memindahkan sesi",
  "session.new.workspace.existingLabel": "Worktree",
  "desktop.onboarding.defaultProject": "Projek Lalai",
  "home.projects.all": "Semua projek",
  "session.tab.files": "Fail",
  "session.files.openTabs": "Buka fail",
  ...
  "session.background.tasksRunning.one": "{{count}} tugasan latar belakang berjalan",
  "session.background.tasksRunning.other": "{{count}} tugasan latar belakang berjalan",
  "session.background.combine": "{{first}} dan {{second}}",
  "session.background.shell.one": "{{count}} cangkerang",
  "session.background.shell.other": "{{count}} cengkerang",
  ...
  "session.websearch.any": "mana-mana",
  "session.websearch.disable": "Jangan gunakan carian",
  "session.websearch.enable": "Dayakan",
  "session.websearch.loadFailed": "Tidak dapat memuatkan penyedia carian.",
  "session.websearch.empty": "Tiada pembekal carian tersedia.",
  "session.websearch.failed": "Tidak dapat menyimpan pilihan anda. Sila cuba lagi.",
  "session.websearch.retry": "Cuba semula",
  "session.new.worktree.draftPlaceholder": "Draf susulan semasa worktree sedang disediakan…",
  "session.search.placeholder": "Cari...",
  "session.search.noResults": "Tiada padanan",
  "titlebar.tabs": "Tab",
  "titlebar.channel.local": "Tempatan",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Togol alat nyahpepijat",
  "settings.tab.experimental": "Eksperimen",
  "settings.experimental.description": "Cuba ciri percubaan",
  "settings.tab.about": "Tentang",
  "settings.about.version": "Versi {{version}}",
  "settings.about.devVersion": "pembangunan",
  "settings.about.license": "Dikeluarkan di bawah Lesen MIT",
  "settings.about.writtenBy": "Ditulis oleh",
  "settings.about.illustratedBy": "Digambarkan oleh",
  "settings.about.and": "dan",
  "settings.about.otherContributor.one": "{{count}} lain",
  "settings.about.otherContributor.other": "{{count}} yang lain",
  "settings.about.firstPublished": "Pertama kali diterbitkan di Missouri, Amerika Syarikat",
  "settings.about.firstIllustrated": "Pertama digambarkan di London, England",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, ejen pengekodan sumber terbuka",
  "settings.about.trademark": "OpenCode ialah tanda dagangan berdaftar Anomaly Innovations, Inc.",
  "settings.about.typeset": "Set taip dalam Inter dan IBM Plex Mono",
  "settings.about.tagline": "AI tidak boleh membina perisian yang hebat, tanpa anda",
  "settings.about.copyright": "© Anomaly Innovations, Inc.",
  "settings.appearance.row.projectName.title": "Tunjukkan nama projek",
  "settings.appearance.row.projectName.description": "Tunjukkan nama projek dalam tab menegak dan laci tab mudah alih",
  "project.settings.title": "Edit projek",
  "settings.timeline.title": "Garis masa",
  "settings.timeline.detail": "Perincian garis masa",
  "settings.timeline.description": "Pilih jumlah aktiviti yang muncul dalam garis masa. Mesej kekal kelihatan.",
  "settings.timeline.preset.everything": "Semuanya",
  "settings.timeline.preset.detailed": "Terperinci",
  "settings.timeline.preset.compact": "Padat",
  "settings.timeline.preset.quiet": "senyap",
  "settings.timeline.preset.text-only": "Teks sahaja",
  ...
  "settings.timeline.custom": "Adat",
  "settings.timeline.advanced": "Maju",
  "settings.timeline.advanced.description": "Tetapkan peletakan dan butiran untuk setiap kategori aktiviti.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Suntingan",
  ...
  "session.review.filesChangedCount.one": "{{count}} fail ditukar",
  "session.review.filesChangedCount.other": "{{count}} fail ditukar",
  "settings.about.writtenByNames": "Ditulis oleh {{names}}",
  "settings.about.illustratedByNames": "Diilustrasikan oleh {{names}}",
  "ssh.label": "SSH",
  "ssh.offline": "Tidak bersambung ke {{host}}. Draf anda disimpan; kerja jarak jauh mungkin masih berjalan.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Tambah pelayan SSH",
  "ssh.server.menu.label": "Pelayan SSH",
  "ssh.target": "Hos atau arahan SSH",
  "ssh.connect": "Sambung",
  "ssh.connectTo": "Sambung ke {{host}}",
  "ssh.authenticate": "Pengesahan SSH",
  "ssh.action.authenticate": "Pengesahan",
  "ssh.session.disconnected": "Sambungan SSH tidak aktif",
  "ssh.session.connecting": "Menyambung ke pelayan SSH",
  "ssh.session.reconnectDescription":
    "Sambung semula untuk melihat sesi ini dan terus bekerja. Sesi jauh anda disimpan.",
  "ssh.session.reconnect": "Sambung semula",
  "ssh.authenticationRequired": "Pengesahan diperlukan untuk {{host}}",
  "ssh.trust": "Percaya dan sambung",
  "ssh.continue": "Teruskan",
  "ssh.retry": "Cuba semula",
  "ssh.update": "Kemas kini dan sambung semula",
  "ssh.openProject": "Buka projek",
  "ssh.project": "Buka projek di {{host}}",
  "ssh.disconnect": "Putuskan sambungan",
  "ssh.forget": "Lupakan sambungan",
  "ssh.stage.disconnected": "Sambungan terputus. Pelayan jauh dibiarkan berjalan.",
  "ssh.stage.connecting": "Menyambung melalui SSH…",
  "ssh.stage.checking": "Memeriksa OpenCode…",
  "ssh.stage.downloading": "Muat turun pelayan…",
  "ssh.stage.uploading": "Muat naik pelayan…",
  "ssh.stage.starting": "Menyambung ke OpenCode…",
  "ssh.stage.ready": "Disambungkan",
  "ssh.stage.authentication": "Pengesahan diperlukan",
  "ssh.stage.incompatible": "Kemas kini pelayan diperlukan",
  "ssh.stage.failed": "Sambungan gagal",
  "ssh.error.input":
    "Masukkan hos atau perintah sambungan SSH. Perintah jauh dan pilihan SSH yang tidak disokong tidak dibenarkan.",
  "ssh.error.connection": "Tidak dapat mewujudkan sambungan SSH. Semak rangkaian dan konfigurasi SSH anda.",
  "ssh.error.platform":
    "Platform jauh ini tidak disokong. Penetapan automatik kini memerlukan Linux atau macOS pada x64 atau arm64.",
  "ssh.error.version": "Perkhidmatan jauh mesti sepadan dengan versi Desktop ini sebelum menyambung.",
  "ssh.error.install": "Gagal memasang pelayan jauh. Semak sambungan, ruang cakera, dan pastikan tar dipasang.",
  ...
  "ssh.error.service": "SSH bersambung, tetapi pelayan OpenCode tidak bersedia.",
  "ssh.error.host-key":
    "Identiti hos tidak dapat disahkan. Sahkan cap jarinya sebelum mengemaskini hos yang diketahui dalam SSH anda.",
  "ssh.error.ssh-missing": "OpenSSH tidak dijumpai. Pasang klien OpenSSH dan pastikan ssh tersedia dalam PATH.",
  "command.browser.open": "Buka penyemak imbas",
  "command.browser.reload": "Muat semula halaman penyemak imbas",
  "command.session.summary.toggle": "Togol ringkasan",
  "common.color.orange": "oren",
  ...
  "common.color.gray": "kelabu",
  "mcp.auth.interactiveForm": "Pelayan MCP {{name}} memerlukan borang pengesahan interaktif",
  "server.connect.title": "Sambung ke pelayan",
  "server.connect.description": "Masukkan alamat pelayan dan kata laluan anda untuk memulakan.",
  ...
  "server.connect.camera": "Memasangkan kamera",
  ...
  "server.connect.camera.error":
    "Tidak dapat membuka kamera. Benarkan akses kamera atau masukkan butiran sambungan anda secara manual.",
  "dialog.server.menu.remove": "Alih keluar",
  "file.error.notFound": "Fail tidak dijumpai: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Menghijrah sesi {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Menghijrah sesi {{current}}/{{total}}",
  "toast.migration.progress.working": "Menghijrah data",
  "toast.migration.progress.working.current": "Menghijrah data {{current}}",
  "toast.migration.progress.working.progress": "Memindahkan data {{current}}/{{total}}",
  "home.workspaceTip": "Mula sesi seterusnya dalam ruang kerja baru untuk memastikan perubahan terasing",
  "session.tab.browser": "Pelayar",
  "session.tab.add": "Tambah tab",
  "session.queue.attachments.one": "Tambah {{count}} lampiran",
  "session.queue.attachments.other": "Tambah {{count}} lampiran",
  "session.browser.address": "Alamat pelayar",
  "session.browser.replaced": "Kawalan pelayar dipindahkan ke tetingkap desktop lain.",
  "session.browser.unsupported": "Aplikasi desktop ini tidak menyokong panel pelayar.",
  "session.browser.suspended": "Pelayar digantung. Berinteraksi dengan sesi ini untuk menyambung semula.",
  "session.browser.address.placeholder": "Masukkan URL",
  "session.browser.empty.title": "Masukkan URL",
  "session.browser.empty.description": 'Atau masukkan prompt "Buka dalam pelayar aplikasi"',
  "session.browser.failed.title": "URL tidak dapat dicapai",
  "session.browser.failed.description": "Semak URL dan sambungan anda, kemudian cuba lagi.",
  "settings.backToSettings": "Kembali ke tetapan",
  "settings.backToProjects": "Kembali ke projek",
  "settings.search.placeholder": "Cari",
  "settings.search.results": "Keputusan tetapan",
  "settings.search.group.pages": "Laman",
  "settings.search.group.settings": "Tetapan",
  "settings.search.group.projects": "Projek",
  "settings.search.group.servers": "Pelayan",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Tiada keputusan untuk {{query}}",
  "settings.search.refine": "Sempitkan carian anda untuk melihat keputusan yang lebih spesifik.",
  "settings.server.description": "Urus sambungan dan tetapan pelayan ini",
  "settings.server.section.connection": "Sambungan",
  "settings.server.preferences.websearch.title": "Carian pihak ketiga",
  "settings.server.preferences.websearch.description": "Pilih penyedia carian yang digunakan ejen untuk mencari di web",
  "settings.projects.search.placeholder": "Cari projek",
  "project.settings.name.title": "Nama projek",
  "project.settings.name.description": "Nama yang ditunjukkan untuk projek ini di seluruh OpenCode",
  "project.settings.icon.description": "Disyorkan: 128×128px. Klik atau seret untuk memuat naik imej.",
  "project.settings.color.description": "Digunakan untuk ikon projek apabila tiada imej khusus ditetapkan",
  "project.settings.worktree.startup.description": "Dijalankan sekali selepas membuat worktree baru",
  "project.settings.worktree.startup.hint.base": "Gunakan $OPENCODE_WORKTREE_BASE untuk worktree asas.",
  "project.settings.worktree.startup.hint.new": "Gunakan $OPENCODE_WORKTREE_PATH untuk worktree baru.",
  "project.settings.extensions.empty.mcps.title": "Tiada MCP lagi",
  "project.settings.extensions.empty.mcps.description": "MCP yang tersedia untuk OpenCode akan muncul di sini",
  "project.settings.extensions.empty.plugins.title": "Tiada plugin lagi",
  "project.settings.extensions.empty.plugins.description": "Plugin yang tersedia untuk OpenCode akan muncul di sini",
  "project.settings.extensions.empty.skills.title": "Tiada kemahiran lagi",
  "project.settings.extensions.empty.skills.description": "Kemahiran yang tersedia untuk OpenCode akan muncul di sini",
  "project.settings.extensions.lsp.configured": "Pelayan bahasa yang telah dikonfigurasi",
  ...
  "project.settings.extensions.lsp.empty.title": "Tiada pelayan bahasa dikonfigurasi",
  "project.settings.extensions.lsp.empty.description":
    "Pelayan bahasa yang dikonfigurasi untuk projek ini akan muncul di sini",
  "project.settings.extensions.lsp.disabled.title": "Pelayan bahasa dinonaktifkan",
  "project.settings.extensions.lsp.disabled.description": "LSP dinonaktifkan dalam konfigurasi projek ini",
  "project.settings.extensions.lsp.loadFailed": "Tidak dapat memuatkan konfigurasi pelayan bahasa",
  "project.settings.extensions.lsp.retry": "Cuba semula",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Kumpulan",
  "settings.timeline.collapse": "Runtuhkan",
  "settings.timeline.visibility.show": "Tunjukkan",
  "settings.timeline.visibility.hide": "Sembunyi",
  "settings.timeline.visibility.label": "Ketampakan {{activity}}",
  "settings.timeline.grouped.label": "{{activity}} dikelompokkan",
  "settings.timeline.collapsed.label": "{{activity}} diruntuhkan",
  "settings.general.row.browserPane.title": "Pelayar",
  "settings.general.row.browserPane.description":
    "Beri kebenaran kepada ejen untuk membuka dan mengawal pelayar pembangunan dalam apl.",
  "session.new.workspace.search.empty": "Tiada worktree sepadan",
  "settings.workspaces.description": "Semak worktree dan urus penggunaan cakera",
  "settings.workspaces.empty.description": "Worktree yang dibuat dalam OpenCode akan muncul di sini",
  "settings.workspaces.sessions.filtered.one": "{{count}} sesi",
  "settings.workspaces.sessions.filtered.other": "{{count}} sesi",
  "settings.workspaces.deleteAll.confirm.one": "Ini akan memadam secara kekal {{count}} worktree terpilih.",
  "settings.workspaces.deleteAll.confirm.other": "Ini akan memadam secara kekal {{count}} worktree terpilih.",
  "settings.workspaces.deleteWithoutSessions": "Padam worktrees tanpa sesi",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Ini akan memadam secara kekal {{count}} worktree tanpa sesi yang dipautkan.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Ini akan memadam secara kekal {{count}} worktree tanpa sesi yang dipautkan.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Worktrees dengan perubahan yang belum digabung atau lokasi aktif akan dikekalkan.",
  "settings.workspaces.delete.button": "Padam worktrees",
  "workspace.lifecycle.deleting": "Sedang memadam…",
  "session.summary.tooltip": "Ringkasan",
  "session.summary.server": "Lanjutan",
  "session.summary.chooseProject": "Pilih projek",
  "session.summary.mcp.onCreation": "Berkuat kuasa apabila worktree dicipta",
  "session.summary.mcp.prepareFailed": "Tidak dapat menyediakan pelayan MCP",
  "session.summary.mcp.unavailable": "Pelayan MCP {{name}} tidak tersedia dalam worktree ini.",
  "session.summary.mcp.signInBeforeSend": "Log masuk ke {{name}} sebelum menghantar prompt.",
  "session.summary.mcp.notReady":
    "Pelayan MCP {{name}} belum sedia. Selesaikan sambungannya sebelum menghantar prompt.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Pelayan MCP yang dikonfigurasikan",
  "session.summary.plugins": "Plugin",
  "session.summary.plugins.configured": "Plugin yang dikonfigurasikan",
  "session.summary.skills": "Kemahiran",
  "session.summary.skills.configured": "Kemahiran yang dikonfigurasikan",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Gagal",
  "session.summary.retry": "Cuba semula",
  "session.summary.connecting": "Menyambung…",
  "session.summary.needsAuth": "Perlu log masuk",
  "session.summary.configure": "Fail konfigurasi",
  "session.summary.copyConfigPath": "Salin laluan fail konfigurasi",
  "session.summary.configFileMissing": "Tiada fail konfigurasi dijumpai",
  "session.summary.mcp.empty": "Tiada pelayan MCP dikonfigurasikan",
  "session.summary.mcp.add": "Tambah pelayan dalam opencode.json",
  "session.summary.plugins.manage": "Urus plugin dalam opencode.json",
  "session.summary.plugins.empty": "Tiada plugin dikonfigurasikan",
  "session.summary.plugins.add": "Tambah plugin dalam opencode.json",
  "session.summary.skills.manage": "Urus kemahiran dalam opencode.json",
  "session.summary.skills.empty": "Tiada kemahiran dikonfigurasikan",
  "session.summary.skills.add": "Tambah kemahiran dalam opencode.json",
  "session.summary.lsp.configured": "LSP yang dikonfigurasikan",
  "session.summary.lsp.empty": "Tiada pelayan LSP dikonfigurasikan",
  "session.summary.lsp.manage": "Urus LSP dalam opencode.json",
  "workspace.delete.confirm": "Padam “{{name}}”?",
