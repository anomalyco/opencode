...
export const dict = {
  ...
  "session.queue.attachments": "+ ekler",
  ...
  "settings.timeline.advanced.explainer":
    "Gruplandırılmış etkinlik Kullanılanlar bölümüne gider. Detaylar grup açıldıktan sonra geçerlidir.",
  "settings.timeline.activity": "Etkinlik",
  ...
  "settings.timeline.placement.title": "Yerleştirme",
  "settings.timeline.placement.separate": "Ayrı",
  "settings.timeline.placement.grouped": "Gruplandırılmış",
  "settings.timeline.placement.hidden": "Gizli",
  "settings.timeline.expansion.title": "Ayrıntılar",
  "settings.timeline.expansion.collapsed": "Daraltılmış",
  "settings.timeline.expansion.expanded": "Genişletilmiş",
