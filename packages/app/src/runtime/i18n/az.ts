export const dict = {
  ...
  "session.queue.attachments": "+ əlavələr",
  ...
  "settings.appearance.row.projectName.title": "Layihə adlarını göstər",
  "settings.appearance.row.projectName.description": "Layihə adlarını şaquli tablarda və mobil tab panelində göstər",
  ...
  "settings.timeline.advanced.explainer":
    "Qruplaşdırılmış fəaliyyət «İstifadə edildi» bölməsinə keçir. Təfərrüatlar qrupu açdıqdan sonra tətbiq olunur.",
  "settings.timeline.activity": "Fəaliyyət",
  ...
  "settings.timeline.placement.title": "Yerləşdirmə",
  "settings.timeline.placement.separate": "Ayrı",
  "settings.timeline.placement.grouped": "Qruplaşdırılmış",
  "settings.timeline.placement.hidden": "Gizli",
  "settings.timeline.expansion.title": "Təfərrüatlar",
  "settings.timeline.expansion.collapsed": "Yığılmış",
  "settings.timeline.expansion.expanded": "Genişləndirilmiş",
