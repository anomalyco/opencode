export const dict = {
  ...
  "session.queue.attachments": "+ կցորդներ",
  ...
  "settings.timeline.advanced.explainer":
    "Խմբավորված գործունեությունը հայտնվում է «Օգտագործված» բաժնում։ Մանրամասները կիրառվում են խումբը բացելուց հետո։",
  "settings.timeline.activity": "Գործունեություն",
  ...
  "settings.timeline.placement.title": "Տեղադրում",
  "settings.timeline.placement.separate": "Առանձին",
  "settings.timeline.placement.grouped": "Խմբավորված",
  "settings.timeline.placement.hidden": "Թաքնված",
  "settings.timeline.expansion.title": "Մանրամասներ",
  "settings.timeline.expansion.collapsed": "Ծալված",
  "settings.timeline.expansion.expanded": "Ընդարձակված",
