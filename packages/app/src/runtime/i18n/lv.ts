export const dict = {
  ...
  "session.queue.attachments": "+ pielikumi",
  ...
  "settings.timeline.advanced.explainer":
    "Grupētas darbības tiek iekļautas sadaļā Lietotās. Sīkāka informācija tiek piemērota pēc grupas atvēršanas.",
  "settings.timeline.activity": "Aktivitāte",
  ...
  "settings.timeline.placement.title": "Izvietojums",
  "settings.timeline.placement.separate": "Atsevišķi",
  "settings.timeline.placement.grouped": "Sagrupēts",
  "settings.timeline.placement.hidden": "Slēpts",
  "settings.timeline.expansion.title": "Sīkāka informācija",
  "settings.timeline.expansion.collapsed": "Sakļauts",
  "settings.timeline.expansion.expanded": "Izvērsts",
