export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Tiks saglabāti darbkoki ar nesapludinātām izmaiņām, saistītām sesijām vai aktīvām atrašanās vietām.",
  ...
  "session.location.worktree": "Izvēlēties darba koku",
  "session.location.worktreesFailed": "Neizdevās ielādēt darba kokus",
  "session.location.moving": "Pārvieto sesiju…",
  "dialog.server.menu.hide": "Paslēpt projektu sarakstā",
  "dialog.server.menu.show": "Rādīt projektu sarakstā",
  "session.queue.count.zero": "Rindā: {{count}}",
  "session.queue.count.one": "Rindā: {{count}}",
  "session.queue.count.other": "Rindā: {{count}}",
  "session.queue.steer": "Virzīt",
  "session.queue.send": "Sūtīt",
  "session.queue.steerTooltip": "Sūtīt bez pārtraukšanas",
  "session.queue.remove": "Noņemt",
  "session.queue.reorder": "Pārkārtot rindā ievietoto uzvedni",
  "session.new.worktree.creating": "Izveido darba koku",
  "settings.backToApp": "Atpakaļ uz lietotni",
  "settings.appearance.section.experimental": "Eksperimentāli",
  "settings.appearance.row.tabs.title": "Cilnes",
  "settings.appearance.row.tabs.description": "Izvēlieties sesiju ciļņu izkārtojumu",
  "settings.appearance.row.tabs.horizontal": "Horizontāli",
  "settings.appearance.row.tabs.vertical": "Vertikāli",
  "settings.general.row.followUpBehavior.title": "Turpinājuma ziņojumu darbība",
  "settings.general.row.followUpBehavior.description":
    "Izvēlieties, vai turpinājuma ziņojumus ievietot rindā vai ar tiem virzīt pašreizējo gājienu. Pārslēgšanai izmantojiet {{keybind}}.",
  "settings.general.row.followUpBehavior.queue": "Ievietot rindā",
  "settings.general.row.followUpBehavior.steer": "Virzīt",
  "settings.general.row.reasoningMode.title": "Modeļa spriešana",
  "settings.general.row.reasoningMode.description": "Izvēlieties, kā modeļa spriešana tiek rādīta laika skalā",
  "settings.general.row.reasoningMode.hidden": "Paslēpta",
  "settings.general.row.reasoningMode.compact": "Kompakta",
  "settings.general.row.reasoningMode.full": "Pilna",
  "session.new.workspace.createFrom": "Izveidot no zara",
  "session.new.workspace.branch.search.placeholder": "Meklēt zarus",
  "session.review.change.zero": "Izmaiņu",
  "toast.migration.progress.clearingOldEvents": "Notīra vecos notikumus",
  "toast.migration.progress.migratingSessions": "Migrē sesijas",
  "session.new.workspace.existingLabel": "Darba koks",
  "desktop.onboarding.defaultProject": "Noklusējuma projekts",
  "home.projects.all": "Visi projekti",
  "session.tab.files": "Faili",
  "session.files.openTabs": "Atveriet failus",
  "session.tab.usage": "Lietošana",
  "session.view.select": "Sesijas skats",
  "session.background.moveTasks": "Pārvietojiet {{tasks}} uz fonu",
  "session.background.moveRunning": "Pāriet uz fonu",
  "session.background.inBackground": "Fonā darbojas {{tasks}}",
  "session.background.tasksRunning.one": "{{count}} fona uzdevums darbojas",
  "session.background.tasksRunning.other": "{{count}} fona uzdevumi darbojas",
  "session.background.combine": "{{first}} un {{second}}",
  "session.background.shell.one": "{{count}} apvalks",
  ...
  "session.websearch.any": "Jebkurš",
  "session.websearch.disable": "Neizmantojiet meklēšanu",
  "session.websearch.enable": "Iespējot",
  "session.websearch.loadFailed": "Nevarēja ielādēt meklēšanas pakalpojumu sniedzējus.",
  "session.websearch.empty": "Nav pieejami meklēšanas nodrošinātāji.",
  "session.websearch.failed": "Nevarēja saglabāt jūsu izvēli. Lūdzu, mēģiniet vēlreiz.",
  "session.websearch.retry": "Mēģiniet vēlreiz",
  "session.new.worktree.draftPlaceholder": "Uzmetiet turpinājuma projektu, kamēr tiek sagatavots darbkoks…",
  "session.search.placeholder": "Atrast…",
  "session.search.noResults": "Nav atbilstību",
  "titlebar.tabs": "Cilnes",
  "titlebar.channel.local": "Vietējais",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Pārslēgt atkļūdošanas rīkus",
  "settings.tab.experimental": "Eksperimentāls",
  "settings.experimental.description": "Izmēģiniet eksperimentālās funkcijas",
  "settings.tab.about": "Par",
  "settings.about.version": "Versija {{version}}",
  "settings.about.devVersion": "izstrādes versija",
  "settings.about.license": "Izlaists saskaņā ar MIT licenci",
  "settings.about.writtenBy": "Raksta",
  "settings.about.illustratedBy": "Ilustrējis",
  "settings.about.and": "un",
  "settings.about.otherContributor.one": "{{count}} cits",
  "settings.about.otherContributor.other": "{{count}} citi",
  "settings.about.firstPublished": "Pirmo reizi publicēts Misūri štatā, ASV",
  "settings.about.firstIllustrated": "Pirmo reizi ilustrēts Londonā, Anglijā",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, atvērtā koda kodēšanas aģents",
  "settings.about.trademark": "OpenCode ir Anomaly Innovations, Inc. reģistrēta preču zīme.",
  ...
  "settings.timeline.description": "Izvēlieties, cik daudz darbības tiek rādītas laika skalā. Ziņojumi paliek redzami.",
  "settings.timeline.preset.everything": "Viss",
  "settings.timeline.preset.detailed": "Detalizēti",
  "settings.timeline.preset.compact": "Kompakts",
  "settings.timeline.preset.quiet": "Kluss",
  "settings.timeline.preset.text-only": "Tikai teksts",
  ...
  "settings.timeline.description.custom":
    "Izmantojiet atlasīto izvietojumu un informāciju katrai darbības kategorijai.",
  "settings.timeline.custom": "Pielāgots",
  "settings.timeline.advanced": "Papildu",
  "settings.timeline.advanced.description": "Iestatiet izvietojumu un informāciju katrai darbības kategorijai.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Labojumi",
  "settings.timeline.category.thinking": "Domāšana",
  ...
  "session.background.tasksRunning.zero": "Darbojas {{count}} fona uzdevumu",
  ...
  "provider.connect.error.unsupportedFields": "Šajā autentifikācijas veidlapā ir neatbalstīti lauki",
  "session.review.filesChangedCount.one": "{{count}} fails mainīts",
  "session.review.filesChangedCount.other": "Mainīti {{count}} faili",
  "settings.about.writtenByNames": "Autors: {{names}}",
  "settings.about.illustratedByNames": "Ilustrējis {{names}}",
  "session.review.filesChangedCount.zero": "Mainīti {{count}} failu",
  "ssh.label": "SSH",
  "ssh.offline":
    "Nav savienots ar {{host}}. Jūsu melnraksts tiek saglabāts; attālinātais darbs joprojām var darboties.",
  "ssh.placeholder": "ssh lietotājs@example.com",
  "ssh.add": "Pievienot serveri SSH",
  "ssh.server.menu.label": "SSH serveris",
  "ssh.target": "Host vai SSH komanda",
  "ssh.connect": "Savienot",
  "ssh.connectTo": "Savienojiet ar {{host}}",
  "ssh.authenticate": "SSH autentifikācija",
  "ssh.action.authenticate": "Autentificēt",
  "ssh.session.disconnected": "SSH savienojums neaktīvs",
  "ssh.session.connecting": "Savienojuma izveide ar serveri SSH",
  "ssh.session.reconnectDescription":
    "Atkārtoti izveidojiet savienojumu, lai skatītu šo sesiju un turpinātu darbu. Jūsu attālā sesija tiek saglabāta.",
  "ssh.session.reconnect": "Atkārtoti savienot",
  "ssh.authenticationRequired": "Nepieciešama autentifikācija {{host}}",
  "ssh.trust": "Uzticieties un izveidojiet savienojumu",
  "ssh.continue": "Turpināt",
  "ssh.retry": "Mēģināt vēlreiz",
  "ssh.update": "Atjauniniet un atkārtoti izveidojiet savienojumu",
  "ssh.openProject": "Atvērts projekts",
  "ssh.project": "Atvērt projektu uz {{host}}",
  "ssh.disconnect": "Atvienot",
  "ssh.forget": "Aizmirstiet savienojumu",
  "ssh.stage.disconnected": "Atvienots. Attālais serveris ir atstāts darboties.",
  "ssh.stage.connecting": "Savienojuma izveide, izmantojot SSH…",
  "ssh.stage.checking": "Pārbauda OpenCode…",
  "ssh.stage.downloading": "Notiek servera lejupielāde…",
  "ssh.stage.uploading": "Notiek servera augšupielāde…",
  "ssh.stage.starting": "Savienojuma izveide ar OpenCode…",
  "ssh.stage.ready": "Savienots",
  "ssh.stage.authentication": "Nepieciešama autentifikācija",
  "ssh.stage.incompatible": "Nepieciešams servera atjauninājums",
  "ssh.stage.failed": "Savienojums neizdevās",
  "ssh.error.input":
    "Ievadiet resursdatora vai SSH savienojuma komandu. Tālvadības komandas un neatbalstītas SSH opcijas nav atļautas.",
  "ssh.error.connection": "Nevarēja izveidot savienojumu SSH. Pārbaudiet savu tīklu un SSH konfigurāciju.",
  "ssh.error.platform":
    "Šī attālā platforma netiek atbalstīta. Automātiskajai iestatīšanai pašlaik ir nepieciešams Linux vai macOS uz x64 vai arm64.",
  "ssh.error.version": "Pirms savienojuma izveides attālajam pakalpojumam ir jāatbilst šai darbvirsmas versijai.",
  "ssh.error.install":
    "Nevarēja instalēt attālo serveri. Pārbaudiet savienojumu, diska vietu un to, vai ir instalēta tar.",
  ...
  "ssh.error.service": "SSH ir izveidots savienojums, taču serveris OpenCode nebija gatavs.",
  "ssh.error.host-key":
  ...
  "ssh.error.ssh-missing":
    "OpenSSH netika atrasts. Instalējiet OpenSSH klientu un pārliecinieties, ka ssh ir pieejams PATH.",
  "command.browser.open": "Atvērt pārlūkprogrammu",
  "command.browser.reload": "Pārlādēt pārlūkprogrammas lapu",
  "command.session.summary.toggle": "Pārslēgt kopsavilkumu",
  "mcp.auth.interactiveForm": "MCP serverim {{name}} ir nepieciešama interaktīva autentifikācijas veidlapa",
  "server.connect.title": "Izveidojiet savienojumu ar serveri",
  "server.connect.description": "Lai sāktu, ievadiet servera adresi un paroli.",
  "server.connect.button": "Savienot",
  ...
  "server.connect.camera.error":
    "Nevarēja atvērt kameru. Atļaujiet piekļuvi kamerai vai manuāli ievadiet savienojuma informāciju.",
  "dialog.server.menu.remove": "Noņemt",
  "file.error.notFound": "Fails nav atrasts: {{name}}",
  "home.workspaceTip": "Sāciet nākamo sesiju jaunā darbvietā, lai izmaiņas būtu izolētas",
  "session.tab.browser": "Pārlūkprogramma",
  "session.tab.add": "Pievienot cilni",
  "session.queue.attachments.one": "Plus {{count}} stiprinājums",
  "session.queue.attachments.other": "Plus {{count}} stiprinājumi",
  "session.browser.address": "Pārlūkprogrammas adrese",
  "session.browser.replaced": "Pārlūka vadība ir pārvietota uz citu darbvirsmas logu.",
  "session.browser.suspended":
    "Pārlūka darbība ir apturēta. Mijiedarbojieties ar šo sesiju, lai atjaunotu savienojumu.",
  "session.browser.address.placeholder": "Ievadiet URL",
  "settings.backToSettings": "Atpakaļ uz iestatījumiem",
  "settings.backToProjects": "Atpakaļ uz projektiem",
  "settings.search.placeholder": "Meklēt",
  "settings.search.results": "Iestatījumu rezultāti",
  "settings.search.group.pages": "Lapas",
  "settings.search.group.settings": "Iestatījumi",
  "settings.search.group.projects": "Projekti",
  "settings.search.group.servers": "Serveri",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Nav rezultātu vaicājumam {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Sašauriniet meklēšanu, lai redzētu konkrētākus rezultātus.",
  "settings.server.description": "Pārvaldīt šī servera savienojumu un preferences",
  "settings.server.section.connection": "Savienojums",
  "settings.server.preferences.websearch.title": "Trešās puses meklēšana",
  "settings.server.preferences.websearch.description":
    "Atlasiet meklēšanas nodrošinātāja aģentus, ko izmanto, lai meklētu tīmeklī",
  "settings.projects.search.placeholder": "Meklēt projektus",
  "project.settings.name.title": "Projekta nosaukums",
  "project.settings.name.description": "Šī projekta nosaukums tiek rādīts visā OpenCode",
  "project.settings.icon.description":
    "Ieteicamais: 128 × 128 pikseļi. Noklikšķiniet vai velciet, lai augšupielādētu attēlu.",
  "project.settings.color.description": "Izmanto projekta ikonai, ja nav iestatīts pielāgots attēls",
  "project.settings.worktree.startup.description": "Palaiž vienu reizi pēc jauna darbkoka izveides",
  "project.settings.worktree.startup.hint.base": "Pamatdarba kokam izmantojiet $OPENCODE_WORKTREE_BASE.",
  "project.settings.worktree.startup.hint.new": "Izmantojiet $OPENCODE_WORKTREE_PATH jaunajam darbkokam.",
  "project.settings.extensions.empty.mcps.title": "MCPs vēl nav",
  "project.settings.extensions.empty.mcps.description": "MCPs, kas pieejams OpenCode, tiks parādīts šeit",
  "project.settings.extensions.empty.plugins.title": "Vēl nav spraudņu",
  "project.settings.extensions.empty.plugins.description": "OpenCode pieejamie spraudņi parādīsies šeit",
  "project.settings.extensions.empty.skills.title": "Vēl nav prasmju",
  "project.settings.extensions.empty.skills.description": "OpenCode pieejamās prasmes parādīsies šeit",
  "project.settings.extensions.lsp.configured": "Konfigurēti valodu serveri",
  "project.settings.extensions.lsp.status.enabled": "Iespējots konfigurācijā",
  "project.settings.extensions.lsp.status.disabled": "Atspējots konfigurācijā",
  "project.settings.extensions.lsp.empty.title": "Nav konfigurēts neviens valodas serveris",
  "project.settings.extensions.lsp.empty.description": "Šeit tiks parādīti šim projektam konfigurētie valodu serveri",
  "project.settings.extensions.lsp.disabled.title": "Valodu serveri atspējoti",
  "project.settings.extensions.lsp.disabled.description": "LSP ir atspējots šī projekta konfigurācijā",
  "project.settings.extensions.lsp.loadFailed": "Nevarēja ielādēt valodas servera konfigurāciju",
  "project.settings.extensions.lsp.retry": "Mēģināt vēlreiz",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Grupa",
  "settings.timeline.collapse": "Sakļaut",
  "settings.timeline.visibility.show": "Rādīt",
  "settings.timeline.visibility.hide": "Slēpt",
  ...
  "settings.workspaces.sessions.filtered.other": "{{count}} sesijas",
  "settings.workspaces.deleteAll.confirm.one": "Tādējādi tiks neatgriezeniski izdzēsts atlasītais darbkoks {{count}}.",
  "settings.workspaces.deleteAll.confirm.other": "Tas neatgriezeniski dzēsīs {{count}} atlasītos darbkokus.",
  "settings.workspaces.deleteWithoutSessions": "Dzēst darbkokus bez sesijām",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Tādējādi tiks neatgriezeniski izdzēsts {{count}} darbkoks bez saistītām sesijām.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Tādējādi tiks neatgriezeniski dzēsti {{count}} darbkoki bez saistītām sesijām.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Darbkoki ar neapvienotām izmaiņām vai aktīvām atrašanās vietām tiks saglabāti.",
  "settings.workspaces.delete.button": "Dzēst darba kokus",
  "workspace.lifecycle.deleting": "Notiek dzēšana…",
  "session.summary.tooltip": "Kopsavilkums",
  "session.summary.server": "Paplašinājumi",
  "session.summary.chooseProject": "Izvēlieties projektu",
  "session.summary.mcp.onCreation": "Attiecas, kad tiek izveidots darbkoks",
  "session.summary.mcp.prepareFailed": "Nevarēja sagatavot MCP serverus",
  "session.summary.mcp.unavailable": "MCP serveris {{name}} nav pieejams šajā darbkokā.",
  "session.summary.mcp.signInBeforeSend": "Pirms uzvednes nosūtīšanas pierakstieties {{name}}.",
  "session.summary.mcp.notReady":
    "MCP serveris {{name}} nav gatavs. Pirms uzvednes nosūtīšanas atrisiniet tā savienojumu.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfigurētie MCP serveri",
  "session.summary.plugins": "Spraudņi",
  "session.summary.plugins.configured": "Konfigurēti spraudņi",
  "session.summary.skills": "Prasmes",
  "session.summary.skills.configured": "Konfigurētas prasmes",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Neizdevās",
  "session.summary.retry": "Mēģināt vēlreiz",
  "session.summary.connecting": "Notiek savienošana…",
  "session.summary.needsAuth": "Nepieciešama pierakstīšanās",
  "session.summary.configure": "Konfigurācijas fails",
  "session.summary.copyConfigPath": "Kopēt konfigurācijas faila ceļu",
  "session.summary.configFileMissing": "Nav atrasts neviens konfigurācijas fails",
  "session.summary.mcp.empty": "Nav konfigurēts neviens MCP serveris",
  "session.summary.mcp.add": "Pievienojiet serverus failā opencode.json",
  "session.summary.plugins.manage": "Pārvaldīt spraudņus vietnē opencode.json",
  "session.summary.plugins.empty": "Nav konfigurēts neviens spraudnis",
  "session.summary.plugins.add": "Pievienojiet spraudņus failā opencode.json",
  "session.summary.skills.manage": "Pārvaldiet prasmes vietnē opencode.json",
  "session.summary.skills.empty": "Nav konfigurētu prasmju",
  "session.summary.skills.add": "Pievienojiet prasmes vietnē opencode.json",
  "session.summary.lsp.configured": "Konfigurēts LSPs",
  "session.summary.lsp.empty": "Nav konfigurēts neviens LSP serveris",
  "session.summary.lsp.manage": "Pārvaldiet LSP vietnē opencode.json",
  "workspace.delete.location": "Atrašanās vieta",
  "session.queue.attachments.zero": "Plus {{count}} stiprinājumi",
  "settings.workspaces.sessions.filtered.zero": "{{count}} sesijas",
  "settings.workspaces.deleteAll.confirm.zero": "Tas neatgriezeniski dzēsīs {{count}} atlasītos darbkokus.",
  "settings.workspaces.deleteWithoutSessions.confirm.zero":
    "Tādējādi tiks neatgriezeniski dzēsti {{count}} darbkoki bez saistītām sesijām.",
  "common.color.orange": "oranžs",
  "common.color.yellow": "dzeltens",
  "common.color.cyan": "ciāna",
  "common.color.green": "zaļš",
  "common.color.red": "sarkans",
  "common.color.pink": "rozā",
  "common.color.blue": "zils",
  "common.color.purple": "violeta",
  "common.color.gray": "pelēks",
  "toast.migration.progress.migratingSessions.current": "Sesiju migrēšana {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Sesiju migrēšana {{current}}/{{total}}",
  "toast.migration.progress.working": "Datu migrēšana",
  "toast.migration.progress.working.current": "Notiek datu migrēšana {{current}}",
  "toast.migration.progress.working.progress": "Notiek datu migrēšana {{current}}/{{total}}",
  "session.browser.unsupported": "Šī darbvirsmas lietotne neatbalsta pārlūkprogrammas rūti.",
  "command.debugBar.toggle": "Rādīt vai paslēpt atkļūdošanas joslu",
  "command.session.location.cycle": "Mainīt sesijas atrašanās vietu",
  "dialog.provider.anthropic.note": "Tieša piekļuve Claude modeļiem, izmantojot API atslēgu",
  "provider.connect.title.anthropicProMax": "Pieteikties, izmantojot Anthropic",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Atcelt augšupielādi",
  "prompt.toast.uploading.cancelFile": "Atcelt faila {{filename}} augšupielādi",
  "prompt.toast.uploadFailed.title": "Augšupielāde neizdevās",
  "session.browser.empty.title": "Ievadiet URL",
  "session.browser.empty.description": "Vai arī lūdziet “Atvērt lietotnes pārlūkā”",
  "session.browser.failed.title": "URL nav sasniedzams",
  "session.browser.failed.description": "Pārbaudiet URL un savienojumu un mēģiniet vēlreiz.",
  "debugBar.providerAriaLabel": "Pakalpojumu sniedzēja veiktspējas diagnostika",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "Laiks no pieprasījuma nosūtīšanas pakalpojumu sniedzējam līdz pirmajai modeļa izvadei.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "Laiks no pieprasījuma nosūtīšanas pakalpojumu sniedzējam līdz pirmajam atbildes tekstam.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Izvades žetoni sekundē pēc pirmās modeļa izvades.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "Laiks no pieprasījuma nosūtīšanas pakalpojumu sniedzējam līdz atbildes straumes beigām.",
  "settings.updates.action.download": "Lejupielādēt OpenCode",
  "settings.updates.migration.title": "Pāriet no Beta uz stabilo versiju",
