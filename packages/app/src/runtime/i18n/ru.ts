export const dict = {
  ...
  "session.queue.attachments": "+ вложения",
  ...
  "settings.timeline.advanced.explainer":
    "Сгруппированные действия переходят в Использовано. Подробности действуют после открытия группы.",
  "settings.timeline.activity": "Активность",
  ...
  "settings.timeline.placement.title": "Размещение",
  "settings.timeline.placement.separate": "Отдельный",
  "settings.timeline.placement.grouped": "Сгруппированы",
  "settings.timeline.placement.hidden": "Скрытый",
  "settings.timeline.expansion.title": "Подробности",
  "settings.timeline.expansion.collapsed": "Свернут",
  "settings.timeline.expansion.expanded": "Расширенный",
