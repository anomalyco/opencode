export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "Дарахтони корӣ бо тағйироти якҷоянашуда, ҷаласаҳои пайваст ё маконҳои фаъол нигоҳ дошта мешаванд.",
  ...
  "session.location.worktree": "Интихоби worktree",
  "session.location.worktreesFailed": "Боркунии worktree-ҳо ноком шуд",
  "session.location.moving": "Сессия интиқол дода мешавад…",
  "dialog.server.menu.hide": "Аз рӯйхати лоиҳаҳо пинҳон кунед",
  "dialog.server.menu.show": "Дар рӯйхати лоиҳаҳо нишон диҳед",
  "session.queue.count.one": "{{count}} дар навбат",
  "session.queue.count.other": "{{count}} дар навбат",
  "session.queue.steer": "Роҳнамоӣ",
  "session.queue.send": "Фиристодан",
  "session.queue.steerTooltip": "Бе қатъ кардан фиристед",
  "session.queue.remove": "Хориҷ кардан",
  "session.queue.reorder": "Ҷойи промпти навбатиро иваз кунед",
  "session.new.worktree.creating": "Worktree эҷод мешавад",
  "settings.backToApp": "Бозгашт ба барнома",
  "settings.appearance.section.experimental": "Озмоишӣ",
  "settings.appearance.row.tabs.title": "Ҷадвалбандҳо",
  "settings.appearance.row.tabs.description": "Тарзи ҷойгиршавии ҷадвалбандҳои сессияро интихоб кунед",
  "settings.appearance.row.tabs.horizontal": "Уфуқӣ",
  "settings.appearance.row.tabs.vertical": "Амудӣ",
  "settings.general.row.followUpBehavior.title": "Рафтори паёмҳои минбаъда",
  "settings.general.row.followUpBehavior.description":
    "Интихоб кунед, ки паёмҳои минбаъда ба навбат гузошта шаванд ё даври ҷорӣ роҳнамоӣ шавад. Барои иваз кардан {{keybind}}-ро истифода баред.",
  "settings.general.row.followUpBehavior.queue": "Ба навбат гузоштан",
  "settings.general.row.followUpBehavior.steer": "Роҳнамоӣ",
  "settings.general.row.reasoningMode.title": "Истидлоли модел",
  "settings.general.row.reasoningMode.description":
    "Интихоб кунед, ки истидлоли модел дар ҷадвали вақт чӣ гуна нишон дода шавад",
  "settings.general.row.reasoningMode.hidden": "Пинҳон",
  "settings.general.row.reasoningMode.compact": "Фишурда",
  "settings.general.row.reasoningMode.full": "Пурра",
  "session.new.workspace.createFrom": "Аз ин ҷо эҷод кунед",
  "session.new.workspace.branch.search.placeholder": "Ҷустуҷӯи шохаҳо",
  "toast.migration.progress.clearingOldEvents": "Рӯйдодҳои кӯҳна тоза мешаванд",
  "toast.migration.progress.migratingSessions": "Сессияҳо интиқол дода мешаванд",
  "session.new.workspace.existingLabel": "Git worktree",
  "desktop.onboarding.defaultProject": "Лоиҳаи пешфарз",
  "home.projects.all": "Ҳамаи лоиҳаҳо",
  "session.tab.files": "Файлҳо",
  "session.files.openTabs": "Файлҳои кушода",
  "session.tab.usage": "Истифода",
  ...
  "session.background.tasksRunning.one": "{{count}} вазифаи заминавӣ иҷро шуда истодааст",
  "session.background.tasksRunning.other": "{{count}} вазифаи заминавӣ иҷро шуда истодаанд",
  ...
  "session.background.subagent.one": "{{count}} зер-агент",
  "session.background.subagent.other": "{{count}} зер-агент",
  ...
  "session.websearch.provider": "Провайдери ҷустуҷӯ",
  "session.websearch.any": "Ҳар кадом",
  "session.websearch.disable": "Ҷустуҷӯро истифода набаред",
  "session.websearch.enable": "Фаъол кардан",
  "session.websearch.loadFailed": "Провайдерҳои ҷустуҷӯ бор карда нашуданд.",
  "session.websearch.empty": "Ягон провайдери ҷустуҷӯ дастрас нест.",
  "session.websearch.failed": "Интихоби шумо захира карда нашуд. Лутфан, аз нав кӯшиш кунед.",
  "session.websearch.retry": "Аз нав кӯшиш кунед",
  "session.new.worktree.draftPlaceholder": "Ҳангоми омода шудани worktree паёми минбаъдаро омода кунед…",
  "session.search.placeholder": "Ёфтан...",
  "session.search.noResults": "Мувофиқат нест",
  "titlebar.tabs": "Ҷадвалбандҳо",
  "titlebar.channel.local": "Маҳаллӣ",
  "titlebar.channel.dev": "Таҳия",
  "titlebar.channel.beta": "Бета",
  "titlebar.toggleDebugTools": "Фаъол ё ғайрифаъол кардани абзорҳои ислоҳи хато",
  "settings.tab.experimental": "Озмоишӣ",
  "settings.experimental.description": "Имкониятҳои озмоиширо санҷед",
  "settings.tab.about": "Дар бораи барнома",
  "settings.about.version": "Версияи {{version}}",
  "settings.about.devVersion": "таҳия",
  "settings.about.license": "Таҳти иҷозатномаи MIT нашр шудааст",
  "settings.about.writtenBy": "Муаллиф",
  "settings.about.illustratedBy": "Мусаввир",
  "settings.about.and": "ва",
  "settings.about.otherContributor.one": "{{count}} нафари дигар",
  "settings.about.otherContributor.other": "{{count}} нафари дигар",
  "settings.about.firstPublished": "Бори аввал дар Миссури, ИМА нашр шудааст",
  "settings.about.firstIllustrated": "Бори аввал дар Лондон, Англия мусаввар шудааст",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, агенти рамзнависии манбаи кушода",
  "settings.about.trademark": "OpenCode тамғаи тиҷории бақайдгирифтаи Anomaly Innovations, Inc. мебошад.",
  ...
  "settings.timeline.description":
    "Интихоб кунед, ки чӣ қадар фаъолият дар ҷадвали вақт нишон дода шавад. Паёмҳо намоён мемонанд.",
  "settings.timeline.preset.everything": "Ҳама чиз",
  "settings.timeline.preset.detailed": "Муфассал",
  "settings.timeline.preset.compact": "Фишурда",
  "settings.timeline.preset.quiet": "Ором",
  "settings.timeline.preset.text-only": "Танҳо матн",
  "settings.timeline.description.everything":
    "Ҳамаи фаъолиятро ҷудогона нишон диҳед. Баромади shell, таҳрирҳо ва андешарониро васеъ кунед.",
  "settings.timeline.description.detailed":
    "Баромади shell ва таҳрирҳоро васеъ кунед. Зер-агентҳоро ҷудогона нишон диҳед ва фаъолияти дигарро дар «Истифодашуда» гурӯҳбандӣ кунед.",
  "settings.timeline.description.compact": "Ҳамаи фаъолиятро бо тафсилоти пӯшида дар «Истифодашуда» гурӯҳбандӣ кунед.",
  "settings.timeline.description.quiet":
    "Таҳрирҳо ва зер-агентҳоро дар «Истифодашуда» гурӯҳбандӣ кунед. Фаъолияти дигарро пинҳон кунед.",
  "settings.timeline.description.text-only": "Ҳамаи фаъолиятро пинҳон кунед. Танҳо паёмҳоро нишон диҳед.",
  "settings.timeline.description.custom":
    "Барои ҳар як гурӯҳи фаъолият ҷойгиршавӣ ва тафсилоти интихобкардаатонро истифода баред.",
  "settings.timeline.custom": "Фармоишӣ",
  "settings.timeline.advanced": "Пешрафта",
  "settings.timeline.advanced.description": "Барои ҳар як гурӯҳи фаъолият ҷойгиршавӣ ва тафсилотро танзим кунед.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Таҳрирҳо",
  "settings.timeline.category.thinking": "Андешаронӣ",
  ...
  "session.review.filesChangedCount.one": "{{count}} файл тағйир ёфт",
  "session.review.filesChangedCount.other": "{{count}} файл тағйир ёфтанд",
  "settings.about.writtenByNames": "Муаллиф: {{names}}",
  "settings.about.illustratedByNames": "Мусаввир: {{names}}",
  "ssh.label": "SSH",
  "ssh.offline":
    "Ба {{host}} пайваст нашудааст. Лоиҳаи шумо нигоҳ дошта мешавад; кори дурдаст метавонад то ҳол иҷро шавад.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "Илова кардани сервери SSH",
  "ssh.server.menu.label": "Сервери SSH",
  "ssh.target": "Фармони хост ё SSH",
  "ssh.connect": "Пайваст кунед",
  "ssh.connectTo": "Ба {{host}} пайваст шавед",
  "ssh.authenticate": "Аутентификатсияи SSH",
  "ssh.action.authenticate": "Тасдиқ кардан",
  "ssh.session.disconnected": "Пайвасти SSH ғайрифаъол аст",
  "ssh.session.connecting": "Пайвастшавӣ ба сервери SSH",
  "ssh.session.reconnectDescription":
    "Барои дидани ин ҷаласа дубора пайваст шавед ва корро идома диҳед. Сеанси дурдасти шумо нигоҳ дошта мешавад.",
  "ssh.session.reconnect": "Аз нав пайваст кунед",
  "ssh.authenticationRequired": "Барои {{host}} аутентификатсия лозим аст",
  "ssh.trust": "Бовар кунед ва пайваст шавед",
  "ssh.continue": "Давом додан",
  "ssh.retry": "Аз нав кӯшиш кунед",
  "ssh.update": "Навсозӣ ва дубора пайваст кунед",
  "ssh.openProject": "Лоиҳаи кушода",
  "ssh.project": "Кушодани лоиҳа дар {{host}}",
  "ssh.disconnect": "Қатъ кунед",
  "ssh.forget": "Пайвастшавӣ фаромӯш кунед",
  "ssh.stage.disconnected": "Қатъи. Сервери дурдаст кор мекунад.",
  "ssh.stage.connecting": "Пайвастшавӣ тавассути SSH…",
  "ssh.stage.checking": "Санҷиши OpenCode…",
  "ssh.stage.downloading": "Зеркашӣ кардани сервер…",
  "ssh.stage.uploading": "Сервер бор карда мешавад…",
  "ssh.stage.starting": "Пайвастшавӣ ба OpenCode…",
  "ssh.stage.ready": "пайваст",
  "ssh.stage.authentication": "Аутентификатсия талаб карда мешавад",
  "ssh.stage.incompatible": "Навсозии сервер талаб карда мешавад",
  "ssh.stage.failed": "Пайваст ноком шуд",
  "ssh.error.input":
    "Фармони пайвастшавӣ ё SSH-ро ворид кунед. Фармонҳои дурдаст ва имконоти дастгирӣнашавандаи SSH иҷозат дода намешаванд.",
  "ssh.error.connection": "Пайвасти SSH барқарор карда нашуд. Шабака ва конфигуратсияи SSH-и худро санҷед.",
  "ssh.error.platform":
    "Ин платформаи дурдаст дастгирӣ намешавад. Танзимоти худкор ҳоло Linux ё macOS-ро дар x64 ё arm64 талаб мекунад.",
  "ssh.error.version": "Пеш аз пайваст шудан хидмати дурдаст бояд ба ин версияи мизи корӣ мувофиқ бошад.",
  "ssh.error.install":
    "Сервери дурдаст насб карда нашуд. Пайвастшавӣ, фазои дискро тафтиш кунед ва он қатрон насб шудааст.",
  "ssh.error.unpublished":
    "Ин версияи мизи корӣ сервери дурдасти нашршуда надорад. Барои сохтани таҳия, V2-ро дар мизбон насб кунед ва оғоз кунед, пас аз нав кӯшиш кунед.",
  "ssh.error.service": "SSH пайваст шуд, аммо сервери OpenCode омода нашуд.",
  "ssh.error.host-key":
  ...
  "command.browser.open": "Браузерро кушоед",
  "command.browser.reload": "Саҳифаи браузерро аз нав бор кунед",
  "command.session.summary.toggle": "Гузаронидани хулоса",
  "common.color.orange": "норанҷӣ",
  "common.color.yellow": "зард",
  "common.color.cyan": "фирӯзагӣ",
  "common.color.green": "сабз",
  "common.color.red": "сурх",
  "common.color.pink": "гулобӣ",
  "common.color.blue": "кабуд",
  "common.color.purple": "бунафш",
  "common.color.gray": "хокистарӣ",
  "mcp.auth.interactiveForm": "Сервери MCP {{name}} шакли интерактивии аутентификатсияро талаб мекунад",
  "server.connect.title": "Ба сервер пайваст шавед",
  "server.connect.description": "Барои оғоз кардан суроғаи сервер ва пароли худро ворид кунед.",
  ...
  "server.connect.camera.error":
    "Камераро кушода натавонист. Ба дастрасӣ ба камера иҷозат диҳед ё тафсилоти пайвасти худро дастӣ ворид кунед.",
  "dialog.server.menu.remove": "Хориҷ кунед",
  "file.error.notFound": "Файл ёфт нашуд: {{name}}",
  "toast.migration.progress.migratingSessions.current": "Интиқоли ҷаласаҳо {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Интиқоли ҷаласаҳо {{current}}/{{total}}",
  "toast.migration.progress.working": "Интиқоли додаҳо",
  "toast.migration.progress.working.current": "Интиқоли додаҳо {{current}}",
  "toast.migration.progress.working.progress": "Интиқоли додаҳо {{current}}/{{total}}",
  "home.workspaceTip": "Сеанси навбатиро дар фазои кории нав оғоз кунед, то тағирот дар алоҳидагӣ нигоҳ дошта шавад",
  "session.tab.browser": "Браузер",
  "session.tab.add": "Иловаи ҷадвал",
  "session.queue.attachments.one": "Илова бар замимаи {{count}}",
  "session.queue.attachments.other": "Илова бар ин {{count}} замима",
  "session.browser.address": "Суроғаи браузер",
  "session.browser.replaced": "Назорати браузер ба равзанаи дигари мизи корӣ кӯчонида шуд.",
  "session.browser.unsupported": "Ин барномаи мизи корӣ панели браузерро дастгирӣ намекунад.",
  "session.browser.suspended": "Браузер боздошта шуд. Барои аз нав пайваст шудан бо ин сессия муошират кунед.",
  "session.browser.address.placeholder": "URL-ро ворид кунед",
  "settings.backToSettings": "Бозгашт ба танзимот",
  "settings.backToProjects": "Бозгашт ба лоиҳаҳо",
  "settings.search.placeholder": "Ҷустуҷӯ",
  "settings.search.results": "Натиҷаҳои танзимот",
  "settings.search.group.pages": "Саҳифаҳо",
  "settings.search.group.settings": "Танзимотҳо",
  "settings.search.group.projects": "Лоиҳаҳо",
  "settings.search.group.servers": "Серверҳо",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Натоиҷе барои {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Ҷустуҷӯи худро танг кунед, то натиҷаҳои мушаххасро бубинед.",
  "settings.server.description": "Пайвастшавӣ ва афзалиятҳои ин серверро идора кунед",
  "settings.server.section.connection": "Пайвастшавӣ",
  "settings.server.preferences.websearch.title": "Ҷустуҷӯи тарафи сеюм",
  "settings.server.preferences.websearch.description":
    "Агенти провайдери ҷустуҷӯро интихоб кунед, ки барои ҷустуҷӯ дар веб истифода мебаранд",
  "settings.projects.search.placeholder": "Ҷустуҷӯи лоиҳаҳо",
  "project.settings.name.title": "Номи лоиҳа",
  "project.settings.name.description": "Номе, ки барои ин лоиҳа дар саросари OpenCode нишон дода шудааст",
  "project.settings.icon.description":
    "Тавсия дода мешавад: 128×128px. Барои бор кардани тасвир клик кунед ё кашола кунед.",
  "project.settings.color.description":
    "Барои тасвири лоиҳа истифода мешавад, вақте ки ягон тасвири фармоишӣ муқаррар карда нашудааст",
  "project.settings.worktree.startup.description": "Пас аз сохтани дарахти нави корӣ як маротиба иҷро мешавад",
  "project.settings.worktree.startup.hint.base": "Барои дарахти кории асосӣ $OPENCODE_WORKTREE_BASE-ро истифода баред.",
  "project.settings.worktree.startup.hint.new": "Барои дарахти нави корӣ $OPENCODE_WORKTREE_PATH-ро истифода баред.",
  "project.settings.extensions.empty.mcps.title": "Ҳанӯз MCP нест",
  "project.settings.extensions.empty.mcps.description": "MCP-ҳои барои OpenCode дастрас дар ин ҷо пайдо мешаванд",
  "project.settings.extensions.empty.plugins.title": "Ҳоло ягон плагинҳо нест",
  "project.settings.extensions.empty.plugins.description":
    "Васлкунакҳои дастрас барои OpenCode дар ин ҷо пайдо мешаванд",
  "project.settings.extensions.empty.skills.title": "Ҳанӯз малака нест",
  "project.settings.extensions.empty.skills.description": "Малакаҳои дастрас барои OpenCode дар ин ҷо пайдо мешаванд",
  "project.settings.extensions.lsp.configured": "Серверҳои забонҳои танзимшуда",
  "project.settings.extensions.lsp.status.enabled": "Дар конфигуратсия фаъол карда шудааст",
  "project.settings.extensions.lsp.status.disabled": "Дар конфигуратсия ғайрифаъол",
  "project.settings.extensions.lsp.empty.title": "Ҳеҷ сервери забон танзим карда нашудааст",
  "project.settings.extensions.lsp.empty.description":
    "Серверҳои забони барои ин лоиҳа танзимшуда дар ин ҷо пайдо мешаванд",
  "project.settings.extensions.lsp.disabled.title": "Серверҳои забонӣ хомӯш карда шудаанд",
  "project.settings.extensions.lsp.disabled.description": "LSP дар конфигуратсияи ин лоиҳа ғайрифаъол аст",
  "project.settings.extensions.lsp.loadFailed": "Конфигуратсияи сервери забонро бор карда натавонист",
  "project.settings.extensions.lsp.retry": "Аз нав кӯшиш кунед",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Гурӯҳ",
  "settings.timeline.collapse": "Фурӯпошӣ",
  "settings.timeline.visibility.show": "Намоиш",
  "settings.timeline.visibility.hide": "Пинҳон кардан",
  ...
  "settings.workspaces.sessions.filtered.other": "{{count}} сессия",
  "settings.workspaces.deleteAll.confirm.one": "Ин {{count}} дарахти кории интихобшударо ба таври доимӣ нест мекунад.",
  "settings.workspaces.deleteAll.confirm.other":
    "Ин {{count}} дарахти кории интихобшударо ба таври доимӣ нест мекунад.",
  "settings.workspaces.deleteWithoutSessions": "Дарахти кории бе сессияҳоро нест кунед",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Ин {{count}} дарахти кории бе сеансҳои алоқамандро ба таври доимӣ нест мекунад.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Ин {{count}} дарахти кории бе сессияҳои алоқамандро ба таври доимӣ нест мекунад.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "Дарахтҳои корӣ бо тағиротҳои муттаҳиднашуда ё ҷойгиршавии фаъол нигоҳ дошта мешаванд.",
  "settings.workspaces.delete.button": "Тоза кардани дарахтони корӣ",
  "workspace.lifecycle.deleting": "Нест карда мешавад…",
  "session.summary.tooltip": "Хулоса",
  "session.summary.server": "Васеъшавӣ",
  "session.summary.chooseProject": "Лоиҳаро интихоб кунед",
  "session.summary.mcp.onCreation": "Ҳангоми сохтани дарахти корӣ татбиқ мешавад",
  "session.summary.mcp.prepareFailed": "Серверҳои MCP омода карда нашуд",
  "session.summary.mcp.unavailable": "Сервери MCP {{name}} дар ин дарахти корӣ мавҷуд нест.",
  "session.summary.mcp.signInBeforeSend": "Пеш аз фиристодани дархост ба {{name}} ворид шавед.",
  "session.summary.mcp.notReady":
    "Сервери MCP {{name}} омода нест. Пеш аз фиристодани дархост пайвасти онро ҳал кунед.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Серверҳои танзимшудаи MCP",
  "session.summary.plugins": "Плагинҳо",
  "session.summary.plugins.configured": "Плагинҳои танзимшуда",
  "session.summary.skills": "Маҳорат",
  "session.summary.skills.configured": "Малакаҳои танзимшуда",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Муваффақ шуд",
  "session.summary.retry": "Аз нав кӯшиш кунед",
  "session.summary.connecting": "Пайвастшавӣ…",
  "session.summary.needsAuth": "Ворид шудан лозим аст",
  "session.summary.configure": "Файли конфигуратсия",
  "session.summary.copyConfigPath": "Роҳи файли конфигуратсияро нусхабардорӣ кунед",
  "session.summary.configFileMissing": "Ягон файли конфигуратсия ёфт нашуд",
  "session.summary.mcp.empty": "Ягон сервери MCP танзим карда нашудааст",
  "session.summary.mcp.add": "Илова кардани серверҳо дар opencode.json",
  "session.summary.plugins.manage": "Плагинҳоро дар opencode.json идора кунед",
  "session.summary.plugins.empty": "Ягон плагинҳо танзим карда нашудаанд",
  "session.summary.plugins.add": "Иловаи плагинҳо дар opencode.json",
  "session.summary.skills.manage": "Идоракунии малакаҳо дар opencode.json",
  "session.summary.skills.empty": "Ягон малака танзим карда нашудааст",
  "session.summary.skills.add": "Илова кардани малакаҳо дар opencode.json",
  "session.summary.lsp.configured": "LSP-ҳои танзимшуда",
  "session.summary.lsp.empty": "Ҳеҷ сервери LSP танзим нашудааст",
  "session.summary.lsp.manage": "LSP-ро дар opencode.json идора кунед",
  "workspace.delete.location": "Ҷойгиршавӣ",
  "command.debugBar.toggle": "Навори ислоҳи хатоҳоро иваз кунед",
  "command.session.location.cycle": "Ҷойгиршавии сессияро иваз кунед",
  "dialog.provider.anthropic.note": "Дастрасии мустақим ба моделҳои Claude тавассути калиди API",
  "provider.connect.title.anthropicProMax": "Бо Anthropic ворид шавед",
  "prompt.toast.uploading.cancel": "Боркуниро бекор кунед",
  ...
  "session.browser.empty.title": "URL-ро ворид кунед",
  "session.browser.empty.description": "Ё дархости «Дар браузери барнома кушоед»-ро ворид кунед",
  "session.browser.failed.title": "URL дастнорас аст",
  "session.browser.failed.description": "URL ва пайвастшавиро санҷед ва аз нав кӯшиш кунед.",
  "debugBar.providerAriaLabel": "Ташхиси кори таъминкунанда",
  "debugBar.ttft.tip": "Вақт аз фиристодани дархост ба таъминкунанда то баромади аввалини модел.",
  "debugBar.ttfa.tip": "Вақт аз фиристодани дархост ба таъминкунанда то матни аввалини ҷавоб.",
  "debugBar.tps.tip": "Шумораи токенҳои баромад дар як сония пас аз баромади аввалини модел.",
  "debugBar.e2e.tip": "Вақт аз фиристодани дархост ба таъминкунанда то анҷоми ҷараёни ҷавоб.",
  "settings.updates.action.download": "OpenCode-ро боргирӣ кунед",
  "settings.updates.migration.title": "Аз Beta ба Stable гузаред",
