...
export const dict = {
  ...
  "settings.workspaces.deleteAll.warning":
    "A nem egyesített módosításokkal, összekapcsolt munkamenetekkel vagy aktív helyekkel rendelkező munkafák megmaradnak.",
  ...
  "session.location.worktree": "Munkafa kiválasztása",
  "session.location.worktreesFailed": "Nem sikerült betölteni a munkafákat",
  "session.location.moving": "Munkamenet áthelyezése…",
  "dialog.server.menu.hide": "Elrejtés a projektlistából",
  "dialog.server.menu.show": "Megjelenítés a projektlistában",
  "session.queue.count.one": "{{count}} várakozik",
  "session.queue.count.other": "{{count}} várakozik",
  "session.queue.steer": "Irányítás",
  "session.queue.send": "Küldés",
  "session.queue.steerTooltip": "Küldés megszakítás nélkül",
  "session.queue.remove": "Eltávolítás",
  "session.queue.reorder": "Sorba állított prompt átrendezése",
  "session.new.worktree.creating": "Munkafa létrehozása",
  "settings.backToApp": "Vissza az alkalmazáshoz",
  "settings.appearance.section.experimental": "Kísérleti",
  "settings.appearance.row.tabs.title": "Lapok",
  "settings.appearance.row.tabs.description": "Válassza ki a munkamenetlapok elrendezését",
  "settings.appearance.row.tabs.horizontal": "Vízszintes",
  "settings.appearance.row.tabs.vertical": "Függőleges",
  "settings.general.row.followUpBehavior.title": "Követő üzenetek viselkedése",
  "settings.general.row.followUpBehavior.description":
    "Válassza ki, hogy a követő üzenetek sorba álljanak vagy az aktuális kört irányítsák. A váltáshoz használja a(z) {{keybind}} billentyűt.",
  "settings.general.row.followUpBehavior.queue": "Sorba állítás",
  "settings.general.row.followUpBehavior.steer": "Irányítás",
  "settings.general.row.reasoningMode.title": "Modell következtetése",
  "settings.general.row.reasoningMode.description":
    "Válassza ki, hogyan jelenjen meg a modell következtetése az idővonalon",
  "settings.general.row.reasoningMode.hidden": "Rejtett",
  "settings.general.row.reasoningMode.compact": "Tömör",
  "settings.general.row.reasoningMode.full": "Teljes",
  "session.new.workspace.createFrom": "Létrehozás ágból",
  "session.new.workspace.branch.search.placeholder": "Ágak keresése",
  "toast.migration.progress.clearingOldEvents": "Régi események törlése",
  "toast.migration.progress.migratingSessions": "Munkamenetek áttelepítése",
  "session.new.workspace.existingLabel": "Munkafa",
  "home.projects.all": "Minden projekt",
  "session.tab.files": "Fájlok",
  "session.files.openTabs": "Nyissa meg a fájlokat",
  "session.tab.usage": "Használat",
  "session.view.select": "Munkamenet nézet",
  "session.background.moveTasks": "A {{tasks}} áthelyezése a háttérbe",
  "session.background.moveRunning": "Ugrás a háttérre",
  "session.background.inBackground": "{{tasks}} fut a háttérben",
  "session.background.tasksRunning.one": "{{count}} háttérfeladat fut",
  "session.background.tasksRunning.other": "{{count}} háttérfeladatok futnak",
  ...
  "session.websearch.any": "Bármelyik",
  "session.websearch.disable": "Ne használja a keresést",
  "session.websearch.enable": "Engedélyezés",
  "session.websearch.loadFailed": "Nem sikerült betölteni a keresőszolgáltatókat.",
  "session.websearch.empty": "Nem állnak rendelkezésre keresési szolgáltatók.",
  "session.websearch.failed": "Nem sikerült menteni a választást. Kérjük, próbálja újra.",
  "session.websearch.retry": "Próbálja újra",
  "session.new.worktree.draftPlaceholder": "Készítsen nyomon követést, amíg a munkafa készül…",
  "session.search.placeholder": "Találd meg…",
  "session.search.noResults": "Nincs egyezés",
  "titlebar.tabs": "Lapok",
  "titlebar.channel.local": "Helyi",
  "titlebar.channel.dev": "Dev",
  "titlebar.channel.beta": "Beta",
  "titlebar.toggleDebugTools": "Hibakereső eszközök váltása",
  "settings.tab.experimental": "Kísérleti",
  "settings.experimental.description": "Próbálja ki a kísérleti funkciókat",
  "settings.tab.about": "Névjegy",
  "settings.about.version": "{{version}} verzió",
  "settings.about.devVersion": "fejlesztői verzió",
  "settings.about.license": "MIT licenc alatt jelent meg",
  "settings.about.writtenBy": "Írta",
  "settings.about.illustratedBy": "Illusztrálta",
  "settings.about.and": "és",
  "settings.about.otherContributor.one": "{{count}} egyéb",
  "settings.about.otherContributor.other": "{{count}} egyebek",
  "settings.about.firstPublished": "Először az Egyesült Államokban, Missouriban jelent meg",
  "settings.about.firstIllustrated": "Először Londonban, Angliában illusztrálták",
  "settings.about.website": "www.opencode.ai",
  "settings.about.description": "OpenCode, a nyílt forráskódú kódoló ügynök",
  "settings.about.trademark": "A OpenCode a Anomaly Innovations, Inc. bejegyzett védjegye.",
  ...
  "settings.timeline.description":
    "Válassza ki, hogy mennyi tevékenység jelenjen meg az idővonalon. Az üzenetek láthatóak maradnak.",
  "settings.timeline.preset.everything": "Mindent",
  "settings.timeline.preset.detailed": "Részletes",
  "settings.timeline.preset.compact": "Kompakt",
  "settings.timeline.preset.quiet": "Csendes",
  "settings.timeline.preset.text-only": "Csak szöveg",
  ...
  "settings.timeline.description.custom":
    "Használja a kiválasztott elhelyezést és az egyes tevékenységi kategóriák adatait.",
  "settings.timeline.custom": "Egyedi",
  "settings.timeline.advanced": "Haladó",
  "settings.timeline.advanced.description":
    "Állítsa be az elhelyezést és a részleteket az egyes tevékenységkategóriákhoz.",
  "settings.timeline.category.shell": "Shell",
  "settings.timeline.category.edit": "Szerkesztések",
  ...
  "session.review.filesChangedCount.one": "{{count}} fájl megváltozott",
  "session.review.filesChangedCount.other": "{{count}} fájl megváltozott",
  "settings.about.writtenByNames": "Írta: {{names}}",
  "settings.about.illustratedByNames": "Illusztrálta: {{names}}",
  "ssh.label": "SSH",
  "ssh.offline":
    "Nincs csatlakoztatva a {{host}}-hez. Piszkozatát megőrizzük; lehet, hogy a távoli munka továbbra is fut.",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "SSH szerver hozzáadása",
  "ssh.server.menu.label": "SSH szerver",
  "ssh.target": "Host vagy SSH parancs",
  "ssh.connect": "Csatlakozás",
  "ssh.connectTo": "Csatlakozás a {{host}}",
  "ssh.authenticate": "SSH hitelesítés",
  "ssh.action.authenticate": "Hitelesítés",
  "ssh.session.disconnected": "SSH kapcsolat inaktív",
  "ssh.session.connecting": "Csatlakozás a SSH szerverhez",
  ...
  "ssh.session.reconnect": "Csatlakozás újra",
  "ssh.authenticationRequired": "Hitelesítés szükséges a {{host}}",
  "ssh.trust": "Bízzon és csatlakozzon",
  "ssh.continue": "Folytatás",
  "ssh.retry": "Próbálja újra",
  "ssh.update": "Frissítés és újracsatlakozás",
  "ssh.openProject": "Projekt megnyitása",
  "ssh.project": "Projekt megnyitása a {{host}}",
  "ssh.disconnect": "Leválasztás",
  "ssh.forget": "Felejtsd el a kapcsolatot",
  "ssh.stage.disconnected": "Szétkapcsolt. A távoli szerver futva marad.",
  "ssh.stage.connecting": "Csatlakozás SSH-n keresztül…",
  "ssh.stage.checking": "OpenCode ellenőrzése…",
  "ssh.stage.downloading": "Szerver letöltése…",
  "ssh.stage.uploading": "Szerver feltöltése…",
  "ssh.stage.starting": "Csatlakozás a OpenCode-hez…",
  "ssh.stage.ready": "Csatlakoztatva",
  "ssh.stage.authentication": "Hitelesítés szükséges",
  "ssh.stage.incompatible": "Szerverfrissítés szükséges",
  "ssh.stage.failed": "A csatlakozás sikertelen",
  "ssh.error.input":
  ...
  "ssh.error.connection": "Nem sikerült létrehozni a SSH kapcsolatot. Ellenőrizze a hálózatot és a SSH konfigurációt.",
  "ssh.error.platform":
    "Ez a távoli platform nem támogatott. Az automatikus beállításhoz jelenleg Linux vagy macOS szükséges x64-en vagy arm64-en.",
  "ssh.error.version": "A távoli szolgáltatásnak meg kell egyeznie ezzel az asztali verzióval a csatlakozás előtt.",
  "ssh.error.install":
  ...
  "ssh.error.service": "A SSH csatlakozott, de a OpenCode szerver nem vált készenlétben.",
  "ssh.error.host-key":
  ...
  "command.browser.open": "Nyissa meg a böngészőt",
  "command.browser.reload": "Böngészőoldal újratöltése",
  "command.session.summary.toggle": "Összegzés váltása",
  "mcp.auth.interactiveForm": "A MCP szerver A {{name}} interaktív hitelesítési űrlapot igényel",
  "server.connect.title": "Csatlakozás egy szerverhez",
  "server.connect.description": "A kezdéshez adja meg a szerver címét és jelszavát.",
  ...
  "server.connect.camera.error":
    "Nem sikerült kinyitni a kamerát. Engedélyezze a kamera elérését, vagy adja meg manuálisan a csatlakozási adatokat.",
  "dialog.server.menu.remove": "Eltávolítás",
  "file.error.notFound": "A fájl nem található: {{name}}",
  "home.workspaceTip":
    "Indítsa el a következő munkamenetet egy új munkaterületen, hogy a változtatások elszigeteltek maradjanak",
  "session.tab.browser": "Böngésző",
  "session.tab.add": "Tabulátor hozzáadása",
  "session.queue.attachments.one": "Plusz {{count}} rögzítés",
  "session.queue.attachments.other": "Plusz {{count}} tartozékok",
  "session.browser.address": "Böngésző címe",
  "session.browser.replaced": "A böngésző vezérlése átkerült egy másik asztali ablakba.",
  "session.browser.suspended":
    "A böngésző felfüggesztve. Lépjen kapcsolatba ezzel a munkamenettel az újracsatlakozáshoz.",
  "session.browser.address.placeholder": "Írja be az URL-t",
  "settings.backToSettings": "Vissza a beállításokhoz",
  "settings.backToProjects": "Vissza a projektekhez",
  "settings.search.placeholder": "Keresés",
  "settings.search.results": "Beállítások eredményei",
  "settings.search.group.pages": "Oldalak",
  "settings.search.group.settings": "Beállítások",
  "settings.search.group.projects": "Projektek",
  "settings.search.group.servers": "Szerverek",
  "settings.search.result": "{{title}}, {{scope}}, {{page}}",
  "settings.search.page": "{{title}}, {{scope}}",
  "settings.search.result.unscoped": "{{title}}, {{page}}",
  "settings.search.empty": "Nincs találat a következőre: {{query}}",
  "settings.search.empty.query": '"{{query}}"',
  "settings.search.refine": "Szűkítse a keresést, ha pontosabb találatokat szeretne látni.",
  "settings.server.description": "A szerver kapcsolatának és beállításainak kezelése",
  "settings.server.section.connection": "Csatlakozás",
  "settings.server.preferences.websearch.title": "Harmadik féltől származó keresés",
  "settings.server.preferences.websearch.description":
    "Válassza ki a keresési szolgáltató ügynökei által használt keresést az interneten",
  "settings.projects.search.placeholder": "Projektek keresése",
  "project.settings.name.title": "Projekt neve",
  "project.settings.name.description": "A projekt neve a OpenCode",
  "project.settings.icon.description": "Javasolt: 128×128 képpont. Kattintson vagy húzza a képet a kép feltöltéséhez.",
  "project.settings.color.description": "A projekt ikonként használatos, ha nincs egyéni kép beállítva",
  "project.settings.worktree.startup.description": "Egyszer lefut egy új munkafa létrehozása után",
  "project.settings.worktree.startup.hint.base": "Használja a $OPENCODE_WORKTREE_BASE-t az alapmunkafához.",
  "project.settings.worktree.startup.hint.new": "Használja a $OPENCODE_WORKTREE_PATH-t az új munkafához.",
  "project.settings.extensions.empty.mcps.title": "Még nincs MCPs",
  "project.settings.extensions.empty.mcps.description": "A OpenCode számára elérhető MCPs itt jelenik meg",
  "project.settings.extensions.empty.plugins.title": "Még nincsenek bővítmények",
  "project.settings.extensions.empty.plugins.description":
    "A OpenCode számára elérhető beépülő modulok itt jelennek meg",
  "project.settings.extensions.empty.skills.title": "Még nincsenek készségek",
  "project.settings.extensions.empty.skills.description": "A OpenCode számára elérhető készségek itt jelennek meg",
  "project.settings.extensions.lsp.configured": "Beállított nyelvi szerverek",
  "project.settings.extensions.lsp.status.enabled": "Engedélyezve a konfigurációban",
  "project.settings.extensions.lsp.status.disabled": "Letiltva a konfigurációban",
  "project.settings.extensions.lsp.empty.title": "Nincsenek konfigurálva nyelvi szerverek",
  "project.settings.extensions.lsp.empty.description": "A projekthez konfigurált nyelvi szerverek itt jelennek meg",
  "project.settings.extensions.lsp.disabled.title": "Nyelvi szerverek letiltva",
  "project.settings.extensions.lsp.disabled.description": "A LSP le van tiltva a projekt konfigurációjában",
  "project.settings.extensions.lsp.loadFailed": "Nem sikerült betölteni a nyelvi kiszolgáló konfigurációját",
  "project.settings.extensions.lsp.retry": "Próbálja újra",
  "settings.timeline.summary": "{{preset}}:",
  "settings.timeline.group": "Csoport",
  "settings.timeline.collapse": "Összecsukás",
  "settings.timeline.visibility.show": "Mutasd",
  "settings.timeline.visibility.hide": "Elrejtés",
  ...
  "settings.workspaces.sessions.filtered.one": "{{count}} munkamenet",
  "settings.workspaces.sessions.filtered.other": "{{count}} munkamenetek",
  "settings.workspaces.deleteAll.confirm.one": "Ezzel véglegesen törli a {{count}} kiválasztott munkafát.",
  "settings.workspaces.deleteAll.confirm.other": "Ezzel véglegesen törli a {{count}} kiválasztott munkafákat.",
  "settings.workspaces.deleteWithoutSessions": "Munkafák törlése munkamenetek nélkül",
  "settings.workspaces.deleteWithoutSessions.confirm.one":
    "Ezzel véglegesen törli a {{count}} munkafát összekapcsolt munkamenetek nélkül.",
  "settings.workspaces.deleteWithoutSessions.confirm.other":
    "Ezzel véglegesen törli a {{count}} munkafákat összekapcsolt munkamenetek nélkül.",
  "settings.workspaces.deleteWithoutSessions.warning":
    "A nem összevont változtatásokkal vagy aktív helyekkel rendelkező munkafák megmaradnak.",
  "settings.workspaces.delete.button": "Munkafák törlése",
  "workspace.lifecycle.deleting": "Törlés…",
  "session.summary.tooltip": "Összegzés",
  "session.summary.server": "Kiterjesztések",
  "session.summary.chooseProject": "Válasszon egy projektet",
  "session.summary.mcp.onCreation": "A munkafa létrehozásakor érvényes",
  "session.summary.mcp.prepareFailed": "Nem sikerült előkészíteni a MCP szervereket",
  "session.summary.mcp.unavailable": "A MCP szerver A {{name}} kiszolgáló nem érhető el ebben a munkafában.",
  "session.summary.mcp.signInBeforeSend": "A felszólítás elküldése előtt jelentkezzen be a {{name}} fiókba.",
  "session.summary.mcp.notReady":
    "A MCP {{name}} szerver nem áll készen. A felszólítás elküldése előtt oldja meg a kapcsolatot.",
  "session.summary.mcp": "MCP",
  "session.summary.mcp.title": "Konfigurált MCP szerverek",
  "session.summary.plugins": "Beépülő modulok",
  "session.summary.plugins.configured": "Beállított bővítmények",
  "session.summary.skills": "Készségek",
  "session.summary.skills.configured": "Konfigurált készségek",
  "session.summary.lsp": "LSP",
  "session.summary.failed": "Sikertelen",
  "session.summary.retry": "Próbálja újra",
  "session.summary.connecting": "Csatlakozás…",
  "session.summary.needsAuth": "Bejelentkezés szükséges",
  "session.summary.configure": "Konfigurációs fájl",
  "session.summary.copyConfigPath": "Másolja a konfigurációs fájl elérési útját",
  "session.summary.configFileMissing": "Nem található konfigurációs fájl",
  "session.summary.mcp.empty": "Nincs konfigurálva MCP szerver",
  "session.summary.mcp.add": "Szerverek hozzáadása az opencode.json fájlhoz",
  "session.summary.plugins.manage": "Beépülő modulok kezelése az opencode.json fájlban",
  "session.summary.plugins.empty": "Nincsenek beállítva bővítmények",
  "session.summary.plugins.add": "Adjon hozzá bővítményeket az opencode.json fájlhoz",
  "session.summary.skills.manage": "Kezelje a készségeket az opencode.json fájlban",
  "session.summary.skills.empty": "Nincsenek konfigurálva készségek",
  "session.summary.skills.add": "Adjon hozzá készségeket az opencode.json",
  "session.summary.lsp.configured": "Konfigurált LSPs",
  "session.summary.lsp.empty": "Nincs konfigurálva LSP szerver",
  "session.summary.lsp.manage": "A LSP kezelése az opencode.json fájlban",
  "workspace.delete.location": "Helyszín",
  "common.color.orange": "narancssárga",
  "common.color.yellow": "sárga",
  ...
  "common.color.gray": "szürke",
  "toast.migration.progress.migratingSessions.current": "Munkamenetek áttelepítése {{current}}",
  "toast.migration.progress.migratingSessions.progress": "Munkamenetek áttelepítése {{current}}/{{total}}",
  "toast.migration.progress.working": "Adatok migrálása",
  "toast.migration.progress.working.current": "Adatok migrálása {{current}}",
  "toast.migration.progress.working.progress": "Adatok migrálása {{current}}/{{total}}",
  "session.browser.unsupported": "Ez az asztali alkalmazás nem támogatja a böngésző ablaktáblát.",
  "command.debugBar.toggle": "Hibakeresési sáv be- vagy kikapcsolása",
  "command.session.location.cycle": "Munkamenet helyének váltása",
  "dialog.provider.anthropic.note": "Közvetlen hozzáférés a Claude-modellekhez API-kulccsal",
  "provider.connect.title.anthropicProMax": "Bejelentkezés az Anthropic használatával",
  "prompt.toast.uploading.percent": "{{percent}}%",
  "prompt.toast.uploading.cancel": "Feltöltés megszakítása",
  "prompt.toast.uploading.cancelFile": "A(z) {{filename}} feltöltésének megszakítása",
  "prompt.toast.uploadFailed.title": "A feltöltés sikertelen",
  "session.browser.empty.title": "Adja meg az URL-címet",
  "session.browser.empty.description": "Vagy kérje ezt: „Megnyitás az alkalmazás böngészőjében”",
  "session.browser.failed.title": "Az URL-cím nem érhető el",
  "session.browser.failed.description": "Ellenőrizze az URL-címet és a kapcsolatot, majd próbálja újra.",
  "debugBar.providerAriaLabel": "Szolgáltatói teljesítménydiagnosztika",
  "debugBar.ttft.label": "TTFT",
  "debugBar.ttft.tip": "A szolgáltatói kérés elküldésétől a modell első kimenetéig eltelt idő.",
  "debugBar.ttfa.label": "TTFA",
  "debugBar.ttfa.tip": "A szolgáltatói kérés elküldésétől az első válaszszövegig eltelt idő.",
  "debugBar.tps.label": "TPS",
  "debugBar.tps.tip": "Kimeneti tokenek másodpercenként a modell első kimenete után.",
  "debugBar.e2e.label": "E2E",
  "debugBar.e2e.tip": "A szolgáltatói kérés elküldésétől a válaszfolyam végéig eltelt idő.",
  "settings.updates.action.download": "OpenCode letöltése",
  "settings.updates.migration.title": "Váltás a Bétáról a Stabil verzióra",
