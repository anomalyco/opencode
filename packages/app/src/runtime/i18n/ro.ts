export const dict = {
  ...
  "session.queue.attachments": "+ atașamente",
  ...
  "settings.timeline.advanced.explainer":
    "Activitatea grupată intră în Folosit. Detaliile se aplică după deschiderea grupului.",
  "settings.timeline.activity": "Activitate",
  ...
  "settings.timeline.placement.title": "Plasarea",
  "settings.timeline.placement.separate": "Separați",
  "settings.timeline.placement.grouped": "Grupate",
  "settings.timeline.placement.hidden": "Ascuns",
  "settings.timeline.expansion.title": "Detalii",
  "settings.timeline.expansion.collapsed": "Restrâns",
  "settings.timeline.expansion.expanded": "Extins",
