export const dict = {
  ...
  "session.queue.attachments": "+ ዓባሪዎች",
  ...
  "settings.appearance.row.projectName.title": "የፕሮጀክት ስሞችን አሳይ",
  "settings.appearance.row.projectName.description": "የፕሮጀክት ስሞችን በቁመታዊ ትሮች እና በሞባይል ትር መሳቢያ ውስጥ አሳይ",
  ...
  "settings.timeline.advanced.explainer": "የተሰበሰበ እንቅስቃሴ ወደ «ጥቅም ላይ የዋለ» ይገባል። ዝርዝር ቡድኑን ከከፈቱ በኋላ ይተገበራል።",
  "settings.timeline.activity": "እንቅስቃሴ",
  ...
  "settings.timeline.placement.title": "አቀማመጥ",
  "settings.timeline.placement.separate": "ለየብቻ",
  "settings.timeline.placement.grouped": "የተሰበሰበ",
  "settings.timeline.placement.hidden": "የተደበቀ",
  "settings.timeline.expansion.title": "ዝርዝሮች",
  "settings.timeline.expansion.collapsed": "የተዘጋ",
  "settings.timeline.expansion.expanded": "የተዘረጋ",
