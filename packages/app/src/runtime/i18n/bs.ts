export const dict = {
  ...
  "session.queue.attachments": "+ prilozi",
  ...
  "settings.appearance.row.projectName.description":
    "Prikaži nazive projekata u vertikalnim karticama i ladici mobilnih kartica",
  ...
  "settings.timeline.advanced.explainer": "Grupirana aktivnost ide u Korišteno. Detalji vrijede nakon otvaranja grupe.",
  "settings.timeline.activity": "Aktivnost",
  ...
  "settings.timeline.placement.title": "Položaj",
  "settings.timeline.placement.separate": "Odvojeno",
  "settings.timeline.placement.grouped": "Grupirano",
  "settings.timeline.placement.hidden": "Skriveno",
  "settings.timeline.expansion.title": "Detalji",
  "settings.timeline.expansion.collapsed": "Sažeto",
  "settings.timeline.expansion.expanded": "Prošireno",
