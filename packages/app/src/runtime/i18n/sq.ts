export const dict = {
  ...
  "session.queue.attachments": "+ bashkëngjitje",
  ...
  "settings.timeline.advanced.explainer":
    "Aktiviteti i grupuar shkon në U përdorën. Detajet zbatohen pas hapjes së grupit.",
  "settings.timeline.activity": "Aktiviteti",
  ...
  "settings.timeline.placement.title": "Vendosja",
  "settings.timeline.placement.separate": "Të ndara",
  "settings.timeline.placement.grouped": "Të grupuara",
  "settings.timeline.placement.hidden": "I fshehur",
  "settings.timeline.expansion.title": "Detajet",
  "settings.timeline.expansion.collapsed": "Palosur",
  "settings.timeline.expansion.expanded": "Zgjeruar",
