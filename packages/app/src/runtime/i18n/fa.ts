export const dict = {
  ...
  "session.queue.attachments": "+ پیوست‌ها",
  ...
  "settings.timeline.advanced.explainer":
    "فعالیت گروه‌بندی‌شده در «ابزارهای استفاده‌شده» ظاهر می‌شود. جزئیات پس از باز کردن گروه اعمال می‌شود.",
  "settings.timeline.activity": "فعالیت",
  ...
  "settings.timeline.placement.title": "محل",
  "settings.timeline.placement.separate": "جدا",
  "settings.timeline.placement.grouped": "گروه‌بندی‌شده",
  "settings.timeline.placement.hidden": "پنهان",
  "settings.timeline.expansion.title": "جزئیات",
  "settings.timeline.expansion.collapsed": "بسته",
  "settings.timeline.expansion.expanded": "باز",
