export const dict = {
  ...
  "session.queue.attachments": "+ tệp đính kèm",
  ...
  "session.background.subagent.one": "đại lý phụ {{count}}",
  "session.background.subagent.other": "{{count}} đại lý phụ",
  ...
  "settings.appearance.row.projectName.title": "Hiển thị tên dự án",
  "settings.appearance.row.projectName.description": "Hiển thị tên dự án trong tab dọc và ngăn tab di động",
  ...
  "settings.timeline.advanced.explainer":
    "Hoạt động được nhóm sẽ chuyển sang Đã sử dụng. Chi tiết áp dụng sau khi mở nhóm.",
  "settings.timeline.activity": "Hoạt động",
  ...
  "settings.timeline.placement.title": "Vị trí",
  "settings.timeline.placement.separate": "Chia",
  "settings.timeline.placement.grouped": "Được nhóm",
  "settings.timeline.placement.hidden": "Ẩn giấu",
  "settings.timeline.expansion.title": "Chi tiết",
  "settings.timeline.expansion.collapsed": "Đã thu gọn",
  "settings.timeline.expansion.expanded": "Đã mở rộng",
