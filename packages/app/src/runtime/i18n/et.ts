export const dict = {
  ...
  "settings.general.row.browserPane.title": "Brauser",
  "settings.general.row.browserPane.description": "Lubage agentidel avada ja juhtida rakendusesisest arendusbrauserit.",
