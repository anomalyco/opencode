export const dict = {
  ...
  "session.queue.attachments": "+ manused",
  ...
  "settings.appearance.row.projectName.title": "Näita projektide nimesid",
  "settings.appearance.row.projectName.description":
    "Kuva projektide nimed vertikaalsetel vahekaartidel ja mobiili vahekaartide sahtlis",
  ...
  "settings.timeline.advanced.explainer":
    "Grupeeritud tegevus läheb jaotisesse Kasutatud. Üksikasjad kehtivad peale grupi avamist.",
  "settings.timeline.activity": "Tegevus",
  ...
  "settings.timeline.placement.title": "Paigutus",
  "settings.timeline.placement.separate": "Eraldi",
  "settings.timeline.placement.grouped": "Rühmitatud",
  "settings.timeline.placement.hidden": "Peidetud",
  "settings.timeline.expansion.title": "Üksikasjad",
  "settings.timeline.expansion.collapsed": "Ahendatud",
  "settings.timeline.expansion.expanded": "Laiendatud",
