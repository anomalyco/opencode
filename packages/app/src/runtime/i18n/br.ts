export const dict = {
  ...
  "settings.timeline.advanced.explainer":
    "As atividades agrupadas ficam em Usado. Os detalhes são aplicados depois que o grupo é aberto.",
  "settings.timeline.activity": "Atividade",
  ...
  "settings.timeline.placement.title": "Posicionamento",
  ...
  "settings.timeline.expansion.title": "Detalhes",
  "settings.timeline.expansion.collapsed": "Recolhido",
