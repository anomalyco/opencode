export const dict = {
  ...
  "session.queue.attachments": "+ goşundylar",
  ...
  "settings.timeline.advanced.explainer":
    "Toparlanan işjeňlik «Ulanyldy» bölümine geçýär. Jikme-jiklikler topar açylandan soň ulanylýar.",
  "settings.timeline.activity": "Işjeňlik",
  ...
  "settings.timeline.placement.title": "Ýerleşiş",
  "settings.timeline.placement.separate": "Aýratyn",
  "settings.timeline.placement.grouped": "Toparlanan",
  "settings.timeline.placement.hidden": "Gizlin",
  "settings.timeline.expansion.title": "Jikme-jiklikler",
  "settings.timeline.expansion.collapsed": "Ýygnalan",
  "settings.timeline.expansion.expanded": "Giňeldilen",
