...
export const dict = {
  ...
  "gitGraph.title": "Git 提交圖",
  "gitGraph.refresh": "重新整理 Git 提交圖",
  "gitGraph.retry": "重試",
  "gitGraph.loading": "正在載入 Git 歷史…",
  "gitGraph.loadingMore": "正在載入更多…",
  "gitGraph.loadMore": "載入更多",
  "gitGraph.merge": "合併提交",
  "gitGraph.continues": "已載入提交之外仍有歷史",
  "gitGraph.column.graph": "圖形",
  "gitGraph.column.description": "說明 / 參照",
  "gitGraph.column.date": "日期",
  "gitGraph.column.author": "作者",
  "gitGraph.column.commit": "提交",
  "gitGraph.graph.ariaLabel": "包含分支與合併連線的提交圖",
  "gitGraph.detail.ariaLabel": "所選提交詳情",
  "gitGraph.detail.commit": "提交",
  "gitGraph.detail.author": "作者",
  "gitGraph.detail.date": "日期",
  "gitGraph.detail.parents": "父提交",
  "gitGraph.detail.refs": "參照",
  "gitGraph.value.unknown": "未知",
  "gitGraph.value.none": "無",
  "gitGraph.empty.title": "尚無提交",
  "gitGraph.empty.description": "此儲存庫沒有任何可見的提交。",
  "gitGraph.unsupported.title": "Git 提交圖無法使用",
  "gitGraph.unsupported.description": "此位置未使用支援提交圖的版本控制提供者。",
  "gitGraph.error.initial.title": "無法載入 Git 歷史",
  "gitGraph.error.initial.description": "請檢查儲存庫後重試。",
  "gitGraph.error.loadMore": "無法載入更多提交。",
  "gitGraph.error.refresh": "無法重新整理 Git 歷史。仍顯示既有的提交圖。",
