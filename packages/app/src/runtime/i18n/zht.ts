...
export const dict = {
  ...
  "settings.appearance.row.projectName.description": "在垂直索引標籤和行動索引標籤抽屜中顯示專案名稱",
  ...
  "settings.timeline.advanced.explainer": "分組活動進入「已使用」。 開啟羣組後會顯示詳細資訊。",
  "settings.timeline.activity": "活動",
  ...
  "settings.timeline.placement.separate": "分開",
  "settings.timeline.placement.grouped": "已分組",
  "settings.timeline.placement.hidden": "隱藏",
  "settings.timeline.expansion.title": "詳情",
  "settings.timeline.expansion.collapsed": "已收起",
  "settings.timeline.expansion.expanded": "已展開",
  "settings.general.row.mobileDiffWrap.description": "在行動裝置差異中換行，而不是水平捲動",

  "provider.connect.error.unsupportedFields": "此身份驗證表單包含不支援的字段",
  "session.review.filesChangedCount.one": "{{count}} 個檔案已更改",
  "session.review.filesChangedCount.other": "{{count}} 個檔案已更改",
