...
export const dict = {
  ...
  "ssh.label": "SSH",
  "ssh.offline": "未連線至 {{host}}。你的草稿已保留；遠端工作可能仍在執行。",
  "ssh.placeholder": "ssh user@example.com",
  "ssh.add": "新增 SSH 伺服器",
  "ssh.server.menu.label": "SSH 伺服器",
  "ssh.target": "主機或 SSH 指令",
  "ssh.connect": "連線",
  "ssh.connectTo": "連線至 {{host}}",
  "ssh.authenticate": "SSH 身分驗證",
  "ssh.action.authenticate": "驗證身分",
  "ssh.session.disconnected": "SSH 連線未啟動",
  "ssh.session.connecting": "正在連線 SSH 伺服器",
  "ssh.session.reconnectDescription": "重新連線以檢視此工作階段並繼續工作。你的遠端工作階段已保留。",
  "ssh.session.reconnect": "重新連線",
  "ssh.authenticationRequired": "{{host}} 需要身分驗證",
  "ssh.trust": "信任並連線",
  "ssh.continue": "繼續",
  "ssh.retry": "重試",
  "ssh.update": "更新並重新連線",
  ...
  "ssh.disconnect": "中斷連線",
  "ssh.forget": "忘記連線",
  "ssh.stage.disconnected": "已中斷連線。遠端伺服器保持執行。",
  "ssh.stage.connecting": "正在透過 SSH 連線…",
  "ssh.stage.checking": "正在檢查 OpenCode…",
  "ssh.stage.downloading": "正在下載伺服器…",
  "ssh.stage.uploading": "正在上傳伺服器…",
  "ssh.stage.starting": "正在連線 OpenCode…",
  "ssh.stage.ready": "已連線",
  "ssh.stage.authentication": "需要身分驗證",
  "ssh.stage.incompatible": "需要更新伺服器",
  "ssh.stage.failed": "連線失敗",
  "ssh.error.input": "輸入主機名稱或 SSH 連線指令。不允許遠端指令與不受支援的 SSH 選項。",
  "ssh.error.connection": "無法建立 SSH 連線。請檢查網路與 SSH 設定。",
  "ssh.error.platform": "不支援此遠端平台。自動部署目前需要 x64 或 arm64 的 Linux 或 macOS。",
  "ssh.error.version": "遠端服務必須與此 Desktop 版本一致才能連線。",
  "ssh.error.install": "無法安裝遠端伺服器。請檢查網路連通性、磁碟空間，並確認已安裝 tar。",
  "ssh.error.unpublished": "此 Desktop 版本沒有已發佈的遠端伺服器。對於開發版本，請先在主機上安裝並啟動 V2，再重試。",
  "ssh.error.service": "SSH 已連線，但 OpenCode 伺服器尚未就緒。",
  "ssh.error.host-key": "無法驗證該主機的身分。更新 SSH known hosts 前請先核對其指紋。",
  "ssh.error.ssh-missing": "找不到 OpenSSH。請安裝 OpenSSH 用戶端，並確保 ssh 已在 PATH 中。",
  "session.location.unavailable": "工作階段位置無法使用",
  "session.location.description": "選擇其他目錄以繼續此工作階段。",
  "session.location.choose": "選擇目錄",
  "session.location.worktree": "選擇工作樹",
  "session.location.worktreesFailed": "載入工作樹失敗",
  "session.location.moving": "正在移動工作階段…",
  "command.debugBar.toggle": "切換除錯列",
  "command.project.copyID": "複製專案 ID",
  "command.session.location.cycle": "切換工作階段位置",
  ...
  "mcp.auth.interactiveForm": "MCP 伺服器 {{name}} 需要互動式驗證表單",
  "server.connect.title": "連線至伺服器",
  "server.connect.description": "輸入伺服器位址與密碼以開始。",
  "server.connect.button": "連線",
  "server.connect.address.invalid": "請輸入有效的 HTTP 或 HTTPS 伺服器位址。",
  "server.connect.failed": "無法連線。請檢查伺服器位址與密碼，然後重試。",
  "server.connect.pair.description": "在你的電腦上執行此指令以取得連線資訊。",
  "server.connect.scan": "掃描 QR Code",
  "server.connect.scan.description": "將相機對準 opencode pair 顯示的 QR Code。",
  "server.connect.scan.invalid": "這不是 OpenCode 配對碼。請掃描 opencode pair 顯示的配對碼。",
  "server.connect.camera": "配對相機",
  "server.connect.camera.starting": "正在開啟相機…",
  "server.connect.mixedContent": "無法從 HTTPS 頁面連線此 HTTP 伺服器。請改用 HTTPS 伺服器位址。",
  "server.connect.camera.insecure": "掃描需要透過 HTTPS 或 localhost 開啟此頁面。",
  "server.connect.camera.unavailable": "此瀏覽器無法使用相機。請手動輸入連線資訊。",
  "server.connect.camera.error": "無法開啟相機。請允許相機存取權限或手動輸入連線資訊。",
  "dialog.server.menu.remove": "移除",
  "dialog.server.menu.hide": "從專案清單中隱藏",
  "dialog.server.menu.show": "在專案清單中顯示",
  "server.row.incompatible": "此伺服器執行的是 OpenCode {{version}}，與目前應用程式不相容。請將其升級至 OpenCode V2 以繼續。",
  "file.error.notFound": "找不到檔案：{{name}}",
  "toast.session.copyID.failed.title": "複製工作階段 ID 失敗",
  "toast.session.copyID.failed.description": "複製工作階段 ID 時發生錯誤",
  "toast.project.copyID.failed.title": "複製專案 ID 失敗",
  "toast.project.copyID.failed.description": "複製專案 ID 時發生錯誤",
  "toast.migration.failed.title": "資料移轉失敗",
  "error.page.title.status": "伺服器請求失敗",
  "error.page.description.status": "伺服器傳回了 HTTP {{status}} 回應。",
  "error.page.action.reload": "重新載入",
  "home.projects.all": "全部專案",
  "home.workspaceTip": "在新的工作區開始下一個工作階段，以隔離變更",
  "session.tab.files": "檔案",
  "session.files.openTabs": "開啟的檔案",
  "session.tab.usage": "用量",
  "session.view.select": "工作階段檢視",
  "session.tab.browser": "瀏覽器",
  "session.tab.add": "新增標籤頁",
  "session.error.incompatible": "此伺服器版本不受支援",
  "session.error.incompatible.description": "{{server}} 執行的是 OpenCode {{version}}，與目前應用程式不相容。請將伺服器升級至 OpenCode V2 以繼續。",
  "session.background.moveTasks": "將 {{tasks}} 移至背景",
  "session.background.moveRunning": "移至背景",
  "session.background.inBackground": "背景執行 {{tasks}}",
  "session.background.moveInline": "按 {{keybind}} 將執行中的工作移至背景",
  "session.background.running": "背景有工作在執行",
  "session.background.runningCount.one": "背景有 {{count}} 個項目在執行",
  "session.background.runningCount.other": "背景有 {{count}} 個項目在執行",
  "session.background.tasksRunning.one": "背景有 {{count}} 個工作在執行",
  "session.background.tasksRunning.other": "背景有 {{count}} 個工作在執行",
  ...
  "session.background.subagent.one": "{{count}} 個子智慧體",
  "session.background.subagent.other": "{{count}} 個子智慧體",
  "command.session.background": "移至背景",
  "session.queue.count.one": "{{count}} 則排隊中",
  "session.queue.count.other": "{{count}} 則排隊中",
  "session.queue.steer": "引導",
  "session.queue.send": "傳送",
  "session.queue.steerTooltip": "不中斷直接傳送",
  "session.queue.remove": "移除",
  "session.queue.reorder": "調整排隊訊息順序",
  "session.queue.attachments.one": "{{count}} 個附件",
  "session.queue.attachments.other": "{{count}} 個附件",
  "session.timeline.working": "執行中",
  ...
  "session.review.wrapLines": "自動換行",
  "session.websearch.title": "第三方網頁搜尋",
  "session.websearch.description": "選擇智慧體連網搜尋使用的搜尋服務商",
  "session.websearch.provider": "搜尋服務商",
  "session.websearch.any": "任意",
  "session.websearch.disable": "不使用搜尋",
  "session.websearch.enable": "啟用",
  "session.websearch.loadFailed": "無法載入搜尋服務商。",
  "session.websearch.empty": "沒有可用的搜尋服務商。",
  "session.websearch.failed": "無法儲存你的選擇。請重試。",
  "session.websearch.retry": "重試",
  "session.new.worktree.creating": "正在建立工作樹",
  "session.new.worktree.draftPlaceholder": "工作樹準備期間起草後續訊息…",
  "session.search.placeholder": "尋找…",
  "session.search.noResults": "無相符結果",
  "session.browser.address": "瀏覽器網址",
  "session.browser.replaced": "瀏覽器控制已轉移至另一個桌面視窗。",
  "session.browser.suspended": "瀏覽器已暫停。與此工作階段互動以重新連線。",
  "session.browser.address.placeholder": "輸入網址",
  "titlebar.tabs": "標籤頁",
  "titlebar.channel.local": "本機",
  "titlebar.channel.dev": "開發版",
  "titlebar.channel.beta": "Beta 版",
  "titlebar.toggleDebugTools": "切換偵錯工具",
  "debugBar.providerAriaLabel": "服務商效能診斷",
  "debugBar.ttft.label": "首 Token 時間",
  "debugBar.ttft.tip": "從請求發出到首個模型輸出的時間。",
  "debugBar.ttfa.label": "首字時間",
  "debugBar.ttfa.tip": "從請求發出到首個答案文字的時間。",
  "debugBar.tps.label": "每秒 Token 數",
  "debugBar.tps.tip": "首個模型輸出之後每秒輸出的 Token 數。",
  "debugBar.e2e.label": "端對端",
  "debugBar.e2e.tip": "從請求發出到回應串流結束的時間。",
  "settings.backToApp": "返回應用程式",
  "settings.backToSettings": "返回設定",
  "settings.backToProjects": "返回專案",
  "settings.search.placeholder": "搜尋",
  "settings.search.results": "設定搜尋結果",
  ...
  "settings.search.empty": "沒有與 {{query}} 相關的結果",
  ...
  "settings.experimental.description": "試用實驗性功能",
  "settings.tab.about": "關於",
  "settings.about.version": "版本 {{version}}",
  "settings.about.devVersion": "開發版",
  "settings.about.license": "基於 MIT 授權條款發佈",
  "settings.about.writtenBy": "作者",
  "settings.about.illustratedBy": "插畫",
  "settings.about.and": "和",
  "settings.about.otherContributor.one": "還有 {{count}} 位",
  "settings.about.otherContributor.other": "還有 {{count}} 位",
  "settings.about.firstPublished": "首次出版於美國密蘇里州",
  "settings.about.firstIllustrated": "首次插畫於英國倫敦",
  "settings.about.description": "OpenCode，開源編碼智慧體",
  "settings.about.trademark": "OpenCode 是 Anomaly Innovations, Inc. 的註冊商標",
  "settings.about.typeset": "字型：Inter 與 IBM Plex Mono",
  "settings.about.tagline": "沒有你，AI 造不出偉大的軟體",
  "settings.preferences.description": "自訂偏好設定、佈景主題與預設行為",
  "settings.appearance.description": "自訂佈景主題與字型",
  "settings.appearance.section.experimental": "實驗性功能",
  "settings.appearance.row.tabs.title": "標籤頁",
  "settings.appearance.row.tabs.description": "選擇工作階段標籤頁的排列方式",
  "settings.appearance.row.tabs.horizontal": "水平",
  "settings.appearance.row.tabs.vertical": "垂直",
  "settings.appearance.row.projectName.title": "顯示專案名稱",
  "settings.appearance.row.projectName.description": "在垂直標籤頁與行動版標籤抽屜中顯示專案名稱",
  "settings.notifications.description": "選擇何時接收通知與播放提示音",
  "settings.shortcuts.description": "自訂常用操作的快速鍵",
  ...
  "settings.server.preferences.websearch.description": "選擇智慧體連網搜尋使用的搜尋服務商",
  ...
  "settings.projects.server.all": "全部伺服器",
  "settings.mcps.description": "管理模型上下文協定（MCP）伺服器與工具",
  ...
  "dialog.server.authenticate.title": "身分驗證",
  "project.settings.title": "編輯專案",
  "project.settings.general.description": "管理專案名稱與外觀",
  "project.settings.name.title": "專案名稱",
  "project.settings.name.description": "在 OpenCode 中為此專案顯示的名稱",
  "project.settings.icon.description": "建議尺寸：128×128px。按一下或拖曳以上傳圖片。",
  "project.settings.color.description": "未設定自訂圖片時用於專案圖示",
  "project.settings.worktree.startup.description": "在新增工作樹後執行一次",
  "project.settings.worktree.startup.hint.base": "基礎工作樹請使用 $OPENCODE_WORKTREE_BASE。",
  "project.settings.worktree.startup.hint.new": "新工作樹請使用 $OPENCODE_WORKTREE_PATH。",
  "project.settings.scripts": "指令碼",
  "project.settings.scripts.description": "為此專案設定指令碼",
  "project.settings.extensions.description": "檢視此專案可用的擴充功能",
  "project.settings.extensions.tab.lsps": "語言伺服器",
  ...
  "project.settings.extensions.empty.mcps.description": "可用於 OpenCode 的 MCP 將顯示在這裡",
  "project.settings.extensions.empty.plugins.title": "尚無外掛",
  "project.settings.extensions.empty.plugins.description": "可用於 OpenCode 的外掛將顯示在這裡",
  "project.settings.extensions.empty.skills.title": "尚無技能",
  "project.settings.extensions.empty.skills.description": "可用於 OpenCode 的技能將顯示在這裡",
  ...
  "project.settings.extensions.lsp.empty.title": "未設定語言伺服器",
  "project.settings.extensions.lsp.empty.description": "為此專案設定的語言伺服器將顯示在這裡",
  ...
  "settings.timeline.detail": "時間軸詳細內容",
  "settings.timeline.description": "選擇在工作階段時間軸中顯示多少詳細內容。",
  "settings.timeline.summary": "{{preset}}：",
  "settings.timeline.preset.everything": "全部",
  "settings.timeline.preset.detailed": "詳細",
  "settings.timeline.preset.compact": "精簡",
  "settings.timeline.preset.quiet": "安靜",
  "settings.timeline.preset.text-only": "僅訊息",
  "settings.timeline.description.everything": "分別顯示所有動態。展開 Shell 輸出、編輯與思考過程。",
  "settings.timeline.description.detailed": "展開 Shell 輸出與編輯。單獨顯示子智慧體，並將其他動態分組。",
  "settings.timeline.description.compact": "將所有動態分組，詳細內容預設收合。",
  "settings.timeline.description.quiet": "將編輯與子智慧體分組。隱藏其他動態。",
  "settings.timeline.description.text-only": "隱藏所有動態。",
  "settings.timeline.description.custom": "使用進階設定。",
  "settings.timeline.custom": "自訂",
  "settings.timeline.advanced": "進階",
  "settings.timeline.advanced.description": "為每個動態類別設定位置與詳細內容。",
  "settings.timeline.group": "分組",
  "settings.timeline.collapse": "收合",
  ...
  "settings.timeline.collapsed.label": "{{activity}}已收合",
  "settings.timeline.category.edit": "編輯",
  "settings.timeline.category.thinking": "思考過程",
  "settings.timeline.category.subagents": "子智慧體",
  ...
  "settings.general.row.browserPane.title": "瀏覽器",
  "settings.general.row.browserPane.description": "允許智慧體開啟並控制應用程式內建的開發瀏覽器。",
  "settings.general.row.showProjectIcon.title": "顯示專案圖示",
  "settings.general.row.showProjectIcon.description": "在工作階段標頭顯示專案圖示",
  "settings.general.row.mobileDiffWrap.description": "在行動版差異檢視中自動換行，而不是水平捲動",
  "settings.general.row.followUpBehavior.title": "後續訊息行為",
  "settings.general.row.followUpBehavior.description": "選擇後續訊息要排隊等候還是引導目前的工作階段。使用 {{keybind}} 切換。",
  "settings.general.row.followUpBehavior.queue": "排隊",
  "settings.general.row.followUpBehavior.steer": "引導",
  "settings.general.row.reasoningMode.title": "模型推論",
  "settings.general.row.reasoningMode.description": "選擇在時間軸中如何顯示模型推論過程",
  ...
  "settings.updates.migration.title": "從 Beta 版移轉至 Stable 版",
  "settings.updates.migration.description": "OpenCode Beta 版正在移轉至 OpenCode Stable 版。請下載 {{version}} 版本，再從磁碟映像檔安裝 OpenCode 以繼續接收更新。",
  "common.viewAll": "查看全部",
  "session.new.workspace.local.tooltip": "使用專案目前的取出",
  "session.new.workspace.new.tooltip": "從目前取出建立隔離副本",
  "session.new.workspace.fromBranch": "來自 {{branch}}",
  "session.new.workspace.createFrom": "從分支建立",
  "session.new.workspace.branch.search.placeholder": "搜尋分支",
  "session.new.workspace.trigger.tooltip": "選擇工作階段執行位置",
  "session.new.workspace.search.placeholder": "搜尋工作樹",
  "session.new.workspace.search.empty": "沒有相符的工作樹",
  "settings.tab.workspaces": "工作樹",
  "settings.workspaces.description": "檢視工作樹並管理磁碟使用量",
  "settings.workspaces.filter.all": "全部專案",
  "settings.workspaces.empty": "尚無工作樹",
  "settings.workspaces.empty.description": "在 OpenCode 中建立的工作樹將顯示在這裡",
  "settings.workspaces.count.one": "{{count}} 個工作樹",
  "settings.workspaces.count.other": "{{count}} 個工作樹",
  ...
  "settings.workspaces.lastActiveSession": "上次活躍的工作階段",
  "settings.workspaces.deleteAll": "刪除所有工作樹",
  "settings.workspaces.deleteAll.confirm.one": "這將永久刪除選取的 {{count}} 個工作樹。",
  "settings.workspaces.deleteAll.confirm.other": "這將永久刪除選取的 {{count}} 個工作樹。",
  "settings.workspaces.deleteWithoutSessions": "刪除沒有關聯工作階段的工作樹",
  "settings.workspaces.deleteWithoutSessions.confirm.one": "這將永久刪除 {{count}} 個沒有關聯工作階段的工作樹。",
  "settings.workspaces.deleteWithoutSessions.confirm.other": "這將永久刪除 {{count}} 個沒有關聯工作階段的工作樹。",
  "settings.workspaces.deleteWithoutSessions.warning": "有未合併變更或正在使用中的工作樹將被保留。",
  "settings.workspaces.delete.button": "刪除工作樹",
  "settings.workspaces.delete.warning": "這將永久刪除該工作樹及其分支。",
  "settings.workspaces.deleteAll.warning": "有未合併變更、關聯工作階段或正在使用中的工作樹將被保留。",
  "settings.workspaces.delete.blocked.active": "目前使用中的工作樹無法刪除。",
  "settings.workspaces.delete.blocked.linked": "關聯的工作階段將保留，但其工作目錄將不存在。",
  "settings.workspaces.default.title": "預設環境",
  "settings.workspaces.default.description": "選擇新工作階段的啟動位置",
  "settings.workspaces.default.lastUsed": "每個專案使用上次的位置",
  "settings.workspaces.default.local": "本機目錄",
  "settings.workspaces.default.new": "新增工作樹",
  "workspace.move.title": "移至工作樹",
  "workspace.move.menu.title": "將工作階段移動至",
  "workspace.move.failed": "移動工作階段失敗",
  "workspace.lifecycle.creating": "正在建立工作樹",
  "workspace.lifecycle.created": "工作樹已建立",
  "workspace.lifecycle.deleting": "正在刪除…",
  "workspace.lifecycle.starting": "正在啟動工作階段",
  "workspace.onboarding.title": "使用工作樹隔離工作階段",
  "workspace.onboarding.description": "每個工作階段擁有獨立的工作副本",
  "workspace.lifecycle.moving": "正在移動至工作樹",
  "workspace.lifecycle.set": "工作樹已設定",
  "session.summary.title": "工作階段詳細資訊",
  "session.summary.tooltip": "摘要",
  "session.summary.noBranch": "無分支",
  "session.summary.basedOn": "基於 {{branch}}",
  "session.summary.server": "擴充功能",
  "session.summary.chooseProject": "選擇專案",
  "session.summary.mcp.onCreation": "在工作樹建立時生效",
  "session.summary.mcp.prepareFailed": "無法準備 MCP 伺服器",
  "session.summary.mcp.unavailable": "MCP 伺服器 {{name}} 在此工作樹中無法使用。",
  "session.summary.mcp.signInBeforeSend": "傳送前請先登入 {{name}}。",
  "session.summary.mcp.notReady": "MCP 伺服器 {{name}} 尚未就緒。請在傳送前解決其連線問題。",
  "session.summary.mcp.title": "已設定的 MCP 伺服器",
  "session.summary.plugins": "外掛",
  "session.summary.plugins.configured": "已設定的外掛",
  "session.summary.skills": "技能",
  "session.summary.skills.configured": "已設定的技能",
  "session.summary.failed": "失敗",
  "session.summary.retry": "重試",
  "session.summary.connecting": "正在連線…",
  ...
  "session.summary.mcp.empty": "未設定 MCP 伺服器",
  "session.summary.mcp.add": "在 opencode.json 中新增伺服器",
  "session.summary.plugins.manage": "在 opencode.json 中管理外掛",
  "session.summary.plugins.empty": "未設定外掛",
  "session.summary.plugins.add": "在 opencode.json 中新增外掛",
  ...
  "session.summary.lsp.configured": "已設定的語言伺服器",
  "session.summary.lsp.empty": "未設定語言伺服器",
  "session.summary.lsp.manage": "在 opencode.json 中管理語言伺服器",
