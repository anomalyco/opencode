...
export type WslJob =
  ...
  | { kind: "install-argus"; distro: string; startedAt: number }
...
export type WslServersState = {
  ...
  argusChecks: Record<string, WslArgusCheck>
...
export type WslServersPlatform = {
  ...
  installArgus(name: string): Promise<void>
