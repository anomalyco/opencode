...
import { showToast } from "@argus-ai/ui/toast"
...
import { LoaderV2 } from "@argus-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@argus-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-argus") {
      await run(() => api.installArgus(distro))
      return
    }
