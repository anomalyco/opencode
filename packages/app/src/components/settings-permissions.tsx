    ...
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar">
      ...
      <div class="flex flex-col gap-6 px-4 py-6 sm:p-8 sm:pt-6 max-w-[720px]">
        <div class="flex flex-col gap-2">
          <h3 class="text-14-medium text-text-strong">{language.t("settings.permissions.section.autoaccept")}</h3>
          <div class="border border-border-weak-base rounded-lg overflow-hidden">
            <SettingsRow
              title={language.t("settings.permissions.autoaccept.global.title")}
              description={language.t("settings.permissions.autoaccept.global.description")}
            >
              <div data-action="settings-autoaccept-global">
                <Switch
                  checked={permission.isAutoAcceptingGlobal()}
                  onChange={() => permission.toggleAutoAcceptGlobal()}
                />
              </div>
            </SettingsRow>
          </div>
