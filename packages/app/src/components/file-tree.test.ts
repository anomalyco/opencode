...
beforeAll(async () => {
  ...
  mock.module("@simpliciocode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@simpliciocode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@simpliciocode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@simpliciocode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
