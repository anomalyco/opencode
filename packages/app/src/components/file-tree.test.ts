...
beforeAll(async () => {
  ...
  mock.module("@athena/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@athena/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@athena/ui/icon", () => ({ Icon: () => null }))
  mock.module("@athena/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
