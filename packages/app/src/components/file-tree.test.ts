...
beforeAll(async () => {
  ...
  mock.module("@yunpat/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@yunpat/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@yunpat/ui/icon", () => ({ Icon: () => null }))
  mock.module("@yunpat/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
