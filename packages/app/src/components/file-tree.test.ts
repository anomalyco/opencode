...
beforeAll(async () => {
  ...
  mock.module("@cedric/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@cedric/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@cedric/ui/icon", () => ({ Icon: () => null }))
  mock.module("@cedric/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
