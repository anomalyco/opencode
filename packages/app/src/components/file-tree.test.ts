...
beforeAll(async () => {
  ...
  mock.module("@octopus-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@octopus-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@octopus-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@octopus-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
