...
beforeAll(async () => {
  ...
  mock.module("@leak-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@leak-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@leak-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@leak-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
