...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  // Worktree send only applies to brand-new sessions (no session id yet) in a git project.
  // This is independent of the layout variant so it works in both the new and legacy composers.
  const showWorktreeSend = createMemo(() => !props.controls.session.id && sync().project?.vcs === "git")
          ...
          <div class="flex flex-col gap-3">
            ...
            >
              ...
              <div class="flex h-11 items-center px-2">
                ...
                <Show when={showWorktreeSend()}>
                  <TooltipV2 placement="top" value={language.t("prompt.action.sendInWorktree")}>
                    <IconButton
                      data-action="prompt-submit-worktree"
                      type="button"
                      ...
                      onClick={(event) => {
                        event.preventDefault()
                        void handleSubmit(event, { worktree: "create" })
                      }}
                      aria-label={language.t("prompt.action.sendInWorktree")}
                    />
                  </TooltipV2>
                </Show>
            ...
            >
              ...
              <div class="pointer-events-none absolute bottom-2 right-2 flex items-center gap-2">
                ...
                <div class="flex items-center gap-1 pointer-events-auto">
                  <Show when={showWorktreeSend()}>
                    <Tooltip placement="top" value={language.t("prompt.action.sendInWorktree")}>
                      <IconButton
                        data-action="prompt-submit-worktree"
                        type="button"
                        disabled={!working() && blank()}
