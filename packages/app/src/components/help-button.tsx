      ...
      <Drawer open={drawerOpen()} onOpenChange={setDrawerOpen} side="right">
            ...
            >
              <Show when={open()}>
                ...
                >
                  ...
                  <button
                    type="button"
                    class="relative block h-[232px] w-[184px] cursor-default overflow-hidden rounded-[4px] text-left"
        ...
        <DrawerContent>
          <div class="flex h-[52px] w-full shrink-0 items-center gap-4 self-stretch border-b border-v2-border-border-muted p-4">
            <p class="min-h-0 min-w-0 flex-1 text-[13px] font-[530] leading-5 tracking-[-0.04px] tabular-nums text-[#5C5C5C]">
              June 16
            </p>
            <DrawerClose
              as={IconButtonV2}
          ...
          <div class="relative flex w-full flex-col items-start gap-6 p-8">
            <p class="w-full shrink-0 self-stretch text-[21px] font-[610] leading-6 tracking-[-0.37px] tabular-nums text-[#161616]">
              Introducing Tabs Navigation.
            </p>
            <p class="w-full flex-1 text-[13px] font-[440] leading-5 tracking-[-0.04px] text-[#161616]">
              We've introduced tabs as the primary navigation in OpenCode. Your most important session are now pinned at
              the top of your screen at all times. No more hunting through menus or losing your place mid-session.
              Switch contexts instantly, pick up exactly where you left off, and keep your focus where it belongs: on
              the sessions.
            </p>
          </div>
        </DrawerContent>
