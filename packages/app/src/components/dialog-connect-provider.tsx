import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@athena/sdk/v2/client"
import { Button } from "@athena/ui/button"
import { useDialog } from "@athena/ui/context/dialog"
import { Dialog } from "@athena/ui/dialog"
import { Icon } from "@athena/ui/icon"
import { IconButton } from "@athena/ui/icon-button"
import { List, type ListRef } from "@athena/ui/list"
import { ProviderIcon } from "@athena/ui/provider-icon"
import { Spinner } from "@athena/ui/spinner"
import { TextField } from "@athena/ui/text-field"
import { showToast } from "@athena/ui/toast"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "athena"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.athenaZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.athenaZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.athenaZen.visit.prefix")}
                <Link href="https://athena.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.athenaZen.visit.link")}
                </Link>
                {language.t("provider.connect.athenaZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
