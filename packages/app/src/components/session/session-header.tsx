                  ...
                  >
                    <div class="flex items-center">
                      <div class="flex items-center rounded-md border border-border-base bg-surface-panel overflow-hidden">
                        <Button
                          variant="ghost"
                          class="rounded-none h-[28px] py-1.5 pr-4 pl-3 gap-2 border-none shadow-none"
                        ...
                        <DropdownMenu>
                          <DropdownMenu.Trigger
                            ...
                            icon="chevron-down"
                            variant="ghost"
                            class="rounded-none h-[28px] w-auto px-2 border-none shadow-none data-[expanded]:bg-surface-raised-base-active"
