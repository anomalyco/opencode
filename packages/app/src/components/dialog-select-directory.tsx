...
function RecentProjectItem(props: { project: Project; onSelect: (worktree: string) => void; homedir?: string }) {
      ...
      <div class="flex flex-col">
        <Show when={recentProjects().length > 0}>
          <div class="px-3 pb-2 mb-2">
            <div class="text-12-regular text-text-weak mb-2 ml-2">{language.t("home.recentProjects")}</div>
            <div class="space-y-1">
