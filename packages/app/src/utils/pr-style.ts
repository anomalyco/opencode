...
export function getPrPillStyle(pr: PrInfo): string {
  if (pr.state === "MERGED") return "border-[#8957e5]/60 bg-[#8957e5]/20 text-[#a371f7]"
  if (pr.state === "CLOSED") return "border-[#da3633]/60 bg-[#da3633]/20 text-[#f85149]"
  if (pr.isDraft) return "border-[#768390]/60 bg-[#768390]/20 text-[#768390]"
  if (pr.state === "OPEN" && pr.checksState === "FAILURE") return "border-[#da3633]/60 bg-[#da3633]/20 text-[#f85149]"
  return "border-[#238636]/60 bg-[#238636]/20 text-[#3fb950]"
}
