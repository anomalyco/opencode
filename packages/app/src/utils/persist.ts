...
const GLOBAL_STORAGE = "argus.global.dat"
const WINDOW_STORAGE = "argus.window"
const LOCAL_PREFIX = "argus."
...
function workspaceStorage(dir: string) {
  ...
  return `argus.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `argus.draft.${head}.${sum}.dat`
}
