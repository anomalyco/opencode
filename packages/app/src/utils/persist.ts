...
const GLOBAL_STORAGE = "pencode.global.dat"
const WINDOW_STORAGE = "pencode.window"
const LOCAL_PREFIX = "pencode."
...
function workspaceStorage(dir: string) {
  ...
  return `pencode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `pencode.draft.${head}.${sum}.dat`
}
