export const dict = {
  ...
  "provider.custom.models.load": "Dinamik yuklash",
  "provider.custom.models.loading": "Yuklanmoqda...",
  "provider.custom.models.load.invalidUrl": "To'g'ri baza URL kiriting",
  "provider.custom.models.load.unauthorized": "Ruxsat yo'q. API kalitini tekshiring",
  "provider.custom.models.load.invalidFormat": "Server javobi to'g'ri modellar ro'yxati emas",
  "provider.custom.models.load.timeout": "Modellarni yuklash vaqti tugadi",
  "provider.custom.models.load.failed": "Modellarni yuklash amalga oshmadi",
  "provider.custom.models.load.empty": "Modellar topilmadi",
