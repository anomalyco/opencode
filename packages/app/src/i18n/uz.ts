export const dict = {
  ...
  "command.session.handoff": "Seansni topshirish",
  "command.session.handoff.description": "Seansni ixchamlashtirib, ishni yangi seansda davom ettirish",
  ...
  "toast.session.handoff.failed.title": "Seansni topshirib boʻlmadi",
  "toast.session.handoff.failed.description": "Ushbu seansni topshirish uchun umumlashtirib boʻlmadi",
