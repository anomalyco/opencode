export const dict = {
  ...
  "settings.plugins.section.browse": "Koʻrish",
  "settings.plugins.section.installed": "Oʻrnatilgan",
  ...
  "settings.mcp.add": "Server qoʻshish",
  "settings.mcp.empty": "Hech qanday MCP server sozlanmagan.",
  "settings.mcp.deleted": "{{name}} oʻchirildi.",
  "settings.mcp.errors.refresh": "MCP serverlarni yuklash imkonsiz.",
  "settings.mcp.status.pending": "ulanmoqda…",
  "settings.mcp.action.connect": "Ulanish",
  "settings.mcp.action.disconnect": "Uzish",
  "settings.mcp.action.authenticate": "Tasdiqlash",
  "settings.mcp.action.edit": "Tahrirlash",
  "settings.mcp.action.delete": "Oʻchirish",
  "settings.mcp.delete.title": "MCP serverni oʻchirish",
  "settings.mcp.delete.body": "{{name}} olib tashlansinmi? Bu qaytarilmaydi.",
  "settings.mcp.form.title.add": "MCP server qoʻshish",
  "settings.mcp.form.title.edit": "MCP serverni tahrirlash",
  "settings.mcp.form.subtitle": "Ulanish sozlamalarini moslang.",
  "settings.mcp.form.name": "Nom",
  "settings.mcp.form.command": "Buyruq",
  "settings.mcp.form.command.hint": "masalan npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Ish katalogi",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Muhit oʻzgaruvchilari",
  "settings.mcp.form.headers": "Sarlavhalar",
  "settings.mcp.form.addRow": "Qator qoʻshish",
  "settings.mcp.form.removeRow": "Oʻchirish",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Mijoz IDsi",
  "settings.mcp.form.oauth.clientSecret": "Mijoz siri",
  "settings.mcp.form.oauth.clientSecret.keep": "Sozlangan — saqlash uchun boʻsh qoldiring",
  "settings.mcp.form.oauth.scope": "Doira",
  "settings.mcp.form.oauth.callbackPort": "Qayta aloqa porti",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth avtomatik aniqlashni oʻchirish",
  "settings.mcp.form.enabled": "Yoqilgan",
  "settings.mcp.form.timeout": "Vaqt chegarasi (ms)",
  "settings.mcp.form.save": "Saqlash",
  "settings.mcp.form.cancel": "Bekor qilish",
  "settings.mcp.form.error.name": "Nom kiriting.",
  "settings.mcp.form.error.command": "Buyruq kiriting.",
  "settings.mcp.form.error.url": "URL kiriting.",
  "settings.mcp.form.error.callbackPort": "Qayta aloqa porti 1–65535 oraligʻida boʻlishi kerak.",
  "settings.mcp.form.error.timeout": "Vaqt chegarasi musbat butun son boʻlishi kerak.",
  "settings.mcp.errors.invalid": "Belgilangan maydonlarni tuzating.",
  "settings.mcp.errors.duplicate": "Bu nomli server allaqachon mavjud.",
  "settings.mcp.errors.noConfig": "{{name}} konfiguratsiyasini oʻqib boʻlmadi — loyihadan tashqarida aniqlangan boʻlishi mumkin.",
  "settings.mcp.edit.warn": "Saqlash bu serverni qayta ulaydi.",
  ...
  "settings.plugins.detail.copied": "Nusxalandi",
  "settings.plugins.detail.notOnNpm": "npm-da topilmadi — opencode.json-ga qoʻlda qoʻshing",
  "settings.plugins.install.title": "Plagin oʻrnatish",
  "settings.plugins.install.description": "{{name}} qayerga qoʻshilsin?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Bu loyiha",
  "settings.plugins.install.cancel": "Bekor qilish",
  "settings.plugins.install.success": "{{name}} oʻrnatildi. Yuklash uchun OpenCode-ni qayta ishga tushiring.",
  "settings.plugins.installed.empty": "Oʻrnatilgan plagin yoʻq.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Loyiha",
  ...
  "settings.plugins.errors.catalog": "Plaginlar katalogi yangilanmadi.",
  "settings.plugins.stale": "Keshlangan katalog koʻrsatilmoqda ({{age}} avvalgi).",
