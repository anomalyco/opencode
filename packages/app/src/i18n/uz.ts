export const dict = {
  ...
  "desktop.menu.documentation": "Pencode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Pencode menyusi",
  ...
  "desktop.recovery.loadFailed": "Pencode yuklanmadi",
  "desktop.recovery.terminated": "Pencode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Pencode javob bermayapti",
  ...
  "desktop.wsl.error.installPencode": "Pencode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.pencodeMissing": "Pencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.pencodeCannotRun": "pencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Pencode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.pencode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.pencode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.pencodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Pencode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Pencode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Pencode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "pencode.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Pencode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode tekshirilmoqda...",
  "wsl.onboarding.checkingPencodeIn": "Pencode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingPencode": "Pencode yangilanmoqda...",
  "wsl.onboarding.updatingPencodeIn": "Pencode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updatePencodeIn": "Pencode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updatePencode": "Pencode-ni yangilang",
  "wsl.onboarding.pencodeReadyIn": "Pencode {{distro}} da tayyor.",
  "wsl.onboarding.pencodeReady": "Pencode tayyor.",
  "wsl.onboarding.installPencodeIn": "Pencode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installPencode": "Pencode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pencode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Pencode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Pencode-ni qayta oching.",
  ...
  "help.tabs.introduction": "Pencode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Pencode jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (pencode.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Pencode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Pencode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Pencode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Pencode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Pencode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Pencode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Pencode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Pencode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Pencode oxirgi versiyasini ishga tushiryapsiz.",
