export const dict = {
  ...
  "mcp.status.needs_client_registration": "mijozni ro'yxatdan o'tkazish kerak",
  "mcp.status.pending": "ulanmoqda…",
  ...
  "settings.mcp.type.remote": "Masofaviy",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "O'tkazib yuborish uchun bo'sh qoldiring — qayta autentifikatsiya kerak bo'lishi mumkin",
