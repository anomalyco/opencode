export const dict = {
  ...
  "session.tab.agents": "Subagentlar",
  "session.agents.empty": "Hech qanday subagent ishlamayapti",
  "session.agents.costTotal": "Jami xarajat",
  "session.agents.costSubagents": "Subagentlar",
  "session.agents.count": "Agentlar",
  "session.agents.tokens": "tokenlar",
  "session.agents.showAll": "Barchasini ko‘rsatish ({{count}})",
  "session.agents.status.idle": "Bo‘sh",
  "session.agents.status.busy": "Ishlamoqda",
  "session.agents.status.retry": "Qayta urinish",
  "session.agents.status.cancelled": "Bekor qilindi",
  "session.agents.status.completed": "Yakunlandi",
  "session.agents.status.error": "Muvaffaqiyatsiz",
