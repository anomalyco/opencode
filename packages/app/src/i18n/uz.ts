export const dict = {
  ...
  "command.tab.closeAll": "Barcha tablarni yoping",
  "command.tab.closeRight": "O‘ngdagi barcha tablarni yoping",
  "command.tab.closeOthers": "Bundan boshqa barcha tablarni yoping",
