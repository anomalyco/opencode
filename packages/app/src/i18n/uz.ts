export const dict = {
  ...
  "desktop.menu.documentation": "Argus hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Argus menyusi",
  ...
  "desktop.recovery.loadFailed": "Argus yuklanmadi",
  "desktop.recovery.terminated": "Argus oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Argus javob bermayapti",
  ...
  "desktop.wsl.error.installArgus": "Argus oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.argusMissing": "Argus ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.argusCannotRun": "argus o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.argusNotInstalled": "Argus {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Argus yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.argus.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.argus.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.argusGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Argus tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Argus’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.argusZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Argus da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Argus da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "argus.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Argus serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingArgus": "Argus tekshirilmoqda...",
  "wsl.onboarding.checkingArgusIn": "Argus {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingArgus": "Argus yangilanmoqda...",
  "wsl.onboarding.updatingArgusIn": "Argus {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateArgusIn": "Argus-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateArgus": "Argus-ni yangilang",
  "wsl.onboarding.argusReadyIn": "Argus {{distro}} da tayyor.",
  "wsl.onboarding.argusReady": "Argus tayyor.",
  "wsl.onboarding.installArgusIn": "Argus-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installArgus": "Argus-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Argus WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Argus WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Argus-ni qayta oching.",
  ...
  "help.tabs.introduction": "Argus Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Argus ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Argus jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (argus.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Argus hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Argus bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Argus serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Argus uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Argus qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Argus tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Argus mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Argus ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Argus oxirgi versiyasini ishga tushiryapsiz.",
