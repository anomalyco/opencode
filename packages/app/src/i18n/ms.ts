export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Argus",
  ...
  "desktop.recovery.loadFailed": "Argus gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Argus ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Argus tidak memberi respons",
  ...
  "desktop.wsl.error.installArgus": "Pemasangan Argus gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.argusMissing": "argus tidak dipasang dalam distro ini",
  "desktop.wsl.error.argusCannotRun": "argus dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.argusNotInstalled": "Argus tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Argus selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.argus.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.argus.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.argusGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Argus",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.argusZen.visit.prefix": "Layari",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Argus.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam argus.json",
  ...
  "dialog.server.description": "Tukar pelayan Argus yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingArgus": "Sedang menyemak Argus...",
  "wsl.onboarding.checkingArgusIn": "Sedang menyemak Argus dalam {{distro}}...",
  "wsl.onboarding.updatingArgus": "Sedang mengemas kini Argus...",
  "wsl.onboarding.updatingArgusIn": "Sedang mengemas kini Argus dalam {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Kemas kini Argus dalam {{distro}}.",
  "wsl.onboarding.updateArgus": "Kemas kini Argus",
  "wsl.onboarding.argusReadyIn": "Argus sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.argusReady": "Argus sedia digunakan.",
  "wsl.onboarding.installArgusIn": "Pasang Argus dalam {{distro}}.",
  "wsl.onboarding.installArgus": "Pasang Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Argus boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Argus tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Argus ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Argus",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (argus.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Argus belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Argus dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Argus",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Argus pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Argus mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Argus.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Argus dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Argus.",
