export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Pencode",
  ...
  "desktop.recovery.loadFailed": "Pencode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Pencode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Pencode tidak memberi respons",
  ...
  "desktop.wsl.error.installPencode": "Pemasangan Pencode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.pencodeMissing": "pencode tidak dipasang dalam distro ini",
  "desktop.wsl.error.pencodeCannotRun": "pencode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Pencode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.pencode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.pencode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.pencodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Pencode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Layari",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Pencode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam pencode.json",
  ...
  "dialog.server.description": "Tukar pelayan Pencode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingPencode": "Sedang menyemak Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Sedang menyemak Pencode dalam {{distro}}...",
  "wsl.onboarding.updatingPencode": "Sedang mengemas kini Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Sedang mengemas kini Pencode dalam {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Kemas kini Pencode dalam {{distro}}.",
  "wsl.onboarding.updatePencode": "Kemas kini Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode sedia digunakan.",
  "wsl.onboarding.installPencodeIn": "Pasang Pencode dalam {{distro}}.",
  "wsl.onboarding.installPencode": "Pasang Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Pencode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Pencode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Pencode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Pencode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (pencode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Pencode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Pencode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Pencode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Pencode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Pencode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Pencode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Pencode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Pencode.",
