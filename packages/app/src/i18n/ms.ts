export const dict = {
  ...
  "command.session.handoff.description": "Padatkan sesi dan teruskan kerja dalam sesi baharu",
  ...
  "toast.session.handoff.failed.description": "Sesi ini tidak dapat diringkaskan untuk diserahkan",
