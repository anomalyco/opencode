export const dict = {
  ...
  "provider.custom.models.load": "Muat secara dinamik",
  "provider.custom.models.loading": "Memuat...",
  "provider.custom.models.load.invalidUrl": "Masukkan URL asas yang sah",
  "provider.custom.models.load.unauthorized": "Tidak dibenarkan. Semak kunci API",
  "provider.custom.models.load.invalidFormat": "Respons pelayan tidak mengandungi senarai model yang sah",
  "provider.custom.models.load.timeout": "Tamat masa semasa memuatkan model",
  "provider.custom.models.load.failed": "Gagal memuatkan model",
  "provider.custom.models.load.empty": "Tiada model ditemui",
