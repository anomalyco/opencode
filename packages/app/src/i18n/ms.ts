export const dict = {
  ...
  "settings.plugins.section.browse": "Layar",
  "settings.plugins.section.installed": "Dipasang",
  ...
  "settings.mcp.add": "Tambah pelayan",
  "settings.mcp.empty": "Tiada pelayan MCP dikonfigurasi.",
  "settings.mcp.deleted": "{{name}} dipadam.",
  "settings.mcp.errors.refresh": "Gagal memuatkan pelayan MCP.",
  "settings.mcp.status.pending": "menyambung…",
  "settings.mcp.action.connect": "Sambung",
  "settings.mcp.action.disconnect": "Putuskan",
  "settings.mcp.action.authenticate": "Sah",
  "settings.mcp.action.edit": "Sunting",
  "settings.mcp.action.delete": "Padam",
  "settings.mcp.delete.title": "Padam pelayan MCP",
  "settings.mcp.delete.body": "Buang {{name}}? Ini tidak boleh dibuat asal.",
  "settings.mcp.form.title.add": "Tambah pelayan MCP",
  "settings.mcp.form.title.edit": "Edit pelayan MCP",
  "settings.mcp.form.subtitle": "Konfigur tetapan sambungan.",
  "settings.mcp.form.name": "Nama",
  "settings.mcp.form.command": "Arahan",
  "settings.mcp.form.command.hint": "cth. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Direktori kerja",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Pemboleh ubah persekitaran",
  "settings.mcp.form.headers": "Pengepala",
  "settings.mcp.form.addRow": "Tambah baris",
  "settings.mcp.form.removeRow": "Alih keluar",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID pelanggan",
  "settings.mcp.form.oauth.clientSecret": "Rahsia pelanggan",
  "settings.mcp.form.oauth.clientSecret.keep": "Dikonfigurasi — biarkan kosong untuk mengekalkan",
  "settings.mcp.form.oauth.scope": "Skop",
  "settings.mcp.form.oauth.callbackPort": "Port panggil balik",
  "settings.mcp.form.oauth.disableAutodetect": "Lumpuhkan pengesanan automatik OAuth",
  "settings.mcp.form.enabled": "Didayakan",
  "settings.mcp.form.timeout": "Had masa (ms)",
  "settings.mcp.form.save": "Simpan",
  "settings.mcp.form.cancel": "Batal",
  "settings.mcp.form.error.name": "Masukkan nama.",
  "settings.mcp.form.error.command": "Masukkan arahan.",
  "settings.mcp.form.error.url": "Masukkan URL.",
  "settings.mcp.form.error.callbackPort": "Port panggil balik mesti antara 1 hingga 65535.",
  "settings.mcp.form.error.timeout": "Had masa mesti nombor bulat positif.",
  "settings.mcp.errors.invalid": "Betulkan medan yang diserlahkan.",
  "settings.mcp.errors.duplicate": "Pelayan dengan nama ini sudah wujud.",
  "settings.mcp.errors.noConfig": "Tidak dapat membaca konfigurasi {{name}} — mungkin ditakrifkan di luar projek.",
  "settings.mcp.edit.warn": "Menyimpan menyambung semula pelayan ini.",
  ...
  "settings.plugins.detail.copied": "Disalin",
  "settings.plugins.detail.notOnNpm": "Tidak dijumpai di npm — tambah secara manual ke opencode.json",
  "settings.plugins.install.title": "Pasang plugin",
  "settings.plugins.install.description": "Ke mana {{name}} ditambah?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Projek ini",
  "settings.plugins.install.cancel": "Batal",
  "settings.plugins.install.success": "{{name}} dipasang. Mulakan semula OpenCode untuk memuatkannya.",
  "settings.plugins.installed.empty": "Tiada plugin dipasang.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Projek",
  ...
  "settings.plugins.errors.catalog": "Katalog plugin tidak dapat disegarkan semula.",
  "settings.plugins.stale": "Memaparkan katalog cache ({{age}} lepas).",
