export const dict = {
  ...
  "session.tab.agents": "Sub-ejen",
  "session.agents.empty": "Tiada sub-ejen berjalan",
  "session.agents.costTotal": "Jumlah kos",
  "session.agents.costSubagents": "Sub-ejen",
  "session.agents.count": "Ejen",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Tunjuk semua ({{count}})",
  "session.agents.status.idle": "Melandang",
  "session.agents.status.busy": "Berjalan",
  "session.agents.status.retry": "Mencuba semula",
  "session.agents.status.cancelled": "Dibatalkan",
  "session.agents.status.completed": "Selesai",
  "session.agents.status.error": "Gagal",
