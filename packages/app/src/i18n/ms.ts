export const dict = {
  ...
  "mcp.status.needs_client_registration": "pendaftaran klien diperlukan",
  "mcp.status.pending": "menyambung…",
  ...
  "settings.mcp.type.local": "Setempat",
  "settings.mcp.type.remote": "Jauh",
