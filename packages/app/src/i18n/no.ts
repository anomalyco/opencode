...
export const dict = {
  ...
  "dialog.provider.athena.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.athena.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.athenaGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Athena",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Athena.",
  ...
  "provider.connect.athenaZen.line1":
    "Athena Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.athenaZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.athenaZen.visit.prefix": "Besøk ",
  "provider.connect.athenaZen.visit.link": "athena.ai/zen",
  "provider.connect.athenaZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Athena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Athena.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i athena.json",
  ...
  "dialog.server.description": "Bytt hvilken Athena-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Athena ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Athena-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (athena.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Athena ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Athena inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Athena-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Athena",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Athena ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Athena skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Athena er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Athena starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Athena.",
