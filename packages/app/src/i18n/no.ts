...
export const dict = {
  ...
  "desktop.menu.documentation": "Pencode-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "Pencode kunne ikke lastes inn",
  "desktop.recovery.terminated": "Pencode-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.installPencode": "Installasjonen av Pencode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.pencodeMissing": "pencode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.pencodeCannotRun": "pencode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Pencode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.pencode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.pencode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.pencodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Pencode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.pencodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.pencodeZen.visit.prefix": "Besøk ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Pencode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i pencode.json",
  ...
  "dialog.server.description": "Bytt hvilken Pencode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Pencode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Pencode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (pencode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Pencode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Pencode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Pencode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Pencode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Pencode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Pencode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Pencode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Pencode starter",
  ...
  "settings.updates.toast.latest.title": "Pencode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Pencode.",
  ...
  "wsl.onboarding.checkingPencode": "Sjekker Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Sjekker Pencode i {{distro}}...",
  "wsl.onboarding.updatingPencode": "Oppdaterer Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Oppdaterer Pencode i {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Oppdater Pencode i {{distro}}.",
  "wsl.onboarding.updatePencode": "Oppdater Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Pencode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Pencode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Pencode på nytt.",
  ...
  "help.tabs.introduction": "Pencode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
