...
export const dict = {
  ...
  "settings.general.section.input": "Inndata",
  ...
  "settings.general.row.sendKey.description": "Velg hvilken tast som sender meldinger. Den andre Enter-tasten setter inn en ny linje.",
