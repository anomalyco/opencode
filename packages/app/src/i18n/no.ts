...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenSec",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenSec.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenSec Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenSec.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenSec.",
  ...
  "dialog.server.description": "Bytt hvilken OpenSec-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenSec ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenSec-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenSec ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenSec inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenSec",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenSec ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenSec er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenSec starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenSec.",
