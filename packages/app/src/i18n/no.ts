...
export const dict = {
  ...
  "dialog.newProject.title": "Nytt prosjekt",
  "dialog.newProject.tab.github": "Importer fra GitHub",
  "dialog.newProject.tab.folder": "Importer fra mappe",
  "dialog.newProject.url.label": "URL for depot",
  "dialog.newProject.destination.label": "Kloningsmål",
  "dialog.newProject.destination.placeholder": "Velg en målmappe",
  "dialog.newProject.destination.browse": "Bla gjennom",
  "dialog.newProject.destination.pick": "Velg kloningsmål",
  "dialog.newProject.clone": "Klon depot",
  "dialog.newProject.cloning": "Kloner...",
  "dialog.newProject.error.cloneFailed": "Kunne ikke klone depotet",
  "dialog.newProject.folder.title": "Åpne et eksisterende prosjekt",
  "dialog.newProject.folder.description": "Velg en lokal mappe for å legge til som et prosjekt i OpenCode.",
  "dialog.newProject.folder.action": "Velg mappe",
