...
export const dict = {
  ...
  "home.activity.daily": "Daglig",
  "home.activity.weekly": "Ukentlig",
  "home.activity.cumulative": "Akkumulert",
  "home.activity.loading": "Laster aktivitet",
  "home.activity.empty": "Ingen token-aktivitet ennå",
  "home.activity.lifetimeTokens": "Totalt antall tokens",
  "home.activity.peakTokens": "Token-topp",
  "home.activity.longestTask": "Lengste oppgave",
  "home.activity.currentStreak": "Nåværende rekke",
  "home.activity.longestStreak": "Lengste rekke",
  "home.activity.days.one": "{{count}} dag",
  "home.activity.days.other": "{{count}} dager",
  "home.activity.summary":
    "{{tokens}} tokens totalt, {{peak}} token-topp, {{current}} nåværende rekke, {{longest}} lengste rekke.",
