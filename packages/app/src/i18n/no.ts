...
export const dict = {
  ...
  "settings.general.row.reasoningSummaries.title": "Vis resonnementssammendrag",
  "settings.general.row.reasoningSummaries.description": "Vis modellens resonnementssammendrag i tidslinjen",
