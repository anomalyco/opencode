...
export const dict = {
  ...
  "status.button.tooltip": "Vis systemstatus",
  "status.tab.servers.one": "{{count}} Tjener",
  "status.tab.servers.other": "{{count}} Tjenere",
  ...
  "status.tab.plugins.one": "{{count}} Programtillegg",
  "status.tab.plugins.other": "{{count}} Programtillegg",
  "status.servers.empty": "Ingen tjenere konfigurert",
  "status.servers.manage": "Administrer tjenere",
  "status.mcp.empty": "Ingen MCP-tjenere konfigurert",
  "status.lsp.empty": "Ingen aktive LSP-tjenere",
  "status.plugins.empty": "Programtillegg konfigurert i 'opencode.json'",
  "status.noProject": "Åpne et prosjekt for å vise",
