...
export const dict = {
  ...
  "error.page.action.restartFrontend": "Start frontend på nytt",
  "error.page.action.restartBackend": "Start backend på nytt",
  "error.page.action.restartApp": "Start app på nytt",
