...
export const dict = {
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i leak-code.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (leak-code.json)",
