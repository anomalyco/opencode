...
export const dict = {
  ...
  "provider.custom.models.output.label": "Maksimal utdata",
  "provider.custom.models.output.placeholder": "Maksimal utdata",
  "provider.custom.models.reasoning.label": "Støtter resonnering",
  ...
  "provider.custom.error.positiveInteger": "Skriv inn et positivt heltall",
