...
export const dict = {
  ...
  "command.todo.toggle": "Veksle todo-panel",
  ...
  "sidebar.issue.title": "Oppgaver",
  "sidebar.issue.add": "Legg til oppgave",
  "sidebar.issue.addSubtodo": "Legg til underoppgave",
  "sidebar.issue.empty": "Ingen oppgaver",
  "sidebar.issue.collapse": "Skjul underoppgaver",
  "sidebar.issue.expand": "Vis underoppgaver",
  "sidebar.issue.confirmDeleteWithChildren": "Slett denne oppgaven og dens {{count}} underoppgaver?",
  "sidebar.issue.toast.deleteFailed": "Kunne ikke slette oppgave",
  "sidebar.issue.tooltip.cycleStatus": "Bytt status",
  "sidebar.issue.tooltip.cyclePriority": "Bytt prioritet",
  "sidebar.issue.tooltip.linkedLinear": "Koblet til Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Tilkoblet",
  "sidebar.linear.management": "Administrer Linear-binding",
  "sidebar.linear.management.teamRequired": "Velg et team",
  "sidebar.linear.management.projectRequired": "Velg et prosjekt",
  "sidebar.linear.management.saveFailed": "Kunne ikke lagre Linear-binding",
  "sidebar.linear.management.saved": "Linear-binding lagret",
  "sidebar.linear.management.save": "Lagre",
  "sidebar.linear.toggleHistory": "Vis/skjul synkroniseringshistorikk",
  "sidebar.linear.field.team": "Team",
  "sidebar.linear.field.team.loading": "Laster team...",
  "sidebar.linear.field.team.placeholder": "Velg et team",
  "sidebar.linear.field.project": "Prosjekt",
  "sidebar.linear.field.project.selectTeamFirst": "Velg et team først",
  "sidebar.linear.field.project.loading": "Laster prosjekter...",
  "sidebar.linear.field.project.placeholder": "Velg et prosjekt",
  "sidebar.linear.notConfigured": "Linear ikke konfigurert",
  "sidebar.linear.notConfiguredHint": "Åpne administrasjon for å velge team og prosjekt",
  ...
  "sidebar.linear.pullSuccess":
    "Hentet {{pulled}}, oppdatert {{updated}}, hoppet over {{skipped}}, slettet {{deleted}}",
  "sidebar.linear.pushFailed": "Kunne ikke sende til Linear",
  "sidebar.linear.pushPartialFailed": "Sending delvis mislyktes: {{count}} feil",
  "sidebar.linear.pushSuccess": "Sendte {{count}} oppgaver til Linear",
  "sidebar.linear.pushNothing": "Ingenting å sende",
  "sidebar.linear.syncHistory.syncing": "Synkroniserer...",
  "sidebar.linear.syncHistory.error": "Feil",
  "sidebar.linear.syncHistory.empty": "Ingen synkroniseringshistorikk",
  "dialog.todo.title.create": "Ny oppgave",
  "dialog.todo.title.edit": "Rediger oppgave",
  "dialog.todo.field.title": "Tittel",
  "dialog.todo.field.title.placeholder": "Oppgavetittel",
  "dialog.todo.field.description": "Beskrivelse",
  "dialog.todo.field.description.placeholder": "Legg til detaljer, lenker eller kontekst...",
  "dialog.todo.field.description.hint": "Støtter fil- og ferdighetsreferanser",
  "dialog.todo.field.status": "Status",
  "dialog.todo.field.priority": "Prioritet",
  "dialog.todo.field.dueDate": "Forfallsdato",
  "dialog.todo.field.dueDate.placeholder": "Angi forfallsdato",
  "dialog.todo.field.dueDate.clear": "Tøm",
  "dialog.todo.field.dueDate.prevMonth": "Forrige måned",
  "dialog.todo.field.dueDate.nextMonth": "Neste måned",
  "dialog.todo.field.dueDate.shortcut.today": "I dag",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "I morgen",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Om en uke",
  ...
  "dialog.todo.field.assignee.loadFailed": "Kunne ikke laste tildelte",
  "dialog.todo.field.assignee.loading": "Laster tildelte...",
  "dialog.todo.field.assignee.placeholder": "Velg tildelt",
  "dialog.todo.field.assignee.hint": "Fra Linear-teammedlemmer",
  "dialog.todo.linkedLinear": "Koblet til Linear",
  "dialog.todo.created": "Oppgave opprettet",
  "dialog.todo.updated": "Oppgave oppdatert",
  "dialog.todo.error.titleRequired": "Tittel er påkrevd",
  "dialog.todo.error.saveFailed": "Kunne ikke lagre oppgave",
  "dialog.todo.action.create": "Opprett",
  ...
  "sidebar.issue.priority.urgent": "Haster",
  "sidebar.issue.priority.high": "Høy",
  ...
  "sidebar.issue.archivedBadge": "Arkivert",
  "sidebar.issue.archiveArea.title": "Arkiverte",
  "sidebar.issue.archiveArea.expand": "Vis arkiverte",
  "sidebar.issue.archiveArea.collapse": "Skjul arkiverte",
  "sidebar.issue.archiveArea.empty": "Ingen arkiverte oppgaver",
