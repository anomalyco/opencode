...
export const dict = {
  ...
  "command.context.addToChat": "Legg til markering i chatten",
  "command.context.addToChat.description": "Sett inn valgte linjer ved markørposisjonen",
  "command.context.quickEdit": "Hurtigredigering av markering",
  "command.context.quickEdit.description": "Rediger valgt kode i en ny økt",
  "selection.action.addToChat": "Legg til i chatten",
  "selection.action.quickEdit": "Hurtigredigering",
  "selection.quickEdit.placeholder": "Rediger valgt kode",
