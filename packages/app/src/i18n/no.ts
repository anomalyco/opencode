...
export const dict = {
  ...
  "desktop.menu.documentation": "Argus-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "Argus kunne ikke lastes inn",
  "desktop.recovery.terminated": "Argus-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.installArgus": "Installasjonen av Argus mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.argusMissing": "argus er ikke installert i denne distribusjonen",
  "desktop.wsl.error.argusCannotRun": "argus er installert, men kunne ikke kjøres",
  "desktop.wsl.error.argusNotInstalled": "Argus er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Argus er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Argus.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i argus.json",
  ...
  "settings.general.row.colorScheme.description":
    "Velg om Argus skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Argus.",
  ...
  "settings.updates.toast.latest.title": "Argus er oppdatert",
  ...
  "wsl.onboarding.checkingArgus": "Sjekker Argus...",
  "wsl.onboarding.checkingArgusIn": "Sjekker Argus i {{distro}}...",
  "wsl.onboarding.updatingArgus": "Oppdaterer Argus...",
  "wsl.onboarding.updatingArgusIn": "Oppdaterer Argus i {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Oppdater Argus i {{distro}}.",
  "wsl.onboarding.updateArgus": "Oppdater Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Argus kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Argus kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Argus på nytt.",
  ...
  "help.tabs.introduction": "Argus Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
