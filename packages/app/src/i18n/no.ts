...
export const dict = {
  ...
  "presets.title": "Forhåndsinnstillinger",
  "presets.manage": "Administrer forhåndsinnstillinger",
  "presets.count": "{{count}} forhåndsinnstillinger",
  "presets.empty": "Ingen forhåndsinnstillinger",
  "presets.empty.hint": "Klikk \"Legg til\" for å opprette din første forhåndsinnstilling",
  "presets.add": "Legg til",
  "presets.name": "Navn",
  "presets.content": "Innhold",
  "presets.content.placeholder": "Innhold (støtter {date} {time} {file} {code} {text} variabler)",
  "presets.moveUp": "Flytt opp",
  "presets.moveDown": "Flytt ned",
  "presets.edit": "Rediger",
  "presets.delete": "Slett",
  "presets.variables.title": "Skriv inn variabler for \"{{name}}\"",
  "presets.variables.next": "Neste",
  "presets.variables.insert": "Sett inn",
