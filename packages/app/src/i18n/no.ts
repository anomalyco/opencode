...
export const dict = {
  ...
  "settings.general.row.keepModelOverride.title": "Behold modelloverstyring",
  "settings.general.row.keepModelOverride.description":
    "Behold en manuelt valgt modell for den nåværende samtalen etter at en melding er sendt",
