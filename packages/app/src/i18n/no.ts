...
export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Ugyldig SSH-vert: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} er allerede lagt til",
  "desktop.ssh.error.opencodeNotInstalled": "opencode er ikke installert på {{host}}",
  "desktop.ssh.error.installOpencode": "Installasjonen av opencode mislyktes",
  "desktop.ssh.error.connectFailed": "Kunne ikke koble til {{host}}",
  "desktop.ssh.error.serverExited": "SSH-serveren ble avsluttet etter oppstart (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "SSH-serveren for {{host}} ble avsluttet før den var klar (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "Tidsavbrudd for tilstandskontrollen av serveren på {{host}} etter {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "Tidsavbrudd for ssh-kommandoen til {{host}} etter {{timeout}} ms",
  "desktop.ssh.error.failedPort": "Kunne ikke hente port",
  "desktop.ssh.error.terminalFailed": "Kunne ikke åpne en terminal",
  ...
  "ssh.server.add": "Legg til SSH-server",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH-server",
  "ssh.server.retryStart": "Koble til på nytt",
  "ssh.server.disconnect": "Koble fra",
  "ssh.server.openTerminal": "Åpne terminal",
  "ssh.server.updating": "Oppdaterer...",
  "ssh.server.status.connecting": "Kobler til...",
  "ssh.server.status.disconnected": "Frakoblet",
  "ssh.add.hostLabel": "SSH-vert",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Kobler til via systemets ssh-klient, så verter, nøkler og agenter fra SSH-konfigurasjonen din fungerer som vanlig.",
  "ssh.add.configHosts": "Fra SSH-konfigurasjonen din",
  "ssh.add.connect": "Koble til",
  "ssh.add.checking": "Kobler til...",
  "ssh.add.addServer": "Legg til server",
  "ssh.add.adding": "Legger til...",
  "ssh.add.installOpencode": "Installer opencode",
  "ssh.add.updateOpencode": "Oppdater opencode",
  "ssh.add.installing": "Installerer...",
  "ssh.add.status.unreachable": "Kunne ikke koble til",
  "ssh.add.status.opencodeMissing": "opencode er ikke installert på denne verten",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} er installert, skrivebordsappen forventer v{{expected}}",
  "ssh.add.status.opencodeFound": "Fant opencode v{{version}}",
  "ssh.add.authHint":
    "Sørg for at nøkkelbasert SSH-autentisering fungerer for denne verten — kjør `ssh {{host}}` i en terminal for å sjekke.",
