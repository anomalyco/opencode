...
export const dict = {
  ...
  "session.agents.empty": "Ingen underagenturer kjører",
  "session.agents.costTotal": "Totalkostnad",
  "session.agents.costSubagents": "Underagenturer",
  ...
  "session.agents.status.busy": "Kjører",
  "session.agents.status.retry": "Prøver igjen",
  "session.agents.status.cancelled": "Kansellert",
  "session.agents.status.completed": "Fullført",
  "session.agents.status.error": "Mislyktes",
  ...
  "session.header.reveal.finder": "Vis i Finder",
  "session.header.reveal.fileExplorer": "Vis i Filutforsker",
  "session.header.reveal.containingFolder": "Åpne mappen som inneholder",
