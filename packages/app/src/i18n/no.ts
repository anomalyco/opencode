...
export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode-meny",
  "desktop.appMenu.file": "Fil",
  "desktop.appMenu.edit": "Rediger",
  "desktop.appMenu.view": "Vis",
  "desktop.appMenu.go": "Gå",
  "desktop.appMenu.window": "Vindu",
  "desktop.appMenu.help": "Hjelp",
  "desktop.appMenu.about": "Om OpenCode",
  "desktop.appMenu.checkForUpdates": "Se etter oppdateringer...",
  "desktop.appMenu.settings": "Innstillinger",
  "desktop.appMenu.reloadWebview": "Last inn nettvisning på nytt",
  "desktop.appMenu.restart": "Start på nytt",
  "desktop.appMenu.exportLogs": "Eksporter logger...",
  "desktop.appMenu.hide": "Skjul OpenCode",
  "desktop.appMenu.hideOthers": "Skjul andre",
  "desktop.appMenu.showAll": "Vis alle",
  "desktop.appMenu.quit": "Avslutt OpenCode",
  "desktop.appMenu.newSession": "Ny sesjon",
  "desktop.appMenu.openProject": "Åpne prosjekt...",
  "desktop.appMenu.newWindow": "Nytt vindu",
  "desktop.appMenu.closeWindow": "Lukk vindu",
  "desktop.appMenu.undo": "Angre",
  "desktop.appMenu.redo": "Gjør om",
  "desktop.appMenu.cut": "Klipp ut",
  "desktop.appMenu.copy": "Kopier",
  "desktop.appMenu.paste": "Lim inn",
  "desktop.appMenu.delete": "Slett",
  "desktop.appMenu.selectAll": "Merk alt",
  "desktop.appMenu.toggleSidebar": "Vis/skjul sidepanel",
  "desktop.appMenu.toggleTerminal": "Vis/skjul terminal",
  "desktop.appMenu.toggleFileTree": "Vis/skjul filtre",
  "desktop.appMenu.reload": "Last inn på nytt",
  "desktop.appMenu.toggleDeveloperTools": "Vis/skjul utviklerverktøy",
  "desktop.appMenu.actualSize": "Faktisk størrelse",
  "desktop.appMenu.zoomIn": "Zoom inn",
  "desktop.appMenu.zoomOut": "Zoom ut",
  "desktop.appMenu.toggleFullScreen": "Slå fullskjermmodus av/på",
  "desktop.appMenu.back": "Tilbake",
  "desktop.appMenu.forward": "Frem",
  "desktop.appMenu.previousSession": "Forrige sesjon",
  "desktop.appMenu.nextSession": "Neste sesjon",
  "desktop.appMenu.previousProject": "Forrige prosjekt",
  "desktop.appMenu.nextProject": "Neste prosjekt",
  "desktop.appMenu.minimize": "Minimer",
  "desktop.appMenu.zoomWindow": "Zoom",
  "desktop.appMenu.maximize": "Maksimer",
  "desktop.appMenu.bringAllToFront": "Flytt alle fremst",
  "desktop.appMenu.documentation": "OpenCode-dokumentasjon",
  "desktop.appMenu.supportForum": "Forum for brukerstøtte",
  "desktop.appMenu.shareFeedback": "Send tilbakemelding",
  "desktop.appMenu.reportBug": "Rapporter en feil",
