...
export const dict = {
  ...
  "provider.custom.models.load": "Last inn dynamisk",
  "provider.custom.models.loading": "Laster...",
  "provider.custom.models.load.invalidUrl": "Oppgi en gyldig basis-URL",
  "provider.custom.models.load.unauthorized": "Ikke autorisert. Sjekk API-nøkkelen",
  "provider.custom.models.load.invalidFormat": "Serverens svar inneholdt ikke en gyldig modelliste",
  "provider.custom.models.load.timeout": "Tidsavbrudd ved lasting av modeller",
  "provider.custom.models.load.failed": "Kunne ikke laste inn modeller",
  "provider.custom.models.load.empty": "Ingen modeller funnet",
