export const dict = {
  ...
  "settings.plugins.section.browse": "Procházet",
  "settings.plugins.section.installed": "Nainstalované",
  "settings.plugins.source.all": "Všechny zdroje",
  "settings.plugins.source.ecosystem": "Ekosystém",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Přidat server",
  "settings.mcp.empty": "Nejsou nakonfigurovány žádné servery MCP.",
  "settings.mcp.deleted": "{{name}} odstraněn.",
  "settings.mcp.errors.refresh": "Nelze načíst servery MCP.",
  "settings.mcp.status.pending": "připojování…",
  "settings.mcp.action.connect": "Připojit",
  "settings.mcp.action.disconnect": "Odpojit",
  "settings.mcp.action.authenticate": "Autentizovat",
  "settings.mcp.action.edit": "Upravit",
  "settings.mcp.action.delete": "Odstranit",
  "settings.mcp.delete.title": "Odstranit server MCP",
  "settings.mcp.delete.body": "Odebrat {{name}}? Tuto akci nelze vrátit.",
  "settings.mcp.form.title.add": "Přidat server MCP",
  "settings.mcp.form.title.edit": "Upravit server MCP",
  "settings.mcp.form.subtitle": "Nakonfigurujte nastavení připojení.",
  "settings.mcp.form.name": "Název",
  "settings.mcp.form.command": "Příkaz",
  "settings.mcp.form.command.hint": "např. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Pracovní adresář",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Proměnné prostředí",
  "settings.mcp.form.headers": "Hlavičky",
  "settings.mcp.form.addRow": "Přidat řádek",
  "settings.mcp.form.removeRow": "Odebrat",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID klienta",
  "settings.mcp.form.oauth.clientSecret": "Tajný klíč klienta",
  "settings.mcp.form.oauth.clientSecret.keep": "Nakonfigurováno — ponechte prázdné pro zachování",
  "settings.mcp.form.oauth.scope": "Rozsah",
  "settings.mcp.form.oauth.callbackPort": "Port zpětného volání",
  "settings.mcp.form.oauth.disableAutodetect": "Zakázat autodetekci OAuth",
  "settings.mcp.form.enabled": "Povoleno",
  "settings.mcp.form.timeout": "Časový limit (ms)",
  "settings.mcp.form.save": "Uložit",
  "settings.mcp.form.cancel": "Zrušit",
  "settings.mcp.form.error.name": "Zadejte název.",
  "settings.mcp.form.error.command": "Zadejte příkaz.",
  "settings.mcp.form.error.url": "Zadejte URL.",
  "settings.mcp.form.error.callbackPort": "Port zpětného volání musí být 1 až 65535.",
  "settings.mcp.form.error.timeout": "Časový limit musí být kladné celé číslo.",
  "settings.mcp.errors.invalid": "Opravte zvýrazněná pole.",
  "settings.mcp.errors.duplicate": "Server s tímto názvem už existuje.",
  "settings.mcp.errors.noConfig": "Konfiguraci {{name}} nelze přečíst — může být definována mimo projekt.",
  "settings.mcp.edit.warn": "Uložení server znovu připojí.",
  "settings.plugins.search.placeholder": "Hledat pluginy…",
  "settings.plugins.detail.install": "Nainstalovat…",
  "settings.plugins.detail.copy": "Zkopírovat úryvek konfigurace",
  "settings.plugins.detail.copied": "Zkopírováno",
  "settings.plugins.detail.notOnNpm": "Nenalezeno na npm — přidejte ručně do opencode.json",
  "settings.plugins.install.title": "Nainstalovat plugin",
  "settings.plugins.install.description": "Kam přidat {{name}}?",
  "settings.plugins.install.global": "Globálně (~/.config/opencode)",
  "settings.plugins.install.project": "Tento projekt",
  "settings.plugins.install.cancel": "Zrušit",
  "settings.plugins.install.success": "{{name}} nainstalován. Restartujte OpenCode, aby se načetl.",
  "settings.plugins.installed.empty": "Žádné nainstalované pluginy.",
  "settings.plugins.installed.provenance.global": "Globálně",
  "settings.plugins.installed.provenance.project": "Projekt",
  "settings.plugins.installed.disable": "Zakázat",
  "settings.plugins.installed.enable": "Povolit",
  "settings.plugins.installed.uninstall": "Odinstalovat",
  "settings.plugins.installed.uninstallBody": "Odinstalovat {{name}} z {{scope}}? Bude odebrán z konfiguračního souboru.",
  "settings.plugins.installed.recentlyRemoved": "Nedávno odstraněné",
  "settings.plugins.installed.openConfig": "Otevřít konfiguraci",
  "settings.plugins.errors.parseFailed": "Nelze číst {{path}} — opravte nebo odstraňte soubor, chcete-li tam spravovat pluginy.",
  "settings.plugins.errors.catalog": "Nelze obnovit katalog pluginů.",
  "settings.plugins.stale": "Zobrazen katalog z mezipaměti ({{age}}).",
