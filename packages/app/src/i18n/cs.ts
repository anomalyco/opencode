export const dict = {
  ...
  "provider.custom.models.load": "Načíst dynamicky",
  "provider.custom.models.loading": "Načítání...",
  "provider.custom.models.load.invalidUrl": "Zadejte platnou základní URL",
  "provider.custom.models.load.unauthorized": "Neautorizováno. Zkontrolujte klíč API",
  "provider.custom.models.load.invalidFormat": "Odpověď serveru neobsahovala platný seznam modelů",
  "provider.custom.models.load.timeout": "Vypršel čas při načítání modelů",
  "provider.custom.models.load.failed": "Načtení modelů se nezdařilo",
  "provider.custom.models.load.empty": "Nebyly nalezeny žádné modely",
