export const dict = {
  ...
  "desktop.menu.documentation": "Argus Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Argus",
  ...
  "desktop.recovery.loadFailed": "Argus se nepodařilo načíst",
  "desktop.recovery.terminated": "Argus okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Argus nereaguje",
  ...
  "desktop.wsl.error.installArgus": "Argus instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.argusMissing": "argus není v této distribuci nainstalováno",
  "desktop.wsl.error.argusCannotRun": "argus je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.argusNotInstalled": "Argus není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.argus.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.argus.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.argusGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.argusZen.visit.prefix": "Návštěva ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Argus.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v argus.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Argus serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingArgus": "Kontrola Argus...",
  "wsl.onboarding.checkingArgusIn": "Kontrola Argus v {{distro}}...",
  "wsl.onboarding.updatingArgus": "Aktualizace Argus...",
  "wsl.onboarding.updatingArgusIn": "Aktualizace Argus v {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Aktualizace Argus v {{distro}}.",
  "wsl.onboarding.updateArgus": "Aktualizovat Argus",
  "wsl.onboarding.argusReadyIn": "Argus je připraveno v {{distro}}.",
  "wsl.onboarding.argusReady": "Argus je připraven.",
  "wsl.onboarding.installArgusIn": "Nainstalujte Argus do {{distro}}.",
  "wsl.onboarding.installArgus": "Instalovat Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Argus může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Argus nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Argus.",
  ...
  "help.tabs.introduction": "Argus Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Argus ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Argus",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (argus.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Argus zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Argus uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Argus",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Argus na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Argus následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Argus.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Argus",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Argus.",
