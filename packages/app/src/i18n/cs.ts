export const dict = {
  ...
  "desktop.menu.documentation": "Pencode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Pencode",
  ...
  "desktop.recovery.loadFailed": "Pencode se nepodařilo načíst",
  "desktop.recovery.terminated": "Pencode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Pencode nereaguje",
  ...
  "desktop.wsl.error.installPencode": "Pencode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.pencodeMissing": "pencode není v této distribuci nainstalováno",
  "desktop.wsl.error.pencodeCannotRun": "pencode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.pencode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.pencode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.pencodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Návštěva ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Pencode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v pencode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Pencode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingPencode": "Kontrola Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Kontrola Pencode v {{distro}}...",
  "wsl.onboarding.updatingPencode": "Aktualizace Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Aktualizace Pencode v {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Aktualizace Pencode v {{distro}}.",
  "wsl.onboarding.updatePencode": "Aktualizovat Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode je připraveno v {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode je připraven.",
  "wsl.onboarding.installPencodeIn": "Nainstalujte Pencode do {{distro}}.",
  "wsl.onboarding.installPencode": "Instalovat Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Pencode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Pencode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Pencode.",
  ...
  "help.tabs.introduction": "Pencode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Pencode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Pencode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (pencode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Pencode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Pencode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Pencode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Pencode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Pencode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Pencode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Pencode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Pencode.",
