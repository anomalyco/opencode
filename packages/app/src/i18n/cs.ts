export const dict = {
  ...
  "command.session.background": "Podagenti na pozadí",
  "command.session.background.description": "Odpojte podagenty blokující tuto relaci a nechte je pokračovat na pozadí",
  ...
  "toast.session.background.failed.title": "Nepodařilo se přesunout podagenty na pozadí",
