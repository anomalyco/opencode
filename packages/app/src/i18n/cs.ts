export const dict = {
  ...
  "command.session.handoff": "Předat relaci",
  "command.session.handoff.description": "Shrnout relaci a pokračovat v práci v nové relaci",
  ...
  "toast.session.handoff.failed.title": "Předání relace se nezdařilo",
  "toast.session.handoff.failed.description": "Tuto relaci se nepodařilo shrnout pro předání",
