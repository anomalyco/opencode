export const dict = {
  ...
  "session.agents.empty": "Žádní podagenti neběží",
  "session.agents.costTotal": "Celkové náklady",
  "session.agents.costSubagents": "Podagenti",
  "session.agents.count": "Agenti",
  "session.agents.tokens": "tokenů",
  "session.agents.showAll": "Zobrazit vše ({{count}})",
  "session.agents.status.idle": "Nečinný",
  "session.agents.status.busy": "Běží",
  "session.agents.status.retry": "Opakování",
  "session.agents.status.cancelled": "Zrušeno",
  "session.agents.status.completed": "Dokončeno",
  "session.agents.status.error": "Selhalo",
