export const dict = {
  ...
  "mcp.status.needs_client_registration": "vyžadována registrace klienta",
  "mcp.status.pending": "připojování…",
  ...
  "settings.mcp.type.local": "Lokální",
  "settings.mcp.type.remote": "Vzdálený",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Ponechte prázdné pro vynechání — může být vyžadována opětovná autentizace",
