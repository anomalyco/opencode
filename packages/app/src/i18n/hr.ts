...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "potrebna registracija klijenta",
  "mcp.status.pending": "povezivanje…",
  ...
  "settings.mcp.type.remote": "Udaljeni",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Ostavite prazno za izostavljanje — može biti potrebna ponovna autentifikacija",
