...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Pencode se nije uspio učitati",
  "Prozor aplikacije Pencode neočekivano je zatvoren",
  "Pencode ne reagira",
  ...
  "Instalacija aplikacije Pencode nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "pencode nije instaliran u ovoj distribuciji",
  "pencode je instaliran, ali se ne može pokrenuti",
  "Pencode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Pencode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.pencode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.pencode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.pencodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Pencode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Posjetiti",
  "provider.connect.pencodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Pencode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u pencode.json",
  ...
  "dialog.server.description": "Promijenite na koji se Pencode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingPencode": "Provjera Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Provjera Pencode u {{distro}}...",
  "wsl.onboarding.updatingPencode": "Ažuriranje Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Ažuriranje Pencode u {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Ažurirajte Pencode u {{distro}}.",
  "wsl.onboarding.updatePencode": "Ažurirajte Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode je spreman u {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode je spreman.",
  "wsl.onboarding.installPencodeIn": "Instalirajte Pencode u {{distro}}.",
  "wsl.onboarding.installPencode": "Instalirajte Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Pencode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Pencode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Pencode.",
  ...
  "help.tabs.introduction": "Radna površina Pencode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Pencode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Pencode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (pencode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Pencode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Pencode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Pencode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Pencode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Pencode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Pencode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Pencode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Pencode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Pencode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Pencode.",
