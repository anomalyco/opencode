...
export const dict = {
  ...
  "command.session.handoff.description": "Sažmite sesiju i nastavite rad u novoj sesiji",
  ...
  "toast.session.handoff.failed.description": "Ovu sesiju nije bilo moguće sažeti za predaju",
