...
export const dict = {
  ...
  "settings.tab.plugins": "Dodaci",
  "settings.plugins.section.browse": "Pregledaj",
  "settings.plugins.section.installed": "Instalirano",
  "settings.plugins.source.all": "Svi izvori",
  "settings.plugins.source.ecosystem": "Ekosustav",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Dodaj poslužitelj",
  "settings.mcp.empty": "Nema konfiguriranih MCP poslužitelja.",
  "settings.mcp.deleted": "{{name}} je izbrisan.",
  "settings.mcp.errors.refresh": "Učitavanje MCP poslužitelja nije uspjelo.",
  "settings.mcp.status.pending": "povezivanje…",
  "settings.mcp.action.connect": "Poveži",
  "settings.mcp.action.disconnect": "Odspoji",
  "settings.mcp.action.authenticate": "Autentificiraj",
  "settings.mcp.action.edit": "Uredi",
  "settings.mcp.action.delete": "Izbriši",
  "settings.mcp.delete.title": "Izbriši MCP poslužitelj",
  "settings.mcp.delete.body": "Ukloniti {{name}}? Ovo se ne može poništiti.",
  "settings.mcp.form.title.add": "Dodaj MCP poslužitelj",
  "settings.mcp.form.title.edit": "Uredi MCP poslužitelj",
  "settings.mcp.form.subtitle": "Konfigurirajte postavke veze.",
  "settings.mcp.form.name": "Naziv",
  "settings.mcp.form.command": "Naredba",
  "settings.mcp.form.command.hint": "npr. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Radni direktorij",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Varijable okoline",
  "settings.mcp.form.headers": "Zaglavlja",
  "settings.mcp.form.addRow": "Dodaj redak",
  "settings.mcp.form.removeRow": "Ukloni",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID klijenta",
  "settings.mcp.form.oauth.clientSecret": "Tajna klijenta",
  "settings.mcp.form.oauth.clientSecret.keep": "Konfigurirano — ostavite prazno za zadržavanje",
  "settings.mcp.form.oauth.scope": "Opseg",
  "settings.mcp.form.oauth.callbackPort": "Povratni port",
  "settings.mcp.form.oauth.disableAutodetect": "Onemogući automatsko otkrivanje OAutha",
  "settings.mcp.form.enabled": "Omogućeno",
  "settings.mcp.form.timeout": "Vremensko ograničenje (ms)",
  "settings.mcp.form.save": "Spremi",
  "settings.mcp.form.cancel": "Odustani",
  "settings.mcp.form.error.name": "Unesite naziv.",
  "settings.mcp.form.error.command": "Unesite naredbu.",
  "settings.mcp.form.error.url": "Unesite URL.",
  "settings.mcp.form.error.callbackPort": "Povratni port mora biti 1–65535.",
  "settings.mcp.form.error.timeout": "Vremensko ograničenje mora biti pozitivan cijeli broj.",
  "settings.mcp.errors.invalid": "Ispravite istaknuta polja.",
  "settings.mcp.errors.duplicate": "Poslužitelj s ovim nazivom već postoji.",
  "settings.mcp.errors.noConfig": "Konfiguraciju za {{name}} nije moguće pročitati — možda je definirana izvan projekta.",
  "settings.mcp.edit.warn": "Spremanje ponovno povezuje ovaj poslužitelj.",
  ...
  "settings.plugins.detail.copied": "Kopirano",
  "settings.plugins.detail.notOnNpm": "Nije pronađeno na npm — dodajte ručno u opencode.json",
  "settings.plugins.install.title": "Instaliraj dodatak",
  "settings.plugins.install.description": "Gdje dodati {{name}}?",
  "settings.plugins.install.global": "Globalno (~/.config/opencode)",
  "settings.plugins.install.project": "Ovaj projekt",
  "settings.plugins.install.cancel": "Odustani",
  "settings.plugins.install.success": "{{name}} je instaliran. Ponovno pokrenite OpenCode da se učita.",
  "settings.plugins.installed.empty": "Nema instaliranih dodataka.",
  "settings.plugins.installed.provenance.global": "Globalno",
  "settings.plugins.installed.provenance.project": "Projekt",
  "settings.plugins.installed.disable": "Onemogući",
  "settings.plugins.installed.enable": "Omogući",
  "settings.plugins.installed.uninstall": "Deinstaliraj",
  "settings.plugins.installed.uninstallBody": "Deinstalirati {{name}} iz {{scope}}? Uklonit će se iz konfiguracijske datoteke.",
  "settings.plugins.installed.recentlyRemoved": "Nedavno uklonjeno",
  "settings.plugins.installed.openConfig": "Otvori konfiguraciju",
  "settings.plugins.errors.parseFailed": "Nije moguće čitati {{path}} — popravite ili uklonite datoteku za upravljanje dodacima tamo.",
  "settings.plugins.errors.catalog": "Nije moguće osvježiti katalog dodataka.",
  "settings.plugins.stale": "Prikazuje se predmemorirani katalog (starost {{age}}).",
