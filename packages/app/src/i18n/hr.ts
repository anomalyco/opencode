...
export const dict = {
  ...
  "provider.custom.models.load": "Učitaj dinamički",
  "provider.custom.models.loading": "Učitavanje...",
  "provider.custom.models.load.invalidUrl": "Unesite valjani baza URL",
  "provider.custom.models.load.unauthorized": "Neovlašteno. Provjerite API ključ",
  "provider.custom.models.load.invalidFormat": "Odgovor poslužitelja nije sadržavao valjani popis modela",
  "provider.custom.models.load.timeout": "Isteklo vrijeme pri učitavanju modela",
  "provider.custom.models.load.failed": "Učitavanje modela nije uspjelo",
  "provider.custom.models.load.empty": "Nije pronađen nijedan model",
