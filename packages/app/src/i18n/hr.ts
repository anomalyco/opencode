...
export const dict = {
  ...
  "session.agents.empty": "Nijedan podagent nije pokrenut",
  "session.agents.costTotal": "Ukupni trošak",
  "session.agents.costSubagents": "Podagenti",
  "session.agents.count": "Agenti",
  "session.agents.tokens": "tokena",
  "session.agents.showAll": "Prikaži sve ({{count}})",
  "session.agents.status.idle": "Neaktivan",
  "session.agents.status.busy": "U tijeku",
  "session.agents.status.retry": "Pokušava ponovno",
  "session.agents.status.cancelled": "Otkazano",
  "session.agents.status.completed": "Dovršeno",
  "session.agents.status.error": "Neuspješno",
