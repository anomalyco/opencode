...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Argus se nije uspio učitati",
  "Prozor aplikacije Argus neočekivano je zatvoren",
  "Argus ne reagira",
  ...
  "Instalacija aplikacije Argus nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "argus nije instaliran u ovoj distribuciji",
  "argus je instaliran, ali se ne može pokrenuti",
  "Argus nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Argus je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.argus.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.argus.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.argusGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Argus",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.argusZen.visit.prefix": "Posjetiti",
  "provider.connect.argusZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.argusZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Argus.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u argus.json",
  ...
  "dialog.server.description": "Promijenite na koji se Argus poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingArgus": "Provjera Argus...",
  "wsl.onboarding.checkingArgusIn": "Provjera Argus u {{distro}}...",
  "wsl.onboarding.updatingArgus": "Ažuriranje Argus...",
  "wsl.onboarding.updatingArgusIn": "Ažuriranje Argus u {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Ažurirajte Argus u {{distro}}.",
  "wsl.onboarding.updateArgus": "Ažurirajte Argus",
  "wsl.onboarding.argusReadyIn": "Argus je spreman u {{distro}}.",
  "wsl.onboarding.argusReady": "Argus je spreman.",
  "wsl.onboarding.installArgusIn": "Instalirajte Argus u {{distro}}.",
  "wsl.onboarding.installArgus": "Instalirajte Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Argus može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Argus nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Argus.",
  ...
  "help.tabs.introduction": "Radna površina Argus sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Argus ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Argus timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (argus.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Argus još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Argus uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Argus Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Argus poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Argus",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Argus izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Argus slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Argus tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Argus pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Argus.",
