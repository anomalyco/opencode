export const dict = {
  ...
  "command.tab.closeAll": "Затваряне на всички раздели",
  "command.tab.closeRight": "Затваряне на всички раздели вдясно",
  "command.tab.closeOthers": "Затваряне на всички раздели освен този",
