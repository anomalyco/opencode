export const dict = {
  ...
  "command.session.handoff": "Предаване на сесията",
  "command.session.handoff.description": "Обобщете сесията и продължете работата в нова сесия",
  ...
  "toast.session.handoff.failed.title": "Неуспешно предаване на сесията",
  "toast.session.handoff.failed.description": "Тази сесия не можа да бъде обобщена за предаване",
