export const dict = {
  ...
  "session.agents.empty": "Няма активни подабгенти",
  "session.agents.costTotal": "Обща цена",
  "session.agents.costSubagents": "Подагенти",
  "session.agents.count": "Агенти",
  "session.agents.tokens": "токена",
  "session.agents.showAll": "Покажи всички ({{count}})",
  "session.agents.status.idle": "Неактивен",
  "session.agents.status.busy": "Изпълнява се",
  "session.agents.status.retry": "Повторен опит",
  "session.agents.status.cancelled": "Отменен",
  "session.agents.status.completed": "Завършен",
  "session.agents.status.error": "Неуспешен",
