export const dict = {
  ...
  "provider.custom.models.load": "Зареди динамично",
  "provider.custom.models.loading": "Зарежда се...",
  "provider.custom.models.load.invalidUrl": "Въведете валидна основа URL",
  "provider.custom.models.load.unauthorized": "Неоторизиран. Проверете API ключа",
  "provider.custom.models.load.invalidFormat": "Отговорът на сървъра не съдържаше валиден списък с модели",
  "provider.custom.models.load.timeout": "Изтече време при зареждане на модели",
  "provider.custom.models.load.failed": "Неуспешно зареждане на модели",
  "provider.custom.models.load.empty": "Не са намерени модели",
