export const dict = {
  ...
  "home.recentWorkspaces": "Espaços de trabalho recentes",
  ...
  "workspace.addFolder": "Adicionar pasta ao espaço de trabalho",
  "workspace.removeFolder": "Remover pasta do espaço de trabalho",
