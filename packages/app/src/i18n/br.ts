export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "Menu do OpenCode",
  "desktop.appMenu.file": "Arquivo",
  "desktop.appMenu.edit": "Editar",
  "desktop.appMenu.view": "Visualizar",
  "desktop.appMenu.go": "Ir",
  "desktop.appMenu.window": "Janela",
  "desktop.appMenu.help": "Ajuda",
  "desktop.appMenu.about": "Sobre o OpenCode",
  "desktop.appMenu.checkForUpdates": "Verificar atualizações...",
  "desktop.appMenu.settings": "Configurações",
  "desktop.appMenu.reloadWebview": "Recarregar visualização web",
  "desktop.appMenu.restart": "Reiniciar",
  "desktop.appMenu.exportLogs": "Exportar logs...",
  "desktop.appMenu.hide": "Ocultar OpenCode",
  "desktop.appMenu.hideOthers": "Ocultar outros",
  "desktop.appMenu.showAll": "Mostrar tudo",
  "desktop.appMenu.quit": "Sair do OpenCode",
  "desktop.appMenu.newSession": "Nova sessão",
  "desktop.appMenu.openProject": "Abrir projeto...",
  "desktop.appMenu.newWindow": "Nova janela",
  "desktop.appMenu.closeWindow": "Fechar janela",
  "desktop.appMenu.undo": "Desfazer",
  "desktop.appMenu.redo": "Refazer",
  "desktop.appMenu.cut": "Recortar",
  "desktop.appMenu.copy": "Copiar",
  "desktop.appMenu.paste": "Colar",
  "desktop.appMenu.delete": "Excluir",
  "desktop.appMenu.selectAll": "Selecionar tudo",
  "desktop.appMenu.toggleSidebar": "Alternar barra lateral",
  "desktop.appMenu.toggleTerminal": "Alternar terminal",
  "desktop.appMenu.toggleFileTree": "Alternar árvore de arquivos",
  "desktop.appMenu.reload": "Recarregar",
  "desktop.appMenu.toggleDeveloperTools": "Alternar ferramentas do desenvolvedor",
  "desktop.appMenu.actualSize": "Tamanho real",
  "desktop.appMenu.zoomIn": "Ampliar",
  "desktop.appMenu.zoomOut": "Reduzir",
  "desktop.appMenu.toggleFullScreen": "Alternar tela cheia",
  "desktop.appMenu.back": "Voltar",
  "desktop.appMenu.forward": "Avançar",
  "desktop.appMenu.previousSession": "Sessão anterior",
  "desktop.appMenu.nextSession": "Próxima sessão",
  "desktop.appMenu.previousProject": "Projeto anterior",
  "desktop.appMenu.nextProject": "Próximo projeto",
  "desktop.appMenu.minimize": "Minimizar",
  "desktop.appMenu.zoomWindow": "Zoom",
  "desktop.appMenu.maximize": "Maximizar",
  "desktop.appMenu.bringAllToFront": "Trazer Tudo para Frente",
  "desktop.appMenu.documentation": "Documentação do OpenCode",
  "desktop.appMenu.supportForum": "Fórum de suporte",
  "desktop.appMenu.shareFeedback": "Compartilhar feedback",
  "desktop.appMenu.reportBug": "Relatar um bug",
