export const dict = {
  ...
  "palette.group.files": "Correspondências de nomes de arquivo",
  "palette.group.content": "Correspondências de conteúdo de arquivos locais",
  "palette.group.chat": "Correspondências de conteúdo de chat",
  "palette.group.sessions": "Correspondências de nomes de sessão",
  "palette.group.files.count": "{{count}} resultados.",
  "palette.group.content.count": "{{count}} resultados em {{files}} arquivos.",
  "palette.group.chat.count": "{{count}} resultados em {{sessions}} sessões.",
