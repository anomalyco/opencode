export const dict = {
  ...
  "toast.file.uploadFailed.title": "Falha ao enviar arquivo",
  "toast.file.downloadFailed.title": "Falha ao baixar arquivo",
  "toast.file.deleteFailed.title": "Falha ao excluir arquivo",
  ...
  "session.files.uploadFile": "Enviar arquivo",
  "session.files.uploading": "Enviando…",
  "session.files.downloadFile": "Baixar",
  "session.files.refresh": "Atualizar",
  "session.files.dropFiles": "Solte os arquivos aqui ou clique em + para enviar",
  "session.files.deleteConfirm": "Excluir \"{{path}}\"?",
  "session.files.uploadTooLarge": "Arquivo muito grande (máx. {{size}})",
