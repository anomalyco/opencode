export const dict = {
  ...
  "session.tab.agents": "Subagentes",
  "session.agents.empty": "Nenhum subagente em execução",
  "session.agents.costTotal": "Custo total",
  "session.agents.costSubagents": "Subagentes",
  "session.agents.count": "Agentes",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Mostrar tudo ({{count}})",
  "session.agents.status.idle": "Ocioso",
  "session.agents.status.busy": "Executando",
  "session.agents.status.retry": "Tentando novamente",
  "session.agents.status.cancelled": "Cancelado",
  "session.agents.status.completed": "Concluído",
  "session.agents.status.error": "Falhou",
