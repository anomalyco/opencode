export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Pencode",
  ...
  "desktop.menu.ariaLabel": "Menu do Pencode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Pencode",
  "desktop.recovery.terminated": "A janela do Pencode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Pencode não está respondendo",
  ...
  "desktop.wsl.error.installPencode": "Falha na instalação do Pencode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.pencodeMissing": "O pencode não está instalado nesta distribuição",
  "desktop.wsl.error.pencodeCannotRun": "O pencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.pencodeNotInstalled": "O Pencode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Pencode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.pencode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.pencode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.pencodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Pencode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.pencodeZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.pencodeZen.visit.prefix": "Visite ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Pencode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em pencode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Pencode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingPencode": "Verificando o Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Verificando o Pencode em {{distro}}...",
  "wsl.onboarding.updatingPencode": "Atualizando o Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Atualizando o Pencode em {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Atualize o Pencode em {{distro}}.",
  "wsl.onboarding.updatePencode": "Atualizar o Pencode",
  "wsl.onboarding.pencodeReadyIn": "O Pencode está pronto em {{distro}}.",
  "wsl.onboarding.pencodeReady": "O Pencode está pronto.",
  "wsl.onboarding.installPencodeIn": "Instale o Pencode em {{distro}}.",
  "wsl.onboarding.installPencode": "Instalar o Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Pencode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Pencode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Pencode novamente.",
  ...
  "help.tabs.introduction": "Agora, o Pencode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Pencode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Pencode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (pencode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Pencode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Pencode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Pencode",
  ...
  "settings.general.row.appearance.description": "Personalize como o Pencode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Pencode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Pencode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Pencode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Pencode.",
