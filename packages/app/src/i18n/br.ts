export const dict = {
  ...
  "presets.manage": "Gerenciar predefinições",
  "presets.count": "{{count}} predefinições",
  "presets.empty": "Sem predefinições",
  "presets.empty.hint": "Clique em \"Adicionar\" para criar sua primeira predefinição",
  "presets.add": "Adicionar",
  "presets.name": "Nome",
  "presets.content": "Conteúdo",
  "presets.content.placeholder": "Conteúdo (suporta variáveis {date} {time} {file} {code} {text})",
  "presets.moveUp": "Mover para cima",
  "presets.moveDown": "Mover para baixo",
  "presets.edit": "Editar",
  "presets.delete": "Excluir",
  "presets.variables.title": "Insira variáveis para \"{{name}}\"",
  "presets.variables.next": "Próximo",
  "presets.variables.insert": "Inserir",
}
