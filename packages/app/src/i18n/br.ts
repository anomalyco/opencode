export const dict = {
  ...
  "command.context.addToChat": "Adicionar seleção ao chat",
  "command.context.addToChat.description": "Inserir linhas selecionadas na posição do cursor",
  "command.context.quickEdit": "Edição rápida da seleção",
  "command.context.quickEdit.description": "Editar o código selecionado em uma nova sessão",
  "selection.action.addToChat": "Adicionar ao chat",
  "selection.action.quickEdit": "Edição rápida",
  "selection.quickEdit.placeholder": "Editar código selecionado",
