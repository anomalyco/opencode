export const dict = {
  ...
  "command.project.index": "Mudar para projeto {{index}}",
  ...
  "wsl.onboarding.ready": "WSL está pronto.",
  "wsl.onboarding.required": "WSL é necessário para continuar.",
  ...
  "wsl.onboarding.finishingDistro": "Finalizando configuração do {{distro}}.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Verificando OpenCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando OpenCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando OpenCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualizar OpenCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar OpenCode",
  "wsl.onboarding.opencodeReadyIn": "OpenCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instalar OpenCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar OpenCode",
  "wsl.onboarding.chooseDistroFirst": "Escolha uma distribuição primeiro.",
  "wsl.onboarding.loadFailed": "Falha ao carregar estado do WSL.",
  ...
  "wsl.onboarding.distroStatus.missingTools": "Faltando bash, curl",
  ...
  "wsl.onboarding.needAnotherDistroHint": "Instale uma distribuição Linux do catálogo WSL",
  "wsl.onboarding.wslNotInstalled.title": "WSL não instalado",
  "wsl.onboarding.wslNotInstalled.description": "WSL (Subsistema Windows para Linux) é necessário antes do OpenCode adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "OpenCode não pôde verificar o WSL nesta máquina.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired": "Reinicie o Windows para concluir a instalação do WSL e reabra o OpenCode.",
  ...
  "wsl.onboarding.wsl2Required": "WSL 2 é necessário.",
  "wsl.onboarding.toolsRequired": "Esta distribuição precisa de bash e curl.",
  ...
  "home.sessions.empty": "Nada aqui ainda",
  ...
  "session.review.noUncommittedChanges": "Nenhuma alteração não commitada ainda",
  ...
  "settings.general.row.shell.description": "Escolha o shell usado para seu terminal. Shells compatíveis também são usados para chamadas de ferramentas do agente.",
  "settings.general.row.shell.autoDefault": "Auto (Padrão)",
  ...
  "settings.general.row.showTerminal.description": "Mostrar o botão de terminal na barra de título do desktop",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Colocar a barra de título e abas da sessão na parte inferior da tela em dispositivos móveis",
  "settings.general.row.showCustomAgents.title": "Agentes personalizados",
  "settings.general.row.showCustomAgents.description": "Mostrar o seletor de agente no compositor",
  "settings.general.row.newLayoutDesigns.title": "Novo layout e designs",
  "settings.general.row.newLayoutDesigns.description": "Habilitar o layout, início, compositor e interface de sessão redesenhados",
  "settings.general.row.pinchZoom.title": "Pinça para zoom",
  "settings.general.row.pinchZoom.description": "Permitir gestos de pinça no trackpad e Ctrl+scroll para aplicar zoom",
