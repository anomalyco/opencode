export const dict = {
  ...
  "command.session.handoff": "Transferir sessão",
  "command.session.handoff.description": "Compactar a sessão e continuar o trabalho em uma nova sessão",
  ...
  "toast.session.handoff.failed.title": "Falha ao transferir sessão",
  "toast.session.handoff.failed.description": "Não foi possível resumir esta sessão para transferência",
