export const dict = {
  ...
  "session.new.branch.search": "Buscar branches",
  "session.new.branch.checkout": "Trocar para",
  "session.new.branch.base": "Ramificar de",
  "session.new.branch.local": "Local",
  "session.new.branch.empty": "Nenhum branch",
  "session.new.branch.switchFailed": "Falha ao trocar de branch",
