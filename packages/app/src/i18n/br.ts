export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Argus",
  ...
  "desktop.menu.ariaLabel": "Menu do Argus",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Argus",
  "desktop.recovery.terminated": "A janela do Argus foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Argus não está respondendo",
  ...
  "desktop.wsl.error.installArgus": "Falha na instalação do Argus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.argusMissing": "O argus não está instalado nesta distribuição",
  "desktop.wsl.error.argusCannotRun": "O argus está instalado, mas não pôde ser executado",
  "desktop.wsl.error.argusNotInstalled": "O Argus não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Argus foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "wsl.onboarding.checkingArgus": "Verificando o Argus...",
  "wsl.onboarding.checkingArgusIn": "Verificando o Argus em {{distro}}...",
  "wsl.onboarding.updatingArgus": "Atualizando o Argus...",
  "wsl.onboarding.updatingArgusIn": "Atualizando o Argus em {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Atualize o Argus em {{distro}}.",
  "wsl.onboarding.updateArgus": "Atualizar o Argus",
  "wsl.onboarding.argusReadyIn": "O Argus está pronto em {{distro}}.",
  "wsl.onboarding.argusReady": "O Argus está pronto.",
  "wsl.onboarding.installArgusIn": "Instale o Argus em {{distro}}.",
  "wsl.onboarding.installArgus": "Instalar o Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Argus possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Argus não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Argus novamente.",
  ...
  "help.tabs.introduction": "Agora, o Argus Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "settings.general.row.colorScheme.description": "Escolha se o Argus segue o tema do sistema, claro ou escuro",
