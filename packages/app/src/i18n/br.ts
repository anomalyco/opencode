export const dict = {
  ...
  "settings.general.row.sendKey.title": "Tecla de envio",
  "settings.general.row.sendKey.description": "Escolha qual tecla envia mensagens. A outra tecla Enter insere uma nova linha.",
