export const dict = {
  ...
  "settings.general.row.reducedMotion.title": "Reduzir movimento",
  "settings.general.row.reducedMotion.description": "Desative a maioria das animações da interface.",
