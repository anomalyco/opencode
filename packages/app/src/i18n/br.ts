export const dict = {
  ...
  "command.todo.toggle": "Alternar painel de todo",
  ...
  "sidebar.issue.title": "Tarefas",
  "sidebar.issue.add": "Adicionar tarefa",
  "sidebar.issue.addSubtodo": "Adicionar subtarefa",
  "sidebar.issue.empty": "Sem tarefas",
  "sidebar.issue.collapse": "Recolher subtarefas",
  "sidebar.issue.expand": "Expandir subtarefas",
  "sidebar.issue.confirmDeleteWithChildren": "Excluir esta tarefa e suas {{count}} subtarefas?",
  "sidebar.issue.toast.deleteFailed": "Falha ao excluir tarefa",
  "sidebar.issue.tooltip.cycleStatus": "Alternar status",
  "sidebar.issue.tooltip.cyclePriority": "Alternar prioridade",
  "sidebar.issue.tooltip.linkedLinear": "Vinculado ao Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Conectado",
  "sidebar.linear.management": "Gerenciar vinculação do Linear",
  "sidebar.linear.management.teamRequired": "Selecione uma equipe",
  "sidebar.linear.management.projectRequired": "Selecione um projeto",
  "sidebar.linear.management.saveFailed": "Falha ao salvar vinculação do Linear",
  "sidebar.linear.management.saved": "Vinculação do Linear salva",
  "sidebar.linear.management.save": "Salvar",
  "sidebar.linear.toggleHistory": "Alternar histórico de sincronização",
  "sidebar.linear.field.team": "Equipe",
  "sidebar.linear.field.team.loading": "Carregando equipes...",
  "sidebar.linear.field.team.placeholder": "Selecionar uma equipe",
  "sidebar.linear.field.project": "Projeto",
  "sidebar.linear.field.project.selectTeamFirst": "Selecione uma equipe primeiro",
  "sidebar.linear.field.project.loading": "Carregando projetos...",
  "sidebar.linear.field.project.placeholder": "Selecionar um projeto",
  "sidebar.linear.notConfigured": "Linear não configurado",
  "sidebar.linear.notConfiguredHint": "Abra o gerenciamento para selecionar equipe e projeto",
  "sidebar.linear.actions": "Ações de sincronização",
  "sidebar.linear.push": "Enviar",
  "sidebar.linear.pull": "Baixar",
  "sidebar.linear.pullHint": "Puxar do Linear. Nota: alterações de hierarquia feitas no Linear (reparentamento, remoção de pai) não são sincronizadas localmente — apenas os valores dos campos são reconciliados.",
  "sidebar.linear.pullFailed": "Falha ao baixar do Linear",
  "sidebar.linear.pullPartialFailed": "Baixamento parcialmente falhou: {{count}} erro(s)",
  "sidebar.linear.pullSuccess": "Puxado {{pulled}}, atualizado {{updated}}, ignorado {{skipped}}, excluído {{deleted}}",
  "sidebar.linear.pushFailed": "Falha ao enviar para Linear",
  "sidebar.linear.pushPartialFailed": "Envio parcialmente falhou: {{count}} erro(s)",
  "sidebar.linear.pushSuccess": "{{count}} tarefa(s) enviada(s) para Linear",
  "sidebar.linear.pushNothing": "Nada para enviar",
  "sidebar.linear.syncHistory.syncing": "Sincronizando...",
  "sidebar.linear.syncHistory.error": "Erro",
  "sidebar.linear.syncHistory.empty": "Sem histórico de sincronização",
  "dialog.todo.title.create": "Nova tarefa",
  "dialog.todo.title.edit": "Editar tarefa",
  "dialog.todo.field.title": "Título",
  "dialog.todo.field.title.placeholder": "Título da tarefa",
  "dialog.todo.field.description": "Descrição",
  "dialog.todo.field.description.placeholder": "Adicione detalhes, links ou contexto...",
  "dialog.todo.field.description.hint": "Suporta referências de arquivos e habilidades",
  "dialog.todo.field.status": "Status",
  "dialog.todo.field.priority": "Prioridade",
  "dialog.todo.field.dueDate": "Data de vencimento",
  "dialog.todo.field.dueDate.placeholder": "Definir data de vencimento",
  "dialog.todo.field.dueDate.clear": "Limpar",
  "dialog.todo.field.dueDate.prevMonth": "Mês anterior",
  "dialog.todo.field.dueDate.nextMonth": "Próximo mês",
  "dialog.todo.field.dueDate.shortcut.today": "Hoje",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Amanhã",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Em uma semana",
  ...
  "dialog.todo.field.labels": "Rótulos",
  "dialog.todo.field.assignee": "Responsável",
  "dialog.todo.field.assignee.unassigned": "Não atribuído",
  "dialog.todo.field.assignee.loadFailed": "Falha ao carregar responsáveis",
  "dialog.todo.field.assignee.loading": "Carregando responsáveis...",
  "dialog.todo.field.assignee.placeholder": "Selecionar responsável",
  "dialog.todo.field.assignee.hint": "Originado dos membros da equipe Linear",
  "dialog.todo.linkedLinear": "Vinculado ao Linear",
  "dialog.todo.created": "Tarefa criada",
  "dialog.todo.updated": "Tarefa atualizada",
  "dialog.todo.error.titleRequired": "O título é obrigatório",
  "dialog.todo.error.saveFailed": "Falha ao salvar tarefa",
  "dialog.todo.action.create": "Criar",
  ...
  "sidebar.issue.priority.none": "Nenhum",
  "sidebar.issue.priority.urgent": "Urgente",
  "sidebar.issue.priority.high": "Alto",
  "sidebar.issue.priority.medium": "Médio",
  "sidebar.issue.priority.low": "Baixo",
  "sidebar.issue.toast.archiveFailed": "Falha ao arquivar a tarefa",
  "sidebar.issue.toast.reorderFailed": "Falha ao reordenar a tarefa",
  "sidebar.issue.toast.reparentFailed": "Falha ao mover a tarefa",
  "sidebar.issue.tooltip.archive": "Arquivar esta tarefa",
  "sidebar.issue.tooltip.delete": "Excluir esta tarefa",
  "sidebar.issue.confirmArchive": "Arquivar",
  "sidebar.issue.archivedBadge": "Arquivada",
  "sidebar.issue.archiveArea.title": "Arquivadas",
  "sidebar.issue.archiveArea.expand": "Mostrar arquivadas",
  "sidebar.issue.archiveArea.collapse": "Ocultar arquivadas",
  "sidebar.issue.archiveArea.empty": "Nenhuma tarefa arquivada",
}
