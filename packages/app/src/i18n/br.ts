export const dict = {
  ...
  "home.activity.title": "Atividade de tokens",
  "home.activity.daily": "Diário",
  "home.activity.weekly": "Semanal",
  "home.activity.cumulative": "Acumulativo",
  "home.activity.loading": "Carregando atividade",
  "home.activity.empty": "Nenhuma atividade de tokens ainda",
  "home.activity.lifetimeTokens": "Total de tokens",
  "home.activity.peakTokens": "Pico de tokens",
  "home.activity.longestTask": "Tarefa mais longa",
  "home.activity.currentStreak": "Sequência atual",
  "home.activity.longestStreak": "Maior sequência",
  "home.activity.days.one": "{{count}} dia",
  "home.activity.days.other": "{{count}} dias",
  "home.activity.summary":
    "{{tokens}} tokens no total, {{peak}} pico de tokens, {{current}} sequência atual, {{longest}} maior sequência.",
