export const dict = {
  ...
  "session.review.context.openDefault": "Aplicativo padrão",
  "session.review.context.copyRelative": "Copiar caminho relativo",
  "session.review.context.copyAbsolute": "Copiar caminho absoluto",
