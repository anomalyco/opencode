export const dict = {
  ...
  "status.button.tooltip": "Ver status do sistema",
  ...
  "status.servers.empty": "Nenhum servidor configurado",
  "status.servers.manage": "Gerenciar servidores",
  "status.mcp.empty": "Nenhum servidor MCP configurado",
  "status.lsp.empty": "Nenhum servidor LSP ativo",
  "status.plugins.empty": "Plugins configurados em 'opencode.json'",
  "status.noProject": "Abra um projeto para visualizar",
