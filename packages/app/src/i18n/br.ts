export const dict = {
  ...
  "command.tab.closeAll": "Fechar todas as abas",
  "command.tab.closeRight": "Fechar todas as abas à direita",
  "command.tab.closeOthers": "Fechar todas as abas exceto esta",
