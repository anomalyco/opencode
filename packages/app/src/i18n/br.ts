export const dict = {
  ...
  "provider.custom.models.load": "Carregar dinamicamente",
  "provider.custom.models.loading": "Carregando...",
  "provider.custom.models.load.invalidUrl": "Insira uma URL base válida",
  "provider.custom.models.load.unauthorized": "Não autorizado. Verifique a chave de API",
  "provider.custom.models.load.invalidFormat": "A resposta do servidor não continha uma lista de modelos válida",
  "provider.custom.models.load.timeout": "Tempo esgotado ao carregar os modelos",
  "provider.custom.models.load.failed": "Falha ao carregar os modelos",
  "provider.custom.models.load.empty": "Nenhum modelo encontrado",
