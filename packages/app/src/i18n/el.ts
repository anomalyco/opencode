export const dict = {
  ...
  "command.session.handoff": "Μεταβίβαση συνεδρίας",
  "command.session.handoff.description": "Συνοψίστε τη συνεδρία και συνεχίστε την εργασία σε νέα συνεδρία",
  ...
  "toast.session.handoff.failed.title": "Αποτυχία μεταβίβασης συνεδρίας",
  "toast.session.handoff.failed.description": "Δεν ήταν δυνατή η σύνοψη αυτής της συνεδρίας για μεταβίβαση",
