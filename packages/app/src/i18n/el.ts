export const dict = {
  ...
  "home.recentlyClosed.options": "Φίλτρο και ταξινόμηση",
  "home.recentlyClosed.filter.label": "Φίλτρο",
  "home.recentlyClosed.filter.recent": "Πρόσφατα",
  "home.recentlyClosed.filter.archived": "Αρχειοθετημένα",
  "home.recentlyClosed.filter.hidden": "Κρυφά",
  "home.recentlyClosed.filter.all": "Όλα",
  "home.recentlyClosed.filter.empty": "Κανένα έργο δεν ταιριάζει με αυτό το φίλτρο",
  "home.recentlyClosed.sort.label": "Ταξινόμηση",
  "home.recentlyClosed.sort.recent": "Πιο πρόσφατα πρώτα",
  "home.recentlyClosed.sort.oldest": "Παλαιότερα πρώτα",
  "home.recentlyClosed.sort.nameAsc": "Όνομα Α–Ω",
  "home.recentlyClosed.sort.nameDesc": "Όνομα Ω–Α",
  "home.recentlyClosed.search.placeholder": "Αναζήτηση στα πρόσφατα κλειστά",
  "home.recentlyClosed.showMore": "Εμφάνιση όλων ({{count}})",
  "home.recentlyClosed.showLess": "Εμφάνιση λιγότερων",
  "home.recentlyClosed.select": "Επιλογή…",
  "home.recentlyClosed.selectAll": "Επιλογή όλων",
  "home.recentlyClosed.deselectAll": "Αποεπιλογή όλων",
  "home.recentlyClosed.cancelSelection": "Ακύρωση επιλογής",
  "home.recentlyClosed.selected": "{{count}} επιλεγμένα",
  "home.recentlyClosed.noResults": "Κανένα έργο δεν ταιριάζει με «{{query}}»",
  "home.recentlyClosed.archived.badge": "Αρχειοθετημένο",
  "home.recentlyClosed.hidden.badge": "Κρυφό",
  "home.recentlyClosed.action.reopen": "Άνοιγμα ξανά",
  "home.recentlyClosed.action.unarchive": "Επαναφορά από το αρχείο",
  "home.recentlyClosed.action.hide": "Απόκρυψη",
  "home.recentlyClosed.action.unhide": "Εμφάνιση",
  "home.recentlyClosed.action.remove": "Ξέχασέ το",
  "home.recentlyClosed.remove.title": "Να ξεχαστεί το έργο;",
  "home.recentlyClosed.remove.titleMany": "Να ξεχαστούν {{count}} έργα;",
  "home.recentlyClosed.remove.confirm": "Αφαίρεση του «{{name}}» από τα πρόσφατα κλειστά; Αυτό καθαρίζει μόνο το ιστορικό και δεν διαγράφει ποτέ αρχεία.",
  "home.recentlyClosed.remove.confirmMany": "Αφαίρεση {{count}} έργων από τα πρόσφατα κλειστά; Αυτό καθαρίζει μόνο το ιστορικό και δεν διαγράφει ποτέ αρχεία.",
  "home.recentlyClosed.toast.archived": "Αρχειοθετήθηκε",
  "home.recentlyClosed.toast.hidden": "Αποκρύφθηκε",
  "home.recentlyClosed.toast.removed": "Αφαιρέθηκε από τα πρόσφατα κλειστά",
  "home.recentlyClosed.toast.undo": "Αναίρεση",
