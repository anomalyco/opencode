export const dict = {
  ...
  "mcp.status.needs_client_registration": "απαιτείται καταχώρηση πελάτη",
  "mcp.status.pending": "σύνδεση…",
  ...
  "settings.mcp.type.local": "Τοπικός",
  "settings.mcp.type.remote": "Απομακρυσμένος",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Αφήστε κενό για παράλειψη — ενδέχεται να απαιτηται εκ νέου πιστοποίηση",
