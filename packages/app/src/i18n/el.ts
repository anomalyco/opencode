export const dict = {
  ...
  "command.tab.closeAll": "Κλείσιμο όλων των καρτελών",
  "command.tab.closeRight": "Κλείσιμο όλων των καρτελών στα δεξιά",
  "command.tab.closeOthers": "Κλείσιμο όλων των καρτελών εκτός από αυτήν",
