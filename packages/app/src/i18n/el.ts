export const dict = {
  ...
  "session.tab.agents": "Υπο-πράκτορες",
  "session.agents.empty": "Κανένας υπο-πράκτορας σε εκτέλεση",
  "session.agents.costTotal": "Συνολικό κόστος",
  "session.agents.costSubagents": "Υπο-πράκτορες",
  "session.agents.count": "Πράκτορες",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Εμφάνιση όλων ({{count}})",
  "session.agents.status.idle": "Αδρανής",
  "session.agents.status.busy": "Εκτελείται",
  "session.agents.status.retry": "Επανάληψη",
  "session.agents.status.cancelled": "Ακυρώθηκε",
  "session.agents.status.completed": "Ολοκληρώθηκε",
  "session.agents.status.error": "Απέτυχε",
