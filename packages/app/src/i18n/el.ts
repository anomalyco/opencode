export const dict = {
  ...
  "provider.custom.models.load": "Δυναμική φόρτωση",
  "provider.custom.models.loading": "Φόρτωση...",
  "provider.custom.models.load.invalidUrl": "Εισαγάγετε έγκυρη Βάση URL",
  "provider.custom.models.load.unauthorized": "Μη εξουσιοδοτημένο. Ελέγξτε το κλειδί API",
  "provider.custom.models.load.invalidFormat": "Η απόκριση του διακομιστή δεν περιείχε έγκυρη λίστα μοντέλων",
  "provider.custom.models.load.timeout": "Λήξη χρόνου κατά τη φόρτωση μοντέλων",
  "provider.custom.models.load.failed": "Αποτυχία φόρτωσης μοντέλων",
  "provider.custom.models.load.empty": "Δεν βρέθηκαν μοντέλα",
