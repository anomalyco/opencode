export const dict = {
  ...
  "settings.tab.plugins": "Πρόσθετα",
  "settings.plugins.section.browse": "Περιήγηση",
  "settings.plugins.section.installed": "Εγκατεστημένα",
  ...
  "settings.mcp.add": "Προσθήκη διακομιστή",
  "settings.mcp.empty": "Δεν έχουν ρυθμιστεί διακομιστές MCP.",
  "settings.mcp.deleted": "Διαγράφηκε ο {{name}}.",
  "settings.mcp.errors.refresh": "Αδύνατη η φόρτωση διακομιστών MCP.",
  "settings.mcp.status.pending": "σύνδεση…",
  "settings.mcp.action.connect": "Σύνδεση",
  "settings.mcp.action.disconnect": "Αποσύνδεση",
  "settings.mcp.action.authenticate": "Πιστοποίηση",
  "settings.mcp.action.edit": "Επεξεργασία",
  "settings.mcp.action.delete": "Διαγραφή",
  "settings.mcp.delete.title": "Διαγραφή διακομιστή MCP",
  "settings.mcp.delete.body": "Να αφαιρεθεί το {{name}}; Η ενέργεια είναι μη αναστρέψιμη.",
  "settings.mcp.form.title.add": "Προσθήκη διακομιστή MCP",
  "settings.mcp.form.title.edit": "Επεξεργασία διακομιστή MCP",
  "settings.mcp.form.subtitle": "Ρυθμίστε τις παραμέτρους σύνδεσης.",
  "settings.mcp.form.name": "Όνομα",
  "settings.mcp.form.command": "Εντολή",
  "settings.mcp.form.command.hint": "π.χ. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Κατάλογος εργασίας",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Μεταβλητές περιβάλλοντος",
  "settings.mcp.form.headers": "Κεφαλίδες",
  "settings.mcp.form.addRow": "Προσθήκη γραμμής",
  "settings.mcp.form.removeRow": "Αφαίρεση",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID πελάτη",
  "settings.mcp.form.oauth.clientSecret": "Μυστικό πελάτη",
  "settings.mcp.form.oauth.clientSecret.keep": "Ρυθμισμένο — αφήστε κενό για διατήρηση",
  "settings.mcp.form.oauth.scope": "Εύρος",
  "settings.mcp.form.oauth.callbackPort": "Θύρα επιστροφής κλήσης",
  "settings.mcp.form.oauth.disableAutodetect": "Απενεργοποίηση αυτόματης ανίχνευσης OAuth",
  "settings.mcp.form.enabled": "Ενεργοποιημένο",
  "settings.mcp.form.timeout": "Χρονικό όριο (ms)",
  "settings.mcp.form.save": "Αποθήκευση",
  "settings.mcp.form.cancel": "Ακύρωση",
  "settings.mcp.form.error.name": "Εισάγετε όνομα.",
  "settings.mcp.form.error.command": "Εισάγετε εντολή.",
  "settings.mcp.form.error.url": "Εισάγετε URL.",
  "settings.mcp.form.error.callbackPort": "Η θύρα callback πρέπει να είναι 1-65535.",
  "settings.mcp.form.error.timeout": "Το χρονικό όριο πρέπει να είναι θετικός ακέραιος.",
  "settings.mcp.errors.invalid": "Διορθώστε τα επισημασμένα πεδία.",
  "settings.mcp.errors.duplicate": "Υπάρχει ήδη διακομιστής με αυτό το όνομα.",
  "settings.mcp.errors.noConfig": "Δεν είναι δυνατή η ανάγνωση της διαμόρφωσης του {{name}} — μπορεί να ορίζεται εκτός έργου.",
  "settings.mcp.edit.warn": "Η αποθήκευση επανασυνδέει τον διακομιστή.",
  ...
  "settings.plugins.detail.copied": "Αντιγράφηκε",
  "settings.plugins.detail.notOnNpm": "Δεν βρέθηκε στο npm — προσθέστε το χειροκίνητα στο opencode.json",
  "settings.plugins.install.title": "Εγκατάσταση πρόσθετου",
  "settings.plugins.install.description": "Πού θα προστεθεί το {{name}};",
  "settings.plugins.install.global": "Καθολικά (~/.config/opencode)",
  "settings.plugins.install.project": "Αυτό το έργο",
  "settings.plugins.install.cancel": "Ακύρωση",
  "settings.plugins.install.success": "Το {{name}} εγκαταστάθηκε. Επανεκκινήστε το OpenCode για να φορτώσει.",
  "settings.plugins.installed.empty": "Δεν υπάρχουν εγκατεστημένα πρόσθετα.",
  "settings.plugins.installed.provenance.global": "Καθολικά",
  "settings.plugins.installed.provenance.project": "Έργο",
  ...
  "settings.plugins.errors.catalog": "Δεν ήταν δυνατή η ανανέωση του καταλόγου πρόσθετων.",
  "settings.plugins.stale": "Εμφανίζεται καταλόγος από την προσωρινή μνήμη ({{age}} πριν).",
