...
export const dict = {
  ...
  "prompt.action.startVoice": "Spracheingabe starten",
  "prompt.action.stopVoice": "Aufnahme beenden",
  "prompt.action.voiceNotSupported": "Spracherkennung wird nicht unterstützt",
