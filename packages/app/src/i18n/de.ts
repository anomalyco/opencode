...
export const dict = {
  ...
  "session.review.context.openDefault": "Standard-App",
  "session.review.context.copyRelative": "Relativen Pfad kopieren",
  "session.review.context.copyAbsolute": "Absoluten Pfad kopieren",
