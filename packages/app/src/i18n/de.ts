...
export const dict = {
  ...
  "toast.file.uploadFailed.title": "Datei konnte nicht hochgeladen werden",
  "toast.file.downloadFailed.title": "Datei konnte nicht heruntergeladen werden",
  "toast.file.deleteFailed.title": "Datei konnte nicht gelöscht werden",
  ...
  "session.files.uploadFile": "Datei hochladen",
  "session.files.uploading": "Wird hochgeladen…",
  "session.files.downloadFile": "Herunterladen",
  "session.files.refresh": "Aktualisieren",
  "session.files.dropFiles": "Dateien hierher ziehen oder auf + klicken zum Hochladen",
  "session.files.deleteConfirm": "\"{{path}}\" löschen?",
  "session.files.uploadTooLarge": "Datei ist zu groß (max. {{size}})",
  "dialog.provider.custom.label": "Benutzerdefinierter OpenAI-kompatibler Anbieter",
  "dialog.model.unpaid.viewMoreProviders": "70+ weitere Anbieter ansehen",
  "session.header.reveal.finder": "In Finder anzeigen",
