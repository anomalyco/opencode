...
export const dict = {
  ...
  "dialog.plugins.empty": "In leak-code.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (leak-code.json)",
