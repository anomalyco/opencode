...
export const dict = {
  ...
  "command.todo.toggle": "Todo-Panel umschalten",
  ...
  "sidebar.issue.title": "Aufgaben",
  "sidebar.issue.add": "Aufgabe hinzufügen",
  "sidebar.issue.addSubtodo": "Unteraufgabe hinzufügen",
  "sidebar.issue.empty": "Noch keine Aufgaben",
  "sidebar.issue.collapse": "Unteraufgaben einklappen",
  "sidebar.issue.expand": "Unteraufgaben ausklappen",
  "sidebar.issue.confirmDeleteWithChildren": "Diese Aufgabe und ihre {{count}} Unteraufgaben löschen?",
  "sidebar.issue.toast.deleteFailed": "Aufgabe konnte nicht gelöscht werden",
  "sidebar.issue.tooltip.cycleStatus": "Status wechseln",
  "sidebar.issue.tooltip.cyclePriority": "Priorität wechseln",
  "sidebar.issue.tooltip.linkedLinear": "Mit Linear verknüpft",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Verbunden",
  "sidebar.linear.management": "Linear-Verbindung verwalten",
  "sidebar.linear.management.teamRequired": "Bitte ein Team auswählen",
  "sidebar.linear.management.projectRequired": "Bitte ein Projekt auswählen",
  "sidebar.linear.management.saveFailed": "Linear-Verbindung konnte nicht gespeichert werden",
  "sidebar.linear.management.saved": "Linear-Verbindung gespeichert",
  "sidebar.linear.management.save": "Speichern",
  "sidebar.linear.toggleHistory": "Sync-Verlauf umschalten",
  "sidebar.linear.field.team": "Team",
  "sidebar.linear.field.team.loading": "Teams werden geladen...",
  "sidebar.linear.field.team.placeholder": "Team auswählen",
  "sidebar.linear.field.project": "Projekt",
  "sidebar.linear.field.project.selectTeamFirst": "Zuerst ein Team auswählen",
  "sidebar.linear.field.project.loading": "Projekte werden geladen...",
  "sidebar.linear.field.project.placeholder": "Projekt auswählen",
  "sidebar.linear.notConfigured": "Linear nicht konfiguriert",
  "sidebar.linear.notConfiguredHint": "Verwaltung öffnen, um Team und Projekt auszuwählen",
  ...
  "sidebar.linear.pullSuccess":
    "Abgerufen {{pulled}}, aktualisiert {{updated}}, übersprungen {{skipped}}, gelöscht {{deleted}}",
  "sidebar.linear.pushFailed": "Push zu Linear fehlgeschlagen",
  "sidebar.linear.pushPartialFailed": "Push teilweise fehlgeschlagen: {{count}} Fehler",
  "sidebar.linear.pushSuccess": "{{count}} Aufgabe(n) an Linear gepusht",
  "sidebar.linear.pushNothing": "Nichts zu pushen",
  "sidebar.linear.syncHistory.syncing": "Synchronisiere...",
  "sidebar.linear.syncHistory.error": "Fehler",
  "sidebar.linear.syncHistory.empty": "Kein Synchronisierungsverlauf",
  "dialog.todo.title.create": "Neue Aufgabe",
  "dialog.todo.title.edit": "Aufgabe bearbeiten",
  "dialog.todo.field.title": "Titel",
  "dialog.todo.field.title.placeholder": "Aufgabentitel",
  "dialog.todo.field.description": "Beschreibung",
  "dialog.todo.field.description.placeholder": "Details, Links oder Kontext hinzufügen...",
  "dialog.todo.field.description.hint": "Unterstützt Datei- und Skill-Referenzen",
  "dialog.todo.field.status": "Status",
  "dialog.todo.field.priority": "Priorität",
  "dialog.todo.field.dueDate": "Fälligkeitsdatum",
  "dialog.todo.field.dueDate.placeholder": "Fälligkeitsdatum festlegen",
  "dialog.todo.field.dueDate.clear": "Löschen",
  "dialog.todo.field.dueDate.prevMonth": "Vorheriger Monat",
  "dialog.todo.field.dueDate.nextMonth": "Nächster Monat",
  "dialog.todo.field.dueDate.shortcut.today": "Heute",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Morgen",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "In einer Woche",
  ...
  "dialog.todo.field.assignee": "Zuständig",
  "dialog.todo.field.assignee.unassigned": "Nicht zugewiesen",
  "dialog.todo.field.assignee.loadFailed": "Zuständige konnten nicht geladen werden",
  "dialog.todo.field.assignee.loading": "Zuständige werden geladen...",
  "dialog.todo.field.assignee.placeholder": "Zuständigen auswählen",
  "dialog.todo.field.assignee.hint": "Aus Linear-Teammitgliedern",
  "dialog.todo.linkedLinear": "Mit Linear verknüpft",
  "dialog.todo.created": "Aufgabe erstellt",
  "dialog.todo.updated": "Aufgabe aktualisiert",
  "dialog.todo.error.titleRequired": "Titel ist erforderlich",
  "dialog.todo.error.saveFailed": "Aufgabe konnte nicht gespeichert werden",
  "dialog.todo.action.create": "Erstellen",
  ...
  "sidebar.issue.priority.none": "Keine",
  "sidebar.issue.priority.urgent": "Dringend",
  "sidebar.issue.priority.high": "Hoch",
  "sidebar.issue.priority.medium": "Mittel",
  ...
  "sidebar.issue.archivedBadge": "Archiviert",
  "sidebar.issue.archiveArea.title": "Archiviert",
  "sidebar.issue.archiveArea.expand": "Archivierte anzeigen",
  "sidebar.issue.archiveArea.collapse": "Archivierte ausblenden",
  "sidebar.issue.archiveArea.empty": "Keine archivierten Aufgaben",
