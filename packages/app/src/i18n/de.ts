...
export const dict = {
  ...
  "session.new.branch.search": "Branches durchsuchen",
  "session.new.branch.checkout": "Wechseln zu",
  "session.new.branch.base": "Abzweigen von",
  "session.new.branch.local": "Lokal",
  "session.new.branch.empty": "Keine Branches",
  "session.new.branch.switchFailed": "Branch konnte nicht gewechselt werden",
