...
export const dict = {
  ...
  "presets.manage": "Voreinstellungen verwalten",
  "presets.count": "{{count}} Voreinstellungen",
  "presets.empty": "Keine Voreinstellungen",
  "presets.empty.hint": "Klicken Sie auf \"Hinzufügen\", um Ihre erste Voreinstellung zu erstellen",
  "presets.add": "Hinzufügen",
  "presets.name": "Name",
  "presets.content": "Inhalt",
  "presets.content.placeholder": "Inhalt (unterstützt {date} {time} {file} {code} {text} Variablen)",
  "presets.moveUp": "Nach oben",
  "presets.moveDown": "Nach unten",
  "presets.edit": "Bearbeiten",
  "presets.delete": "Löschen",
  "presets.variables.title": "Variablen für \"{{name}}\" eingeben",
  "presets.variables.next": "Weiter",
  "presets.variables.insert": "Einfügen",
