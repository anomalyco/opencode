...
export const dict = {
  ...
  "prompt.action.expand": "Editor erweitern",
  ...
  "error.page.action.restartFrontend": "Frontend neu starten",
  "error.page.action.restartBackend": "Backend neu starten",
  "error.page.action.restartApp": "App neu starten",
