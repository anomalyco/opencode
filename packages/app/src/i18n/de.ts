...
export const dict = {
  ...
  "settings.general.row.reducedMotion.title": "Bewegung reduzieren",
  "settings.general.row.reducedMotion.description": "Die meisten Oberflächenanimationen deaktivieren.",
