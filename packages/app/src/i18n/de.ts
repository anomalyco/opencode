...
export const dict = {
  ...
  "dialog.provider.pencode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.pencode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.pencodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Pencode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Pencode zu nutzen.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Pencode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Pencode zu nutzen.",
  ...
  "dialog.plugins.empty": "In pencode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Pencode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode wird geprüft…",
  "wsl.onboarding.checkingPencodeIn": "Pencode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingPencode": "Pencode wird aktualisiert…",
  "wsl.onboarding.updatingPencodeIn": "Pencode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updatePencodeIn": "Aktualisieren Sie Pencode in {{distro}}.",
  "wsl.onboarding.updatePencode": "Pencode aktualisieren",
  "wsl.onboarding.pencodeReadyIn": "Pencode ist in {{distro}} bereit.",
  "wsl.onboarding.pencodeReady": "Pencode ist bereit.",
  "wsl.onboarding.installPencodeIn": "Installieren Sie Pencode in {{distro}}.",
  "wsl.onboarding.installPencode": "Pencode installieren",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Pencode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Pencode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Pencode erneut.",
  ...
  "toast.update.description": "Eine neue Version von Pencode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Pencode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (pencode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Pencode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Pencode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Pencode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Pencode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Pencode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Pencode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Pencode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Pencode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Pencode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Pencode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Pencode wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "Pencode-Menü",
  ...
  "desktop.recovery.loadFailed": "Pencode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Pencode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Pencode reagiert nicht",
  ...
  "desktop.wsl.error.installPencode": "Pencode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.pencodeMissing": "pencode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.pencodeCannotRun": "pencode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Pencode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Pencode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
