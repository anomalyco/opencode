...
export const dict = {
  ...
  "palette.group.files": "Dateinamen-Treffer",
  "palette.group.content": "Lokale Dateiinhalts-Treffer",
  "palette.group.chat": "Chat-Inhalts-Treffer",
  "palette.group.sessions": "Sitzungsnamen-Treffer",
  "palette.group.files.count": "{{count}} Ergebnisse.",
  "palette.group.content.count": "{{count}} Ergebnisse in {{files}} Dateien.",
  "palette.group.chat.count": "{{count}} Ergebnisse in {{sessions}} Sitzungen.",
  "palette.group.sessions.count": "{{count}} Ergebnisse.",
