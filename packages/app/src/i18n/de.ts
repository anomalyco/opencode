...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Argus zu nutzen.",
  ...
  "wsl.onboarding.checkingArgus": "Argus wird geprüft…",
  "wsl.onboarding.checkingArgusIn": "Argus in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingArgus": "Argus wird aktualisiert…",
  "wsl.onboarding.updatingArgusIn": "Argus in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateArgusIn": "Aktualisieren Sie Argus in {{distro}}.",
  "wsl.onboarding.updateArgus": "Argus aktualisieren",
  "wsl.onboarding.argusReadyIn": "Argus ist in {{distro}} bereit.",
  "wsl.onboarding.argusReady": "Argus ist bereit.",
  "wsl.onboarding.installArgusIn": "Installieren Sie Argus in {{distro}}.",
  "wsl.onboarding.installArgus": "Argus installieren",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Argus einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Argus konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Argus erneut.",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (argus.json)",
  ...
  "home.providerTip":
    "Argus mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Argus dem System-, hellen oder dunklen Thema folgt",
  ...
  "settings.updates.toast.latest.title": "Argus ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Argus wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "Argus-Menü",
  ...
  "desktop.recovery.loadFailed": "Argus konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Argus-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Argus reagiert nicht",
  ...
  "desktop.wsl.error.installArgus": "Argus-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.argusMissing": "argus ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.argusCannotRun": "argus ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.argusNotInstalled": "Argus ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Argus-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Argus Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
