...
export const dict = {
  ...
  "dialog.model.group.recent": "Zuletzt verwendet",
  "dialog.model.favorite.add": "Modell zu Favoriten hinzufügen",
  "dialog.model.favorite.remove": "Modell aus Favoriten entfernen",
