...
export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode-Menü",
  "desktop.appMenu.file": "Datei",
  "desktop.appMenu.edit": "Bearbeiten",
  "desktop.appMenu.view": "Ansicht",
  "desktop.appMenu.go": "Gehe zu",
  "desktop.appMenu.window": "Fenster",
  "desktop.appMenu.help": "Hilfe",
  "desktop.appMenu.about": "Über OpenCode",
  "desktop.appMenu.checkForUpdates": "Nach Updates suchen...",
  "desktop.appMenu.settings": "Einstellungen",
  "desktop.appMenu.reloadWebview": "Webview neu laden",
  "desktop.appMenu.restart": "Neu starten",
  "desktop.appMenu.exportLogs": "Protokolle exportieren...",
  "desktop.appMenu.hide": "OpenCode ausblenden",
  "desktop.appMenu.hideOthers": "Andere ausblenden",
  "desktop.appMenu.showAll": "Alle einblenden",
  "desktop.appMenu.quit": "OpenCode beenden",
  "desktop.appMenu.newSession": "Neue Sitzung",
  "desktop.appMenu.openProject": "Projekt öffnen...",
  "desktop.appMenu.newWindow": "Neues Fenster",
  "desktop.appMenu.closeWindow": "Fenster schließen",
  "desktop.appMenu.undo": "Rückgängig",
  "desktop.appMenu.redo": "Wiederholen",
  "desktop.appMenu.cut": "Ausschneiden",
  "desktop.appMenu.copy": "Kopieren",
  "desktop.appMenu.paste": "Einfügen",
  "desktop.appMenu.delete": "Löschen",
  "desktop.appMenu.selectAll": "Alles auswählen",
  "desktop.appMenu.toggleSidebar": "Seitenleiste ein-/ausblenden",
  "desktop.appMenu.toggleTerminal": "Terminal ein-/ausblenden",
  "desktop.appMenu.toggleFileTree": "Dateibaum ein-/ausblenden",
  "desktop.appMenu.reload": "Neu laden",
  "desktop.appMenu.toggleDeveloperTools": "Entwicklerwerkzeuge ein-/ausblenden",
  "desktop.appMenu.actualSize": "Tatsächliche Größe",
  "desktop.appMenu.zoomIn": "Vergrößern",
  "desktop.appMenu.zoomOut": "Verkleinern",
  "desktop.appMenu.toggleFullScreen": "Vollbild ein-/ausschalten",
  "desktop.appMenu.back": "Zurück",
  "desktop.appMenu.forward": "Vorwärts",
  "desktop.appMenu.previousSession": "Vorherige Sitzung",
  "desktop.appMenu.nextSession": "Nächste Sitzung",
  "desktop.appMenu.previousProject": "Vorheriges Projekt",
  "desktop.appMenu.nextProject": "Nächstes Projekt",
  "desktop.appMenu.minimize": "Minimieren",
  "desktop.appMenu.zoomWindow": "Zoomen",
  "desktop.appMenu.maximize": "Maximieren",
  "desktop.appMenu.bringAllToFront": "Alle nach vorne",
  "desktop.appMenu.documentation": "OpenCode-Dokumentation",
  "desktop.appMenu.supportForum": "Supportforum",
  "desktop.appMenu.shareFeedback": "Feedback geben",
  "desktop.appMenu.reportBug": "Fehler melden",
