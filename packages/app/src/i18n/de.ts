...
export const dict = {
  ...
  "settings.general.row.sendKey.title": "Senden-Taste",
  "settings.general.row.sendKey.description": "Wählen Sie, welche Taste Nachrichten sendet. Die andere Enter-Taste fügt eine neue Zeile ein.",
