...
export const dict = {
  ...
  "session.tab.agents": "Sub-Agents",
  "session.agents.empty": "Keine Sub-Agents aktiv",
  "session.agents.costTotal": "Gesamtkosten",
  "session.agents.costSubagents": "Sub-Agents",
  "session.agents.count": "Agents",
  "session.agents.tokens": "Token",
  "session.agents.showAll": "Alle anzeigen ({{count}})",
  "session.agents.status.idle": "Inaktiv",
  "session.agents.status.busy": "Läuft",
  "session.agents.status.retry": "Erneuter Versuch",
  "session.agents.status.cancelled": "Abgebrochen",
  "session.agents.status.completed": "Abgeschlossen",
  "session.agents.status.error": "Fehlgeschlagen",
