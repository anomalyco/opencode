...
export const dict = {
  ...
  "ssh.server.add": "SSH-Server hinzufügen",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH-Server",
  "ssh.server.retryStart": "Erneut verbinden",
  "ssh.server.disconnect": "Verbindung trennen",
  "ssh.server.openTerminal": "Terminal öffnen",
  "ssh.server.updating": "Wird aktualisiert…",
  "ssh.server.status.connecting": "Verbindung wird hergestellt…",
  "ssh.server.status.disconnected": "Verbindung getrennt",
  "ssh.add.hostLabel": "SSH-Host",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Die Verbindung erfolgt über den ssh-Client Ihres Systems, sodass Hosts, Schlüssel und Agents aus Ihrer SSH-Konfiguration wie gewohnt funktionieren.",
  "ssh.add.configHosts": "Aus Ihrer SSH-Konfiguration",
  "ssh.add.connect": "Verbinden",
  "ssh.add.checking": "Verbindung wird hergestellt…",
  "ssh.add.addServer": "Server hinzufügen",
  "ssh.add.adding": "Wird hinzugefügt…",
  "ssh.add.installOpencode": "opencode installieren",
  "ssh.add.updateOpencode": "opencode aktualisieren",
  "ssh.add.installing": "Wird installiert…",
  "ssh.add.status.unreachable": "Verbindung konnte nicht hergestellt werden",
  "ssh.add.status.opencodeMissing": "opencode ist auf diesem Host nicht installiert",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} installiert, die Desktop-App erwartet v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} gefunden",
  "ssh.add.authHint":
    "Stellen Sie sicher, dass die schlüsselbasierte SSH-Authentifizierung für diesen Host funktioniert. Führen Sie zur Überprüfung `ssh {{host}}` in einem Terminal aus.",
  ...
  "desktop.ssh.error.invalidHost": "Ungültiger SSH-Host: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} wurde bereits hinzugefügt",
  "desktop.ssh.error.opencodeNotInstalled": "opencode ist auf {{host}} nicht installiert",
  "desktop.ssh.error.installOpencode": "opencode-Installation fehlgeschlagen",
  "desktop.ssh.error.connectFailed": "Verbindung mit {{host}} konnte nicht hergestellt werden",
  "desktop.ssh.error.serverExited": "SSH-Server wurde nach dem Start beendet (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "SSH-Server für {{host}} wurde beendet, bevor er betriebsbereit war (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Zeitüberschreitung bei der Integritätsprüfung des Servers auf {{host}} nach {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "Zeitüberschreitung beim ssh-Befehl an {{host}} nach {{timeout}} ms",
  "desktop.ssh.error.failedPort": "Port konnte nicht abgerufen werden",
  "desktop.ssh.error.terminalFailed": "Terminal konnte nicht geöffnet werden",
