...
export const dict = {
  ...
  "provider.custom.models.loading": "Wird geladen…",
  "provider.custom.models.load.invalidUrl": "Geben Sie eine gültige Basis-URL ein",
  "provider.custom.models.load.unauthorized": "Nicht autorisiert. Prüfen Sie den API-Schlüssel",
  "provider.custom.models.load.invalidFormat": "Die Serverantwort enthielt keine gültige Modellliste",
  "provider.custom.models.load.timeout": "Zeitüberschreitung beim Laden der Modelle",
  "provider.custom.models.load.failed": "Modelle konnten nicht geladen werden",
  "provider.custom.models.load.empty": "Keine Modelle gefunden",
