...
export const dict = {
  ...
  "command.context.addToChat": "Auswahl zum Chat hinzufügen",
  "command.context.addToChat.description": "Ausgewählte Zeilen an der Cursorposition einfügen",
  "command.context.quickEdit": "Schnellbearbeitung der Auswahl",
  "command.context.quickEdit.description": "Ausgewählten Code in einer neuen Sitzung bearbeiten",
  "selection.action.addToChat": "Zum Chat hinzufügen",
  "selection.action.quickEdit": "Schnellbearbeiten",
  "selection.quickEdit.placeholder": "Ausgewählten Code bearbeiten",
  "selection.quickEdit.submit": "Starten",
