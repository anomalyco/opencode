...
export const dict = {
  ...
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} Elemente",
  ...
  "dialog.todo.field.dueDate.month.2": "Mär",
  ...
  "dialog.todo.autocomplete.noFiles": "Keine Dateien gefunden",
  "dialog.todo.autocomplete.noSkills": "Keine Skills gefunden",
