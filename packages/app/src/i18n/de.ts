...
export const dict = {
  ...
  "command.session.handoff": "Sitzung übergeben",
  "command.session.handoff.description": "Sitzung komprimieren und die Arbeit in einer neuen Sitzung fortsetzen",
  ...
  "toast.session.handoff.failed.title": "Übergabe der Sitzung fehlgeschlagen",
  "toast.session.handoff.failed.description": "Diese Sitzung konnte für die Übergabe nicht zusammengefasst werden",
