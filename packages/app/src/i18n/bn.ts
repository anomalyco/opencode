export const dict: Record<string, string> = {
  ...
  "home.recentlyClosed.options": "ফিল্টার ও সাজানো",
  "home.recentlyClosed.filter.label": "ফিল্টার",
  "home.recentlyClosed.filter.recent": "সাম্প্রতিক",
  "home.recentlyClosed.filter.archived": "সংরক্ষণাগারভুক্ত",
  "home.recentlyClosed.filter.hidden": "লুকানো",
  "home.recentlyClosed.filter.all": "সব",
  "home.recentlyClosed.filter.empty": "এই ফিল্টারের সাথে কোনো প্রকল্প মেলে না",
  "home.recentlyClosed.sort.label": "সাজানো",
  "home.recentlyClosed.sort.recent": "নতুনতম আগে",
  "home.recentlyClosed.sort.oldest": "পুরোনোতম আগে",
  "home.recentlyClosed.sort.nameAsc": "নাম A–Z",
  "home.recentlyClosed.sort.nameDesc": "নাম Z–A",
  "home.recentlyClosed.search.placeholder": "সম্প্রতি বন্ধ করা প্রকল্পে খুঁজুন",
  "home.recentlyClosed.showMore": "সব দেখান ({{count}})",
  "home.recentlyClosed.showLess": "কম দেখান",
  "home.recentlyClosed.select": "নির্বাচন করুন…",
  "home.recentlyClosed.selectAll": "সব নির্বাচন করুন",
  "home.recentlyClosed.deselectAll": "সব নির্বাচন বাতিল করুন",
  "home.recentlyClosed.cancelSelection": "নির্বাচন বাতিল করুন",
  "home.recentlyClosed.selected": "{{count}}টি নির্বাচিত",
  "home.recentlyClosed.noResults": "“{{query}}”-এর সাথে কোনো প্রকল্প মেলে না",
  "home.recentlyClosed.archived.badge": "সংরক্ষণাগারভুক্ত",
  "home.recentlyClosed.hidden.badge": "লুকানো",
  "home.recentlyClosed.action.reopen": "আবার খুলুন",
  "home.recentlyClosed.action.unarchive": "সংরক্ষণাগার থেকে ফেরান",
  "home.recentlyClosed.action.hide": "লুকান",
  "home.recentlyClosed.action.unhide": "দেখান",
  "home.recentlyClosed.action.remove": "ভুলে যান",
  "home.recentlyClosed.remove.title": "প্রকল্পটি ভুলে যাবেন?",
  "home.recentlyClosed.remove.titleMany": "{{count}}টি প্রকল্প ভুলে যাবেন?",
  "home.recentlyClosed.remove.confirm": "“{{name}}” সম্প্রতি বন্ধ করা তালিকা থেকে সরাবেন? এটি শুধু ইতিহাস মুছে দেয়, কখনো ফাইল মুছে না।",
  "home.recentlyClosed.remove.confirmMany": "{{count}}টি প্রকল্প সম্প্রতি বন্ধ করা তালিকা থেকে সরাবেন? এটি শুধু ইতিহাস মুছে দেয়, কখনো ফাইল মুছে না।",
  "home.recentlyClosed.toast.archived": "সংরক্ষণাগারভুক্ত হয়েছে",
  "home.recentlyClosed.toast.hidden": "লুকানো হয়েছে",
  "home.recentlyClosed.toast.removed": "সম্প্রতি বন্ধ করা তালিকা থেকে সরানো হয়েছে",
  "home.recentlyClosed.toast.undo": "পূর্বাবস্থায় ফেরান",
