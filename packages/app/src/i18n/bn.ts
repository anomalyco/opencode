export const dict: Record<string, string> = {
  ...
  "command.session.handoff": "সেশন হস্তান্তর করুন",
  "command.session.handoff.description": "সেশনটি কমপ্যাক্ট করুন এবং একটি নতুন সেশনে কাজ চালিয়ে যান",
  ...
  "toast.session.handoff.failed.title": "সেশন হস্তান্তর করতে ব্যর্থ হয়েছে",
  "toast.session.handoff.failed.description": "হস্তান্তরের জন্য এই সেশনটির সারসংক্ষেপ করা যায়নি",
