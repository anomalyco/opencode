export const dict: Record<string, string> = {
  ...
  "provider.custom.models.load": "গতিশীলভাবে লোড করুন",
  "provider.custom.models.loading": "লোড হচ্ছে...",
  "provider.custom.models.load.invalidUrl": "একটি বৈধ ভিত্তি URL লিখুন",
  "provider.custom.models.load.unauthorized": "অননুমোদিত। API কী পরীক্ষা করুন",
  "provider.custom.models.load.invalidFormat": "সার্ভারের প্রতিক্রিয়ায় বৈধ মডেল তালিকা নেই",
  "provider.custom.models.load.timeout": "মডেল লোড করার সময় শেষ হয়ে গেছে",
  "provider.custom.models.load.failed": "মডেল লোড করতে ব্যর্থ",
  "provider.custom.models.load.empty": "কোনো মডেল পাওয়া যায়নি",
