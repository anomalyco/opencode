export const dict: Record<string, string> = {
  ...
  "session.tab.agents": "সাবএজেন্ট",
  "session.agents.empty": "কোনো সাবএজেন্ট চলছে না",
  "session.agents.costTotal": "মোট খরচ",
  "session.agents.costSubagents": "সাবএজেন্ট",
  "session.agents.count": "এজেন্ট",
  "session.agents.tokens": "টোকেন",
  "session.agents.showAll": "সব দেখান ({{count}})",
  "session.agents.status.idle": "নিষ্ক্রিয়",
  "session.agents.status.busy": "চলছে",
  "session.agents.status.retry": "পুনরায় চেষ্টা",
  "session.agents.status.cancelled": "বাতিল",
  "session.agents.status.completed": "সম্পন্ন",
  "session.agents.status.error": "ব্যর্থ",
