...
export const dict = {
  ...
  "provider.custom.models.load": "Hlaða inn dýnamískt",
  "provider.custom.models.loading": "Hleð inn...",
  "provider.custom.models.load.invalidUrl": "Sláðu inn gilda grundar-URL",
  "provider.custom.models.load.unauthorized": "Ekki heimilað. Athugaðu API-lykilinn",
  "provider.custom.models.load.invalidFormat": "Svar frá þjóni innihélt ekki gildan lista líkana",
  "provider.custom.models.load.timeout": "Tíminn rann út við að hlaða inn líkönum",
  "provider.custom.models.load.failed": "Mistókst að hlaða inn líkönum",
  "provider.custom.models.load.empty": "Engin líkön fundust",
