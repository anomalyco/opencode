...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Argus",
  "Argus-glugganum var óvænt lokað",
  "Argus svarar ekki",
  ...
  "Uppsetning Argus mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "argus er ekki uppsett í þessari dreifingu",
  "argus er uppsett en ekki var hægt að keyra það",
  "Argus er ekki uppsett í {{distro}}",
  "Uppfærslu Argus lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.argus.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.argus.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.argusGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Argus",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.argusZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.argusZen.visit.prefix": "Heimsókn",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Argus.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í argus.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Argus miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingArgus": "Athugar Argus...",
  "wsl.onboarding.checkingArgusIn": "Athugar Argus í {{distro}}...",
  "wsl.onboarding.updatingArgus": "Uppfærir Argus...",
  "wsl.onboarding.updatingArgusIn": "Uppfærir Argus í {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Uppfærðu Argus í {{distro}}.",
  "wsl.onboarding.updateArgus": "Uppfærðu Argus",
  "wsl.onboarding.argusReadyIn": "Argus er tilbúið í {{distro}}.",
  "wsl.onboarding.argusReady": "Argus er tilbúinn.",
  "wsl.onboarding.installArgusIn": "Settu upp Argus í {{distro}}.",
  "wsl.onboarding.installArgus": "Settu upp Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Argus getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Argus gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Argus aftur.",
  ...
  "help.tabs.introduction": "Argus Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Argus ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Argus teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (argus.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Argus styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Argus inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Argus skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Argus netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Argus",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Argus lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Argus fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Argus er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Argus ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Argus.",
