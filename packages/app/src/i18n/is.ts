...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Pencode",
  "Pencode-glugganum var óvænt lokað",
  "Pencode svarar ekki",
  ...
  "Uppsetning Pencode mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "pencode er ekki uppsett í þessari dreifingu",
  "pencode er uppsett en ekki var hægt að keyra það",
  "Pencode er ekki uppsett í {{distro}}",
  "Uppfærslu Pencode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.pencode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.pencode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.pencodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Pencode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.pencodeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.pencodeZen.visit.prefix": "Heimsókn",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Pencode.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í pencode.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Pencode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingPencode": "Athugar Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Athugar Pencode í {{distro}}...",
  "wsl.onboarding.updatingPencode": "Uppfærir Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Uppfærir Pencode í {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Uppfærðu Pencode í {{distro}}.",
  "wsl.onboarding.updatePencode": "Uppfærðu Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode er tilbúið í {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode er tilbúinn.",
  "wsl.onboarding.installPencodeIn": "Settu upp Pencode í {{distro}}.",
  "wsl.onboarding.installPencode": "Settu upp Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Pencode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Pencode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Pencode aftur.",
  ...
  "help.tabs.introduction": "Pencode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Pencode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Pencode teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (pencode.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Pencode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Pencode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Pencode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Pencode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Pencode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Pencode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Pencode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Pencode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Pencode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Pencode.",
