...
export const dict = {
  ...
  "session.tab.agents": "Undirfulltrúar",
  "session.agents.empty": "Enginn undirfulltrúi keyrir",
  "session.agents.costTotal": "Heildarkostnaður",
  "session.agents.costSubagents": "Undirfulltrúar",
  "session.agents.count": "Fulltrúar",
  "session.agents.tokens": "tákn",
  "session.agents.showAll": "Sýna allt ({{count}})",
  "session.agents.status.idle": "Aðgerðalaus",
  "session.agents.status.busy": "Keyrir",
  "session.agents.status.retry": "Reynir aftur",
  "session.agents.status.cancelled": "Hætt við",
  "session.agents.status.completed": "Lokið",
  "session.agents.status.error": "Mistókst",
