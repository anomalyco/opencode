...
export const dict = {
  ...
  "command.session.handoff": "Afhenda setu",
  "command.session.handoff.description": "Þjappa setunni og halda vinnunni áfram í nýrri setu",
  ...
  "toast.session.handoff.failed.title": "Ekki tókst að afhenda setu",
  "toast.session.handoff.failed.description": "Ekki tókst að draga þessa setu saman til afhendingar",
