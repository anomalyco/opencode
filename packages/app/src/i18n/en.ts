export const dict = {
  ...
  "wsl.server.configureAccess": "Configure external access",
  "wsl.server.copyAttachCommand": "Copy attach command",
  "wsl.server.access.title": "External access",
  "wsl.server.access.description":
    "Set a stable port and password for this WSL server. Leave fields empty to keep the default random values.",
  "wsl.server.access.port": "Port",
  "wsl.server.access.portPlaceholder": "Random",
  "wsl.server.access.password": "Password",
  "wsl.server.access.passwordPlaceholder": "Random each start",
  "wsl.server.access.restart": "Saving restarts this WSL server.",
  "wsl.server.access.invalidPort": "Port must be a whole number between 1 and 65535.",
  "wsl.server.access.portMeta": "Port {{port}}",
  "wsl.server.access.copied": "Attach command copied",
  "wsl.server.access.copyFailed": "Failed to copy attach command",
