export const dict = {
  ...
  "file.edit.toggle.edit": "Edit",
  "file.edit.toggle.view": "View",
  "file.save.command": "Save file",
  "file.unsaved.title": "Unsaved changes",
  "file.unsaved.description": "You have unsaved changes. Do you want to save them?",
  "file.conflict.title": "File changed on disk",
  "file.conflict.description": "This file was modified outside the editor. Reload to discard your edits, or overwrite to keep them.",
  "toast.file.saved.title": "File saved",
  "toast.file.saveFailed.title": "Failed to save file",
  "toast.file.changedExternally.title": "File changed on disk",
  "toast.file.definitionExternal.title": "Definition is outside the workspace",
  "common.key.esc": "ESC",
