export const dict = {
  ...
  "session.agents.empty": "No sub-agents running",
  "session.agents.costTotal": "Total cost",
  "session.agents.costSubagents": "Sub-agents",
  "session.agents.status.idle": "Completed",
  "session.agents.status.busy": "Running",
  "session.agents.status.retry": "Retrying",
  "session.agents.status.cancelled": "Cancelled",
  "session.agents.cost": "Cost",
  "session.agents.backToParent": "Back to parent",
