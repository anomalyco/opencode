export const dict = {
  ...
  "browserPreview.error.unreachable": "Local server unavailable",
  "browserPreview.error.tls": "Local TLS certificate rejected",
  ...
  "browserPreview.allowedHosts": "Allowed hosts: localhost, 127.0.0.1, and ::1",
