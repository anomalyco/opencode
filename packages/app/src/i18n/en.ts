export const dict = {
  ...
  "command.context.addToChat": "Add selection to chat",
  "command.context.addToChat.description": "Insert selected lines at cursor position",
  "command.context.quickEdit": "Quick edit selection",
  "command.context.quickEdit.description": "Edit selected code in a new session",
  "selection.action.addToChat": "Add to chat",
  "selection.action.quickEdit": "Quick edit",
  "selection.quickEdit.placeholder": "Edit selected code",
