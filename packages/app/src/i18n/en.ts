export const dict = {
  ...
  "settings.general.row.fontSize.description": "Adjust the base text size across the interface",
  "settings.general.row.lineHeight.title": "Line height",
  "settings.general.row.lineHeight.description": "Adjust the spacing between lines of text",
