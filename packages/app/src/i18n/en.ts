export const dict = {
  ...
  "settings.mcp.status.needs_auth": "Needs Authentication",
  "settings.mcp.status.needs_registration": "Needs Registration",
  ...
  "settings.mcp.register": "Register",
  "settings.mcp.tools": "{count} tools",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Manage and invoke available skills for AI assistants.",
  "settings.skills.section.available": "Available Skills",
  "settings.skills.section.about": "About Skills",
  "settings.skills.empty": "No skills found",
  "settings.skills.loading": "Loading skills...",
  "settings.skills.about.description": "Skills provide specialized knowledge and step-by-step guidance for specific tasks. They are automatically discovered from:",
  "settings.skills.about.item1": "Project-level: .claude/skills/*/SKILL.md",
  "settings.skills.about.item2": "Global-level: ~/.claude/skills/*/SKILL.md",
  "settings.skills.about.item3": "OpenCode format: .opencode/skill/*/SKILL.md or .opencode/skills/*/SKILL.md",
  "settings.skills.dialog.description": "Description",
  "settings.skills.dialog.hint": "This skill is automatically available when working with relevant tasks in your project.",
  "settings.skills.dialog.content": "Skill Content",
