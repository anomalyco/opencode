export const dict = {
  ...
  "provider.custom.models.config.label": "Configure model capabilities",
  "provider.custom.models.config.description": "Enable only the variants this model supports.",
  "provider.custom.models.reasoning.label": "Supports reasoning / thinking",
  "provider.custom.models.reasoning.description":
    "Expose thinking intensity variants for OpenAI-compatible reasoning parameters.",
  "provider.custom.models.efforts.label": "Thinking intensities",
  "provider.custom.models.effort.none": "None",
  "provider.custom.models.effort.low": "Low",
  "provider.custom.models.effort.medium": "Medium",
  "provider.custom.models.effort.high": "High",
  "provider.custom.models.effort.xhigh": "XHigh",
  "provider.custom.models.fast.label": "Add fast preset",
  "provider.custom.models.fast.description": "Adds a fast variant using low reasoning effort and low verbosity.",
  ...
  "prompt.model.effort.label": "Thinking effort",
  "prompt.model.effort.fast": "Fast",
