export const dict = {
  ...
  "provider.custom.models.context.label": "Context size",
  "provider.custom.models.context.placeholder": "Context size",
  "provider.custom.models.output.label": "Max output",
  "provider.custom.models.output.placeholder": "Max output",
  "provider.custom.models.reasoning.label": "Supports reasoning",
