...
export const dict = {
  ...
  "provider.custom.models.load": "Load dynamically",
  "provider.custom.models.loading": "Loading...",
  "provider.custom.models.load.invalidUrl": "Enter a valid base URL",
  "provider.custom.models.load.unauthorized": "Unauthorized. Check the API key",
  "provider.custom.models.load.invalidFormat": "The server response was not a valid model list",
  "provider.custom.models.load.timeout": "Timed out loading models",
  "provider.custom.models.load.failed": "Failed to load models",
  "provider.custom.models.load.empty": "No models found",
