export const dict = {
  ...
  "dialog.connect.connecting.title": "Connecting…",
  "dialog.connect.connecting.description": "Waiting for the connection to complete.",
  "dialog.connect.connecting.error": "Couldn't connect. The external app didn't respond.",
