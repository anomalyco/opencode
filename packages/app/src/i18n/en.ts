export const dict = {
  ...
  "command.prompt.mode.draw": "Draw",
  "command.prompt.mode.doc": "Doc",
  ...
  "prompt.mode.draw": "Draw",
  "prompt.mode.doc": "Doc",
  "prompt.mode.shell.exit": "esc to exit",
  "prompt.mode.draw.exit": "esc to exit",
  "prompt.mode.doc.exit": "esc to exit",
  ...
  "prompt.action.drawUndo": "Undo",
  "prompt.action.drawRedo": "Redo",
  ...
  "prompt.toast.docAdvanceFailed.description": "The prompt was sent, but switching to the next doc failed.",
  "prompt.toast.drawImageTooLarge.title": "Image too large",
  "prompt.toast.drawImageTooLarge.description": "Use a smaller image or lower resolution.",
  "prompt.toast.drawImageCount.title": "Too many images",
  "prompt.toast.drawImageCount.description": "Remove an image before adding another.",
  "prompt.toast.drawImageTotal.title": "Canvas images too large",
  "prompt.toast.drawImageTotal.description": "Remove images or use smaller files.",
  "prompt.toast.drawImageType.title": "Unsupported image",
  "prompt.toast.drawImageType.description": "Only image files can be added to the canvas.",
  ...
  "session.files.addToContext": "Add file to document",
  "session.files.addFolderToContext": "Add folder to document",
  ...
  "settings.general.row.followup.description":
    "Choose whether follow-up prompts queue, steer immediately, or only allow stop while the agent is busy",
  "settings.general.row.followup.option.queue": "Queue",
  "settings.general.row.followup.option.steer": "Steer",
  "settings.general.row.followup.option.none": "None",
