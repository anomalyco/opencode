export const dict = {
  ...
  "command.project.run": "Run project",
  "command.project.run.description": "Run the selected project command",
  "command.project.stop": "Stop project",
  "command.project.stop.description": "Stop the running project command",
  ...
  "run.selector.placeholder": "Select run command",
  "run.empty": "No run command configured",
  "run.run": "Run",
  "run.stop": "Stop",
  ...
  "dialog.project.edit.runConfigs": "Run configurations",
  "dialog.project.edit.runConfigs.description": "Named commands you can run in the project terminal.",
  "dialog.project.edit.runConfigs.detected": "Detected from project files",
  "dialog.project.edit.runConfigs.scan": "Scan project files",
  "dialog.project.edit.runConfigs.scan.scanning": "Scanning...",
  "dialog.project.edit.runConfigs.add": "Add run config",
  "dialog.project.edit.runConfigs.name": "Name",
  "dialog.project.edit.runConfigs.name.placeholder": "e.g. Dev server",
  "dialog.project.edit.runConfigs.command": "Command",
  "dialog.project.edit.runConfigs.command.placeholder": "e.g. bun dev",
  "dialog.project.edit.runConfigs.remove": "Remove run config",
