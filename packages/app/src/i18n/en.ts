export const dict = {
  ...
  "dialog.project.create.title": "New Client",
  "dialog.project.create.name": "Client name",
  "dialog.project.create.name.placeholder": "my-client",
  "dialog.project.create.submit": "Create client",
  "dialog.add.create": "Create new client",
