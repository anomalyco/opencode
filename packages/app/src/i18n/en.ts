...
export const dict = {
  ...
  "settings.mcp.menu.edit": "Edit",
  "settings.mcp.menu.enable": "Enable",
  "settings.mcp.menu.disable": "Disable",
  "settings.mcp.menu.remove": "Remove",
  "settings.mcp.menu.authenticate": "Authenticate",
  "settings.mcp.toast.saveFailed": "Failed to save MCP server",
  "settings.mcp.toast.removeFailed": "Failed to remove MCP server",
  "dialog.mcp.form.title.add": "Add MCP server",
  "dialog.mcp.form.title.edit": "Edit MCP server",
  "dialog.mcp.form.name": "Name",
  "dialog.mcp.form.name.placeholder": "my-server",
  "dialog.mcp.form.type": "Type",
  "dialog.mcp.form.command": "Command",
  "dialog.mcp.form.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem /path",
  "dialog.mcp.form.command.hint": "The command and arguments used to launch the server, separated by spaces.",
  "dialog.mcp.form.url": "URL",
  "dialog.mcp.form.url.placeholder": "https://example.com/mcp",
  "dialog.mcp.form.environment": "Environment variables",
  "dialog.mcp.form.headers": "Headers",
  "dialog.mcp.form.keyValue.hint": "One KEY=VALUE per line.",
  "dialog.mcp.form.enabled": "Enabled",
  "dialog.mcp.form.test": "Test connection",
  "dialog.mcp.form.testing": "Testing…",
  "dialog.mcp.form.save": "Save",
  "dialog.mcp.form.cancel": "Cancel",
  "dialog.mcp.form.error.name": "Enter a unique server name.",
  "dialog.mcp.form.error.command": "Enter a command to run.",
  "dialog.mcp.form.error.url": "Enter a valid URL.",
  "dialog.mcp.test.reachable": "Reachable",
  "dialog.mcp.test.unreachable": "Unreachable",
  "dialog.mcp.test.auth": "Authentication",
  "dialog.mcp.test.tools": "Tools discovered",
  "dialog.mcp.test.tools.none": "No tools discovered",
  "dialog.mcp.test.error": "Error",
  "dialog.mcp.test.success": "Connected successfully",
