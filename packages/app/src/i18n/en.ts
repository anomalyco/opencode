...
export const dict = {
  ...
  "provider.connect.venice.visit.prefix": "You can create one in your ",
  "provider.connect.venice.visit.link": "Venice API settings",
  "provider.connect.venice.visit.suffix": ".",
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in VeniceCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in VeniceCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in VeniceCode.",
  ...
  "dialog.server.description": "Switch which VeniceCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "VeniceCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking VeniceCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking VeniceCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating VeniceCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating VeniceCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update VeniceCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update VeniceCode",
  "wsl.onboarding.opencodeReadyIn": "VeniceCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "VeniceCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install VeniceCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install VeniceCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VeniceCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before VeniceCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "VeniceCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen VeniceCode.",
  ...
  "help.tabs.introduction": "VeniceCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of VeniceCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the VeniceCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, VeniceCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "VeniceCode runs on Venice AI, a private, uncensored AI provider.",
  "sidebar.gettingStarted.line2": "Add your Venice API key to start using models.",
  ...
  "app.name.desktop": "VeniceCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the VeniceCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for VeniceCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how VeniceCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether VeniceCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how VeniceCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when VeniceCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of VeniceCode.",
