export const dict = {
  ...
  "dialog.linear.title": "Linear Configuration",
  "dialog.linear.description": "Configure Linear integration for issue tracking and sync.",
  "dialog.linear.status.connected": "Connected",
  "dialog.linear.status.notConnected": "Not connected",
  "dialog.linear.status.connectButton": "Connect Linear MCP",
  "dialog.linear.project.label": "Project",
  "dialog.linear.project.placeholder": "Select a Linear project",
  "dialog.linear.project.disabled": "Configure Linear MCP first",
  "dialog.linear.team.label": "Team",
  "dialog.linear.team.placeholder": "Select a Linear team",
  "dialog.linear.team.disabled": "Configure Linear MCP first",
  "dialog.linear.syncMode.label": "Sync mode",
  "dialog.linear.syncMode.manual": "Manual",
  "dialog.linear.syncMode.autoPush": "Auto-push",
  "dialog.linear.syncMode.autoPull": "Auto-pull",
  "dialog.linear.syncMode.bidirectional": "Two-way",
  "dialog.linear.autoPush.label": "Auto-push issues",
  "dialog.linear.autoPush.description": "Automatically push issues to Linear when created",
  "dialog.linear.help": "Find your Linear project ID at linear.app/[org]/settings/api",
  "dialog.linear.validation.required": "Project and team are required",
  ...
  "sidebar.issue.empty": "No todos yet for this project.",
  "sidebar.issue.add": "Add todo",
  "sidebar.issue.l1": "L1",
  "sidebar.issue.l2": "L2",
  "sidebar.issue.status.backlog": "Backlog",
  "sidebar.issue.status.todo": "Todo",
  "sidebar.issue.status.in_progress": "In progress",
  "sidebar.issue.status.in_review": "In review",
  "sidebar.issue.status.done": "Done",
  "sidebar.issue.status.canceled": "Canceled",
  "sidebar.issue.priority.none": "No priority",
  ...
  "sidebar.issue.autoProgress.start": "Start auto-progress",
  "sidebar.issue.autoProgress.stop": "Stop auto-progress",
  "sidebar.issue.autoProgress.running": "Auto-progress running",
  "sidebar.issue.autoProgress.idle": "Auto-progress idle",

  "sidebar.linear.notConfigured": "Linear MCP is connected but the project is not yet configured.",
