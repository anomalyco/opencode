export const dict = {
  ...
  "settings.general.row.transparentAppIcons.title": "Transparent app icons",
  "settings.general.row.transparentAppIcons.description": "Show app logos without the background frame in Open in menu",
