export const dict = {
  ...
  "settings.general.row.sendKey.title": "Send key",
  "settings.general.row.sendKey.description": "Choose which key sends messages. The other Enter key inserts a newline.",
