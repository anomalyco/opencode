export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by ИИ аналитика предприятий питания. На базе GigaChat",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ИИ аналитика предприятий питания. На базе GigaChat.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ИИ аналитика предприятий питания. На базе GigaChat.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ИИ аналитика предприятий питания. На базе GigaChat.",
  ...
  "dialog.server.description": "Switch which ИИ аналитика предприятий питания. На базе GigaChat server this app connects to.",
  ...
  "toast.update.description": "A new version of ИИ аналитика предприятий питания. На базе GigaChat ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ИИ аналитика предприятий питания. На базе GigaChat team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, ИИ аналитика предприятий питания. На базе GigaChat does not support MCP authentication yet.',
  ...
  "sidebar.help": "Help",
  "sidebar.heading.workspaces": "Spaces",
  "sidebar.heading.chats": "Chats",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "ИИ аналитика предприятий питания. На базе GigaChat includes free models so you can start immediately.",
  ...
  "sidebar.search.scope.current": "Current project",
  "sidebar.search.scope.all": "All projects",
  "sidebar.search.noResults": "No sessions match your search",
  ...
  "app.name.desktop": "ИИ аналитика предприятий питания. На базе GigaChat",
  ...
  "settings.desktop.wsl.description": "Run the ИИ аналитика предприятий питания. На базе GigaChat server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for ИИ аналитика предприятий питания. На базе GigaChat",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how ИИ аналитика предприятий питания. На базе GigaChat looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether ИИ аналитика предприятий питания. На базе GigaChat follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how ИИ аналитика предприятий питания. На базе GigaChat is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when ИИ аналитика предприятий питания. На базе GigaChat launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ИИ аналитика предприятий питания. На базе GigaChat.",
