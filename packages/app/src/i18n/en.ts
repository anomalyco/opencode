export const dict = {
  ...
  "dialog.server.add.remote": "Remote server",
  "dialog.server.add.managed": "WSL server",
  ...
  "wsl.server.access.port": "Port",
  "wsl.server.access.portPlaceholder": "Random",
  "wsl.server.access.passwordPlaceholder": "Random each start",
  "wsl.server.access.invalidPort": "Port must be a whole number between 1 and 65535.",
  "wsl.server.access.portMeta": "Port {{port}}",
  "wsl.onboarding.step.distro": "Distro",
  ...
  "wsl.onboarding.restartRequiredTitle": "Restart required",
  "wsl.onboarding.ready": "WSL is ready.",
  "wsl.onboarding.readyDescription": "Choose a Linux distro to use as the OpenCode server.",
  "wsl.onboarding.required": "Windows Subsystem for Linux is required before OpenCode can add a WSL server.",
  "wsl.onboarding.wslNotReady": "WSL is not ready",
  ...
  "wsl.onboarding.checking": "Checking...",
  "wsl.onboarding.checkFailed": "Check failed",
  "wsl.onboarding.updatingOpencode": "Updating OpenCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating OpenCode in {{distro}}...",
  "wsl.onboarding.installingOpencodeIn": "Installing OpenCode in {{distro}}...",
  ...
  "wsl.onboarding.notInstalled": "Not installed",
  ...
  "wsl.onboarding.needsAttention": "Needs attention",
  "wsl.onboarding.viewIssues": "View issues",
  "wsl.onboarding.availableDistros": "Available to install",
  "wsl.onboarding.installed": "Installed",
  "wsl.onboarding.wsl2": "WSL 2",
  "wsl.onboarding.defaultWslDistro": "Default WSL distro",
  "wsl.onboarding.select": "Select",
  "wsl.onboarding.selected": "Selected",
  "wsl.onboarding.alreadyAdded": "Already added",
  "wsl.onboarding.alreadyAddedToOpencode": "Already added to OpenCode",
  "wsl.onboarding.allDistrosAdded": "All installed distros are already added.",
  "wsl.onboarding.noDistros": "No distros detected yet.",
  "wsl.onboarding.installNewDistro": "Install a new distro",
  "wsl.onboarding.installDistroTitle": "Install a distro",
  "wsl.onboarding.installDistroIntro":
    "Choose a Linux distribution to install. After installation, you'll return to distro selection.",
  "wsl.onboarding.searchDistros": "Search distros",
  "wsl.onboarding.noMatchingDistros": "No distros match this search.",
  "wsl.onboarding.noMatchingDistrosHint": "Try a different distro name.",
  "wsl.onboarding.needAnotherDistro": "Need another distro?",
  "wsl.onboarding.installDistroDescription": "Install a Linux distribution from the WSL catalog.",
  "wsl.onboarding.installDistroAction": "Install a distro...",
  "wsl.onboarding.expand": "Show",
  "wsl.onboarding.collapse": "Hide",
  ...
  "wsl.onboarding.firstRunRequired": "Open {{distro}} once to finish Linux user setup, then check again.",
  "wsl.onboarding.toolsRequired": "This distro needs bash and curl.",
  "wsl.onboarding.missingRequiredTools": "This distro is missing required tools.",
  "wsl.onboarding.toolsRequiredDetail": "OpenCode needs {{tools}} before you can continue.",
  "wsl.onboarding.toolMissing": "missing",
  "wsl.onboarding.bashRequired": "This distro is missing bash.",
  "wsl.onboarding.curlRequired": "This distro is missing curl.",
  "wsl.onboarding.openTerminal": "Open terminal",
  "wsl.onboarding.path": "Path: {{path}}",
  "wsl.onboarding.notFound": "not found",
  "wsl.onboarding.notFoundTitle": "Not found",
  "wsl.onboarding.version": "Version: {{version}}",
  "wsl.onboarding.unknown": "unknown",
  "wsl.onboarding.desktopVersion": "Desktop version: {{version}}",
  "wsl.onboarding.wslVersion": "WSL version: {{version}}",
  "wsl.onboarding.versionMismatch": "Installed version does not match the desktop app version.",
  "wsl.onboarding.opencodeMissing": "OpenCode is not installed in {{distro}}.",
  "wsl.onboarding.opencodeUpdateRequired": "OpenCode needs to be updated",
  "wsl.onboarding.opencodeSelectedDistro": "Selected distro",
  "wsl.onboarding.opencodeDesktopVersion": "Desktop version",
  "wsl.onboarding.opencodeWslVersion": "WSL version",
  "wsl.onboarding.opencodeStatus": "OpenCode status",
  "wsl.onboarding.opencodeInstallPath": "Install path",
  "wsl.onboarding.opencodeCheckFailedIn": "OpenCode check failed in {{distro}}.",
  "wsl.onboarding.opencodeUpToDateIn": "OpenCode is up to date in {{distro}}.",
  "wsl.onboarding.opencodeUpdateNeededIn": "OpenCode needs to be updated in {{distro}}.",
  "wsl.onboarding.opencodeNotInstalledIn": "OpenCode is not installed in {{distro}}.",
  "wsl.onboarding.selectedDistro": "the selected distro",
  "wsl.onboarding.showDetails": "Show details",
  "wsl.onboarding.hideDetails": "Hide details",
  "wsl.onboarding.wslContinueBlocked": "Continue is available after WSL is ready.",
  "wsl.onboarding.distroContinueBlocked": "Continue is available after the selected distro is ready.",
  "wsl.onboarding.fixDistroOrChooseReady": "Fix the selected distro or choose a ready distro.",
  "wsl.onboarding.installOpencodeToContinue": "Install or update OpenCode to continue.",
  "wsl.onboarding.installOpencodeOnlyToContinue": "Install OpenCode to continue.",
  "wsl.onboarding.opencodeCheckingToContinue": "Checking OpenCode before you can add this WSL server.",
  "wsl.onboarding.opencodeCheckAgainToContinue": "Check OpenCode again to continue.",
  "wsl.onboarding.opencodeReadyToAdd": "OpenCode is ready. You can add this WSL server.",
  "wsl.onboarding.opencodeContinueBlocked": "Add is available after OpenCode is ready.",
  "wsl.onboarding.back": "Back",
