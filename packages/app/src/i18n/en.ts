export const dict = {
  ...
  "provider.custom.description.prefix": "Configure an OpenAI-compatible provider. Enter its endpoint and the app will try to discover models automatically. See the ",
  ...
  "provider.custom.field.baseURL.label": "API endpoint",
  "provider.custom.field.baseURL.placeholder": "https://api.myprovider.com/v1",
  "provider.custom.field.baseURL.description": "The app will try /models and /v1/models to discover models automatically.",
  ...
  "provider.custom.models.refresh": "Detect models",
  ...
  "settings.providers.custom.description": "Add an OpenAI-compatible provider by API endpoint.",
