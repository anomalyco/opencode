...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Jarvis",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Jarvis.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Jarvis.",
  ...
  "dialog.server.description": "Switch which Jarvis server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Jarvis in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Jarvis in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Jarvis in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Jarvis in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Jarvis can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Jarvis could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Jarvis ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Jarvis team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Jarvis does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis includes free models so you can start immediately.",
  ...
  "settings.integrations.placeholder": "Integrations extend the Jarvis runtime. Soon you'll be able to install plugins, themes, and system extensions.",
  "settings.connectors.placeholder": "Connectors link Jarvis with external services. Coming soon: Gmail, WhatsApp, Slack, Notion, Telegram and more.",
  "settings.connectors.unavailable": "Connectors are only available in the desktop app.",
  "settings.connectors.badge.connected": "Connected",
  "settings.connectors.badge.notConnected": "Not connected",
  "settings.connectors.badge.disabled": "Disabled",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "Connect your GitHub account to let Jarvis read and manage your repositories.",
  "settings.connectors.github.detail": "Connect your GitHub account so Jarvis can work with your repositories, issues and pull requests directly from chat. You authorize access with your own GitHub account via OAuth — Jarvis never sees your password.",
  "settings.connectors.github.permission.repos": "Read and manage your repositories, issues and pull requests",
  "settings.connectors.github.permission.profile": "Read your public profile (username and avatar)",
  "settings.connectors.github.connect": "Connect GitHub",
  "settings.connectors.github.disconnect": "Disconnect",
  "settings.connectors.github.cancel": "Cancel",
  "settings.connectors.github.openBrowser": "Open browser",
  "settings.connectors.github.waiting": "Waiting for authorization…",
  "settings.connectors.github.code.instructions": "Enter this code at",
  "settings.connectors.github.connected.text": "Connected via OAuth. Jarvis can access your GitHub account.",
  "settings.connectors.github.error.expired": "The authorization code expired. Please try again.",
  "settings.connectors.github.error.generic": "Could not connect to GitHub. Check your connection and try again.",
  "settings.connectors.github.error.denied": "Authorization denied. You can try again whenever you want.",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the Jarvis server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Jarvis",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Jarvis looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Jarvis follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Jarvis is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Jarvis launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Jarvis.",
