export const dict = {
  ...
  "settings.config.project.title": "Project Config",
  "settings.config.project.description": "Edit opencode.json in the current project directory",
  "settings.config.global.title": "Global Config",
  "settings.config.global.description": "Edit opencode.json in the global config directory",
