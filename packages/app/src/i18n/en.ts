export const dict = {
  ...
  "error.chain.checkConfig": "Check your config (cyberstrike.json) provider/model names",
  ...
  "settings.desktop.wsl.description": "Run the CyberStrike server inside WSL on Windows.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CyberStrike launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CyberStrike.",
