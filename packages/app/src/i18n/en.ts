export const dict = {
  ...
  "dialog.provider.deepseek.note": "DeepSeek chat and reasoning models",
  "dialog.provider.alibaba.note": "Qwen via Alibaba DashScope (China)",
  "dialog.provider.moonshot.note": "Moonshot Kimi with long context",
  "dialog.provider.zhipuai.note": "Zhipu GLM family",
  "dialog.provider.siliconflow.note": "SiliconFlow model hub",
  "dialog.provider.minimax.note": "MiniMax models",
  "dialog.provider.302ai.note": "302.AI unified model API",
  "dialog.provider.qiniu.note": "Qiniu cloud AI inference",
