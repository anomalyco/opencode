export const dict = {
  ...
  "session.followupDock.paused": "Follow-ups are paused",
  "session.followupDock.editingBlocked": "Finish editing this follow-up before continuing",
  "session.followupDock.resume": "Resume",
  "session.followupDock.moveUp": "Move up",
  "session.followupDock.moveDown": "Move down",
  "session.followupDock.editingState": "Editing",
  "session.followupDock.editDisabledDraft": "This draft cannot be edited yet",
  "session.followupDock.pendingSubmitBlocked": "Resume or clear pending follow-ups before sending a new message",
  "session.followupDock.pendingBlocked": "Resolve pending follow-ups before changing history",
