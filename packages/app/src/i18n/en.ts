export const dict = {
  ...
  "prompt.action.voice.start": "Start voice input",
  "prompt.action.voice.stop": "Stop voice input",
  "prompt.voice.listening": "Listening...",
  "prompt.voice.processing": "Processing...",
  "prompt.voice.error": "Voice input error",
  "prompt.voice.notSupported": "Voice input is not supported in this browser",
  "command.prompt.voice.toggle": "Toggle voice input",
  "command.prompt.voice.toggle.description": "Start or stop voice input for the prompt",
