export const dict = {
  ...
  "command.browserPreview.toggle": "Toggle browser preview",
  ...
  "browserPreview.title": "Browser Preview",
  "browserPreview.hideReset": "Hide and reset browser preview",
  "browserPreview.tab.new": "New preview tab",
  "browserPreview.tab.close": "Close preview tab",
  "browserPreview.address": "Preview address",
  "browserPreview.back": "Back",
  "browserPreview.forward": "Forward",
  "browserPreview.reload": "Reload",
  "browserPreview.hardReload": "Hard reload",
  "browserPreview.external": "Open in default browser",
  "browserPreview.external.warning": "This URL will leave OpenCode and open in your default browser",
  "browserPreview.more": "Browser preview options",
  "browserPreview.autoRefresh.active": "Auto refresh",
  "browserPreview.autoRefresh.start": "Start auto refresh",
  "browserPreview.autoRefresh.stop": "Stop auto refresh",
  "browserPreview.inspect": "Open developer tools",
  "browserPreview.device.enable": "Enable mobile emulation",
  "browserPreview.device.disable": "Disable mobile emulation",
  "browserPreview.zoomIn": "Zoom in",
  "browserPreview.zoomOut": "Zoom out",
  "browserPreview.clearCache": "Clear preview cache",
  "browserPreview.editor.start": "Select element for chat",
  "browserPreview.editor.cancel": "Cancel element selection (Esc)",
  "browserPreview.editor.attached": "Page element added to the chat",
  "browserPreview.captureScreenshot": "Capture screenshot",
  "browserPreview.readDom": "Read page DOM",
  "browserPreview.console.start": "Start console capture",
  "browserPreview.console.get": "Show captured console logs",
  "browserPreview.result.title": "Explicit page result",
  "browserPreview.result.ephemeral": "Memory only; cleared on navigation",
  "browserPreview.error.title": "Browser Preview error",
  "browserPreview.error.unreachable": "Page unavailable",
  "browserPreview.error.tls": "TLS certificate rejected",
  "browserPreview.error.blocked": "Navigation blocked",
  "browserPreview.error.crashed": "Preview process crashed",
  "browserPreview.error.unknown": "Preview failed",
  "browserPreview.allowedHosts": "HTTP and HTTPS pages are supported",
  "browserPreview.retry": "Retry",
