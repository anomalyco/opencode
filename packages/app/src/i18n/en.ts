export const dict = {
  ...
  "session.panel.reviewAndFiles": "Review, memory, reports, detail, and files",
  "session.tab.memory": "Memory",
  "session.tab.bugReport": "Reports",
  "session.tab.detail": "Detail",
  "session.tab.detail.empty": "No agent is currently active.",
  "session.dashboard.todos": "Tasks",
  "session.dashboard.todos.empty": "No tasks tracked yet.",
  "session.dashboard.files": "Changed Files",
  "session.dashboard.files.empty": "No files changed yet.",
  "session.dashboard.agents": "Sub-agents",
  "session.dashboard.agents.empty": "No sub-agents spawned.",
  "session.dashboard.agents.showHistory": "Show history",
  "session.dashboard.agents.activeOnly": "Active only",
  "session.dashboard.summary.empty": "Open the detail panel to follow the active agent.",
  "session.dashboard.summary.agent": "{{agent}} is driving this session right now.",
  "session.dashboard.metric.todos": "Tracked todos",
  "session.dashboard.metric.files": "Changed files",
  "session.dashboard.metric.agents": "Active workers",
  "session.dashboard.ayaz.title": "Ayaz execution focus",
  "session.dashboard.ayaz.body": "Surface the live coding lane, pending work, and touched files.",
  "session.dashboard.ayaz.active": "Live work",
  "session.dashboard.ayaz.pending": "Queued todos",
  "session.dashboard.ayaz.files": "Touched files",
  "session.dashboard.atlas.title": "Atlas orchestration focus",
  "session.dashboard.atlas.body": "Track active workers, finished routes, and shared file impact.",
  "session.dashboard.atlas.running": "Running routes",
  "session.dashboard.atlas.completed": "Finished routes",
  "session.dashboard.atlas.files": "Affected files",
  "session.dashboard.lead.title": "Lead execution hub",
  "session.dashboard.lead.body": "Monitor delegated work, throughput, and task board pressure.",
  "session.dashboard.lead.running": "Running workers",
  "session.dashboard.lead.completed": "Completed workers",
  "session.dashboard.lead.todos": "Tracked todos",
  "session.dashboard.niggli.title": "Niggli planning focus",
  "session.dashboard.niggli.body": "Keep the plan view centered on open work, completed steps, and evidence files.",
  "session.dashboard.niggli.pending": "Open steps",
  "session.dashboard.niggli.done": "Closed steps",
  "session.dashboard.niggli.files": "Evidence files",
  "bugReport.trigger": "Agent reports",
  "bugReport.tooltip": "View agent bug reports, suggestions, and feature requests",
