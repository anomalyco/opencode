export const dict = {
  ...
  "pr.create.field.body": "Description",
  ...
  "pr.commit.warning": "{{count}} uncommitted changes",
  "pr.commit.action": "Commit changes",
  "pr.commit.placeholder": "Commit message",
  "pr.commit.submit": "Commit",
  "pr.commit.committing": "Committing...",
  "pr.commit.success": "Changes committed",
  "pr.commit.requiredHint": "Commit your changes before creating a PR",
  "pr.comments.title": "Address Review Comments",
  "pr.comments.count": "{{count}} unresolved comments",
  "pr.comments.count.one": "1 unresolved comment",
  "pr.comments.selected": "{{selected}} of {{total}} selected",
  "pr.comments.none": "No unresolved comments",
  "pr.comments.error.title": "Unable to fetch comments",
  ...
  "pr.toast.created": "Pull request created",
  "pr.error.gh_not_installed": "GitHub CLI (gh) is not installed",
  "pr.error.gh_not_authenticated": "Run `gh auth login` to authenticate",
  "pr.error.upstream_missing": "Push your branch first",
  "pr.error.create_failed": "Failed to create pull request",
  "pr.error.no_pr": "No pull request found",
  "pr.error.comments_fetch_failed": "Failed to fetch review comments",
  "pr.menu.merge": "Merge Pull Request",
  "pr.menu.ready": "Mark as ready for review",
  "pr.menu.delete_branch": "Delete Branch",
  "pr.merge.title": "Merge Pull Request",
  "pr.merge.strategy": "Merge Strategy",
  "pr.merge.strategy.squash": "Squash and merge",
  "pr.merge.strategy.merge": "Create a merge commit",
  "pr.merge.strategy.rebase": "Rebase and merge",
  "pr.merge.delete_branch": "Delete branch after merge",
  ...
  "pr.toast.branch_deleted": "Branch deleted",
