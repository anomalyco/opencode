export const dict = {
  ...
  "command.preview.refresh": "Refresh preview",
  "command.preview.openExternal": "Open preview in new window",
  ...
  "preview.empty": "Set a preview URL in settings to display your web app here",
  "preview.url.label": "Preview URL",
  "preview.url.placeholder": "http://localhost:3000",
  ...
  "settings.general.row.showPreview.title": "Show preview toggle",
  "settings.general.row.showPreview.description": "Show the web app preview toggle in the session title bar",
  "settings.general.row.previewUrl.description": "The URL rendered inside the preview panel",
