export const dict = {
  ...
  "command.session.rename.description": "Change the current session title",
  ...
  "dialog.session.rename.name": "Session name",
  "dialog.session.rename.error.empty": "Enter a session name.",
  "dialog.session.rename.failed.title": "Failed to rename session",
  ...
  "settings.general.background.image.title": "Background image",
  "settings.general.background.image.description": "Choose a local image to display over the app background",
  "settings.general.background.choose": "Choose image",
  "settings.general.background.choose.title": "Choose background image",
  "settings.general.background.clear": "Clear",
  "settings.general.background.enabled.title": "Show background image",
  "settings.general.background.enabled.description": "Display the selected image as a subtle app background",
  "settings.general.background.fit.title": "Background layout",
  "settings.general.background.fit.description": "Choose how the background image is drawn",
  "settings.general.background.fit.cover": "Cover",
  "settings.general.background.fit.contain": "Contain",
  "settings.general.background.fit.repeat": "Repeat",
  "settings.general.background.opacity.title": "Background opacity",
  "settings.general.background.blur.title": "Background blur",
  ...
  "dialog.archivedSessions.menu": "Archived sessions",
  ...
  "dialog.archivedSessions.delete": "Delete permanently",
  "dialog.archivedSessions.delete.confirm": 'Permanently delete session "{{name}}"?',
  "dialog.archivedSessions.loadFailed.title": "Failed to load archived sessions",
  "dialog.archivedSessions.restoreFailed.title": "Failed to restore session",
  "settings.general.row.archivedSessions.title": "Archived sessions",
  "settings.general.row.archivedSessions.description": "Review archived sessions and restore or permanently delete them.",
  "settings.general.row.archivedSessions.action": "Manage",
