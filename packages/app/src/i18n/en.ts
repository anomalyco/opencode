export const dict = {
  ...
  "command.model.provider.cycle": "Cycle Copilot account",
  "command.model.provider.cycle.description": "Switch to the next Copilot subscription",
  ...
  "settings.providers.addAccount": "Add account",
