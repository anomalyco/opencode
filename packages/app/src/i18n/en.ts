export const dict = {
  ...
  "prompt.slash.badge.workflow": "workflow",
  ...
  // Ultracode + workflows
  "command.ultracode.enable": "Ultracode: turn on",
  "command.ultracode.disable": "Ultracode: turn off",
  "toast.ultracode.on.title": "Ultracode ON",
  "toast.ultracode.on.description": "Workflows will be planned and run by default this session.",
  "toast.ultracode.on.descriptionBoosted":
    "Workflows will be planned and run by default this session (reasoning boosted to {{boost}}).",
  "toast.ultracode.off.title": "Ultracode OFF",
  "toast.ultracode.off.description": "Back to working turn by turn.",
  "command.workflow.start": "Start a workflow",
  "command.workflow.dashboard": "Open workflows",

  "dialog.workflow.title": "Workflows",
  "dialog.workflow.description": "{{count}} runs",
  "dialog.workflow.empty": "No workflow runs yet. Start one with /workflow <name>.",
  "dialog.workflow.section.phases": "Phases",
  "dialog.workflow.section.agents": "Agents",
  "dialog.workflow.section.result": "Result",
  "dialog.workflow.section.usage": "Usage",
  "dialog.workflow.section.logs": "Logs",
  "dialog.workflow.logs.earlier": "… {{count}} earlier entries",
  "dialog.workflow.status.running": "running",
  "dialog.workflow.status.completed": "completed",
  "dialog.workflow.status.failed": "failed",
  "dialog.workflow.status.cancelled": "cancelled",
  "dialog.workflow.status.interrupted": "interrupted",
  "dialog.workflow.status.paused": "paused",
  "dialog.workflow.action.pause": "Pause",
  "dialog.workflow.action.resume": "Resume",
  "dialog.workflow.action.cancel": "Cancel",
  "dialog.workflow.action.answer": "Answer",
  "dialog.workflow.action.save": "Save as command",
  "dialog.workflow.action.delete": "Delete",
  "dialog.workflow.action.copy": "Copy",
  "dialog.workflow.action.rerun": "Re-run",
  "dialog.workflow.agent.openSession": "Open agent session",
  "dialog.workflow.delete.title": "Delete workflow run",
  "dialog.workflow.delete.text": "Delete run {{id}} ({{name}}) from history? This cannot be undone.",
  "dialog.workflow.delete.confirm": "Delete",
  "dialog.workflow.save.noSource": "This run has no captured source to save.",
  "dialog.workflow.save.title": "Save workflow as command",
  "dialog.workflow.save.description": "Write this run's source as a reusable /<name> workflow.",
  "dialog.workflow.save.placeholder": "workflow-name",
  "dialog.workflow.save.scope.project": "Project",
  "dialog.workflow.save.scope.global": "Global",
  "dialog.workflow.usage.total": "Total cost: ${{cost}}",
  "dialog.workflow.detail.empty": "Select a run to see details.",
  "dialog.workflow.detail.noResult": "No result yet.",
  "dialog.workflow.detail.noAgents": "No agents have run yet.",

  "dialog.workflow.question.title": "Workflow question",
  "dialog.workflow.question.placeholder": "Type your answer…",

  "dialog.workflow.approval.title": "Start workflow: {{name}}",
  "dialog.workflow.approval.whenToUse": "When to use: {{text}}",
  "dialog.workflow.approval.arguments": "Arguments",
  "dialog.workflow.approval.noPhases": "(none declared)",
  "dialog.workflow.approval.noSource": "No source recorded.",
  "dialog.workflow.approval.view": "View script",
  "dialog.workflow.approval.back": "Back to approval",
  "dialog.workflow.approval.yes": "Yes",
  "dialog.workflow.approval.always": "Yes, always",
  ...
  "toast.workflow.pause.failed.title": "Could not pause run",
  "toast.workflow.resume.failed.title": "Could not resume run",
  "toast.workflow.resumed.title": "Workflow resumed",
  "toast.workflow.resumed.description": "Resumed {{name}} as a new run.",
  "toast.workflow.cancel.failed.title": "Could not cancel run",
  "toast.workflow.delete.ok.title": "Deleted workflow {{id}}",
  "toast.workflow.delete.alreadyGone.title": "Workflow {{id}} already gone",
  "toast.workflow.delete.failed.title": "Could not delete run",
  "toast.workflow.copy.ok.title": "Workflow response copied to clipboard",
  "toast.workflow.copy.failed.title": "Failed to copy workflow response",
  "toast.workflow.answer.failed.title": "Could not submit answer",
  "toast.workflow.answer.notFound.description": "That run no longer exists.",
  "toast.workflow.answer.noQuestion.description": "That run is not waiting for an answer.",
  "toast.workflow.save.ok.title": "Workflow saved",
  "toast.workflow.save.ok.description": "Saved {{name}} as a command.",
  "toast.workflow.save.conflict.title": "Workflow already exists",
  "toast.workflow.save.conflict.description": "A workflow named {{name}} already exists at this destination.",
  "toast.workflow.save.invalidName.title": "Invalid workflow",
  "toast.workflow.save.failed.title": "Could not save workflow",
  "toast.workflow.finished.title": "Workflow {{name}} finished",
  "notification.workflow.finished.title": "Workflow finished",
}
