export const dict = {
  ...
  "settings.general.notifications.push.devices.item.label": "Device label",
  "settings.general.notifications.push.devices.item.muted": "Push delivery is muted for this device.",
  ...
  "settings.general.notifications.push.devices.action.mute": "Mute",
  ...
  "settings.general.notifications.push.devices.action.save": "Save",
  "settings.general.notifications.push.devices.action.saving": "Saving...",
  "settings.general.notifications.push.devices.action.unmute": "Unmute",
  "settings.general.notifications.push.devices.toast.muted.title": "Device muted",
  "settings.general.notifications.push.devices.toast.muted.description":
    "That device will stay registered, but it will stop receiving push notifications.",
  "settings.general.notifications.push.devices.toast.saved.title": "Device updated",
  "settings.general.notifications.push.devices.toast.saved.description": "The device label has been updated.",
  "settings.general.notifications.push.devices.toast.saveFailed": "Failed to update that device label.",
  "settings.general.notifications.push.devices.toast.toggleFailed": "Failed to update that device's delivery state.",
  ...
  "settings.general.notifications.push.devices.toast.unmuted.title": "Device unmuted",
  "settings.general.notifications.push.devices.toast.unmuted.description":
    "That device can receive push notifications again.",
