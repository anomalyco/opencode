...
export const dict = {
  ...
  "ssh.server.add": "Add SSH connection",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH connection",
  "ssh.server.retryStart": "Retry start",
  "ssh.server.updating": "Updating...",
  "ssh.server.viewErrors": "View errors",
  "ssh.server.errorLog.title": "SSH connection error",
  "ssh.server.status.authenticating": "Authenticating...",
  "ssh.server.status.installing": "Installing OpenCode...",
  "ssh.server.status.starting": "Starting server...",
  "ssh.server.status.failed": "Connection failed",
  "ssh.server.status.stopped": "Stopped",
  "ssh.dialog.add.title": "Add SSH connection",
  "ssh.dialog.add.name": "Name",
  "ssh.dialog.add.namePlaceholder": "My server",
  "ssh.dialog.add.host": "SSH host",
  "ssh.dialog.add.hostPlaceholder": "user@hostname",
  "ssh.dialog.add.port": "Port (optional)",
  "ssh.dialog.add.portPlaceholder": "22",
  "ssh.dialog.add.identityFile": "Identity file (optional)",
  "ssh.dialog.add.identityFilePlaceholder": "~/.ssh/id_rsa",
  "ssh.dialog.add.identityFileBrowse": "Browse...",
  "ssh.dialog.edit.title": "Edit SSH connection",
