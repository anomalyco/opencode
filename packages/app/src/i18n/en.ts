export const dict = {
  ...
  "command.todo.toggle": "Toggle todo panel",
  ...
  "sidebar.issue.title": "Todos",
  "sidebar.issue.add": "Add Todo",
  "sidebar.issue.addSubtodo": "Add sub-todo",
  "sidebar.issue.empty": "No todos yet",
  "sidebar.issue.collapse": "Collapse sub-todos",
  "sidebar.issue.expand": "Expand sub-todos",
  "sidebar.issue.confirmDeleteWithChildren": "Delete this todo and its {{count}} sub-todos?",
  "sidebar.issue.toast.deleteFailed": "Failed to delete todo",
  "sidebar.issue.toast.archiveFailed": "Failed to archive todo",
  "sidebar.issue.toast.reorderFailed": "Failed to reorder todo",
  "sidebar.issue.toast.reparentFailed": "Failed to move todo",
  "sidebar.issue.tooltip.archive": "Archive this todo",
  "sidebar.issue.tooltip.delete": "Delete this todo",
  "sidebar.issue.confirmArchive": "Archive",
  "sidebar.issue.archivedBadge": "Archived",
  "sidebar.issue.archiveArea.title": "Archived",
  "sidebar.issue.archiveArea.expand": "Show archived",
  "sidebar.issue.archiveArea.collapse": "Hide archived",
  "sidebar.issue.archiveArea.empty": "No archived todos",
  "sidebar.issue.tooltip.cycleStatus": "Cycle status",
  "sidebar.issue.tooltip.cyclePriority": "Cycle priority",
  "sidebar.issue.tooltip.linkedLinear": "Linked to Linear",
  ...
  "sidebar.linear.connected": "Connected",
  "sidebar.linear.management": "Manage Linear binding",
  "sidebar.linear.management.teamRequired": "Please select a team",
  "sidebar.linear.management.projectRequired": "Please select a project",
  "sidebar.linear.management.saveFailed": "Failed to save Linear binding",
  "sidebar.linear.management.saved": "Linear binding saved",
  "sidebar.linear.management.save": "Save",
  "sidebar.linear.toggleHistory": "Toggle sync history",
  "sidebar.linear.field.team": "Team",
  "sidebar.linear.field.team.loading": "Loading teams...",
  "sidebar.linear.field.team.placeholder": "Select a team",
  "sidebar.linear.field.project": "Project",
  "sidebar.linear.field.project.selectTeamFirst": "Select a team first",
  "sidebar.linear.field.project.loading": "Loading projects...",
  "sidebar.linear.field.project.placeholder": "Select a project",
  "sidebar.linear.notConfigured": "Linear not configured",
  "sidebar.linear.notConfiguredHint": "Open management to select a team and project",
  "sidebar.linear.actions": "Sync actions",
  "sidebar.linear.push": "Push",
  "sidebar.linear.pull": "Pull",
  "sidebar.linear.pullHint": "Pull from Linear. Note: hierarchy changes made on Linear (reparenting, parent removal) are not synced locally — only field values are reconciled.",
  "sidebar.linear.pullFailed": "Failed to pull from Linear",
  "sidebar.linear.pullPartialFailed": "Pull partially failed: {{count}} error(s)",
  "sidebar.linear.pullSuccess": "Pulled {{pulled}}, updated {{updated}}, skipped {{skipped}}, deleted {{deleted}}",
  "sidebar.linear.pushFailed": "Failed to push to Linear",
  "sidebar.linear.pushPartialFailed": "Push partially failed: {{count}} error(s)",
  "sidebar.linear.pushSuccess": "Pushed {{count}} todo(s) to Linear",
  "sidebar.linear.pushNothing": "Nothing to push",
  "sidebar.linear.syncHistory.syncing": "Syncing...",
  "sidebar.linear.syncHistory.error": "Error",
  "sidebar.linear.syncHistory.empty": "No sync history",

  "dialog.todo.title.create": "New Todo",
  "dialog.todo.title.edit": "Edit Todo",
  "dialog.todo.field.title": "Title",
  "dialog.todo.field.title.placeholder": "Todo title",
  "dialog.todo.field.description": "Description",
  "dialog.todo.field.description.placeholder": "Add details, links, or context...",
  "dialog.todo.field.description.hint": "Supports file and skill references",
  "dialog.todo.field.status": "Status",
  "dialog.todo.field.priority": "Priority",
  "dialog.todo.field.dueDate": "Due date",
  "dialog.todo.field.dueDate.placeholder": "Set due date",
  "dialog.todo.field.dueDate.clear": "Clear",
  "dialog.todo.field.dueDate.prevMonth": "Previous month",
  "dialog.todo.field.dueDate.nextMonth": "Next month",
  "dialog.todo.field.dueDate.shortcut.today": "Today",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Tomorrow",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "In one week",
  ...
  "dialog.todo.field.labels": "Labels",
  "dialog.todo.field.assignee": "Assignee",
  "dialog.todo.field.assignee.unassigned": "Unassigned",
  "dialog.todo.field.assignee.loadFailed": "Failed to load assignees",
  "dialog.todo.field.assignee.loading": "Loading assignees...",
  "dialog.todo.field.assignee.placeholder": "Select an assignee",
  "dialog.todo.field.assignee.hint": "Sourced from Linear team members",
  "dialog.todo.linkedLinear": "Linked to Linear",
  "dialog.todo.created": "Todo created",
  "dialog.todo.updated": "Todo updated",
  "dialog.todo.error.titleRequired": "Title is required",
  "dialog.todo.error.saveFailed": "Failed to save todo",
  "dialog.todo.action.create": "Create",
