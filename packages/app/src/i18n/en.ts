...
export const dict = {
  ...
  "dialog.provider.argus.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.argus.tagline": "Reliable optimized models",
  "dialog.provider.argusGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Argus",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Argus.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.argusZen.line1":
    "Argus Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.argusZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.argusZen.visit.prefix": "Visit ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Argus.",
  ...
  "dialog.plugins.empty": "Plugins configured in argus.json",
  ...
  "dialog.server.description": "Switch which Argus server this app connects to.",
  ...
  "wsl.onboarding.checkingArgus": "Checking Argus...",
  "wsl.onboarding.checkingArgusIn": "Checking Argus in {{distro}}...",
  "wsl.onboarding.updatingArgus": "Updating Argus...",
  "wsl.onboarding.updatingArgusIn": "Updating Argus in {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Update Argus in {{distro}}.",
  "wsl.onboarding.updateArgus": "Update Argus",
  "wsl.onboarding.argusReadyIn": "Argus is ready in {{distro}}.",
  "wsl.onboarding.argusReady": "Argus is ready.",
  "wsl.onboarding.installArgusIn": "Install Argus in {{distro}}.",
  "wsl.onboarding.installArgus": "Install Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Argus can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Argus could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Argus ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Argus team",
  ...
  "error.chain.checkConfig": "Check your config (argus.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Argus does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Argus includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Argus server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Argus",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Argus looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Argus follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Argus is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Argus launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Argus.",
