export const dict = {
  ...
  "playground.prompt.placeholder": "What do you want to build?",
  "playground.prompt.modify": "Modify {{title}}...",
  "playground.empty.title": "What do you want to build?",
  "playground.window.untitled": "Untitled",
  "playground.panel.chat": "Chat",
  "playground.panel.code": "Code",
  "playground.device.auto": "Auto",
  "playground.device.mobile": "Mobile",
  "playground.device.tablet": "Tablet",
  "playground.device.desktop": "Desktop",
  "playground.export.html": "Export as HTML",
  "playground.bridge.timeout": "Request timed out",
  "playground.bridge.rateLimit": "Too many concurrent requests",
  "command.playground.open": "Open Playground",
