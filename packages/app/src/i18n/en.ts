...
export const dict = {
  ...
  "dialog.provider.pencode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.pencode.tagline": "Reliable optimized models",
  "dialog.provider.pencodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Pencode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Pencode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.pencodeZen.line1":
    "Pencode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.pencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.pencodeZen.visit.prefix": "Visit ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Pencode.",
  ...
  "dialog.plugins.empty": "Plugins configured in pencode.json",
  ...
  "dialog.server.description": "Switch which Pencode server this app connects to.",
  ...
  "wsl.onboarding.checkingPencode": "Checking Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Checking Pencode in {{distro}}...",
  "wsl.onboarding.updatingPencode": "Updating Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Updating Pencode in {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Update Pencode in {{distro}}.",
  "wsl.onboarding.updatePencode": "Update Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode is ready in {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode is ready.",
  "wsl.onboarding.installPencodeIn": "Install Pencode in {{distro}}.",
  "wsl.onboarding.installPencode": "Install Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Pencode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Pencode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Pencode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Pencode team",
  ...
  "error.chain.checkConfig": "Check your config (pencode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Pencode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Pencode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Pencode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Pencode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Pencode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Pencode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Pencode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Pencode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Pencode.",
