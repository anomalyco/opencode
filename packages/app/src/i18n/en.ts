export const dict = {
  ...
  "settings.agents.description": "Configure LLM models for each AI Dev System agent. Changes apply globally across all projects.",
  "settings.agents.model": "Model",
  "settings.agents.selectModel": "Select model...",
  "settings.agents.temperature": "Temp",
