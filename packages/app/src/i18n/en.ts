...
export const dict = {
  ...
  "session.tab.reasoning": "Reasoning",
  ...
  "session.reasoning.empty": "No reasoning recorded yet",
  "session.reasoning.metadata": "Metadata",
  "session.reasoning.type.whyLoop": "Why Loop",
  "session.reasoning.type.thenLoop": "Then Loop",
  "session.reasoning.type.preAction": "Pre-action Check",
  "session.reasoning.type.hypothesisUpdate": "Hypothesis Update",
  "session.reasoning.type.eviScore": "EVI Score",
  "session.reasoning.type.counterfactual": "Counterfactual",
  "session.reasoning.type.selfConsistency": "Self-Consistency",
  "session.reasoning.type.temporalGuard": "Temporal Guard",
