...
export const dict = {
  ...
  "ssh.server.add": "Add SSH server",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH server",
  "ssh.server.retryStart": "Reconnect",
  "ssh.server.disconnect": "Disconnect",
  "ssh.server.openTerminal": "Open terminal",
  "ssh.server.updating": "Updating...",
  "ssh.server.status.connecting": "Connecting...",
  "ssh.server.status.disconnected": "Disconnected",
  "ssh.add.hostLabel": "SSH host",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Connects through your system ssh client, so hosts, keys, and agents from your SSH config work as usual.",
  "ssh.add.configHosts": "From your SSH config",
  "ssh.add.connect": "Connect",
  "ssh.add.checking": "Connecting...",
  "ssh.add.addServer": "Add server",
  "ssh.add.adding": "Adding...",
  "ssh.add.installOpencode": "Install opencode",
  "ssh.add.updateOpencode": "Update opencode",
  "ssh.add.installing": "Installing...",
  "ssh.add.status.unreachable": "Could not connect",
  "ssh.add.status.opencodeMissing": "opencode is not installed on this host",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} installed, desktop expects v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} found",
  "ssh.add.authHint":
    "Make sure key-based SSH authentication works for this host — run `ssh {{host}}` in a terminal to check.",
