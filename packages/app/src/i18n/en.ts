export const dict = {
  ...
  "dialog.project.create.title": "New Project",
  "dialog.project.create.name": "Project name",
  "dialog.project.create.name.placeholder": "my-project",
  "dialog.project.create.location": "Location",
  "dialog.project.create.browse": "Browse",
  "dialog.project.create.path.preview": "Will be created at",
  "dialog.project.create.submit": "Create project",
  "dialog.add.create": "Create new project",
  "dialog.add.create.description": "Start fresh with a new empty directory",
  "dialog.add.open": "Open existing directory",
  "dialog.add.open.description": "Browse and open a project on your filesystem",
  "dialog.add.title": "Add Project",
  ...
  "session.version.latest": "Latest",
  "session.version.opened": "Opened in workspace",
  "session.version.viewing": "Viewing only. Workspace is on {{target}}.",
  "session.version.open": "Open this version",
  "session.version.unknownTarget": "another branch",
  "session.version.readOnly": "You're viewing an older version. Create a new version to keep working.",
  "session.version.continue": "Continue from here",
  "session.version.createFailed.title": "Failed to create version",
  "session.version.selectFailed.title": "Failed to open version",
  ...
  "settings.pricing.status.grace": "Grace period",
  "settings.pricing.status.missing": "No license",
  "settings.pricing.status.invalid": "Invalid",
  "settings.pricing.status.expired": "Expired",
  "settings.pricing.status.checking": "Checking",
  "settings.pricing.state.active": "Verified and ready to use.",
  "settings.pricing.state.grace": "Temporary access is active while we retry verification.",
  "settings.pricing.state.missing": "Paste a valid license key to unlock the app.",
  "settings.pricing.state.invalid": "This license key isn't valid for this installation.",
  "settings.pricing.state.expired": "Your license has expired or can no longer be refreshed.",
  "settings.pricing.state.checking": "Checking your license status...",
  "settings.pricing.row.license.title": "License",
  "settings.pricing.row.plan.title": "Plan",
  "settings.pricing.row.validated.title": "Last validated",
  "settings.pricing.row.expires.title": "Expires",
  "settings.pricing.row.grace.title": "Grace until",
  "settings.pricing.form.key.label": "License key",
  "settings.pricing.form.key.description": "Paste the key issued by your billing service.",
  "settings.pricing.form.key.placeholder": "XXXX-XXXX-XXXX-XXXX",
  "settings.pricing.form.key.required": "Enter a license key",
  "settings.pricing.action.activate": "Activate license",
  "settings.pricing.action.update": "Update license",
  "settings.pricing.action.refresh": "Refresh status",
  "settings.pricing.action.remove": "Remove license",
  "settings.pricing.toast.activated.title": "License activated",
  "settings.pricing.toast.activated.description": "This installation now has access to OpenCode.",
  "settings.pricing.toast.removed.title": "License removed",
  "settings.pricing.toast.removed.description": "This installation is locked until a valid license is added again.",
  "settings.pricing.toast.refreshed.title": "License refreshed",
  "settings.pricing.toast.refreshed.description": "Your cached license status is up to date.",
  "settings.pricing.error.generic": "We couldn't verify your license. Try again.",
  "license.gate.title": "Activate OpenCode",
  "license.gate.description": "A valid license key is required before you can use the app.",
