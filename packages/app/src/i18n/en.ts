export const dict = {
  ...
  "settings.general.row.followup.description": "Choose whether follow-up prompts halt and steer immediately, wait for the current step, or wait in a queue",
  "settings.general.row.followup.option.queue": "Queue",
  "settings.general.row.followup.option.wrap": "Wait and Steer",
  "settings.general.row.followup.option.steer": "Halt and Steer",
