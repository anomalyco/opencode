export const dict = {
  ...
  "provider.connect.xcshZen.line1":
    "xcsh Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.xcshZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.xcshZen.visit.prefix": "Visit ",
  "provider.connect.xcshZen.visit.link": "f5xc-salesdemos.github.io/xcsh/zen",
  "provider.connect.xcshZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in xcsh.json",
  ...
  "error.chain.checkConfig": "Check your config (xcsh.json) provider/model names",
