export const dict = {
  ...
  "command.model.quick.switch": "Quick switch models",
  "command.model.quick.switch.description": "Toggle to your other quick switch model",
  "command.model.quick.switch.reverse": "Quick switch models backwards",
  "command.model.quick.switch.reverse.description": "Toggle backwards between your two quick switch models",
  "command.model.quick.settings": "Open quick switch settings",
  "command.model.quick.settings.description": "Open Settings > Models to choose your quick switch pair",
  ...
  "toast.model.quick.none.title": "Quick switch is not ready",
  "toast.model.quick.none.description": "Choose two enabled models in Settings > Models under Quick Switch.",
  ...
  "settings.models.description": "Choose which models are enabled and set the pair used for quick switching.",
  "settings.models.quick.title": "Quick Switch",
  "settings.models.quick.first.title": "First model",
  "settings.models.quick.first.description": "Pick one of the two enabled models in your quick switch pair",
  "settings.models.quick.second.title": "Second model",
  "settings.models.quick.second.description": "Pick the other enabled model used by the quick switch commands",
