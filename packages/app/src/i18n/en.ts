export const dict = {
  ...
  "command.project.reload": "Reload config",
  "command.project.reload.description": "Reload config, skills, plugins, agents, and commands from disk",
  ...
  "command.session.find.description": "Search text in the current session",
  "session.find.placeholder": "Find in session",
  "session.find.count": "{{current}} of {{total}}",
  "session.find.none": "No results",
  "session.find.prev": "Previous match",
  "session.find.next": "Next match",
  "session.find.close": "Close find",
  ...
  "command.session.exportTransfer": "Export transfer bundle",
  "command.session.exportTransfer.description": "Export a full session bundle for device migration",
  "command.session.importTransfer": "Import transfer bundle",
  "command.session.importTransfer.description": "Import a session bundle from another device",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Basalt",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Basalt.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Basalt Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Basalt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Basalt.",
  ...
  "session.children.open": "Child sessions",
  "command.session.children": "Child sessions",
  "command.session.children.description": "Browse and open child sessions from this session",
  "dialog.childSessions.title": "Child sessions",
  "dialog.childSessions.description": "{{count}} child sessions",
  "dialog.childSessions.empty": "No child sessions",
  ...
  "dialog.skills.scope.cloud": "Cloud",
  ...
  "dialog.skills.empty.cloud": "No cloud skills",
  ...
  "dialog.skills.cloud.repository": "Git repository",
  "dialog.skills.cloud.repository.description":
    "SSH repositories use the deploy key from Settings > Deploy; grant it write access to sync.",
  "dialog.skills.cloud.repository.placeholder": "git@github.com:owner/skills.git",
  "dialog.skills.cloud.connect": "Connect",
  "dialog.skills.cloud.save": "Save",
  "dialog.skills.cloud.update": "Update",
  "dialog.skills.cloud.sync": "Sync",
  "dialog.skills.cloud.edit": "Edit repository",
  "dialog.skills.cloud.add": "Add repository",
  "dialog.skills.cloud.updateAll": "Update all",
  "dialog.skills.cloud.name": "Name",
  "dialog.skills.cloud.name.placeholder": "Repository name (optional)",
  "dialog.skills.cloud.delete.title": "Remove repository",
  "dialog.skills.cloud.delete.confirm": "Remove cloud repository \"{{name}}\"?",
  "dialog.skills.cloud.empty": "No cloud skill repositories configured",
  "dialog.skills.cloud.toast.deleted": "Cloud repository removed",
  "dialog.skills.cloud.error": "Cloud skill operation failed",
  "dialog.skills.cloud.sdkRestart": "Restart the Desktop dev server to load the regenerated SDK",
  "dialog.skills.cloud.state.unconfigured": "Not connected",
  "dialog.skills.cloud.state.ready": "Up to date",
  "dialog.skills.cloud.state.modified": "Local changes",
  "dialog.skills.cloud.state.ahead": "Waiting to sync",
  "dialog.skills.cloud.state.behind": "Update available",
  "dialog.skills.cloud.state.diverged": "Needs reconciliation",
  "dialog.skills.cloud.changes": "{{count}} changed",
  "dialog.skills.cloud.ahead": "{{count}} ahead",
  "dialog.skills.cloud.behind": "{{count}} behind",
  ...
  "dialog.server.description": "Switch which Basalt server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Basalt...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Basalt in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Basalt...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Basalt in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Basalt in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Basalt",
  "wsl.onboarding.opencodeReadyIn": "Basalt is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Basalt is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Basalt in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Basalt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Basalt not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Basalt can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Basalt could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Basalt.",
  ...
  "context.breakdown.detail.text": "Text · {{tokens}} tokens",
  "context.breakdown.detail.reasoning": "Reasoning · {{tokens}} tokens",
  "context.breakdown.detail.file": "Files · {{tokens}} tokens ({{count}})",
  "context.breakdown.detail.agent": "Agents · {{tokens}} tokens ({{count}})",
  "context.breakdown.detail.subtask": "Subtasks · {{tokens}} tokens ({{count}})",
  "context.breakdown.detail.tool": "{{name}} · {{tokens}} tokens ({{count}})",
  "context.breakdown.detail.messages": "{{count}} messages",
  "context.breakdown.detail.parts": "{{count}} parts",
  "context.breakdown.detail.overhead": "Tool definitions and protocol overhead",
  "context.breakdown.prompts.title": "Prompt distribution",
  "context.breakdown.prompts.empty": "No prompt content estimated",
  "context.breakdown.tools.title": "Tool distribution",
  "context.breakdown.tools.empty": "No tool calls in context",
  "context.breakdown.share.system": "System · {{name}}",
  "context.breakdown.share.system.base": "Built-in template",
  "context.breakdown.share.system.env": "Environment",
  "context.breakdown.share.system.references": "Project references",
  "context.breakdown.share.system.mcp": "MCP instructions",
  "context.breakdown.share.system.skills": "Skills list",
  "context.breakdown.share.system.todo": "Todo list",
  "context.breakdown.share.system.instruction": "Instruction · {{name}}",
  "context.breakdown.share.agent": "Agent attachments",
  "context.breakdown.share.user": "User text",
  "context.breakdown.share.synthetic": "Synthetic / injected",
  "context.breakdown.share.file": "File attachments",
  "context.breakdown.share.subtask": "Subtasks",
  "context.breakdown.share.assistant": "Assistant text",
  "context.breakdown.share.reasoning": "Reasoning",
  "context.breakdown.share.overhead": "Overhead",
  "context.breakdown.share.count": "×{{count}}",
  "context.breakdown.share.fact.chars": "{{value}} chars",
  "context.breakdown.share.fact.messages": "{{value}} messages",
  "context.breakdown.share.fact.parts": "{{value}} parts",
  "context.breakdown.share.fact.calls": "{{value}} calls",
  "context.breakdown.share.fact.input": "input {{tokens}}",
  "context.breakdown.share.fact.output": "output {{tokens}}",
  "context.breakdown.share.fact.error": "error {{tokens}}",
  "context.breakdown.share.fact.preview": "{{text}}",

  "context.systemPrompt.title": "System Prompt",
  "context.rawMessages.title": "Raw messages",
  "context.rawMessages.role.user": "User",
  "context.rawMessages.role.assistant": "Assistant",
  "context.rawMessages.preview.empty": "No content",
  "context.rawMessages.preview.parts": "{{count}} parts",
  "context.rawMessages.summary": "{{parts}} parts · {{texts}} text · {{tools}} tools · {{files}} files",
  "context.rawMessages.copy": "Copy JSON",
  ...
  "context.stats.requestBody": "Request Body",
  ...
  "toast.project.reload.success.title": "Config reloaded",
  "toast.project.reload.success.description": "Config, skills, and plugins reloaded for {{project}}",

  "toast.update.title": "Update available",
  "toast.update.description": "A new version of Basalt ({{version}}) is now available to install.",
  ...
  "error.page.action.dismiss": "Continue",
  ...
  "error.page.report.prefix": "Please report this error to the Basalt team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Basalt does not support MCP authentication yet.',
  ...
  "notification.goal.complete.title": "Goal complete",
  ...
  "command.session.goal": "Start goal",
  "command.session.goal.description": "Run autonomously until a verified outcome is reached",
  "goal.toast.queueBlocked.title": "Wait for the current turn",
  "goal.toast.queueBlocked.description": "Start the goal after the current response finishes.",
  "goal.toast.objectiveRequired.title": "Goal required",
  "goal.toast.objectiveRequired.description": "Add an objective after /goal.",
  "goal.toast.createSuccess.title": "Goal started",
  "goal.toast.createSuccess.description": "Basalt will continue until the goal is complete, paused, or limited.",
  "goal.toast.conflict.title": "A goal already exists",
  "goal.toast.conflict.description": "Complete or clear the current goal before starting another.",
  "goal.toast.createFailed.title": "Failed to start goal",
  "goal.toast.pauseSuccess.title": "Goal paused",
  "goal.toast.pauseFailed.title": "Failed to pause goal",
  "goal.toast.resumeSuccess.title": "Goal resumed",
  "goal.toast.resumeFailed.title": "Failed to resume goal",
  "goal.toast.wakeSuccess.title": "Goal restarted",
  "goal.toast.wakeFailed.title": "Failed to restart goal",
  "goal.toast.clearSuccess.title": "Goal cleared",
  "goal.toast.clearFailed.title": "Failed to clear goal",
  "goal.toast.budgetUpdated.title": "Goal budget updated",
  "goal.toast.budgetFailed.title": "Failed to update budget",
  "goal.toast.lessonDisabled.title": "Lesson disabled",
  ...
  "goal.dock.status.complete": "Complete",
  "goal.dock.status.blocked": "Blocked",
  "goal.dock.status.budgetLimited": "Budget limited",
  "goal.dock.status.usageLimited": "Usage limited",
  "goal.dock.contextTokens": "Context {{tokens}}",
  "goal.dock.tokensUnlimited": "Cumulative {{used}}",
  "goal.dock.tokensUsed": "Budget {{used}} / {{budget}}",
  "goal.dock.seconds": "{{value}}s",
  "goal.dock.minutes": "{{value}}m",
  "goal.dock.lessonsCount": "{{count}} lessons",
  "goal.dock.loadFailed": "Could not load the goal.",
  "goal.dock.refreshFailed": "Goal refresh failed; showing the last known state.",
  "goal.dock.retry": "Retry",
  "goal.dock.pause": "Pause",
  "goal.dock.resume": "Resume",
  "goal.dock.wake": "Wake",
  "goal.dock.budget": "Budget",
  "goal.dock.budgetHint": "Increase or clear the budget to continue.",
  "goal.dock.clear": "Clear",
  "goal.dock.clearConfirm.title": "Clear goal?",
  "goal.dock.clearConfirm.description": "This also deletes the goal's lessons and usage history.",
  "goal.dock.contract": "Contract",
  "goal.dock.outcome": "Outcome",
  "goal.dock.verification": "Verification",
  "goal.dock.constraints": "Constraints",
  "goal.dock.boundaries": "Boundaries",
  "goal.dock.iterationPolicy": "Iteration policy",
  "goal.dock.blockedCondition": "Blocked condition",
  "goal.dock.lessons": "Lessons",
  "goal.dock.lesson.disabled": "Disabled",
  "goal.dock.lesson.disable": "Disable",
  ...
  "goal.budget.invalid": "Enter a positive whole number.",
  "goal.budget.clear": "No limit",
  ...
  "dialog.run.title": "Edit run scripts",
  "dialog.run.description": "Edit the scripts saved in .opencode/run.json.",
  "dialog.run.invalid": "Each script needs a unique name and a command.",
  "dialog.run.saveFailed": "Failed to save scripts. Please try again.",
  "dialog.run.openFile": "Open file",
  "dialog.run.name": "Name",
  "dialog.run.namePlaceholder": "build-windows",
  "dialog.run.command": "Command",
  "dialog.run.commandPlaceholder": "bun ./script/build-windows.ts",
  "dialog.run.add": "Add script",
  "dialog.run.remove": "Remove script",
  ...
  "session.export.action.response": "Export last response",
  "session.export.action.transfer": "Export transfer bundle",
  ...
  "session.import.toast.success.title": "Session imported",
  "session.import.toast.failed.title": "Failed to import session",
  ...
  "sidebar.gettingStarted.line1": "Basalt includes free models so you can start immediately.",
  ...
  "sidebar.project.importTransfer": "Import transfer bundle",
  ...
  "settings.instructions.copy": "Copy",
  "settings.instructions.copied": "Copied",
  "settings.instructions.openFile": "Open file",
  "settings.prompts.search.placeholder": "Search prompts…",
  "settings.prompts.search.empty": "No prompts match",
  "settings.prompts.select": "Select a prompt to edit",
  "settings.prompts.badge.overridden": "Custom",
  "settings.prompts.editor.label": "Prompt content",
  "settings.prompts.editor.loading": "Loading prompt…",
  "settings.prompts.action.save": "Save",
  "settings.prompts.action.saving": "Saving…",
  "settings.prompts.action.reset": "Reset to default",
  "settings.prompts.toast.saved.title": "Prompt saved",
  "settings.prompts.toast.saved.description": "Saved override for {{title}}",
  "settings.prompts.toast.reset.title": "Prompt reset",
  "settings.prompts.toast.reset.description": "Restored built-in default for {{title}}",
  "settings.prompts.group.system": "System",
  "settings.prompts.group.agent": "Agent",
  "settings.prompts.group.session": "Session",
  "settings.prompts.group.tool": "Tool",
  "settings.prompts.group.command": "Command",
  "settings.prompts.group.compaction": "Compaction",
  "settings.prompts.group.runtime": "Runtime",
  "settings.database.loading": "Loading database info…",
  "settings.database.unavailable": "Database info is unavailable for this server.",
  "settings.database.section.storage": "Storage paths",
  "settings.database.section.stats": "Database stats",
  "settings.database.section.tables": "Tables",
  "settings.database.section.breakdown": "What's using space",
  "settings.database.breakdown.description":
    "Top-level contents of the data directory, sorted by size. This is where large SQLite files, WAL, tool-output, and installed tools live.",
  "settings.database.breakdown.total": "Data directory total",
  "settings.database.breakdown.activeDb": "Active SQLite footprint (db + wal + shm)",
  "settings.database.breakdown.empty": "No data directory entries found",
  "settings.database.breakdown.kind.directory": "Directory",
  "settings.database.breakdown.kind.file": "File",
  "settings.database.section.tableRows": "SQLite table rows",
  "settings.database.tableRows.description":
    "Row counts for the active database. Large message/part/event tables usually explain most of the SQLite file size.",
  "settings.database.row.dbPath.title": "SQLite database",
  "settings.database.row.dataDir.title": "Data directory",
  "settings.database.row.configDir.title": "Config directory",
  "settings.database.row.logDir.title": "Log directory",
  "settings.database.row.cacheDir.title": "Cache directory",
  "settings.database.row.size.title": "Database file size",
  "settings.database.row.walSize.title": "WAL file size",
  "settings.database.row.totalSize.title": "Total size (db + wal + shm)",
  "settings.database.row.journalMode.title": "Journal mode",
  "settings.database.row.pageCount.title": "Page count",
  "settings.database.row.pageSize.title": "Page size",
  "settings.database.row.freelist.title": "Freelist pages",
  "settings.database.tables.empty": "No tables found",
  "settings.database.tables.rows": "{{count}} rows",
  "settings.database.tables.rowsUnknown": "—",
  "settings.database.action.copy": "Copy",
  "settings.database.action.copied": "Copied",
  "settings.database.action.reveal": "Reveal",
  ...
  "settings.database.compact.action.checkpoint.description":
    "Flush and truncate the write-ahead log so temporary WAL growth is released.",
  "settings.database.compact.action.vacuum": "VACUUM database",
  "settings.database.compact.action.vacuum.description":
    "Compact freelist pages into a smaller database file. May pause briefly and needs temporary disk space.",
  "settings.database.compact.action.toolOutput": "Delete expired tool-output",
  "settings.database.compact.action.toolOutput.description":
    "Remove managed tool-output files older than {{days}} days. Session history is kept.",
  "settings.database.compact.action.toolOutput.detail":
    "Delete {{count}} tool-output files ({{size}}) older than {{days}} days",
  ...
  "settings.database.compact.confirm.body": "Run only the actions listed below?",
  ...
  "settings.desktop.wsl.description": "Run the Basalt server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Basalt",
  ...
  "settings.general.row.appearance.description": "Customise how Basalt looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Basalt follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Basalt is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Basalt launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Basalt.",
  ...
  "settings.deploy.title": "Deploy key",
  "settings.deploy.description": "The server-wide SSH identity managed by Basalt.",
  "settings.deploy.publicKey.title": "SSH public key",
  "settings.deploy.publicKey.description":
    "Add this public key to a repository or host. Basalt keeps the private key on this server and reuses it across restarts.",
  "settings.deploy.privateKeyPath": "Private key location",
  "settings.deploy.publicKeyPath": "Public key location",
  "settings.deploy.loading": "Loading deploy key…",
  "settings.deploy.unavailable": "The deploy key is unavailable on this server.",
  "settings.deploy.copy": "Copy public key",
  "settings.deploy.copied": "Copied",
  "settings.deploy.retry": "Retry",
  "settings.deploy.toast.copyFailed.title": "Failed to copy public key",
