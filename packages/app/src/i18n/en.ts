export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in IMECODE.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in IMECODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in IMECODE.",
  ...
  "dialog.server.description": "Switch which IMECODE server this app connects to.",
  ...
  "toast.update.description": "A new version of IMECODE ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the IMECODE team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, IMECODE does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "IMECODE includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the IMECODE server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for IMECODE",
  ...
  "settings.general.row.appearance.description": "Customise how IMECODE looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether IMECODE follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how IMECODE is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when IMECODE launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of IMECODE.",
