...
export const dict = {
  ...
  "settings.mods.title": "MODs",
  "settings.mods.openFolder": "Open folder",
  "settings.mods.refresh": "Refresh",
  "settings.mods.safeMode.title": "Safe mode",
  "settings.mods.safeMode.description": "Disable all MODs until MOD loading is enabled again.",
  "settings.mods.empty": "No MODs found in the MOD folder.",
  "settings.mods.versionPriority": "v{{version}} · Priority {{priority}}",
  "settings.mods.versionIncompatible": "v{{version}} · Incompatible with this OpenCode version",
  "settings.mods.conflict.title": "MOD load conflict",
  "settings.mods.conflict.description":
    "{{mod}} overlaps with enabled MOD contributions. The higher-priority MOD loads later and wins where load order can resolve the overlap.",
  "settings.mods.conflict.declared": "Declared conflict",
  "settings.mods.conflict.potential": "Potential conflict",
  "settings.mods.conflict.cancel": "Cancel",
  "settings.mods.conflict.repair": "Repair with AI",
  "settings.mods.conflict.keepPriority": "Keep existing priority",
  "settings.mods.conflict.prioritize": "Prioritize {{mod}}",
