export const dict = {
  ...
  "univer.insertChart.tooltip":
    "Open the Veritly chart preview for the current selection (ECharts). If nothing is selected, uses a small default data range.",
  "univer.insertChart.noWorkbook": "No active workbook.",
  "univer.insertChart.noSheet": "No active sheet.",
  "univer.insertChart.panelUnavailable": "Chart panel is not available (spreadsheet viewer not ready).",
  "univer.chartDock.title": "Chart preview",
  "univer.chartDock.close": "Close",
  "univer.chartDock.refresh": "Refresh from selection",
  "univer.chartDock.firstRowHeaders": "First row is headers",
  "univer.chartDock.kind": "Chart type",
  "univer.chartDock.kind.bar": "Bar",
  "univer.chartDock.kind.line": "Line",
  "univer.chartDock.kind.stack": "Stacked bar",
  "univer.chartDock.kind.pie": "Pie",
  "univer.chartDock.orientation": "Series layout",
  "univer.chartDock.orientation.cols": "Columns share the horizontal axis (categories in the first column)",
  "univer.chartDock.orientation.rows": "Rows share the horizontal axis (needs a header row for column names)",
  "univer.chartDock.noHost": "Spreadsheet host is not connected.",
