export const dict = {
  ...
  "presets.count": "{{count}} presets",
  "presets.empty": "No presets",
  "presets.empty.hint": "Click \"Add\" to create your first preset",
  "presets.add": "Add",
  "presets.name": "Name",
  "presets.content": "Content",
  "presets.content.placeholder": "Content (supports {date} {time} {file} {code} {text} variables)",
  "presets.moveUp": "Move up",
  "presets.moveDown": "Move down",
  "presets.edit": "Edit",
  "presets.delete": "Delete",
  "presets.variables.title": "Enter variables for \"{{name}}\"",
  "presets.variables.next": "Next",
  "presets.variables.insert": "Insert",
}
