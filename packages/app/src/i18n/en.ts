export const dict = {
  ...
  "status.button.tooltip": "View system status",
  "status.tab.servers.one": "{{count}} Server",
  "status.tab.servers.other": "{{count}} Servers",
  "status.tab.mcp.one": "{{count}} MCP",
  "status.tab.mcp.other": "{{count}} MCP",
  "status.tab.lsp.one": "{{count}} LSP",
  "status.tab.lsp.other": "{{count}} LSP",
  "status.tab.plugins.one": "{{count}} Plugin",
  "status.tab.plugins.other": "{{count}} Plugins",
  "status.servers.empty": "No servers configured",
  "status.servers.manage": "Manage servers",
  "status.mcp.empty": "No MCP servers configured",
  "status.lsp.empty": "No LSP servers active",
  "status.plugins.empty": "Plugins configured in 'opencode.json'",
  "status.noProject": "Open a project to view",
