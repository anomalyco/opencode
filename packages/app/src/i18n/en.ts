...
export const dict = {
  ...
  "session.tasks.running": "Running",
  "session.tasks.completed": "Completed",
  "session.tasks.kind.agent": "Agent",
  "session.tasks.kind.shell": "Shell",
  "session.tasks.state.running": "Running",
  "session.tasks.state.needsInput": "Needs input",
  "session.tasks.state.completed": "Completed",
  "session.tasks.state.failed": "Failed",
  "session.tasks.empty": "No background work running",
  "session.tasks.openTranscript": "Open transcript",
