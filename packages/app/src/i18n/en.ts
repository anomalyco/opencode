export const dict = {
  ...
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} item",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} items",
  ...
  "dialog.todo.autocomplete.noFiles": "No files found",
  "dialog.todo.autocomplete.noSkills": "No skills found",
