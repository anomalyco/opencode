export const dict = {
  ...
  "dialog.project.open.git.label": "Repository URL",
  "dialog.project.open.git.placeholder": "https://gitlab.com/group/repo.git",
  ...
  "dialog.project.open.path.browse": "Choose folder",
  "dialog.project.open.submit.git": "Clone and open",
  "dialog.project.open.submit.path": "Open project",
  "dialog.project.open.submit.cloning": "Cloning...",
  "dialog.project.open.submit.opening": "Opening...",
  "dialog.project.open.error.gitRequired": "Enter a Git repository URL",
  "dialog.project.open.error.gitInvalid": "Enter a valid Git repository URL",
  "dialog.project.open.error.pathRequired": "Enter a local path",
  ...
  "settings.desktop.section.projects": "Projects",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the OpenCode server inside WSL on Windows.",
  "settings.desktop.clonePath.title": "Default clone location",
  "settings.desktop.clonePath.description": "Used by the Clone project dialog when choosing a local destination.",
  "settings.desktop.clonePath.placeholder": "~/Documents/code",
