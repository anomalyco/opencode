export const dict = {
  ...
  "settings.tab.feishu": "Feishu Bridge",
  "settings.feishu.title": "Feishu Bridge",
  "settings.feishu.description": "Talk to your AI agent via Feishu / Lark.",
  "settings.feishu.adapter.notReady": "Feishu adapter is not running.",
  ...
  "settings.feishu.account.empty.title": "No Feishu account bound",
  "settings.feishu.account.empty.description": "Bind your first Feishu / Lark account to start receiving messages.",
  "settings.feishu.account.add": "Add Feishu account",
  "settings.feishu.account.delete": "Delete",
  "settings.feishu.bind.title": "Bind Feishu account",
  ...
  "settings.feishu.bind.scanQr": "Scan the QR code below with the Feishu app",
  "settings.feishu.bind.userCodeLabel": "Or enter this user_code in the Feishu app",
