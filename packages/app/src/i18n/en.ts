export const dict = {
  ...
  "monitor.tab.kanban": "Kanban",
  "monitor.tab.health": "Health",
  "monitor.tab.workflows": "Workflows",
  "monitor.tab.alerts": "Alerts",
  "monitor.tab.channels": "Channels",
  "monitor.kanban.working": "Working",
  "monitor.kanban.waiting": "Waiting",
  "monitor.kanban.completed": "Completed",
  "monitor.kanban.error": "Error",
  "monitor.kanban.abandoned": "Abandoned",
  "monitor.kanban.view.sessions": "Sessions",
  "monitor.kanban.view.agents": "Agents",
  "monitor.kanban.empty": "Nothing here yet.",
  "monitor.health.title": "Composite health",
  "monitor.health.formula": "0.40 × success + 0.25 × cache hit + 0.25 × (100 − errors) + 0.10 × (100 − heap)",
  "monitor.health.success_rate": "Success rate",
  "monitor.health.cache_hit_rate": "Cache hit",
  "monitor.health.error_rate": "Error rate",
  "monitor.health.heap_pct": "Heap usage",
  "monitor.workflows.title": "Workflows",
  "monitor.workflows.status_active": "Active only",
  "monitor.workflows.status_completed": "Completed",
  "monitor.workflows.status_all": "All",
  "monitor.alerts.title": "Alerts",
  "monitor.alerts.create": "Create rule",
  "monitor.alerts.types.event-pattern": "Event pattern",
  "monitor.alerts.types.inactivity": "Inactivity",
  "monitor.alerts.types.stuck-agent": "Stuck agent",
  "monitor.alerts.types.token-threshold": "Token threshold",
  "monitor.alerts.fields.name": "Name",
  "monitor.alerts.fields.cooldown": "Cooldown (s)",
  "monitor.alerts.fields.enabled": "Enabled",
  "monitor.alerts.activity": "Activity",
  "monitor.alerts.acked": "Acknowledge",
  "monitor.alerts.acked_all": "Acknowledge all",
  "monitor.alerts.only_unacked": "Show unacknowledged only",
  "monitor.channels.title": "Channels",
  "monitor.channels.create": "Add channel",
  "monitor.channels.test": "Send test",
  "monitor.channels.providers.slack": "Slack",
  "monitor.channels.providers.discord": "Discord",
  "monitor.channels.providers.teams": "Microsoft Teams",
  "monitor.channels.providers.google-chat": "Google Chat",
  "monitor.channels.providers.mattermost": "Mattermost",
  "monitor.channels.providers.rocketchat": "Rocket.Chat",
  "monitor.channels.providers.telegram": "Telegram",
  "monitor.channels.providers.pagerduty": "PagerDuty",
  "monitor.channels.providers.opsgenie": "Opsgenie",
  "monitor.channels.providers.splunk-oncall": "Splunk On-Call",
  "monitor.channels.providers.zapier": "Zapier",
  "monitor.channels.providers.make": "Make",
  "monitor.channels.providers.n8n": "n8n",
  "monitor.channels.providers.pipedream": "Pipedream",
  "monitor.channels.providers.generic": "Generic",
  "monitor.tabby.panel_title": "Tabby",
  "monitor.tabby.live": "{{n}} live",
  "monitor.tabby.errored": "{{n}} errored",
  "monitor.tabby.ask": "Ask",
  "monitor.tabby.ask_placeholder": "What's running? Any errors?",
  "monitor.tabby.mute": "Mute bubbles",
  "monitor.tabby.clear_alerts": "Clear alerts",
  "monitor.common.loading": "Loading…",
  "monitor.common.empty": "No data yet.",
  "monitor.common.refresh": "Refresh",
  "monitor.common.save": "Save",
  "monitor.common.cancel": "Cancel",
  "monitor.common.delete": "Delete",
  "monitor.common.view_session": "View session →",
}
