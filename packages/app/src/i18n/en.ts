export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Cedric",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Cedric.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Cedric Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Cedric.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Cedric.",
  ...
  "dialog.server.description": "Switch which Cedric server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Cedric",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Cedric...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Cedric in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Cedric...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Cedric in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Cedric in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Cedric",
  "wsl.onboarding.opencodeReadyIn": "Cedric is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cedric is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Cedric in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Cedric",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Cedric.",
  ...
  "toast.update.description": "A new version of Cedric ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Cedric team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Cedric does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Cedric includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Cedric Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Cedric server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Cedric",
  ...
  "settings.general.row.appearance.description": "Customise how Cedric looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Cedric follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Cedric is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Cedric launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Cedric.",
