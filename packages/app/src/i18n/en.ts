export const dict = {
  ...
  "toast.update.description": "A new version of Placeholder name ({{version}}) is now available to install.",
  ...
  "sidebar.gettingStarted.line1": "Placeholder name includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Placeholder name",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Placeholder name.",
