...
export const dict = {
  ...
  "dialog.model.ratings.title": "Model Ratings & Benchmark Leaderboard",
  "dialog.model.ratings.description": "Compare model capabilities, benchmark scores, cost efficiency, and community ratings.",
  "dialog.model.ratings.button": "Model Leaderboard & Ratings",
  "dialog.model.ratings.filters.title": "Capability Filters",
  "dialog.model.ratings.guardrail.notice": "Minimum {{hours}} hours of model usage required to submit community ratings. Current usage: {{current}} hrs.",
  "dialog.model.ratings.column.rank": "Rank",
  "dialog.model.ratings.column.model": "Model",
  "dialog.model.ratings.column.scores": "Scores",
  "dialog.model.ratings.column.params": "Params",
  "dialog.model.ratings.column.cost": "Cost / Mn",
  "dialog.model.ratings.column.rating": "Rating",
