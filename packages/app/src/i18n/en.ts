export const dict = {
  ...
  "dialog.fork.worktree.point.description":
    "Choose where to resume. Full session keeps everything; selecting a message keeps earlier context and restores that message in the composer.",
