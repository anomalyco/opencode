...
export const dict = {
  ...
  "settings.plugins.source.all": "All sources",
  "settings.plugins.source.ecosystem": "Ecosystem",
  ...
  "settings.mcp.deleted": "Deleted {{name}}.",
  "settings.mcp.errors.refresh": "Could not load MCP servers.",
  "settings.mcp.status.pending": "connecting…",
  "settings.mcp.action.connect": "Connect",
  "settings.mcp.action.disconnect": "Disconnect",
  ...
  "settings.mcp.delete.body": "Remove {{name}}? This cannot be undone.",
  "settings.mcp.form.title.add": "Add MCP server",
  ...
  "settings.mcp.form.addRow": "Add row",
  "settings.mcp.form.removeRow": "Remove",
  ...
  "settings.mcp.form.oauth.disableAutodetect": "Disable OAuth auto-detection",
  ...
  "settings.mcp.form.error.name": "Enter a name.",
  "settings.mcp.form.error.command": "Enter a command.",
  "settings.mcp.form.error.url": "Enter a URL.",
  "settings.mcp.form.error.callbackPort": "Callback port must be a number between 1 and 65535.",
  "settings.mcp.form.error.timeout": "Timeout must be a positive whole number.",
  ...
  "settings.mcp.errors.noConfig": "Cannot read the config for {{name}} — it may be defined outside this project's config.",
  "settings.mcp.edit.warn": "Saving reconnects this server.",
  ...
  "settings.plugins.installed.uninstallBody": "Uninstall {{name}} from {{scope}}? It will be removed from the config file.",
