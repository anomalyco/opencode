export const dict = {
  ...
  "prompt.voice.action.turnOn": "Turn on voice",
  "prompt.voice.action.turnOff": "Turn off voice",
  "prompt.voice.disclosure": "Voice uses cloud transcription. Audio is sent to a transcription service.",
  "prompt.voice.disclosure.dismiss": "Got it",
  "prompt.voice.status.off": "Voice off",
  "prompt.voice.status.listening": "Listening",
  "prompt.voice.status.hearing": "Hearing you",
