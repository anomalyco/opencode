...
export const dict = {
  ...
  "command.session.sideChat": "New Side Chat",
  "command.session.sideChat.description": "Ask a focused question without changing the main chat",
  "command.session.sideChat.switch": "Switch to Side Chat {{number}}",
  "command.session.sideChat.switch.description": "Show this Side Chat in the side panel",
  ...
  "session.sideChat.numberedTitle": "Side Chat {{number}}",
  "session.sideChat.addTab": "Add panel tab",
  "session.sideChat.close": "Close Side Chat",
  "session.sideChat.empty": "Ask a focused question. This conversation won't be added to the main chat.",
  "session.sideChat.askSelection": "Side Chat",
  "session.sideChat.quoteInMain": "Quote in Main Chat",
  "session.sideChat.quoteSource.main": "Main Chat",
  "session.sideChat.quoteSource.side": "Side Chat",
  "session.sideChat.parentWorking": "Main chat working",
  "session.sideChat.parentIdle": "Main chat idle",
