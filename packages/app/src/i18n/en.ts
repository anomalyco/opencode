export const dict = {
  ...
  "command.model.assign": "Assign subagent model",
  "command.model.assign.description": "Choose a model for a subagent",
  ...
  "dialog.assignModel.subagent.search.placeholder": "Search subagents",
  "dialog.assignModel.subagent.empty": "No subagents available",
  "dialog.assignModel.provider.title": "Select provider",
  "dialog.assignModel.provider.titleForAgent": "Select provider for {{agent}}",
  "dialog.assignModel.provider.search.placeholder": "Search connected providers",
  "dialog.assignModel.provider.empty": "No connected providers available",
  "dialog.assignModel.provider.connected": "Connected",
  "dialog.assignModel.model.title": "Select model",
  "dialog.assignModel.model.titleForAgent": "Select model for {{agent}} on {{provider}}",
  "dialog.assignModel.scope.title": "Save to",
  "dialog.assignModel.scope.global": "Global",
  "dialog.assignModel.scope.global.description": "Applies to all projects",
  "dialog.assignModel.scope.project": "Project",
  "dialog.assignModel.scope.project.description": "Applies only to this project",
