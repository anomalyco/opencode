...
export const dict = {
  ...
  "settings.general.row.contentMaxWidth.title": "Content Width",
  "settings.general.row.contentMaxWidth.description": "Set the maximum width of the chat content area. Set to full width to use the entire window.",
  "settings.general.row.contentMaxWidth.fullWidth": "Full width",
