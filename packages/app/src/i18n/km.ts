export const dict = {
  ...
  "mcp.status.needs_client_registration": "ត្រូវការចុះឈ្មោះអតិថិជន",
  "mcp.status.pending": "កំពុងតភ្ជាប់…",
  ...
  "settings.mcp.type.local": "មូលដ្ឋាន",
  "settings.mcp.type.remote": "ចម្ងាយ",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "ដើម្បីរំលង ទុកវាចាស់ទេ — ការផ្ទៀងផ្ទាត់ឡើងវិញអាចចាំបាច់",
