export const dict = {
  ...
  "command.session.background": "ដំណើរការភ្នាក់ងាររងនៅផ្ទៃខាងក្រោយ",
  "command.session.background.description": "ផ្តាច់ភ្នាក់ងាររងដែលរាំងខ្ទប់វគ្គនេះ ហើយបន្តពួកវានៅផ្ទៃខាងក្រោយ",
  ...
  "toast.session.background.failed.title": "មិនអាចដំណើរការភ្នាក់ងាររងនៅផ្ទៃខាងក្រោយបានទេ",
