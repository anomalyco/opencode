export const dict = {
  ...
  "settings.tab.plugins": "ប្លាកអ៊ីន",
  "settings.plugins.section.browse": "រុករក",
  "settings.plugins.section.installed": "ដែលបានដំឡើង",
  ...
  "settings.mcp.add": "បន្ថែមម៉ាស៊ីនបម្រើ",
  "settings.mcp.empty": "មិនមានម៉ាស៊ីនបម្រើ MCP បានកំណត់រចនាសម្ព័ន្ធទេ។",
  "settings.mcp.deleted": "បានលុប {{name}} ។",
  "settings.mcp.errors.refresh": "មិនអាចផ្ទុកម៉ាស៊ីនបម្រើ MCP បានទេ។",
  "settings.mcp.status.pending": "កំពុងភ្ជាប់…",
  "settings.mcp.action.connect": "ភ្ជាប់",
  "settings.mcp.action.disconnect": "ផ្ដាច់",
  "settings.mcp.action.authenticate": "ផ្ទៀងផ្ទាត់",
  "settings.mcp.action.edit": "កែសម្រួល",
  "settings.mcp.action.delete": "លុប",
  "settings.mcp.delete.title": "លុបម៉ាស៊ីនបម្រើ MCP",
  "settings.mcp.delete.body": "ដក {{name}} ចេញ? មិនអាចមិនធ្វើវិញបានទេ។",
  "settings.mcp.form.title.add": "បន្ថែមម៉ាស៊ីនបម្រើ MCP",
  "settings.mcp.form.title.edit": "កែសម្រួលម៉ាស៊ីនបម្រើ MCP",
  "settings.mcp.form.subtitle": "កំណត់រចនាសម្ព័ន្ធការតភ្ជាប់។",
  "settings.mcp.form.name": "ឈ្មោះ",
  "settings.mcp.form.command": "ពាក្យបញ្ជា",
  "settings.mcp.form.command.hint": "ឧ. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ថតការងារ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "អថេរបរិស្ថាន",
  "settings.mcp.form.headers": "ក្បាលសេចក្តី",
  "settings.mcp.form.addRow": "បន្ថែមជួរ",
  "settings.mcp.form.removeRow": "លុបចោល",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "លេខសម្គាល់អតិថិជន",
  "settings.mcp.form.oauth.clientSecret": "សម្ងាត់អតិថិជន",
  "settings.mcp.form.oauth.clientSecret.keep": "បានកំណត់រចនាសម្ព័ន្ធ — ទុកទំនេរដើម្បីរក្សាទុក",
  "settings.mcp.form.oauth.scope": "វិសាលភាព",
  "settings.mcp.form.oauth.callbackPort": "ច្រកហៅត្រឡប់",
  "settings.mcp.form.oauth.disableAutodetect": "បិទការរកឃើញ OAuth ស្វ័យប្រវត្តិ",
  "settings.mcp.form.enabled": "បានបើកប្រើ",
  "settings.mcp.form.timeout": "ពេលផ្តល់ (ms)",
  "settings.mcp.form.save": "រក្សាទុក",
  "settings.mcp.form.cancel": "បោះបង់",
  "settings.mcp.form.error.name": "បញ្ចូលឈ្មោះ។",
  "settings.mcp.form.error.command": "បញ្ចូលពាក្យបញ្ជា។",
  "settings.mcp.form.error.url": "បញ្ចូល URL។",
  "settings.mcp.form.error.callbackPort": "ច្រកហៅត្រឡប់ត្រូវនៅចន្លោះ ១ ដល់ ៦៥៥៣៥។",
  "settings.mcp.form.error.timeout": "ពេលផ្តល់ត្រូវជាលេខគត់វិជ្ជមាន។",
  "settings.mcp.errors.invalid": "កែសម្រួលវាលដែលបានរំលង។",
  "settings.mcp.errors.duplicate": "ម៉ាស៊ីនបម្រើឈ្មោះនេះមានរួចហើយ។",
  "settings.mcp.errors.noConfig": "មិនអាចអានការកំណត់រចនាសម្ព័ន្ធនៃ {{name}} — អាចកំណត់ក្រៅគម្រោង។",
  "settings.mcp.edit.warn": "ការរក្សាទុកភ្ជាប់ម៉ាស៊ីនបម្រើនេះឡើងវិញ។",
  ...
  "settings.plugins.detail.copied": "បានចម្លង",
  "settings.plugins.detail.notOnNpm": "រកមិនឃើញលើ npm — បន្ថែមដោយដៃទៅ opencode.json",
  "settings.plugins.install.title": "ដំឡើងប្លាកអ៊ីន",
  "settings.plugins.install.description": "តើគួរបន្ថែម {{name}} នៅទីណា?",
  "settings.plugins.install.global": "សកល (~/.config/opencode)",
  "settings.plugins.install.project": "គម្រោងនេះ",
  "settings.plugins.install.cancel": "បោះបង់",
  "settings.plugins.install.success": "បានដំឡើង {{name}} ។ ចាប់ផ្ដើម OpenCode ឡើងវិញដើម្បីផ្ទុកវា។",
  "settings.plugins.installed.empty": "មិនមានប្លាកអ៊ីនដែលបានដំឡើងទេ។",
  "settings.plugins.installed.provenance.global": "សកល",
  "settings.plugins.installed.provenance.project": "គម្រោង",
  ...
  "settings.plugins.errors.catalog": "មិនអាចធ្វើបច្ចុប្បន្នភាពការកត់ត្រាប្លាកអ៊ីនបានទេ។",
  "settings.plugins.stale": "កំពុងបង្ហាញការកត់ត្រាដែលបានរក្សាទុក (ចាស់ {{age}}) ។",
