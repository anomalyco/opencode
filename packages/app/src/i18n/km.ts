export const dict = {
  ...
  "session.tab.agents": "ភ្នាក់ងាររង",
  "session.agents.empty": "គ្មានភ្នាក់ងាររងណាមួយកំពុងដំណើរការ",
  "session.agents.costTotal": "ថ្លៃដើមសរុប",
  "session.agents.costSubagents": "ភ្នាក់ងាររង",
  "session.agents.count": "ភ្នាក់ងារ",
  "session.agents.tokens": "ថូខឹន",
  "session.agents.showAll": "បង្ហាញទាំងអស់ ({{count}})",
  "session.agents.status.idle": "ទំនេរ",
  "session.agents.status.busy": "កំពុងដំណើរការ",
  "session.agents.status.retry": "ព្យាយាមម្តងទៀត",
  "session.agents.status.cancelled": "បានលុបចោល",
  "session.agents.status.completed": "បានបញ្ចប់",
  "session.agents.status.error": "បរាជ័យ",
