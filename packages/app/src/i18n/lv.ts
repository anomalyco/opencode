export const dict = {
  ...
  "command.session.background": "Palaist apakšaģentus fonā",
  "command.session.background.description": "Atvienojiet apakšaģentus, kas bloķē šo sesiju, un turpiniet tos fonā",
  ...
  "toast.session.background.failed.title": "Neizdevās palaist apakšaģentus fonā",
