export const dict = {
  ...
  "provider.custom.models.load": "Ielādēt dinamiski",
  "provider.custom.models.loading": "Ielādē...",
  "provider.custom.models.load.invalidUrl": "Ievadiet derīgu bāzes URL",
  "provider.custom.models.load.unauthorized": "Neatļauts. Pārbaudiet API atslēgu",
  "provider.custom.models.load.invalidFormat": "Servera atbilde nesaturēja derīgu modeļu sarakstu",
  "provider.custom.models.load.timeout": "Iestājās noilgums ielādējot modeļus",
  "provider.custom.models.load.failed": "Neizdevās ielādēt modeļus",
  "provider.custom.models.load.empty": "Modeļi nav atrasti",
