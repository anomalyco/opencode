export const dict = {
  ...
  "command.session.handoff": "Nodot sesiju",
  "command.session.handoff.description": "Saspiest sesiju un turpināt darbu jaunā sesijā",
  ...
  "toast.session.handoff.failed.title": "Neizdevās nodot sesiju",
  "toast.session.handoff.failed.description": "Šo sesiju neizdevās apkopot nodošanai",
