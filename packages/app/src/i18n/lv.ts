export const dict = {
  ...
  "desktop.menu.documentation": "Pencode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Pencode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Pencode",
  "desktop.recovery.terminated": "Pencode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Pencode neatbild",
  ...
  "desktop.wsl.error.installPencode": "Pencode instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.pencodeMissing": "pencode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.pencodeCannotRun": "pencode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.pencode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.pencode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.pencodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Pencode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Pencode.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti pencode.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Pencode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingPencode": "Pārbaudu Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Pārbaudu Pencode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingPencode": "Atjauninu Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Atjauninu Pencode distribūcijā {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Atjauniniet Pencode distribūcijā {{distro}}.",
  "wsl.onboarding.updatePencode": "Atjauniniet Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode ir gatavs.",
  "wsl.onboarding.installPencodeIn": "Instalējiet Pencode distribūcijā {{distro}}.",
  "wsl.onboarding.installPencode": "Instalējiet Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Pencode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Pencode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Pencode no jauna.",
  ...
  "help.tabs.introduction": "Pencode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Pencode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Pencode komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (pencode.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Pencode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Pencode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Pencode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Pencode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Pencode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Pencode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Pencode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Pencode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Pencode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Pencode versiju.",
