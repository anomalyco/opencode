export const dict = {
  ...
  "session.tab.agents": "Apakšaģenti",
  "session.agents.empty": "Neviens apakšaģents nedarbojas",
  "session.agents.costTotal": "Kopējās izmaksas",
  "session.agents.costSubagents": "Apakšaģenti",
  "session.agents.count": "Aģenti",
  "session.agents.tokens": "žetoni",
  "session.agents.showAll": "Rādīt visu ({{count}})",
  "session.agents.status.idle": "Neaktīvs",
  "session.agents.status.busy": "Darbojas",
  "session.agents.status.retry": "Mēģina vēlreiz",
  "session.agents.status.cancelled": "Atcelts",
  "session.agents.status.completed": "Pabeigts",
  "session.agents.status.error": "Neizdevās",
