export const dict = {
  ...
  "desktop.menu.documentation": "Argus dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Argus izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Argus",
  "desktop.recovery.terminated": "Argus logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Argus neatbild",
  ...
  "desktop.wsl.error.installArgus": "Argus instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.argusMissing": "argus nav instalēts šajā distribūcijā",
  "desktop.wsl.error.argusCannotRun": "argus ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.argusNotInstalled": "Argus nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.argus.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.argus.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.argusGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Argus",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  "provider.connect.argusZen.line2":
    "Ar vienu API atslēgu iegūsiet piekļuvi tādiem modeļiem kā Claude, GPT, Gemini, GLM un citiem.",
  "provider.connect.argusZen.visit.prefix": "Apmeklējiet",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Argus.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti argus.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Argus servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingArgus": "Pārbaudu Argus...",
  "wsl.onboarding.checkingArgusIn": "Pārbaudu Argus distribūcijā {{distro}}...",
  "wsl.onboarding.updatingArgus": "Atjauninu Argus...",
  "wsl.onboarding.updatingArgusIn": "Atjauninu Argus distribūcijā {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Atjauniniet Argus distribūcijā {{distro}}.",
  "wsl.onboarding.updateArgus": "Atjauniniet Argus",
  "wsl.onboarding.argusReadyIn": "Argus ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.argusReady": "Argus ir gatavs.",
  "wsl.onboarding.installArgusIn": "Instalējiet Argus distribūcijā {{distro}}.",
  "wsl.onboarding.installArgus": "Instalējiet Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Argus var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Argus neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Argus no jauna.",
  ...
  "help.tabs.introduction": "Argus Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Argus versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Argus komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (argus.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Argus vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Argus ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Argus darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Argus serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Argus saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Argus izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Argus sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Argus tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Argus",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Argus versiju.",
