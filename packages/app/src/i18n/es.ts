export const dict = {
  ...
  "command.tab.closeAll": "Cerrar todas las pestañas",
  "command.tab.closeRight": "Cerrar todas las pestañas a la derecha",
  "command.tab.closeOthers": "Cerrar todas las pestañas excepto esta",
