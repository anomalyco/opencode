export const dict = {
  ...
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} elemento",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} elementos",
  ...
  "dialog.todo.autocomplete.noFiles": "No se encontraron archivos",
  "dialog.todo.autocomplete.noSkills": "No se encontraron habilidades",
