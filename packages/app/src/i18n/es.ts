export const dict = {
  ...
  "session.tab.agents": "Sub-agentes",
  "session.agents.empty": "No hay sub-agentes ejecutándose",
  "session.agents.costTotal": "Coste total",
  "session.agents.costSubagents": "Sub-agentes",
  "session.agents.count": "Agentes",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Mostrar todo ({{count}})",
  "session.agents.status.idle": "Inactivo",
  "session.agents.status.busy": "Ejecutando",
  "session.agents.status.retry": "Reintentando",
  "session.agents.status.cancelled": "Cancelado",
  "session.agents.status.completed": "Completado",
  "session.agents.status.error": "Fallido",
