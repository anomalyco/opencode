export const dict = {
  ...
  "home.activity.title": "Actividad de tokens",
  "home.activity.daily": "Diario",
  "home.activity.weekly": "Semanal",
  "home.activity.cumulative": "Acumulado",
  "home.activity.loading": "Cargando actividad",
  "home.activity.empty": "Sin actividad de tokens aún",
  "home.activity.lifetimeTokens": "Tokens totales",
  "home.activity.peakTokens": "Pico de tokens",
  "home.activity.longestTask": "Tarea más larga",
  "home.activity.currentStreak": "Racha actual",
  "home.activity.longestStreak": "Racha más larga",
  "home.activity.days.one": "{{count}} día",
  "home.activity.days.other": "{{count}} días",
  "home.activity.summary":
    "{{tokens}} tokens totales, {{peak}} pico de tokens, {{current}} racha actual, {{longest}} racha más larga.",
