export const dict = {
  ...
  "settings.general.section.feed": "Novedades",
  ...
  "settings.general.row.shell.description": "Shell usado en la terminal. Los compatibles también se usan para herramientas del agente.",
  ...
  "settings.general.row.terminalFont.title": "Fuente de terminal",
  "settings.general.row.terminalFont.description": "Personaliza la fuente usada en la terminal",
  ...
  "settings.general.row.showFileTree.description": "Mostrar el árbol de archivos en sesiones",
  ...
  "settings.general.row.showTerminal.title": "Panel de terminal",
  "settings.general.row.showTerminal.description": "Mostrar el botón de terminal en la barra de título",
  ...
  "settings.general.row.newLayoutDesigns.title": "Nuevo diseño y maquetación",
  "settings.general.row.newLayoutDesigns.description": "Habilitar el diseño, inicio, compositor e interfaz de sesión rediseñados",
  "settings.general.row.pinchZoom.title": "Zoom con gestos y scroll",
  "settings.general.row.pinchZoom.description": "Permite usar gestos en el trackpad y Ctrl+desplazamiento para ampliar la vista.",
