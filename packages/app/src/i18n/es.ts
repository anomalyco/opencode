export const dict = {
  ...
  "error.page.action.restartFrontend": "Reiniciar frontend",
  "error.page.action.restartBackend": "Reiniciar backend",
  "error.page.action.restartApp": "Reiniciar aplicación",
