export const dict = {
  ...
  "status.tab.servers.one": "{{count}} Servidor",
  "status.tab.servers.other": "{{count}} Servidores",
  ...
  "status.servers.manage": "Gestionar servidores",
  ...
  "status.noProject": "Abrir un proyecto para ver",
