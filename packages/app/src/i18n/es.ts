export const dict = {
  ...
  "mcp.status.needs_client_registration": "requiere registro de cliente",
  "mcp.status.pending": "conectando…",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Dejar en blanco para omitir — puede requerir reautenticación",
