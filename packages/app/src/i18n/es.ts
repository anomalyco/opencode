export const dict = {
  ...
  "presets.title": "Preajustes",
  "presets.manage": "Gestionar preajustes",
  "presets.count": "{{count}} preajustes",
  "presets.empty": "Sin preajustes",
  "presets.empty.hint": "Haga clic en \"Agregar\" para crear su primer preajuste",
  "presets.add": "Agregar",
  "presets.name": "Nombre",
  "presets.content": "Contenido",
  "presets.content.placeholder": "Contenido (soporta variables {date} {time} {file} {code} {text})",
  "presets.moveUp": "Mover arriba",
  "presets.moveDown": "Mover abajo",
  "presets.edit": "Editar",
  "presets.delete": "Eliminar",
  "presets.variables.title": "Ingrese variables para \"{{name}}\"",
  "presets.variables.next": "Siguiente",
  "presets.variables.insert": "Insertar",
}
