export const dict = {
  ...
  "provider.custom.models.load": "Cargar dinámicamente",
  "provider.custom.models.loading": "Cargando...",
  "provider.custom.models.load.invalidUrl": "Introduce una URL base válida",
  "provider.custom.models.load.unauthorized": "No autorizado. Comprueba la clave de API",
  "provider.custom.models.load.invalidFormat": "La respuesta del servidor no contenía una lista de modelos válida",
  "provider.custom.models.load.timeout": "Se agotó el tiempo al cargar los modelos",
  "provider.custom.models.load.failed": "Error al cargar los modelos",
  "provider.custom.models.load.empty": "No se encontraron modelos",
