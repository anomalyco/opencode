export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en leak-code.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (leak-code.json)",
