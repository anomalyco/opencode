export const dict = {
  ...
  "command.workspace.switch": "Cambiar espacio de trabajo",
  "command.workspace.previous": "Espacio de trabajo anterior",
  "command.workspace.next": "Siguiente espacio de trabajo",
