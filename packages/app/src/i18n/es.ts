export const dict = {
  ...
  "settings.plugins.section.browse": "Explorar",
  "settings.plugins.section.installed": "Instalados",
  "settings.plugins.source.all": "Todas las fuentes",
  "settings.plugins.source.ecosystem": "Ecosistema",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Añadir servidor",
  "settings.mcp.empty": "No hay servidores MCP configurados.",
  "settings.mcp.deleted": "{{name}} eliminado.",
  "settings.mcp.errors.refresh": "No se pudieron cargar los servidores MCP.",
  "settings.mcp.status.pending": "conectando…",
  "settings.mcp.action.connect": "Conectar",
  "settings.mcp.action.disconnect": "Desconectar",
  "settings.mcp.action.authenticate": "Autenticar",
  "settings.mcp.action.edit": "Editar",
  "settings.mcp.action.delete": "Eliminar",
  "settings.mcp.delete.title": "Eliminar servidor MCP",
  "settings.mcp.delete.body": "¿Eliminar {{name}}? No se puede deshacer.",
  "settings.mcp.form.title.add": "Añadir servidor MCP",
  "settings.mcp.form.title.edit": "Editar servidor MCP",
  "settings.mcp.form.subtitle": "Configura los ajustes de conexión.",
  "settings.mcp.form.name": "Nombre",
  "settings.mcp.form.command": "Comando",
  "settings.mcp.form.command.hint": "p. ej. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Directorio de trabajo",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Variables de entorno",
  "settings.mcp.form.headers": "Cabeceras",
  "settings.mcp.form.addRow": "Añadir fila",
  "settings.mcp.form.removeRow": "Quitar",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID de cliente",
  "settings.mcp.form.oauth.clientSecret": "Secreto de cliente",
  "settings.mcp.form.oauth.clientSecret.keep": "Configurado — deja en blanco para mantener",
  "settings.mcp.form.oauth.scope": "Ámbito",
  "settings.mcp.form.oauth.callbackPort": "Puerto de callback",
  "settings.mcp.form.oauth.disableAutodetect": "Desactivar detección automática de OAuth",
  "settings.mcp.form.enabled": "Activado",
  "settings.mcp.form.timeout": "Tiempo de espera (ms)",
  "settings.mcp.form.save": "Guardar",
  "settings.mcp.form.cancel": "Cancelar",
  "settings.mcp.form.error.name": "Introduce un nombre.",
  "settings.mcp.form.error.command": "Introduce un comando.",
  "settings.mcp.form.error.url": "Introduce una URL.",
  "settings.mcp.form.error.callbackPort": "El puerto de callback debe estar entre 1 y 65535.",
  "settings.mcp.form.error.timeout": "El tiempo de espera debe ser un número entero positivo.",
  "settings.mcp.errors.invalid": "Corrige los campos resaltados.",
  "settings.mcp.errors.duplicate": "Ya existe un servidor con este nombre.",
  "settings.mcp.errors.noConfig": "No se puede leer la configuración de {{name}} — puede estar definida fuera del proyecto.",
  "settings.mcp.edit.warn": "Guardar reconecta este servidor.",
  "settings.plugins.search.placeholder": "Buscar complementos…",
  "settings.plugins.detail.install": "Instalar…",
  "settings.plugins.detail.copy": "Copiar fragmento de configuración",
  "settings.plugins.detail.copied": "Copiado",
  "settings.plugins.detail.notOnNpm": "No se encontró en npm — añádelo manualmente a opencode.json",
  "settings.plugins.install.title": "Instalar complemento",
  "settings.plugins.install.description": "¿Dónde se añadirá {{name}}?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Este proyecto",
  "settings.plugins.install.cancel": "Cancelar",
  "settings.plugins.install.success": "{{name}} instalado. Reinicia OpenCode para cargarlo.",
  "settings.plugins.installed.empty": "No hay complementos instalados.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Proyecto",
  ...
  "settings.plugins.errors.catalog": "No se pudo actualizar el catálogo de complementos.",
  "settings.plugins.stale": "Mostrando catálogo en caché ({{age}}).",
