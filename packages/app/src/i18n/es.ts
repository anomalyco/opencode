export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Pencode",
  ...
  "desktop.menu.ariaLabel": "Menú de Pencode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Pencode",
  "desktop.recovery.terminated": "La ventana de Pencode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Pencode no responde",
  ...
  "desktop.wsl.error.installPencode": "No se pudo instalar Pencode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.pencodeMissing": "pencode no está instalado en esta distribución",
  "desktop.wsl.error.pencodeCannotRun": "pencode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Pencode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.pencode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.pencode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.pencodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Pencode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.pencodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Pencode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en pencode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Pencode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingPencode": "Comprobando Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Comprobando Pencode en {{distro}}...",
  "wsl.onboarding.updatingPencode": "Actualizando Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Actualizando Pencode en {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Actualiza Pencode en {{distro}}.",
  "wsl.onboarding.updatePencode": "Actualizar Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode está listo en {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode está listo.",
  "wsl.onboarding.installPencodeIn": "Instala Pencode en {{distro}}.",
  "wsl.onboarding.installPencode": "Instalar Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Pencode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Pencode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Pencode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Pencode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (pencode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Pencode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Pencode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Pencode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Pencode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Pencode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Pencode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Pencode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Pencode.",
