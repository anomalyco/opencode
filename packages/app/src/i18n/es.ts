export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Argus",
  ...
  "desktop.menu.ariaLabel": "Menú de Argus",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Argus",
  "desktop.recovery.terminated": "La ventana de Argus se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Argus no responde",
  ...
  "desktop.wsl.error.installArgus": "No se pudo instalar Argus",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.argusMissing": "argus no está instalado en esta distribución",
  "desktop.wsl.error.argusCannotRun": "argus está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.argusNotInstalled": "Argus no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Argus finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.argus.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  ...
  "dialog.server.description": "Cambiar el servidor de Argus al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingArgus": "Comprobando Argus...",
  "wsl.onboarding.checkingArgusIn": "Comprobando Argus en {{distro}}...",
  "wsl.onboarding.updatingArgus": "Actualizando Argus...",
  "wsl.onboarding.updatingArgusIn": "Actualizando Argus en {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Actualiza Argus en {{distro}}.",
  "wsl.onboarding.updateArgus": "Actualizar Argus",
  "wsl.onboarding.argusReadyIn": "Argus está listo en {{distro}}.",
  "wsl.onboarding.argusReady": "Argus está listo.",
  "wsl.onboarding.installArgusIn": "Instala Argus en {{distro}}.",
  "wsl.onboarding.installArgus": "Instalar Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Argus pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Argus no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Argus",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Argus aún no admite la autenticación MCP.',
  ...
  "settings.general.row.colorScheme.description": "Elige si Argus sigue el tema del sistema, claro u oscuro",
