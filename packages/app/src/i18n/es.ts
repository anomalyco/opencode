export const dict = {
  ...
  "command.context.addToChat": "Añadir selección al chat",
  "command.context.addToChat.description": "Insertar las líneas seleccionadas en la posición del cursor",
  "command.context.quickEdit": "Edición rápida de selección",
  "command.context.quickEdit.description": "Editar el código seleccionado en una nueva sesión",
  "selection.action.addToChat": "Añadir al chat",
  "selection.action.quickEdit": "Edición rápida",
  "selection.quickEdit.placeholder": "Editar el código seleccionado",
  "selection.quickEdit.submit": "Iniciar",
