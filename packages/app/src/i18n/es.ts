export const dict = {
  ...
  "session.review.context.openDefault": "Aplicación predeterminada",
  "session.review.context.copyRelative": "Copiar ruta relativa",
  "session.review.context.copyAbsolute": "Copiar ruta absoluta",
