export const dict = {
  ...
  "command.todo.toggle": "Alternar panel de todos",
  ...
  "sidebar.issue.title": "Tareas",
  "sidebar.issue.add": "Añadir tarea",
  "sidebar.issue.addSubtodo": "Añadir subtarea",
  "sidebar.issue.empty": "Sin tareas",
  "sidebar.issue.collapse": "Contraer subtareas",
  "sidebar.issue.expand": "Expandir subtareas",
  "sidebar.issue.confirmDeleteWithChildren": "¿Eliminar esta tarea y sus {{count}} subtareas?",
  "sidebar.issue.toast.deleteFailed": "Error al eliminar la tarea",
  "sidebar.issue.tooltip.cycleStatus": "Cambiar estado",
  "sidebar.issue.tooltip.cyclePriority": "Cambiar prioridad",
  "sidebar.issue.tooltip.linkedLinear": "Vinculado a Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Conectado",
  "sidebar.linear.management": "Gestionar vinculación de Linear",
  "sidebar.linear.management.teamRequired": "Por favor, selecciona un equipo",
  "sidebar.linear.management.projectRequired": "Por favor, selecciona un proyecto",
  "sidebar.linear.management.saveFailed": "Error al guardar la vinculación de Linear",
  "sidebar.linear.management.saved": "Vinculación de Linear guardada",
  "sidebar.linear.management.save": "Guardar",
  "sidebar.linear.toggleHistory": "Alternar historial de sincronización",
  "sidebar.linear.field.team": "Equipo",
  "sidebar.linear.field.team.loading": "Cargando equipos...",
  "sidebar.linear.field.team.placeholder": "Seleccionar un equipo",
  "sidebar.linear.field.project": "Proyecto",
  "sidebar.linear.field.project.selectTeamFirst": "Primero selecciona un equipo",
  "sidebar.linear.field.project.loading": "Cargando proyectos...",
  "sidebar.linear.field.project.placeholder": "Seleccionar un proyecto",
  "sidebar.linear.notConfigured": "Linear no configurado",
  "sidebar.linear.notConfiguredHint": "Abre la gestión para seleccionar un equipo y proyecto",
  ...
  "sidebar.linear.pullSuccess":
    "Obtenido {{pulled}}, actualizado {{updated}}, omitido {{skipped}}, eliminado {{deleted}}",
  "sidebar.linear.pushFailed": "Error al subir a Linear",
  "sidebar.linear.pushPartialFailed": "Subida parcialmente fallida: {{count}} error(es)",
  "sidebar.linear.pushSuccess": "{{count}} tarea(s) subida(s) a Linear",
  "sidebar.linear.pushNothing": "Nada que subir",
  "sidebar.linear.syncHistory.syncing": "Sincronizando...",
  "sidebar.linear.syncHistory.error": "Error",
  "sidebar.linear.syncHistory.empty": "Sin historial de sincronización",
  "dialog.todo.title.create": "Nueva tarea",
  "dialog.todo.title.edit": "Editar tarea",
  "dialog.todo.field.title": "Título",
  "dialog.todo.field.title.placeholder": "Título de la tarea",
  "dialog.todo.field.description": "Descripción",
  "dialog.todo.field.description.placeholder": "Añadir detalles, enlaces o contexto...",
  "dialog.todo.field.description.hint": "Admite referencias de archivos y habilidades",
  "dialog.todo.field.status": "Estado",
  "dialog.todo.field.priority": "Prioridad",
  "dialog.todo.field.dueDate": "Fecha de vencimiento",
  "dialog.todo.field.dueDate.placeholder": "Establecer fecha de vencimiento",
  "dialog.todo.field.dueDate.clear": "Borrar",
  "dialog.todo.field.dueDate.prevMonth": "Mes anterior",
  "dialog.todo.field.dueDate.nextMonth": "Mes siguiente",
  "dialog.todo.field.dueDate.shortcut.today": "Hoy",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Mañana",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "En una semana",
  ...
  "dialog.todo.field.labels": "Etiquetas",
  "dialog.todo.field.assignee": "Responsable",
  "dialog.todo.field.assignee.unassigned": "Sin asignar",
  "dialog.todo.field.assignee.loadFailed": "Error al cargar responsables",
  "dialog.todo.field.assignee.loading": "Cargando responsables...",
  "dialog.todo.field.assignee.placeholder": "Seleccionar responsable",
  "dialog.todo.field.assignee.hint": "Obtenido de los miembros del equipo de Linear",
  "dialog.todo.linkedLinear": "Vinculado a Linear",
  "dialog.todo.created": "Tarea creada",
  "dialog.todo.updated": "Tarea actualizada",
  "dialog.todo.error.titleRequired": "El título es obligatorio",
  "dialog.todo.error.saveFailed": "Error al guardar la tarea",
  "dialog.todo.action.create": "Crear",
  ...
  "sidebar.issue.priority.none": "Ninguna",
  "sidebar.issue.priority.urgent": "Urgente",
  "sidebar.issue.priority.high": "Alto",
  "sidebar.issue.priority.medium": "Medio",
  ...
  "sidebar.issue.archivedBadge": "Archivada",
  "sidebar.issue.archiveArea.title": "Archivadas",
  "sidebar.issue.archiveArea.expand": "Mostrar archivadas",
  "sidebar.issue.archiveArea.collapse": "Ocultar archivadas",
  "sidebar.issue.archiveArea.empty": "No hay tareas archivadas",
}
