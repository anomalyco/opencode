export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Host SSH no válido: {{host}}",
  "desktop.ssh.error.alreadyAdded": "Ya se ha añadido {{host}}",
  "desktop.ssh.error.opencodeNotInstalled": "opencode no está instalado en {{host}}",
  "desktop.ssh.error.installOpencode": "No se pudo instalar opencode",
  "desktop.ssh.error.connectFailed": "No se pudo conectar con {{host}}",
  "desktop.ssh.error.serverExited": "El servidor SSH se cerró después de iniciarse (código={{code}} señal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "El servidor SSH de {{host}} se cerró antes de estar operativo (código={{code}} señal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Se agotó el tiempo de espera de la comprobación de estado del servidor en {{host}} tras {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "Se agotó el tiempo de espera del comando ssh a {{host}} tras {{timeout}} ms",
  "desktop.ssh.error.failedPort": "No se pudo obtener el puerto",
  "desktop.ssh.error.terminalFailed": "No se pudo abrir una terminal",
  ...
  "ssh.server.add": "Añadir servidor SSH",
  ...
  "ssh.server.updating": "Actualizando...",
  ...
  "ssh.add.hint":
    "Se conecta a través del cliente ssh de tu sistema, por lo que los hosts, las claves y los agentes de tu configuración SSH funcionan como de costumbre.",
  "ssh.add.configHosts": "De tu configuración SSH",
  "ssh.add.connect": "Conectar",
  "ssh.add.checking": "Conectando...",
  "ssh.add.addServer": "Añadir servidor",
  "ssh.add.adding": "Añadiendo...",
  "ssh.add.installOpencode": "Instalar opencode",
  "ssh.add.updateOpencode": "Actualizar opencode",
  "ssh.add.installing": "Instalando...",
  "ssh.add.status.unreachable": "No se pudo conectar",
  "ssh.add.status.opencodeMissing": "opencode no está instalado en este host",
  "ssh.add.status.opencodeMismatch":
    "opencode v{{version}} instalado, la aplicación de escritorio espera v{{expected}}",
  "ssh.add.status.opencodeFound": "Se encontró opencode v{{version}}",
  "ssh.add.authHint":
    "Asegúrate de que la autenticación SSH mediante clave funciona para este host: ejecuta `ssh {{host}}` en una terminal para comprobarlo.",
