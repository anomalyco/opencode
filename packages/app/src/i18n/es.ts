export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Jarvis",
  ...
  "desktop.menu.ariaLabel": "Menú de Jarvis",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Jarvis",
  "desktop.recovery.terminated": "La ventana de Jarvis se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Jarvis no responde",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Jarvis",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Jarvis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Jarvis.",
  ...
  "dialog.server.description": "Cambiar el servidor de Jarvis al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Jarvis en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Jarvis en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Jarvis en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Jarvis en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Jarvis pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Jarvis no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.session.export.failed.title": "Error al exportar la sesión",
  ...
  "toast.update.description": "Una nueva versión de Jarvis ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Jarvis",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Jarvis aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.integrations.placeholder": "Las integraciones extienden el runtime de Jarvis. Próximamente podrás instalar plugins, temas y extensiones del sistema.",
  "settings.connectors.placeholder": "Los conectores vinculan Jarvis con servicios externos. Próximamente: Gmail, WhatsApp, Slack, Notion, Telegram y más.",
  "settings.connectors.unavailable": "Los conectores solo están disponibles en la app de escritorio.",
  ...
  "settings.connectors.github.permission.repos": "Leer y gestionar tus repositorios, issues y pull requests",
  "settings.connectors.github.permission.profile": "Leer tu perfil público (usuario y avatar)",
  "settings.connectors.github.connect": "Conectar GitHub",
  "settings.connectors.github.disconnect": "Desconectar",
  "settings.connectors.github.cancel": "Cancelar",
  "settings.connectors.github.openBrowser": "Abrir navegador",
  "settings.connectors.github.waiting": "Esperando autorización…",
  "settings.connectors.github.code.instructions": "Introduce este código en",
  "settings.connectors.github.connected.text": "Conectado mediante OAuth. Jarvis puede acceder a tu cuenta de GitHub.",
  "settings.connectors.github.error.expired": "El código de autorización ha expirado. Inténtalo de nuevo.",
  "settings.connectors.github.error.generic": "No se pudo conectar con GitHub. Comprueba tu conexión e inténtalo de nuevo.",
  "settings.connectors.github.error.denied": "Autorización denegada. Puedes intentarlo de nuevo cuando quieras.",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integración con WSL",
  "settings.desktop.wsl.description": "Ejecutar el servidor Jarvis dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Jarvis",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Jarvis en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Jarvis sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Jarvis.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Jarvis",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Jarvis.",
