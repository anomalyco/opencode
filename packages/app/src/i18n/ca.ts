export const dict = {
  ...
  "session.agents.empty": "Cap subagent en execució",
  ...
  "session.agents.showAll": "Mostra-ho tot ({{count}})",
  "session.agents.status.idle": "Inactiu",
  "session.agents.status.busy": "En execució",
  "session.agents.status.retry": "Reintentant",
  "session.agents.status.cancelled": "Cancel·lat",
  "session.agents.status.completed": "Completat",
  "session.agents.status.error": "Error",
