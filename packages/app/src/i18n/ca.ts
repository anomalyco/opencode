export const dict = {
  ...
  "command.session.handoff": "Transfereix la sessió",
  "command.session.handoff.description": "Compacta la sessió i continua la feina en una sessió nova",
  ...
  "toast.session.handoff.failed.title": "No s'ha pogut transferir la sessió",
  "toast.session.handoff.failed.description": "No s'ha pogut resumir aquesta sessió per transferir-la",
