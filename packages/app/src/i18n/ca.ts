export const dict = {
  ...
  "provider.custom.models.load": "Carrega dinàmicament",
  "provider.custom.models.loading": "Carregant...",
  "provider.custom.models.load.invalidUrl": "Introdueix una URL base vàlida",
  "provider.custom.models.load.unauthorized": "No autoritzat. Comprova la clau API",
  "provider.custom.models.load.invalidFormat": "La resposta del servidor no contenia una llista de models vàlida",
  "provider.custom.models.load.timeout": "S'ha esgotat el temps en carregar els models",
  "provider.custom.models.load.failed": "No s'han pogut carregar els models",
  "provider.custom.models.load.empty": "No s'han trobat models",
