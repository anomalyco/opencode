export const dict = {
  ...
  "desktop.menu.documentation": "Argus Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Argus.",
  ...
  "desktop.recovery.loadFailed": "Argus no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Argus s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Argus no respon",
  ...
  "desktop.wsl.error.installArgus": "La instal·lació de Argus ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.argusMissing": "argus no està instal·lat en aquesta distribució",
  "desktop.wsl.error.argusCannotRun": "argus està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.argusNotInstalled": "Argus no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.argus.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.argus.tagline": "Models optimitzats fiables",
  "dialog.provider.argusGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Argus",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.argusZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Argus.",
  ...
  "dialog.plugins.empty": "Connectors configurats a argus.json",
  ...
  "dialog.server.description": "Canvia a quin Argus servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingArgus": "S'està comprovant Argus...",
  "wsl.onboarding.checkingArgusIn": "S'està registrant Argus a {{distro}}...",
  "wsl.onboarding.updatingArgus": "S'està actualitzant Argus...",
  "wsl.onboarding.updatingArgusIn": "S'està actualitzant Argus a {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Actualitza Argus a {{distro}}.",
  "wsl.onboarding.updateArgus": "Actualització Argus",
  "wsl.onboarding.argusReadyIn": "Argus està llest a {{distro}}.",
  "wsl.onboarding.argusReady": "Argus està llest.",
  "wsl.onboarding.installArgusIn": "Instal·leu Argus a {{distro}}.",
  "wsl.onboarding.installArgus": "Instal·la Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Argus pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Argus no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Argus.",
  ...
  "help.tabs.introduction": "Argus L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Argus ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Argus.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (argus.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Argus encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Argus Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Argus dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Argus",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Argus al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Argus segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Argus.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Argus.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Argus.",
