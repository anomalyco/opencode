export const dict = {
  ...
  "command.tab.closeAll": "Tanca totes les pestanyes",
  "command.tab.closeRight": "Tanca totes les pestanyes de la dreta",
  "command.tab.closeOthers": "Tanca totes les pestanyes excepte aquesta",
