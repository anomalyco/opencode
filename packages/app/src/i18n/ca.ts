export const dict = {
  ...
  "desktop.menu.documentation": "Pencode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Pencode.",
  ...
  "desktop.recovery.loadFailed": "Pencode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Pencode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Pencode no respon",
  ...
  "desktop.wsl.error.installPencode": "La instal·lació de Pencode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.pencodeMissing": "pencode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.pencodeCannotRun": "pencode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.pencode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.pencode.tagline": "Models optimitzats fiables",
  "dialog.provider.pencodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Pencode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.pencodeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Pencode.",
  ...
  "dialog.plugins.empty": "Connectors configurats a pencode.json",
  ...
  "dialog.server.description": "Canvia a quin Pencode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingPencode": "S'està comprovant Pencode...",
  "wsl.onboarding.checkingPencodeIn": "S'està registrant Pencode a {{distro}}...",
  "wsl.onboarding.updatingPencode": "S'està actualitzant Pencode...",
  "wsl.onboarding.updatingPencodeIn": "S'està actualitzant Pencode a {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Actualitza Pencode a {{distro}}.",
  "wsl.onboarding.updatePencode": "Actualització Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode està llest a {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode està llest.",
  "wsl.onboarding.installPencodeIn": "Instal·leu Pencode a {{distro}}.",
  "wsl.onboarding.installPencode": "Instal·la Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Pencode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Pencode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Pencode.",
  ...
  "help.tabs.introduction": "Pencode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Pencode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Pencode.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (pencode.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Pencode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Pencode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Pencode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Pencode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Pencode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Pencode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Pencode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Pencode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Pencode.",
