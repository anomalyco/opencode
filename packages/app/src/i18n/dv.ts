export const dict = {
  ...
  "session.tab.agents": "ސަބްއެޖެންޓުން",
  "session.agents.empty": "ކުރިއަށް އޮތް ސަބްއެޖެންޓެއް ނެތް",
  "session.agents.costTotal": "ޖުމްލަ އަގު",
  "session.agents.costSubagents": "ސަބްއެޖެންޓުން",
  "session.agents.count": "އޭޖެންޓުން",
  "session.agents.tokens": "ޓޯކަންތައް",
  "session.agents.showAll": "ހުރިހާ އެއްޗެއް ދައްކާ ({{count}})",
  "session.agents.status.idle": "ހުސްވެފައި",
  "session.agents.status.busy": "ކުރިއަށް ދަނީ",
  "session.agents.status.retry": "އަލުން މަސައްކަތް ކުރަނީ",
  "session.agents.status.cancelled": "ކެންސަލްކޮށްފި",
  "session.agents.status.completed": "ނިމިއްޖެ",
  "session.agents.status.error": "ނާކާމިޔާބު",
