export const dict = {
  ...
  "command.session.handoff": "ސެޝަން ހަވާލުކުރުން",
  "command.session.handoff.description": "ސެޝަން ކޮމްޕެކްޓްކޮށް، މަސައްކަތް އާ ސެޝަނެއްގައި ކުރިއަށްގެންދިޔުން",
  ...
  "toast.session.handoff.failed.title": "ސެޝަން ހަވާލުކުރަން ނާކާމިޔާބުވި",
  "toast.session.handoff.failed.description": "ހަވާލުކުރުމަށް މި ސެޝަން ޚުލާޞާ ކުރުމަށް ނުކުޅެދިއްޖެއެވެ",
