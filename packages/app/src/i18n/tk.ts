export const dict = {
  ...
  "desktop.menu.documentation": "Argus Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Argus menýusy",
  ...
  "desktop.recovery.loadFailed": "Argus ýükläp bilmedi",
  "desktop.recovery.terminated": "Argus penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Argus jogap berenok",
  ...
  "desktop.wsl.error.installArgus": "Argus gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.argusMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.argusCannotRun": "argus guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.argusNotInstalled": "Argus {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Argus täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.argus.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.argus.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.argusGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Argus tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Argus-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.argusZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.argusZen.visit.prefix": "Sapar ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Argus-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Argus-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "argus.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Argus serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingArgus": "Argus barlamak ...",
  "wsl.onboarding.checkingArgusIn": "{{distro}} içinde Argus barlanýar...",
  "wsl.onboarding.updatingArgus": "Argus täzelenmek ...",
  "wsl.onboarding.updatingArgusIn": "{{distro}}-de Argus täzelenmek ...",
  "wsl.onboarding.updateArgusIn": "Argus-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateArgus": "Argus täzeläň",
  "wsl.onboarding.argusReadyIn": "Argus {{distro}}-de taýýar.",
  "wsl.onboarding.argusReady": "Argus taýýar.",
  "wsl.onboarding.installArgusIn": "{{distro}}-de Argus guruň.",
  "wsl.onboarding.installArgus": "Argus guruň",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Argus WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Argus bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Argus açyň.",
  ...
  "help.tabs.introduction": "Argus Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Argus ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Argus toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (argus.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Argus entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Argus mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Argus serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Argus üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Argus enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Argus ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Argus-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Argus işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Argus-iň iň soňky wersiýasyny işleýärsiňiz.",
