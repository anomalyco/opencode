export const dict = {
  ...
  "command.tab.closeAll": "Ähli goýmalary ýapyň",
  "command.tab.closeRight": "Sag tarapdaky ähli goýmalary ýapyň",
  "command.tab.closeOthers": "Şu goýmadan başga ähli goýmalary ýapyň",
