export const dict = {
  ...
  "mcp.status.needs_client_registration": "müşderi hasaba alyş gerek",
  "mcp.status.pending": "birleşýär…",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Ýalap geçmek üçin boş goý — täzeden tassyklamak gerek bolup biler",
