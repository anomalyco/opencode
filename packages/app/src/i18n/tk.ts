export const dict = {
  ...
  "desktop.menu.documentation": "Pencode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Pencode menýusy",
  ...
  "desktop.recovery.loadFailed": "Pencode ýükläp bilmedi",
  "desktop.recovery.terminated": "Pencode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Pencode jogap berenok",
  ...
  "desktop.wsl.error.installPencode": "Pencode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.pencodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.pencodeCannotRun": "pencode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Pencode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.pencode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.pencode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.pencodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Pencode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Sapar ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Pencode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Pencode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "pencode.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Pencode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode barlamak ...",
  "wsl.onboarding.checkingPencodeIn": "{{distro}} içinde Pencode barlanýar...",
  "wsl.onboarding.updatingPencode": "Pencode täzelenmek ...",
  "wsl.onboarding.updatingPencodeIn": "{{distro}}-de Pencode täzelenmek ...",
  "wsl.onboarding.updatePencodeIn": "Pencode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updatePencode": "Pencode täzeläň",
  "wsl.onboarding.pencodeReadyIn": "Pencode {{distro}}-de taýýar.",
  "wsl.onboarding.pencodeReady": "Pencode taýýar.",
  "wsl.onboarding.installPencodeIn": "{{distro}}-de Pencode guruň.",
  "wsl.onboarding.installPencode": "Pencode guruň",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Pencode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Pencode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Pencode açyň.",
  ...
  "help.tabs.introduction": "Pencode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Pencode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Pencode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (pencode.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Pencode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Pencode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Pencode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Pencode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Pencode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Pencode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Pencode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Pencode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Pencode-iň iň soňky wersiýasyny işleýärsiňiz.",
