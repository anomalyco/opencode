export const dict = {
  ...
  "session.tab.agents": "Kiçi agentler",
  "session.agents.empty": "Hiç bir kiçi agent işlemeýär",
  "session.agents.costTotal": "Jemi çykdajy",
  "session.agents.costSubagents": "Kiçi agentler",
  "session.agents.count": "Agentler",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Hemmesini görkez ({{count}})",
  "session.agents.status.idle": "Boş",
  "session.agents.status.busy": "Işleýär",
  "session.agents.status.retry": "Gaýtadan synanyşýk",
  "session.agents.status.cancelled": "Ýatyryldy",
  "session.agents.status.completed": "Tamamlandy",
  "session.agents.status.error": "Şowsuz",
