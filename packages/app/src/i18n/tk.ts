export const dict = {
  ...
  "settings.tab.plugins": "Plaginlar",
  "settings.plugins.section.browse": "Göz aýla",
  "settings.plugins.section.installed": "Gurnalan",
  ...
  "settings.mcp.add": "Serwer goş",
  "settings.mcp.empty": "Inşik edil serwerler ýok.",
  "settings.mcp.deleted": "{{name}} aýryldy.",
  "settings.mcp.errors.refresh": "MCP serwerleri ýüklenmedi.",
  "settings.mcp.status.pending": "birleşýär…",
  "settings.mcp.action.connect": "Birleş",
  "settings.mcp.action.disconnect": "Aýyr",
  "settings.mcp.action.authenticate": "Şahadatnama",
  "settings.mcp.action.edit": "Redaktla",
  "settings.mcp.action.delete": "Poz",
  "settings.mcp.delete.title": "MCP serwerini pozmak",
  "settings.mcp.delete.body": "{{name}} aýyrylsynmy? Ony yzyna getirmek bolmaýar.",
  "settings.mcp.form.title.add": "MCP serwerini goş",
  "settings.mcp.form.title.edit": "MCP serwerini redaktirla",
  "settings.mcp.form.subtitle": "Birikme sazlamalaryny düz.",
  "settings.mcp.form.name": "Ad",
  "settings.mcp.form.command": "Buýruk",
  "settings.mcp.form.command.hint": "meselem npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Iş katalogy",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Müşir üýtgeýjileri",
  "settings.mcp.form.headers": "Sözbaşylar",
  "settings.mcp.form.addRow": "Setir goş",
  "settings.mcp.form.removeRow": "Aýyr",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Müşderi ID",
  "settings.mcp.form.oauth.clientSecret": "Müşderi syry",
  "settings.mcp.form.oauth.clientSecret.keep": "Sazlanan — saklamak üçin boş goý",
  "settings.mcp.form.oauth.scope": "Möhlet",
  "settings.mcp.form.oauth.callbackPort": "Yzjaklaport",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth awtotesiri öçür",
  "settings.mcp.form.enabled": "Enabled",
  "settings.mcp.form.timeout": "Wagt (ms)",
  "settings.mcp.form.save": "Sakla",
  "settings.mcp.form.cancel": "Ýatyr",
  "settings.mcp.form.error.name": "Ady gir.",
  "settings.mcp.form.error.command": "Buýrugy gir.",
  "settings.mcp.form.error.url": "URL gir.",
  "settings.mcp.form.error.callbackPort": "Yzjaklaport 1–65535 arasynda bolmaly.",
  "settings.mcp.form.error.timeout": "Wagt požitif bitewi san bolmaly.",
  "settings.mcp.errors.invalid": "Bellikli meýdanlary düz.",
  "settings.mcp.errors.duplicate": "Bu adyň serweri eýýäm bar.",
  "settings.mcp.errors.noConfig": "{{name}} konfigurasiýasy okalmaýar — taslamadan daşy kesgitlenen bolup biler.",
  "settings.mcp.edit.warn": "Saklamak bu serweri täzeden birikdirýär.",
  ...
  "settings.plugins.detail.copied": "Göçürildi",
  "settings.plugins.detail.notOnNpm": "npm-de tapylmady — opencode.json-a el bilen goşuň",
  "settings.plugins.install.title": "Plegin gurnamak",
  "settings.plugins.install.description": "{{name}} nireä goşulmaly?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Bu taslama",
  "settings.plugins.install.cancel": "Ýatyr",
  "settings.plugins.install.success": "{{name}} gurnaldy. Yuklamak üçin OpenCode-y täzeden başlaň.",
  "settings.plugins.installed.empty": "Gurnalan plegin ýok.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Taslama",
  ...
  "settings.plugins.errors.catalog": "Plegin katalogy täzelenmedi.",
  "settings.plugins.stale": "Keşlenen katalog görkezilýär ({{age}} öňki).",
