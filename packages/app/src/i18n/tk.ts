export const dict = {
  ...
  "command.session.handoff": "Sessiýany tabşyryň",
  "command.session.handoff.description": "Sessiýany jemläp, işi täze sessiýada dowam etdiriň",
  ...
  "toast.session.handoff.failed.title": "Sessiýany tabşyryp bilmedi",
  "toast.session.handoff.failed.description": "Bu sessiýany tabşyrmak üçin jemläp bolmady",
