export const dict = {
  ...
  "provider.custom.models.load": "Dinamik ýükla",
  "provider.custom.models.loading": "Ýüklenýär...",
  "provider.custom.models.load.invalidUrl": "Dogry esasy URL giriziň",
  "provider.custom.models.load.unauthorized": "Rugsat ýok. API açary barlaň",
  "provider.custom.models.load.invalidFormat": "Serveriň jogapy dogry modeller sanawysy däl",
  "provider.custom.models.load.timeout": "Modeller ýükleňde wagyt gutardy",
  "provider.custom.models.load.failed": "Modeller ýüklemedi",
  "provider.custom.models.load.empty": "Modeller tapylmady",
