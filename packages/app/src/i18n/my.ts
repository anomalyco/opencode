export const dict = {
  ...
  "session.tab.agents": "ခွဲအေးဂျင့်များ",
  "session.agents.empty": "မည်သည့် ခွဲအေးဂျင့်မှ မလည်ပတ်နေပါ",
  "session.agents.costTotal": "စုစုပေါင်းကုန်ကျစရိတ်",
  "session.agents.costSubagents": "ခွဲအေးဂျင့်များ",
  "session.agents.count": "အေးဂျင့်များ",
  "session.agents.tokens": "တိုကင်များ",
  "session.agents.showAll": "အားလုံးပြရန် ({{count}})",
  "session.agents.status.idle": "အားလပ်နေသည်",
  "session.agents.status.busy": "လည်ပတ်နေသည်",
  "session.agents.status.retry": "ထပ်ကြိုးစားနေသည်",
  "session.agents.status.cancelled": "ပယ်ဖျက်ပြီး",
  "session.agents.status.completed": "ပြီးမြောက်ပြီး",
  "session.agents.status.error": "မအောင်မြင်ပါ",
