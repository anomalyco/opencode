export const dict = {
  ...
  "settings.tab.plugins": "ပလပ်ဂင်များ",
  "settings.plugins.section.browse": "ရှာဖွေတား",
  "settings.plugins.section.installed": "ထည့်သွင်းပြီး",
  ...
  "settings.mcp.add": "ဆာဗာ ထည့်ရန်",
  "settings.mcp.empty": "MCP ဆာဗာ မည်မျှမထည့်သွင်းရသေးပါ။",
  "settings.mcp.deleted": "{{name}} ကို ဖျက်ပြီးပါပြီ။",
  "settings.mcp.errors.refresh": "MCP ဆာဗာများ ဝန်တင်မရပါ။",
  "settings.mcp.status.pending": "ချိတ်ဆက်နေသည်…",
  "settings.mcp.action.connect": "ချိတ်ဆက်",
  "settings.mcp.action.disconnect": "ချိတ်ဆက်မှု ဖြုတ်",
  "settings.mcp.action.authenticate": "စစ်မှန်ကြောင်း အတည်ပြု",
  "settings.mcp.action.edit": "ပြင်ဆင်",
  "settings.mcp.action.delete": "ဖျက်",
  "settings.mcp.delete.title": "MCP ဆာဗာ ဖျက်",
  "settings.mcp.delete.body": "{{name}} ကို ဖယ်ရှားမလား? ပြန်လည်ရယ်မရနိုင်ပါ။",
  "settings.mcp.form.title.add": "MCP ဆာဗာ ထည့်ရန်",
  "settings.mcp.form.title.edit": "MCP ဆာဗာ ပြင်ရန်",
  "settings.mcp.form.subtitle": "ချိတ်ဆက်မှု ဆက်တင်များ ပြင်ဆင်ပါ။",
  "settings.mcp.form.name": "အမည်",
  "settings.mcp.form.command": "command",
  "settings.mcp.form.command.hint": "ဥပမာ npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "အလုပ်လုပ်ရမည့် folder",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "ပတ်ဝန်းကျင် အချက်များ",
  "settings.mcp.form.headers": "ခေါင်းစီးများ",
  "settings.mcp.form.addRow": "အတန်း ထည့်ရန်",
  "settings.mcp.form.removeRow": "ဖျက်ရန်",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ကလိုင်းအင့် ID",
  "settings.mcp.form.oauth.clientSecret": "ကလိုင်းအင့် secret",
  "settings.mcp.form.oauth.clientSecret.keep": "ပြင်ဆင်ပြီး — ထိန်းသိမ်းရန် ချန်ထားပါ",
  "settings.mcp.form.oauth.scope": "အတိုင်းအတာ",
  "settings.mcp.form.oauth.callbackPort": "callback port",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth အလိုအလျောက် ရှာဖွေမှု ပိတ်ရန်",
  "settings.mcp.form.enabled": "ဖွင့်ထားသည်",
  "settings.mcp.form.timeout": "အချိန်ကုန် (ms)",
  "settings.mcp.form.save": "သိမ်းဆည်းရန်",
  "settings.mcp.form.cancel": "ပယ်ဖျက်",
  "settings.mcp.form.error.name": "အမည် ထည့်ပါ။",
  "settings.mcp.form.error.command": "command ထည့်ပါ။",
  "settings.mcp.form.error.url": "URL ထည့်ပါ။",
  "settings.mcp.form.error.callbackPort": "callback port သည် 1-65535 ဖြစ်ရမည်။",
  "settings.mcp.form.error.timeout": "အချိန်ကုန်သည် အပေါင်းကိန်းပြည့် ဖြစ်ရမည်။",
  "settings.mcp.errors.invalid": "ရောင်ပြထားသော field များကို ပြင်ပါ။",
  "settings.mcp.errors.duplicate": "ဤအမည်ဖြင့် ဆာဗာ ရှိပြီးသားဖြစ်သည်။",
  "settings.mcp.errors.noConfig": "{{name}} ၏ configuration ကို ဖတ်မရနိုင် — project ပြင်ပတွင် သတ်မှတ်ထားနိုင်သည်။",
  "settings.mcp.edit.warn": "သိမ်းဆည်းလျှင် ဤဆာဗာကို ပြန်ချိတ်ဆက်ပါမည်။",
  ...
  "settings.plugins.detail.copied": "ကူးယူပြီး",
  "settings.plugins.detail.notOnNpm": "npm တွင် မတွေ့ရှိ — opencode.json တွင် ကိုယ်တိုင်ထည့်ပါ",
  "settings.plugins.install.title": "ပလပ်ဂင် ထည့်သွင်း",
  "settings.plugins.install.description": "{{name}} ကို ဘယ်မှာ ထည့်မလဲ?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "ဤပရောဂျက်",
  "settings.plugins.install.cancel": "ဖျက်သိမ်း",
  "settings.plugins.install.success": "{{name}} ထည့်သွင်းပြီး။ ဝန်တင်ရန် OpenCode ကို ပြန်စပါ။",
  "settings.plugins.installed.empty": "ထည့်သွင်းထားသော ပလပ်ဂင် မရှိ",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "ပရောဂျက်",
  ...
  "settings.plugins.errors.catalog": "ပလပ်ဂင် စာရင်း ပြန်လည်ဆန်းစစ်မှု မအောင်မြင်",
  "settings.plugins.stale": "cache လုပ်ထားသော စာရင်းကို ပြသနေသည် ({{age}} အရင်)",
