export const dict = {
  ...
  "session.tab.agents": "Подагенты",
  "session.agents.empty": "Нет запущенных подагентов",
  "session.agents.costTotal": "Общая стоимость",
  "session.agents.costSubagents": "Подагенты",
  "session.agents.count": "Агенты",
  "session.agents.tokens": "токенов",
  "session.agents.showAll": "Показать все ({{count}})",
  "session.agents.status.idle": "Ожидание",
  "session.agents.status.busy": "Выполняется",
  "session.agents.status.retry": "Повторная попытка",
  "session.agents.status.cancelled": "Отменено",
  "session.agents.status.completed": "Завершено",
  "session.agents.status.error": "Ошибка",
