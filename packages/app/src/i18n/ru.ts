export const dict = {
  ...
  "home.recentlyClosed.options": "Фильтр и сортировка",
  "home.recentlyClosed.filter.label": "Фильтр",
  "home.recentlyClosed.filter.recent": "Недавние",
  "home.recentlyClosed.filter.archived": "В архиве",
  "home.recentlyClosed.filter.hidden": "Скрытые",
  "home.recentlyClosed.filter.all": "Все",
  "home.recentlyClosed.filter.empty": "Ни один проект не подходит под этот фильтр",
  "home.recentlyClosed.sort.label": "Сортировка",
  "home.recentlyClosed.sort.recent": "Сначала новые",
  "home.recentlyClosed.sort.oldest": "Сначала старые",
  "home.recentlyClosed.sort.nameAsc": "Имя А–Я",
  "home.recentlyClosed.sort.nameDesc": "Имя Я–А",
  "home.recentlyClosed.search.placeholder": "Поиск среди недавно закрытых",
  "home.recentlyClosed.showMore": "Показать все ({{count}})",
  "home.recentlyClosed.showLess": "Показать меньше",
  "home.recentlyClosed.select": "Выбрать…",
  "home.recentlyClosed.selectAll": "Выбрать все",
  "home.recentlyClosed.deselectAll": "Снять выделение",
  "home.recentlyClosed.cancelSelection": "Отменить выбор",
  "home.recentlyClosed.selected": "Выбрано: {{count}}",
  "home.recentlyClosed.noResults": "Ни один проект не соответствует запросу «{{query}}»",
  "home.recentlyClosed.archived.badge": "В архиве",
  "home.recentlyClosed.hidden.badge": "Скрыт",
  "home.recentlyClosed.action.reopen": "Открыть снова",
  "home.recentlyClosed.action.unarchive": "Вернуть из архива",
  "home.recentlyClosed.action.hide": "Скрыть",
  "home.recentlyClosed.action.unhide": "Показать",
  "home.recentlyClosed.action.remove": "Забыть",
  "home.recentlyClosed.remove.title": "Забыть проект?",
  "home.recentlyClosed.remove.titleMany": "Забыть проекты ({{count}})?",
  "home.recentlyClosed.remove.confirm": "Убрать «{{name}}» из недавно закрытых? Это лишь очищает историю и никогда не удаляет файлы.",
  "home.recentlyClosed.remove.confirmMany": "Убрать проекты ({{count}}) из недавно закрытых? Это лишь очищает историю и никогда не удаляет файлы.",
  "home.recentlyClosed.toast.archived": "В архиве",
  "home.recentlyClosed.toast.hidden": "Скрыто",
  "home.recentlyClosed.toast.removed": "Убрано из недавно закрытых",
  "home.recentlyClosed.toast.undo": "Отменить",
