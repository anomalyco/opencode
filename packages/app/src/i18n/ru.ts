export const dict = {
  ...
  "provider.custom.models.load": "Загрузить динамически",
  "provider.custom.models.loading": "Загрузка...",
  "provider.custom.models.load.invalidUrl": "Введите действительный базовый URL",
  "provider.custom.models.load.unauthorized": "Нет доступа. Проверьте ключ API",
  "provider.custom.models.load.invalidFormat": "Ответ сервера не содержит действительного списка моделей",
  "provider.custom.models.load.timeout": "Превышено время ожидания при загрузке моделей",
  "provider.custom.models.load.failed": "Не удалось загрузить модели",
  "provider.custom.models.load.empty": "Модели не найдены",
