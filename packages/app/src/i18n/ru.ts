export const dict = {
  ...
  "toast.update.description": "Новая версия Placeholder name ({{version}}) доступна для установки.",
  ...
  "sidebar.gettingStarted.line1": "Placeholder name включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Placeholder name.",
