export const dict = {
  ...
  "command.workspace.switch": "Переключить рабочее пространство",
  "command.workspace.previous": "Предыдущее рабочее пространство",
  "command.workspace.next": "Следующее рабочее пространство",
