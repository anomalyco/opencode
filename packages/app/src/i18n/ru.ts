export const dict = {
  ...
  "session.review.context.openDefault": "Приложение по умолчанию",
  "session.review.context.copyRelative": "Копировать относительный путь",
  "session.review.context.copyAbsolute": "Копировать абсолютный путь",
