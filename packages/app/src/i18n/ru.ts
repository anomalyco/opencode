export const dict = {
  ...
  "provider.custom.models.context.label": "Размер контекста",
  "provider.custom.models.context.placeholder": "Размер контекста",
  "provider.custom.models.output.label": "Максимальный вывод",
  "provider.custom.models.output.placeholder": "Максимальный вывод",
  "provider.custom.models.reasoning.label": "Поддерживает рассуждение",
  ...
  "provider.custom.error.positiveInteger": "Введите положительное целое число",
