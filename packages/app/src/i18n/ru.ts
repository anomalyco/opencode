export const dict = {
  ...
  "toast.file.uploadFailed.title": "Не удалось загрузить файл",
  "toast.file.downloadFailed.title": "Не удалось скачать файл",
  ...
  "session.files.uploadFile": "Загрузить файл",
  "session.files.uploading": "Загрузка…",
  "session.files.downloadFile": "Скачать",
  "session.files.refresh": "Обновить",
  "session.files.dropFiles": "Перетащите файлы сюда или нажмите +, чтобы загрузить",
  "session.files.deleteConfirm": "Удалить \"{{path}}\"?",
  "session.files.uploadTooLarge": "Файл слишком большой (макс. {{size}})",
  ...
  "session.header.reveal.containingFolder": "Открыть родительскую папку",
