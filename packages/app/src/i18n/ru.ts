export const dict = {
  ...
  "command.todo.toggle": "Переключить панель задач",
  ...
  "sidebar.issue.title": "Задачи",
  "sidebar.issue.add": "Добавить задачу",
  "sidebar.issue.addSubtodo": "Добавить подзадачу",
  "sidebar.issue.empty": "Задач пока нет",
  "sidebar.issue.collapse": "Свернуть подзадачи",
  "sidebar.issue.expand": "Развернуть подзадачи",
  "sidebar.issue.confirmDeleteWithChildren": "Удалить эту задачу и её {{count}} подзадач?",
  "sidebar.issue.toast.deleteFailed": "Не удалось удалить задачу",
  "sidebar.issue.tooltip.cycleStatus": "Сменить статус",
  "sidebar.issue.tooltip.cyclePriority": "Сменить приоритет",
  "sidebar.issue.tooltip.linkedLinear": "Связано с Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Подключено",
  "sidebar.linear.management": "Управление привязкой Linear",
  "sidebar.linear.management.teamRequired": "Пожалуйста, выберите команду",
  "sidebar.linear.management.projectRequired": "Пожалуйста, выберите проект",
  "sidebar.linear.management.saveFailed": "Не удалось сохранить привязку Linear",
  "sidebar.linear.management.saved": "Привязка Linear сохранена",
  "sidebar.linear.management.save": "Сохранить",
  "sidebar.linear.toggleHistory": "Показать историю синхронизации",
  "sidebar.linear.field.team": "Команда",
  "sidebar.linear.field.team.loading": "Загрузка команд...",
  "sidebar.linear.field.team.placeholder": "Выберите команду",
  "sidebar.linear.field.project": "Проект",
  "sidebar.linear.field.project.selectTeamFirst": "Сначала выберите команду",
  "sidebar.linear.field.project.loading": "Загрузка проектов...",
  "sidebar.linear.field.project.placeholder": "Выберите проект",
  "sidebar.linear.notConfigured": "Linear не настроен",
  "sidebar.linear.notConfiguredHint": "Откройте управление, чтобы выбрать команду и проект",
  ...
  "sidebar.linear.pullSuccess":
    "Получено {{pulled}}, обновлено {{updated}}, пропущено {{skipped}}, удалено {{deleted}}",
  "sidebar.linear.pushFailed": "Не удалось отправить в Linear",
  "sidebar.linear.pushPartialFailed": "Отправка частично не удалась: {{count}} ошибок",
  "sidebar.linear.pushSuccess": "Отправлено {{count}} задач в Linear",
  "sidebar.linear.pushNothing": "Нечего отправлять",
  "sidebar.linear.syncHistory.syncing": "Синхронизация...",
  "sidebar.linear.syncHistory.push": "↗ Linear",
  "sidebar.linear.syncHistory.pull": "↙ Linear",
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} элемент",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} элементов",
  "sidebar.linear.syncHistory.error": "Ошибка",
  "sidebar.linear.syncHistory.empty": "Нет истории синхронизации",
  "dialog.todo.title.create": "Новая задача",
  "dialog.todo.title.edit": "Редактировать задачу",
  "dialog.todo.field.title": "Заголовок",
  "dialog.todo.field.title.placeholder": "Заголовок задачи",
  "dialog.todo.field.description": "Описание",
  "dialog.todo.field.description.placeholder": "Добавьте детали, ссылки или контекст...",
  "dialog.todo.field.description.hint": "Поддерживает ссылки на файлы и навыки",
  "dialog.todo.field.status": "Статус",
  "dialog.todo.field.priority": "Приоритет",
  "dialog.todo.field.dueDate": "Срок",
  "dialog.todo.field.dueDate.placeholder": "Установить срок",
  "dialog.todo.field.dueDate.clear": "Очистить",
  "dialog.todo.field.dueDate.prevMonth": "Предыдущий месяц",
  "dialog.todo.field.dueDate.nextMonth": "Следующий месяц",
  "dialog.todo.field.dueDate.shortcut.today": "Сегодня",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Завтра",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Через неделю",
  "dialog.todo.field.dueDate.month.0": "Янв",
  "dialog.todo.field.dueDate.month.1": "Фев",
  "dialog.todo.field.dueDate.month.2": "Мар",
  "dialog.todo.field.dueDate.month.3": "Апр",
  "dialog.todo.field.dueDate.month.4": "Май",
  "dialog.todo.field.dueDate.month.5": "Июн",
  "dialog.todo.field.dueDate.month.6": "Июл",
  "dialog.todo.field.dueDate.month.7": "Авг",
  "dialog.todo.field.dueDate.month.8": "Сен",
  "dialog.todo.field.dueDate.month.9": "Окт",
  "dialog.todo.field.dueDate.month.10": "Ноя",
  "dialog.todo.field.dueDate.month.11": "Дек",
  "dialog.todo.field.labels": "Метки",
  "dialog.todo.field.assignee": "Исполнитель",
  "dialog.todo.field.assignee.unassigned": "Не назначен",
  "dialog.todo.field.assignee.loadFailed": "Не удалось загрузить исполнителей",
  "dialog.todo.field.assignee.loading": "Загрузка исполнителей...",
  "dialog.todo.field.assignee.placeholder": "Выберите исполнителя",
  "dialog.todo.field.assignee.hint": "Из участников команды Linear",
  "dialog.todo.autocomplete.noFiles": "Файлы не найдены",
  "dialog.todo.autocomplete.noSkills": "Навыки не найдены",
  "dialog.todo.linkedLinear": "Связано с Linear",
  "dialog.todo.created": "Задача создана",
  "dialog.todo.updated": "Задача обновлена",
  "dialog.todo.error.titleRequired": "Заголовок обязателен",
  "dialog.todo.error.saveFailed": "Не удалось сохранить задачу",
  "dialog.todo.action.create": "Создать",
  ...
  "sidebar.issue.priority.none": "Никакие",
  "sidebar.issue.priority.urgent": "Срочно",
  "sidebar.issue.priority.high": "Высокий",
  "sidebar.issue.priority.medium": "Средний",
