export const dict = {
  ...
  "home.activity.title": "Активность токенов",
  "home.activity.daily": "Ежедневно",
  "home.activity.weekly": "Еженедельно",
  "home.activity.cumulative": "Накопительно",
  "home.activity.loading": "Загрузка активности",
  "home.activity.empty": "Активности токенов пока нет",
  "home.activity.lifetimeTokens": "Всего токенов",
  "home.activity.peakTokens": "Пик токенов",
  "home.activity.longestTask": "Самая долгая задача",
  "home.activity.currentStreak": "Текущая серия",
  "home.activity.longestStreak": "Максимальная серия",
  "home.activity.days.one": "{{count}} день",
  "home.activity.days.other": "{{count}} дней",
  "home.activity.summary":
    "{{tokens}} всего токенов, {{peak}} пик токенов, {{current}} текущая серия, {{longest}} максимальная серия.",
