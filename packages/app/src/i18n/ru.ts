export const dict = {
  ...
  "presets.manage": "Управление пресетами",
  "presets.count": "Пресетов: {{count}}",
  "presets.empty": "Нет пресетов",
  "presets.empty.hint": "Нажмите \"Добавить\", чтобы создать первый пресет",
  "presets.add": "Добавить",
  "presets.name": "Название",
  "presets.content": "Содержание",
  "presets.content.placeholder": "Содержание (поддерживает переменные {date} {time} {file} {code} {text})",
  "presets.moveUp": "Переместить вверх",
  "presets.moveDown": "Переместить вниз",
  "presets.edit": "Редактировать",
  "presets.delete": "Удалить",
  "presets.variables.title": "Введите переменные для \"{{name}}\"",
  "presets.variables.next": "Далее",
  "presets.variables.insert": "Вставить",
}
