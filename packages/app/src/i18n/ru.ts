export const dict = {
  ...
  "status.button.tooltip": "Просмотр состояния системы",
  "status.tab.servers.one": "{{count}} Сервер",
  "status.tab.servers.other": "{{count}} Серверы",
  "status.tab.mcp.one": "{{count}} MCP",
  "status.tab.mcp.other": "{{count}} MCP",
  "status.tab.lsp.one": "{{count}} LSP",
  "status.tab.lsp.other": "{{count}} LSP",
  "status.tab.plugins.one": "{{count}} Плагин",
  "status.tab.plugins.other": "{{count}} Плагинов",
  "status.servers.empty": "Серверы не настроены",
  "status.servers.manage": "Управление серверами",
  "status.mcp.empty": "Серверы MCP не настроены",
  "status.lsp.empty": "Нет активных серверов LSP",
