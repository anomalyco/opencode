export const dict = {
  ...
  "desktop.appMenu.edit": "Правка",
  "desktop.appMenu.view": "Вид",
  "desktop.appMenu.go": "Переход",
  "desktop.appMenu.window": "Окно",
  "desktop.appMenu.help": "Справка",
  "desktop.appMenu.about": "О программе OpenCode",
  "desktop.appMenu.checkForUpdates": "Проверить наличие обновлений...",
  "desktop.appMenu.settings": "Настройки",
  "desktop.appMenu.reloadWebview": "Перезагрузить веб-представление",
  "desktop.appMenu.restart": "Перезапустить",
  "desktop.appMenu.exportLogs": "Экспортировать журналы...",
  "desktop.appMenu.hide": "Скрыть OpenCode",
  "desktop.appMenu.hideOthers": "Скрыть остальные",
  "desktop.appMenu.showAll": "Показать все",
  "desktop.appMenu.quit": "Выйти из OpenCode",
  "desktop.appMenu.newSession": "Новая сессия",
  "desktop.appMenu.openProject": "Открыть проект...",
  "desktop.appMenu.newWindow": "Новое окно",
  "desktop.appMenu.closeWindow": "Закрыть окно",
  "desktop.appMenu.undo": "Отменить",
  "desktop.appMenu.redo": "Повторить",
  "desktop.appMenu.cut": "Вырезать",
  "desktop.appMenu.copy": "Копировать",
  "desktop.appMenu.paste": "Вставить",
  "desktop.appMenu.delete": "Удалить",
  "desktop.appMenu.selectAll": "Выделить всё",
  "desktop.appMenu.toggleSidebar": "Переключить боковую панель",
  "desktop.appMenu.toggleTerminal": "Переключить терминал",
  "desktop.appMenu.toggleFileTree": "Переключить дерево файлов",
  "desktop.appMenu.reload": "Перезагрузить",
  "desktop.appMenu.toggleDeveloperTools": "Переключить инструменты разработчика",
  "desktop.appMenu.actualSize": "Фактический размер",
  "desktop.appMenu.zoomIn": "Увеличить",
  "desktop.appMenu.zoomOut": "Уменьшить",
  "desktop.appMenu.toggleFullScreen": "Переключить полноэкранный режим",
  "desktop.appMenu.back": "Назад",
  "desktop.appMenu.forward": "Вперёд",
  "desktop.appMenu.previousSession": "Предыдущая сессия",
  "desktop.appMenu.nextSession": "Следующая сессия",
  "desktop.appMenu.previousProject": "Предыдущий проект",
  "desktop.appMenu.nextProject": "Следующий проект",
  "desktop.appMenu.minimize": "Свернуть",
  "desktop.appMenu.zoomWindow": "Масштаб",
  "desktop.appMenu.maximize": "Развернуть",
  "desktop.appMenu.bringAllToFront": "Все окна на передний план",
  "desktop.appMenu.documentation": "Документация OpenCode",
  "desktop.appMenu.supportForum": "Форум поддержки",
  "desktop.appMenu.shareFeedback": "Отправить отзыв",
  "desktop.appMenu.reportBug": "Сообщить об ошибке",
