export const dict = {
  ...
  "command.project.index": "Перейти к проекту {{index}}",
  ...
  "wsl.onboarding.restartRequired": "Требуется перезагрузить Windows для завершения установки WSL.",
  "wsl.onboarding.ready": "WSL готов к работе.",
  ...
  "wsl.onboarding.distroNotInstalled": "{{distro}} еще не установлен.",
  "wsl.onboarding.openDistroOnce": "Откройте {{distro}} один раз для завершения настройки.",
  "wsl.onboarding.finishingDistro": "Завершение настройки для {{distro}}.",
  "wsl.onboarding.pickDistro": "Выберите дистрибутив или установите один из списка ниже.",
  ...
  "wsl.onboarding.toolsRequired": "Этот дистрибутив требует bash и curl.",
  ...
  "wsl.onboarding.desktopVersion": "версия для компьютера {{version}}",
  "wsl.onboarding.versionMismatch": "Установленная версия не соответствует версии приложения для компьютера.",
  ...
  "home.sessions.search.noResults": "Не найдено сессий для {{query}}",
  "home.sessions.empty": "Сессии не найдены",
  "home.sessions.empty.description": "Начать новую сессию для этого проекта",
  ...
  "session.review.noUncommittedChanges": "Нет незафиксированных изменений",
  ...
  "sidebar.empty.title": "Боковая панель пуста",
  "sidebar.empty.description": "Откройте сессию или проект для начала",
  ...
  "settings.general.row.showFileTree.description": "Отображать боковую панель проводника файлов",
  ...
  "settings.general.row.showSearch.description": "Отображать кнопку глобального поиска в заголовке",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Отображать кнопку терминала в заголовке рабочего стола",
  "settings.general.row.showStatus.title": "Server status",
  "settings.general.row.showStatus.description": "Отображать кнопку статуса сервера в заголовке",
  "settings.general.row.showCustomAgents.title": "Custom agents",
  "settings.general.row.showCustomAgents.description": "Отображать выбор агента в поле ввода",
