export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Недопустимый хост SSH: {{host}}",
  "desktop.ssh.error.alreadyAdded": "Хост {{host}} уже добавлен",
  "desktop.ssh.error.opencodeNotInstalled": "opencode не установлен на {{host}}",
  "desktop.ssh.error.installOpencode": "Не удалось установить opencode",
  "desktop.ssh.error.connectFailed": "Не удалось подключиться к {{host}}",
  "desktop.ssh.error.serverExited": "Сервер SSH завершил работу после запуска (код={{code}}, сигнал={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Сервер SSH для {{host}} завершил работу до перехода в рабочее состояние (код={{code}}, сигнал={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Истекло время ожидания проверки работоспособности сервера на {{host}} ({{timeout}} мс)",
  "desktop.ssh.error.commandTimeout": "Истекло время ожидания выполнения команды ssh для {{host}} ({{timeout}} мс)",
  "desktop.ssh.error.failedPort": "Не удалось получить порт",
  "desktop.ssh.error.terminalFailed": "Не удалось открыть терминал",
  ...
  "ssh.server.add": "Добавить сервер SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "Сервер SSH",
  "ssh.server.retryStart": "Переподключиться",
  "ssh.server.disconnect": "Отключить",
  "ssh.server.openTerminal": "Открыть терминал",
  "ssh.server.updating": "Обновление...",
  "ssh.server.status.connecting": "Подключение...",
  "ssh.server.status.disconnected": "Отключено",
  "ssh.add.hostLabel": "Хост SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Подключение выполняется через системный клиент ssh, поэтому хосты, ключи и агенты из вашей конфигурации SSH работают как обычно.",
  "ssh.add.configHosts": "Из вашей конфигурации SSH",
  "ssh.add.connect": "Подключиться",
  "ssh.add.checking": "Подключение...",
  "ssh.add.addServer": "Добавить сервер",
  "ssh.add.adding": "Добавление...",
  "ssh.add.installOpencode": "Установить opencode",
  "ssh.add.updateOpencode": "Обновить opencode",
  "ssh.add.installing": "Установка...",
  "ssh.add.status.unreachable": "Не удалось подключиться",
  "ssh.add.status.opencodeMissing": "opencode не установлен на этом хосте",
  "ssh.add.status.opencodeMismatch": "Установлен opencode v{{version}}, приложение ожидает v{{expected}}",
  "ssh.add.status.opencodeFound": "Найден opencode v{{version}}",
  "ssh.add.authHint":
    "Убедитесь, что для этого хоста работает аутентификация SSH по ключу — выполните `ssh {{host}}` в терминале, чтобы проверить.",
