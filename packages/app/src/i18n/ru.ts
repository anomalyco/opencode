export const dict = {
  ...
  "prompt.action.voiceInput": "Голосовой ввод",
  "prompt.action.voiceStop": "Остановить голосовой ввод",
  "prompt.voice.error.notAllowed": "Доступ к микрофону запрещён",
  "prompt.voice.error.noSpeech": "Речь не распознана",
  "prompt.voice.error.audioCapture": "Не удалось получить доступ к микрофону",
  "prompt.voice.error.network": "Распознавание речи недоступно",
  "prompt.voice.error.serviceNotAllowed": "Сервис распознавания речи недоступен",
  "prompt.voice.error.languageNotSupported": "Распознавание речи не поддерживает этот язык",
  "prompt.voice.error.generic": "Ошибка распознавания речи",
  ...
  "context.budget.title": "Бюджет сессии",
  "context.budget.unset": "Бюджет не задан",
  "context.budget.edit": "Изменить бюджет",
  "context.budget.clear": "Сбросить",
  ...
  "session.budget.exceeded.title": "Бюджет сессии исчерпан",
  "session.budget.exceeded.description": "Сессия достигла лимита бюджета. Увеличьте или сбросьте бюджет, чтобы продолжить.",
