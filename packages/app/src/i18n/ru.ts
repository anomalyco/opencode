export const dict = {
  ...
  "error.page.action.restartFrontend": "Перезапустить фронтенд",
  "error.page.action.restartBackend": "Перезапустить бэкенд",
  "error.page.action.restartApp": "Перезапустить приложение",
