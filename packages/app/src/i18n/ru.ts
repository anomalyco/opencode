export const dict = {
  ...
  "command.context.addToChat": "Добавить выделение в чат",
  "command.context.addToChat.description": "Вставить выбранные строки в позицию курсора",
  "command.context.quickEdit": "Быстрое редактирование выделения",
  "command.context.quickEdit.description": "Редактировать выбранный код в новой сессии",
  "selection.action.addToChat": "Добавить в чат",
  "selection.action.quickEdit": "Быстрое редактирование",
  "selection.quickEdit.placeholder": "Редактировать выбранный код",
  "selection.quickEdit.submit": "Начать",
