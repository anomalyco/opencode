export const dict = {
  ...
  "command.context.addToChat": "إضافة التحديد إلى الدردشة",
  "command.context.addToChat.description": "إدراج الأسطر المحددة عند موضع المؤشر",
  "command.context.quickEdit": "تحرير سريع للتحديد",
  "command.context.quickEdit.description": "تحرير الكود المحدد في جلسة جديدة",
  "selection.action.addToChat": "إضافة إلى الدردشة",
  "selection.action.quickEdit": "تحرير سريع",
  "selection.quickEdit.placeholder": "تحرير الكود المحدد",
  "selection.quickEdit.submit": "بدء",
