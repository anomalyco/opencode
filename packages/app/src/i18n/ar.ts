export const dict = {
  ...
  "prompt.action.expand": "توسيع المحرر",
  "prompt.attachment.remove": "إزالة المرفق",
  "prompt.action.send": "إرسال",
  "prompt.action.stop": "توقف",
  "prompt.editor.title": "تحرير المطالبة",
  ...
  "error.page.action.restartFrontend": "إعادة تشغيل الواجهة الأمامية",
  "error.page.action.restartBackend": "إعادة تشغيل الواجهة الخلفية",
  "error.page.action.restartApp": "إعادة تشغيل التطبيق",
