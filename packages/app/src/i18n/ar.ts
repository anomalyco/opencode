export const dict = {
  ...
  "settings.general.row.sendKey.title": "مفتاح الإرسال",
  "settings.general.row.sendKey.description": "اختر المفتاح الذي يرسل الرسائل. مفتاح Enter الآخر يُدرج سطرًا جديدًا.",
