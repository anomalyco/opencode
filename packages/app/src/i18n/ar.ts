export const dict = {
  ...
  "command.todo.toggle": "تبديل لوحة المهام",
  ...
  "sidebar.issue.title": "المهام",
  "sidebar.issue.add": "إضافة مهمة",
  "sidebar.issue.addSubtodo": "إضافة مهمة فرعية",
  "sidebar.issue.empty": "لا توجد مهام",
  "sidebar.issue.collapse": "طي المهام الفرعية",
  "sidebar.issue.expand": "توسيع المهام الفرعية",
  "sidebar.issue.confirmDeleteWithChildren": "حذف هذه المهمة و {{count}} من مهامها الفرعية؟",
  "sidebar.issue.toast.deleteFailed": "فشل حذف المهمة",
  "sidebar.issue.tooltip.cycleStatus": "تبديل الحالة",
  "sidebar.issue.tooltip.cyclePriority": "تبديل الأولوية",
  "sidebar.issue.tooltip.linkedLinear": "مرتبط بـ Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "متصل",
  "sidebar.linear.management": "إدارة ربط Linear",
  "sidebar.linear.management.teamRequired": "يرجى اختيار فريق",
  "sidebar.linear.management.projectRequired": "يرجى اختيار مشروع",
  "sidebar.linear.management.saveFailed": "فشل حفظ ربط Linear",
  "sidebar.linear.management.saved": "تم حفظ ربط Linear",
  "sidebar.linear.management.save": "حفظ",
  "sidebar.linear.toggleHistory": "تبديل سجل المزامنة",
  "sidebar.linear.field.team": "الفريق",
  "sidebar.linear.field.team.loading": "جاري تحميل الفرق...",
  "sidebar.linear.field.team.placeholder": "اختر فريقًا",
  "sidebar.linear.field.project": "المشروع",
  "sidebar.linear.field.project.selectTeamFirst": "اختر فريقًا أولاً",
  "sidebar.linear.field.project.loading": "جاري تحميل المشاريع...",
  "sidebar.linear.field.project.placeholder": "اختر مشروعًا",
  "sidebar.linear.notConfigured": "Linear غير مكوّن",
  "sidebar.linear.notConfiguredHint": "افتح الإدارة لاختيار فريق ومشروع",
  "sidebar.linear.actions": "إجراءات المزامنة",
  "sidebar.linear.push": "دفع",
  "sidebar.linear.pull": "سحب",
  "sidebar.linear.pullFailed": "فشل السحب من Linear",
  "sidebar.linear.pullPartialFailed": "سحب فشل جزئيًا: {{count}} خطأ",
  "sidebar.linear.pullSuccess": "سحب {{pulled}}، تحديث {{updated}}، تخطي {{skipped}}، حذف {{deleted}}",
  "sidebar.linear.pushFailed": "فشل الدفع إلى Linear",
  "sidebar.linear.pushPartialFailed": "دفع فشل جزئيًا: {{count}} خطأ",
  "sidebar.linear.pushSuccess": "تم دفع {{count}} مهمة إلى Linear",
  "sidebar.linear.pushNothing": "لا شيء للدفع",
  "sidebar.linear.syncHistory.syncing": "جارٍ المزامنة...",
  "sidebar.linear.syncHistory.push": "↗ Linear",
  "sidebar.linear.syncHistory.pull": "↙ Linear",
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} عنصر",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} عناصر",
  "sidebar.linear.syncHistory.error": "خطأ",
  "sidebar.linear.syncHistory.empty": "لا يوجد سجل مزامنة",
  "dialog.todo.title.create": "إنشاء مهمة جديدة",
  "dialog.todo.title.edit": "تحرير المهمة",
  "dialog.todo.field.title": "العنوان",
  "dialog.todo.field.title.placeholder": "عنوان المهمة",
  "dialog.todo.field.description": "الوصف",
  "dialog.todo.field.description.placeholder": "أضف تفاصيل أو روابط أو سياق...",
  "dialog.todo.field.description.hint": "يدعم مراجع الملفات والمهارات",
  "dialog.todo.field.status": "الحالة",
  "dialog.todo.field.priority": "الأولوية",
  "dialog.todo.field.dueDate": "تاريخ الاستحقاق",
  "dialog.todo.field.dueDate.placeholder": "تعيين تاريخ الاستحقاق",
  "dialog.todo.field.dueDate.clear": "مسح",
  "dialog.todo.field.dueDate.prevMonth": "الشهر السابق",
  "dialog.todo.field.dueDate.nextMonth": "الشهر التالي",
  "dialog.todo.field.dueDate.shortcut.today": "اليوم",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "غداً",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "خلال أسبوع",
  "dialog.todo.field.dueDate.month.0": "يناير",
  "dialog.todo.field.dueDate.month.1": "فبراير",
  "dialog.todo.field.dueDate.month.2": "مارس",
  "dialog.todo.field.dueDate.month.3": "أبريل",
  "dialog.todo.field.dueDate.month.4": "مايو",
  "dialog.todo.field.dueDate.month.5": "يونيو",
  "dialog.todo.field.dueDate.month.6": "يوليو",
  "dialog.todo.field.dueDate.month.7": "أغسطس",
  "dialog.todo.field.dueDate.month.8": "سبتمبر",
  "dialog.todo.field.dueDate.month.9": "أكتوبر",
  "dialog.todo.field.dueDate.month.10": "نوفمبر",
  "dialog.todo.field.dueDate.month.11": "ديسمبر",
  "dialog.todo.field.labels": "التصنيفات",
  "dialog.todo.field.assignee": "المسؤول",
  "dialog.todo.field.assignee.unassigned": "غير معين",
  "dialog.todo.field.assignee.loadFailed": "فشل تحميل المسؤولين",
  "dialog.todo.field.assignee.loading": "جاري تحميل المسؤولين...",
  "dialog.todo.field.assignee.placeholder": "اختر مسؤولاً",
  "dialog.todo.field.assignee.hint": "من أعضاء فريق Linear",
  "dialog.todo.autocomplete.noFiles": "لم يتم العثور على ملفات",
  "dialog.todo.autocomplete.noSkills": "لم يتم العثور على مهارات",
  "dialog.todo.linkedLinear": "مرتبط بـ Linear",
  "dialog.todo.created": "تم إنشاء المهمة",
  "dialog.todo.updated": "تم تحديث المهمة",
  "dialog.todo.error.titleRequired": "العنوان مطلوب",
  "dialog.todo.error.saveFailed": "فشل حفظ المهمة",
  "dialog.todo.action.create": "إنشاء",
  ...
  "sidebar.issue.priority.none": "لا شيء",
  "sidebar.issue.priority.urgent": "عاجل",
  "sidebar.issue.priority.high": "عالية",
  "sidebar.issue.priority.medium": "متوسطة",
  "sidebar.issue.priority.low": "منخفض",
}
