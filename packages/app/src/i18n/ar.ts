export const dict = {
  ...
  "session.new.branch.search": "البحث عن الفروع",
  "session.new.branch.checkout": "التبديل",
  "session.new.branch.base": "التفريع من",
  "session.new.branch.local": "محلي",
  "session.new.branch.empty": "لا توجد فروع",
  "session.new.branch.switchFailed": "فشل تبديل الفرع",
