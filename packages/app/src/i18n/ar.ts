export const dict = {
  ...
  "session.tab.agents": "الوكلاء",
  "session.agents.empty": "لا توجد وكلاء فرعيين قيد التشغيل",
  "session.agents.costTotal": "التكلفة الإجمالية",
  "session.agents.costSubagents": "الوكلاء الفرعيون",
  "session.agents.count": "الوكلاء",
  "session.agents.tokens": "رموز",
  "session.agents.showAll": "عرض الكل ({{count}})",
  "session.agents.status.idle": "خامل",
  "session.agents.status.busy": "قيد التشغيل",
  "session.agents.status.retry": "إعادة المحاولة",
  "session.agents.status.cancelled": "ملغية",
  "session.agents.status.completed": "مكتمل",
  "session.agents.status.error": "فشل",
