export const dict = {
  ...
  "status.button.label": "الحالة",
  "status.button.tooltip": "عرض حالة النظام",
  "status.tab.servers.one": "{{count}} خادم",
  "status.tab.servers.other": "{{count}} خوادم",
  "status.tab.mcp.one": "{{count}} MCP",
  "status.tab.mcp.other": "{{count}} MCP",
  "status.tab.lsp.one": "{{count}} LSP",
  "status.tab.lsp.other": "{{count}} LSP",
  "status.tab.plugins.one": "{{count}} إضافة",
  "status.tab.plugins.other": "{{count}} إضافات",
  "status.servers.empty": "لا توجد خوادم مكوّنة",
  "status.servers.manage": "إدارة الخوادم",
  "status.mcp.empty": "لا توجد خوادم MCP مكوّنة",
  "status.lsp.empty": "لا توجد خوادم LSP نشطة",
  "status.plugins.empty": "الإضافات مكوّنة في 'opencode.json'",
  "status.noProject": "افتح مشروعاً للعرض",
