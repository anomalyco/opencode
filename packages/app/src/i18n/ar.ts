export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "مضيف SSH غير صالح: {{host}}",
  "desktop.ssh.error.alreadyAdded": "تمت إضافة {{host}} بالفعل",
  "desktop.ssh.error.opencodeNotInstalled": "opencode غير مثبت على {{host}}",
  "desktop.ssh.error.installOpencode": "فشل تثبيت opencode",
  "desktop.ssh.error.connectFailed": "تعذر الاتصال بـ {{host}}",
  "desktop.ssh.error.serverExited": "خرج خادم SSH بعد بدء التشغيل (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "خرج خادم SSH الخاص بـ {{host}} قبل أن يصبح سليمًا (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "انتهت مهلة فحص سلامة الخادم على {{host}} بعد {{timeout}}ms",
  "desktop.ssh.error.commandTimeout": "انتهت مهلة أمر ssh إلى {{host}} بعد {{timeout}}ms",
  "desktop.ssh.error.failedPort": "فشل الحصول على المنفذ",
  "desktop.ssh.error.terminalFailed": "فشل فتح المحطة الطرفية",
  ...
  "ssh.server.add": "إضافة خادم SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "خادم SSH",
  "ssh.server.retryStart": "إعادة الاتصال",
  "ssh.server.disconnect": "قطع الاتصال",
  "ssh.server.openTerminal": "فتح المحطة الطرفية",
  "ssh.server.updating": "جارٍ التحديث...",
  "ssh.server.status.connecting": "جارٍ الاتصال...",
  "ssh.server.status.disconnected": "غير متصل",
  "ssh.add.hostLabel": "مضيف SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint": "يتصل عبر عميل ssh في نظامك، لذا تعمل المضيفات والمفاتيح والوكلاء من تكوين SSH لديك كالمعتاد.",
  "ssh.add.configHosts": "من تكوين SSH لديك",
  "ssh.add.connect": "اتصال",
  "ssh.add.checking": "جارٍ الاتصال...",
  "ssh.add.addServer": "إضافة خادم",
  "ssh.add.adding": "جارٍ الإضافة...",
  "ssh.add.installOpencode": "تثبيت opencode",
  "ssh.add.updateOpencode": "تحديث opencode",
  "ssh.add.installing": "جارٍ التثبيت...",
  "ssh.add.status.unreachable": "تعذر الاتصال",
  "ssh.add.status.opencodeMissing": "opencode غير مثبت على هذا المضيف",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} مثبت، ويتوقع تطبيق سطح المكتب v{{expected}}",
  "ssh.add.status.opencodeFound": "تم العثور على opencode v{{version}}",
  "ssh.add.authHint": "تأكد من أن مصادقة SSH بالمفاتيح تعمل مع هذا المضيف — شغّل `ssh {{host}}` في محطة طرفية للتحقق.",
