export const dict = {
  ...
  "command.session.handoff": "تسليم الجلسة",
  "command.session.handoff.description": "ضغط الجلسة ومتابعة العمل في جلسة جديدة",
  ...
  "toast.session.handoff.failed.title": "فشل تسليم الجلسة",
  "toast.session.handoff.failed.description": "لا يمكن تلخيص هذه الجلسة للتسليم",
