export const dict = {
  ...
  "provider.custom.models.load": "تحميل ديناميكي",
  "provider.custom.models.loading": "جارٍ التحميل...",
  "provider.custom.models.load.invalidUrl": "أدخل عنوان URL أساسي صالح",
  "provider.custom.models.load.unauthorized": "غير مصرح. تحقق من مفتاح API",
  "provider.custom.models.load.invalidFormat": "استجابة الخادم لا تحتوي على قائمة نماذج صالحة",
  "provider.custom.models.load.timeout": "انتهت مهلة تحميل النماذج",
  "provider.custom.models.load.failed": "فشل تحميل النماذج",
  "provider.custom.models.load.empty": "لم يتم العثور على نماذج",
