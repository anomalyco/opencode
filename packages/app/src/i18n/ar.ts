export const dict = {
  ...
  "home.recentlyClosed.options": "تصفية وفرز",
  "home.recentlyClosed.filter.label": "تصفية",
  "home.recentlyClosed.filter.recent": "الأخيرة",
  "home.recentlyClosed.filter.archived": "المؤرشفة",
  "home.recentlyClosed.filter.hidden": "المخفية",
  "home.recentlyClosed.filter.all": "الكل",
  "home.recentlyClosed.filter.empty": "لا توجد مشاريع تطابق هذه التصفية",
  "home.recentlyClosed.sort.label": "فرز",
  "home.recentlyClosed.sort.recent": "الأحدث أولاً",
  "home.recentlyClosed.sort.oldest": "الأقدم أولاً",
  "home.recentlyClosed.sort.nameAsc": "الاسم أ–ي",
  "home.recentlyClosed.sort.nameDesc": "الاسم ي–أ",
  "home.recentlyClosed.search.placeholder": "البحث في المغلقة مؤخرًا",
  "home.recentlyClosed.showMore": "عرض الكل ({{count}})",
  "home.recentlyClosed.showLess": "عرض أقل",
  "home.recentlyClosed.select": "تحديد…",
  "home.recentlyClosed.selectAll": "تحديد الكل",
  "home.recentlyClosed.deselectAll": "إلغاء تحديد الكل",
  "home.recentlyClosed.cancelSelection": "إلغاء التحديد",
  "home.recentlyClosed.selected": "تم تحديد {{count}}",
  "home.recentlyClosed.noResults": "لا توجد مشاريع تطابق «{{query}}»",
  "home.recentlyClosed.archived.badge": "مؤرشف",
  "home.recentlyClosed.hidden.badge": "مخفي",
  "home.recentlyClosed.action.reopen": "إعادة فتح",
  "home.recentlyClosed.action.unarchive": "إلغاء الأرشفة",
  "home.recentlyClosed.action.hide": "إخفاء",
  "home.recentlyClosed.action.unhide": "إظهار",
  "home.recentlyClosed.action.remove": "نسيان",
  "home.recentlyClosed.remove.title": "هل تريد نسيان المشروع؟",
  "home.recentlyClosed.remove.titleMany": "هل تريد نسيان {{count}} مشاريع؟",
  "home.recentlyClosed.remove.confirm": "هل تريد إزالة «{{name}}» من المغلقة مؤخرًا؟ هذا يمسح السجل فقط ولا يحذف الملفات أبدًا.",
  "home.recentlyClosed.remove.confirmMany": "هل تريد إزالة {{count}} مشاريع من المغلقة مؤخرًا؟ هذا يمسح السجل فقط ولا يحذف الملفات أبدًا.",
  "home.recentlyClosed.toast.archived": "تمت الأرشفة",
  "home.recentlyClosed.toast.hidden": "تم الإخفاء",
  "home.recentlyClosed.toast.removed": "تمت الإزالة من المغلقة مؤخرًا",
  "home.recentlyClosed.toast.undo": "تراجع",
