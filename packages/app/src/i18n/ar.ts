export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "قائمة OpenCode",
  "desktop.appMenu.file": "ملف",
  "desktop.appMenu.edit": "تحرير",
  "desktop.appMenu.view": "عرض",
  "desktop.appMenu.go": "انتقال",
  "desktop.appMenu.window": "نافذة",
  "desktop.appMenu.help": "مساعدة",
  "desktop.appMenu.about": "حول OpenCode",
  "desktop.appMenu.checkForUpdates": "التحقق من وجود تحديثات...",
  "desktop.appMenu.settings": "الإعدادات",
  "desktop.appMenu.reloadWebview": "إعادة تحميل عرض الويب",
  "desktop.appMenu.restart": "إعادة التشغيل",
  "desktop.appMenu.exportLogs": "تصدير السجلات...",
  "desktop.appMenu.hide": "إخفاء OpenCode",
  "desktop.appMenu.hideOthers": "إخفاء الآخرين",
  "desktop.appMenu.showAll": "إظهار الكل",
  "desktop.appMenu.quit": "إنهاء OpenCode",
  "desktop.appMenu.newSession": "جلسة جديدة",
  "desktop.appMenu.openProject": "فتح مشروع...",
  "desktop.appMenu.newWindow": "نافذة جديدة",
  "desktop.appMenu.closeWindow": "إغلاق النافذة",
  "desktop.appMenu.undo": "تراجع",
  "desktop.appMenu.redo": "إعادة",
  "desktop.appMenu.cut": "قص",
  "desktop.appMenu.copy": "نسخ",
  "desktop.appMenu.paste": "لصق",
  "desktop.appMenu.delete": "حذف",
  "desktop.appMenu.selectAll": "تحديد الكل",
  "desktop.appMenu.toggleSidebar": "تبديل الشريط الجانبي",
  "desktop.appMenu.toggleTerminal": "تبديل المحطة الطرفية",
  "desktop.appMenu.toggleFileTree": "تبديل شجرة الملفات",
  "desktop.appMenu.reload": "إعادة التحميل",
  "desktop.appMenu.toggleDeveloperTools": "تبديل أدوات المطور",
  "desktop.appMenu.actualSize": "الحجم الفعلي",
  "desktop.appMenu.zoomIn": "تكبير",
  "desktop.appMenu.zoomOut": "تصغير",
  "desktop.appMenu.toggleFullScreen": "تبديل وضع ملء الشاشة",
  "desktop.appMenu.back": "رجوع",
  "desktop.appMenu.forward": "تقدم",
  "desktop.appMenu.previousSession": "الجلسة السابقة",
  "desktop.appMenu.nextSession": "الجلسة التالية",
  "desktop.appMenu.previousProject": "المشروع السابق",
  "desktop.appMenu.nextProject": "المشروع التالي",
  "desktop.appMenu.minimize": "تصغير",
  "desktop.appMenu.zoomWindow": "تكبير",
  "desktop.appMenu.maximize": "تكبير",
  "desktop.appMenu.bringAllToFront": "إحضار الكل إلى المقدمة",
  "desktop.appMenu.documentation": "وثائق OpenCode",
  "desktop.appMenu.supportForum": "منتدى الدعم",
  "desktop.appMenu.shareFeedback": "مشاركة الملاحظات",
  "desktop.appMenu.reportBug": "الإبلاغ عن خطأ",
