export const dict = {
  ...
  "toast.file.uploadFailed.title": "فشل رفع الملف",
  "toast.file.downloadFailed.title": "فشل تنزيل الملف",
  "toast.file.deleteFailed.title": "فشل حذف الملف",
  ...
  "session.files.uploadFile": "رفع ملف",
  "session.files.uploading": "جارٍ الرفع…",
  "session.files.downloadFile": "تنزيل",
  "session.files.refresh": "تحديث",
  "session.files.dropFiles": "أسقط الملفات هنا أو انقر + للرفع",
  "session.files.deleteConfirm": "حذف \"{{path}}\"؟",
  "session.files.uploadTooLarge": "الملف كبير جدًا (الحد الأقصى {{size}})",
