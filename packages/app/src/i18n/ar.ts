export const dict = {
  ...
  "command.tab.closeAll": "إغلاق كل علامات التبويب",
  "command.tab.closeRight": "إغلاق كل علامات التبويب على اليمين",
  "command.tab.closeOthers": "إغلاق كل علامات التبويب باستثناء هذه",
