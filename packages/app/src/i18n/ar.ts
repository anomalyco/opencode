export const dict = {
  ...
  "home.activity.title": "نشاط الرموز",
  "home.activity.daily": "يومي",
  "home.activity.weekly": "أسبوعي",
  "home.activity.cumulative": "تراكمي",
  "home.activity.loading": "جاري تحميل النشاط",
  "home.activity.empty": "لا يوجد نشاط رموز بعد",
  "home.activity.lifetimeTokens": "إجمالي الرموز",
  "home.activity.peakTokens": "ذروة الرموز",
  "home.activity.longestTask": "أطول مهمة",
  "home.activity.currentStreak": "السلسلة الحالية",
  "home.activity.longestStreak": "أطول سلسلة",
  "home.activity.days.one": "{{count}} يوم",
  "home.activity.days.other": "{{count}} أيام",
  "home.activity.summary":
    "{{tokens}} إجمالي الرموز، {{peak}} ذروة الرموز، {{current}} السلسلة الحالية، {{longest}} أطول سلسلة.",
