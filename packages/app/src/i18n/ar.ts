export const dict = {
  ...
  "sidebar.linear.pullHint": "سحب من Linear. ملاحظة: تغييرات التسلسل الهرمي التي تتم على Linear (إعادة التعيين للأب، إزالة الأب) لا يتم مزامنتها محليًا — يتم فقط تسوية قيم الحقول.",
  ...
  "sidebar.issue.toast.archiveFailed": "فشل في أرشفة المهمة",
  "sidebar.issue.toast.reorderFailed": "فشل في إعادة ترتيب المهمة",
  "sidebar.issue.toast.reparentFailed": "فشل في نقل المهمة",
  "sidebar.issue.tooltip.archive": "أرشفة هذه المهمة",
  "sidebar.issue.tooltip.delete": "حذف هذه المهمة",
  "sidebar.issue.confirmArchive": "أرشفة",
  "sidebar.issue.archivedBadge": "مؤرشفة",
  "sidebar.issue.archiveArea.title": "مؤرشفة",
  "sidebar.issue.archiveArea.expand": "إظهار المؤرشفة",
  "sidebar.issue.archiveArea.collapse": "إخفاء المؤرشفة",
  "sidebar.issue.archiveArea.empty": "لا توجد مهام مؤرشفة",
}
