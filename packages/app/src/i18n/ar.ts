export const dict = {
  ...
  "presets.title": "الإعدادات المسبقة",
  "presets.manage": "إدارة الإعدادات المسبقة",
  "presets.count": "{{count}} إعدادات مسبقة",
  "presets.empty": "لا توجد إعدادات مسبقة",
  "presets.empty.hint": "انقر على \"إضافة\" لإنشاء أول إعداد مسبق",
  "presets.add": "إضافة",
  "presets.name": "الاسم",
  "presets.content": "المحتوى",
  "presets.content.placeholder": "المحتوى (يدعم المتغيرات {date} {time} {file} {code} {text})",
  "presets.moveUp": "نقل لأعلى",
  "presets.moveDown": "نقل لأسفل",
  "presets.edit": "تعديل",
  "presets.delete": "حذف",
  "presets.variables.title": "أدخل المتغيرات لـ \"{{name}}\"",
  "presets.variables.next": "التالي",
  "presets.variables.insert": "إدراج",
}
