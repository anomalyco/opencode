export const dict = {
  ...
  "session.review.context.openDefault": "التطبيق الافتراضي",
  "session.review.context.copyRelative": "نسخ المسار النسبي",
  "session.review.context.copyAbsolute": "نسخ المسار المطلق",
