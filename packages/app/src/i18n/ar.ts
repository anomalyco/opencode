export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Argus",
  "desktop.recovery.terminated": "توقفت نافذة Argus بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Argus لا يستجيب",
  ...
  "desktop.wsl.error.installArgus": "فشل تثبيت Argus",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.argusMissing": "argus غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.argusCannotRun": "argus مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.argusNotInstalled": "Argus غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Argus، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Argus.",
  ...
  "wsl.onboarding.checkingArgus": "جارٍ التحقق من Argus...",
  "wsl.onboarding.checkingArgusIn": "جارٍ التحقق من Argus في {{distro}}...",
  "wsl.onboarding.updatingArgus": "جارٍ تحديث Argus...",
  "wsl.onboarding.updatingArgusIn": "جارٍ تحديث Argus في {{distro}}...",
  "wsl.onboarding.updateArgusIn": "حدّث Argus في {{distro}}.",
  "wsl.onboarding.updateArgus": "تحديث Argus",
  "wsl.onboarding.argusReadyIn": "Argus جاهز في {{distro}}.",
  "wsl.onboarding.argusReady": "Argus جاهز.",
  "wsl.onboarding.installArgusIn": "ثبّت Argus في {{distro}}.",
  "wsl.onboarding.installArgus": "تثبيت Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Argus من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Argus التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Argus.",
  ...
  "help.tabs.introduction": "أصبح Argus Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Argus ({{version}}) للتثبيت.",
  ...
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Argus يتبع سمة النظام أو الفاتح أو الداكن",
