export const dict = {
  ...
  "palette.group.files": "تطابقات أسماء الملفات",
  "palette.group.content": "تطابقات محتوى الملفات المحلية",
  "palette.group.chat": "تطابقات محتوى الدردشة",
  "palette.group.sessions": "تطابقات أسماء الجلسات",
  "palette.group.files.count": "{{count}} نتائج.",
  "palette.group.content.count": "{{count}} نتائج في {{files}} ملفات.",
  "palette.group.chat.count": "{{count}} نتائج في {{sessions}} جلسات.",
  "palette.group.sessions.count": "{{count}} نتائج.",
