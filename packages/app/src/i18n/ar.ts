export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Pencode",
  "desktop.recovery.terminated": "توقفت نافذة Pencode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Pencode لا يستجيب",
  ...
  "desktop.wsl.error.installPencode": "فشل تثبيت Pencode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.pencodeMissing": "pencode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.pencodeCannotRun": "pencode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Pencode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.pencode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.pencode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.pencodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Pencode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "يمنحك Pencode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Pencode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في pencode.json",
  ...
  "dialog.server.description": "تبديل خادم Pencode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingPencode": "جارٍ التحقق من Pencode...",
  "wsl.onboarding.checkingPencodeIn": "جارٍ التحقق من Pencode في {{distro}}...",
  "wsl.onboarding.updatingPencode": "جارٍ تحديث Pencode...",
  "wsl.onboarding.updatingPencodeIn": "جارٍ تحديث Pencode في {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "حدّث Pencode في {{distro}}.",
  "wsl.onboarding.updatePencode": "تحديث Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode جاهز في {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode جاهز.",
  "wsl.onboarding.installPencodeIn": "ثبّت Pencode في {{distro}}.",
  "wsl.onboarding.installPencode": "تثبيت Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Pencode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Pencode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Pencode.",
  ...
  "help.tabs.introduction": "أصبح Pencode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Pencode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Pencode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (pencode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Pencode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Pencode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Pencode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Pencode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Pencode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Pencode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Pencode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Pencode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Pencode.",
