...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Pencode failed to load",
  "desktop.recovery.terminated": "Pencode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Pencode is not responding",
  ...
  "desktop.wsl.error.installPencode": "Pencode installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.pencodeMissing": "pencode is not installed in this distro",
  "desktop.wsl.error.pencodeCannotRun": "pencode is installed but could not run",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
