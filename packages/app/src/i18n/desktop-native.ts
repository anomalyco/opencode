...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Argus failed to load",
  "desktop.recovery.terminated": "Argus window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Argus is not responding",
  ...
  "desktop.wsl.error.installArgus": "Argus installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.argusMissing": "argus is not installed in this distro",
  "desktop.wsl.error.argusCannotRun": "argus is installed but could not run",
  "desktop.wsl.error.argusNotInstalled": "Argus is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
