export const dict = {
  ...
  "desktop.menu.ariaLabel": "Argus-meny",
  ...
  "desktop.recovery.loadFailed": "Argus kunde inte läsas in",
  "desktop.recovery.terminated": "Argus-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Argus svarar inte",
  ...
  "desktop.wsl.error.installArgus": "Installationen av Argus misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.argusMissing": "argus är inte installerat i den här distributionen",
  "desktop.wsl.error.argusCannotRun": "argus är installerat men kunde inte köras",
  "desktop.wsl.error.argusNotInstalled": "Argus är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.argus.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.argus.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.argusGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Argus",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.argusZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.argusZen.visit.prefix": "Besök ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Argus.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i argus.json",
  ...
  "dialog.server.description": "Växla vilken Argus-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingArgus": "Kontrollerar Argus...",
  "wsl.onboarding.checkingArgusIn": "Kontrollerar Argus i {{distro}}...",
  "wsl.onboarding.updatingArgus": "Uppdaterar Argus...",
  "wsl.onboarding.updatingArgusIn": "Uppdaterar Argus i {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Uppdatera Argus i {{distro}}.",
  "wsl.onboarding.updateArgus": "Uppdatera Argus",
  "wsl.onboarding.argusReadyIn": "Argus är redo i {{distro}}.",
  "wsl.onboarding.argusReady": "Argus är redo.",
  "wsl.onboarding.installArgusIn": "Installera Argus i {{distro}}.",
  "wsl.onboarding.installArgus": "Installera Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Argus kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Argus kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Argus igen.",
  ...
  "help.tabs.introduction": "Argus Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Argus ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Argus-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (argus.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Argus stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Argus innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Argus-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Argus",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Argus ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Argus följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Arguss tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Argus startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Argus.",
