export const dict = {
  ...
  "command.session.handoff": "Lämna över session",
  "command.session.handoff.description": "Komprimera sessionen och fortsätt arbetet i en ny session",
  ...
  "toast.session.handoff.failed.title": "Kunde inte lämna över sessionen",
  "toast.session.handoff.failed.description": "Den här sessionen kunde inte sammanfattas för överlämning",
