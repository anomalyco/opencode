export const dict = {
  ...
  "session.tab.agents": "Subagenter",
  "session.agents.empty": "Inga subagenter körs",
  "session.agents.costTotal": "Total kostnad",
  "session.agents.costSubagents": "Subagenter",
  "session.agents.count": "Agenter",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Visa alla ({{count}})",
  "session.agents.status.idle": "Inaktiv",
  "session.agents.status.busy": "Körs",
  "session.agents.status.retry": "Försöker igen",
  "session.agents.status.cancelled": "Avbruten",
  "session.agents.status.completed": "Slutförd",
  "session.agents.status.error": "Misslyckades",
