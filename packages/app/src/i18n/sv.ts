export const dict = {
  ...
  "desktop.menu.ariaLabel": "Pencode-meny",
  ...
  "desktop.recovery.loadFailed": "Pencode kunde inte läsas in",
  "desktop.recovery.terminated": "Pencode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Pencode svarar inte",
  ...
  "desktop.wsl.error.installPencode": "Installationen av Pencode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.pencodeMissing": "pencode är inte installerat i den här distributionen",
  "desktop.wsl.error.pencodeCannotRun": "pencode är installerat men kunde inte köras",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.pencode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.pencode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.pencodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Pencode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.pencodeZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.pencodeZen.visit.prefix": "Besök ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Pencode.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i pencode.json",
  ...
  "dialog.server.description": "Växla vilken Pencode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingPencode": "Kontrollerar Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Kontrollerar Pencode i {{distro}}...",
  "wsl.onboarding.updatingPencode": "Uppdaterar Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Uppdaterar Pencode i {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Uppdatera Pencode i {{distro}}.",
  "wsl.onboarding.updatePencode": "Uppdatera Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode är redo i {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode är redo.",
  "wsl.onboarding.installPencodeIn": "Installera Pencode i {{distro}}.",
  "wsl.onboarding.installPencode": "Installera Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Pencode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Pencode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Pencode igen.",
  ...
  "help.tabs.introduction": "Pencode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Pencode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Pencode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (pencode.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Pencode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Pencode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Pencode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Pencode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Pencode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Pencode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Pencodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Pencode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Pencode.",
