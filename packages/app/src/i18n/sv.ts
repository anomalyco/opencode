export const dict = {
  ...
  "provider.custom.models.load": "Ladda dynamiskt",
  "provider.custom.models.loading": "Laddar...",
  "provider.custom.models.load.invalidUrl": "Ange en giltig bas-URL",
  "provider.custom.models.load.unauthorized": "Obehörig. Kontrollera API-nyckeln",
  "provider.custom.models.load.invalidFormat": "Serverns svar innehöll inte en giltig modellista",
  "provider.custom.models.load.timeout": "Tidsgräns överskreds vid laddning av modeller",
  "provider.custom.models.load.failed": "Misslyckades att ladda modeller",
  "provider.custom.models.load.empty": "Inga modeller hittades",
