export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Ogiltig SSH-värd: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} har redan lagts till",
  "desktop.ssh.error.opencodeNotInstalled": "opencode är inte installerat på {{host}}",
  "desktop.ssh.error.installOpencode": "Installationen av opencode misslyckades",
  "desktop.ssh.error.connectFailed": "Det gick inte att ansluta till {{host}}",
  "desktop.ssh.error.serverExited": "SSH-servern avslutades efter start (kod={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "SSH-servern för {{host}} avslutades innan den blev felfri (kod={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Tidsgränsen för hälsokontrollen av servern på {{host}} överskreds efter {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "Tidsgränsen för ssh-kommandot till {{host}} överskreds efter {{timeout}} ms",
  "desktop.ssh.error.failedPort": "Det gick inte att hämta porten",
  "desktop.ssh.error.terminalFailed": "Det gick inte att öppna en terminal",
  ...
  "ssh.server.add": "Lägg till SSH-server",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH-server",
  "ssh.server.retryStart": "Återanslut",
  "ssh.server.disconnect": "Koppla från",
  "ssh.server.openTerminal": "Öppna terminalen",
  "ssh.server.updating": "Uppdaterar...",
  "ssh.server.status.connecting": "Ansluter...",
  "ssh.server.status.disconnected": "Frånkopplad",
  "ssh.add.hostLabel": "SSH-värd",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Ansluter via systemets ssh-klient, så värdar, nycklar och agenter från din SSH-konfiguration fungerar som vanligt.",
  "ssh.add.configHosts": "Från din SSH-konfiguration",
  "ssh.add.connect": "Anslut",
  "ssh.add.checking": "Ansluter...",
  "ssh.add.addServer": "Lägg till server",
  "ssh.add.adding": "Lägger till...",
  "ssh.add.installOpencode": "Installera opencode",
  "ssh.add.updateOpencode": "Uppdatera opencode",
  "ssh.add.installing": "Installerar...",
  "ssh.add.status.unreachable": "Det gick inte att ansluta",
  "ssh.add.status.opencodeMissing": "opencode är inte installerat på den här värden",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} installerat, skrivbordsappen förväntar sig v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} hittades",
  "ssh.add.authHint":
    "Kontrollera att nyckelbaserad SSH-autentisering fungerar för den här värden: kör `ssh {{host}}` i en terminal för att testa.",
