export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "अमान्य SSH होस्ट: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} पहले ही जोड़ा जा चुका है",
  "desktop.ssh.error.opencodeNotInstalled": "{{host}} पर opencode इंस्टॉल नहीं है",
  "desktop.ssh.error.installOpencode": "opencode इंस्टॉल नहीं हो सका",
  "desktop.ssh.error.connectFailed": "{{host}} से कनेक्ट नहीं कर सका",
  "desktop.ssh.error.serverExited": "SSH सर्वर स्टार्टअप के बाद बंद हो गया (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}} का SSH सर्वर सुचारु होने से पहले बंद हो गया (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "{{host}} पर सर्वर की स्वास्थ्य जाँच {{timeout}}ms के बाद समय-सीमा पार कर गई",
  "desktop.ssh.error.commandTimeout": "{{host}} के लिए ssh कमांड ने {{timeout}}ms के बाद समय-सीमा पार कर दी",
  "desktop.ssh.error.failedPort": "पोर्ट प्राप्त नहीं किया जा सका",
  "desktop.ssh.error.terminalFailed": "टर्मिनल नहीं खोला जा सका",
  ...
  "ssh.server.add": "SSH सर्वर जोड़ें",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH सर्वर",
  "ssh.server.retryStart": "पुन: कनेक्ट करें",
  "ssh.server.disconnect": "डिस्कनेक्ट करें",
  "ssh.server.openTerminal": "टर्मिनल खोलें",
  "ssh.server.updating": "अद्यतन किया जा रहा है...",
  "ssh.server.status.connecting": "कनेक्ट हो रहा है...",
  "ssh.server.status.disconnected": "डिस्कनेक्टेड",
  "ssh.add.hostLabel": "SSH होस्ट",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "आपके सिस्टम के ssh क्लाइंट के माध्यम से कनेक्ट होता है, इसलिए आपके SSH कॉन्फ़िगरेशन के होस्ट, कुंजियाँ और एजेंट हमेशा की तरह काम करते हैं।",
  "ssh.add.configHosts": "आपके SSH कॉन्फ़िगरेशन से",
  "ssh.add.connect": "कनेक्ट करें",
  "ssh.add.checking": "कनेक्ट हो रहा है...",
  "ssh.add.addServer": "सर्वर जोड़ें",
  "ssh.add.adding": "जोड़ा जा रहा है...",
  "ssh.add.installOpencode": "opencode स्थापित करें",
  "ssh.add.updateOpencode": "opencode को अपडेट करें",
  "ssh.add.installing": "स्थापित किया जा रहा है...",
  "ssh.add.status.unreachable": "कनेक्ट नहीं कर सका",
  "ssh.add.status.opencodeMissing": "इस होस्ट पर opencode इंस्टॉल नहीं है",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} इंस्टॉल है, डेस्कटॉप v{{expected}} की अपेक्षा करता है",
  "ssh.add.status.opencodeFound": "opencode v{{version}} मिला",
  "ssh.add.authHint":
    "सुनिश्चित करें कि इस होस्ट के लिए कुंजी-आधारित SSH प्रमाणीकरण काम करता है — जाँचने के लिए टर्मिनल में `ssh {{host}}` चलाएँ।",
