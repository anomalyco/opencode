export const dict = {
  ...
  "session.tab.agents": "सबएजेंट",
  "session.agents.empty": "कोई सबएजेंट नहीं चल रहा",
  "session.agents.costTotal": "कुल लागत",
  "session.agents.costSubagents": "सबएजेंट",
  "session.agents.count": "एजेंट",
  "session.agents.tokens": "टोकन",
  "session.agents.showAll": "सभी दिखाएं ({{count}})",
  "session.agents.status.idle": "निष्क्रिय",
  "session.agents.status.busy": "चल रहा है",
  "session.agents.status.retry": "पुनः प्रयास",
  "session.agents.status.cancelled": "रद्द",
  "session.agents.status.completed": "पूर्ण",
  "session.agents.status.error": "विफल",
