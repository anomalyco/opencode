export const dict = {
  ...
  "provider.custom.models.load": "गतिशील रूप से लोड करें",
  "provider.custom.models.loading": "लोड हो रहा है...",
  "provider.custom.models.load.invalidUrl": "एक मान्य आधार URL दर्ज करें",
  "provider.custom.models.load.unauthorized": "अनधिकृत। API कुंजी जांचें",
  "provider.custom.models.load.invalidFormat": "सर्वर प्रतिक्रिया में मान्य मॉडल सूची नहीं है",
  "provider.custom.models.load.timeout": "मॉडल लोड करने का समय समाप्त",
  "provider.custom.models.load.failed": "मॉडल लोड करने में विफल",
  "provider.custom.models.load.empty": "कोई मॉडल नहीं मिला",
