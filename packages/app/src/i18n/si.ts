export const dict: Record<string, string> = {
  ...
  "command.session.background": "උප නියෝජිතයන් පසුබිමින් ධාවනය කරන්න",
  "command.session.background.description": "මෙම සැසිය අවහිර කරන උප නියෝජිතයන් වෙන් කර පසුබිමින් ඉදිරියට ගෙන යන්න",
  ...
  "toast.session.background.failed.title": "උප නියෝජිතයන් පසුබිමට මාරු කිරීම අසාර්ථක විය",
