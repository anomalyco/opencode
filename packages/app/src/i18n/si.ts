export const dict: Record<string, string> = {
  ...
  "voice.error.microphonePermission": "පද්ධති සැකසුම් තුළ මයික්‍රොෆෝන ප්‍රවේශයට අවසර දී නැවත උත්සාහ කරන්න.",
  "voice.error.microphoneUnavailable": "මෙම උපාංගයේ මයික්‍රොෆෝනය ආරම්භ කිරීමට නොහැකි විය.",
  ...
  "voice.settings.enabled.description": "ප්‍රොම්ප්ට් සංස්කාරකයේ මයික්‍රොෆෝන බොත්තමක් පෙන්වන්න",
  ...
  "voice.settings.aiModel.description":
    "පටිගත කිරීම් තෝරාගත් සපයන්නා වෙත යවයි. ශ්‍රව්‍ය ආදාන සහාය ප්‍රකාශ කරන ආකෘති පමණක් පෙන්වයි.",
  "voice.settings.aiModel.empty": "සම්බන්ධිත කිසිදු ආකෘතියක් ශ්‍රව්‍ය ආදාන සහාය ප්‍රකාශ නොකරයි.",
