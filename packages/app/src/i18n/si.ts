export const dict: Record<string, string> = {
  ...
  "session.tab.agents": "උප නියෝජිතයෝ",
  "session.agents.empty": "কোন ඔහු නියෝජිතයෙක් ක්‍රියාත්මක නොවේ",
  "session.agents.costTotal": "මුළු පිරිවැය",
  "session.agents.costSubagents": "උප නියෝජිතයෝ",
  "session.agents.count": "නියෝජිතයෝ",
  "session.agents.tokens": "ටෝකන",
  "session.agents.showAll": "සියල්ල පෙන්වන්න ({{count}})",
  "session.agents.status.idle": "අක්‍රිය",
  "session.agents.status.busy": "ක්‍රියාත්මක වෙමින්",
  "session.agents.status.retry": "නැවත උත්සාහ කරමින්",
  "session.agents.status.cancelled": "අවලංගු කරන ලදී",
  "session.agents.status.completed": "සම්පූර්ණ කරන ලදී",
  "session.agents.status.error": "අසාර්ථක විය",
