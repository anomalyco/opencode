export const dict: Record<string, string> = {
  ...
  "command.session.handoff": "සැසිය භාර දෙන්න",
  "command.session.handoff.description": "සැසිය සාරාංශ කර නව සැසියක වැඩ දිගටම කරගෙන යන්න",
  ...
  "toast.session.handoff.failed.title": "සැසිය භාර දීමට අසමත් විය",
  "toast.session.handoff.failed.description": "භාර දීම සඳහා මෙම සැසිය සාරාංශ කිරීමට නොහැකි විය",
