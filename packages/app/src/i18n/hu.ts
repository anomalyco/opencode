...
export const dict = {
  ...
  "command.tab.closeAll": "Összes lap bezárása",
  "command.tab.closeRight": "Jobbra lévő összes lap bezárása",
  "command.tab.closeOthers": "Az összes lap bezárása ennek kivételével",
