...
export const dict = {
  ...
  "command.session.handoff": "Munkamenet átadása",
  "command.session.handoff.description": "Tömörítse a munkamenetet, és folytassa a munkát egy új munkamenetben",
  ...
  "toast.session.handoff.failed.title": "Nem sikerült átadni a munkamenetet",
  "toast.session.handoff.failed.description": "Nem sikerült összefoglalni ezt a munkamenetet az átadáshoz",
