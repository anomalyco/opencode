...
const desktop = [
  ...
  "Kilépés",
  "Az Pencode betöltése sikertelen",
  "Az Pencode ablaka váratlanul leállt",
  "Az Pencode nem válaszol",
  ...
  "Az Pencode telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az pencode nincs telepítve ebben a disztribúcióban",
  "Az pencode telepítve van, de nem futtatható",
  "Az Pencode nincs telepítve ebben: {{distro}}",
  "Az Pencode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.pencode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.pencode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.pencodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A Pencode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Pencode-ben.",
  ...
  "provider.connect.pencodeZen.line1":
    "A Pencode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Látogatás",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Pencode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Pencode-ben.",
  ...
  "dialog.plugins.empty": "Az pencode.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Pencode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode ellenőrzése...",
  "wsl.onboarding.checkingPencodeIn": "Pencode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingPencode": "Pencode frissítése...",
  "wsl.onboarding.updatingPencodeIn": "Pencode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updatePencodeIn": "Frissítse a Pencode-t a {{distro}}-ben.",
  "wsl.onboarding.updatePencode": "Frissítse a Pencode-t",
  "wsl.onboarding.pencodeReadyIn": "A Pencode készen áll a {{distro}}-ben.",
  "wsl.onboarding.pencodeReady": "A Pencode készen áll.",
  "wsl.onboarding.installPencodeIn": "Telepítse a Pencode-t a {{distro}}-be.",
  "wsl.onboarding.installPencode": "Telepítse a Pencode-t",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "A Pencode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Pencode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Pencode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Pencode programot.",
  ...
  "help.tabs.introduction": "A Pencode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Pencode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Pencode csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (pencode.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Pencode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Pencode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Pencode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Pencode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Pencode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Pencode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Pencode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Pencode témáját.",
  ...
  "settings.updates.row.startup.description": "A Pencode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Pencode legújabb verzióját futtatja.",
