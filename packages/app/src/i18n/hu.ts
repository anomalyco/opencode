...
export const dict = {
  ...
  "settings.tab.plugins": "Pluginek",
  "settings.plugins.section.browse": "Böngészés",
  "settings.plugins.section.installed": "Telepítve",
  ...
  "settings.mcp.add": "Szerver hozzáadása",
  "settings.mcp.empty": "Nincs konfigurálva MCP-szerver.",
  "settings.mcp.deleted": "{{name}} törölve.",
  "settings.mcp.errors.refresh": "Az MCP-szerverek betöltése nem sikerült.",
  "settings.mcp.status.pending": "kapcsolódás…",
  "settings.mcp.action.connect": "Kapcsolódás",
  "settings.mcp.action.disconnect": "Kapcsolat bontása",
  "settings.mcp.action.authenticate": "Hitelesítés",
  "settings.mcp.action.edit": "Szerkesztés",
  "settings.mcp.action.delete": "Törlés",
  "settings.mcp.delete.title": "MCP-szerver törlése",
  "settings.mcp.delete.body": "Eltávolítod: {{name}}? Ez nem visszavonható.",
  "settings.mcp.form.title.add": "MCP-szerver hozzáadása",
  "settings.mcp.form.title.edit": "MCP-szerver szerkesztése",
  "settings.mcp.form.subtitle": "Állítsd be a kapcsolat beállításait.",
  "settings.mcp.form.name": "Név",
  "settings.mcp.form.command": "Parancs",
  "settings.mcp.form.command.hint": "pl. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Munkakönyvtár",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Környezeti változók",
  "settings.mcp.form.headers": "Fejlécek",
  "settings.mcp.form.addRow": "Sor hozzáadása",
  "settings.mcp.form.removeRow": "Eltávolítás",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Ügyfél-azonosító",
  "settings.mcp.form.oauth.clientSecret": "Ügyféltitok",
  "settings.mcp.form.oauth.clientSecret.keep": "Beállítva — hagyd üresen a megtartásához",
  "settings.mcp.form.oauth.scope": "Hatókör",
  "settings.mcp.form.oauth.callbackPort": "Callback-port",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth automatikus felismerés letiltása",
  "settings.mcp.form.enabled": "Engedélyezve",
  "settings.mcp.form.timeout": "Időkorlát (ms)",
  "settings.mcp.form.save": "Mentés",
  "settings.mcp.form.cancel": "Mégse",
  "settings.mcp.form.error.name": "Adj meg egy nevet.",
  "settings.mcp.form.error.command": "Adj meg egy parancsot.",
  "settings.mcp.form.error.url": "Adj meg egy URL-t.",
  "settings.mcp.form.error.callbackPort": "A callback-port 1 és 65535 között legyen.",
  "settings.mcp.form.error.timeout": "Az időkorlát legyen pozitív egész szám.",
  "settings.mcp.errors.invalid": "Javítsd a kiemelt mezőket.",
  "settings.mcp.errors.duplicate": "Már létezik ezzel a névvel szerver.",
  "settings.mcp.errors.noConfig": "A(z) {{name}} konfigurációja nem olvasható — lehet, hogy a projekten kívül van definiálva.",
  "settings.mcp.edit.warn": "A mentés újracsatlakoztatja a szervert.",
  ...
  "settings.plugins.detail.copied": "Kimásolva",
  "settings.plugins.detail.notOnNpm": "Nem található az npm-en — add hozzá kézzel az opencode.json fájlhoz",
  "settings.plugins.install.title": "Plugin telepítése",
  "settings.plugins.install.description": "Hova kerüljön {{name}}?",
  "settings.plugins.install.global": "Globális (~/.config/opencode)",
  "settings.plugins.install.project": "Ez a projekt",
  "settings.plugins.install.cancel": "Mégse",
  "settings.plugins.install.success": "{{name}} telepítve. A betöltéshez indítsd újra az OpenCode-ot.",
  "settings.plugins.installed.empty": "Nincsenek telepítve pluginok.",
  "settings.plugins.installed.provenance.global": "Globális",
  ...
  "settings.plugins.errors.catalog": "A plugin-katalógus frissítése nem sikerült.",
  "settings.plugins.stale": "Gyorsítótárazott katalógus megjelenítése ({{age}} óta).",
