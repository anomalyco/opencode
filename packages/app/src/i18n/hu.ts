...
const desktop = [
  ...
  "Kilépés",
  "Az Argus betöltése sikertelen",
  "Az Argus ablaka váratlanul leállt",
  "Az Argus nem válaszol",
  ...
  "Az Argus telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az argus nincs telepítve ebben a disztribúcióban",
  "Az argus telepítve van, de nem futtatható",
  "Az Argus nincs telepítve ebben: {{distro}}",
  "Az Argus frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.argus.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.argus.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.argusGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A Argus ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Argus-ben.",
  ...
  "provider.connect.argusZen.line1":
    "A Argus Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.argusZen.visit.prefix": "Látogatás",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Argus-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Argus-ben.",
  ...
  "dialog.plugins.empty": "Az argus.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Argus szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingArgus": "Argus ellenőrzése...",
  "wsl.onboarding.checkingArgusIn": "Argus ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingArgus": "Argus frissítése...",
  "wsl.onboarding.updatingArgusIn": "Argus frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateArgusIn": "Frissítse a Argus-t a {{distro}}-ben.",
  "wsl.onboarding.updateArgus": "Frissítse a Argus-t",
  "wsl.onboarding.argusReadyIn": "A Argus készen áll a {{distro}}-ben.",
  "wsl.onboarding.argusReady": "A Argus készen áll.",
  "wsl.onboarding.installArgusIn": "Telepítse a Argus-t a {{distro}}-be.",
  "wsl.onboarding.installArgus": "Telepítse a Argus-t",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "A Argus nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Argus hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Argus nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Argus programot.",
  ...
  "help.tabs.introduction": "A Argus Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Argus ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Argus csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (argus.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Argus még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Argus ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Argus asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Argus szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Argus kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Argus az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Argus a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Argus témáját.",
  ...
  "settings.updates.row.startup.description": "A Argus indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Argus legújabb verzióját futtatja.",
