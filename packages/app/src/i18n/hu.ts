...
export const dict = {
  ...
  "session.tab.agents": "Alügynökök",
  "session.agents.empty": "Nincs futó alügynök",
  "session.agents.costTotal": "Összköltség",
  "session.agents.costSubagents": "Alügynökök",
  "session.agents.count": "Ügynökök",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Összes megjelenítése ({{count}})",
  "session.agents.status.idle": "Tétlen",
  "session.agents.status.busy": "Fut",
  "session.agents.status.retry": "Újrapróbálás",
  "session.agents.status.cancelled": "Megszakítva",
  "session.agents.status.completed": "Befejezve",
  "session.agents.status.error": "Sikertelen",
