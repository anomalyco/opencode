...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "ügyfélregisztráció szükséges",
  "mcp.status.pending": "kapcsolódás…",
  ...
  "settings.mcp.type.local": "Helyi",
  "settings.mcp.type.remote": "Távoli",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Hagyd üresen a kihagyáshoz — újbóli hitelesítés lehet szükséges",
