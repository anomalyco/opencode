...
export const dict = {
  ...
  "provider.custom.models.load": "Dinamikus betöltés",
  "provider.custom.models.loading": "Betöltés...",
  "provider.custom.models.load.invalidUrl": "Adjon meg egy érvényes alap URL-t",
  "provider.custom.models.load.unauthorized": "Nem jogosult. Ellenőrizze az API-kulcsot",
  "provider.custom.models.load.invalidFormat": "A kiszolgáló válasza nem tartalmazott érvényes modellistát",
  "provider.custom.models.load.timeout": "Időtúllépés a modellek betöltésekor",
  "provider.custom.models.load.failed": "A modellek betöltése sikertelen",
  "provider.custom.models.load.empty": "Nem találhatók modellek",
