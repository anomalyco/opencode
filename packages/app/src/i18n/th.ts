export const dict = {
  ...
  "command.context.addToChat": "เพิ่มส่วนที่เลือกไปยังแชต",
  "command.context.addToChat.description": "แทรกบรรทัดที่เลือกที่ตำแหน่งเคอร์เซอร์",
  "command.context.quickEdit": "แก้ไขด่วนสำหรับส่วนที่เลือก",
  "command.context.quickEdit.description": "แก้ไขโค้ดที่เลือกในเซสชันใหม่",
  "selection.action.addToChat": "เพิ่มไปยังแชต",
  "selection.action.quickEdit": "แก้ไขด่วน",
  "selection.quickEdit.placeholder": "แก้ไขโค้ดที่เลือก",
  "selection.quickEdit.submit": "เริ่ม",
