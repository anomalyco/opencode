export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "โฮสต์ SSH ไม่ถูกต้อง: {{host}}",
  "desktop.ssh.error.alreadyAdded": "เพิ่ม {{host}} แล้ว",
  "desktop.ssh.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง opencode บน {{host}}",
  "desktop.ssh.error.installOpencode": "การติดตั้ง opencode ล้มเหลว",
  "desktop.ssh.error.connectFailed": "ไม่สามารถเชื่อมต่อกับ {{host}} ได้",
  "desktop.ssh.error.serverExited": "เซิร์ฟเวอร์ SSH หยุดทำงานหลังเริ่มต้น (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "เซิร์ฟเวอร์ SSH สำหรับ {{host}} หยุดทำงานก่อนพร้อมใช้งาน (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "การตรวจสอบสถานะเซิร์ฟเวอร์บน {{host}} หมดเวลาหลังจาก {{timeout}}ms",
  "desktop.ssh.error.commandTimeout": "คำสั่ง ssh ไปยัง {{host}} หมดเวลาหลังจาก {{timeout}}ms",
  "desktop.ssh.error.failedPort": "ไม่สามารถรับพอร์ตได้",
  "desktop.ssh.error.terminalFailed": "ไม่สามารถเปิดเทอร์มินัลได้",
  ...
  "ssh.server.add": "เพิ่มเซิร์ฟเวอร์ SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "เซิร์ฟเวอร์ SSH",
  "ssh.server.retryStart": "เชื่อมต่ออีกครั้ง",
  "ssh.server.disconnect": "ยกเลิกการเชื่อมต่อ",
  "ssh.server.openTerminal": "เปิดเทอร์มินัล",
  "ssh.server.updating": "กำลังอัปเดต...",
  "ssh.server.status.connecting": "กำลังเชื่อมต่อ...",
  "ssh.server.status.disconnected": "ยกเลิกการเชื่อมต่อแล้ว",
  "ssh.add.hostLabel": "โฮสต์ SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "เชื่อมต่อผ่านไคลเอ็นต์ ssh ของระบบ ดังนั้นโฮสต์ คีย์ และเอเจนต์จากการกำหนดค่า SSH ของคุณจึงใช้งานได้ตามปกติ",
  "ssh.add.configHosts": "จากการกำหนดค่า SSH ของคุณ",
  "ssh.add.connect": "เชื่อมต่อ",
  "ssh.add.checking": "กำลังเชื่อมต่อ...",
  "ssh.add.addServer": "เพิ่มเซิร์ฟเวอร์",
  "ssh.add.adding": "กำลังเพิ่ม...",
  "ssh.add.installOpencode": "ติดตั้ง opencode",
  "ssh.add.updateOpencode": "อัปเดต opencode",
  "ssh.add.installing": "กำลังติดตั้ง...",
  "ssh.add.status.unreachable": "ไม่สามารถเชื่อมต่อได้",
  "ssh.add.status.opencodeMissing": "ไม่ได้ติดตั้ง opencode บนโฮสต์นี้",
  "ssh.add.status.opencodeMismatch": "ติดตั้ง opencode v{{version}} แล้ว แต่เดสก์ท็อปต้องการ v{{expected}}",
  "ssh.add.status.opencodeFound": "พบ opencode v{{version}}",
  "ssh.add.authHint":
    "ตรวจสอบให้แน่ใจว่าการตรวจสอบสิทธิ์ SSH ด้วยคีย์ใช้งานได้กับโฮสต์นี้ โดยเรียกใช้ `ssh {{host}}` ในเทอร์มินัลเพื่อทดสอบ",
