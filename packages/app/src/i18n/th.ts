export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Jarvis ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Jarvis หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Jarvis ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง Jarvis ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง Jarvis ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Jarvis เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Jarvis",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Jarvis",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Jarvis",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Jarvis ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Jarvis ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Jarvis ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Jarvis ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "Jarvis พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Jarvis ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Jarvis",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Jarvis จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Jarvis ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Jarvis อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Jarvis Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Jarvis ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Jarvis",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Jarvis ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Jarvis รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.tab.integrations": "การผสานรวม",
  "settings.tab.connectors": "ตัวเชื่อมต่อ",
  "settings.integrations.placeholder": "การผสานรวมขยายความสามารถของ Jarvis ในเร็วๆ นี้คุณจะสามารถติดตั้งปลั๊กอิน ธีม และส่วนขยายระบบได้",
  "settings.connectors.placeholder": "ตัวเชื่อมต่อเชื่อม Jarvis กับบริการภายนอก เร็วๆ นี้: Gmail, WhatsApp, Slack, Notion, Telegram และอื่นๆ",
  "settings.connectors.unavailable": "ตัวเชื่อมต่อพร้อมใช้งานเฉพาะในแอปเดสก์ท็อปเท่านั้น",
  ...
  "settings.connectors.github.permission.repos": "อ่านและจัดการที่เก็บโค้ด ปัญหา และคำขอดึงของคุณ",
  "settings.connectors.github.permission.profile": "อ่านโปรไฟล์สาธารณะของคุณ (ชื่อผู้ใช้และรูปโปรไฟล์)",
  "settings.connectors.github.connect": "เชื่อมต่อ GitHub",
  "settings.connectors.github.disconnect": "ยกเลิกการเชื่อมต่อ",
  "settings.connectors.github.cancel": "ยกเลิก",
  "settings.connectors.github.openBrowser": "เปิดเบราว์เซอร์",
  "settings.connectors.github.waiting": "กำลังรอการอนุญาต…",
  "settings.connectors.github.code.instructions": "ป้อนรหัสนี้บน",
  "settings.connectors.github.connected.text": "เชื่อมต่อผ่าน OAuth แล้ว Jarvis สามารถเข้าถึงบัญชี GitHub ของคุณได้",
  "settings.connectors.github.error.expired": "รหัสอนุญาตหมดอายุแล้ว ลองอีกครั้ง",
  "settings.connectors.github.error.generic": "ไม่สามารถเชื่อมต่อกับ GitHub ได้ โปรดตรวจสอบการเชื่อมต่อของคุณแล้วลองอีกครั้ง",
  "settings.connectors.github.error.denied": "การอนุญาตถูกปฏิเสธ คุณสามารถลองอีกครั้งได้ทุกเมื่อ",
  "desktop.menu.wiki": "วิกิ",
  "command.session.export": "ส่งออกเซสชัน",
  "command.session.export.description": "ส่งออกบันทึกการสนทนาทั้งหมดของเซสชันเป็น JSON",
  "context.export.session": "ส่งออกเซสชัน",
  "toast.session.export.success.title": "ส่งออกเซสชันแล้ว",
  "toast.session.export.success.description": "บันทึกเซสชันไปยัง {{filename}}",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Jarvis ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Jarvis",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Jarvis บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Jarvis ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Jarvis",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Jarvis เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Jarvis เวอร์ชันล่าสุด",
