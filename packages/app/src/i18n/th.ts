export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Argus ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Argus หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Argus ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installArgus": "การติดตั้ง Argus ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.argusMissing": "ไม่ได้ติดตั้ง argus ในดิสโทรนี้",
  "desktop.wsl.error.argusCannotRun": "ติดตั้ง argus แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.argusNotInstalled": "ไม่ได้ติดตั้ง Argus ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Argus เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "provider.connect.argusZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Argus",
  ...
  "wsl.onboarding.checkingArgus": "กำลังตรวจสอบ Argus...",
  "wsl.onboarding.checkingArgusIn": "กำลังตรวจสอบ Argus ใน {{distro}}...",
  "wsl.onboarding.updatingArgus": "กำลังอัปเดต Argus...",
  "wsl.onboarding.updatingArgusIn": "กำลังอัปเดต Argus ใน {{distro}}...",
  "wsl.onboarding.updateArgusIn": "อัปเดต Argus ใน {{distro}}",
  "wsl.onboarding.updateArgus": "อัปเดต Argus",
  "wsl.onboarding.argusReadyIn": "Argus พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.argusReady": "Argus พร้อมใช้งานแล้ว",
  "wsl.onboarding.installArgusIn": "ติดตั้ง Argus ใน {{distro}}",
  "wsl.onboarding.installArgus": "ติดตั้ง Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "ยังไม่ได้ติดตั้ง Argus",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Argus จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Argus ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Argus อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Argus Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Argus บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Argus ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Argus",
