export const dict = {
  ...
  "session.review.context.openDefault": "แอปเริ่มต้น",
  "session.review.context.copyRelative": "คัดลอกพาธสัมพัทธ์",
  "session.review.context.copyAbsolute": "คัดลอกพาธสัมบูรณ์",
