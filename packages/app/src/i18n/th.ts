export const dict = {
  ...
  "presets.title": "ค่าที่ตั้งไว้",
  "presets.manage": "จัดการค่าที่ตั้งไว้",
  "presets.count": "ค่าที่ตั้งไว้ {{count}} รายการ",
  "presets.empty": "ไม่มีค่าที่ตั้งไว้",
  "presets.empty.hint": "คลิก \"เพิ่ม\" เพื่อสร้างค่าที่ตั้งไว้แรกของคุณ",
  "presets.add": "เพิ่ม",
  "presets.name": "ชื่อ",
  "presets.content": "เนื้อหา",
  "presets.content.placeholder": "เนื้อหา (รองรับตัวแปร {date} {time} {file} {code} {text})",
  "presets.moveUp": "เลื่อนขึ้น",
  "presets.moveDown": "เลื่อนลง",
  "presets.edit": "แก้ไข",
  "presets.delete": "ลบ",
  "presets.variables.title": "ป้อนตัวแปรสำหรับ \"{{name}}\"",
  "presets.variables.next": "ถัดไป",
  "presets.variables.insert": "แทรก",
}
