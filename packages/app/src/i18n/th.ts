export const dict = {
  ...
  "settings.general.section.input": "การป้อนข้อมูล",
  ...
  "settings.general.row.sendKey.title": "ปุ่มส่ง",
  "settings.general.row.sendKey.description": "เลือกปุ่มที่ใช้ส่งข้อความ ปุ่ม Enter อีกปุ่มหนึ่งจะขึ้นบรรทัดใหม่",
