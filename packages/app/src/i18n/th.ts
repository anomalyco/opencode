export const dict = {
  ...
  "home.activity.title": "กิจกรรมโทเค็น",
  "home.activity.daily": "รายวัน",
  "home.activity.weekly": "รายสัปดาห์",
  "home.activity.cumulative": "สะสม",
  "home.activity.loading": "กำลังโหลดกิจกรรม",
  "home.activity.empty": "ยังไม่มีกิจกรรมโทเค็น",
  "home.activity.lifetimeTokens": "โทเค็นทั้งหมด",
  "home.activity.peakTokens": "โทเค็นสูงสุด",
  "home.activity.longestTask": "งานที่ยาวที่สุด",
  "home.activity.currentStreak": "สถิติต่อเนื่องปัจจุบัน",
  "home.activity.longestStreak": "สถิติต่อเนื่องสูงสุด",
  "home.activity.days.one": "{{count}} วัน",
  "home.activity.days.other": "{{count}} วัน",
  "home.activity.summary":
    "{{tokens}} โทเค็นทั้งหมด, {{peak}} โทเค็นสูงสุด, {{current}} สถิติต่อเนื่องปัจจุบัน, {{longest}} สถิติต่อเนื่องสูงสุด.",
