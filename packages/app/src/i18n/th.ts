export const dict = {
  ...
  "settings.plugins.section.browse": "เรียกดู",
  ...
  "settings.mcp.add": "เพิ่มเซิร์ฟเวอร์",
  "settings.mcp.empty": "ยังไม่มีการกำหนดค่าเซิร์ฟเวอร์ MCP",
  "settings.mcp.deleted": "ลบ {{name}} แล้ว",
  "settings.mcp.errors.refresh": "โหลดเซิร์ฟเวอร์ MCP ไม่สำเร็จ",
  "settings.mcp.status.pending": "กำลังเชื่อมต่อ…",
  "settings.mcp.action.connect": "เชื่อมต่อ",
  "settings.mcp.action.disconnect": "ยกเลิกการเชื่อมต่อ",
  "settings.mcp.action.authenticate": "ยืนยันตัวตน",
  "settings.mcp.action.edit": "แก้ไข",
  "settings.mcp.action.delete": "ลบ",
  "settings.mcp.delete.title": "ลบเซิร์ฟเวอร์ MCP",
  "settings.mcp.delete.body": "ลบ {{name}}? ทำไม่สำเร็จไม่ได้",
  "settings.mcp.form.title.add": "เพิ่มเซิร์ฟเวอร์ MCP",
  "settings.mcp.form.title.edit": "แก้ไขเซิร์ฟเวอร์ MCP",
  "settings.mcp.form.subtitle": "กำหนดค่าการเชื่อมต่อ",
  "settings.mcp.form.name": "ชื่อ",
  "settings.mcp.form.command": "คำสั่ง",
  "settings.mcp.form.command.hint": "เช่น npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ไดเรกทอรีทำงาน",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "ตัวแปรสภาพแวดล้อม",
  "settings.mcp.form.headers": "ส่วนหัว",
  "settings.mcp.form.addRow": "เพิ่มแถว",
  "settings.mcp.form.removeRow": "ลบ",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "รหัสไคลเอนต์",
  "settings.mcp.form.oauth.clientSecret": "ความลับไคลเอนต์",
  "settings.mcp.form.oauth.clientSecret.keep": "กำหนดแล้ว — เว้นว่างไว้เพื่อคงค่า",
  "settings.mcp.form.oauth.scope": "ขอบเขต",
  "settings.mcp.form.oauth.callbackPort": "พอร์ตเรียกกลับ",
  "settings.mcp.form.oauth.disableAutodetect": "ปิดการตรวจจับ OAuth อัตโนมัติ",
  "settings.mcp.form.enabled": "เปิดใช้งาน",
  "settings.mcp.form.timeout": "หมดเวลา (ms)",
  "settings.mcp.form.save": "บันทึก",
  "settings.mcp.form.cancel": "ยกเลิก",
  "settings.mcp.form.error.name": "ป้อนชื่อ",
  "settings.mcp.form.error.command": "ป้อนคำสั่ง",
  "settings.mcp.form.error.url": "ป้อน URL",
  "settings.mcp.form.error.callbackPort": "พอร์ตเรียกกลับต้องอยู่ระหว่าง 1-65535",
  "settings.mcp.form.error.timeout": "หมดเวลาต้องเป็นจำนวนเต็มบวก",
  "settings.mcp.errors.invalid": "แก้ไขช่องที่ไฮไลต์",
  "settings.mcp.errors.duplicate": "มีเซิร์ฟเวอร์ชื่อนี้แล้ว",
  "settings.mcp.errors.noConfig": "อ่านการกำหนดค่าของ {{name}} ไม่ได้ — อาจกำหนดไว้นอกโปรเจกต์",
  "settings.mcp.edit.warn": "บันทึกจะเชื่อมต่อเซิร์ฟเวอร์นี้อีกครั้ง",
  ...
  "settings.plugins.detail.copied": "คัดลอกแล้ว",
  "settings.plugins.detail.notOnNpm": "ไม่พบบน npm — เพิ่มลงใน opencode.json ด้วยตนเอง",
  "settings.plugins.install.title": "ติดตั้งปลั๊กอิน",
  "settings.plugins.install.description": "จะเพิ่ม {{name}} ที่ไหน?",
  "settings.plugins.install.global": "ทั่วโลก (~/.config/opencode)",
  "settings.plugins.install.project": "โปรเจกต์นี้",
  "settings.plugins.install.cancel": "ยกเลิก",
  "settings.plugins.install.success": "ติดตั้ง {{name}} แล้ว รีสตาร์ท OpenCode เพื่อโหลด",
  "settings.plugins.installed.empty": "ไม่มีปลั๊กอินที่ติดตั้ง",
  "settings.plugins.installed.provenance.global": "ทั่วโลก",
  "settings.plugins.installed.provenance.project": "โปรเจกต์",
  ...
  "settings.plugins.errors.catalog": "ไม่สามารถรีเฟรชแคตตาล็กปลั๊กอิน",
  "settings.plugins.stale": "กำลังแสดงแคตตาล็กจากแคช (เก่า {{age}})",
