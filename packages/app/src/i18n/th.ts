export const dict = {
  ...
  "command.todo.toggle": "สลับแผง Todo",
  ...
  "sidebar.issue.title": "สิ่งที่ต้องทำ",
  "sidebar.issue.add": "เพิ่มสิ่งที่ต้องทำ",
  "sidebar.issue.addSubtodo": "เพิ่มสิ่งที่ต้องทำย่อย",
  "sidebar.issue.empty": "ยังไม่มีสิ่งที่ต้องทำ",
  "sidebar.issue.collapse": "ย่องานย่อย",
  "sidebar.issue.expand": "ขยายงานย่อย",
  "sidebar.issue.confirmDeleteWithChildren": "ลบงานนี้และงานย่อย {{count}} รายการ?",
  "sidebar.issue.toast.deleteFailed": "ลบสิ่งที่ต้องทำไม่สำเร็จ",
  "sidebar.issue.tooltip.cycleStatus": "สลับสถานะ",
  "sidebar.issue.tooltip.cyclePriority": "สลับความสำคัญ",
  "sidebar.issue.tooltip.linkedLinear": "เชื่อมต่อกับ Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "เชื่อมต่อแล้ว",
  "sidebar.linear.management": "จัดการการเชื่อมโยง Linear",
  "sidebar.linear.management.teamRequired": "กรุณาเลือกทีม",
  "sidebar.linear.management.projectRequired": "กรุณาเลือกโปรเจกต์",
  "sidebar.linear.management.saveFailed": "บันทึกการเชื่อมโยง Linear ไม่สำเร็จ",
  "sidebar.linear.management.saved": "บันทึกการเชื่อมโยง Linear แล้ว",
  "sidebar.linear.management.save": "บันทึก",
  "sidebar.linear.toggleHistory": "สลับประวัติการซิงค์",
  "sidebar.linear.field.team": "ทีม",
  "sidebar.linear.field.team.loading": "กำลังโหลดทีม...",
  "sidebar.linear.field.team.placeholder": "เลือกทีม",
  "sidebar.linear.field.project": "โปรเจกต์",
  "sidebar.linear.field.project.selectTeamFirst": "กรุณาเลือกทีมก่อน",
  "sidebar.linear.field.project.loading": "กำลังโหลดโปรเจกต์...",
  "sidebar.linear.field.project.placeholder": "เลือกโปรเจกต์",
  "sidebar.linear.notConfigured": "Linear ยังไม่ได้กำหนดค่า",
  "sidebar.linear.notConfiguredHint": "เปิดการจัดการเพื่อเลือกทีมและโปรเจกต์",
  "sidebar.linear.actions": "การดำเนินการซิงค์",
  "sidebar.linear.push": "ส่ง",
  "sidebar.linear.pull": "ดึง",
  "sidebar.linear.pullHint": "ดึงจาก Linear หมายเหตุ: การเปลี่ยนแปลงลำดับชั้นที่ทำบน Linear (เปลี่ยนพาเรนต์ ลบพาเรนต์) จะไม่ถูกซิงค์กับเครื่อง — มีเพียงค่าของฟิลด์เท่านั้นที่ถูกกระทบกระเทือน",
  "sidebar.linear.pullFailed": "ดึงจาก Linear ไม่สำเร็จ",
  "sidebar.linear.pullPartialFailed": "ดึงไม่สำเร็จบางส่วน: {{count}} ข้อผิดพลาด",
  "sidebar.linear.pullSuccess": "ดึง {{pulled}}, อัปเดต {{updated}}, ข้าม {{skipped}}, ลบ {{deleted}}",
  "sidebar.linear.pushFailed": "ส่งไปยัง Linear ไม่สำเร็จ",
  "sidebar.linear.pushPartialFailed": "ส่งไม่สำเร็จบางส่วน: {{count}} ข้อผิดพลาด",
  "sidebar.linear.pushSuccess": "ส่ง {{count}} สิ่งที่ต้องทำไปยัง Linear",
  "sidebar.linear.pushNothing": "ไม่มีอะไรต้องส่ง",
  "sidebar.linear.syncHistory.syncing": "กำลังซิงค์...",
  "sidebar.linear.syncHistory.error": "ข้อผิดพลาด",
  "sidebar.linear.syncHistory.empty": "ไม่มีประวัติการซิงค์",
  "dialog.todo.title.create": "สิ่งที่ต้องทำใหม่",
  "dialog.todo.title.edit": "แก้ไขสิ่งที่ต้องทำ",
  "dialog.todo.field.title": "ชื่อ",
  "dialog.todo.field.title.placeholder": "ชื่อสิ่งที่ต้องทำ",
  "dialog.todo.field.description": "คำอธิบาย",
  "dialog.todo.field.description.placeholder": "เพิ่มรายละเอียด ลิงก์ หรือบริบท...",
  "dialog.todo.field.description.hint": "รองรับการอ้างอิงไฟล์และทักษะ",
  "dialog.todo.field.status": "สถานะ",
  "dialog.todo.field.priority": "ความสำคัญ",
  "dialog.todo.field.dueDate": "วันครบกำหนด",
  "dialog.todo.field.dueDate.placeholder": "ตั้งวันครบกำหนด",
  "dialog.todo.field.dueDate.clear": "ล้าง",
  "dialog.todo.field.dueDate.prevMonth": "เดือนก่อนหน้า",
  "dialog.todo.field.dueDate.nextMonth": "เดือนถัดไป",
  "dialog.todo.field.dueDate.shortcut.today": "วันนี้",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "พรุ่งนี้",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "ในหนึ่งสัปดาห์",
  ...
  "dialog.todo.field.labels": "ป้ายกำกับ",
  "dialog.todo.field.assignee": "ผู้รับผิดชอบ",
  "dialog.todo.field.assignee.unassigned": "ยังไม่ได้มอบหมาย",
  "dialog.todo.field.assignee.loadFailed": "โหลดผู้รับผิดชอบไม่สำเร็จ",
  "dialog.todo.field.assignee.loading": "กำลังโหลดผู้รับผิดชอบ...",
  "dialog.todo.field.assignee.placeholder": "เลือกผู้รับผิดชอบ",
  "dialog.todo.field.assignee.hint": "มาจากสมาชิกทีม Linear",
  "dialog.todo.linkedLinear": "เชื่อมต่อกับ Linear",
  "dialog.todo.created": "สร้างสิ่งที่ต้องทำแล้ว",
  "dialog.todo.updated": "อัปเดตสิ่งที่ต้องทำแล้ว",
  "dialog.todo.error.titleRequired": "ชื่อเป็นข้อมูลที่จำเป็น",
  "dialog.todo.error.saveFailed": "บันทึกสิ่งที่ต้องทำไม่สำเร็จ",
  "dialog.todo.action.create": "สร้าง",
  ...
  "sidebar.issue.priority.none": "ไม่มี",
  "sidebar.issue.priority.urgent": "เร่งด่วน",
  "sidebar.issue.priority.high": "สูง",
  "sidebar.issue.priority.medium": "ปานกลาง",
  "sidebar.issue.priority.low": "ต่ำ",
  "sidebar.issue.toast.archiveFailed": "ไม่สามารถเก็บถาวรงานได้",
  "sidebar.issue.toast.reorderFailed": "จัดลำดับงานใหม่ไม่สำเร็จ",
  "sidebar.issue.toast.reparentFailed": "ย้ายงานไม่สำเร็จ",
  "sidebar.issue.tooltip.archive": "เก็บถาวรงานนี้",
  "sidebar.issue.tooltip.delete": "ลบงานนี้",
  "sidebar.issue.confirmArchive": "เก็บถาวร",
  "sidebar.issue.archivedBadge": "ถูกเก็บถาวร",
  "sidebar.issue.archiveArea.title": "ถูกเก็บถาวร",
  "sidebar.issue.archiveArea.expand": "แสดงรายการที่เก็บถาวร",
  "sidebar.issue.archiveArea.collapse": "ซ่อนรายการที่เก็บถาวร",
  "sidebar.issue.archiveArea.empty": "ไม่มีงานที่เก็บถาวร",
}
