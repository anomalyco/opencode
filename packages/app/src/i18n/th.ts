export const dict = {
  ...
  "dialog.newProject.title": "โปรเจกต์ใหม่",
  "dialog.newProject.tab.github": "นำเข้าจาก GitHub",
  "dialog.newProject.tab.folder": "นำเข้าจากโฟลเดอร์",
  "dialog.newProject.url.label": "URL ที่เก็บข้อมูล",
  "dialog.newProject.destination.label": "ปลายทางโคลน",
  "dialog.newProject.destination.placeholder": "เลือกโฟลเดอร์ปลายทาง",
  "dialog.newProject.destination.browse": "เรียกดู",
  "dialog.newProject.destination.pick": "เลือกปลายทางโคลน",
  "dialog.newProject.clone": "โคลนที่เก็บข้อมูล",
  "dialog.newProject.cloning": "กำลังโคลน...",
  "dialog.newProject.error.cloneFailed": "โคลนที่เก็บข้อมูลไม่สำเร็จ",
  "dialog.newProject.folder.title": "เปิดโปรเจกต์ที่มีอยู่",
  "dialog.newProject.folder.description": "เลือกโฟลเดอร์ในเครื่องเพื่อเพิ่มเป็นโปรเจกต์ใน OpenCode",
  "dialog.newProject.folder.action": "เลือกโฟลเดอร์",
