export const dict = {
  ...
  "provider.custom.models.load": "โหลดแบบไดนามิก",
  "provider.custom.models.loading": "กำลังโหลด...",
  "provider.custom.models.load.invalidUrl": "ป้อน URL พื้นฐานที่ถูกต้อง",
  "provider.custom.models.load.unauthorized": "ไม่ได้รับอนุญาต ตรวจสอบคีย์ API",
  "provider.custom.models.load.invalidFormat": "การตอบกลับของเซิร์ฟเวอร์ไม่ใช่รายการโมเดลที่ถูกต้อง",
  "provider.custom.models.load.timeout": "หมดเวลาขณะโหลดโมเดล",
  "provider.custom.models.load.failed": "โหลดโมเดลไม่สำเร็จ",
  "provider.custom.models.load.empty": "ไม่พบโมเดล",
