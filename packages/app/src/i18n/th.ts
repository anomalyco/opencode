export const dict = {
  ...
  "dialog.provider.custom.label": "ผู้ให้บริการที่กำหนดเองซึ่งรองรับ OpenAI",
  ...
  "dialog.model.unpaid.viewMoreProviders": "ดูผู้ให้บริการเพิ่มอีกกว่า 70 ราย",
  ...
  "session.tab.agents": "ตัวแทนย่อย",
  "session.agents.empty": "ไม่มีตัวแทนย่อยที่กำลังทำงาน",
  "session.agents.costTotal": "ต้นทุนรวม",
  "session.agents.costSubagents": "ตัวแทนย่อย",
  "session.agents.count": "ตัวแทน",
  "session.agents.tokens": "โทเค็น",
  "session.agents.showAll": "แสดงทั้งหมด ({{count}})",
  "session.agents.status.idle": "ว่าง",
  "session.agents.status.busy": "กำลังทำงาน",
  "session.agents.status.retry": "ลองใหม่",
  "session.agents.status.cancelled": "ถูกยกเลิก",
  "session.agents.status.completed": "เสร็จสิ้น",
  "session.agents.status.error": "ล้มเหลว",
