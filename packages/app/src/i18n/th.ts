export const dict = {
  ...
  "provider.connect.xcshZen.line1":
    "xcsh Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.xcshZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.xcshZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.xcshZen.visit.link": "f5xc-salesdemos.github.io/xcsh/zen",
  "provider.connect.xcshZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน xcsh.json",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (xcsh.json) ชื่อผู้ให้บริการ/โมเดล",
