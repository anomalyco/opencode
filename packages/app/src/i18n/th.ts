export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "เมนู OpenCode",
  "desktop.appMenu.file": "ไฟล์",
  "desktop.appMenu.edit": "แก้ไข",
  "desktop.appMenu.view": "มุมมอง",
  "desktop.appMenu.go": "ไป",
  "desktop.appMenu.window": "หน้าต่าง",
  "desktop.appMenu.help": "วิธีใช้",
  "desktop.appMenu.about": "เกี่ยวกับ OpenCode",
  "desktop.appMenu.checkForUpdates": "ตรวจหาการอัปเดต...",
  "desktop.appMenu.settings": "การตั้งค่า",
  "desktop.appMenu.reloadWebview": "โหลดเว็บวิวใหม่",
  "desktop.appMenu.restart": "เริ่มใหม่",
  "desktop.appMenu.exportLogs": "ส่งออกบันทึก...",
  "desktop.appMenu.hide": "ซ่อน OpenCode",
  "desktop.appMenu.hideOthers": "ซ่อนแอปอื่น",
  "desktop.appMenu.showAll": "แสดงทั้งหมด",
  "desktop.appMenu.quit": "ออกจาก OpenCode",
  "desktop.appMenu.newSession": "เซสชันใหม่",
  "desktop.appMenu.openProject": "เปิดโปรเจกต์...",
  "desktop.appMenu.newWindow": "หน้าต่างใหม่",
  "desktop.appMenu.closeWindow": "ปิดหน้าต่าง",
  "desktop.appMenu.undo": "เลิกทำ",
  "desktop.appMenu.redo": "ทำซ้ำ",
  "desktop.appMenu.cut": "ตัด",
  "desktop.appMenu.copy": "คัดลอก",
  "desktop.appMenu.paste": "วาง",
  "desktop.appMenu.delete": "ลบ",
  "desktop.appMenu.selectAll": "เลือกทั้งหมด",
  "desktop.appMenu.toggleSidebar": "สลับแถบข้าง",
  "desktop.appMenu.toggleTerminal": "สลับเทอร์มินัล",
  "desktop.appMenu.toggleFileTree": "สลับต้นไม้ไฟล์",
  "desktop.appMenu.reload": "โหลดใหม่",
  "desktop.appMenu.toggleDeveloperTools": "สลับเครื่องมือสำหรับนักพัฒนา",
  "desktop.appMenu.actualSize": "ขนาดจริง",
  "desktop.appMenu.zoomIn": "ขยาย",
  "desktop.appMenu.zoomOut": "ย่อ",
  "desktop.appMenu.toggleFullScreen": "สลับโหมดเต็มหน้าจอ",
  "desktop.appMenu.back": "ย้อนกลับ",
  "desktop.appMenu.forward": "ไปข้างหน้า",
  "desktop.appMenu.previousSession": "เซสชันก่อนหน้า",
  "desktop.appMenu.nextSession": "เซสชันถัดไป",
  "desktop.appMenu.previousProject": "โปรเจกต์ก่อนหน้า",
  "desktop.appMenu.nextProject": "โปรเจกต์ถัดไป",
  "desktop.appMenu.minimize": "ย่อหน้าต่าง",
  "desktop.appMenu.zoomWindow": "ซูม",
  "desktop.appMenu.maximize": "ขยายหน้าต่าง",
  "desktop.appMenu.bringAllToFront": "นำทั้งหมดมาไว้ด้านหน้า",
  "desktop.appMenu.documentation": "เอกสาร OpenCode",
  "desktop.appMenu.supportForum": "ฟอรัมสนับสนุน",
  "desktop.appMenu.shareFeedback": "ส่งความคิดเห็น",
  "desktop.appMenu.reportBug": "รายงานข้อบกพร่อง",
