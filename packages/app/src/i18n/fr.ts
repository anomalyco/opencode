export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Jarvis",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Jarvis",
  "desktop.recovery.terminated": "La fenêtre Jarvis s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Jarvis ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Jarvis",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Jarvis est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Jarvis.",
  ...
  "dialog.server.description": "Changez le serveur Jarvis auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Jarvis dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Jarvis dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Jarvis dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Jarvis dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Jarvis puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Jarvis n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Jarvis ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Jarvis",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Jarvis ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Jarvis inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.integrations.placeholder": "Les intégrations étendent le runtime de Jarvis. Vous pourrez bientôt installer des plugins, des thèmes et des extensions système.",
  "settings.connectors.placeholder": "Les connecteurs relient Jarvis aux services externes. Bientôt : Gmail, WhatsApp, Slack, Notion, Telegram et plus.",
  "settings.connectors.unavailable": "Les connecteurs ne sont disponibles que dans l'application de bureau.",
  "settings.connectors.badge.connected": "Connecté",
  "settings.connectors.badge.notConnected": "Non connecté",
  "settings.connectors.badge.disabled": "Désactivé",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "Connectez votre compte GitHub pour que Jarvis puisse lire et gérer vos dépôts.",
  "settings.connectors.github.detail": "Connectez votre compte GitHub pour que Jarvis puisse travailler avec vos dépôts, issues et pull requests directement depuis le chat. Vous autorisez l'accès avec votre propre compte GitHub via OAuth — Jarvis ne voit jamais votre mot de passe.",
  "settings.connectors.github.permission.repos": "Lire et gérer vos dépôts, issues et pull requests",
  "settings.connectors.github.permission.profile": "Lire votre profil public (nom d'utilisateur et avatar)",
  "settings.connectors.github.connect": "Connecter GitHub",
  "settings.connectors.github.disconnect": "Déconnecter",
  "settings.connectors.github.cancel": "Annuler",
  "settings.connectors.github.openBrowser": "Ouvrir le navigateur",
  "settings.connectors.github.waiting": "En attente d'autorisation…",
  "settings.connectors.github.code.instructions": "Saisissez ce code sur",
  "settings.connectors.github.connected.text": "Connecté via OAuth. Jarvis peut accéder à votre compte GitHub.",
  "settings.connectors.github.error.expired": "Le code d'autorisation a expiré. Veuillez réessayer.",
  "settings.connectors.github.error.generic": "Impossible de se connecter à GitHub. Vérifiez votre connexion et réessayez.",
  "settings.connectors.github.error.denied": "Autorisation refusée. Vous pouvez réessayer à tout moment.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Jarvis dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Jarvis",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Jarvis sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Jarvis suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Jarvis.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Jarvis",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Jarvis.",
