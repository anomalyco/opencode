export const dict = {
  ...
  "toast.file.uploadFailed.title": "Échec du téléversement du fichier",
  "toast.file.downloadFailed.title": "Échec du téléchargement du fichier",
  "toast.file.deleteFailed.title": "Échec de la suppression du fichier",
  ...
  "session.files.uploadFile": "Téléverser un fichier",
  "session.files.uploading": "Téléversement…",
  "session.files.downloadFile": "Télécharger",
  "session.files.refresh": "Actualiser",
  "session.files.dropFiles": "Déposez les fichiers ici ou cliquez sur + pour téléverser",
  "session.files.deleteConfirm": "Supprimer \"{{path}}\" ?",
  "session.files.uploadTooLarge": "Fichier trop volumineux (max {{size}})",
  ...
  "session.header.reveal.finder": "Révéler dans le Finder",
  "session.header.reveal.fileExplorer": "Révéler dans l'Explorateur de fichiers",
