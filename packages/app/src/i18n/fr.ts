export const dict = {
  ...
  "settings.general.row.reducedMotion.title": "Réduire les animations",
  "settings.general.row.reducedMotion.description": "Désactiver la plupart des animations de l'interface.",
