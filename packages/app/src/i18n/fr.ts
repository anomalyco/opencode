export const dict = {
  ...
  "session.new.branch.search": "Rechercher des branches",
  "session.new.branch.checkout": "Basculer vers",
  "session.new.branch.base": "Dériver de",
  "session.new.branch.local": "Local",
  "session.new.branch.empty": "Aucune branche",
  "session.new.branch.switchFailed": "Échec du changement de branche",
