export const dict = {
  ...
  "provider.custom.models.load": "Charger dynamiquement",
  "provider.custom.models.loading": "Chargement...",
  "provider.custom.models.load.invalidUrl": "Saisissez une URL de base valide",
  "provider.custom.models.load.unauthorized": "Non autorisé. Vérifiez la clé d'API",
  "provider.custom.models.load.invalidFormat": "La réponse du serveur ne contenait pas une liste de modèles valide",
  "provider.custom.models.load.timeout": "Délai dépassé lors du chargement des modèles",
  "provider.custom.models.load.failed": "Échec du chargement des modèles",
  "provider.custom.models.load.empty": "Aucun modèle trouvé",
