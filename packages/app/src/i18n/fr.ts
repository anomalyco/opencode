export const dict = {
  ...
  "home.activity.title": "Activité des jetons",
  "home.activity.daily": "Quotidien",
  "home.activity.weekly": "Hebdomadaire",
  "home.activity.cumulative": "Cumulatif",
  "home.activity.loading": "Chargement de l'activité",
  "home.activity.empty": "Aucune activité de jetons pour l'instant",
  "home.activity.lifetimeTokens": "Total des jetons",
  "home.activity.peakTokens": "Pic de jetons",
  "home.activity.longestTask": "Tâche la plus longue",
  "home.activity.currentStreak": "Série actuelle",
  "home.activity.longestStreak": "Série la plus longue",
  "home.activity.days.one": "{{count}} jour",
  "home.activity.days.other": "{{count}} jours",
  "home.activity.summary":
    "{{tokens}} jetons au total, {{peak}} pic de jetons, {{current}} série actuelle, {{longest}} série la plus longue.",
