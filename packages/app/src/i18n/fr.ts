export const dict = {
  ...
  "session.review.context.openDefault": "Application par défaut",
  "session.review.context.copyRelative": "Copier le chemin relatif",
  "session.review.context.copyAbsolute": "Copier le chemin absolu",
