export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Argus",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Argus",
  "desktop.recovery.terminated": "La fenêtre Argus s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Argus ne répond pas",
  ...
  "desktop.wsl.error.installArgus": "Échec de l'installation d'Argus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.argusMissing": "argus n'est pas installé dans cette distribution",
  "desktop.wsl.error.argusCannotRun": "argus est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.argusNotInstalled": "Argus n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Argus est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.argus.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.argus.tagline": "Modèles optimisés et fiables",
  "dialog.provider.argusGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Argus",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.argusZen.visit.prefix": "Visitez ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Argus.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans argus.json",
  ...
  "dialog.server.description": "Changez le serveur Argus auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingArgus": "Vérification d'Argus...",
  "wsl.onboarding.checkingArgusIn": "Vérification d'Argus dans {{distro}}...",
  "wsl.onboarding.updatingArgus": "Mise à jour d'Argus...",
  "wsl.onboarding.updatingArgusIn": "Mise à jour d'Argus dans {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Mettez à jour Argus dans {{distro}}.",
  "wsl.onboarding.updateArgus": "Mettre à jour Argus",
  "wsl.onboarding.argusReadyIn": "Argus est prêt dans {{distro}}.",
  "wsl.onboarding.argusReady": "Argus est prêt.",
  "wsl.onboarding.installArgusIn": "Installez Argus dans {{distro}}.",
  "wsl.onboarding.installArgus": "Installer Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Argus puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Argus n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Argus ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Argus",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (argus.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Argus ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Argus inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Argus dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Argus",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Argus sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Argus suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Argus.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Argus",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Argus.",
