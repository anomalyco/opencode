export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans IMECODE.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans IMECODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans IMECODE.",
  ...
  "dialog.server.description": "Changez le serveur IMECODE auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'IMECODE ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe IMECODE",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'IMECODE ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "IMECODE inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "IMECODE Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur IMECODE dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour IMECODE",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'IMECODE sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si IMECODE suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'IMECODE.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'IMECODE",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'IMECODE.",
