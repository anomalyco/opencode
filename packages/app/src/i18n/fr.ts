export const dict = {
  ...
  "status.button.label": "Statut",
  "status.button.tooltip": "Voir l'état du système",
  "status.tab.servers.one": "{{count}} Serveur",
  "status.tab.servers.other": "{{count}} Serveurs",
  "status.tab.mcp.one": "{{count}} MCP",
  "status.tab.mcp.other": "{{count}} MCPs",
  "status.tab.lsp.one": "{{count}} LSP",
  "status.tab.lsp.other": "{{count}} LSPs",
  "status.tab.plugins.one": "{{count}} Plugin",
  "status.tab.plugins.other": "{{count}} Plugins",
  "status.servers.empty": "Aucun serveur configuré",
  "status.servers.manage": "Gérer les serveurs",
  "status.mcp.empty": "Aucun serveur MCP configuré",
  "status.lsp.empty": "Aucun serveur LSP actif",
  "status.plugins.empty": "Plugins configurés dans 'opencode.json'",
  "status.noProject": "Ouvrir un projet pour voir",
