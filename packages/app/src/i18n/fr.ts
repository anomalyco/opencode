export const dict = {
  ...
  "home.recentWorkspaces": "Espaces de travail récents",
  ...
  "workspace.addFolder": "Ajouter un dossier à l'espace de travail",
  "workspace.removeFolder": "Retirer un dossier de l'espace de travail",
  ...
  "dialog.workspace.open.title": "Ouvrir un espace de travail",
  "dialog.workspace.search.placeholder": "Rechercher des espaces de travail",
  "dialog.workspace.empty": "Aucun espace de travail. Créez-en un !",
  "dialog.workspace.open.button": "Ouvrir",
  "dialog.workspace.delete.confirm": "Supprimer cet espace de travail ?",
  "dialog.workspace.folders": "{{count}} dossiers",
  "dialog.workspace.create.title": "Créer un espace de travail",
  "dialog.workspace.create.name": "Nom de l'espace de travail",
  "dialog.workspace.create.name.placeholder": "Mon espace de travail",
  "dialog.workspace.create.folders": "Dossiers",
  "dialog.workspace.create.folders.empty": "Aucun dossier ajouté",
  "dialog.workspace.create.addFolder": "Ajouter un dossier",
  "dialog.workspace.create.removeFolder": "Retirer le dossier",
  "dialog.workspace.create.button": "Créer l'espace de travail",
}
