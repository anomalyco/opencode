export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Hôte SSH non valide : {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} a déjà été ajouté",
  "desktop.ssh.error.opencodeNotInstalled": "opencode n'est pas installé sur {{host}}",
  "desktop.ssh.error.installOpencode": "Échec de l'installation d'opencode",
  "desktop.ssh.error.connectFailed": "Impossible de se connecter à {{host}}",
  "desktop.ssh.error.serverExited": "Le serveur SSH s'est arrêté après son démarrage (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Le serveur SSH pour {{host}} s'est arrêté avant d'être opérationnel (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "La vérification de l'état du serveur sur {{host}} a dépassé le délai de {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "La commande ssh vers {{host}} a dépassé le délai de {{timeout}} ms",
  "desktop.ssh.error.failedPort": "Impossible d'obtenir le port",
  "desktop.ssh.error.terminalFailed": "Impossible d'ouvrir un terminal",
  ...
  "ssh.server.add": "Ajouter un serveur SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "Serveur SSH",
  "ssh.server.retryStart": "Reconnecter",
  "ssh.server.disconnect": "Déconnecter",
  "ssh.server.openTerminal": "Ouvrir le terminal",
  "ssh.server.updating": "Mise à jour...",
  "ssh.server.status.connecting": "Connexion...",
  "ssh.server.status.disconnected": "Déconnecté",
  "ssh.add.hostLabel": "Hôte SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "La connexion s'effectue via le client ssh de votre système, de sorte que les hôtes, les clés et les agents de votre configuration SSH fonctionnent comme d'habitude.",
  "ssh.add.configHosts": "Depuis votre configuration SSH",
  "ssh.add.connect": "Se connecter",
  "ssh.add.checking": "Connexion...",
  "ssh.add.addServer": "Ajouter le serveur",
  "ssh.add.adding": "Ajout...",
  "ssh.add.installOpencode": "Installer opencode",
  "ssh.add.updateOpencode": "Mettre à jour opencode",
  "ssh.add.installing": "Installation...",
  "ssh.add.status.unreachable": "Impossible de se connecter",
  "ssh.add.status.opencodeMissing": "opencode n'est pas installé sur cet hôte",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} installé, l'application de bureau attend la v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} détecté",
  "ssh.add.authHint":
    "Assurez-vous que l'authentification SSH par clé fonctionne pour cet hôte : exécutez `ssh {{host}}` dans un terminal pour le vérifier.",
