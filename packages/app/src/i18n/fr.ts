export const dict = {
  ...
  "presets.manage": "Gérer les préréglages",
  "presets.count": "{{count}} préréglages",
  "presets.empty": "Aucun préréglage",
  "presets.empty.hint": "Cliquez sur \"Ajouter\" pour créer votre premier préréglage",
  "presets.add": "Ajouter",
  "presets.name": "Nom",
  "presets.content": "Contenu",
  "presets.content.placeholder": "Contenu (prend en charge les variables {date} {time} {file} {code} {text})",
  "presets.moveUp": "Déplacer vers le haut",
  "presets.moveDown": "Déplacer vers le bas",
  "presets.edit": "Modifier",
  "presets.delete": "Supprimer",
  "presets.variables.title": "Entrez les variables pour \"{{name}}\"",
  "presets.variables.next": "Suivant",
  "presets.variables.insert": "Insérer",
}
