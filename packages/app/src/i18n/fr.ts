export const dict = {
  ...
  "command.context.addToChat": "Ajouter la sélection au chat",
  "command.context.addToChat.description": "Insérer les lignes sélectionnées à la position du curseur",
  "command.context.quickEdit": "Modification rapide de la sélection",
  "command.context.quickEdit.description": "Modifier le code sélectionné dans une nouvelle session",
  "selection.action.addToChat": "Ajouter au chat",
  "selection.action.quickEdit": "Modification rapide",
  "selection.quickEdit.placeholder": "Modifier le code sélectionné",
  "selection.quickEdit.submit": "Démarrer",
