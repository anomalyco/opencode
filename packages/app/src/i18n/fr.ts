export const dict = {
  ...
  "sidebar.linear.syncHistory.push": "↗ Linear",
  "sidebar.linear.syncHistory.pull": "↙ Linear",
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} élément",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} éléments",
  ...
  "dialog.todo.autocomplete.noFiles": "Aucun fichier trouvé",
  "dialog.todo.autocomplete.noSkills": "Aucune compétence trouvée",
