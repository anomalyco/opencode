export const dict = {
  ...
  "desktop.menu.file.settings": "Paramètres",
  "desktop.menu.file.newWindow": "Nouvelle fenêtre",
  "desktop.menu.file.closeWindow": "Fermer la fenêtre",
  "desktop.menu.edit": "Édition",
  "desktop.menu.edit.undo": "Annuler",
  "desktop.menu.edit.redo": "Rétablir",
  "desktop.menu.edit.cut": "Couper",
  "desktop.menu.edit.copy": "Copier",
  "desktop.menu.edit.paste": "Coller",
  "desktop.menu.edit.delete": "Supprimer",
  "desktop.menu.edit.selectAll": "Tout sélectionner",
  "desktop.menu.view": "Affichage",
  "desktop.menu.view.toggleSidebar": "Afficher/Masquer la barre latérale",
  "desktop.menu.view.toggleTerminal": "Afficher/Masquer le terminal",
  "desktop.menu.view.toggleFileTree": "Afficher/Masquer l'arborescence",
  "desktop.menu.view.reload": "Recharger",
  "desktop.menu.view.toggleDevTools": "Outils de développement",
  "desktop.menu.view.actualSize": "Taille réelle",
  "desktop.menu.view.zoomIn": "Zoom avant",
  "desktop.menu.view.zoomOut": "Zoom arrière",
  "desktop.menu.view.toggleFullscreen": "Plein écran",
  "desktop.menu.go": "Aller",
  "desktop.menu.go.back": "Retour",
  "desktop.menu.go.forward": "Avancer",
  "desktop.menu.go.previousSession": "Session précédente",
  "desktop.menu.go.nextSession": "Session suivante",
  "desktop.menu.go.previousProject": "Projet précédent",
  "desktop.menu.go.nextProject": "Projet suivant",
  "desktop.menu.window": "Fenêtre",
  "desktop.menu.window.minimize": "Réduire",
  "desktop.menu.window.maximize": "Agrandir",
  "desktop.menu.window.closeWindow": "Fermer la fenêtre",
  "desktop.menu.help": "Aide",
  "desktop.menu.help.documentation": "Documentation OpenCode",
  "desktop.menu.help.supportForum": "Forum d'aide",
  "desktop.menu.help.exportLogs": "Exporter les logs...",
  "desktop.menu.help.shareFeedback": "Partager un avis",
