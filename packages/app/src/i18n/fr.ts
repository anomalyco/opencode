export const dict = {
  ...
  "mcp.status.needs_client_registration": "enregistrement client requis",
  "mcp.status.pending": "connexion…",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Laisser vide pour omettre — une réauthentification peut être nécessaire",
