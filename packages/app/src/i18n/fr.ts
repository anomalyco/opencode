export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "Menu OpenCode",
  "desktop.appMenu.file": "Fichier",
  "desktop.appMenu.edit": "Édition",
  "desktop.appMenu.view": "Affichage",
  "desktop.appMenu.go": "Aller",
  "desktop.appMenu.window": "Fenêtre",
  "desktop.appMenu.help": "Aide",
  "desktop.appMenu.about": "À propos d'OpenCode",
  "desktop.appMenu.checkForUpdates": "Rechercher les mises à jour...",
  "desktop.appMenu.settings": "Paramètres",
  "desktop.appMenu.reloadWebview": "Recharger la vue web",
  "desktop.appMenu.restart": "Redémarrer",
  "desktop.appMenu.exportLogs": "Exporter les journaux...",
  "desktop.appMenu.hide": "Masquer OpenCode",
  "desktop.appMenu.hideOthers": "Masquer les autres",
  "desktop.appMenu.showAll": "Tout afficher",
  "desktop.appMenu.quit": "Quitter OpenCode",
  "desktop.appMenu.newSession": "Nouvelle session",
  "desktop.appMenu.openProject": "Ouvrir un projet...",
  "desktop.appMenu.newWindow": "Nouvelle fenêtre",
  "desktop.appMenu.closeWindow": "Fermer la fenêtre",
  "desktop.appMenu.undo": "Annuler",
  "desktop.appMenu.redo": "Rétablir",
  "desktop.appMenu.cut": "Couper",
  "desktop.appMenu.copy": "Copier",
  "desktop.appMenu.paste": "Coller",
  "desktop.appMenu.delete": "Supprimer",
  "desktop.appMenu.selectAll": "Tout sélectionner",
  "desktop.appMenu.toggleSidebar": "Afficher ou masquer la barre latérale",
  "desktop.appMenu.toggleTerminal": "Afficher ou masquer le terminal",
  "desktop.appMenu.toggleFileTree": "Afficher ou masquer l'arborescence des fichiers",
  "desktop.appMenu.reload": "Recharger",
  "desktop.appMenu.toggleDeveloperTools": "Afficher ou masquer les outils de développement",
  "desktop.appMenu.actualSize": "Taille réelle",
  "desktop.appMenu.zoomIn": "Zoom avant",
  "desktop.appMenu.zoomOut": "Zoom arrière",
  "desktop.appMenu.toggleFullScreen": "Activer ou désactiver le plein écran",
  "desktop.appMenu.back": "Retour",
  "desktop.appMenu.forward": "Suivant",
  "desktop.appMenu.previousSession": "Session précédente",
  "desktop.appMenu.nextSession": "Session suivante",
  "desktop.appMenu.previousProject": "Projet précédent",
  "desktop.appMenu.nextProject": "Projet suivant",
  "desktop.appMenu.minimize": "Réduire",
  "desktop.appMenu.zoomWindow": "Zoom",
  "desktop.appMenu.maximize": "Agrandir",
  "desktop.appMenu.bringAllToFront": "Tout ramener au premier plan",
  "desktop.appMenu.documentation": "Documentation OpenCode",
  "desktop.appMenu.supportForum": "Forum d'assistance",
  "desktop.appMenu.shareFeedback": "Donner votre avis",
  "desktop.appMenu.reportBug": "Signaler un bug",
