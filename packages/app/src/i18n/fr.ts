export const dict = {
  ...
  "command.tab.closeAll": "Fermer tous les onglets",
  "command.tab.closeRight": "Fermer tous les onglets à droite",
  "command.tab.closeOthers": "Fermer tous les onglets sauf celui-ci",
