export const dict = {
  ...
  "palette.group.files": "Correspondances de noms de fichiers",
  "palette.group.content": "Correspondances de contenu de fichiers locaux",
  "palette.group.chat": "Correspondances de contenu de chat",
  "palette.group.sessions": "Correspondances de noms de sessions",
  "palette.group.files.count": "{{count}} résultats.",
  "palette.group.content.count": "{{count}} résultats dans {{files}} fichiers.",
  "palette.group.chat.count": "{{count}} résultats dans {{sessions}} sessions.",
  "palette.group.sessions.count": "{{count}} résultats.",
