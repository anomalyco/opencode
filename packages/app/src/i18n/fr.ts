export const dict = {
  ...
  "command.workspace.switch": "Changer d'espace de travail",
  "command.workspace.previous": "Espace de travail précédent",
  "command.workspace.next": "Espace de travail suivant",
