export const dict = {
  ...
  "session.tab.agents": "Sous-agents",
  "session.agents.empty": "Aucun sous-agent en cours",
  "session.agents.costTotal": "Coût total",
  "session.agents.costSubagents": "Sous-agents",
  "session.agents.count": "Agents",
  "session.agents.tokens": "jetons",
  "session.agents.showAll": "Tout afficher ({{count}})",
  "session.agents.status.idle": "Inactif",
  "session.agents.status.busy": "En cours",
  "session.agents.status.retry": "Nouvelle tentative",
  "session.agents.status.cancelled": "Annulé",
  "session.agents.status.completed": "Terminé",
  "session.agents.status.error": "Échec",
