export const dict = {
  ...
  "settings.plugins.section.browse": "Parcourir",
  "settings.plugins.section.installed": "Installées",
  "settings.plugins.source.all": "Toutes les sources",
  "settings.plugins.source.ecosystem": "Écosystème",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Ajouter un serveur",
  "settings.mcp.empty": "Aucun serveur MCP configuré.",
  "settings.mcp.deleted": "{{name}} supprimé.",
  "settings.mcp.errors.refresh": "Impossible de charger les serveurs MCP.",
  "settings.mcp.status.pending": "connexion…",
  "settings.mcp.action.connect": "Connecter",
  "settings.mcp.action.disconnect": "Déconnecter",
  "settings.mcp.action.authenticate": "Authentifier",
  "settings.mcp.action.edit": "Modifier",
  "settings.mcp.action.delete": "Supprimer",
  "settings.mcp.delete.title": "Supprimer le serveur MCP",
  "settings.mcp.delete.body": "Supprimer {{name}} ? Cette action est irréversible.",
  "settings.mcp.form.title.add": "Ajouter un serveur MCP",
  "settings.mcp.form.title.edit": "Modifier le serveur MCP",
  "settings.mcp.form.subtitle": "Configurer les paramètres de connexion.",
  "settings.mcp.form.name": "Nom",
  "settings.mcp.form.command": "Commande",
  "settings.mcp.form.command.hint": "ex. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Répertoire de travail",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Variables d'environnement",
  "settings.mcp.form.headers": "En-têtes",
  "settings.mcp.form.addRow": "Ajouter une ligne",
  "settings.mcp.form.removeRow": "Supprimer",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID client",
  "settings.mcp.form.oauth.clientSecret": "Secret client",
  "settings.mcp.form.oauth.clientSecret.keep": "Configuré — laisser vide pour conserver",
  "settings.mcp.form.oauth.scope": "Portée",
  "settings.mcp.form.oauth.callbackPort": "Port de rappel",
  "settings.mcp.form.oauth.disableAutodetect": "Désactiver la détection auto OAuth",
  "settings.mcp.form.enabled": "Activé",
  "settings.mcp.form.timeout": "Délai (ms)",
  "settings.mcp.form.save": "Enregistrer",
  "settings.mcp.form.cancel": "Annuler",
  "settings.mcp.form.error.name": "Saisissez un nom.",
  "settings.mcp.form.error.command": "Saisissez une commande.",
  "settings.mcp.form.error.url": "Saisissez une URL.",
  "settings.mcp.form.error.callbackPort": "Le port de rappel doit être entre 1 et 65535.",
  "settings.mcp.form.error.timeout": "Le délai doit être un nombre entier positif.",
  "settings.mcp.errors.invalid": "Corrigez les champs en surbrillance.",
  "settings.mcp.errors.duplicate": "Un serveur portant ce nom existe déjà.",
  "settings.mcp.errors.noConfig": "Impossible de lire la config de {{name}} — elle est peut-être définie hors du projet.",
  "settings.mcp.edit.warn": "Enregistrer reconnecte ce serveur.",
  "settings.plugins.search.placeholder": "Rechercher des extensions…",
  "settings.plugins.detail.install": "Installer…",
  "settings.plugins.detail.copy": "Copier l'extrait de config",
  "settings.plugins.detail.copied": "Copié",
  "settings.plugins.detail.notOnNpm": "Introuvable sur npm — à ajouter manuellement dans opencode.json",
  "settings.plugins.install.title": "Installer l'extension",
  "settings.plugins.install.description": "Où ajouter {{name}} ?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Ce projet",
  "settings.plugins.install.cancel": "Annuler",
  "settings.plugins.install.success": "{{name}} installé. Redémarrez OpenCode pour le charger.",
  "settings.plugins.installed.empty": "Aucune extension installée.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Projet",
  ...
  "settings.plugins.errors.catalog": "Impossible d'actualiser le catalogue d'extensions.",
  "settings.plugins.stale": "Catalogue en cache affiché ({{age}}).",
