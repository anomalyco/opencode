export const dict = {
  ...
  "prompt.action.expand": "Agrandir l’éditeur",
  "prompt.attachment.remove": "Supprimer la pièce jointe",
  "prompt.action.send": "Envoyer",
  "prompt.action.stop": "Arrêter",
  "prompt.editor.title": "Modifier le prompt",
  ...
  "error.page.action.restartFrontend": "Redémarrer le frontend",
  "error.page.action.restartBackend": "Redémarrer le backend",
  "error.page.action.restartApp": "Redémarrer l'application",
