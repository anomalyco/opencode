export const dict = {
  ...
  "command.todo.toggle": "Basculer le panneau todo",
  ...
  "sidebar.issue.title": "Tâches",
  "sidebar.issue.add": "Ajouter une tâche",
  "sidebar.issue.addSubtodo": "Ajouter une sous-tâche",
  "sidebar.issue.empty": "Aucune tâche",
  "sidebar.issue.collapse": "Réduire les sous-tâches",
  "sidebar.issue.expand": "Développer les sous-tâches",
  "sidebar.issue.confirmDeleteWithChildren": "Supprimer cette tâche et ses {{count}} sous-tâches ?",
  "sidebar.issue.toast.deleteFailed": "Échec de la suppression de la tâche",
  "sidebar.issue.tooltip.cycleStatus": "Changer le statut",
  "sidebar.issue.tooltip.cyclePriority": "Changer la priorité",
  "sidebar.issue.tooltip.linkedLinear": "Lié à Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Connecté",
  "sidebar.linear.management": "Gérer la liaison Linear",
  "sidebar.linear.management.teamRequired": "Veuillez sélectionner une équipe",
  "sidebar.linear.management.projectRequired": "Veuillez sélectionner un projet",
  "sidebar.linear.management.saveFailed": "Échec de l'enregistrement de la liaison Linear",
  "sidebar.linear.management.saved": "Liaison Linear enregistrée",
  "sidebar.linear.management.save": "Enregistrer",
  "sidebar.linear.toggleHistory": "Afficher l'historique de sync",
  "sidebar.linear.field.team": "Équipe",
  "sidebar.linear.field.team.loading": "Chargement des équipes...",
  "sidebar.linear.field.team.placeholder": "Sélectionner une équipe",
  "sidebar.linear.field.project": "Projet",
  "sidebar.linear.field.project.selectTeamFirst": "Sélectionnez d'abord une équipe",
  "sidebar.linear.field.project.loading": "Chargement des projets...",
  "sidebar.linear.field.project.placeholder": "Sélectionner un projet",
  "sidebar.linear.notConfigured": "Linear non configuré",
  "sidebar.linear.notConfiguredHint": "Ouvrir la gestion pour sélectionner une équipe et un projet",
  "sidebar.linear.actions": "Actions de sync",
  "sidebar.linear.push": "Pousser",
  "sidebar.linear.pull": "Tirer",
  "sidebar.linear.pullHint": "Tirer de Linear. Remarque : les modifications de hiérarchie effectuées sur Linear (reparentage, suppression de parent) ne sont pas synchronisées localement — seules les valeurs des champs sont réconciliées.",
  "sidebar.linear.pullFailed": "Échec du tirage depuis Linear",
  "sidebar.linear.pullPartialFailed": "Tirage partiellement échoué : {{count}} erreur(s)",
  "sidebar.linear.pullSuccess": "Récupéré {{pulled}}, mis à jour {{updated}}, ignoré {{skipped}}, supprimé {{deleted}}",
  "sidebar.linear.pushFailed": "Échec de la poussée vers Linear",
  "sidebar.linear.pushPartialFailed": "Poussée partiellement échouée : {{count}} erreur(s)",
  "sidebar.linear.pushSuccess": "{{count}} tâche(s) poussée(s) vers Linear",
  "sidebar.linear.pushNothing": "Rien à pousser",
  "sidebar.linear.syncHistory.syncing": "Synchronisation...",
  "sidebar.linear.syncHistory.error": "Erreur",
  "sidebar.linear.syncHistory.empty": "Aucun historique de synchronisation",
  "dialog.todo.title.create": "Nouvelle tâche",
  "dialog.todo.title.edit": "Modifier la tâche",
  "dialog.todo.field.title": "Titre",
  "dialog.todo.field.title.placeholder": "Titre de la tâche",
  "dialog.todo.field.description": "Description",
  "dialog.todo.field.description.placeholder": "Ajouter des détails, liens ou contexte...",
  "dialog.todo.field.description.hint": "Prend en charge les références de fichiers et de compétences",
  "dialog.todo.field.status": "Statut",
  "dialog.todo.field.priority": "Priorité",
  "dialog.todo.field.dueDate": "Date d'échéance",
  "dialog.todo.field.dueDate.placeholder": "Définir la date d'échéance",
  "dialog.todo.field.dueDate.clear": "Effacer",
  "dialog.todo.field.dueDate.prevMonth": "Mois précédent",
  "dialog.todo.field.dueDate.nextMonth": "Mois suivant",
  "dialog.todo.field.dueDate.shortcut.today": "Aujourd'hui",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Demain",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Dans une semaine",
  "dialog.todo.field.dueDate.month.0": "Jan",
  "dialog.todo.field.dueDate.month.1": "Feb",
  "dialog.todo.field.dueDate.month.2": "Mar",
  "dialog.todo.field.dueDate.month.3": "Apr",
  "dialog.todo.field.dueDate.month.4": "May",
  "dialog.todo.field.dueDate.month.5": "Jun",
  "dialog.todo.field.dueDate.month.6": "Jul",
  "dialog.todo.field.dueDate.month.7": "Aug",
  "dialog.todo.field.dueDate.month.8": "Sep",
  "dialog.todo.field.dueDate.month.9": "Oct",
  "dialog.todo.field.dueDate.month.10": "Nov",
  "dialog.todo.field.dueDate.month.11": "Dec",
  "dialog.todo.field.dueDate.weekday.0": "Su",
  "dialog.todo.field.dueDate.weekday.1": "Mo",
  "dialog.todo.field.dueDate.weekday.2": "Tu",
  "dialog.todo.field.dueDate.weekday.3": "We",
  "dialog.todo.field.dueDate.weekday.4": "Th",
  "dialog.todo.field.dueDate.weekday.5": "Fr",
  "dialog.todo.field.dueDate.weekday.6": "Sa",
  "dialog.todo.field.labels": "Étiquettes",
  "dialog.todo.field.assignee": "Assigné à",
  "dialog.todo.field.assignee.unassigned": "Non assigné",
  "dialog.todo.field.assignee.loadFailed": "Échec du chargement des assignés",
  "dialog.todo.field.assignee.loading": "Chargement des assignés...",
  "dialog.todo.field.assignee.placeholder": "Sélectionner un assigné",
  "dialog.todo.field.assignee.hint": "Issu des membres de l'équipe Linear",
  "dialog.todo.linkedLinear": "Lié à Linear",
  "dialog.todo.created": "Tâche créée",
  "dialog.todo.updated": "Tâche mise à jour",
  "dialog.todo.error.titleRequired": "Le titre est requis",
  "dialog.todo.error.saveFailed": "Échec de l'enregistrement de la tâche",
  "dialog.todo.action.create": "Créer",
  ...
  "sidebar.issue.priority.none": "Aucun",
  "sidebar.issue.priority.urgent": "Urgent",
  "sidebar.issue.priority.high": "Haut",
  "sidebar.issue.priority.medium": "Moyen",
  "sidebar.issue.priority.low": "Faible",
  "sidebar.issue.toast.archiveFailed": "Échec de l'archivage de la tâche",
  "sidebar.issue.toast.reorderFailed": "Échec de la réorganisation de la tâche",
  "sidebar.issue.toast.reparentFailed": "Échec du déplacement de la tâche",
  "sidebar.issue.tooltip.archive": "Archiver cette tâche",
  "sidebar.issue.tooltip.delete": "Supprimer cette tâche",
  "sidebar.issue.confirmArchive": "Archiver",
  "sidebar.issue.archivedBadge": "Archivée",
  "sidebar.issue.archiveArea.title": "Archivées",
  "sidebar.issue.archiveArea.expand": "Afficher les archivées",
  "sidebar.issue.archiveArea.collapse": "Masquer les archivées",
  "sidebar.issue.archiveArea.empty": "Aucune tâche archivée",
}
