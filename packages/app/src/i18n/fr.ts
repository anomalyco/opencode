export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Pencode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Pencode",
  "desktop.recovery.terminated": "La fenêtre Pencode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Pencode ne répond pas",
  ...
  "desktop.wsl.error.installPencode": "Échec de l'installation d'Pencode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.pencodeMissing": "pencode n'est pas installé dans cette distribution",
  "desktop.wsl.error.pencodeCannotRun": "pencode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Pencode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.pencode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.pencode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.pencodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Pencode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Visitez ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Pencode.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans pencode.json",
  ...
  "dialog.server.description": "Changez le serveur Pencode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingPencode": "Vérification d'Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Vérification d'Pencode dans {{distro}}...",
  "wsl.onboarding.updatingPencode": "Mise à jour d'Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Mise à jour d'Pencode dans {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Mettez à jour Pencode dans {{distro}}.",
  "wsl.onboarding.updatePencode": "Mettre à jour Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode est prêt dans {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode est prêt.",
  "wsl.onboarding.installPencodeIn": "Installez Pencode dans {{distro}}.",
  "wsl.onboarding.installPencode": "Installer Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Pencode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Pencode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Pencode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Pencode",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (pencode.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Pencode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Pencode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Pencode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Pencode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Pencode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Pencode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Pencode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Pencode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Pencode.",
