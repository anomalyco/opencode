export const dict = {
  ...
  "settings.general.row.sendKey.title": "Touche d'envoi",
  "settings.general.row.sendKey.description": "Choisissez quelle touche envoie les messages. L'autre touche Entrée insère une nouvelle ligne.",
