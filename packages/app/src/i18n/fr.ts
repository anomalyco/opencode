export const dict = {
  ...
  "command.session.handoff": "Transférer la session",
  "command.session.handoff.description": "Compacter la session et continuer le travail dans une nouvelle session",
  ...
  "toast.session.handoff.failed.title": "Échec du transfert de la session",
  "toast.session.handoff.failed.description": "Cette session n'a pas pu être résumée pour le transfert",
