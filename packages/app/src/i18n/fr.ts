export const dict = {
  ...
  "provider.connect.xcshZen.line1":
    "xcsh Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.xcshZen.visit.prefix": "Visitez ",
  "provider.connect.xcshZen.visit.link": "f5xc-salesdemos.github.io/xcsh/zen",
  "provider.connect.xcshZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans xcsh.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (xcsh.json) pour les noms de fournisseur/modèle",
