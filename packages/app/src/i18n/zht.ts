...
export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode 選單",
  "desktop.appMenu.file": "檔案",
  "desktop.appMenu.edit": "編輯",
  "desktop.appMenu.view": "檢視",
  "desktop.appMenu.go": "前往",
  "desktop.appMenu.window": "視窗",
  "desktop.appMenu.help": "說明",
  "desktop.appMenu.about": "關於 OpenCode",
  "desktop.appMenu.checkForUpdates": "檢查更新...",
  "desktop.appMenu.settings": "設定",
  "desktop.appMenu.reloadWebview": "重新載入 Webview",
  "desktop.appMenu.restart": "重新啟動",
  "desktop.appMenu.exportLogs": "匯出日誌...",
  "desktop.appMenu.hide": "隱藏 OpenCode",
  "desktop.appMenu.hideOthers": "隱藏其他項目",
  "desktop.appMenu.showAll": "全部顯示",
  "desktop.appMenu.quit": "結束 OpenCode",
  "desktop.appMenu.newSession": "新增工作階段",
  "desktop.appMenu.openProject": "開啟專案...",
  "desktop.appMenu.newWindow": "新增視窗",
  "desktop.appMenu.closeWindow": "關閉視窗",
  "desktop.appMenu.undo": "復原",
  "desktop.appMenu.redo": "重做",
  "desktop.appMenu.cut": "剪下",
  "desktop.appMenu.copy": "複製",
  "desktop.appMenu.paste": "貼上",
  "desktop.appMenu.delete": "刪除",
  "desktop.appMenu.selectAll": "全選",
  "desktop.appMenu.toggleSidebar": "切換側邊欄",
  "desktop.appMenu.toggleTerminal": "切換終端機",
  "desktop.appMenu.toggleFileTree": "切換檔案樹",
  "desktop.appMenu.reload": "重新載入",
  "desktop.appMenu.toggleDeveloperTools": "切換開發人員工具",
  "desktop.appMenu.actualSize": "實際大小",
  "desktop.appMenu.zoomIn": "放大",
  "desktop.appMenu.zoomOut": "縮小",
  "desktop.appMenu.toggleFullScreen": "切換全螢幕",
  "desktop.appMenu.back": "返回",
  "desktop.appMenu.forward": "前進",
  "desktop.appMenu.previousSession": "上一個工作階段",
  "desktop.appMenu.nextSession": "下一個工作階段",
  "desktop.appMenu.previousProject": "上一個專案",
  "desktop.appMenu.nextProject": "下一個專案",
  "desktop.appMenu.minimize": "最小化",
  "desktop.appMenu.zoomWindow": "縮放",
  "desktop.appMenu.maximize": "最大化",
  "desktop.appMenu.bringAllToFront": "將全部移到最前面",
  "desktop.appMenu.documentation": "OpenCode 文件",
  "desktop.appMenu.supportForum": "支援論壇",
  "desktop.appMenu.shareFeedback": "提供意見",
  "desktop.appMenu.reportBug": "回報錯誤",
