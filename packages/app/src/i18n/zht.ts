...
export const dict = {
  ...
  "status.tab.servers.one": "{{count}} 個伺服器",
  "status.tab.servers.other": "{{count}} 個伺服器",
  "status.tab.mcp.one": "{{count}} 個 MCP",
  "status.tab.mcp.other": "{{count}} 個 MCP",
  "status.tab.lsp.one": "{{count}} 個 LSP",
  "status.tab.lsp.other": "{{count}} 個 LSP",
  "status.tab.plugins.one": "{{count}} 個外掛程式",
  "status.tab.plugins.other": "{{count}} 個外掛程式",
  "status.servers.empty": "未配置伺服器",
  "status.servers.manage": "管理伺服器",
  "status.mcp.empty": "未配置 MCP 伺服器",
  "status.lsp.empty": "沒有活躍的 LSP 伺服器",
  "status.plugins.empty": "在 'opencode.json' 中配置外掛程式",
  "status.noProject": "打開項目以檢視",
