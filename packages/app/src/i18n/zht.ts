...
export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "查看 70 多個其他提供者",
  ...
  "session.agents.empty": "沒有執行中的子代理",
  "session.agents.costTotal": "總費用",
  "session.agents.costSubagents": "子代理",
  "session.agents.count": "代理",
  "session.agents.tokens": "Token",
  "session.agents.showAll": "顯示全部 ({{count}})",
  "session.agents.status.idle": "閒置",
  "session.agents.status.busy": "執行中",
  "session.agents.status.retry": "重試中",
