...
export const dict = {
  ...
  "sidebar.linear.pullHint": "從 Linear 拉取。注意：在 Linear 上做的層級變更（重新指定父級、移除父級）不會同步到本地，僅同步欄位值。",
  ...
  "sidebar.issue.toast.archiveFailed": "歸檔待辦失敗",
  "sidebar.issue.toast.reorderFailed": "重新排序待辦失敗",
  "sidebar.issue.toast.reparentFailed": "移動待辦失敗",
  "sidebar.issue.tooltip.archive": "歸檔此待辦",
  "sidebar.issue.tooltip.delete": "刪除此待辦",
  "sidebar.issue.confirmArchive": "歸檔",
  "sidebar.issue.archivedBadge": "已歸檔",
  "sidebar.issue.archiveArea.title": "已歸檔",
  "sidebar.issue.archiveArea.expand": "顯示已歸檔",
  "sidebar.issue.archiveArea.collapse": "隱藏已歸檔",
  "sidebar.issue.archiveArea.empty": "暫無已歸檔待辦",
