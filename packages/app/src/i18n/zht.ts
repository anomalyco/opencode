...
export const dict = {
  ...
  "command.project.run": "執行專案",
  "command.project.run.description": "執行選取的專案命令",
  "command.project.stop": "停止專案",
  "command.project.stop.description": "停止正在執行的專案命令",
  ...
  "run.project.start": "啟動",
  "run.selector.placeholder": "選擇執行命令",
  "run.empty": "尚未設定執行命令",
  "run.run": "執行",
  "run.stop": "停止",
  ...
  "dialog.project.edit.runConfigs": "執行設定",
  "dialog.project.edit.runConfigs.description": "可在專案終端機中執行的命名命令。",
  "dialog.project.edit.runConfigs.detected": "從專案檔案偵測到",
  "dialog.project.edit.runConfigs.scan": "掃描專案檔案",
  "dialog.project.edit.runConfigs.scan.scanning": "掃描中...",
  "dialog.project.edit.runConfigs.add": "新增執行設定",
  "dialog.project.edit.runConfigs.name": "名稱",
  "dialog.project.edit.runConfigs.name.placeholder": "例如開發伺服器",
  "dialog.project.edit.runConfigs.command": "命令",
  "dialog.project.edit.runConfigs.command.placeholder": "例如 bun dev",
  "dialog.project.edit.runConfigs.remove": "移除執行設定",
