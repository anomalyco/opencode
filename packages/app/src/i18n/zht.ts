...
export const dict = {
  ...
  "sidebar.issue.title": "待辦",
  "sidebar.issue.add": "新增待辦",
  "sidebar.issue.addSubtodo": "新增子待辦",
  "sidebar.issue.empty": "尚無待辦",
  "sidebar.issue.collapse": "摺疊子待辦",
  "sidebar.issue.expand": "展開子待辦",
  "sidebar.issue.confirmDeleteWithChildren": "刪除此待辦及其 {{count}} 個子待辦？",
  "sidebar.issue.toast.deleteFailed": "刪除待辦失敗",
  "sidebar.issue.tooltip.cycleStatus": "切換狀態",
  "sidebar.issue.tooltip.cyclePriority": "切換優先順序",
  "sidebar.issue.tooltip.linkedLinear": "已連結 Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "已連線",
  "sidebar.linear.management": "管理 Linear 綁定",
  "sidebar.linear.management.teamRequired": "請選擇團隊",
  "sidebar.linear.management.projectRequired": "請選擇專案",
  "sidebar.linear.management.saveFailed": "儲存 Linear 綁定失敗",
  "sidebar.linear.management.saved": "Linear 綁定已儲存",
  "sidebar.linear.management.save": "儲存",
  "sidebar.linear.toggleHistory": "切換同步歷史",
  "sidebar.linear.field.team": "團隊",
  "sidebar.linear.field.team.loading": "正在載入團隊...",
  "sidebar.linear.field.team.placeholder": "選擇團隊",
  "sidebar.linear.field.project": "專案",
  "sidebar.linear.field.project.selectTeamFirst": "請先選擇團隊",
  "sidebar.linear.field.project.loading": "正在載入專案...",
  "sidebar.linear.field.project.placeholder": "選擇專案",
  "sidebar.linear.notConfigured": "Linear 未設定",
  "sidebar.linear.notConfiguredHint": "開啟管理面板選擇團隊和專案",
  "sidebar.linear.actions": "同步動作",
  "sidebar.linear.push": "推送",
  "sidebar.linear.pull": "拉取",
  "sidebar.linear.pullFailed": "從 Linear 拉取失敗",
  "sidebar.linear.pullPartialFailed": "拉取部分失敗：{{count}} 個錯誤",
  "sidebar.linear.pullSuccess": "拉取 {{pulled}}，更新 {{updated}}，跳過 {{skipped}}，刪除 {{deleted}}",
  "sidebar.linear.pushFailed": "推送到 Linear 失敗",
  "sidebar.linear.pushPartialFailed": "推送部分失敗：{{count}} 個錯誤",
  "sidebar.linear.pushSuccess": "已推送 {{count}} 個待辦到 Linear",
  "sidebar.linear.pushNothing": "沒有需要推送的內容",
  "sidebar.linear.syncHistory.syncing": "同步中...",
  "sidebar.linear.syncHistory.push": "↗ Linear",
  "sidebar.linear.syncHistory.pull": "↙ Linear",
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} 項",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} 項",
  "sidebar.linear.syncHistory.error": "錯誤",
  "sidebar.linear.syncHistory.empty": "沒有同步歷史",
  "dialog.todo.title.create": "新建待辦",
  "dialog.todo.title.edit": "編輯待辦",
  "dialog.todo.field.title": "標題",
  "dialog.todo.field.title.placeholder": "待辦標題",
  "dialog.todo.field.description": "描述",
  "dialog.todo.field.description.placeholder": "新增詳情、連結或上下文...",
  "dialog.todo.field.description.hint": "支援檔案和技能參照",
  "dialog.todo.field.status": "狀態",
  "dialog.todo.field.priority": "優先順序",
  "dialog.todo.field.dueDate": "截止日期",
  "dialog.todo.field.dueDate.placeholder": "設定截止日期",
  "dialog.todo.field.dueDate.clear": "清除",
  "dialog.todo.field.dueDate.prevMonth": "上個月",
  "dialog.todo.field.dueDate.nextMonth": "下個月",
  "dialog.todo.field.dueDate.shortcut.today": "今天",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "明天",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "一週後",
  ...
  "dialog.todo.field.labels": "標籤",
  "dialog.todo.field.assignee": "負責人",
  "dialog.todo.field.assignee.unassigned": "未指派",
  "dialog.todo.field.assignee.loadFailed": "載入負責人失敗",
  "dialog.todo.field.assignee.loading": "正在載入負責人...",
  "dialog.todo.field.assignee.placeholder": "選擇負責人",
  "dialog.todo.field.assignee.hint": "來源於 Linear 團隊成員",
  "dialog.todo.autocomplete.noFiles": "未找到檔案",
  "dialog.todo.autocomplete.noSkills": "未找到技能",
  "dialog.todo.linkedLinear": "已連結 Linear",
  "dialog.todo.created": "待辦已建立",
  "dialog.todo.updated": "待辦已更新",
  "dialog.todo.error.titleRequired": "標題為必填項",
  "dialog.todo.error.saveFailed": "儲存待辦失敗",
  "dialog.todo.action.create": "建立",
