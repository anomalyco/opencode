...
export const dict = {
  ...
  "toast.file.uploadFailed.title": "上傳檔案失敗",
  "toast.file.downloadFailed.title": "下載檔案失敗",
  "toast.file.deleteFailed.title": "刪除檔案失敗",
  ...
  "session.files.uploadFile": "上傳檔案",
  "session.files.uploading": "上傳中…",
  "session.files.downloadFile": "下載",
  "session.files.refresh": "重新整理",
  "session.files.dropFiles": "將檔案拖到這裡或點擊 + 上傳",
  "session.files.deleteConfirm": "刪除 \"{{path}}\"？",
  "session.files.uploadTooLarge": "檔案太大（最大 {{size}}）",
