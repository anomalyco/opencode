...
"command.project.index": "切換到專案 {{index}}",
  ...
  "home.sessions.empty.description": "為此專案啟動新工作階段",
  ...
  "settings.general.row.showNavigation.description": "顯示後退和前進按鈕，用於在工作階段歷史中導覽",
  "settings.general.row.showNavigation.title": "導覽控制項",
  "settings.general.row.showSearch.description": "顯示搜尋和命令面板按鈕",
  "settings.general.row.showSearch.title": "命令面板",
  "settings.general.row.showStatus.description": "顯示伺服器狀態按鈕",
  "settings.general.row.showStatus.title": "伺服器狀態",
  "settings.general.row.showTerminal.description": "顯示終端機按鈕",
  ...
  "sidebar.empty.description": "開啟專案開始使用",
  "sidebar.empty.title": "尚無專案開啟",
  ...
  "wsl.onboarding.openDistroOnce": "請啟動一次 {{distro}} 以完成設定。",
  ...
  "wsl.onboarding.pickDistro": "選擇一個發行版或安裝一個。",
  ...
  "wsl.onboarding.versionMismatch": "已安裝的版本與桌面應用程式版本不符。",
