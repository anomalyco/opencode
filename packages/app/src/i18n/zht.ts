...
export const dict = {
  ...
  "common.clear": "清除",
  "session.child.promptDisabled": "子代理程式工作階段無法傳送提示。",
  ...
  "wsl.onboarding.openDistroOnce": "請開啟 {{distro}} 一次以完成設定。",
  "wsl.onboarding.finishingDistro": "正在完成 {{distro}} 的設定。",
  "wsl.onboarding.pickDistro": "選擇一個發行版或在下方安裝。",
  ...
  "wsl.onboarding.opencodeReadyIn": "OpenCode 在 {{distro}} 中已就緒。",
  ...
  "wsl.onboarding.windowsRestartRequired": "請重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 OpenCode。",
  ...
  "error.page.description.localServerStartup": "啟動本地伺服器時發生錯誤。",
  ...
  "home.sessions.empty.description": "為此專案開始一個新工作階段",
  ...
  "settings.general.row.shell.description": "選擇終端機使用的 Shell。相容的 Shell 也用於代理程式工具呼叫。",
  ...
  "settings.general.row.showCustomAgents.description": "在 v2 桌面編輯器中顯示代理程式選擇器",
  "settings.general.row.newLayoutDesigns.title": "新版面配置與設計",
  "settings.general.row.newLayoutDesigns.description": "啟用重新設計的版面配置、首頁、編輯器和工作階段介面",
