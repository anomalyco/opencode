...
export const dict = {
  ...
  "session.modelRace.details": "Details（详情）",
  "session.modelRace.hideDetails": "Hide details（收起详情）",
  "session.modelRace.state": "State（状态）",
  "session.modelRace.phase": "Race phase（竞速阶段）",
  "session.modelRace.reason": "Reason（锁定原因）",
  "session.modelRace.outputTokens": "Output tokens（输出 Token）",
  "session.modelRace.speed": "Speed（速度）",
  "session.modelRace.elapsed": "Elapsed（竞速耗时）",
