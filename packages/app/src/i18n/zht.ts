...
export const dict = {
  ...
  "home.recentlyClosed.options": "篩選與排序",
  "home.recentlyClosed.filter.label": "篩選",
  "home.recentlyClosed.filter.recent": "最近",
  "home.recentlyClosed.filter.archived": "已封存",
  "home.recentlyClosed.filter.hidden": "已隱藏",
  "home.recentlyClosed.filter.all": "全部",
  "home.recentlyClosed.filter.empty": "沒有符合此篩選條件的專案",
  "home.recentlyClosed.sort.label": "排序",
  "home.recentlyClosed.sort.recent": "最新優先",
  "home.recentlyClosed.sort.oldest": "最舊優先",
  "home.recentlyClosed.sort.nameAsc": "名稱 A–Z",
  "home.recentlyClosed.sort.nameDesc": "名稱 Z–A",
  "home.recentlyClosed.search.placeholder": "搜尋最近關閉的專案",
  "home.recentlyClosed.showMore": "顯示全部（{{count}}）",
  "home.recentlyClosed.showLess": "收合",
  "home.recentlyClosed.select": "選取…",
  "home.recentlyClosed.selectAll": "全選",
  "home.recentlyClosed.deselectAll": "取消全選",
  "home.recentlyClosed.cancelSelection": "取消選取",
  "home.recentlyClosed.selected": "已選取 {{count}} 項",
  "home.recentlyClosed.noResults": "沒有與「{{query}}」相符的專案",
  "home.recentlyClosed.archived.badge": "已封存",
  "home.recentlyClosed.hidden.badge": "已隱藏",
  "home.recentlyClosed.action.reopen": "重新開啟",
  "home.recentlyClosed.action.unarchive": "取消封存",
  "home.recentlyClosed.action.hide": "隱藏",
  "home.recentlyClosed.action.unhide": "取消隱藏",
  "home.recentlyClosed.action.remove": "忘記",
  "home.recentlyClosed.remove.title": "要忘記此專案嗎？",
  "home.recentlyClosed.remove.titleMany": "要忘記 {{count}} 個專案嗎？",
  "home.recentlyClosed.remove.confirm": "要從最近關閉中移除「{{name}}」嗎？這只會清除紀錄，絕不會刪除檔案。",
  "home.recentlyClosed.remove.confirmMany": "要從最近關閉中移除 {{count}} 個專案嗎？這只會清除紀錄，絕不會刪除檔案。",
  "home.recentlyClosed.toast.archived": "已封存",
  "home.recentlyClosed.toast.hidden": "已隱藏",
  "home.recentlyClosed.toast.removed": "已從最近關閉中移除",
  "home.recentlyClosed.toast.undo": "復原",
