...
export const dict = {
  ...
  "provider.connect.xcshZen.line1": "xcsh Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.xcshZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.xcshZen.visit.prefix": "造訪 ",
  "provider.connect.xcshZen.visit.link": "f5xc-salesdemos.github.io/xcsh/zen",
  "provider.connect.xcshZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 xcsh.json 中設定的外掛程式",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (xcsh.json) 中的 provider/model 名稱",
