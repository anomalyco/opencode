...
export const dict = {
  ...
  "settings.tab.feishu": "飛書橋接",
  "settings.feishu.title": "飛書橋接",
  "settings.feishu.description": "透過飛書 / Lark 與你的 AI agent 對話。",
  "settings.feishu.adapter.notReady": "飛書橋接服務尚未啟動。",
  ...
  "settings.feishu.account.empty.title": "尚未綁定飛書帳號",
  "settings.feishu.account.empty.description": "綁定你的第一個飛書 / Lark 帳號即可開始接收訊息。",
  "settings.feishu.account.add": "新增飛書帳號",
  "settings.feishu.account.delete": "刪除",
  "settings.feishu.bind.title": "綁定飛書帳號",
  "settings.feishu.bind.domain.label": "選擇網域",
  "settings.feishu.bind.domain.feishu": "飛書(國內)",
  "settings.feishu.bind.domain.lark": "Lark(國際)",
  "settings.feishu.bind.scanQr": "用飛書 App 掃描下方 QR Code 完成授權",
  "settings.feishu.bind.userCodeLabel": "或在飛書 App 中輸入此 user_code",
