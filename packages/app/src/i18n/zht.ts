...
export const dict = {
  ...
  "settings.permissions.tool.bash_unsandboxed.title": "Bash（無沙箱）",
  "settings.permissions.tool.bash_unsandboxed.description": "在沒有沙箱限制的情況下重試 shell 指令",
  "settings.permissions.tool.bash_unsandboxed_network.title": "Bash（無沙箱）",
  "settings.permissions.tool.bash_unsandboxed_network.description": "沙箱網路已停用，因此上一次嘗試可能因沙箱而失敗。",
  "settings.permissions.tool.bash_unsandboxed_explicit.title": "Bash（無沙箱）",
  "settings.permissions.tool.bash_unsandboxed_explicit.description": "此指令要求在沒有沙箱限制的情況下執行。",
