...
export const dict = {
  ...
  "provider.custom.description.prefix": "設定與 OpenAI 相容的提供商。輸入端點後，應用程式會自動嘗試探索模型。請參閱",
  ...
  "provider.custom.field.baseURL.label": "API 端點",
  "provider.custom.field.baseURL.placeholder": "https://api.myprovider.com/v1",
  "provider.custom.field.baseURL.description": "應用程式會嘗試 /models 和 /v1/models 來自動探索模型。",
  ...
  "provider.custom.models.refresh": "偵測模型",
  ...
  "settings.providers.custom.description": "透過 API 端點新增與 OpenAI 相容的提供者。",
