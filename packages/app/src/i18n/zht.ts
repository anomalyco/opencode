...
export const dict = {
  ...
  "command.context.addToChat": "將所選內容加入聊天",
  "command.context.addToChat.description": "在游標位置插入選取的行",
  "command.context.quickEdit": "快速編輯所選內容",
  "command.context.quickEdit.description": "在新工作階段中編輯選取的程式碼",
  "selection.action.addToChat": "加入聊天",
  "selection.action.quickEdit": "快速編輯",
  "selection.quickEdit.placeholder": "編輯選取的程式碼",
