...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Argus 載入失敗",
  "desktop.recovery.terminated": "Argus 視窗意外終止",
  "desktop.recovery.unresponsive": "Argus 沒有回應",
  ...
  "desktop.wsl.error.installArgus": "Argus 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.argusMissing": "此發行版中未安裝 argus",
  "desktop.wsl.error.argusCannotRun": "已安裝 argus，但無法執行",
  "desktop.wsl.error.argusNotInstalled": "{{distro}} 中未安裝 Argus",
  "desktop.wsl.error.updateVersion":
    "Argus 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.argus.tagline": "經過最佳化的可靠模型",
  ...
  "wsl.onboarding.checkingArgus": "正在檢查 Argus...",
  "wsl.onboarding.checkingArgusIn": "正在檢查 {{distro}} 中的 Argus...",
  ...
  "wsl.onboarding.argusReadyIn": "{{distro}} 中的 Argus 已就緒。",
  "wsl.onboarding.argusReady": "Argus 已就緒。",
  "wsl.onboarding.installArgusIn": "在 {{distro}} 中安裝 Argus。",
  "wsl.onboarding.installArgus": "安裝 Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "未安裝 Argus",
  ...
  "wsl.onboarding.wslUnavailable.description": "Argus 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Argus。",
  ...
  "help.tabs.introduction": "Argus Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Argus 尚不支援 MCP 驗證。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Argus 伺服器。",
  ...
  "settings.general.row.colorScheme.description": "選擇 Argus 要跟隨系統、淺色或深色主題",
