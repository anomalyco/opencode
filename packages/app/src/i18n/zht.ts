...
export const dict = {
  ...
  "provider.custom.models.load": "動態載入",
  "provider.custom.models.loading": "載入中...",
  "provider.custom.models.load.invalidUrl": "請輸入有效的基底 URL",
  "provider.custom.models.load.unauthorized": "未授權。請檢查 API 金鑰",
  "provider.custom.models.load.invalidFormat": "伺服器回應不是有效的模型清單",
  "provider.custom.models.load.timeout": "載入模型逾時",
  "provider.custom.models.load.failed": "載入模型失敗",
  "provider.custom.models.load.empty": "找不到模型",
