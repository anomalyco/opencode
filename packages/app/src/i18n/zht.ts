...
export const dict = {
  ...
  "provider.custom.models.config.expand": "展開模型設定",
  "provider.custom.models.config.collapse": "折疊模型設定",
  "provider.custom.models.config.empty": "留空則不設定",
  "provider.custom.models.config.placeholder": "類型：{{type}}；範例：{{example}}；留空則不設定",
  ...
  "provider.custom.error.boolean": "請填寫 true 或 false",
  "provider.custom.error.number": "請填寫有限數字",
  "provider.custom.error.json": "請填寫有效 JSON",
  "provider.custom.error.status": "請填寫 active、beta、alpha 或 deprecated",
  "provider.custom.error.modalities": "請填寫 text、audio、image、video 或 pdf",
  ...
  "error.page.action.restartFrontend": "重新啟動前端",
  "error.page.action.restartBackend": "重新啟動後端",
  "error.page.action.restartApp": "重新啟動應用程式",
  ...
  "settings.general.row.reasoningSummaries.title": "顯示思考內容",
  "settings.general.row.reasoningSummaries.description": "在時間軸中顯示模型思考內容",
