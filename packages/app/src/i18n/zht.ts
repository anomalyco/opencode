...
export const dict = {
  ...
  "home.activity.title": "權杖活動",
  "home.activity.daily": "每日",
  "home.activity.weekly": "每週",
  "home.activity.cumulative": "累計",
  "home.activity.loading": "載入活動中",
  "home.activity.empty": "尚無權杖活動",
  "home.activity.lifetimeTokens": "總權杖數",
  "home.activity.peakTokens": "峰值權杖",
  "home.activity.longestTask": "最長任務",
  "home.activity.currentStreak": "目前連續",
  "home.activity.longestStreak": "最長連續",
  "home.activity.days.one": "{{count}} 天",
  "home.activity.days.other": "{{count}} 天",
  "home.activity.summary": "{{tokens}} 總權杖，{{peak}} 峰值權杖，{{current}} 目前連續，{{longest}} 最長連續。",
