...
export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "無效的 SSH 主機：{{host}}",
  "desktop.ssh.error.alreadyAdded": "已新增 {{host}}",
  "desktop.ssh.error.opencodeNotInstalled": "{{host}} 上未安裝 opencode",
  "desktop.ssh.error.installOpencode": "opencode 安裝失敗",
  "desktop.ssh.error.connectFailed": "無法連線到 {{host}}",
  "desktop.ssh.error.serverExited": "SSH 伺服器在啟動後結束 (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}} 的 SSH 伺服器在健全狀態確認前結束 (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "{{host}} 上的伺服器健全狀態檢查在 {{timeout}}ms 後逾時",
  "desktop.ssh.error.commandTimeout": "傳送到 {{host}} 的 ssh 命令在 {{timeout}}ms 後逾時",
  "desktop.ssh.error.failedPort": "無法取得連接埠",
  "desktop.ssh.error.terminalFailed": "無法開啟終端機",
  ...
  "ssh.server.add": "新增 SSH 伺服器",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH 伺服器",
  "ssh.server.retryStart": "重新連線",
  "ssh.server.disconnect": "中斷連線",
  "ssh.server.openTerminal": "開啟終端機",
  "ssh.server.updating": "更新中...",
  "ssh.server.status.connecting": "連線中...",
  "ssh.server.status.disconnected": "已中斷連線",
  "ssh.add.hostLabel": "SSH 主機",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint": "透過系統的 ssh 用戶端連線，因此 SSH 設定中的主機、金鑰和代理程式都可照常使用。",
  "ssh.add.configHosts": "來自你的 SSH 設定",
  "ssh.add.connect": "連線",
  "ssh.add.checking": "連線中...",
  "ssh.add.addServer": "新增伺服器",
  "ssh.add.adding": "新增中...",
  "ssh.add.installOpencode": "安裝 opencode",
  "ssh.add.updateOpencode": "更新 opencode",
  "ssh.add.installing": "安裝中...",
  "ssh.add.status.unreachable": "無法連線",
  "ssh.add.status.opencodeMissing": "此主機上未安裝 opencode",
  "ssh.add.status.opencodeMismatch": "已安裝 opencode v{{version}}，桌面版預期為 v{{expected}}",
  "ssh.add.status.opencodeFound": "已找到 opencode v{{version}}",
  "ssh.add.authHint": "請確保此主機可使用 SSH 金鑰驗證，在終端機中執行 `ssh {{host}}` 即可檢查。",
