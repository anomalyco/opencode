...
export const dict = {
  ...
  "dialog.newProject.title": "新增專案",
  "dialog.newProject.tab.github": "從 GitHub 匯入",
  "dialog.newProject.tab.folder": "從資料夾匯入",
  "dialog.newProject.url.label": "儲存庫 URL",
  "dialog.newProject.destination.label": "克隆目標",
  "dialog.newProject.destination.placeholder": "選擇目標資料夾",
  "dialog.newProject.destination.browse": "瀏覽",
  "dialog.newProject.destination.pick": "選擇克隆目標",
  "dialog.newProject.clone": "克隆儲存庫",
  "dialog.newProject.cloning": "克隆中...",
  "dialog.newProject.error.cloneFailed": "克隆儲存庫失敗",
  "dialog.newProject.folder.title": "開啟現有專案",
  "dialog.newProject.folder.description": "選擇一個本地資料夾作為專案加入 OpenCode。",
  "dialog.newProject.folder.action": "選擇資料夾",
