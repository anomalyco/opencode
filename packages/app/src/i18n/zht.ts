...
export const dict = {
  ...
  "presets.title": "常用語",
  "presets.manage": "管理常用語",
  "presets.count": "共 {{count}} 條常用語",
  "presets.empty": "暫無常用語",
  "presets.empty.hint": "點擊「新增」新增你的第一條常用語",
  "presets.add": "新增",
  "presets.name": "名稱",
  "presets.content": "內容",
  "presets.content.placeholder": "內容（支援 {date} {time} {file} {code} {text} 等變數）",
  "presets.moveUp": "上移",
  "presets.moveDown": "下移",
  "presets.edit": "編輯",
  "presets.delete": "刪除",
  "presets.variables.title": "輸入「{{name}}」的變數",
  "presets.variables.next": "下一個",
  "presets.variables.insert": "插入",
