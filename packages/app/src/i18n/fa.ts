export const dict = {
  ...
  "settings.tab.plugins": "افزونه",
  "settings.plugins.section.browse": "مرور",
  "settings.plugins.section.installed": "نصب‌شده",
  ...
  "settings.mcp.add": "افزودن سرور",
  "settings.mcp.empty": "هیچ سرور MCP پیکربندی نشده است.",
  "settings.mcp.deleted": "{{name}} حذف شد.",
  "settings.mcp.errors.refresh": "بارگذاری سرورهای MCP ممکن نشد.",
  "settings.mcp.status.pending": "در حال اتصال…",
  "settings.mcp.action.connect": "اتصال",
  "settings.mcp.action.disconnect": "قطع اتصال",
  "settings.mcp.action.authenticate": "احراز هویت",
  "settings.mcp.action.edit": "ویرایش",
  "settings.mcp.action.delete": "حذف",
  "settings.mcp.delete.title": "حذف سرور MCP",
  "settings.mcp.delete.body": "{{name}} حذف شود؟ قابل بازگشت نیست.",
  "settings.mcp.form.title.add": "افزودن سرور MCP",
  "settings.mcp.form.title.edit": "ویرایش سرور MCP",
  "settings.mcp.form.subtitle": "تنظیمات اتصال را پیکربندی کنید.",
  "settings.mcp.form.name": "نام",
  "settings.mcp.form.command": "دستور",
  "settings.mcp.form.command.hint": "مثلاً npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "پوشه کاری",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "متغیرهای محیطی",
  "settings.mcp.form.headers": "سرصفحه‌ها",
  "settings.mcp.form.addRow": "افزودن ردیف",
  "settings.mcp.form.removeRow": "حذف",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "شناسه مشتری",
  "settings.mcp.form.oauth.clientSecret": "رمز مشتری",
  "settings.mcp.form.oauth.clientSecret.keep": "پیکربندی شده — برای حفظ خالی بگذارید",
  "settings.mcp.form.oauth.scope": "دامنه",
  "settings.mcp.form.oauth.callbackPort": "پورت بازگشت",
  "settings.mcp.form.oauth.disableAutodetect": "غیرفعال‌سازی تشخیص خودکار OAuth",
  "settings.mcp.form.enabled": "فعال",
  "settings.mcp.form.timeout": "وقفه (ms)",
  "settings.mcp.form.save": "ذخیره",
  "settings.mcp.form.cancel": "انصراف",
  "settings.mcp.form.error.name": "نام را وارد کنید.",
  "settings.mcp.form.error.command": "دستور را وارد کنید.",
  "settings.mcp.form.error.url": "URL را وارد کنید.",
  "settings.mcp.form.error.callbackPort": "پورت بازگشت باید بین 1 تا 65535 باشد.",
  "settings.mcp.form.error.timeout": "وقفه باید عدد صحیح مثبت باشد.",
  "settings.mcp.errors.invalid": "فیلدهای مشخص‌شده را اصلاح کنید.",
  "settings.mcp.errors.duplicate": "سروری با این نام از قبل وجود دارد.",
  "settings.mcp.errors.noConfig": "پیکربندی {{name}} قابل خواندن نیست — ممکن است بیرون از پروژه تعریف شده باشد.",
  "settings.mcp.edit.warn": "ذخیره، این سرور را دوباره متصل می‌کند.",
  ...
  "settings.plugins.detail.copied": "کپی شد",
  "settings.plugins.detail.notOnNpm": "در npm یافت نشد — به‌صورت دستی به opencode.json اضافه کنید",
  "settings.plugins.install.title": "نصب افزونه",
  "settings.plugins.install.description": "{{name}} کجا اضافه شود؟",
  "settings.plugins.install.global": "سراسری (~/.config/opencode)",
  "settings.plugins.install.project": "این پروژه",
  "settings.plugins.install.cancel": "لغو",
  "settings.plugins.install.success": "{{name}} نصب شد. برای بارگذاری، OpenCode را دوباره اجرا کنید.",
  "settings.plugins.installed.empty": "هیچ افزونه‌ای نصب نشده است.",
  "settings.plugins.installed.provenance.global": "سراسری",
  "settings.plugins.installed.provenance.project": "پروژه",
  ...
  "settings.plugins.errors.catalog": "به‌روزرسانی کاتالوگ افزونه‌ها ممکن نشد.",
  "settings.plugins.stale": "نمایش کاتالوگ ذخیره‌شده ({{age}} پیش).",
