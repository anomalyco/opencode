export const dict = {
  ...
  "mcp.status.needs_client_registration": "ثبت مشتری لازم است",
  "mcp.status.pending": "در حال اتصال…",
  ...
  "settings.mcp.type.local": "محلی",
  "settings.mcp.type.remote": "از راه دور",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "برای حذف خالی بگذارید — احراز هویت مجدد ممکن است لازم باشد",
