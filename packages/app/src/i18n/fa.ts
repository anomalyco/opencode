export const dict = {
  ...
  "command.session.handoff": "انتقال جلسه",
  "command.session.handoff.description": "جلسه را فشرده کنید و کار را در جلسه‌ای جدید ادامه دهید",
  ...
  "toast.session.handoff.failed.title": "انتقال جلسه انجام نشد",
  "toast.session.handoff.failed.description": "خلاصه‌کردن این جلسه برای انتقال ممکن نبود",
