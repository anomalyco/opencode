export const dict = {
  ...
  "voice.error.microphoneUnavailable": "میکروفون در این دستگاه راه‌اندازی نشد.",
  ...
  "voice.settings.backend.title": "بک‌اند رونویسی",
  "voice.settings.backend.description": "انتخاب کنید ضبط‌ها کجا رونویسی شوند",
  ...
  "voice.settings.localModel.description":
    "پس از یک بار دانلود {{size}} مگابایت به‌صورت آفلاین اجرا می‌شود. ضبط‌ها هرگز از این دستگاه خارج نمی‌شوند.",
  ...
  "voice.settings.aiModel.description":
    "ضبط‌ها را به ارائه‌دهنده انتخاب‌شده می‌فرستد. فقط مدل‌هایی که پشتیبانی از ورودی صوتی را اعلام می‌کنند نمایش داده می‌شوند.",
  "voice.settings.aiModel.empty": "هیچ مدل متصلی پشتیبانی از ورودی صوتی را اعلام نمی‌کند.",
