export const dict = {
  ...
  "provider.custom.models.load": "بارگذاری پویا",
  "provider.custom.models.loading": "در حال بارگذاری...",
  "provider.custom.models.load.invalidUrl": "یک پایه URL معتبر وارد کنید",
  "provider.custom.models.load.unauthorized": "غیرمجاز. کلید API را بررسی کنید",
  "provider.custom.models.load.invalidFormat": "پاسخ سرور فهرست مدل معتبری نبود",
  "provider.custom.models.load.timeout": "زمان بارگذاری مدل‌ها به پایان رسید",
  "provider.custom.models.load.failed": "بارگذاری مدل‌ها ناموفق بود",
  "provider.custom.models.load.empty": "مدلی پیدا نشد",
