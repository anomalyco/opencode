export const dict = {
  ...
  "session.tab.agents": "زیرعامل‌ها",
  "session.agents.empty": "هیچ زیرعاملی در حال اجرا نیست",
  "session.agents.costTotal": "هزینه کل",
  "session.agents.costSubagents": "زیرعامل‌ها",
  "session.agents.count": "عامل‌ها",
  "session.agents.tokens": "توکن",
  "session.agents.showAll": "نمایش همه ({{count}})",
  "session.agents.status.idle": "بیکار",
  "session.agents.status.busy": "در حال اجرا",
  "session.agents.status.retry": "تلاش مجدد",
  "session.agents.status.cancelled": "لغو شد",
  "session.agents.status.completed": "تکمیل شد",
  "session.agents.status.error": "ناموفق",
