...
export const dict = {
  ...
  "command.tab.closeAll": "Uždaryti visus skirtukus",
  "command.tab.closeRight": "Uždaryti visus skirtukus dešinėje",
  "command.tab.closeOthers": "Uždaryti visus skirtukus, išskyrus šį",
