...
export const dict = {
  ...
  "provider.custom.models.load": "Įkelti dinamiškai",
  "provider.custom.models.loading": "Įkeliama...",
  "provider.custom.models.load.invalidUrl": "Įveskite tinkamą pagrindo URL",
  "provider.custom.models.load.unauthorized": "Neleistina. Patikrinkite API raktą",
  "provider.custom.models.load.invalidFormat": "Serverio atsakyme nebuvo tinkamo modelių sąrašo",
  "provider.custom.models.load.timeout": "Baigėsi laikas įkeliant modelius",
  "provider.custom.models.load.failed": "Nepavyko įkelti modelių",
  "provider.custom.models.load.empty": "Modelių nerasta",
