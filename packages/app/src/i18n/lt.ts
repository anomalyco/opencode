...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Argus įkelti nepavyko",
  "Argus langas netikėtai užsidarė",
  "Argus neatsako",
  ...
  "Argus įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "argus šiame distributyve neįdiegtas",
  "argus įdiegtas, bet jo paleisti nepavyko",
  "Argus neįdiegtas distributyve {{distro}}",
  "Argus naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.argus.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.argus.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.argusGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Argus modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.argusZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.argusZen.visit.prefix": "Aplankykite",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Argus.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti argus.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Argus serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingArgus": "Tikrinama Argus...",
  "wsl.onboarding.checkingArgusIn": "Tikrinama Argus {{distro}}...",
  "wsl.onboarding.updatingArgus": "Atnaujinamas Argus...",
  "wsl.onboarding.updatingArgusIn": "Atnaujinamas Argus {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Atnaujinkite Argus {{distro}}.",
  "wsl.onboarding.updateArgus": "Atnaujinkite Argus",
  "wsl.onboarding.argusReadyIn": "Argus yra paruoštas {{distro}}.",
  "wsl.onboarding.argusReady": "Argus yra paruoštas.",
  "wsl.onboarding.installArgusIn": "Įdiekite Argus į {{distro}}.",
  "wsl.onboarding.installArgus": "Įdiekite Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Argus galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Argus nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Argus ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Argus komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (argus.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Argus dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Argus apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Argus darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Argus serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Argus ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Argus atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Argus seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Argus temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Argus",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Argus versiją.",
