...
export const dict = {
  ...
  "session.tab.agents": "Subagentai",
  "session.agents.empty": "Nevyksta jokių subagentų",
  "session.agents.costTotal": "Bendra kaina",
  "session.agents.costSubagents": "Subagentai",
  "session.agents.count": "Agentai",
  "session.agents.tokens": "žetonų",
  "session.agents.showAll": "Rodyti viską ({{count}})",
  "session.agents.status.idle": "Neaktyvus",
  "session.agents.status.busy": "Vykdoma",
  "session.agents.status.retry": "Bandoma iš naujo",
  "session.agents.status.cancelled": "Atšaukta",
  "session.agents.status.completed": "Baigta",
  "session.agents.status.error": "Nepavyko",
