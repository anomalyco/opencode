...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Pencode įkelti nepavyko",
  "Pencode langas netikėtai užsidarė",
  "Pencode neatsako",
  ...
  "Pencode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "pencode šiame distributyve neįdiegtas",
  "pencode įdiegtas, bet jo paleisti nepavyko",
  "Pencode neįdiegtas distributyve {{distro}}",
  "Pencode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.pencode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.pencode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.pencodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Pencode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.pencodeZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.pencodeZen.visit.prefix": "Aplankykite",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Pencode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti pencode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Pencode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingPencode": "Tikrinama Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Tikrinama Pencode {{distro}}...",
  "wsl.onboarding.updatingPencode": "Atnaujinamas Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Atnaujinamas Pencode {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Atnaujinkite Pencode {{distro}}.",
  "wsl.onboarding.updatePencode": "Atnaujinkite Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode yra paruoštas {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode yra paruoštas.",
  "wsl.onboarding.installPencodeIn": "Įdiekite Pencode į {{distro}}.",
  "wsl.onboarding.installPencode": "Įdiekite Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Pencode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Pencode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Pencode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Pencode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (pencode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Pencode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Pencode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Pencode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Pencode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Pencode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Pencode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Pencode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Pencode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Pencode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Pencode versiją.",
