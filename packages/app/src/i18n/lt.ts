...
export const dict = {
  ...
  "command.session.background": "Paleisti subagentus fone",
  "command.session.background.description": "Atkabinkite šią sesiją blokuojančius subagentus ir tęskite juos fone",
  ...
  "toast.session.background.failed.title": "Nepavyko paleisti subagentų fone",
