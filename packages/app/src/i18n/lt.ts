...
export const dict = {
  ...
  "command.session.handoff": "Perduoti seansą",
  "command.session.handoff.description": "Glaudinti seansą ir tęsti darbą naujame seanse",
  ...
  "toast.session.handoff.failed.title": "Nepavyko perduoti seanso",
  "toast.session.handoff.failed.description": "Šio seanso nepavyko apibendrinti, kad jį būtų galima perduoti",
