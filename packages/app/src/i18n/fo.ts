export const dict = {
  ...
  "desktop.menu.documentation": "Pencode Skjøl",
  ...
  "desktop.menu.ariaLabel": "Pencode valmynd",
  ...
  "desktop.recovery.loadFailed": "Pencode miseydnaðist at heinta",
  "desktop.recovery.terminated": "Pencode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Pencode svarar ikki",
  ...
  "desktop.wsl.error.installPencode": "Pencode uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.pencodeMissing": "pencode er ikki sett upp í hesi distro",
  "desktop.wsl.error.pencodeCannotRun": "pencode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.pencode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.pencode.tagline": "Álítandi optimerað modell",
  "dialog.provider.pencodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Pencode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.pencodeZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.pencodeZen.visit.prefix": "Vitja ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Pencode.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í pencode.json",
  ...
  "dialog.server.description": "Skift hvønn Pencode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingPencode": "Kanna Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Kanna Pencode í {{distro}}...",
  "wsl.onboarding.updatingPencode": "Dagføring Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Dagføring Pencode í {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Dagfør Pencode í {{distro}}.",
  "wsl.onboarding.updatePencode": "Dagfør Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode er klárt í {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode er klárt.",
  "wsl.onboarding.installPencodeIn": "Set Pencode upp í {{distro}}.",
  "wsl.onboarding.installPencode": "Set upp Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Pencode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Pencode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Pencode aftur.",
  ...
  "help.tabs.introduction": "Pencode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Pencode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Pencode toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (pencode.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Pencode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Pencode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Pencode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Pencode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Pencode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Pencode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Pencode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Pencode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Pencode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Pencode.",
