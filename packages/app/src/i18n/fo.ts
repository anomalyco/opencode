export const dict = {
  ...
  "desktop.menu.documentation": "Argus Skjøl",
  ...
  "desktop.menu.ariaLabel": "Argus valmynd",
  ...
  "desktop.recovery.loadFailed": "Argus miseydnaðist at heinta",
  "desktop.recovery.terminated": "Argus vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Argus svarar ikki",
  ...
  "desktop.wsl.error.installArgus": "Argus uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.argusMissing": "argus er ikki sett upp í hesi distro",
  "desktop.wsl.error.argusCannotRun": "argus er sett upp men kundi ikki koyra",
  "desktop.wsl.error.argusNotInstalled": "Argus er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.argus.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.argus.tagline": "Álítandi optimerað modell",
  "dialog.provider.argusGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Argus",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.argusZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.argusZen.visit.prefix": "Vitja ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Argus.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í argus.json",
  ...
  "dialog.server.description": "Skift hvønn Argus ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingArgus": "Kanna Argus...",
  "wsl.onboarding.checkingArgusIn": "Kanna Argus í {{distro}}...",
  "wsl.onboarding.updatingArgus": "Dagføring Argus...",
  "wsl.onboarding.updatingArgusIn": "Dagføring Argus í {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Dagfør Argus í {{distro}}.",
  "wsl.onboarding.updateArgus": "Dagfør Argus",
  "wsl.onboarding.argusReadyIn": "Argus er klárt í {{distro}}.",
  "wsl.onboarding.argusReady": "Argus er klárt.",
  "wsl.onboarding.installArgusIn": "Set Argus upp í {{distro}}.",
  "wsl.onboarding.installArgus": "Set upp Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Argus kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Argus kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Argus aftur.",
  ...
  "help.tabs.introduction": "Argus Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Argus ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Argus toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (argus.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Argus stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Argus inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Argus Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Argus ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Argus",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Argus sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Argus fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Argus er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Argus byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Argus.",
