export const dict = {
  ...
  "provider.custom.models.load": "Innles dynamiskt",
  "provider.custom.models.loading": "Innlesur...",
  "provider.custom.models.load.invalidUrl": "Innslá eina gilduga grund URL",
  "provider.custom.models.load.unauthorized": "Ikki heimilað. Kanna API-lykilin",
  "provider.custom.models.load.invalidFormat": "Svarið frá ambætarin inniheldur ikki eina gilda modelllista",
  "provider.custom.models.load.timeout": "Tíðin rann út tá modellir vóru innlesnar",
  "provider.custom.models.load.failed": "Tað miseydnaðist at innlesa modellir",
  "provider.custom.models.load.empty": "Ongar modellir funnar",
