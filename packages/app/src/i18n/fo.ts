export const dict = {
  ...
  "command.session.handoff": "Avhenda setu",
  "command.session.handoff.description": "Tak saman um setuna og halt arbeiðinum fram í einari nýggjari setu",
  ...
  "toast.session.handoff.failed.title": "Tað eydnaðist ikki at avhenda setuna",
  "toast.session.handoff.failed.description": "Tað bar ikki til at taka saman um hesa setuna til avhendingar",
