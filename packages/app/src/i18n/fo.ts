export const dict = {
  ...
  "session.tab.agents": "Undirumboð",
  "session.agents.empty": "Eingin undirumboð koyrir",
  "session.agents.costTotal": "Samlaður kostnaður",
  "session.agents.costSubagents": "Undirumboð",
  "session.agents.count": "Umboð",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Vís alt ({{count}})",
  "session.agents.status.idle": "Óvirkið",
  "session.agents.status.busy": "Koyrir",
  "session.agents.status.retry": "Royndar aftur",
  "session.agents.status.cancelled": "Avlýst",
  "session.agents.status.completed": "Liðugt",
  "session.agents.status.error": "Miseydnaðist",
