export const dict = {
  ...
  "command.tab.closeAll": "Lat allar flipar aftur",
  "command.tab.closeRight": "Lat allar flipar til høgru aftur",
  "command.tab.closeOthers": "Lat allar flipar uttan hendan aftur",
