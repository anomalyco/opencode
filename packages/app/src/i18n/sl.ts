export const dict = {
  ...
  "command.session.handoff": "Predaj sejo",
  "command.session.handoff.description": "Povzemite sejo in nadaljujte delo v novi seji",
  ...
  "toast.session.handoff.failed.title": "Predaja seje ni uspela",
  "toast.session.handoff.failed.description": "Te seje ni bilo mogoče povzeti za predajo",
