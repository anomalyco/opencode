export const dict = {
  ...
  "mcp.status.needs_client_registration": "potrebna registracija odjemalca",
  "mcp.status.pending": "povezovanje…",
  ...
  "settings.mcp.type.local": "Lokalni",
  "settings.mcp.type.remote": "Oddaljeni",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Pustite prazno za izpust — morda bo potrebna vnovična overitev",
