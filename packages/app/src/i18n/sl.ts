export const dict = {
  ...
  "command.session.background": "Zaženi podagente v ozadju",
  "command.session.background.description": "Odklopite podagente, ki blokirajo to sejo, in jih nadaljujte v ozadju",
  ...
  "toast.session.background.failed.title": "Podagentov ni bilo mogoče zagnati v ozadju",
