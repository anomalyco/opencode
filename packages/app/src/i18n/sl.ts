export const dict = {
  ...
  "desktop.menu.documentation": "Pencode Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "Pencode meni",
  ...
  "desktop.recovery.loadFailed": "Pencode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Pencode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Pencode se ne odziva",
  ...
  "desktop.wsl.error.installPencode": "Namestitev Pencode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.pencodeMissing": "pencode ni nameščen v tej distribuciji",
  "desktop.wsl.error.pencodeCannotRun": "pencode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Pencode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.pencode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.pencode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.pencodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Pencode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Obisk ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Pencode.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v pencode.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Pencode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingPencode": "Preverjanje Pencode ...",
  "wsl.onboarding.checkingPencodeIn": "Preverjanje Pencode v {{distro}} ...",
  "wsl.onboarding.updatingPencode": "Posodabljanje Pencode ...",
  "wsl.onboarding.updatingPencodeIn": "Posodabljanje Pencode v {{distro}} ...",
  "wsl.onboarding.updatePencodeIn": "Posodobite Pencode v {{distro}}.",
  "wsl.onboarding.updatePencode": "Posodobite Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode je pripravljen v {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode je pripravljen.",
  "wsl.onboarding.installPencodeIn": "Namestite Pencode v {{distro}}.",
  "wsl.onboarding.installPencode": "Namestite Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Pencode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Pencode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Pencode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Pencode",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (pencode.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Pencode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Pencode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Pencode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Pencode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Pencode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Pencode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Pencode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Pencode.",
