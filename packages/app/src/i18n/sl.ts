export const dict = {
  ...
  "session.tab.agents": "Podagenti",
  "session.agents.empty": "Noben podagent ne teče",
  "session.agents.costTotal": "Skupni strošek",
  "session.agents.costSubagents": "Podagenti",
  "session.agents.count": "Agenti",
  "session.agents.tokens": "žetonov",
  "session.agents.showAll": "Prikaži vse ({{count}})",
  "session.agents.status.idle": "Nedejaven",
  "session.agents.status.busy": "Deluje",
  "session.agents.status.retry": "Poskuša znova",
  "session.agents.status.cancelled": "Preklicano",
  "session.agents.status.completed": "Končano",
  "session.agents.status.error": "Spodletelo",
