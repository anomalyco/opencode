export const dict = {
  ...
  "desktop.menu.documentation": "Argus Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "Argus meni",
  ...
  "desktop.recovery.loadFailed": "Argus ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Argus se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Argus se ne odziva",
  ...
  "desktop.wsl.error.installArgus": "Namestitev Argus ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.argusMissing": "argus ni nameščen v tej distribuciji",
  "desktop.wsl.error.argusCannotRun": "argus je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.argusNotInstalled": "Argus ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Argus je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.argus.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.argus.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.argusGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Argus",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.argusZen.visit.prefix": "Obisk ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Argus.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v argus.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Argus se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingArgus": "Preverjanje Argus ...",
  "wsl.onboarding.checkingArgusIn": "Preverjanje Argus v {{distro}} ...",
  "wsl.onboarding.updatingArgus": "Posodabljanje Argus ...",
  "wsl.onboarding.updatingArgusIn": "Posodabljanje Argus v {{distro}} ...",
  "wsl.onboarding.updateArgusIn": "Posodobite Argus v {{distro}}.",
  "wsl.onboarding.updateArgus": "Posodobite Argus",
  "wsl.onboarding.argusReadyIn": "Argus je pripravljen v {{distro}}.",
  "wsl.onboarding.argusReady": "Argus je pripravljen.",
  "wsl.onboarding.installArgusIn": "Namestite Argus v {{distro}}.",
  "wsl.onboarding.installArgus": "Namestite Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Argus doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Argus ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Argus ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Argus",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (argus.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Argus še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Argus znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Argus",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Argus izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Argus sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Argus.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Argus",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Argus.",
