export const dict = {
  ...
  "settings.tab.plugins": "Vtičniki",
  "settings.plugins.section.browse": "Brskaj",
  "settings.plugins.section.installed": "Nameščeni",
  "settings.plugins.source.all": "Vsi viri",
  "settings.plugins.source.ecosystem": "Ekosistem",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Dodaj strežnik",
  "settings.mcp.empty": "Ni konfiguriranih MCP strežnikov.",
  "settings.mcp.deleted": "{{name}} je izbrisan.",
  "settings.mcp.errors.refresh": "MCP strežnikov ni bilo mogoče naložiti.",
  "settings.mcp.status.pending": "povezovanje…",
  "settings.mcp.action.connect": "Poveži",
  "settings.mcp.action.disconnect": "Odklopi",
  "settings.mcp.action.authenticate": "Overi",
  "settings.mcp.action.edit": "Uredi",
  "settings.mcp.action.delete": "Izbriši",
  "settings.mcp.delete.title": "Izbriši MCP strežnik",
  "settings.mcp.delete.body": "Odstranim {{name}}? Tega ni mogoče razveljaviti.",
  "settings.mcp.form.title.add": "Dodaj strežnik MCP",
  "settings.mcp.form.title.edit": "Uredi strežnik MCP",
  "settings.mcp.form.subtitle": "Konfigurirajte nastavitve povezave.",
  "settings.mcp.form.name": "Ime",
  "settings.mcp.form.command": "Ukaz",
  "settings.mcp.form.command.hint": "npr. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Delovni imenik",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Spremenljivke okolja",
  "settings.mcp.form.headers": "Glave",
  "settings.mcp.form.addRow": "Dodaj vrstico",
  "settings.mcp.form.removeRow": "Odstrani",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID odjemalca",
  "settings.mcp.form.oauth.clientSecret": "Skrivnost odjemalca",
  "settings.mcp.form.oauth.clientSecret.keep": "Konfigurirano — pustite prazno za ohranitev",
  "settings.mcp.form.oauth.scope": "Obseg",
  "settings.mcp.form.oauth.callbackPort": "Vratna vrata za povratni klic",
  "settings.mcp.form.oauth.disableAutodetect": "Onemogoči samodejno zaznavanje OAuth",
  "settings.mcp.form.enabled": "Omogočeno",
  "settings.mcp.form.timeout": "Časovna omejitev (ms)",
  "settings.mcp.form.save": "Shrani",
  "settings.mcp.form.cancel": "Prekliči",
  "settings.mcp.form.error.name": "Vnesite ime.",
  "settings.mcp.form.error.command": "Vnesite ukaz.",
  "settings.mcp.form.error.url": "Vnesite URL.",
  "settings.mcp.form.error.callbackPort": "Vrata za povratni klic morajo biti med 1 in 65535.",
  "settings.mcp.form.error.timeout": "Časovna omejitev mora biti pozitivno celo število.",
  "settings.mcp.errors.invalid": "Popravite označena polja.",
  "settings.mcp.errors.duplicate": "Strežnik s tem imenom že obstaja.",
  "settings.mcp.errors.noConfig": "Konfiguracije za {{name}} ni mogoče prebrati — morda je definirana izven projekta.",
  "settings.mcp.edit.warn": "Shranjevanje strežnik znova poveže.",
  "settings.plugins.search.placeholder": "Iskanje vtičnikov…",
  "settings.plugins.detail.install": "Namesti…",
  "settings.plugins.detail.copy": "Kopiraj del konfiguracije",
  "settings.plugins.detail.copied": "Kopirano",
  "settings.plugins.detail.notOnNpm": "Ni najdeno na npm — dodajte ročno v opencode.json",
  "settings.plugins.install.title": "Namesti vtičnik",
  "settings.plugins.install.description": "Kam naj se doda {{name}}?",
  "settings.plugins.install.global": "Globalno (~/.config/opencode)",
  "settings.plugins.install.project": "Ta projekt",
  "settings.plugins.install.cancel": "Prekliči",
  "settings.plugins.install.success": "{{name}} je nameščen. Za nalaganje znova zaženite OpenCode.",
  "settings.plugins.installed.empty": "Ni nameščenih vtičnikov.",
  ...
  "settings.plugins.errors.catalog": "Ni mogoče osvežiti kataloga vtičnikov.",
  "settings.plugins.stale": "Prikazan je predpomnjen katalog ({{age}} star).",
