export const dict = {
  ...
  "provider.custom.models.load": "Naloži dinamično",
  "provider.custom.models.loading": "Nalaganje...",
  "provider.custom.models.load.invalidUrl": "Vnesite veljavno osnova URL",
  "provider.custom.models.load.unauthorized": "Neavtorizirano. Preverite ključ API",
  "provider.custom.models.load.invalidFormat": "Odgovor strežnika ni vseboval veljavnega seznama modelov",
  "provider.custom.models.load.timeout": "Čas je potekel pri nalaganju modelov",
  "provider.custom.models.load.failed": "Nalaganje modelov ni uspelo",
  "provider.custom.models.load.empty": "Ni najdenih modelov",
