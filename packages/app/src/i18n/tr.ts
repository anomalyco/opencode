...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Jarvis yüklenemedi",
  "desktop.recovery.terminated": "Jarvis penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Jarvis yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Jarvis güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Jarvis'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Jarvis'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Jarvis'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Jarvis sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvis kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Jarvis kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Jarvis güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Jarvis güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Jarvis'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Jarvis'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Jarvis hazır.",
  "wsl.onboarding.opencodeReady": "Jarvis hazır.",
  "wsl.onboarding.installOpencodeIn": "Jarvis'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Jarvis'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Jarvis'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Jarvis bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Jarvis'u tekrar açın.",
  ...
  "help.tabs.introduction": "Jarvis Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Jarvis'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Jarvis ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Jarvis henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Jarvis Masaüstü",
  ...
  "settings.tab.connectors": "Bağlayıcılar",
  "settings.integrations.placeholder": "Entegrasyonlar Jarvis çalışma zamanını genişletir. Yakında eklentileri, temaları ve sistem uzantılarını yükleyebileceksiniz.",
  "settings.connectors.placeholder": "Bağlayıcılar Jarvis'i harici hizmetlere bağlar. Yakında: Gmail, WhatsApp, Slack, Notion, Telegram ve daha fazlası.",
  "settings.connectors.unavailable": "Bağlayıcılar yalnızca masaüstü uygulamasında kullanılabilir.",
  ...
  "settings.connectors.github.permission.repos": "Depolarınızı, sorunlarınızı ve çekme isteklerinizi okuma ve yönetme",
  "settings.connectors.github.permission.profile": "Genel profilinizi okuma (kullanıcı adı ve avatar)",
  "settings.connectors.github.connect": "GitHub'ı bağla",
  "settings.connectors.github.disconnect": "Bağlantıyı kes",
  "settings.connectors.github.cancel": "İptal",
  "settings.connectors.github.openBrowser": "Tarayıcıyı aç",
  "settings.connectors.github.waiting": "Yetkilendirme bekleniyor…",
  "settings.connectors.github.code.instructions": "Bu kodu şuraya girin:",
  "settings.connectors.github.connected.text": "OAuth ile bağlandı. Jarvis GitHub hesabınıza erişebilir.",
  "settings.connectors.github.error.expired": "Yetkilendirme kodunun süresi doldu. Lütfen tekrar deneyin.",
  "settings.connectors.github.error.generic": "GitHub'a bağlanılamadı. Bağlantınızı kontrol edip tekrar deneyin.",
  "settings.connectors.github.error.denied": "Yetkilendirme reddedildi. İstediğiniz zaman tekrar deneyebilirsiniz.",
  "desktop.menu.wiki": "Viki",
  ...
  "settings.desktop.wsl.description": "Jarvis sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Jarvis'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Jarvis'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Jarvis'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Jarvis'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Jarvis başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Jarvis'un en son sürümünü kullanıyorsunuz.",
