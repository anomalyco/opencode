...
export const dict = {
  ...
  "home.activity.title": "Token etkinliği",
  "home.activity.daily": "Günlük",
  "home.activity.weekly": "Haftalık",
  "home.activity.cumulative": "Kümülatif",
  "home.activity.loading": "Etkinlik yükleniyor",
  "home.activity.empty": "Henüz token etkinliği yok",
  "home.activity.lifetimeTokens": "Toplam token",
  "home.activity.peakTokens": "Zirve token",
  "home.activity.longestTask": "En uzun görev",
  "home.activity.currentStreak": "Mevcut seri",
  "home.activity.longestStreak": "En uzun seri",
  "home.activity.days.one": "{{count}} gün",
  "home.activity.days.other": "{{count}} gün",
  "home.activity.summary":
    "{{tokens}} toplam token, {{peak}} zirve token, {{current}} mevcut seri, {{longest}} en uzun seri.",
