...
export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode menüsü",
  "desktop.appMenu.file": "Dosya",
  "desktop.appMenu.edit": "Düzenle",
  "desktop.appMenu.view": "Görünüm",
  "desktop.appMenu.go": "Git",
  "desktop.appMenu.window": "Pencere",
  "desktop.appMenu.help": "Yardım",
  "desktop.appMenu.about": "OpenCode hakkında",
  "desktop.appMenu.checkForUpdates": "Güncellemeleri denetle...",
  "desktop.appMenu.settings": "Ayarlar",
  "desktop.appMenu.reloadWebview": "Web görünümünü yeniden yükle",
  "desktop.appMenu.restart": "Yeniden başlat",
  "desktop.appMenu.exportLogs": "Günlükleri dışa aktar...",
  "desktop.appMenu.hide": "OpenCode'u gizle",
  "desktop.appMenu.hideOthers": "Diğerlerini gizle",
  "desktop.appMenu.showAll": "Tümünü göster",
  "desktop.appMenu.quit": "OpenCode'dan çık",
  "desktop.appMenu.newSession": "Yeni oturum",
  "desktop.appMenu.openProject": "Proje aç...",
  "desktop.appMenu.newWindow": "Yeni pencere",
  "desktop.appMenu.closeWindow": "Pencereyi kapat",
  "desktop.appMenu.undo": "Geri al",
  "desktop.appMenu.redo": "Yinele",
  "desktop.appMenu.cut": "Kes",
  "desktop.appMenu.copy": "Kopyala",
  "desktop.appMenu.paste": "Yapıştır",
  "desktop.appMenu.delete": "Sil",
  "desktop.appMenu.selectAll": "Tümünü seç",
  "desktop.appMenu.toggleSidebar": "Kenar çubuğunu aç/kapat",
  "desktop.appMenu.toggleTerminal": "Terminali aç/kapat",
  "desktop.appMenu.toggleFileTree": "Dosya ağacını aç/kapat",
  "desktop.appMenu.reload": "Yeniden yükle",
  "desktop.appMenu.toggleDeveloperTools": "Geliştirici araçlarını aç/kapat",
  "desktop.appMenu.actualSize": "Gerçek boyut",
  "desktop.appMenu.zoomIn": "Yakınlaştır",
  "desktop.appMenu.zoomOut": "Uzaklaştır",
  "desktop.appMenu.toggleFullScreen": "Tam ekranı aç/kapat",
  "desktop.appMenu.back": "Geri",
  "desktop.appMenu.forward": "İleri",
  "desktop.appMenu.previousSession": "Önceki oturum",
  "desktop.appMenu.nextSession": "Sonraki oturum",
  "desktop.appMenu.previousProject": "Önceki proje",
  "desktop.appMenu.nextProject": "Sonraki proje",
  "desktop.appMenu.minimize": "Küçült",
  "desktop.appMenu.zoomWindow": "Büyüt",
  "desktop.appMenu.maximize": "Büyüt",
  "desktop.appMenu.bringAllToFront": "Tümünü Öne Getir",
  "desktop.appMenu.documentation": "OpenCode belgeleri",
  "desktop.appMenu.supportForum": "Destek forumu",
  "desktop.appMenu.shareFeedback": "Geri bildirim paylaş",
  "desktop.appMenu.reportBug": "Hata bildir",
