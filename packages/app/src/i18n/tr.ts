...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Pencode yüklenemedi",
  "desktop.recovery.terminated": "Pencode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Pencode yanıt vermiyor",
  ...
  "desktop.wsl.error.installPencode": "Pencode kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.pencodeMissing": "pencode bu dağıtımda kurulu değil",
  "desktop.wsl.error.pencodeCannotRun": "pencode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Pencode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.pencode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.pencode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.pencodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Pencode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Pencode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Pencode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler pencode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Pencode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode kontrol ediliyor...",
  "wsl.onboarding.checkingPencodeIn": "{{distro}} içinde Pencode kontrol ediliyor...",
  "wsl.onboarding.updatingPencode": "Pencode güncelleniyor...",
  "wsl.onboarding.updatingPencodeIn": "{{distro}} içinde Pencode güncelleniyor...",
  "wsl.onboarding.updatePencodeIn": "{{distro}} içindeki Pencode'u güncelleyin.",
  "wsl.onboarding.updatePencode": "Pencode'u güncelle",
  "wsl.onboarding.pencodeReadyIn": "{{distro}} içinde Pencode hazır.",
  "wsl.onboarding.pencodeReady": "Pencode hazır.",
  "wsl.onboarding.installPencodeIn": "Pencode'u {{distro}} içine kurun.",
  "wsl.onboarding.installPencode": "Pencode'u kur",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pencode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Pencode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Pencode'u tekrar açın.",
  ...
  "help.tabs.introduction": "Pencode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Pencode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (pencode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Pencode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Pencode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Pencode Masaüstü",
  ...
  "settings.desktop.wsl.description": "Pencode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Pencode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Pencode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Pencode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Pencode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Pencode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Pencode'un en son sürümünü kullanıyorsunuz.",
