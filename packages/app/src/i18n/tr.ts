...
export const dict = {
  ...
  "session.panel.reviewAndFiles": "İnceleme, hafıza, raporlar, detay ve dosyalar",
  "session.tab.memory": "Hafıza",
  "session.tab.bugReport": "Raporlar",
  "session.tab.detail": "Detay",
  "session.tab.detail.empty": "Şu anda etkin bir ajan yok.",
  "session.dashboard.todos": "Görevler",
  "session.dashboard.todos.empty": "Henüz izlenen görev yok.",
  "session.dashboard.files": "Değişen Dosyalar",
  "session.dashboard.files.empty": "Henüz değişen dosya yok.",
  "session.dashboard.agents": "Alt ajanlar",
  "session.dashboard.agents.empty": "Henüz alt ajan başlatılmadı.",
  "session.dashboard.agents.showHistory": "Geçmişi göster",
  "session.dashboard.agents.activeOnly": "Sadece aktifler",
  "session.dashboard.summary.empty": "Aktif ajanı takip etmek için detay panelini açın.",
  "session.dashboard.summary.agent": "{{agent}} şu anda bu oturumu yürütüyor.",
  "session.dashboard.metric.todos": "İzlenen görevler",
  "session.dashboard.metric.files": "Değişen dosyalar",
  "session.dashboard.metric.agents": "Aktif çalışanlar",
  "session.dashboard.ayaz.title": "Ayaz yürütme odağı",
  "session.dashboard.ayaz.body": "Canlı kodlama akışını, bekleyen işleri ve dokunulan dosyaları öne çıkar.",
  "session.dashboard.ayaz.active": "Canlı iş",
  "session.dashboard.ayaz.pending": "Sıradaki görevler",
  "session.dashboard.ayaz.files": "Dokunulan dosyalar",
  "session.dashboard.atlas.title": "Atlas orkestrasyon odağı",
  "session.dashboard.atlas.body": "Aktif çalışanları, biten rotaları ve ortak dosya etkisini izle.",
  "session.dashboard.atlas.running": "Çalışan rotalar",
  "session.dashboard.atlas.completed": "Biten rotalar",
  "session.dashboard.atlas.files": "Etkilenen dosyalar",
  "session.dashboard.lead.title": "Lead yürütme merkezi",
  "session.dashboard.lead.body": "Devredilen işleri, çıktıyı ve görev panosu baskısını izle.",
  "session.dashboard.lead.running": "Çalışan çalışanlar",
  "session.dashboard.lead.completed": "Tamamlanan çalışanlar",
  "session.dashboard.lead.todos": "İzlenen görevler",
  "session.dashboard.niggli.title": "Niggli planlama odağı",
  "session.dashboard.niggli.body": "Plan görünümünü açık işler, tamamlanan adımlar ve kanıt dosyaları etrafında tut.",
  "session.dashboard.niggli.pending": "Açık adımlar",
  "session.dashboard.niggli.done": "Kapanan adımlar",
  "session.dashboard.niggli.files": "Kanıt dosyaları",
  "bugReport.trigger": "Ajan raporları",
  "bugReport.tooltip": "Ajan hata raporlarını, önerileri ve özellik taleplerini görüntüle",
