...
export const dict = {
  ...
  "presets.title": "Ön ayarlar",
  "presets.manage": "Ön ayarları yönet",
  "presets.count": "{{count}} ön ayar",
  "presets.empty": "Ön ayar yok",
  "presets.empty.hint": "İlk ön ayarınızı oluşturmak için \"Ekle\" tıklayın",
  "presets.add": "Ekle",
  "presets.name": "Ad",
  "presets.content": "İçerik",
  "presets.content.placeholder": "İçerik ({date} {time} {file} {code} {text} değişkenlerini destekler)",
  "presets.moveUp": "Yukarı taşı",
  "presets.moveDown": "Aşağı taşı",
  "presets.edit": "Düzenle",
  "presets.delete": "Sil",
  "presets.variables.title": "\"{{name}}\" için değişkenleri girin",
  "presets.variables.next": "Sonraki",
  "presets.variables.insert": "Ekle",
