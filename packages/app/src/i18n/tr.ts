...
export const dict = {
  ...
  "dialog.provider.athena.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.athena.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.athenaGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Athena tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Athena'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.athenaZen.line1":
    "Athena Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.athenaZen.visit.prefix": "",
  "provider.connect.athenaZen.visit.link": "athena.ai/zen",
  "provider.connect.athenaZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Athena'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Athena'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler athena.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Athena sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Athena'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Athena ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (athena.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Athena henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Athena ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Athena Masaüstü",
  ...
  "settings.desktop.wsl.description": "Athena sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Athena'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Athena'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Athena'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Athena'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Athena başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Athena'un en son sürümünü kullanıyorsunuz.",
