...
export const dict = {
  ...
  "error.page.action.restartFrontend": "Ön yüzü yeniden başlat",
  "error.page.action.restartBackend": "Arka yüzü yeniden başlat",
  "error.page.action.restartApp": "Uygulamayı yeniden başlat",
