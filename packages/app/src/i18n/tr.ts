...
export const dict = {
  ...
  "session.review.context.openDefault": "Varsayılan uygulama",
  "session.review.context.copyRelative": "Göreli yolu kopyala",
  "session.review.context.copyAbsolute": "Mutlak yolu kopyala",
