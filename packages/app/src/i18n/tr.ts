...
export const dict = {
  ...
  "settings.plugins.section.browse": "Göz at",
  "settings.plugins.section.installed": "Yüklü",
  "settings.plugins.source.all": "Tüm kaynaklar",
  "settings.plugins.source.ecosystem": "Ekosistem",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Sunucu ekle",
  "settings.mcp.empty": "Yapılandırılmış MCP sunucusu yok.",
  "settings.mcp.deleted": "{{name}} silindi.",
  "settings.mcp.errors.refresh": "MCP sunucuları yüklenemedi.",
  "settings.mcp.status.pending": "bağlanıyor…",
  "settings.mcp.action.connect": "Bağlan",
  "settings.mcp.action.disconnect": "Bağlantıyı kes",
  "settings.mcp.action.authenticate": "Kimlik doğrula",
  "settings.mcp.action.edit": "Düzenle",
  "settings.mcp.action.delete": "Sil",
  "settings.mcp.delete.title": "MCP sunucusunu sil",
  "settings.mcp.delete.body": "{{name}} kaldırılsın mı? Bu geri alınamaz.",
  "settings.mcp.form.title.add": "MCP sunucusu ekle",
  "settings.mcp.form.title.edit": "MCP sunucusunu düzenle",
  "settings.mcp.form.subtitle": "Bağlantı ayarlarını yapılandır.",
  "settings.mcp.form.name": "Ad",
  "settings.mcp.form.command": "Komut",
  "settings.mcp.form.command.hint": "örn. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Çalışma dizini",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Ortam değişkenleri",
  "settings.mcp.form.headers": "Üstbilgiler",
  "settings.mcp.form.addRow": "Satır ekle",
  "settings.mcp.form.removeRow": "Kaldır",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "İstemci kimliği",
  "settings.mcp.form.oauth.clientSecret": "İstemci parolası",
  "settings.mcp.form.oauth.clientSecret.keep": "Yapılandırıldı — tutmak için boş bırakın",
  "settings.mcp.form.oauth.scope": "Kapsam",
  "settings.mcp.form.oauth.callbackPort": "Geri çağırma portu",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth otomatik algılamayı devre dışı bırak",
  "settings.mcp.form.enabled": "Etkin",
  "settings.mcp.form.timeout": "Zaman aşımı (ms)",
  "settings.mcp.form.save": "Kaydet",
  "settings.mcp.form.cancel": "İptal",
  "settings.mcp.form.error.name": "Bir ad girin.",
  "settings.mcp.form.error.command": "Bir komut girin.",
  "settings.mcp.form.error.url": "Bir URL girin.",
  "settings.mcp.form.error.callbackPort": "Geri çağırma portu 1-65535 arasında olmalıdır.",
  "settings.mcp.form.error.timeout": "Zaman aşımı pozitif bir tam sayı olmalıdır.",
  "settings.mcp.errors.invalid": "Vurgulanan alanları düzeltin.",
  "settings.mcp.errors.duplicate": "Bu adda bir sunucu zaten var.",
  "settings.mcp.errors.noConfig": "{{name}} yapılandırması okunamıyor — proje dışında tanımlı olabilir.",
  "settings.mcp.edit.warn": "Kaydetmek bu sunucuyu yeniden bağlar.",
  "settings.plugins.search.placeholder": "Eklenti ara…",
  "settings.plugins.detail.install": "Yükle…",
  "settings.plugins.detail.copy": "Yapılandırma parçasını kopyala",
  "settings.plugins.detail.copied": "Kopyalandı",
  "settings.plugins.detail.notOnNpm": "npm'de bulunamadı — opencode.json dosyasına elle ekleyin",
  "settings.plugins.install.title": "Eklenti yükle",
  "settings.plugins.install.description": "{{name}} nereye eklensin?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Bu proje",
  "settings.plugins.install.cancel": "İptal",
  "settings.plugins.install.success": "{{name}} yüklendi. Yüklemek için OpenCode'u yeniden başlatın.",
  "settings.plugins.installed.empty": "Yüklü eklenti yok.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Proje",
  ...
  "settings.plugins.errors.catalog": "Eklenti kataloğu yenilenemedi.",
  "settings.plugins.stale": "Önbelleğe alınmış katalog gösteriliyor ({{age}} eski).",
