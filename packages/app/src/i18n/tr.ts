...
export const dict = {
  ...
  "mcp.status.needs_client_registration": "istemci kaydı gerekli",
  "mcp.status.pending": "bağlanıyor…",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Atlamak için boş bırakın — yeniden kimlik doğrulama gerekebilir",
