...
export const dict = {
  ...
  "provider.connect.apiKey.description": "{{provider}} hesabınızı bağlamak ve OpenCode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenCode'da {{provider}} modellerini kullanın.",
  ...
  "wsl.onboarding.step.distro": "Dağıtımı seçin",
  ...
  "home.server.expand": "Sunucu projelerini genişletin",
  "home.sessions.search.placeholder": "Oturumları ara",
  "home.sessions.search.placeholder.scoped": "{{scope}} konumundaki oturumları arayın",
  "home.sessions.search.sessions": "Oturumlar",
  "home.sessions.search.noResults": "{{query}} için oturum bulunamadı",
  "home.sessions.empty": "Henüz burada hiçbir şey yok",
  ...
  "settings.general.row.colorScheme.description": "OpenCode'un sistem, açık veya koyu temayı takip edip etmeyeceğini seçin",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Başlık çubuğunu ve oturum sekmelerini mobil cihazda ekranın altına yerleştirin",
