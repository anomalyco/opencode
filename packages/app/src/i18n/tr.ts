...
export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "70+ sağlayıcı daha görün",
  ...
  "session.tab.agents": "Alt ajanlar",
  "session.agents.empty": "Çalışan alt ajan yok",
  "session.agents.costTotal": "Toplam maliyet",
  "session.agents.costSubagents": "Alt ajanlar",
  "session.agents.count": "Ajanlar",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Tümünü göster ({{count}})",
  "session.agents.status.idle": "Boşta",
  "session.agents.status.busy": "Çalışıyor",
  "session.agents.status.retry": "Yeniden deneniyor",
  "session.agents.status.cancelled": "İptal edildi",
  "session.agents.status.completed": "Tamamlandı",
  "session.agents.status.error": "Başarısız",
