...
export const dict = {
  ...
  "settings.agents.description": "Her AI Dev System ajanı için LLM modelini yapılandırın. Değişiklikler tüm projelerde geçerlidir.",
  "settings.agents.model": "Model",
  "settings.agents.selectModel": "Model seçin...",
  "settings.agents.temperature": "Sıcaklık",
