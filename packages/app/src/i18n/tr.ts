...
export const dict = {
  ...
  "provider.custom.models.load": "Dinamik olarak yükle",
  "provider.custom.models.loading": "Yükleniyor...",
  "provider.custom.models.load.invalidUrl": "Geçerli bir temel URL girin",
  "provider.custom.models.load.unauthorized": "Yetkisiz. API anahtarını kontrol edin",
  "provider.custom.models.load.invalidFormat": "Sunucu yanıtı geçerli bir model listesi içermiyor",
  "provider.custom.models.load.timeout": "Modeller yüklenirken zaman aşımı oluştu",
  "provider.custom.models.load.failed": "Modeller yüklenemedi",
  "provider.custom.models.load.empty": "Model bulunamadı",
