...
export const dict = {
  ...
  "command.project.index": "{{index}}. projeye geç",

  "common.clear": "Temizle",

  "session.child.promptDisabled": "Alt ajan oturumlarına komut gönderilemez.",
  "session.child.backToParent": "Ana oturuma geri dön.",
  ...
  "wsl.server.retryStart": "Yeniden başlat",
  ...
  "wsl.onboarding.pickDistro": "Bir dağıtım seçin veya aşağıdan yükleyin.",
  ...
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içinde OpenCode'u güncelle.",
  ...
  "wsl.onboarding.installOpencodeIn": "{{distro}} içine OpenCode yükle.",
  "wsl.onboarding.installOpencode": "OpenCode yükle",
  ...
  "wsl.onboarding.installWsl": "WSL yükle",
  ...
  "wsl.onboarding.allDistrosAdded": "Tüm yüklü dağıtımlar zaten eklenmiş.",
  ...
  "wsl.onboarding.path": "Konum: {{path}}",
  ...
  "session.review.noUncommittedChanges": "Commit edilmemiş değişiklik yok",
  "session.review.noBranchChanges": "Branch değişikliği yok",
  ...
  "settings.general.row.shell.description": "Terminaliniz için kullanılacak kabuğu seçin. Uyumlu kabuklar ajan araç çağrıları için de kullanılır.",
  ...
  "settings.general.row.showFileTree.description": "Masaüstü oturumlarında dosya ağacı panelini göster",
  ...
  "settings.general.row.showCustomAgents.description": "v2 masaüstü düzenleyicide ajan seçiciyi göster",
  "settings.general.row.newLayoutDesigns.title": "Yeni düzen ve tasarımlar",
  "settings.general.row.newLayoutDesigns.description": "Yeniden tasarlanmış düzen, ana sayfa, düzenleyici ve oturum arayüzünü etkinleştir",
  "settings.general.row.pinchZoom.title": "Yakınlaştırma hareketi",
  "settings.general.row.pinchZoom.description": "Trackpad sıkıştırma ve Ctrl-kaydırma hareketleriyle yakınlaştırmaya izin ver",
