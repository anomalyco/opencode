...
export const dict = {
  ...
  "provider.custom.models.context.label": "Bağlam boyutu",
  "provider.custom.models.context.placeholder": "Bağlam boyutu",
  "provider.custom.models.output.label": "Maksimum çıktı",
  "provider.custom.models.output.placeholder": "Maksimum çıktı",
  "provider.custom.models.reasoning.label": "Akıl yürütmeyi destekler",
  ...
  "provider.custom.error.positiveInteger": "Pozitif bir tam sayı girin",
