...
export const dict = {
  ...
  "dialog.newProject.title": "Yeni proje",
  "dialog.newProject.tab.github": "GitHub'dan içe aktar",
  "dialog.newProject.tab.folder": "Klasörden içe aktar",
  "dialog.newProject.url.label": "Depo URL'si",
  "dialog.newProject.destination.label": "Klon hedefi",
  "dialog.newProject.destination.placeholder": "Hedef klasör seçin",
  "dialog.newProject.destination.browse": "Gözat",
  "dialog.newProject.destination.pick": "Klon hedefini seçin",
  "dialog.newProject.clone": "Depoyu klonla",
  "dialog.newProject.cloning": "Klonlanıyor...",
  "dialog.newProject.error.cloneFailed": "Depo klonlanamadı",
  "dialog.newProject.folder.title": "Mevcut bir projeyi aç",
  "dialog.newProject.folder.description": "OpenCode'da proje olarak eklemek için bir yerel klasör seçin.",
  "dialog.newProject.folder.action": "Klasör seç",
