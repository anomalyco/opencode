...
export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Geçersiz SSH ana bilgisayarı: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} zaten eklendi",
  "desktop.ssh.error.opencodeNotInstalled": "opencode, {{host}} üzerinde kurulu değil",
  "desktop.ssh.error.installOpencode": "opencode kurulamadı",
  "desktop.ssh.error.connectFailed": "{{host}} ana bilgisayarına bağlanılamadı",
  "desktop.ssh.error.serverExited": "SSH sunucusu başlatıldıktan sonra kapandı (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}} için SSH sunucusu kullanıma hazır duruma gelmeden kapandı (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "{{host}} üzerindeki sunucunun sistem durumu denetimi {{timeout}} ms sonra zaman aşımına uğradı",
  "desktop.ssh.error.commandTimeout": "{{host}} için ssh komutu {{timeout}} ms sonra zaman aşımına uğradı",
  "desktop.ssh.error.failedPort": "Bağlantı noktası alınamadı",
  "desktop.ssh.error.terminalFailed": "Terminal açılamadı",
  ...
  "ssh.server.add": "SSH sunucusu ekle",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH sunucusu",
  "ssh.server.retryStart": "Yeniden bağlan",
  "ssh.server.disconnect": "Bağlantıyı kes",
  "ssh.server.openTerminal": "Terminali aç",
  "ssh.server.updating": "Güncelleniyor...",
  "ssh.server.status.connecting": "Bağlanıyor...",
  "ssh.server.status.disconnected": "Bağlantı kesildi",
  "ssh.add.hostLabel": "SSH ana bilgisayarı",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Sisteminizdeki ssh istemcisi üzerinden bağlanır; böylece SSH yapılandırmanızdaki ana bilgisayarlar, anahtarlar ve aracılar her zamanki gibi çalışır.",
  "ssh.add.configHosts": "SSH yapılandırmanızdan",
  "ssh.add.connect": "Bağlan",
  "ssh.add.checking": "Bağlanıyor...",
  "ssh.add.addServer": "Sunucu ekle",
  "ssh.add.adding": "Ekleniyor...",
  "ssh.add.installOpencode": "opencode'u kur",
  "ssh.add.updateOpencode": "opencode'u güncelle",
  "ssh.add.installing": "Kuruluyor...",
  "ssh.add.status.unreachable": "Bağlanılamadı",
  "ssh.add.status.opencodeMissing": "opencode bu ana bilgisayarda kurulu değil",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} kurulu, masaüstü uygulaması v{{expected}} bekliyor",
  "ssh.add.status.opencodeFound": "opencode v{{version}} bulundu",
  "ssh.add.authHint":
    "Bu ana bilgisayar için anahtar tabanlı SSH kimlik doğrulamasının çalıştığından emin olun — kontrol etmek için bir terminalde `ssh {{host}}` komutunu çalıştırın.",
