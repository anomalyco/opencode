...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Argus yüklenemedi",
  "desktop.recovery.terminated": "Argus penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Argus yanıt vermiyor",
  ...
  "desktop.wsl.error.installArgus": "Argus kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.argusMissing": "argus bu dağıtımda kurulu değil",
  "desktop.wsl.error.argusCannotRun": "argus kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.argusNotInstalled": "Argus, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Argus güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.argus.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.argus.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.argusGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Argus tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Argus'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.argusZen.visit.prefix": "",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Argus'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Argus'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler argus.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Argus sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingArgus": "Argus kontrol ediliyor...",
  "wsl.onboarding.checkingArgusIn": "{{distro}} içinde Argus kontrol ediliyor...",
  "wsl.onboarding.updatingArgus": "Argus güncelleniyor...",
  "wsl.onboarding.updatingArgusIn": "{{distro}} içinde Argus güncelleniyor...",
  "wsl.onboarding.updateArgusIn": "{{distro}} içindeki Argus'u güncelleyin.",
  "wsl.onboarding.updateArgus": "Argus'u güncelle",
  "wsl.onboarding.argusReadyIn": "{{distro}} içinde Argus hazır.",
  "wsl.onboarding.argusReady": "Argus hazır.",
  "wsl.onboarding.installArgusIn": "Argus'u {{distro}} içine kurun.",
  "wsl.onboarding.installArgus": "Argus'u kur",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Argus'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Argus bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Argus'u tekrar açın.",
  ...
  "help.tabs.introduction": "Argus Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Argus'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Argus ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (argus.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Argus henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Argus ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Argus Masaüstü",
  ...
  "settings.desktop.wsl.description": "Argus sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Argus'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Argus'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Argus'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Argus'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Argus başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Argus'un en son sürümünü kullanıyorsunuz.",
