...
export const dict = {
  ...
  "command.todo.toggle": "Todo panelini aç/kapat",
  ...
  "sidebar.issue.title": "Görevler",
  "sidebar.issue.add": "Görev ekle",
  "sidebar.issue.addSubtodo": "Alt görev ekle",
  "sidebar.issue.empty": "Henüz görev yok",
  "sidebar.issue.collapse": "Alt görevleri daralt",
  "sidebar.issue.expand": "Alt görevleri genişlet",
  "sidebar.issue.confirmDeleteWithChildren": "Bu görevi ve {{count}} alt görevini sil?",
  "sidebar.issue.toast.deleteFailed": "Görev silinemedi",
  "sidebar.issue.tooltip.cycleStatus": "Durumu değiştir",
  "sidebar.issue.tooltip.cyclePriority": "Önceliği değiştir",
  "sidebar.issue.tooltip.linkedLinear": "Linear'a bağlı",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Bağlı",
  "sidebar.linear.management": "Linear bağlamasını yönet",
  "sidebar.linear.management.teamRequired": "Lütfen bir takım seçin",
  "sidebar.linear.management.projectRequired": "Lütfen bir proje seçin",
  "sidebar.linear.management.saveFailed": "Linear bağlaması kaydedilemedi",
  "sidebar.linear.management.saved": "Linear bağlaması kaydedildi",
  "sidebar.linear.management.save": "Kaydet",
  "sidebar.linear.toggleHistory": "Senkronizasyon geçmişini aç/kapat",
  "sidebar.linear.field.team": "Takım",
  "sidebar.linear.field.team.loading": "Takımlar yükleniyor...",
  "sidebar.linear.field.team.placeholder": "Takım seçin",
  "sidebar.linear.field.project": "Proje",
  "sidebar.linear.field.project.selectTeamFirst": "Önce bir takım seçin",
  "sidebar.linear.field.project.loading": "Projeler yükleniyor...",
  "sidebar.linear.field.project.placeholder": "Proje seçin",
  "sidebar.linear.notConfigured": "Linear yapılandırılmamış",
  "sidebar.linear.notConfiguredHint": "Takım ve proje seçmek için yönetimi açın",
  "sidebar.linear.actions": "Senkronizasyon eylemleri",
  "sidebar.linear.push": "Gönder",
  "sidebar.linear.pull": "Çek",
  "sidebar.linear.pullHint": "Linear'dan çek. Not: Linear üzerinde yapılan hiyerarşi değişiklikleri (yeniden ebeveyn atama, ebeveyn kaldırma) yerel olarak senkronize edilmez — yalnızca alan değerleri uzlaştırılır.",
  "sidebar.linear.pullFailed": "Linear'dan çekme başarısız",
  "sidebar.linear.pullPartialFailed": "Çekme kısmen başarısız: {{count}} hata",
  "sidebar.linear.pullSuccess": "Çekilen {{pulled}}, güncellenen {{updated}}, atlanan {{skipped}}, silinen {{deleted}}",
  "sidebar.linear.pushFailed": "Linear'a gönderme başarısız",
  "sidebar.linear.pushPartialFailed": "Gönderme kısmen başarısız: {{count}} hata",
  "sidebar.linear.pushSuccess": "{{count}} görev Linear'a gönderildi",
  "sidebar.linear.pushNothing": "Gönderilecek bir şey yok",
  "sidebar.linear.syncHistory.syncing": "Senkronize ediliyor...",
  "sidebar.linear.syncHistory.error": "Hata",
  "sidebar.linear.syncHistory.empty": "Senkronizasyon geçmişi yok",
  "dialog.todo.title.create": "Yeni görev",
  "dialog.todo.title.edit": "Görevi düzenle",
  "dialog.todo.field.title": "Başlık",
  "dialog.todo.field.title.placeholder": "Görev başlığı",
  "dialog.todo.field.description": "Açıklama",
  "dialog.todo.field.description.placeholder": "Detay, bağlantı veya bağlam ekle...",
  "dialog.todo.field.description.hint": "Dosya ve yetenek referanslarını destekler",
  "dialog.todo.field.status": "Durum",
  "dialog.todo.field.priority": "Öncelik",
  "dialog.todo.field.dueDate": "Bitiş tarihi",
  "dialog.todo.field.dueDate.placeholder": "Bitiş tarihi ayarla",
  "dialog.todo.field.dueDate.clear": "Temizle",
  "dialog.todo.field.dueDate.prevMonth": "Önceki ay",
  "dialog.todo.field.dueDate.nextMonth": "Sonraki ay",
  "dialog.todo.field.dueDate.shortcut.today": "Bugün",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Yarın",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Bir hafta içinde",
  ...
  "dialog.todo.field.labels": "Etiketler",
  "dialog.todo.field.assignee": "Atanan",
  "dialog.todo.field.assignee.unassigned": "Atanmamış",
  "dialog.todo.field.assignee.loadFailed": "Atananlar yüklenemedi",
  "dialog.todo.field.assignee.loading": "Atananlar yükleniyor...",
  "dialog.todo.field.assignee.placeholder": "Atanan seçin",
  "dialog.todo.field.assignee.hint": "Linear takım üyelerinden alınır",
  "dialog.todo.linkedLinear": "Linear'a bağlı",
  "dialog.todo.created": "Görev oluşturuldu",
  "dialog.todo.updated": "Görev güncellendi",
  "dialog.todo.error.titleRequired": "Başlık zorunludur",
  "dialog.todo.error.saveFailed": "Görev kaydedilemedi",
  "dialog.todo.action.create": "Oluştur",
  ...
  "sidebar.issue.priority.none": "Hiçbiri",
  "sidebar.issue.priority.urgent": "Acil",
  "sidebar.issue.priority.high": "Yüksek",
  "sidebar.issue.priority.medium": "Orta",
  "sidebar.issue.priority.low": "Düşük",
  "sidebar.issue.toast.archiveFailed": "Görev arşivlenemedi",
  "sidebar.issue.toast.reorderFailed": "Görev yeniden sıralanamadı",
  "sidebar.issue.toast.reparentFailed": "Görev taşınamadı",
  "sidebar.issue.tooltip.archive": "Bu görevi arşivle",
  "sidebar.issue.tooltip.delete": "Bu görevi sil",
  "sidebar.issue.confirmArchive": "Arşivle",
  "sidebar.issue.archivedBadge": "Arşivlendi",
  "sidebar.issue.archiveArea.title": "Arşivlenenler",
  "sidebar.issue.archiveArea.expand": "Arşivlenenleri göster",
  "sidebar.issue.archiveArea.collapse": "Arşivlenenleri gizle",
  "sidebar.issue.archiveArea.empty": "Arşivlenen görev yok",
