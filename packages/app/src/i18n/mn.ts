export const dict = {
  ...
  "session.tab.agents": "Дэд агентууд",
  "session.agents.empty": "Ямар ч дэд агент ажиллахгүй байна",
  "session.agents.costTotal": "Нийт зардал",
  "session.agents.costSubagents": "Дэд агентууд",
  "session.agents.count": "Агентууд",
  "session.agents.tokens": "токен",
  "session.agents.showAll": "Бүгдийг харуулах ({{count}})",
  "session.agents.status.idle": "Сул",
  "session.agents.status.busy": "Ажиллаж байна",
  "session.agents.status.retry": "Дахин оролдох",
  "session.agents.status.cancelled": "Цуцлагдсан",
  "session.agents.status.completed": "Дууссан",
  "session.agents.status.error": "Амжилтгүй",
