export const dict = {
  ...
  "command.session.background": "Дэд агентуудыг ард ажиллуулах",
  "command.session.background.description": "Энэ сессийг хааж буй дэд агентуудыг салгаж, ард нь үргэлжлүүлнэ",
  ...
  "toast.session.background.failed.title": "Дэд агентуудыг ард ажиллуулж чадсангүй",
