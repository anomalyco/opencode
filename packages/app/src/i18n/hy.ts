export const dict = {
  ...
  "provider.custom.models.load": "Դինամիկ բեռնել",
  "provider.custom.models.loading": "Բեռնում...",
  "provider.custom.models.load.invalidUrl": "Մուտքագրեք վավեր հիմնական URL",
  "provider.custom.models.load.unauthorized": "Չարտորակված։ Ստուգեք API բանալին",
  "provider.custom.models.load.invalidFormat": "Սերվերի պատասխանը վավեր մոդելների ցանկ չէր",
  "provider.custom.models.load.timeout": "Մոդելները բեռնելիս ժամանակը սպառվեց",
  "provider.custom.models.load.failed": "Մոդելների բեռնումը ձախողվեց",
  "provider.custom.models.load.empty": "Մոդելներ չեն գտնվել",
