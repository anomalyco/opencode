export const dict = {
  ...
  "desktop.menu.documentation": "Argus Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Argus մենյու",
  ...
  "desktop.recovery.loadFailed": "Argus չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Argus պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Argus-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installArgus": "Argus տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.argusMissing": "argus-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.argusCannotRun": "argus-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.argusNotInstalled": "Argus տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.argus.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.argus.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.argusGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Argus",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Argus-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.argusZen.visit.prefix": "Այցելություն ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Argus-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Argus-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են argus.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Argus սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingArgus": "Ստուգում է Argus...",
  "wsl.onboarding.checkingArgusIn": "Ստուգում է Argus-ը {{distro}}...",
  "wsl.onboarding.updatingArgus": "Թարմացվում է Argus...",
  "wsl.onboarding.updatingArgusIn": "Թարմացվում է Argus-ը {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Թարմացնել Argus-ը {{distro}}-ում։",
  "wsl.onboarding.updateArgus": "Թարմացնել Argus",
  "wsl.onboarding.argusReadyIn": "Argus պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.argusReady": "Argus պատրաստ է։",
  "wsl.onboarding.installArgusIn": "Տեղադրեք Argus-ը {{distro}}-ում։",
  "wsl.onboarding.installArgus": "Տեղադրեք Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Argus-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Argus-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Argus։",
  ...
  "help.tabs.introduction": "Argus Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Argus-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Argus թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (argus.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Argus-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Argus ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Argus սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Argus",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Argus տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Argus-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Argus-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Argus-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Argus-ի վերջին տարբերակը։",
