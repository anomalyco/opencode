export const dict = {
  ...
  "settings.tab.plugins": "Հավելումներ",
  "settings.plugins.section.browse": "Թերթել",
  "settings.plugins.section.installed": "Տեղադրված",
  ...
  "settings.mcp.add": "Ավելացնել սերվեր",
  "settings.mcp.empty": "Կոնֆիգուրացված MCP սերվերներ չկան։",
  "settings.mcp.deleted": "{{name}}-ը ջնջված է։",
  "settings.mcp.errors.refresh": "Չհաջողվեց բեռնել MCP սերվերները։",
  "settings.mcp.status.pending": "միանում է…",
  "settings.mcp.action.connect": "Միանալ",
  "settings.mcp.action.disconnect": "Անջատել",
  "settings.mcp.action.authenticate": "Նույնականացնել",
  "settings.mcp.action.edit": "Խմբագրել",
  "settings.mcp.action.delete": "Ջնջել",
  "settings.mcp.delete.title": "Ջնջել MCP սերվերը",
  "settings.mcp.delete.body": "Հեռացնե՞լ {{name}}-ը։ Գործողությունը չեղարկելի չէ։",
  "settings.mcp.form.title.add": "Ավելացնել MCP սերվեր",
  "settings.mcp.form.title.edit": "Խմբագրել MCP սերվերը",
  "settings.mcp.form.subtitle": "Կարգավորեք միացման կարգավորումները։",
  "settings.mcp.form.name": "Անուն",
  "settings.mcp.form.command": "Հրաման",
  "settings.mcp.form.command.hint": "օրինակ՝ npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Աշխատանքային պանակ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Միջավայրի փոփոխականներ",
  "settings.mcp.form.headers": "Վերնագրեր",
  "settings.mcp.form.addRow": "Ավելացնել տող",
  "settings.mcp.form.removeRow": "Հեռացնել",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Client ID",
  "settings.mcp.form.oauth.clientSecret": "Client secret",
  "settings.mcp.form.oauth.clientSecret.keep": "Կարգավորված — պահելու համար դատարկ թողեք",
  "settings.mcp.form.oauth.scope": "Ծավալ",
  "settings.mcp.form.oauth.callbackPort": "Callback պորտ",
  "settings.mcp.form.oauth.disableAutodetect": "Անջատել OAuth ինքնաբացահայտումը",
  "settings.mcp.form.enabled": "Միացված",
  "settings.mcp.form.timeout": "Ժամանակի սահմանում (ms)",
  "settings.mcp.form.save": "Պահպանել",
  "settings.mcp.form.cancel": "Չեղարկել",
  "settings.mcp.form.error.name": "Մուտքագրեք անուն։",
  "settings.mcp.form.error.command": "Մուտքագրեք հրաման։",
  "settings.mcp.form.error.url": "Մուտքագրեք URL։",
  "settings.mcp.form.error.callbackPort": "Callback պորտը պետք է լինի 1-65535։",
  "settings.mcp.form.error.timeout": "Ժամանակի սահմանումը դրական ամբողջ թիվ պետք է լինի.",
  "settings.mcp.errors.invalid": "Ուղղեք ընդգծված դաշտերը։",
  "settings.mcp.errors.duplicate": "Այս անունով սերվեր արդեն կա։",
  "settings.mcp.errors.noConfig": "{{name}}-ի կոնֆիգուրացիան հնարավոր չէ կարդալ — կարող է սահմանված լինել նախագծից դուրս։",
  "settings.mcp.edit.warn": "Պահպանումը վերամիացնում է այս սերվերը։",
  ...
  "settings.plugins.detail.copied": "Պատճենված",
  "settings.plugins.detail.notOnNpm": "Չի գտնվել npm-ում — ձեռքով ավելացրեք opencode.json-ում",
  "settings.plugins.install.title": "Տեղադրել հավելում",
  "settings.plugins.install.description": "Որտեղ ավելացվի {{name}}-ը?",
  "settings.plugins.install.global": "Գլոբալ (~/.config/opencode)",
  "settings.plugins.install.project": "Այս նախագիծ",
  "settings.plugins.install.cancel": "Չեղարկել",
  "settings.plugins.install.success": "{{name}}-ը տեղադրված է։ Բեռնելու համար վերագործարկեք OpenCode-ը։",
  "settings.plugins.installed.empty": "Տեղադրված հավելումներ չկան։",
  "settings.plugins.installed.provenance.global": "Գլոբալ",
  "settings.plugins.installed.provenance.project": "Նախագիծ",
  ...
  "settings.plugins.errors.catalog": "Չհաջողվեց թարմացնել հավելումների կատալոգը։",
  "settings.plugins.stale": "Ցուցադրվում է քեշավորված կատալոգը ({{age}} հնի)։",
