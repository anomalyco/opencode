export const dict = {
  ...
  "command.tab.closeAll": "Փակել բոլոր ներդիրները",
  "command.tab.closeRight": "Փակել աջ կողմի բոլոր ներդիրները",
  "command.tab.closeOthers": "Փակել բոլոր ներդիրները, բացի այս մեկից",
