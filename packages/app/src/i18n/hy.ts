export const dict = {
  ...
  "command.session.handoff": "Փոխանցել նիստը",
  "command.session.handoff.description": "Ամփոփել նիստը և շարունակել աշխատանքը նոր նիստում",
  ...
  "toast.session.handoff.failed.title": "Չհաջողվեց փոխանցել նիստը",
  "toast.session.handoff.failed.description": "Այս նիստը չհաջողվեց ամփոփել՝ փոխանցելու համար",
