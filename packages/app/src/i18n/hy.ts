export const dict = {
  ...
  "desktop.menu.documentation": "Pencode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Pencode մենյու",
  ...
  "desktop.recovery.loadFailed": "Pencode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Pencode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Pencode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installPencode": "Pencode տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.pencodeMissing": "pencode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.pencodeCannotRun": "pencode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.pencode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.pencode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.pencodeGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Pencode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Pencode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Pencode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Pencode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են pencode.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Pencode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingPencode": "Ստուգում է Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Ստուգում է Pencode-ը {{distro}}...",
  "wsl.onboarding.updatingPencode": "Թարմացվում է Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Թարմացվում է Pencode-ը {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Թարմացնել Pencode-ը {{distro}}-ում։",
  "wsl.onboarding.updatePencode": "Թարմացնել Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.pencodeReady": "Pencode պատրաստ է։",
  "wsl.onboarding.installPencodeIn": "Տեղադրեք Pencode-ը {{distro}}-ում։",
  "wsl.onboarding.installPencode": "Տեղադրեք Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Pencode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Pencode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Pencode։",
  ...
  "help.tabs.introduction": "Pencode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Pencode թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (pencode.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Pencode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Pencode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Pencode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Pencode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Pencode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Pencode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Pencode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Pencode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Pencode-ի վերջին տարբերակը։",
