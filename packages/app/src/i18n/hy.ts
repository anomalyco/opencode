export const dict = {
  ...
  "session.tab.agents": "Ենթագործակալներ",
  "session.agents.empty": "Ենթագործակալ չի աշխատում",
  "session.agents.costTotal": "Ընդհանուր արժեք",
  "session.agents.costSubagents": "Ենթագործակալներ",
  "session.agents.count": "Գործակալներ",
  "session.agents.tokens": "տոքեն",
  "session.agents.showAll": "Ցույց տալ բոլորը ({{count}})",
  "session.agents.status.idle": "Անգործ",
  "session.agents.status.busy": "Աշխատում է",
  "session.agents.status.retry": "Կրկին փորձում է",
  "session.agents.status.cancelled": "Չեղարկված",
  "session.agents.status.completed": "Ավարտված",
  "session.agents.status.error": "Ձախողված",
