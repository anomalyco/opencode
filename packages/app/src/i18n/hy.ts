export const dict = {
  ...
  "mcp.status.needs_client_registration": "անհրաժեշտ է հաճախորդի գրանցում",
  "mcp.status.pending": "միանում է…",
  ...
  "settings.mcp.type.local": "Լոկալ",
  "settings.mcp.type.remote": "Հեռավար",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Բաց թողեք՝ շրջանցելու համար — կարող է անհրաժեշտ լինել վերանույնականացում",
