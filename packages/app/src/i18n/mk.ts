export const dict = {
  ...
  "session.tab.agents": "Подагенти",
  "session.agents.empty": "Нема активни подабгенти",
  "session.agents.costTotal": "Вкупен трошок",
  "session.agents.costSubagents": "Подагенти",
  "session.agents.count": "Агенти",
  "session.agents.tokens": "токени",
  "session.agents.showAll": "Прикажи сè ({{count}})",
  "session.agents.status.idle": "Неактивен",
  "session.agents.status.busy": "Во тек",
  "session.agents.status.retry": "Повторен обид",
  "session.agents.status.cancelled": "Откажано",
  "session.agents.status.completed": "Завршено",
  "session.agents.status.error": "Неуспешно",
