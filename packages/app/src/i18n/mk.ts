export const dict = {
  ...
  "provider.custom.models.load": "Вчитај динамички",
  "provider.custom.models.loading": "Вчитува...",
  "provider.custom.models.load.invalidUrl": "Внесете валидна база URL",
  "provider.custom.models.load.unauthorized": "Неовластено. Проверете го API-ключот",
  "provider.custom.models.load.invalidFormat": "Одговорот на серверот не содржеше валидна листа на модели",
  "provider.custom.models.load.timeout": "Истече времето при вчитување на модели",
  "provider.custom.models.load.failed": "Вчитувањето на моделите не успеа",
  "provider.custom.models.load.empty": "Не се пронајдени модели",
