export const dict = {
  ...
  "desktop.menu.documentation": "Argus Документација",
  ...
  "desktop.menu.ariaLabel": "Argus мени",
  ...
  "desktop.recovery.loadFailed": "Argus не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот Argus неочекувано заврши",
  "desktop.recovery.unresponsive": "Argus не реагира",
  ...
  "desktop.wsl.error.installArgus": "инсталацијата Argus не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.argusMissing": "argus не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.argusCannotRun": "argus е инсталиран, но не може да се изврши",
  "desktop.wsl.error.argusNotInstalled": "Argus не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.argus.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.argus.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.argusGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од Argus",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  "provider.connect.argusZen.line2":
    "Со еден клуч API ќе добиете пристап до модели како што се Claude, GPT, Gemini, GLM и повеќе.",
  "provider.connect.argusZen.visit.prefix": "Посетете",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во Argus.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во argus.json",
  ...
  "dialog.server.description": "Променете на кој Argus сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingArgus": "Се проверува Argus...",
  "wsl.onboarding.checkingArgusIn": "Се проверува Argus во {{distro}}...",
  "wsl.onboarding.updatingArgus": "Се ажурира Argus...",
  "wsl.onboarding.updatingArgusIn": "Се ажурира Argus во {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Ажурирајте Argus во {{distro}}.",
  "wsl.onboarding.updateArgus": "Ажурирај Argus",
  "wsl.onboarding.argusReadyIn": "Argus е подготвен во {{distro}}.",
  "wsl.onboarding.argusReady": "Argus е подготвен.",
  "wsl.onboarding.installArgusIn": "Инсталирајте Argus во {{distro}}.",
  "wsl.onboarding.installArgus": "Инсталирај Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред Argus да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "Argus не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на Argus ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот Argus",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (argus.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, Argus сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "Argus вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот Argus во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за Argus",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа Argus на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали Argus ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како Argus е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува Argus",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на Argus.",
