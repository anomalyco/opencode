export const dict = {
  ...
  "dialog.provider.argus.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.argus.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.argusGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Argus",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.argusZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.argusZen.visit.prefix": "Besøg ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Argus.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i argus.json",
  ...
  "dialog.server.description": "Skift hvilken Argus-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingArgus": "Tjekker Argus...",
  "wsl.onboarding.checkingArgusIn": "Tjekker Argus i {{distro}}...",
  "wsl.onboarding.updatingArgus": "Opdaterer Argus...",
  "wsl.onboarding.updatingArgusIn": "Opdaterer Argus i {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Opdater Argus i {{distro}}.",
  "wsl.onboarding.updateArgus": "Opdater Argus",
  "wsl.onboarding.argusReadyIn": "Argus er klar i {{distro}}.",
  "wsl.onboarding.argusReady": "Argus er klar.",
  "wsl.onboarding.installArgusIn": "Installer Argus i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Argus kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Argus kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Argus igen.",
  ...
  "toast.update.description": "En ny version af Argus ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Argus-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (argus.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Argus understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Argus inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Argus-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Argus",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Argus ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Argus skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Arguss tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Argus starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Argus.",
  ...
  "desktop.menu.documentation": "Argus-dokumentation",
  ...
  "desktop.recovery.loadFailed": "Argus kunne ikke indlæses",
  "desktop.recovery.terminated": "Argus-vinduet blev uventet afsluttet",
  "desktop.recovery.unresponsive": "Argus svarer ikke",
  ...
  "desktop.wsl.error.installArgus": "Installationen af Argus mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.argusMissing": "argus er ikke installeret i denne distribution",
  "desktop.wsl.error.argusCannotRun": "argus er installeret, men kunne ikke køre",
  "desktop.wsl.error.argusNotInstalled": "Argus er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Argus er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Argus Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
