export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Jarvis.",
  ...
  "dialog.server.description": "Skift hvilken Jarvis-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Jarvis i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Jarvis i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Jarvis i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Jarvis i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Jarvis kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Jarvis kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Jarvis igen.",
  ...
  "toast.update.description": "En ny version af Jarvis ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Jarvis-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Jarvis understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.tab.connectors": "Forbindelser",
  "settings.integrations.placeholder": "Integrationer udvider Jarvis-runtime. Snart kan du installere plugins, temaer og systemudvidelser.",
  "settings.connectors.placeholder": "Forbindelser knytter Jarvis til eksterne tjenester. Kommer snart: Gmail, WhatsApp, Slack, Notion, Telegram og mere.",
  "settings.connectors.unavailable": "Forbindelser er kun tilgængelige i desktop-appen.",
  "settings.connectors.badge.connected": "Forbundet",
  "settings.connectors.badge.notConnected": "Ikke forbundet",
  "settings.connectors.badge.disabled": "Deaktiveret",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "Forbind din GitHub-konto, så Jarvis kan læse og administrere dine repositories.",
  "settings.connectors.github.detail": "Forbind din GitHub-konto, så Jarvis kan arbejde med dine repositories, issues og pull requests direkte fra chatten. Du giver adgang med din egen GitHub-konto via OAuth — Jarvis ser aldrig din adgangskode.",
  "settings.connectors.github.permission.repos": "Læse og administrere dine repositories, issues og pull requests",
  "settings.connectors.github.permission.profile": "Læse din offentlige profil (brugernavn og avatar)",
  "settings.connectors.github.connect": "Forbind GitHub",
  "settings.connectors.github.disconnect": "Afbryd",
  "settings.connectors.github.cancel": "Annuller",
  "settings.connectors.github.openBrowser": "Åbn browser",
  "settings.connectors.github.waiting": "Venter på godkendelse…",
  "settings.connectors.github.code.instructions": "Indtast denne kode på",
  "settings.connectors.github.connected.text": "Forbundet via OAuth. Jarvis kan få adgang til din GitHub-konto.",
  "settings.connectors.github.error.expired": "Godkendelseskoden er udløbet. Prøv igen.",
  "settings.connectors.github.error.generic": "Kunne ikke oprette forbindelse til GitHub. Tjek din forbindelse, og prøv igen.",
  "settings.connectors.github.error.denied": "Godkendelse afvist. Du kan prøve igen, når du vil.",
  "desktop.menu.wiki": "Wiki",
  "command.session.export": "Eksporter session",
  "command.session.export.description": "Eksporter hele sessionstranskriptet som JSON",
  ...
  "settings.desktop.wsl.description": "Kør Jarvis-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Jarvis",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Jarvis ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Jarvis skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Jarviss tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Jarvis starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Jarvis.",
  ...
  "desktop.menu.documentation": "Jarvis-dokumentation",
  ...
  "desktop.recovery.loadFailed": "Jarvis kunne ikke indlæses",
  "desktop.recovery.terminated": "Jarvis-vinduet blev uventet afsluttet",
  "desktop.recovery.unresponsive": "Jarvis svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Jarvis mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Jarvis er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Jarvis Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
