export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode-menu",
  "desktop.appMenu.file": "Fil",
  "desktop.appMenu.edit": "Rediger",
  "desktop.appMenu.view": "Vis",
  "desktop.appMenu.go": "Gå",
  "desktop.appMenu.window": "Vindue",
  "desktop.appMenu.help": "Hjælp",
  "desktop.appMenu.about": "Om OpenCode",
  "desktop.appMenu.checkForUpdates": "Søg efter opdateringer...",
  "desktop.appMenu.settings": "Indstillinger",
  "desktop.appMenu.reloadWebview": "Genindlæs webvisning",
  "desktop.appMenu.restart": "Genstart",
  "desktop.appMenu.exportLogs": "Eksportér logfiler...",
  "desktop.appMenu.hide": "Skjul OpenCode",
  "desktop.appMenu.hideOthers": "Skjul andre",
  "desktop.appMenu.showAll": "Vis alle",
  "desktop.appMenu.quit": "Afslut OpenCode",
  "desktop.appMenu.newSession": "Ny session",
  "desktop.appMenu.openProject": "Åbn projekt...",
  "desktop.appMenu.newWindow": "Nyt vindue",
  "desktop.appMenu.closeWindow": "Luk vindue",
  "desktop.appMenu.undo": "Fortryd",
  "desktop.appMenu.redo": "Gentag",
  "desktop.appMenu.cut": "Klip",
  "desktop.appMenu.copy": "Kopiér",
  "desktop.appMenu.paste": "Sæt ind",
  "desktop.appMenu.delete": "Slet",
  "desktop.appMenu.selectAll": "Vælg alle",
  "desktop.appMenu.toggleSidebar": "Vis/skjul sidebjælke",
  "desktop.appMenu.toggleTerminal": "Vis/skjul terminal",
  "desktop.appMenu.toggleFileTree": "Vis/skjul filtræ",
  "desktop.appMenu.reload": "Genindlæs",
  "desktop.appMenu.toggleDeveloperTools": "Vis/skjul udviklerværktøjer",
  "desktop.appMenu.actualSize": "Faktisk størrelse",
  "desktop.appMenu.zoomIn": "Zoom ind",
  "desktop.appMenu.zoomOut": "Zoom ud",
  "desktop.appMenu.toggleFullScreen": "Slå fuld skærm til/fra",
  "desktop.appMenu.back": "Tilbage",
  "desktop.appMenu.forward": "Frem",
  "desktop.appMenu.previousSession": "Forrige session",
  "desktop.appMenu.nextSession": "Næste session",
  "desktop.appMenu.previousProject": "Forrige projekt",
  "desktop.appMenu.nextProject": "Næste projekt",
  "desktop.appMenu.minimize": "Minimer",
  "desktop.appMenu.zoomWindow": "Zoom",
  "desktop.appMenu.maximize": "Maksimer",
  "desktop.appMenu.bringAllToFront": "Anbring alle forrest",
  "desktop.appMenu.documentation": "OpenCode-dokumentation",
  "desktop.appMenu.supportForum": "Supportforum",
  "desktop.appMenu.shareFeedback": "Giv feedback",
  "desktop.appMenu.reportBug": "Rapportér en fejl",
