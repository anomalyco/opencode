export const dict = {
  ...
  "settings.general.row.sendKey.title": "Sendetast",
  "settings.general.row.sendKey.description": "Vælg hvilken tast der sender beskeder. Den anden Enter-tast indsætter en ny linje.",
