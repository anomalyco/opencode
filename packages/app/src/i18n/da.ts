export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (cyberstrike.json) udbyder/modelnavne",
  ...
  "settings.desktop.wsl.description": "Kør CyberStrike-serveren inde i WSL på Windows.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CyberStrike starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CyberStrike.",
