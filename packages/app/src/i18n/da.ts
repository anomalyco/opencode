export const dict = {
  ...
  "settings.plugins.section.browse": "Gennemse",
  ...
  "settings.mcp.add": "Tilføj server",
  "settings.mcp.empty": "Ingen MCP-servere konfigureret.",
  "settings.mcp.deleted": "{{name}} slettet.",
  "settings.mcp.errors.refresh": "Kunne ikke indlæse MCP-servere.",
  "settings.mcp.status.pending": "forbinder…",
  "settings.mcp.action.connect": "Forbind",
  "settings.mcp.action.disconnect": "Afbryd",
  "settings.mcp.action.authenticate": "Godkend",
  "settings.mcp.action.edit": "Redigér",
  "settings.mcp.action.delete": "Slet",
  "settings.mcp.delete.title": "Slet MCP-server",
  "settings.mcp.delete.body": "Fjerne {{name}}? Dette kan ikke fortrydes.",
  "settings.mcp.form.title.add": "Tilføj MCP-server",
  "settings.mcp.form.title.edit": "Redigér MCP-server",
  "settings.mcp.form.subtitle": "Konfigurér forbindelsesindstillingerne.",
  "settings.mcp.form.name": "Navn",
  "settings.mcp.form.command": "Kommando",
  "settings.mcp.form.command.hint": "f.eks. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Arbejdsmappe",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Miljøvariabler",
  "settings.mcp.form.headers": "Headers",
  "settings.mcp.form.addRow": "Tilføj række",
  "settings.mcp.form.removeRow": "Fjern",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Klient-ID",
  "settings.mcp.form.oauth.clientSecret": "Klienthemmelighed",
  "settings.mcp.form.oauth.clientSecret.keep": "Konfigureret — lad stå tom for at beholde",
  "settings.mcp.form.oauth.scope": "Scope",
  "settings.mcp.form.oauth.callbackPort": "Callback-port",
  "settings.mcp.form.oauth.disableAutodetect": "Deaktivér automatisk OAuth-registrering",
  "settings.mcp.form.enabled": "Aktiveret",
  "settings.mcp.form.timeout": "Timeout (ms)",
  "settings.mcp.form.save": "Gem",
  "settings.mcp.form.cancel": "Annullér",
  "settings.mcp.form.error.name": "Indtast et navn.",
  "settings.mcp.form.error.command": "Indtast en kommando.",
  "settings.mcp.form.error.url": "Indtast en URL.",
  "settings.mcp.form.error.callbackPort": "Callback-porten skal være mellem 1 og 65535.",
  "settings.mcp.form.error.timeout": "Timeout skal være et positivt heltal.",
  "settings.mcp.errors.invalid": "Ret de markerede felter.",
  "settings.mcp.errors.duplicate": "Der findes allerede en server med dette navn.",
  "settings.mcp.errors.noConfig": "Kan ikke læse konfigurationen for {{name}} — defineret muligvis uden for projektet.",
  "settings.mcp.edit.warn": "Gem genopretter forbindelsen til denne server.",
  "settings.plugins.search.placeholder": "Søg efter plugins…",
  "settings.plugins.detail.install": "Installer…",
  "settings.plugins.detail.copy": "Kopiér konfigurationsuddrag",
  "settings.plugins.detail.copied": "Kopieret",
  "settings.plugins.detail.notOnNpm": "Ikke fundet på npm — tilføj manuelt til opencode.json",
  "settings.plugins.install.title": "Installér plugin",
  "settings.plugins.install.description": "Hvor skal {{name}} tilføjes?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Dette projekt",
  "settings.plugins.install.cancel": "Annullér",
  "settings.plugins.install.success": "{{name}} installeret. Genstart OpenCode for at indlæse det.",
  "settings.plugins.installed.empty": "Ingen plugins installeret.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Projekt",
  "settings.plugins.installed.disable": "Deaktivér",
  "settings.plugins.installed.enable": "Aktivér",
  "settings.plugins.installed.uninstall": "Afinstallér",
  "settings.plugins.installed.uninstallBody": "Afinstallér {{name}} fra {{scope}}? Det fjernes fra konfigurationsfilen.",
  "settings.plugins.installed.recentlyRemoved": "For nylig fjernet",
  "settings.plugins.installed.openConfig": "Åbn konfiguration",
  "settings.plugins.errors.parseFailed": "Kan ikke læse {{path}} — ret eller fjern filen for at administrere plugins dér.",
  "settings.plugins.errors.catalog": "Kunne ikke opdatere plugin-kataloget.",
  "settings.plugins.stale": "Viser cachet katalog ({{age}} gammelt).",
