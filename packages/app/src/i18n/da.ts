export const dict = {
  ...
  "home.activity.title": "Token-aktivitet",
  "home.activity.daily": "Dagligt",
  "home.activity.weekly": "Ugentligt",
  "home.activity.cumulative": "Akkumuleret",
  "home.activity.loading": "Indlæser aktivitet",
  "home.activity.empty": "Ingen token-aktivitet endnu",
  "home.activity.lifetimeTokens": "Tokens i alt",
  "home.activity.peakTokens": "Token-top",
  "home.activity.longestTask": "Længste opgave",
  "home.activity.currentStreak": "Nuværende stime",
  "home.activity.longestStreak": "Længste stime",
  "home.activity.days.one": "{{count}} dag",
  "home.activity.days.other": "{{count}} dage",
  "home.activity.summary":
    "{{tokens}} tokens i alt, {{peak}} token-top, {{current}} nuværende stime, {{longest}} længste stime.",
