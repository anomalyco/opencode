export const dict = {
  ...
  "session.review.context.openDefault": "Standardapp",
  "session.review.context.copyRelative": "Kopiér relativ sti",
  "session.review.context.copyAbsolute": "Kopiér absolut sti",
