export const dict = {
  ...
  "dialog.plugins.empty": "Plugins konfigureret i leak-code.json",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (leak-code.json)",
