export const dict = {
  ...
  "session.tab.agents": "Underagenter",
  "session.agents.empty": "Ingen underkører i gang",
  "session.agents.costTotal": "Samlet omkostning",
  "session.agents.costSubagents": "Underkører",
  "session.agents.count": "Agenter",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Vis alle ({{count}})",
  "session.agents.status.idle": "Inaktiv",
  "session.agents.status.busy": "Kører",
  "session.agents.status.retry": "Forsøger igen",
  "session.agents.status.cancelled": "Annulleret",
  "session.agents.status.completed": "Fuldført",
  "session.agents.status.error": "Mislykkedes",
