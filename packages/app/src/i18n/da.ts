export const dict = {
  ...
  "presets.title": "Forudindstillinger",
  "presets.manage": "Administrer forudindstillinger",
  "presets.count": "{{count}} forudindstillinger",
  "presets.empty": "Ingen forudindstillinger",
  "presets.empty.hint": "Klik på \"Tilføj\" for at oprette din første forudindstilling",
  "presets.add": "Tilføj",
  "presets.name": "Navn",
  "presets.content": "Indhold",
  "presets.content.placeholder": "Indhold (understøtter {date} {time} {file} {code} {text} variabler)",
  "presets.moveUp": "Flyt op",
  "presets.moveDown": "Flyt ned",
  "presets.edit": "Rediger",
  "presets.delete": "Slet",
  "presets.variables.title": "Indtast variabler for \"{{name}}\"",
  "presets.variables.next": "Næste",
  "presets.variables.insert": "Indsæt",
}
