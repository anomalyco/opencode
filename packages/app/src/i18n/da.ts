export const dict = {
  ...
  "command.context.addToChat": "Tilføj markering til chat",
  "command.context.addToChat.description": "Indsæt markerede linjer ved markørpositionen",
  "command.context.quickEdit": "Hurtig redigering af markering",
  "command.context.quickEdit.description": "Rediger markeret kode i en ny session",
  "selection.action.addToChat": "Tilføj til chat",
  "selection.action.quickEdit": "Hurtig redigering",
  "selection.quickEdit.placeholder": "Rediger markeret kode",
  "selection.quickEdit.submit": "Start",
