export const dict = {
  ...
  "provider.custom.models.load": "Indlæs dynamisk",
  "provider.custom.models.loading": "Indlæser...",
  "provider.custom.models.load.invalidUrl": "Indtast en gyldig basis-URL",
  "provider.custom.models.load.unauthorized": "Ikke godkendt. Tjek API-nøglen",
  "provider.custom.models.load.invalidFormat": "Serverens svar indeholdt ikke en gyldig modelliste",
  "provider.custom.models.load.timeout": "Tidsgrænsen overskredet ved indlæsning af modeller",
  "provider.custom.models.load.failed": "Kunne ikke indlæse modeller",
  "provider.custom.models.load.empty": "Ingen modeller fundet",
