export const dict = {
  ...
  "dialog.provider.pencode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.pencode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.pencodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Pencode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.pencodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.pencodeZen.visit.prefix": "Besøg ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Pencode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i pencode.json",
  ...
  "dialog.server.description": "Skift hvilken Pencode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingPencode": "Tjekker Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Tjekker Pencode i {{distro}}...",
  "wsl.onboarding.updatingPencode": "Opdaterer Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Opdaterer Pencode i {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Opdater Pencode i {{distro}}.",
  "wsl.onboarding.updatePencode": "Opdater Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode er klar i {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode er klar.",
  "wsl.onboarding.installPencodeIn": "Installer Pencode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Pencode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Pencode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Pencode igen.",
  ...
  "toast.update.description": "En ny version af Pencode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Pencode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (pencode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Pencode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Pencode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Pencode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Pencode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Pencode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Pencode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Pencodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Pencode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Pencode.",
  ...
  "desktop.menu.documentation": "Pencode-dokumentation",
  ...
  "desktop.recovery.loadFailed": "Pencode kunne ikke indlæses",
  "desktop.recovery.terminated": "Pencode-vinduet blev uventet afsluttet",
  "desktop.recovery.unresponsive": "Pencode svarer ikke",
  ...
  "desktop.wsl.error.installPencode": "Installationen af Pencode mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.pencodeMissing": "pencode er ikke installeret i denne distribution",
  "desktop.wsl.error.pencodeCannotRun": "pencode er installeret, men kunne ikke køre",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Pencode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Pencode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
