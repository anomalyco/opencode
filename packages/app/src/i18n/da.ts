export const dict = {
  ...
  "mcp.status.needs_client_registration": "klientregistrering kræves",
  "mcp.status.pending": "forbinder…",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Lad stå tom for at udelade — ny godkendelse kan være påkrævet",
