export const dict = {
  ...
  "toast.file.uploadFailed.title": "Kunne ikke uploade fil",
  "toast.file.downloadFailed.title": "Kunne ikke downloade fil",
  ...
  "session.files.uploadFile": "Upload fil",
  "session.files.uploading": "Uploader…",
  "session.files.downloadFile": "Download",
  "session.files.refresh": "Opdater",
  "session.files.dropFiles": "Slip filer her eller klik + for at uploade",
  "session.files.deleteConfirm": "Slet \"{{path}}\"?",
