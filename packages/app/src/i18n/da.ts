export const dict = {
  ...
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} elementer",
  ...
  "dialog.todo.field.dueDate.month.9": "Okt",
  ...
  "dialog.todo.autocomplete.noFiles": "Ingen filer fundet",
  "dialog.todo.autocomplete.noSkills": "Ingen færdigheder fundet",
