export const dict = {
  ...
  "ssh.server.add": "Tilføj SSH-server",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH-server",
  "ssh.server.retryStart": "Genopret forbindelse",
  "ssh.server.disconnect": "Afbryd forbindelsen",
  "ssh.server.openTerminal": "Åbn terminal",
  "ssh.server.updating": "Opdaterer...",
  "ssh.server.status.connecting": "Opretter forbindelse...",
  "ssh.server.status.disconnected": "Afbrudt",
  "ssh.add.hostLabel": "SSH-vært",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Forbinder via systemets ssh-klient, så værter, nøgler og agenter fra din SSH-konfiguration fungerer som normalt.",
  "ssh.add.configHosts": "Fra din SSH-konfiguration",
  "ssh.add.connect": "Opret forbindelse",
  "ssh.add.checking": "Opretter forbindelse...",
  "ssh.add.addServer": "Tilføj server",
  "ssh.add.adding": "Tilføjer...",
  "ssh.add.installOpencode": "Installer opencode",
  "ssh.add.updateOpencode": "Opdater opencode",
  "ssh.add.installing": "Installerer...",
  "ssh.add.status.unreachable": "Kunne ikke oprette forbindelse",
  "ssh.add.status.opencodeMissing": "opencode er ikke installeret på denne vært",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} er installeret, desktopappen forventer v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} blev fundet",
  "ssh.add.authHint":
    "Sørg for, at nøglebaseret SSH-godkendelse virker for denne vært: kør `ssh {{host}}` i en terminal for at tjekke.",
  ...
  "desktop.ssh.error.invalidHost": "Ugyldig SSH-vært: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} er allerede tilføjet",
  "desktop.ssh.error.opencodeNotInstalled": "opencode er ikke installeret på {{host}}",
  "desktop.ssh.error.installOpencode": "Installationen af opencode mislykkedes",
  "desktop.ssh.error.connectFailed": "Kunne ikke oprette forbindelse til {{host}}",
  "desktop.ssh.error.serverExited": "SSH-serveren blev afsluttet efter opstart (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "SSH-serveren for {{host}} blev afsluttet, før den var klar (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "Tilstandskontrollen af serveren på {{host}} fik timeout efter {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "ssh-kommandoen til {{host}} fik timeout efter {{timeout}} ms",
  "desktop.ssh.error.failedPort": "Kunne ikke hente porten",
  "desktop.ssh.error.terminalFailed": "Kunne ikke åbne en terminal",
