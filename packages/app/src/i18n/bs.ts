export const dict = {
  ...
  "command.context.addToChat": "Dodaj odabir u chat",
  "command.context.addToChat.description": "Umetni odabrane linije na poziciju kursora",
  "command.context.quickEdit": "Brzo uređivanje odabira",
  "command.context.quickEdit.description": "Uredi odabrani kod u novoj sesiji",
  "selection.action.addToChat": "Dodaj u chat",
  "selection.action.quickEdit": "Brzo uređivanje",
  "selection.quickEdit.placeholder": "Uredi odabrani kod",
  "selection.quickEdit.submit": "Pokreni",
