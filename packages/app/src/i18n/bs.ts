export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Argus",
  ...
  "desktop.recovery.loadFailed": "Argus se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Argus-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Argus ne reaguje",
  ...
  "desktop.wsl.error.installArgus": "Instalacija Argus-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.argusMissing": "argus nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.argusCannotRun": "argus je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.argusNotInstalled": "Argus nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Argus-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "wsl.onboarding.checkingArgusIn": "Provjera Argus u distribuciji {{distro}}...",
  "wsl.onboarding.updatingArgus": "Ažuriranje Argus...",
  "wsl.onboarding.updatingArgusIn": "Ažuriranje Argus u distribuciji {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Ažuriraj Argus u distribuciji {{distro}}.",
  "wsl.onboarding.updateArgus": "Ažuriraj Argus",
  "wsl.onboarding.argusReadyIn": "Argus je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.argusReady": "Argus je spreman.",
  "wsl.onboarding.installArgusIn": "Instaliraj Argus u distribuciji {{distro}}.",
  "wsl.onboarding.installArgus": "Instaliraj Argus",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Argus mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Argus nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (argus.json)",
  ...
  "settings.general.row.colorScheme.description": "Odaberi da li Argus prati sistemsku, svijetlu ili tamnu temu",
