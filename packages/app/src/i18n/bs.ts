export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode meni",
  "desktop.appMenu.file": "Datoteka",
  "desktop.appMenu.edit": "Uredi",
  "desktop.appMenu.view": "Prikaz",
  "desktop.appMenu.go": "Idi",
  "desktop.appMenu.window": "Prozor",
  "desktop.appMenu.help": "Pomoć",
  "desktop.appMenu.about": "O aplikaciji OpenCode",
  "desktop.appMenu.checkForUpdates": "Provjeri ažuriranja...",
  "desktop.appMenu.settings": "Postavke",
  "desktop.appMenu.reloadWebview": "Ponovo učitaj web-prikaz",
  "desktop.appMenu.restart": "Ponovo pokreni",
  "desktop.appMenu.exportLogs": "Izvezi logove...",
  "desktop.appMenu.hide": "Sakrij OpenCode",
  "desktop.appMenu.hideOthers": "Sakrij ostale",
  "desktop.appMenu.showAll": "Prikaži sve",
  "desktop.appMenu.quit": "Zatvori OpenCode",
  "desktop.appMenu.newSession": "Nova sesija",
  "desktop.appMenu.openProject": "Otvori projekat...",
  "desktop.appMenu.newWindow": "Novi prozor",
  "desktop.appMenu.closeWindow": "Zatvori prozor",
  "desktop.appMenu.undo": "Poništi",
  "desktop.appMenu.redo": "Vrati",
  "desktop.appMenu.cut": "Izreži",
  "desktop.appMenu.copy": "Kopiraj",
  "desktop.appMenu.paste": "Zalijepi",
  "desktop.appMenu.delete": "Izbriši",
  "desktop.appMenu.selectAll": "Odaberi sve",
  "desktop.appMenu.toggleSidebar": "Prikaži/sakrij bočnu traku",
  "desktop.appMenu.toggleTerminal": "Prikaži/sakrij terminal",
  "desktop.appMenu.toggleFileTree": "Prikaži/sakrij stablo datoteka",
  "desktop.appMenu.reload": "Ponovo učitaj",
  "desktop.appMenu.toggleDeveloperTools": "Prikaži/sakrij razvojne alate",
  "desktop.appMenu.actualSize": "Stvarna veličina",
  "desktop.appMenu.zoomIn": "Uvećaj",
  "desktop.appMenu.zoomOut": "Umanji",
  "desktop.appMenu.toggleFullScreen": "Prikaži/sakrij cijeli ekran",
  "desktop.appMenu.back": "Nazad",
  "desktop.appMenu.forward": "Naprijed",
  "desktop.appMenu.previousSession": "Prethodna sesija",
  "desktop.appMenu.nextSession": "Sljedeća sesija",
  "desktop.appMenu.previousProject": "Prethodni projekat",
  "desktop.appMenu.nextProject": "Sljedeći projekat",
  "desktop.appMenu.minimize": "Minimiziraj",
  "desktop.appMenu.zoomWindow": "Uvećaj",
  "desktop.appMenu.maximize": "Maksimiziraj",
  "desktop.appMenu.bringAllToFront": "Dovedi sve naprijed",
  "desktop.appMenu.documentation": "Dokumentacija za OpenCode",
  "desktop.appMenu.supportForum": "Forum za podršku",
  "desktop.appMenu.shareFeedback": "Podijeli povratne informacije",
  "desktop.appMenu.reportBug": "Prijavi grešku",
