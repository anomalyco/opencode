export const dict = {
  ...
  "session.agents.empty": "Nema pokrenutih podagenata",
  ...
  "session.agents.status.idle": "Neaktivno",
  "session.agents.status.busy": "Pokrenuto",
  "session.agents.status.retry": "Ponavljanje",
  "session.agents.status.cancelled": "Otkazano",
  "session.agents.status.completed": "Završeno",
  "session.agents.status.error": "Neuspjelo",
  ...
  "session.header.reveal.finder": "Prikaži u Finderu",
  "session.header.reveal.fileExplorer": "Prikaži u File Exploreru",
  "session.header.reveal.containingFolder": "Otvori folder koji ga sadrži",
