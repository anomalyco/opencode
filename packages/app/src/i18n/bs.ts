export const dict = {
  ...
  "provider.custom.models.load.invalidUrl": "Unesite ispravan bazni URL",
  "provider.custom.models.load.unauthorized": "Neovlašteno. Provjerite API ključ",
  "provider.custom.models.load.invalidFormat": "Odgovor servera nije sadržavao ispravan popis modela",
  ...
  "provider.custom.models.load.empty": "Nema pronađenih modela",
