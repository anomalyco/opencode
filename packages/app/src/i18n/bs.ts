export const dict = {
  ...
  "home.activity.title": "Aktivnost tokena",
  "home.activity.daily": "Dnevno",
  "home.activity.weekly": "Sedmično",
  "home.activity.cumulative": "Kumulativno",
  "home.activity.loading": "Učitavanje aktivnosti",
  "home.activity.empty": "Još nema aktivnosti tokena",
  "home.activity.lifetimeTokens": "Ukupno tokena",
  "home.activity.peakTokens": "Vrhunac tokena",
  "home.activity.longestTask": "Najduži zadatak",
  "home.activity.currentStreak": "Trenutni niz",
  "home.activity.longestStreak": "Najduži niz",
  "home.activity.days.one": "{{count}} dan",
  "home.activity.days.other": "{{count}} dana",
  "home.activity.summary":
    "{{tokens}} ukupno tokena, {{peak}} vrhunac tokena, {{current}} trenutni niz, {{longest}} najduži niz.",
