export const dict = {
  ...
  "presets.title": "Unaprijed postavljene",
  "presets.manage": "Upravljanje unaprijed postavljenim",
  "presets.count": "{{count}} unaprijed postavljenih",
  "presets.empty": "Nema unaprijed postavljenih",
  "presets.empty.hint": "Kliknite \"Dodaj\" da kreirate prvu unaprijed postavljenu",
  "presets.add": "Dodaj",
  "presets.name": "Naziv",
  "presets.content": "Sadržaj",
  "presets.content.placeholder": "Sadržaj (podržava {date} {time} {file} {code} {text} varijable)",
  "presets.moveUp": "Pomjeri gore",
  "presets.moveDown": "Pomjeri dolje",
  "presets.edit": "Uredi",
  "presets.delete": "Obriši",
  "presets.variables.title": "Unesite varijable za \"{{name}}\"",
  "presets.variables.next": "Sljedeće",
  "presets.variables.insert": "Umetni",
}
