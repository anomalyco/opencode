export const dict = {
  ...
  "settings.general.row.sendKey.title": "Tipka za slanje",
  "settings.general.row.sendKey.description": "Odaberite tipku koja šalje poruke. Druga Enter tipka ubacuje novi red.",
