export const dict = {
  ...
  "error.page.action.restartFrontend": "Restartuj frontend",
  "error.page.action.restartBackend": "Restartuj backend",
  "error.page.action.restartApp": "Restartuj aplikaciju",
