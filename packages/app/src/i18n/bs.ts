export const dict = {
  ...
  "command.todo.toggle": "Uključi/isključi todo panel",
  ...
  "sidebar.issue.title": "Zadaci",
  "sidebar.issue.add": "Dodaj zadatak",
  "sidebar.issue.addSubtodo": "Dodaj podzadatak",
  "sidebar.issue.empty": "Nema zadataka",
  "sidebar.issue.collapse": "Sklopi podzadatke",
  "sidebar.issue.expand": "Proširi podzadatke",
  "sidebar.issue.confirmDeleteWithChildren": "Obrisati ovaj zadatak i njegovih {{count}} podzadataka?",
  "sidebar.issue.toast.deleteFailed": "Brisanje zadatka nije uspjelo",
  "sidebar.issue.tooltip.cycleStatus": "Promijeni status",
  "sidebar.issue.tooltip.cyclePriority": "Promijeni prioritet",
  "sidebar.issue.tooltip.linkedLinear": "Povezano sa Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Povezano",
  "sidebar.linear.management": "Upravljaj Linear vezom",
  "sidebar.linear.management.teamRequired": "Molimo odaberite tim",
  "sidebar.linear.management.projectRequired": "Molimo odaberite projekat",
  "sidebar.linear.management.saveFailed": "Spremanje Linear veze nije uspjelo",
  "sidebar.linear.management.saved": "Linear veza spremljena",
  "sidebar.linear.management.save": "Spremi",
  "sidebar.linear.toggleHistory": "Prikaži/sakrii historiju sinhronizacije",
  "sidebar.linear.field.team": "Tim",
  "sidebar.linear.field.team.loading": "Učitavanje timova...",
  "sidebar.linear.field.team.placeholder": "Odaberite tim",
  "sidebar.linear.field.project": "Projekat",
  "sidebar.linear.field.project.selectTeamFirst": "Prvo odaberite tim",
  "sidebar.linear.field.project.loading": "Učitavanje projekata...",
  "sidebar.linear.field.project.placeholder": "Odaberite projekat",
  "sidebar.linear.notConfigured": "Linear nije konfigurisan",
  "sidebar.linear.notConfiguredHint": "Otvorite upravljanje za odabir tima i projekta",
  ...
  "sidebar.linear.pullSuccess":
    "Povučeno {{pulled}}, ažurirano {{updated}}, preskočeno {{skipped}}, obrisano {{deleted}}",
  "sidebar.linear.pushFailed": "Slanje na Linear nije uspjelo",
  "sidebar.linear.pushPartialFailed": "Slanje djelimično nije uspjelo: {{count}} greška",
  "sidebar.linear.pushSuccess": "Poslano {{count}} zadataka na Linear",
  "sidebar.linear.pushNothing": "Ništa za slanje",
  "sidebar.linear.syncHistory.syncing": "Sinhronizacija...",
  "sidebar.linear.syncHistory.error": "Greška",
  "sidebar.linear.syncHistory.empty": "Nema istorije sinhronizacije",
  "dialog.todo.title.create": "Novi zadatak",
  "dialog.todo.title.edit": "Uredi zadatak",
  "dialog.todo.field.title": "Naslov",
  "dialog.todo.field.title.placeholder": "Naslov zadatka",
  "dialog.todo.field.description": "Opis",
  "dialog.todo.field.description.placeholder": "Dodajte detalje, linkove ili kontekst...",
  "dialog.todo.field.description.hint": "Podržava reference na datoteke i vještine",
  "dialog.todo.field.status": "Status",
  "dialog.todo.field.priority": "Prioritet",
  "dialog.todo.field.dueDate": "Rok",
  "dialog.todo.field.dueDate.placeholder": "Postavi rok",
  "dialog.todo.field.dueDate.clear": "Obriši",
  "dialog.todo.field.dueDate.prevMonth": "Prethodni mjesec",
  "dialog.todo.field.dueDate.nextMonth": "Sljedeći mjesec",
  "dialog.todo.field.dueDate.shortcut.today": "Danas",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Sutra",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Za jednu sedmicu",
  ...
  "dialog.todo.field.labels": "Oznake",
  "dialog.todo.field.assignee": "Zaduženi",
  "dialog.todo.field.assignee.unassigned": "Nije dodijeljeno",
  "dialog.todo.field.assignee.loadFailed": "Učitavanje zaduženih nije uspjelo",
  "dialog.todo.field.assignee.loading": "Učitavanje zaduženih...",
  "dialog.todo.field.assignee.placeholder": "Odaberite zaduženog",
  "dialog.todo.field.assignee.hint": "Iz članova Linear tima",
  "dialog.todo.linkedLinear": "Povezano sa Linear",
  "dialog.todo.created": "Zadatak kreiran",
  "dialog.todo.updated": "Zadatak ažuriran",
  "dialog.todo.error.titleRequired": "Naslov je obavezan",
  "dialog.todo.error.saveFailed": "Spremanje zadatka nije uspjelo",
  "dialog.todo.action.create": "Kreiraj",
  ...
  "sidebar.issue.priority.none": "Ništa.",
  "sidebar.issue.priority.urgent": "Hitno",
  "sidebar.issue.priority.high": "Visoko",
  "sidebar.issue.priority.medium": "Medijum",
  ...
  "sidebar.issue.archivedBadge": "Arhivirano",
  "sidebar.issue.archiveArea.title": "Arhivirano",
  "sidebar.issue.archiveArea.expand": "Prikaži arhivirano",
  "sidebar.issue.archiveArea.collapse": "Sakrij arhivirano",
  "sidebar.issue.archiveArea.empty": "Nema arhiviranih zadataka",
}
