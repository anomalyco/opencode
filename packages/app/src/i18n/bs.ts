export const dict = {
  ...
  "dialog.model.group.favorites": "Favoriti",
  "dialog.model.group.recent": "Nedavno korišteni",
  "dialog.model.favorite.add": "Dodaj model u favorite",
  "dialog.model.favorite.remove": "Ukloni model iz favorita",
