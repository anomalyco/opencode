export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Nevažeći SSH host: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} je već dodan",
  "desktop.ssh.error.opencodeNotInstalled": "opencode nije instaliran na {{host}}",
  "desktop.ssh.error.installOpencode": "Instalacija opencode-a nije uspjela",
  "desktop.ssh.error.connectFailed": "Nije moguće povezati se na {{host}}",
  "desktop.ssh.error.serverExited": "SSH server se zatvorio nakon pokretanja (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "SSH server za {{host}} se zatvorio prije nego što je postao dostupan (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "Isteklo je vrijeme provjere dostupnosti servera na {{host}} nakon {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "Isteklo je vrijeme za ssh komandu prema {{host}} nakon {{timeout}} ms",
  "desktop.ssh.error.failedPort": "Nije uspjelo dohvaćanje porta",
  "desktop.ssh.error.terminalFailed": "Nije uspjelo otvaranje terminala",
  ...
  "ssh.server.add": "Dodaj SSH server",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH server",
  "ssh.server.retryStart": "Poveži ponovo",
  "ssh.server.disconnect": "Prekini vezu",
  "ssh.server.openTerminal": "Otvori terminal",
  "ssh.server.updating": "Ažuriranje...",
  "ssh.server.status.connecting": "Povezivanje...",
  "ssh.server.status.disconnected": "Veza prekinuta",
  "ssh.add.hostLabel": "SSH host",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Povezuje se preko ssh klijenta tvog sistema, tako da hostovi, ključevi i agenti iz tvoje SSH konfiguracije rade kao i obično.",
  "ssh.add.configHosts": "Iz tvoje SSH konfiguracije",
  "ssh.add.connect": "Poveži",
  "ssh.add.checking": "Povezivanje...",
  "ssh.add.addServer": "Dodaj server",
  "ssh.add.adding": "Dodavanje...",
  "ssh.add.installOpencode": "Instaliraj opencode",
  "ssh.add.updateOpencode": "Ažuriraj opencode",
  "ssh.add.installing": "Instaliranje...",
  "ssh.add.status.unreachable": "Nije moguće povezati se",
  "ssh.add.status.opencodeMissing": "opencode nije instaliran na ovom hostu",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} je instaliran, desktop aplikacija očekuje v{{expected}}",
  "ssh.add.status.opencodeFound": "Pronađen je opencode v{{version}}",
  "ssh.add.authHint":
    "Provjeri da SSH autentifikacija putem ključa radi za ovaj host — pokreni `ssh {{host}}` u terminalu da provjeriš.",
