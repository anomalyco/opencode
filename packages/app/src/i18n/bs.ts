export const dict = {
  ...
  "session.review.context.openDefault": "Zadana aplikacija",
  "session.review.context.copyRelative": "Kopiraj relativnu putanju",
  "session.review.context.copyAbsolute": "Kopiraj apsolutnu putanju",
