export const dict = {
  ...
  "dialog.provider.athena.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.athena.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.athenaGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Athena",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Athena-u.",
  ...
  "provider.connect.athenaZen.line1":
    "Athena Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.athenaZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.athenaZen.visit.prefix": "Posjeti ",
  "provider.connect.athenaZen.visit.link": "athena.ai/zen",
  "provider.connect.athenaZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Athena-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Athena-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u athena.json",
  ...
  "dialog.server.description": "Promijeni na koji se Athena server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Athena-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Athena timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (athena.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Athena još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Athena uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Athena server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Athena-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Athena izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Athena prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Athena-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Athena pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Athena-a.",
