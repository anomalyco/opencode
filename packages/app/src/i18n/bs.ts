export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Pencode",
  ...
  "desktop.recovery.loadFailed": "Pencode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Pencode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Pencode ne reaguje",
  ...
  "desktop.wsl.error.installPencode": "Instalacija Pencode-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.pencodeMissing": "pencode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.pencodeCannotRun": "pencode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Pencode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.pencode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.pencode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.pencodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Pencode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Pencode-u.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.pencodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.pencodeZen.visit.prefix": "Posjeti ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Pencode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Pencode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u pencode.json",
  ...
  "dialog.server.description": "Promijeni na koji se Pencode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingPencodeIn": "Provjera Pencode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingPencode": "Ažuriranje Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Ažuriranje Pencode u distribuciji {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Ažuriraj Pencode u distribuciji {{distro}}.",
  "wsl.onboarding.updatePencode": "Ažuriraj Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode je spreman.",
  "wsl.onboarding.installPencodeIn": "Instaliraj Pencode u distribuciji {{distro}}.",
  "wsl.onboarding.installPencode": "Instaliraj Pencode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Pencode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Pencode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Pencode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Pencode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (pencode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Pencode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Pencode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Pencode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Pencode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Pencode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Pencode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Pencode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Pencode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Pencode-a.",
