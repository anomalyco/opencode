export const dict = {
  ...
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} stavka",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} stavki",
  ...
  "dialog.todo.autocomplete.noFiles": "Nema pronađenih datoteka",
  "dialog.todo.autocomplete.noSkills": "Nema pronađenih vještina",
