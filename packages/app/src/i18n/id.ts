export const dict = {
  ...
  "provider.custom.models.load": "Muat secara dinamis",
  "provider.custom.models.loading": "Memuat...",
  "provider.custom.models.load.invalidUrl": "Masukkan URL Dasar yang valid",
  "provider.custom.models.load.unauthorized": "Tidak diizinkan. Periksa kunci API",
  "provider.custom.models.load.invalidFormat": "Respons server tidak berisi daftar model yang valid",
  "provider.custom.models.load.timeout": "Waktu habis saat memuat model",
  "provider.custom.models.load.failed": "Gagal memuat model",
  "provider.custom.models.load.empty": "Tidak ada model ditemukan",
