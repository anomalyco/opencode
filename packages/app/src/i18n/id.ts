export const dict = {
  ...
  "desktop.recovery.loadFailed": "Argus gagal dimuat",
  "desktop.recovery.terminated": "Jendela Argus berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Argus tidak merespons",
  ...
  "desktop.wsl.error.installArgus": "Instalasi Argus gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.argusMissing": "argus belum terinstal di distro ini",
  "desktop.wsl.error.argusCannotRun": "argus telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.argusNotInstalled": "Argus belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Argus selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.argus.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.argus.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.argusGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Argus",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.argusZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Argus.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di argus.json",
  ...
  "dialog.server.description": "Ganti server Argus mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingArgus": "Memeriksa Argus...",
  "wsl.onboarding.checkingArgusIn": "Memeriksa Argus di {{distro}}...",
  "wsl.onboarding.updatingArgus": "Memperbarui Argus...",
  "wsl.onboarding.updatingArgusIn": "Memperbarui Argus di {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Perbarui Argus di {{distro}}.",
  "wsl.onboarding.updateArgus": "Perbarui Argus",
  "wsl.onboarding.argusReadyIn": "Argus siap di {{distro}}.",
  "wsl.onboarding.argusReady": "Argus siap.",
  "wsl.onboarding.installArgusIn": "Instal Argus di {{distro}}.",
  "wsl.onboarding.installArgus": "Instal Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Argus dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Argus tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Argus ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Argus",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (argus.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Argus belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Argus di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Argus",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Argus di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Argus mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Argus diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Argus.",
