export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Host SSH tidak valid: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} sudah ditambahkan",
  "desktop.ssh.error.opencodeNotInstalled": "opencode belum terinstal di {{host}}",
  "desktop.ssh.error.installOpencode": "Instalasi opencode gagal",
  "desktop.ssh.error.connectFailed": "Tidak dapat terhubung ke {{host}}",
  "desktop.ssh.error.serverExited": "Server SSH berhenti setelah dimulai (kode={{code}} sinyal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Server SSH untuk {{host}} berhenti sebelum siap (kode={{code}} sinyal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "Pemeriksaan kesehatan server di {{host}} kehabisan waktu setelah {{timeout}}ms",
  "desktop.ssh.error.commandTimeout": "Perintah ssh ke {{host}} kehabisan waktu setelah {{timeout}}ms",
  "desktop.ssh.error.failedPort": "Gagal mendapatkan porta",
  "desktop.ssh.error.terminalFailed": "Gagal membuka terminal",
  ...
  "ssh.server.add": "Tambah server SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "Server SSH",
  "ssh.server.retryStart": "Hubungkan kembali",
  "ssh.server.disconnect": "Putuskan",
  "ssh.server.openTerminal": "Buka terminal",
  "ssh.server.updating": "Memperbarui...",
  "ssh.server.status.connecting": "Menghubungkan...",
  "ssh.server.status.disconnected": "Terputus",
  "ssh.add.hostLabel": "Host SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Terhubung melalui klien ssh sistem, jadi host, kunci, dan agen di konfigurasi SSH Anda berfungsi seperti biasa.",
  "ssh.add.configHosts": "Dari konfigurasi SSH Anda",
  "ssh.add.connect": "Hubungkan",
  "ssh.add.checking": "Menghubungkan...",
  "ssh.add.addServer": "Tambah server",
  "ssh.add.adding": "Menambahkan...",
  "ssh.add.installOpencode": "Instal opencode",
  "ssh.add.updateOpencode": "Perbarui opencode",
  "ssh.add.installing": "Menginstal...",
  "ssh.add.status.unreachable": "Tidak dapat terhubung",
  "ssh.add.status.opencodeMissing": "opencode belum terinstal di host ini",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} terinstal, desktop mengharapkan v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} ditemukan",
  "ssh.add.authHint":
    "Pastikan autentikasi SSH berbasis kunci berfungsi untuk host ini dengan menjalankan `ssh {{host}}` di terminal.",
