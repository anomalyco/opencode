export const dict = {
  ...
  "mcp.status.needs_client_registration": "perlu registrasi klien",
  "mcp.status.pending": "menghubungkan…",
  ...
  "settings.mcp.type.remote": "Jarak jauh",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Biarkan kosong untuk melewati — autentikasi ulang mungkin diperlukan",
