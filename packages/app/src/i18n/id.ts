export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Jarvis",
  ...
  "desktop.recovery.loadFailed": "Jarvis gagal dimuat",
  "desktop.recovery.terminated": "Jendela Jarvis berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Jarvis tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Jarvis gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Jarvis selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Jarvis.",
  ...
  "dialog.server.description": "Ganti server Jarvis mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Jarvis di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Jarvis di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Jarvis di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Jarvis di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Jarvis dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Jarvis tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Jarvis ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Jarvis",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Jarvis belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.tab.connectors": "Konektor",
  "settings.integrations.placeholder": "Integrasi memperluas runtime Jarvis. Segera Anda dapat menginstal plugin, tema, dan ekstensi sistem.",
  "settings.connectors.placeholder": "Konektor menghubungkan Jarvis ke layanan eksternal. Segera hadir: Gmail, WhatsApp, Slack, Notion, Telegram, dan lainnya.",
  "settings.connectors.unavailable": "Konektor hanya tersedia di aplikasi desktop.",
  ...
  "settings.connectors.github.permission.repos": "Membaca dan mengelola repositori, isu, dan pull request Anda",
  "settings.connectors.github.permission.profile": "Membaca profil publik Anda (nama pengguna dan avatar)",
  "settings.connectors.github.connect": "Hubungkan GitHub",
  "settings.connectors.github.disconnect": "Putuskan",
  "settings.connectors.github.cancel": "Batal",
  "settings.connectors.github.openBrowser": "Buka browser",
  "settings.connectors.github.waiting": "Menunggu otorisasi…",
  "settings.connectors.github.code.instructions": "Masukkan kode ini di",
  "settings.connectors.github.connected.text": "Terhubung melalui OAuth. Jarvis dapat mengakses akun GitHub Anda.",
  "settings.connectors.github.error.expired": "Kode otorisasi kedaluwarsa. Coba lagi.",
  "settings.connectors.github.error.generic": "Tidak dapat terhubung ke GitHub. Periksa koneksi Anda dan coba lagi.",
  "settings.connectors.github.error.denied": "Otorisasi ditolak. Anda dapat mencoba lagi kapan saja.",
  ...
  "toast.session.export.success.description": "Sesi disimpan di {{filename}}",
  ...
  "settings.desktop.wsl.description": "Jalankan server Jarvis di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Jarvis",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Jarvis di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Jarvis mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Jarvis.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Jarvis diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Jarvis.",
