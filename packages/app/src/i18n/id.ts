export const dict = {
  ...
  "settings.plugins.section.browse": "Jelajahi",
  "settings.plugins.section.installed": "Terpasang",
  ...
  "settings.mcp.add": "Tambah server",
  "settings.mcp.empty": "Belum ada server MCP yang dikonfigurasi.",
  "settings.mcp.deleted": "{{name}} dihapus.",
  "settings.mcp.errors.refresh": "Tidak dapat memuat server MCP.",
  "settings.mcp.status.pending": "menghubungkan…",
  "settings.mcp.action.connect": "Sambungkan",
  "settings.mcp.action.disconnect": "Putuskan",
  "settings.mcp.action.authenticate": "Autentikasi",
  "settings.mcp.action.edit": "Edit",
  "settings.mcp.action.delete": "Hapus",
  "settings.mcp.delete.title": "Hapus server MCP",
  "settings.mcp.delete.body": "Hapus {{name}}? Tidak dapat dibatalkan.",
  "settings.mcp.form.title.add": "Tambah server MCP",
  "settings.mcp.form.title.edit": "Edit server MCP",
  "settings.mcp.form.subtitle": "Konfigurasi pengaturan koneksi.",
  "settings.mcp.form.name": "Nama",
  "settings.mcp.form.command": "Perintah",
  "settings.mcp.form.command.hint": "mis. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Direktori kerja",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Variabel lingkungan",
  "settings.mcp.form.headers": "Header",
  "settings.mcp.form.addRow": "Tambah baris",
  "settings.mcp.form.removeRow": "Hapus",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID klien",
  "settings.mcp.form.oauth.clientSecret": "Rahasia klien",
  "settings.mcp.form.oauth.clientSecret.keep": "Terkonfigurasi — biarkan kosong untuk mempertahankan",
  "settings.mcp.form.oauth.scope": "Cakupan",
  "settings.mcp.form.oauth.callbackPort": "Port callback",
  "settings.mcp.form.oauth.disableAutodetect": "Nonaktifkan deteksi otomatis OAuth",
  "settings.mcp.form.enabled": "Diaktifkan",
  "settings.mcp.form.timeout": "Waktu tunggu (ms)",
  "settings.mcp.form.save": "Simpan",
  "settings.mcp.form.cancel": "Batal",
  "settings.mcp.form.error.name": "Masukkan nama.",
  "settings.mcp.form.error.command": "Masukkan perintah.",
  "settings.mcp.form.error.url": "Masukkan URL.",
  "settings.mcp.form.error.callbackPort": "Port callback harus antara 1 dan 65535.",
  "settings.mcp.form.error.timeout": "Waktu tunggu harus bilangan bulat positif.",
  "settings.mcp.errors.invalid": "Perbaiki bidang yang disorot.",
  "settings.mcp.errors.duplicate": "Server dengan nama ini sudah ada.",
  "settings.mcp.errors.noConfig": "Tidak dapat membaca konfigurasi {{name}} — mungkin didefinisikan di luar proyek.",
  "settings.mcp.edit.warn": "Menyimpan menyambungkan ulang server ini.",
  "settings.plugins.search.placeholder": "Cari plugin…",
  "settings.plugins.detail.install": "Pasang…",
  "settings.plugins.detail.copy": "Salin cuplikan konfigurasi",
  "settings.plugins.detail.copied": "Tersalin",
  "settings.plugins.detail.notOnNpm": "Tidak ditemukan di npm — tambahkan manual ke opencode.json",
  "settings.plugins.install.title": "Pasang plugin",
  "settings.plugins.install.description": "Ke mana {{name}} ditambahkan?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Proyek ini",
  "settings.plugins.install.cancel": "Batal",
  "settings.plugins.install.success": "{{name}} terpasang. Mulai ulang OpenCode untuk memuatnya.",
  "settings.plugins.installed.empty": "Tidak ada plugin terpasang.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Proyek",
  ...
  "settings.plugins.errors.catalog": "Tidak dapat memperbarui katalog plugin.",
  "settings.plugins.stale": "Menampilkan katalog dari cache ({{age}} lalu).",
