...
export const dict = {
  ...
  "command.input.focus": "Fokuskan input",
  ...
  "command.workspace.toggle": "Alihkan workspace",
  "command.workspace.toggle.description": "Aktifkan atau nonaktifkan banyak workspace di panel samping",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenCode Zen memberi Anda akses ke serangkaian model optimal yang andal untuk agen coding.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mengumpulkan kode otorisasi Anda guna menghubungkan akun dan menggunakan model {{provider}} di OpenCode.",
  ...
  "provider.custom.field.apiKey.description": "Opsional. Kosongkan jika Anda mengelola auth melalui header.",
  ...
  "prompt.dropzone.file.label": "Letakkan untuk @menyebut berkas",
  ...
  "dialog.server.default.description":
    "Hubungkan ke server ini saat aplikasi diluncurkan, alih-alih memulai server lokal. Memerlukan restart.",
  ...
  "wsl.onboarding.restartRequired": "Windows perlu di-restart untuk menyelesaikan instalasi WSL.",
  ...
  "wsl.onboarding.listingDistros": "Mendaftar distro...",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows untuk menyelesaikan instalasi WSL, lalu buka kembali OpenCode.",
  ...
  "dialog.project.edit.worktree.startup.description": "Berjalan setelah membuat workspace (worktree) baru.",
  ...
  "home.sessions.empty": "Tidak ada sesi ditemukan",
  ...
  "session.review.noVcs": "Git VCS tidak terdeteksi, perubahan tidak ditampilkan",
  ...
  "session.todo.progress": "{{done}} dari {{total}} to-do selesai",
  ...
  "session.followupDock.collapse": "Ciutkan pesan antrean",
  "session.followupDock.expand": "Bentangkan pesan antrean",
  "session.revertDock.summary.one": "{{count}} pesan dikembalikan",
  "session.revertDock.summary.other": "{{count}} pesan dikembalikan",
  "session.revertDock.collapse": "Ciutkan pesan yang dikembalikan",
  "session.revertDock.expand": "Bentangkan pesan yang dikembalikan",
  ...
  "session.new.lastModified": "Terakhir dimodifikasi",
  ...
  "debugBar.nav.tip":
    "Transisi rute terakhir yang menyentuh halaman sesi, diukur dari awal router hingga cat pertama setelah stabil.",
  "debugBar.fps.label": "FPS",
  "debugBar.fps.tip": "Rata-rata frame per detik selama 5 detik terakhir.",
  ...
  "settings.general.row.shell.description":
    "Pilih shell yang digunakan untuk terminal Anda. Shell yang kompatibel juga digunakan untuk panggilan alat agen.",
  ...
  "settings.general.row.showCustomAgents.description": "Tampilkan pemilih agen di composer",
  ...
  "settings.general.row.showSessionProgressBar.description":
    "Tampilkan bilah progres animasi di bagian atas sesi saat agen bekerja",
  "settings.general.row.newLayoutDesigns.title": "Tata letak dan desain baru",
  "settings.general.row.newLayoutDesigns.description": "Aktifkan tata letak, beranda, composer, dan UI sesi yang didesain ulang",
  ...
  "settings.general.row.wayland.description": "Nonaktifkan fallback X11 di Wayland. Memerlukan restart.",
  "settings.general.row.wayland.tooltip":
    "Di Linux dengan monitor refresh-rate campuran, Wayland asli bisa lebih stabil.",
  ...
  "settings.updates.toast.latest.title": "Anda sudah yang terbaru",
  ...
  "settings.permissions.tool.read.description": "Membaca berkas (mencocokkan path berkas)",
  ...
  "settings.permissions.tool.todowrite.title": "Tulis To-do",
  "settings.permissions.tool.todowrite.description": "Perbarui daftar to-do",
  ...
  "settings.permissions.tool.doom_loop.description": "Deteksi panggilan alat berulang dengan input yang identik",
  ...
  "workspace.resetting.title": "Mengatur ulang workspace",
  "workspace.resetting.description": "Ini mungkin memakan waktu sebentar.",
  "workspace.reset.failed.title": "Gagal mengatur ulang workspace",
  "workspace.reset.success.title": "Workspace diatur ulang",
  "workspace.reset.success.description": "Workspace sekarang cocok dengan cabang bawaan.",
  ...
  "workspace.status.clean": "Tidak ada perubahan yang belum digabung terdeteksi.",
  "workspace.status.dirty": "Perubahan yang belum digabung terdeteksi di workspace ini.",
  ...
  "workspace.reset.title": "Atur ulang workspace",
  "workspace.reset.confirm": 'Atur ulang workspace "{{name}}"?',
  "workspace.reset.button": "Atur ulang workspace",
  ...
  "workspace.reset.note": "Ini akan mengatur ulang workspace agar cocok dengan cabang bawaan.",
