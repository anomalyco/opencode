export const dict = {
  ...
  "desktop.recovery.loadFailed": "Pencode gagal dimuat",
  "desktop.recovery.terminated": "Jendela Pencode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Pencode tidak merespons",
  ...
  "desktop.wsl.error.installPencode": "Instalasi Pencode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.pencodeMissing": "pencode belum terinstal di distro ini",
  "desktop.wsl.error.pencodeCannotRun": "pencode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Pencode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.pencode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.pencode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.pencodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Pencode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Pencode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di pencode.json",
  ...
  "dialog.server.description": "Ganti server Pencode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingPencode": "Memeriksa Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Memeriksa Pencode di {{distro}}...",
  "wsl.onboarding.updatingPencode": "Memperbarui Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Memperbarui Pencode di {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Perbarui Pencode di {{distro}}.",
  "wsl.onboarding.updatePencode": "Perbarui Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode siap di {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode siap.",
  "wsl.onboarding.installPencodeIn": "Instal Pencode di {{distro}}.",
  "wsl.onboarding.installPencode": "Instal Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Pencode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Pencode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Pencode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Pencode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (pencode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Pencode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Pencode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Pencode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Pencode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Pencode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Pencode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Pencode.",
