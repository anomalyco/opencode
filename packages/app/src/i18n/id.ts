export const dict = {
  ...
  "session.tab.agents": "Subagen",
  "session.agents.empty": "Tidak ada subagen berjalan",
  "session.agents.costTotal": "Total biaya",
  "session.agents.costSubagents": "Subagen",
  "session.agents.count": "Agen",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Tampilkan semua ({{count}})",
  "session.agents.status.idle": "Menganggur",
  "session.agents.status.busy": "Berjalan",
  "session.agents.status.retry": "Mencoba lagi",
