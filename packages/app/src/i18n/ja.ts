export const dict = {
  ...
  "command.todo.toggle": "Todo パネルを切り替え",
  ...
  "sidebar.issue.title": "Todo",
  "sidebar.issue.add": "Todoを追加",
  "sidebar.issue.addSubtodo": "サブTodoを追加",
  "sidebar.issue.empty": "Todoがありません",
  "sidebar.issue.collapse": "サブタスクを折りたたむ",
  "sidebar.issue.expand": "サブタスクを展開",
  "sidebar.issue.confirmDeleteWithChildren": "このタスクと{{count}}個のサブタスクを削除しますか？",
  "sidebar.issue.toast.deleteFailed": "Todoの削除に失敗しました",
  "sidebar.issue.tooltip.cycleStatus": "ステータスを切り替え",
  "sidebar.issue.tooltip.cyclePriority": "優先度を切り替え",
  "sidebar.issue.tooltip.linkedLinear": "Linearにリンク済み",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "接続済み",
  "sidebar.linear.management": "Linear連携を管理",
  "sidebar.linear.management.teamRequired": "チームを選択してください",
  "sidebar.linear.management.projectRequired": "プロジェクトを選択してください",
  "sidebar.linear.management.saveFailed": "Linear連携の保存に失敗しました",
  "sidebar.linear.management.saved": "Linear連携を保存しました",
  "sidebar.linear.management.save": "保存",
  "sidebar.linear.toggleHistory": "同期履歴を切り替え",
  "sidebar.linear.field.team": "チーム",
  "sidebar.linear.field.team.loading": "チームを読み込み中...",
  "sidebar.linear.field.team.placeholder": "チームを選択",
  "sidebar.linear.field.project": "プロジェクト",
  "sidebar.linear.field.project.selectTeamFirst": "先にチームを選択してください",
  "sidebar.linear.field.project.loading": "プロジェクトを読み込み中...",
  "sidebar.linear.field.project.placeholder": "プロジェクトを選択",
  "sidebar.linear.notConfigured": "Linearが未設定です",
  "sidebar.linear.notConfiguredHint": "管理パネルからチームとプロジェクトを選択してください",
  "sidebar.linear.actions": "同期アクション",
  "sidebar.linear.push": "プッシュ",
  "sidebar.linear.pull": "プル",
  "sidebar.linear.pullFailed": "Linearからのプルに失敗しました",
  "sidebar.linear.pullPartialFailed": "プルが一部失敗しました：{{count}}件のエラー",
  "sidebar.linear.pullSuccess": "取得 {{pulled}}、更新 {{updated}}、スキップ {{skipped}}、削除 {{deleted}}",
  "sidebar.linear.pushFailed": "Linearへのプッシュに失敗しました",
  "sidebar.linear.pushPartialFailed": "プッシュが一部失敗しました：{{count}}件のエラー",
  "sidebar.linear.pushSuccess": "{{count}}件のTodoをLinearにプッシュしました",
  "sidebar.linear.pushNothing": "プッシュするものがありません",
  "sidebar.linear.syncHistory.syncing": "同期中...",
  "sidebar.linear.syncHistory.push": "↗ Linear",
  "sidebar.linear.syncHistory.pull": "↙ Linear",
  "sidebar.linear.syncHistory.itemCount.one": "{{count}}件",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}}件",
  "sidebar.linear.syncHistory.error": "エラー",
  "sidebar.linear.syncHistory.empty": "同期履歴なし",
  "dialog.todo.title.create": "Todoを作成",
  "dialog.todo.title.edit": "Todoを編集",
  "dialog.todo.field.title": "タイトル",
  "dialog.todo.field.title.placeholder": "Todoタイトル",
  "dialog.todo.field.description": "説明",
  "dialog.todo.field.description.placeholder": "詳細、リンク、コンテキストを追加...",
  "dialog.todo.field.description.hint": "ファイルとスキルの参照に対応",
  "dialog.todo.field.status": "ステータス",
  "dialog.todo.field.priority": "優先度",
  "dialog.todo.field.dueDate": "期限",
  "dialog.todo.field.dueDate.placeholder": "期限を設定",
  "dialog.todo.field.dueDate.clear": "クリア",
  "dialog.todo.field.dueDate.prevMonth": "前の月",
  "dialog.todo.field.dueDate.nextMonth": "翌月",
  "dialog.todo.field.dueDate.shortcut.today": "今日",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "明日",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "1週間後",
  ...
  "dialog.todo.field.labels": "ラベル",
  "dialog.todo.field.assignee": "担当者",
  "dialog.todo.field.assignee.unassigned": "未担当",
  "dialog.todo.field.assignee.loadFailed": "担当者の読み込みに失敗しました",
  "dialog.todo.field.assignee.loading": "担当者を読み込み中...",
  "dialog.todo.field.assignee.placeholder": "担当者を選択",
  "dialog.todo.field.assignee.hint": "Linearチームメンバーから取得",
  "dialog.todo.autocomplete.noFiles": "ファイルが見つかりません",
  "dialog.todo.autocomplete.noSkills": "スキルが見つかりません",
  "dialog.todo.linkedLinear": "Linearにリンク済み",
  "dialog.todo.created": "Todoを作成しました",
  "dialog.todo.updated": "Todoを更新しました",
  "dialog.todo.error.titleRequired": "タイトルは必須です",
  "dialog.todo.error.saveFailed": "Todoの保存に失敗しました",
  "dialog.todo.action.create": "作成",
  ...
  "sidebar.issue.priority.none": "なし",
  "sidebar.issue.priority.urgent": "緊急",
  "sidebar.issue.priority.high": "高",
  "sidebar.issue.priority.medium": "中",
