export const dict = {
  ...
  "session.new.branch.search": "ブランチを検索",
  "session.new.branch.checkout": "切り替え",
  "session.new.branch.base": "分岐元",
  "session.new.branch.local": "ローカル",
  "session.new.branch.empty": "ブランチがありません",
  "session.new.branch.switchFailed": "ブランチの切り替えに失敗しました",
