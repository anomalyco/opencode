export const dict = {
  ...
  "sidebar.linear.pullHint": "Linear からプル。注意：Linear 上での階層変更（親の再指定、親の削除）はローカルに同期されません。フィールド値のみ同期されます。",
  ...
  "sidebar.issue.toast.archiveFailed": "タスクのアーカイブに失敗しました",
  "sidebar.issue.toast.reorderFailed": "タスクの並べ替えに失敗しました",
  "sidebar.issue.toast.reparentFailed": "タスクの親変更に失敗しました",
  "sidebar.issue.tooltip.archive": "このタスクをアーカイブ",
  "sidebar.issue.tooltip.delete": "このタスクを削除",
  "sidebar.issue.confirmArchive": "アーカイブ",
  "sidebar.issue.archivedBadge": "アーカイブ済み",
  "sidebar.issue.archiveArea.title": "アーカイブ済み",
  "sidebar.issue.archiveArea.expand": "アーカイブ済みを表示",
  "sidebar.issue.archiveArea.collapse": "アーカイブ済みを非表示",
  "sidebar.issue.archiveArea.empty": "アーカイブされたタスクはありません",
}
