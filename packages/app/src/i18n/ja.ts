export const dict = {
  ...
  "home.activity.title": "トークンアクティビティ",
  "home.activity.daily": "日次",
  "home.activity.weekly": "週次",
  "home.activity.cumulative": "累積",
  "home.activity.loading": "アクティビティを読み込み中",
  "home.activity.empty": "まだトークンアクティビティはありません",
  "home.activity.lifetimeTokens": "総トークン数",
  "home.activity.peakTokens": "ピークトークン数",
  "home.activity.longestTask": "最長タスク",
  "home.activity.currentStreak": "現在の連続日数",
  "home.activity.longestStreak": "最長連続日数",
  "home.activity.days.one": "{{count}} 日",
  "home.activity.days.other": "{{count}} 日",
  "home.activity.summary":
    "{{tokens}} 総トークン、{{peak}} ピークトークン、{{current}} 現在の連続日数、{{longest}} 最長連続日数。",
