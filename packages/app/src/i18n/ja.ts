export const dict = {
  ...
  "home.recentlyClosed.options": "絞り込みと並べ替え",
  "home.recentlyClosed.filter.label": "絞り込み",
  "home.recentlyClosed.filter.recent": "最近",
  "home.recentlyClosed.filter.archived": "アーカイブ済み",
  "home.recentlyClosed.filter.hidden": "非表示",
  "home.recentlyClosed.filter.all": "すべて",
  "home.recentlyClosed.filter.empty": "この絞り込みに一致するプロジェクトはありません",
  "home.recentlyClosed.sort.label": "並べ替え",
  "home.recentlyClosed.sort.recent": "新しい順",
  "home.recentlyClosed.sort.oldest": "古い順",
  "home.recentlyClosed.sort.nameAsc": "名前 A–Z",
  "home.recentlyClosed.sort.nameDesc": "名前 Z–A",
  "home.recentlyClosed.search.placeholder": "最近閉じたプロジェクトを検索",
  "home.recentlyClosed.showMore": "すべて表示（{{count}}）",
  "home.recentlyClosed.showLess": "表示を減らす",
  "home.recentlyClosed.select": "選択…",
  "home.recentlyClosed.selectAll": "すべて選択",
  "home.recentlyClosed.deselectAll": "すべて選択解除",
  "home.recentlyClosed.cancelSelection": "選択をキャンセル",
  "home.recentlyClosed.selected": "{{count}} 件選択中",
  "home.recentlyClosed.noResults": "「{{query}}」に一致するプロジェクトはありません",
  "home.recentlyClosed.archived.badge": "アーカイブ済み",
  "home.recentlyClosed.hidden.badge": "非表示",
  "home.recentlyClosed.action.reopen": "再度開く",
  "home.recentlyClosed.action.unarchive": "アーカイブ解除",
  "home.recentlyClosed.action.hide": "非表示にする",
  "home.recentlyClosed.action.unhide": "再表示",
  "home.recentlyClosed.action.remove": "忘れる",
  "home.recentlyClosed.remove.title": "プロジェクトを忘れますか？",
  "home.recentlyClosed.remove.titleMany": "{{count}} 件のプロジェクトを忘れますか？",
  "home.recentlyClosed.remove.confirm": "「{{name}}」を最近閉じたプロジェクトから削除しますか？履歴が消去されるだけで、ファイルが削除されることはありません。",
  "home.recentlyClosed.remove.confirmMany": "{{count}} 件のプロジェクトを最近閉じたプロジェクトから削除しますか？履歴が消去されるだけで、ファイルが削除されることはありません。",
  "home.recentlyClosed.toast.archived": "アーカイブしました",
  "home.recentlyClosed.toast.hidden": "非表示にしました",
  "home.recentlyClosed.toast.removed": "最近閉じたプロジェクトから削除しました",
  "home.recentlyClosed.toast.undo": "元に戻す",
