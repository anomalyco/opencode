export const dict = {
  ...
  "provider.custom.models.load": "動的に読み込む",
  "provider.custom.models.loading": "読み込んでいます...",
  "provider.custom.models.load.invalidUrl": "有効なベースURLを入力してください",
  "provider.custom.models.load.unauthorized": "認証エラー。APIキーを確認してください",
  "provider.custom.models.load.invalidFormat": "サーバーの応答が有効なモデルリストではありません",
  "provider.custom.models.load.timeout": "モデルの読み込みがタイムアウトしました",
  "provider.custom.models.load.failed": "モデルの読み込みに失敗しました",
  "provider.custom.models.load.empty": "モデルが見つかりません",
