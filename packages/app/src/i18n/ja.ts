export const dict = {
  ...
  "desktop.recovery.loadFailed": "Argusを読み込めませんでした",
  "desktop.recovery.terminated": "Argusのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Argusが応答していません",
  ...
  "desktop.wsl.error.installArgus": "Argusのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.argusMissing": "このディストリビューションにはargusがインストールされていません",
  "desktop.wsl.error.argusCannotRun": "argusはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.argusNotInstalled": "{{distro}}にはArgusがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Argusのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "wsl.onboarding.checkingArgus": "Argusを確認中...",
  "wsl.onboarding.checkingArgusIn": "{{distro}}内のArgusを確認中...",
  "wsl.onboarding.updatingArgus": "Argusを更新中...",
  "wsl.onboarding.updatingArgusIn": "{{distro}}内のArgusを更新中...",
  "wsl.onboarding.updateArgusIn": "{{distro}}内のArgusを更新してください。",
  "wsl.onboarding.updateArgus": "Argusを更新",
  "wsl.onboarding.argusReadyIn": "{{distro}}内のArgusの準備ができました。",
  "wsl.onboarding.argusReady": "Argusの準備ができました。",
  "wsl.onboarding.installArgusIn": "{{distro}}にArgusをインストールしてください。",
  "wsl.onboarding.installArgus": "Argusをインストール",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argusがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ArgusでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Argusをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Argus Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "settings.general.row.colorScheme.description": "Argusがシステム、ライト、またはダークテーマに従うかを選択します",
