export const dict = {
  ...
  "toast.file.uploadFailed.title": "ファイルのアップロードに失敗しました",
  "toast.file.downloadFailed.title": "ファイルのダウンロードに失敗しました",
  "toast.file.deleteFailed.title": "ファイルの削除に失敗しました",
  ...
  "session.files.uploadFile": "ファイルをアップロード",
  "session.files.uploading": "アップロード中…",
  "session.files.downloadFile": "ダウンロード",
  "session.files.refresh": "更新",
  "session.files.dropFiles": "ここにファイルをドロップするか、+ をクリックしてアップロード",
  "session.files.deleteConfirm": "\"{{path}}\" を削除しますか？",
  "session.files.uploadTooLarge": "ファイルが大きすぎます（最大 {{size}}）",
  ...
  "session.header.reveal.containingFolder": "含むフォルダーを開く",
