export const dict = {
  ...
  "provider.custom.models.context.label": "コンテキストサイズ",
  "provider.custom.models.context.placeholder": "コンテキストサイズ",
  "provider.custom.models.output.label": "最大出力",
  "provider.custom.models.output.placeholder": "最大出力",
  "provider.custom.models.reasoning.label": "推論をサポート",
  ...
  "provider.custom.error.positiveInteger": "正の整数を入力してください",
