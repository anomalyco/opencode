export const dict = {
  ...
  "command.context.addToChat": "選択範囲をチャットに追加",
  "command.context.addToChat.description": "選択した行をカーソル位置に挿入",
  "command.context.quickEdit": "選択範囲をクイック編集",
  "command.context.quickEdit.description": "選択したコードを新しいセッションで編集",
  "selection.action.addToChat": "チャットに追加",
  "selection.action.quickEdit": "クイック編集",
  "selection.quickEdit.placeholder": "選択したコードを編集",
  "selection.quickEdit.submit": "開始",
