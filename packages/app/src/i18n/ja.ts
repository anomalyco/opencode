export const dict = {
  ...
  "session.tab.agents": "サブエージェント",
  "session.agents.empty": "実行中のサブエージェントはありません",
  "session.agents.costTotal": "合計コスト",
  "session.agents.costSubagents": "サブエージェント",
  "session.agents.count": "エージェント",
  "session.agents.tokens": "トークン",
  "session.agents.showAll": "すべて表示 ({{count}})",
  "session.agents.status.idle": "アイドル",
  "session.agents.status.busy": "実行中",
  "session.agents.status.retry": "再試行",
  "session.agents.status.cancelled": "キャンセル済み",
  "session.agents.status.completed": "完了",
  "session.agents.status.error": "失敗",
