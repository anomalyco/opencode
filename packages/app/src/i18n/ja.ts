export const dict = {
  ...
  "palette.group.files": "ファイル名の一致",
  "palette.group.content": "ローカルファイル内容の一致",
  "palette.group.chat": "チャット内容の一致",
  "palette.group.sessions": "セッション名の一致",
  "palette.group.files.count": "{{count}} 件の結果。",
  "palette.group.content.count": "{{count}} 件の結果（{{files}} ファイル）。",
  "palette.group.chat.count": "{{count}} 件の結果（{{sessions}} セッション）。",
  "palette.group.sessions.count": "{{count}} 件の結果。",
