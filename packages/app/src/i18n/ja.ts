export const dict = {
  ...
  "presets.count": "プリセット {{count}} 件",
  "presets.empty": "プリセットなし",
  "presets.empty.hint": "「追加」をクリックして最初のプリセットを作成",
  "presets.add": "追加",
  "presets.name": "名前",
  "presets.content": "内容",
  "presets.content.placeholder": "内容（{date} {time} {file} {code} {text} 変数対応）",
  "presets.moveUp": "上に移動",
  "presets.moveDown": "下に移動",
  "presets.edit": "編集",
  "presets.delete": "削除",
  "presets.variables.title": "「{{name}}」の変数を入力",
  "presets.variables.next": "次へ",
  "presets.variables.insert": "挿入",
}
