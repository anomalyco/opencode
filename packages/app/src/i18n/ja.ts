export const dict = {
  ...
  "status.tab.servers.one": "{{count}} サーバー",
  "status.tab.servers.other": "{{count}} サーバー",
  "status.tab.mcp.one": "{{count}} MCP",
  "status.tab.mcp.other": "{{count}} MCP",
  "status.tab.lsp.one": "{{count}} LSP",
  "status.tab.lsp.other": "{{count}} LSP",
  "status.tab.plugins.one": "{{count}} プラグイン",
  "status.tab.plugins.other": "{{count}} プラグイン",
  "status.servers.empty": "サーバーが構成されていません",
  "status.servers.manage": "サーバーを管理",
  "status.mcp.empty": "MCP サーバーが構成されていません",
  "status.lsp.empty": "アクティブな LSP サーバーはありません",
  "status.plugins.empty": "'opencode.json' でプラグインを構成",
