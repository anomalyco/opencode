export const dict = {
  ...
  "error.page.action.restartFrontend": "フロントエンドを再起動",
  "error.page.action.restartBackend": "バックエンドを再起動",
  "error.page.action.restartApp": "アプリを再起動",
