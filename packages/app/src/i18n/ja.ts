export const dict = {
  ...
  "desktop.recovery.loadFailed": "Pencodeを読み込めませんでした",
  "desktop.recovery.terminated": "Pencodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Pencodeが応答していません",
  ...
  "desktop.wsl.error.installPencode": "Pencodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.pencodeMissing": "このディストリビューションにはpencodeがインストールされていません",
  "desktop.wsl.error.pencodeCannotRun": "pencodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.pencodeNotInstalled": "{{distro}}にはPencodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Pencodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.pencode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.pencode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.pencodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Pencodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.pencodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.pencodeZen.visit.prefix": " ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してPencodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Pencodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "pencode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するPencodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingPencode": "Pencodeを確認中...",
  "wsl.onboarding.checkingPencodeIn": "{{distro}}内のPencodeを確認中...",
  "wsl.onboarding.updatingPencode": "Pencodeを更新中...",
  "wsl.onboarding.updatingPencodeIn": "{{distro}}内のPencodeを更新中...",
  "wsl.onboarding.updatePencodeIn": "{{distro}}内のPencodeを更新してください。",
  "wsl.onboarding.updatePencode": "Pencodeを更新",
  "wsl.onboarding.pencodeReadyIn": "{{distro}}内のPencodeの準備ができました。",
  "wsl.onboarding.pencodeReady": "Pencodeの準備ができました。",
  "wsl.onboarding.installPencodeIn": "{{distro}}にPencodeをインストールしてください。",
  "wsl.onboarding.installPencode": "Pencodeをインストール",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PencodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Pencodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Pencode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをPencodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (pencode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: PencodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Pencodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でPencodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Pencodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのPencodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Pencodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Pencodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Pencode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Pencode は最新バージョンです。",
