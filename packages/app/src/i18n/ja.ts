export const dict = {
  ...
  "command.session.handoff": "セッションを引き継ぐ",
  "command.session.handoff.description": "セッションを圧縮して新しいセッションで作業を続ける",
  ...
  "toast.session.handoff.failed.title": "セッションの引き継ぎに失敗しました",
  "toast.session.handoff.failed.description": "引き継ぎのためにこのセッションを要約できませんでした",
