export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCodeメニュー",
  "desktop.appMenu.file": "ファイル",
  "desktop.appMenu.edit": "編集",
  "desktop.appMenu.view": "表示",
  "desktop.appMenu.go": "移動",
  "desktop.appMenu.window": "ウィンドウ",
  "desktop.appMenu.help": "ヘルプ",
  "desktop.appMenu.about": "OpenCodeについて",
  "desktop.appMenu.checkForUpdates": "アップデートを確認...",
  "desktop.appMenu.settings": "設定",
  "desktop.appMenu.reloadWebview": "Webビューを再読み込み",
  "desktop.appMenu.restart": "再起動",
  "desktop.appMenu.exportLogs": "ログをエクスポート...",
  "desktop.appMenu.hide": "OpenCodeを隠す",
  "desktop.appMenu.hideOthers": "ほかを隠す",
  "desktop.appMenu.showAll": "すべてを表示",
  "desktop.appMenu.quit": "OpenCodeを終了",
  "desktop.appMenu.newSession": "新しいセッション",
  "desktop.appMenu.openProject": "プロジェクトを開く...",
  "desktop.appMenu.newWindow": "新しいウィンドウ",
  "desktop.appMenu.closeWindow": "ウィンドウを閉じる",
  "desktop.appMenu.undo": "元に戻す",
  "desktop.appMenu.redo": "やり直す",
  "desktop.appMenu.cut": "切り取り",
  "desktop.appMenu.copy": "コピー",
  "desktop.appMenu.paste": "ペースト",
  "desktop.appMenu.delete": "削除",
  "desktop.appMenu.selectAll": "すべてを選択",
  "desktop.appMenu.toggleSidebar": "サイドバーの表示を切り替え",
  "desktop.appMenu.toggleTerminal": "ターミナルの表示を切り替え",
  "desktop.appMenu.toggleFileTree": "ファイルツリーの表示を切り替え",
  "desktop.appMenu.reload": "再読み込み",
  "desktop.appMenu.toggleDeveloperTools": "開発者ツールの表示を切り替え",
  "desktop.appMenu.actualSize": "実際のサイズ",
  "desktop.appMenu.zoomIn": "拡大",
  "desktop.appMenu.zoomOut": "縮小",
  "desktop.appMenu.toggleFullScreen": "フルスクリーン表示を切り替え",
  "desktop.appMenu.back": "戻る",
  "desktop.appMenu.forward": "進む",
  "desktop.appMenu.previousSession": "前のセッション",
  "desktop.appMenu.nextSession": "次のセッション",
  "desktop.appMenu.previousProject": "前のプロジェクト",
  "desktop.appMenu.nextProject": "次のプロジェクト",
  "desktop.appMenu.minimize": "最小化",
  "desktop.appMenu.zoomWindow": "ズーム",
  "desktop.appMenu.maximize": "最大化",
  "desktop.appMenu.bringAllToFront": "すべてを手前に移動",
  "desktop.appMenu.documentation": "OpenCodeドキュメント",
  "desktop.appMenu.supportForum": "サポートフォーラム",
  "desktop.appMenu.shareFeedback": "フィードバックを送信",
  "desktop.appMenu.reportBug": "バグを報告",
