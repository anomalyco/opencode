export const dict = {
  ...
  "mcp.status.needs_client_registration": "cần đăng ký ứng dụng khách",
  "mcp.status.pending": "đang kết nối…",
  ...
  "settings.mcp.type.local": "Cục bộ",
  "settings.mcp.type.remote": "Từ xa",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Để trống để bỏ qua — có thể cần xác thực lại",
