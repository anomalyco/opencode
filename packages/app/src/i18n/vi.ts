export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Host SSH không hợp lệ: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} đã được thêm",
  "desktop.ssh.error.opencodeNotInstalled": "opencode chưa được cài đặt trên {{host}}",
  "desktop.ssh.error.installOpencode": "Không cài đặt được opencode",
  "desktop.ssh.error.connectFailed": "Không thể kết nối với {{host}}",
  "desktop.ssh.error.serverExited": "Máy chủ SSH đã thoát sau khi khởi động (mã={{code}} tín hiệu={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Máy chủ SSH cho {{host}} đã thoát trước khi sẵn sàng (mã={{code}} tín hiệu={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "Kiểm tra tình trạng máy chủ trên {{host}} đã hết thời gian chờ sau {{timeout}}ms",
  "desktop.ssh.error.commandTimeout": "Lệnh ssh tới {{host}} đã hết thời gian chờ sau {{timeout}}ms",
  "desktop.ssh.error.failedPort": "Không lấy được cổng",
  "desktop.ssh.error.terminalFailed": "Không mở được terminal",
  ...
  "ssh.server.add": "Thêm máy chủ SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "Máy chủ SSH",
  "ssh.server.retryStart": "Kết nối lại",
  "ssh.server.disconnect": "Ngắt kết nối",
  "ssh.server.openTerminal": "Mở terminal",
  "ssh.server.updating": "Đang cập nhật...",
  "ssh.server.status.connecting": "Đang kết nối...",
  "ssh.server.status.disconnected": "Đã ngắt kết nối",
  "ssh.add.hostLabel": "Host SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Kết nối qua ssh client của hệ thống, nên host, khóa và agent trong cấu hình SSH của bạn vẫn dùng được như bình thường.",
  "ssh.add.configHosts": "Từ cấu hình SSH của bạn",
  "ssh.add.connect": "Kết nối",
  "ssh.add.checking": "Đang kết nối...",
  "ssh.add.addServer": "Thêm máy chủ",
  "ssh.add.adding": "Đang thêm...",
  "ssh.add.installOpencode": "Cài đặt opencode",
  "ssh.add.updateOpencode": "Cập nhật opencode",
  "ssh.add.installing": "Đang cài đặt...",
  "ssh.add.status.unreachable": "Không thể kết nối",
  "ssh.add.status.opencodeMissing": "opencode chưa được cài đặt trên host này",
  "ssh.add.status.opencodeMismatch": "Đã cài đặt opencode v{{version}}, ứng dụng desktop cần v{{expected}}",
  "ssh.add.status.opencodeFound": "Đã tìm thấy opencode v{{version}}",
  "ssh.add.authHint":
    "Hãy đảm bảo xác thực SSH bằng khóa hoạt động với host này. Chạy `ssh {{host}}` trong terminal để kiểm tra.",
