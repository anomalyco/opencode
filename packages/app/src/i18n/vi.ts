export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Jarvis",
  ...
  "desktop.recovery.loadFailed": "Không tải được Jarvis",
  "desktop.recovery.terminated": "Cửa sổ Jarvis đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Jarvis không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Jarvis",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Jarvis nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Jarvis.",
  ...
  "dialog.server.description": "Chuyển máy chủ Jarvis mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Jarvis trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Jarvis trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Jarvis trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Jarvis trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Jarvis có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Jarvis không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Jarvis ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Jarvis",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Jarvis chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.tab.connectors": "Trình kết nối",
  "settings.integrations.placeholder": "Tích hợp mở rộng môi trường chạy Jarvis. Sắp tới bạn có thể cài đặt plugin, chủ đề và tiện ích hệ thống.",
  "settings.connectors.placeholder": "Trình kết nối liên kết Jarvis với các dịch vụ bên ngoài. Sắp ra mắt: Gmail, WhatsApp, Slack, Notion, Telegram và nhiều hơn nữa.",
  "settings.connectors.unavailable": "Trình kết nối chỉ khả dụng trong ứng dụng máy tính để bàn.",
  ...
  "settings.connectors.github.permission.repos": "Đọc và quản lý kho lưu trữ, vấn đề và yêu cầu kéo của bạn",
  "settings.connectors.github.permission.profile": "Đọc hồ sơ công khai của bạn (tên người dùng và hình đại diện)",
  "settings.connectors.github.connect": "Kết nối GitHub",
  "settings.connectors.github.disconnect": "Ngắt kết nối",
  "settings.connectors.github.cancel": "Hủy",
  "settings.connectors.github.openBrowser": "Mở trình duyệt",
  "settings.connectors.github.waiting": "Đang chờ ủy quyền…",
  "settings.connectors.github.code.instructions": "Nhập mã này trên",
  "settings.connectors.github.connected.text": "Đã kết nối qua OAuth. Jarvis có thể truy cập tài khoản GitHub của bạn.",
  "settings.connectors.github.error.expired": "Mã ủy quyền đã hết hạn. Hãy thử lại.",
  "settings.connectors.github.error.generic": "Không thể kết nối với GitHub. Kiểm tra kết nối của bạn và thử lại.",
  "settings.connectors.github.error.denied": "Ủy quyền bị từ chối. Bạn có thể thử lại bất cứ lúc nào.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Jarvis bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Jarvis",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Jarvis trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Jarvis tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Jarvis.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Jarvis khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Jarvis.",
