export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Argus",
  ...
  "desktop.recovery.loadFailed": "Không tải được Argus",
  "desktop.recovery.terminated": "Cửa sổ Argus đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Argus không phản hồi",
  ...
  "desktop.wsl.error.installArgus": "Không cài đặt được Argus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.argusMissing": "argus chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.argusCannotRun": "argus đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.argusNotInstalled": "Argus chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Argus nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.argus.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.argus.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.argusGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Argus cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.argusZen.visit.prefix": "Truy cập ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Argus.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong argus.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Argus mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingArgus": "Đang kiểm tra Argus...",
  "wsl.onboarding.checkingArgusIn": "Đang kiểm tra Argus trong {{distro}}...",
  "wsl.onboarding.updatingArgus": "Đang cập nhật Argus...",
  "wsl.onboarding.updatingArgusIn": "Đang cập nhật Argus trong {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Cập nhật Argus trong {{distro}}.",
  "wsl.onboarding.updateArgus": "Cập nhật Argus",
  "wsl.onboarding.argusReadyIn": "Argus đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.argusReady": "Argus đã sẵn sàng.",
  "wsl.onboarding.installArgusIn": "Cài đặt Argus trong {{distro}}.",
  "wsl.onboarding.installArgus": "Cài đặt Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Argus có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Argus không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Argus ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Argus",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (argus.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Argus chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Argus bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Argus",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Argus trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Argus tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Argus.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Argus khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Argus.",
