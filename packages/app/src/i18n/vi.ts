export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Pencode",
  ...
  "desktop.recovery.loadFailed": "Không tải được Pencode",
  "desktop.recovery.terminated": "Cửa sổ Pencode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Pencode không phản hồi",
  ...
  "desktop.wsl.error.installPencode": "Không cài đặt được Pencode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.pencodeMissing": "pencode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.pencodeCannotRun": "pencode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Pencode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.pencode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.pencode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.pencodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Pencode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Truy cập ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Pencode.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong pencode.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Pencode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingPencode": "Đang kiểm tra Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Đang kiểm tra Pencode trong {{distro}}...",
  "wsl.onboarding.updatingPencode": "Đang cập nhật Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Đang cập nhật Pencode trong {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Cập nhật Pencode trong {{distro}}.",
  "wsl.onboarding.updatePencode": "Cập nhật Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode đã sẵn sàng.",
  "wsl.onboarding.installPencodeIn": "Cài đặt Pencode trong {{distro}}.",
  "wsl.onboarding.installPencode": "Cài đặt Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Pencode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Pencode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Pencode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Pencode",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (pencode.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Pencode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Pencode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Pencode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Pencode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Pencode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Pencode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Pencode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Pencode.",
