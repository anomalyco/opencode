export const dict = {
  ...
  "settings.plugins.section.browse": "Duyệt",
  ...
  "settings.mcp.add": "Thêm máy chủ",
  "settings.mcp.empty": "Chưa cấu hình máy chủ MCP nào.",
  "settings.mcp.deleted": "Đã xóa {{name}}.",
  "settings.mcp.errors.refresh": "Không thể tải các máy chủ MCP.",
  "settings.mcp.status.pending": "đang kết nối…",
  "settings.mcp.action.connect": "Kết nối",
  "settings.mcp.action.disconnect": "Ngắt kết nối",
  "settings.mcp.action.authenticate": "Xác thực",
  "settings.mcp.action.edit": "Chỉnh sửa",
  "settings.mcp.action.delete": "Xóa",
  "settings.mcp.delete.title": "Xóa máy chủ MCP",
  "settings.mcp.delete.body": "Gỡ bỏ {{name}}? Không thể hoàn tác.",
  "settings.mcp.form.title.add": "Thêm máy chủ MCP",
  "settings.mcp.form.title.edit": "Sửa máy chủ MCP",
  "settings.mcp.form.subtitle": "Cấu hình cài đặt kết nối.",
  "settings.mcp.form.name": "Tên",
  "settings.mcp.form.command": "Lệnh",
  "settings.mcp.form.command.hint": "vd. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Thư mục làm việc",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Biến môi trường",
  "settings.mcp.form.headers": "Tiêu đề",
  "settings.mcp.form.addRow": "Thêm hàng",
  "settings.mcp.form.removeRow": "Xóa",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID ứng dụng khách",
  "settings.mcp.form.oauth.clientSecret": "Mật khẩu ứng dụng khách",
  "settings.mcp.form.oauth.clientSecret.keep": "Đã cấu hình — để trống để giữ",
  "settings.mcp.form.oauth.scope": "Phạm vi",
  "settings.mcp.form.oauth.callbackPort": "Cổng callback",
  "settings.mcp.form.oauth.disableAutodetect": "Tắt tự động phát hiện OAuth",
  "settings.mcp.form.enabled": "Đã bật",
  "settings.mcp.form.timeout": "Thời gian chờ (ms)",
  "settings.mcp.form.save": "Lưu",
  "settings.mcp.form.cancel": "Hủy",
  "settings.mcp.form.error.name": "Nhập tên.",
  "settings.mcp.form.error.command": "Nhập lệnh.",
  "settings.mcp.form.error.url": "Nhập URL.",
  "settings.mcp.form.error.callbackPort": "Cổng callback phải từ 1 đến 65535.",
  "settings.mcp.form.error.timeout": "Thời gian chờ phải là số nguyên dương.",
  "settings.mcp.errors.invalid": "Sửa các trường được đánh dấu.",
  "settings.mcp.errors.duplicate": "Đã tồn tại máy chủ với tên này.",
  "settings.mcp.errors.noConfig": "Không thể đọc cấu hình của {{name}} — có thể định nghĩa ngoài dự án.",
  "settings.mcp.edit.warn": "Lưu sẽ kết nối lại máy chủ này.",
  ...
  "settings.plugins.detail.copied": "Đã sao chép",
  "settings.plugins.detail.notOnNpm": "Không tìm thấy trên npm — thêm thủ công vào opencode.json",
  "settings.plugins.install.title": "Cài đặt plugin",
  "settings.plugins.install.description": "Thêm {{name}} vào đâu?",
  "settings.plugins.install.global": "Toàn cục (~/.config/opencode)",
  "settings.plugins.install.project": "Dự án này",
  "settings.plugins.install.cancel": "Hủy",
  "settings.plugins.install.success": "Đã cài đặt {{name}}. Khởi động lại OpenCode để tải nó.",
  "settings.plugins.installed.empty": "Không có plugin nào được cài.",
  "settings.plugins.installed.provenance.global": "Toàn cục",
  "settings.plugins.installed.provenance.project": "Dự án",
  ...
  "settings.plugins.errors.catalog": "Không thể làm mới danh mục plugin.",
  "settings.plugins.stale": "Đang hiển thị danh mục đã lưu cache ({{age}} trước).",
