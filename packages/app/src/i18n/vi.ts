export const dict = {
  ...
  "command.session.handoff": "Chuyển giao phiên",
  "command.session.handoff.description": "Nén phiên và tiếp tục công việc trong phiên mới",
  ...
  "toast.session.handoff.failed.title": "Không thể chuyển giao phiên",
  "toast.session.handoff.failed.description": "Không thể tóm tắt phiên này để chuyển giao",
