export const dict = {
  ...
  "provider.custom.models.load": "Tải động",
  "provider.custom.models.loading": "Đang tải...",
  "provider.custom.models.load.invalidUrl": "Nhập URL cơ sở hợp lệ",
  "provider.custom.models.load.unauthorized": "Không được phép. Kiểm tra khóa API",
  "provider.custom.models.load.invalidFormat": "Phản hồi của máy chủ không chứa danh sách mô hình hợp lệ",
  "provider.custom.models.load.timeout": "Hết thời gian khi tải mô hình",
  "provider.custom.models.load.failed": "Tải mô hình thất bại",
  "provider.custom.models.load.empty": "Không tìm thấy mô hình",
