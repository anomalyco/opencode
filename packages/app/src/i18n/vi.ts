export const dict = {
  ...
  "session.tab.agents": "Subagent",
  "session.agents.empty": "Không có subagent đang chạy",
  "session.agents.costTotal": "Tổng chi phí",
  "session.agents.costSubagents": "Subagent",
  "session.agents.count": "Agent",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Hiển thị tất cả ({{count}})",
  "session.agents.status.idle": "Nhàn rỗi",
  "session.agents.status.busy": "Đang chạy",
  "session.agents.status.retry": "Đang thử lại",
  "session.agents.status.cancelled": "Đã hủy",
  "session.agents.status.completed": "Hoàn thành",
  "session.agents.status.error": "Thất bại",
