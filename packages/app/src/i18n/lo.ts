export const dict = {
  ...
  "provider.custom.models.load": "ໂຫຼດແບບພະລັງງານ",
  "provider.custom.models.loading": "ກຳລັງໂຫຼດ...",
  "provider.custom.models.load.invalidUrl": "ໃສ່ URL ພື້ນຖານທີ່ຖືກຕ້ອງ",
  "provider.custom.models.load.unauthorized": "ບໍ່ໄດ້ຮັບອະນຸຍາດ. ກວດສອບກະແຈ API",
  "provider.custom.models.load.invalidFormat": "ການຕອບສະໜອງຂອງເຊີບເວີບໍ່ແມ່ນລາຍການແບບທີ່ຖືກຕ້ອງ",
  "provider.custom.models.load.timeout": "ໝົດເວລາຂະນະໂຫຼດແບບ",
  "provider.custom.models.load.failed": "ໂຫຼດແບບບໍ່ສຳເລັດ",
  "provider.custom.models.load.empty": "ບໍ່ພົບແບບ",
