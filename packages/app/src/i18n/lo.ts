export const dict = {
  ...
  "command.session.background": "ແລ່ນຕົວແທນຍ່ອຍໃນພື້ນຫຼັງ",
  "command.session.background.description": "ປົດຕົວແທນຍ່ອຍທີ່ກີດຂວາງເຊດຊັນນີ້ ແລະ ໃຫ້ພວກມັນເຮັດວຽກຕໍ່ໃນພື້ນຫຼັງ",
  ...
  "toast.session.background.failed.title": "ບໍ່ສາມາດແລ່ນຕົວແທນຍ່ອຍໃນພື້ນຫຼັງໄດ້",
