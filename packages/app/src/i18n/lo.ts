export const dict = {
  ...
  "command.session.handoff": "ສົ່ງຕໍ່ເຊດຊັນ",
  "command.session.handoff.description": "ບີບອັດເຊດຊັນ ແລະສືບຕໍ່ວຽກໃນເຊດຊັນໃໝ່",
  ...
  "toast.session.handoff.failed.title": "ສົ່ງຕໍ່ເຊດຊັນບໍ່ສຳເລັດ",
  "toast.session.handoff.failed.description": "ບໍ່ສາມາດສະຫຼຸບເຊດຊັນນີ້ເພື່ອສົ່ງຕໍ່ໄດ້",
