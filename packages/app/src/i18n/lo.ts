export const dict = {
  ...
  "session.tab.agents": "ຕົວແທນຍ່ອຍ",
  "session.agents.empty": "ບໍ່ມີຕົວແທນຍ່ອຍໃດກຳລັງແລ່ນ",
  "session.agents.costTotal": "ຄ່າໃຊ້ຈ່າຍລວມ",
  "session.agents.costSubagents": "ຕົວແທນຍ່ອຍ",
  "session.agents.count": "ຕົວແທນ",
  "session.agents.tokens": "ໂທເຄັນ",
  "session.agents.showAll": "ສະແດງທັງໝົດ ({{count}})",
  "session.agents.status.idle": "ວ່າງ",
  "session.agents.status.busy": "ກຳລັງແລ່ນ",
  "session.agents.status.retry": "ລອງໃໝ່",
  "session.agents.status.cancelled": "ຍົກເລີກແລ້ວ",
  "session.agents.status.completed": "ສຳເລັດແລ້ວ",
  "session.agents.status.error": "ລົ້ມເຫລວ",
