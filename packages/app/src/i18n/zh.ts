...
export const dict = {
  ...
  "settings.mcp.status.needs_registration": "需要注册",
  "settings.mcp.status.unknown": "未知",
  "settings.mcp.loading": "加载 MCP 服务器中...",
  "settings.mcp.empty": "未配置 MCP 服务器",
  "settings.mcp.authenticate": "认证",
  "settings.mcp.retry": "重试",
  "settings.mcp.register": "注册",
  "settings.mcp.tools": "{count} 个工具",
  "settings.skills.title": "技能",
  "settings.skills.description": "管理和调用可用于 AI 助手的技能。",
  "settings.skills.section.available": "可用技能",
  "settings.skills.section.about": "关于技能",
  "settings.skills.empty": "未找到技能",
  "settings.skills.loading": "加载技能中...",
  "settings.skills.about.description": "技能为特定任务提供专业知识和分步指导。它们会自动从以下位置发现：",
  "settings.skills.about.item1": "项目级：.claude/skills/*/SKILL.md",
  "settings.skills.about.item2": "全局级：~/.claude/skills/*/SKILL.md",
  "settings.skills.about.item3": "OpenCode 格式：.opencode/skill/*/SKILL.md 或 .opencode/skills/*/SKILL.md",
  "settings.skills.dialog.description": "描述",
  "settings.skills.dialog.hint": "此技能在项目中处理相关任务时自动可用。",
  "settings.skills.dialog.content": "技能内容",
