...
export const dict = {
  ...
  "provider.custom.description.prefix": "配置与 OpenAI 兼容的提供商。输入端点后，应用会自动尝试发现模型。请查看",
  ...
  "provider.custom.field.baseURL.label": "API 端点",
  "provider.custom.field.baseURL.placeholder": "https://api.myprovider.com/v1",
  "provider.custom.field.baseURL.description": "应用会尝试 /models 和 /v1/models 来自动发现模型。",
  ...
  "provider.custom.models.refresh": "检测模型",
  ...
  "settings.providers.custom.description": "通过 API 端点添加与 OpenAI 兼容的提供商。",
