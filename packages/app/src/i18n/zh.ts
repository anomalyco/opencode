...
export const dict = {
  ...
  "toast.file.deleteFailed.title": "删除文件失败",
  ...
  "session.files.uploadFile": "上传文件",
  "session.files.uploading": "上传中…",
  "session.files.downloadFile": "下载",
  "session.files.refresh": "刷新",
  "session.files.dropFiles": "将文件拖到这里或点击 + 上传",
  "session.files.deleteConfirm": "删除 \"{{path}}\"？",
  "session.files.uploadTooLarge": "文件太大（最大 {{size}}）",
