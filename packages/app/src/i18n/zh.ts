...
export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode 菜单",
  "desktop.appMenu.file": "文件",
  "desktop.appMenu.edit": "编辑",
  "desktop.appMenu.view": "视图",
  "desktop.appMenu.go": "前往",
  "desktop.appMenu.window": "窗口",
  "desktop.appMenu.help": "帮助",
  "desktop.appMenu.about": "关于 OpenCode",
  "desktop.appMenu.checkForUpdates": "检查更新...",
  "desktop.appMenu.settings": "设置",
  "desktop.appMenu.reloadWebview": "重新加载 Webview",
  "desktop.appMenu.restart": "重启",
  "desktop.appMenu.exportLogs": "导出日志...",
  "desktop.appMenu.hide": "隐藏 OpenCode",
  "desktop.appMenu.hideOthers": "隐藏其他",
  "desktop.appMenu.showAll": "全部显示",
  "desktop.appMenu.quit": "退出 OpenCode",
  "desktop.appMenu.newSession": "新建会话",
  "desktop.appMenu.openProject": "打开项目...",
  "desktop.appMenu.newWindow": "新建窗口",
  "desktop.appMenu.closeWindow": "关闭窗口",
  "desktop.appMenu.undo": "撤销",
  "desktop.appMenu.redo": "重做",
  "desktop.appMenu.cut": "剪切",
  "desktop.appMenu.copy": "复制",
  "desktop.appMenu.paste": "粘贴",
  "desktop.appMenu.delete": "删除",
  "desktop.appMenu.selectAll": "全选",
  "desktop.appMenu.toggleSidebar": "切换侧边栏",
  "desktop.appMenu.toggleTerminal": "切换终端",
  "desktop.appMenu.toggleFileTree": "切换文件树",
  "desktop.appMenu.reload": "重新加载",
  "desktop.appMenu.toggleDeveloperTools": "切换开发者工具",
  "desktop.appMenu.actualSize": "实际大小",
  "desktop.appMenu.zoomIn": "放大",
  "desktop.appMenu.zoomOut": "缩小",
  "desktop.appMenu.toggleFullScreen": "切换全屏",
  "desktop.appMenu.back": "后退",
  "desktop.appMenu.forward": "前进",
  "desktop.appMenu.previousSession": "上一个会话",
  "desktop.appMenu.nextSession": "下一个会话",
  "desktop.appMenu.previousProject": "上一个项目",
  "desktop.appMenu.nextProject": "下一个项目",
  "desktop.appMenu.minimize": "最小化",
  "desktop.appMenu.zoomWindow": "缩放",
  "desktop.appMenu.maximize": "最大化",
  "desktop.appMenu.bringAllToFront": "将全部移到最前面",
  "desktop.appMenu.documentation": "OpenCode 文档",
  "desktop.appMenu.supportForum": "支持论坛",
  "desktop.appMenu.shareFeedback": "提供反馈",
  "desktop.appMenu.reportBug": "报告错误",
