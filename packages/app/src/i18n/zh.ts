...
export const dict = {
  ...
  "provider.custom.models.load": "动态加载",
  "provider.custom.models.loading": "加载中...",
  "provider.custom.models.load.invalidUrl": "请输入有效的基础 URL",
  "provider.custom.models.load.unauthorized": "未授权。请检查 API 密钥",
  "provider.custom.models.load.invalidFormat": "服务器响应不是有效的模型列表",
  "provider.custom.models.load.timeout": "加载模型超时",
  "provider.custom.models.load.failed": "加载模型失败",
  "provider.custom.models.load.empty": "未找到模型",
