...
export const dict = {
  ...
  "dialog.provider.deepseek.note": "DeepSeek 对话与推理模型，性价比高",
  "dialog.provider.alibaba.note": "通义千问（DashScope），国内常用大模型",
  "dialog.provider.moonshot.note": "月之暗面 Kimi，长上下文能力强",
  "dialog.provider.zhipuai.note": "智谱 GLM 系列模型",
  "dialog.provider.siliconflow.note": "硅基流动，聚合多家开源与商业模型",
  "dialog.provider.minimax.note": "MiniMax 海螺模型",
  "dialog.provider.302ai.note": "302.AI 一站式模型 API 网关",
  "dialog.provider.qiniu.note": "七牛云 AI 推理服务",
