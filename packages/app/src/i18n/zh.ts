...
export const dict = {
  ...
  "home.activity.title": "令牌活动",
  "home.activity.daily": "每日",
  "home.activity.weekly": "每周",
  "home.activity.cumulative": "累计",
  "home.activity.loading": "加载活动中",
  "home.activity.empty": "暂无令牌活动",
  "home.activity.lifetimeTokens": "总令牌数",
  "home.activity.peakTokens": "峰值令牌",
  "home.activity.longestTask": "最长任务",
  "home.activity.currentStreak": "当前连续",
  "home.activity.longestStreak": "最长连续",
  "home.activity.days.one": "{{count}} 天",
  "home.activity.days.other": "{{count}} 天",
  "home.activity.summary": "{{tokens}} 总令牌，{{peak}} 峰值令牌，{{current}} 当前连续，{{longest}} 最长连续。",
  "home.title": "主页",
  "home.projects": "项目",
