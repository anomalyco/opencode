...
"command.project.index": "切换到项目 {{index}}",
  ...
  "session.child.promptDisabled": "子智能体会话无法被提示。",
  ...
  "settings.general.row.newLayoutDesigns.title": "新布局与设计",
  ...
  "settings.general.row.shell.description": "选择终端使用的 Shell（仅影响在 OpenCode 中打开的终端）",
  ...
  "settings.general.row.showNavigation.description": "显示后退和前进按钮，用于在会话历史中导航",
  ...
  "sidebar.empty.description": "打开项目开始使用",
  "sidebar.empty.title": "暂无项目打开",
  ...
  "wsl.onboarding.openDistroOnce": "请启动一次 {{distro}} 以完成设置。",
  ...
  "wsl.onboarding.pickDistro": "选择一个发行版或安装一个。",
  ...
  "wsl.onboarding.versionMismatch": "已安装的版本与桌面应用版本不匹配。",
