...
export const dict = {
  ...
  "command.session.handoff": "交接会话",
  "command.session.handoff.description": "精简会话并在新会话中继续工作",
  ...
  "toast.session.handoff.failed.title": "交接会话失败",
  "toast.session.handoff.failed.description": "无法总结此会话以进行交接",
