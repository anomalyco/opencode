...
export const dict = {
  ...
  "monitor.title": "监控",
  "monitor.tab.kanban": "看板",
  "monitor.tab.health": "健康度",
  "monitor.tab.workflows": "工作流",
  "monitor.tab.alerts": "告警",
  "monitor.tab.channels": "通知渠道",
  "monitor.kanban.working": "运行中",
  "monitor.kanban.waiting": "等待中",
  "monitor.kanban.completed": "已完成",
  "monitor.kanban.error": "出错",
  "monitor.kanban.abandoned": "已弃置",
  "monitor.kanban.view.sessions": "会话",
  "monitor.kanban.view.agents": "代理",
  "monitor.kanban.empty": "暂无内容。",
  "monitor.health.title": "综合健康度",
  "monitor.health.formula": "0.40 × 成功率 + 0.25 × 缓存命中 + 0.25 × (100 − 错误率) + 0.10 × (100 − 堆占用)",
  "monitor.health.success_rate": "成功率",
  "monitor.health.cache_hit_rate": "缓存命中",
  "monitor.health.error_rate": "错误率",
  "monitor.health.heap_pct": "堆占用",
  "monitor.workflows.title": "工作流",
  "monitor.workflows.status_active": "仅进行中",
  "monitor.workflows.status_completed": "已完成",
  "monitor.workflows.status_all": "全部",
  "monitor.alerts.title": "告警",
  "monitor.alerts.create": "新建规则",
  "monitor.alerts.types.event-pattern": "事件匹配",
  "monitor.alerts.types.inactivity": "无活动",
  "monitor.alerts.types.stuck-agent": "代理卡住",
  "monitor.alerts.types.token-threshold": "Token 阈值",
  "monitor.alerts.fields.name": "名称",
  "monitor.alerts.fields.cooldown": "冷却(秒)",
  "monitor.alerts.fields.enabled": "启用",
  "monitor.alerts.activity": "告警记录",
  "monitor.alerts.acked": "确认",
  "monitor.alerts.acked_all": "全部确认",
  "monitor.alerts.only_unacked": "仅显示未确认",
  "monitor.channels.title": "通知渠道",
  "monitor.channels.create": "添加渠道",
  "monitor.channels.test": "发送测试",
  ...
  "monitor.channels.providers.generic": "自定义",
  "monitor.tabby.panel_title": "Tabby",
  "monitor.tabby.live": "{{n}} 运行中",
  "monitor.tabby.errored": "{{n}} 出错",
  "monitor.tabby.ask": "问",
  "monitor.tabby.ask_placeholder": "现在有什么在跑?有错误吗?",
  "monitor.tabby.mute": "静音气泡",
  "monitor.tabby.clear_alerts": "清除告警",
  "monitor.common.loading": "加载中…",
  "monitor.common.empty": "暂无数据。",
  "monitor.common.refresh": "刷新",
  "monitor.common.save": "保存",
  "monitor.common.cancel": "取消",
  "monitor.common.delete": "删除",
  "monitor.common.view_session": "查看会话 →",
