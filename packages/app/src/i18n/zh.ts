...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Argus 加载失败",
  "desktop.recovery.terminated": "Argus 窗口意外终止",
  "desktop.recovery.unresponsive": "Argus 未响应",
  ...
  "desktop.wsl.error.installArgus": "Argus 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.argusMissing": "此发行版中未安装 argus",
  "desktop.wsl.error.argusCannotRun": "已安装 argus，但无法运行",
  "desktop.wsl.error.argusNotInstalled": "{{distro}} 中未安装 Argus",
  "desktop.wsl.error.updateVersion":
    "Argus 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.argus.note": "精选模型，包括 Claude、GPT、Gemini 等",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Argus 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Argus 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Argus 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.checkingArgus": "正在检查 Argus...",
  "wsl.onboarding.checkingArgusIn": "正在检查 {{distro}} 中的 Argus...",
  "wsl.onboarding.updatingArgus": "正在更新 Argus...",
  "wsl.onboarding.updatingArgusIn": "正在更新 {{distro}} 中的 Argus...",
  "wsl.onboarding.updateArgusIn": "更新 {{distro}} 中的 Argus。",
  "wsl.onboarding.updateArgus": "更新 Argus",
  "wsl.onboarding.argusReadyIn": "{{distro}} 中的 Argus 已就绪。",
  "wsl.onboarding.argusReady": "Argus 已就绪。",
  "wsl.onboarding.installArgusIn": "在 {{distro}} 中安装 Argus。",
  "wsl.onboarding.installArgus": "安装 Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "未安装 Argus",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Argus 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Argus 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Argus。",
  ...
  "help.tabs.introduction": "Argus Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "settings.general.row.colorScheme.description": "选择 Argus 跟随系统、浅色或深色主题",
