...
export const dict = {
  ...
  "settings.permissions.tool.bash_unsandboxed.title": "Bash（无沙箱）",
  "settings.permissions.tool.bash_unsandboxed.description": "在没有沙箱限制的情况下重试 shell 命令",
  "settings.permissions.tool.bash_unsandboxed_network.title": "Bash（无沙箱）",
  "settings.permissions.tool.bash_unsandboxed_network.description":
    "沙箱网络已被禁用，因此上一次尝试可能因沙箱而失败。",
  "settings.permissions.tool.bash_unsandboxed_explicit.title": "Bash（无沙箱）",
  "settings.permissions.tool.bash_unsandboxed_explicit.description": "该命令请求在没有沙箱限制的情况下运行。",
