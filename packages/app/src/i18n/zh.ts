...
export const dict = {
  ...
  "menu.view.toggleFileTree": "切换文件树",
  ...
  "menu.go.back": "后退",
  "menu.go.forward": "前进",
  "menu.go.previousSession": "上一个会话",
  "menu.go.nextSession": "下一个会话",
  "menu.go.previousProject": "上一个项目",
  "menu.go.nextProject": "下一个项目",

  "menu.window.minimize": "最小化",
  "menu.window.maximize": "最大化",
  "menu.window.closeWindow": "关闭窗口",

  "menu.help.documentation": "OpenCode 文档",
  "menu.help.supportForum": "支持论坛",
  "menu.help.exportLogs": "导出日志...",
  "menu.help.shareFeedback": "分享反馈",
  "menu.help.reportBug": "报告 Bug",

  "menu.app.about": "关于 OpenCode",
  "menu.app.checkUpdates": "检查更新...",
  "menu.app.settings": "设置",
  "menu.app.reloadWebview": "重新加载页面",
  "menu.app.restart": "重启",
  "menu.app.exportLogs": "导出日志...",
  "menu.app.hide": "隐藏 OpenCode",
  "menu.app.hideOthers": "隐藏其他",
  "menu.app.showAll": "显示全部",
  "menu.app.quit": "退出 OpenCode",
