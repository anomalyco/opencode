...
export const dict = {
  ...
  "wsl.onboarding.openDistroOnce": "请打开 {{distro}} 一次以完成设置。",
  ...
  "wsl.onboarding.opencodeReadyIn": "OpenCode 在 {{distro}} 中已就绪。",
  ...
  "wsl.onboarding.windowsRestartRequired": "请重启 Windows 以完成 WSL 安装，然后重新打开 OpenCode。",
  ...
  "settings.general.row.shell.description": "选择终端使用的 Shell。兼容的 Shell 也用于智能体工具调用。",
  ...
  "settings.general.row.showCustomAgents.description": "在 v2 桌面编辑器中显示智能体选择器",
  "settings.general.row.newLayoutDesigns.title": "新布局和设计",
  "settings.general.row.newLayoutDesigns.description": "启用重新设计的布局、主页、编辑器和会话界面",
  "settings.general.row.pinchZoom.title": "捏合缩放",
  "settings.general.row.pinchZoom.description": "允许触控板捏合和 Ctrl+滚动手势进行缩放",
