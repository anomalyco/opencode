...
export const dict = {
  ...
  "provider.custom.models.context.label": "上下文大小",
  "provider.custom.models.context.placeholder": "上下文大小",
  "provider.custom.models.output.label": "最大输出",
  "provider.custom.models.output.placeholder": "最大输出",
  "provider.custom.models.reasoning.label": "支持推理",
