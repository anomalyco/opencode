...
export const dict = {
  ...
  "prompt.action.voice.start": "开始语音输入",
  "prompt.action.voice.stop": "停止语音输入",
  "prompt.voice.listening": "正在聆听...",
  "prompt.voice.processing": "正在处理...",
  "prompt.voice.error": "语音输入错误",
  "prompt.voice.notSupported": "此浏览器不支持语音输入",
  "command.prompt.voice.toggle": "切换语音输入",
  "command.prompt.voice.toggle.description": "开始或停止提示的语音输入",
