...
export const dict = {
  ...
  "dialog.provider.opencode.note": "包含 Claude、GPT、Gemini 等精选优化模型",
  "dialog.provider.opencode.tagline": "可靠的优化模型",
  "dialog.provider.opencodeGo.tagline": "适合所有人的低成本订阅",
  "dialog.provider.anthropic.note": "直接访问 Claude 模型，包括 Pro 和 Max",
  "dialog.provider.copilot.note": "通过 GitHub Copilot 提供代码辅助 AI 模型",
  "dialog.provider.openai.note": "GPT 模型，快速且功能强大，适合通用 AI 任务",
  "dialog.provider.google.note": "Gemini 模型，响应迅速，结构化输出",
  "dialog.provider.openrouter.note": "通过一个提供商访问所有支持的模型",
  "dialog.provider.vercel.note": "通过智能路由统一访问 AI 模型",
  ...
  "settings.permissions.tool.doom_loop.title": "死循环检测",
  ...
  "session.child.promptDisabled": "子智能体会话无法接受提示。",
  ...
  "settings.general.row.showNavigation.description": "在桌面标题栏中显示返回和前进按钮",
