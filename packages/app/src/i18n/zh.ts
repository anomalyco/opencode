...
export const dict = {
  ...
  "settings.general.row.contentMaxWidth.title": "内容宽度",
  "settings.general.row.contentMaxWidth.description": "设置聊天内容区域的最大宽度。设为全宽可使用整个窗口。",
  "settings.general.row.contentMaxWidth.fullWidth": "全宽",
