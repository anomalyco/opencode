...
export const dict = {
  ...
  "presets.title": "常用语",
  "presets.manage": "管理常用语",
  "presets.count": "共 {{count}} 条常用语",
  "presets.empty": "暂无常用语",
  "presets.empty.hint": "点击「新增」添加你的第一条常用语",
  "presets.add": "新增",
  "presets.name": "名称",
  "presets.content": "内容",
  "presets.content.placeholder": "内容（支持 {date} {time} {file} {code} {text} 等变量）",
  "presets.moveUp": "上移",
  "presets.moveDown": "下移",
  "presets.edit": "编辑",
  "presets.delete": "删除",
  "presets.variables.title": "输入「{{name}}」的变量",
  "presets.variables.next": "下一个",
