...
export const dict = {
  ...
  "settings.mods.title": "模组",
  "settings.mods.openFolder": "打开文件夹",
  "settings.mods.refresh": "刷新",
  "settings.mods.safeMode.title": "安全模式",
  "settings.mods.safeMode.description": "在重新启用 MOD 加载前，禁用所有模组。",
  "settings.mods.empty": "MOD 文件夹中未找到模组。",
  "settings.mods.versionPriority": "v{{version}} · 优先级 {{priority}}",
  "settings.mods.versionIncompatible": "v{{version}} · 与当前 OpenCode 版本不兼容",
  "settings.mods.conflict.title": "模组加载冲突",
  "settings.mods.conflict.description": "{{mod}} 与已启用模组的贡献内容重叠。优先级更高的模组会在后加载，并在加载顺序能够解决重叠时生效。",
  "settings.mods.conflict.declared": "已声明冲突",
  "settings.mods.conflict.potential": "潜在冲突",
  "settings.mods.conflict.cancel": "取消",
  "settings.mods.conflict.repair": "使用 AI 修复",
  "settings.mods.conflict.keepPriority": "保留现有优先级",
  "settings.mods.conflict.prioritize": "优先 {{mod}}",
