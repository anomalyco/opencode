...
export const dict = {
  ...
  "session.new.branch.search": "搜索分支",
  "session.new.branch.checkout": "切换到",
  "session.new.branch.base": "基于分支",
  "session.new.branch.local": "本地",
  "session.new.branch.empty": "没有分支",
  "session.new.branch.switchFailed": "切换分支失败",
