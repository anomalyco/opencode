...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Pencode 加载失败",
  "desktop.recovery.terminated": "Pencode 窗口意外终止",
  "desktop.recovery.unresponsive": "Pencode 未响应",
  ...
  "desktop.wsl.error.installPencode": "Pencode 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.pencodeMissing": "此发行版中未安装 pencode",
  "desktop.wsl.error.pencodeCannotRun": "已安装 pencode，但无法运行",
  "desktop.wsl.error.pencodeNotInstalled": "{{distro}} 中未安装 Pencode",
  "desktop.wsl.error.updateVersion":
    "Pencode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.pencode.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.pencode.tagline": "可靠的优化模型",
  "dialog.provider.pencodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Pencode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.pencodeZen.line1": "Pencode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.pencodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.pencodeZen.visit.prefix": "访问 ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Pencode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Pencode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 pencode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Pencode 服务器。",
  ...
  "wsl.onboarding.checkingPencode": "正在检查 Pencode...",
  "wsl.onboarding.checkingPencodeIn": "正在检查 {{distro}} 中的 Pencode...",
  "wsl.onboarding.updatingPencode": "正在更新 Pencode...",
  "wsl.onboarding.updatingPencodeIn": "正在更新 {{distro}} 中的 Pencode...",
  "wsl.onboarding.updatePencodeIn": "更新 {{distro}} 中的 Pencode。",
  "wsl.onboarding.updatePencode": "更新 Pencode",
  "wsl.onboarding.pencodeReadyIn": "{{distro}} 中的 Pencode 已就绪。",
  "wsl.onboarding.pencodeReady": "Pencode 已就绪。",
  "wsl.onboarding.installPencodeIn": "在 {{distro}} 中安装 Pencode。",
  "wsl.onboarding.installPencode": "安装 Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "未安装 Pencode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Pencode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Pencode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Pencode。",
  ...
  "help.tabs.introduction": "Pencode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Pencode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (pencode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Pencode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Pencode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Pencode 服务器。",
  ...
  "settings.general.row.language.description": "更改 Pencode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Pencode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Pencode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Pencode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Pencode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Pencode。",
