...
export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "无效的 SSH 主机：{{host}}",
  "desktop.ssh.error.alreadyAdded": "已添加 {{host}}",
  "desktop.ssh.error.opencodeNotInstalled": "{{host}} 上未安装 opencode",
  "desktop.ssh.error.installOpencode": "opencode 安装失败",
  "desktop.ssh.error.connectFailed": "无法连接到 {{host}}",
  "desktop.ssh.error.serverExited": "SSH 服务器启动后退出（code={{code}} signal={{signal}}）",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}} 的 SSH 服务器在进入正常状态前退出（code={{code}} signal={{signal}}）{{output}}",
  "desktop.ssh.error.healthTimeout": "{{host}} 上的服务器运行状况检查在 {{timeout}}ms 后超时",
  "desktop.ssh.error.commandTimeout": "发送到 {{host}} 的 ssh 命令在 {{timeout}}ms 后超时",
  "desktop.ssh.error.failedPort": "无法获取端口",
  "desktop.ssh.error.terminalFailed": "无法打开终端",
  ...
  "ssh.server.add": "添加 SSH 服务器",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH 服务器",
  "ssh.server.retryStart": "重新连接",
  "ssh.server.disconnect": "断开连接",
  "ssh.server.openTerminal": "打开终端",
  "ssh.server.updating": "正在更新...",
  "ssh.server.status.connecting": "正在连接...",
  "ssh.server.status.disconnected": "已断开连接",
  "ssh.add.hostLabel": "SSH 主机",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint": "通过系统的 ssh 客户端连接，因此 SSH 配置中的主机、密钥和代理均可照常使用。",
  "ssh.add.configHosts": "来自你的 SSH 配置",
  "ssh.add.connect": "连接",
  "ssh.add.checking": "正在连接...",
  "ssh.add.addServer": "添加服务器",
  "ssh.add.adding": "正在添加...",
  "ssh.add.installOpencode": "安装 opencode",
  "ssh.add.updateOpencode": "更新 opencode",
  "ssh.add.installing": "正在安装...",
  "ssh.add.status.unreachable": "无法连接",
  "ssh.add.status.opencodeMissing": "此主机上未安装 opencode",
  "ssh.add.status.opencodeMismatch": "已安装 opencode v{{version}}，桌面版预期为 v{{expected}}",
  "ssh.add.status.opencodeFound": "已找到 opencode v{{version}}",
  "ssh.add.authHint": "请确保此主机可使用基于密钥的 SSH 认证，在终端中运行 `ssh {{host}}` 即可检查。",
