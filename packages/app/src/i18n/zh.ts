...
export const dict = {
  ...
  "dialog.project.archive.title": "归档项目",
  "dialog.project.archive.description":
    "这将从项目列表中隐藏 {{name}}。项目和其会话仍保留在数据库中。重新打开项目目录即可恢复。",
  "dialog.project.archive.confirm": "归档",
  ...
  "home.title": "主页",
  "home.projects": "项目",
  "home.projects.archived": "已归档项目",
  "home.projects.archived.expand": "显示已归档项目",
  "home.projects.archived.collapse": "隐藏已归档项目",
  "home.projects.archived.empty": "没有已归档项目",
