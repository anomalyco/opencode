...
export const dict = {
  ...
  "session.messages.timelineNavigation": "消息导航",
  "session.messages.jumpToMessage": "跳转到第 {{index}} 条消息",
  ...
  "settings.general.row.preloadTimelineHistory.title": "预加载完整消息历史",
  "settings.general.row.preloadTimelineHistory.description": "在后台加载更早的消息，让消息导航覆盖整个会话。",
