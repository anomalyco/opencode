...
export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "查看 70 多个其他提供商",
  ...
  "session.tab.agents": "子代理",
  "session.agents.empty": "没有运行中的子代理",
  "session.agents.costTotal": "总费用",
  "session.agents.costSubagents": "子代理",
  "session.agents.count": "代理",
  "session.agents.tokens": "Token",
  "session.agents.showAll": "显示全部 ({{count}})",
  "session.agents.status.idle": "空闲",
  "session.agents.status.busy": "运行中",
  "session.agents.status.retry": "重试中",
  "session.agents.status.cancelled": "已取消",
  "session.agents.status.completed": "已完成",
  "session.agents.status.error": "失败",
