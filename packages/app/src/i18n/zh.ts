...
export const dict = {
  ...
  "dialog.newProject.tab.github": "从 GitHub 导入",
  "dialog.newProject.tab.folder": "从文件夹导入",
  "dialog.newProject.url.label": "仓库 URL",
  "dialog.newProject.destination.label": "克隆目标",
  "dialog.newProject.destination.placeholder": "选择目标文件夹",
  "dialog.newProject.destination.browse": "浏览",
  "dialog.newProject.destination.pick": "选择克隆目标",
  "dialog.newProject.clone": "克隆仓库",
  "dialog.newProject.cloning": "克隆中...",
  "dialog.newProject.error.cloneFailed": "克隆仓库失败",
  "dialog.newProject.folder.title": "打开现有项目",
  "dialog.newProject.folder.description": "选择一个本地文件夹作为项目添加到 OpenCode。",
  "dialog.newProject.folder.action": "选择文件夹",
