...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 xcsh Zen 或 API 密钥连接",
  ...
  "provider.connect.xcshZen.line1": "xcsh Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.xcshZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.xcshZen.visit.prefix": "访问 ",
  "provider.connect.xcshZen.visit.link": "f5xc-salesdemos.github.io/xcsh/zen",
  "provider.connect.xcshZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 xcsh.json 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (xcsh.json) 中的 provider/model 名称",
