...
export const dict = {
  ...
  "sidebar.issue.title": "待办",
  "sidebar.issue.add": "添加待办",
  "sidebar.issue.addSubtodo": "添加子待办",
  "sidebar.issue.empty": "暂无待办",
  "sidebar.issue.collapse": "折叠子待办",
  "sidebar.issue.expand": "展开子待办",
  "sidebar.issue.confirmDeleteWithChildren": "删除此待办及其 {{count}} 个子待办？",
  "sidebar.issue.toast.deleteFailed": "删除待办失败",
  "sidebar.issue.tooltip.cycleStatus": "切换状态",
  "sidebar.issue.tooltip.cyclePriority": "切换优先级",
  "sidebar.issue.tooltip.linkedLinear": "已关联 Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "已连接",
  "sidebar.linear.management": "管理 Linear 绑定",
  "sidebar.linear.management.teamRequired": "请选择团队",
  "sidebar.linear.management.projectRequired": "请选择项目",
  "sidebar.linear.management.saveFailed": "保存 Linear 绑定失败",
  "sidebar.linear.management.saved": "Linear 绑定已保存",
  "sidebar.linear.management.save": "保存",
  "sidebar.linear.toggleHistory": "切换同步历史",
  "sidebar.linear.field.team": "团队",
  "sidebar.linear.field.team.loading": "正在加载团队...",
  "sidebar.linear.field.team.placeholder": "选择团队",
  "sidebar.linear.field.project": "项目",
  "sidebar.linear.field.project.selectTeamFirst": "请先选择团队",
  "sidebar.linear.field.project.loading": "正在加载项目...",
  "sidebar.linear.field.project.placeholder": "选择项目",
  "sidebar.linear.notConfigured": "Linear 未配置",
  "sidebar.linear.notConfiguredHint": "打开管理面板选择团队和项目",
  "sidebar.linear.actions": "同步操作",
  "sidebar.linear.push": "推送",
  "sidebar.linear.pull": "拉取",
  "sidebar.linear.pullHint": "从 Linear 拉取。注意：在 Linear 上做的层级变更（重新指定父级、移除父级）不会同步到本地，仅同步字段值。",
  "sidebar.linear.pullFailed": "从 Linear 拉取失败",
  "sidebar.linear.pullPartialFailed": "拉取部分失败：{{count}} 个错误",
  "sidebar.linear.pullSuccess": "拉取 {{pulled}}，更新 {{updated}}，跳过 {{skipped}}，删除 {{deleted}}",
  "sidebar.linear.pushFailed": "推送到 Linear 失败",
  "sidebar.linear.pushPartialFailed": "推送部分失败：{{count}} 个错误",
  "sidebar.linear.pushSuccess": "已推送 {{count}} 个待办到 Linear",
  "sidebar.linear.pushNothing": "没有需要推送的内容",
  "sidebar.linear.syncHistory.syncing": "同步中...",
  "sidebar.linear.syncHistory.error": "错误",
  "sidebar.linear.syncHistory.empty": "暂无同步历史",
  "dialog.todo.title.create": "新建待办",
  "dialog.todo.title.edit": "编辑待办",
  "dialog.todo.field.title": "标题",
  "dialog.todo.field.title.placeholder": "待办标题",
  "dialog.todo.field.description": "描述",
  "dialog.todo.field.description.placeholder": "添加详情、链接或上下文...",
  "dialog.todo.field.description.hint": "支持文件和技能引用",
  "dialog.todo.field.status": "状态",
  "dialog.todo.field.priority": "优先级",
  "dialog.todo.field.dueDate": "截止日期",
  "dialog.todo.field.dueDate.placeholder": "设置截止日期",
  "dialog.todo.field.dueDate.clear": "清除",
  "dialog.todo.field.dueDate.prevMonth": "上个月",
  "dialog.todo.field.dueDate.nextMonth": "下个月",
  "dialog.todo.field.dueDate.shortcut.today": "今天",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "明天",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "一周后",
  "dialog.todo.field.dueDate.month.0": "1月",
  "dialog.todo.field.dueDate.month.1": "2月",
  "dialog.todo.field.dueDate.month.2": "3月",
  "dialog.todo.field.dueDate.month.3": "4月",
  "dialog.todo.field.dueDate.month.4": "5月",
  "dialog.todo.field.dueDate.month.5": "6月",
  "dialog.todo.field.dueDate.month.6": "7月",
  "dialog.todo.field.dueDate.month.7": "8月",
  "dialog.todo.field.dueDate.month.8": "9月",
  "dialog.todo.field.dueDate.month.9": "10月",
  "dialog.todo.field.dueDate.month.10": "11月",
  "dialog.todo.field.dueDate.month.11": "12月",
  "dialog.todo.field.dueDate.weekday.0": "日",
  "dialog.todo.field.dueDate.weekday.1": "一",
  "dialog.todo.field.dueDate.weekday.2": "二",
  "dialog.todo.field.dueDate.weekday.3": "三",
  "dialog.todo.field.dueDate.weekday.4": "四",
  "dialog.todo.field.dueDate.weekday.5": "五",
  "dialog.todo.field.dueDate.weekday.6": "六",
  "dialog.todo.field.labels": "标签",
  "dialog.todo.field.assignee": "指派人",
  "dialog.todo.field.assignee.unassigned": "未指派",
  "dialog.todo.field.assignee.loadFailed": "加载指派人失败",
  "dialog.todo.field.assignee.loading": "正在加载指派人...",
  "dialog.todo.field.assignee.placeholder": "选择指派人",
  "dialog.todo.field.assignee.hint": "来源于 Linear 团队成员",
  "dialog.todo.linkedLinear": "已关联 Linear",
  "dialog.todo.created": "待办已创建",
  "dialog.todo.updated": "待办已更新",
  "dialog.todo.error.titleRequired": "标题为必填项",
  "dialog.todo.error.saveFailed": "保存待办失败",
  "dialog.todo.action.create": "创建",
  ...
  "sidebar.issue.priority.none": "无",
  "sidebar.issue.priority.urgent": "紧急",
  "sidebar.issue.priority.high": "高",
  "sidebar.issue.priority.medium": "中等",
  "sidebar.issue.priority.low": "低",
  "sidebar.issue.toast.archiveFailed": "归档待办失败",
  "sidebar.issue.toast.reorderFailed": "重新排序待办失败",
  "sidebar.issue.toast.reparentFailed": "移动待办失败",
  "sidebar.issue.tooltip.archive": "归档此待办",
  "sidebar.issue.tooltip.delete": "删除此待办",
  "sidebar.issue.confirmArchive": "归档",
  "sidebar.issue.archivedBadge": "已归档",
  "sidebar.issue.archiveArea.title": "已归档",
  "sidebar.issue.archiveArea.expand": "显示已归档",
  "sidebar.issue.archiveArea.collapse": "隐藏已归档",
  "sidebar.issue.archiveArea.empty": "暂无已归档待办",
