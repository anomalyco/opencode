...
export const dict = {
  ...
  "settings.general.section.modelRace": "模型竞速",
  "session.modelRace.title": "模型竞速",
  "session.modelRace.candidates": "{{count}} 个候选模型",
  "session.modelRace.leader": "当前领先",
  "session.modelRace.winner": "胜出模型",
  "session.modelRace.ttft": "首 Token",
  "session.modelRace.tps": "{{count}} tok/s",
  "session.modelRace.toolCall": "工具调用",
  "session.modelRace.ready": "等待下一次生成",
  "session.modelRace.manage": "管理模型竞速",
  "session.modelRace.manageTitle": "管理模型竞速",
  "session.modelRace.manageDescription": "配置当前 OpenCode 实例的模型竞速设置。",
  "session.modelRace.details": "详情",
  "session.modelRace.hideDetails": "收起详情",
  "session.modelRace.state": "状态",
  "session.modelRace.phase": "竞速阶段",
  "session.modelRace.reason": "锁定原因",
  "session.modelRace.outputTokens": "输出 Token",
  "session.modelRace.speed": "速度",
  "session.modelRace.elapsed": "竞速耗时",
  ...
  "settings.general.modelRace.enabled.title": "启用模型竞速",
  "settings.general.modelRace.enabled.description": "每次 LLM 生成同时请求多个候选模型，并只提交一个获胜结果",
  "settings.general.modelRace.models.title": "候选模型",
  "settings.general.modelRace.models.description": "选择参与每次竞速的模型",
  "settings.general.modelRace.models.select": "选择模型",
  "settings.general.modelRace.models.selected": "已选择：{{count}}",
  "settings.general.modelRace.firstToken.title": "首 Token 领先模型",
  "settings.general.modelRace.firstToken.description": "第一个有效 Token 对应的模型成为临时领先者",
  "settings.general.modelRace.throughput.title": "吞吐量切换",
  "settings.general.modelRace.throughput.description": "允许持续生成速度更快的模型替换临时领先者",
  "settings.general.modelRace.toolCall.title": "工具调用锁定",
  "settings.general.modelRace.toolCall.description": "候选模型产生完整 Tool Call 时立即锁定竞速",
  "settings.general.modelRace.warmup.title": "预热 Token 数",
  "settings.general.modelRace.warmup.description": "开始测量吞吐量前忽略的 Token 数量",
  "settings.general.modelRace.window.title": "测量窗口",
  "settings.general.modelRace.window.description": "每次测量吞吐量的时间窗口",
  "settings.general.modelRace.switch.title": "允许切换领先模型",
  "settings.general.modelRace.switch.description": "允许竞速过程中临时领先者发生变化",
  "settings.general.modelRace.unsaved": "模型竞速配置有未保存的修改",
  "settings.general.modelRace.action.reset": "恢复默认值",
