...
export const dict = {
  ...
  "status.tab.servers.one": "{{count}} 个服务器",
  "status.tab.servers.other": "{{count}} 个服务器",
  "status.tab.mcp.one": "{{count}} 个 MCP",
  "status.tab.mcp.other": "{{count}} 个 MCP",
  "status.tab.lsp.one": "{{count}} 个 LSP",
  "status.tab.lsp.other": "{{count}} 个 LSP",
  "status.tab.plugins.one": "{{count}} 个插件",
  "status.tab.plugins.other": "{{count}} 个插件",
  "status.servers.empty": "未配置服务器",
  "status.servers.manage": "管理服务器",
  "status.mcp.empty": "未配置 MCP 服务器",
  "status.lsp.empty": "没有活跃的 LSP 服务器",
  "status.plugins.empty": "在 'opencode.json' 中配置插件",
