...
export const dict = {
  ...
  "home.recentlyClosed.options": "筛选和排序",
  "home.recentlyClosed.filter.label": "筛选",
  "home.recentlyClosed.filter.recent": "最近",
  "home.recentlyClosed.filter.archived": "已归档",
  "home.recentlyClosed.filter.hidden": "已隐藏",
  "home.recentlyClosed.filter.all": "全部",
  "home.recentlyClosed.filter.empty": "没有符合此筛选条件的项目",
  "home.recentlyClosed.sort.label": "排序",
  "home.recentlyClosed.sort.recent": "最新优先",
  "home.recentlyClosed.sort.oldest": "最旧优先",
  "home.recentlyClosed.sort.nameAsc": "名称 A–Z",
  "home.recentlyClosed.sort.nameDesc": "名称 Z–A",
  "home.recentlyClosed.search.placeholder": "搜索最近关闭的项目",
  "home.recentlyClosed.showMore": "显示全部（{{count}}）",
  "home.recentlyClosed.showLess": "收起",
  "home.recentlyClosed.select": "选择…",
  "home.recentlyClosed.selectAll": "全选",
  "home.recentlyClosed.deselectAll": "取消全选",
  "home.recentlyClosed.cancelSelection": "取消选择",
  "home.recentlyClosed.selected": "已选择 {{count}} 项",
  "home.recentlyClosed.noResults": "没有与“{{query}}”匹配的项目",
  "home.recentlyClosed.archived.badge": "已归档",
  "home.recentlyClosed.hidden.badge": "已隐藏",
  "home.recentlyClosed.action.reopen": "重新打开",
  "home.recentlyClosed.action.unarchive": "取消归档",
  "home.recentlyClosed.action.hide": "隐藏",
  "home.recentlyClosed.action.unhide": "取消隐藏",
  "home.recentlyClosed.action.remove": "忘记",
  "home.recentlyClosed.remove.title": "忘记此项目？",
  "home.recentlyClosed.remove.titleMany": "忘记 {{count}} 个项目？",
  "home.recentlyClosed.remove.confirm": "要从最近关闭中移除“{{name}}”吗？这只会清除历史记录，绝不会删除文件。",
  "home.recentlyClosed.remove.confirmMany": "要从最近关闭中移除 {{count}} 个项目吗？这只会清除历史记录，绝不会删除文件。",
  "home.recentlyClosed.toast.archived": "已归档",
  "home.recentlyClosed.toast.hidden": "已隐藏",
  "home.recentlyClosed.toast.removed": "已从最近关闭中移除",
  "home.recentlyClosed.toast.undo": "撤销",
