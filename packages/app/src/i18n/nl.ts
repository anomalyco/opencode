export const dict = {
  ...
  "command.tab.closeAll": "Alle tabbladen sluiten",
  "command.tab.closeRight": "Alle tabbladen rechts sluiten",
  "command.tab.closeOthers": "Alle tabbladen behalve deze sluiten",
