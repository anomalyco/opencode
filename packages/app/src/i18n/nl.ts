export const dict = {
  ...
  "session.agents.empty": "Geen subagents actief",
  "session.agents.costTotal": "Totale kosten",
  "session.agents.costSubagents": "Subagents",
  "session.agents.count": "Agents",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Alles weergeven ({{count}})",
  "session.agents.status.idle": "Inactief",
  "session.agents.status.busy": "Actief",
  "session.agents.status.retry": "Opnieuw proberen",
  "session.agents.status.cancelled": "Geannuleerd",
  "session.agents.status.completed": "Voltooid",
  "session.agents.status.error": "Mislukt",
