export const dict = {
  ...
  "command.session.handoff": "Sessie overdragen",
  "command.session.handoff.description": "Comprimeer de sessie en ga verder in een nieuwe sessie",
  ...
  "toast.session.handoff.failed.title": "Overdragen van sessie mislukt",
  "toast.session.handoff.failed.description": "Deze sessie kon niet worden samengevat om over te dragen",
