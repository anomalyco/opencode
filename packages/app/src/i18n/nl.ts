export const dict = {
  ...
  "desktop.menu.documentation": "Pencode-documentatie",
  ...
  "desktop.recovery.loadFailed": "Pencode kan niet worden geladen",
  "desktop.recovery.terminated": "Het Pencode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Pencode reageert niet",
  ...
  "desktop.wsl.error.installPencode": "Installatie van Pencode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.pencodeMissing": "pencode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.pencodeCannotRun": "pencode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Pencode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.pencode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.pencode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.pencodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Pencode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Pencode te gebruiken.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.pencodeZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.pencodeZen.visit.prefix": "Ga naar ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Pencode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Pencode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in pencode.json",
  ...
  "dialog.server.description": "Wijzig met welke Pencode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode controleren...",
  "wsl.onboarding.checkingPencodeIn": "Pencode controleren in {{distro}}...",
  "wsl.onboarding.updatingPencode": "Pencode bijwerken...",
  "wsl.onboarding.updatingPencodeIn": "Pencode bijwerken in {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Werk Pencode bij in {{distro}}.",
  "wsl.onboarding.updatePencode": "Pencode bijwerken",
  "wsl.onboarding.pencodeReadyIn": "Pencode is gereed in {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode is klaar.",
  "wsl.onboarding.installPencodeIn": "Installeer Pencode in {{distro}}.",
  "wsl.onboarding.installPencode": "Installeer Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Pencode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Pencode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Pencode opnieuw.",
  ...
  "help.tabs.introduction": "Pencode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Pencode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Pencode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (pencode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Pencode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Pencode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Pencode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Pencode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Pencode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Pencode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Pencode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Pencode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Pencode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Pencode.",
