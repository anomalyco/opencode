export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Ongeldige SSH-host: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} is al toegevoegd",
  "desktop.ssh.error.opencodeNotInstalled": "opencode is niet geïnstalleerd op {{host}}",
  "desktop.ssh.error.installOpencode": "Installatie van opencode is mislukt",
  "desktop.ssh.error.connectFailed": "Kan geen verbinding maken met {{host}}",
  "desktop.ssh.error.serverExited": "SSH-server is na het opstarten afgesloten (code={{code}} signaal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "SSH-server voor {{host}} is afgesloten voordat deze gereed was (code={{code}} signaal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "Time-out bij statuscontrole van server op {{host}} na {{timeout}} ms",
  "desktop.ssh.error.commandTimeout": "Time-out voor ssh-opdracht naar {{host}} na {{timeout}} ms",
  "desktop.ssh.error.failedPort": "Kan poort niet ophalen",
  "desktop.ssh.error.terminalFailed": "Kan geen terminal openen",
  ...
  "ssh.server.add": "SSH-server toevoegen",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH-server",
  "ssh.server.retryStart": "Opnieuw verbinden",
  "ssh.server.disconnect": "Verbinding verbreken",
  "ssh.server.openTerminal": "Terminal openen",
  "ssh.server.updating": "Updaten...",
  "ssh.server.status.connecting": "Verbinden...",
  "ssh.server.status.disconnected": "Verbinding verbroken",
  "ssh.add.hostLabel": "SSH-host",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Maakt verbinding via de ssh-client van je systeem, zodat hosts, sleutels en agents uit je SSH-configuratie zoals gewoonlijk werken.",
  "ssh.add.configHosts": "Uit je SSH-configuratie",
  "ssh.add.connect": "Verbinden",
  "ssh.add.checking": "Verbinden...",
  "ssh.add.addServer": "Server toevoegen",
  "ssh.add.adding": "Toevoegen...",
  "ssh.add.installOpencode": "opencode installeren",
  "ssh.add.updateOpencode": "opencode bijwerken",
  "ssh.add.installing": "Installeren...",
  "ssh.add.status.unreachable": "Kan geen verbinding maken",
  "ssh.add.status.opencodeMissing": "opencode is niet geïnstalleerd op deze host",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} geïnstalleerd, de desktop-app verwacht v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} gevonden",
  "ssh.add.authHint":
    "Zorg ervoor dat SSH-authenticatie op basis van sleutels werkt voor deze host: voer `ssh {{host}}` uit in een terminal om dit te controleren.",
