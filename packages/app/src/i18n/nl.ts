export const dict = {
  ...
  "provider.custom.models.load": "Dynamisch laden",
  "provider.custom.models.loading": "Laden...",
  "provider.custom.models.load.invalidUrl": "Voer een geldige basis-URL in",
  "provider.custom.models.load.unauthorized": "Niet geautoriseerd. Controleer de API-sleutel",
  "provider.custom.models.load.invalidFormat": "Het serverantwoord bevatte geen geldige modellenlijst",
  "provider.custom.models.load.timeout": "Time-out bij laden van modellen",
  "provider.custom.models.load.failed": "Modellen laden mislukt",
  "provider.custom.models.load.empty": "Geen modellen gevonden",
