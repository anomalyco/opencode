export const dict = {
  ...
  "desktop.menu.documentation": "Argus-documentatie",
  ...
  "desktop.recovery.loadFailed": "Argus kan niet worden geladen",
  "desktop.recovery.terminated": "Het Argus-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Argus reageert niet",
  ...
  "desktop.wsl.error.installArgus": "Installatie van Argus is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.argusMissing": "argus is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.argusCannotRun": "argus is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.argusNotInstalled": "Argus is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Argus-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.argus.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.argus.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.argusGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Argus",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Argus te gebruiken.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.argusZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.argusZen.visit.prefix": "Ga naar ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Argus te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Argus te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in argus.json",
  ...
  "dialog.server.description": "Wijzig met welke Argus-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingArgus": "Argus controleren...",
  "wsl.onboarding.checkingArgusIn": "Argus controleren in {{distro}}...",
  "wsl.onboarding.updatingArgus": "Argus bijwerken...",
  "wsl.onboarding.updatingArgusIn": "Argus bijwerken in {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Werk Argus bij in {{distro}}.",
  "wsl.onboarding.updateArgus": "Argus bijwerken",
  "wsl.onboarding.argusReadyIn": "Argus is gereed in {{distro}}.",
  "wsl.onboarding.argusReady": "Argus is klaar.",
  "wsl.onboarding.installArgusIn": "Installeer Argus in {{distro}}.",
  "wsl.onboarding.installArgus": "Installeer Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Argus een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Argus kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Argus opnieuw.",
  ...
  "help.tabs.introduction": "Argus Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Argus ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Argus-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (argus.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Argus ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Argus bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Argus-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Argus",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Argus eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Argus het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Argus aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Argus wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Argus is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Argus.",
