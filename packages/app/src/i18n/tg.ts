export const dict = {
  ...
  "settings.tab.plugins": "Плагинҳо",
  "settings.plugins.section.browse": "Аз назар гузаронидан",
  "settings.plugins.section.installed": "Насбшуда",
  ...
  "settings.mcp.add": "Илова кардани сервер",
  "settings.mcp.empty": "Ягон сервери MCP танзим нашудааст.",
  "settings.mcp.deleted": "{{name}} нест карда шуд.",
  "settings.mcp.errors.refresh": "Боркунӣ серверҳои MCP имконнопазир аст.",
  "settings.mcp.status.pending": "пайвастан…",
  "settings.mcp.action.connect": "Пайваст",
  "settings.mcp.action.disconnect": "Ҷуда кардан",
  "settings.mcp.action.authenticate": "Санҷиши ҳувият",
  "settings.mcp.action.edit": "Тағйир додан",
  "settings.mcp.action.delete": "Нест кардан",
  "settings.mcp.delete.title": "Нест кардани сервери MCP",
  "settings.mcp.delete.body": "{{name}}-ро тоза кардан? Ин амал баозгаштнопазир аст.",
  "settings.mcp.form.title.add": "Илова кардани сервери MCP",
  "settings.mcp.form.title.edit": "Тағйири сервери MCP",
  "settings.mcp.form.subtitle": "Танзимоти пайвастшавиро танзим кунед.",
  "settings.mcp.form.name": "Ном",
  "settings.mcp.form.command": "Фармон",
  "settings.mcp.form.command.hint": "мс. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Феҳристи корӣ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Тағйирёбандаҳои муҳит",
  "settings.mcp.form.headers": "Сарлавҳаҳо",
  "settings.mcp.form.addRow": "Илова кардани сатр",
  "settings.mcp.form.removeRow": "Нест кардан",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID муштарӣ",
  "settings.mcp.form.oauth.clientSecret": "Сирри муштарӣ",
  "settings.mcp.form.oauth.clientSecret.keep": "Танзимшуда — барои нигоҳ доштан холӣ гузоред",
  "settings.mcp.form.oauth.scope": "Ҳаҷм",
  "settings.mcp.form.oauth.callbackPort": "Порти баргардонидан",
  "settings.mcp.form.oauth.disableAutodetect": "Хомӯш кардани муайяни худкори OAuth",
  "settings.mcp.form.enabled": "Фаъол",
  "settings.mcp.form.timeout": "Вақт (ms)",
  "settings.mcp.form.save": "Нигоҳ доштан",
  "settings.mcp.form.cancel": "Бекор кардан",
  "settings.mcp.form.error.name": "Ном ворид кунед.",
  "settings.mcp.form.error.command": "Фармон ворид кунед.",
  "settings.mcp.form.error.url": "URL ворид кунед.",
  "settings.mcp.form.error.callbackPort": "Порти баргардонидан бояд 1–65535 бошад.",
  "settings.mcp.form.error.timeout": "Вақт бояд адади томи мусбат бошад.",
  "settings.mcp.errors.invalid": "Майдонҳои таъкидшударо ислоҳ кунед.",
  "settings.mcp.errors.duplicate": "Сервер бо ин ном аллакай вуҷуд дорад.",
  "settings.mcp.errors.noConfig": "Танзимоти {{name}} хонда намешавад — метавонад берун аз лоиҳа муайян шуда бошад.",
  "settings.mcp.edit.warn": "Нигоҳ доштан ин серверро аз нав пайваст мекунад.",
  ...
  "settings.plugins.detail.copied": "Нусхабардорӣ шуд",
  "settings.plugins.detail.notOnNpm": "Дар npm ёфт нашуд — ба opencode.json дастӣ илова кунед",
  "settings.plugins.install.title": "Насби плагин",
  "settings.plugins.install.description": "{{name}}-ро ба куҷо илова кардан?",
  "settings.plugins.install.global": "Глобалӣ (~/.config/opencode)",
  "settings.plugins.install.project": "Ин лоиҳа",
  "settings.plugins.install.cancel": "Бекор кардан",
  "settings.plugins.install.success": "{{name}} насб шуд. Барои боркунӣ OpenCode-ро аз нав оғоз кунед.",
  "settings.plugins.installed.empty": "Ягон плагин насб нашудааст.",
  "settings.plugins.installed.provenance.global": "Глобалӣ",
  "settings.plugins.installed.provenance.project": "Лоиҳа",
  ...
  "settings.plugins.errors.catalog": "Каталоги плагинҳо навсозӣ нашуд.",
  "settings.plugins.stale": "Каталоги кэшшуда нишон дода мешавад ({{age}} пештар).",
