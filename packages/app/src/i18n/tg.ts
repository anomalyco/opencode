export const dict = {
  ...
  "provider.custom.models.load": "Ботибии динамикӣ бор кунед",
  "provider.custom.models.loading": "Бор мешавад...",
  "provider.custom.models.load.invalidUrl": "URL-и асосии дурустро ворид кунед",
  "provider.custom.models.load.unauthorized": "Иҷозат нест. Калиди API-ро тафтиш кунед",
  "provider.custom.models.load.invalidFormat": "Ҷавоби сервер рӯйхати дурусти моделҳо набуд",
  "provider.custom.models.load.timeout": "Вақти боркунии моделҳо ба анҷом расид",
  "provider.custom.models.load.failed": "Боркунии моделҳо иҷро нашуд",
  "provider.custom.models.load.empty": "Моделҳо ёфт нашуданд",
