export const dict = {
  ...
  "mcp.status.needs_client_registration": "барқарорсозии муштарӣ лозим аст",
  "mcp.status.pending": "пайвастан…",
  ...
  "settings.mcp.type.local": "Маҳаллӣ",
  "settings.mcp.type.remote": "Дурдаст",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Роҳанӣ кардан барои холӣ гузоштан — аз нав аутентфикатсия лозим шуда метавонад",
