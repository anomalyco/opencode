export const dict = {
  ...
  "session.tab.agents": "Зерагентҳо",
  "session.agents.empty": "Ҳеҷ як зерагент кор намекунад",
  "session.agents.costTotal": "Арзиши умумӣ",
  "session.agents.costSubagents": "Зерагентҳо",
  "session.agents.count": "Агентҳо",
  "session.agents.tokens": "токенҳо",
  "session.agents.showAll": "Ҳамаро нишон додан ({{count}})",
  "session.agents.status.idle": "Ғайрифаъол",
  "session.agents.status.busy": "Дар ҷараён",
  "session.agents.status.retry": "Аз нав кӯшиш",
  "session.agents.status.cancelled": "Лағв шуд",
  "session.agents.status.completed": "Анҷом ёфт",
  "session.agents.status.error": "Нокомёб",
