export const dict = {
  ...
  "provider.custom.models.load": "동적으로 불러오기",
  "provider.custom.models.loading": "불러오는 중...",
  "provider.custom.models.load.invalidUrl": "유효한 기본 URL을 입력하세요",
  "provider.custom.models.load.unauthorized": "인증되지 않음. API 키를 확인하세요",
  "provider.custom.models.load.invalidFormat": "서버 응답이 유효한 모델 목록이 아닙니다",
  "provider.custom.models.load.timeout": "모델 불러오기 시간 초과",
  "provider.custom.models.load.failed": "모델을 불러오지 못했습니다",
  "provider.custom.models.load.empty": "모델을 찾을 수 없습니다",
