export const dict = {
  ...
  "home.activity.title": "토큰 활동",
  "home.activity.daily": "일간",
  "home.activity.weekly": "주간",
  "home.activity.cumulative": "누적",
  "home.activity.loading": "활동 로딩 중",
  "home.activity.empty": "아직 토큰 활동이 없습니다",
  "home.activity.lifetimeTokens": "총 토큰",
  "home.activity.peakTokens": "최대 토큰",
  "home.activity.longestTask": "최장 작업",
  "home.activity.currentStreak": "현재 연속",
  "home.activity.longestStreak": "최장 연속",
  "home.activity.days.one": "{{count}}일",
  "home.activity.days.other": "{{count}}일",
  "home.activity.summary": "{{tokens}} 총 토큰, {{peak}} 최대 토큰, {{current}} 현재 연속, {{longest}} 최장 연속.",
