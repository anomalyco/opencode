export const dict = {
  ...
  "presets.count": "프리셋 {{count}}개",
  "presets.empty": "프리셋 없음",
  "presets.empty.hint": "\"추가\"를 클릭하여 첫 번째 프리셋을 만드세요",
  "presets.add": "추가",
  "presets.name": "이름",
  "presets.content": "내용",
  "presets.content.placeholder": "내용 ({date} {time} {file} {code} {text} 변수 지원)",
  "presets.moveUp": "위로 이동",
  "presets.moveDown": "아래로 이동",
  "presets.edit": "편집",
  "presets.delete": "삭제",
  "presets.variables.title": "\"{{name}}\"의 변수 입력",
  "presets.variables.next": "다음",
  "presets.variables.insert": "삽입",
}
