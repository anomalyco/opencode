export const dict = {
  ...
  "toast.file.uploadFailed.title": "파일 업로드에 실패했습니다",
  "toast.file.downloadFailed.title": "파일 다운로드에 실패했습니다",
  "toast.file.deleteFailed.title": "파일 삭제에 실패했습니다",
  ...
  "session.files.uploadFile": "파일 업로드",
  "session.files.uploading": "업로드 중…",
  "session.files.downloadFile": "다운로드",
  "session.files.refresh": "새로고침",
  "session.files.dropFiles": "여기에 파일을 끌어다 놓거나 +를 클릭하여 업로드",
  "session.files.deleteConfirm": "\"{{path}}\"을(를) 삭제하시겠습니까?",
  "session.files.uploadTooLarge": "파일이 너무 큽니다 (최대 {{size}})",
