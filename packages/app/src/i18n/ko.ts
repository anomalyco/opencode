export const dict = {
  ...
  "home.recentlyClosed.options": "필터 및 정렬",
  "home.recentlyClosed.filter.label": "필터",
  "home.recentlyClosed.filter.recent": "최근",
  "home.recentlyClosed.filter.archived": "보관됨",
  "home.recentlyClosed.filter.hidden": "숨김",
  "home.recentlyClosed.filter.all": "전체",
  "home.recentlyClosed.filter.empty": "이 필터와 일치하는 프로젝트가 없습니다",
  "home.recentlyClosed.sort.label": "정렬",
  "home.recentlyClosed.sort.recent": "최신순",
  "home.recentlyClosed.sort.oldest": "오래된순",
  "home.recentlyClosed.sort.nameAsc": "이름 A–Z",
  "home.recentlyClosed.sort.nameDesc": "이름 Z–A",
  "home.recentlyClosed.search.placeholder": "최근에 닫은 프로젝트 검색",
  "home.recentlyClosed.showMore": "모두 표시({{count}})",
  "home.recentlyClosed.showLess": "간략히 표시",
  "home.recentlyClosed.select": "선택…",
  "home.recentlyClosed.selectAll": "모두 선택",
  "home.recentlyClosed.deselectAll": "모두 선택 해제",
  "home.recentlyClosed.cancelSelection": "선택 취소",
  "home.recentlyClosed.selected": "{{count}}개 선택됨",
  "home.recentlyClosed.noResults": "“{{query}}”과(와) 일치하는 프로젝트가 없습니다",
  "home.recentlyClosed.archived.badge": "보관됨",
  "home.recentlyClosed.hidden.badge": "숨김",
  "home.recentlyClosed.action.reopen": "다시 열기",
  "home.recentlyClosed.action.unarchive": "보관 해제",
  "home.recentlyClosed.action.hide": "숨기기",
  "home.recentlyClosed.action.unhide": "숨기기 해제",
  "home.recentlyClosed.action.remove": "잊기",
  "home.recentlyClosed.remove.title": "프로젝트를 잊을까요?",
  "home.recentlyClosed.remove.titleMany": "프로젝트 {{count}}개를 잊을까요?",
  "home.recentlyClosed.remove.confirm": "“{{name}}”을(를) 최근에 닫은 프로젝트에서 제거할까요? 기록만 지워지며 파일은 절대 삭제되지 않습니다.",
  "home.recentlyClosed.remove.confirmMany": "프로젝트 {{count}}개를 최근에 닫은 프로젝트에서 제거할까요? 기록만 지워지며 파일은 절대 삭제되지 않습니다.",
  "home.recentlyClosed.toast.archived": "보관됨",
  "home.recentlyClosed.toast.hidden": "숨겨짐",
  "home.recentlyClosed.toast.removed": "최근에 닫은 프로젝트에서 제거됨",
  "home.recentlyClosed.toast.undo": "실행 취소",
