export const dict = {
  ...
  "sidebar.linear.pullHint": "Linear에서 풀. 참고: Linear에서 수행한 계층 변경(부모 재지정, 부모 제거)은 로컬로 동기화되지 않으며 필드 값만 동기화됩니다.",
  ...
  "sidebar.issue.toast.archiveFailed": "작업 보관 실패",
  "sidebar.issue.toast.reorderFailed": "작업 재정렬 실패",
  "sidebar.issue.toast.reparentFailed": "작업 부모 변경 실패",
  "sidebar.issue.tooltip.archive": "이 작업 보관",
  "sidebar.issue.tooltip.delete": "이 작업 삭제",
  "sidebar.issue.confirmArchive": "보관",
  "sidebar.issue.archivedBadge": "보관됨",
  "sidebar.issue.archiveArea.title": "보관됨",
  "sidebar.issue.archiveArea.expand": "보관된 항목 표시",
  "sidebar.issue.archiveArea.collapse": "보관된 항목 숨기기",
  "sidebar.issue.archiveArea.empty": "보관된 작업 없음",
}
