export const dict = {
  ...
  "session.tab.agents": "서브에이전트",
  "session.agents.empty": "실행 중인 서브에이전트 없음",
  "session.agents.costTotal": "총 비용",
  "session.agents.costSubagents": "서브에이전트",
  "session.agents.count": "에이전트",
  "session.agents.tokens": "토큰",
  "session.agents.showAll": "모두 표시 ({{count}})",
  "session.agents.status.idle": "대기 중",
  "session.agents.status.busy": "실행 중",
  "session.agents.status.retry": "재시도",
  "session.agents.status.cancelled": "취소됨",
  "session.agents.status.completed": "완료",
  "session.agents.status.error": "실패",
