export const dict = {
  ...
  "dialog.newProject.title": "새 프로젝트",
  "dialog.newProject.tab.github": "GitHub에서 가져오기",
  "dialog.newProject.tab.folder": "폴더에서 가져오기",
  "dialog.newProject.url.label": "저장소 URL",
  "dialog.newProject.destination.label": "복제 대상",
  "dialog.newProject.destination.placeholder": "대상 폴더 선택",
  "dialog.newProject.destination.browse": "찾아보기",
  "dialog.newProject.destination.pick": "복제 대상 선택",
  "dialog.newProject.clone": "저장소 복제",
  "dialog.newProject.cloning": "복제 중...",
  "dialog.newProject.error.cloneFailed": "저장소 복제에 실패했습니다",
  "dialog.newProject.folder.title": "기존 프로젝트 열기",
  "dialog.newProject.folder.description": "OpenCode에 프로젝트로 추가할 로컬 폴더를 선택하세요.",
  "dialog.newProject.folder.action": "폴더 선택",
