...
export const dict = {
  ...
  "prompt.action.expand": "편집기 확장",
  "prompt.attachment.remove": "첨부 파일 제거",
  "prompt.action.send": "전송",
  "prompt.action.stop": "중지",
  "prompt.editor.title": "프롬프트 편집",
  ...
  "error.page.action.restartFrontend": "프런트엔드 다시 시작",
  "error.page.action.restartBackend": "백엔드 다시 시작",
  "error.page.action.restartApp": "앱 다시 시작",
