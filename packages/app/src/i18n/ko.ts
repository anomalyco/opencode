...
export const dict = {
  ...
  "command.context.addToChat": "선택 항목을 채팅에 추가",
  "command.context.addToChat.description": "선택한 줄을 커서 위치에 삽입",
  "command.context.quickEdit": "선택 항목 빠른 편집",
  "command.context.quickEdit.description": "선택한 코드를 새 세션에서 편집",
  "selection.action.addToChat": "채팅에 추가",
  "selection.action.quickEdit": "빠른 편집",
  "selection.quickEdit.placeholder": "선택한 코드 편집",
  "selection.quickEdit.submit": "시작",
