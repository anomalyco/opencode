...
export const dict = {
  ...
  "palette.group.files": "파일명 일치",
  "palette.group.content": "로컬 파일 내용 일치",
  "palette.group.chat": "채팅 내용 일치",
  "palette.group.sessions": "세션명 일치",
  "palette.group.files.count": "{{count}}개 결과.",
  "palette.group.content.count": "{{count}}개 결과 ({{files}}개 파일).",
  "palette.group.chat.count": "{{count}}개 결과 ({{sessions}}개 세션).",
  "palette.group.sessions.count": "{{count}}개 결과.",
