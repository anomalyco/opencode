export const dict = {
  ...
  "command.todo.toggle": "Todo 패널 전환",
  ...
  "sidebar.issue.title": "할 일",
  "sidebar.issue.add": "할 일 추가",
  "sidebar.issue.addSubtodo": "하위 할 일 추가",
  "sidebar.issue.empty": "할 일이 없습니다",
  "sidebar.issue.collapse": "하위 작업 접기",
  "sidebar.issue.expand": "하위 작업 펼치기",
  "sidebar.issue.confirmDeleteWithChildren": "이 작업과 {{count}}개의 하위 작업을 삭제하시겠습니까?",
  "sidebar.issue.toast.deleteFailed": "할 일 삭제 실패",
  "sidebar.issue.tooltip.cycleStatus": "상태 전환",
  "sidebar.issue.tooltip.cyclePriority": "우선순위 전환",
  "sidebar.issue.tooltip.linkedLinear": "Linear에 연결됨",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "연결됨",
  "sidebar.linear.management": "Linear 연결 관리",
  "sidebar.linear.management.teamRequired": "팀을 선택해 주세요",
  "sidebar.linear.management.projectRequired": "프로젝트를 선택해 주세요",
  "sidebar.linear.management.saveFailed": "Linear 연결 저장 실패",
  "sidebar.linear.management.saved": "Linear 연결이 저장되었습니다",
  "sidebar.linear.management.save": "저장",
  "sidebar.linear.toggleHistory": "동기화 기록 전환",
  "sidebar.linear.field.team": "팀",
  "sidebar.linear.field.team.loading": "팀 불러오는 중...",
  "sidebar.linear.field.team.placeholder": "팀 선택",
  "sidebar.linear.field.project": "프로젝트",
  "sidebar.linear.field.project.selectTeamFirst": "먼저 팀을 선택하세요",
  "sidebar.linear.field.project.loading": "프로젝트 불러오는 중...",
  "sidebar.linear.field.project.placeholder": "프로젝트 선택",
  "sidebar.linear.notConfigured": "Linear가 구성되지 않음",
  "sidebar.linear.notConfiguredHint": "관리 패널에서 팀과 프로젝트를 선택하세요",
  "sidebar.linear.actions": "동기화 작업",
  "sidebar.linear.push": "푸시",
  "sidebar.linear.pull": "풀",
  "sidebar.linear.pullFailed": "Linear에서 풀 실패",
  "sidebar.linear.pullPartialFailed": "풀 일부 실패: {{count}}개 오류",
  "sidebar.linear.pullSuccess": "가져옴 {{pulled}}, 업데이트 {{updated}}, 건너뜀 {{skipped}}, 삭제 {{deleted}}",
  "sidebar.linear.pushFailed": "Linear로 푸시 실패",
  "sidebar.linear.pushPartialFailed": "푸시 일부 실패: {{count}}개 오류",
  "sidebar.linear.pushSuccess": "{{count}}개 할 일을 Linear로 푸시했습니다",
  "sidebar.linear.pushNothing": "푸시할 항목이 없습니다",
  "sidebar.linear.syncHistory.syncing": "동기화 중...",
  "sidebar.linear.syncHistory.push": "↗ Linear",
  "sidebar.linear.syncHistory.pull": "↙ Linear",
  "sidebar.linear.syncHistory.itemCount.one": "{{count}}개 항목",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}}개 항목",
  "sidebar.linear.syncHistory.error": "오류",
  "sidebar.linear.syncHistory.empty": "동기화 기록 없음",
  "dialog.todo.title.create": "새 할 일",
  "dialog.todo.title.edit": "할 일 편집",
  "dialog.todo.field.title": "제목",
  "dialog.todo.field.title.placeholder": "할 일 제목",
  "dialog.todo.field.description": "설명",
  "dialog.todo.field.description.placeholder": "세부 정보, 링크 또는 컨텍스트 추가...",
  "dialog.todo.field.description.hint": "파일 및 스킬 참조 지원",
  "dialog.todo.field.status": "상태",
  "dialog.todo.field.priority": "우선순위",
  "dialog.todo.field.dueDate": "마감일",
  "dialog.todo.field.dueDate.placeholder": "마감일 설정",
  "dialog.todo.field.dueDate.clear": "지우기",
  "dialog.todo.field.dueDate.prevMonth": "이전 달",
  "dialog.todo.field.dueDate.nextMonth": "다음 달",
  "dialog.todo.field.dueDate.shortcut.today": "오늘",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "내일",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "일주일 후",
  "dialog.todo.field.dueDate.month.0": "1월",
  "dialog.todo.field.dueDate.month.1": "2월",
  "dialog.todo.field.dueDate.month.2": "3월",
  "dialog.todo.field.dueDate.month.3": "4월",
  "dialog.todo.field.dueDate.month.4": "5월",
  "dialog.todo.field.dueDate.month.5": "6월",
  "dialog.todo.field.dueDate.month.6": "7월",
  "dialog.todo.field.dueDate.month.7": "8월",
  "dialog.todo.field.dueDate.month.8": "9월",
  "dialog.todo.field.dueDate.month.9": "10월",
  "dialog.todo.field.dueDate.month.10": "11월",
  "dialog.todo.field.dueDate.month.11": "12월",
  "dialog.todo.field.labels": "레이블",
  "dialog.todo.field.assignee": "담당자",
  "dialog.todo.field.assignee.unassigned": "미할당",
  "dialog.todo.field.assignee.loadFailed": "담당자 로드 실패",
  "dialog.todo.field.assignee.loading": "담당자 로드 중...",
  "dialog.todo.field.assignee.placeholder": "담당자 선택",
  "dialog.todo.field.assignee.hint": "Linear 팀 멤버에서 가져옴",
  "dialog.todo.autocomplete.noFiles": "파일을 찾을 수 없습니다",
  "dialog.todo.autocomplete.noSkills": "스킬을 찾을 수 없습니다",
  "dialog.todo.linkedLinear": "Linear에 연결됨",
  "dialog.todo.created": "할 일이 생성되었습니다",
  "dialog.todo.updated": "할 일이 업데이트되었습니다",
  "dialog.todo.error.titleRequired": "제목은 필수입니다",
  "dialog.todo.error.saveFailed": "할 일 저장 실패",
  "dialog.todo.action.create": "생성",
  ...
  "sidebar.issue.priority.none": "없음",
  "sidebar.issue.priority.urgent": "긴급",
  "sidebar.issue.priority.high": "높은",
  "sidebar.issue.priority.medium": "중간",
  "sidebar.issue.priority.low": "낮은",
}
