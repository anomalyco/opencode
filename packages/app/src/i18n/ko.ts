export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "OpenCode 메뉴",
  "desktop.appMenu.file": "파일",
  "desktop.appMenu.edit": "편집",
  "desktop.appMenu.view": "보기",
  "desktop.appMenu.go": "이동",
  "desktop.appMenu.window": "창",
  "desktop.appMenu.help": "도움말",
  "desktop.appMenu.about": "OpenCode 정보",
  "desktop.appMenu.checkForUpdates": "업데이트 확인...",
  "desktop.appMenu.settings": "설정",
  "desktop.appMenu.reloadWebview": "웹뷰 새로고침",
  "desktop.appMenu.restart": "다시 시작",
  "desktop.appMenu.exportLogs": "로그 내보내기...",
  "desktop.appMenu.hide": "OpenCode 가리기",
  "desktop.appMenu.hideOthers": "기타 가리기",
  "desktop.appMenu.showAll": "모두 보기",
  "desktop.appMenu.quit": "OpenCode 종료",
  "desktop.appMenu.newSession": "새 세션",
  "desktop.appMenu.openProject": "프로젝트 열기...",
  "desktop.appMenu.newWindow": "새 창",
  "desktop.appMenu.closeWindow": "창 닫기",
  "desktop.appMenu.undo": "실행 취소",
  "desktop.appMenu.redo": "다시 실행",
  "desktop.appMenu.cut": "잘라내기",
  "desktop.appMenu.copy": "복사",
  "desktop.appMenu.paste": "붙여넣기",
  "desktop.appMenu.delete": "삭제",
  "desktop.appMenu.selectAll": "모두 선택",
  "desktop.appMenu.toggleSidebar": "사이드바 표시 전환",
  "desktop.appMenu.toggleTerminal": "터미널 표시 전환",
  "desktop.appMenu.toggleFileTree": "파일 트리 표시 전환",
  "desktop.appMenu.reload": "새로고침",
  "desktop.appMenu.toggleDeveloperTools": "개발자 도구 표시 전환",
  "desktop.appMenu.actualSize": "실제 크기",
  "desktop.appMenu.zoomIn": "확대",
  "desktop.appMenu.zoomOut": "축소",
  "desktop.appMenu.toggleFullScreen": "전체 화면 전환",
  "desktop.appMenu.back": "뒤로",
  "desktop.appMenu.forward": "앞으로",
  "desktop.appMenu.previousSession": "이전 세션",
  "desktop.appMenu.nextSession": "다음 세션",
  "desktop.appMenu.previousProject": "이전 프로젝트",
  "desktop.appMenu.nextProject": "다음 프로젝트",
  "desktop.appMenu.minimize": "최소화",
  "desktop.appMenu.zoomWindow": "확대/축소",
  "desktop.appMenu.maximize": "최대화",
  "desktop.appMenu.bringAllToFront": "모두 앞으로 가져오기",
  "desktop.appMenu.documentation": "OpenCode 문서",
  "desktop.appMenu.supportForum": "지원 포럼",
  "desktop.appMenu.shareFeedback": "피드백 보내기",
  "desktop.appMenu.reportBug": "버그 신고",
