export const dict = {
  ...
  "settings.general.row.fontSize.title": "글자 크기",
  "settings.general.row.fontSize.description": "인터페이스 전반의 기본 글자 크기를 조절",
  "settings.general.row.lineHeight.title": "줄간격",
  "settings.general.row.lineHeight.description": "텍스트 줄 사이의 간격을 조절",
