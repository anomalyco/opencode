export const dict = {
  ...
  "command.session.handoff": "세션 인계",
  "command.session.handoff.description": "세션을 압축하고 새 세션에서 작업 계속",
  ...
  "toast.session.handoff.failed.title": "세션 인계 실패",
  "toast.session.handoff.failed.description": "인계를 위해 이 세션을 요약할 수 없습니다",
