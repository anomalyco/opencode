export const dict = {
  ...
  "settings.general.row.colorScheme.description": "Argus가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  ...
  "wsl.onboarding.checkingArgus": "Argus 확인 중...",
  "wsl.onboarding.checkingArgusIn": "{{distro}}에서 Argus 확인 중...",
  "wsl.onboarding.updatingArgus": "Argus 업데이트 중...",
  "wsl.onboarding.updatingArgusIn": "{{distro}}에서 Argus 업데이트 중...",
  "wsl.onboarding.updateArgusIn": "{{distro}}에서 Argus를 업데이트하세요.",
  "wsl.onboarding.updateArgus": "Argus 업데이트",
  "wsl.onboarding.argusReadyIn": "{{distro}}에서 Argus를 사용할 준비가 되었습니다.",
  "wsl.onboarding.argusReady": "Argus가 준비되었습니다.",
  "wsl.onboarding.installArgusIn": "{{distro}}에 Argus를 설치하세요.",
  "wsl.onboarding.installArgus": "Argus 설치",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Argus에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Argus에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Argus를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 Argus Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "Argus를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Argus 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Argus가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installArgus": "Argus 설치 실패",
  "desktop.wsl.error.alreadyAdded": "{{distro}} 배포판은 이미 추가되었습니다",
  "desktop.wsl.error.argusMissing": "이 배포판에 argus가 설치되어 있지 않습니다",
  "desktop.wsl.error.argusCannotRun": "argus가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.argusNotInstalled": "{{distro}}에 Argus가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "Argus 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
