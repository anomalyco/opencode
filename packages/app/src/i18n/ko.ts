export const dict = {
  ...
  "provider.custom.models.context.label": "컨텍스트 크기",
  "provider.custom.models.context.placeholder": "컨텍스트 크기",
  "provider.custom.models.output.label": "최대 출력",
  "provider.custom.models.output.placeholder": "최대 출력",
  "provider.custom.models.reasoning.label": "추론 지원",
  ...
  "provider.custom.error.positiveInteger": "양의 정수를 입력하세요",
