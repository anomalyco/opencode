export const dict = {
  ...
  "ssh.server.add": "SSH 서버 추가",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH 서버",
  "ssh.server.retryStart": "다시 연결",
  "ssh.server.disconnect": "연결 해제",
  "ssh.server.openTerminal": "터미널 열기",
  "ssh.server.updating": "업데이트 중...",
  "ssh.server.status.connecting": "연결 중...",
  "ssh.server.status.disconnected": "연결 해제됨",
  "ssh.add.hostLabel": "SSH 호스트",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "시스템 ssh 클라이언트를 통해 연결하므로 SSH 구성의 호스트, 키, 에이전트를 그대로 사용할 수 있습니다.",
  "ssh.add.configHosts": "SSH 구성에서",
  "ssh.add.connect": "연결",
  "ssh.add.checking": "연결 중...",
  "ssh.add.addServer": "서버 추가",
  "ssh.add.adding": "추가 중...",
  "ssh.add.installOpencode": "opencode 설치",
  "ssh.add.updateOpencode": "opencode 업데이트",
  "ssh.add.installing": "설치 중...",
  "ssh.add.status.unreachable": "연결할 수 없습니다",
  "ssh.add.status.opencodeMissing": "이 호스트에 opencode가 설치되어 있지 않습니다",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} 설치됨, 데스크톱 예상 버전: v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} 발견됨",
  "ssh.add.authHint": "이 호스트에서 키 기반 SSH 인증이 작동하는지 터미널에서 `ssh {{host}}` 명령으로 확인하세요.",
  ...
  "desktop.ssh.error.invalidHost": "잘못된 SSH 호스트: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} 호스트는 이미 추가되었습니다",
  "desktop.ssh.error.opencodeNotInstalled": "{{host}}에 opencode가 설치되어 있지 않습니다",
  "desktop.ssh.error.installOpencode": "opencode 설치 실패",
  "desktop.ssh.error.connectFailed": "{{host}}에 연결할 수 없습니다",
  "desktop.ssh.error.serverExited": "SSH 서버가 시작 후 종료되었습니다(코드={{code}} 신호={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}}의 SSH 서버가 정상 상태가 되기 전에 종료되었습니다(코드={{code}} 신호={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "{{host}} 서버의 상태 확인이 {{timeout}}ms 후 시간 초과되었습니다",
  "desktop.ssh.error.commandTimeout": "{{host}}에 대한 ssh 명령이 {{timeout}}ms 후 시간 초과되었습니다",
  "desktop.ssh.error.failedPort": "포트를 가져오지 못했습니다",
  "desktop.ssh.error.terminalFailed": "터미널을 열지 못했습니다",
