export const dict = {
  ...
  "session.tab.agents": "Nën-agjentë",
  "session.agents.empty": "Asnjë nën-agjent nuk po ekzekutohet",
  "session.agents.costTotal": "Kosto totale",
  "session.agents.costSubagents": "Nën-agjentë",
  "session.agents.count": "Agjentë",
  "session.agents.tokens": "tokenë",
  "session.agents.showAll": "Shfaq të gjitha ({{count}})",
  "session.agents.status.idle": "I papunë",
  "session.agents.status.busy": "Në ekzekutim",
  "session.agents.status.retry": "Riprovo",
  "session.agents.status.cancelled": "Anuluar",
  "session.agents.status.completed": "Përfunduar",
  "session.agents.status.error": "Dështoi",
