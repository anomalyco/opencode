export const dict = {
  ...
  "settings.general.section.modelRace": "Model Racing",
  "settings.general.modelRace.enabled.title": "Enable model racing",
  "settings.general.modelRace.enabled.description":
    "Request multiple candidate models for each LLM generation and commit one winner",
  "settings.general.modelRace.models.title": "Candidate models",
  "settings.general.modelRace.models.description": "Select the models that participate in each race",
  "settings.general.modelRace.models.select": "Select models",
  "settings.general.modelRace.models.selected": "Selected: {{count}}",
  "settings.general.modelRace.firstToken.title": "First token leader",
  "settings.general.modelRace.firstToken.description": "Use the first valid token as the provisional leader",
  "settings.general.modelRace.throughput.title": "Throughput switching",
  "settings.general.modelRace.throughput.description":
    "Allow a faster sustained model to replace the provisional leader",
  "settings.general.modelRace.toolCall.title": "Tool call lock",
  "settings.general.modelRace.toolCall.description": "Lock the race when a candidate emits a complete tool call",
  "settings.general.modelRace.warmup.title": "Warmup tokens",
  "settings.general.modelRace.warmup.description": "Tokens ignored before throughput measurement starts",
  "settings.general.modelRace.window.title": "Measurement window",
  "settings.general.modelRace.window.description": "Duration of each throughput measurement window",
  "settings.general.modelRace.switch.title": "Allow leader switch",
  "settings.general.modelRace.switch.description": "Allow the provisional leader to change during a race",
  "settings.general.modelRace.unsaved": "You have unsaved model racing changes",
  "settings.general.modelRace.action.reset": "Reset to defaults",

  "session.modelRace.title": "Model Racing",
  "session.modelRace.candidates": "{{count}} candidates",
  "session.modelRace.leader": "Leader",
  "session.modelRace.winner": "Winner",
  "session.modelRace.ttft": "TTFT",
  "session.modelRace.tps": "{{count}} tok/s",
  "session.modelRace.toolCall": "Tool call",

  "session.modelRace.ready": "Waiting for the next generation",
  "session.modelRace.manage": "Manage Model Racing",
  "session.modelRace.manageTitle": "Manage Model Racing",
  "session.modelRace.manageDescription": "Configure model racing for this OpenCode instance.",
  "session.modelRace.details": "Details",
  "session.modelRace.hideDetails": "Hide details",
  "session.modelRace.state": "State",
  "session.modelRace.phase": "Race phase",
  "session.modelRace.reason": "Reason",
  "session.modelRace.outputTokens": "Output tokens",
  "session.modelRace.speed": "Speed",
  "session.modelRace.elapsed": "Elapsed",
}
