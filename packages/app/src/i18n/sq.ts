export const dict = {
  ...
  "command.tab.closeAll": "Mbyll të gjitha skedat",
  "command.tab.closeRight": "Mbyll të gjitha skedat në të djathtë",
  "command.tab.closeOthers": "Mbyll të gjitha skedat përveç kësaj",
