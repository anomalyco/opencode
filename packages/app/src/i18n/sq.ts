export const dict = {
  ...
  "provider.custom.models.load": "Ngarko dinamikisht",
  "provider.custom.models.loading": "Po ngarkohet...",
  "provider.custom.models.load.invalidUrl": "Vendos një URL baze të vlefshme",
  "provider.custom.models.load.unauthorized": "Pa autorizim. Kontrollo çelësin API",
  "provider.custom.models.load.invalidFormat": "Përgjigja e serverit nuk përmbante një listë modelesh të vlefshme",
  "provider.custom.models.load.timeout": "Mbaroi koha gjatë ngarkimit të modeleve",
  "provider.custom.models.load.failed": "Dështoi ngarkimi i modeleve",
  "provider.custom.models.load.empty": "Nuk u gjetën modele",
