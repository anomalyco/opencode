export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Argus",
  ...
  "desktop.menu.ariaLabel": "Menuja Argus",
  ...
  "desktop.recovery.loadFailed": "Argus nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Argus u mbyll papritur",
  "desktop.recovery.unresponsive": "Argus nuk po përgjigjet",
  ...
  "desktop.wsl.error.installArgus": "Instalimi i Argus dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.argusMissing": "Argus nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.argusCannotRun": "Argus është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.argusNotInstalled": "Argus nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Argus përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.argus.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.argus.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.argusGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Argus",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.argusZen.visit.prefix": "Vizitoni ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Argus.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në argus.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Argus lidhet ky aplikacion.",
  ...
  "wsl.onboarding.step.argus": "Argus",
  ...
  "wsl.onboarding.checkingArgus": "Po kontrollon Argus...",
  "wsl.onboarding.checkingArgusIn": "Po kontrollon Argus në {{distro}}...",
  "wsl.onboarding.updatingArgus": "Argus po përditësohet...",
  "wsl.onboarding.updatingArgusIn": "Po përditëson Argus në {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Përditëso Argus në {{distro}}.",
  "wsl.onboarding.updateArgus": "Përditëso Argus",
  "wsl.onboarding.argusReadyIn": "Argus është gati në {{distro}}.",
  "wsl.onboarding.argusReady": "Argus është gati.",
  "wsl.onboarding.installArgusIn": "Instaloni Argus në {{distro}}.",
  "wsl.onboarding.installArgus": "Instaloni Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Argus të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Argus nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Argus ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Argus",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (argus.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Argus nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Argus brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Argus",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Argus në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Argus ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Argus.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Argus",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Argus.",
