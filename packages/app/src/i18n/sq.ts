export const dict = {
  ...
  "agents.col.stage": "Stage",
  "agents.col.in": "In",
  "agents.col.out": "Out",
  "agents.col.rate": "Tok/s",
  "agents.col.cache": "Cache",
  "agents.col.cost": "$est",
  "agents.col.lat": "Lat",
  "agents.col.graph": "Out",
  "agents.tab.thread": "Thread",
  "agents.tab.diff": "Diff",
  "agents.tab.todos": "Todos",
  "agents.tab.events": "Events",
  "agents.action.permission": "Permission",
  "agents.action.interrupt": "Interrupt",
  "agents.action.open": "Open full session",
}
