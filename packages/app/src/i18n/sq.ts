export const dict = {
  ...
  "command.session.background": "Ekzekuto nënagjentët në sfond",
  "command.session.background.description": "Shkëput nënagjentët që po bllokojnë këtë sesion dhe vazhdoji në sfond",
  ...
  "toast.session.background.failed.title": "Nuk u arrit ekzekutimi i nënagjentëve në sfond",
