export const dict = {
  ...
  "command.session.handoff": "Transferoni seancën",
  "command.session.handoff.description": "Përmblidhni seancën dhe vazhdoni punën në një seancë të re",
  ...
  "toast.session.handoff.failed.title": "Transferimi i seancës dështoi",
  "toast.session.handoff.failed.description": "Kjo seancë nuk mund të përmblidhej për t'u transferuar",
