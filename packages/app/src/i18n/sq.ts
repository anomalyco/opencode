export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Pencode",
  ...
  "desktop.menu.ariaLabel": "Menuja Pencode",
  ...
  "desktop.recovery.loadFailed": "Pencode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Pencode u mbyll papritur",
  "desktop.recovery.unresponsive": "Pencode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installPencode": "Instalimi i Pencode dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.pencodeMissing": "Pencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.pencodeCannotRun": "Pencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Pencode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.pencode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.pencode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.pencodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Pencode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  "provider.connect.pencodeZen.line2":
    "Me një çelës të vetëm API do të keni akses në modele të tilla si Claude, GPT, Gemini, GLM dhe më shumë.",
  "provider.connect.pencodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Pencode.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në pencode.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Pencode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.step.pencode": "Pencode",
  ...
  "wsl.onboarding.checkingPencode": "Po kontrollon Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Po kontrollon Pencode në {{distro}}...",
  "wsl.onboarding.updatingPencode": "Pencode po përditësohet...",
  "wsl.onboarding.updatingPencodeIn": "Po përditëson Pencode në {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Përditëso Pencode në {{distro}}.",
  "wsl.onboarding.updatePencode": "Përditëso Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode është gati në {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode është gati.",
  "wsl.onboarding.installPencodeIn": "Instaloni Pencode në {{distro}}.",
  "wsl.onboarding.installPencode": "Instaloni Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Pencode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Pencode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Pencode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Pencode",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (pencode.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Pencode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "app.name.desktop": "Pencode Desktop",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Pencode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Pencode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Pencode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Pencode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Pencode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Pencode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Pencode.",
