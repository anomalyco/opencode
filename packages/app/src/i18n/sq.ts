export const dict = {
  ...
  "session.tab.agents": "Subagents",
  "session.agents.empty": "No subagents running",
  "session.agents.costTotal": "Total cost",
  "session.agents.costSubagents": "Subagents",
  "session.agents.count": "Agents",
  "session.agents.tokens": "tokens",
  "session.agents.showAll": "Show all ({{count}})",
  "session.agents.status.idle": "Idle",
  "session.agents.status.busy": "Running",
  "session.agents.status.retry": "Retrying",
  "session.agents.status.cancelled": "Cancelled",
  "session.agents.status.completed": "Completed",
  "session.agents.status.error": "Failed",
