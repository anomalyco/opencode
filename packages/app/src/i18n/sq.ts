export const dict = {
  ...
  "settings.tab.plugins": "Shtojca",
  "settings.plugins.section.browse": "Shfeto",
  "settings.plugins.section.installed": "Të instaluara",
  "settings.plugins.source.all": "Të gjitha burimet",
  "settings.plugins.source.ecosystem": "Ekosistemi",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Shto server",
  "settings.mcp.empty": "Nuk ka servera MCP të konfiguruar.",
  "settings.mcp.deleted": "{{name}} u fshi.",
  "settings.mcp.errors.refresh": "Serverat MCP nuk u ngarkuan dot.",
  "settings.mcp.status.pending": "po lidhet…",
  "settings.mcp.action.connect": "Lidh",
  "settings.mcp.action.disconnect": "Shkëput",
  "settings.mcp.action.authenticate": "Vërteto",
  "settings.mcp.action.edit": "Përpuno",
  "settings.mcp.action.delete": "Fshi",
  "settings.mcp.delete.title": "Fshi serverin MCP",
  "settings.mcp.delete.body": "Të hiqet {{name}}? Kjo nuk mund të zhdërrngohet.",
  "settings.mcp.form.title.add": "Shto server MCP",
  "settings.mcp.form.title.edit": "Redakto serverin MCP",
  "settings.mcp.form.subtitle": "Konfiguro parametrat e lidhjes.",
  "settings.mcp.form.name": "Emri",
  "settings.mcp.form.command": "Komanda",
  "settings.mcp.form.command.hint": "p.sh. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Direktori i punës",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Variablat e mjedisit",
  "settings.mcp.form.headers": "Titujt",
  "settings.mcp.form.addRow": "Shto rresht",
  "settings.mcp.form.removeRow": "Hiq",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID e klientit",
  "settings.mcp.form.oauth.clientSecret": "Sekreti i klientit",
  "settings.mcp.form.oauth.clientSecret.keep": "E konfiguruar — lëre bosh për ta ruajtur",
  "settings.mcp.form.oauth.scope": "Qëllimi",
  "settings.mcp.form.oauth.callbackPort": "Porta e rikthimit",
  "settings.mcp.form.oauth.disableAutodetect": "Çaktivizo zbulimin automatik të OAuth-it",
  "settings.mcp.form.enabled": "Aktivizuar",
  "settings.mcp.form.timeout": "Koha e pritjes (ms)",
  "settings.mcp.form.save": "Ruaj",
  "settings.mcp.form.cancel": "Anulo",
  "settings.mcp.form.error.name": "Vendos një emër.",
  "settings.mcp.form.error.command": "Vendos një komandë.",
  "settings.mcp.form.error.url": "Vendos një URL.",
  "settings.mcp.form.error.callbackPort": "Porta e rikthimit duhet të jetë 1–65535.",
  "settings.mcp.form.error.timeout": "Koha e pritjes duhet të jetë numër i plotë pozitiv.",
  "settings.mcp.errors.invalid": "Rregullo fushat e theksuara.",
  "settings.mcp.errors.duplicate": "Ekziston tashmë një server me këtë emër.",
  "settings.mcp.errors.noConfig": "Konfigurimi për {{name}} nuk mund të lexohet — mund të jetë përcaktuar jashtë projektit.",
  "settings.mcp.edit.warn": "Ruajtja e rikonjekton këtë server.",
  "settings.plugins.search.placeholder": "Kërko shtojca…",
  "settings.plugins.detail.install": "Instalo…",
  "settings.plugins.detail.copy": "Kopjo fragmentin e konfigurimit",
  "settings.plugins.detail.copied": "U kopjua",
  "settings.plugins.detail.notOnNpm": "Nuk u gjet në npm — shtoje manualisht në opencode.json",
  "settings.plugins.install.title": "Instalo shtojcën",
  "settings.plugins.install.description": "Ku të shtohet {{name}}?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Ky projekt",
  "settings.plugins.install.cancel": "Anulo",
  "settings.plugins.install.success": "{{name}} u instalua. Rinisni OpenCode për ta ngarkuar.",
  "settings.plugins.installed.empty": "Nuk ka shtojca të instaluara.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Projekt",
  ...
  "settings.plugins.errors.catalog": "Katalogu i shtojcave nuk u rifreskua.",
  "settings.plugins.stale": "Po shfaqet katalogu i ruajtur në cache ({{age}} më parë).",
