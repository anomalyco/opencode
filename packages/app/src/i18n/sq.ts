export const dict = {
  ...
  "mcp.status.needs_client_registration": "kërkon regjistrim klienti",
  "mcp.status.pending": "po lidhet…",
  ...
  "settings.mcp.type.remote": "Në largësi",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Lëre bosh për ta anashkaluar — mund të nevojitet riautentifikimi",
