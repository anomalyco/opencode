export const dict = {
  ...
  "command.session.handoff": "ክፍለ ጊዜን አስተላልፍ",
  "command.session.handoff.description": "ክፍለ ጊዜውን አጠቃልለው ሥራውን በአዲስ ክፍለ ጊዜ ይቀጥሉ",
  ...
  "toast.session.handoff.failed.title": "ክፍለ ጊዜን ማስተላለፍ አልተሳካም",
  "toast.session.handoff.failed.description": "ይህ ክፍለ ጊዜ ለማስተላለፍ ሊጠቃለል አልቻለም",
