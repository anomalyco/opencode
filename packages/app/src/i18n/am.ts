export const dict = {
  ...
  "command.session.background": "ንዑስ ወኪሎችን ወደ ጀርባ አሂድ",
  "command.session.background.description": "ይህን ክፍለ ጊዜ የሚያግዱትን ንዑስ ወኪሎች አላቅቅና በጀርባ አስቀጥላቸው",
  ...
  "toast.session.background.failed.title": "ንዑስ ወኪሎችን ወደ ጀርባ ማሸጋገር አልተሳካም",
