export const dict = {
  ...
  "mcp.status.needs_client_registration": "የደንበኛ ምዝገባ ያስፈልጋል",
  "mcp.status.pending": "በመገናኘት ላይ…",
  ...
  "settings.mcp.type.local": "አካባቢ",
  "settings.mcp.type.remote": "ርቀት",
  ...
  "settings.mcp.form.command": "ትእዛዝ",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Leave blank to omit — re-authentication may be required",
