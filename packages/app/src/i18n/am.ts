export const dict = {
  ...
  "session.tab.agents": "ንዑስ ወኪሎች",
  "session.agents.empty": "ምንም ንዑስ ወኪል እየሰራ አይደለም",
  "session.agents.costTotal": "ጠቅላላ ወጪ",
  "session.agents.costSubagents": "ንዑስ ወኪሎች",
  "session.agents.count": "ወኪሎች",
  "session.agents.tokens": "ቶከኖች",
  "session.agents.showAll": "ሁሉንም አሳይ ({{count}})",
  "session.agents.status.idle": "ባዶ",
  "session.agents.status.busy": "በመሥራት ላይ",
  "session.agents.status.retry": "እንደገና በመሞከር ላይ",
  "session.agents.status.cancelled": "ተሰርዟል",
  "session.agents.status.completed": "ተጠናቋል",
  "session.agents.status.error": "አልተሳካም",
