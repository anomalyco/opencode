export const dict = {
  ...
  "home.recentlyClosed.options": "ማጣራት እና መደርደር",
  "home.recentlyClosed.filter.label": "ማጣሪያ",
  "home.recentlyClosed.filter.recent": "የቅርብ ጊዜ",
  "home.recentlyClosed.filter.archived": "በማህደር የተቀመጡ",
  "home.recentlyClosed.filter.hidden": "የተደበቁ",
  "home.recentlyClosed.filter.all": "ሁሉም",
  "home.recentlyClosed.filter.empty": "ከዚህ ማጣሪያ ጋር የሚዛመድ ፕሮጀክት የለም",
  "home.recentlyClosed.sort.label": "መደርደር",
  "home.recentlyClosed.sort.recent": "አዲሶቹ መጀመሪያ",
  "home.recentlyClosed.sort.oldest": "አሮጌዎቹ መጀመሪያ",
  "home.recentlyClosed.sort.nameAsc": "ስም A–Z",
  "home.recentlyClosed.sort.nameDesc": "ስም Z–A",
  "home.recentlyClosed.search.placeholder": "በቅርቡ በተዘጉት ውስጥ ፈልግ",
  "home.recentlyClosed.showMore": "ሁሉንም አሳይ ({{count}})",
  "home.recentlyClosed.showLess": "ያነሰ አሳይ",
  "home.recentlyClosed.select": "ምረጥ…",
  "home.recentlyClosed.selectAll": "ሁሉንም ምረጥ",
  "home.recentlyClosed.deselectAll": "የሁሉንም ምርጫ አንሳ",
  "home.recentlyClosed.cancelSelection": "ምርጫን ሰርዝ",
  "home.recentlyClosed.selected": "{{count}} ተመርጠዋል",
  "home.recentlyClosed.noResults": "ከ“{{query}}” ጋር የሚዛመድ ፕሮጀክት የለም",
  "home.recentlyClosed.archived.badge": "በማህደር የተቀመጠ",
  "home.recentlyClosed.hidden.badge": "የተደበቀ",
  "home.recentlyClosed.action.reopen": "እንደገና ክፈት",
  "home.recentlyClosed.action.unarchive": "ከማህደር አውጣ",
  "home.recentlyClosed.action.hide": "ደብቅ",
  "home.recentlyClosed.action.unhide": "አሳይ",
  "home.recentlyClosed.action.remove": "እርሳ",
  "home.recentlyClosed.remove.title": "ፕሮጀክቱ ይረሳ?",
  "home.recentlyClosed.remove.titleMany": "{{count}} ፕሮጀክቶች ይረሱ?",
  "home.recentlyClosed.remove.confirm": "“{{name}}” በቅርቡ ከተዘጉት ይወገድ? ይህ ታሪክን ብቻ ያጸዳል እና ፋይሎችን በጭራሽ አይሰርዝም።",
  "home.recentlyClosed.remove.confirmMany": "{{count}} ፕሮጀክቶች በቅርቡ ከተዘጉት ይወገዱ? ይህ ታሪክን ብቻ ያጸዳል እና ፋይሎችን በጭራሽ አይሰርዝም።",
  "home.recentlyClosed.toast.archived": "በማህደር ተቀምጧል",
  "home.recentlyClosed.toast.hidden": "ተደብቋል",
  "home.recentlyClosed.toast.removed": "በቅርቡ ከተዘጉት ተወግዷል",
  "home.recentlyClosed.toast.undo": "ቀልብስ",
