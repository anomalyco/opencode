export const dict = {
  ...
  "provider.custom.models.load": "በራስ-ግምት ይጫን",
  "provider.custom.models.loading": "በመጫን ላይ...",
  "provider.custom.models.load.invalidUrl": "የሚሰራ መሰረት URL ያስገቡ",
  "provider.custom.models.load.unauthorized": "መዳረሻ የለም። የAPI ቁልፍ ያረጋግጡ",
  "provider.custom.models.load.invalidFormat": "የሰርቨሩ ምላሽ ትክክለኛ የሞዴል ዝርዝር አልነበረውም",
  "provider.custom.models.load.timeout": "ሞዴሎችን በመጫን ላይ ጊዜው አልፏል",
  "provider.custom.models.load.failed": "ሞዴሎችን መጫን አልተሳካም",
  "provider.custom.models.load.empty": "ሞዴሎች አልተገኙም",
