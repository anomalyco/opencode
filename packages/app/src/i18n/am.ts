export const dict = {
  ...
  "settings.tab.plugins": "ተሰኪዎች",
  "settings.plugins.section.browse": "ያሂዱ",
  "settings.plugins.section.installed": "የተጫኑ",
  ...
  "settings.mcp.add": "አገልጋይ ያክሉ",
  "settings.mcp.empty": "የተዋቀሩ የMCP አገልጋዮች የሉም።",
  "settings.mcp.deleted": "{{name}} ተሰርዟል።",
  "settings.mcp.errors.refresh": "የMCP አገልጋዮችን መጫን አልተቻለም።",
  "settings.mcp.status.pending": "በመገናኘት ላይ…",
  "settings.mcp.action.connect": "አገናኝ",
  "settings.mcp.action.disconnect": "ግንኙነት አቋርጥ",
  "settings.mcp.action.authenticate": "ያረጋግጡ",
  "settings.mcp.action.edit": "አርትዖች",
  "settings.mcp.action.delete": "ሰርዝ",
  "settings.mcp.delete.title": "የMCP አገልጋይ ሰርዝ",
  "settings.mcp.delete.body": "{{name}} ይወገድ? ይህ መመለስ አይቻልም።",
  "settings.mcp.form.title.add": "የMCP አገልጋይ ያክሉ",
  "settings.mcp.form.title.edit": "የMCP አገልጋይን ያስተካክሉ",
  "settings.mcp.form.subtitle": "የግንኙነት ቅንብሮችን ያዋቅሩ።",
  "settings.mcp.form.name": "ስም",
  "settings.mcp.form.command": "명령",
  "settings.mcp.form.command.hint": "ለምሳሌ npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "የሥራ ማውጫ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "የአካባቢ ተለዋዋጮች",
  "settings.mcp.form.headers": "ራስጌዎች",
  "settings.mcp.form.addRow": "ረድፍ ያክሉ",
  "settings.mcp.form.removeRow": "ያስወግዱ",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "የደንበኛ መለያ",
  "settings.mcp.form.oauth.clientSecret": "የደንበኛ ሚስጥር",
  "settings.mcp.form.oauth.clientSecret.keep": "ተዋቅሯል — ለመጠበቅ ባዶ ይተዉ",
  "settings.mcp.form.oauth.scope": "ክልል",
  "settings.mcp.form.oauth.callbackPort": "የመመለሻ በር",
  "settings.mcp.form.oauth.disableAutodetect": "የOAuth ራስ-ማወቅን ያጥፉ",
  "settings.mcp.form.enabled": "አንቅቷል",
  "settings.mcp.form.timeout": "ጊዜ ገደብ (ms)",
  "settings.mcp.form.save": "አስቀምጥ",
  "settings.mcp.form.cancel": "ሰርዝ",
  "settings.mcp.form.error.name": "ስም ያስገቡ።",
  "settings.mcp.form.error.command": "ትእዛዝ ያስገቡ።",
  "settings.mcp.form.error.url": "URL ያስገቡ።",
  "settings.mcp.form.error.callbackPort": "የመመለሻ በር 1-65535 መካከል መሆን አለበት።",
  "settings.mcp.form.error.timeout": "ጊዜ ገደብ አዎንታዊ ቁጥር መሆን አለበት።",
  "settings.mcp.errors.invalid": "የተመረጡ መስኮችን ያስተካክሉ።",
  "settings.mcp.errors.duplicate": "በዚህ ስም አገልጋይ ቀደም ሲል አለ።",
  "settings.mcp.errors.noConfig": "{{name}} ን ማንበብ አይቻልም — ከፕሮጀክቱ ውጭ ሊተረጎም ይችላል።",
  "settings.mcp.edit.warn": "ማስቀመጥ ይህን አገልጋይ እንደገና ያገናኛል።",
  ...
  "settings.plugins.detail.copied": "ተቀድቷል",
  "settings.plugins.detail.notOnNpm": "በnpm ላይ አልተገኘም — በእጅ ወደ opencode.json ያክሉ",
  "settings.plugins.install.title": "ተሰኪ ይጫኑ",
  "settings.plugins.install.description": "{{name}} ወዴት ይጨመር?",
  "settings.plugins.install.global": "አለም አቀፍ (~/.config/opencode)",
  "settings.plugins.install.project": "ይህ ፕሮጀክት",
  "settings.plugins.install.cancel": "ሰርዝ",
  "settings.plugins.install.success": "{{name}} ተጭኗል። ለመጫን OpenCodeን እንደገና ያስጀምሩ።",
  "settings.plugins.installed.empty": "ምንም ተሰኪዎች አልተጫኑም።",
  "settings.plugins.installed.provenance.global": "አለም አቀፍ",
  "settings.plugins.installed.provenance.project": "ፕሮጀክት",
  ...
  "settings.plugins.errors.catalog": "የተሰኪ ካታሎግን ማደስ አልተቻለም።",
  "settings.plugins.stale": "የተቀመጠ ካታሎግ እየታየ ነው ({{age}} ያረጀ)።",
