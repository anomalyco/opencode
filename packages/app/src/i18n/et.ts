export const dict = {
  ...
  "desktop.wsl.error.executeDistro": "Distributsioonis ei saa käske käivitada",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OpenCode pole distributsiooni {{distro}} installitud",
  ...
  "provider.connect.apiKey.required": "API-võti on nõutav",
  ...
  "wsl.onboarding.updateOpencodeIn": "Värskenda OpenCode’i distributsioonis {{distro}}.",
  ...
  "wsl.onboarding.installOpencodeIn": "Installige OpenCode distributsiooni {{distro}}.",
  ...
  "toast.language.description": "Keeleks valiti {{language}}",
  ...
  "settings.desktop.wsl.description": "Käivitage OpenCode’i server Windowsis WSL'is.",
  ...
  "settings.general.section.feed": "Voog",
  ...
  "settings.general.row.showCustomAgents.description":
    "Koostajas saab agentide vahel vahetada. Peitmisel kasutatakse vaikimisi Build-agenti.",
  ...
  "settings.general.row.editToolPartsExpanded.title": "Laienda redigeerimistööriista osi",
  ...
  "settings.general.row.wayland.title": "Kasuta Waylandi",
  "settings.general.row.wayland.description": "Keela Waylandis X11 varurežiim. Nõuab taaskäivitamist.",
  ...
  "settings.updates.toast.latest.title": "Kasutad uusimat versiooni",
  ...
  "settings.shortcuts.conflict.description": "{{keybind}} on juba määratud toimingule {{titles}}.",
  ...
  "settings.shortcuts.group.general": "Üldine",
  "settings.shortcuts.group.session": "Seanss",
  "settings.shortcuts.group.navigation": "Navigeerimine",
  "settings.shortcuts.group.modelAndAgent": "Mudel ja agent",
  ...
  "settings.permissions.tool.doom_loop.description": "Tuvasta identse sisendiga korduvad tööriistakutsed",
