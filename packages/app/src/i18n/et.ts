export const dict = {
  ...
  "command.tab.closeAll": "Sulge kõik vahelehed",
  "command.tab.closeRight": "Sulge kõik paremal olevad vahelehed",
  "command.tab.closeOthers": "Sulge kõik vahelehed peale selle",
