export const dict = {
  ...
  "command.session.handoff": "Anna seanss üle",
  "command.session.handoff.description": "Tee seansist kokkuvõte ja jätka tööd uues seansis",
  ...
  "toast.session.handoff.failed.title": "Seansi üleandmine ebaõnnestus",
  "toast.session.handoff.failed.description": "Sellest seansist ei saanud üleandmiseks kokkuvõtet teha",
