export const dict = {
  ...
  "session.tab.agents": "Alam-agendid",
  "session.agents.empty": "Ühtegi alam-agenti ei tööta",
  "session.agents.costTotal": "Kogukulu",
  "session.agents.costSubagents": "Alam-agendid",
  "session.agents.count": "Agendid",
  "session.agents.tokens": "tokenit",
  "session.agents.showAll": "Näita kõiki ({{count}})",
  "session.agents.status.idle": "Jõude",
  "session.agents.status.busy": "Töötab",
  "session.agents.status.retry": "Proovib uuesti",
  "session.agents.status.cancelled": "Tühistatud",
  "session.agents.status.completed": "Lõpetatud",
  "session.agents.status.error": "Ebaõnnestus",
