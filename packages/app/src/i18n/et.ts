export const dict = {
  ...
  "desktop.recovery.loadFailed": "Pencode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Pencode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Pencode ei vasta",
  ...
  "desktop.wsl.error.installPencode": "Pencode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.pencodeMissing": "pencode pole sellesse distrosse installitud",
  "desktop.wsl.error.pencodeCannotRun": "pencode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.pencode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.pencode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.pencodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Pencode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Pencode'is.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Külastage ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Pencode.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis pencode.json",
  ...
  "dialog.server.description": "Lülitage, millise Pencode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode kontrollimine...",
  "wsl.onboarding.checkingPencodeIn": "Pencode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingPencode": "Pencode värskendamine...",
  "wsl.onboarding.updatingPencodeIn": "Pencode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Värskenda Pencode jaotises {{distro}}.",
  "wsl.onboarding.updatePencode": "Värskenda Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode on valmis {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode on valmis.",
  "wsl.onboarding.installPencodeIn": "Installige Pencode asukohta {{distro}}.",
  "wsl.onboarding.installPencode": "Installige Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Pencode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Pencode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Pencode.",
  ...
  "help.tabs.introduction": "Pencode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Pencode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Pencode meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (pencode.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Pencode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Pencode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Pencode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Pencode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Pencode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Pencode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Pencode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Pencode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Pencode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Pencode uusimat versiooni.",
