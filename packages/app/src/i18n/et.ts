export const dict = {
  ...
  "provider.custom.models.load": "Laadi dünaamiliselt",
  "provider.custom.models.loading": "Laaditakse...",
  "provider.custom.models.load.invalidUrl": "Sisestage kehtiv baas URL",
  "provider.custom.models.load.unauthorized": "Volitamata. Kontrollige API võtit",
  "provider.custom.models.load.invalidFormat": "Serveri vastus ei sisaldanud kehtivat mudelite loendit",
  "provider.custom.models.load.timeout": "Mudelite laadimisel aegus",
  "provider.custom.models.load.failed": "Mudelite laadimine ebaõnnestus",
  "provider.custom.models.load.empty": "Malle ei leitud",
