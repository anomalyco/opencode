export const dict = {
  ...
  "command.session.background": "Käivita alamagendid taustal",
  "command.session.background.description": "Vabasta seda seanssi blokeerivad alamagendid ja jätka nendega taustal",
  ...
  "toast.session.background.failed.title": "Alamagentide taustale viimine ebaõnnestus",
