export const dict = {
  ...
  "settings.tab.plugins": "Pluginad",
  "settings.plugins.section.browse": "Sirvi",
  "settings.plugins.section.installed": "Paigaldatud",
  ...
  "settings.mcp.add": "Lisa server",
  "settings.mcp.empty": "Ühtegi MCP-serverit pole seadistatud.",
  "settings.mcp.deleted": "{{name}} kustutati.",
  "settings.mcp.errors.refresh": "MCP-serverite laadimine ebaõnnestus.",
  "settings.mcp.status.pending": "ühendamine…",
  "settings.mcp.action.connect": "Ühenda",
  "settings.mcp.action.disconnect": "Katkesta ühendus",
  "settings.mcp.action.authenticate": "Autenti",
  "settings.mcp.action.edit": "Muuda",
  "settings.mcp.action.delete": "Kustuta",
  "settings.mcp.delete.title": "Kustuta MCP-server",
  "settings.mcp.delete.body": "Eemaldada {{name}}? Seda ei saa tagasi võtta.",
  "settings.mcp.form.title.add": "Lisa MCP-server",
  "settings.mcp.form.title.edit": "Muuda MCP-serverit",
  "settings.mcp.form.subtitle": "Seadista ühenduse sätted.",
  "settings.mcp.form.name": "Nimi",
  "settings.mcp.form.command": "Käsk",
  "settings.mcp.form.command.hint": "nt npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Töökataloog",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Keskkonnamuutujad",
  "settings.mcp.form.headers": "Päised",
  "settings.mcp.form.addRow": "Lisa rida",
  "settings.mcp.form.removeRow": "Eemalda",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "Kliendi ID",
  "settings.mcp.form.oauth.clientSecret": "Kliendi saladus",
  "settings.mcp.form.oauth.clientSecret.keep": "Seadistatud — säilitamiseks jäta tühjaks",
  "settings.mcp.form.oauth.scope": "Ulatus",
  "settings.mcp.form.oauth.callbackPort": "Tagasikutse port",
  "settings.mcp.form.oauth.disableAutodetect": "Keela OAuthi automaatne tuvastus",
  "settings.mcp.form.enabled": "Lubatud",
  "settings.mcp.form.timeout": "Ajalõpp (ms)",
  "settings.mcp.form.save": "Salvesta",
  "settings.mcp.form.cancel": "Tühista",
  "settings.mcp.form.error.name": "Sisesta nimi.",
  "settings.mcp.form.error.command": "Sisesta käsk.",
  "settings.mcp.form.error.url": "Sisesta URL.",
  "settings.mcp.form.error.callbackPort": "Tagasikutse port peab olema 1–65535.",
  "settings.mcp.form.error.timeout": "Ajalõpp peab olema positiivne täisarv.",
  "settings.mcp.errors.invalid": "Paranda esiletõstetud väljad.",
  "settings.mcp.errors.duplicate": "Selle nimega server on juba olemas.",
  "settings.mcp.errors.noConfig": "{{name}} konfiguratsiooni ei saa lugeda — see võib olla määratletud väljaspool projekti.",
  "settings.mcp.edit.warn": "Salvestamine ühendab serveri uuesti.",
  ...
  "settings.plugins.detail.copied": "Kopeeritud",
  "settings.plugins.detail.notOnNpm": "Ei leitud npm-ist — lisa käsitsi faili opencode.json",
  "settings.plugins.install.title": "Paigalda plugin",
  "settings.plugins.install.description": "Kuhu {{name}} lisada?",
  "settings.plugins.install.global": "Globaalne (~/.config/opencode)",
  "settings.plugins.install.project": "See projekt",
  "settings.plugins.install.cancel": "Tühista",
  "settings.plugins.install.success": "{{name}} paigaldati. Laadimiseks taaskäivita OpenCode.",
  "settings.plugins.installed.empty": "Ühtegi pluginat pole paigaldatud.",
  "settings.plugins.installed.provenance.global": "Globaalne",
  ...
  "settings.plugins.errors.catalog": "Pluginate kataloogi ei saanud värskendada.",
  "settings.plugins.stale": "Kuvatakse vahemälus olevat kataloogi ({{age}} vanune).",
