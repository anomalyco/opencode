export const dict = {
  ...
  "desktop.recovery.loadFailed": "Argus laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Argus aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Argus ei vasta",
  ...
  "desktop.wsl.error.installArgus": "Argus installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.argusMissing": "argus pole sellesse distrosse installitud",
  "desktop.wsl.error.argusCannotRun": "argus on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.argusNotInstalled": "Argus pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argus värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.argus.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.argus.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.argusGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Argus",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Argus'is.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.argusZen.visit.prefix": "Külastage ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Argus.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis argus.json",
  ...
  "dialog.server.description": "Lülitage, millise Argus serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingArgus": "Argus kontrollimine...",
  "wsl.onboarding.checkingArgusIn": "Argus kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingArgus": "Argus värskendamine...",
  "wsl.onboarding.updatingArgusIn": "Argus värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Värskenda Argus jaotises {{distro}}.",
  "wsl.onboarding.updateArgus": "Värskenda Argus",
  "wsl.onboarding.argusReadyIn": "Argus on valmis {{distro}}.",
  "wsl.onboarding.argusReady": "Argus on valmis.",
  "wsl.onboarding.installArgusIn": "Installige Argus asukohta {{distro}}.",
  "wsl.onboarding.installArgus": "Installige Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Argus saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Argus ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Argus.",
  ...
  "help.tabs.introduction": "Argus Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Argus ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Argus meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (argus.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Argus ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Argus sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Argus Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Argus server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Argus kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Argus teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Argus järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Argus on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Argus käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Argus uusimat versiooni.",
