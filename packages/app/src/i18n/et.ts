export const dict = {
  ...
  "mcp.status.needs_client_registration": "kliendi registreerimine vajalik",
  "mcp.status.pending": "ühendamine…",
  ...
  "settings.mcp.type.local": "Kohalik",
  "settings.mcp.type.remote": "Kaug",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Jäta tühjaks, et vahele jätta — taasautentimine võib olla vajalik",
