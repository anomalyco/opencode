export const dict = {
  ...
  "provider.custom.models.load": "ڈائنامک طور تے لوڈ کرو",
  "provider.custom.models.loading": "لوڈ ہو رہا اے...",
  "provider.custom.models.load.invalidUrl": "اک درست بیس URL درج کرو",
  "provider.custom.models.load.unauthorized": "اجازت نئیں۔ API کلید چیک کرو",
  "provider.custom.models.load.invalidFormat": "سرور دا جواب درست ماڈل لسٹ نئیں سی",
  "provider.custom.models.load.timeout": "ماڈل لوڈ کرن ویلے وقت مک گیا",
  "provider.custom.models.load.failed": "ماڈل لوڈ کرن وچ ناکامی",
  "provider.custom.models.load.empty": "کوئی ماڈل نئیں لبھا",
