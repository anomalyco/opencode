export const dict = {
  ...
  "desktop.menu.documentation": "Pencode دیاں دستاویزاں",
  ...
  "desktop.menu.ariaLabel": "Pencode مینو",
  ...
  "desktop.recovery.loadFailed": "Pencode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Pencode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Pencode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installPencode": "Pencode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.pencodeMissing": "اس ڈسٹرو وچ pencode انسٹال نئیں اے",
  "desktop.wsl.error.pencodeCannotRun": "pencode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.pencodeNotInstalled": "{{distro}} وچ Pencode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Pencode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.pencode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.pencode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.pencodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Pencode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.pencodeZen.visit.prefix": "ویکھو ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Pencode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Pencode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "pencode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Pencode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingPencode": "Pencode چیک کر رئے آں...",
  "wsl.onboarding.checkingPencodeIn": "{{distro}} چ Pencode دی جانچ پڑتال...",
  "wsl.onboarding.updatingPencode": "Pencode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingPencodeIn": "{{distro}} وچ Pencode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatePencodeIn": "{{distro}} وچ Pencode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updatePencode": "Pencode اپ ڈیٹ کرو",
  "wsl.onboarding.pencodeReadyIn": "Pencode {{distro}} چ تیار اے۔",
  "wsl.onboarding.pencodeReady": "Pencode تیار اے۔",
  "wsl.onboarding.installPencodeIn": "{{distro}} وچ Pencode انسٹال کرو۔",
  "wsl.onboarding.installPencode": "Pencode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pencode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Pencode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Pencode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Pencode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Pencode ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (pencode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Pencode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Pencode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "app.name.desktop": "Pencode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Pencode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Pencode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Pencode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Pencode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Pencode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Pencode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Pencode دا تازہ ترین ورژن چلا رئے او۔",
