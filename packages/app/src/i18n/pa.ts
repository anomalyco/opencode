export const dict = {
  ...
  "settings.tab.plugins": "ਪਲੱਗਇਨ",
  "settings.plugins.section.browse": "ਬਰਾਊਜ਼ ਕਰੋ",
  "settings.plugins.section.installed": "ਇੰਸਟਾਲ ਹੈ",
  ...
  "settings.mcp.add": "ਸਰਵਰ ਜੋੜੋ",
  "settings.mcp.empty": "ਕੋਈ MCP ਸਰਵਰ ਕੌਂਫਿਗਰ ਨਹੀਂ ਹੈ।",
  "settings.mcp.deleted": "{{name}} ਮਿਟਾ ਦਿੱਤਾ ਗਿਆ।",
  "settings.mcp.errors.refresh": "MCP ਸਰਵਰ ਲੋਡ ਨਹੀਂ ਹੋ ਸਕੇ।",
  "settings.mcp.status.pending": "ਜੁੜ ਰਿਹਾ ਹੈ…",
  "settings.mcp.action.connect": "ਕਨੈਕਟ ਕਰੋ",
  "settings.mcp.action.disconnect": "ਡਿਸਕਨੈਕਟ ਕਰੋ",
  "settings.mcp.action.authenticate": "ਪ੍ਰਮਾਣਿਤ ਕਰੋ",
  "settings.mcp.action.edit": "ਸੋਧੋ",
  "settings.mcp.action.delete": "ਮਿਟਾਓ",
  "settings.mcp.delete.title": "MCP ਸਰਵਰ ਮਿਟਾਓ",
  "settings.mcp.delete.body": "{{name}} ਹਟਾਉਣਾ ਹੈ? ਇਹ ਵਾਪਸ ਨਹੀਂ ਹੋ ਸਕਦਾ।",
  "settings.mcp.form.title.add": "MCP ਸਰਵਰ ਜੋੜੋ",
  "settings.mcp.form.title.edit": "MCP ਸਰਵਰ ਸੋਧੋ",
  "settings.mcp.form.subtitle": "ਕੁਨੈਕਸ਼ਨ ਸੈਟਿੰਗਾਂ ਕੌਂਫਿਗਰ ਕਰੋ।",
  "settings.mcp.form.name": "ਨਾਮ",
  "settings.mcp.form.command": "ਕਮਾਂਡ",
  "settings.mcp.form.command.hint": "ਜਿਵੇਂ npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ਵਰਕਿੰਗ ਡਾਇਰੈਕਟਰੀ",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "ਏਨਵਾਇਰਨਮੈਂਟ ਵੇਰੀਏਬਲ",
  "settings.mcp.form.headers": "ਹੈੱਡਰ",
  "settings.mcp.form.addRow": "ਕਤਾਰ ਜੋੜੋ",
  "settings.mcp.form.removeRow": "ਹਟਾਓ",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ਕਲਾਈਂਟ ID",
  "settings.mcp.form.oauth.clientSecret": "ਕਲਾਈਂਟ ਸੀਕਰੇਟ",
  "settings.mcp.form.oauth.clientSecret.keep": "ਕੌਂਫਿਗਰ ਹੈ — ਰੱਖਣ ਲਈ ਖਾਲੀ ਛੱਡੋ",
  "settings.mcp.form.oauth.scope": "ਸਕੋਪ",
  "settings.mcp.form.oauth.callbackPort": "ਕਾਲਬੈਕ ਪੋਰਟ",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth ਆਟੋ-ਡਿਟੈਕਸ਼ਨ ਬੰਦ ਕਰੋ",
  "settings.mcp.form.enabled": "ਯੋਗ",
  "settings.mcp.form.timeout": "ਟਾਈਮਆਊਟ (ms)",
  "settings.mcp.form.save": "ਸੰਭਾਲੋ",
  "settings.mcp.form.cancel": "ਰੱਦ ਕਰੋ",
  "settings.mcp.form.error.name": "ਨਾਮ ਦਰਜ ਕਰੋ।",
  "settings.mcp.form.error.command": "ਕਮਾਂਡ ਦਰਜ ਕਰੋ।",
  "settings.mcp.form.error.url": "URL ਦਰਜ ਕਰੋ।",
  "settings.mcp.form.error.callbackPort": "ਕਾਲਬੈਕ ਪੋਰਟ 1-65535 ਵਿਚਕਾਰ ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ।",
  "settings.mcp.form.error.timeout": "ਟਾਈਮਆਊਟ ਧਨਾਤਮਕ ਪੂਰਨ ਅੰਕ ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ।",
  "settings.mcp.errors.invalid": "ਹਾਈਲਾਈਟ ਕੀਤੇ ਖੇਤਰ ਠੀਕ ਕਰੋ।",
  "settings.mcp.errors.duplicate": "ਇਸ ਨਾਮ ਨਾਲ ਸਰਵਰ ਪਹਿਲਾਂ ਹੀ ਮੌਜੂਦ ਹੈ।",
  "settings.mcp.errors.noConfig": "{{name}} ਦੀ ਕੌਂਫਿਗਰੇਸ਼ਨ ਨਹੀਂ ਪੜ੍ਹੀ ਜਾ ਸਕੀ — ਪ੍ਰੋਜੈਕਟ ਤੋਂ ਬਾਹਰ ਪਰਿਭਾਸ਼ਿਤ ਹੋ ਸਕਦੀ ਹੈ।",
  "settings.mcp.edit.warn": "ਸੰਭਾਲਣ ਨਾਲ ਇਹ ਸਰਵਰ ਮੁੜ ਜੁੜੇਗਾ।",
  ...
  "settings.plugins.detail.copied": "ਕਾਪੀ ਕੀਤਾ",
  "settings.plugins.detail.notOnNpm": "npm 'ਤੇ ਨਹੀਂ ਮਿਲਿਆ — opencode.json ਵਿੱਚ ਹੱਥੀਂ ਜੋੜੋ",
  "settings.plugins.install.title": "ਪਲੱਗਇਨ ਇੰਸਟਾਲ ਕਰੋ",
  "settings.plugins.install.description": "{{name}} ਕਿੱਥੇ ਜੋੜਿਆ ਜਾਵੇ?",
  "settings.plugins.install.global": "ਗਲੋਬਲ (~/.config/opencode)",
  "settings.plugins.install.project": "ਇਹ ਪ੍ਰੋਜੈਕਟ",
  "settings.plugins.install.cancel": "ਰੱਦ ਕਰੋ",
  "settings.plugins.install.success": "{{name}} ਇੰਸਟਾਲ ਹੋ ਗਿਆ। ਲੋਡ ਕਰਨ ਲਈ OpenCode ਮੁੜ ਚਾਲੂ ਕਰੋ।",
  "settings.plugins.installed.empty": "ਕੋਈ ਪਲੱਗਇਨ ਇੰਸਟਾਲ ਨਹੀਂ ਹੈ।",
  "settings.plugins.installed.provenance.global": "ਗਲੋਬਲ",
  "settings.plugins.installed.provenance.project": "ਪ੍ਰੋਜੈਕਟ",
  ...
  "settings.plugins.errors.catalog": "ਪਲੱਗਇਨ ਕੈਟਾਲੌਗ ਰਿਫ੍ਰੈਸ਼ ਨਹੀਂ ਹੋ ਸਕਿਆ",
  "settings.plugins.stale": "ਕੈਸ਼ ਕੀਤਾ ਕੈਟਾਲੌਗ ਵਿਖਾਇਆ ਜਾ ਰਿਹਾ ਹੈ ({{age}} ਪੁਰਾਣਾ)",
