export const dict = {
  ...
  "desktop.menu.documentation": "Jarvis دیاں دستاویزاں",
  ...
  "desktop.menu.ariaLabel": "Jarvis مینو",
  ...
  "desktop.recovery.loadFailed": "Jarvis لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Jarvis دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Jarvis جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Jarvis انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Jarvis دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Jarvis وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Jarvis وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Jarvis وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس Jarvis سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvis چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Jarvis دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Jarvis نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Jarvis نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Jarvis نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Jarvis اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Jarvis {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Jarvis تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Jarvis انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Jarvis انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Jarvis دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Jarvis ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Jarvis دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Jarvis Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Jarvis ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Jarvis ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Jarvis ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Jarvis چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "app.name.desktop": "Jarvis ڈیسک ٹاپ",
  "settings.section.desktop": "ڈیسک ٹاپ",
  "settings.section.server": "سرور",
  "settings.tab.general": "عمومی",
  "settings.tab.shortcuts": "شارٹ کٹ",
  "settings.tab.integrations": "ਏਕੀਕਰਨ",
  "settings.tab.connectors": "ਕਨੈਕਟਰ",
  "settings.integrations.placeholder": "ਏਕੀਕਰਨ Jarvis ਰਨਟਾਈਮ ਨੂੰ ਵਧਾਉਂਦੇ ਹਨ। ਜਲਦੀ ਹੀ ਤੁਸੀਂ ਪਲੱਗਇਨ, ਥੀਮ ਅਤੇ ਸਿਸਟਮ ਐਕਸਟੈਂਸ਼ਨਾਂ ਸਥਾਪਤ ਕਰ ਸਕੋਗੇ।",
  "settings.connectors.placeholder": "ਕਨੈਕਟਰ Jarvis ਨੂੰ ਬਾਹਰੀ ਸੇਵਾਵਾਂ ਨਾਲ ਜੋੜਦੇ ਹਨ। ਜਲਦੀ ਆ ਰਹੇ ਹਨ: Gmail, WhatsApp, Slack, Notion, Telegram ਅਤੇ ਹੋਰ।",
  "settings.connectors.unavailable": "ਕਨੈਕਟਰ ਸਿਰਫ਼ ਡੈਸਕਟਾਪ ਐਪ ਵਿੱਚ ਉਪਲਬਧ ਹਨ।",
  "settings.connectors.badge.connected": "ਕਨੈਕਟ ਕੀਤਾ",
  "settings.connectors.badge.notConnected": "ਕਨੈਕਟ ਨਹੀਂ",
  "settings.connectors.badge.disabled": "ਅਯੋਗ",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "ਆਪਣੇ GitHub ਖਾਤੇ ਨੂੰ ਕਨੈਕਟ ਕਰੋ ਤਾਂ ਕਿ Jarvis ਤੁਹਾਡੇ ਰਿਪੋਜ਼ਟਰੀਆਂ ਨੂੰ ਪੜ੍ਹ ਅਤੇ ਪ੍ਰਬੰਧਿਤ ਕਰ ਸਕੇ।",
  "settings.connectors.github.detail": "ਆਪਣੇ GitHub ਖਾਤੇ ਨੂੰ ਕਨੈਕਟ ਕਰੋ ਤਾਂ ਕਿ Jarvis ਤੁਹਾਡੇ ਰਿਪੋਜ਼ਟਰੀਆਂ, ਇਸ਼ੂਆਂ ਅਤੇ ਪੁੱਲ ਰਿਕਵੈਸਟਾਂ ਨਾਲ ਸਿੱਧੇ ਚੈਟ ਤੋਂ ਕੰਮ ਕਰ ਸਕੇ। ਤੁਸੀਂ OAuth ਰਾਹੀਂ ਆਪਣੇ GitHub ਖਾਤੇ ਨਾਲ ਪਹੁੰਚ ਨੂੰ ਅਧਿਕਾਰਤ ਕਰਦੇ ਹੋ — Jarvis ਤੁਹਾਡਾ ਪਾਸਵਰਡ ਕਦੇ ਨਹੀਂ ਦੇਖਦਾ।",
  "settings.connectors.github.permission.repos": "ਆਪਣੀਆਂ ਰਿਪੋਜ਼ਟਰੀਆਂ, ਇਸ਼ੂਆਂ ਅਤੇ ਪੁੱਲ ਰਿਕਵੈਸਟਾਂ ਨੂੰ ਪੜ੍ਹੋ ਅਤੇ ਪ੍ਰਬੰਧਿਤ ਕਰੋ",
  "settings.connectors.github.permission.profile": "ਆਪਣਾ ਜਨਤਕ ਪ੍ਰੋਫਾਈਲ ਪੜ੍ਹੋ (ਉਪਭੋਗਤਾ ਨਾਮ ਅਤੇ ਅਵਤਾਰ)",
  "settings.connectors.github.connect": "GitHub ਕਨੈਕਟ ਕਰੋ",
  "settings.connectors.github.disconnect": "ਡਿਸਕਨੈਕਟ ਕਰੋ",
  "settings.connectors.github.cancel": "ਰੱਦ ਕਰੋ",
  "settings.connectors.github.openBrowser": "ਬ੍ਰਾਊਜ਼ਰ ਖੋਲ੍ਹੋ",
  "settings.connectors.github.waiting": "ਪ੍ਰਮਾਣੀਕਰਨ ਦੀ ਉਡੀਕ…",
  "settings.connectors.github.code.instructions": "ਇਹ ਕੋਡ ਦਰਜ ਕਰੋ",
  "settings.connectors.github.connected.text": "OAuth ਰਾਹੀਂ ਕਨੈਕਟ ਕੀਤਾ। Jarvis ਤੁਹਾਡੇ GitHub ਖਾਤੇ ਤੱਕ ਪਹੁੰਚ ਕਰ ਸਕਦਾ ਹੈ।",
  "settings.connectors.github.error.expired": "ਪ੍ਰਮਾਣੀਕਰਨ ਕੋਡ ਦੀ ਮਿਆਦ ਖਤਮ ਹੋ ਗਈ ਹੈ। ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
  "settings.connectors.github.error.generic": "GitHub ਨਾਲ ਕਨੈਕਟ ਨਹੀਂ ਹੋ ਸਕਿਆ। ਆਪਣਾ ਕਨੈਕਸ਼ਨ ਚੈੱਕ ਕਰੋ ਅਤੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
  "settings.connectors.github.error.denied": "ਪ੍ਰਮਾਣੀਕਰਨ ਰੱਦ ਕਰ ਦਿੱਤਾ ਗਿਆ। ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਸਮੇਂ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰ ਸਕਦੇ ਹੋ।",
  "desktop.menu.wiki": "ਵਿਕੀ",
  "command.session.export": "ਸੈਸ਼ਨ ਨਿਰਯਾਤ ਕਰੋ",
  "command.session.export.description": "ਸੈਸ਼ਨ ਦਾ ਪੂਰਾ ਟਰਾਂਸਕ੍ਰਿਪਟ JSON ਵਜੋਂ ਨਿਰਯਾਤ ਕਰੋ",
  "context.export.session": "ਸੈਸ਼ਨ ਨਿਰਯਾਤ ਕਰੋ",
  "toast.session.export.success.title": "ਸੈਸ਼ਨ ਨਿਰਯਾਤ ਹੋਇਆ",
  "toast.session.export.success.description": "ਸੈਸ਼ਨ {{filename}} ਵਿੱਚ ਸੁਰੱਖਿਅਤ ਕੀਤਾ ਗਿਆ",
  "toast.session.export.failed.title": "ਸੈਸ਼ਨ ਨਿਰਯਾਤ ਅਸਫਲ",
  "toast.session.export.failed.description": "ਸੈਸ਼ਨ ਨਿਰਯਾਤ ਕਰਦੇ ਸਮੇਂ ਇੱਕ ਗਲਤੀ ਆਈ",
  "common.export": "ਨਿਰਯਾਤ",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL نال جوڑ",
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Jarvis سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Jarvis لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Jarvis کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Jarvis سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Jarvis نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Jarvis لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Jarvis دا تازہ ترین ورژن چلا رئے او۔",
