export const dict = {
  ...
  "desktop.menu.documentation": "Argus دیاں دستاویزاں",
  ...
  "desktop.menu.ariaLabel": "Argus مینو",
  ...
  "desktop.recovery.loadFailed": "Argus لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Argus دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Argus جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installArgus": "Argus دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.argusMissing": "اس ڈسٹرو وچ argus انسٹال نئیں اے",
  "desktop.wsl.error.argusCannotRun": "argus انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.argusNotInstalled": "{{distro}} وچ Argus انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Argus دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.argus.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.argus.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.argusGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Argus دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Argus وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.argusZen.visit.prefix": "ویکھو ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Argus وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Argus وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "argus.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Argus سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingArgus": "Argus چیک کر رئے آں...",
  "wsl.onboarding.checkingArgusIn": "{{distro}} چ Argus دی جانچ پڑتال...",
  "wsl.onboarding.updatingArgus": "Argus نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingArgusIn": "{{distro}} وچ Argus نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateArgusIn": "{{distro}} وچ Argus نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateArgus": "Argus اپ ڈیٹ کرو",
  "wsl.onboarding.argusReadyIn": "Argus {{distro}} چ تیار اے۔",
  "wsl.onboarding.argusReady": "Argus تیار اے۔",
  "wsl.onboarding.installArgusIn": "{{distro}} وچ Argus انسٹال کرو۔",
  "wsl.onboarding.installArgus": "Argus انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Argus دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Argus ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Argus دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Argus Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Argus ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Argus ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (argus.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Argus ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Argus چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "app.name.desktop": "Argus ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Argus سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Argus لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Argus کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Argus سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Argus نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Argus لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Argus دا تازہ ترین ورژن چلا رئے او۔",
