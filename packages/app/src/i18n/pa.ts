export const dict = {
  ...
  "command.session.handoff": "ਸੈਸ਼ਨ ਸੌਂਪੋ",
  "command.session.handoff.description": "ਸੈਸ਼ਨ ਨੂੰ ਸੰਖੇਪ ਕਰੋ ਅਤੇ ਨਵੇਂ ਸੈਸ਼ਨ ਵਿੱਚ ਕੰਮ ਜਾਰੀ ਰੱਖੋ",
  ...
  "toast.session.handoff.failed.title": "ਸੈਸ਼ਨ ਸੌਂਪਣ ਵਿੱਚ ਅਸਫਲ",
  "toast.session.handoff.failed.description": "ਸੌਂਪਣ ਲਈ ਇਸ ਸੈਸ਼ਨ ਦਾ ਸੰਖੇਪ ਨਹੀਂ ਬਣਾਇਆ ਜਾ ਸਕਿਆ",
