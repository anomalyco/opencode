export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "غلط SSH ہوسٹ: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} پہلے ای شامل اے",
  "desktop.ssh.error.opencodeNotInstalled": "{{host}} تے opencode انسٹال نئیں اے",
  "desktop.ssh.error.installOpencode": "opencode دی تنصیب ناکام ہو گئی",
  "desktop.ssh.error.connectFailed": "{{host}} نال جڑیا نئیں جا سکیا",
  "desktop.ssh.error.serverExited": "SSH سرور شروع ہون پچھوں بند ہو گیا (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}} دا SSH سرور ٹھیک حالت وچ آون توں پہلاں بند ہو گیا (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "{{host}} تے سرور دی صحت پڑتال لئی مقرر ویلا {{timeout}}ms پچھوں مُک گیا",
  "desktop.ssh.error.commandTimeout": "{{host}} لئی ssh کمانڈ دا مقرر ویلا {{timeout}}ms پچھوں مُک گیا",
  "desktop.ssh.error.failedPort": "پورٹ نئیں مل سکی",
  "desktop.ssh.error.terminalFailed": "ٹرمینل نئیں کھولیا جا سکیا",
  ...
  "ssh.server.add": "SSH سرور شامل کرو",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH سرور",
  "ssh.server.retryStart": "دوبارہ منسلک کرو",
  "ssh.server.disconnect": "منقطع کرو",
  "ssh.server.openTerminal": "ٹرمینل کھولو",
  "ssh.server.updating": "اپ ڈیٹ...",
  "ssh.server.status.connecting": "جڑ رہیا اے...",
  "ssh.server.status.disconnected": "منقطع",
  "ssh.add.hostLabel": "SSH ہوسٹ",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "تہاڈے سسٹم دے ssh کلائنٹ راہیں جڑدا اے، اس لئی تہاڈی SSH کنفیگ دے ہوسٹ، کلیداں تے ایجنٹ عام وانگ کم کردے نیں۔",
  "ssh.add.configHosts": "تہاڈی SSH کنفیگ توں",
  "ssh.add.connect": "منسلک کرو",
  "ssh.add.checking": "جڑ رہیا اے...",
  "ssh.add.addServer": "سرور شامل کرو",
  "ssh.add.adding": "شامل کر رہیا واں...",
  "ssh.add.installOpencode": "opencode انسٹال کرو",
  "ssh.add.updateOpencode": "opencode اپ ڈیٹ کرو",
  "ssh.add.installing": "انسٹال کر رہیا اے...",
  "ssh.add.status.unreachable": "جڑیا نئیں جا سکیا",
  "ssh.add.status.opencodeMissing": "اس ہوسٹ تے opencode انسٹال نئیں اے",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} انسٹال اے، ڈیسک ٹاپ نوں v{{expected}} چاہیدا اے",
  "ssh.add.status.opencodeFound": "opencode v{{version}} مل گیا",
  "ssh.add.authHint":
    "پکا کرو کہ اس ہوسٹ لئی کلید والی SSH تصدیق کم کردی اے — پڑتال لئی ٹرمینل وچ `ssh {{host}}` چلاؤ۔",
