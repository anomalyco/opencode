export const dict = {
  ...
  "session.tab.agents": "ਸਬਏਜੰਟ",
  "session.agents.empty": "ਕੋਈ ਸਬਏਜੰਟ ਨਹੀਂ ਚੱਲ ਰਿਹਾ",
  "session.agents.costTotal": "ਕੁੱਲ ਲਾਗਤ",
  "session.agents.costSubagents": "ਸਬਏਜੰਟ",
  "session.agents.count": "ਏਜੰਟ",
  "session.agents.tokens": "ਟੋਕਨ",
  "session.agents.showAll": "ਸਭ ਦਿਖਾਓ ({{count}})",
  "session.agents.status.idle": "ਵਿਹਲਾ",
  "session.agents.status.busy": "ਚੱਲ ਰਿਹਾ ਹੈ",
  "session.agents.status.retry": "ਮੁੜ ਕੋਸ਼ਿਸ਼",
  "session.agents.status.cancelled": "ਰੱਦ ਕੀਤਾ",
  "session.agents.status.completed": "ਮੁਕੰਮਲ",
  "session.agents.status.error": "ਅਸਫਲ",
