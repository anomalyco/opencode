export const dict = {
  ...
  "mcp.status.needs_client_registration": "ਕਲਾਈਂਟ ਰਜਿਸਟ੍ਰੇਸ਼ਨ ਲੋੜੀਂਦੀ",
  "mcp.status.pending": "ਜੁੜ ਰਿਹਾ ਹੈ…",
  ...
  "settings.mcp.type.local": "ਲੋਕਲ",
  "settings.mcp.type.remote": "ਰਿਮੋਟ",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "ਛੱਡਣ ਲਈ ਖਾਲੀ ਛੱਡੋ — ਦੁਬਾਰਾ ਪ੍ਰਮਾਣੀਕਰਨ ਦੀ ਲੋੜ ਹੋ ਸਕਦੀ ਹੈ",
