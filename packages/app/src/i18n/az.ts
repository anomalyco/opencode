export const dict = {
  ...
  "provider.custom.models.load": "Dinamik yüklə",
  "provider.custom.models.loading": "Yüklənir...",
  "provider.custom.models.load.invalidUrl": "Düzgün əsas URL daxil edin",
  "provider.custom.models.load.unauthorized": "İcazə yoxdur. API açarını yoxlayın",
  "provider.custom.models.load.invalidFormat": "Server cavabı düzgün model siyahısı deyil",
  "provider.custom.models.load.timeout": "Modelləri yükləyərkən vaxt bitdi",
  "provider.custom.models.load.failed": "Modelləri yükləmək mümkün olmadı",
  "provider.custom.models.load.empty": "Model tapılmadı",
