export const dict = {
  ...
  "desktop.recovery.loadFailed": "Pencode yüklənə bilmədi",
  "desktop.recovery.terminated": "Pencode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Pencode cavab vermir",
  ...
  "desktop.wsl.error.installPencode": "Pencode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.pencodeMissing": "Bu distribütivdə pencode quraşdırılmayıb",
  "desktop.wsl.error.pencodeCannotRun": "pencode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Pencode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.pencode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.pencode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.pencodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Pencode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.pencodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Pencode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Pencode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər pencode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Pencode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingPencode": "Pencode yoxlanılır...",
  "wsl.onboarding.checkingPencodeIn": "{{distro}}-də Pencode yoxlanılır...",
  "wsl.onboarding.updatingPencode": "Pencode yenilənir...",
  "wsl.onboarding.updatingPencodeIn": "{{distro}}-də Pencode yenilənir...",
  "wsl.onboarding.updatePencodeIn": "{{distro}}-də Pencode-u yeniləyin.",
  "wsl.onboarding.updatePencode": "Pencode-u yeniləyin",
  "wsl.onboarding.pencodeReadyIn": "Pencode {{distro}}-də hazırdır.",
  "wsl.onboarding.pencodeReady": "Pencode hazırdır.",
  "wsl.onboarding.installPencodeIn": "Pencode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installPencode": "Pencode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pencode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Pencode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Pencode-u yenidən açın.",
  ...
  "help.tabs.introduction": "Pencode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Pencode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (pencode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Pencode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Pencode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Pencode serverini işlət.",
  ...
  "settings.general.row.language.description": "Pencode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Pencode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Pencode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Pencode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Pencode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Pencode-un ən son versiyasından istifadə edirsiniz.",
