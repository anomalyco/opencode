export const dict = {
  ...
  "command.session.handoff": "Sessiyanı təhvil ver",
  "command.session.handoff.description": "Sessiyanı sıxışdır və işi yeni sessiyada davam et",
  ...
  "toast.session.handoff.failed.title": "Sessiya təhvil verilə bilmədi",
  "toast.session.handoff.failed.description": "Təhvil vermək üçün bu sessiya xülasə edilə bilmədi",
