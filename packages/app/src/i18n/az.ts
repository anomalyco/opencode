export const dict = {
  ...
  "desktop.recovery.loadFailed": "Argus yüklənə bilmədi",
  "desktop.recovery.terminated": "Argus pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Argus cavab vermir",
  ...
  "desktop.wsl.error.installArgus": "Argus quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.argusMissing": "Bu distribütivdə argus quraşdırılmayıb",
  "desktop.wsl.error.argusCannotRun": "argus quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.argusNotInstalled": "Argus {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Argus yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.argus.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.argus.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.argusGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Argus tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Argus-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.argusZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Argus-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Argus-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər argus.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Argus serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingArgus": "Argus yoxlanılır...",
  "wsl.onboarding.checkingArgusIn": "{{distro}}-də Argus yoxlanılır...",
  "wsl.onboarding.updatingArgus": "Argus yenilənir...",
  "wsl.onboarding.updatingArgusIn": "{{distro}}-də Argus yenilənir...",
  "wsl.onboarding.updateArgusIn": "{{distro}}-də Argus-u yeniləyin.",
  "wsl.onboarding.updateArgus": "Argus-u yeniləyin",
  "wsl.onboarding.argusReadyIn": "Argus {{distro}}-də hazırdır.",
  "wsl.onboarding.argusReady": "Argus hazırdır.",
  "wsl.onboarding.installArgusIn": "Argus-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installArgus": "Argus quraşdırın",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Argus WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Argus bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Argus-u yenidən açın.",
  ...
  "help.tabs.introduction": "Argus Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Argus-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Argus komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (argus.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Argus hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Argus-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Argus serverini işlət.",
  ...
  "settings.general.row.language.description": "Argus üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Argus-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Argus-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Argus-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Argus açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Argus-un ən son versiyasından istifadə edirsiniz.",
