export const dict = {
  ...
  "session.tab.agents": "Subagentlər",
  "session.agents.empty": "Heç bir subagent işləmir",
  "session.agents.costTotal": "Ümumi xərc",
  "session.agents.costSubagents": "Subagentlər",
  "session.agents.count": "Agentlər",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Hamısını göstər ({{count}})",
  "session.agents.status.idle": "Boş",
  "session.agents.status.busy": "İşləyir",
  "session.agents.status.retry": "Yenidən cəhd",
  "session.agents.status.cancelled": "Ləğv edildi",
  "session.agents.status.completed": "Tamamlandı",
  "session.agents.status.error": "Uğursuz",
