export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Yanlış SSH hostu: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} artıq əlavə edilib",
  "desktop.ssh.error.opencodeNotInstalled": "opencode {{host}} hostunda quraşdırılmayıb",
  "desktop.ssh.error.installOpencode": "opencode quraşdırılması uğursuz oldu",
  "desktop.ssh.error.connectFailed": "{{host}} hostuna qoşulmaq mümkün olmadı",
  "desktop.ssh.error.serverExited": "SSH serveri başladıqdan sonra dayandı (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}} üçün SSH serveri işlək vəziyyətə gəlməzdən əvvəl dayandı (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "{{host}} üzərindəki serverin sağlamlıq yoxlamasının {{timeout}}ms gözləmə müddəti bitdi",
  "desktop.ssh.error.commandTimeout": "{{host}} üçün ssh əmrinin {{timeout}}ms gözləmə müddəti bitdi",
  "desktop.ssh.error.failedPort": "Portu əldə etmək mümkün olmadı",
  "desktop.ssh.error.terminalFailed": "Terminalı açmaq mümkün olmadı",
  ...
  "ssh.server.add": "SSH server əlavə edin",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH server",
  "ssh.server.retryStart": "Yenidən qoşulun",
  "ssh.server.disconnect": "Bağlantını kəs",
  "ssh.server.openTerminal": "Terminalı aç",
  "ssh.server.updating": "Yenilənir...",
  "ssh.server.status.connecting": "Qoşulur...",
  "ssh.server.status.disconnected": "Bağlantı kəsildi",
  "ssh.add.hostLabel": "SSH hostu",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Sisteminizdəki ssh müştərisi vasitəsilə qoşulur, buna görə də SSH konfiqurasiyanızdakı hostlar, açarlar və agentlər həmişəki kimi işləyir.",
  "ssh.add.configHosts": "SSH konfiqurasiyanızdan",
  "ssh.add.connect": "Qoşul",
  "ssh.add.checking": "Qoşulur...",
  "ssh.add.addServer": "Server əlavə et",
  "ssh.add.adding": "Əlavə edilir...",
  "ssh.add.installOpencode": "opencode quraşdırın",
  "ssh.add.updateOpencode": "opencode-u yeniləyin",
  "ssh.add.installing": "Quraşdırılır...",
  "ssh.add.status.unreachable": "Qoşulmaq mümkün olmadı",
  "ssh.add.status.opencodeMissing": "Bu hostda opencode quraşdırılmayıb",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} quraşdırılıb, masaüstü v{{expected}} gözləyir",
  "ssh.add.status.opencodeFound": "opencode v{{version}} tapıldı",
  "ssh.add.authHint":
    "Bu host üçün açar əsaslı SSH autentifikasiyasının işlədiyinə əmin olun — yoxlamaq üçün terminalda `ssh {{host}}` əmrini icra edin.",
