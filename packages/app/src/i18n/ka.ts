export const dict = {
  ...
  "session.tab.agents": "ქვეაგენტები",
  "session.agents.empty": "არცერთი ქვეაგენტი არ მუშაობს",
  "session.agents.costTotal": "საერთო ღირებულება",
  "session.agents.costSubagents": "ქვეაგენტები",
  "session.agents.count": "აგენტები",
  "session.agents.tokens": "ტოკენი",
  "session.agents.showAll": "ყველას ჩვენება ({{count}})",
  "session.agents.status.idle": "უმოქმედო",
  "session.agents.status.busy": "მუშაობს",
  "session.agents.status.retry": "ხელახლა ცდა",
  "session.agents.status.cancelled": "გაუქმებული",
  "session.agents.status.completed": "დასრულებული",
  "session.agents.status.error": "წარუმატებელი",
