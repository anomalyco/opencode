export const dict = {
  ...
  "provider.custom.models.load": "დინამიურად ჩატვირთვა",
  "provider.custom.models.loading": "იტვირთება...",
  "provider.custom.models.load.invalidUrl": "შეიყვანეთ მოქმედი ბაზა URL",
  "provider.custom.models.load.unauthorized": "არაავტორიზებული. შეამოწმეთ API გასაღები",
  "provider.custom.models.load.invalidFormat": "სერვერის პასუხი არ შეიცავს მოქმედ მოდელების სიას",
  "provider.custom.models.load.timeout": "მოდელების ჩატვირთვის დრო ამოიწურა",
  "provider.custom.models.load.failed": "მოდელების ჩატვირთვა ვერ მოხერხდა",
  "provider.custom.models.load.empty": "მოდელები ვერ მოიძებნა",
