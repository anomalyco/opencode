export const dict = {
  ...
  "command.tab.closeAll": "Zamknij wszystkie karty",
  "command.tab.closeRight": "Zamknij wszystkie karty po prawej",
  "command.tab.closeOthers": "Zamknij wszystkie karty oprócz tej",
