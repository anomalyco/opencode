export const dict = {
  ...
  "mcp.status.needs_client_registration": "wymagana rejestracja klienta",
  "mcp.status.pending": "łączenie…",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Zostaw puste, aby pominąć — może być wymagana ponowna autoryzacja",
