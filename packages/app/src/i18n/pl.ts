export const dict = {
  ...
  "session.new.branch.search": "Szukaj gałęzi",
  "session.new.branch.checkout": "Przełącz na",
  "session.new.branch.base": "Odgałęź od",
  "session.new.branch.local": "Lokalnie",
  "session.new.branch.empty": "Brak gałęzi",
  "session.new.branch.switchFailed": "Nie udało się przełączyć gałęzi",
