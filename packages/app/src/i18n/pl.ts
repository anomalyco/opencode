export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "Zobacz ponad 70 dostawców",
  ...
  "session.tab.agents": "Podagenty",
  "session.agents.empty": "Brak uruchomionych podagentów",
  "session.agents.costTotal": "Łączny koszt",
  "session.agents.costSubagents": "Podagenty",
  "session.agents.count": "Agenty",
  "session.agents.tokens": "tokenów",
  "session.agents.showAll": "Pokaż wszystkie ({{count}})",
  "session.agents.status.idle": "Bezczynny",
  "session.agents.status.busy": "Uruchomiono",
  "session.agents.status.retry": "Ponawianie",
  "session.agents.status.cancelled": "Anulowano",
  "session.agents.status.completed": "Zakończono",
  "session.agents.status.error": "Niepowodzenie",
