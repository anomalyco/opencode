export const dict = {
  ...
  "prompt.action.startVoice": "Rozpocznij wprowadzanie głosowe",
  "prompt.action.stopVoice": "Zatrzymaj nagrywanie",
  "prompt.action.voiceNotSupported": "Rozpoznawanie mowy nie jest obsługiwane",
