export const dict = {
  ...
  "toast.file.uploadFailed.title": "Nie udało się przesłać pliku",
  "toast.file.downloadFailed.title": "Nie udało się pobrać pliku",
  "toast.file.deleteFailed.title": "Nie udało się usunąć pliku",
  ...
  "session.files.uploadFile": "Prześlij plik",
  "session.files.uploading": "Przesyłanie…",
  "session.files.downloadFile": "Pobierz",
  "session.files.refresh": "Odśwież",
  "session.files.dropFiles": "Upuść pliki tutaj lub kliknij +, aby przesłać",
  "session.files.deleteConfirm": "Usuń \"{{path}}\"?",
  "session.files.uploadTooLarge": "Plik jest za duży (maks. {{size}})",
