export const dict = {
  ...
  "command.session.handoff": "Przekaż sesję",
  "command.session.handoff.description": "Skompaktuj sesję i kontynuuj pracę w nowej sesji",
  ...
  "toast.session.handoff.failed.title": "Nie udało się przekazać sesji",
  "toast.session.handoff.failed.description": "Nie można podsumować tej sesji do przekazania",
