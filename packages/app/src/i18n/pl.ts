export const dict = {
  ...
  "session.review.context.openDefault": "Domyślna aplikacja",
  "session.review.context.copyRelative": "Kopiuj ścieżkę względną",
  "session.review.context.copyAbsolute": "Kopiuj ścieżkę bezwzględną",
