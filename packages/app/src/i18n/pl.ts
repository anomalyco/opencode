export const dict = {
  ...
  "provider.custom.models.context.label": "Rozmiar kontekstu",
  "provider.custom.models.context.placeholder": "Rozmiar kontekstu",
  "provider.custom.models.output.label": "Maksymalna długość odpowiedzi",
  "provider.custom.models.output.placeholder": "Maksymalna długość odpowiedzi",
  "provider.custom.models.reasoning.label": "Obsługuje rozumowanie",
  ...
  "provider.custom.error.positiveInteger": "Wprowadź dodatnią liczbę całkowitą",
