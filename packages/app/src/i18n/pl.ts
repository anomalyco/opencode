export const dict = {
  ...
  "provider.connect.xcshZen.line1":
    "xcsh Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.xcshZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.xcshZen.visit.prefix": "Odwiedź ",
  "provider.connect.xcshZen.visit.link": "f5xc-salesdemos.github.io/xcsh/zen",
  "provider.connect.xcshZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w xcsh.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (xcsh.json) nazwy dostawców/modeli",
