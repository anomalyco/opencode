export const dict = {
  ...
  "command.context.addToChat": "Dodaj zaznaczenie do czatu",
  "command.context.addToChat.description": "Wstaw zaznaczone linie w miejscu kursora",
  "command.context.quickEdit": "Szybka edycja zaznaczenia",
  "command.context.quickEdit.description": "Edytuj zaznaczony kod w nowej sesji",
  "selection.action.addToChat": "Dodaj do czatu",
  "selection.action.quickEdit": "Szybka edycja",
  "selection.quickEdit.placeholder": "Edytuj zaznaczony kod",
