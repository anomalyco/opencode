export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Argus",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Argus",
  "desktop.recovery.terminated": "Okno Argus zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Argus nie odpowiada",
  ...
  "desktop.wsl.error.installArgus": "Nie udało się zainstalować Argus",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.argusMissing": "Program argus nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.argusCannotRun": "Program argus jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.argusNotInstalled": "Argus nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Argus została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.argus.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.argus.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.argusGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Argus",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.argusZen.visit.prefix": "Odwiedź ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Argus.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku argus.json",
  ...
  "dialog.server.description": "Przełącz serwer Argus, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingArgus": "Sprawdzanie Argus...",
  "wsl.onboarding.checkingArgusIn": "Sprawdzanie Argus w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingArgus": "Aktualizowanie Argus...",
  "wsl.onboarding.updatingArgusIn": "Aktualizowanie Argus w dystrybucji {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Zaktualizuj Argus w dystrybucji {{distro}}.",
  "wsl.onboarding.updateArgus": "Zaktualizuj Argus",
  "wsl.onboarding.argusReadyIn": "Argus jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.argusReady": "Argus jest gotowy.",
  "wsl.onboarding.installArgusIn": "Zainstaluj Argus w dystrybucji {{distro}}.",
  "wsl.onboarding.installArgus": "Zainstaluj Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Argus będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Argus nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Argus ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Argus",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (argus.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Argus nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Argus zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Argus wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Argus",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Argus na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Argus ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Argus.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Argus",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Argus.",
