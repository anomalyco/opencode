export const dict = {
  ...
  "desktop.appMenu.file": "Plik",
  "desktop.appMenu.edit": "Edycja",
  "desktop.appMenu.view": "Widok",
  "desktop.appMenu.go": "Przejdź",
  "desktop.appMenu.window": "Okno",
  "desktop.appMenu.help": "Pomoc",
  "desktop.appMenu.about": "O OpenCode",
  "desktop.appMenu.checkForUpdates": "Sprawdź aktualizacje...",
  "desktop.appMenu.settings": "Ustawienia",
  "desktop.appMenu.reloadWebview": "Odśwież widok internetowy",
  "desktop.appMenu.restart": "Uruchom ponownie",
  "desktop.appMenu.exportLogs": "Eksportuj dzienniki...",
  "desktop.appMenu.hide": "Ukryj OpenCode",
  "desktop.appMenu.hideOthers": "Ukryj pozostałe",
  "desktop.appMenu.showAll": "Pokaż wszystkie",
  "desktop.appMenu.quit": "Zakończ OpenCode",
  "desktop.appMenu.newSession": "Nowa sesja",
  "desktop.appMenu.openProject": "Otwórz projekt...",
  "desktop.appMenu.newWindow": "Nowe okno",
  "desktop.appMenu.closeWindow": "Zamknij okno",
  "desktop.appMenu.undo": "Cofnij",
  "desktop.appMenu.redo": "Ponów",
  "desktop.appMenu.cut": "Wytnij",
  "desktop.appMenu.copy": "Kopiuj",
  "desktop.appMenu.paste": "Wklej",
  "desktop.appMenu.delete": "Usuń",
  "desktop.appMenu.selectAll": "Zaznacz wszystko",
  "desktop.appMenu.toggleSidebar": "Przełącz pasek boczny",
  "desktop.appMenu.toggleTerminal": "Przełącz terminal",
  "desktop.appMenu.toggleFileTree": "Przełącz drzewo plików",
  "desktop.appMenu.reload": "Odśwież",
  "desktop.appMenu.toggleDeveloperTools": "Przełącz narzędzia deweloperskie",
  "desktop.appMenu.actualSize": "Rozmiar rzeczywisty",
  "desktop.appMenu.zoomIn": "Powiększ",
  "desktop.appMenu.zoomOut": "Pomniejsz",
  "desktop.appMenu.toggleFullScreen": "Przełącz tryb pełnoekranowy",
  "desktop.appMenu.back": "Wstecz",
  "desktop.appMenu.forward": "Dalej",
  "desktop.appMenu.previousSession": "Poprzednia sesja",
  "desktop.appMenu.nextSession": "Następna sesja",
  "desktop.appMenu.previousProject": "Poprzedni projekt",
  "desktop.appMenu.nextProject": "Następny projekt",
  "desktop.appMenu.minimize": "Minimalizuj",
  "desktop.appMenu.zoomWindow": "Powiększ",
  "desktop.appMenu.maximize": "Maksymalizuj",
  "desktop.appMenu.bringAllToFront": "Przenieś wszystko na wierzch",
  "desktop.appMenu.documentation": "Dokumentacja OpenCode",
  "desktop.appMenu.supportForum": "Forum pomocy",
  "desktop.appMenu.shareFeedback": "Prześlij opinię",
  "desktop.appMenu.reportBug": "Zgłoś błąd",
