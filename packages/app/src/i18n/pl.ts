export const dict = {
  ...
  "dialog.newProject.title": "Nowy projekt",
  "dialog.newProject.tab.github": "Importuj z GitHub",
  "dialog.newProject.tab.folder": "Importuj z folderu",
  "dialog.newProject.url.label": "URL repozytorium",
  "dialog.newProject.destination.label": "Miejsce klonowania",
  "dialog.newProject.destination.placeholder": "Wybierz folder docelowy",
  "dialog.newProject.destination.browse": "Przeglądaj",
  "dialog.newProject.destination.pick": "Wybierz miejsce klonowania",
  "dialog.newProject.clone": "Klonuj repozytorium",
  "dialog.newProject.cloning": "Klonowanie...",
  "dialog.newProject.error.cloneFailed": "Nie udało się sklonować repozytorium",
  "dialog.newProject.folder.title": "Otwórz istniejący projekt",
  "dialog.newProject.folder.description": "Wybierz folder lokalny, aby dodać go jako projekt w OpenCode.",
  "dialog.newProject.folder.action": "Wybierz folder",
