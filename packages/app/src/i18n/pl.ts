export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Nieprawidłowy host SSH: {{host}}",
  "desktop.ssh.error.alreadyAdded": "Host {{host}} został już dodany",
  "desktop.ssh.error.opencodeNotInstalled": "Program opencode nie jest zainstalowany na hoście {{host}}",
  "desktop.ssh.error.installOpencode": "Nie udało się zainstalować opencode",
  "desktop.ssh.error.connectFailed": "Nie można połączyć się z {{host}}",
  "desktop.ssh.error.serverExited": "Serwer SSH zakończył działanie po uruchomieniu (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Serwer SSH dla {{host}} zakończył działanie przed osiągnięciem gotowości (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Przekroczono limit czasu {{timeout}}ms podczas sprawdzania kondycji serwera na {{host}}",
  "desktop.ssh.error.commandTimeout": "Polecenie ssh do {{host}} przekroczyło limit czasu {{timeout}}ms",
  "desktop.ssh.error.failedPort": "Nie udało się uzyskać portu",
  "desktop.ssh.error.terminalFailed": "Nie udało się otworzyć terminala",
  ...
  "ssh.server.add": "Dodaj serwer SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "Serwer SSH",
  "ssh.server.retryStart": "Połącz ponownie",
  "ssh.server.disconnect": "Rozłącz",
  "ssh.server.openTerminal": "Otwórz terminal",
  "ssh.server.updating": "Aktualizowanie...",
  "ssh.server.status.connecting": "Łączenie...",
  "ssh.server.status.disconnected": "Rozłączono",
  "ssh.add.hostLabel": "Host SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Łączy się przez systemowego klienta ssh, więc hosty, klucze i agenty z konfiguracji SSH działają jak zwykle.",
  "ssh.add.configHosts": "Z konfiguracji SSH",
  "ssh.add.connect": "Połącz",
  "ssh.add.checking": "Łączenie...",
  "ssh.add.addServer": "Dodaj serwer",
  "ssh.add.adding": "Dodawanie...",
  "ssh.add.installOpencode": "Zainstaluj opencode",
  "ssh.add.updateOpencode": "Zaktualizuj opencode",
  "ssh.add.installing": "Instalowanie...",
  "ssh.add.status.unreachable": "Nie można połączyć się",
  "ssh.add.status.opencodeMissing": "Program opencode nie jest zainstalowany na tym hoście",
  "ssh.add.status.opencodeMismatch":
    "Zainstalowano opencode v{{version}}, aplikacja komputerowa oczekuje v{{expected}}",
  "ssh.add.status.opencodeFound": "Znaleziono opencode v{{version}}",
  "ssh.add.authHint":
    "Upewnij się, że uwierzytelnianie SSH za pomocą klucza działa dla tego hosta — uruchom `ssh {{host}}` w terminalu, aby to sprawdzić.",
