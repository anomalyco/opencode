export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Jarvis",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Jarvis",
  "desktop.recovery.terminated": "Okno Jarvis zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Jarvis nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Jarvis",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Jarvis została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Jarvis.",
  ...
  "dialog.server.description": "Przełącz serwer Jarvis, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Jarvis w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Jarvis w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Jarvis w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Jarvis w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Jarvis będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Jarvis nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Jarvis ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Jarvis",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Jarvis nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Jarvis zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.tab.connectors": "Łączniki",
  "settings.integrations.placeholder": "Integracje rozszerzają środowisko Jarvis. Wkrótce będziesz mógł instalować wtyczki, motywy i rozszerzenia systemowe.",
  "settings.connectors.placeholder": "Łączniki łączą Jarvis z usługami zewnętrznymi. Wkrótce: Gmail, WhatsApp, Slack, Notion, Telegram i inne.",
  "settings.connectors.unavailable": "Łączniki są dostępne tylko w aplikacji desktopowej.",
  "settings.connectors.badge.connected": "Połączono",
  "settings.connectors.badge.notConnected": "Nie połączono",
  "settings.connectors.badge.disabled": "Wyłączony",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "Połącz swoje konto GitHub, aby Jarvis mógł czytać i zarządzać Twoimi repozytoriami.",
  "settings.connectors.github.detail": "Połącz swoje konto GitHub, aby Jarvis mógł pracować z Twoimi repozytoriami, issues i pull requestami bezpośrednio z czatu. Udzielasz dostępu własnym kontem GitHub przez OAuth — Jarvis nigdy nie widzi Twojego hasła.",
  "settings.connectors.github.permission.repos": "Czytanie i zarządzanie Twoimi repozytoriami, issues i pull requestami",
  "settings.connectors.github.permission.profile": "Czytanie Twojego publicznego profilu (nazwa użytkownika i awatar)",
  "settings.connectors.github.connect": "Połącz GitHub",
  "settings.connectors.github.disconnect": "Rozłącz",
  "settings.connectors.github.cancel": "Anuluj",
  "settings.connectors.github.openBrowser": "Otwórz przeglądarkę",
  "settings.connectors.github.waiting": "Oczekiwanie na autoryzację…",
  "settings.connectors.github.code.instructions": "Wprowadź ten kod na",
  "settings.connectors.github.connected.text": "Połączono przez OAuth. Jarvis może uzyskać dostęp do Twojego konta GitHub.",
  "settings.connectors.github.error.expired": "Kod autoryzacji wygasł. Spróbuj ponownie.",
  "settings.connectors.github.error.generic": "Nie udało się połączyć z GitHub. Sprawdź połączenie i spróbuj ponownie.",
  "settings.connectors.github.error.denied": "Autoryzacja odrzucona. Możesz spróbować ponownie w dowolnym momencie.",
  ...
  "toast.session.export.success.description": "Zapisano sesję do {{filename}}",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Jarvis wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Jarvis",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Jarvis na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Jarvis ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Jarvis.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Jarvis",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Jarvis.",
