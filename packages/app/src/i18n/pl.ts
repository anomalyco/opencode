export const dict = {
  ...
  "dialog.model.group.favorites": "Ulubione",
  "dialog.model.group.recent": "Ostatnie",
  "dialog.model.favorite.add": "Dodaj model do ulubionych",
  "dialog.model.favorite.remove": "Usuń model z ulubionych",
