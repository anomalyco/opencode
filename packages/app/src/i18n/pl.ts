export const dict = {
  ...
  "command.todo.toggle": "Przełącz panel todo",
  ...
  "sidebar.issue.title": "Zadania",
  "sidebar.issue.add": "Dodaj zadanie",
  "sidebar.issue.addSubtodo": "Dodaj podzadanie",
  "sidebar.issue.empty": "Brak zadań",
  "sidebar.issue.collapse": "Zwiń podzadania",
  "sidebar.issue.expand": "Rozwiń podzadania",
  "sidebar.issue.confirmDeleteWithChildren": "Usunąć to zadanie i jego {{count}} podzadań?",
  "sidebar.issue.toast.deleteFailed": "Nie udało się usunąć zadania",
  "sidebar.issue.tooltip.cycleStatus": "Zmień status",
  "sidebar.issue.tooltip.cyclePriority": "Zmień priorytet",
  "sidebar.issue.tooltip.linkedLinear": "Połączono z Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Połączono",
  "sidebar.linear.management": "Zarządzaj powiązaniem Linear",
  "sidebar.linear.management.teamRequired": "Wybierz zespół",
  "sidebar.linear.management.projectRequired": "Wybierz projekt",
  "sidebar.linear.management.saveFailed": "Nie udało się zapisać powiązania Linear",
  "sidebar.linear.management.saved": "Powiązanie Linear zapisane",
  "sidebar.linear.management.save": "Zapisz",
  "sidebar.linear.toggleHistory": "Przełącz historię synchronizacji",
  "sidebar.linear.field.team": "Zespół",
  "sidebar.linear.field.team.loading": "Ładowanie zespołów...",
  "sidebar.linear.field.team.placeholder": "Wybierz zespół",
  "sidebar.linear.field.project": "Projekt",
  "sidebar.linear.field.project.selectTeamFirst": "Najpierw wybierz zespół",
  "sidebar.linear.field.project.loading": "Ładowanie projektów...",
  "sidebar.linear.field.project.placeholder": "Wybierz projekt",
  "sidebar.linear.notConfigured": "Linear nie skonfigurowany",
  "sidebar.linear.notConfiguredHint": "Otwórz zarządzanie, aby wybrać zespół i projekt",
  ...
  "sidebar.linear.pullSuccess":
    "Pobrano {{pulled}}, zaktualizowano {{updated}}, pominięto {{skipped}}, usunięto {{deleted}}",
  "sidebar.linear.pushFailed": "Nie udało się wysłać do Linear",
  "sidebar.linear.pushPartialFailed": "Wysyłanie częściowo nieudane: {{count}} błąd/błędy",
  "sidebar.linear.pushSuccess": "Wysłano {{count}} zadań do Linear",
  "sidebar.linear.pushNothing": "Nic do wysłania",
  "sidebar.linear.syncHistory.syncing": "Synchronizowanie...",
  "sidebar.linear.syncHistory.error": "Błąd",
  "sidebar.linear.syncHistory.empty": "Brak historii synchronizacji",
  "dialog.todo.title.create": "Nowe zadanie",
  "dialog.todo.title.edit": "Edytuj zadanie",
  "dialog.todo.field.title": "Tytuł",
  "dialog.todo.field.title.placeholder": "Tytuł zadania",
  "dialog.todo.field.description": "Opis",
  "dialog.todo.field.description.placeholder": "Dodaj szczegóły, linki lub kontekst...",
  "dialog.todo.field.description.hint": "Obsługuje odwołania do plików i umiejętności",
  "dialog.todo.field.status": "Status",
  "dialog.todo.field.priority": "Priorytet",
  "dialog.todo.field.dueDate": "Termin",
  "dialog.todo.field.dueDate.placeholder": "Ustaw termin",
  "dialog.todo.field.dueDate.clear": "Wyczyść",
  "dialog.todo.field.dueDate.prevMonth": "Poprzedni miesiąc",
  "dialog.todo.field.dueDate.nextMonth": "Następny miesiąc",
  "dialog.todo.field.dueDate.shortcut.today": "Dziś",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Jutro",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Za tydzień",
  ...
  "dialog.todo.field.labels": "Etykiety",
  "dialog.todo.field.assignee": "Przypisany",
  "dialog.todo.field.assignee.unassigned": "Nieprzypisany",
  "dialog.todo.field.assignee.loadFailed": "Nie udało się załadować przypisanych",
  "dialog.todo.field.assignee.loading": "Ładowanie przypisanych...",
  "dialog.todo.field.assignee.placeholder": "Wybierz przypisanego",
  "dialog.todo.field.assignee.hint": "Z członków zespołu Linear",
  "dialog.todo.linkedLinear": "Połączono z Linear",
  "dialog.todo.created": "Zadanie utworzone",
  "dialog.todo.updated": "Zadanie zaktualizowane",
  "dialog.todo.error.titleRequired": "Tytuł jest wymagany",
  "dialog.todo.error.saveFailed": "Nie udało się zapisać zadania",
  "dialog.todo.action.create": "Utwórz",
  ...
  "sidebar.issue.priority.none": "Żaden",
  "sidebar.issue.priority.urgent": "Pilne",
  "sidebar.issue.priority.high": "Wysoki",
  "sidebar.issue.priority.medium": "Średni",
  ...
  "sidebar.issue.archivedBadge": "Zarchiwizowane",
  "sidebar.issue.archiveArea.title": "Zarchiwizowane",
  "sidebar.issue.archiveArea.expand": "Pokaż zarchiwizowane",
  "sidebar.issue.archiveArea.collapse": "Ukryj zarchiwizowane",
  "sidebar.issue.archiveArea.empty": "Brak zarchiwizowanych zadań",
}
