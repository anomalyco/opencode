export const dict = {
  ...
  "settings.plugins.section.browse": "Przeglądaj",
  ...
  "settings.mcp.add": "Dodaj serwer",
  "settings.mcp.empty": "Brak skonfigurowanych serwerów MCP.",
  "settings.mcp.deleted": "Usunięto {{name}}.",
  "settings.mcp.errors.refresh": "Nie można wczytać serwerów MCP.",
  "settings.mcp.status.pending": "łączenie…",
  "settings.mcp.action.connect": "Połącz",
  "settings.mcp.action.disconnect": "Rozłącz",
  "settings.mcp.action.authenticate": "Uwierzytelnij",
  "settings.mcp.action.edit": "Edytuj",
  "settings.mcp.action.delete": "Usuń",
  "settings.mcp.delete.title": "Usuń serwer MCP",
  "settings.mcp.delete.body": "Usunąć {{name}}? Tej operacji nie można cofnąć.",
  "settings.mcp.form.title.add": "Dodaj serwer MCP",
  "settings.mcp.form.title.edit": "Edytuj serwer MCP",
  "settings.mcp.form.subtitle": "Skonfiguruj ustawienia połączenia.",
  "settings.mcp.form.name": "Nazwa",
  "settings.mcp.form.command": "Polecenie",
  "settings.mcp.form.command.hint": "np. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Katalog roboczy",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Zmienne środowiskowe",
  "settings.mcp.form.headers": "Nagłówki",
  "settings.mcp.form.addRow": "Dodaj wiersz",
  "settings.mcp.form.removeRow": "Usuń",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID klienta",
  "settings.mcp.form.oauth.clientSecret": "Sekret klienta",
  "settings.mcp.form.oauth.clientSecret.keep": "Skonfigurowano — zostaw puste, aby zachować",
  "settings.mcp.form.oauth.scope": "Zakres",
  "settings.mcp.form.oauth.callbackPort": "Port wywołania zwrotnego",
  "settings.mcp.form.oauth.disableAutodetect": "Wyłącz automatyczne wykrywanie OAuth",
  "settings.mcp.form.enabled": "Włączone",
  "settings.mcp.form.timeout": "Limit czasu (ms)",
  "settings.mcp.form.save": "Zapisz",
  "settings.mcp.form.cancel": "Anuluj",
  "settings.mcp.form.error.name": "Podaj nazwę.",
  "settings.mcp.form.error.command": "Podaj polecenie.",
  "settings.mcp.form.error.url": "Podaj URL.",
  "settings.mcp.form.error.callbackPort": "Port wywołania zwrotnego musi być od 1 do 65535.",
  "settings.mcp.form.error.timeout": "Limit czasu musi być dodatnią liczbą całkowitą.",
  "settings.mcp.errors.invalid": "Popraw zaznaczone pola.",
  "settings.mcp.errors.duplicate": "Serwer o tej nazwie już istnieje.",
  "settings.mcp.errors.noConfig": "Nie można odczytać konfiguracji {{name}} — może być zdefiniowana poza projektem.",
  "settings.mcp.edit.warn": "Zapisanie ponownie łączy serwer.",
  ...
  "settings.plugins.detail.copied": "Skopiowano",
  "settings.plugins.detail.notOnNpm": "Nie znaleziono na npm — dodaj ręcznie do opencode.json",
  "settings.plugins.install.title": "Zainstaluj wtyczkę",
  "settings.plugins.install.description": "Gdzie dodać {{name}}?",
  "settings.plugins.install.global": "Globalnie (~/.config/opencode)",
  "settings.plugins.install.project": "Ten projekt",
  "settings.plugins.install.cancel": "Anuluj",
  "settings.plugins.install.success": "Zainstalowano {{name}}. Uruchom ponownie OpenCode, aby go wczytać.",
  "settings.plugins.installed.empty": "Brak zainstalowanych wtyczek.",
  "settings.plugins.installed.provenance.global": "Globalnie",
  "settings.plugins.installed.provenance.project": "Projekt",
  "settings.plugins.installed.disable": "Wyłącz",
  "settings.plugins.installed.enable": "Włącz",
  "settings.plugins.installed.uninstall": "Odinstaluj",
  "settings.plugins.installed.uninstallBody": "Odinstalować {{name}} z {{scope}}? Wpis zostanie usunięty z pliku konfiguracji.",
  "settings.plugins.installed.recentlyRemoved": "Ostatnio usunięte",
  "settings.plugins.installed.openConfig": "Otwórz konfigurację",
  "settings.plugins.errors.parseFailed": "Nie można odczytać {{path}} — popraw lub usuń plik, aby zarządzać wtyczkami.",
  "settings.plugins.errors.catalog": "Nie można odświeżyć katalogu wtyczek.",
  "settings.plugins.stale": "Wyświetlono katalog z pamięci podręcznej ({{age}}).",
