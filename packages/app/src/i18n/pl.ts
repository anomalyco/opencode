export const dict = {
  ...
  "presets.title": "Ustawienia wstępne",
  "presets.manage": "Zarządzaj ustawieniami wstępnymi",
  "presets.count": "{{count}} ustawień wstępnych",
  "presets.empty": "Brak ustawień wstępnych",
  "presets.empty.hint": "Kliknij \"Dodaj\", aby utworzyć pierwsze ustawienie wstępne",
  "presets.add": "Dodaj",
  "presets.name": "Nazwa",
  "presets.content": "Treść",
  "presets.content.placeholder": "Treść (obsługuje zmienne {date} {time} {file} {code} {text})",
  "presets.moveUp": "Przesuń w górę",
  "presets.moveDown": "Przesuń w dół",
  "presets.edit": "Edytuj",
  "presets.delete": "Usuń",
  "presets.variables.title": "Wprowadź zmienne dla \"{{name}}\"",
  "presets.variables.next": "Dalej",
  "presets.variables.insert": "Wstaw",
}
