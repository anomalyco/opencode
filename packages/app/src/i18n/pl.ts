export const dict = {
  ...
  "dialog.provider.athena.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.athena.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.athenaGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Athena",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Athena.",
  ...
  "provider.connect.athenaZen.line1":
    "Athena Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.athenaZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.athenaZen.visit.prefix": "Odwiedź ",
  "provider.connect.athenaZen.visit.link": "athena.ai/zen",
  "provider.connect.athenaZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Athena.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Athena.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w athena.json",
  ...
  "dialog.server.description": "Przełącz serwer Athena, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Athena ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Athena",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (athena.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Athena zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Athena",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Athena na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Athena ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Athena.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Athena",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Athena.",
