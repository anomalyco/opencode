export const dict = {
  ...
  "palette.group.files": "Dopasowania nazw plików",
  "palette.group.content": "Dopasowania zawartości lokalnych plików",
  "palette.group.chat": "Dopasowania zawartości czatu",
  "palette.group.sessions": "Dopasowania nazw sesji",
  "palette.group.files.count": "{{count}} wyników.",
  "palette.group.content.count": "{{count}} wyników w {{files}} plikach.",
  "palette.group.chat.count": "{{count}} wyników w {{sessions}} sesjach.",
  "palette.group.sessions.count": "{{count}} wyników.",
