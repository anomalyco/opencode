export const dict = {
  ...
  "provider.custom.models.load": "Wczytaj dynamicznie",
  "provider.custom.models.loading": "Wczytywanie...",
  "provider.custom.models.load.invalidUrl": "Wprowadź prawidłowy bazowy adres URL",
  "provider.custom.models.load.unauthorized": "Brak autoryzacji. Sprawdź klucz API",
  "provider.custom.models.load.invalidFormat": "Odpowiedź serwera nie zawierała prawidłowej listy modeli",
  "provider.custom.models.load.timeout": "Przekroczono czas podczas wczytywania modeli",
  "provider.custom.models.load.failed": "Wczytywanie modeli nie powiodło się",
  "provider.custom.models.load.empty": "Nie znaleziono modeli",
