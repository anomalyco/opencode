export const dict = {
  ...
  "command.workspace.switch": "Przełącz przestrzeń roboczą",
  "command.workspace.previous": "Poprzednia przestrzeń robocza",
  "command.workspace.next": "Następna przestrzeń robocza",
