export const dict = {
  ...
  "settings.general.row.sendKey.title": "Klawisz wysyłania",
  "settings.general.row.sendKey.description": "Wybierz, który klawisz wysyła wiadomości. Drugi klawisz Enter wstawia nową linię.",
