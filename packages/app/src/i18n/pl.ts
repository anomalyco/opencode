export const dict = {
  ...
  "home.activity.title": "Aktywność tokenów",
  "home.activity.daily": "Dziennie",
  "home.activity.weekly": "Tygodniowo",
  "home.activity.cumulative": "Łącznie",
  "home.activity.loading": "Ładowanie aktywności",
  "home.activity.empty": "Brak aktywności tokenów",
  "home.activity.lifetimeTokens": "Łącznie tokenów",
  "home.activity.peakTokens": "Szczyt tokenów",
  "home.activity.longestTask": "Najdłuższe zadanie",
  "home.activity.currentStreak": "Bieżąca seria",
  "home.activity.longestStreak": "Najdłuższa seria",
  "home.activity.days.one": "{{count}} dzień",
  "home.activity.days.other": "{{count}} dni",
  "home.activity.summary":
    "{{tokens}} łącznie tokenów, {{peak}} szczyt tokenów, {{current}} bieżąca seria, {{longest}} najdłuższa seria.",
