export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Pencode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Pencode",
  "desktop.recovery.terminated": "Okno Pencode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Pencode nie odpowiada",
  ...
  "desktop.wsl.error.installPencode": "Nie udało się zainstalować Pencode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.pencodeMissing": "Program pencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.pencodeCannotRun": "Program pencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Pencode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.pencode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.pencode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.pencodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Pencode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Pencode.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku pencode.json",
  ...
  "dialog.server.description": "Przełącz serwer Pencode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingPencode": "Sprawdzanie Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Sprawdzanie Pencode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingPencode": "Aktualizowanie Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Aktualizowanie Pencode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Zaktualizuj Pencode w dystrybucji {{distro}}.",
  "wsl.onboarding.updatePencode": "Zaktualizuj Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode jest gotowy.",
  "wsl.onboarding.installPencodeIn": "Zainstaluj Pencode w dystrybucji {{distro}}.",
  "wsl.onboarding.installPencode": "Zainstaluj Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Pencode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Pencode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Pencode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Pencode",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (pencode.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Pencode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Pencode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Pencode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Pencode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Pencode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Pencode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Pencode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Pencode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Pencode.",
