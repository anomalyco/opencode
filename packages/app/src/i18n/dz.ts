export const dict: Record<string, string> = {
  ...
  "provider.custom.models.load": "རང་བཞིན་གྱིས་མངོན་གསལ་འབད",
  "provider.custom.models.loading": "མངོན་གསལ་འབད་དོ...",
  "provider.custom.models.load.invalidUrl": "ནུས་ཅན་གཞི་རྟེན་ URL་ཅིག་བཙུགས",
  "provider.custom.models.load.unauthorized": "གནང་བ་མེད། API ལྡེ་མིག་ཞིབ་དཔྱད་འབད",
  "provider.custom.models.load.invalidFormat": "སར་བར་གྱི་ལན་དེ་ནུས་ཅན་དཔེ་ཚད་ཐོ་ཡིག་མེན་པས",
  "provider.custom.models.load.timeout": "དཔེ་ཚད་མངོན་གསལ་འབད་བའི་སྐབས་དུས་ཚོད་ལས་བརྒལ་ཡོདཔ",
  "provider.custom.models.load.failed": "དཔེ་ཚད་མངོན་གསལ་འབད་མ་ཚུགས",
  "provider.custom.models.load.empty": "དཔེ་ཚད་མ་ཐོབ་ཡོདཔ",
