export const dict: Record<string, string> = {
  ...
  "command.tab.closeAll": "མཆོང་ལྡེ་ཆ་མཉམ་ཁ་བསྡམས།",
  "command.tab.closeRight": "གཡས་ཕྱོགས་ཀྱི་མཆོང་ལྡེ་ཆ་མཉམ་ཁ་བསྡམས།",
  "command.tab.closeOthers": "འདི་མ་གཏོགས་མཆོང་ལྡེ་ཆ་མཉམ་ཁ་བསྡམས།",
