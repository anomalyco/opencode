export const dict: Record<string, string> = {
  ...
  "command.session.background": "ལས་བྱེད་ཆུང་བ་ཚུ་རྒྱབ་ཁར་གཡོག་བཀོལ།",
  "command.session.background.description": "ལཱ་ཡུན་འདི་བཀག་མི་ལས་བྱེད་ཆུང་བ་ཚུ་ཁ་འཕྱལ་ཏེ་རྒྱབ་ཁར་འཕྲོ་མཐུད་འབད།",
  ...
  "toast.session.background.failed.title": "ལས་བྱེད་ཆུང་བ་ཚུ་རྒྱབ་ཁར་བཏང་མ་ཚུགས།",
