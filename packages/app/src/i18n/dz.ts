export const dict: Record<string, string> = {
  ...
  "settings.tab.plugins": "པལ་ག་ཨིན།",
  "settings.plugins.section.browse": "བརྟག་ཞིབ།",
  "settings.plugins.section.installed": "བཙུགས་ཟིན།",
  ...
  "settings.mcp.add": "སར་བར་ཁ་སྐོང་།",
  "settings.mcp.empty": "MCP སར་བར་ གནས་ཚུལ་བཀོད་མེད།",
  "settings.mcp.deleted": "{{name}} བསྡོམས་ཡོད།",
  "settings.mcp.errors.refresh": "MCP སར་བར་ ལོག་ནི་མ་འགྲུབ།",
  "settings.mcp.status.pending": "མཐུད་དོ།…",
  "settings.mcp.action.connect": "མཐུད།",
  "settings.mcp.action.disconnect": "མཐུད་མཚམས་བཞག",
  "settings.mcp.action.authenticate": "རྒྱུ་དཔང་བཟོ།",
  "settings.mcp.action.edit": "ཞུན་དག",
  "settings.mcp.action.delete": "བསྡོམས།",
  "settings.mcp.delete.title": "MCP སར་བར་བསྡོམས།",
  "settings.mcp.delete.body": "{{name}} རྩ་བ་ལས་བཏོན་ནི་ཨིན་ནམ? ཚུར་ལོག་མི་བ།",
  "settings.mcp.form.title.add": "MCP སར་བར་ཁ་སྐོང་།",
  "settings.mcp.form.title.edit": "MCP སར་བར་ཞུན་དག",
  "settings.mcp.form.subtitle": "མཐུད་ལམ་གཏན་འབེབས་ཚུ་གཞི་སྒྲིག་འབད།",
  "settings.mcp.form.name": "མིང་།",
  "settings.mcp.form.command": "བརྡ་བཀོད།",
  "settings.mcp.form.command.hint": "དཔེར་ན་ npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "ལཱ་གི་སྣོད་ཐོ།",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "མཐུད་ཆ་ཚུ་གཞི་སྒྲིག་འབད།",
  "settings.mcp.form.headers": "མགོ་མིང་ཚུ།",
  "settings.mcp.form.addRow": "གྲལ་ཐོག་ཁ་སྐོང་།",
  "settings.mcp.form.removeRow": "རྩ་བསྐྲད་གཏང་།",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ཨིན་ཊོ་ནི་ཊ་འབྲེལ་མི་དང་།",
  "settings.mcp.form.oauth.clientSecret": "ཛ་གས་ཀྱི་མི་འབྲེལ།",
  "settings.mcp.form.oauth.clientSecret.keep": "གཞི་སྒྲིག་འབད་ཡོདཔ་— ཉེན་སྲུང་གི་དོན་ལུ་སྟོངམ་བཞག",
  "settings.mcp.form.oauth.scope": "ཁྱབ་ཚད།",
  "settings.mcp.form.oauth.callbackPort": "ལོག་འབྲེལ་གྱི་འདོན་ལམ།",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth རང་བཞིན་ཤེས་རྟོག་བཀག་ཆོགཔ།",
  "settings.mcp.form.enabled": "ལྕོགས་ཅན།",
  "settings.mcp.form.timeout": "དུས་ཚོད་ཚད་（ms）",
  "settings.mcp.form.save": "ཉེན་སྲུང།",
  "settings.mcp.form.cancel": "ཆ་མེད།",
  "settings.mcp.form.error.name": "མིང་བཙུགས།",
  "settings.mcp.form.error.command": "བརྡ་བཀོད་བཙུགས།",
  "settings.mcp.form.error.url": "URL བཙུགས།",
  "settings.mcp.form.error.callbackPort": "ལོག་འབྲེལ་འདོན་ལམ་ ༡-༦༥༥༣༥ བར་དགོཔ།",
  "settings.mcp.form.error.timeout": "དུས་ཚོད་ཚད་ཡོད་དགོ ང་བ་ཨིནམ་འདང་ཚད་དགོ།",
  "settings.mcp.errors.invalid": "དམར་པོ་བཏོན་ཡོད་མི་ས་ཁོངས་ཞུན་དག།མིང་འདི་དང་མཐུན་སར་བར་ཧེ་མ་ལས་ཡོད།",
  "settings.mcp.errors.duplicate": "མིང་འདི་དང་མཐུན་པའི་སར་བར་ཧེ་མ་ལས་གནས་ཏེ་ཡོདཔ།",
  "settings.mcp.errors.noConfig": "{{name}} གི་གཞི་སྒྲིག་ལྷག་མ་ཚུགས་— ལས་འགུལ་གྱི་ཕྱི་ཁར་གཞི་བཙུགས་ཡོད་འོང་།",
  "settings.mcp.edit.warn": "ཉེན་སྲུང་གི་སྐབས་སར་བར་འདི་ལོག་མཐུད་འབད།",
  ...
  "settings.plugins.detail.copied": "འདྲ་བཤུས་ཟིན།",
  "settings.plugins.detail.notOnNpm": "npm གུ་མ་རྙེད — opencode.json ནང་ལག་ཐོག་ལས་ཁ་སྐོང་རྡུང་།",
  "settings.plugins.install.title": "པལ་ག་ཨིན་བཙུགས།",
  "settings.plugins.install.description": "{{name}} ག་པ་བཀལ་ནི་ཨིན།",
  "settings.plugins.install.global": "ཡོངས་ཁྱབ། (~/.config/opencode)",
  "settings.plugins.install.project": "ལས་འགུལ་འདི།",
  "settings.plugins.install.cancel": "ཆ་མེད་བཏང་།",
  "settings.plugins.install.success": "{{name}} བཙུགས་ཡོད། ཡོངས་འབྲེལ་ལས་འཁོར་ནང་བཙུགས་ནི་ལས་ OpenCode ཡང་བསྐྱར་འགོ་བཙུགས།",
  "settings.plugins.installed.empty": "བཙུགས་ཡོད་པའི་པལ་ག་ཨིན་མེད།",
  "settings.plugins.installed.provenance.global": "ཡོངས་ཁྱབ།",
  "settings.plugins.installed.provenance.project": "ལས་འགུལ།",
  ...
  "settings.plugins.errors.catalog": "པལ་ག་ཨིན་དཀར་ཆིག་གསར་བསྒྱུར་འབད་མ་ཚུགས།",
  "settings.plugins.stale": "དཀར་ཆིག་གསོག་འཇོག་འབད་ཡོད་པའི་ ({{age}} སྔོན་མ།) སྟོན་དོ།",
