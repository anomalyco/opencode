export const dict: Record<string, string> = {
  ...
  "session.tab.agents": "སབ་ཨེ་ཇེནཊི།",
  "session.agents.empty": "སབ་ཨེ་ཇེནཊི་གང་ཡང་མི་རྒྱུགས།",
  "session.agents.costTotal": "བསྡོམས་གོང་ཚད།",
  "session.agents.costSubagents": "སབ་ཨེ་ཇེནཊི།",
  "session.agents.count": "ཨེ་ཇེནཊི།",
  "session.agents.tokens": "ཊོ་ཁེན།",
  "session.agents.showAll": "ཆ་མཇུག་གང་རུང་སྟོན། ({{count}})",
  "session.agents.status.idle": "ལས་མེད།",
  "session.agents.status.busy": "ལས་ཀ་བྱེད་བཞིན།",
  "session.agents.status.retry": "བསྐྱར་སྦྱོར།",
  "session.agents.status.cancelled": "རྒྱབ་འཐེན་འབད།",
  "session.agents.status.completed": "མཇུག་རྫོགས།",
  "session.agents.status.error": "ནོར་འཁྲུལ།",
