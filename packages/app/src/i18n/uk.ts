export const dict = {
  ...
  "desktop.menu.documentation": "Документація Argus",
  ...
  "desktop.menu.ariaLabel": "Меню Argus",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Argus",
  "desktop.recovery.terminated": "Роботу вікна Argus несподівано завершено",
  "desktop.recovery.unresponsive": "Argus не відповідає",
  ...
  "desktop.wsl.error.installArgus": "Не вдалося встановити Argus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.argusMissing": "argus не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.argusCannotRun": "argus встановлено, але його не вдалося запустити",
  "desktop.wsl.error.argusNotInstalled": "Argus не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Argus завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.argus.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.argus.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.argusGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Argus",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  "provider.connect.argusZen.line2":
    "З одним ключем API ви отримаєте доступ до таких моделей, як Claude, GPT, Gemini, GLM та інших.",
  "provider.connect.argusZen.visit.prefix": "Відвідайте ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Argus.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в argus.json",
  ...
  "dialog.server.description": "Перемкніть сервер Argus, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingArgus": "Перевірка Argus...",
  "wsl.onboarding.checkingArgusIn": "Перевірка Argus у {{distro}}...",
  "wsl.onboarding.updatingArgus": "Оновлення Argus...",
  "wsl.onboarding.updatingArgusIn": "Оновлення Argus у {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Оновіть Argus у {{distro}}.",
  "wsl.onboarding.updateArgus": "Оновити Argus",
  "wsl.onboarding.argusReadyIn": "Argus готовий до роботи у {{distro}}.",
  "wsl.onboarding.argusReady": "Argus готовий до роботи.",
  "wsl.onboarding.installArgusIn": "Встановіть Argus у {{distro}}.",
  "wsl.onboarding.installArgus": "Встановити Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Argus потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Argus не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Argus ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Argus",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (argus.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Argus ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Argus всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Argus",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Argus на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Argus використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Argus.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Argus",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Argus.",
