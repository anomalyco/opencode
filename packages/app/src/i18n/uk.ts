export const dict = {
  ...
  "provider.connect.apiKey.description": "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у OpenCode.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix": ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у OpenCode.",
  ...
  "prompt.placeholder.newLayout": "Запитайте що завгодно, / для команд, @ для контексту...",
  ...
  "session.child.promptDisabled": "Сесіям підагентів не можна надсилати запити.",
  ...
  "wsl.onboarding.step.distro": "Виберіть дистрибутив",
  "wsl.onboarding.step.opencode": "OpenCode",
  "wsl.onboarding.checkingRuntime": "Перевірка WSL...",
  "wsl.onboarding.restartRequired": "Для завершення встановлення WSL необхідно перезавантажити Windows.",
  ...
  "wsl.onboarding.listingDistros": "Складання списку дистрибутивів...",
  ...
  "wsl.onboarding.finishingDistro": "Завершення налаштування для {{distro}}.",
  ...
  "wsl.onboarding.windowsRestartRequired": "Перезавантажте Windows, щоб завершити встановлення WSL, а потім знову відкрийте OpenCode.",
  ...
  "wsl.onboarding.noDistros": "Дистрибутивів ще не виявлено.",
  ...
  "wsl.onboarding.wsl2Required": "Потрібна версія WSL 2.",
  "wsl.onboarding.toolsRequired": "Цьому дистрибутиву потрібні bash та curl.",
  ...
  "wsl.onboarding.desktopVersion": "версія для комп'ютера {{version}}",
  "wsl.onboarding.versionMismatch": "Встановлена версія не збігається з версією програми для комп'ютера.",
  ...
  "error.page.description.localServerStartup": "Під час запуску локального сервера виникла помилка.",
  ...
  "home.sessions.search.noResults": "Не знайдено сесій для {{query}}",
  ...
  "home.sessions.group.yesterday": "Вчора",
  ...
  "common.dontShowAgain": "Більше не показувати",
  ...
  "settings.general.row.showCustomAgents.description": "Показувати вибір агента в полі введення",
  ...
  "settings.general.row.newLayoutDesigns.description": "Увімкнути оновлений дизайн макета, головного екрана, поля введення та сесії",
  "settings.general.row.pinchZoom.title": "Pinch to zoom",
  "settings.general.row.pinchZoom.description": "Дозволити масштабування жестами трекпада (pinch) або Ctrl+прокручування",
