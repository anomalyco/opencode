export const dict = {
  ...
  "settings.general.section.input": "Введення",
  ...
  "settings.general.row.sendKey.title": "Клавіша надсилання",
  "settings.general.row.sendKey.description": "Виберіть, яка клавіша надсилає повідомлення. Інша клавіша Enter вставляє новий рядок.",
