export const dict = {
  ...
  "presets.title": "Пресети",
  "presets.manage": "Керування пресетами",
  "presets.count": "Пресетів: {{count}}",
  "presets.empty": "Немає пресетів",
  "presets.empty.hint": "Натисніть \"Додати\", щоб створити перший пресет",
  "presets.add": "Додати",
  "presets.name": "Назва",
  "presets.content": "Вміст",
  "presets.content.placeholder": "Вміст (підтримує змінні {date} {time} {file} {code} {text})",
  "presets.moveUp": "Перемістити вгору",
  "presets.moveDown": "Перемістити вниз",
  "presets.edit": "Редагувати",
  "presets.delete": "Видалити",
  "presets.variables.title": "Введіть змінні для \"{{name}}\"",
  "presets.variables.next": "Далі",
  "presets.variables.insert": "Вставити",
}
