export const dict = {
  ...
  "dialog.newProject.title": "Новий проєкт",
  "dialog.newProject.tab.github": "Імпортувати з GitHub",
  "dialog.newProject.tab.folder": "Імпортувати з папки",
  "dialog.newProject.url.label": "URL репозиторію",
  "dialog.newProject.destination.label": "Місце клонування",
  "dialog.newProject.destination.placeholder": "Оберіть цільову папку",
  "dialog.newProject.destination.browse": "Огляд",
  "dialog.newProject.destination.pick": "Оберіть місце клонування",
  "dialog.newProject.clone": "Клонувати репозиторій",
  "dialog.newProject.cloning": "Клонування...",
  "dialog.newProject.error.cloneFailed": "Не вдалося клонувати репозиторій",
  "dialog.newProject.folder.title": "Відкрити наявний проєкт",
  "dialog.newProject.folder.description": "Оберіть локальну папку, щоб додати її як проєкт у OpenCode.",
  "dialog.newProject.folder.action": "Обрати папку",
