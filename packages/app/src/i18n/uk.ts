export const dict = {
  ...
  "session.tab.agents": "Підагенти",
  "session.agents.empty": "Немає запущених підагентів",
  "session.agents.costTotal": "Загальна вартість",
  "session.agents.costSubagents": "Підагенти",
  "session.agents.count": "Агенти",
  "session.agents.tokens": "токенів",
  "session.agents.showAll": "Показати всі ({{count}})",
  "session.agents.status.idle": "Очікування",
  "session.agents.status.busy": "Виконується",
  "session.agents.status.retry": "Повторна спроба",
  "session.agents.status.cancelled": "Скасовано",
  "session.agents.status.completed": "Завершено",
  "session.agents.status.error": "Помилка",
