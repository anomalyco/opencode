export const dict = {
  ...
  "home.activity.title": "Активність токенів",
  "home.activity.daily": "Щоденно",
  "home.activity.weekly": "Щотижня",
  "home.activity.cumulative": "Накопичувально",
  "home.activity.loading": "Завантаження активності",
  "home.activity.empty": "Активності токенів ще немає",
  "home.activity.lifetimeTokens": "Всього токенів",
  "home.activity.peakTokens": "Пік токенів",
  "home.activity.longestTask": "Найдовше завдання",
  "home.activity.currentStreak": "Поточна серія",
  "home.activity.longestStreak": "Найдовша серія",
  "home.activity.days.one": "{{count}} день",
  "home.activity.days.other": "{{count}} днів",
  "home.activity.summary":
    "{{tokens}} всього токенів, {{peak}} пік токенів, {{current}} поточна серія, {{longest}} найдовша серія.",
