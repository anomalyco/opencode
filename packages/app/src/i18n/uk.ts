export const dict = {
  ...
  "desktop.ssh.error.invalidHost": "Недійсний хост SSH: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} уже додано",
  "desktop.ssh.error.opencodeNotInstalled": "opencode не встановлено на {{host}}",
  "desktop.ssh.error.installOpencode": "Не вдалося встановити opencode",
  "desktop.ssh.error.connectFailed": "Не вдалося підключитися до {{host}}",
  "desktop.ssh.error.serverExited": "Сервер SSH завершив роботу після запуску (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Сервер SSH для {{host}} завершив роботу, не досягнувши працездатного стану (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Час очікування перевірки працездатності сервера на {{host}} минув через {{timeout}}мс",
  "desktop.ssh.error.commandTimeout": "Час очікування команди ssh до {{host}} минув через {{timeout}}мс",
  "desktop.ssh.error.failedPort": "Не вдалося отримати порт",
  "desktop.ssh.error.terminalFailed": "Не вдалося відкрити термінал",
  ...
  "ssh.server.add": "Додати сервер SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "Сервер SSH",
  "ssh.server.retryStart": "Перепідключитися",
  "ssh.server.disconnect": "Відключити",
  "ssh.server.openTerminal": "Відкрити термінал",
  "ssh.server.updating": "Оновлення...",
  "ssh.server.status.connecting": "Підключення...",
  "ssh.server.status.disconnected": "Відключено",
  "ssh.add.hostLabel": "Хост SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Підключення виконується через системний клієнт ssh, тому хости, ключі та агенти з вашої конфігурації SSH працюють як зазвичай.",
  "ssh.add.configHosts": "З вашої конфігурації SSH",
  "ssh.add.connect": "Підключитися",
  "ssh.add.checking": "Підключення...",
  "ssh.add.addServer": "Додати сервер",
  "ssh.add.adding": "Додавання...",
  "ssh.add.installOpencode": "Встановити opencode",
  "ssh.add.updateOpencode": "Оновити opencode",
  "ssh.add.installing": "Встановлення...",
  "ssh.add.status.unreachable": "Не вдалося підключитися",
  "ssh.add.status.opencodeMissing": "opencode не встановлено на цьому хості",
  "ssh.add.status.opencodeMismatch": "Встановлено opencode v{{version}}, десктопний застосунок очікує v{{expected}}",
  "ssh.add.status.opencodeFound": "Знайдено opencode v{{version}}",
  "ssh.add.authHint":
    "Переконайтеся, що для цього хоста працює автентифікація SSH за ключем — виконайте `ssh {{host}}` у терміналі, щоб перевірити.",
