export const dict = {
  ...
  "provider.custom.models.context.label": "Розмір контексту",
  "provider.custom.models.context.placeholder": "Розмір контексту",
  "provider.custom.models.output.label": "Максимальний вивід",
  "provider.custom.models.output.placeholder": "Максимальний вивід",
  "provider.custom.models.reasoning.label": "Підтримує міркування",
  ...
  "provider.custom.error.positiveInteger": "Введіть додатне ціле число",
