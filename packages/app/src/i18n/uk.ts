export const dict = {
  ...
  "command.todo.toggle": "Перемкнути панель завдань",
  ...
  "sidebar.issue.title": "Завдання",
  "sidebar.issue.add": "Додати завдання",
  "sidebar.issue.addSubtodo": "Додати підзавдання",
  "sidebar.issue.empty": "Завдань поки немає",
  "sidebar.issue.collapse": "Згорнути підзадачі",
  "sidebar.issue.expand": "Розгорнути підзадачі",
  "sidebar.issue.confirmDeleteWithChildren": "Видалити це завдання та його {{count}} підзадач?",
  "sidebar.issue.toast.deleteFailed": "Не вдалося видалити завдання",
  "sidebar.issue.tooltip.cycleStatus": "Змінити статус",
  "sidebar.issue.tooltip.cyclePriority": "Змінити пріоритет",
  "sidebar.issue.tooltip.linkedLinear": "Пов'язано з Linear",
  "sidebar.linear.title": "Linear",
  "sidebar.linear.connected": "Підключено",
  "sidebar.linear.management": "Керування прив'язкою Linear",
  "sidebar.linear.management.teamRequired": "Будь ласка, оберіть команду",
  "sidebar.linear.management.projectRequired": "Будь ласка, оберіть проект",
  "sidebar.linear.management.saveFailed": "Не вдалося зберегти прив'язку Linear",
  "sidebar.linear.management.saved": "Прив'язку Linear збережено",
  "sidebar.linear.management.save": "Зберегти",
  "sidebar.linear.toggleHistory": "Показати історію синхронізації",
  "sidebar.linear.field.team": "Команда",
  "sidebar.linear.field.team.loading": "Завантаження команд...",
  "sidebar.linear.field.team.placeholder": "Оберіть команду",
  "sidebar.linear.field.project": "Проект",
  "sidebar.linear.field.project.selectTeamFirst": "Спочатку оберіть команду",
  "sidebar.linear.field.project.loading": "Завантаження проектів...",
  "sidebar.linear.field.project.placeholder": "Оберіть проект",
  "sidebar.linear.notConfigured": "Linear не налаштовано",
  "sidebar.linear.notConfiguredHint": "Відкрийте керування, щоб обрати команду та проект",
  ...
  "sidebar.linear.pullSuccess":
    "Отримано {{pulled}}, оновлено {{updated}}, пропущено {{skipped}}, видалено {{deleted}}",
  "sidebar.linear.pushFailed": "Не вдалося надіслати в Linear",
  "sidebar.linear.pushPartialFailed": "Надсилання частково не вдалося: {{count}} помилок",
  "sidebar.linear.pushSuccess": "Надіслано {{count}} завдань до Linear",
  "sidebar.linear.pushNothing": "Нічого надсилати",
  "sidebar.linear.syncHistory.syncing": "Синхронізація...",
  "sidebar.linear.syncHistory.push": "↗ Linear",
  "sidebar.linear.syncHistory.pull": "↙ Linear",
  "sidebar.linear.syncHistory.itemCount.one": "{{count}} елемент",
  "sidebar.linear.syncHistory.itemCount.other": "{{count}} елементів",
  "sidebar.linear.syncHistory.error": "Помилка",
  "sidebar.linear.syncHistory.empty": "Немає історії синхронізації",
  "dialog.todo.title.create": "Нове завдання",
  "dialog.todo.title.edit": "Редагувати завдання",
  "dialog.todo.field.title": "Заголовок",
  "dialog.todo.field.title.placeholder": "Заголовок завдання",
  "dialog.todo.field.description": "Опис",
  "dialog.todo.field.description.placeholder": "Додайте деталі, посилання або контекст...",
  "dialog.todo.field.description.hint": "Підтримує посилання на файли та навички",
  "dialog.todo.field.status": "Статус",
  "dialog.todo.field.priority": "Пріоритет",
  "dialog.todo.field.dueDate": "Термін",
  "dialog.todo.field.dueDate.placeholder": "Встановити термін",
  "dialog.todo.field.dueDate.clear": "Очистити",
  "dialog.todo.field.dueDate.prevMonth": "Попередній місяць",
  "dialog.todo.field.dueDate.nextMonth": "Наступний місяць",
  "dialog.todo.field.dueDate.shortcut.today": "Сьогодні",
  "dialog.todo.field.dueDate.shortcut.tomorrow": "Завтра",
  "dialog.todo.field.dueDate.shortcut.inOneWeek": "Через тиждень",
  "dialog.todo.field.dueDate.month.0": "Січ",
  "dialog.todo.field.dueDate.month.1": "Лют",
  "dialog.todo.field.dueDate.month.2": "Бер",
  "dialog.todo.field.dueDate.month.3": "Кві",
  "dialog.todo.field.dueDate.month.4": "Тра",
  "dialog.todo.field.dueDate.month.5": "Чер",
  "dialog.todo.field.dueDate.month.6": "Лип",
  "dialog.todo.field.dueDate.month.7": "Сер",
  "dialog.todo.field.dueDate.month.8": "Вер",
  "dialog.todo.field.dueDate.month.9": "Жов",
  "dialog.todo.field.dueDate.month.10": "Лис",
  "dialog.todo.field.dueDate.month.11": "Гру",
  "dialog.todo.field.labels": "Мітки",
  "dialog.todo.field.assignee": "Виконавець",
  "dialog.todo.field.assignee.unassigned": "Не призначено",
  "dialog.todo.field.assignee.loadFailed": "Не вдалося завантажити виконавців",
  "dialog.todo.field.assignee.loading": "Завантаження виконавців...",
  "dialog.todo.field.assignee.placeholder": "Оберіть виконавця",
  "dialog.todo.field.assignee.hint": "З учасників команди Linear",
  "dialog.todo.autocomplete.noFiles": "Файли не знайдено",
  "dialog.todo.autocomplete.noSkills": "Навички не знайдено",
  "dialog.todo.linkedLinear": "Пов'язано з Linear",
  "dialog.todo.created": "Завдання створено",
  "dialog.todo.updated": "Завдання оновлено",
  "dialog.todo.error.titleRequired": "Заголовок обов'язковий",
  "dialog.todo.error.saveFailed": "Не вдалося зберегти завдання",
  "dialog.todo.action.create": "Створити",
  ...
  "sidebar.issue.priority.none": "Жодного",
  "sidebar.issue.priority.urgent": "Терміново",
  "sidebar.issue.priority.high": "Високий",
  "sidebar.issue.priority.medium": "Середній",
