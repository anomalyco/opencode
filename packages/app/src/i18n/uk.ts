export const dict = {
  ...
  "desktop.menu.documentation": "Документація Pencode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Pencode",
  "desktop.recovery.terminated": "Роботу вікна Pencode несподівано завершено",
  "desktop.recovery.unresponsive": "Pencode не відповідає",
  ...
  "desktop.wsl.error.installPencode": "Не вдалося встановити Pencode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.pencodeMissing": "pencode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.pencodeCannotRun": "pencode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Pencode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.pencode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.pencode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.pencodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Pencode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Pencode.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в pencode.json",
  ...
  "dialog.server.description": "Перемкніть сервер Pencode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingPencode": "Перевірка Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Перевірка Pencode у {{distro}}...",
  "wsl.onboarding.updatingPencode": "Оновлення Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Оновлення Pencode у {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Оновіть Pencode у {{distro}}.",
  "wsl.onboarding.updatePencode": "Оновити Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode готовий до роботи у {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode готовий до роботи.",
  "wsl.onboarding.installPencodeIn": "Встановіть Pencode у {{distro}}.",
  "wsl.onboarding.installPencode": "Встановити Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Pencode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Pencode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Pencode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Pencode",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (pencode.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Pencode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Pencode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Pencode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Pencode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Pencode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Pencode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Pencode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Pencode.",
