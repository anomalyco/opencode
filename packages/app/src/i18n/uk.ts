export const dict = {
  ...
  "desktop.appMenu.ariaLabel": "Меню OpenCode",
  "desktop.appMenu.file": "Файл",
  "desktop.appMenu.edit": "Редагування",
  "desktop.appMenu.view": "Вигляд",
  "desktop.appMenu.go": "Перехід",
  "desktop.appMenu.window": "Вікно",
  "desktop.appMenu.help": "Довідка",
  "desktop.appMenu.about": "Про OpenCode",
  "desktop.appMenu.checkForUpdates": "Перевірити наявність оновлень...",
  "desktop.appMenu.settings": "Налаштування",
  "desktop.appMenu.reloadWebview": "Перезавантажити вебперегляд",
  "desktop.appMenu.restart": "Перезапустити",
  "desktop.appMenu.exportLogs": "Експортувати журнали...",
  "desktop.appMenu.hide": "Приховати OpenCode",
  "desktop.appMenu.hideOthers": "Приховати інші",
  "desktop.appMenu.showAll": "Показати все",
  "desktop.appMenu.quit": "Вийти з OpenCode",
  "desktop.appMenu.newSession": "Нова сесія",
  "desktop.appMenu.openProject": "Відкрити проєкт...",
  "desktop.appMenu.newWindow": "Нове вікно",
  "desktop.appMenu.closeWindow": "Закрити вікно",
  "desktop.appMenu.undo": "Скасувати",
  "desktop.appMenu.redo": "Повторити",
  "desktop.appMenu.cut": "Вирізати",
  "desktop.appMenu.copy": "Копіювати",
  "desktop.appMenu.paste": "Вставити",
  "desktop.appMenu.delete": "Видалити",
  "desktop.appMenu.selectAll": "Вибрати все",
  "desktop.appMenu.toggleSidebar": "Перемкнути бічну панель",
  "desktop.appMenu.toggleTerminal": "Перемкнути термінал",
  "desktop.appMenu.toggleFileTree": "Перемкнути дерево файлів",
  "desktop.appMenu.reload": "Перезавантажити",
  "desktop.appMenu.toggleDeveloperTools": "Перемкнути інструменти розробника",
  "desktop.appMenu.actualSize": "Фактичний розмір",
  "desktop.appMenu.zoomIn": "Збільшити масштаб",
  "desktop.appMenu.zoomOut": "Зменшити масштаб",
  "desktop.appMenu.toggleFullScreen": "Перемкнути повноекранний режим",
  "desktop.appMenu.back": "Назад",
  "desktop.appMenu.forward": "Вперед",
  "desktop.appMenu.previousSession": "Попередня сесія",
  "desktop.appMenu.nextSession": "Наступна сесія",
  "desktop.appMenu.previousProject": "Попередній проєкт",
  "desktop.appMenu.nextProject": "Наступний проєкт",
  "desktop.appMenu.minimize": "Згорнути",
  "desktop.appMenu.zoomWindow": "Масштаб",
  "desktop.appMenu.maximize": "Розгорнути",
  "desktop.appMenu.bringAllToFront": "Усі вікна на передній план",
  "desktop.appMenu.documentation": "Документація OpenCode",
  "desktop.appMenu.supportForum": "Форум підтримки",
  "desktop.appMenu.shareFeedback": "Надіслати відгук",
  "desktop.appMenu.reportBug": "Повідомити про помилку",
