export const dict = {
  ...
  "provider.custom.models.load": "Завантажити динамічно",
  "provider.custom.models.loading": "Завантаження...",
  "provider.custom.models.load.invalidUrl": "Введіть дійсний базовий URL",
  "provider.custom.models.load.unauthorized": "Немає доступу. Перевірте ключ API",
  "provider.custom.models.load.invalidFormat": "Відповідь сервера не містить дійсного списку моделей",
  "provider.custom.models.load.timeout": "Перевищено час очікування під час завантаження моделей",
  "provider.custom.models.load.failed": "Не вдалося завантажити моделі",
  "provider.custom.models.load.empty": "Моделі не знайдено",
