export const dict = {
  ...
  "command.session.handoff": "Luovuta istunto",
  "command.session.handoff.description": "Tiivistä istunto ja jatka työtä uudessa istunnossa",
  ...
  "toast.session.handoff.failed.title": "Istunnon luovutus epäonnistui",
  "toast.session.handoff.failed.description": "Tätä istuntoa ei voitu tiivistää luovutusta varten",
