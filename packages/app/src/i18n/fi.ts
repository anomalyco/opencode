export const dict = {
  ...
  "ssh.server.add": "Lisää SSH-palvelin",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH-palvelin",
  "ssh.server.retryStart": "Yhdistä uudelleen",
  "ssh.server.disconnect": "Katkaise yhteys",
  "ssh.server.openTerminal": "Avaa terminaali",
  "ssh.server.updating": "Päivitetään...",
  "ssh.server.status.connecting": "Yhdistetään...",
  "ssh.server.status.disconnected": "Yhteys katkaistu",
  "ssh.add.hostLabel": "SSH-isäntä",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "Yhdistää järjestelmän ssh-asiakasohjelman kautta, joten SSH-määrityksesi isännät, avaimet ja agentit toimivat tavalliseen tapaan.",
  "ssh.add.configHosts": "SSH-määrityksestäsi",
  "ssh.add.connect": "Yhdistä",
  "ssh.add.checking": "Yhdistetään...",
  "ssh.add.addServer": "Lisää palvelin",
  "ssh.add.adding": "Lisätään...",
  "ssh.add.installOpencode": "Asenna opencode",
  "ssh.add.updateOpencode": "Päivitä opencode",
  "ssh.add.installing": "Asennetaan...",
  "ssh.add.status.unreachable": "Yhteyttä ei voitu muodostaa",
  "ssh.add.status.opencodeMissing": "opencodea ei ole asennettu tälle isännälle",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} asennettu, työpöytäsovellus odottaa v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} löytyi",
  "ssh.add.authHint":
    "Varmista, että avainpohjainen SSH-todennus toimii tälle isännälle — tarkista suorittamalla `ssh {{host}}` terminaalissa.",
  ...
  "desktop.ssh.error.invalidHost": "Virheellinen SSH-isäntä: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} on jo lisätty",
  "desktop.ssh.error.opencodeNotInstalled": "opencodea ei ole asennettu isännälle {{host}}",
  "desktop.ssh.error.installOpencode": "opencoden asennus epäonnistui",
  "desktop.ssh.error.connectFailed": "Ei voitu muodostaa yhteyttä isäntään {{host}}",
  "desktop.ssh.error.serverExited": "SSH-palvelin sulkeutui käynnistyksen jälkeen (koodi={{code}} signaali={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Isännän {{host}} SSH-palvelin sulkeutui ennen toimintavalmiutta (koodi={{code}} signaali={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Isännän {{host}} palvelimen kuntotarkistus aikakatkaistiin {{timeout}} ms:n jälkeen",
  "desktop.ssh.error.commandTimeout": "ssh-komento isännälle {{host}} aikakatkaistiin {{timeout}} ms:n jälkeen",
  "desktop.ssh.error.failedPort": "Portin noutaminen epäonnistui",
  "desktop.ssh.error.terminalFailed": "Terminaalin avaaminen epäonnistui",
