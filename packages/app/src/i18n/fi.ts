export const dict = {
  ...
  "command.tab.closeAll": "Sulje kaikki välilehdet",
  "command.tab.closeRight": "Sulje kaikki oikealla olevat välilehdet",
  "command.tab.closeOthers": "Sulje kaikki välilehdet paitsi tämä",
