export const dict = {
  ...
  "provider.custom.models.load": "Lataa dynaamisesti",
  "provider.custom.models.loading": "Ladataan...",
  "provider.custom.models.load.invalidUrl": "Anna kelvollinen perus-URL-osoite",
  "provider.custom.models.load.unauthorized": "Ei valtuutta. Tarkista API-avain",
  "provider.custom.models.load.invalidFormat": "Palvelimen vastaus ei sisältänyt kelvollista malliluetteloa",
  "provider.custom.models.load.timeout": "Aikaraja ylittyi malleja ladattaessa",
  "provider.custom.models.load.failed": "Mallien lataaminen epäonnistui",
  "provider.custom.models.load.empty": "Malleja ei löytynyt",
