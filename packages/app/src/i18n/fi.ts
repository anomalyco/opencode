export const dict = {
  ...
  "dialog.provider.pencode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.pencode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.pencodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Pencodessa.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.pencodeZen.visit.prefix": "Avaa ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Pencodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Pencodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään pencode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Pencode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingPencode": "Tarkistetaan Pencodea...",
  "wsl.onboarding.checkingPencodeIn": "Tarkistetaan Pencodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingPencode": "Päivitetään Pencodea...",
  "wsl.onboarding.updatingPencodeIn": "Päivitetään Pencodea kohteessa {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Päivitä Pencode jakelussa {{distro}}.",
  "wsl.onboarding.updatePencode": "Päivitä Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode on valmis.",
  "wsl.onboarding.installPencodeIn": "Asenna Pencode jakeluun {{distro}}.",
  "wsl.onboarding.installPencode": "Asenna Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Pencode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Pencode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Pencode uudelleen.",
  ...
  "toast.update.description": "Pencoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Pencode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (pencode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Pencode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Pencode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Pencode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Pencoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Pencode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Pencode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Pencoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Pencode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Pencoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Pencode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Pencode-valikko",
  ...
  "desktop.recovery.loadFailed": "Pencoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Pencode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Pencode ei vastaa",
  ...
  "desktop.wsl.error.installPencode": "Pencoden asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.pencodeMissing": "pencodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.pencodeCannotRun": "pencode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.pencodeNotInstalled": "Pencodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pencoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Pencode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
