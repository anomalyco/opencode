export const dict = {
  ...
  "dialog.provider.argus.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.argus.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.argusGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Argusn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Argusssa.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.argusZen.visit.prefix": "Avaa ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Argusssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Argusssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään argus.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Argus-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingArgus": "Tarkistetaan Argusa...",
  "wsl.onboarding.checkingArgusIn": "Tarkistetaan Argusa kohteessa {{distro}}...",
  "wsl.onboarding.updatingArgus": "Päivitetään Argusa...",
  "wsl.onboarding.updatingArgusIn": "Päivitetään Argusa kohteessa {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Päivitä Argus jakelussa {{distro}}.",
  "wsl.onboarding.updateArgus": "Päivitä Argus",
  "wsl.onboarding.argusReadyIn": "Argus on valmis jakelussa {{distro}}.",
  "wsl.onboarding.argusReady": "Argus on valmis.",
  "wsl.onboarding.installArgusIn": "Asenna Argus jakeluun {{distro}}.",
  "wsl.onboarding.installArgus": "Asenna Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argusa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Argus voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Argus ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Argus uudelleen.",
  ...
  "toast.update.description": "Argusn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Argus-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (argus.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Argus ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Argus sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Argus-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Argusn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Argus näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Argus järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Argusn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Argus käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Argusn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Argus-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Argus-valikko",
  ...
  "desktop.recovery.loadFailed": "Argusn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Argus-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Argus ei vastaa",
  ...
  "desktop.wsl.error.installArgus": "Argusn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.argusMissing": "argusa ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.argusCannotRun": "argus on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.argusNotInstalled": "Argusa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Argusn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Argus Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
