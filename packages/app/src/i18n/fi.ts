export const dict = {
  ...
  "session.tab.agents": "Aliagentit",
  "session.agents.empty": "Ei aliagentteja käynnissä",
  "session.agents.costTotal": "Kokonaishinta",
  "session.agents.costSubagents": "Aliagentit",
  "session.agents.count": "Agentit",
  "session.agents.tokens": "tokenia",
  "session.agents.showAll": "Näytä kaikki ({{count}})",
  "session.agents.status.idle": "Jouten",
  "session.agents.status.busy": "Käynnissä",
  "session.agents.status.retry": "Yritetään uudelleen",
  "session.agents.status.cancelled": "Peruutettu",
  "session.agents.status.completed": "Valmis",
  "session.agents.status.error": "Epäonnistui",
