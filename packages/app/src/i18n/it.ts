export const dict = {
  ...
  "mcp.status.needs_client_registration": "registrazione client necessaria",
  "mcp.status.pending": "connessione…",
  ...
  "settings.mcp.type.local": "Locale",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Lascia vuoto per omettere — potrebbe essere necessaria una nuova autenticazione",
