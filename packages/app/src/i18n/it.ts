export const dict = {
  ...
  "session.tab.agents": "Subagenti",
  "session.agents.empty": "Nessun subagente in esecuzione",
  "session.agents.costTotal": "Costo totale",
  "session.agents.costSubagents": "Subagenti",
  "session.agents.count": "Agenti",
  "session.agents.tokens": "token",
  "session.agents.showAll": "Mostra tutti ({{count}})",
  "session.agents.status.idle": "Inattivo",
  "session.agents.status.busy": "In esecuzione",
  "session.agents.status.retry": "Nuovo tentativo",
  "session.agents.status.cancelled": "Annullato",
  "session.agents.status.completed": "Completato",
  "session.agents.status.error": "Errore",
