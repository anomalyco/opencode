export const dict = {
  ...
  "command.terminal.new.description": "Crea una nuova scheda del terminale",
  ...
  "command.mcp.toggle.description": "Attiva o disattiva MCP",
  "command.agent.cycle": "Passa all'agente successivo",
  "command.agent.cycle.description": "Passa all'agente successivo",
  "command.agent.cycle.reverse": "Passa all'agente precedente",
  "command.agent.cycle.reverse.description": "Passa all'agente precedente",
  "command.model.variant.cycle": "Passa al livello di sforzo di ragionamento",
  ...
  "command.permissions.autoaccept.disable": "Disattiva accettazione automatica",
  "command.workspace.toggle": "Mostra/Nascondi spazi di lavoro",
  "command.workspace.toggle.description": "Attiva o disattiva spazi di lavoro multipli nella barra laterale",
  ...
  "command.session.fork.description": "Crea una nuova sessione a partire da un messaggio precedente",
  ...
  "dialog.provider.tag.recommended": "Consigliati",
  ...
  "dialog.provider.openai.note": "Modelli GPT per attività AI generali veloci e potenti",
  ...
  "dialog.model.empty": "Nessun risultato per il modello",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in OpenCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenCode Zen offre accesso a un set selezionato di modelli ottimizzati e affidabili per gli agenti di programmazione.",
  ...
  "provider.connect.opencodeZen.visit.suffix": " per recuperare la chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo link",
  "provider.connect.oauth.code.visit.suffix":
    " per recuperare il codice di autorizzazione, connettere il tuo account e utilizzare i modelli {{provider}} in OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per collegare il tuo account e utilizzare i modelli {{provider}} in OpenCode.",
  ...
  "provider.custom.description.link": "documentazione sulla configurazione del provider",
  "provider.custom.description.suffix": ".",
  "provider.custom.field.providerID.label": "ID provider",
  "provider.custom.field.providerID.placeholder": "myprovider",
  "provider.custom.field.providerID.description": "Lettere minuscole, numeri, trattini o caratteri di sottolineatura",
  ...
  "provider.custom.headers.label": "Intestazioni (opzionali)",
  ...
  "provider.custom.error.providerID.format":
    "Utilizza lettere minuscole, numeri, trattini o caratteri di sottolineatura",
  ...
  "model.tooltip.reasoning.allowed": "Consente il ragionamento",
  ...
  "session.child.promptDisabled": "Impossibile inviare prompt alle sessioni dei sottagenti.",
  ...
  "prompt.example.7": "Rendi più leggibile questa funzione",
  ...
  "prompt.example.12": "Aggiungi la validazione degli input",
  ...
  "prompt.example.19": "Aggiungi il logging in tutto il codice",
  ...
  "prompt.dropzone.file.label": "Trascina per @mention del file",
  ...
  "prompt.toast.pasteUnsupported.description": "È possibile allegare solo immagini, PDF o file di testo.",
  ...
  "mcp.auth.clickToAuthenticate": "Fare clic per autenticarsi",
  "dialog.fork.empty": "Nessun messaggio da cui creare un fork",
  ...
  "dialog.server.description": "Passa al server OpenCode a cui si connette questa app.",
  "dialog.server.search.placeholder": "Cerca server",
  "dialog.server.empty": "Nessun server presente",
  ...
  "dialog.releaseNotes.media.alt": "Anteprima della versione",
  "context.breakdown.title": "Ripartizione del contesto",
  "context.breakdown.note":
    'Ripartizione approssimativa dei token di input. "Altro" include definizioni degli strumenti e overhead.',
  ...
  "context.usage.view": "Visualizza utilizzo del contesto",
  "language.en": "Inglese",
  ...
  "toast.theme.title": "Tema modificato",
  "toast.scheme.title": "Schema colori",
  "toast.workspace.enabled.title": "Spazi di lavoro abilitati",
  "toast.workspace.enabled.description": "I worktree multipli sono ora visualizzati nella barra laterale",
  "toast.workspace.disabled.title": "Spazi di lavoro disabilitati",
  "toast.workspace.disabled.description": "Solo il worktree principale è visualizzato nella barra laterale",
  ...
  "toast.session.unshare.failed.title": "Impossibile rimuovere la condivisione della sessione",
  "toast.session.unshare.failed.description":
    "Si è verificato un errore durante la rimozione della condivisione della sessione",
  ...
  "toast.update.description": "È disponibile una nuova versione di OpenCode ({{version}}) da installare.",
  ...
  "error.childStore.storeCreateFailed": "Impossibile creare l'archivio",
  ...
  "error.chain.checkConfig": "Verifica i nomi provider/modello nella configurazione (opencode.json)",
  "error.chain.mcpFailed":
    'Server MCP "{{name}}" non riuscito. Nota: OpenCode non supporta ancora l\'autenticazione MCP.',
  "error.chain.providerAuthFailed": "Autenticazione provider non riuscita ({{provider}}): {{message}}",
  "error.chain.providerInitFailed":
    'Impossibile inizializzare il provider "{{provider}}". Verifica le credenziali e la configurazione.',
  "error.chain.configJsonInvalid": "Il file di configurazione in {{path}} non è un JSON(C) valido",
  "error.chain.configJsonInvalidWithMessage":
    "Il file di configurazione in {{path}} non è un JSON(C) valido: {{message}}",
  "error.chain.configDirectoryTypo":
    'La directory "{{dir}}" in {{path}} non è valida. Rinominala in "{{suggestion}}" o rimuovila. Si tratta di un errore comune.',
  ...
  "notification.permission.description": "{{sessionTitle}} in {{projectName}} richiede un'autorizzazione",
  ...
  "home.sessions.group.older": "Precedenti",
  ...
  "session.review.noUncommittedChanges": "Nessuna modifica non committata al momento",
  "session.review.noBranchChanges": "Nessuna modifica del branch al momento",
  ...
  "session.share.popover.description.shared":
    "Questa sessione è pubblica sul web. È accessibile a chiunque disponga del link.",
  "session.share.popover.description.unshared":
    "Condividi la sessione pubblicamente sul web. Sarà accessibile a chiunque disponga del link.",
  "session.share.action.share": "Condividi",
  "session.share.action.publish": "Pubblica",
  "session.share.action.publishing": "Pubblicazione in corso...",
  "session.share.action.unpublish": "Rimuovi pubblicazione",
  "session.share.action.unpublishing": "Rimozione pubblicazione in corso...",
  ...
  "terminal.connectionLost.title": "Connessione interrotta",
  "terminal.connectionLost.abnormalClose": "WebSocket chiuso in modo anomalo: {{code}}",
  "terminal.connectionLost.description":
    "La connessione al terminale è stata interrotta. Questo può accadere durante il riavvio del server.",
  "common.closeTab": "Chiudi scheda",
  "common.dismiss": "Chiudi",
  "common.moreCountSuffix": " (+{{count}} altro)",
  "common.requestFailed": "Richiesta non riuscita",
  "common.moreOptions": "Altre opzioni",
  "common.learnMore": "Maggiori informazioni",
  ...
  "common.time.hoursAgo.short": "{{count}} ore fa",
  "common.time.daysAgo.short": "{{count}} giorni fa",
  "sidebar.menu.toggle": "Mostra/nascondi menu",
  "sidebar.nav.projectsAndSessions": "Progetti e sessioni",
  "sidebar.settings": "Impostazioni",
  "sidebar.help": "Aiuto",
  "sidebar.workspaces.enable": "Abilita spazi di lavoro",
  "sidebar.workspaces.disable": "Disabilita spazi di lavoro",
  ...
  "sidebar.gettingStarted.line2": "Collega un provider per utilizzare modelli, tra cui Claude, GPT, Gemini, ecc.",
  ...
  "debugBar.nav.tip":
    "Ultima transizione di route completata che tocca una pagina di sessione, misurata dall'avvio del router fino al primo rendering dopo il stabilizzamento.",
  "debugBar.fps.label": "FPS",
  "debugBar.fps.tip": "Fotogrammi al secondo mediati negli ultimi 5 secondi.",
  "debugBar.frame.label": "FRAME",
  "debugBar.frame.tip": "Tempo fotogramma peggiore negli ultimi 5 secondi.",
  "debugBar.jank.label": "JANK",
  "debugBar.jank.tip": "Fotogrammi superiori a 32ms negli ultimi 5 secondi.",
  "debugBar.long.label": "LONG",
  "debugBar.long.tip": "Tempo di blocco e conteggio attività lunghe negli ultimi 5 secondi. Attività massima: {{max}}.",
  "debugBar.delay.label": "DELAY",
  "debugBar.delay.tip": "Ritardo di input peggiore osservato negli ultimi 5 secondi.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip":
    "Durata interazione approssimativa negli ultimi 5 secondi. Simile a INP, non l'INP ufficiale Web Vitals.",
  "debugBar.cls.label": "CLS",
  "debugBar.cls.tip": "Spostamento cumulativo del layout per la durata attuale dell'app.",
  "debugBar.mem.label": "MEM",
  "debugBar.mem.tipUnavailable": "Heap JS utilizzato rispetto al limite heap. Solo Chromium.",
  "debugBar.mem.tip": "Heap JS utilizzato rispetto al limite heap. {{used}} di {{limit}}.",
  ...
  "settings.general.row.language.description": "Modifica la lingua di visualizzazione per OpenCode",
  "settings.general.row.shell.title": "Shell del terminale",
  "settings.general.row.shell.description":
    "Scegli la shell utilizzata per il terminale. Le shell compatibili vengono utilizzate anche dalle chiamate agli strumenti dell'agente.",
  "settings.general.row.shell.autoDefault": "Automatica (predefinita)",
  ...
  "settings.general.row.colorScheme.description": "Scegli se OpenCode segue il sistema, il tema chiaro o quello scuro",
  ...
  "settings.general.row.font.description": "Personalizza il font utilizzato nei blocchi di codice",
  ...
  "settings.general.row.uiFont.description": "Personalizza il carattere utilizzato in tutta l'interfaccia",
  "settings.general.row.followup.title": "Comportamento dei prompt successivi",
  "settings.general.row.followup.description":
    "Scegli se i prompt successivi vengono eseguiti immediatamente o accodati",
  "settings.general.row.followup.option.queue": "Accoda",
  "settings.general.row.followup.option.steer": "Esegui subito",
  "settings.general.row.showFileTree.title": "Albero dei file",
  "settings.general.row.showFileTree.description": "Mostra il pannello dell'albero dei file nelle sessioni desktop",
  "settings.general.row.showNavigation.title": "Controlli di navigazione",
  "settings.general.row.showNavigation.description":
    "Mostra i pulsanti indietro e avanti nella barra del titolo desktop",
  "settings.general.row.showSearch.title": "Palette comandi",
  "settings.general.row.showSearch.description":
    "Mostra il pulsante per la ricerca e la palette comandi nella barra del titolo desktop",
  ...
  "settings.general.row.showStatus.description":
    "Mostra il pulsante dello stato del server nella barra del titolo desktop",
  "settings.general.row.showCustomAgents.title": "Agenti personalizzati",
  "settings.general.row.showCustomAgents.description": "Mostra il selettore agenti nel composer desktop v2",
  "settings.general.row.reasoningSummaries.title": "Mostra riepiloghi del ragionamento",
  "settings.general.row.reasoningSummaries.description":
    "Visualizza i riepiloghi del ragionamento del modello nella cronologia",
  "settings.general.row.shellToolPartsExpanded.title": "Espandi parti strumento shell",
  "settings.general.row.shellToolPartsExpanded.description":
    "Mostra le parti dello strumento shell espanse per impostazione predefinita nella cronologia",
  "settings.general.row.editToolPartsExpanded.title": "Espandi parti strumento modifica",
  "settings.general.row.editToolPartsExpanded.description":
    "Mostra le parti degli strumenti di modifica, scrittura e patch espanse per impostazione predefinita nella cronologia",
  "settings.general.row.showSessionProgressBar.title": "Mostra barra di avanzamento sessione",
  "settings.general.row.showSessionProgressBar.description":
    "Visualizza la barra di avanzamento animata in alto nella sessione quando l'agente sta lavorando",
  "settings.general.row.newLayoutDesigns.title": "Nuovi layout e design",
  "settings.general.row.newLayoutDesigns.description":
    "Abilita il layout ridisegnato, la home, il composer e l'interfaccia della sessione",
  "settings.general.row.pinchZoom.title": "Pinch per zoom",
  "settings.general.row.pinchZoom.description": "Consenti i gesti di pinch del trackpad e Ctrl-scroll per lo zoom",
  ...
  "settings.general.row.releaseNotes.description": "Mostra i popup delle novità dopo gli aggiornamenti",
  ...
  "settings.updates.toast.latest.title": "Versione aggiornata",
  ...
  "settings.general.notifications.agent.description":
    "Mostra una notifica di sistema quando l'agente è completo o richiede attenzione",
  ...
  "settings.general.sounds.agent.description": "Riproduci un suono quando l'agente è completo o richiede attenzione",
  ...
  "settings.shortcuts.reset.button": "Reimposta su valori predefiniti",
  "settings.shortcuts.reset.toast.title": "Scorciatoie reimpostate",
  "settings.shortcuts.reset.toast.description":
    "Le scorciatoie da tastiera sono state reimpostate sui valori predefiniti.",
  ...
  "settings.providers.connected.environmentDescription": "Connesso tramite variabili di ambiente",
  ...
  "settings.permissions.description":
    "Controlla quali strumenti il server può utilizzare per impostazione predefinita.",
  ...
  "settings.permissions.tool.glob.description": "Corrispondenza dei file utilizzando pattern glob",
  "settings.permissions.tool.grep.title": "Grep",
  "settings.permissions.tool.grep.description": "Ricerca nei contenuti dei file utilizzando espressioni regolari",
  "settings.permissions.tool.list.title": "Elenco",
  "settings.permissions.tool.list.description": "Elenco dei file all'interno di una directory",
  "settings.permissions.tool.bash.title": "Bash",
  "settings.permissions.tool.bash.description": "Esecuzione di comandi della shell",
  "settings.permissions.tool.task.title": "Attività",
  "settings.permissions.tool.task.description": "Avvio di sotto-agenti",
  "settings.permissions.tool.skill.title": "Skill",
  "settings.permissions.tool.skill.description": "Caricamento di una skill per nome",
  "settings.permissions.tool.lsp.title": "LSP",
  "settings.permissions.tool.lsp.description": "Esecuzione di query del server di linguaggio",
  "settings.permissions.tool.todowrite.title": "Scrittura Todo",
  "settings.permissions.tool.todowrite.description": "Aggiornamento dell'elenco delle attività",
  "settings.permissions.tool.webfetch.title": "Recupero Web",
  "settings.permissions.tool.webfetch.description": "Recupero di contenuti da un URL",
  "settings.permissions.tool.websearch.title": "Ricerca Web",
  "settings.permissions.tool.websearch.description": "Ricerca nel web",
  "settings.permissions.tool.external_directory.title": "Directory esterna",
  "settings.permissions.tool.external_directory.description":
    "Accesso ai file al di fuori della directory del progetto",
  "settings.permissions.tool.doom_loop.title": "Ciclo infinito",
  "settings.permissions.tool.doom_loop.description": "Rilevamento di chiamate di strumenti ripetute con input identico",
  ...
  "workspace.error.stillPreparing": "L'area di lavoro è ancora in fase di preparazione",
  ...
  "workspace.status.dirty": "Rilevate modifiche non unite in questa area di lavoro.",
  "workspace.delete.title": "Elimina area di lavoro",
  "workspace.delete.confirm": 'Eliminare l\'area di lavoro "{{name}}"?',
  "workspace.delete.button": "Elimina area di lavoro",
  "workspace.reset.title": "Reimposta area di lavoro",
  "workspace.reset.confirm": 'Reimpostare l\'area di lavoro "{{name}}"?',
  "workspace.reset.button": "Reimposta area di lavoro",
  ...
  "workspace.reset.note": "Questo ripristinerà l'area di lavoro per farla corrispondere al branch predefinito.",
}
