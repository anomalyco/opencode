export const dict = {
  ...
  "command.session.handoff": "Trasferisci sessione",
  "command.session.handoff.description": "Comprimi la sessione e continua il lavoro in una nuova sessione",
  ...
  "toast.session.handoff.failed.title": "Trasferimento della sessione non riuscito",
  "toast.session.handoff.failed.description": "Non è stato possibile riassumere questa sessione per trasferirla",
