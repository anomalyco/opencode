export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Jarvis.",
  ...
  "dialog.server.description": "Cambia il server Jarvis a cui si connette l'app.",
  ...
  "wsl.onboarding.step.opencode": "Jarvis",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Jarvis in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Jarvis in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Jarvis in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Jarvis in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Jarvis possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Jarvis non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Jarvis ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Jarvis",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Jarvis non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "app.name.desktop": "Jarvis Desktop",
  "settings.section.desktop": "Desktop",
  "settings.section.server": "Server",
  "settings.tab.general": "Generale",
  "settings.tab.shortcuts": "Scorciatoie",
  "settings.tab.integrations": "Integrazioni",
  "settings.tab.connectors": "Connettori",
  "settings.integrations.placeholder": "Le integrazioni estendono il runtime di Jarvis. Presto potrai installare plugin, temi ed estensioni di sistema.",
  "settings.connectors.placeholder": "I connettori collegano Jarvis ai servizi esterni. In arrivo: Gmail, WhatsApp, Slack, Notion, Telegram e altri.",
  "settings.connectors.unavailable": "I connettori sono disponibili solo nell'app desktop.",
  "settings.connectors.badge.connected": "Connesso",
  "settings.connectors.badge.notConnected": "Non connesso",
  "settings.connectors.badge.disabled": "Disabilitato",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "Collega il tuo account GitHub per permettere a Jarvis di leggere e gestire i tuoi repository.",
  "settings.connectors.github.detail": "Collega il tuo account GitHub così Jarvis può lavorare con i tuoi repository, issue e pull request direttamente dalla chat. Autorizzi l'accesso con il tuo account GitHub tramite OAuth — Jarvis non vede mai la tua password.",
  "settings.connectors.github.permission.repos": "Leggere e gestire i tuoi repository, issue e pull request",
  "settings.connectors.github.permission.profile": "Leggere il tuo profilo pubblico (nome utente e avatar)",
  "settings.connectors.github.connect": "Connetti GitHub",
  "settings.connectors.github.disconnect": "Disconnetti",
  "settings.connectors.github.cancel": "Annulla",
  "settings.connectors.github.openBrowser": "Apri browser",
  "settings.connectors.github.waiting": "In attesa di autorizzazione…",
  "settings.connectors.github.code.instructions": "Inserisci questo codice su",
  "settings.connectors.github.connected.text": "Connesso via OAuth. Jarvis può accedere al tuo account GitHub.",
  "settings.connectors.github.error.expired": "Il codice di autorizzazione è scaduto. Riprova.",
  "settings.connectors.github.error.generic": "Impossibile connettersi a GitHub. Controlla la connessione e riprova.",
  "settings.connectors.github.error.denied": "Autorizzazione negata. Puoi riprovare quando vuoi.",
  ...
  "toast.session.export.failed.title": "Esportazione sessione non riuscita",
  ...
  "settings.desktop.wsl.description": "Esegui il server Jarvis all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Jarvis",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Jarvis sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Jarvis segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Jarvis.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Jarvis",
  ...
  "settings.updates.toast.latest.title": "Jarvis è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Jarvis.",
  ...
  "desktop.menu.documentation": "Documentazione di Jarvis",
  ...
  "desktop.menu.ariaLabel": "Menu Jarvis",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Jarvis",
  "desktop.recovery.terminated": "La finestra di Jarvis si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Jarvis non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Jarvis non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Jarvis è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
