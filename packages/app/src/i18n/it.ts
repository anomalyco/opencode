export const dict = {
  ...
  "dialog.provider.pencode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.pencode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.pencodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Pencode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.pencodeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.pencodeZen.visit.prefix": "Visita ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Pencode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in pencode.json",
  ...
  "dialog.server.description": "Cambia il server Pencode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingPencode": "Controllo Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Controllo Pencode in {{distro}}...",
  "wsl.onboarding.updatingPencode": "Aggiornamento Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Aggiornamento Pencode in {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Aggiorna Pencode in {{distro}}.",
  "wsl.onboarding.updatePencode": "Aggiorna Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode è pronto in {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode è pronto.",
  "wsl.onboarding.installPencodeIn": "Installa Pencode in {{distro}}.",
  "wsl.onboarding.installPencode": "Installa Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Pencode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Pencode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Pencode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Pencode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (pencode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Pencode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Pencode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Pencode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Pencode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Pencode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Pencode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Pencode",
  ...
  "settings.updates.toast.latest.title": "Pencode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Pencode.",
  ...
  "desktop.menu.documentation": "Documentazione di Pencode",
  ...
  "desktop.menu.ariaLabel": "Menu Pencode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Pencode",
  "desktop.recovery.terminated": "La finestra di Pencode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Pencode non risponde",
  ...
  "desktop.wsl.error.installPencode": "Installazione di Pencode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.pencodeMissing": "pencode non è installato in questa distribuzione",
  "desktop.wsl.error.pencodeCannotRun": "pencode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Pencode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
