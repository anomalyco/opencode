export const dict = {
  ...
  "dialog.provider.argus.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.argus.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.argusGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Argus",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.argusZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Argus.",
  ...
  "dialog.plugins.empty": "Plugin configurati in argus.json",
  ...
  "dialog.server.description": "Cambia il server Argus a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingArgus": "Controllo Argus...",
  "wsl.onboarding.checkingArgusIn": "Controllo Argus in {{distro}}...",
  "wsl.onboarding.updatingArgus": "Aggiornamento Argus...",
  "wsl.onboarding.updatingArgusIn": "Aggiornamento Argus in {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Aggiorna Argus in {{distro}}.",
  "wsl.onboarding.updateArgus": "Aggiorna Argus",
  "wsl.onboarding.argusReadyIn": "Argus è pronto in {{distro}}.",
  "wsl.onboarding.argusReady": "Argus è pronto.",
  "wsl.onboarding.installArgusIn": "Installa Argus in {{distro}}.",
  "wsl.onboarding.installArgus": "Installa Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Argus possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Argus non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Argus ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Argus",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (argus.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Argus non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Argus all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Argus",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Argus sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Argus segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Argus.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Argus",
  ...
  "settings.updates.toast.latest.title": "Argus è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Argus.",
  ...
  "desktop.menu.documentation": "Documentazione di Argus",
  ...
  "desktop.menu.ariaLabel": "Menu Argus",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Argus",
  "desktop.recovery.terminated": "La finestra di Argus si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Argus non risponde",
  ...
  "desktop.wsl.error.installArgus": "Installazione di Argus non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.argusMissing": "argus non è installato in questa distribuzione",
  "desktop.wsl.error.argusCannotRun": "argus è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.argusNotInstalled": "Argus non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Argus è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
