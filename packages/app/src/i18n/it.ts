export const dict = {
  ...
  "settings.plugins.section.browse": "Sfoglia",
  "settings.plugins.section.installed": "Installati",
  "settings.plugins.source.all": "Tutte le fonti",
  "settings.plugins.source.ecosystem": "Ecosistema",
  "settings.plugins.source.awesome": "Awesome",
  "settings.plugins.source.cafe": "Cafe",
  "settings.tab.mcp": "MCP",
  "settings.mcp.add": "Aggiungi server",
  "settings.mcp.empty": "Nessun server MCP configurato.",
  "settings.mcp.deleted": "{{name}} eliminato.",
  "settings.mcp.errors.refresh": "Impossibile caricare i server MCP.",
  "settings.mcp.status.pending": "connessione…",
  "settings.mcp.action.connect": "Connetti",
  "settings.mcp.action.disconnect": "Disconnetti",
  "settings.mcp.action.authenticate": "Autentica",
  "settings.mcp.action.edit": "Modifica",
  "settings.mcp.action.delete": "Elimina",
  "settings.mcp.delete.title": "Elimina server MCP",
  "settings.mcp.delete.body": "Rimuovere {{name}}? Questa azione non è annullabile.",
  "settings.mcp.form.title.add": "Aggiungi server MCP",
  "settings.mcp.form.title.edit": "Modifica server MCP",
  "settings.mcp.form.subtitle": "Configura le impostazioni di connessione.",
  "settings.mcp.form.name": "Nome",
  "settings.mcp.form.command": "Comando",
  "settings.mcp.form.command.hint": "es. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Directory di lavoro",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Variabili d'ambiente",
  "settings.mcp.form.headers": "Intestazioni",
  "settings.mcp.form.addRow": "Aggiungi riga",
  "settings.mcp.form.removeRow": "Rimuovi",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "ID client",
  "settings.mcp.form.oauth.clientSecret": "Segreto client",
  "settings.mcp.form.oauth.clientSecret.keep": "Configurato — lascia vuoto per mantenere",
  "settings.mcp.form.oauth.scope": "Ambito",
  "settings.mcp.form.oauth.callbackPort": "Porta di callback",
  "settings.mcp.form.oauth.disableAutodetect": "Disabilita rilevamento automatico OAuth",
  "settings.mcp.form.enabled": "Attivo",
  "settings.mcp.form.timeout": "Timeout (ms)",
  "settings.mcp.form.save": "Salva",
  "settings.mcp.form.cancel": "Annulla",
  "settings.mcp.form.error.name": "Inserisci un nome.",
  "settings.mcp.form.error.command": "Inserisci un comando.",
  "settings.mcp.form.error.url": "Inserisci un URL.",
  "settings.mcp.form.error.callbackPort": "La porta di callback deve essere tra 1 e 65535.",
  "settings.mcp.form.error.timeout": "Il timeout deve essere un numero intero positivo.",
  "settings.mcp.errors.invalid": "Correggi i campi evidenziati.",
  "settings.mcp.errors.duplicate": "Esiste già un server con questo nome.",
  "settings.mcp.errors.noConfig": "Impossibile leggere la configurazione di {{name}} — potrebbe essere definita fuori dal progetto.",
  "settings.mcp.edit.warn": "Il salvataggio riconnette questo server.",
  "settings.plugins.search.placeholder": "Cerca plugin…",
  "settings.plugins.detail.install": "Installa…",
  "settings.plugins.detail.copy": "Copia snippet di configurazione",
  "settings.plugins.detail.copied": "Copiato",
  "settings.plugins.detail.notOnNpm": "Non trovato su npm — aggiungi manualmente a opencode.json",
  "settings.plugins.install.title": "Installa plugin",
  "settings.plugins.install.description": "Dove aggiungere {{name}}?",
  "settings.plugins.install.global": "Globale (~/.config/opencode)",
  "settings.plugins.install.project": "Questo progetto",
  "settings.plugins.install.cancel": "Annulla",
  "settings.plugins.install.success": "{{name}} installato. Riavvia OpenCode per caricarlo.",
  "settings.plugins.installed.empty": "Nessun plugin installato.",
  "settings.plugins.installed.provenance.global": "Globale",
  "settings.plugins.installed.provenance.project": "Progetto",
  "settings.plugins.installed.disable": "Disattiva",
  "settings.plugins.installed.enable": "Attiva",
  "settings.plugins.installed.uninstall": "Disinstalla",
  "settings.plugins.installed.uninstallBody": "Disinstallare {{name}} da {{scope}}? Verrà rimosso dal file di configurazione.",
  "settings.plugins.installed.recentlyRemoved": "Rimossi di recente",
  "settings.plugins.installed.openConfig": "Apri config",
  "settings.plugins.errors.parseFailed": "Impossibile leggere {{path}} — correggi o rimuovi il file per gestire i plugin.",
  "settings.plugins.errors.catalog": "Impossibile aggiornare il catalogo dei plugin.",
  "settings.plugins.stale": "Catalogo in cache ({{age}}).",
