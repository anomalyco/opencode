export const dict = {
  ...
  "ssh.server.add": "Aggiungi il server SSH",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "Server SSH",
  "ssh.server.retryStart": "Riconnetti",
  "ssh.server.disconnect": "Disconnetti",
  "ssh.server.openTerminal": "Apri terminale",
  "ssh.server.updating": "Aggiornamento...",
  "ssh.server.status.connecting": "Connessione...",
  "ssh.server.status.disconnected": "Disconnesso",
  "ssh.add.hostLabel": "Host SSH",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "La connessione avviene tramite il client ssh del sistema, quindi host, chiavi e agent della tua configurazione SSH funzionano come al solito.",
  "ssh.add.configHosts": "Dalla tua configurazione SSH",
  "ssh.add.connect": "Connetti",
  "ssh.add.checking": "Connessione...",
  "ssh.add.addServer": "Aggiungi server",
  "ssh.add.adding": "Aggiunta...",
  "ssh.add.installOpencode": "Installa opencode",
  "ssh.add.updateOpencode": "Aggiorna opencode",
  "ssh.add.installing": "Installazione...",
  "ssh.add.status.unreachable": "Impossibile connettersi",
  "ssh.add.status.opencodeMissing": "opencode non è installato su questo host",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} installato, l'app desktop prevede la v{{expected}}",
  "ssh.add.status.opencodeFound": "opencode v{{version}} trovato",
  "ssh.add.authHint":
    "Assicurati che l'autenticazione SSH con chiave funzioni per questo host: esegui `ssh {{host}}` in un terminale per verificarlo.",
  ...
  "desktop.ssh.error.invalidHost": "Host SSH non valido: {{host}}",
  "desktop.ssh.error.alreadyAdded": "{{host}} è già stato aggiunto",
  "desktop.ssh.error.opencodeNotInstalled": "opencode non è installato su {{host}}",
  "desktop.ssh.error.installOpencode": "Installazione di opencode non riuscita",
  "desktop.ssh.error.connectFailed": "Impossibile connettersi a {{host}}",
  "desktop.ssh.error.serverExited": "Il server SSH si è chiuso dopo l'avvio (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "Il server SSH per {{host}} si è chiuso prima di diventare operativo (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout":
    "Il controllo dello stato del server su {{host}} ha superato il tempo limite di {{timeout}}ms",
  "desktop.ssh.error.commandTimeout": "Il comando ssh verso {{host}} ha superato il tempo limite di {{timeout}}ms",
  "desktop.ssh.error.failedPort": "Impossibile ottenere la porta",
  "desktop.ssh.error.terminalFailed": "Impossibile aprire un terminale",
