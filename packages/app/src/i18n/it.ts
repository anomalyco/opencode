export const dict = {
  ...
  "dialog.plugins.empty": "Plugin configurati in leak-code.json",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (leak-code.json)",
