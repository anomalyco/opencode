export const dict = {
  ...
  "provider.custom.models.load": "Carica dinamicamente",
  "provider.custom.models.loading": "Caricamento...",
  "provider.custom.models.load.invalidUrl": "Inserisci un URL di base valido",
  "provider.custom.models.load.unauthorized": "Non autorizzato. Controlla la chiave API",
  "provider.custom.models.load.invalidFormat": "La risposta del server non conteneva un elenco di modelli valido",
  "provider.custom.models.load.timeout": "Timeout durante il caricamento dei modelli",
  "provider.custom.models.load.failed": "Caricamento dei modelli non riuscito",
  "provider.custom.models.load.empty": "Nessun modello trovato",
