export const dict = {
  ...
  "command.tab.closeAll": "Chiudi tutte le schede",
  "command.tab.closeRight": "Chiudi tutte le schede a destra",
  "command.tab.closeOthers": "Chiudi tutte le schede tranne questa",
