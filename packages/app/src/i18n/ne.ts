export const dict: Record<string, string> = {
  ...
  "session.tab.agents": "उप-एजेन्टहरू",
  "session.agents.empty": "कुनै उप-एजेन्ट चलिरहेको छैन",
  "session.agents.costTotal": "कुल लागत",
  "session.agents.costSubagents": "उप-एजेन्टहरू",
  "session.agents.count": "एजेन्टहरू",
  "session.agents.tokens": "टोकनहरू",
  "session.agents.showAll": "सबै देखाउनुहोस् ({{count}})",
  "session.agents.status.idle": "निष्क्रिय",
  "session.agents.status.busy": "चलिरहेको",
  "session.agents.status.retry": "पुनः प्रयास",
  "session.agents.status.cancelled": "रद्द गरियो",
  "session.agents.status.completed": "सम्पन्न",
  "session.agents.status.error": "असफल",
