export const dict: Record<string, string> = {
  ...
  "provider.custom.models.load": "गतिशील रूपमा लोड गर्नुहोस्",
  "provider.custom.models.loading": "लोड हुँदैछ...",
  "provider.custom.models.load.invalidUrl": "मान्य आधार URL लेख्नुहोस्",
  "provider.custom.models.load.unauthorized": "अनधिकृत। API कुञ्जी जाँच्नुहोस्",
  "provider.custom.models.load.invalidFormat": "सर्भरको प्रतिक्रियामा मान्य मोडेल सूची छैन",
  "provider.custom.models.load.timeout": "मोडेल लोड गर्दा समय सकियो",
  "provider.custom.models.load.failed": "मोडेल लोड गर्न असफल",
  "provider.custom.models.load.empty": "कुनै मोडेल फेला परेन",
