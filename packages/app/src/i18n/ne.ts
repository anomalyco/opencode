export const dict: Record<string, string> = {
  ...
  "settings.tab.plugins": "प्लगइनहरू",
  "settings.plugins.section.browse": "ब्राउज",
  "settings.plugins.section.installed": "स्थापित",
  ...
  "settings.mcp.add": "सर्भर थप्नुहोस्",
  "settings.mcp.empty": "कुनै MCP सर्भर कन्फिगर गरिएको छैन।",
  "settings.mcp.deleted": "{{name}} मेटियो।",
  "settings.mcp.errors.refresh": "MCP सर्भरहरू लोड गर्न सकिएन।",
  "settings.mcp.status.pending": "जोड्दै…",
  "settings.mcp.action.connect": "जोड्नुहोस्",
  "settings.mcp.action.disconnect": "विच्छेद गर्नुहोस्",
  "settings.mcp.action.authenticate": "प्रमाणीकरण",
  "settings.mcp.action.edit": "सम्पादन",
  "settings.mcp.action.delete": "मेट्नुहोस्",
  "settings.mcp.delete.title": "MCP सर्भर मेट्नुहोस्",
  "settings.mcp.delete.body": "{{name}} हटाउने? यो फिर्ता गर्न मिल्दैन।",
  "settings.mcp.form.title.add": "MCP सर्भर थप्नुहोस्",
  "settings.mcp.form.title.edit": "MCP सर्भर सम्पादन गर्नुहोस्",
  "settings.mcp.form.subtitle": "जडान सेटिङहरू कन्फिगर गर्नुहोस्।",
  "settings.mcp.form.name": "नाम",
  "settings.mcp.form.command": "आदेश",
  "settings.mcp.form.command.hint": "जस्तै npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "कार्य डाइरेक्टरी",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "वातावरण चरहरू",
  "settings.mcp.form.headers": "हेडरहरू",
  "settings.mcp.form.addRow": "पङ्क्ति थप्नुहोस्",
  "settings.mcp.form.removeRow": "हटाउनुहोस्",
  "settings.mcp.form.oauth": "OAuth",
  "settings.mcp.form.oauth.clientId": "क्लाइन्ट ID",
  "settings.mcp.form.oauth.clientSecret": "क्लाइन्ट सिक्रेट",
  "settings.mcp.form.oauth.clientSecret.keep": "कन्फिगर गरिएको — राख्न खाली छोड्नुहोस्",
  "settings.mcp.form.oauth.scope": "दायरा",
  "settings.mcp.form.oauth.callbackPort": "कलब्याक पोर्ट",
  "settings.mcp.form.oauth.disableAutodetect": "OAuth स्वतः पत्ता लगाउने अक्षम गर्नुहोस्",
  "settings.mcp.form.enabled": "सक्षम",
  "settings.mcp.form.timeout": "समयसीमा (ms)",
  "settings.mcp.form.save": "सुरक्षित गर्नुहोस्",
  "settings.mcp.form.cancel": "रद्द",
  "settings.mcp.form.error.name": "नाम टाइप गर्नुहोस्।",
  "settings.mcp.form.error.command": "आदेश टाइप गर्नुहोस्।",
  "settings.mcp.form.error.url": "URL टाइप गर्नुहोस्।",
  "settings.mcp.form.error.callbackPort": "कलब्याक पोर्ट १-६५५३५ बीच हुनुपर्छ।",
  "settings.mcp.form.error.timeout": "समयसीमा धनात्मक पूर्णाङ्क हुनुपर्छ।",
  "settings.mcp.errors.invalid": "हाइलाइट गरिएका फिल्डहरू सच्याउनुहोस्।",
  "settings.mcp.errors.duplicate": "यो नामको सर्भर पहिले नै छ।",
  "settings.mcp.errors.noConfig": "{{name}} को कन्फिगरेसन पढ्न सकिएन — परियोजना बाहिर परिभाषित हुन सक्छ।",
  "settings.mcp.edit.warn": "सुरक्षित गर्दा यो सर्भर पुनः जडान हुन्छ।",
  ...
  "settings.plugins.detail.copied": "प्रतिलिपि गरियो",
  "settings.plugins.detail.notOnNpm": "npm मा फेला परेन — opencode.json मा हस्तगत रूपमा थप्नुहोस्",
  "settings.plugins.install.title": "प्लगइन स्थापना",
  "settings.plugins.install.description": "{{name}} कहाँ थप्ने?",
  "settings.plugins.install.global": "विश्वव्यापी (~/.config/opencode)",
  "settings.plugins.install.project": "यो परियोजना",
  "settings.plugins.install.cancel": "रद्द",
  "settings.plugins.install.success": "{{name}} स्थापित भयो। लोड गर्न OpenCode पुनः सुरु गर्नुहोस्।",
  "settings.plugins.installed.empty": "कुनै प्लगइन स्थापित छैन।",
  "settings.plugins.installed.provenance.global": "विश्वव्यापी",
  "settings.plugins.installed.provenance.project": "परियोजना",
  ...
  "settings.plugins.errors.catalog": "प्लगइन क्याटलग रिफ्रेस गर्न सकिएन।",
  "settings.plugins.stale": "क्यास गरिएको क्याटलग देखाइँदैछ ({{age}} पुरानो)।",
