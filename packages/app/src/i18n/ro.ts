export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Argus",
  ...
  "desktop.menu.ariaLabel": "Meniu Argus",
  ...
  "desktop.recovery.loadFailed": "Argus nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Argus s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Argus nu răspunde",
  ...
  "desktop.wsl.error.installArgus": "Instalarea Argus a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.argusMissing": "argus nu este instalat în această distribuție",
  "desktop.wsl.error.argusCannotRun": "argus este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.argusNotInstalled": "Argus nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Argus s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.argus.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.argus.tagline": "Modele optimizate, fiabile",
  "dialog.provider.argusGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Argus",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Argus.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.argusZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.argusZen.visit.prefix": "Vizitează",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Argus.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în argus.json",
  ...
  "dialog.server.description": "Schimbă serverul Argus la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingArgus": "Se verifică Argus...",
  "wsl.onboarding.checkingArgusIn": "Se verifică Argus în {{distro}}...",
  "wsl.onboarding.updatingArgus": "Se actualizează Argus...",
  "wsl.onboarding.updatingArgusIn": "Se actualizează Argus în {{distro}}...",
  "wsl.onboarding.updateArgusIn": "Actualizează Argus în {{distro}}.",
  "wsl.onboarding.updateArgus": "Actualizează Argus",
  "wsl.onboarding.argusReadyIn": "Argus este gata în {{distro}}.",
  "wsl.onboarding.argusReady": "Argus este gata.",
  "wsl.onboarding.installArgusIn": "Instalează Argus în {{distro}}.",
  "wsl.onboarding.installArgus": "Instalează Argus",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Argus să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Argus nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Argus.",
  ...
  "help.tabs.introduction": "Argus Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Argus ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Argus",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (argus.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Argus nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Argus include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Argus în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Argus",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Argus pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Argus urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Argus.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Argus",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Argus.",
