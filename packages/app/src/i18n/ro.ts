export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Pencode",
  ...
  "desktop.menu.ariaLabel": "Meniu Pencode",
  ...
  "desktop.recovery.loadFailed": "Pencode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Pencode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Pencode nu răspunde",
  ...
  "desktop.wsl.error.installPencode": "Instalarea Pencode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.pencodeMissing": "pencode nu este instalat în această distribuție",
  "desktop.wsl.error.pencodeCannotRun": "pencode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.pencodeNotInstalled": "Pencode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Pencode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.pencode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.pencode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.pencodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Pencode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Pencode.",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.pencodeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.pencodeZen.visit.prefix": "Vizitează",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Pencode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Pencode.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în pencode.json",
  ...
  "dialog.server.description": "Schimbă serverul Pencode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingPencode": "Se verifică Pencode...",
  "wsl.onboarding.checkingPencodeIn": "Se verifică Pencode în {{distro}}...",
  "wsl.onboarding.updatingPencode": "Se actualizează Pencode...",
  "wsl.onboarding.updatingPencodeIn": "Se actualizează Pencode în {{distro}}...",
  "wsl.onboarding.updatePencodeIn": "Actualizează Pencode în {{distro}}.",
  "wsl.onboarding.updatePencode": "Actualizează Pencode",
  "wsl.onboarding.pencodeReadyIn": "Pencode este gata în {{distro}}.",
  "wsl.onboarding.pencodeReady": "Pencode este gata.",
  "wsl.onboarding.installPencodeIn": "Instalează Pencode în {{distro}}.",
  "wsl.onboarding.installPencode": "Instalează Pencode",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Pencode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Pencode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Pencode.",
  ...
  "help.tabs.introduction": "Pencode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Pencode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Pencode",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (pencode.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Pencode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Pencode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Pencode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Pencode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Pencode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Pencode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Pencode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Pencode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Pencode.",
