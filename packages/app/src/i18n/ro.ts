export const dict = {
  ...
  "provider.custom.models.load": "Încarcă dinamic",
  "provider.custom.models.loading": "Se încarcă...",
  "provider.custom.models.load.invalidUrl": "Introdu un URL de bază valid",
  "provider.custom.models.load.unauthorized": "Neautorizat. Verifică cheia API",
  "provider.custom.models.load.invalidFormat": "Răspunsul serverului nu conținea o listă validă de modele",
  "provider.custom.models.load.timeout": "Timp expirat la încărcarea modelelor",
  "provider.custom.models.load.failed": "Încărcarea modelelor a eșuat",
  "provider.custom.models.load.empty": "Niciun model găsit",
