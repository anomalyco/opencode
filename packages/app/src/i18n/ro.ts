export const dict = {
  ...
  "session.tab.agents": "Subagenți",
  "session.agents.empty": "Niciun subagent în execuție",
  "session.agents.costTotal": "Cost total",
  "session.agents.costSubagents": "Subagenți",
  "session.agents.count": "Agenți",
  "session.agents.tokens": "tokenuri",
  "session.agents.showAll": "Arată tot ({{count}})",
  "session.agents.status.idle": "Inactiv",
  "session.agents.status.busy": "În execuție",
  "session.agents.status.retry": "Reîncercare",
  "session.agents.status.cancelled": "Anulat",
  "session.agents.status.completed": "Finalizat",
  "session.agents.status.error": "Eșuat",
