export const dict = {
  ...
  "command.session.handoff": "Transferă sesiunea",
  "command.session.handoff.description": "Compactează sesiunea și continuă lucrul într-o sesiune nouă",
  ...
  "toast.session.handoff.failed.title": "Nu s-a putut transfera sesiunea",
  "toast.session.handoff.failed.description": "Această sesiune nu a putut fi rezumată pentru transfer",
