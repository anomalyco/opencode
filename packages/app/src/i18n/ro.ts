export const dict = {
  ...
  "settings.tab.plugins": "Plugin-uri",
  "settings.plugins.section.browse": "Răsfoiește",
  "settings.plugins.section.installed": "Instalate",
  ...
  "settings.mcp.add": "Adaugă server",
  "settings.mcp.empty": "Nu există servere MCP configurate.",
  "settings.mcp.deleted": "{{name}} a fost șters.",
  "settings.mcp.errors.refresh": "Nu s-au putut încărca serverele MCP.",
  "settings.mcp.status.pending": "se conectează…",
  "settings.mcp.action.connect": "Conectare",
  "settings.mcp.action.disconnect": "Deconectare",
  "settings.mcp.action.authenticate": "Autentificare",
  "settings.mcp.action.edit": "Editează",
  "settings.mcp.action.delete": "Șterge",
  "settings.mcp.delete.title": "Șterge serverul MCP",
  "settings.mcp.delete.body": "Se elimină {{name}}? Acțiunea este ireversibilă.",
  "settings.mcp.form.title.add": "Adaugă server MCP",
  "settings.mcp.form.title.edit": "Editează serverul MCP",
  "settings.mcp.form.subtitle": "Configurează setările conexiunii.",
  "settings.mcp.form.name": "Nume",
  "settings.mcp.form.command": "Comandă",
  "settings.mcp.form.command.hint": "ex. npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.form.cwd": "Director de lucru",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.env": "Variabile de mediu",
  "settings.mcp.form.headers": "Anteturi",
  "settings.mcp.form.addRow": "Adaugă rând",
  "settings.mcp.form.removeRow": "Elimină",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Configurat — lasă gol pentru a păstra",
  "settings.mcp.form.oauth.scope": "Domeniu",
  "settings.mcp.form.oauth.callbackPort": "Port de callback",
  "settings.mcp.form.oauth.disableAutodetect": "Dezactivează detectarea automată OAuth",
  "settings.mcp.form.enabled": "Activat",
  "settings.mcp.form.timeout": "Limită de timp (ms)",
  "settings.mcp.form.save": "Salvează",
  "settings.mcp.form.cancel": "Anulează",
  "settings.mcp.form.error.name": "Introdu un nume.",
  "settings.mcp.form.error.command": "Introdu o comandă.",
  "settings.mcp.form.error.url": "Introdu un URL.",
  "settings.mcp.form.error.callbackPort": "Portul de callback trebuie să fie între 1 și 65535.",
  "settings.mcp.form.error.timeout": "Limita de timp trebuie să fie un număr întreg pozitiv.",
  "settings.mcp.errors.invalid": "Corectează câmpurile evidențiate.",
  "settings.mcp.errors.duplicate": "Există deja un server cu acest nume.",
  "settings.mcp.errors.noConfig": "Nu se poate citi configurația pentru {{name}} — poate fi definită în afara proiectului.",
  "settings.mcp.edit.warn": "Salvarea reconectează acest server.",
  ...
  "settings.plugins.detail.copied": "Copiat",
  "settings.plugins.detail.notOnNpm": "Negăsit pe npm — adaugă manual în opencode.json",
  "settings.plugins.install.title": "Instalează pluginul",
  "settings.plugins.install.description": "Unde se adaugă {{name}}?",
  "settings.plugins.install.global": "Global (~/.config/opencode)",
  "settings.plugins.install.project": "Acest proiect",
  "settings.plugins.install.cancel": "Anulează",
  "settings.plugins.install.success": "{{name}} a fost instalat. Repornește OpenCode pentru încărcare.",
  "settings.plugins.installed.empty": "Nu există pluginuri instalate.",
  "settings.plugins.installed.provenance.global": "Global",
  "settings.plugins.installed.provenance.project": "Proiect",
  ...
  "settings.plugins.errors.catalog": "Catalogul de pluginuri nu a putut fi reîmprospătat.",
  "settings.plugins.stale": "Se afișează catalogul din cache (în vârstă de {{age}}).",
