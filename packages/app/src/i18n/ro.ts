export const dict = {
  ...
  "mcp.status.needs_client_registration": "necesită înregistrarea clientului",
  "mcp.status.pending": "se conectează…",
  ...
  "settings.mcp.type.remote": "La distanță",
  ...
  "settings.mcp.form.oauth.clientSecret.keep": "Lasa gol pentru a omite — poate fi necesară reautentificarea",
