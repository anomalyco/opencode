export const dict = {
  ...
  "command.tab.closeAll": "Închide toate filele",
  "command.tab.closeRight": "Închide toate filele din dreapta",
  "command.tab.closeOthers": "Închide toate filele în afară de aceasta",
