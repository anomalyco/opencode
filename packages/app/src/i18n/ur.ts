export const dict = {
  ...
  "desktop.menu.documentation": "Argus دستاویزات",
  ...
  "desktop.recovery.loadFailed": "Argus لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Argus ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Argus جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installArgus": "Argus کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.argusMissing": "اس ڈسٹری بیوشن میں argus انسٹال نہیں ہے",
  "desktop.wsl.error.argusCannotRun": "argus انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.argusNotInstalled": "{{distro}} میں Argus انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Argus کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.argus.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.argus.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.argusGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Argus کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Argus میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.argusZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.argusZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.argusZen.visit.link": "argus.ai/zen",
  "provider.connect.argusZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Argus میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Argus میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "argus.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Argus سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingArgus": "Argus چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingArgusIn": "{{distro}} میں Argus چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingArgus": "Argus کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingArgusIn": "{{distro}} میں Argus کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateArgusIn": "{{distro}} میں Argus کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateArgus": "Argus کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.argusReadyIn": "Argus {{distro}} میں تیار ہے۔",
  "wsl.onboarding.argusReady": "Argus تیار ہے۔",
  "wsl.onboarding.installArgusIn": "{{distro}} میں Argus انسٹال کریں۔",
  "wsl.onboarding.installArgus": "Argus انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.argusMissing": "Argus انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Argus WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Argus اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Argus کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Argus Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Argus ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Argus ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (argus.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Argus ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Argus میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Argus سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Argus کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Argus کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Argus سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Argus کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Argus لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Argus کا تازہ ترین ورژن چلا رہے ہیں۔",
