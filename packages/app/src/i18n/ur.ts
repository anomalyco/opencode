export const dict = {
  ...
  "command.session.handoff": "سیشن منتقل کریں",
  "command.session.handoff.description": "سیشن کا خلاصہ بنائیں اور نئے سیشن میں کام جاری رکھیں",
  ...
  "toast.session.handoff.failed.title": "سیشن منتقل کرنے میں ناکامی",
  "toast.session.handoff.failed.description": "منتقلی کے لیے اس سیشن کا خلاصہ نہیں بنایا جا سکا",
