export const dict = {
  ...
  "home.recentlyClosed.options": "فلٹر اور ترتیب",
  ...
  "home.recentlyClosed.filter.hidden": "پوشیدہ",
  "home.recentlyClosed.filter.all": "تمام",
  "home.recentlyClosed.filter.empty": "اس فلٹر سے کوئی پروجیکٹ مطابقت نہیں رکھتا",
  "home.recentlyClosed.sort.label": "ترتیب",
  "home.recentlyClosed.sort.recent": "سب سے نئے پہلے",
  "home.recentlyClosed.sort.oldest": "سب سے پرانے پہلے",
  "home.recentlyClosed.sort.nameAsc": "نام ا–ی",
  "home.recentlyClosed.sort.nameDesc": "نام ی–ا",
  "home.recentlyClosed.search.placeholder": "حال ہی میں بند کیے گئے میں تلاش کریں",
  "home.recentlyClosed.showMore": "سب دکھائیں ({{count}})",
  "home.recentlyClosed.showLess": "کم دکھائیں",
  "home.recentlyClosed.select": "منتخب کریں…",
  "home.recentlyClosed.selectAll": "سب منتخب کریں",
  "home.recentlyClosed.deselectAll": "سب کا انتخاب ختم کریں",
  "home.recentlyClosed.cancelSelection": "انتخاب منسوخ کریں",
  "home.recentlyClosed.selected": "{{count}} منتخب",
  "home.recentlyClosed.noResults": "“{{query}}” سے کوئی پروجیکٹ مطابقت نہیں رکھتا",
  "home.recentlyClosed.archived.badge": "آرکائیو شدہ",
  "home.recentlyClosed.hidden.badge": "پوشیدہ",
  "home.recentlyClosed.action.reopen": "دوبارہ کھولیں",
  "home.recentlyClosed.action.unarchive": "آرکائیو سے نکالیں",
  "home.recentlyClosed.action.hide": "چھپائیں",
  "home.recentlyClosed.action.unhide": "ظاہر کریں",
  "home.recentlyClosed.action.remove": "بھول جائیں",
  "home.recentlyClosed.remove.title": "پروجیکٹ بھول جائیں؟",
  "home.recentlyClosed.remove.titleMany": "{{count}} پروجیکٹس بھول جائیں؟",
  "home.recentlyClosed.remove.confirm": "“{{name}}” کو حال ہی میں بند کیے گئے سے ہٹائیں؟ یہ صرف تاریخ صاف کرتا ہے اور کبھی فائلیں حذف نہیں کرتا۔",
  "home.recentlyClosed.remove.confirmMany": "{{count}} پروجیکٹس کو حال ہی میں بند کیے گئے سے ہٹائیں؟ یہ صرف تاریخ صاف کرتا ہے اور کبھی فائلیں حذف نہیں کرتا۔",
  "home.recentlyClosed.toast.archived": "آرکائیو ہو گیا",
  "home.recentlyClosed.toast.hidden": "چھپا دیا گیا",
  "home.recentlyClosed.toast.removed": "حال ہی میں بند کیے گئے سے ہٹا دیا گیا",
  "home.recentlyClosed.toast.undo": "کالعدم",
