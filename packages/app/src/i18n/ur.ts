export const dict = {
  ...
  "desktop.menu.documentation": "Pencode دستاویزات",
  ...
  "desktop.recovery.loadFailed": "Pencode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Pencode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Pencode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installPencode": "Pencode کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.pencodeMissing": "اس ڈسٹری بیوشن میں pencode انسٹال نہیں ہے",
  "desktop.wsl.error.pencodeCannotRun": "pencode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.pencodeNotInstalled": "{{distro}} میں Pencode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Pencode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.pencode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.pencode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.pencodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Pencode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Pencode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.pencodeZen.line1":
    "Pencode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.pencodeZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.pencodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.pencodeZen.visit.link": "pencode.ai/zen",
  "provider.connect.pencodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Pencode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Pencode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "pencode.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Pencode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingPencode": "Pencode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingPencodeIn": "{{distro}} میں Pencode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingPencode": "Pencode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingPencodeIn": "{{distro}} میں Pencode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatePencodeIn": "{{distro}} میں Pencode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updatePencode": "Pencode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.pencodeReadyIn": "Pencode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.pencodeReady": "Pencode تیار ہے۔",
  "wsl.onboarding.installPencodeIn": "{{distro}} میں Pencode انسٹال کریں۔",
  "wsl.onboarding.installPencode": "Pencode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.pencodeMissing": "Pencode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Pencode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Pencode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Pencode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Pencode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pencode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Pencode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (pencode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Pencode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Pencode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Pencode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Pencode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Pencode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Pencode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Pencode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Pencode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Pencode کا تازہ ترین ورژن چلا رہے ہیں۔",
