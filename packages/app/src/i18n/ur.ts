export const dict = {
  ...
  "provider.custom.models.load": "متحرک طور پر لوڈ کریں",
  "provider.custom.models.loading": "لوڈ ہو رہا ہے...",
  "provider.custom.models.load.invalidUrl": "ایک درست بیس URL درج کریں",
  "provider.custom.models.load.unauthorized": "غیر مجاز۔ API کلید چیک کریں",
  "provider.custom.models.load.invalidFormat": "سرور کا ردعمل درست ماڈل فہرست نہیں تھا",
  "provider.custom.models.load.timeout": "ماڈل لوڈ کرتے وقت وقت ختم ہو گیا",
  "provider.custom.models.load.failed": "ماڈل لوڈ کرنے میں ناکامی",
  "provider.custom.models.load.empty": "کوئی ماڈل نہیں ملا",
