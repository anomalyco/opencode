export const dict = {
  ...
  "desktop.ssh.error.alreadyAdded": "{{host}} پہلے ہی شامل ہے",
  "desktop.ssh.error.opencodeNotInstalled": "{{host}} پر opencode انسٹال نہیں ہے",
  "desktop.ssh.error.installOpencode": "opencode کی تنصیب ناکام ہو گئی",
  "desktop.ssh.error.connectFailed": "{{host}} سے منسلک نہیں ہو سکا",
  "desktop.ssh.error.serverExited": "SSH سرور شروع ہونے کے بعد بند ہو گیا (code={{code}} signal={{signal}})",
  "desktop.ssh.error.serverExitedBeforeHealthy":
    "{{host}} کا SSH سرور فعال ہونے سے پہلے بند ہو گیا (code={{code}} signal={{signal}}){{output}}",
  "desktop.ssh.error.healthTimeout": "{{host}} پر سرور کی صحت کی جانچ {{timeout}}ms کے بعد مقررہ وقت سے تجاوز کر گئی",
  "desktop.ssh.error.commandTimeout": "{{host}} کو ssh کمانڈ نے {{timeout}}ms کے بعد مقررہ وقت سے تجاوز کر دیا",
  "desktop.ssh.error.failedPort": "پورٹ حاصل نہیں ہو سکی",
  "desktop.ssh.error.terminalFailed": "ٹرمینل نہیں کھولا جا سکا",
  ...
  "ssh.server.add": "SSH سرور شامل کریں۔",
  "ssh.server.label": "SSH",
  "ssh.server.menu.label": "SSH سرور",
  "ssh.server.retryStart": "دوبارہ منسلک کریں۔",
  "ssh.server.disconnect": "منقطع کریں",
  "ssh.server.openTerminal": "ٹرمینل کھولیں۔",
  "ssh.server.updating": "اپ ڈیٹ ہو رہا ہے...",
  "ssh.server.status.connecting": "منسلک ہو رہا ہے...",
  "ssh.server.status.disconnected": "منقطع",
  "ssh.add.hostLabel": "SSH ہوسٹ",
  "ssh.add.hostPlaceholder": "user@example.com",
  "ssh.add.hint":
    "آپ کے سسٹم کے ssh کلائنٹ کے ذریعے منسلک ہوتا ہے، اس لیے آپ کی SSH کنفیگ کے ہوسٹس، کلیدیں اور ایجنٹس معمول کے مطابق کام کرتے ہیں۔",
  "ssh.add.configHosts": "آپ کی SSH کنفیگ سے",
  "ssh.add.connect": "منسلک کریں۔",
  "ssh.add.checking": "منسلک ہو رہا ہے...",
  "ssh.add.addServer": "سرور شامل کریں۔",
  "ssh.add.adding": "شامل کیا جا رہا ہے...",
  "ssh.add.installOpencode": "opencode انسٹال کریں۔",
  "ssh.add.updateOpencode": "opencode کو اپ ڈیٹ کریں۔",
  "ssh.add.installing": "انسٹال ہو رہا ہے...",
  "ssh.add.status.unreachable": "منسلک نہیں ہو سکا",
  "ssh.add.status.opencodeMissing": "اس ہوسٹ پر opencode انسٹال نہیں ہے",
  "ssh.add.status.opencodeMismatch": "opencode v{{version}} انسٹال ہے، ڈیسک ٹاپ کے لیے متوقع ورژن v{{expected}} ہے",
  "ssh.add.status.opencodeFound": "opencode v{{version}} مل گیا",
  "ssh.add.authHint":
    "یقینی بنائیں کہ اس ہوسٹ کے لیے کلید پر مبنی SSH توثیق کام کرتی ہے — جانچنے کے لیے ٹرمینل میں `ssh {{host}}` چلائیں۔",
