export const dict = {
  ...
  "session.tab.agents": "سب ایجنٹس",
  "session.agents.empty": "کوئی سب ایجنٹ نہیں چل رہا",
  "session.agents.costTotal": "کل لاگت",
  "session.agents.costSubagents": "سب ایجنٹس",
  "session.agents.count": "ایجنٹس",
  "session.agents.tokens": "ٹوکن",
  "session.agents.showAll": "سب دکھائیں ({{count}})",
  "session.agents.status.idle": "غیر فعال",
  "session.agents.status.busy": "جاری ہے",
  "session.agents.status.retry": "دوبارہ کوشش",
  "session.agents.status.cancelled": "منسوخ",
  "session.agents.status.completed": "مکمل",
  "session.agents.status.error": "ناکام",
