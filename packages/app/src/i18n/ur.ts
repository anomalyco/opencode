export const dict = {
  ...
  "command.tab.closeAll": "تمام ٹیبز بند کریں۔",
  "command.tab.closeRight": "دائیں طرف کے تمام ٹیبز بند کریں۔",
  "command.tab.closeOthers": "اس ٹیب کے علاوہ تمام ٹیبز بند کریں۔",
