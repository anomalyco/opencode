...
test("expands a folder whose path has a trailing Windows separator", async ({ page }) => {
  await mockOpenCodeServer(page, {
    ...
    fileList: (path) => {
      ...
      if (path) return []
      return [
        { name: "frontend", path: "frontend\\", absolute: `${directory}/frontend`, type: "directory" as const, ignored: false },
        { name: "README.md", path: "README.md", absolute: `${directory}/README.md`, type: "file" as const, ignored: false },
      ]
    },
