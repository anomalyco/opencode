...
import { compile, emitEffectImported, emitPromise, write } from "@leak-code/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@leak-code/protocol/groups/event"',
            },
          },
        }),
