...
import { compile, emitEffectImported, emitPromise, write } from "@kancode/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "KanCodeEventEncoded",
              import: 'import type { KanCodeEventEncoded } from "@kancode/protocol/groups/event"',
            },
          },
        }),
