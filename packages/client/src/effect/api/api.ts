...
export type LocationCatalogOutput = {
  ...
  readonly data: {
    readonly agent: ReadonlyArray<Agent.Info>
    readonly command: ReadonlyArray<Command.Info>
    readonly integration: ReadonlyArray<Integration.Info>
    readonly mcp: ReadonlyArray<Mcp.Server>
    readonly mcpResource: Mcp.ResourceCatalog
    readonly model: ReadonlyArray<Model.Info>
    readonly provider: ReadonlyArray<Provider.Info>
    readonly reference: ReadonlyArray<Reference.Info>
    readonly skill: ReadonlyArray<Skill.Info>
    readonly shell: ReadonlyArray<Shell.Info>
    readonly form: ReadonlyArray<Form.Info>
  }
}
export type LocationCatalogOperation<E = never> = (
  input?: LocationCatalogInput,
) => Effect.Effect<LocationCatalogOutput, E>

export interface LocationApi<E = never> {
  readonly get: LocationGetOperation<E>
  readonly catalog: LocationCatalogOperation<E>
}
