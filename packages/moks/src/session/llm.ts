...
import { llmClient } from "@moks/core/effect/app-node-platform"
...
import type { LLMEvent } from "@moks/llm"
import { LLMClient } from "@moks/llm/route"
import type { LLMClientService } from "@moks/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@moks/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @moks/llm. It
