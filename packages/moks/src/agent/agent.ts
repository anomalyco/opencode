...
import { AbsolutePath, type DeepMutable } from "@moks/core/schema"
...
import { Reference } from "@moks/core/reference"
import { Location } from "@moks/core/location"
import { PluginV2 } from "@moks/core/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@moks/Agent") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          general: {
            name: "general",
            description: `General-purpose agent for multi-step research and execution. Use for parallel units of work that are not specialized file recon — domain-neutral, not a coding agent by default.`,
