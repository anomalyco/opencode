import type { PermissionV1 } from "@moks/core/v1/permission"
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@moks/sdk/v2"
...
export const RunCommand = effectCmd({
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running moks server (e.g., http://localhost:4096)",
      })
      .option("password", {
        alias: ["p"],
        type: "string",
        describe: "basic auth password (defaults to MOKS_SERVER_PASSWORD)",
      })
      .option("username", {
        alias: ["u"],
        type: "string",
