...
import { optional } from "@moks/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@moks/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
...
export class Service extends Context.Service<Service, Interface>()("@moks/Provider") {}
