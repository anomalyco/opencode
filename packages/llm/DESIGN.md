...
> current private `@kancode/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@kancode/ai`
...
import { LLM } from "@kancode/ai"
import { OpenAI } from "@kancode/ai/providers/openai"
...
```ts
import { Message } from "@kancode/ai"
...
import { LLM, Tool } from "@kancode/ai"
...
```ts
import { LLM } from "@kancode/ai/promise"
import { OpenAI } from "@kancode/ai/providers/openai"
...
```ts
import { LLMSchema } from "@kancode/ai/schema"
...
```ts
import { Provider, Protocol } from "@kancode/ai/provider"
...
@kancode/ai/providers/openai
@kancode/ai/providers/anthropic
@kancode/ai/providers/google
...
```
