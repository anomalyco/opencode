...
const openAICompatibleReasoningContent = (native: unknown) => {
  ...
  const source = isRecord(native.providerOptions) ? native.providerOptions.openaiCompatible : native.openaiCompatible
  return isRecord(source) && typeof source.reasoning_content === "string" ? source.reasoning_content : undefined
}
