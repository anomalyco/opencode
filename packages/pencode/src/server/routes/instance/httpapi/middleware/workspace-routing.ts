...
>()("@pencode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@pencode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.PENCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.PENCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-pencode-directory"] || process.cwd()
}
