...
export class Service extends Context.Service<Service, Interface>()("@pencode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __PENCODE_PHOTON_WASM_PATH?: string }).__PENCODE_PHOTON_WASM_PATH =
