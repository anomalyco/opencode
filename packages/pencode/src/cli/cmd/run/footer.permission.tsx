...
import type { PermissionRequest } from "@pencode-ai/sdk/v2"
import {
...
export function RejectField(props: {
  ...
  return (
    <textarea
      ...
      maxHeight={3}
      wrapMode="word"
      placeholder="Tell Pencode what to do differently"
      ...
      >
        ...
        <Switch>
          ...
          <Match when={state().stage === "reject"}>
            <box paddingLeft={1}>
              <text fg={props.theme.muted}>Tell Pencode what to do differently</text>
            </box>
          </Match>
        </Switch>
      </box>
