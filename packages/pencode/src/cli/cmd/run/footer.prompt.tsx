...
import { normalizePromptContent } from "@pencode-ai/tui/editor"
...
import { PENCODE_BASE_MODE, useBindings } from "@pencode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Pencode" } satisfies SlashOption,
    ]
