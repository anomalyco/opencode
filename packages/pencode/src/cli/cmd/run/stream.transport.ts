...
import type { Event, GlobalEvent, PencodeClient } from "@pencode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@pencode/RunStreamTransport") {}
