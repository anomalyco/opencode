...
//
// The saved variant persists across sessions in ~/.local/state/pencode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@pencode/RunVariant") {}
