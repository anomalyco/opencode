...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@pencode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@pencode/ACPDirectory") {}
