 ...
 *   "@pencode/ServerAuthConfig",
 *   {
 *     password: Config.string("PENCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("PENCODE_SERVER_USERNAME").pipe(Config.withDefault("pencode")),
 *   },
 * ) {}
 *
