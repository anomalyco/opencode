...
import { httpClient, path } from "@pencode-ai/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/SkillDiscovery") {}
