...
import { ProjectDirectoryTable, ProjectTable } from "@pencode-ai/core/project/sql"
import { ProjectDirectories } from "@pencode-ai/core/project/directories"
import { SessionTable } from "@pencode-ai/core/session/sql"
import { WorkspaceTable } from "@pencode-ai/core/control-plane/workspace.sql"
import { Flag } from "@pencode-ai/core/flag/flag"
import { GlobalBus } from "@/bus/global"
import { which } from "@pencode-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.PENCODE_FAKE_VCS)
