...
import type * as SDK from "@pencode-ai/sdk/v2"
...
import { SessionShareTable } from "@pencode-ai/core/share/sql"
...
const disabled = process.env["PENCODE_DISABLE_SHARE"] === "true" || process.env["PENCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/ShareNext") {}
