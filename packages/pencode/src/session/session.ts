...
import { Slug } from "@pencode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@pencode-ai/llm"
...
import { locationServiceMapLayer } from "@pencode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@pencode-ai/core/session/sql"
...
import { WorkspaceV2 } from "@pencode-ai/core/workspace"
import { SessionID, MessageID, PartID } from "./schema"

import type { Provider } from "@/provider/provider"
import { Global } from "@pencode-ai/core/global"
import { Effect, Layer, Option, Context, Schema, Types } from "effect"
import { NonNegativeInt, optional } from "@pencode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".pencode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@pencode/Session") {}
