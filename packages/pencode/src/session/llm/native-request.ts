import type { JsonSchema, LLMRequest, ProviderMetadata } from "@pencode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@pencode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @pencode-ai/llm request objects from pencode's session/AI SDK-shaped data.
  return LLM.request({
