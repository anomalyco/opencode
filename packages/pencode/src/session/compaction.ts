...
import { buildPrompt } from "@pencode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@pencode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/SessionCompaction") {}
