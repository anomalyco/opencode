...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "pencode-gitlab-auth"
import { PoeAuthPlugin } from "pencode-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/Plugin") {}
