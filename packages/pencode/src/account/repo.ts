...
import { AccountStateTable, AccountTable } from "@pencode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/AccountRepo") {}
