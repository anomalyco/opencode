...
import { EventSequenceTable, EventTable } from "@pencode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@pencode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        PENCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        PENCODE_WORKSPACE_ID: config.id,
        PENCODE_EXPERIMENTAL_WORKSPACES: "true",
