...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@pencode-ai/plugin"
...
import { Glob } from "@pencode-ai/core/util/glob"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return (
    ...
    providerID === ProviderV2.ID.make("pencode-go") ||
    flags.exa ||
    flags.parallel
  )
}
...
export class Service extends Context.Service<Service, Interface>()("@pencode/ToolRegistry") {}
