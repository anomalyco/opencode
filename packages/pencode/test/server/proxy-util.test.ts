...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips pencode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-pencode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-pencode-directory")).toBeNull()
      expect(result.get("x-pencode-workspace")).toBeNull()
