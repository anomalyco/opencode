...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PENCODE_CALLER", () => {
    process.env["PENCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PENCODE_CALLER", () => {
    process.env["PENCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PENCODE_CALLER", () => {
    process.env["PENCODE_CALLER"] = "unknown"
