...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pencode.git")).toEqual({ owner: "sst", repo: "pencode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pencode")).toEqual({ owner: "sst", repo: "pencode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pencode.git")).toEqual({ owner: "sst", repo: "pencode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pencode")).toEqual({ owner: "sst", repo: "pencode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pencode.git")).toEqual({ owner: "sst", repo: "pencode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pencode")).toEqual({ owner: "sst", repo: "pencode" })
})
