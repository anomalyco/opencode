import type { GlobalEvent } from "@pencode-ai/sdk/v2"
import type { EventSource } from "@pencode-ai/tui/context/sdk"

export const worktree = "/tmp/pencode"
export const directory = `${worktree}/packages/pencode`
