...
Practical reference for the current tool-migration state in `packages/pencode`.
...
Tool tests should use the existing Effect helpers in `packages/pencode/test/lib/effect.ts`:
