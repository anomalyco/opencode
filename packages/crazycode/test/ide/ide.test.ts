...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CRAZYCODE_CALLER", () => {
    process.env["CRAZYCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CRAZYCODE_CALLER", () => {
    process.env["CRAZYCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CRAZYCODE_CALLER", () => {
    process.env["CRAZYCODE_CALLER"] = "unknown"
