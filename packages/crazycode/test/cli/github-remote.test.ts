...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/crazycode.git")).toEqual({ owner: "sst", repo: "crazycode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/crazycode")).toEqual({ owner: "sst", repo: "crazycode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/crazycode.git")).toEqual({ owner: "sst", repo: "crazycode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/crazycode")).toEqual({ owner: "sst", repo: "crazycode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/crazycode.git")).toEqual({ owner: "sst", repo: "crazycode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/crazycode")).toEqual({ owner: "sst", repo: "crazycode" })
})
