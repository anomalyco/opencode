...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      npm: "npm uninstall -g crazycode-ai",
      pnpm: "pnpm uninstall -g crazycode-ai",
      bun: "bun remove -g crazycode-ai",
      yarn: "yarn global remove crazycode-ai",
      brew: "brew uninstall crazycode",
    }
