...
import * as OpenAIChat from "@kancode/llm/protocols/openai-chat"
import { Database } from "@kancode/core/database/database"
import { makeLocationNode } from "@kancode/core/effect/app-node"
...
import { EventTable } from "@kancode/core/event/sql"
import { Project } from "@kancode/core/project"
import { ProjectTable } from "@kancode/core/project/sql"
import { QuestionV2 } from "@kancode/core/question"
import { AbsolutePath } from "@kancode/core/schema"
import { SessionV2 } from "@kancode/core/session"
import { Snapshot } from "@kancode/core/snapshot"
import { ContextSnapshotDecodeError } from "@kancode/core/session/error"
import { SessionEvent } from "@kancode/core/session/event"
import { SessionInput } from "@kancode/core/session/input"
import { SessionMessage } from "@kancode/core/session/message"
import { Prompt } from "@kancode/core/session/prompt"
import { SessionProjector } from "@kancode/core/session/projector"
import { SessionExecution } from "@kancode/core/session/execution"
import { SessionRunCoordinator } from "@kancode/core/session/run-coordinator"
import { SessionRunner } from "@kancode/core/session/runner"
import * as SessionRunnerLLM from "@kancode/core/session/runner/llm"
import { SessionRunnerModel } from "@kancode/core/session/runner/model"
import { ToolRegistry } from "@kancode/core/tool/registry"
import { ApplicationTools } from "@kancode/core/tool/application-tools"
import { AgentV2 } from "@kancode/core/agent"
import { Config } from "@kancode/core/config"
import { ConfigCompaction } from "@kancode/core/config/compaction"
import { Tool } from "@kancode/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@kancode/core/session/sql"
import { SessionStore } from "@kancode/core/session/store"
import { SystemContext } from "@kancode/core/system-context"
import { SystemContextRegistry } from "@kancode/core/system-context/registry"
import { SkillGuidance } from "@kancode/core/skill/guidance"
import { ReferenceGuidance } from "@kancode/core/reference/guidance"
...
describe("SessionRunnerLLM", () => {
  ...
  it.effect("updates selected-agent skill guidance after an agent switch", () =>
    Effect.gen(function* () {
      ...
      const session = yield* SessionV2.Service
      const events = yield* EventV2.Service
      skillBaselines.set(AgentV2.ID.make("default"), "Build skills")
      yield* session.prompt({ sessionID, prompt: Prompt.make({ text: "First" }), resume: false })
