import { HttpRecorder } from "@kancode/http-recorder"
import { HttpRecorderInternal } from "@kancode/http-recorder/internal"
import * as OpenAIChat from "@kancode/llm/protocols/openai-chat"
import { Auth, LLMClient, RequestExecutor } from "@kancode/llm/route"
...
describe("SessionRunnerLLM recorded", () => {
  it.effect("executes one recorded V2 prompt through the recorded HTTP transport", () =>
    Effect.gen(function* () {
      ...
      expect(messages[1]).toMatchObject({ type: "assistant", agent: "default", finish: "stop" })
