...
import { GoogleVertexPlugin } from "@pencode-ai/core/plugin/provider/google-vertex"
      ...
      yield* catalog.transform((catalog) =>
        catalog.provider.update(ProviderV2.ID.pencode, (provider) => {
          provider.api = {
            ...
            url: "https://pencode.ai/zen/v1",
          }
        }),
      )
      yield* addPlugin()

      const provider = required(yield* catalog.provider.get(ProviderV2.ID.pencode))
