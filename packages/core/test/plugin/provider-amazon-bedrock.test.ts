  ...
  it.effect("applies the full legacy cross-region prefix matrix", () =>
    Effect.gen(function* () {
      ...
      const cases = [
        ...
        { region: "us-gov-east-1", modelID: "amazon.nova-lite-v1:0", expected: "amazon.nova-lite-v1:0" },
        ...
        { region: "us-east-1", modelID: "nvidia.nemotron-nano-3-30b", expected: "nvidia.nemotron-nano-3-30b" },
