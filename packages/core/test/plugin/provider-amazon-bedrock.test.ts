  ...
  it.effect("applies the full legacy cross-region prefix matrix", () =>
    Effect.gen(function* () {
      ...
      const cases = [
        ...
        { region: "us-gov-west-1", modelID: "anthropic.claude-sonnet-4-5", expected: "us-gov.anthropic.claude-sonnet-4-5" },
        { region: "us-gov-east-1", modelID: "anthropic.claude-sonnet-4-5", expected: "us-gov.anthropic.claude-sonnet-4-5" },
        { region: "us-gov-east-1", modelID: "xai.grok-4.6", expected: "us-gov.xai.grok-4.6" },
        { region: "us-gov-east-1", modelID: "nvidia.nemotron-nano-3-30b", expected: "us-gov.nvidia.nemotron-nano-3-30b" },
        { region: "us-gov-east-1", modelID: "amazon.nova-lite-v1:0", expected: "us-gov.amazon.nova-lite-v1:0" },
        { region: "us-gov-east-1", modelID: "us-gov.xai.grok-4.6", expected: "us-gov.xai.grok-4.6" },
        { region: "us-gov-east-1", modelID: "cohere.command-r-plus-v1:0", expected: "cohere.command-r-plus-v1:0" },
        { region: "us-east-1", modelID: "xai.grok-4.6", expected: "us.xai.grok-4.6" },
        { region: "us-east-1", modelID: "nvidia.nemotron-nano-3-30b", expected: "us.nvidia.nemotron-nano-3-30b" },
