...
const opencodeClient = process.env.APEX_CLIENT

afterEach(() => {
  if (otelResourceAttributes === undefined) delete process.env.OTEL_RESOURCE_ATTRIBUTES
  else process.env.OTEL_RESOURCE_ATTRIBUTES = otelResourceAttributes

  if (opencodeClient === undefined) delete process.env.APEX_CLIENT
  else process.env.APEX_CLIENT = opencodeClient
})
