...
import { SystemContextBuiltIns } from "@moks/core/system-context/builtins"
...
const instructionFile = FSUtil.resolve("/repo/HIRING.md")
    ...
    Effect.gen(function* () {
      ...
      expect(initialized.baseline).toBe(
        [
          ...
          `  Company workspace: ${projectDirectory}`,
          "  Git audit: yes",
