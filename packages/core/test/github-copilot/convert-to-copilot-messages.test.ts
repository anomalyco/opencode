import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@simpliciocode/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
