...
import { Message, Model } from "@kancode/llm"
...
import { AgentAttachment, FileAttachment } from "@kancode/core/session/prompt"
import { toLLMMessages } from "@kancode/core/session/runner/to-llm-message"
    ...
    const messages = toLLMMessages(
      [
        ...
        SessionMessage.User.make({
          ...
          files: [file],
          agents: [AgentAttachment.make({ name: "default" })],
          time: { created },
        }),
