export * as ConfigACEV1 from "./ace"

import { Schema } from "effect"
import { NonNegativeInt, PositiveInt } from "../../schema"

export const Mode = Schema.Literals(["monitor", "fixed-cap", "reject-escalate", "cap", "reject"])
export type Mode = typeof Mode.Type

export class Experiment extends Schema.Class<Experiment>("ConfigV1.ACE.Experiment")({
  name: Schema.String.pipe(Schema.optional),
  arm: Schema.String.pipe(Schema.optional),
}) {}

export class Limits extends Schema.Class<Limits>("ConfigV1.ACE.Limits")({
...
export class Trace extends Schema.Class<Trace>("ConfigV1.ACE.Trace")({
...
export class ExecutionMode extends Schema.Class<ExecutionMode>("ConfigV1.ACE.Headless.ExecutionMode")({
...
export class ToolAccessRights extends Schema.Class<ToolAccessRights>("ConfigV1.ACE.Headless.ToolAccessRights")({
...
export class OutputConstraints extends Schema.Class<OutputConstraints>("ConfigV1.ACE.Headless.OutputConstraints")({
...
export class Headless extends Schema.Class<Headless>("ConfigV1.ACE.Headless")({
...
export class AgentOverride extends Schema.Class<AgentOverride>("ConfigV1.ACE.AgentOverride")({
...
export class Info extends Schema.Class<Info>("ConfigV1.ACE")({
