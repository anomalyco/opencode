...
Summarize only the conversation history in the <conversation> tags. The newest turns may be kept verbatim outside your summary, so focus on the older context that still matters for continuing the work.
