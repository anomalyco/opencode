...
import { Entry, FileSystem, FindInput, Match } from "@kancode/schema/filesystem"
export { Entry, Match, Submatch } from "@kancode/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/v2/FileSystem") {}
