...
import { Entry, FileSystem, FindInput, Match } from "@pencode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@pencode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/v2/FileSystem") {}
