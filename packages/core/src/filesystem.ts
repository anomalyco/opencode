...
import { Entry, FileSystem, FindInput, Match } from "@argus-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@argus-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@argus/v2/FileSystem") {}
