...
import { type Model } from "@argus-ai/llm"
import * as AnthropicMessages from "@argus-ai/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@argus-ai/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@argus-ai/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@argus-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@argus/v2/SessionRunnerModel") {}
