...
import { type Model } from "@kancode/llm"
import * as AnthropicMessages from "@kancode/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@kancode/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@kancode/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@kancode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/v2/SessionRunnerModel") {}
