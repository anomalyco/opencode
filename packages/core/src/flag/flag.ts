...
export const Flag = {
  ...
  OPENCODE_PUSH_VAPID_PRIVATE_KEY: process.env["OPENCODE_PUSH_VAPID_PRIVATE_KEY"],
  OPENCODE_PUSH_VAPID_PUBLIC_KEY: process.env["OPENCODE_PUSH_VAPID_PUBLIC_KEY"],
  OPENCODE_PUSH_VAPID_SUBJECT: process.env["OPENCODE_PUSH_VAPID_SUBJECT"],
