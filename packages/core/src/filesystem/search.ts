...
export class Service extends Context.Service<Service, Interface>()("@pencode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.PENCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
