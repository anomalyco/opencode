...
import { FileSystemWatcher } from "@pencode-ai/schema/filesystem-watcher"
...
declare const PENCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof PENCODE_LIBC === "undefined" ? undefined : PENCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@pencode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.PENCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.PENCODE_EXPERIMENTAL_FILEWATCHER)) {
