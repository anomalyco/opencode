...
import { FileSystemWatcher } from "@argus-ai/schema/filesystem-watcher"
...
declare const ARGUS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof ARGUS_LIBC === "undefined" ? undefined : ARGUS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@argus/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.ARGUS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.ARGUS_EXPERIMENTAL_FILEWATCHER)) {
