...
import { ListAnchor } from "@kancode/schema/session"
...
import { PromptInput } from "@kancode/schema/prompt-input"
...
import { SessionDurable } from "@kancode/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/v2/Session") {}
