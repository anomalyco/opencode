...
import { ListAnchor } from "@argus-ai/schema/session"
...
import { SessionDurable } from "@argus-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@argus/v2/Session") {}
