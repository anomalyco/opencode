...
import type { Data, Definition, Payload } from "@pencode-ai/schema/event"
...
import { Durable } from "@pencode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@pencode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@pencode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/Event") {}
