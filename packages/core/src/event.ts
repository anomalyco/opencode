...
import { Event } from "@kancode/schema/event"
import type { Data, Definition, Payload } from "@kancode/schema/event"
...
import { Durable } from "@kancode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@kancode/schema/event").ID
export type { Data, Definition, Payload } from "@kancode/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/Event") {}
