...
import type { Data, Definition, Payload } from "@argus-ai/schema/event"
...
import { Durable } from "@argus-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@argus-ai/schema/event").ID
export type { Data, Definition, Payload } from "@argus-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@argus/Event") {}
