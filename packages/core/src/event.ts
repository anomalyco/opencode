...
import type { Data, Definition, Payload } from "@leak-code/schema/event"
...
import { Durable } from "@leak-code/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@leak-code/schema/event").ID
export type { Data, Definition, Payload } from "@leak-code/schema/event"
