...
import type { Plugin as PluginRuntime } from "@argus-ai/plugin/v2/effect"
import { Plugin } from "@argus-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@argus/v2/Plugin") {}
