...
import type { EffectDrizzleSqlite } from "@pencode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/ProjectDirectories") {}
