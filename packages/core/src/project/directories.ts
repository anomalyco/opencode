...
import type { EffectDrizzleSqlite } from "@kancode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/ProjectDirectories") {}
