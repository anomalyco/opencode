...
import type { EffectDrizzleSqlite } from "@argus-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@argus/ProjectDirectories") {}
