...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@pencode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@pencode/v2/ToolRegistry") {}
