...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@argus-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@argus/v2/ToolRegistry") {}
