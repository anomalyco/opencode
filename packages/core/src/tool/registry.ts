...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@kancode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@kancode/v2/ToolRegistry") {}
