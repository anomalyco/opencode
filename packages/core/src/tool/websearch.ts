...
export class ConfigService extends Context.Service<ConfigService, Config>()("@argus/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.ARGUS_WEBSEARCH_PROVIDER === "exa" || process.env.ARGUS_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.ARGUS_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("ARGUS_EXPERIMENTAL") || truthy("ARGUS_ENABLE_EXA") || truthy("ARGUS_EXPERIMENTAL_EXA"),
    enableParallel: truthy("ARGUS_ENABLE_PARALLEL") || truthy("ARGUS_EXPERIMENTAL_PARALLEL"),
...
export { ExaArgs, ParallelArgs, McpRequest }
