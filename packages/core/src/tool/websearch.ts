...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.MOKS_WEBSEARCH_PROVIDER === "exa" || process.env.MOKS_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.MOKS_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("MOKS_EXPERIMENTAL") || truthy("MOKS_ENABLE_EXA") || truthy("MOKS_EXPERIMENTAL_EXA"),
    enableParallel: truthy("MOKS_ENABLE_PARALLEL") || truthy("MOKS_EXPERIMENTAL_PARALLEL"),
