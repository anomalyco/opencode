...
import { ToolFailure } from "@leak-code/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.LEAKCODE_WEBSEARCH_PROVIDER === "exa" || process.env.LEAKCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.LEAKCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("LEAKCODE_EXPERIMENTAL") || truthy("LEAKCODE_ENABLE_EXA") || truthy("LEAKCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("LEAKCODE_ENABLE_PARALLEL") || truthy("LEAKCODE_EXPERIMENTAL_PARALLEL"),
