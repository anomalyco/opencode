...
import { SessionTimelineV2 } from "../v2/components/session-timeline-v2"
...
export function TimelinePlayground(props: { version?: "v1" | "v2" }) {
              ...
              >
                ...
                >
                  <SessionTimelineV2
                    ...
                    editToolDefaultOpen
                    classes={{
                      root: "flex flex-col w-full px-5",
                      turn: "min-w-0 w-full relative",
                      content: "flex flex-col justify-between !overflow-visible",
                      container: "w-full",
                    }}
                  />
