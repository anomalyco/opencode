...
export function setCopyButtonState(host: HTMLElement, state: CopyButtonState) {
  copyButtonState.set(host, state)
}

export function setCopyState(host: HTMLElement, labels: CopyLabels, copied: boolean) {
...
export function disposeCopyButtons(root: Element) {
  const hosts = [
