      ...
      >
        ...
        <div class="relative min-h-[60px]">
          <div
            ...
            // @ts-expect-error
            autocomplete="off"
            // String.raw keeps the single-backslash CSS hex escape identical in
            // the scanned source and the runtime string; a JS-escaped "\\200B"
            // makes Tailwind generate a selector that never matches.
            class={String.raw`relative z-10 block min-h-[60px] max-h-[180px] w-full overflow-y-auto whitespace-pre-wrap bg-transparent px-4 pt-4 pb-2 text-[13px] font-[440] leading-5 text-v2-text-text-base focus:outline-none empty:before:content-['\200B'] [&_[data-mention=file]]:text-syntax-property [&_[data-mention=agent]]:text-syntax-type [&_[data-mention=reference]]:text-syntax-keyword`}
