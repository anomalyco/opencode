...
import { registerPencodeTheme } from "@pencode-ai/ui/context/marked-theme-register"

registerPencodeTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for Pencode, as I think 8 might be
