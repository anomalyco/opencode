...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at cyberstrike.io",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.cyberstrike/tools/{/highlight} to define new LLM tools",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/CyberStrikeus/cyberstrike{/highlight} for containerized use",
