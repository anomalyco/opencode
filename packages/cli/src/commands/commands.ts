...
declare const PENCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof PENCODE_CLI_NAME === "string" ? PENCODE_CLI_NAME : "pencode", {
  description: "Pencode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
