import type { JsonSchema, LLMRequest, ProviderMetadata } from "@simpliciocode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@simpliciocode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @simpliciocode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
