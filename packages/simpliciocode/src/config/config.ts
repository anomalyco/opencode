...
import { NonNegativeInt, PositiveInt, type DeepMutable } from "@simpliciocode/core/schema"
...
// Uses the shared `DeepMutable` from `@simpliciocode/core/schema`. See the definition
