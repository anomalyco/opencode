...
import type { Event, PermissionRequest, QuestionRequest, Session } from "@simpliciocode/sdk/v2"
import type { TuiAttentionNotifyInput } from "@simpliciocode/plugin/tui"
