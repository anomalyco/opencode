...
import { SchemaErrorMiddleware } from "@leak-code/protocol/middleware/schema-error"
export { SchemaErrorMiddleware } from "@leak-code/protocol/middleware/schema-error"
