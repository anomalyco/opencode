...
export default function ChatIndicator({ room, connectionState }: ChatIndicatorProps) {
  const [showBorder, setShowBorder] = useState(
    () => localStorage.getItem("hal-show-border") !== "false",
  )
  const [showBlobOutline, setShowBlobOutline] = useState(
    () => localStorage.getItem("blob-show-outline") === "true",
  )
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (newGridIndex !== activeWidget.gridIndex) {
        ...
        const newSizes = {
          ...widgetSizes,
          [activeWidget.gridIndex]: { width: newWidth, height: newHeight },
        }
  ...
  return (
    <div className="chat-indicator" style={{ transform: "scale(0.6)" }}>
      {/* Widget Grid - INSIDE chat-indicator to be behind lens */}
      <div
        style={{
          position: "absolute",
          inset: "0px",
        ...
        >
          <div
            style={{
              ...
              pointerEvents: "none",
              opacity: 0.6,
              filter: "drop-shadow(rgba(255, 0, 0, 0.6) 0px 0px 0px)",
          ...
          >
            ...
            >
              <defs>
                <linearGradient id="linearGradient2781">
                  <stop
                    id="stop2782"
                    offset="0"
                    style={{ stopColor: "rgb(252, 255, 0)", stopOpacity: 1 }}
                  />
                  <stop
                    id="stop2784"
                    offset="1"
                ...
                <linearGradient id="linearGradient1530">
                  ...
                  <stop
                    id="stop1534"
                    offset="0.5"
                    style={{ stopColor: "rgb(238, 0, 0)", stopOpacity: 1 }}
                  />
                  <stop
                    id="stop4709"
                    offset="0.75"
                    style={{ stopColor: "rgb(164, 0, 0)", stopOpacity: 1 }}
                  />
                  <stop
                    id="stop1532"
                    offset="1"
              ...
              <g
                id="g3882"
                transform="matrix(0.999995,0.000000,0.000000,1.000000,-366.8852,-202.1756)"
              >
                <g
                  id="g1285"
                  transform="matrix(0.706473,0.000000,0.000000,0.706473,392.0851,234.7421)"
                >
                  <path
                    id="path908"
          ...
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="blob-svg">
            ...
            <g filter="none">
              ...
              <circle
                ...
                r="50"
                fill="url(#glass-purple)"
                style={{ transform: `scale(${agentOrb1.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                className="blob-orb"
                cx={agentOrb2.x}
                ...
                r="20"
                fill="url(#glass-purple)"
                style={{ transform: `scale(${agentOrb2.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                className="blob-orb"
                cx={agentOrb3.x}
                ...
                r="18"
                fill="url(#glass-purple)"
                style={{ transform: `scale(${agentOrb3.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                className="blob-orb"
                cx={agentOrb4.x}
                ...
                r="15"
                fill="url(#glass-purple)"
                style={{ transform: `scale(${agentOrb4.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                cx="100"
                cy="100"
          ...
          >
            ...
            >
              <defs>
                <linearGradient id="linearGradient3671">
                  ...
                  <stop
                    id="stop3679"
                    offset="0.92592591"
                    style={{ stopColor: "#272727", stopOpacity: 0.49803922 }}
                  />
                ...
                <linearGradient id="linearGradient3877">
                  ...
                  <stop
                    id="stop3881"
                    offset="0.5"
                    style={{ stopColor: "#000000", stopOpacity: 0.4742268 }}
                  />
                ...
                <linearGradient id="linearGradient1621">
                  ...
                  <stop
                    id="stop1626"
                    offset="0.58647060"
                    style={{ stopColor: "#868686", stopOpacity: 0.21568628 }}
                  />
                ...
                <linearGradient id="linearGradient1613">
                  ...
                  <stop
                    id="stop1615"
                    offset="0.74384898"
                    style={{ stopColor: "#4c4242", stopOpacity: 1 }}
                  />
                  <stop
                    id="stop1616"
                    offset="0.85169548"
                    style={{ stopColor: "#746969", stopOpacity: 1 }}
                  />
                ...
                <linearGradient id="linearGradient4731">
                  <stop
                    id="stop4732"
                    offset="0"
                    style={{ stopColor: "#ffffff", stopOpacity: 0.8019802 }}
                  />
                ...
                <linearGradient id="linearGradient4727">
                  <stop
                    id="stop4728"
                    offset="0"
                    style={{ stopColor: "#ffffff", stopOpacity: 0.47524753 }}
                  />
                ...
                <linearGradient id="linearGradient4699">
                  <stop
                    id="stop4700"
                    offset="0"
                    style={{ stopColor: "#ffffff", stopOpacity: 0.67450982 }}
                  />
                ...
                <linearGradient id="linearGradient4680">
                  ...
                  <stop
                    id="stop4692"
                    offset="0.85705882"
                    style={{ stopColor: "#ffffff", stopOpacity: 0.49803922 }}
                  />
                  <stop
                    id="stop4690"
                    offset="0.98"
                ...
                <linearGradient id="linearGradient4666">
                  ...
                  <stop
                    id="stop4678"
                    offset="0.85169548"
                    style={{ stopColor: "#ffffff", stopOpacity: 0.53465348 }}
                  />
                  <stop
                    id="stop4669"
                    offset="1"
                    style={{ stopColor: "#ffffff", stopOpacity: 0.68316829 }}
                  />
                </linearGradient>
                ...
                <linearGradient id="linearGradient1530">
                  ...
                  <stop
                    id="stop1534"
                    offset="0.5"
                    style={{ stopColor: "#ee0000", stopOpacity: 1 }}
                  />
                  <stop
                    id="stop4709"
                    offset="0.75"
                    style={{ stopColor: "#a40000", stopOpacity: 1 }}
                  />
                ...
                <radialGradient
                  spreadMethod="reflect"
                  gradientTransform="scale(1.338494,0.747108)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient4666"
                ...
                />
                <radialGradient
                  gradientTransform="scale(1.913099,0.522712)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient4699"
                ...
                />
                <linearGradient
                  gradientTransform="scale(1.125463,0.888523)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient3416"
                ...
                />
                <linearGradient
                  gradientTransform="scale(1.145102,0.873285)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient3416"
                ...
                />
                <radialGradient
                  gradientTransform="scale(0.989176,1.010943)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient4727"
                ...
                />
                <radialGradient
                  gradientTransform="scale(1.010943,0.989176)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient4727"
                ...
                />
                <linearGradient
                  gradientTransform="scale(1.125464,0.888522)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient4731"
                ...
                />
                <radialGradient
                  gradientTransform="scale(1.737464,0.575552)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient4699"
                ...
                />
                <linearGradient
                  gradientTransform="scale(0.999208,1.000792)"
                  gradientUnits="userSpaceOnUse"
                  xlinkHref="#linearGradient2976"
              ...
              >
                <g
                  id="g4743"
                  transform="matrix(0.615433,0.000000,0.000000,0.615433,465.9215,207.9876)"
                >
                  <path
                    id="path4044"
                    style={{
                      fill: "url(#radialGradient2177)",
                      fillOpacity: 1,
                      fillRule: "evenodd",
                      stroke: "none",
                      strokeWidth: "1pt",
          ...
          <div
            className="blob-glow"
            style={{
              background: "radial-gradient(circle, #a78bfa 0%, transparent 25%)",
      ...
      <div className="status-container">
        <div className="blob-container">
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="blob-svg">
            ...
            <g filter="none">
              ...
              <circle
                ...
                r="50"
                fill="url(#glass-blue)"
                style={{ transform: `scale(${userOrb1.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                className="blob-orb"
                cx={userOrb2.x}
                ...
                r="20"
                fill="url(#glass-blue)"
                style={{ transform: `scale(${userOrb2.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                className="blob-orb"
                cx={userOrb3.x}
                ...
                r="18"
                fill="url(#glass-blue)"
                style={{ transform: `scale(${userOrb3.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                className="blob-orb"
                cx={userOrb4.x}
                ...
                r="15"
                fill="url(#glass-blue)"
                style={{ transform: `scale(${userOrb4.scale})`, transformOrigin: "100px 100px" }}
              />
              <circle
                cx="100"
                cy="100"
          ...
          <div
            className="blob-glow"
            style={{
              background: "radial-gradient(circle, #60a5fa 0%, transparent 25%)",
              display: showGlow ? "block" : "none",
            }}
          />
        </div>
