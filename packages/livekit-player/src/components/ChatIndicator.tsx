        ...
        <div className="blob-container">
          ...
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="blob-svg">
            ...
            <g filter="url(#goo-agent)">
              ...
              <circle cx={agentOrb1.x} cy={agentOrb1.y} r="40" fill="#a78bfa" opacity={0.2 * (agentBands[0] || 0)} filter="url(#blur-tight)" />
              <circle cx={agentOrb2.x} cy={agentOrb2.y} r="35" fill="#a78bfa" opacity={0.2 * (agentBands[1] || 0)} filter="url(#blur-tight)" />
              <circle cx={agentOrb3.x} cy={agentOrb3.y} r="30" fill="#a78bfa" opacity={0.2 * (agentBands[2] || 0)} filter="url(#blur-tight)" />
              <circle cx={agentOrb4.x} cy={agentOrb4.y} r="25" fill="#a78bfa" opacity={0.2 * (agentBands[3] || 0)} filter="url(#blur-tight)" />
        ...
        <div className="blob-container">
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="blob-svg">
            ...
            <g filter="url(#goo-user)">
              ...
              <circle cx={userOrb1.x} cy={userOrb1.y} r="40" fill="#3b82f6" opacity={0.2 * (userBands[0] || 0)} filter="url(#blur-tight)" />
              <circle cx={userOrb2.x} cy={userOrb2.y} r="35" fill="#3b82f6" opacity={0.2 * (userBands[1] || 0)} filter="url(#blur-tight)" />
              <circle cx={userOrb3.x} cy={userOrb3.y} r="30" fill="#3b82f6" opacity={0.2 * (userBands[2] || 0)} filter="url(#blur-tight)" />
              <circle cx={userOrb4.x} cy={userOrb4.y} r="25" fill="#3b82f6" opacity={0.2 * (userBands[3] || 0)} filter="url(#blur-tight)" />
