...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENDEEPSEEK_CALLER", () => {
    process.env["OPENDEEPSEEK_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENDEEPSEEK_CALLER", () => {
    process.env["OPENDEEPSEEK_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENDEEPSEEK_CALLER", () => {
    process.env["OPENDEEPSEEK_CALLER"] = "unknown"
