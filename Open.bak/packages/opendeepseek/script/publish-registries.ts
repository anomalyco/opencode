...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    "provides=('opendeepseek')",
    "conflicts=('opendeepseek')",
    "depends=('ripgrep')",
    "",
  ...
  const sourcePkgbuild = [
    ...
    "",
    "package() {",
    `  cd "opencode-\${pkgver}/packages/opendeepseek"`,
