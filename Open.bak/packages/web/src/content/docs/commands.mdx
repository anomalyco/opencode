...
Create `.opendeepseek/command/test.md`:

```md title=".opendeepseek/command/test.md"
---
...
```json title="opendeepseek.jsonc" {4-12}
{
...
- Per-project: `.opendeepseek/command/`
...
```md title=".opendeepseek/command/component.md"
---
...
```md title=".opendeepseek/command/create-file.md"
---
...
```md title=".opendeepseek/command/analyze-coverage.md"
---
...
```md title=".opendeepseek/command/review-changes.md"
---
...
```md title=".opendeepseek/command/review-component.md"
---
