...
В OpenCode есть три встроенных агента, между которыми можно переключаться клавишей `Tab`.

- **build** - По умолчанию, агент с полным доступом для разработки
- **ask** - Агент только для вопросов, понимания кода, и мозгового штурма/оценки идей
  - Не может изменять файлы
  - Идеален для изучения незнакомых кодовых баз и понимания принципов работы
- **plan** - Агент только для чтения для создания планов реализации
  - По умолчанию запрещает редактирование файлов
  - Запрашивает разрешение перед выполнением bash-команд
  - Создает детальные планы реализации, которые выполнит агент Build
