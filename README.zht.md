...
nix run nixpkgs#opencode           # 或使用 github:wesleysimplicio/simplicio-code 以取得最新開發分支
```
...
OpenCode 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/wesleysimplicio/simplicio-code/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下載。
