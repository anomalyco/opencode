...
nix run nixpkgs#opencode           # ou github:f5xc-salesdemos/xcsh para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/f5xc-salesdemos/xcsh/releases) ou em [f5xc-salesdemos.github.io/xcsh/download](https://f5xc-salesdemos.github.io/xcsh/download).
...
Saiba mais sobre [agents](https://f5xc-salesdemos.github.io/xcsh/docs/agents).

### Documentação

Para mais informações sobre como configurar o OpenCode, [**veja nossa documentação**](https://f5xc-salesdemos.github.io/xcsh/docs).
