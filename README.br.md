...
<p align="center">
  <a href="https://opencode.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo do SimplicioCode">
    </picture>
  </a>
</p>
...
nix run nixpkgs#opencode           # ou github:wesleysimplicio/simplicio-code para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/wesleysimplicio/simplicio-code/releases) ou em [opencode.ai/download](https://opencode.ai/download).
