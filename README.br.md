<p align="center">
  <a href="https://jaminsmoke.github.io/Jarvis">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo do Jarvis">
    </picture>
  </a>
</p>
...
nix run nixpkgs#opencode           # ou github:jaminsmoke/Jarvis para a branch dev mais recente
```
...
O Jarvis também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/jaminsmoke/Jarvis/releases) ou em [opencode.ai/download](https://jaminsmoke.github.io/Jarvis/download).
...
O Jarvis inclui dois agents integrados, que você pode alternar com a tecla `Tab`.
...
Saiba mais sobre [agents](https://jaminsmoke.github.io/Jarvis/docs/agents).

### Documentação

Para mais informações sobre como configurar o Jarvis, [**veja nossa documentação**](https://jaminsmoke.github.io/Jarvis/docs).

### Contribuir

Se você tem interesse em contribuir com o Jarvis, leia os [contributing docs](./CONTRIBUTING.md) antes de enviar um pull request.

### Construindo com Jarvis

Se você estiver trabalhando em um projeto relacionado ao Jarvis e estiver usando "opencode" como parte do nome (por exemplo, "opencode-dashboard" ou "opencode-mobile"), adicione uma nota no README para deixar claro que não foi construído pela equipe do Jarvis e não é afiliado a nós de nenhuma forma.
