...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/f5xc-salesdemos/xcsh/releases) ou em [opencode.ai/download](https://opencode.ai/download).
