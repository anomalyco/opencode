...
![Sieć opencode - Nowa sesja](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![opencode Web - Aktywna sesja](../../packages/web/src/assets/web/web-homepage-active-session.png)
