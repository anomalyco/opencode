...
![opencode Web - Yeni Oturum](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![opencode Web - Etkin Oturum](../../packages/web/src/assets/web/web-homepage-active-session.png)

### Sunucu Durumu

Bağlı sunucuları ve durumlarını görüntülemek için "Sunucuları Gör" seçeneğini tıklayın.

![opencode Web - Sunuculara bakın](../../packages/web/src/assets/web/web-homepage-see-servers.png)
