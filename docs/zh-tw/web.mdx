...
![OpenCode Web - New Session](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - Active Session](../../packages/web/src/assets/web/web-homepage-active-session.png)
