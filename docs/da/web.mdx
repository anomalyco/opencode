...
![OpenCode Web - Ny session](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - Se servere](../../packages/web/src/assets/web/web-homepage-see-servers.png)
