...
![OpenCode Web – Neue Sitzung](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web – Aktive Sitzung](../../packages/web/src/assets/web/web-homepage-active-session.png)

### Serverstatus

Klicken Sie auf „Server anzeigen“, um verbundene Server und deren Status anzuzeigen.

![OpenCode Web – Siehe Server](../../packages/web/src/assets/web/web-homepage-see-servers.png)
