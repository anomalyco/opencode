...
> **适用范围**:DeskFox(opencode-fork)分支策略 v2 模型下,Win 端(笑南)与 Mac 端(李哲)双端协作的日常开发流程
...
- 笑南在 Win 端开 `feat/win-tri-env-appid`(以下简称 feat/A)
...
**Step 4:谁先做完谁先合(假设笑南先)**

笑南走完单人流程的 Step 3-5(rebase + 合 dev + 删分支),**完成后通知李哲**:
