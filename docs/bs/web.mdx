...
![OpenCode Web - Nova sesija](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - aktivna sesija](../../packages/web/src/assets/web/web-homepage-active-session.png)

### Status servera

Kliknite "Pogledajte servere" da vidite povezane servere i njihov status.

![OpenCode Web - Vidi servere](../../packages/web/src/assets/web/web-homepage-see-servers.png)
