...
![opencode Web - 새로운 세션](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![opencode Web - Servers 참조](../../packages/web/src/assets/web/web-homepage-see-servers.png)
