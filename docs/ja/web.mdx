...
![OpenCode Web - 新しいセッション](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - アクティブなセッション](../../packages/web/src/assets/web/web-homepage-active-session.png)

### サーバーステータス

「サーバーを表示」をクリックすると、接続されているサーバーとそのステータスが表示されます。

![OpenCode Web - サーバー](../../packages/web/src/assets/web/web-homepage-see-servers.png)
