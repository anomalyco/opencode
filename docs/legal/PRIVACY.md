...
| Purpose | Channel |
|---|---|
| Privacy policy questions / exercise of data subject rights | GitHub Issues: https://github.com/yuesoue/opencode-for-office-deskfox/issues (please include "Privacy" in the title for routing) |
...
| **Security vulnerability disclosure** (private channel) | Submit privately via GitHub Security Advisory: https://github.com/yuesoue/opencode-for-office-deskfox/security/advisories/new (**please do not** disclose unfixed security issues in public Issues) |
