...
![opencode Web - Nova Sessão](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![opencode Web - Sessão Ativa](../../packages/web/src/assets/web/web-homepage-active-session.png)
