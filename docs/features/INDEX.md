...
| [repo-migration-deskfox](./repo-migration-deskfox/) | done | 主仓从 `yuesoue/opencode-for-office-deskfox`(无 fork 关系)迁到 `yuesoue/deskfox`(真 fork from anomalyco/opencode);修品牌诚信 + 解锁上游 PR 工作流;dev + 全 tag push,4 处 docs URL 更新,老仓 dev 加 deprecation banner;Mac 端 origin 切换 / Gitee 镜像迁 / 老仓 archive / user 改名 留 backlog |
