...
![OpenCode Web - جلسة جديدة](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - جلسة نشطة](../../packages/web/src/assets/web/web-homepage-active-session.png)

### حالة الخادم

انقر على "See Servers" لعرض الخوادم المتصلة وحالتها.

![OpenCode Web - See Servers (عرض الخوادم)](../../packages/web/src/assets/web/web-homepage-see-servers.png)
