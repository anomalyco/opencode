...
![OpenCode Web - Nuova sessione](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - Sessione attiva](../../packages/web/src/assets/web/web-homepage-active-session.png)

### Stato del server

Fai clic su "See Servers" per vedere i server connessi e il loro stato.

![OpenCode Web - See Servers](../../packages/web/src/assets/web/web-homepage-see-servers.png)
