...
![OpenCode Web - Nueva sesión](../../packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - Sesión activa](../../packages/web/src/assets/web/web-homepage-active-session.png)

### Estado del servidor

Haga clic en "Ver servidores" para ver los servidores conectados y su estado.

![OpenCode Web - Ver Servidores](../../packages/web/src/assets/web/web-homepage-see-servers.png)
