...
- timestamp: 2026-01-31T22:22:52Z
  ...
  found: authMiddleware only bypasses /auth/* and /health; all other paths require session and return 401 for non-HTML accept headers.
  implication: asset requests like /assets/*, /src/login/index.tsx, /oc-theme-preload.js are treated as API calls and receive 401 when not authenticated.
- timestamp: 2026-01-31T22:22:52Z
