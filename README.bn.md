...
OpenCode এ তিনটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।

- **build** - ডিফল্ট, ডেভেলপমেন্টের কাজের জন্য সম্পূর্ণ অ্যাক্সেসযুক্ত এজেন্ট
- **ask** - প্রশ্ন করতে, কোড বুঝতে, এবং আইডিয়া ব্রেইনস্টর্মিং ও মূল্যায়ন করতে রিড-ওনলি এজেন্ট
  - ফাইল এডিট করতে পারে না
  - অপরিচিত কোডবেস এক্সপ্লোর করা এবং কিভাবে কাজ করে তা বুঝার জন্য আদর্শ
- **plan** - ইমপ্লিমেন্টেশন প্ল্যান তৈরি করতে রিড-ওনলি এজেন্ট
  - ডিফল্টভাবে ফাইল এডিট করতে দেয় না
  - ব্যাশ কমান্ড চালানোর আগে অনুমতি চায়
  - বিস্তারিত ইমপ্লিমেন্টেশন প্ল্যান তৈরি করে যা Build এজেন্ট এক্সিকিউট করবে
