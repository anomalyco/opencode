...
OpenCode ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/f5xc-salesdemos/xcsh/releases) অথবা [f5xc-salesdemos.github.io/xcsh/download](https://f5xc-salesdemos.github.io/xcsh/download) থেকে ডাউনলোড করুন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://f5xc-salesdemos.github.io/xcsh/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে OpenCode কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://f5xc-salesdemos.github.io/xcsh/docs)।
