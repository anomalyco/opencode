...
function useShareUrl() {
  return isMock() ? "https://opencode.j9xym.com" : "https://opencode.j9xym.com"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://opencode.j9xym.com/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://opencode.j9xym.com/exchange_github_app_token", {
      method: "POST",
      headers: {
