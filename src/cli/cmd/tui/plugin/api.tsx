...
import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition } from "@/plugin/types/tui"
...
import { createAthenaClient, type AthenaClient } from "@/sdk/v2"
...
type TuiHostPluginApi = TuiPluginApi & {
  map: Map<string | undefined, AthenaClient>
  dispose: () => void
}
