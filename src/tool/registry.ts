...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@athena/ToolRegistry") {}
  ...
  export const layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const all = Effect.fn("ToolRegistry.all")(function* (custom: Tool.Info[]) {
        ...
        const question = ["app", "cli", "desktop"].includes(Flag.ATHENA_CLIENT) || Flag.ATHENA_ENABLE_QUESTION_TOOL
        ...
        return [
          ...
          BrowserHumanHandoffTool,
          // Browser — Patchright fallback (iframes, edge cases)
          PatchrightFallbackTool,
          ...custom,
        ]
      })
      ...
      const tools = Effect.fn("ToolRegistry.tools")(function* (
        ...
        const filtered = allTools.filter((tool) => {
          if (tool.id === "codesearch" || tool.id === "websearch") {
            return model.providerID === ProviderID.athena || Flag.ATHENA_ENABLE_EXA
          }
