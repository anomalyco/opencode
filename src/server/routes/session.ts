  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Athena Agent sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Athena Agent session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Athena Agent session for interacting with AI assistants and managing conversations.",
