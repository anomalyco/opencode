...
export namespace Skill {
  ...
  const ATHENA_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const loadSkills = Effect.fnUntraced(function* (
    ...
    if (!Flag.ATHENA_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of configDirs) {
      yield* scan(state, bus, dir, ATHENA_SKILL_PATTERN)
    }
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@athena/Skill") {}
