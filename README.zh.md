...
nix run nixpkgs#opencode           # 或用 github:f5xc-salesdemos/opencode 获取最新 dev 分支
```
...
OpenCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/f5xc-salesdemos/opencode/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
