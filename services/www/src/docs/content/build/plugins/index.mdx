...
await ctx.skill.transform((editor) => {
  ...
  // Or pass a loader as the second argument to read the body only when the skill is used.
  editor.add({ id: "remote", name: "Remote", path: "/skills/remote.md" }, async () => fetchBody())
