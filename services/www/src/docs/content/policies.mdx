...
| 2           | [Managed settings](/config#managed-settings)                    |
| 3           | Global `~/.config/opencode/opencode.json(c)`                    |
| 4           | Direct `opencode.json(c)`; outer directories beat inner ones    |
| 5 (lowest)  | `.opencode/opencode.json(c)`; outer directories beat inner ones |
