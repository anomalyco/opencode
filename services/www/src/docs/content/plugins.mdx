...
Local files can import `@opencode/plugin` without installing it; OpenCode resolves the package at runtime. Other
dependencies must be installed next to the plugin.
