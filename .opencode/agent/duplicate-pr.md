...
IMPORTANT: The input will contain a line `CURRENT_PR_NUMBER: NNNN`. You MUST pass this number as the `excludePR` parameter to every github-pr-search call to avoid flagging the current PR as a duplicate of itself.
