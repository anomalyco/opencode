...
if (!httpOnly) {
  ...
  mcp.registerTool(
    "ea_lab_store_experiment",
    {
      ...
      inputSchema: {
        ...
        optimized_on_single_period_only: z.boolean().optional(),
      },
    },
  ...
  mcp.registerTool(
    ...
    {
      description: "Find deterministic similar success/failure memories by symbol, strategy, timeframe, and query text.",
      inputSchema: {
