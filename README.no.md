...
nix run nixpkgs#opencode           # eller github:wesleysimplicio/simplicio-code for nyeste dev-branch
```
...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/wesleysimplicio/simplicio-code/releases) eller [opencode.ai/download](https://opencode.ai/download).
