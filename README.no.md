...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/f5xc-salesdemos/xcsh/releases) eller [opencode.ai/download](https://opencode.ai/download).
