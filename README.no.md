...
Jarvis er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/jaminsmoke/Jarvis/releases) eller [opencode.ai/download](https://jaminsmoke.github.io/Jarvis/download).
...
Jarvis har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://jaminsmoke.github.io/Jarvis/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer Jarvis, [**se dokumentasjonen**](https://jaminsmoke.github.io/Jarvis/docs).

### Bidra

Hvis du vil bidra til Jarvis, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på Jarvis

Hvis du jobber med et prosjekt som er relatert til Jarvis og bruker "opencode" som en del av navnet; for eksempel "opencode-dashboard" eller "opencode-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av Jarvis-teamet og ikke er tilknyttet oss på noen måte.
