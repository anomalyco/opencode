...
nix run nixpkgs#opencode           # eller github:f5xc-salesdemos/opencode for nyeste dev-branch
```
...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/f5xc-salesdemos/opencode/releases) eller [opencode.ai/download](https://opencode.ai/download).
